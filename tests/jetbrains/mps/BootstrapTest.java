...
public class BootstrapTest extends BaseMPSTest {
  ...
  public void testCoreLanguage() {
    String res = testProject(new File("languages/core/core.mpr"));
    assertTrue(res, res == null);
  }
  ...
  public void testCollectionsLanguage() {
    String res = testProject(new File("projects/baseLanguageExt/dev/baseLanguageExt.mpr"));
    assertTrue(res, res == null);
  }
  ...
  public void testTransformation() {
    String res = testProject(new File("languages/transformation/templateLanguage.mpr"));
    assertTrue(res, res == null);
  }
  ...
  public void testFindUsagesLanguage() {
    //String res = testProject(new File("languages/bootstrap/findUsagesLanguage/findUsagesLanguage.mpr"));
    //assertTrue(res, res == null);
  }

  public void testXML() {
    String res = testProject(new File("languages/xml/xml.mpr"));
    assertTrue(res, res == null);
  }
