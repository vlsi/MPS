...
public class BootstrapTest extends BaseMPSTest {
  ...
  public void testCoreLanguage() {
    String res = testProject(new File("core/languageDesign/core.mpr"));
    assertTrue(res, res == null);
  }
  ...
  public void testCollectionsLanguage() {
    String res = testProject(new File("baseLanguage/ext/dev/baseLanguageExt.mpr"));
    assertTrue(res, res == null);
  }
  ...
  public void testTransformation() {
    String res = testProject(new File("core/languagesDesign/templateLanguage.mpr"));
    assertTrue(res, res == null);
  }
