...
public class StateMachineTest_Constraints extends BaseConstraintsDescriptor {
  public StateMachineTest_Constraints() {
    super(MetaIdFactory.conceptId(0x6986543d82184ebfL, 0xa2e9565e5049c1ceL, 0x116c17a1865L));
  }
  @Override
  protected Map<SPropertyId, PropertyConstraintsDescriptor> getNotDefaultSProperties() {
    ...
    properties.put(MetaIdFactory.propId(0xceab519525ea4f22L, 0x9b92103b95ca8c0cL, 0x110396eaaa4L, 0x110396ec041L), new BasePropertyConstraintsDescriptor(MetaIdFactory.propId(0xceab519525ea4f22L, 0x9b92103b95ca8c0cL, 0x110396eaaa4L, 0x110396ec041L), this) {
      ...
      public Object getValue(SNode node) {
        ...
        return StateMachineTest_BehaviorDescriptor.getStateMachineName_idhr1J3q0.invoke(node) + " State Machine Test";
      }
    });
    return properties;
  }
