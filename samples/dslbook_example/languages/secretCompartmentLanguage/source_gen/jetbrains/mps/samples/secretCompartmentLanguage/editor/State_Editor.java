...
public class State_Editor extends DefaultNodeEditor {
  ...
  private static class transitionListHandler_sjqidp_b1a extends RefNodeListHandler {
    ...
    public EditorCell createEmptyCell(EditorContext editorContext) {
      ...
      editorContext.getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(transitionListHandler_sjqidp_b1a.this.getOwner(), MetaAdapterFactory.getContainmentLink(0x6986543d82184ebfL, 0xa2e9565e5049c1ceL, 0x116bced8217L, 0x116c117829bL, "transition")));
      try {
