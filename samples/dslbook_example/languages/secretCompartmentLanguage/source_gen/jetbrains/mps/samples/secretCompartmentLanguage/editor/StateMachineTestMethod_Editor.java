...
public class StateMachineTestMethod_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createRefNodeList_ttjdsx_a1b0(EditorContext editorContext, SNode node) {
    ...
    editorCell.setAction(CellActionType.COMMENT, new CellAction_CommentOrUncommentChild(node, MetaAdapterFactory.getContainmentLink(0x6986543d82184ebfL, 0xa2e9565e5049c1ceL, 0x116c1d2af8aL, 0x116c201fd3fL, "handleEvent")));
