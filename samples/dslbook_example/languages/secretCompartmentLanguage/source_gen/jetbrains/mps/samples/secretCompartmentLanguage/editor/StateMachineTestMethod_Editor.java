...
public class StateMachineTestMethod_Editor extends DefaultNodeEditor {
  ...
  private static class handleEventListHandler_ttjdsx_a1b0 extends RefNodeListHandler {
    ...
    public EditorCell createEmptyCell(EditorContext editorContext) {
      ...
      editorContext.getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(handleEventListHandler_ttjdsx_a1b0.this.getOwner(), MetaAdapterFactory.getContainmentLink(0x6986543d82184ebfL, 0xa2e9565e5049c1ceL, 0x116c1d2af8aL, 0x116c201fd3fL, "handleEvent")));
      try {
