...
public class StateMachine_Constraints extends BaseConstraintsDescriptor {
  public StateMachine_Constraints() {
    super(MetaIdFactory.conceptId(new UUID(7603857644014030527l, -6707735206917717554l), 1197149564476l));
  }
  @Override
  protected Map<SPropertyId, PropertyConstraintsDescriptor> getNotDefaultSProperties() {
    ...
    properties.put(MetaIdFactory.propId(new UUID(-3554657779850784990l, -7236703803128771572l), 1169194658468l, 1169194664001l), new BasePropertyConstraintsDescriptor(MetaIdFactory.propId(new UUID(-3554657779850784990l, -7236703803128771572l), 1169194658468l, 1169194664001l), this) {
      ...
      public Object getValue(SNode node) {
        ...
        return SPropertyOperations.getString(node, MetaAdapterFactory.getProperty(new UUID(7603857644014030527l, -6707735206917717554l), 1197149564476l, 1197166557152l, "stateMachineName")) + " State Machine";
      }
    });
    return properties;
  }
