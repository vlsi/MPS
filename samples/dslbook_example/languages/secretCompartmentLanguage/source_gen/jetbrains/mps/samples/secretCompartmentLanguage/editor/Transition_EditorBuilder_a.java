...
/*package*/ class Transition_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createRefCell_jj4qz_a0() {
    CellProviderWithRole provider = new RefCellCellProvider(myNode, getEditorContext()) {
      ...
      protected InlineCellProvider createInlineCellProvider(SNode innerCellNode) {
        return new Transition_EditorBuilder_a._Inline_jj4qz_a0a(innerCellNode, myNode);
      }
    };
  ...
  public static class _Inline_jj4qz_a0a extends InlineCellProvider {
    public _Inline_jj4qz_a0a(SNode node, SNode refNode) {
      super(node, refNode);
    }
  ...
  private EditorCell createRefCell_jj4qz_c0() {
    CellProviderWithRole provider = new RefCellCellProvider(myNode, getEditorContext()) {
      @Override
      protected InlineCellProvider createInlineCellProvider(SNode innerCellNode) {
        return new Transition_EditorBuilder_a._Inline_jj4qz_a2a(innerCellNode, myNode);
      }
    };
  ...
  public static class _Inline_jj4qz_a2a extends InlineCellProvider {
    public _Inline_jj4qz_a2a(SNode node, SNode refNode) {
      super(node, refNode);
    }
    public EditorCell createEditorCell(EditorContext editorContext) {
      return createEditorCell(editorContext, getSNode());
