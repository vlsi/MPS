...
<model modelUID="r:00000000-0000-4000-0000-011c89590431(jetbrains.mps.samples.secretCompartmentLanguage.sandbox)">
  ...
  <root type="tpo2.StateMachine" typeId="tpo2.1197149564476" id="1197150020790" nodeInfo="ng">
    ...
    <node role="state" roleId="tpo2.1197223095983" type="tpo2.State" typeId="tpo2.1197170590231" id="1197223600313" nodeInfo="ng">
      <property name="stateName" nameId="tpo2.1197170631630" value="idle" />
      <node role="transition" roleId="tpo2.1197240451739" type="tpo2.Transition" typeId="tpo2.1197240155690" id="1197240843830" nodeInfo="ng">
    ...
    <node role="state" roleId="tpo2.1197223095983" type="tpo2.State" typeId="tpo2.1197170590231" id="1197240913970" nodeInfo="ng">
      <property name="stateName" nameId="tpo2.1197170631630" value="doorClosed" />
      <node role="transition" roleId="tpo2.1197240451739" type="tpo2.Transition" typeId="tpo2.1197240155690" id="1197242140286" nodeInfo="ng">
    ...
    <node role="state" roleId="tpo2.1197223095983" type="tpo2.State" typeId="tpo2.1197170590231" id="1197242143240" nodeInfo="ng">
      <property name="stateName" nameId="tpo2.1197170631630" value="drawOpened" />
      <node role="transition" roleId="tpo2.1197240451739" type="tpo2.Transition" typeId="tpo2.1197240155690" id="1197242172476" nodeInfo="ng">
    ...
    <node role="state" roleId="tpo2.1197223095983" type="tpo2.State" typeId="tpo2.1197170590231" id="1197242160585" nodeInfo="ng">
      <property name="stateName" nameId="tpo2.1197170631630" value="panelUnlocked" />
    </node>
    <node role="event" roleId="tpo2.1197169554182" type="tpo2.Event" typeId="tpo2.1197169363230" id="1197169658976" nodeInfo="ng">
    ...
    <node role="event" roleId="tpo2.1197169554182" type="tpo2.Event" typeId="tpo2.1197169363230" id="1197169676040" nodeInfo="ng">
    ...
    <node role="event" roleId="tpo2.1197169554182" type="tpo2.Event" typeId="tpo2.1197169363230" id="1197169688807" nodeInfo="ng">
      <property name="eventName" nameId="tpo2.1197169389356" value="lightOn" />
      <property name="code" nameId="tpo2.1197169394841" value="L1ON" />
    </node>
    <node role="event" roleId="tpo2.1197169554182" type="tpo2.Event" typeId="tpo2.1197169363230" id="1197169702886" nodeInfo="ng">
  ...
  <root type="tpo2.StateMachineTest" typeId="tpo2.1197246912613" id="1197247437082" nodeInfo="ng">
    <link role="stateMachine" roleId="tpo2.1197247793411" targetNodeId="1197150020790" resolveInfo="MrsH_StateMachine" />
    <node role="testMethod" roleId="tpo2.1197252952541" type="tpo2.StateMachineTestMethod" typeId="tpo2.1197252718474" id="1197253131013" nodeInfo="ng">
      ...
      <node role="handleEvent" roleId="tpo2.1197255818559" type="tpo2.HandleEvent" typeId="tpo2.1197255776563" id="1197255880355" nodeInfo="ng">
        <link role="event" roleId="tpo2.1197255783048" targetNodeId="1197169658976" resolveInfo="doorClosed" />
      </node>
      <node role="handleEvent" roleId="tpo2.1197255818559" type="tpo2.HandleEvent" typeId="tpo2.1197255776563" id="1197255894825" nodeInfo="ng">
        <link role="event" roleId="tpo2.1197255783048" targetNodeId="1197169676040" resolveInfo="drawOpened" />
      </node>
      <node role="handleEvent" roleId="tpo2.1197255818559" type="tpo2.HandleEvent" typeId="tpo2.1197255776563" id="1197255910138" nodeInfo="ng">
