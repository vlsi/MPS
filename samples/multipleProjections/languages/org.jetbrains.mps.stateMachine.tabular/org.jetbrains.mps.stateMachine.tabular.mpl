...
<language namespace="jetbrains.mps.samples.multipleProjections.stateMachine.tabular" uuid="9357c0ba-2430-4f01-b20a-cc8947960ac3" generatorOutputPath="${module}/source_gen" version="0">
  <models>
  ...
  <accessoryModels />
  <generators>
    <generator name="" generatorUID="jetbrains.mps.samples.multipleProjections.stateMachine.tabular#3675491646420732262" uuid="a8a18a0f-5ff4-4a26-8c9a-bcfc48fe6a5b">
      <models>
        <modelRoot contentPath="${module}" type="default">
