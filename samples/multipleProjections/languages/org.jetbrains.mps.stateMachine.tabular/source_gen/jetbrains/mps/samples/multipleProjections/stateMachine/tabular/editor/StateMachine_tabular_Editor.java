        ...
        return new AbstractTableModel() {
          ...
          public void createElement(int row, int column) {
            if (row > 0 && column > 0) {
              ...
              SLinkOperations.setTarget(transition, "trigger", SNodeFactoryOperations.createNewNode("jetbrains.mps.samples.multipleProjections.stateMachine.structure.EventReference", null), true);
              SLinkOperations.setTarget(SLinkOperations.getTarget(transition, "trigger", true), "event", event, false);
              SLinkOperations.setTarget(transition, "fromState", SNodeFactoryOperations.createNewNode("jetbrains.mps.samples.multipleProjections.stateMachine.structure.StateReference", null), true);
