...
<model ref="r:bdfa3a84-8ee6-4fba-b3f2-b16b2216a12b(jetbrains.mps.samples.Shapes.colors)">
  ...
  <node concept="SVoC5" id="6ckZSPrYT8j">
    <property role="TrG5h" value="white" />
  </node>
  <node concept="SVoC5" id="6ckZSPrYT8k">
    <property role="TrG5h" value="black" />
  </node>
  <node concept="SVoC5" id="6ckZSPrYT8l">
    <property role="TrG5h" value="cyan" />
  </node>
  <node concept="SVoC5" id="6ckZSPrYT8m">
    <property role="TrG5h" value="red" />
  </node>
  <node concept="SVoC5" id="6ckZSPrYT8n">
    <property role="TrG5h" value="blue" />
  </node>
  <node concept="SVoC5" id="6ckZSPrYT8o">
    <property role="TrG5h" value="green" />
  </node>
  <node concept="SVoC5" id="6ckZSPrYT8p">
