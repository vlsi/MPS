...
public final class ColorReference_BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<Color> findColor_id1Os2kBLuoy8 = new SMethodBuilder<Color>(new SJavaCompoundTypeImpl(Color.class)).name("findColor").modifiers(SModifiersImpl.create(0, AccessPrivileges.PUBLIC)).concept(CONCEPT).id("1Os2kBLuoy8").registry(REGISTRY).build(SParameterImpl.fromList(SJavaCompoundTypeImpl.fromClasses()));
  ...
  private static Color findColor_id1Os2kBLuoy8(@NotNull SNode __thisNode__) {
  ...
  /*package*/ ColorReference_BehaviorDescriptor() {
    super(REGISTRY);
  }
  ...
  protected <T> T invokeSpecial0(@NotNull SNode node, @NotNull SMethod<T> method, @NotNull Object[] parameters) {
    ...
    switch (methodIndex) {
      case 0:
        return (T) findColor_id1Os2kBLuoy8(node);
      default:
        throw new BHMethodNotFoundException(this, method);
    }
  }
