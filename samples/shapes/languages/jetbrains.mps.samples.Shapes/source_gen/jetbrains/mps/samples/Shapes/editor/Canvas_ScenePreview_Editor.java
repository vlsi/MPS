...
public class Canvas_ScenePreview_Editor extends DefaultNodeEditor {
  ...
  private static class shapesListHandler_3bcydw_a2a extends RefNodeListHandler {
    ...
    public EditorCell createEmptyCell(EditorContext editorContext) {
      editorContext.getCellFactory().pushCellContext();
      editorContext.getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(shapesListHandler_3bcydw_a2a.this.getOwner(), MetaAdapterFactory.getContainmentLink(0x16bafbb4c6cd4cc5L, 0x83327c6de8729b3fL, 0x51dcaa29974fa71dL, 0x51dcaa29974ffa47L, "shapes")));
      try {
