...
public class ReaderConfiguration_Editor extends DefaultNodeEditor {
  ...
  private static class mappingListHandler_vfprw_b2a extends RefNodeListHandler {
    ...
    public EditorCell createEmptyCell(EditorContext editorContext) {
      editorContext.getCellFactory().pushCellContext();
      editorContext.getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(mappingListHandler_vfprw_b2a.this.getOwner(), MetaAdapterFactory.getContainmentLink(0x89e26c5bfc34a60L, 0x9953f68169a4608aL, 0x103f6aa11b7L, 0x103f6af233bL, "mapping")));
      try {
