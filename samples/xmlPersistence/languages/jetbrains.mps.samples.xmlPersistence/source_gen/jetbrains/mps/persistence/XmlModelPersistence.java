...
public class XmlModelPersistence implements ModelFactory, SModelPersistence {
  ...
  public SModelData createEmpty(SModelReference reference, StreamDataSource source) {
    ...
    sModel.addLanguage(LangUtil.getLanguageId(PersistenceFacade.getInstance().createModuleReference("479c7a8c-02f9-43b5-9139-d910cb22f298(jetbrains.mps.core.xml)").getModuleId()), 0);
