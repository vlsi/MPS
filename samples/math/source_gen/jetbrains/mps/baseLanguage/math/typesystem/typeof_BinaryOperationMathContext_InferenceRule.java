        ...
        public void run() {
          {
            ...
            typeCheckingContext.whenConcrete(rightType, new Runnable() {
              public void run() {
                ...
                if (!((SNodeOperations.isInstanceOf(opType, MetaAdapterFactory.getConcept(new UUID(3676340747305173022l, -6911132873973321185l), 1237108887116l, "jetbrains.mps.baseLanguage.math.structure.BigComplexType")) || SNodeOperations.isInstanceOf(opType, MetaAdapterFactory.getConcept(new UUID(3676340747305173022l, -6911132873973321185l), 1237106070629l, "jetbrains.mps.baseLanguage.math.structure.BigDecimalType")) || (SNodeOperations.isInstanceOf(opType, MetaAdapterFactory.getConcept(new UUID(3676340747305173022l, -6911132873973321185l), 5853558151363197539l, "jetbrains.mps.baseLanguage.math.structure.MatrixOrVectorType")) && (SNodeOperations.isInstanceOf(MathUtil.getUnboxedElementType(opType), MetaAdapterFactory.getConcept(new UUID(3676340747305173022l, -6911132873973321185l), 1237108887116l, "jetbrains.mps.baseLanguage.math.structure.BigComplexType")) || SNodeOperations.isInstanceOf(MathUtil.getUnboxedElementType(opType), MetaAdapterFactory.getConcept(new UUID(3676340747305173022l, -6911132873973321185l), 1237106070629l, "jetbrains.mps.baseLanguage.math.structure.BigDecimalType"))))))) {
                  {
