  ...
  public void applyRule(final SNode intervalType, final TypeCheckingContext typeCheckingContext, IsApplicableStatus status) {
    {
      ...
      typeCheckingContext.createLessThanInequality((SNode) SLinkOperations.getTarget(intervalType, MetaAdapterFactory.getContainmentLink(new UUID(3676340747305173022l, -6911132873973321185l), 1235747354994l, 1235747354995l, "elementType")), (SNode) _quotation_createNode_zf55c1_a0a0b(), false, false, _info_12389875345);
    }
  }
