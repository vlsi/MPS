...
public class typeof_MatrixElementAccessExpression_InferenceRule extends AbstractInferenceRule_Runtime implements InferenceRule_Runtime {
  ...
  public void applyRule(final SNode mea, final TypeCheckingContext typeCheckingContext, IsApplicableStatus status) {
    if (!(SNodeOperations.isInstanceOf(SLinkOperations.getTarget(mea, MetaAdapterFactory.getContainmentLink(new UUID(3676340747305173022l, -6911132873973321185l), 6389121991274611498l, 6389121991274611517l, "rowIndex")), "jetbrains.mps.baseLanguage.math.structure.MatrixIndexWildcard"))) {
      {
    ...
    if (!(SNodeOperations.isInstanceOf(SLinkOperations.getTarget(mea, MetaAdapterFactory.getContainmentLink(new UUID(3676340747305173022l, -6911132873973321185l), 6389121991274611498l, 6389121991274611518l, "colIndex")), "jetbrains.mps.baseLanguage.math.structure.MatrixIndexWildcard"))) {
      {
    ...
    if (SNodeOperations.isInstanceOf(SLinkOperations.getTarget(mea, MetaAdapterFactory.getContainmentLink(new UUID(3676340747305173022l, -6911132873973321185l), 6389121991274611498l, 6389121991274611517l, "rowIndex")), "jetbrains.mps.baseLanguage.math.structure.MatrixIndexWildcard") && SNodeOperations.isInstanceOf(SLinkOperations.getTarget(mea, MetaAdapterFactory.getContainmentLink(new UUID(3676340747305173022l, -6911132873973321185l), 6389121991274611498l, 6389121991274611518l, "colIndex")), "jetbrains.mps.baseLanguage.math.structure.MatrixIndexWildcard")) {
      {
