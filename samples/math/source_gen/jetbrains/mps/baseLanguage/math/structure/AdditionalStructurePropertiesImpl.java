...
public class AdditionalStructurePropertiesImpl extends BaseAdditionalStructureProperties {
  ...
  private final AdditionalConceptProperties props_AbstractIndex = new ConceptPropsBuilder().create();
  private final AdditionalConceptProperties props_ArithmSymbol = new ConceptPropsBuilder().create();
  private final AdditionalConceptProperties props_BigComplexType = new ConceptPropsBuilder().create();
  private final AdditionalConceptProperties props_BigDecimalType = new ConceptPropsBuilder().create();
  private final AdditionalConceptProperties props_BigIntegerType = new ConceptPropsBuilder().create();
  private final AdditionalConceptProperties props_BigMaxExpression = new ConceptPropsBuilder().create();
  private final AdditionalConceptProperties props_BigMinExpression = new ConceptPropsBuilder().create();
  private final AdditionalConceptProperties props_BigProdExpression = new ConceptPropsBuilder().create();
  private final AdditionalConceptProperties props_BigSumExpression = new ConceptPropsBuilder().create();
  private final AdditionalConceptProperties props_ComplexLiteral = new ConceptPropsBuilder().create();
  private final AdditionalConceptProperties props_ComplexType = new ConceptPropsBuilder().create();
  private final AdditionalConceptProperties props_ConjugateOperation = new ConceptPropsBuilder().create();
  private final AdditionalConceptProperties props_CosineExpression = new ConceptPropsBuilder().create();
  private final AdditionalConceptProperties props_DecimalBinaryOperation = new ConceptPropsBuilder().create();
  private final AdditionalConceptProperties props_DecimalDivExpression = new ConceptPropsBuilder().create();
  private final AdditionalConceptProperties props_DecimalMinusExpression = new ConceptPropsBuilder().create();
  private final AdditionalConceptProperties props_DecimalMulExpression = new ConceptPropsBuilder().create();
  private final AdditionalConceptProperties props_DecimalPlusExpression = new ConceptPropsBuilder().create();
  private final AdditionalConceptProperties props_Determinant = new ConceptPropsBuilder().create();
  private final AdditionalConceptProperties props_DivExpressionFraction = new ConceptPropsBuilder().create();
  private final AdditionalConceptProperties props_ExponentExpression = new ConceptPropsBuilder().create();
  private final AdditionalConceptProperties props_ExponentialOperation = new ConceptPropsBuilder().create();
  private final AdditionalConceptProperties props_ExtrSymbol = new ConceptPropsBuilder().create();
  private final AdditionalConceptProperties props_InIntervalExpression = new ConceptPropsBuilder().create();
  private final AdditionalConceptProperties props_IntervalContainsExpression = new ConceptPropsBuilder().create();
  private final AdditionalConceptProperties props_IntervalLiteral = new ConceptPropsBuilder().create();
  private final AdditionalConceptProperties props_IntervalType = new ConceptPropsBuilder().create();
  private final AdditionalConceptProperties props_LinearSolveOperation = new ConceptPropsBuilder().create();
  private final AdditionalConceptProperties props_LiteralI = new ConceptPropsBuilder().create();
  private final AdditionalConceptProperties props_LogExpression = new ConceptPropsBuilder().create();
  private final AdditionalConceptProperties props_MathContext = new ConceptPropsBuilder().create();
  private final AdditionalConceptProperties props_MathFuncExpression = new ConceptPropsBuilder().create();
  private final AdditionalConceptProperties props_MathPrimitiveType = new ConceptPropsBuilder().create();
  private final AdditionalConceptProperties props_MathSymbol = new ConceptPropsBuilder().create();
  private final AdditionalConceptProperties props_MathSymbolFromToIndex = new ConceptPropsBuilder().create();
  private final AdditionalConceptProperties props_MathSymbolIndex = new ConceptPropsBuilder().create();
  private final AdditionalConceptProperties props_MathSymbolIndexReference = new ConceptPropsBuilder().create();
  private final AdditionalConceptProperties props_MathTypeCast = new ConceptPropsBuilder().create();
  private final AdditionalConceptProperties props_MatrixConstructor = new ConceptPropsBuilder().create();
  private final AdditionalConceptProperties props_MatrixElementAccessExpression = new ConceptPropsBuilder().create();
  private final AdditionalConceptProperties props_MatrixExponentialOperation = new ConceptPropsBuilder().create();
  private final AdditionalConceptProperties props_MatrixIndexWildcard = new ConceptPropsBuilder().create();
  private final AdditionalConceptProperties props_MatrixInitializer = new ConceptPropsBuilder().create();
  private final AdditionalConceptProperties props_MatrixInitializerIndex = new ConceptPropsBuilder().create();
  private final AdditionalConceptProperties props_MatrixInitializerIndexReference = new ConceptPropsBuilder().create();
  private final AdditionalConceptProperties props_MatrixInverseOperation = new ConceptPropsBuilder().create();
  private final AdditionalConceptProperties props_MatrixNorm = new ConceptPropsBuilder().create();
  private final AdditionalConceptProperties props_MatrixOrVectorInitializer = new ConceptPropsBuilder().create();
  private final AdditionalConceptProperties props_MatrixOrVectorType = new ConceptPropsBuilder().create();
  private final AdditionalConceptProperties props_MatrixType = new ConceptPropsBuilder().create();
  private final AdditionalConceptProperties props_MatrixUnit = new ConceptPropsBuilder().create();
  private final AdditionalConceptProperties props_MatrixZero = new ConceptPropsBuilder().create();
  private final AdditionalConceptProperties props_PowExpression = new ConceptPropsBuilder().create();
  private final AdditionalConceptProperties props_SineExpression = new ConceptPropsBuilder().create();
  private final AdditionalConceptProperties props_TangentExpression = new ConceptPropsBuilder().create();
  private final AdditionalConceptProperties props_TransposeOperation = new ConceptPropsBuilder().create();
  private final AdditionalConceptProperties props_VectorInitializer = new ConceptPropsBuilder().create();
  private final AdditionalConceptProperties props_VectorType = new ConceptPropsBuilder().create();
