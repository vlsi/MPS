...
public class IntervalContainsExpression_Editor extends DefaultNodeEditor {
  ...
  private class leftExpressionSingleRoleHandler_8gz0ko_a0 extends SingleRoleCellProvider {
    ...
    public void installCellInfo(SNode node, EditorCell editorCell) {
      if (node != null) {
        BinaryOperation_LeftArgument_Actions.setCellActions(editorCell, node, myEditorContext);
      }
  ...
  private class rightExpressionSingleRoleHandler_8gz0ko_c0 extends SingleRoleCellProvider {
    ...
    public void installCellInfo(SNode node, EditorCell editorCell) {
      if (node != null) {
        BinaryOperation_RightArgument_Actions.setCellActions(editorCell, node, myEditorContext);
      }
      editorCell.setSubstituteInfo(new DefaultChildSubstituteInfo(myOwnerNode, myContainmentLink.getDeclarationNode(), myEditorContext));
      if (editorCell.getRole() == null) {
