...
public class IntervalContainsExpression_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createRefNode_8gz0ko_a0(EditorContext editorContext, SNode node) {
    SingleRoleCellProvider provider = new IntervalContainsExpression_Editor.leftExpressionSingleRoleHandler_8gz0ko_a0(node, MetaAdapterFactory.getContainmentLink(0xf3061a5392264cc5L, 0xa443f952ceaf5816L, 0xfbdeb6fecfL, 0xfbdeb7a11cL, "leftExpression"), editorContext);
    return provider.createCell();
  }
  private class leftExpressionSingleRoleHandler_8gz0ko_a0 extends SingleRoleCellProvider {
    public leftExpressionSingleRoleHandler_8gz0ko_a0(SNode ownerNode, SContainmentLink containmentLink, EditorContext context) {
  ...
  private EditorCell createConstant_8gz0ko_b0(EditorContext editorContext, SNode node) {
    ...
    editorCell.setSubstituteInfo(new CompositeSubstituteInfo(editorContext, new BasicCellContext(node), new SubstituteInfoPartExt[]{new IntervalContainsExpression_Editor.ReplaceWith_BinaryOperation_cellMenu_8gz0ko_a0b0(), new SChildSubstituteInfoPartEx(editorCell)}));
    return editorCell;
  }
  ...
  private EditorCell createRefNode_8gz0ko_c0(EditorContext editorContext, SNode node) {
    SingleRoleCellProvider provider = new IntervalContainsExpression_Editor.rightExpressionSingleRoleHandler_8gz0ko_c0(node, MetaAdapterFactory.getContainmentLink(0xf3061a5392264cc5L, 0xa443f952ceaf5816L, 0xfbdeb6fecfL, 0xfbdeb7a11bL, "rightExpression"), editorContext);
    return provider.createCell();
  }
  private class rightExpressionSingleRoleHandler_8gz0ko_c0 extends SingleRoleCellProvider {
    public rightExpressionSingleRoleHandler_8gz0ko_c0(SNode ownerNode, SContainmentLink containmentLink, EditorContext context) {
      super(ownerNode, containmentLink, context);
    }
    protected EditorCell createChildCell(SNode child) {
      myEditorContext.getCellFactory().pushCellContext();
