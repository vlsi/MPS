  ...
  public static void main(String[] args) {
    ...
    System.out.println(String.valueOf((new _FunctionTypes._return_P0_E0<Matrix<Double>>() {
      public Matrix<Double> invoke() {
        Matrix<Double> r_a0a0a2a0;
        r_a0a0a2a0 = null;
        for (int i_a0a0a0c0a = 0; i_a0a0a0c0a <= 99; i_a0a0a0c0a++) {
          int k_a0a0a0c0a = i_a0a0a0c0a;
          r_a0a0a2a0 = new Matrix(r_a0a0a2a0, new Matrix<Double>(true, Matrix.soDouble, new Matrix<Double>(new Matrix<Integer>(new Integer[][]{{1, k_a0a0a0c0a, 0}}, Matrix.soInt), Matrix.soDouble), new Matrix<Double>(new Double[][]{{(double) 0, 1.0, (double) 0}}, Matrix.soDouble), new Matrix<Double>(new Matrix<Integer>(new Integer[][]{{0, 0, 1}}, Matrix.soInt), Matrix.soDouble)), MatrixOperation.MatrixAdd, Matrix.soDouble);
        }
        return r_a0a0a2a0;
      }
    }.invoke())));
