...
public class MindMapThoughtView extends CenterVerticalLayoutView {
  ...
  public MindMapThoughtView() {
    super(false);
    background().set(Color.YELLOW);

    CellView cellView = new CellView();
    cellView.background().set(Color.LIGHT_GREEN);
  ...
  private void initSynchronizers() {
    new Mapper<MindMapThoughtView, MindMapThoughtView>(this, this) {
      @Override
