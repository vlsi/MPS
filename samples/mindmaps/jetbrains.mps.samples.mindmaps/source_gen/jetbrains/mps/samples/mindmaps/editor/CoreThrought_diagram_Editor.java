...
import jetbrains.mps.samples.mindmaps.figures.model.MindMapCentralThoughtView;
...
public class CoreThrought_diagram_Editor extends DefaultNodeEditor {
  ...
  private class BlockCellImpl_pr685x_a extends BlockCell {
    private final PropertyMapperCell<String> myPropertyCell_pr685x_a0a;
    private final PropertyMapperCell<Boolean> myPropertyCell_pr685x_a1a;
    ...
    private BlockCellImpl_pr685x_a(EditorContext editorContext, final SNode node) {
      ...
      myPropertyCell_pr685x_a0a = new PropertyMapperCell<String>(editorContext, node) {
      ...
      myPropertyCell_pr685x_a0a.getEditor().addCellDependentOnNodeProperty(myPropertyCell_pr685x_a0a, new Pair<SNodeReference, String>(new SNodePointer(node), "name"));
      myPropertyCell_pr685x_a1a = new PropertyMapperCell<Boolean>(editorContext, node) {
      ...
      myPropertyCell_pr685x_a1a.getEditor().addCellDependentOnNodeProperty(myPropertyCell_pr685x_a1a, new Pair<SNodeReference, String>(new SNodePointer(node), "myIsClicked"));
    ...
    public Mapper<SNode, DiagramNodeView> createMapper() {
      return new Mapper<SNode, DiagramNodeView>(getSNode(), createDiagramNodeView()) {
        ...
        protected void registerSynchronizers(Mapper.SynchronizersConfiguration configuration) {
          ...
          configuration.add(Synchronizers.forConstantRole(this, getContentViewMapperSource(), getTarget().contentView.children(), new MapperFactory<String, MindMapCentralThoughtView>() {
            public Mapper<? extends String, ? extends MindMapCentralThoughtView> createMapper(String block) {
              return new Mapper<String, MindMapCentralThoughtView>(block, new MindMapCentralThoughtView()) {
                @Override
                protected void registerSynchronizers(Mapper.SynchronizersConfiguration configuration) {
                  super.registerSynchronizers(configuration);
                  myPropertyCell_pr685x_a0a.registerSynchronizers(configuration, getTarget().text());
                  myPropertyCell_pr685x_a1a.registerSynchronizers(configuration, getTarget().isClicked);
                }
              };
            }
          }));
    ...
    private DiagramNodeView createDiagramNodeView() {
      ...
      AbstractJetpadCell.configureView(blockView, BlockCellImpl_pr685x_a.this, new _FunctionTypes._return_P0_E0<Boolean>() {
