...
public class AdditionalStructurePropertiesImpl extends BaseAdditionalStructureProperties {
  private final AdditionalConceptProperties props_NewComponent = new ConceptPropsBuilder().create();
  private final AdditionalConceptProperties props_NewComponentMember = new ConceptPropsBuilder().create();
  private final AdditionalConceptProperties props_OldComponent = new ConceptPropsBuilder().deprecated().create();
  private final AdditionalConceptProperties props_OldComponentMember = new ConceptPropsBuilder().deprecated().create();
