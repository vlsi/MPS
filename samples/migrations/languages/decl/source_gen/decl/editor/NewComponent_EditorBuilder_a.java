...
/*package*/ class NewComponent_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createCollection_sv9e1j_a() {
    ...
    if (renderingCondition_sv9e1j_a2a(myNode, getEditorContext())) {
  ...
  private EditorCell createCollection_sv9e1j_a0() {
    ...
    if (renderingCondition_sv9e1j_a1a0(myNode, getEditorContext())) {
  ...
  private class memberListHandler_sv9e1j_b1a extends RefNodeListHandler {
    ...
    public void installElementCellActions(SNode elementNode, EditorCell elementCell) {
      if (elementCell.getUserObject(AbstractCellListHandler.ELEMENT_CELL_ACTIONS_SET) == null) {
        ...
        if (elementCell.getSubstituteInfo() == null || elementCell.getSubstituteInfo() instanceof DefaultSubstituteInfo) {
          elementCell.setSubstituteInfo(new OldNewCompositeSubstituteInfo(getEditorContext(), new SChildSubstituteInfo(elementCell, getNode(), MetaAdapterFactory.getContainmentLink(0x9de7c5ceea6f4fb4L, 0xa7ba45e62b53cbadL, 0x6aff2c1049329d71L, 0x6aff2c1049329d74L, "member"), elementNode), new DefaultChildSubstituteInfo(getNode(), elementNode, super.getLinkDeclaration(), getEditorContext())));
        }
      }
    }
  }
