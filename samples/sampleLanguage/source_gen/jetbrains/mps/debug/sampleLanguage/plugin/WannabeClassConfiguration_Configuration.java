...
public class WannabeClassConfiguration_Configuration extends BaseRunConfig {
  @Tag(value = "state")
  private WannabeClassConfiguration_Configuration.MyState myState = new WannabeClassConfiguration_Configuration.MyState();

  public WannabeClassConfiguration_Configuration(Project p, ConfigurationFactory f, String name) {
    super(p, f, name);
  }

  public RunConfiguration clone() {
    try {
      WannabeClassConfiguration_Configuration result = ((WannabeClassConfiguration_Configuration) super.clone());
      result.myState = ((WannabeClassConfiguration_Configuration.MyState) this.myState.clone());
      return result;
  ...
  public void checkConfiguration() throws RuntimeConfigurationException {
    ...
    try {
      String paramsReport = WannabeClassConfiguration_Configuration.this.getStateObject().myJavaRunParameters.getErrorReport();
      ...
      String errorReport;
      {
        Tuples._2<SNode, String> _tmp_h3rckn_e0a0b0b = WannabeClassConfiguration_Configuration.this.checkNode();
        node = _tmp_h3rckn_e0a0b0b._0();
        errorReport = _tmp_h3rckn_e0a0b0b._1();
      }
      if (node == null) {
      ...
      Logger.getLogger(WannabeClassConfiguration_Configuration.class).error(t_22042010);
    }
  ...
  public RunProfileState getState(@NotNull final Executor executor, @NotNull final ExecutionEnvironment environment) throws ExecutionException {
    return new JavaRunProfileState() {
      ...
      public ExecutionResult execute(Executor executor, @NotNull ProgramRunner runner) throws ExecutionException {
        ...
        // user's execute code 
        try {
          final ConfigRunParameters javaRunParameters = WannabeClassConfiguration_Configuration.this.getStateObject().myJavaRunParameters.copy();
          ...
          final SNode node = WannabeClassConfiguration_Configuration.this.getNodeForExecution(environment.getProject(), (javaRunParameters).getMake());
          {
            // calculate parameter 
          ...
          if (t instanceof ExecutionException) {
            ...
            Logger.getLogger(WannabeClassConfiguration_Configuration.class).error(t);
        ...
        return new WannabeClassConfiguration_Configuration.MyExecutionResult(handler_22042010, ListSequence.fromList(actions_22042010).toGenericArray(AnAction.class), new WannabeClassConfiguration_Configuration.MyExecutionConsole(consoleComponent_22042010, consoleDispose_22042010));
      }
  ...
  public SettingsEditor<? extends RunConfiguration> getConfigurationEditor() {
    return new WannabeClassConfiguration_Configuration.MySettingsEditor();
  }
  ...
  public WannabeClassConfiguration_Configuration.MyState getStateObject() {
    return this.myState;
  }
  ...
  public SNode getNode() {
    ...
    ModelAccess.instance().runReadAction(new Runnable() {
      public void run() {
        node.value = new SNodePointer(WannabeClassConfiguration_Configuration.this.getStateObject().modelId, WannabeClassConfiguration_Configuration.this.getStateObject().nodeId).getNode();
      }
    });
    return node.value;
  }
  ...
  public void setNode(final SNode node) {
    if (node == null) {
      WannabeClassConfiguration_Configuration.this.getStateObject().modelId = null;
      WannabeClassConfiguration_Configuration.this.getStateObject().nodeId = null;
      return;
    }
    ModelAccess.instance().runReadAction(new Runnable() {
      public void run() {
        WannabeClassConfiguration_Configuration.this.getStateObject().modelId = node.getModel().getModelDescriptor().getSModelReference().toString();
        WannabeClassConfiguration_Configuration.this.getStateObject().nodeId = node.getId();
      }
    });
  }
  ...
  private static class MySettingsEditor extends SettingsEditor<WannabeClassConfiguration_Configuration> {
    private WannabeClassConfiguration_Editor myComponent = null;

    public MySettingsEditor() {
    }

    protected void resetEditorFrom(WannabeClassConfiguration_Configuration c) {
      try {
    ...
    protected void applyEditorTo(WannabeClassConfiguration_Configuration c) {
      try {
    ...
    protected JComponent createEditor() {
      try {
        this.myComponent = new WannabeClassConfiguration_Editor();
  ...
  public static class MyState implements Cloneable {
    ...
    public Object clone() throws CloneNotSupportedException {
      WannabeClassConfiguration_Configuration.MyState object = (WannabeClassConfiguration_Configuration.MyState) super.clone();
