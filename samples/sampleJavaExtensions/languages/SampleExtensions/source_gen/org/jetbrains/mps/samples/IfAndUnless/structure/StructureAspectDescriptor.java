...
public class StructureAspectDescriptor extends BaseStructureAspectDescriptor {
  ...
  /*package*/ final ConceptDescriptor myConceptFlow = new ConceptDescriptorBuilder("org.jetbrains.mps.samples.IfAndUnless.structure.Flow", MetaIdFactory.conceptId(UUID.fromString("67b828fd-8fbc-4496-b7f7-8b64ac097c62"), 954830572075912399L)).super_("jetbrains.mps.baseLanguage.structure.StatementList").super_(MetaIdFactory.conceptId(UUID.fromString("f3061a53-9226-4cc5-a443-f952ceaf5816"), 1068580123136L)).parents("jetbrains.mps.baseLanguage.structure.StatementList").parentIds(MetaIdFactory.conceptId(UUID.fromString("f3061a53-9226-4cc5-a443-f952ceaf5816"), 1068580123136L)).abstract_().create();
  /*package*/ final ConceptDescriptor myConceptMyIfStatement = new ConceptDescriptorBuilder("org.jetbrains.mps.samples.IfAndUnless.structure.MyIfStatement", MetaIdFactory.conceptId(UUID.fromString("67b828fd-8fbc-4496-b7f7-8b64ac097c62"), 954830572075912394L)).super_("jetbrains.mps.baseLanguage.structure.Statement").super_(MetaIdFactory.conceptId(UUID.fromString("f3061a53-9226-4cc5-a443-f952ceaf5816"), 1068580123157L)).parents("jetbrains.mps.baseLanguage.structure.Statement").parentIds(MetaIdFactory.conceptId(UUID.fromString("f3061a53-9226-4cc5-a443-f952ceaf5816"), 1068580123157L)).childDescriptors(new ConceptDescriptorBuilder.Link(954830572075912397L, "condition", MetaIdFactory.conceptId(UUID.fromString("f3061a53-9226-4cc5-a443-f952ceaf5816"), 1068431790191L), false, false, false), new ConceptDescriptorBuilder.Link(954830572075912398L, "body", MetaIdFactory.conceptId(UUID.fromString("67b828fd-8fbc-4496-b7f7-8b64ac097c62"), 954830572075998495L), false, false, false), new ConceptDescriptorBuilder.Link(954830572075974221L, "alternative", MetaIdFactory.conceptId(UUID.fromString("67b828fd-8fbc-4496-b7f7-8b64ac097c62"), 954830572075998500L), false, false, false)).children(new String[]{"condition", "body", "alternative"}, new boolean[]{false, false, false}).alias("my_if", "").staticScope(StaticScope.NONE).create();
  ...
  /*package*/ final ConceptDescriptor myConceptUnlessStatement = new ConceptDescriptorBuilder("org.jetbrains.mps.samples.IfAndUnless.structure.UnlessStatement", MetaIdFactory.conceptId(UUID.fromString("67b828fd-8fbc-4496-b7f7-8b64ac097c62"), 393299394024627213L)).super_("jetbrains.mps.baseLanguage.structure.Statement").super_(MetaIdFactory.conceptId(UUID.fromString("f3061a53-9226-4cc5-a443-f952ceaf5816"), 1068580123157L)).parents("jetbrains.mps.baseLanguage.structure.Statement").parentIds(MetaIdFactory.conceptId(UUID.fromString("f3061a53-9226-4cc5-a443-f952ceaf5816"), 1068580123157L)).childDescriptors(new ConceptDescriptorBuilder.Link(393299394024627214L, "condition", MetaIdFactory.conceptId(UUID.fromString("f3061a53-9226-4cc5-a443-f952ceaf5816"), 1068431790191L), false, false, false), new ConceptDescriptorBuilder.Link(393299394024627228L, "body", MetaIdFactory.conceptId(UUID.fromString("f3061a53-9226-4cc5-a443-f952ceaf5816"), 1068580123136L), false, false, false)).children(new String[]{"condition", "body"}, new boolean[]{false, false}).alias("unless", "").staticScope(StaticScope.NONE).create();
