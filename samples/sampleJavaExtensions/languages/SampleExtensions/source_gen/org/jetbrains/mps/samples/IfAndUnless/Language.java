...
public class Language extends LanguageRuntime {
  ...
  public Language() {
    myId = SLanguageId.deserialize("67b828fd-8fbc-4496-b7f7-8b64ac097c62");
  }
  ...
  protected <T extends ILanguageAspect> T createAspect(Class<T> aspectClass) {
    ...
    if (aspectClass == StructureAspectDescriptor.class) {
      return aspectClass.cast(new org.jetbrains.mps.samples.IfAndUnless.structure.StructureAspectDescriptor());
    }
