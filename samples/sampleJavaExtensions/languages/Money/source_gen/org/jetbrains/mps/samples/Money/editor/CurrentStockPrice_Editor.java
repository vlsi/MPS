...
import org.jetbrains.mps.samples.Money.behavior.CurrentStockPrice_BehaviorDescriptor;
  ...
  private EditorCell createReadOnlyModelAccessor_w8qb9s_e0(final EditorContext editorContext, final SNode node) {
    EditorCell_Property editorCell = EditorCell_Property.create(editorContext, new ModelAccessor() {
      public String getText() {
        return CurrentStockPrice_BehaviorDescriptor.getCurrentPrice_id3u6SZi0yq4L.invoke(node).toString();
      }
