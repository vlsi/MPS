...
public class CurrencyUnit extends BaseConcept implements INamedConcept {
  public static final String concept = "org.jetbrains.mps.samples.Money.structure.CurrencyUnit";
  ...
  public static CurrencyUnit newInstance(SModel sm, boolean init) {
    return (CurrencyUnit) SModelUtil_new.instantiateConceptDeclaration("org.jetbrains.mps.samples.Money.structure.CurrencyUnit", sm, GlobalScope.getInstance(), init).getAdapter();
  }
