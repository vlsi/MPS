...
public class StructureAspectDescriptor extends BaseStructureAspectDescriptor {
  ...
  /*package*/ final ConceptDescriptor myConceptCurrentStockPrice = new ConceptDescriptorBuilder("org.jetbrains.mps.samples.Money.structure.CurrentStockPrice", MetaIdFactory.conceptId(0x662a9f2b58024d16L, 0x955872c65c7a681eL, 0x3786e3f4808999c3L)).super_("jetbrains.mps.baseLanguage.structure.Expression").version(1).super_(MetaIdFactory.conceptId(0xf3061a5392264cc5L, 0xa443f952ceaf5816L, 0xf8c37f506fL)).parents("jetbrains.mps.baseLanguage.structure.Expression").parentIds(MetaIdFactory.conceptId(0xf3061a5392264cc5L, 0xa443f952ceaf5816L, 0xf8c37f506fL)).childDescriptors(new ConceptDescriptorBuilder.Link(0x3786e3f480b0926aL, "symbol", MetaIdFactory.conceptId(0x662a9f2b58024d16L, 0x955872c65c7a681eL, 0x3786e3f480a9b18aL), false, false, false)).children(new String[]{"symbol"}, new boolean[]{false}).alias("current stock price", "").sourceNode(new SNodePointer("r:cd29712f-cf1b-4f19-90a2-4ce86af0d5f6(org.jetbrains.mps.samples.Money.structure)", "4001135958233291203")).create();
  ...
  /*package*/ final ConceptDescriptor myConceptMoneyLiteral = new ConceptDescriptorBuilder("org.jetbrains.mps.samples.Money.structure.MoneyLiteral", MetaIdFactory.conceptId(0x662a9f2b58024d16L, 0x955872c65c7a681eL, 0x4b9a2fe559135132L)).super_("jetbrains.mps.baseLanguage.structure.Expression").version(1).super_(MetaIdFactory.conceptId(0xf3061a5392264cc5L, 0xa443f952ceaf5816L, 0xf8c37f506fL)).parents("jetbrains.mps.baseLanguage.structure.Expression").parentIds(MetaIdFactory.conceptId(0xf3061a5392264cc5L, 0xa443f952ceaf5816L, 0xf8c37f506fL)).propertyDescriptors(new ConceptDescriptorBuilder.Prop(0x4b9a2fe559135183L, "amount")).properties("amount").referenceDescriptors(new ConceptDescriptorBuilder.Ref(0x3210b276d14435a8L, "unit", MetaIdFactory.conceptId(0x662a9f2b58024d16L, 0x955872c65c7a681eL, 0x3210b276d1443597L), false)).references("unit").alias("money", "").staticScope(StaticScope.NONE).sourceNode(new SNodePointer("r:cd29712f-cf1b-4f19-90a2-4ce86af0d5f6(org.jetbrains.mps.samples.Money.structure)", "5447719361346490674")).create();
  ...
  /*package*/ final ConceptDescriptor myConceptMovingAverage = new ConceptDescriptorBuilder("org.jetbrains.mps.samples.Money.structure.MovingAverage", MetaIdFactory.conceptId(0x662a9f2b58024d16L, 0x955872c65c7a681eL, 0x3786e3f480b1c19aL)).super_("jetbrains.mps.baseLanguage.structure.Expression").version(1).super_(MetaIdFactory.conceptId(0xf3061a5392264cc5L, 0xa443f952ceaf5816L, 0xf8c37f506fL)).parents("jetbrains.mps.baseLanguage.structure.Expression").parentIds(MetaIdFactory.conceptId(0xf3061a5392264cc5L, 0xa443f952ceaf5816L, 0xf8c37f506fL)).propertyDescriptors(new ConceptDescriptorBuilder.Prop(0x3786e3f480b1c19bL, "period")).properties("period").childDescriptors(new ConceptDescriptorBuilder.Link(0x3786e3f480b1c6d0L, "symbol", MetaIdFactory.conceptId(0x662a9f2b58024d16L, 0x955872c65c7a681eL, 0x3786e3f480a9b18aL), false, false, false)).children(new String[]{"symbol"}, new boolean[]{false}).alias("moving average", "").sourceNode(new SNodePointer("r:cd29712f-cf1b-4f19-90a2-4ce86af0d5f6(org.jetbrains.mps.samples.Money.structure)", "4001135958235922842")).create();
