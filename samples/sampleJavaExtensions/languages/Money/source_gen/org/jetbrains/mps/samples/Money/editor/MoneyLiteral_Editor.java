...
public class MoneyLiteral_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createCollection_84i1v2_a(EditorContext editorContext, SNode node) {
    ...
    editorCell.addEditorCell(this.createRefCell_84i1v2_b0(editorContext, node));
    return editorCell;
  }
  ...
  private EditorCell createRefCell_84i1v2_b0(EditorContext editorContext, SNode node) {
  ...
  public static class _Inline_84i1v2_a1a extends InlineCellProvider {
    ...
    public EditorCell createEditorCell(EditorContext editorContext, SNode node) {
      return this.createProperty_84i1v2_a0b0(editorContext, node);
    }
    private EditorCell createProperty_84i1v2_a0b0(EditorContext editorContext, SNode node) {
      CellProviderWithRole provider = new PropertyCellProvider(node, editorContext);
