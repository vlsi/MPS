...
/*package*/ class ThreadSafe_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  /*package*/ EditorCell createCell() {
    return createCollection_ly4xkq_a();
  }

  private EditorCell createCollection_ly4xkq_a() {
    EditorCell_Collection editorCell = EditorCell_Collection.createIndent2(getEditorContext(), myNode);
    editorCell.setCellId("Collection_ly4xkq_a");
    editorCell.setBig(true);
    editorCell.setCellContext(getCellFactory().getCellContext());
    editorCell.addEditorCell(createConstant_ly4xkq_a0());
    editorCell.addEditorCell(createAttributedNodeCell_ly4xkq_b0());
    return editorCell;
  }
  private EditorCell createConstant_ly4xkq_a0() {
