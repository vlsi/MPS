...
/*package*/ class ParallelFor_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createCollection_p0t1np_a() {
    ...
    if (renderingCondition_p0t1np_a6a(myNode, getEditorContext())) {
      editorCell.addEditorCell(createConstant_p0t1np_g0());
    }
    editorCell.addEditorCell(createRefNode_p0t1np_h0());
    if (renderingCondition_p0t1np_a8a(myNode, getEditorContext())) {
  ...
  private class loopVariableSingleRoleHandler_p0t1np_c0 extends SingleRoleCellProvider {
    ...
    private void installCellInfo(SNode child, EditorCell editorCell) {
      if (editorCell.getSubstituteInfo() == null || editorCell.getSubstituteInfo() instanceof DefaultSubstituteInfo) {
        editorCell.setSubstituteInfo(new OldNewCompositeSubstituteInfo(getEditorContext(), new SChildSubstituteInfo(editorCell, getNode(), MetaAdapterFactory.getContainmentLink(0xcb7388e8f1824cdaL, 0xbd839796e8634856L, 0x7bd8445d1e8770aaL, 0x7bd8445d1e8810c2L, "loopVariable"), child), new DefaultChildSubstituteInfo(getNode(), myContainmentLink.getDeclarationNode(), getEditorContext())));
      }
