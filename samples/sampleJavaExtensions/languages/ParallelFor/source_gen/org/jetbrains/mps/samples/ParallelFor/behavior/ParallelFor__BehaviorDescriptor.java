...
public final class ParallelFor__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<SNode> findPoolDeclaration_id6FH9fp$mItT = new SMethodBuilder<SNode>(new SJavaCompoundTypeImpl((Class<SNode>) ((Class) Object.class))).name("findPoolDeclaration").modifiers(SModifiersImpl.create(0, AccessPrivileges.PUBLIC)).concept(CONCEPT).id("6FH9fp$mItT").registry(REGISTRY).build(SParameterImpl.fromList(SJavaCompoundTypeImpl.fromClasses()));
  ...
  private static Scope getScope_id3fifI_xCJOQ(@NotNull SNode __thisNode__, SNode kind, SNode child) {
    if (SConceptOperations.isExactly(SNodeOperations.asSConcept(kind), MetaAdapterFactory.getConcept(0xf3061a5392264cc5L, 0xa443f952ceaf5816L, 0xf8c37a7f6eL, "jetbrains.mps.baseLanguage.structure.VariableDeclaration"))) {
      ...
      if (!(ScopeUtils.comeFrom("loopVariable", __thisNode__, child))) {
  ...
  private static SNode findPoolDeclaration_id6FH9fp$mItT(@NotNull SNode __thisNode__) {
  ...
  protected <T> T invokeSpecial0(@NotNull SNode node, @NotNull SMethod<T> method, @NotNull Object[] parameters) {
    ...
    switch (methodIndex) {
      ...
      case 7:
        return (T) findPoolDeclaration_id6FH9fp$mItT(node);
      default:
        throw new BHMethodNotFoundException(this, method);
    }
  }
