...
public class StructureAspectDescriptor extends BaseStructureAspectDescriptor {
  ...
  private static ConceptDescriptor createDescriptorForArithmeticSimpleMathExpression() {
    return new ConceptDescriptorBuilder("jetbrains.mps.samples.Expressions.structure.ArithmeticSimpleMathExpression", MetaIdFactory.conceptId(0x7e282943fc6b4900L, 0xada534c0024cc4f4L, 0x1cc69153b8289497L)).super_("jetbrains.mps.samples.Expressions.structure.BinarySimpleMathExpression").version(1).super_(MetaIdFactory.conceptId(0x7e282943fc6b4900L, 0xada534c0024cc4f4L, 0x1cc69153b81c52ccL)).parents("jetbrains.mps.samples.Expressions.structure.BinarySimpleMathExpression").parentIds(MetaIdFactory.conceptId(0x7e282943fc6b4900L, 0xada534c0024cc4f4L, 0x1cc69153b81c52ccL)).propertyDescriptors(new ConceptDescriptorBuilder.Prop(0x1cc69153b82894eaL, "operator")).properties("operator").staticScope(StaticScope.NONE).sourceNode(new SNodePointer("r:5607284d-edb3-4e34-bafc-a3b8fa3360be(jetbrains.mps.samples.Expressions.structure)", "2073504467208672407")).create();
  }
  ...
  private static ConceptDescriptor createDescriptorForSimpleMathWrapper() {
    return new ConceptDescriptorBuilder("jetbrains.mps.samples.Expressions.structure.SimpleMathWrapper", MetaIdFactory.conceptId(0x7e282943fc6b4900L, 0xada534c0024cc4f4L, 0x1cc69153b8237002L)).super_("jetbrains.mps.baseLanguage.structure.Statement").version(1).super_(MetaIdFactory.conceptId(0xf3061a5392264cc5L, 0xa443f952ceaf5816L, 0xf8cc56b215L)).parents("jetbrains.mps.baseLanguage.structure.Statement").parentIds(MetaIdFactory.conceptId(0xf3061a5392264cc5L, 0xa443f952ceaf5816L, 0xf8cc56b215L)).childDescriptors(new ConceptDescriptorBuilder.Link(0x1cc69153b8237177L, "expressions", MetaIdFactory.conceptId(0x7e282943fc6b4900L, 0xada534c0024cc4f4L, 0x1cc69153b81c4c0bL), true, true, false)).children(new String[]{"expressions"}, new boolean[]{true}).sourceNode(new SNodePointer("r:5607284d-edb3-4e34-bafc-a3b8fa3360be(jetbrains.mps.samples.Expressions.structure)", "2073504467208335362")).create();
  }
