...
public class StructureAspectDescriptor extends BaseStructureAspectDescriptor {
  ...
  /*package*/ final ConceptDescriptor myConceptArithmeticSimpleMathExpression = new ConceptDescriptorBuilder("jetbrains.mps.samples.Expressions.structure.ArithmeticSimpleMathExpression", MetaIdFactory.conceptId(0x7e282943fc6b4900L, 0xada534c0024cc4f4L, 0x1cc69153b8289497L)).super_("jetbrains.mps.samples.Expressions.structure.BinarySimpleMathExpression").super_(MetaIdFactory.conceptId(0x7e282943fc6b4900L, 0xada534c0024cc4f4L, 0x1cc69153b81c52ccL)).parents("jetbrains.mps.samples.Expressions.structure.BinarySimpleMathExpression").parentIds(MetaIdFactory.conceptId(0x7e282943fc6b4900L, 0xada534c0024cc4f4L, 0x1cc69153b81c52ccL)).propertyDescriptors(new ConceptDescriptorBuilder.Prop(0x1cc69153b82894eaL, "operator")).properties("operator").staticScope(StaticScope.NONE).create();
  ...
  /*package*/ final ConceptDescriptor myConceptSimpleMathVarReference = new ConceptDescriptorBuilder("jetbrains.mps.samples.Expressions.structure.SimpleMathVarReference", MetaIdFactory.conceptId(0x7e282943fc6b4900L, 0xada534c0024cc4f4L, 0x1cc69153b832e4e1L)).super_("jetbrains.mps.samples.Expressions.structure.SimpleMathExpression").super_(MetaIdFactory.conceptId(0x7e282943fc6b4900L, 0xada534c0024cc4f4L, 0x1cc69153b81c4c0bL)).parents("jetbrains.mps.samples.Expressions.structure.SimpleMathExpression").parentIds(MetaIdFactory.conceptId(0x7e282943fc6b4900L, 0xada534c0024cc4f4L, 0x1cc69153b81c4c0bL)).referenceDescriptors(new ConceptDescriptorBuilder.Ref(0x1cc69153b832e4e2L, "declaration", MetaIdFactory.conceptId(0x7e282943fc6b4900L, 0xada534c0024cc4f4L, 0x1cc69153b832ccbfL), false)).references("declaration").create();
  /*package*/ final ConceptDescriptor myConceptSimpleMathWrapper = new ConceptDescriptorBuilder("jetbrains.mps.samples.Expressions.structure.SimpleMathWrapper", MetaIdFactory.conceptId(0x7e282943fc6b4900L, 0xada534c0024cc4f4L, 0x1cc69153b8237002L)).super_("jetbrains.mps.baseLanguage.structure.Statement").super_(MetaIdFactory.conceptId(0xf3061a5392264cc5L, 0xa443f952ceaf5816L, 0xf8cc56b215L)).parents("jetbrains.mps.baseLanguage.structure.Statement").parentIds(MetaIdFactory.conceptId(0xf3061a5392264cc5L, 0xa443f952ceaf5816L, 0xf8cc56b215L)).childDescriptors(new ConceptDescriptorBuilder.Link(0x1cc69153b8237177L, "expressions", MetaIdFactory.conceptId(0x7e282943fc6b4900L, 0xada534c0024cc4f4L, 0x1cc69153b81c4c0bL), true, true, false)).children(new String[]{"expressions"}, new boolean[]{true}).create();
  /*package*/ final ConceptDescriptor myConceptUnarySimpleMathExpression = new ConceptDescriptorBuilder("jetbrains.mps.samples.Expressions.structure.UnarySimpleMathExpression", MetaIdFactory.conceptId(0x7e282943fc6b4900L, 0xada534c0024cc4f4L, 0x1cc69153b81d547bL)).super_("jetbrains.mps.samples.Expressions.structure.SimpleMathExpression").super_(MetaIdFactory.conceptId(0x7e282943fc6b4900L, 0xada534c0024cc4f4L, 0x1cc69153b81c4c0bL)).parents("jetbrains.mps.samples.Expressions.structure.SimpleMathExpression").parentIds(MetaIdFactory.conceptId(0x7e282943fc6b4900L, 0xada534c0024cc4f4L, 0x1cc69153b81c4c0bL)).childDescriptors(new ConceptDescriptorBuilder.Link(0x1cc69153b81d547cL, "original", MetaIdFactory.conceptId(0x7e282943fc6b4900L, 0xada534c0024cc4f4L, 0x1cc69153b81c4c0bL), false, false, false)).children(new String[]{"original"}, new boolean[]{false}).abstract_().create();
