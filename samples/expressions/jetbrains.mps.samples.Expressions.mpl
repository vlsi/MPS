...
<language namespace="jetbrains.mps.samples.Expressions" uuid="7e282943-fc6b-4900-ada5-34c0024cc4f4" generatorOutputPath="${module}/source_gen" version="0">
  <models>
  ...
  <accessoryModels />
  <generators>
    <generator name="" generatorUID="jetbrains.mps.samples.Expressions#2073504467207856858" uuid="eef058a7-de86-460b-ad59-5059d2eb4026">
      <models>
        <modelRoot contentPath="${module}" type="default">
