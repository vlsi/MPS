...
public class Transition extends BaseConcept {
  public static final String concept = "jetbrains.mps.samples.editorTables.structure.Transition";
  ...
  public static Transition newInstance(SModel sm, boolean init) {
    return (Transition) SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.samples.editorTables.structure.Transition", sm, GlobalScope.getInstance(), init).getAdapter();
  }
