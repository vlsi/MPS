...
public class State extends BaseConcept implements INamedConcept {
  public static final String concept = "jetbrains.mps.samples.editorTables.structure.State";
  ...
  public static State newInstance(SModel sm, boolean init) {
    return (State) SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.samples.editorTables.structure.State", sm, GlobalScope.getInstance(), init).getAdapter();
  }
