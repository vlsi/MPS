...
public class StateMachine extends BaseConcept implements INamedConcept {
  public static final String concept = "jetbrains.mps.samples.editorTables.structure.StateMachine";
  ...
  public static StateMachine newInstance(SModel sm, boolean init) {
    return (StateMachine) SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.samples.editorTables.structure.StateMachine", sm, GlobalScope.getInstance(), init).getAdapter();
  }
