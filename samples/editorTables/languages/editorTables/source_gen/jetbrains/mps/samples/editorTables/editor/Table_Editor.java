      ...
      public TableModel getTable(final SNode node, EditorContext editorContext) {
        return new AbstractTableModel() {
          ...
          public void insertRow(int row) {
            SNode rowNode = SConceptOperations.createNewNode("jetbrains.mps.samples.editorTables.structure.Row", null);
            for (int i = 0; i < ListSequence.fromList(SLinkOperations.getTargets(ListSequence.fromList(SLinkOperations.getTargets(node, "rows", true)).first(), "cells", true)).count(); i++) {
              ListSequence.fromList(SLinkOperations.getTargets(rowNode, "cells", true)).addElement(SConceptOperations.createNewNode("jetbrains.mps.samples.editorTables.structure.DataCell", null));
            }
