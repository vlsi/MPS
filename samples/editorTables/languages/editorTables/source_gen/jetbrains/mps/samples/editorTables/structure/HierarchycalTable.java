...
public class HierarchycalTable extends Table {
  public static final String concept = "jetbrains.mps.samples.editorTables.structure.HierarchycalTable";
  ...
  public static HierarchycalTable newInstance(SModel sm, boolean init) {
    return (HierarchycalTable) SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.samples.editorTables.structure.HierarchycalTable", sm, GlobalScope.getInstance(), init).getAdapter();
  }
