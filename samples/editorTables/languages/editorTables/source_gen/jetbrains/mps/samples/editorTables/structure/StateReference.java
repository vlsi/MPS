...
public class StateReference extends BaseConcept {
  public static final String concept = "jetbrains.mps.samples.editorTables.structure.StateReference";
  ...
  public static StateReference newInstance(SModel sm, boolean init) {
    return (StateReference) SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.samples.editorTables.structure.StateReference", sm, GlobalScope.getInstance(), init).getAdapter();
  }
