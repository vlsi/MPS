package jetbrains.mps.samples.editorTables.behavior;
...
public class StateMachine_Behavior {
  public static void init(SNode thisNode) {
    ...
    for (int i = 0; i < count; i++) {
      SNode event = SConceptOperations.createNewNode("jetbrains.mps.samples.editorTables.structure.Event", null);
    ...
    for (int i = 0; i < count; i++) {
      SNode state = SConceptOperations.createNewNode("jetbrains.mps.samples.editorTables.structure.State", null);
    ...
    for (int i = 0; i < count; i++) {
      ...
      SLinkOperations.setTarget(transition, "toState", SConceptOperations.createNewNode("jetbrains.mps.samples.editorTables.structure.StateReference", null), true);
