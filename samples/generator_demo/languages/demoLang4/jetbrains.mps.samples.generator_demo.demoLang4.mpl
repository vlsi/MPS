...
<language namespace="jetbrains.mps.samples.generator_demo.demoLang4" uuid="1409a436-ea24-4d03-a196-53795139ce8d">
  ...
  <accessoryModels />
  <generators>
    <generator name="swing" generatorUID="jetbrains.mps.samples.generator_demo.demoLang4#1228678587345" uuid="fba3f122-376d-47a5-9857-db3c00612598" needs-opctx="false">
      <models>
        <modelRoot contentPath="${module}" type="default">
