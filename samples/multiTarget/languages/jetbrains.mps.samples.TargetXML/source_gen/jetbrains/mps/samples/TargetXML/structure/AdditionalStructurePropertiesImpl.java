...
public class AdditionalStructurePropertiesImpl extends BaseAdditionalStructureProperties {
  private final AdditionalConceptProperties props_IncludeXMLTarget = new ConceptPropsBuilder().create();
  ...
  private static final Map<SAbstractConcept, Integer> indices_4qogsf_a0c = buildConceptIndices(MetaAdapterFactory.getConcept(0x804719785b5c4b34L, 0xa272816c5dc96e2aL, 0x6e7027ecccdf1fdbL, "IncludeXMLTarget"));
}
