...
/*package*/ class MinusOperation_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public MinusOperation_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private static class leftOperandSingleRoleHandler_3kvffu_a0 extends SingleRoleCellProvider {
    @NotNull
    private SNode myNode;

    public leftOperandSingleRoleHandler_3kvffu_a0(SNode ownerNode, SContainmentLink containmentLink, EditorContext context) {
  ...
  private EditorCell createConstant_3kvffu_b0() {
    ...
    editorCell.setSubstituteInfo(new CompositeSubstituteInfo(getEditorContext(), new BasicCellContext(myNode), new SubstituteInfoPartExt[]{new MinusOperation_EditorBuilder_a.ReplaceWith_Operation_cellMenu_3kvffu_a0b0(), new SChildSubstituteInfoPartEx(editorCell)}));
    return editorCell;
  }
  public static class ReplaceWith_Operation_cellMenu_3kvffu_a0b0 extends AbstractCellMenuPart_ReplaceNode_CustomNodeConcept {
    public ReplaceWith_Operation_cellMenu_3kvffu_a0b0() {
    }
  ...
  private static class rightOperandSingleRoleHandler_3kvffu_c0 extends SingleRoleCellProvider {
    @NotNull
    private SNode myNode;

    public rightOperandSingleRoleHandler_3kvffu_c0(SNode ownerNode, SContainmentLink containmentLink, EditorContext context) {
      super(containmentLink, context);
      myNode = ownerNode;
    }
