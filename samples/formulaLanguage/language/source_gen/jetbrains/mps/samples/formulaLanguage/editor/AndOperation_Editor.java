...
public class AndOperation_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createConstant_1vjwda_b0(EditorContext editorContext, SNode node) {
    ...
    editorCell.setSubstituteInfo(new CompositeSubstituteInfo(editorContext, new BasicCellContext(node), new SubstituteInfoPart[]{new AndOperation_Editor.AndOperation_Editor_replaceWith_Operation_cellMenu_a0b0()}));
    return editorCell;
  }
  ...
  public static class AndOperation_Editor_replaceWith_Operation_cellMenu_a0b0 extends AbstractCellMenuPart_ReplaceNode_CustomNodeConcept {
    public AndOperation_Editor_replaceWith_Operation_cellMenu_a0b0() {
    }
