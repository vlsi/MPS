...
public class AndOperation_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createConstant_1vjwda_b0(EditorContext editorContext, SNode node) {
    ...
    editorCell.setSubstituteInfo(new CompositeSubstituteInfo(editorContext, new BasicCellContext(node), new SubstituteInfoPartExt[]{new AndOperation_Editor.ReplaceWith_Operation_cellMenu_a0b0_5()}));
    return editorCell;
  }
