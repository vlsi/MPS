...
public class GreaterThanOperation_Editor extends DefaultNodeEditor {
  ...
  public static class ReplaceWith_Operation_cellMenu_a0b0_4 extends AbstractCellMenuPart_ReplaceNode_CustomNodeConcept {
    public ReplaceWith_Operation_cellMenu_a0b0_4() {
    }
  ...
  private EditorCell createConstant_7s0zrk_b0(EditorContext editorContext, SNode node) {
    ...
    editorCell.setSubstituteInfo(new CompositeSubstituteInfo(editorContext, new BasicCellContext(node), new SubstituteInfoPartExt[]{new GreaterThanOperation_Editor.ReplaceWith_Operation_cellMenu_a0b0_4()}));
    return editorCell;
  }
