...
public class StructureAspectDescriptor extends DescriptorProvider<StructureDescriptor> {
  ...
  public StructureDescriptor getDescriptor(String conceptFqName) {
    switch ((conceptFqName).hashCode()) {
      ...
      case -2104864100:
        return new StructureAspectDescriptor.DataBasedStructureDescriptor("jetbrains.mps.samples.formulaLanguage.structure.IntegerConstant", new String[]{"jetbrains.mps.samples.formulaLanguage.structure.Constant"}, new String[]{"jetbrains.mps.samples.formulaLanguage.structure.Expression", "jetbrains.mps.samples.formulaLanguage.structure.Constant"}, new String[]{"jetbrains.mps.lang.core.structure.BaseConcept"});
      case -1065354488:
        return new StructureAspectDescriptor.DataBasedStructureDescriptor("jetbrains.mps.samples.formulaLanguage.structure.FloatingPointConstant", new String[]{"jetbrains.mps.samples.formulaLanguage.structure.Constant"}, new String[]{"jetbrains.mps.samples.formulaLanguage.structure.Expression", "jetbrains.mps.samples.formulaLanguage.structure.Constant"}, new String[]{"jetbrains.mps.lang.core.structure.BaseConcept"});
      case 1724184635:
      ...
      case -275643397:
        return new StructureAspectDescriptor.DataBasedStructureDescriptor("jetbrains.mps.samples.formulaLanguage.structure.StringConstant", new String[]{"jetbrains.mps.samples.formulaLanguage.structure.Constant"}, new String[]{"jetbrains.mps.samples.formulaLanguage.structure.Expression", "jetbrains.mps.samples.formulaLanguage.structure.Constant"}, new String[]{"jetbrains.mps.lang.core.structure.BaseConcept"});
      case 120171510:
