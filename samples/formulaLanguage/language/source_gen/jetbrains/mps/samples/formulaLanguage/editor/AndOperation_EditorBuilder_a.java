...
/*package*/ class AndOperation_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  /*package*/ EditorCell createCell() {
    return createCollection_1vjwda_a();
  }

  private EditorCell createCollection_1vjwda_a() {
    EditorCell_Collection editorCell = new EditorCell_Collection(getEditorContext(), myNode, new CellLayout_Horizontal());
    editorCell.setCellId("Collection_1vjwda_a");
    editorCell.setBig(true);
    editorCell.setCellContext(getCellFactory().getCellContext());
    editorCell.addEditorCell(createRefNode_1vjwda_a0());
    editorCell.addEditorCell(createConstant_1vjwda_b0());
    editorCell.addEditorCell(createRefNode_1vjwda_c0());
    return editorCell;
  }
  private EditorCell createRefNode_1vjwda_a0() {
  ...
  private EditorCell createConstant_1vjwda_b0() {
  ...
  private EditorCell createRefNode_1vjwda_c0() {
