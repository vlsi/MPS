...
public class OrOperation_Editor extends DefaultNodeEditor {
  ...
  private class leftOperandSingleRoleHandler_fnt2o4_a0 extends SingleRoleCellProvider {
    ...
    public void installCellInfo(SNode node, EditorCell editorCell) {
      if (node != null) {
        Operation_leftOperand_Actions.setCellActions(editorCell, node, myEditorContext);
      }
  ...
  private class rightOperandSingleRoleHandler_fnt2o4_c0 extends SingleRoleCellProvider {
    ...
    public void installCellInfo(SNode node, EditorCell editorCell) {
      if (node != null) {
        Operation_rightOperand_Actions.setCellActions(editorCell, node, myEditorContext);
      }
      editorCell.setSubstituteInfo(new DefaultChildSubstituteInfo(myOwnerNode, myContainmentLink.getDeclarationNode(), myEditorContext));
      if (editorCell.getRole() == null) {
