...
public class OrOperation_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createRefNode_fnt2o4_a0(EditorContext editorContext, SNode node) {
    SingleRoleCellProvider provider = new OrOperation_Editor.leftOperandSingleRoleHandler_fnt2o4_a0(node, MetaAdapterFactory.getContainmentLink(0xb1a9bc478a264792L, 0x8b684660c531090aL, 0x102db8620dbL, 0x102db86e5b3L, "leftOperand"), editorContext);
    return provider.createCell();
  }
  private class leftOperandSingleRoleHandler_fnt2o4_a0 extends SingleRoleCellProvider {
    public leftOperandSingleRoleHandler_fnt2o4_a0(SNode ownerNode, SContainmentLink containmentLink, EditorContext context) {
    ...
    protected EditorCell createEmptyCell() {
      ...
      editorCell.setTransformationMenuLookup(new DefaultEmptyCellSubstituteMenuLookup(MetaAdapterFactory.getContainmentLink(0xb1a9bc478a264792L, 0x8b684660c531090aL, 0x102db8620dbL, 0x102db86e5b3L, "leftOperand")));
  ...
  private EditorCell createConstant_fnt2o4_b0(EditorContext editorContext, SNode node) {
    ...
    editorCell.setSubstituteInfo(new CompositeSubstituteInfo(editorContext, new BasicCellContext(node), new SubstituteInfoPartExt[]{new OrOperation_Editor.ReplaceWith_Operation_cellMenu_fnt2o4_a0b0(), new SChildSubstituteInfoPartEx(editorCell)}));
    return editorCell;
  }
  ...
  private EditorCell createRefNode_fnt2o4_c0(EditorContext editorContext, SNode node) {
    SingleRoleCellProvider provider = new OrOperation_Editor.rightOperandSingleRoleHandler_fnt2o4_c0(node, MetaAdapterFactory.getContainmentLink(0xb1a9bc478a264792L, 0x8b684660c531090aL, 0x102db8620dbL, 0x102db87696bL, "rightOperand"), editorContext);
    return provider.createCell();
  }
  private class rightOperandSingleRoleHandler_fnt2o4_c0 extends SingleRoleCellProvider {
    public rightOperandSingleRoleHandler_fnt2o4_c0(SNode ownerNode, SContainmentLink containmentLink, EditorContext context) {
      super(ownerNode, containmentLink, context);
    }
    protected EditorCell createChildCell(SNode child) {
      EditorCell editorCell = super.createChildCell(child);
    ...
    protected EditorCell createEmptyCell() {
      ...
      installCellInfo(null, editorCell);
      editorCell.setTransformationMenuLookup(new DefaultEmptyCellSubstituteMenuLookup(MetaAdapterFactory.getContainmentLink(0xb1a9bc478a264792L, 0x8b684660c531090aL, 0x102db8620dbL, 0x102db87696bL, "rightOperand")));
