...
<language namespace="jetbrains.mps.samples.formulaLanguage" uuid="b1a9bc47-8a26-4792-8b68-4660c531090a" generatorOutputPath="${module}/source_gen" languageVersion="0" moduleVersion="0">
  <models>
  ...
  <accessoryModels />
  <generators>
    <generator name="" generatorUID="jetbrains.mps.formulaLanguage#1130266266255" uuid="9e79e6dc-3005-4fdf-901d-d1d70047ef7b">
      <models>
        <modelRoot contentPath="${module}" type="default">
