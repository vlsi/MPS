...
public class MinusOperation_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createCollection_4389_0(EditorContext context, SNode node) {
    EditorCell_Collection editorCell = EditorCell_Collection.createHorizontal(context, node);
    editorCell.setCellId("Collection_4389_0");
    editorCell.addEditorCell(this.createRefNode_4389_0(context, node));
  ...
  private EditorCell createConstant_4389_0(EditorContext context, SNode node, String text) {
  ...
  private EditorCell createRefNode_4389_0(EditorContext context, SNode node) {
  ...
  private EditorCell createRefNode_4389_1(EditorContext context, SNode node) {
    CellProviderWithRole provider = new RefNodeCellProvider(node, context);
