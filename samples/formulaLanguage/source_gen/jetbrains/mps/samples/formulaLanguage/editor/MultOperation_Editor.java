...
public class MultOperation_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createCollection_0165_0(EditorContext context, SNode node) {
    EditorCell_Collection editorCell = EditorCell_Collection.createHorizontal(context, node);
    editorCell.setCellId("Collection_0165_0");
    editorCell.addEditorCell(this.createRefNode_0165_0(context, node));
  ...
  private EditorCell createConstant_0165_0(EditorContext context, SNode node, String text) {
  ...
  private EditorCell createRefNode_0165_0(EditorContext context, SNode node) {
  ...
  private EditorCell createRefNode_0165_1(EditorContext context, SNode node) {
    CellProviderWithRole provider = new RefNodeCellProvider(node, context);
