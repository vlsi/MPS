...
public class OrOperation_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createCollection_0584_0(EditorContext context, SNode node) {
    EditorCell_Collection editorCell = EditorCell_Collection.createHorizontal(context, node);
    editorCell.setCellId("Collection_0584_0");
    editorCell.addEditorCell(this.createRefNode_0584_0(context, node));
  ...
  private EditorCell createConstant_0584_0(EditorContext context, SNode node, String text) {
  ...
  private EditorCell createRefNode_0584_0(EditorContext context, SNode node) {
  ...
  private EditorCell createRefNode_0584_1(EditorContext context, SNode node) {
    CellProviderWithRole provider = new RefNodeCellProvider(node, context);
