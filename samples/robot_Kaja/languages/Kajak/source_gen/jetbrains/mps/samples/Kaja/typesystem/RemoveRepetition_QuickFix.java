...
public class RemoveRepetition_QuickFix extends QuickFix_Runtime {
  ...
  public void execute(SNode node) {
    ...
    SLinkOperations.setTarget(repeat, MetaAdapterFactory.getContainmentLink(new UUID(331587165301851084l, -4784639992745830411l), 3308300503039660364l, 3308300503039660367l, "body"), SConceptOperations.createNewNode(MetaAdapterFactory.getConcept(new UUID(331587165301851084l, -4784639992745830411l), 3308300503039896127l, "jetbrains.mps.samples.Kaja.structure.CommandList")));
