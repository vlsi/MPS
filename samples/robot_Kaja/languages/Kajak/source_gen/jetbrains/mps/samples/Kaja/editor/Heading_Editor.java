...
public class Heading_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createCollection_i9varp_a(EditorContext editorContext, SNode node) {
    ...
    editorCell.addEditorCell(this.createConceptProperty_i9varp_a0(editorContext, node));
  ...
  private EditorCell createConceptProperty_i9varp_a0(EditorContext editorContext, SNode node) {
