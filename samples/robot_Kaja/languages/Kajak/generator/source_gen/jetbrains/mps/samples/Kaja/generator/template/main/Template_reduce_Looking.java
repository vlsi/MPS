...
public class Template_reduce_Looking extends TemplateDeclarationBase {
  ...
  protected SNode applyPart0(@NotNull final TemplateContext context) throws GenerationException {
    ...
    try {
      ...
      environment.resolveInTemplateLater(tnode1, MetaAdapterFactory.getReferenceLink(0xf3061a5392264cc5L, 0xa443f952ceaf5816L, 0x11857355952L, 0xf8c78301adL, "baseMethodDeclaration"), templateNode_yqxv9z_c0a1a2a2, "tpl/r:3ab3501c-2f4b-48e6-9b6c-e31ff8ef3185/7060824959893184061", "heading", context);
      TemplateContext context1 = context.subContext();
      {
        Collection<SNode> tlist2 = null;
        {
          final SNode switchInput2 = QueriesGenerated.sourceNodeQuery_7060824959896242619(new SourceSubstituteMacroNodeContext(context1, switchMacroRef_yqxv9z_b0a0a0a1a3a2a2));
          if (switchInput2 == null) {
            ...
            tlist2 = environment.trySwitch(templateSwitchNode_yqxv9z_a0a0c0a1a1a3a2a2, switchContext2);
            if (tlist2 == null) {
  ...
  private static SNodePointer templateNode_yqxv9z_c0a1a2a2 = new SNodePointer("r:3ab3501c-2f4b-48e6-9b6c-e31ff8ef3185(jetbrains.mps.samples.Kaja.generator.template.main@generator)", "4923130412073306264");
  private static SNodePointer switchMacroRef_yqxv9z_b0a0a0a1a3a2a2 = new SNodePointer("r:3ab3501c-2f4b-48e6-9b6c-e31ff8ef3185(jetbrains.mps.samples.Kaja.generator.template.main@generator)", "2238065674976419305");
  private static SNodePointer templateSwitchNode_yqxv9z_a0a0c0a1a1a3a2a2 = new SNodePointer("r:3ab3501c-2f4b-48e6-9b6c-e31ff8ef3185(jetbrains.mps.samples.Kaja.generator.template.main@generator)", "7060824959896164452");
}
