...
public class StructureAspectDescriptor extends BaseStructureAspectDescriptor {
  ...
  /*package*/ final ConceptDescriptor myConceptLogicalOperator = new ConceptDescriptorBuilder("jetbrains.mps.samples.KajaAndOr.structure.LogicalOperator", MetaIdFactory.conceptId(UUID.fromString("44306fd2-ef94-4b56-9806-d9ab509536db"), 1904811872814253785L)).super_("jetbrains.mps.samples.Kaja.structure.LogicalExpression").super_(MetaIdFactory.conceptId(UUID.fromString("049a08c5-1fe5-43cc-bd99-8b46d641d7f5"), 3308300503039647681L)).parents("jetbrains.mps.samples.Kaja.structure.LogicalExpression", "jetbrains.mps.lang.core.structure.IDontSubstituteByDefault").parentIds(MetaIdFactory.conceptId(UUID.fromString("049a08c5-1fe5-43cc-bd99-8b46d641d7f5"), 3308300503039647681L), MetaIdFactory.conceptId(UUID.fromString("ceab5195-25ea-4f22-9b92-103b95ca8c0c"), 1835621062190663819L)).childDescriptors(new ConceptDescriptorBuilder.Link(1904811872814253580L, "left", MetaIdFactory.conceptId(UUID.fromString("049a08c5-1fe5-43cc-bd99-8b46d641d7f5"), 3308300503039647681L), false, false, false), new ConceptDescriptorBuilder.Link(1904811872814253581L, "right", MetaIdFactory.conceptId(UUID.fromString("049a08c5-1fe5-43cc-bd99-8b46d641d7f5"), 3308300503039647681L), false, false, false)).children(new String[]{"left", "right"}, new boolean[]{false, false}).abstract_().create();
