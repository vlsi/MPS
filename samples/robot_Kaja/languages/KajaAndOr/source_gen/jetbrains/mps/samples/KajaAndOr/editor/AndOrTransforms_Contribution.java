...
public class AndOrTransforms_Contribution extends TransformationMenuBase {
  ...
  protected List<MenuPart<TransformationMenuItem, TransformationMenuContext>> getParts(TransformationMenuContext _context) {
    ...
    if (ListSequence.fromListAndArray(new ArrayList<String>(), MenuLocations.RIGHT_SIDE_TRANSFORM).contains(_context.getMenuLocation())) {
      result.add(new ConstraintsFilteringTransformationMenuPartDecorator(new AndOrTransforms_Contribution.TransformationMenuPart_Parameterized_ry9dqf_a0(), MetaAdapterFactory.getConcept(0x49a08c51fe543ccL, 0xbd998b46d641d7f5L, 0x2de971c785ec9fc1L, "jetbrains.mps.samples.Kaja.structure.LogicalExpression")));
    }
    return result;
  }

  private class TransformationMenuPart_Parameterized_ry9dqf_a0 extends ParameterizedMenuPart<SConcept, TransformationMenuItem, TransformationMenuContext> {

    @NotNull
    @Override
    protected List<TransformationMenuItem> createItems(SConcept parameter, TransformationMenuContext context) {
      return new AndOrTransforms_Contribution.TransformationMenuPart_Parameterized_ry9dqf_a0.TransformationMenuPart_Action_ry9dqf_a0a(parameter).createItems(context);
    }
    ...
    private class TransformationMenuPart_Action_ry9dqf_a0a extends SingleItemMenuPart<TransformationMenuItem, TransformationMenuContext> {
      private final SConcept myParameterObject;
      public TransformationMenuPart_Action_ry9dqf_a0a(SConcept parameterObject) {
        myParameterObject = parameterObject;
      }
      @Nullable
      protected TransformationMenuItem createItem(TransformationMenuContext context) {
        return new AndOrTransforms_Contribution.TransformationMenuPart_Parameterized_ry9dqf_a0.TransformationMenuPart_Action_ry9dqf_a0a.Item(context);
      }
