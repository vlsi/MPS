...
<language namespace="jetbrains.mps.samples.KajaSceneConstruction" uuid="b56912a3-674f-4530-b0cf-55261b526a1f" version="0">
  <models>
  ...
  <accessoryModels />
  <generators>
    <generator name="" generatorUID="jetbrains.mps.samples.KajaSceneConstruction#3210697320273563026" uuid="b4e19835-6919-44a5-8b70-73791426c235" generate-templates="true">
      <models>
        <modelRoot contentPath="${module}" type="default">
  ...
  <languageVersions>
    ...
    <language id="b56912a3-674f-4530-b0cf-55261b526a1f" fqName="jetbrains.mps.samples.KajaSceneConstruction" version="-1" />
  </languageVersions>
  <extendedLanguages>
