...
public class DestroyWall_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createCollection_d48ed0_a(EditorContext editorContext, SNode node) {
    ...
    editorCell.addEditorCell(this.createConceptProperty_d48ed0_a0(editorContext, node));
  ...
  private EditorCell createConceptProperty_d48ed0_a0(EditorContext editorContext, SNode node) {
