...
public class StructureAspectDeclaration_Editor extends DefaultNodeEditor {
  public EditorCell createEditorCell(EditorContext editorContext, SNode node) {
    return this.createCollection_vq6uem_a(editorContext, node);
  }
  private EditorCell createCollection_vq6uem_a(EditorContext editorContext, SNode node) {
  ...
  private EditorCell createConstant_vq6uem_a0(EditorContext editorContext, SNode node) {
    EditorCell_Constant editorCell = new EditorCell_Constant(editorContext, node, "language concepts");
  ...
  private static class conceptsListHandler_vq6uem_b1a extends RefNodeListHandler {
    ...
    public EditorCell createEmptyCell(EditorContext editorContext) {
      ...
      editorContext.getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(conceptsListHandler_vq6uem_b1a.this.getOwner(), MetaAdapterFactory.getContainmentLink(0xbaa9238b36da4ccbL, 0xa76b8ad70e222183L, 0x346ead2c08cc7fc8L, 0x346ead2c08cc7fd5L, "concepts")));
      try {
