...
public class StructureAspectDescriptor extends BaseStructureAspectDescriptor {
  ...
  /*package*/ final ConceptDescriptor myConceptEditorAspectDeclaration = new ConceptDescriptorBuilder("jetbrains.mps.samples.highlevel.simpleEditor.structure.EditorAspectDeclaration", MetaIdFactory.conceptId(0xc457c5de60274104L, 0xab9ca31c5404ae8bL, 0x346ead2c08cc7fbbL)).super_("jetbrains.mps.lang.core.structure.BaseConcept").version(1).super_(MetaIdFactory.conceptId(0xceab519525ea4f22L, 0x9b92103b95ca8c0cL, 0x10802efe25aL)).parents("jetbrains.mps.lang.core.structure.BaseConcept").parentIds(MetaIdFactory.conceptId(0xceab519525ea4f22L, 0x9b92103b95ca8c0cL, 0x10802efe25aL)).childDescriptors(new ConceptDescriptorBuilder.Link(0x346ead2c08ccf70cL, "editors", MetaIdFactory.conceptId(0xc457c5de60274104L, 0xab9ca31c5404ae8bL, 0x346ead2c08ccf6ffL), true, true, false)).children(new String[]{"editors"}, new boolean[]{true}).rootable().sourceNode(new SNodePointer("r:64c71df5-2adc-4e3d-8424-aa08c0bc782f(jetbrains.mps.samples.highlevel.simpleEditor.structure)", "3778147542048210875")).create();
  /*package*/ final ConceptDescriptor myConceptSimpleEditorDeclaration = new ConceptDescriptorBuilder("jetbrains.mps.samples.highlevel.simpleEditor.structure.SimpleEditorDeclaration", MetaIdFactory.conceptId(0xc457c5de60274104L, 0xab9ca31c5404ae8bL, 0x346ead2c08ccf6ffL)).super_("jetbrains.mps.lang.core.structure.BaseConcept").version(1).super_(MetaIdFactory.conceptId(0xceab519525ea4f22L, 0x9b92103b95ca8c0cL, 0x10802efe25aL)).parents("jetbrains.mps.lang.core.structure.BaseConcept").parentIds(MetaIdFactory.conceptId(0xceab519525ea4f22L, 0x9b92103b95ca8c0cL, 0x10802efe25aL)).propertyDescriptors(new ConceptDescriptorBuilder.Prop(0x346ead2c08ccfa54L, "caption")).properties("caption").referenceDescriptors(new ConceptDescriptorBuilder.Ref(0x346ead2c08ccf9f3L, "cncpt", MetaIdFactory.conceptId(0xbaa9238b36da4ccbL, 0xa76b8ad70e222183L, 0x460f3ddb176b0a3cL), false)).references("cncpt").childDescriptors(new ConceptDescriptorBuilder.Link(0x346ead2c08ccfa0dL, "visibleProperties", MetaIdFactory.conceptId(0xc457c5de60274104L, 0xab9ca31c5404ae8bL, 0x346ead2c08ccfa10L), true, true, false)).children(new String[]{"visibleProperties"}, new boolean[]{true}).sourceNode(new SNodePointer("r:64c71df5-2adc-4e3d-8424-aa08c0bc782f(jetbrains.mps.samples.highlevel.simpleEditor.structure)", "3778147542048241407")).create();
  /*package*/ final ConceptDescriptor myConceptSimplePropertyReference = new ConceptDescriptorBuilder("jetbrains.mps.samples.highlevel.simpleEditor.structure.SimplePropertyReference", MetaIdFactory.conceptId(0xc457c5de60274104L, 0xab9ca31c5404ae8bL, 0x346ead2c08ccfa10L)).super_("jetbrains.mps.lang.core.structure.BaseConcept").version(1).super_(MetaIdFactory.conceptId(0xceab519525ea4f22L, 0x9b92103b95ca8c0cL, 0x10802efe25aL)).parents("jetbrains.mps.lang.core.structure.BaseConcept").parentIds(MetaIdFactory.conceptId(0xceab519525ea4f22L, 0x9b92103b95ca8c0cL, 0x10802efe25aL)).referenceDescriptors(new ConceptDescriptorBuilder.Ref(0x346ead2c08ccfa1fL, "prop", MetaIdFactory.conceptId(0xbaa9238b36da4ccbL, 0xa76b8ad70e222183L, 0x346ead2c08cc7faeL), false)).references("prop").sourceNode(new SNodePointer("r:64c71df5-2adc-4e3d-8424-aa08c0bc782f(jetbrains.mps.samples.highlevel.simpleEditor.structure)", "3778147542048242192")).create();
