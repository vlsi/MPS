...
public class LegacyRunConfigurationsProvider_CustomApplicationPlugin extends BaseCustomApplicationPlugin {
  ...
  public void doInit() {
    ...
    {
      LambdaCalculus_ConfigurationType configurationKind = new LambdaCalculus_ConfigurationType();
    ...
    {
      DefaultLambdaCalculusFromProgram configurationCreator = new DefaultLambdaCalculusFromProgram();
