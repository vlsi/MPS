...
public class DefaultLambdaCalculusProgram_Configuration extends BaseRunConfig {
  private static final Logger LOG = Logger.getLogger(DefaultLambdaCalculusProgram_Configuration.class);
    ...
    return new BaseRunProfileState() {
      ...
      public ExecutionResult execute(Executor executor, @NotNull ProgramRunner runner) throws ExecutionException {
        ...
        try {
          ...
          DefaultLambdaCalculusProgram_Configuration.LOG.error(t);
