...
public class typeof_BinaryStringOperation_InferenceRule extends AbstractInferenceRule_Runtime implements InferenceRule_Runtime {
  ...
  public static class QuotationClass_wf0uj2_a0a0a0 {
    ...
    public SNode createNode(final TypeCheckingContext typeCheckingContext) {
      ...
      SNode quotedNode_wf0uj2_a0a0a0 = null;
      {
        quotedNode_wf0uj2_a0a0a0 = SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.samples.lambdaCalculus.structure.StringType", TypeChecker.getInstance().getRuntimeTypesModel(), GlobalScope.getInstance(), false);
        SNode quotedNode1_wf0uj2_a0a0a0 = quotedNode_wf0uj2_a0a0a0;
        result = quotedNode1_wf0uj2_a0a0a0;
      }
      return result;
    }
