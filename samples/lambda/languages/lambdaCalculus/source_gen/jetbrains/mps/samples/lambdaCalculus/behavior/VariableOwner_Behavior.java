...
public class VariableOwner_Behavior {
  ...
  public static List<SNode> call_getOuterVariables_5249919352014727828(SNode thisNode) {
    ...
    for (SNode ref : allRef) {
      if (!(Sequence.fromIterable(allVar).contains(SLinkOperations.getTarget(ref, "variable", false))) && !(Sequence.fromIterable(result).contains(SLinkOperations.getTarget(ref, "variable", false)))) {
