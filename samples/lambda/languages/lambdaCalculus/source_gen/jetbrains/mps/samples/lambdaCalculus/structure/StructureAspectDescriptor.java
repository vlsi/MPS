...
public class StructureAspectDescriptor extends DescriptorProvider<StructureDescriptor> {
  ...
  public StructureDescriptor getDescriptor(String conceptFqName) {
    switch ((conceptFqName).hashCode()) {
      ...
      case 598926277:
        return new StructureAspectDescriptor.DataBasedStructureDescriptor("jetbrains.mps.samples.lambdaCalculus.structure.AbstractionVariable", new String[]{"jetbrains.mps.samples.lambdaCalculus.structure.Variable", "jetbrains.mps.lang.core.structure.INamedConcept"}, new String[]{"jetbrains.mps.samples.lambdaCalculus.structure.Variable", "jetbrains.mps.samples.lambdaCalculus.structure.LambdaExpression"}, new String[]{"jetbrains.mps.lang.core.structure.BaseConcept", "jetbrains.mps.lang.core.structure.INamedConcept"});
      case -1527043470:
      ...
      case -1496603787:
        return new StructureAspectDescriptor.DataBasedStructureDescriptor("jetbrains.mps.samples.lambdaCalculus.structure.AbstractionVarRef", new String[]{"jetbrains.mps.samples.lambdaCalculus.structure.VariableReference"}, new String[]{"jetbrains.mps.samples.lambdaCalculus.structure.VariableReference", "jetbrains.mps.samples.lambdaCalculus.structure.LambdaExpression"}, new String[]{"jetbrains.mps.lang.core.structure.BaseConcept"});
      case 1404709481:
      ...
      case 1507395747:
        return new StructureAspectDescriptor.DataBasedStructureDescriptor("jetbrains.mps.samples.lambdaCalculus.structure.AddOperation", new String[]{"jetbrains.mps.samples.lambdaCalculus.structure.BinaryNumericOperation"}, new String[]{"jetbrains.mps.samples.lambdaCalculus.structure.BinaryOperation", "jetbrains.mps.samples.lambdaCalculus.structure.LambdaExpression", "jetbrains.mps.samples.lambdaCalculus.structure.BinaryNumericOperation"}, new String[]{"jetbrains.mps.lang.core.structure.BaseConcept"});
      case 1987793638:
        return new StructureAspectDescriptor.DataBasedStructureDescriptor("jetbrains.mps.samples.lambdaCalculus.structure.MultiplyOperation", new String[]{"jetbrains.mps.samples.lambdaCalculus.structure.BinaryNumericOperation"}, new String[]{"jetbrains.mps.samples.lambdaCalculus.structure.BinaryOperation", "jetbrains.mps.samples.lambdaCalculus.structure.LambdaExpression", "jetbrains.mps.samples.lambdaCalculus.structure.BinaryNumericOperation"}, new String[]{"jetbrains.mps.lang.core.structure.BaseConcept"});
      case -979538954:
        return new StructureAspectDescriptor.DataBasedStructureDescriptor("jetbrains.mps.samples.lambdaCalculus.structure.SubtractOperation", new String[]{"jetbrains.mps.samples.lambdaCalculus.structure.BinaryNumericOperation"}, new String[]{"jetbrains.mps.samples.lambdaCalculus.structure.BinaryOperation", "jetbrains.mps.samples.lambdaCalculus.structure.LambdaExpression", "jetbrains.mps.samples.lambdaCalculus.structure.BinaryNumericOperation"}, new String[]{"jetbrains.mps.lang.core.structure.BaseConcept"});
      case 2128068849:
        return new StructureAspectDescriptor.DataBasedStructureDescriptor("jetbrains.mps.samples.lambdaCalculus.structure.DivideOperation", new String[]{"jetbrains.mps.samples.lambdaCalculus.structure.BinaryNumericOperation"}, new String[]{"jetbrains.mps.samples.lambdaCalculus.structure.BinaryOperation", "jetbrains.mps.samples.lambdaCalculus.structure.LambdaExpression", "jetbrains.mps.samples.lambdaCalculus.structure.BinaryNumericOperation"}, new String[]{"jetbrains.mps.lang.core.structure.BaseConcept"});
      case -1069771330:
      ...
      case -1156557809:
        return new StructureAspectDescriptor.DataBasedStructureDescriptor("jetbrains.mps.samples.lambdaCalculus.structure.ConcatenateOperation", new String[]{"jetbrains.mps.samples.lambdaCalculus.structure.BinaryStringOperation"}, new String[]{"jetbrains.mps.samples.lambdaCalculus.structure.BinaryOperation", "jetbrains.mps.samples.lambdaCalculus.structure.LambdaExpression", "jetbrains.mps.samples.lambdaCalculus.structure.BinaryStringOperation"}, new String[]{"jetbrains.mps.lang.core.structure.BaseConcept"});
      case 195157974:
      ...
      case -1272924907:
        return new StructureAspectDescriptor.DataBasedStructureDescriptor("jetbrains.mps.samples.lambdaCalculus.structure.LetRef", new String[]{"jetbrains.mps.samples.lambdaCalculus.structure.VariableReference"}, new String[]{"jetbrains.mps.samples.lambdaCalculus.structure.VariableReference", "jetbrains.mps.samples.lambdaCalculus.structure.LambdaExpression"}, new String[]{"jetbrains.mps.lang.core.structure.BaseConcept"});
      case -952543430:
        return new StructureAspectDescriptor.DataBasedStructureDescriptor("jetbrains.mps.samples.lambdaCalculus.structure.LetVariable", new String[]{"jetbrains.mps.samples.lambdaCalculus.structure.Variable", "jetbrains.mps.lang.core.structure.INamedConcept"}, new String[]{"jetbrains.mps.samples.lambdaCalculus.structure.Variable", "jetbrains.mps.samples.lambdaCalculus.structure.LambdaExpression"}, new String[]{"jetbrains.mps.lang.core.structure.BaseConcept", "jetbrains.mps.lang.core.structure.INamedConcept"});
      case 783209050:
