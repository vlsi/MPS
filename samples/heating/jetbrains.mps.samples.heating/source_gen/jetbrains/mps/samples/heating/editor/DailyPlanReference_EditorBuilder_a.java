...
/*package*/ class DailyPlanReference_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createRefCell_e3jrht_a0() {
    CellProviderWithRole provider = new RefCellCellProvider(myNode, getEditorContext()) {
      ...
      protected InlineCellProvider createInlineCellProvider(SNode innerCellNode) {
        return new DailyPlanReference_EditorBuilder_a._Inline_e3jrht_a0a(innerCellNode, myNode);
      }
    };
  ...
  public static class _Inline_e3jrht_a0a extends InlineCellProvider {
    public _Inline_e3jrht_a0a(SNode node, SNode refNode) {
      super(node, refNode);
    }
    ...
    public EditorCell createEditorCell(EditorContext editorContext, SNode node) {
      ...
      return new DailyPlanReference_EditorBuilder_a.Inline_Builder_e3jrht_a0a(editorContext, getRefNode(), node).createCell();
    }
  }
