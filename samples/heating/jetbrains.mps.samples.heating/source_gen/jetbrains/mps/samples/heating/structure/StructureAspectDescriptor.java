...
public class StructureAspectDescriptor extends BaseStructureAspectDescriptor {
  ...
  private static ConceptDescriptor createDescriptorForDayRange() {
    return new ConceptDescriptorBuilder("jetbrains.mps.samples.heating.structure.DayRange", MetaIdFactory.conceptId(0xa7d67633e8d9473bL, 0x98ce995a7aa66941L, 0x40bcae6c0e6bc56bL)).super_("jetbrains.mps.samples.heating.structure.Applicability").version(1).super_(MetaIdFactory.conceptId(0xa7d67633e8d9473bL, 0x98ce995a7aa66941L, 0x40bcae6c0e68643cL)).parents("jetbrains.mps.samples.heating.structure.Applicability").parentIds(MetaIdFactory.conceptId(0xa7d67633e8d9473bL, 0x98ce995a7aa66941L, 0x40bcae6c0e68643cL)).propertyDescriptors(new ConceptDescriptorBuilder.Prop(0x40bcae6c0e6bc59fL, "start"), new ConceptDescriptorBuilder.Prop(0x40bcae6c0e6bc5a1L, "end")).properties("start", "end").alias("range", "").sourceNode(new SNodePointer("r:3b810168-3010-426e-9275-12b4e509a27b(jetbrains.mps.samples.heating.structure)", "4664795093170636139")).create();
  }
  private static ConceptDescriptor createDescriptorForHeatingPlan() {
    return new ConceptDescriptorBuilder("jetbrains.mps.samples.heating.structure.HeatingPlan", MetaIdFactory.conceptId(0xa7d67633e8d9473bL, 0x98ce995a7aa66941L, 0x4644aa4ce08aa3f2L)).super_("jetbrains.mps.lang.core.structure.BaseConcept").version(1).super_(MetaIdFactory.conceptId(0xceab519525ea4f22L, 0x9b92103b95ca8c0cL, 0x10802efe25aL)).parents("jetbrains.mps.lang.core.structure.BaseConcept", "jetbrains.mps.lang.core.structure.INamedConcept").parentIds(MetaIdFactory.conceptId(0xceab519525ea4f22L, 0x9b92103b95ca8c0cL, 0x10802efe25aL), MetaIdFactory.conceptId(0xceab519525ea4f22L, 0x9b92103b95ca8c0cL, 0x110396eaaa4L)).childDescriptors(new ConceptDescriptorBuilder.Link(0x4644aa4ce08aec4dL, "dailyPlans", MetaIdFactory.conceptId(0xa7d67633e8d9473bL, 0x98ce995a7aa66941L, 0x4644aa4ce08aec4fL), true, true, false)).children(new String[]{"dailyPlans"}, new boolean[]{true}).rootable().sourceNode(new SNodePointer("r:3b810168-3010-426e-9275-12b4e509a27b(jetbrains.mps.samples.heating.structure)", "5063359128232698866")).create();
  }
  ...
  private static ConceptDescriptor createDescriptorForSpecificDay() {
    return new ConceptDescriptorBuilder("jetbrains.mps.samples.heating.structure.SpecificDay", MetaIdFactory.conceptId(0xa7d67633e8d9473bL, 0x98ce995a7aa66941L, 0x40bcae6c0e6b4ea6L)).super_("jetbrains.mps.samples.heating.structure.Applicability").version(1).super_(MetaIdFactory.conceptId(0xa7d67633e8d9473bL, 0x98ce995a7aa66941L, 0x40bcae6c0e68643cL)).parents("jetbrains.mps.samples.heating.structure.Applicability").parentIds(MetaIdFactory.conceptId(0xa7d67633e8d9473bL, 0x98ce995a7aa66941L, 0x40bcae6c0e68643cL)).propertyDescriptors(new ConceptDescriptorBuilder.Prop(0x40bcae6c0e6b4ea7L, "day")).properties("day").alias("specific day", "").sourceNode(new SNodePointer("r:3b810168-3010-426e-9275-12b4e509a27b(jetbrains.mps.samples.heating.structure)", "4664795093170605734")).create();
  }
