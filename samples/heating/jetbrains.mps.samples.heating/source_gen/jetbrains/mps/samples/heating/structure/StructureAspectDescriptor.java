...
public class StructureAspectDescriptor extends BaseStructureAspectDescriptor {
  ...
  /*package*/ final ConceptDescriptor myConceptApplicability = new ConceptDescriptorBuilder("jetbrains.mps.samples.heating.structure.Applicability", MetaIdFactory.conceptId(0xa7d67633e8d9473bL, 0x98ce995a7aa66941L, 0x40bcae6c0e68643cL)).super_("jetbrains.mps.lang.core.structure.BaseConcept").version(1).super_(MetaIdFactory.conceptId(0xceab519525ea4f22L, 0x9b92103b95ca8c0cL, 0x10802efe25aL)).parents("jetbrains.mps.lang.core.structure.BaseConcept").parentIds(MetaIdFactory.conceptId(0xceab519525ea4f22L, 0x9b92103b95ca8c0cL, 0x10802efe25aL)).abstract_().sourceNode(new SNodePointer("r:3b810168-3010-426e-9275-12b4e509a27b(jetbrains.mps.samples.heating.structure)", "4664795093170414652")).create();
  ...
  /*package*/ final ConceptDescriptor myConceptDayRange = new ConceptDescriptorBuilder("jetbrains.mps.samples.heating.structure.DayRange", MetaIdFactory.conceptId(0xa7d67633e8d9473bL, 0x98ce995a7aa66941L, 0x40bcae6c0e6bc56bL)).super_("jetbrains.mps.samples.heating.structure.Applicability").version(1).super_(MetaIdFactory.conceptId(0xa7d67633e8d9473bL, 0x98ce995a7aa66941L, 0x40bcae6c0e68643cL)).parents("jetbrains.mps.samples.heating.structure.Applicability").parentIds(MetaIdFactory.conceptId(0xa7d67633e8d9473bL, 0x98ce995a7aa66941L, 0x40bcae6c0e68643cL)).propertyDescriptors(new ConceptDescriptorBuilder.Prop(0x40bcae6c0e6bc59fL, "start"), new ConceptDescriptorBuilder.Prop(0x40bcae6c0e6bc5a1L, "end")).properties("start", "end").alias("range", "").sourceNode(new SNodePointer("r:3b810168-3010-426e-9275-12b4e509a27b(jetbrains.mps.samples.heating.structure)", "4664795093170636139")).create();
  ...
  /*package*/ final ConceptDescriptor myConceptWeekDays = new ConceptDescriptorBuilder("jetbrains.mps.samples.heating.structure.WeekDays", MetaIdFactory.conceptId(0xa7d67633e8d9473bL, 0x98ce995a7aa66941L, 0x40bcae6c0e6b4ea5L)).super_("jetbrains.mps.samples.heating.structure.Applicability").version(1).super_(MetaIdFactory.conceptId(0xa7d67633e8d9473bL, 0x98ce995a7aa66941L, 0x40bcae6c0e68643cL)).parents("jetbrains.mps.samples.heating.structure.Applicability").parentIds(MetaIdFactory.conceptId(0xa7d67633e8d9473bL, 0x98ce995a7aa66941L, 0x40bcae6c0e68643cL)).alias("week days", "").sourceNode(new SNodePointer("r:3b810168-3010-426e-9275-12b4e509a27b(jetbrains.mps.samples.heating.structure)", "4664795093170605733")).create();
  /*package*/ final ConceptDescriptor myConceptWeekendDay = new ConceptDescriptorBuilder("jetbrains.mps.samples.heating.structure.WeekendDay", MetaIdFactory.conceptId(0xa7d67633e8d9473bL, 0x98ce995a7aa66941L, 0x40bcae6c0e68b8faL)).super_("jetbrains.mps.samples.heating.structure.Applicability").version(1).super_(MetaIdFactory.conceptId(0xa7d67633e8d9473bL, 0x98ce995a7aa66941L, 0x40bcae6c0e68643cL)).parents("jetbrains.mps.samples.heating.structure.Applicability").parentIds(MetaIdFactory.conceptId(0xa7d67633e8d9473bL, 0x98ce995a7aa66941L, 0x40bcae6c0e68643cL)).alias("weekend day", "").sourceNode(new SNodePointer("r:3b810168-3010-426e-9275-12b4e509a27b(jetbrains.mps.samples.heating.structure)", "4664795093170436346")).create();
