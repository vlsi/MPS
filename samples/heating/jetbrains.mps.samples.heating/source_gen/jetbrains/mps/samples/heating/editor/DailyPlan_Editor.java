...
public class DailyPlan_Editor extends DefaultNodeEditor {
  ...
  private static class itemsListHandler_dgzt1x_a6a extends RefNodeListHandler {
    ...
    public SNode nodeFactory(SNode node, EditorContext editorContext) {
      SNode item = SNodeFactoryOperations.createNewNode(MetaAdapterFactory.getConcept(new UUID(-6352760259037542597l, -7435837320858277567l), 5726447348463731062l, "jetbrains.mps.samples.heating.structure.Slot"), null);
