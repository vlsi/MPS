...
public class TextMacro_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createCollection_6211_0(EditorContext context, SNode node) {
    EditorCell_Collection editorCell = EditorCell_Collection.createIndent2(context, node);
    editorCell.setCellId("Collection_6211_0");
    editorCell.addEditorCell(this.createConstant_6211_0(context, node, "${"));
    editorCell.addEditorCell(this.createRefNode_6211_0(context, node));
    editorCell.addEditorCell(this.createConstant_6211_1(context, node, "}"));
    return editorCell;
  }

  private EditorCell createConstant_6211_0(EditorContext context, SNode node, String text) {
  ...
  private EditorCell createConstant_6211_1(EditorContext context, SNode node, String text) {
    EditorCell_Constant editorCell = new EditorCell_Constant(context, node, text);
  ...
  private EditorCell createRefNode_6211_0(EditorContext context, SNode node) {
