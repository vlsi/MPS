...
public class TransposeExpression_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createCollection_8379_0(EditorContext context, SNode node) {
    EditorCell_Collection editorCell = EditorCell_Collection.createIndent2(context, node);
    editorCell.setCellId("Collection_8379_0");
    editorCell.addEditorCell(this.createRefNode_8379_0(context, node));
    editorCell.addEditorCell(this.createConstant_8379_0(context, node, "T"));
    return editorCell;
  }

  private EditorCell createConstant_8379_0(EditorContext context, SNode node, String text) {
  ...
  private EditorCell createRefNode_8379_0(EditorContext context, SNode node) {
