...
public class PostingRule_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createCollection_4002_0(EditorContext editorContext, SNode node) {
    EditorCell_Collection editorCell = EditorCell_Collection.createVertical(editorContext, node);
    editorCell.setCellId("Collection_4002_0");
    editorCell.addEditorCell(this.createCollection_4002_1(editorContext, node));
    editorCell.addEditorCell(this.createCollection_4002_2(editorContext, node));
    return editorCell;
  }

  private EditorCell createCollection_4002_1(EditorContext editorContext, SNode node) {
  ...
  private EditorCell createCollection_4002_2(EditorContext editorContext, SNode node) {
    EditorCell_Collection editorCell = EditorCell_Collection.createHorizontal(editorContext, node);
  ...
  private EditorCell createRefNode_4002_0(EditorContext editorContext, SNode node) {
  ...
  private EditorCell createRefCell_4002_0(EditorContext editorContext, SNode node) {
  ...
  public static class _Inline4002_0 extends InlineCellProvider {
    ...
    public EditorCell createEditorCell(EditorContext editorContext, SNode node) {
      return this.createProperty_4002_0(editorContext, node);
    }

    private EditorCell createProperty_4002_0(EditorContext editorContext, SNode node) {
