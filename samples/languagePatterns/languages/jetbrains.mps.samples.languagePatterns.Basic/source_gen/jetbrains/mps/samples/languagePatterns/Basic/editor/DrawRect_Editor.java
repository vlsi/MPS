...
public class DrawRect_Editor extends DefaultNodeEditor {
  ...
  private class lineStyleSingleRoleHandler_z7ybz6_a0 extends SingleRoleCellProvider {
    ...
    private EditorCell createEmptyCell_internal(EditorContext editorContext, SNode node) {
      return this.createCollection_z7ybz6_a0a(editorContext, node);
    }
    private EditorCell createCollection_z7ybz6_a0a(EditorContext editorContext, SNode node) {
      EditorCell_Collection editorCell = EditorCell_Collection.createIndent2(editorContext, node);
  ...
  private EditorCell createConstant_z7ybz6_b0(EditorContext editorContext, SNode node) {
    ...
    editorCell.setSubstituteInfo(new CompositeSubstituteInfo(editorContext, new BasicCellContext(node), new SubstituteInfoPartExt[]{new DrawRect_Editor.ReplaceWith_DrawCommand_cellMenu_z7ybz6_a0b0(), new SChildSubstituteInfoPartEx(editorCell)}));
    return editorCell;
  }
