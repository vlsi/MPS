...
public final class Component_BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<String> fullName_id4Vpsm2KEoLo = new SMethodBuilder<String>(new SJavaCompoundTypeImpl(String.class)).name("fullName").modifiers(SModifiersImpl.create(0, AccessPrivileges.PUBLIC)).concept(CONCEPT).id("4Vpsm2KEoLo").registry(REGISTRY).build(SParameterImpl.fromList(SJavaCompoundTypeImpl.fromClasses()));
  ...
  /*package*/ Component_BehaviorDescriptor() {
    super(REGISTRY);
  }
  ...
  protected <T> T invokeSpecial0(@NotNull SNode node, @NotNull SMethod<T> method, @NotNull Object[] parameters) {
    ...
    switch (methodIndex) {
      case 0:
        return (T) fullName_id4Vpsm2KEoLo(node);
      default:
        throw new BHMethodNotFoundException(this, method);
    }
  }
