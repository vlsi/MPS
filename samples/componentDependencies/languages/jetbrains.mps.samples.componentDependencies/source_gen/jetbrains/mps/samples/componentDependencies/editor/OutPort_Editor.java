...
public class OutPort_Editor extends DefaultNodeEditor {
  public EditorCell createEditorCell(EditorContext editorContext, SNode node) {
    return this.createDiagramPort_ubd1fi_a(editorContext, node);
  }

  private EditorCell createDiagramPort_ubd1fi_a(final EditorContext editorContext, final SNode node) {
    final EditorCell editorCell = new OutPort_Editor.PortCellImpl_ubd1fi_a(editorContext, node);
    editorCell.setCellId("DiagramPort_ubd1fi_a");
    editorCell.setBig(true);
    return editorCell;
  }

  private class PortCellImpl_ubd1fi_a extends PortCell {
    private PortCellImpl_ubd1fi_a(EditorContext editorContext, SNode node) {
