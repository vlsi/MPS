...
public class EditorAspectDescriptorImpl implements EditorAspectDescriptor {
  public Collection<EditorAspect> getEditorAspects(ConceptDescriptor descriptor) {
    switch (Arrays.binarySearch(stringSwitchCases_xbvbvu_a0a0a, descriptor.getConceptFqName())) {
      case 0:
        return Collections.<EditorAspect>singletonList(new DegreeComplexExpression_Editor());
      case 1:
        return Collections.<EditorAspect>singletonList(new ImaginaryUnit_Editor());
      case 2:
        return Collections.<EditorAspect>singletonList(new SingleComplexExpression_Editor());
      default:
    }
