...
public class ConcatOperation extends BinaryOperation {
  ...
  public static ConcatOperation newInstance(SModel sm, boolean init) {
    return (ConcatOperation)SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.baseLanguage.ext.collections.lang.ConcatOperation", sm, GlobalScope.getInstance(), init).getAdapter();
  }
