...
public class SortDirection extends BooleanConstant {
  ...
  public static SortDirection newInstance(SModel sm, boolean init) {
    return (SortDirection)SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.baseLanguage.ext.collections.lang.SortDirection", sm, GlobalScope.getInstance(), init).getAdapter();
  }
