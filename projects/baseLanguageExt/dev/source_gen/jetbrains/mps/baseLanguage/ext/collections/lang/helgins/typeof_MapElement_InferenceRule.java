...
public class typeof_MapElement_InferenceRule implements InferenceRule_Runtime {
  ...
  public void applyRule(final SNode argument) {
    ...
    TypeChecker.getInstance().getRuntimeSupport().createEquation(TypeChecker.getInstance().getRuntimeSupport().typeOf(argument, "jetbrains.mps.baseLanguage.ext.collections.lang.helgins", "1198083609561", true), TypeChecker.getInstance().getEquationManager().getRepresentator(valueType_typevar_1198083495346), argument, null, "jetbrains.mps.baseLanguage.ext.collections.lang.helgins", "1198083621785");
    TypeChecker.getInstance().getRuntimeSupport().createLessThanInequation(TypeChecker.getInstance().getRuntimeSupport().typeOf(SLinkOperations.getTarget(argument, "key", true), "jetbrains.mps.baseLanguage.ext.collections.lang.helgins", "1198084142392", true), TypeChecker.getInstance().getEquationManager().getRepresentator(keyType_typevar_1198083488673), SLinkOperations.getTarget(argument, "key", true), null, "jetbrains.mps.baseLanguage.ext.collections.lang.helgins", "1198084142390");
  }
