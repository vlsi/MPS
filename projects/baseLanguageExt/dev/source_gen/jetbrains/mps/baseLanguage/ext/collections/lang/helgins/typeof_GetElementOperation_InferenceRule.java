...
import jetbrains.mps.baseLanguage.ext.collections.lang.helgins.QuotationClass_15;
...
public class typeof_GetElementOperation_InferenceRule implements InferenceRule_Runtime {
  ...
  public void applyRule(SNode argument) {
    ...
    if(!(TypeChecker.getInstance().getSubtypingManager().isSubtype(TypeChecker.getInstance().getRuntimeSupport().checkedTypeOf(arg), new QuotationClass_15().createNode()))) {
