...
public class supertypesOf_ListType_SequenceType_SubtypingRule extends SubtypingRule_Runtime implements ISubtypingRule_Runtime {
  ...
  public SNode getSubOrSuperType(SNode type) {
    return new QuotationClass_18().createNode(SLinkOperations.getTarget(type, "elementType", true));
  }
  ...
  public ApplicableNodeCondition getNodeCondition() {
    ...
    return (ApplicableNodeCondition)BaseAdapter.fromNode(model.getNodeById("1178725704750"));
  }
