...
public class typeof_SkipOperation_InferenceRule implements InferenceRule_Runtime {
  ...
  public void applyRule(SNode argument) {
    ...
    if(!(TypeChecker.getInstance().getSubtypingManager().isSubtype(TypeChecker.getInstance().getRuntimeSupport().checkedTypeOf(SLinkOperations.getTarget(argument, "elementsToSkip", true)), new QuotationClass_1().createNode()))) {
  ...
  public ApplicableNodeCondition getNodeCondition() {
    ...
    return (ApplicableNodeCondition)BaseAdapter.fromNode(model.getNodeById("1178725704648"));
  }
