...
public class typeof_BinaryOperation_InferenceRule implements InferenceRule_Runtime {
  ...
  public void applyRule(final SNode argument) {
    ...
    TypeChecker.getInstance().getRuntimeSupport().createLessThanInequation(TypeChecker.getInstance().getRuntimeSupport().typeOf(lValue, "jetbrains.mps.baseLanguage.ext.collections.lang.helgins", "1184848533289"), TypeChecker.getInstance().getEquationManager().getRepresentator(sequenceType_typevar_1184848409899), lValue, null, "jetbrains.mps.baseLanguage.ext.collections.lang.helgins", "1184848544308");
    TypeChecker.getInstance().getRuntimeSupport().createLessThanInequation(TypeChecker.getInstance().getRuntimeSupport().typeOf(rValue, "jetbrains.mps.baseLanguage.ext.collections.lang.helgins", "1184848549565"), TypeChecker.getInstance().getEquationManager().getRepresentator(sequenceType_typevar_1184848409899), rValue, null, "jetbrains.mps.baseLanguage.ext.collections.lang.helgins", "1184848553704");
    TypeChecker.getInstance().getRuntimeSupport().createEquation(TypeChecker.getInstance().getRuntimeSupport().typeOf(argument, "jetbrains.mps.baseLanguage.ext.collections.lang.helgins", "1184848561861"), TypeChecker.getInstance().getEquationManager().getRepresentator(sequenceType_typevar_1184848409899), argument, null, "jetbrains.mps.baseLanguage.ext.collections.lang.helgins", "1184848565182");
  }
