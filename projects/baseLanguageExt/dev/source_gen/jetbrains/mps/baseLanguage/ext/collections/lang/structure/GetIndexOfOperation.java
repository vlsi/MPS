...
public class GetIndexOfOperation extends AbstractListOperation {
  ...
  public static GetIndexOfOperation newInstance(SModel sm, boolean init) {
    return (GetIndexOfOperation)SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.baseLanguage.ext.collections.lang.GetIndexOfOperation", sm, GlobalScope.getInstance(), init).getAdapter();
  }
