...
public class PageOperation extends SequenceOperation {
  ...
  public static PageOperation newInstance(SModel sm, boolean init) {
    return (PageOperation)SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.baseLanguage.ext.collections.lang.PageOperation", sm, GlobalScope.getInstance(), init).getAdapter();
  }
