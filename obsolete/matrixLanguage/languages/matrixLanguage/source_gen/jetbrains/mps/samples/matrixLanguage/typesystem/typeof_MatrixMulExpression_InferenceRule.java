        ...
        public void run() {
          {
            ...
            typeCheckingContext.whenConcrete(right, new Runnable() {
              public void run() {
                boolean done = false;
                if (TypeChecker.getInstance().getSubtypingManager().isSubtype(typeCheckingContext.getExpandedType(left), new typeof_MatrixMulExpression_InferenceRule.QuotationClass_s4fcwx_a1a0b0a0a0a().createNode(typeCheckingContext))) {
                  {
                    ...
                    SNode coercedNode_bwoj06_a0b0a0a0 = TypeChecker.getInstance().getRuntimeSupport().coerce_(typeCheckingContext.getExpandedType(right), pattern_bwoj06_a0b0a0a0);
                  ...
                  if (!(done)) {
                    {
                      ...
                      IErrorReporter _reporter_2309309498 = typeCheckingContext.reportTypeError(SLinkOperations.getTarget(nodeToCheck, "rightExpression", true), "Type must be Matrix but " + SNodeOperations.getConceptDeclaration(typeCheckingContext.getExpandedType(right)), "r:00000000-0000-4000-0000-011c89590452(jetbrains.mps.samples.matrixLanguage.typesystem)", "1210175930104", null, errorTarget);
                    }
                  }
                } else
                if (TypeChecker.getInstance().getSubtypingManager().isSubtype(typeCheckingContext.getExpandedType(right), new typeof_MatrixMulExpression_InferenceRule.QuotationClass_s4fcwx_a1a0a1a0a0a0().createNode(typeCheckingContext))) {
                  {
                    ...
                    SNode coercedNode_bwoj06_a0a1a0a0a = TypeChecker.getInstance().getRuntimeSupport().coerce_(typeCheckingContext.getExpandedType(left), pattern_bwoj06_a0a1a0a0a);
                  ...
                  if (!(done)) {
                    {
                      MessageTarget errorTarget = new NodeMessageTarget();
                      IErrorReporter _reporter_2309309498 = typeCheckingContext.reportTypeError(SLinkOperations.getTarget(nodeToCheck, "leftExpression", true), "Type must be Matrix but " + SNodeOperations.getConceptDeclaration(typeCheckingContext.getExpandedType(left)), "r:00000000-0000-4000-0000-011c89590452(jetbrains.mps.samples.matrixLanguage.typesystem)", "1210176257229", null, errorTarget);
                    }
                  }
                } else {
