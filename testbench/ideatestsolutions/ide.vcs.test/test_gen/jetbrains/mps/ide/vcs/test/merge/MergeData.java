...
public class MergeData {
  ...
  private void loadResultData() throws IOException {
    ...
    myChangesMineString = loadString(MergeData.CHANGES_MINE_TXT);
    myChangesRepositoryString = loadString(MergeData.CHANGES_REPOSITORY_TXT);
  }
  ...
  private void saveAndClose() throws IOException {
    ...
    addFileToZos(zos, MergeData.CHANGES_MINE_TXT, myChangesMineString);
    addFileToZos(zos, MergeData.CHANGES_REPOSITORY_TXT, myChangesRepositoryString);
    zos.close();
  }
  @Nullable
