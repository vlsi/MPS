...
public final class JUnit3TestCaseRef_BehaviorDescriptor extends BaseBHDescriptor {
  ...
  private static String fqClassName_id2$98zG5liRT(@NotNull SNode __thisNode__) {
    return UnitConcept_BehaviorDescriptor.getUnitName_id4pl5GY7LKmR.invoke(SLinkOperations.getTarget(__thisNode__, MetaAdapterFactory.getReferenceLink(0xd3c5a46fb8c247dbL, 0xad0a30b8f19c2055L, 0x3e81ed1e2be77cb9L, 0x11c3fc56a6d10bbfL, "klass")));
  }
  private static Iterable<String> testNames_id3z1mdFUF$j3(@NotNull SNode __thisNode__) {
    ...
    return Sequence.fromIterable(Classifier_BehaviorDescriptor.methods_id4_LVZ3pBKCn.invoke(SLinkOperations.getTarget(__thisNode__, MetaAdapterFactory.getReferenceLink(0xd3c5a46fb8c247dbL, 0xad0a30b8f19c2055L, 0x3e81ed1e2be77cb9L, 0x11c3fc56a6d10bbfL, "klass")))).where(new IWhereFilter<SNode>() {
  ...
  private static Iterable<SNode> getTestClassesForModule_id1k5vvhzzWoK(@NotNull SAbstractConcept __thisConcept__, SNode module) {
  ...
  /*package*/ JUnit3TestCaseRef_BehaviorDescriptor() {
    super(REGISTRY);
  }
  ...
  protected <T> T invokeSpecial0(@NotNull SAbstractConcept concept, @NotNull SMethod<T> method, @NotNull Object[] parameters) {
    ...
    switch (methodIndex) {
      case 3:
        return (T) getTestClassesForModule_id1k5vvhzzWoK(concept, (SNode) parameters[0]);
      default:
        throw new BHMethodNotFoundException(this, method);
    }
  }
