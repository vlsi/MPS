...
public class JUnit3TestCaseRef_Editor extends DefaultNodeEditor {
  public EditorCell createEditorCell(EditorContext editorContext, SNode node) {
    return this.createCollection_oadaxc_a(editorContext, node);
  }
  ...
  private EditorCell createConstant_oadaxc_a0(EditorContext editorContext, SNode node) {
    ...
    style.set(StyleAttributes.STRIKE_OUT, 0, JUnit3TestCaseRef_Editor._StyleParameter_QueryFunction_oadaxc_a0a0((editorCell == null ? null : editorCell.getContext()), (editorCell == null ? null : editorCell.getSNode())));
    editorCell.getStyle().putAll(style);
    editorCell.setDefaultText("");
    return editorCell;
  }
  private static boolean _StyleParameter_QueryFunction_oadaxc_a0a0(EditorContext editorContext, SNode node) {
  ...
  private EditorCell createRefCell_oadaxc_b0(EditorContext editorContext, SNode node) {
    CellProviderWithRole provider = new RefCellCellProvider(node, editorContext);
    provider.setRole("klass");
    provider.setNoTargetText("<no klass>");
    EditorCell editorCell;
    provider.setAuxiliaryCellProvider(new JUnit3TestCaseRef_Editor._Inline_oadaxc_a1a());
  ...
  public static class _Inline_oadaxc_a1a extends InlineCellProvider {
    ...
    public EditorCell createEditorCell(EditorContext editorContext, SNode node) {
      return this.createProperty_oadaxc_a0b0(editorContext, node);
    }
    private EditorCell createProperty_oadaxc_a0b0(EditorContext editorContext, SNode node) {
