...
public class TestCaseRef_SubstituteMenu extends SubstituteMenuBase {
  ...
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new TestCaseRef_SubstituteMenu.SubstituteMenuPart_Parameterized_dnvvk3_a());
    result.add(new TestCaseRef_SubstituteMenu.SubstituteMenuPart_Subconcepts_dnvvk3_b());
    result.add(new SimpleConceptSubstituteMenuPart(MetaAdapterFactory.getConcept(0xd3c5a46fb8c247dbL, 0xad0a30b8f19c2055L, 0x3e81ed1e2be77cb7L, "jetbrains.mps.testbench.suite.structure.TestCaseRef")));
    return result;
  }
