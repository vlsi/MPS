...
public class JUnit3TestCaseRef_klass_ReferentConstraint extends BaseNodeReferenceSearchScopeProvider implements IModelConstraints {
  public JUnit3TestCaseRef_klass_ReferentConstraint() {
  }

  public void registerSelf(ModelConstraintsManager manager) {
    manager.registerNodeReferentSearchScopeProvider("jetbrains.mps.testbench.suite.structure.JUnit3TestCaseRef", "klass", this);
  }

  public void unRegisterSelf(ModelConstraintsManager manager) {
    manager.unRegisterNodeReferentSearchScopeProvider("jetbrains.mps.testbench.suite.structure.JUnit3TestCaseRef", "klass");
  }
  ...
  public Object createSearchScopeOrListOfNodes(final IOperationContext operationContext, final ReferentConstraintContext _context) {
    ...
    return new VisibleClassifiersScope(_context.getEnclosingNode(), IClassifiersSearchScope.CLASS, (ms != null ?
      ...
      public List<SNode> getClassifiers() {
        SNode testCase = SLinkOperations.getTarget(new JUnit3TestCaseRef_klass_ReferentConstraint.QuotationClass_92riot_a0a0a0a0a0b0c().createNode(), "classifier", false);
  ...
  public static class QuotationClass_92riot_a0a0a0a0a0b0c {
    public QuotationClass_92riot_a0a0a0a0a0b0c() {
    }
