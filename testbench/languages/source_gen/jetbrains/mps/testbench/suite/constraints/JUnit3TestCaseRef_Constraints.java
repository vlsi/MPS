...
public class JUnit3TestCaseRef_Constraints extends ConstraintsDataHolder {
      ...
      public Object createSearchScopeOrListOfNodes(final IOperationContext operationContext, final ReferentConstraintContext _context) {
        ...
        return new VisibleClassifiersScope(_context.getEnclosingNode(), IClassifiersSearchScope.CLASS, (ms != null ?
          ...
          public List<SNode> getClassifiers() {
            SNode testCase = SLinkOperations.getTarget(new JUnit3TestCaseRef_Constraints.QuotationClass_qx1fe9_a0a0a0a0a0b0c0a1a0b0b().createNode(), "classifier", false);
  ...
  public static class QuotationClass_qx1fe9_a0a0a0a0a0b0c0a1a0b0b {
    public QuotationClass_qx1fe9_a0a0a0a0a0b0c0a1a0b0b() {
    }
