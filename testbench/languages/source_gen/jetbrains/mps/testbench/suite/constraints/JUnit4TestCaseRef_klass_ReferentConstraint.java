...
public class JUnit4TestCaseRef_klass_ReferentConstraint extends BaseNodeReferenceSearchScopeProvider implements IModelConstraints {
  public JUnit4TestCaseRef_klass_ReferentConstraint() {
  }

  public void registerSelf(ModelConstraintsManager manager) {
    manager.registerNodeReferentSearchScopeProvider("jetbrains.mps.testbench.suite.structure.JUnit4TestCaseRef", "klass", this);
  }

  public void unRegisterSelf(ModelConstraintsManager manager) {
    manager.unRegisterNodeReferentSearchScopeProvider("jetbrains.mps.testbench.suite.structure.JUnit4TestCaseRef", "klass");
  }
  ...
  public static class QuotationClass_bsxj4t_a0a0a0a0a0b0c {
    public QuotationClass_bsxj4t_a0a0a0a0a0b0c() {
    }
