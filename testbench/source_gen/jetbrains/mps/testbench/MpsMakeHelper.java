...
public class MpsMakeHelper {
  ...
  static {
    PATTERNS = (Object[][]) ListSequence.fromListAndArray(new ArrayList<Object[]>(), new Object[]{FilesCollector.FilePattern.Type.EXCLUDE, "**/classes_gen/**"}, new Object[]{FilesCollector.FilePattern.Type.EXCLUDE, "**/lib/**"}, new Object[]{FilesCollector.FilePattern.Type.EXCLUDE, "**/testRefactoring/**"}, new Object[]{FilesCollector.FilePattern.Type.EXCLUDE, "**/**transformationTest**/**"}, new Object[]{FilesCollector.FilePattern.Type.EXCLUDE, "**/**testLogger**/**"}, new Object[]{FilesCollector.FilePattern.Type.EXCLUDE, "**/**sandbox**/**"}, new Object[]{FilesCollector.FilePattern.Type.EXCLUDE, "**/**Sandbox**/**"}, new Object[]{FilesCollector.FilePattern.Type.EXCLUDE, "**/IdeaPlugin/solutions/**"}, new Object[]{FilesCollector.FilePattern.Type.EXCLUDE, "**/**.mpl"}, new Object[]{FilesCollector.FilePattern.Type.EXCLUDE, "**/**.msd"}, new Object[]{FilesCollector.FilePattern.Type.EXCLUDE, "**/resolve.msd"}, new Object[]{FilesCollector.FilePattern.Type.EXCLUDE, "**/lib/**"}).toArray();
  }
