...
@ModuleSymbolicSuite.ModuleClassSymbols(classes = {"jetbrains.mps.traceInfo.test.TraceInfoTest"}, tests = {"ifTest,forTest,blockStatementTest,foreachTest,generatedForeachTest"})
