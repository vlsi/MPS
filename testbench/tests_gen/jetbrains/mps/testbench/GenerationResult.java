...
public class GenerationResult {
  public static GenerationResult generateModule(SModule module, Project project) {
    return new GenerationResult(module, project);
  }
  ...
  private final GenerationResult.MyMessageHandler myMessageHandler = new GenerationResult.MyMessageHandler();
  private boolean isSucessful;


  private GenerationResult(SModule module, Project project) {
    this.module = module;
  ...
  private void build() {
    ...
    ThreadUtils.runInUIThreadAndWait(new Runnable() {
      public void run() {
        ...
        IScript scr = GenerationResult.defaultScriptBuilder().toScript();
        try {
          result.value = new TestMakeService(context, myMessageHandler).make(null, GenerationResult.collectResources(context, module), scr, ctl, new EmptyProgressMonitor()).get();
