...
<solution name="jetbrains.mps.testActions" uuid="ae6cedf1-e261-45d9-972d-e8cfbc5e7f52" pluginKind="PLUGIN_OTHER" compileInMPS="true" generatorOutputPath="${module}/tests_gen">
  <models>
