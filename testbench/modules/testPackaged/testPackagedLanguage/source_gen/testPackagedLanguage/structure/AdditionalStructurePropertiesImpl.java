...
public class AdditionalStructurePropertiesImpl extends BaseAdditionalStructureProperties {
  private final AdditionalConceptProperties props_TestConcept = new ConceptPropsBuilder().icon("icon.png", AdditionalStructurePropertiesImpl.class).create();
  ...
  private static final Map<SAbstractConcept, Integer> indices_4qogsf_a0c = buildConceptIndices(MetaAdapterFactory.getConcept(0x2d9a25d302b84024L, 0xafe2bb9457a02cbfL, 0x6005c4080114d50fL, "TestConcept"));
}
