...
<model ref="r:34874a5b-aeb7-40c7-a70f-cd58be43b014(testWrappedType.editor)">
  ...
  <node concept="24kQdi" id="15xlXKdz5cN">
    ...
    <node concept="3EZMnI" id="15xlXKdz5cP" role="2wV5jI">
      ...
      <node concept="3F0ifn" id="15xlXKdzcwD" role="3EZMnx">
        ...
        <node concept="11L4FC" id="15xlXKdzc$f" role="3F10Kt">
          <property role="VOm3f" value="true" />
        </node>
        <node concept="11LMrY" id="15xlXKdzc_Z" role="3F10Kt">
          <property role="VOm3f" value="true" />
        </node>
      </node>
      <node concept="3F0A7n" id="15xlXKdz5d2" role="3EZMnx">
        <ref role="1NtTu8" to="jwoj:15xlXKdz5cG" resolve="unit" />
      </node>
      <node concept="3F0ifn" id="15xlXKdzcwP" role="3EZMnx">
        <property role="3F0ifm" value="/" />
        <node concept="11L4FC" id="15xlXKdzcy$" role="3F10Kt">
          <property role="VOm3f" value="true" />
        </node>
      </node>
    </node>
