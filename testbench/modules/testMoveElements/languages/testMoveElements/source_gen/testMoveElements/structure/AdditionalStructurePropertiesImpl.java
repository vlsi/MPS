...
public class AdditionalStructurePropertiesImpl extends BaseAdditionalStructureProperties {
  private final AdditionalConceptProperties props_DummyBlock = new ConceptPropsBuilder().create();
  private final AdditionalConceptProperties props_ManyStatements = new ConceptPropsBuilder().create();
  private final AdditionalConceptProperties props_ManyStatementsContainer = new ConceptPropsBuilder().create();
