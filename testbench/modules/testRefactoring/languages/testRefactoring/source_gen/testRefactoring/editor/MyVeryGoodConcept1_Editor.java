...
public class MyVeryGoodConcept1_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createConstant_15tf1e_a0a(EditorContext editorContext, SNode node) {
    EditorCell_Constant editorCell = new EditorCell_Constant((jetbrains.mps.nodeEditor.EditorContext) editorContext, node, "good");
  ...
  private EditorCell createConstant_15tf1e_c0a(EditorContext editorContext, SNode node) {
    EditorCell_Constant editorCell = new EditorCell_Constant((jetbrains.mps.nodeEditor.EditorContext) editorContext, node, "brother:");
  ...
  private EditorCell createConstant_15tf1e_a1a(EditorContext editorContext, SNode node) {
    EditorCell_Constant editorCell = new EditorCell_Constant((jetbrains.mps.nodeEditor.EditorContext) editorContext, node, "good property:");
