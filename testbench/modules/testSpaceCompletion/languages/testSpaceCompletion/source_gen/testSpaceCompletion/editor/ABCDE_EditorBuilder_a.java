...
/*package*/ class ABCDE_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  /*package*/ EditorCell createCell() {
    return createCollection_rc2jd0_a();
  }

  private EditorCell createCollection_rc2jd0_a() {
    EditorCell_Collection editorCell = EditorCell_Collection.createIndent2(getEditorContext(), myNode);
    editorCell.setCellId("Collection_rc2jd0_a");
    editorCell.setBig(true);
    editorCell.setCellContext(getCellFactory().getCellContext());
    editorCell.addEditorCell(createConstant_rc2jd0_a0());
    editorCell.addEditorCell(createConstant_rc2jd0_b0());
    editorCell.addEditorCell(createConstant_rc2jd0_c0());
    return editorCell;
  }
  private EditorCell createConstant_rc2jd0_a0() {
  ...
  private EditorCell createConstant_rc2jd0_b0() {
  ...
  private EditorCell createConstant_rc2jd0_c0() {
    EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, ")");
