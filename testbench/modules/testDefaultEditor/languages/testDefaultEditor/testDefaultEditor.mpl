...
<language namespace="testDefaultEditor" uuid="b5734616-c4b0-4639-9c6a-f3a1cf5dc4db" generatorOutputPath="${module}/source_gen" version="0">
  <models>
  ...
  <accessoryModels />
  <generators>
    <generator name="" generatorUID="testDefaultEditor#938834323431407324" uuid="6347035b-39ac-4ba2-a86e-006974863808">
      <models>
        <modelRoot contentPath="${module}" type="default">
