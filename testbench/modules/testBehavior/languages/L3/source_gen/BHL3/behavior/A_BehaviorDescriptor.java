...
public final class A_BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<Object> foo_id38300 = new SMethodBuilder(new SJavaCompoundTypeImpl(Object.class)).name("foo").modifiers(SModifiersImpl.create(0, AccessPrivileges.PUBLIC)).concept(CONCEPT).baseMethod(null).id(SNodeId.fromString("7688460527007462273")).build(SParameterImpl.fromList(SJavaCompoundTypeImpl.fromClasses()));
