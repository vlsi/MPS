...
public final class H_BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<Integer> foo_id34761 = new SMethodBuilder(new SJavaCompoundTypeImpl(Integer.TYPE)).name("foo").modifiers(SMethodModifiers.create(true, false, AccessPrivileges.PUBLIC)).concept(CONCEPT).baseMethod(null).build();
  public static final SMethod<Integer> foo_id34814 = new SMethodBuilder(new SJavaCompoundTypeImpl(Integer.TYPE)).name("foo___1").modifiers(SMethodModifiers.create(true, false, AccessPrivileges.PUBLIC)).concept(CONCEPT).baseMethod(null).build();
