...
public final class B_BehaviorDescriptor extends BaseBHDescriptor {
  public static final SMethod<Object> virtualMethod_METHOD = SMethod.create("virtualMethod", SMethod.BHMethodModifiers.empty().virtualOn(false).staticOn(false), Object.class);
  public static final SMethod<Object> staticVirtualMethod_METHOD = SMethod.create("staticVirtualMethod", SMethod.BHMethodModifiers.empty().virtualOn(false).staticOn(true), Object.class);
