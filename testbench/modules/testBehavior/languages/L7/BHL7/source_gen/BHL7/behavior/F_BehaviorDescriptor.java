...
public final class F_BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<Integer> foo_id15618 = new SMethodBuilder(Integer.TYPE).name("foo").modifiers(BHMethodModifiers.create(true, false, AccessPrivileges.PUBLIC)).concept(CONCEPT).baseMethod(I1_BehaviorDescriptor.foo_id63191).build();
  public static final SMethod<Integer> foo_id15742 = new SMethodBuilder(Integer.TYPE).name("foo___1").modifiers(BHMethodModifiers.create(true, false, AccessPrivileges.PUBLIC)).concept(CONCEPT).baseMethod(null).build();
