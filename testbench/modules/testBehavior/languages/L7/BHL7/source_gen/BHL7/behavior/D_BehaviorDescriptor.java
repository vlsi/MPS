...
public final class D_BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<Integer> foo_id63091 = new SMethodBuilder(new SJavaCompoundTypeImpl(Integer.TYPE)).name("foo").modifiers(SModifiersImpl.create(8, AccessPrivileges.PUBLIC)).concept(CONCEPT).baseMethod(I1_BehaviorDescriptor.foo_id63191).id(SNodeId.fromString("6097773470847816409")).build(SParameterImpl.fromList(SJavaCompoundTypeImpl.fromClasses()));
  public static final SMethod<Integer> foo_id63093 = new SMethodBuilder(new SJavaCompoundTypeImpl(Integer.TYPE)).name("foo_1").modifiers(SModifiersImpl.create(8, AccessPrivileges.PUBLIC)).concept(CONCEPT).baseMethod(I2_BehaviorDescriptor.foo_id62978).id(SNodeId.fromString("6097773470847816415")).build(SParameterImpl.fromList(SJavaCompoundTypeImpl.fromClasses()));
