...
public final class D_BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<Integer> foo_id63091 = new SMethodBuilder(new SJavaCompoundTypeImpl(Integer.TYPE)).name("foo").modifiers(SMethodModifiers.create(true, false, AccessPrivileges.PUBLIC)).concept(CONCEPT).baseMethod(I1_BehaviorDescriptor.foo_id63191).build(SParameterImpl.fromList(SJavaCompoundTypeImpl.fromClasses()));
  public static final SMethod<Integer> foo_id63093 = new SMethodBuilder(new SJavaCompoundTypeImpl(Integer.TYPE)).name("foo___1").modifiers(SMethodModifiers.create(true, false, AccessPrivileges.PUBLIC)).concept(CONCEPT).baseMethod(I2_BehaviorDescriptor.foo_id62978).build(SParameterImpl.fromList(SJavaCompoundTypeImpl.fromClasses()));
