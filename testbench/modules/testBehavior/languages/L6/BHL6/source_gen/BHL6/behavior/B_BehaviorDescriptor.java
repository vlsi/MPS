...
public final class B_BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<Integer> bar_METHOD = SMethod.create("bar", SMethod.BHMethodModifiers.empty().virtualOn(false).staticOn(false), Integer.TYPE);
  ...
  public B_BehaviorDescriptor(@NotNull SAbstractConcept concept) {
    super(concept);
  }
