...
public final class G_BehaviorDescriptor extends BaseBHDescriptor {
  public static final SMethod<Object> foo_METHOD = SMethod.create("foo", SMethod.BHMethodModifiers.empty().virtualOn(false).staticOn(true), Object.class);
  ...
  public G_BehaviorDescriptor(@NotNull SAbstractConcept concept) {
    super(concept);
  }
