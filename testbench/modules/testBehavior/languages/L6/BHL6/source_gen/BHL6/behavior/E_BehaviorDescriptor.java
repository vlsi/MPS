...
public final class E_BehaviorDescriptor extends BaseBHDescriptor {
  public static final SMethod<Integer> foo_METHOD = SMethod.create("foo", SMethod.BHMethodModifiers.empty().virtualOn(false).staticOn(true), Integer.TYPE);
  ...
  public E_BehaviorDescriptor(@NotNull SAbstractConcept concept) {
    super(concept);
  }
