...
public final class F_BehaviorDescriptor extends BaseBHDescriptor {
  public static final SMethod<Object> foo_METHOD = SMethod.create("foo", SMethod.BHMethodModifiers.empty().virtualOn(true).staticOn(true), Object.class);
  ...
  public F_BehaviorDescriptor(@NotNull SAbstractConcept concept) {
    super(concept);
  }
