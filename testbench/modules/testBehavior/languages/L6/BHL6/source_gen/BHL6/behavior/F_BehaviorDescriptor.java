...
public final class F_BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<Object> foo_id31307 = new SMethodBuilder(Object.class).name("foo").modifiers(BHMethodModifiers.create(true, true, AccessPrivileges.PUBLIC)).concept(CONCEPT).baseMethod(null).build();
