...
public final class A_BehaviorDescriptor extends BaseBHDescriptor {
  ...
  private static final SMethod<Integer> bar2_id6LtvT_VTCe3 = new SMethodBuilder<Integer>(new SJavaCompoundTypeImpl(Integer.TYPE)).name("bar2").modifiers(SModifiersImpl.create(0, AccessPrivileges.PRIVATE)).concept(CONCEPT).id("6LtvT_VTCe3").registry(REGISTRY).build(SParameterImpl.fromList(SJavaCompoundTypeImpl.fromClasses()));
