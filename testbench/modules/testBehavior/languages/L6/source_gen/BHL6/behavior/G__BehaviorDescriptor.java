...
public final class G__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<Object> foo_id5mnatV0h_el = new SMethodBuilder<Object>(new SJavaCompoundTypeImpl(Object.class)).name("foo").modifiers(SModifiersImpl.create(9, AccessPrivileges.PUBLIC)).concept(CONCEPT).id("5mnatV0h_el").registry(REGISTRY).build();
