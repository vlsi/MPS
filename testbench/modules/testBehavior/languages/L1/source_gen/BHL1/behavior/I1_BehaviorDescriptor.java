...
public final class I1_BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<Object> foo_id20708 = new SMethodBuilder(Object.class).name("foo").modifiers(BHMethodModifiers.create(true, false, AccessPrivileges.PUBLIC)).concept(CONCEPT).baseMethod(null).build();
