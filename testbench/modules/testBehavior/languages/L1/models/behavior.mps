...
<model ref="r:e76e445e-2173-496b-9059-50cca123009f(L1.behavior)">
  ...
  <imports>
    ...
    <import index="8jon" ref="r:28855287-2116-4523-9c44-f18e3449e08d(L1.structure)" implicit="true" />
  </imports>
  <registry>
      ...
      <node concept="3clFbS" id="7Ts2tYwvl$Y" role="3clF47">
        <node concept="3cpWs6" id="7Ts2tYwvswK" role="3cqZAp">
          <node concept="10M0yZ" id="6EMTxOPT4t7" role="3cqZAk">
            ...
            <ref role="3cqZAo" to="ynox:6EMTxOPT4pe" resolve="DEFAULT_METHOD_WORKS" />
          </node>
        </node>
      </node>
    </node>
