...
public final class I2_BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<Object> foo_id17646 = new SMethodBuilder(Object.class).name("foo").modifiers(BHMethodModifiers.create(true, false, AccessPrivileges.PUBLIC)).concept(CONCEPT).baseMethod(I_BehaviorDescriptor.foo_id29640).build();
