...
public final class I1_BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<Object> foo_id18077 = new SMethodBuilder(new SJavaCompoundTypeImpl(Object.class)).name("foo").modifiers(SModifiersImpl.create(8, AccessPrivileges.PUBLIC)).concept(CONCEPT).baseMethod(I_BehaviorDescriptor.foo_id29640).id(SNodeId.fromString("7817628362470493454")).build(SParameterImpl.fromList(SJavaCompoundTypeImpl.fromClasses()));
