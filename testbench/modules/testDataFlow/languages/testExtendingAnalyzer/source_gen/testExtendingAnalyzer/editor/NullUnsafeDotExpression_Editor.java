...
public class NullUnsafeDotExpression_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createRefNode_yu15xo_b0(EditorContext editorContext, SNode node) {
    SingleRoleCellProvider provider = new NullUnsafeDotExpression_Editor.operandSingleRoleHandler_yu15xo_b0(node, MetaAdapterFactory.getContainmentLink(0xf3061a5392264cc5L, 0xa443f952ceaf5816L, 0x116b46a08c4L, 0x116b46a4416L, "operand"), editorContext);
    return provider.createCell();
  }
  private class operandSingleRoleHandler_yu15xo_b0 extends SingleRoleCellProvider {
  ...
  private EditorCell createRefNode_yu15xo_d0(EditorContext editorContext, SNode node) {
    SingleRoleCellProvider provider = new NullUnsafeDotExpression_Editor.operationSingleRoleHandler_yu15xo_d0(node, MetaAdapterFactory.getContainmentLink(0xf3061a5392264cc5L, 0xa443f952ceaf5816L, 0x116b46a08c4L, 0x116b46b36c4L, "operation"), editorContext);
    return provider.createCell();
  }
  private class operationSingleRoleHandler_yu15xo_d0 extends SingleRoleCellProvider {
