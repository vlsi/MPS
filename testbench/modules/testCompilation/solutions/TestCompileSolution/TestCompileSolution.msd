...
<solution name="TestCompileSolution" uuid="a2e9b672-d7f0-4804-bc04-9161af907fda" moduleVersion="0" compileInMPS="true">
  <models>
    <modelRoot contentPath="${module}" type="default">
      <sourceRoot location="models" />
    </modelRoot>
    <modelRoot contentPath="${module}" type="java_classes" />
    <modelRoot contentPath="${mps_home}/testbench/modules/testCompilation/lib" type="java_classes">
  ...
  <dependencyVersions>
    ...
    <module reference="a2e9b672-d7f0-4804-bc04-9161af907fda(TestCompileSolution)" version="0" />
  </dependencyVersions>
</solution>
