...
public class UnapplyPriorityStyleCopy_Editor extends DefaultNodeEditor {
  public EditorCell createEditorCell(EditorContext editorContext, SNode node) {
    return this.createComponent_xgaq7j_a(editorContext, node);
  }
  private EditorCell createComponent_xgaq7j_a(EditorContext editorContext, SNode node) {
