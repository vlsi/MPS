...
public class AdditionalStructurePropertiesImpl extends ConceptPresentationAspectBase {
  ...
  private final ConceptPresentation props_ActionTestChild1 = new ConceptPresentationBuilder().icon("child1.png", AdditionalStructurePropertiesImpl.class).create();
  ...
  private final ConceptPresentation
      props_ActionTestChild1SubConcept = new ConceptPresentationBuilder().icon("child1subConcept.png", AdditionalStructurePropertiesImpl.class).create();
  private final ConceptPresentation props_ActionTestChild2 = new ConceptPresentationBuilder().icon("child2.png", AdditionalStructurePropertiesImpl.class).create();
