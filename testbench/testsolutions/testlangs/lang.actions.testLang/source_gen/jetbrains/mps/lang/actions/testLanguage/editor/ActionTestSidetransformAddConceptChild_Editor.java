...
public class ActionTestSidetransformAddConceptChild_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createCollection_f8pdpu_a(EditorContext editorContext, SNode node) {
    ...
    editorCell.addEditorCell(this.createConstant_f8pdpu_a0(editorContext, node));
    editorCell.addEditorCell(this.createConstant_f8pdpu_b0(editorContext, node));
