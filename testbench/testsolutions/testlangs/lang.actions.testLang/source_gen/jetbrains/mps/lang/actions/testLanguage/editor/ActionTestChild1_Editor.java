...
public class ActionTestChild1_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createCollection_ynwskn_a(EditorContext editorContext, SNode node) {
    ...
    editorCell.addEditorCell(this.createCollection_ynwskn_d0(editorContext, node));
  ...
  private EditorCell createCollection_ynwskn_d0(EditorContext editorContext, SNode node) {
    ...
    editorCell.getStyle().putAll(style);
    editorCell.addEditorCell(this.createConstant_ynwskn_a3a(editorContext, node));
    editorCell.addEditorCell(this.createConstant_ynwskn_b3a(editorContext, node));
  ...
  private static class child1ListHandler_ynwskn_c3a extends RefNodeListHandler {
    ...
    public EditorCell createEmptyCell(EditorContext editorContext) {
      editorContext.getCellFactory().pushCellContext();
      editorContext.getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(child1ListHandler_ynwskn_c3a.this.getOwner(), MetaAdapterFactory.getContainmentLink(0x737ed1fffa634ebcL, 0xa834435499b23c64L, 0x2365c14e167220f9L, 0x7f805f0c2dd46343L, "child1")));
      try {
