...
public class NamedSubstituteMenu extends SubstituteMenuBase {
  ...
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new ConstraintsFilteringSubstituteMenuPartDecorator(new NamedSubstituteMenu.SubstituteMenuPart_Action_75hh6x_a(), MetaAdapterFactory.getConcept(0xcb6d57037c8e46a9L, 0xb993c1373dc0942fL, 0x7ce1116e3a6fb0beL, "jetbrains.mps.lang.editor.menus.substitute.testLanguage.structure.TestSubstituteChild")));
    return result;
  }
  private class SubstituteMenuPart_Action_75hh6x_a extends SingleItemSubstituteMenuPart {
    ...
    protected SubstituteMenuItem createItem(SubstituteMenuContext _context) {
      return new NamedSubstituteMenu.SubstituteMenuPart_Action_75hh6x_a.Item(_context);
    }
