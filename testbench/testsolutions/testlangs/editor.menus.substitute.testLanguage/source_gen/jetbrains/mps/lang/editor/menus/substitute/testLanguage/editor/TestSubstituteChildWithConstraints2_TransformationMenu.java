...
public class TestSubstituteChildWithConstraints2_TransformationMenu extends TransformationMenuBase {
  ...
  private class TransformationMenuPart_Action_pma3ru_a0 extends SingleItemMenuPart<TransformationMenuItem, TransformationMenuContext> {
    @Nullable
    protected TransformationMenuItem createItem(TransformationMenuContext context) {
      return new TestSubstituteChildWithConstraints2_TransformationMenu.TransformationMenuPart_Action_pma3ru_a0.Item(context);
    }
  ...
  private class TransformationMenuPart_Action_pma3ru_b0 extends SingleItemMenuPart<TransformationMenuItem, TransformationMenuContext> {
    @Nullable
    protected TransformationMenuItem createItem(TransformationMenuContext context) {
      return new TestSubstituteChildWithConstraints2_TransformationMenu.TransformationMenuPart_Action_pma3ru_b0.Item(context);
    }
  ...
  private class TransformationMenuPart_Action_pma3ru_c0 extends SingleItemMenuPart<TransformationMenuItem, TransformationMenuContext> {
    @Nullable
    protected TransformationMenuItem createItem(TransformationMenuContext context) {
      return new TestSubstituteChildWithConstraints2_TransformationMenu.TransformationMenuPart_Action_pma3ru_c0.Item(context);
    }
