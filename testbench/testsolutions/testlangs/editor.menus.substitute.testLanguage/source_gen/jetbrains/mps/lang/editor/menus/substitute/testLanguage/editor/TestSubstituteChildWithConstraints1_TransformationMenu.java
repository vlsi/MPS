...
public class TestSubstituteChildWithConstraints1_TransformationMenu extends TransformationMenuBase {
  ...
  protected List<MenuPart<TransformationMenuItem, TransformationMenuContext>> getParts(TransformationMenuContext _context) {
    ...
    if (ListSequence.fromListAndArray(new ArrayList<String>(), MenuLocations.LEFT_SIDE_TRANSFORM).contains(_context.getMenuLocation())) {
      result.add(new TestSubstituteChildWithConstraints1_TransformationMenu.TransformationMenuPart_Action_szzd63_a0());
      result.add(new TestSubstituteChildWithConstraints1_TransformationMenu.TransformationMenuPart_Action_szzd63_b0());
      result.add(new TestSubstituteChildWithConstraints1_TransformationMenu.TransformationMenuPart_Action_szzd63_c0());
    }
    return result;
  }
