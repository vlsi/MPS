...
public class Checkbox_KeyMap_i0 extends KeyMapImpl {
  public Checkbox_KeyMap_i0() {
    this.setApplicableToEveryModel(false);
    KeyMapAction action;
    action = new Checkbox_KeyMap_i0.Checkbox_KeyMap_i0_Action0();
    this.putAction("none", "VK_SPACE", action);
  }
  public static class Checkbox_KeyMap_i0_Action0 extends KeyMapActionImpl {
    public Checkbox_KeyMap_i0_Action0() {
