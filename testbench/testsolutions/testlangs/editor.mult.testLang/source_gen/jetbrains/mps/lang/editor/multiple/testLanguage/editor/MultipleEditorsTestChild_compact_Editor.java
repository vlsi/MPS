...
public class MultipleEditorsTestChild_compact_Editor extends DefaultNodeEditor {
  ...
  public EditorCell createInspectedCell(EditorContext editorContext, SNode node) {
    return this.createConstant_bdtuju_a(editorContext, node);
  }
  private EditorCell createCollection_bdtuju_a(EditorContext editorContext, SNode node) {
    ...
    editorCell.addEditorCell(this.createProperty_bdtuju_a0(editorContext, node));
    editorCell.addEditorCell(this.createConstant_bdtuju_b0(editorContext, node));
    editorCell.addEditorCell(this.createProperty_bdtuju_c0(editorContext, node));
    editorCell.addEditorCell(this.createConstant_bdtuju_d0(editorContext, node));
  ...
  private EditorCell createConstant_bdtuju_a(EditorContext editorContext, SNode node) {
