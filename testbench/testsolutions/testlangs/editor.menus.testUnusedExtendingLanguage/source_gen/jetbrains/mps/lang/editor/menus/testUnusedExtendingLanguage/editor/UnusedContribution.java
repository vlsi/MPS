...
public class UnusedContribution extends TransformationMenuBase {
  ...
  protected List<MenuPart<TransformationMenuItem, TransformationMenuContext>> getParts(TransformationMenuContext _context) {
    ...
    if (ListSequence.fromListAndArray(new ArrayList<String>(), "test location").contains(_context.getMenuLocation())) {
      result.add(new UnusedContribution.TransformationMenuPart_Action_upxn7_a0());
    }
    return result;
  }

  private static class TransformationMenuPart_Action_upxn7_a0 extends SingleItemMenuPart<TransformationMenuItem, TransformationMenuContext> {
    @Nullable
    protected TransformationMenuItem createItem(TransformationMenuContext context) {
      return new UnusedContribution.TransformationMenuPart_Action_upxn7_a0.Item(context);
    }
