...
public class ImplicitEnumMethodImplementation_Test extends BaseTransformationTest {
  ...
  public static class TestBody extends BaseTestBody {
    public void test_ErrorMessagesCheck8841676161362742012() throws Exception {
      ...
      NodeCheckOperation_BehaviorDescriptor.perform_iddCRb6FLnvk.invoke(operation, this.getRealNodeById("8841676161362741755"));
    }
    public void test_ErrorMessagesCheck8841676161362742874() throws Exception {
      ...
      NodeCheckOperation_BehaviorDescriptor.perform_iddCRb6FLnvk.invoke(operation, this.getRealNodeById("8841676161362742601"));
    }
    public void test_NodeEnumHasUnimplementedMethodsCheck8841676161362904735() throws Exception {
      ...
      NodeCheckOperation_BehaviorDescriptor.perform_iddCRb6FLnvk.invoke(operation, this.getRealNodeById("8841676161362736760"));
    }
    public void test_ErrorMessagesCheck8841676161362737481() throws Exception {
      ...
      NodeCheckOperation_BehaviorDescriptor.perform_iddCRb6FLnvk.invoke(operation, this.getRealNodeById("8841676161362736758"));
    }
    public void test_NodeEnumConstantHasUnimplementedCheck8841676161362737703() throws Exception {
      ...
      NodeCheckOperation_BehaviorDescriptor.perform_iddCRb6FLnvk.invoke(operation, this.getRealNodeById("8841676161362737582"));
    }
    public void test_NodeEnumConstantHasUnimplementedCheck8841676161362737723() throws Exception {
      ...
      NodeCheckOperation_BehaviorDescriptor.perform_iddCRb6FLnvk.invoke(operation, this.getRealNodeById("8841676161362737645"));
    }
    public void test_ErrorMessagesCheck8841676161362737639() throws Exception {
      ...
      NodeCheckOperation_BehaviorDescriptor.perform_iddCRb6FLnvk.invoke(operation, this.getRealNodeById("8841676161362737487"));
    }
    public void test_ErrorMessagesCheck8841676161362738093() throws Exception {
      ...
      NodeCheckOperation_BehaviorDescriptor.perform_iddCRb6FLnvk.invoke(operation, this.getRealNodeById("8841676161362738021"));
    }
  }
}
