...
public class RemoveSynchronizedDelete_Test extends BaseTransformationTest {
  public RemoveSynchronizedDelete_Test() {
  }
  @Test
  public void test_RemoveSynchronizedDelete() throws Throwable {
    this.initTest("${mps_home}", "r:914ee49a-537d-44b2-a5fb-bac87a54743d(jetbrains.mps.editorTest@tests)");
    this.runTest("jetbrains.mps.editorTest.RemoveSynchronizedDelete_Test$TestBody", "testMethod", false);
  }
  @MPSLaunch
  public static class TestBody extends BaseEditorTestBody {
    ...
    public void testMethodImpl() throws Exception {
      initEditor("6131265013450951071", "6131265013450951080");
