...
<solution name="jetbrains.mps.lang.editor.table.tests" uuid="69de002c-bbba-40be-be5b-f3a6e61ea828" pluginKind="PLUGIN_OTHER" compileInMPS="true" generatorOutputPath="${module}/source_gen">
  <models>
