...
public class RH_conflicting2_Extension extends Extension.Default<IHttpRequestHandlerFactory> {
  public RH_conflicting2_Extension() {
  ...
  public IHttpRequestHandlerFactory factory = new IHttpRequestHandlerFactory() {
    ...
    public String getHandlerName() {
      return "RH_conflicting2";
    }
    @NotNull
    public IHttpRequestHandler create(@NotNull HttpRequest request) {
      return new RH_conflicting2_RequestHandler(request);
    }
  };
