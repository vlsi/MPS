...
public class RH_conflicting1_Extension extends Extension.Default<IHttpRequestHandlerFactory> {
  public RH_conflicting1_Extension() {
  ...
  public IHttpRequestHandlerFactory factory = new IHttpRequestHandlerFactory() {
    ...
    public String getHandlerName() {
      return "RH_conflicting1";
    }
    @NotNull
    public IHttpRequestHandler create(@NotNull HttpRequest request) {
      return new RH_conflicting1_RequestHandler(request);
    }
  };
