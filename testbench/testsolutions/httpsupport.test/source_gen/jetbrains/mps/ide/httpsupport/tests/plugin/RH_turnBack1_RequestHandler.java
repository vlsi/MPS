...
public class RH_turnBack1_RequestHandler extends HttpRequestHandlerBase {

  private static final List<String> QUERY_PREFIX = ListSequence.fromListAndArray(new ArrayList<String>(), "handlerTest", "turnBack1");

  private final boolean myCorrectRequest;
  private final String param;

  public RH_turnBack1_RequestHandler(HttpRequest request) {
    super(request);
