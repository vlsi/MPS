...
public class RH_conditional_Extension extends Extension.Default<IHttpRequestHandlerFactory> {
  public RH_conditional_Extension() {
  ...
  public IHttpRequestHandlerFactory factory = new IHttpRequestHandlerFactory() {
    ...
    public String getHandlerName() {
      return "RH_conditional";
    }
    @NotNull
    public IHttpRequestHandler create(@NotNull HttpRequest request) {
      return new RH_conditional_RequestHandler(request);
    }
  };
