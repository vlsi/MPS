...
public class RH_turnBack1_Extension extends Extension.Default<IHttpRequestHandlerFactory> {
  public RH_turnBack1_Extension() {
  ...
  public IHttpRequestHandlerFactory factory = new IHttpRequestHandlerFactory() {
    ...
    public IHttpRequestHandler create(@NotNull HttpRequest request) {
      return new RH_turnBack1_RequestHandler(request);
    }
  };
