...
<model ref="r:5a4d10fc-2567-46c5-982f-547e9102417b(jetbrains.mps.lang.editor.contextAssistant.tests@tests)">
  ...
  <languages>
    ...
    <use id="9a629f9a-abc9-4c29-b1b8-db7f349f7fbc" name="jetbrains.mps.lang.editor.contextAssistant.testLanguage" version="0" />
  </languages>
  <imports>
  ...
  <registry>
    ...
    <language id="9a629f9a-abc9-4c29-b1b8-db7f349f7fbc" name="jetbrains.mps.lang.editor.contextAssistant.testLanguage">
      <concept id="5578424278096849485" name="jetbrains.mps.lang.editor.contextAssistant.testLanguage.structure.Parent" flags="ng" index="1N2y4u">
        <child id="5578424278096849496" name="children" index="1N2y4b" />
      </concept>
      <concept id="5578424278096849458" name="jetbrains.mps.lang.editor.contextAssistant.testLanguage.structure.Child" flags="ng" index="1N2y5x" />
      <concept id="1966322953445209147" name="jetbrains.mps.lang.editor.contextAssistant.testLanguage.structure.SubconceptOfChild" flags="ng" index="3UxrLP" />
    </language>
      ...
      <node concept="3cpWs8" id="2T54UntRcHR" role="3cqZAp">
        <node concept="3cpWsn" id="2T54UntRcHS" role="3cpWs9">
          ...
          <node concept="3uibUv" id="2T54UntRcHO" role="1tU5fm">
            <ref role="3uigEE" to="rzvg:~ContextAssistantManager" resolve="ContextAssistantManager" />
          </node>
      ...
      <node concept="3clFbF" id="7G6Xcdz6r77" role="3cqZAp">
        <node concept="2OqwBi" id="7G6Xcdz6tpj" role="3clFbG">
          ...
          <node concept="liA8E" id="7G6Xcdz6trl" role="2OqNvi">
            <ref role="37wK5l" to="rzvg:~ContextAssistantManager.updateImmediately():void" resolve="updateImmediately" />
          </node>
        </node>
      </node>
        ...
        <node concept="3cpWsn" id="5ngDOM8uWhy" role="3cpWs9">
          ...
          <node concept="2OqwBi" id="jKDdcutlDu" role="33vP2m">
            ...
            <node concept="liA8E" id="jKDdcutlFZ" role="2OqNvi">
              <ref role="37wK5l" to="rzvg:~ContextAssistantManager.getActiveMenuItems():java.util.List" resolve="getActiveMenuItems" />
            </node>
          </node>
        </node>
      </node>
              ...
              <node concept="3clFbS" id="1H9M4VxNiQq" role="1bW5cS">
                <node concept="3cpWs8" id="1H9M4VxNiQr" role="3cqZAp">
                  <node concept="3cpWsn" id="1H9M4VxNiQs" role="3cpWs9">
                    <property role="TrG5h" value="contextAssistantManager" />
                    <node concept="3uibUv" id="1H9M4VxNiQt" role="1tU5fm">
                      <ref role="3uigEE" to="rzvg:~ContextAssistantManager" resolve="ContextAssistantManager" />
                    </node>
                ...
                <node concept="3clFbF" id="1H9M4VxNmuH" role="3cqZAp">
                  <node concept="2OqwBi" id="1H9M4VxNmuI" role="3clFbG">
                    ...
                    <node concept="liA8E" id="1H9M4VxNmuM" role="2OqNvi">
                      <ref role="37wK5l" to="lwvz:~SelectionManager.setSelection(org.jetbrains.mps.openapi.model.SNode):void" resolve="setSelection" />
                      <node concept="3xONca" id="1H9M4VxNmAp" role="37wK5m">
                ...
                <node concept="3clFbF" id="1H9M4VxNmTn" role="3cqZAp">
                  <node concept="2OqwBi" id="1H9M4VxNmTo" role="3clFbG">
                    ...
                    <node concept="liA8E" id="1H9M4VxNmTs" role="2OqNvi">
                      <ref role="37wK5l" to="lwvz:~SelectionManager.setSelection(org.jetbrains.mps.openapi.model.SNode):void" resolve="setSelection" />
                      <node concept="3xONca" id="1H9M4VxNmZw" role="37wK5m">
                        <ref role="3xOPvv" node="1H9M4VxNmhx" resolve="derived" />
                      </node>
                    </node>
                  </node>
                </node>
