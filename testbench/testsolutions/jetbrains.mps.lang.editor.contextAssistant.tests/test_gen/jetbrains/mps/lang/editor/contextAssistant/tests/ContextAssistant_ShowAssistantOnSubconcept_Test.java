    ...
    public void testMethodImpl() throws Exception {
      ...
      editorContext.getRepository().getModelAccess().runReadInEDT(new Runnable() {
        public void run() {
          ...
          getEditorComponent().getSelectionManager().setSelection(SNodeOperations.cast(getNodeById("9025427969322528788"), MetaAdapterFactory.getConcept(0x9a629f9aabc94c29L, 0xb1b8db7f349f7fbcL, 0x7d40c2eb5957a904L, "jetbrains.mps.lang.editor.contextAssistant.testLanguage.structure.OtherSubconceptOfChild")));
