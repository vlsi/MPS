...
public class WildCardTypeIsAValidSubstituteForBoundedParameter_Test extends BaseTransformationTest {
  ...
  public static class TestBody extends BaseTestBody {
    public void test_NodeWarningCheck595838485961914360() throws Exception {
      ...
      NodeCheckOperation_BehaviorDescriptor.perform_iddCRb6FLnvk.invoke(operation, this.getRealNodeById("595838485955112039"));
    }
    public void test_NodeErrorCheck595838485955120512() throws Exception {
      ...
      NodeCheckOperation_BehaviorDescriptor.perform_iddCRb6FLnvk.invoke(operation, this.getRealNodeById("595838485955112480"));
    }
    public void test_NodeWarningCheck595838485961915035() throws Exception {
      ...
      NodeCheckOperation_BehaviorDescriptor.perform_iddCRb6FLnvk.invoke(operation, this.getRealNodeById("595838485955112302"));
    }
    public void test_NodeWarningCheck595838485961916732() throws Exception {
      ...
      NodeCheckOperation_BehaviorDescriptor.perform_iddCRb6FLnvk.invoke(operation, this.getRealNodeById("595838485955114506"));
    }
    public void test_NodeWarningCheck595838485961917399() throws Exception {
      ...
      NodeCheckOperation_BehaviorDescriptor.perform_iddCRb6FLnvk.invoke(operation, this.getRealNodeById("595838485955117670"));
    }
    public void test_NodeWarningCheck595838485961918062() throws Exception {
      ...
      NodeCheckOperation_BehaviorDescriptor.perform_iddCRb6FLnvk.invoke(operation, this.getRealNodeById("595838485955150406"));
    }
    public void test_ErrorMessagesCheck595838485955141760() throws Exception {
      ...
      NodeCheckOperation_BehaviorDescriptor.perform_iddCRb6FLnvk.invoke(operation, this.getRealNodeById("595838485955086231"));
    }
  }
}
