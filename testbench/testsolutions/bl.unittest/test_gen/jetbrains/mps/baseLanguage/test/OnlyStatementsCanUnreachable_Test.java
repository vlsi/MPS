...
public class OnlyStatementsCanUnreachable_Test extends BaseTransformationTest {
  ...
  public static class TestBody extends BaseTestBody {
    public void test_NodeUnreachableNodeErrorCheck2156906680117409679() throws Exception {
      SNode operation = SNodeOperations.cast(this.getRealNodeById("2156906680117409679"), MetaAdapterFactory.getConcept(new UUID(-8825571760360698496l, -7431307307277756308l), 1215601147424l, "jetbrains.mps.lang.test.structure.NodeCheckOperation"));
    ...
    public void test_ErrorMessagesCheck1216231238662() throws Exception {
      SNode operation = SNodeOperations.cast(this.getRealNodeById("1216231238662"), MetaAdapterFactory.getConcept(new UUID(-8825571760360698496l, -7431307307277756308l), 1215601147424l, "jetbrains.mps.lang.test.structure.NodeCheckOperation"));
