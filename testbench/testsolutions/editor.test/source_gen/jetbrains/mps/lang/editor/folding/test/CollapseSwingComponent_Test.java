...
@MPSLaunch
public class CollapseSwingComponent_Test extends BaseTransformationTest {
  @Test
  public void test_CollapseSwingComponent() throws Throwable {
    initTest("${mps_home}", "r:0204c664-b836-4137-bb87-42caecd8a4e3(jetbrains.mps.lang.editor.folding.test)");
    runTest("jetbrains.mps.lang.editor.folding.test.CollapseSwingComponent_Test$TestBody", "testMethod", false);
  }
  ...
  public static class TestBody extends BaseEditorTestBody {
    ...
    public void testMethodImpl() throws Exception {
      initEditorComponent("5489671301386565014", "5489671301386645812");
