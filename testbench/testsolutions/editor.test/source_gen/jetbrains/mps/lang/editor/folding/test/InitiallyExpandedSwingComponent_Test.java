...
@MPSLaunch
public class InitiallyExpandedSwingComponent_Test extends BaseTransformationTest {
  @Test
  public void test_InitiallyExpandedSwingComponent() throws Throwable {
    initTest("${mps_home}", "r:0204c664-b836-4137-bb87-42caecd8a4e3(jetbrains.mps.lang.editor.folding.test)");
    runTest("jetbrains.mps.lang.editor.folding.test.InitiallyExpandedSwingComponent_Test$TestBody", "testMethod", false);
  }
  ...
  public static class TestBody extends BaseEditorTestBody {
    ...
    public void testMethodImpl() throws Exception {
      initEditorComponent("3824034168925550311", "");
