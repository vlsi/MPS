...
<solution name="jetbrains.mps.transformation.test.inputModels" uuid="cdd4e8a8-17c1-4f16-b054-27e94948bd47" pluginKind="PLUGIN_OTHER" compileInMPS="true" generatorOutputPath="${module}/source_gen">
  <models>
