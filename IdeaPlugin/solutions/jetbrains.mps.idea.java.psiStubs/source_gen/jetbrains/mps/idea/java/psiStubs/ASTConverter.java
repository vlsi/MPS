...
public class ASTConverter {
      ...
      public void visit(PsiField it) {
        if (it instanceof PsiEnumConstant) {
          ...
          if (needToSetId() && SPropertyOperations.getString(cnst, "name") != null) {
            cnst.setId(new jetbrains.mps.smodel.SNodeId.Foreign(childConverter.value.getIdPrefix() + "." + SPropertyOperations.getString(cnst, "name")));
          }
  ...
  public SNode convertMethod(PsiMethod x, SNode parentConcept) {
    ...
    if (x.isConstructor()) {
      ...
      if (((PsiAnnotationMethod) x).getDefaultValue() != null) {
        jetbrains.mps.smodel.SNode str = SConceptOperations.createNewNode("jetbrains.mps.baseLanguage.structure.StringLiteral", null);
    ...
    ListSequence.fromList(SLinkOperations.getTargets(method, "parameter", true)).addSequence(Sequence.fromIterable(Sequence.fromArray(x.getParameterList().getParameters())).select(new ISelector<PsiParameter, SNode>() {
      public SNode select(PsiParameter it) {
        jetbrains.mps.smodel.SNode param = SConceptOperations.createNewNode("jetbrains.mps.baseLanguage.structure.ParameterDeclaration", null);
  ...
  public SNode convertTypeParameter(PsiTypeParameter x) {
    jetbrains.mps.smodel.SNode typeVar = SConceptOperations.createNewNode("jetbrains.mps.baseLanguage.structure.TypeVariableDeclaration", null);
  ...
  public SNode resolveClass(PsiClassType t) {
    ...
    jetbrains.mps.smodel.SNode clsType = SConceptOperations.createNewNode("jetbrains.mps.baseLanguage.structure.ClassifierType", null);
  ...
  public SNode resolveAnnotation(PsiAnnotation a) {
    ...
    jetbrains.mps.smodel.SNode anno = SConceptOperations.createNewNode("jetbrains.mps.baseLanguage.structure.AnnotationInstance", null);
