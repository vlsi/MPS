 ...
 */
public class ProperModelsProjectSearchScope extends ProperModelsSearchScope {
  private Project myProject;

  public ProperModelsProjectSearchScope(Project project) {
    myProject = project;
  }
  ...
  public Iterable<SModule> getModules() {
    ...
    for (Module module : ModuleManager.getInstance(myProject).getModules()) {
      ...
      if (mpsFacet != null) {
        result.add(mpsFacet.getSolution());
      }
    }
    return result;
  }
