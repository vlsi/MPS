...
<model modelUID="r:714e1a8b-f5ef-43ca-864f-d3aa5fa2e53e(jetbrains.mps.idea.java.fastFind)">
  ...
  <import index="s08w" modelUID="f:java_stub#~MPS-core#org.jetbrains.mps.openapi.persistence(MPS-core/org.jetbrains.mps.openapi.persistence@java_stub)" version="-1" />
  ...
  <import index="mz8j" modelUID="f:java_stub#~MPS-core#org.jetbrains.mps.util(MPS-core/org.jetbrains.mps.util@java_stub)" version="-1" />
  <import index="yj1e" modelUID="f:java_stub#~IDEA IC#com.intellij.psi(IDEA IC/com.intellij.psi@java_stub)" version="-1" />
  <import index="kt3r" modelUID="f:java_stub#~MPS-core#org.jetbrains.mps.openapi.language(MPS-core/org.jetbrains.mps.openapi.language@java_stub)" version="-1" />
  ...
  <root id="3335509261457006477">
    <node role="implementedInterface" roleId="tpee.1095933932569" type="tpee.ClassifierType" typeId="tpee.1107535904670" id="6413223424270612688">
      <link role="classifier" roleId="tpee.1107535924139" targetNodeId="s08w.~NavigationParticipant" resolveInfo="NavigationParticipant" />
    </node>
    ...
    <node role="member" roleId="tpee.5375687026011219971" type="tpee.InstanceMethodDeclaration" typeId="tpee.1068580123165" id="2221716848402027316">
      ...
      <node role="parameter" roleId="tpee.1068580123134" type="tpee.ParameterDeclaration" typeId="tpee.1068498886292" id="2221716848402027320">
        ...
        <node role="type" roleId="tpee.5680397130376446158" type="tpee.ClassifierType" typeId="tpee.1107535904670" id="6413223424270627337">
          <link role="classifier" roleId="tpee.1107535924139" targetNodeId="s08w.~NavigationParticipant$TargetKind" resolveInfo="NavigationParticipant.TargetKind" />
        </node>
      </node>
      <node role="parameter" roleId="tpee.1068580123134" type="tpee.ParameterDeclaration" typeId="tpee.1068498886292" id="2221716848402027322">
        ...
        <node role="type" roleId="tpee.5680397130376446158" type="tpee.ClassifierType" typeId="tpee.1107535904670" id="2221716848402027323">
          ...
          <node role="parameter" roleId="tpee.1109201940907" type="tpee.ClassifierType" typeId="tpee.1107535904670" id="6413223424270633377">
            <link role="classifier" roleId="tpee.1107535924139" targetNodeId="s13e.~SModel" resolveInfo="SModel" />
          </node>
        </node>
      </node>
      <node role="parameter" roleId="tpee.1068580123134" type="tpee.ParameterDeclaration" typeId="tpee.1068498886292" id="2221716848402027325">
        ...
        <node role="type" roleId="tpee.5680397130376446158" type="tpee.ClassifierType" typeId="tpee.1107535904670" id="2221716848402027326">
          <link role="classifier" roleId="tpee.1107535924139" targetNodeId="mz8j.~Consumer" resolveInfo="Consumer" />
          <node role="parameter" roleId="tpee.1109201940907" type="tpee.ClassifierType" typeId="tpee.1107535904670" id="6665967467964840621">
            <link role="classifier" roleId="tpee.1107535924139" targetNodeId="s08w.~NavigationParticipant$NavigationTarget" resolveInfo="NavigationParticipant.NavigationTarget" />
          </node>
        </node>
      </node>
          ...
          <node role="body" roleId="tpee.1154032183016" type="tpee.StatementList" typeId="tpee.1068580123136" id="5895509475574050525">
            ...
            <node role="statement" roleId="tpee.1068581517665" type="tpee.ForeachStatement" typeId="tpee.1144226303539" id="6665967467965583166">
                    ...
                    <node role="statement" roleId="tpee.1068581517665" type="tpee.ExpressionStatement" typeId="tpee.1068580123155" id="7414633741220729953">
                      <node role="expression" roleId="tpee.1068580123156" type="tpee.DotExpression" typeId="tpee.1197027756228" id="7414633741220731298">
                        <node role="operation" roleId="tpee.1197027833540" type="tpee.InstanceMethodCallOperation" typeId="tpee.1202948039474" id="7414633741220736583">
                          <link role="baseMethodDeclaration" roleId="tpee.1068499141037" targetNodeId="mz8j.~Consumer%dconsume(java%dlang%dObject)%cvoid" resolveInfo="consume" />
                          <node role="actualArgument" roleId="tpee.1068499141038" type="tpee.GenericNewExpression" typeId="tpee.1145552977093" id="7414633741220737088">
                            <node role="creator" roleId="tpee.1145553007750" type="tpee.AnonymousClassCreator" typeId="tpee.1182160077978" id="7414633741220760523">
                              <node role="cls" roleId="tpee.1182160096073" type="tpee.AnonymousClass" typeId="tpee.1170345865475" id="7414633741220760526">
                                ...
                                <link role="classifier" roleId="tpee.1170346070688" targetNodeId="s08w.~NavigationParticipant$NavigationTarget" resolveInfo="NavigationParticipant.NavigationTarget" />
                                ...
                                <node role="member" roleId="tpee.5375687026011219971" type="tpee.InstanceMethodDeclaration" typeId="tpee.1068580123165" id="7414633741220760534">
                                  ...
                                  <node role="returnType" roleId="tpee.1068580123133" type="tpee.ClassifierType" typeId="tpee.1107535904670" id="6665967467965536535">
                                    <link role="classifier" roleId="tpee.1107535924139" targetNodeId="kt3r.~SConcept" resolveInfo="SConcept" />
                                  </node>
                                      ...
                                      <node role="ifTrue" roleId="tpee.1068580123161" type="tpee.StatementList" typeId="tpee.1068580123136" id="7414633741222028743">
                                        <node role="statement" roleId="tpee.1068581517665" type="tpee.ReturnStatement" typeId="tpee.1068581242878" id="7414633741222056036">
                                          <node role="expression" roleId="tpee.1068581517676" type="tpee.DotExpression" typeId="tpee.1197027756228" id="7414633741222071953">
                                            <node role="operand" roleId="tpee.1197027771414" type="tpee.StaticMethodCall" typeId="tpee.1081236700937" id="6665967467965556868">
                                              <link role="baseMethodDeclaration" roleId="tpee.1068499141037" targetNodeId="kt3r.~SConceptRepository%dgetInstance()%corg%djetbrains%dmps%dopenapi%dlanguage%dSConceptRepository" resolveInfo="getInstance" />
                                              <link role="classConcept" roleId="tpee.1144433194310" targetNodeId="kt3r.~SConceptRepository" resolveInfo="SConceptRepository" />
                                            </node>
                                            <node role="operation" roleId="tpee.1197027833540" type="tpee.InstanceMethodCallOperation" typeId="tpee.1202948039474" id="7414633741222076327">
                                              <link role="baseMethodDeclaration" roleId="tpee.1068499141037" targetNodeId="kt3r.~SConceptRepository%dgetConcept(java%dlang%dString)%corg%djetbrains%dmps%dopenapi%dlanguage%dSAbstractConcept" resolveInfo="getConcept" />
                                              <node role="actualArgument" roleId="tpee.1068499141038" type="tpee.StaticFieldReference" typeId="tpee.1070533707846" id="7414633741222027119">
                                                <link role="classifier" roleId="tpee.1144433057691" targetNodeId="2vhp.~BootstrapLanguages" resolveInfo="BootstrapLanguages" />
                                                <link role="variableDeclaration" roleId="tpee.1068581517664" targetNodeId="2vhp.~BootstrapLanguages%dconcept_baseLanguage_Annotation" resolveInfo="concept_baseLanguage_Annotation" />
                                              </node>
                                            </node>
                                          </node>
                                        </node>
                                            ...
                                            <node role="expression" roleId="tpee.1068581517676" type="tpee.DotExpression" typeId="tpee.1197027756228" id="7414633741222127278">
                                              <node role="operation" roleId="tpee.1197027833540" type="tpee.InstanceMethodCallOperation" typeId="tpee.1202948039474" id="7414633741222127279">
                                                ...
                                                <node role="actualArgument" roleId="tpee.1068499141038" type="tpee.StaticFieldReference" typeId="tpee.1070533707846" id="7414633741222127280">
                                                  <link role="classifier" roleId="tpee.1144433057691" targetNodeId="2vhp.~BootstrapLanguages" resolveInfo="BootstrapLanguages" />
                                                  <link role="variableDeclaration" roleId="tpee.1068581517664" targetNodeId="2vhp.~BootstrapLanguages%dconcept_baseLanguage_Interface" resolveInfo="concept_baseLanguage_Interface" />
                                                </node>
                                              </node>
                                            ...
                                            <node role="expression" roleId="tpee.1068581517676" type="tpee.DotExpression" typeId="tpee.1197027756228" id="7414633741222171551">
                                              <node role="operation" roleId="tpee.1197027833540" type="tpee.InstanceMethodCallOperation" typeId="tpee.1202948039474" id="7414633741222171552">
                                                ...
                                                <node role="actualArgument" roleId="tpee.1068499141038" type="tpee.StaticFieldReference" typeId="tpee.1070533707846" id="7414633741222171553">
                                                  <link role="classifier" roleId="tpee.1144433057691" targetNodeId="2vhp.~BootstrapLanguages" resolveInfo="BootstrapLanguages" />
                                                  <link role="variableDeclaration" roleId="tpee.1068581517664" targetNodeId="2vhp.~BootstrapLanguages%dconcept_baseLanguage_EnumClass" resolveInfo="concept_baseLanguage_EnumClass" />
                                                </node>
                                              </node>
                                            ...
                                            <node role="expression" roleId="tpee.1068581517676" type="tpee.DotExpression" typeId="tpee.1197027756228" id="7414633741222183838">
                                              <node role="operation" roleId="tpee.1197027833540" type="tpee.InstanceMethodCallOperation" typeId="tpee.1202948039474" id="7414633741222183839">
                                                ...
                                                <node role="actualArgument" roleId="tpee.1068499141038" type="tpee.StaticFieldReference" typeId="tpee.1070533707846" id="7414633741222183840">
                                                  <link role="classifier" roleId="tpee.1144433057691" targetNodeId="2vhp.~BootstrapLanguages" resolveInfo="BootstrapLanguages" />
                                                  <link role="variableDeclaration" roleId="tpee.1068581517664" targetNodeId="2vhp.~BootstrapLanguages%dconcept_baseLanguage_ClassConcept" resolveInfo="concept_baseLanguage_ClassConcept" />
                                                </node>
                                              </node>
              ...
              <node role="variable" roleId="tpee.1144230900587" type="tpee.LocalVariableDeclaration" typeId="tpee.1068581242863" id="6665967467965583585">
                ...
                <node role="type" roleId="tpee.5680397130376446158" type="tpee.ClassifierType" typeId="tpee.1107535904670" id="6665967467965595472">
