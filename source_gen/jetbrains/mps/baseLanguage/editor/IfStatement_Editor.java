...
public class IfStatement_Editor extends DefaultNodeEditor {
  ...
  public static boolean _QueryFunction_NodeCondition_1144224391504(SNode node, IScope scope) {
    return SLinkOperations.getTarget(node, "ifFalseStatement", true) != null;
  }
  public static boolean _QueryFunction_NodeCondition_1144223927084(SNode node, IScope scope) {
    return SLinkOperations.getTarget(node, "ifFalseStatement", true) != null;
  }
  public static boolean _QueryFunction_NodeCondition_1143135658648(SNode node, IScope scope) {
    return SLinkOperations.getTarget(node, "ifFalseStatement", true) != null;
  }
  ...
  public EditorCell createStatementBox(EditorContext context, SNode node) {
    ...
    if(IfStatement_Editor._QueryFunction_NodeCondition_1143135658648(node, context.getOperationContext().getScope())) {
      editorCell.addEditorCell(this.createIfFalseBranch(context, node));
    }
    if(IfStatement_Editor._QueryFunction_NodeCondition_1144223927084(node, context.getOperationContext().getScope())) {
      editorCell.addEditorCell(this.createIfFalseBranch1(context, node));
    }
    if(IfStatement_Editor._QueryFunction_NodeCondition_1144224391504(node, context.getOperationContext().getScope())) {
