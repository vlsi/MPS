...
public class NotExpression_Editor extends DefaultNodeEditor {
  ...
  public EditorCell createRowCell(EditorContext context, SNode node) {
    ...
    NotExpression_Editor.setupBasic_RowCell(editorCell, node, context);
  ...
  public EditorCell createConstantCell(EditorContext context, SNode node, String text) {
    ...
    NotExpression_Editor.setupBasic_ConstantCell(editorCell, node, context);
    NotExpression_Editor.setupLabel_ConstantCell(editorCell, node, context);
  ...
  public EditorCell createConstantCell1(EditorContext context, SNode node, String text) {
    EditorCell_Constant editorCell = new EditorCell_Constant(context, node, text);
    NotExpression_Editor.setupBasic_ConstantCell1(editorCell, node, context);
    NotExpression_Editor.setupLabel_ConstantCell1(editorCell, node, context);
    editorCell.setDefaultText("");
    return editorCell;
  }
  ...
  public EditorCell createExpressionCellinternal(EditorContext context, SNode node, CellProviderWithRole aProvider) {
    ...
    NotExpression_Editor.setupBasic_ExpressionCell(editorCell, node, context);
    if(editorCell instanceof EditorCell_Label) {
      NotExpression_Editor.setupLabel_ExpressionCell((EditorCell_Label)editorCell, node, context);
    }
