...
public class GenericNewExpression_Editor extends DefaultNodeEditor {
  ...
  private static void setupCreatorCell(EditorCell editorCell, SNode node, EditorContext context) {
  ...
  public EditorCell createExpressionBox(EditorContext context, SNode node) {
    ...
    GenericNewExpression_Editor.setupExpressionBox(editorCell, node, context);
  ...
  public EditorCell createConstantCell(EditorContext context, SNode node, String text) {
    ...
    GenericNewExpression_Editor.setupConstantCell(editorCell, node, context);
