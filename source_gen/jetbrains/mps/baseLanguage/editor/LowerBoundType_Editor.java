...
public class LowerBoundType_Editor extends DefaultNodeEditor {
  ...
  private static void setupBasic_ConstantCell1(EditorCell editorCell, SNode node, EditorContext context) {
    editorCell.putUserObject(EditorCell.CELL_ID, node.getId() + "_1171903882257");
    editorCell.setDrawBorder(false);
  }
  ...
  public EditorCell createRowCell(EditorContext context, SNode node) {
    ...
    LowerBoundType_Editor.setupBasic_RowCell(editorCell, node, context);
    editorCell.setGridLayout(false);
    editorCell.setUsesBraces(false);
    editorCell.setCanBeFolded(false);
    editorCell.addEditorCell(this.createConstantCell(context, node, "?"));
    editorCell.addEditorCell(this.createConstantCell1(context, node, "super"));
  ...
  public EditorCell createConstantCell(EditorContext context, SNode node, String text) {
    ...
    LowerBoundType_Editor.setupBasic_ConstantCell(editorCell, node, context);
    LowerBoundType_Editor.setupLabel_ConstantCell(editorCell, node, context);
  ...
  public EditorCell createConstantCell1(EditorContext context, SNode node, String text) {
    EditorCell_Constant editorCell = new EditorCell_Constant(context, node, text);
    LowerBoundType_Editor.setupBasic_ConstantCell1(editorCell, node, context);
    LowerBoundType_Editor.setupLabel_ConstantCell1(editorCell, node, context);
    editorCell.setDefaultText("");
    return editorCell;
  }
  ...
  public EditorCell createBoundCellinternal(EditorContext context, SNode node, CellProviderWithRole aProvider) {
    ...
    LowerBoundType_Editor.setupBasic_BoundCell(editorCell, node, context);
    if(editorCell instanceof EditorCell_Label) {
      LowerBoundType_Editor.setupLabel_BoundCell((EditorCell_Label)editorCell, node, context);
    }
