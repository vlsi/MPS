...
public class InstanceMethodDeclaration_Editor extends DefaultNodeEditor {
  ...
  public EditorCellListHandler myParameterListHandler;
  ...
  public EditorCell createMethodNameinternal(EditorContext context, SNode node) {
  ...
  public EditorCell createMethodName(EditorContext context, SNode node) {
    String propertyName = "name";
    EditorCell propertyCell = this.createMethodNameinternal(context, node);
  ...
  public EditorCell createReturnTypeinternal(EditorContext context, SNode node) {
  ...
  public EditorCell createReturnType(EditorContext context, SNode node) {
    String linkRole = "returnType";
    EditorCell refCell = this.createReturnTypeinternal(context, node);
  ...
  public EditorCell createParameterList(EditorContext context, SNode node) {
    ...
    editorCell.setDrawBrackets(false);
    editorCell.setBracketsColor(Color.black);
    editorCell.putUserObject(EditorCell.ROLE, "parameter");
    editorCell.setLayoutConstraint("");
    return editorCell;
  }
}
