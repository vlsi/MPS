...
public class EnumConstantReference_Editor extends DefaultNodeEditor {
  ...
  public EditorCell createEnumConstantDeclarationReferenceCellinternal(EditorContext context, SNode node) {
  ...
  public EditorCell createEnumConstantDeclarationReferenceCell(EditorContext context, SNode node) {
    String linkRole = "enumConstantDeclaration";
    EditorCell refCell = this.createEnumConstantDeclarationReferenceCellinternal(context, node);
