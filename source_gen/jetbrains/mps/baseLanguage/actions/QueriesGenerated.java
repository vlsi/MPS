...
public class QueriesGenerated {
  ...
  public static boolean nodeSubstituteActionsBuilder_Precondition_Expression_1198761649460(final IOperationContext operationContext, final NodeSubstitutePrecondition_ParameterObject _parameterObject) {
    return SNodeOperations.isInstanceOf(_parameterObject.getParentNode(), "jetbrains.mps.baseLanguage.structure.VariableDeclaration") || SNodeOperations.isInstanceOf(_parameterObject.getParentNode(), "jetbrains.mps.baseLanguage.structure.ArrayLiteral");
  }

  public static boolean nodeSubstituteActionsBuilder_Precondition_Statement_1177400765736(final IOperationContext operationContext, final NodeSubstitutePrecondition_ParameterObject _parameterObject) {
    SNode parent = SNodeOperations.getAncestorWhereConceptInList(_parameterObject.getParentNode(), new String[]{"jetbrains.mps.baseLanguage.structure.AbstractLoopStatement","jetbrains.mps.baseLanguage.structure.Closure"}, false, false);
    if(SNodeOperations.isInstanceOf(parent, "jetbrains.mps.baseLanguage.structure.AbstractLoopStatement")) {
      return true;
    }
    parent = SNodeOperations.getAncestorWhereConceptInList(_parameterObject.getParentNode(), new String[]{"jetbrains.mps.baseLanguage.structure.SwitchStatement"}, false, false);
  ...
  public static boolean nodeSubstituteActionsBuilder_Precondition_Visibility_1178549461018(final IOperationContext operationContext, final NodeSubstitutePrecondition_ParameterObject _parameterObject) {
    return SNodeOperations.isInstanceOf(_parameterObject.getParentNode(), "jetbrains.mps.baseLanguage.structure.Classifier") && SNodeOperations.getParent(_parameterObject.getParentNode(), null, false, false) == null;
  }

  public static boolean nodeSubstituteActionsBuilder_Precondition_Statement_1178893978039(final IOperationContext operationContext, final NodeSubstitutePrecondition_ParameterObject _parameterObject) {
    return SNodeOperations.getAncestor(_parameterObject.getParentNode(), "jetbrains.mps.baseLanguage.structure.ConstructorDeclaration", true, false) != null;
  }

  public static boolean nodeSubstituteActionsBuilder_Precondition_Expression_1188219568912(final IOperationContext operationContext, final NodeSubstitutePrecondition_ParameterObject _parameterObject) {
    return SNodeOperations.getAncestor(_parameterObject.getParentNode(), "jetbrains.mps.baseLanguage.structure.AnnotationInstance", true, false) != null;
  }

  public static boolean nodeSubstituteActionsBuilder_Precondition_Expression_1197884253309(final IOperationContext operationContext, final NodeSubstitutePrecondition_ParameterObject _parameterObject) {
  ...
  public static List<INodeSubstituteAction> nodeSubstituteActionsBuilder_ActionsFactory_Expression_1177334764520(final IOperationContext operationContext, final NodeSubstituteActionsFactory_ParameterObject _parameterObject) {
  ...
  public static List<INodeSubstituteAction> nodeSubstituteActionsBuilder_ActionsFactory_Expression_1198761609306(final IOperationContext operationContext, final NodeSubstituteActionsFactory_ParameterObject _parameterObject) {
    List<INodeSubstituteAction> result = new ArrayList<INodeSubstituteAction>();
    {
  ...
  public static List<INodeSubstituteAction> nodeSubstituteActionsBuilder_ActionsFactory_Expression_1177361135564(final IOperationContext operationContext, final NodeSubstituteActionsFactory_ParameterObject _parameterObject) {
    List<INodeSubstituteAction> result = new ArrayList<INodeSubstituteAction>();
    {
      ...
      Calculable calc = new Calculable() {
        ...
        public Object calculate() {
          SNode classConcept = SNodeOperations.getAncestor(_parameterObject.getParentNode(), "jetbrains.mps.baseLanguage.structure.ClassConcept", false, false);
          ISearchScope searchScope = Classifier_Behavior.call_getVisibleMembersSearchScope_1189552517057(classConcept, _parameterObject.getParentNode(), IClassifiersSearchScope.INSTANCE_FIELD);
  ...
  public static List<INodeSubstituteAction> nodeSubstituteActionsBuilder_ActionsFactory_Expression_1197031199065(final IOperationContext operationContext, final NodeSubstituteActionsFactory_ParameterObject _parameterObject) {
    List<INodeSubstituteAction> result = new ArrayList<INodeSubstituteAction>();
    {
      ...
      for(SNode item : queryResult) {
        result.add(new DefaultChildNodeSubstituteAction(item, _parameterObject.getParentNode(), _parameterObject.getCurrentTargetNode(), _parameterObject.getChildSetter(), operationContext.getScope()) {
          ...
          public SNode createChildNode(Object parameterObject, SModel model, String pattern) {
            SNode operationExpression = SModelOperations.createNewNode(model, "jetbrains.mps.baseLanguage.structure.OperationExpression", _parameterObject.getCurrentTargetNode());
  ...
  public static List<INodeSubstituteAction> nodeSubstituteActionsBuilder_ActionsFactory_Expression_1177362994569(final IOperationContext operationContext, final NodeSubstituteActionsFactory_ParameterObject _parameterObject) {
    List<INodeSubstituteAction> result = new ArrayList<INodeSubstituteAction>();
    {
      ...
      Calculable calc = new Calculable() {
        ...
        public Object calculate() {
          SNode classConcept = SNodeOperations.getAncestor(_parameterObject.getParentNode(), "jetbrains.mps.baseLanguage.structure.ClassConcept", false, false);
          ISearchScope searchScope = Classifier_Behavior.call_getVisibleMembersSearchScope_1189552517057(classConcept, _parameterObject.getParentNode(), IClassifiersSearchScope.INSTANCE_METHOD);
          return searchScope.getNodes();
        }
  ...
  public static List<INodeSubstituteAction> nodeSubstituteActionsBuilder_ActionsFactory_Expression_1177396179719(final IOperationContext operationContext, final NodeSubstituteActionsFactory_ParameterObject _parameterObject) {
    List<INodeSubstituteAction> result = new ArrayList<INodeSubstituteAction>();
    {
      ...
      Calculable calc = new Calculable() {
        ...
        public Object calculate() {
          IClassifiersSearchScope searchScope = new VisibleClassifiersScope(SNodeOperations.getModel(_parameterObject.getParentNode()), IClassifiersSearchScope.CLASSIFFIER, operationContext.getScope());
  ...
  public static List<INodeSubstituteAction> nodeSubstituteActionsBuilder_ActionsFactory_Expression_1177397791368(final IOperationContext operationContext, final NodeSubstituteActionsFactory_ParameterObject _parameterObject) {
    List<INodeSubstituteAction> result = new ArrayList<INodeSubstituteAction>();
    {
      ...
      Calculable calc = new Calculable() {
        ...
        public Object calculate() {
          SNode parentFunction = SNodeOperations.getAncestor(_parameterObject.getParentNode(), "jetbrains.mps.baseLanguage.structure.ConceptFunction", false, false);
  ...
  public static List<INodeSubstituteAction> nodeSubstituteActionsBuilder_ActionsFactory_Statement_1177400765735(final IOperationContext operationContext, final NodeSubstituteActionsFactory_ParameterObject _parameterObject) {
    List<INodeSubstituteAction> result = new ArrayList<INodeSubstituteAction>();
    {
  ...
  public static List<INodeSubstituteAction> nodeSubstituteActionsBuilder_ActionsFactory_Statement_1177403614729(final IOperationContext operationContext, final NodeSubstituteActionsFactory_ParameterObject _parameterObject) {
    List<INodeSubstituteAction> result = new ArrayList<INodeSubstituteAction>();
    {
  ...
  public static List<INodeSubstituteAction> nodeSubstituteActionsBuilder_ActionsFactory_Statement_1177406371457(final IOperationContext operationContext, final NodeSubstituteActionsFactory_ParameterObject _parameterObject) {
    List<INodeSubstituteAction> result = new ArrayList<INodeSubstituteAction>();
    {
  ...
  public static List<INodeSubstituteAction> nodeSubstituteActionsBuilder_ActionsFactory_Statement_1177406968279(final IOperationContext operationContext, final NodeSubstituteActionsFactory_ParameterObject _parameterObject) {
    List<INodeSubstituteAction> result = new ArrayList<INodeSubstituteAction>();
    {
      ConceptDeclaration concept = SModelUtil_new.findConceptDeclaration("jetbrains.mps.baseLanguage.structure.LocalVariableDeclarationStatement", operationContext.getScope());
  ...
  public static List<INodeSubstituteAction> nodeSubstituteActionsBuilder_ActionsFactory_ParameterDeclaration_1177408380007(final IOperationContext operationContext, final NodeSubstituteActionsFactory_ParameterObject _parameterObject) {
    List<INodeSubstituteAction> result = new ArrayList<INodeSubstituteAction>();
    {
  ...
  public static List<INodeSubstituteAction> nodeSubstituteActionsBuilder_ActionsFactory_Visibility_1178549410741(final IOperationContext operationContext, final NodeSubstituteActionsFactory_ParameterObject _parameterObject) {
    List<INodeSubstituteAction> result = new ArrayList<INodeSubstituteAction>();
    return result;
  }

  public static List<INodeSubstituteAction> nodeSubstituteActionsBuilder_ActionsFactory_Statement_1178893908066(final IOperationContext operationContext, final NodeSubstituteActionsFactory_ParameterObject _parameterObject) {
    List<INodeSubstituteAction> result = new ArrayList<INodeSubstituteAction>();
    {
      ...
      Calculable calc = new Calculable() {
        ...
        public Object calculate() {
          SNode classConcept = SNodeOperations.getAncestor(_parameterObject.getParentNode(), "jetbrains.mps.baseLanguage.structure.ClassConcept", false, false);
          SNode currentConstr = SNodeOperations.getAncestor(_parameterObject.getParentNode(), "jetbrains.mps.baseLanguage.structure.ConstructorDeclaration", true, false);
      ...
      for(SNode item : queryResult) {
        result.add(new DefaultChildNodeSubstituteAction(item, _parameterObject.getParentNode(), _parameterObject.getCurrentTargetNode(), _parameterObject.getChildSetter(), operationContext.getScope()) {
          ...
          public SNode createChildNode(Object parameterObject, SModel model, String pattern) {
            SNode newNode = SModelOperations.createNewNode(model, "jetbrains.mps.baseLanguage.structure.ThisConstructorInvocation", _parameterObject.getCurrentTargetNode());
            SLinkOperations.setTarget(newNode, "constructorDeclaration", ((SNode)this.getParameterObject()), false);
            if(SNodeOperations.isInstanceOf(_parameterObject.getCurrentTargetNode(), "jetbrains.mps.baseLanguage.structure.ThisConstructorInvocation")) {
              {
                ICursor<SNode> _zCursor2 = CursorFactory.createCursor(SLinkOperations.getTargets(_parameterObject.getCurrentTargetNode(), "actualArgument", true));
                try {
    ...
    }
    {
      ...
      for(SNode item : queryResult) {
        result.add(new DefaultChildNodeSubstituteAction(item, _parameterObject.getParentNode(), _parameterObject.getCurrentTargetNode(), _parameterObject.getChildSetter(), operationContext.getScope()) {
          ...
          public SNode createChildNode(Object parameterObject, SModel model, String pattern) {
            SNode newNode = SModelOperations.createNewNode(model, "jetbrains.mps.baseLanguage.structure.SuperConstructorInvocation", _parameterObject.getCurrentTargetNode());
            SLinkOperations.setTarget(newNode, "constructorDeclaration", ((SNode)this.getParameterObject()), false);
            if(SNodeOperations.isInstanceOf(_parameterObject.getCurrentTargetNode(), "jetbrains.mps.baseLanguage.structure.SuperConstructorInvocation")) {
              {
                ICursor<SNode> _zCursor3 = CursorFactory.createCursor(SLinkOperations.getTargets(_parameterObject.getCurrentTargetNode(), "actualArgument", true));
                try {
  ...
  public static List<INodeSubstituteAction> nodeSubstituteActionsBuilder_ActionsFactory_Expression_1188219521578(final IOperationContext operationContext, final NodeSubstituteActionsFactory_ParameterObject _parameterObject) {
    List<INodeSubstituteAction> result = new ArrayList<INodeSubstituteAction>();
    {
  ...
  public static List<INodeSubstituteAction> nodeSubstituteActionsBuilder_ActionsFactory_Expression_1197884213577(final IOperationContext operationContext, final NodeSubstituteActionsFactory_ParameterObject _parameterObject) {
    List<INodeSubstituteAction> result = new ArrayList<INodeSubstituteAction>();
    {
  ...
  public static List<INodeSubstituteAction> rightTransform_ActionsFactory_Expression_1138168906052(final IOperationContext operationContext, final RTActionsBuilder_ParameterObject _parameterObject) {
    List<INodeSubstituteAction> result = new ArrayList<INodeSubstituteAction>();
    {
      ...
      for(final AbstractConceptDeclaration abstractConcept : SModelUtil_new.getSubconcepts(concept, _parameterObject.getModel(), operationContext.getScope())) {
        ...
        result.add(new AbstractRTransformHintSubstituteAction(currentConcept.getNode(), _parameterObject.getSourceNode()) {

          public SNode doSubstitute(String pattern) {
            SNode result = SModelUtil_new.instantiateConceptDeclaration(currentConcept, _parameterObject.getModel()).getNode();
  ...
  public static List<INodeSubstituteAction> rightTransform_ActionsFactory_Expression_1177499026995(final IOperationContext operationContext, final RTActionsBuilder_ParameterObject _parameterObject) {
    List<INodeSubstituteAction> result = new ArrayList<INodeSubstituteAction>();
    {
      ConceptDeclaration concept = SModelUtil_new.findConceptDeclaration("jetbrains.mps.baseLanguage.structure.FieldReference", operationContext.getScope());
      result.add(new AbstractRTransformHintSubstituteAction(BaseAdapter.fromAdapter(concept), _parameterObject.getSourceNode()) {
        ...
        public SNode doSubstitute(String pattern) {
          SNode result = SModelOperations.createNewNode(_parameterObject.getModel(), "jetbrains.mps.baseLanguage.structure.FieldReference", null);
          SNodeOperations.replaceWithAnother(_parameterObject.getSourceNode(), result);
          SLinkOperations.setTarget(result, "instance", _parameterObject.getSourceNode(), true);
          return result;
        }
  ...
  public static List<INodeSubstituteAction> rightTransform_ActionsFactory_Expression_1197028841767(final IOperationContext operationContext, final RTActionsBuilder_ParameterObject _parameterObject) {
    List<INodeSubstituteAction> result = new ArrayList<INodeSubstituteAction>();
    {
      ConceptDeclaration concept = SModelUtil_new.findConceptDeclaration("jetbrains.mps.baseLanguage.structure.OperationExpression", operationContext.getScope());
      result.add(new AbstractRTransformHintSubstituteAction(BaseAdapter.fromAdapter(concept), _parameterObject.getSourceNode()) {
        ...
        public SNode doSubstitute(String pattern) {
          SNode operationExpression = SNodeOperations.replaceWithNewChild(_parameterObject.getSourceNode(), "jetbrains.mps.baseLanguage.structure.OperationExpression");
          SLinkOperations.setTarget(operationExpression, "operand", _parameterObject.getSourceNode(), true);
          return operationExpression;
        }
  ...
  public static List<INodeSubstituteAction> rightTransform_ActionsFactory_IOperation_1197032086774(final IOperationContext operationContext, final RTActionsBuilder_ParameterObject _parameterObject) {
    List<INodeSubstituteAction> result = new ArrayList<INodeSubstituteAction>();
    {
      Calculable calc = new Calculable() {
  ...
  public static List<INodeSubstituteAction> rightTransform_ActionsFactory_Expression_1177502380176(final IOperationContext operationContext, final RTActionsBuilder_ParameterObject _parameterObject) {
    List<INodeSubstituteAction> result = new ArrayList<INodeSubstituteAction>();
    {
  ...
  public static List<INodeSubstituteAction> rightTransform_ActionsFactory_Expression_1177503307237(final IOperationContext operationContext, final RTActionsBuilder_ParameterObject _parameterObject) {
    List<INodeSubstituteAction> result = new ArrayList<INodeSubstituteAction>();
    {
      ...
      result.add(new AbstractRTransformHintSubstituteAction(BaseAdapter.fromAdapter(concept), _parameterObject.getSourceNode()) {
        ...
        public SNode doSubstitute(String pattern) {
          SNode assignment = SModelOperations.createNewNode(_parameterObject.getModel(), "jetbrains.mps.baseLanguage.structure.AssignmentExpression", null);
          SNodeOperations.replaceWithAnother(_parameterObject.getSourceNode(), assignment);
          SLinkOperations.setTarget(assignment, "lValue", _parameterObject.getSourceNode(), true);
          return assignment;
        }
  ...
  public static List<INodeSubstituteAction> rightTransform_ActionsFactory_Expression_1177503884612(final IOperationContext operationContext, final RTActionsBuilder_ParameterObject _parameterObject) {
    List<INodeSubstituteAction> result = new ArrayList<INodeSubstituteAction>();
    {
      ...
      result.add(new AbstractRTransformHintSubstituteAction(BaseAdapter.fromAdapter(concept), _parameterObject.getSourceNode()) {
        ...
        public SNode doSubstitute(String pattern) {
          SNode result = SModelOperations.createNewNode(_parameterObject.getModel(), "jetbrains.mps.baseLanguage.structure.ArrayAccessExpression", null);
          SNodeOperations.replaceWithAnother(_parameterObject.getSourceNode(), result);
          SLinkOperations.setTarget(result, "array", _parameterObject.getSourceNode(), true);
          return result;
        }
  ...
  public static List<INodeSubstituteAction> rightTransform_ActionsFactory_Expression_1177504604528(final IOperationContext operationContext, final RTActionsBuilder_ParameterObject _parameterObject) {
    List<INodeSubstituteAction> result = new ArrayList<INodeSubstituteAction>();
    {
      ...
      result.add(new AbstractRTransformHintSubstituteAction(BaseAdapter.fromAdapter(concept), _parameterObject.getSourceNode()) {
        ...
        public SNode doSubstitute(String pattern) {
          SNode result = SModelOperations.createNewNode(_parameterObject.getModel(), "jetbrains.mps.baseLanguage.structure.ArrayLengthExpression", null);
          SNodeOperations.replaceWithAnother(_parameterObject.getSourceNode(), result);
          SLinkOperations.setTarget(result, "array", _parameterObject.getSourceNode(), true);
          return result;
        }
  ...
  public static List<INodeSubstituteAction> rightTransform_ActionsFactory_VariableDeclaration_1177505054799(final IOperationContext operationContext, final RTActionsBuilder_ParameterObject _parameterObject) {
    List<INodeSubstituteAction> result = new ArrayList<INodeSubstituteAction>();
    {
  ...
  public static List<INodeSubstituteAction> rightTransform_ActionsFactory_Type_1177505359407(final IOperationContext operationContext, final RTActionsBuilder_ParameterObject _parameterObject) {
    List<INodeSubstituteAction> result = new ArrayList<INodeSubstituteAction>();
    {
      ...
      result.add(new AbstractRTransformHintSubstituteAction(BaseAdapter.fromAdapter(concept), _parameterObject.getSourceNode()) {
        ...
        public SNode doSubstitute(String pattern) {
          SNode result = SModelOperations.createNewNode(_parameterObject.getModel(), "jetbrains.mps.baseLanguage.structure.ArrayType", null);
          SNodeOperations.replaceWithAnother(_parameterObject.getSourceNode(), result);
          SLinkOperations.setTarget(result, "componentType", _parameterObject.getSourceNode(), true);
          return result;
        }
  ...
  public static List<INodeSubstituteAction> rightTransform_ActionsFactory_ClassifierType_1177505734540(final IOperationContext operationContext, final RTActionsBuilder_ParameterObject _parameterObject) {
    List<INodeSubstituteAction> result = new ArrayList<INodeSubstituteAction>();
    {
      ...
      result.add(new AbstractRTransformHintSubstituteAction(BaseAdapter.fromAdapter(concept), _parameterObject.getSourceNode()) {
        ...
        public SNode doSubstitute(String pattern) {
          SLinkOperations.addNewChild(_parameterObject.getSourceNode(), "parameter", "jetbrains.mps.baseLanguage.structure.Type");
          return SequenceOperations.getFirst(SLinkOperations.getTargets(_parameterObject.getSourceNode(), "parameter", true));
        }
  ...
  public static List<INodeSubstituteAction> rightTransform_ActionsFactory_GenericDeclaration_1177506104969(final IOperationContext operationContext, final RTActionsBuilder_ParameterObject _parameterObject) {
    List<INodeSubstituteAction> result = new ArrayList<INodeSubstituteAction>();
    {
      ...
      result.add(new AbstractRTransformHintSubstituteAction(BaseAdapter.fromAdapter(concept), _parameterObject.getSourceNode()) {
        ...
        public SNode doSubstitute(String pattern) {
          SLinkOperations.addNewChild(_parameterObject.getSourceNode(), "typeVariableDeclaration", "jetbrains.mps.baseLanguage.structure.TypeVariableDeclaration");
          return SequenceOperations.getFirst(SLinkOperations.getTargets(_parameterObject.getSourceNode(), "typeVariableDeclaration", true));
        }
  ...
  public static List<INodeSubstituteAction> rightTransform_ActionsFactory_NewExpression_1177506323525(final IOperationContext operationContext, final RTActionsBuilder_ParameterObject _parameterObject) {
    List<INodeSubstituteAction> result = new ArrayList<INodeSubstituteAction>();
    {
      ...
      result.add(new AbstractRTransformHintSubstituteAction(BaseAdapter.fromAdapter(concept), _parameterObject.getSourceNode()) {
        ...
        public SNode doSubstitute(String pattern) {
          SLinkOperations.addNewChild(_parameterObject.getSourceNode(), "typeParameter", "jetbrains.mps.baseLanguage.structure.Type");
          return SequenceOperations.getFirst(SLinkOperations.getTargets(_parameterObject.getSourceNode(), "typeParameter", true));
        }
  ...
  public static List<INodeSubstituteAction> rightTransform_ActionsFactory_TryCatchStatement_1177507970664(final IOperationContext operationContext, final RTActionsBuilder_ParameterObject _parameterObject) {
    List<INodeSubstituteAction> result = new ArrayList<INodeSubstituteAction>();
    {
  ...
  public static List<INodeSubstituteAction> rightTransform_ActionsFactory_TryCatchStatement_1177508119482(final IOperationContext operationContext, final RTActionsBuilder_ParameterObject _parameterObject) {
    List<INodeSubstituteAction> result = new ArrayList<INodeSubstituteAction>();
    {
      ConceptDeclaration concept = SModelUtil_new.findConceptDeclaration("jetbrains.mps.baseLanguage.structure.TryCatchStatement", operationContext.getScope());
      result.add(new AbstractRTransformHintSubstituteAction(BaseAdapter.fromAdapter(concept), _parameterObject.getSourceNode()) {
        ...
        public SNode doSubstitute(String pattern) {
          SNode tryStatement = SModelOperations.createNewNode(_parameterObject.getModel(), "jetbrains.mps.baseLanguage.structure.TryStatement", null);
          SNode body = SLinkOperations.getTarget(_parameterObject.getSourceNode(), "body", true);
          SLinkOperations.deleteChild(_parameterObject.getSourceNode(), "body");
          SLinkOperations.setTarget(tryStatement, "body", body, true);
          for(SNode catchClause : SLinkOperations.getTargets(_parameterObject.getSourceNode(), "catchClause", true)) {
          ...
          SNodeOperations.replaceWithAnother(_parameterObject.getSourceNode(), tryStatement);
          return tryStatement;
        }
  ...
  public static List<INodeSubstituteAction> rightTransform_ActionsFactory_Expression_1177508524786(final IOperationContext operationContext, final RTActionsBuilder_ParameterObject _parameterObject) {
    List<INodeSubstituteAction> result = new ArrayList<INodeSubstituteAction>();
    {
      ...
      result.add(new AbstractRTransformHintSubstituteAction(BaseAdapter.fromAdapter(concept), _parameterObject.getSourceNode()) {
        ...
        public SNode doSubstitute(String pattern) {
          SNode to = SModelOperations.createNewNode(_parameterObject.getModel(), "jetbrains.mps.baseLanguage.structure.TernaryOperatorExpression", null);
          SNode current = _parameterObject.getSourceNode();
  ...
  public static List<INodeSubstituteAction> rightTransform_ActionsFactory_ArrayCreator_1187946508194(final IOperationContext operationContext, final RTActionsBuilder_ParameterObject _parameterObject) {
    List<INodeSubstituteAction> result = new ArrayList<INodeSubstituteAction>();
    {
  ...
  public static List<INodeSubstituteAction> rightTransform_ActionsFactory_DimensionExpression_1187946681659(final IOperationContext operationContext, final RTActionsBuilder_ParameterObject _parameterObject) {
    List<INodeSubstituteAction> result = new ArrayList<INodeSubstituteAction>();
    {
      Calculable calc = new Calculable() {
  ...
  public static List<INodeSubstituteAction> rightTransform_ActionsFactory_BreakStatement_1199465912028(final IOperationContext operationContext, final RTActionsBuilder_ParameterObject _parameterObject) {
    List<INodeSubstituteAction> result = new ArrayList<INodeSubstituteAction>();
    {
      ...
      Calculable calculable = new Calculable() {
        ...
        public Object calculate() {
          return SequenceOperations.toList(SequenceOperations.map(SNodeOperations.getAncestors(_parameterObject.getSourceNode(), "jetbrains.mps.baseLanguage.structure.AbstractLoopStatement", false), new zMapper(null, null)));
        }
      ...
      for(String parameter : parameterObjects) {
        result.add(new AbstractRTransformHintSubstituteAction(parameter, _parameterObject.getSourceNode()) {
          ...
          public SNode doSubstitute(String pattern) {
            SPropertyOperations.set(_parameterObject.getSourceNode(), "label", ((String)this.getParameterObject()));
            return _parameterObject.getSourceNode();
          }
  ...
  public static List<INodeSubstituteAction> rightTransform_ActionsFactory_ContinueStatement_1199470401054(final IOperationContext operationContext, final RTActionsBuilder_ParameterObject _parameterObject) {
    List<INodeSubstituteAction> result = new ArrayList<INodeSubstituteAction>();
    {
      ConceptDeclaration concept = SModelUtil_new.findConceptDeclaration("null", operationContext.getScope());
      Calculable calculable = new Calculable() {
        ...
        public Object calculate() {
          return SequenceOperations.toList(SequenceOperations.map(SNodeOperations.getAncestors(_parameterObject.getSourceNode(), "jetbrains.mps.baseLanguage.structure.AbstractLoopStatement", false), new zMapper2(null, null)));
        }
