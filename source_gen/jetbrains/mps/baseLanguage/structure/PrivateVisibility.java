...
public class PrivateVisibility extends Visibility {
  ...
  public static PrivateVisibility newInstance(SModel sm, boolean init) {
    return (PrivateVisibility)SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.baseLanguage.PrivateVisibility", sm, GlobalScope.getInstance(), init).getAdapter();
  }
