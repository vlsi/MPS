...
public class ClassConcept extends Classifier {
  ...
  public static ClassConcept newInstance(SModel sm) {
    return (ClassConcept) SModelUtil.instantiateConceptDeclaration("jetbrains.mps.baseLanguage.ClassConcept", sm, GlobalScope.getInstance()).getAdapter();
  }
  ...
  public Visibility getVisibility() {
    return (Visibility) this.getChild(ClassConcept.VISIBILITY);
  }

  public void setVisibility(Visibility node) {
    super.setChild(ClassConcept.VISIBILITY, node);
  }
