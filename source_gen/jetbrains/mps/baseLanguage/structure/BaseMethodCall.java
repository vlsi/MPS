...
public class BaseMethodCall extends Expression {
  ...
  public static BaseMethodCall newInstance(SModel sm, boolean init) {
    return (BaseMethodCall)SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.baseLanguage.BaseMethodCall", sm, GlobalScope.getInstance(), init).getAdapter();
  }
