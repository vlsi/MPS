...
public class InstanceOfExpression extends Expression {
  ...
  public static InstanceOfExpression newInstance(SModel sm, boolean init) {
    return (InstanceOfExpression)SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.baseLanguage.InstanceOfExpression", sm, GlobalScope.getInstance(), init).getAdapter();
  }
