...
import jetbrains.mps.baseLanguage.blTypes.editor.FunctionType_Editor_ParamListHandler_paramList_;
...
public class FunctionType_Editor extends DefaultNodeEditor {
  ...
  public EditorCell createParamList(EditorContext context, SNode node) {
    if(this.myParamListHandler_paramList_ == null) {
      this.myParamListHandler_paramList_ = new FunctionType_Editor_ParamListHandler_paramList_(node, "param", context);
    }
