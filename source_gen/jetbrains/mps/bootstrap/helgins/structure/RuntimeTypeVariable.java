...
public class RuntimeTypeVariable extends BaseConcept implements INamedConcept {
  ...
  public static RuntimeTypeVariable newInstance(SModel sm, boolean init) {
    return (RuntimeTypeVariable)SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.bootstrap.helgins.RuntimeTypeVariable", sm, GlobalScope.getInstance(), init).getAdapter();
  }
