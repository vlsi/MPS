...
public class typeOf_TypeOfExpression_InferenceRule implements InferenceRule_Runtime {
  ...
  public void applyRule(final SNode argument) {
    TypeChecker.getInstance().getRuntimeSupport().createLessThanInequation(TypeChecker.getInstance().getRuntimeSupport().typeOf(SLinkOperations.getTarget(argument, "term", true), "jetbrains.mps.bootstrap.helgins.helgins", "1178192158210", true), new QuotationClass_3().createNode(), SLinkOperations.getTarget(argument, "term", true), null, "jetbrains.mps.bootstrap.helgins.helgins", "1178192184638");
