...
public class TypeOfExpression_Editor extends DefaultNodeEditor {
  ...
  public EditorCell createRowCell(EditorContext context, SNode node) {
    ...
    editorCell.putUserObject(EditorCell.CELL_ID, "1174657546993");
  ...
  public EditorCell createConstantCell(EditorContext context, SNode node, String text) {
    ...
    editorCell.putUserObject(EditorCell.CELL_ID, "1174657548745");
    editorCell.setLayoutConstraint("");
    return editorCell;
  }
  public EditorCell createTermCellinternal(EditorContext context, SNode node, CellProviderWithRole aProvider) {
    ...
    editorCell.putUserObject(EditorCell.CELL_ID, "1174657554356");
    editorCell.setLayoutConstraint("");
    return editorCell;
  }
