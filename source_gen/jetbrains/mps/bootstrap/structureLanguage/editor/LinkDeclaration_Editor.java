...
/*Generated by MPS Nov 1, 2006 6:16:35 PM */
...
public class LinkDeclaration_Editor extends DefaultNodeEditor {
  ...
  public static boolean _QueryFunction_NodeCondition_1150230947838(SNode node, IScope scope) {
    return SPropertyOperations.hasValue(node, "metaClass", null, null);
  }
  ...
  public EditorCell createCellAlternation(EditorContext context, SNode node) {
    ...
    alternationCondition = LinkDeclaration_Editor._QueryFunction_NodeCondition_1150230947838(node, context.getOperationContext().getScope());
    ...
    editorCell.putUserObject(EditorCell.CELL_ID, "1150230947837");
  ...
  public EditorCell createRowCell1(EditorContext context, SNode node) {
    ...
    editorCell.putUserObject(EditorCell.CELL_ID, "1150230958622");
    editorCell.setLayoutConstraint("");
    ((EditorCell_Basic)editorCell).setParseable(false);
    return editorCell;
  }
  public EditorCell createConstantCell1(EditorContext context, SNode node, String text) {
    ...
    editorCell.setDrawBrackets(false);
    editorCell.setBracketsColor(Color.black);
    editorCell.putUserObject(EditorCell.CELL_ID, "1150230982389");
    editorCell.setLayoutConstraint("");
    ((EditorCell_Basic)editorCell).setParseable(false);
    return editorCell;
  }
  public EditorCell createConstantCell2(EditorContext context, SNode node, String text) {
    ...
    editorCell.setDrawBrackets(false);
    editorCell.setBracketsColor(Color.black);
    editorCell.putUserObject(EditorCell.CELL_ID, "1150231010846");
    editorCell.setLayoutConstraint("");
    ((EditorCell_Basic)editorCell).setParseable(false);
    return editorCell;
  }
  ...
  public EditorCell createSpecializedLinkReferenceCellinternal(EditorContext context, SNode node, CellProviderWithRole aProvider) {
    ...
    editorCell.setSubstituteInfo(provider.createDefaultSubstituteInfo());
    editorCell.putUserObject(EditorCell.CELL_ID, "1150230982390");
    editorCell.setLayoutConstraint("");
    ((EditorCell_Basic)editorCell).setParseable(false);
    return editorCell;
  }
