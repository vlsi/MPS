...
public class ConceptLink_Editor extends DefaultNodeEditor {
  ...
  private static void setupBasic_ErrorCell(EditorCell editorCell, SNode node, EditorContext context) {
    editorCell.putUserObject(EditorCell.CELL_ID, node.getId() + "_1105742555383");
  ...
  public EditorCell createErrorCell(EditorContext context, SNode node) {
    ...
    ConceptLink_Editor.setupBasic_ErrorCell(editorCell, node, context);
    ConceptLink_Editor.setupLabel_ErrorCell(editorCell, node, context);
    return editorCell;
  }
