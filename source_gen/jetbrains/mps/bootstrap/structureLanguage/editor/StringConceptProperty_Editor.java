...
public class StringConceptProperty_Editor extends DefaultNodeEditor {
  ...
  public EditorCell createErrorCell(EditorContext context, SNode node) {
    ...
    editorCell.setDrawBrackets(false);
    editorCell.setBracketsColor(Color.black);
    editorCell.putUserObject(EditorCell.CELL_ID, "1137475702335");
    editorCell.setLayoutConstraint("");
    return editorCell;
  }
  public EditorCell createConceptPropertyDeclarationReferenceCellinternal(EditorContext context, SNode node, CellProviderWithRole aProvider) {
    ...
    provider.setAuxiliaryCellProvider(new StringConceptProperty_Editor_conceptPropertyDeclaration_InlineComponent());
