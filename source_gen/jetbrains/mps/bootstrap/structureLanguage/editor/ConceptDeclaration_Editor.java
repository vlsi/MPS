...
public class ConceptDeclaration_Editor extends DefaultNodeEditor {
  ...
  public EditorCellListHandler myConceptPropertyDeclarationListHandler;
  public EditorCellListHandler myConceptLinkDeclarationListHandler;
  ...
  public EditorCell createRootableCellinternal(EditorContext context, SNode node) {
    String propertyName = "rootable";
    PropertyAccessor propertyAccessor = new PropertyAccessor(node, propertyName, false, false, context);
    EditorCell_Property editorCell = EditorCell_Property.create(context, propertyAccessor, node);
    editorCell.setSelectable(true);
    editorCell.setDrawBorder(false);
  ...
  public EditorCell createRootableCell(EditorContext context, SNode node) {
    String propertyName = "rootable";
    EditorCell propertyCell = this.createRootableCellinternal(context, node);
    PropertyAttributeConcept propertyAttributeConcept = node.getPropertyAttribute(propertyName);
    if(propertyAttributeConcept != null) {
      IOperationContext opContext = context.getOperationContext();
      EditorManager manager = EditorManager.getInstanceFromContext(opContext);
  ...
  public EditorCell createExtendsReferenceCellinternal(EditorContext context, SNode node) {
    ...
    editorCell.putUserObject(EditorCell.ROLE, "extends");
  ...
  public EditorCell createExtendsReferenceCell(EditorContext context, SNode node) {
    String linkRole = "extends";
    EditorCell refCell = this.createExtendsReferenceCellinternal(context, node);
  ...
  public EditorCell createPropertyDeclarationList(EditorContext context, SNode node) {
    ...
    editorCell.setDrawBrackets(false);
    editorCell.setBracketsColor(Color.black);
    editorCell.putUserObject(EditorCell.ROLE, "propertyDeclaration");
    editorCell.setLayoutConstraint("");
    return editorCell;
  }
  public EditorCell createLinkDeclarationList(EditorContext context, SNode node) {
    ...
    editorCell.setDrawBrackets(false);
    editorCell.setBracketsColor(Color.black);
    editorCell.putUserObject(EditorCell.ROLE, "linkDeclaration");
    editorCell.setLayoutConstraint("");
    return editorCell;
  }
  public EditorCell createConceptPropertyList(EditorContext context, SNode node) {
    ...
    editorCell.setDrawBrackets(false);
    editorCell.setBracketsColor(Color.black);
    editorCell.putUserObject(EditorCell.ROLE, "conceptProperty");
    editorCell.setLayoutConstraint("");
    return editorCell;
  }
  public EditorCell createConceptLinkList(EditorContext context, SNode node) {
    ...
    editorCell.setDrawBrackets(false);
    editorCell.setBracketsColor(Color.black);
    editorCell.putUserObject(EditorCell.ROLE, "conceptLink");
    editorCell.setLayoutConstraint("");
    return editorCell;
  }
