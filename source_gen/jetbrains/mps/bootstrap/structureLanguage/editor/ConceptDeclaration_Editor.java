...
public class ConceptDeclaration_Editor extends DefaultNodeEditor {
  ...
  public EditorCell createRowCell3(EditorContext context, SNode node) {
    ...
    editorCell.addEditorCell(this.createConstantCell9(context, node, "icon"));
  ...
  public EditorCell createColumnCell(EditorContext context, SNode node) {
    ...
    editorCell.setBracketsColor(Color.black);
    editorCell.setUsesBraces(false);
    editorCell.addEditorCell(this.createImageCell(context, node));
  ...
  public EditorCell createImageCell(EditorContext context, SNode node) {
    ...
    editorCell.setDrawBorder(false);
    editorCell.setBracketsColor(Color.black);
    editorCell.putUserObject(EditorCell.CELL_ID, "1160492850419");
    editorCell.setLayoutConstraint("");
    return editorCell;
  }
