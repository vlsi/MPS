...
public class LinkList_AddChildOperation_Editor extends DefaultNodeEditor {
  ...
  private static void setupBasic_ConstantCell1(EditorCell editorCell, SNode node, EditorContext context) {
    editorCell.putUserObject(EditorCell.CELL_ID, node.getId() + "_1139870427668");
    editorCell.setDrawBorder(false);
  }
  ...
  public EditorCell createRowCell(EditorContext context, SNode node) {
    ...
    LinkList_AddChildOperation_Editor.setupBasic_RowCell(editorCell, node, context);
  ...
  public EditorCell createConstantCell(EditorContext context, SNode node, String text) {
    ...
    LinkList_AddChildOperation_Editor.setupBasic_ConstantCell(editorCell, node, context);
    LinkList_AddChildOperation_Editor.setupLabel_ConstantCell(editorCell, node, context);
  ...
  public EditorCell createConstantCell1(EditorContext context, SNode node, String text) {
    EditorCell_Constant editorCell = new EditorCell_Constant(context, node, text);
    LinkList_AddChildOperation_Editor.setupBasic_ConstantCell1(editorCell, node, context);
    LinkList_AddChildOperation_Editor.setupLabel_ConstantCell1(editorCell, node, context);
    editorCell.setDefaultText("");
    return editorCell;
  }
  ...
  public EditorCell createParameterCellinternal(EditorContext context, SNode node, CellProviderWithRole aProvider) {
    ...
    LinkList_AddChildOperation_Editor.setupBasic_ParameterCell(editorCell, node, context);
    if(editorCell instanceof EditorCell_Label) {
      LinkList_AddChildOperation_Editor.setupLabel_ParameterCell((EditorCell_Label)editorCell, node, context);
    }
