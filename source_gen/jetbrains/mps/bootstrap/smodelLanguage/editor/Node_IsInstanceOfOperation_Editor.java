...
public class Node_IsInstanceOfOperation_Editor extends DefaultNodeEditor {
  ...
  public EditorCell createConceptReferenceCellinternal(EditorContext context, SNode node) {
    ...
    if(reference != null && !(reference.isResolved())) {
      ...
      noRefCell.putUserObject(EditorCell.CELL_ID, "1139621610101");
    ...
    AbstractCellProvider inlineComponent = new Node_IsInstanceOfOperation_Editor_concept_InlineComponent(effectiveNode);
