...
public class SNodeListType_Editor extends DefaultNodeEditor {
  ...
  private static void setupBasic_ConstantCell1(EditorCell editorCell, SNode node, EditorContext context) {
    editorCell.putUserObject(EditorCell.CELL_ID, node.getId() + "_1145383245681");
  ...
  public EditorCell createRowCell(EditorContext context, SNode node) {
    ...
    SNodeListType_Editor.setupBasic_RowCell(editorCell, node, context);
  ...
  public EditorCell createConstantCell(EditorContext context, SNode node, String text) {
    ...
    SNodeListType_Editor.setupBasic_ConstantCell(editorCell, node, context);
    SNodeListType_Editor.setupLabel_ConstantCell(editorCell, node, context);
    editorCell.setDefaultText("");
    return editorCell;
  }
  public EditorCell createConstantCell1(EditorContext context, SNode node, String text) {
    EditorCell_Constant editorCell = new EditorCell_Constant(context, node, text);
    SNodeListType_Editor.setupBasic_ConstantCell1(editorCell, node, context);
    SNodeListType_Editor.setupLabel_ConstantCell1(editorCell, node, context);
    editorCell.setDefaultText("");
    return editorCell;
  }
  public EditorCell createConstantCell2(EditorContext context, SNode node, String text) {
    EditorCell_Constant editorCell = new EditorCell_Constant(context, node, text);
    SNodeListType_Editor.setupBasic_ConstantCell2(editorCell, node, context);
    SNodeListType_Editor.setupLabel_ConstantCell2(editorCell, node, context);
    editorCell.setDefaultText("");
    return editorCell;
  }
  public EditorCell createElementConceptReferenceCellinternal(EditorContext context, SNode node, CellProviderWithRole aProvider) {
    ...
    if(editorCell instanceof EditorCell_Label) {
      SNodeListType_Editor.setupLabel_ElementConceptReferenceCell((EditorCell_Label)editorCell, node, context);
    }
