...
public class SConceptPropertyAccess_Editor extends DefaultNodeEditor {
  ...
  public EditorCell createConceptPropertyReferenceCellinternal(EditorContext context, SNode node, CellProviderWithRole aProvider) {
    ...
    provider.setAuxiliaryCellProvider(new SConceptPropertyAccess_Editor._Inline17());
  ...
  public static class _Inline17 extends AbstractCellProvider {
    ...
    public EditorCell createNameCellinternal(EditorContext context, SNode node, CellProviderWithRole aProvider) {
      ...
      EditorCell editorCell = provider.createEditorCell(context);
      SConceptPropertyAccess_Editor._Inline17.setupBasic_NameCell(editorCell, node, context);
      if(editorCell instanceof EditorCell_Label) {
        SConceptPropertyAccess_Editor._Inline17.setupLabel_NameCell((EditorCell_Label)editorCell, node, context);
      }
      editorCell.setSubstituteInfo(provider.createDefaultSubstituteInfo());
      return editorCell;
    }
