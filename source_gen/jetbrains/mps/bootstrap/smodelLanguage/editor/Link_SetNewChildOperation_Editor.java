...
public class Link_SetNewChildOperation_Editor extends DefaultNodeEditor {
  ...
  public EditorCell createConceptReferenceCellinternal(EditorContext context, SNode node) {
    ...
    if(reference != null && !(reference.isResolved())) {
      ...
      noRefCell.putUserObject(EditorCell.CELL_ID, "1139880110905");
    ...
    AbstractCellProvider inlineComponent = new Link_SetNewChildOperation_Editor_concept_InlineComponent(effectiveNode);
