...
public class Node_InsertNewNextSiblingOperation_Editor extends DefaultNodeEditor {
  ...
  public EditorCell createRowCell(EditorContext context, SNode node) {
    ...
    editorCell.putUserObject(EditorCell.CELL_ID, "1139859068528");
  ...
  public EditorCell createConstantCell(EditorContext context, SNode node, String text) {
    ...
    editorCell.setDrawBrackets(false);
    editorCell.setBracketsColor(Color.black);
    editorCell.putUserObject(EditorCell.CELL_ID, "1139859072592");
    editorCell.setLayoutConstraint("");
    return editorCell;
  }
  public EditorCell createConstantCell1(EditorContext context, SNode node, String text) {
    ...
    editorCell.setDrawBrackets(false);
    editorCell.setBracketsColor(Color.black);
    editorCell.putUserObject(EditorCell.CELL_ID, "1139859097547");
    editorCell.setLayoutConstraint("");
    return editorCell;
  }
  public EditorCell createConceptReferenceCellinternal(EditorContext context, SNode node) {
    ...
    if(reference != null && !(reference.isResolved())) {
      ...
      noRefCell.putUserObject(EditorCell.CELL_ID, "1139859121222");
    ...
    AbstractCellProvider inlineComponent = new Node_InsertNewNextSiblingOperation_Editor_concept_InlineComponent(effectiveNode);
