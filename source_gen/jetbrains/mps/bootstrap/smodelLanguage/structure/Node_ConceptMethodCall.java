...
public class Node_ConceptMethodCall extends SNodeOperation {
  ...
  public static Node_ConceptMethodCall newInstance(SModel sm, boolean init) {
    return (Node_ConceptMethodCall)SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.bootstrap.smodelLanguage.Node_ConceptMethodCall", sm, GlobalScope.getInstance(), init).getAdapter();
  }
