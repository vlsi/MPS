...
public class RulesUtil {
  ...
  public static SNode get_AdapterClassType_for_Concept(SNode concept) {
    ...
    SNode adapterClassType = SModelOperations.createNewNode(SNodeOperations.getModel(new QuotationClass_46().createNode()), "jetbrains.mps.baseLanguage.structure.ClassifierType", null);
