...
public class RulesUtil {
  ...
  public static SNode get_inputNodeType(SNode op) {
    ...
    SNode inputNodeType = new QuotationClass_54().createNode(inputNodeConcept);
  ...
  public static SNode get_AdapterClassType_for_Concept(SNode concept) {
    ...
    SNode adapterClassType = SModelOperations.createNewNode(SNodeOperations.getModel(new QuotationClass_56().createNode()), "jetbrains.mps.baseLanguage.structure.ClassifierType", null);
