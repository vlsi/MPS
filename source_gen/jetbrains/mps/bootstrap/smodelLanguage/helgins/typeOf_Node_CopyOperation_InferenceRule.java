...
public class typeOf_Node_CopyOperation_InferenceRule implements InferenceRule_Runtime {
  ...
  public void applyRule(final SNode argument) {
    ...
    TypeChecker.getInstance().getRuntimeSupport().createLessThanInequation(TypeChecker.getInstance().getRuntimeSupport().typeOf(argument, "jetbrains.mps.bootstrap.smodelLanguage.helgins", "1186057865109"), new QuotationClass_55().createNode(), argument, null, "jetbrains.mps.bootstrap.smodelLanguage.helgins", "1186057869956");
  }
