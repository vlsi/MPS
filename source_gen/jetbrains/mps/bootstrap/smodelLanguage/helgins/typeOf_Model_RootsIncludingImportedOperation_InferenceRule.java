...
public class typeOf_Model_RootsIncludingImportedOperation_InferenceRule implements InferenceRule_Runtime {
  ...
  public void applyRule(SNode argument) {
    ...
    TypeChecker.getInstance().getRuntimeSupport().createLessThanInequation(TypeChecker.getInstance().getRuntimeSupport().typeOf(SLinkOperations.getTarget(argument, "scope", true)), new QuotationClass_56().createNode(), SLinkOperations.getTarget(argument, "scope", true));
  }
