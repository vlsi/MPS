...
public class typeOf_Model_CreateNewNodeOperation_InferenceRule implements InferenceRule_Runtime {
  ...
  public void applyRule(SNode argument) {
    ...
    TypeChecker.getInstance().getRuntimeSupport().givetype(new QuotationClass_11().createNode(SLinkOperations.getTarget(argument, "concept", false)), argument);
  }
  ...
  public ApplicableNodeCondition getNodeCondition() {
    ...
    return (ApplicableNodeCondition)BaseAdapter.fromNode(model.getNodeById("1178231930951"));
  }
