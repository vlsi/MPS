...
public class typeOf_Model_RootsOperation_InferenceRule implements InferenceRule_Runtime {
  ...
  public void applyRule(SNode argument) {
    ...
    TypeChecker.getInstance().getRuntimeSupport().givetype(new QuotationClass_18().createNode(SLinkOperations.getTarget(argument, "concept", false)), argument);
  }
  ...
  public ApplicableNodeCondition getNodeCondition() {
    ...
    return (ApplicableNodeCondition)BaseAdapter.fromNode(model.getNodeById("1178233003727"));
  }
