...
public class ConstraintFunction_PropertySetter extends ConceptFunction {
  ...
  public static ConstraintFunction_PropertySetter newInstance(SModel sm, boolean init) {
    return (ConstraintFunction_PropertySetter)SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.bootstrap.constraintsLanguage.structure.ConstraintFunction_PropertySetter", sm, GlobalScope.getInstance(), init).getAdapter();
  }
