...
public class NodeReferentConstraint_Editor extends DefaultNodeEditor {
  ...
  public EditorCell createRowCell6(EditorContext context, SNode node) {
    ...
    editorCell.setUsesBraces(false);
    editorCell.setCanBeFolded(false);
    editorCell.addEditorCell(this.createConstantCell13(context, node, "   create"));
  ...
  public EditorCell createRowCell3(EditorContext context, SNode node) {
    ...
    editorCell.addEditorCell(this.createSearchScopeDescriptionCell(context, node));
  ...
  public EditorCell createRowCell4(EditorContext context, SNode node) {
    ...
    editorCell.setUsesBraces(false);
    editorCell.setCanBeFolded(false);
    editorCell.addEditorCell(this.createConstantCell9(context, node, "   can create (depr)"));
  ...
  public EditorCell createRowCell5(EditorContext context, SNode node) {
    ...
    editorCell.setUsesBraces(false);
    editorCell.setCanBeFolded(false);
    editorCell.addEditorCell(this.createConstantCell11(context, node, "   can create"));
  ...
  public EditorCell createSearchScopeDescriptionCellinternal(EditorContext context, SNode node, CellProviderWithRole aProvider) {
    ...
    editorCell.setSubstituteInfo(provider.createDefaultSubstituteInfo());
    editorCell.putUserObject(EditorCell.CELL_ID, "1163537292098");
    editorCell.setLayoutConstraint("");
    ((EditorCell_Basic)editorCell).setParseable(false);
    return editorCell;
  }
