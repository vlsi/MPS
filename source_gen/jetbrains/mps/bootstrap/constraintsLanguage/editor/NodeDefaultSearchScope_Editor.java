...
import jetbrains.mps.bootstrap.constraintsLanguage.editor.NodeDefaultSearchScope_Editor_referentConcept_InlineComponent;
...
public class NodeDefaultSearchScope_Editor extends DefaultNodeEditor {
  ...
  public static boolean _QueryFunction_NodeCondition_1178194465640(SNode node, IScope scope) {
  ...
  public EditorCell createColumnCell(EditorContext context, SNode node) {
    ...
    editorCell.setCanBeFolded(false);
    if(NodeDefaultSearchScope_Editor._QueryFunction_NodeCondition_1178194465640(node, context.getOperationContext().getScope())) {
