...
import jetbrains.mps.bootstrap.constraintsLanguage.editor.NodePropertyConstraint_Editor_applicableConcept_InlineComponent;
import jetbrains.mps.nodeEditor.EditorCell_Label;
import jetbrains.mps.bootstrap.editorLanguage.cellProviders.RefCellCellProvider;
import jetbrains.mps.smodel.IOperationContext;
import jetbrains.mps.nodeEditor.EditorManager;
import jetbrains.mps.bootstrap.constraintsLanguage.editor.NodePropertyConstraint_Editor_applicableProperty_InlineComponent;
import jetbrains.mps.bootstrap.editorLanguage.cellProviders.RefNodeCellProvider;

public class NodePropertyConstraint_Editor extends DefaultNodeEditor {

  public static boolean _QueryFunction_NodeCondition_1178177642023(SNode node, IScope scope) {
  ...
  public static boolean _QueryFunction_NodeCondition_1178177811048(SNode node, IScope scope) {
    return !(SNodeOperations.isInstanceOf(SNodeOperations.getContainingRoot(node), "jetbrains.mps.bootstrap.constraintsLanguage.structure.ConceptBehavior"));
  }
  ...
  public EditorCell createRowCell(EditorContext context, SNode node) {
    ...
    if(NodePropertyConstraint_Editor._QueryFunction_NodeCondition_1178177642023(node, context.getOperationContext().getScope())) {
      editorCell.addEditorCell(this.createApplicableConceptReferenceCell(context, node));
    }
    if(NodePropertyConstraint_Editor._QueryFunction_NodeCondition_1178177811048(node, context.getOperationContext().getScope())) {
