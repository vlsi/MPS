...
public class NodePropertyConstraint_Editor extends DefaultNodeEditor {
  ...
  public EditorCell createRowCell(EditorContext context, SNode node) {
    ...
    editorCell.setBracketsColor(Color.black);
    editorCell.setUsesBraces(false);
    editorCell.addEditorCell(this.createConstantCell(context, node, "constraint on property"));
  ...
  public EditorCell createRowCell3(EditorContext context, SNode node) {
    ...
    editorCell.addEditorCell(this.createConstantCell9(context, node, "-not implemented-"));
  ...
  public EditorCell createRowCell4(EditorContext context, SNode node) {
    ...
    editorCell.setBracketsColor(Color.black);
    editorCell.setUsesBraces(false);
    editorCell.addEditorCell(this.createConstantCell10(context, node, "validate"));
    editorCell.addEditorCell(this.createConstantCell11(context, node, ":"));
    editorCell.addEditorCell(this.createConstantCell12(context, node, "-not implemented-"));
  ...
  public EditorCell createConstantCell9(EditorContext context, SNode node, String text) {
    ...
    editorCell.putUserObject(EditorCell.CELL_ID, "1149010905593");
    editorCell.setLayoutConstraint("");
    ((EditorCell_Basic)editorCell).setParseable(false);
    return editorCell;
  }
