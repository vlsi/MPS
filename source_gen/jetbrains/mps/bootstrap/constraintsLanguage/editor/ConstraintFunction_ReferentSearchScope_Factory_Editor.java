...
public class ConstraintFunction_ReferentSearchScope_Factory_Editor extends DefaultNodeEditor {
  ...
  public EditorCell createRowCell4(EditorContext context, SNode node) {
    ...
    editorCell.addEditorCell(this.createConstantCell14(context, node, "search context (not a search scope)"));
  ...
  public EditorCell createRowCell2(EditorContext context, SNode node) {
    ...
    editorCell.addEditorCell(this.createConstantCell9(context, node, "search context"));
  ...
  public EditorCell createRowCell1(EditorContext context, SNode node) {
    ...
    editorCell.addEditorCell(this.createConstantCell7(context, node, "search context"));
