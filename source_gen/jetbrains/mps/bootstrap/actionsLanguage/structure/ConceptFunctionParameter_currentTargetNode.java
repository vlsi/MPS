...
public class ConceptFunctionParameter_currentTargetNode extends ConceptFunctionParameter {
  ...
  public static ConceptFunctionParameter_currentTargetNode newInstance(SModel sm, boolean init) {
    return (ConceptFunctionParameter_currentTargetNode)SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.bootstrap.actionsLanguage.ConceptFunctionParameter_currentTargetNode", sm, GlobalScope.getInstance(), init).getAdapter();
  }
