...
public class ParameterizedSubstituteMenuPart extends SubstituteMenuPart {
  ...
  public static ParameterizedSubstituteMenuPart newInstance(SModel sm, boolean init) {
    return (ParameterizedSubstituteMenuPart)SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.bootstrap.actionsLanguage.ParameterizedMenuPart", sm, GlobalScope.getInstance(), init).getAdapter();
  }
