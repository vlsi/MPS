...
public class RemoveDefaultsPart extends NodeBuilderPart {
  ...
  public static RemoveDefaultsPart newInstance(SModel sm, boolean init) {
    return (RemoveDefaultsPart)SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.bootstrap.actionsLanguage.RemoveDefaultsPart", sm, GlobalScope.getInstance(), init).getAdapter();
  }
