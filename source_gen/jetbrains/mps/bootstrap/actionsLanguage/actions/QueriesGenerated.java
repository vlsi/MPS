...
public class QueriesGenerated {
  ...
  public static void removeConceptByCondition_1177495897822(Iterator<INodeSubstituteAction> actions, final SNode parentNode, final SNode currentChild, final SNode childConcept, final IOperationContext operationContext) {
  ...
  public static void removeConceptByCondition_1177496231840(Iterator<INodeSubstituteAction> actions, final SNode parentNode, final SNode currentChild, final SNode childConcept, final IOperationContext operationContext) {
    while(actions.hasNext()) {
      INodeSubstituteAction current = actions.next();
      final SNode concept = (SNode)current.getParameterObject();
      Condition cond = new Condition() {
