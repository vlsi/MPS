...
public class AttributeConcept_Editor extends DefaultNodeEditor {
  ...
  public EditorCell createRowCell(EditorContext context, SNode node) {
    ...
    editorCell.putUserObject(EditorCell.CELL_ID, "1136027532769");
  ...
  public EditorCell createConstantCell(EditorContext context, SNode node, String text) {
    ...
    editorCell.setDrawBrackets(false);
    editorCell.setBracketsColor(Color.black);
    editorCell.putUserObject(EditorCell.CELL_ID, "1136027532770");
    editorCell.setLayoutConstraint("");
    return editorCell;
  }
  public EditorCell createConstantCell1(EditorContext context, SNode node, String text) {
    ...
    editorCell.setDrawBrackets(false);
    editorCell.setBracketsColor(Color.black);
    editorCell.putUserObject(EditorCell.CELL_ID, "1136027532772");
    editorCell.setLayoutConstraint("");
    return editorCell;
  }
  public EditorCell createAttributedNodeCell(EditorContext context, SNode node) {
    ...
    if(reference != null && !(reference.isResolved())) {
      ...
      noRefCell.putUserObject(EditorCell.CELL_ID, "1136027532771");
