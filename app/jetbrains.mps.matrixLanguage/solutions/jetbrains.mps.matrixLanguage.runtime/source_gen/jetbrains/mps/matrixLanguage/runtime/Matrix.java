...
public class Matrix <ScalarType> {
  ...
  public Matrix clone() {
    ...
    for(int i = 0 ; i < this.values.length ; i = i + 1) {
      for(int j = 0 ; j < this.values[0].length ; j = j + 1) {
  ...
  public Matrix<ScalarType> mult(ScalarType v) {
    ...
    for(int i = 0 ; i < this.values.length ; i = i + 1) {
      for(int j = 0 ; j < this.values[i].length ; j = j + 1) {
  ...
  public Matrix<ScalarType> mult(Matrix<ScalarType> m) {
    ...
    for(int i = 0 ; i < this.getRowsNumber() ; i = i + 1) {
      for(int j = 0 ; j < m.getColumnsNumber() ; j = j + 1) {
        ScalarType sum = null;
        for(int k = 0 ; k < this.getColumnsNumber() ; k = k + 1) {
