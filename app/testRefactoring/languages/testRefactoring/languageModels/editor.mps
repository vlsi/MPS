...
<model name="testRefactoring.editor">
  ...
  <import index="3" modelUID="testRefactoringTargetLang.structure" version="-1" />
  ...
  <node type="jetbrains.mps.bootstrap.editorLanguage.structure.ConceptEditorDeclaration" id="1198522097224">
    ...
    <node role="cellModel" type="jetbrains.mps.bootstrap.editorLanguage.structure.CellModel_Constant" id="1198522103867">
