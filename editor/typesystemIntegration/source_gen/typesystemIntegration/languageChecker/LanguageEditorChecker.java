...
public class LanguageEditorChecker implements DisposableEditorChecker, EditorMessageOwner {
  ...
  @Override
  public void processEvents(List<SModelEvent> list) {
    // Nothing to do here - each sub-checker is responsible for listening to appropriate events by itself 
  }
