...
/**
 * 
 * @deprecated this class purpose is to find and collect substitute actions from the actions aspect. From version 2017.1 substitute actions are defined via substitute menu in the editor aspect. Use {@link jetbrains.mps.smodel.action.ModelActions#createChildNodeSubstituteActions(SNode, SNode, SContainmentLink, SAbstractConcept, IChildNodeSetter, EditorContext) }
 */
@Deprecated
