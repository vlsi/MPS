 ...
 * Date: 05/10/15
 */
public class CollapseAllCellAction extends AbstractCollapseCellAction {
  public CollapseAllCellAction(boolean doCollapse) {
    super(doCollapse);
  }
  ...
  protected EditorCell_Collection getAnchorCell(EditorCell selectedCell, EditorContext editorContext) {
    return editorContext.getEditorComponent().getRootCell() instanceof EditorCell_Collection ?
        (EditorCell_Collection) editorContext.getEditorComponent().getRootCell() : null;
  }
