 ...
 * Date: 4/10/13
 */
public class InterpretedEditorAspectDescriptorFactory implements AspectDescriptorFactory<EditorAspectDescriptor>, ApplicationComponent {
  ...
  @Override
  public EditorAspectDescriptor createAspectDescriptor(LanguageRuntime languageRuntime) {
    return new InterpretedEditorAspectDescriptor(languageRuntime);
  }
}
