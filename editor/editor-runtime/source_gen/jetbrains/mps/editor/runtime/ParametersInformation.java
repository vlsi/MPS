...
public class ParametersInformation<T> {
  ...
  public void getStyledMethodPresentation(SNode node, EditorContext editorContext, T method, StyledTextPrinter printer) {
    getStyledMethodPresentation(node, (jetbrains.mps.nodeEditor.EditorContext) editorContext, method, printer);
  }

  @Deprecated
  public void getStyledMethodPresentation(SNode node, jetbrains.mps.nodeEditor.EditorContext editorContext, T method, StyledTextPrinter printer) {
    // Deprecated since MPS 3.0 should be removed 
