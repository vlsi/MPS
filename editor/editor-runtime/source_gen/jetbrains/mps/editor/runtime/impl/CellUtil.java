...
public class CellUtil {
  ...
  public static void setupIDeprecatableStyles(SNode node, EditorCell cell) {
    ...
    if (deprecatable != null && (((Boolean) BHReflection.invoke(deprecatable, SMethodTrimmedId.create("isDeprecated", null, "hOwoPtR"))) || ((Boolean) BHReflection.invoke(SNodeOperations.asNode(SNodeOperations.getConceptDeclaration(deprecatable)), SMethodTrimmedId.create("isDeprecated", null, "hOwoPtR"))))) {
