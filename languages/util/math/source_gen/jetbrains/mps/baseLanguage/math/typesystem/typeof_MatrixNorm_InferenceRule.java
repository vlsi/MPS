  ...
  public void applyRule(final SNode norm, final TypeCheckingContext typeCheckingContext, IsApplicableStatus status) {
    {
      ...
      typeCheckingContext.whenConcrete(mT, new Runnable() {
        public void run() {
          if (!(SNodeOperations.isInstanceOf(typeCheckingContext.getExpandedType(mT), "jetbrains.mps.baseLanguage.math.structure.MatrixOrVectorType"))) {
            {
            ...
            SNode t = MathUtil.getUnboxedElementType(typeCheckingContext.getExpandedType(mT));
