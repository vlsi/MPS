  ...
  public void applyRule(final SNode determinant, final TypeCheckingContext typeCheckingContext, IsApplicableStatus status) {
    {
      ...
      typeCheckingContext.whenConcrete(detmat, new Runnable() {
        public void run() {
          if (SNodeOperations.isInstanceOf(typeCheckingContext.getExpandedType(detmat), "jetbrains.mps.baseLanguage.math.structure.MatrixOrVectorType")) {
            {
              ...
              typeCheckingContext.createEquation((SNode) MathTypeUtil.getElementType(typeCheckingContext.getExpandedType(detmat)), (SNode) typeCheckingContext.typeOf(_nodeToCheck_1029348928467, "r:47d0f24b-df34-4ea0-aa7e-7c2eb0f88f31(jetbrains.mps.baseLanguage.math.typesystem)", "3417571330831779750", true), _info_12389875345);
            }
          } else {
            {
