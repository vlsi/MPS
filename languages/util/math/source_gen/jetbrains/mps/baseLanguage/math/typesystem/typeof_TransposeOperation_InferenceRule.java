      ...
      typeCheckingContext.whenConcrete(t, new Runnable() {
        public void run() {
          if (SNodeOperations.isInstanceOf(typeCheckingContext.getExpandedType(t), "jetbrains.mps.baseLanguage.math.structure.MatrixType")) {
            SNode result = new typeof_TransposeOperation_InferenceRule.QuotationClass_odw3zd_a0a0a0a0a0().createNode(MathTypeUtil.getElementType(typeCheckingContext.getExpandedType(t)), typeCheckingContext);
            ...
            SNode result = new typeof_TransposeOperation_InferenceRule.QuotationClass_odw3zd_a0a0a0a0a0a().createNode(MathTypeUtil.getElementType(typeCheckingContext.getExpandedType(t)), typeCheckingContext);
