...
public class biginteger_extends_BigInteger_SubtypingRule extends SubtypingRule_Runtime implements ISubtypingRule_Runtime {
  ...
  private static SNode _quotation_createNode_nvphb0_a0a1() {
    ...
    quotedNode_1.setReference("classifier", SReference.create("classifier", quotedNode_1, SModelReference.fromString("f:java_stub#6354ebe7-c22a-4a0f-ac54-50b52ab9b065#java.math(JDK/java.math@java_stub)"), jetbrains.mps.smodel.SNodeId.fromString("~BigInteger")));
    return quotedNode_1;
  }
}
