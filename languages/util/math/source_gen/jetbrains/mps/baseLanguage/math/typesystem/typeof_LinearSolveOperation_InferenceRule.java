        ...
        public void run() {
          {
            ...
            typeCheckingContext.whenConcrete(vectorType, new Runnable() {
              public void run() {
                ...
                if (SNodeOperations.isInstanceOf(typeCheckingContext.getExpandedType(matrixType), "jetbrains.mps.baseLanguage.math.structure.MatrixOrVectorType")) {
                  {
                    SNode _nodeToCheck_1029348928467 = op;
                    ...
                    typeCheckingContext.createLessThanInequality((SNode) MathUtil.getUnboxedElementType(typeCheckingContext.getExpandedType(matrixType)), (SNode) typeCheckingContext.getRepresentative(T_typevar_5359814223490060193), false, true, _info_12389875345);
                  }
                } else {
                  {
                ...
                if (SNodeOperations.isInstanceOf(typeCheckingContext.getExpandedType(vectorType), "jetbrains.mps.baseLanguage.math.structure.MatrixOrVectorType")) {
                  {
                    SNode _nodeToCheck_1029348928467 = op;
