...
public class MoneyMethodCall_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createCollection_o0ayvq_a(EditorContext editorContext, SNode node) {
    ...
    editorCell.addEditorCell(this.createConceptProperty_o0ayvq_b0(editorContext, node));
    return editorCell;
  }
  ...
  private EditorCell createConceptProperty_o0ayvq_b0(EditorContext editorContext, SNode node) {
