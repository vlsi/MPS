...
public class ConcretePropertyPart_Behavior {
  ...
  private static SNode _quotation_createNode_e1pb6q_a0a0a0c0a() {
    ...
    quotedNode_1.setReference("dataType", SReference.create("dataType", quotedNode_1, SModelReference.fromString("r:00000000-0000-4000-0000-011c89590288(jetbrains.mps.lang.core.structure)"), jetbrains.mps.smodel.SNodeId.fromString("1082983657062")));
    return quotedNode_1;
  }
