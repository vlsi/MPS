...
public class LinePart_Actions extends KeyMapImpl {
  ...
  public static class LinePart_Actions_Action0 extends KeyMapActionImpl {
    ...
    public boolean canExecute(final EditorContext editorContext) {
      ...
      if (!(SNodeUtil.isInstanceOf(contextNode, SConceptRepository.getInstance().getConcept("jetbrains.mpslite.structure.LinePart")))) {
        return false;
      }
      return true;
    }
  ...
  public static class LinePart_Actions_Action1 extends KeyMapActionImpl {
  ...
  public static class LinePart_Actions_Action2 extends KeyMapActionImpl {
