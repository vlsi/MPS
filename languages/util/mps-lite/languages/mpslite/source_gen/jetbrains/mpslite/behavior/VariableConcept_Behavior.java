...
public class VariableConcept_Behavior {
  ...
  private static SNode _quotation_createNode_mkovpu_a0a0h0c() {
    ...
    quotedNode_1.setReference("dataType", SReference.create("dataType", quotedNode_1, SModelReference.fromString("r:00000000-0000-4000-0000-011c89590288(jetbrains.mps.lang.core.structure)"), jetbrains.mps.smodel.SNodeId.fromString("1082983041843")));
    return quotedNode_1;
  }
