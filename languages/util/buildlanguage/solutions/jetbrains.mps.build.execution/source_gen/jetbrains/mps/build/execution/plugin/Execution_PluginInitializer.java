...
public class Execution_PluginInitializer implements ApplicationComponent {
  protected static Log log = LogFactory.getLog(Execution_PluginInitializer.class);

  private final LibraryContributor myContributor = new Execution_PluginInitializer.MyLibraryContributor();
