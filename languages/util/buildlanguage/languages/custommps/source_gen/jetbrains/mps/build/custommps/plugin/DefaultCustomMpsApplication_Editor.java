...
public class DefaultCustomMpsApplication_Editor extends JPanel {
  ...
  private MainNodeChooser myChooseNodeComponent = new MainNodeChooser(new _FunctionTypes._return_P0_E0<SNode>() {
    ...
    public Boolean invoke(final SNode node) {
      try {
        ...
        Logger.getLogger(DefaultCustomMpsApplication_Editor.class).error(t);
        return false;
      }
    }
  });

  public DefaultCustomMpsApplication_Editor() {
  ...
  public void apply(DefaultCustomMpsApplication_Configuration configuration) {
  ...
  public void reset(DefaultCustomMpsApplication_Configuration configuration) {
