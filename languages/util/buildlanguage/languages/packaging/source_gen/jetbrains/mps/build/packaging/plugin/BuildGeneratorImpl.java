...
public class BuildGeneratorImpl extends AbstractBuildGenerator {
  ...
  protected SNode createMPSLayout(SModelDescriptor targetModelDescriptor, String name, String basedir, List<NodeData> selectedData) {
    ...
    SLinkOperations.setTarget(mpsLayout, "scriptsDirectory", new BuildGeneratorImpl.QuotationClass_un708i_a0a0n0f().createNode(), true);
    SLinkOperations.setTarget(mpsLayout, "deployDirectory", new BuildGeneratorImpl.QuotationClass_un708i_a0a0o0f().createNode(), true);
    // 
