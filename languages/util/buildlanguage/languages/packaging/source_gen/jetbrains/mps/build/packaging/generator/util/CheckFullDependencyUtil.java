...
public class CheckFullDependencyUtil {
  ...
  private static List<IModule> getDependencyToCheck(IModule module) {
    ...
    Collection<IModule> dependency = new GlobalModuleDependenciesManager(module).getModules(Deptype.VISIBLE);
    ...
    ListSequence.fromList(dependencyToCheck).addSequence(SetSequence.fromIterable(dependency));
