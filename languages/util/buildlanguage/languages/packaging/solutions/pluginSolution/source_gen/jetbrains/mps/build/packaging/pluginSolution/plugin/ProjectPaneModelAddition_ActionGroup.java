...
public class ProjectPaneModelAddition_ActionGroup extends GeneratedActionGroup {
  ...
  public static final String ID = "jetbrains.mps.build.packaging.pluginSolution.plugin.ProjectPaneModelAddition_ActionGroup";
  ...
  public ProjectPaneModelAddition_ActionGroup() {
    ...
    this.setPopup(false);
    try {
      ProjectPaneModelAddition_ActionGroup.this.addAction("jetbrains.mps.build.packaging.pluginSolution.plugin.GenerateBuildAction_Action");
    } catch (Throwable t) {
