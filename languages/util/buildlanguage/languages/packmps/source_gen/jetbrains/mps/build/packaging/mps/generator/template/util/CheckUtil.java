...
public class CheckUtil {
  ...
  public static void checkCoreRuntimeDeps() {
    ...
    for (Solution solution : ListSequence.fromList((List<Solution>) ModuleRepositoryFacade.getInstance().getAllModules(Solution.class))) {
      if (solution.isStub()) {
        continue;
      }
  ...
  public static void checkIncludedLanguage() {
    List<Language> langs = (List<Language>) ModuleRepositoryFacade.getInstance().getAllModules(Language.class);
