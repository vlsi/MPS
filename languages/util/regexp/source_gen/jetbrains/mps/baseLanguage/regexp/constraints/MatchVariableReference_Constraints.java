...
public class MatchVariableReference_Constraints extends BaseConstraintsDescriptor {
      ...
      public ReferenceScopeProvider getScopeProvider() {
        return new BaseReferenceScopeProvider() {
          ...
          public SNodeReference getSearchScopeValidatorNode() {
            return breakingNode_8gk9io_a0a1a0a0a1a0b0a1a3;
          }
        };
      }
    });
  ...
  private static SNodePointer breakingNode_8gk9io_a0a1a0a0a1a0b0a1a3 = new SNodePointer("r:00000000-0000-4000-0000-011c89590515(jetbrains.mps.baseLanguage.regexp.constraints)", "1213104858751");
}
