...
public class ReplaceRegexpOperation_removeG {
  ...
  public static class ReplaceRegexpOperation_removeG_DELETE extends AbstractCellAction {
    ...
    public void execute_internal(EditorContext editorContext, SNode node) {
      ...
      SPropertyOperations.set(node, MetaAdapterFactory.getProperty(new UUID(-2688747624584492277l, -5722269945249396544l), 3796137614137086346l, 3796137614137159273l, "globalReplace"), "" + (false));
