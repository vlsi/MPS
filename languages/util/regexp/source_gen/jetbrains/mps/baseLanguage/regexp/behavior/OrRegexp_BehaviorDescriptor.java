...
public final class OrRegexp_BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<Boolean> inParentheses_id1b8uQvZyDXU = new SMethodBuilder<Boolean>(new SJavaCompoundTypeImpl(Boolean.TYPE)).name("inParentheses").modifiers(SModifiersImpl.create(0, AccessPrivileges.PUBLIC)).concept(CONCEPT).id("1b8uQvZyDXU").registry(REGISTRY).build(SParameterImpl.fromList(SJavaCompoundTypeImpl.fromClasses()));
  ...
  private static Boolean inParentheses_id1b8uQvZyDXU(@NotNull SNode __thisNode__) {
  ...
  protected <T> T invokeSpecial0(@NotNull SNode node, @NotNull SMethod<T> method, @NotNull Object[] parameters) {
    ...
    switch (methodIndex) {
      ...
      case 2:
        return (T) inParentheses_id1b8uQvZyDXU(node);
      default:
        throw new BHMethodNotFoundException(this, method);
    }
  }
