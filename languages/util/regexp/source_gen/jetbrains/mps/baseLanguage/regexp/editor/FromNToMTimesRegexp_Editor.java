...
public class FromNToMTimesRegexp_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createRefNode_ybtrqd_b0(EditorContext editorContext, SNode node) {
    SingleRoleCellProvider provider = new FromNToMTimesRegexp_Editor.regexpSingleRoleHandler_ybtrqd_b0(node, MetaAdapterFactory.getContainmentLink(0xdaafa647f1f74b0bL, 0xb09669cd7c8408c0L, 0x11174c678adL, 0x11174c6961aL, "regexp"), editorContext);
    return provider.createCell();
  }
  private class regexpSingleRoleHandler_ybtrqd_b0 extends SingleRoleCellProvider {
    ...
    protected EditorCell createEmptyCell() {
      ...
      editorCell.setTransformationMenuLookup(new DefaultEmptyCellSubstituteMenuLookup(MetaAdapterFactory.getContainmentLink(0xdaafa647f1f74b0bL, 0xb09669cd7c8408c0L, 0x11174c678adL, 0x11174c6961aL, "regexp")));
