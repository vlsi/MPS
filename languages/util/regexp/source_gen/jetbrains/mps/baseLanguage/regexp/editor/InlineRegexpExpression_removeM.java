...
public class InlineRegexpExpression_removeM {
  ...
  public static class InlineRegexpExpression_removeM_DELETE extends AbstractCellAction {
    ...
    public void execute_internal(EditorContext editorContext, SNode node) {
      ...
      SPropertyOperations.set(node, MetaAdapterFactory.getProperty(new UUID(-2688747624584492277l, -5722269945249396544l), 1174510540317l, 1175158906851l, "multiLine"), "" + (false));
