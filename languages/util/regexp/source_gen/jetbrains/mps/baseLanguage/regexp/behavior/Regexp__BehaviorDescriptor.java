...
public final class Regexp__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<SNode> getTopLevelRegexp_idhNm6Oh5 = new SMethodBuilder<SNode>(new SJavaCompoundTypeImpl((Class<SNode>) ((Class) Object.class))).name("getTopLevelRegexp").modifiers(SModifiersImpl.create(0, AccessPrivileges.PUBLIC)).concept(CONCEPT).id("hNm6Oh5").registry(REGISTRY).build(SParameterImpl.fromList(SJavaCompoundTypeImpl.fromClasses()));
  public static final SMethod<String> toString_idhEwIUjb = new SMethodBuilder<String>(new SJavaCompoundTypeImpl(String.class)).name("toString").modifiers(SModifiersImpl.create(8, AccessPrivileges.PUBLIC)).concept(CONCEPT).id("hEwIUjb").registry(REGISTRY).build(SParameterImpl.fromList(SJavaCompoundTypeImpl.fromClasses()));
  ...
  public static final SMethod<String> par_idhMuIPHY = new SMethodBuilder<String>(new SJavaCompoundTypeImpl(String.class)).name("par").modifiers(SModifiersImpl.create(0, AccessPrivileges.PROTECTED)).concept(CONCEPT).id("hMuIPHY").registry(REGISTRY).build(SParameterImpl.fromList(SJavaCompoundTypeImpl.fromClasses(String.class)));
  public static final SMethod<Boolean> checkStringForUnicode_idhMRXRyL = new SMethodBuilder<Boolean>(new SJavaCompoundTypeImpl(Boolean.TYPE)).name("checkStringForUnicode").modifiers(SModifiersImpl.create(0, AccessPrivileges.PROTECTED)).concept(CONCEPT).id("hMRXRyL").registry(REGISTRY).build(SParameterImpl.fromList(SJavaCompoundTypeImpl.fromClasses(String.class)));
  public static final SMethod<String> quote_idhMRXVXe = new SMethodBuilder<String>(new SJavaCompoundTypeImpl(String.class)).name("quote").modifiers(SModifiersImpl.create(0, AccessPrivileges.PROTECTED)).concept(CONCEPT).id("hMRXVXe").registry(REGISTRY).build(SParameterImpl.fromList(SJavaCompoundTypeImpl.fromClasses(Character.TYPE)));
  public static final SMethod<String> escape_id1b8uQvZ_lG7 = new SMethodBuilder<String>(new SJavaCompoundTypeImpl(String.class)).name("escape").modifiers(SModifiersImpl.create(0, AccessPrivileges.PROTECTED)).concept(CONCEPT).id("1b8uQvZ_lG7").registry(REGISTRY).build(SParameterImpl.fromList(SJavaCompoundTypeImpl.fromClasses(String.class)));
  ...
  private static String par_idhMuIPHY(@NotNull SNode __thisNode__, String s) {
    return "(?:" + s + ")";
  }
  private static Boolean checkStringForUnicode_idhMRXRyL(@NotNull SNode __thisNode__, String s) {
    return s.startsWith("\\u");
  }
  private static String quote_idhMRXVXe(@NotNull SNode __thisNode__, char ch) {
    return Pattern.quote("" + ch);
  }
  private static String escape_id1b8uQvZ_lG7(@NotNull SNode __thisNode__, String s) {
  ...
  protected <T> T invokeSpecial0(@NotNull SNode node, @NotNull SMethod<T> method, @NotNull Object[] parameters) {
    ...
    switch (methodIndex) {
      case 0:
        return (T) getTopLevelRegexp_idhNm6Oh5(node);
      case 1:
        return (T) toString_idhEwIUjb(node);
      case 2:
        return (T) getString_idhMuDF1A(node, (List<SNode>) parameters[0]);
      case 3:
        return (T) par_idhMuIPHY(node, (String) parameters[0]);
      case 4:
        return (T) checkStringForUnicode_idhMRXRyL(node, (String) parameters[0]);
      case 5:
        return (T) quote_idhMRXVXe(node, (Character) parameters[0]);
      case 6:
        return (T) escape_id1b8uQvZ_lG7(node, (String) parameters[0]);
      case 7:
