...
public class AtLeastNTimesRegexp_Behavior {
  ...
  public static String virtual_getString_1222432436326(SNode thisNode, List<SNode> vars) {
    ...
    return ((UnaryRegexp_Behavior.call_inParentheses_1353467374623956744(thisNode) ? Regexp_Behavior.call_par_1222433790846(thisNode, s) : s)) + "{" + SPropertyOperations.getInteger(thisNode, MetaAdapterFactory.getProperty(0xdaafa647f1f74b0bL, 0xb09669cd7c8408c0L, 0x1118dc30ee2L, 0x1118dc39835L, "n")) + ",}";
  }
}
