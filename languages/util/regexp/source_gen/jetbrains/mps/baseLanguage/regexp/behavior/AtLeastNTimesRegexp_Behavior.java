...
public class AtLeastNTimesRegexp_Behavior {
  ...
  public static String virtual_getString_1222432436326(SNode thisNode, List<SNode> vars) {
    ...
    return ((UnaryRegexp_Behavior.call_inParentheses_1353467374623956744(thisNode) ? Regexp_Behavior.call_par_1222433790846(thisNode, s) : s)) + "{" + SPropertyOperations.getInteger(thisNode, MetaAdapterFactory.getProperty(new UUID(-2688747624584492277l, -5722269945249396544l), 1174904442594l, 1174904477749l, "n")) + ",}";
  }
}
