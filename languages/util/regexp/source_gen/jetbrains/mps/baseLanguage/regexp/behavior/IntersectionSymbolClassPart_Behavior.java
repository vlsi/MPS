...
public class IntersectionSymbolClassPart_Behavior {
  ...
  public static String callSuperNew_getRepresentation_8173814113624650585(SNode thisNode, String callerConceptFqName) {
    return (String) BehaviorManager.getInstance().invokeSuperNew(Object.class, SNodeOperations.cast(thisNode, "jetbrains.mps.baseLanguage.regexp.structure.IntersectionSymbolClassPart"), callerConceptFqName, "virtual_getRepresentation_8173814113624650482", PARAMETERS_8173814113624650585, new Object[]{});
  }
