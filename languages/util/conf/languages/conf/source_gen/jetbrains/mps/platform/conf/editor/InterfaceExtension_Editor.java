...
public class InterfaceExtension_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createCollection_4lf1wj_a(EditorContext editorContext, SNode node) {
    ...
    editorCell.addEditorCell(this.createRefCell_4lf1wj_a0(editorContext, node));
    editorCell.addEditorCell(this.createCollection_4lf1wj_b0(editorContext, node));
    return editorCell;
  }

  private EditorCell createRefCell_4lf1wj_a0(EditorContext editorContext, SNode node) {
  ...
  public static class _Inline_4lf1wj_a0a extends InlineCellProvider {
    ...
    public EditorCell createEditorCell(EditorContext editorContext, SNode node) {
      return this.createProperty_4lf1wj_a0a0(editorContext, node);
    }

    private EditorCell createProperty_4lf1wj_a0a0(EditorContext editorContext, SNode node) {
  ...
  private EditorCell createCollection_4lf1wj_b0(EditorContext editorContext, SNode node) {
    EditorCell_Collection editorCell = EditorCell_Collection.createIndent2(editorContext, node);
    editorCell.setCellId("Collection_4lf1wj_b0");
    Style style = new StyleImpl();
    style.set(StyleAttributes.SELECTABLE, false);
    editorCell.getStyle().putAll(style);
  ...
  private EditorCell createRefCell_4lf1wj_b1a(EditorContext editorContext, SNode node) {
    CellProviderWithRole provider = new RefCellCellProvider(node, editorContext);
  ...
  public static class _Inline_4lf1wj_a1b0 extends InlineCellProvider {
    ...
    public EditorCell createEditorCell(EditorContext editorContext, SNode node) {
      return this.createProperty_4lf1wj_a0b1a(editorContext, node);
    }

    private EditorCell createProperty_4lf1wj_a0b1a(EditorContext editorContext, SNode node) {
      CellProviderWithRole provider = new PropertyCellProvider(node, editorContext);
      provider.setRole("name");
      provider.setNoTargetText("<no name>");
      provider.setReadOnly(true);
