...
public class GWTModuleStubs extends AbstractModelRootManager {
  ...
  public Collection<SModelDescriptor> load(@NotNull ModelRoot root, IModule module) {
    ...
    ListSequence.fromList(res).addSequence(SetSequence.fromSet(new StubModelDescriptors(SModelStereotype.getStubStereotypeForId("gwt"), root, module).getDescriptors(new _FunctionTypes._return_P1_E0<PathItem, String>() {
