...
public class Path_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createCollection_kwgg2r_a(EditorContext editorContext, SNode node) {
    ...
    editorCell.addEditorCell(this.createComponent_kwgg2r_a0(editorContext, node));
  ...
  private EditorCell createComponent_kwgg2r_a0(EditorContext editorContext, SNode node) {
