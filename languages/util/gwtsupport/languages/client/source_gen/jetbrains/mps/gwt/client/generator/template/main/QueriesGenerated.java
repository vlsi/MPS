...
public class QueriesGenerated {
  public static boolean baseMappingRule_Condition_1220369573364358067(final IOperationContext operationContext, final BaseMappingRuleContext _context) {
    return _context.getSessionObject("jetbrains.mps.gwt.client.generator.runtime-weaving.done" + _context.getNode().getNodeId().toString()) == null;
  }
  ...
  public static Iterable sourceNodesQuery_1220369573364040170(final IOperationContext operationContext, final SourceSubstituteMacroNodesContext _context) {
    ...
    for (Language lang : langs) {
      for (SModuleReference mr : lang.getRuntimeModulesReferences()) {
        for (SModel smd : MPSModuleRepository.getInstance().getModule(mr).getModels()) {
          SModel rtModel = smd;
  ...
  public static SNode weaving_MappingRule_ContextNodeQuery_1220369573364066232(final IOperationContext opereationContext, final WeavingMappingRuleContext _context) {
    _context.putSessionObject("jetbrains.mps.gwt.client.generator.runtime-weaving.done" + _context.getNode().getNodeId().toString(), Boolean.TRUE);
