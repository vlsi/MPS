...
public class StructureAspectDescriptor implements BaseStructureAspectDescriptor {
  ...
  public StructureAspectDescriptor() {
    myFqNameToConcept.put("jetbrains.mps.execution.util.structure.IMainClass", null);
  }
  ...
  private ConceptDescriptor initLazy(String conceptFqName) {
    ...
    switch (Arrays.binarySearch(stringSwitchCases_1htk8d_a0d0i, conceptFqName)) {
      case 0:
        conceptDescriptor = new ConceptDescriptorBuilder("jetbrains.mps.execution.util.structure.IMainClass").interface_().create();
        break;
      default:
  ...
  private static String[] stringSwitchCases_1htk8d_a0d0i = new String[]{"jetbrains.mps.execution.util.structure.IMainClass"};
}
