...
public class StructureAspectDescriptor implements jetbrains.mps.smodel.runtime.StructureAspectDescriptor {
  ...
  public ConceptDescriptor getDescriptor(String conceptFqName) {
    switch (Arrays.binarySearch(stringSwitchCases_1htk8d_a0a0b, conceptFqName)) {
      ...
      case 1:
        return new ConceptDescriptorBuilder("jetbrains.mps.ide.uiLanguage.structure.DialogExpression").super_("jetbrains.mps.baseLanguage.structure.Expression").parents("jetbrains.mps.baseLanguage.structure.Expression").alias("dialog", "").create();
      case 2:
        return new ConceptDescriptorBuilder("jetbrains.mps.ide.uiLanguage.structure.DisposeDialogExpression").super_("jetbrains.mps.baseLanguage.structure.Expression").parents("jetbrains.mps.baseLanguage.structure.Expression", "jetbrains.mps.lang.core.structure.IDontSubstituteByDefault").alias("disposeDialog", "").create();
      case 3:
        return new ConceptDescriptorBuilder("jetbrains.mps.ide.uiLanguage.structure.DisposeDialogStatement").super_("jetbrains.mps.baseLanguage.structure.Statement").parents("jetbrains.mps.baseLanguage.structure.Statement").alias("disposeDialog", "").create();
      case 4:
      ...
      case 7:
        return new ConceptDescriptorBuilder("jetbrains.mps.ide.uiLanguage.structure.ReportErrorStatement").super_("jetbrains.mps.baseLanguage.structure.Statement").parents("jetbrains.mps.baseLanguage.structure.Statement").children(new String[]{"errorText"}, new boolean[]{false}).alias("reportError", "").create();
      default:
