...
public class GFGetterFun_Behavior {
  ...
  private static SNode _quotation_createNode_kkk3v2_a0a0() {
    ...
    quotedNode_1.setReference("concept", SReference.create("concept", quotedNode_1, SModelReference.fromString("r:00000000-0000-4000-0000-011c895902ca(jetbrains.mps.baseLanguage.structure)"), jetbrains.mps.smodel.SNodeId.fromString("1068431790191")));
    return quotedNode_1;
  }
}
