...
public class TreePathAspect_Behavior {
  ...
  public static SNode call_getDefaultProperty_1213877241846(SNode thisNode) {
    return SNodeOperations.cast(ListSequence.fromList(SLinkOperations.getTargets(thisNode, "nodeKinds", true)).translate(new ITranslator2<SNode, SNode>() {
...
__switch__:
    ...
    }).first(), "jetbrains.mps.ypath.structure.TreeNodeKindProperty");
  }
}
