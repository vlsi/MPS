...
public class keymap_ListFeature extends KeyMapImpl {
  ...
  public static class keymap_ListFeature_Action0 extends KeyMapActionImpl {
    ...
    public boolean canExecute(final EditorContext editorContext) {
      ...
      if (!(SNodeUtil.isInstanceOf(contextNode, SConceptRepository.getInstance().getConcept("jetbrains.mps.ypath.structure.ListFeature")))) {
        return false;
      }
      return true;
    }
