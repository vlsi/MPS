...
public class ListFeature_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createAlternation_hr3usq_a0a(EditorContext editorContext, SNode node) {
    ...
    editorCell.setSubstituteInfo(new CompositeSubstituteInfo(editorContext, new BasicCellContext(node), new SubstituteInfoPartExt[]{new ListFeature_Editor.ListFeature_generic_cellMenu_hr3usq_a0a0a()}));
    return editorCell;
  }
  ...
  public static class ListFeature_generic_cellMenu_hr3usq_a0a0a extends AbstractCellMenuPart_Generic_Group {
    public ListFeature_generic_cellMenu_hr3usq_a0a0a() {
    }
  ...
  private EditorCell createConstant_hr3usq_a0a2a0(EditorContext editorContext, SNode node) {
    ...
    editorCell.getStyle().putAll(style);
    editorCell.setDefaultText("");
    editorCell.setSubstituteInfo(new CompositeSubstituteInfo(editorContext, new BasicCellContext(node), new SubstituteInfoPartExt[]{new ListFeature_Editor.ListFeature_component_cellMenu_hr3usq_a0a0a2a0()}));
    return editorCell;
  }

  public static class ListFeature_component_cellMenu_hr3usq_a0a0a2a0 implements SubstituteInfoPartExt {
    private menu_FeatureSetOpposite myComponent;

    public ListFeature_component_cellMenu_hr3usq_a0a0a2a0() {
  ...
  private EditorCell createConstant_hr3usq_a0a2a0_0(EditorContext editorContext, SNode node) {
    ...
    IFeature_opposite_DELETE.setCellActions(editorCell, node, editorContext);
    editorCell.setDefaultText("");
    editorCell.setSubstituteInfo(new CompositeSubstituteInfo(editorContext, new BasicCellContext(node), new SubstituteInfoPartExt[]{new ListFeature_Editor.ListFeature_component_cellMenu_hr3usq_a0a0a2a0_0()}));
    return editorCell;
  }
  ...
  public static class ListFeature_component_cellMenu_hr3usq_a0a0a2a0_0 implements SubstituteInfoPartExt {
    private menu_FeatureSetOpposite myComponent;

    public ListFeature_component_cellMenu_hr3usq_a0a0a2a0_0() {
      this.myComponent = new menu_FeatureSetOpposite();
    }
  ...
  private EditorCell createConstant_hr3usq_b0a2a0(EditorContext editorContext, SNode node) {
    ...
    IFeature_opposite_DELETE.setCellActions(editorCell, node, editorContext);
    editorCell.setDefaultText("");
    editorCell.setSubstituteInfo(new CompositeSubstituteInfo(editorContext, new BasicCellContext(node), new SubstituteInfoPartExt[]{new ListFeature_Editor.ListFeature_component_cellMenu_hr3usq_a0b0a2a0()}));
    return editorCell;
  }
  ...
  public static class ListFeature_component_cellMenu_hr3usq_a0b0a2a0 implements SubstituteInfoPartExt {
    private menu_FeatureSetOpposite myComponent;

    public ListFeature_component_cellMenu_hr3usq_a0b0a2a0() {
      this.myComponent = new menu_FeatureSetOpposite();
    }
