...
public class typeof_ExpressionFunctionParam_InferenceRule extends AbstractInferenceRule_Runtime implements InferenceRule_Runtime {
  ...
  public void applyRule(final SNode expressionFunctionParam, final TypeCheckingContext typeCheckingContext, IsApplicableStatus status) {
    {
      ...
      typeCheckingContext.createEquation((SNode) typeCheckingContext.typeOf(_nodeToCheck_1029348928467, "r:00000000-0000-4000-0000-011c895905aa(jetbrains.mps.ypath.typesystem)", "1223208192097", true), (SNode) _quotation_createNode_hbssoi_a0a0a(), _info_12389875345);
    }
  }
  ...
  private static SNode _quotation_createNode_hbssoi_a0a0a() {
