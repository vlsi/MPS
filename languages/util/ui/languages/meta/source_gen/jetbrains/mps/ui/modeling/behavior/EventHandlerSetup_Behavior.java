...
public class EventHandlerSetup_Behavior {
  ...
  public static List<SNode> virtual_getApplicableConceptFunctionParameter_3044950653914717136(SConcept thisConcept) {
    ...
    ListSequence.fromList(result).addElement(SNodeOperations.getNode("r:ba1d89ed-800e-4d0a-ad09-221b1011fbd1(jetbrains.mps.ui.modeling.structure)", "8115675450774807738"));
    ListSequence.fromList(result).addElement(SNodeOperations.getNode("r:ba1d89ed-800e-4d0a-ad09-221b1011fbd1(jetbrains.mps.ui.modeling.structure)", "5703963167136660800"));
    return result;
  }
}
