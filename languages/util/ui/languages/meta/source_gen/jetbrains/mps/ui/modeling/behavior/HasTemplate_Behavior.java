...
public class HasTemplate_Behavior {
  ...
  public static SNode call_findTemplate_3939571372331676060(SNode thisNode, SModel model, IScope scope) {
    ...
    return (SNode) descriptor.invoke(Object.class, SNodeOperations.cast(thisNode, "jetbrains.mps.ui.modeling.structure.HasTemplate"), "virtual_findTemplate_3939571372331676060", PARAMETERS_3939571372331676060, new Object[]{model, scope});
  }
