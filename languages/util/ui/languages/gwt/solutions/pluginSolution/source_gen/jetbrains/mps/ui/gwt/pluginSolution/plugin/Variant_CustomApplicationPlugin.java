...
public class Variant_CustomApplicationPlugin extends BaseCustomApplicationPlugin {
  ...
  private static SNode _quotation_createNode_fq17w2_a0a0a1a0a0a0a0a() {
    ...
    quotedNode_1.setReference("plugin", jetbrains.mps.smodel.SReference.create("plugin", quotedNode_1, SModelReference.fromString("r:5c48d15b-8e31-45b6-af73-b6432909d8d3(jetbrains.mps.ui.gwt.pluginSolution.plugin)"), SNodeId.fromString("5487985028841944287")));
    return quotedNode_1;
  }
}
