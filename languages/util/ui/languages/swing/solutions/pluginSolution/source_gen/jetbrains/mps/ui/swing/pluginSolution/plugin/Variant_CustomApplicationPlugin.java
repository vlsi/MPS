  ...
  public void doInit() {
    Variants.register(new _FunctionTypes._void_P1_E0<Variants>() {
      public void invoke(Variants vars) {
        vars.addVariant("Swing", SNodeOperations.getModel(SLinkOperations.getTarget(new Variant_CustomApplicationPlugin.QuotationClass_ks96zg_a0a0a0b0a0a0a0a0().createNode(), "plugin", false)).getModelDescriptor().getModule());
      }
    });
  }
  ...
  public static class QuotationClass_ks96zg_a0a0a0b0a0a0a0a0 {
    ...
    public SNode createNode() {
      ...
      SNode quotedNode_1 = null;
      {
        ...
        quotedNode1_2.addReference(SReference.create("plugin", quotedNode1_2, SModelReference.fromString("r:aa1c012e-5fdf-4d29-906b-e1278df6785e(jetbrains.mps.ui.swing.pluginSolution.plugin)"), SNodeId.fromString("5487985028841950024")));
