...
public class BeanPropertyView_Editor extends DefaultNodeEditor {
  public EditorCell createEditorCell(EditorContext editorContext, SNode node) {
    return this.createCollection_te95m9_a(editorContext, node);
  }
  ...
  public static class _Inline_te95m9_a3a extends InlineCellProvider {
    ...
    public EditorCell createEditorCell(EditorContext editorContext, SNode node) {
      return this.createReferencePresentation_te95m9_a0d0(editorContext, node);
    }
  ...
  private EditorCell createCollection_te95m9_a(EditorContext editorContext, SNode node) {
    ...
    editorCell.addEditorCell(this.createRefCell_te95m9_d0(editorContext, node));
    editorCell.addEditorCell(this.createConstant_te95m9_e0(editorContext, node));
    return editorCell;
  }
  ...
  private EditorCell createRefCell_te95m9_d0(EditorContext editorContext, SNode node) {
    CellProviderWithRole provider = new RefCellCellProvider(node, editorContext);
    provider.setRole("getter");
    provider.setNoTargetText("<no getter>");
    EditorCell editorCell;
    provider.setAuxiliaryCellProvider(new BeanPropertyView_Editor._Inline_te95m9_a3a());
  ...
  private EditorCell createRefNode_te95m9_b0(EditorContext editorContext, SNode node) {
