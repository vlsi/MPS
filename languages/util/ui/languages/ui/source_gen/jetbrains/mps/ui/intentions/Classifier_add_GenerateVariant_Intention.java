...
public class Classifier_add_GenerateVariant_Intention implements IntentionFactory {
  ...
  private static SNode _quotation_createNode_3484lm_a0a0a0() {
    ...
    quotedNode_1.setReference("classifier", jetbrains.mps.smodel.SReference.create("classifier", quotedNode_1, SModelReference.fromString("r:36693452-2637-4608-8caa-ab32ee7c1be3(jetbrains.mps.ui.multiplexing)"), SNodeId.fromString("8590671622324268192")));
    return quotedNode_1;
  }
  ...
  private static SNode _quotation_createNode_3484lm_a0a0a0c0a() {
    ...
    quotedNode_1.setReference("annotation", jetbrains.mps.smodel.SReference.create("annotation", quotedNode_1, SModelReference.fromString("r:36693452-2637-4608-8caa-ab32ee7c1be3(jetbrains.mps.ui.multiplexing)"), SNodeId.fromString("8590671622324268192")));
    ...
    quotedNode_2.setReference("key", jetbrains.mps.smodel.SReference.create("key", quotedNode_2, SModelReference.fromString("r:36693452-2637-4608-8caa-ab32ee7c1be3(jetbrains.mps.ui.multiplexing)"), SNodeId.fromString("8590671622324287920")));
