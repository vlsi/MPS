...
public class UI_StyleSheet {
  ...
  public static void applyUIObjectBox(Style style, jetbrains.mps.openapi.editor.cells.EditorCell editorCell) {
  }

  public static void applyUIObjectMargins(Style style, jetbrains.mps.openapi.editor.cells.EditorCell editorCell) {
    style.set(StyleAttributes.SELECTABLE, false);
  }
