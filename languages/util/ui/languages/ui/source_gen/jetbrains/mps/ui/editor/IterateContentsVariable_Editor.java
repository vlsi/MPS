...
public class IterateContentsVariable_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createProperty_rytpvi_a0(EditorContext editorContext, SNode node) {
    ...
    editorCell.setSubstituteInfo(new CompositeSubstituteInfo(editorContext, provider.getCellContext(), new SubstituteInfoPartExt[]{new IterateContentsVariable_Editor.IterateContentsVariable_name_postfixCellMenu_a0a0()}));
