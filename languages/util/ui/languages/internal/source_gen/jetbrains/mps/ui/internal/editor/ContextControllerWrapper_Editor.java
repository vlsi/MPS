...
public class ContextControllerWrapper_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createCollection_p96djm_a0(EditorContext editorContext, SNode node) {
    ...
    editorCell.addEditorCell(this.createComponent_p96djm_a0a(editorContext, node));
  ...
  private EditorCell createComponent_p96djm_a0a(EditorContext editorContext, SNode node) {
