  ...
  public void doInit() {
    Variants.register(new _FunctionTypes._void_P1_E0<Variants>() {
      public void invoke(Variants vars) {
        vars.addVariant("SWT", SNodeOperations.getModel(SLinkOperations.getTarget(new Variant_CustomApplicationPlugin.QuotationClass_ks96zg_a0a0a0b0a0a0a0a0a0a().createNode(), "plugin", false)).getModelDescriptor().getModule());
      }
    });
  }
  ...
  public static class QuotationClass_ks96zg_a0a0a0b0a0a0a0a0a0a {
    ...
    public SNode createNode() {
      ...
      SNode quotedNode_1 = null;
      {
        ...
        quotedNode1_2.setReference("plugin", SReference.create("plugin", quotedNode1_2, SModelReference.fromString("r:a7b2ce5c-fa36-4a0c-9c5e-de5ded669046(jetbrains.mps.ui.swt.pluginSolution.plugin)"), SNodeId.fromString("5487985028841950086")));
