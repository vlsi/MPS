...
public class ExternalCommandCall_Behavior {
  ...
  public static List<SNode> call_getUsedOptions_7803330421062325317(SNode thisNode) {
    ...
    for (SNode ref : ListSequence.<SNode>fromList(SLinkOperations.getTargets(thisNode, "refToOptions", true))) {
      if (SNodeOperations.isInstanceOf(ref, "jetbrains.mps.bash.structure.OptionSetReference")) {
        ListSequence.<SNode>fromList(result).addSequence(ListSequence.<SNode>fromList(OptionSetReference_Behavior.call_getUsedSymbols_7803330421062325062(SNodeOperations.cast(ref, "jetbrains.mps.bash.structure.OptionSetReference"))));
      }
    }
    return result;
  }
  ...
  public static List<SNode> call_getAvailableOptions_7803330421062325454(SNode thisNode) {
    ...
    ListSequence.<SNode>fromList(result).removeSequence(ListSequence.<SNode>fromList(ExternalCommandCall_Behavior.call_getUsedOptions_7803330421062325317(thisNode)));
    return result;
  }

  public static boolean call_isAllOptionsUsed_7803330421063829865(SNode thisNode) {
    return ListSequence.<SNode>fromList(ExternalCommandCall_Behavior.call_getAvailableOptions_7803330421062325454(thisNode)).isEmpty();
  }

  public static boolean call_isArgsListDefined_3147078024755335958(SNode thisNode) {
    for (SNode opt : ListSequence.<SNode>fromList(SLinkOperations.getTargets(SLinkOperations.getTarget(thisNode, "declaration", false), "optionDeclaration", true))) {
  ...
  public static List<SNode> call_getUnusedArguments_3263637656466355284(SNode thisNode) {
    ...
    for (SNode ref : ListSequence.<SNode>fromList(SLinkOperations.getTargets(thisNode, "refToOptions", true))) {
      if (SNodeOperations.isInstanceOf(ref, "jetbrains.mps.bash.structure.ArgumentReference")) {
        ListSequence.<SNode>fromList(args).removeElement(SLinkOperations.getTarget(SNodeOperations.cast(ref, "jetbrains.mps.bash.structure.ArgumentReference"), "arg", false));
      }
    }
    return args;
  }
  ...
  public static List<SNode> call_getUnusedOptionsWithParam_3263637656468078237(SNode thisNode) {
    ...
    for (SNode ref : ListSequence.<SNode>fromList(SLinkOperations.getTargets(thisNode, "refToOptions", true))) {
      if (SNodeOperations.isInstanceOf(ref, "jetbrains.mps.bash.structure.OptionWithParamReference")) {
        ListSequence.<SNode>fromList(args).removeElement(SLinkOperations.getTarget(SNodeOperations.cast(ref, "jetbrains.mps.bash.structure.OptionWithParamReference"), "optionWithParam", false));
      }
    }
