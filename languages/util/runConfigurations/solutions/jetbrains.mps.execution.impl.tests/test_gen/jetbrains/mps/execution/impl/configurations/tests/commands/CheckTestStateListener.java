...
import jetbrains.mps.baseLanguage.unitTest.plugin.TestStateListener;
...
public class CheckTestStateListener implements TestStateListener {
  ...
  private void check(TestEvent event, Set<ITestNodeWrapper> collection, String message) {
    ...
    if (SetSequence.fromSet(collection).findFirst(new IWhereFilter<ITestNodeWrapper>() {
      public boolean accept(ITestNodeWrapper it) {
        return eq_bojeyd_a0a0a0a0a0a1a0(it.getName(), method);
      }
    }) == null) {
