...
public class KeyValueCommandPart_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createCollection_4797dc_a(EditorContext editorContext, SNode node) {
    ...
    editorCell.addEditorCell(this.createRefNode_4797dc_b0(editorContext, node));
    editorCell.addEditorCell(this.createRefNode_4797dc_c0(editorContext, node));
    editorCell.addEditorCell(this.createConstant_4797dc_d0(editorContext, node));
    return editorCell;
  }
  ...
  private EditorCell createConstant_4797dc_d0(EditorContext editorContext, SNode node) {
    EditorCell_Constant editorCell = new EditorCell_Constant(editorContext, node, "]");
    editorCell.setCellId("Constant_4797dc_d0");
  ...
  private EditorCell createRefNode_4797dc_b0(EditorContext editorContext, SNode node) {
