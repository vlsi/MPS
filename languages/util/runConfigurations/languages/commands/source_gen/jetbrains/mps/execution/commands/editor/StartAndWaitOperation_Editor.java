...
public class StartAndWaitOperation_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createCollection_1q86sn_a(EditorContext editorContext, SNode node) {
    ...
    editorCell.addEditorCell(this.createConceptProperty_1q86sn_a0(editorContext, node));
    editorCell.addEditorCell(this.createConstant_1q86sn_b0(editorContext, node));
    editorCell.addEditorCell(this.createConstant_1q86sn_c0(editorContext, node));
    return editorCell;
  }
  ...
  private EditorCell createConstant_1q86sn_c0(EditorContext editorContext, SNode node) {
    EditorCell_Constant editorCell = new EditorCell_Constant(editorContext, node, ")");
    editorCell.setCellId("Constant_1q86sn_c0");
    BaseLanguageStyle_StyleSheet.getRightParen(editorCell).apply(editorCell);
    editorCell.setDefaultText("");
    return editorCell;
  }

  private EditorCell createConceptProperty_1q86sn_a0(EditorContext editorContext, SNode node) {
