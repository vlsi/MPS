...
public class MethodConditions_Behavior {
  ...
  public static List<SNode> virtual_getAttributed_3044950653914717013(SConcept thisConcept) {
    ...
    ListSequence.fromList(result).addElement(SNodeOperations.getNode("r:00000000-0000-4000-0000-011c895902ca(jetbrains.mps.baseLanguage.structure)", "1068580123165"));
    return result;
  }
}
