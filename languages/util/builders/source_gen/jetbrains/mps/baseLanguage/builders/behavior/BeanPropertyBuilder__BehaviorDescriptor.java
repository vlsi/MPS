...
public final class BeanPropertyBuilder_BehaviorDescriptor extends BaseBHDescriptor {
  ...
  private static String getPropertyName_id2kIZjjSEvS7(@NotNull SAbstractConcept __thisConcept__, String methodName) {
    String prefix = "set";
    if (methodName == null) {
      return null;
    }
  ...
  /*package*/ BeanPropertyBuilder_BehaviorDescriptor() {
    super(REGISTRY);
  }
  ...
  protected <T> T invokeSpecial0(@NotNull SAbstractConcept concept, @NotNull SMethod<T> method, @NotNull Object[] parameters) {
    ...
    switch (methodIndex) {
      ...
      case 4:
        return (T) getPropertyName_id2kIZjjSEvS7(concept, (String) parameters[0]);
      default:
        throw new BHMethodNotFoundException(this, method);
    }
  }
