...
public class LocalExtendedMethodCall_Constraints extends BaseConstraintsDescriptor {
  public LocalExtendedMethodCall_Constraints() {
    super(MetaIdFactory.conceptId(0x5dc5fc0d37ef4782L, 0x81928b5ce1f69f80L, 0x6aa7ca55518b9170L));
  }
  @Override
      ...
      public ReferenceScopeProvider getScopeProvider() {
        return new BaseReferenceScopeProvider() {
          ...
          public Object createSearchScopeOrListOfNodes(final IOperationContext operationContext, final ReferenceConstraintsContext _context) {
            ...
            SNode classifier = ExtensionMethodDeclaration_BehaviorDescriptor.getClassifier_id6EBM_lhz9HU.invoke(SNodeOperations.getNodeAncestor(_context.getEnclosingNode(), MetaAdapterFactory.getConcept(0x5dc5fc0d37ef4782L, 0x81928b5ce1f69f80L, 0x1583d1b63365e7f9L, "jetbrains.mps.baseLanguage.extensionMethods.structure.ExtensionMethodDeclaration"), false, false));
            if (classifier == null) {
              return result;
            }
            ...
            while (classifier != null) {
              Iterable<SNode> methods = Members.visibleInstanceMethods(IClassifier_BehaviorDescriptor.getThisType_id6r77ob2UWbY.invoke(classifier), _context.getEnclosingNode());
