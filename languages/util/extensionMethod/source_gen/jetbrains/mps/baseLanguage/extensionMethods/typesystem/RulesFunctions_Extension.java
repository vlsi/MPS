...
public class RulesFunctions_Extension {
  ...
  public static void inference_equateApplicableType(final TypeCheckingContext typeCheckingContext, SNode instanceType, SNode extensionMethod, Map<SNode, List<SNode>> mmap) {
    SNode matchedType = RulesFunctions_BaseLanguage.inference_matchTypeWithTypeVariables(typeCheckingContext, ExtensionMethodDeclaration__BehaviorDescriptor.getThisType_id6XkcKt_eUWM.invoke(extensionMethod), mmap);
    {
