...
public class DoRefactorClause extends ConceptFunction {
  ...
  public static DoRefactorClause newInstance(SModel sm, boolean init) {
    return (DoRefactorClause)SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.logging.refactoring.structure.DoRefactorClause", sm, GlobalScope.getInstance(), init).getAdapter();
  }
