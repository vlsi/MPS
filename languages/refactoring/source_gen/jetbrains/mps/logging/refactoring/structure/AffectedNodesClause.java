...
public class AffectedNodesClause extends ConceptFunction {
  ...
  public static AffectedNodesClause newInstance(SModel sm, boolean init) {
    return (AffectedNodesClause)SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.logging.refactoring.structure.AffectedNodesClause", sm, GlobalScope.getInstance(), init).getAdapter();
  }
