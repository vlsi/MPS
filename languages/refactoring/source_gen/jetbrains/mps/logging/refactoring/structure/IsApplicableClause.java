...
public class IsApplicableClause extends ConceptFunction {
  public static final String concept = "jetbrains.mps.logging.refactoring.structure.IsApplicableClause";
  ...
  public static IsApplicableClause newInstance(SModel sm, boolean init) {
    return (IsApplicableClause)SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.logging.refactoring.structure.IsApplicableClause", sm, GlobalScope.getInstance(), init).getAdapter();
  }
