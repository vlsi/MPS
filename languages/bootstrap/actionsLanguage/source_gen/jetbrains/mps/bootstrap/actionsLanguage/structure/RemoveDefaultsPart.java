...
public class RemoveDefaultsPart extends MenuBuilderPart {
  ...
  public static RemoveDefaultsPart newInstance(SModel sm, boolean init) {
    return (RemoveDefaultsPart)SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.bootstrap.actionsLanguage.structure.RemoveDefaultsPart", sm, GlobalScope.getInstance(), init).getAdapter();
  }
