  ...
  <node type="jetbrains.mps.baseLanguage.ClassConcept" id="1170377640954">
    ...
    <node role="method" type="jetbrains.mps.baseLanguage.InstanceMethodDeclaration" id="1170378088919">
      ...
      <node role="body" type="jetbrains.mps.baseLanguage.StatementList" id="1170378088921">
        ...
        <node role="statement" type="jetbrains.mps.baseLanguage.ExpressionStatement" id="1170378318670">
          <node role="expression" type="jetbrains.mps.baseLanguage.AssignmentExpression" id="1170378321515">
            <node role="lValue" type="jetbrains.mps.baseLanguage.ParameterReference" id="1170378318671">
              <link role="variableDeclaration" targetNodeId="1170378102242" resolveInfo="node" />
            </node>
            <node role="rValue" type="jetbrains.mps.baseLanguage.NewExpression" id="1170378325876">
              <link role="baseMethodDeclaration" extResolveInfo="8.constructor [Classifier]IfStatement[ConstructorDeclaration] ((jetbrains.mps.baseLanguage.types.classifier/jetbrains.mps.baseLanguage.types.classifier [SModel]))" />
              <node role="actualArgument" type="jetbrains.mps.baseLanguage.NullLiteral" id="1170378369734" />
            </node>
          </node>
        </node>
        <node role="statement" type="jetbrains.mps.baseLanguage.LocalVariableDeclarationStatement" id="1170378529228">
          <node role="localVariableDeclaration" type="jetbrains.mps.baseLanguage.LocalVariableDeclaration" id="1170378529229">
            <property name="name" value="n" />
            <node role="type" type="jetbrains.mps.baseLanguage.ClassifierType" id="1170378529230">
              <link role="classifier" extResolveInfo="8.[Classifier]VariableDeclaration" />
            </node>
            <node role="initializer" type="jetbrains.mps.baseLanguage.CastExpression" id="1170378551689">
              <node role="expression" type="jetbrains.mps.baseLanguage.ParameterReference" id="1170378551690">
                <link role="variableDeclaration" targetNodeId="1170378102242" resolveInfo="node" />
              </node>
              <node role="type" type="jetbrains.mps.baseLanguage.ClassifierType" id="1170378551691">
                <link role="classifier" extResolveInfo="8.[Classifier]VariableDeclaration" />
              </node>
            </node>
          </node>
    ...
    <node role="method" type="jetbrains.mps.baseLanguage.InstanceMethodDeclaration" id="1170378121858">
      ...
      <node role="body" type="jetbrains.mps.baseLanguage.StatementList" id="1170378121860">
        ...
        <node role="statement" type="jetbrains.mps.baseLanguage.LocalVariableDeclarationStatement" id="1170378495378">
          <node role="localVariableDeclaration" type="jetbrains.mps.baseLanguage.LocalVariableDeclaration" id="1170378495379">
            <property name="name" value="n" />
            <node role="type" type="jetbrains.mps.baseLanguage.ClassifierType" id="1170378495380">
              <link role="classifier" extResolveInfo="8.[Classifier]VariableDeclaration" />
            </node>
            <node role="initializer" type="jetbrains.mps.baseLanguage.ParameterReference" id="1170378507632">
              <link role="variableDeclaration" targetNodeId="1170378140858" resolveInfo="node" />
            </node>
          </node>
        </node>
  ...
  <node type="jetbrains.mps.baseLanguage.ClassConcept" id="1170378849411">
    ...
    <node role="method" type="jetbrains.mps.baseLanguage.InstanceMethodDeclaration" id="1170378862521">
      ...
      <node role="body" type="jetbrains.mps.baseLanguage.StatementList" id="1170378862523">
        ...
        <node role="statement" type="jetbrains.mps.baseLanguage.ExpressionStatement" id="1170378964884">
          <node role="expression" type="jetbrains.mps.bootstrap.smodelLanguage.SNodeOperationExpression" id="1170378971373">
            <node role="leftExpression" type="jetbrains.mps.bootstrap.smodelLanguage.SNodeOperationExpression" id="1170378967699">
              <node role="leftExpression" type="jetbrains.mps.baseLanguage.ParameterReference" id="1170378964885">
                <link role="variableDeclaration" targetNodeId="1170378882805" resolveInfo="node" />
              </node>
              <node role="nodeOperation" type="jetbrains.mps.bootstrap.smodelLanguage.SPropertyAccess" id="1170378969012">
                <link role="property" targetNodeId="6.1083152972672" />
              </node>
            </node>
            <node role="nodeOperation" type="jetbrains.mps.bootstrap.smodelLanguage.Property_HasValue_Simple" id="1170378978577">
              <node role="value" type="jetbrains.mps.baseLanguage.StringLiteral" id="1170378981954">
                <property name="value" value="..." />
              </node>
            </node>
          </node>
        ...
        <node role="statement" type="jetbrains.mps.baseLanguage.ExpressionStatement" id="1170380724004">
          <node role="expression" type="jetbrains.mps.baseLanguage.InstanceMethodCall" id="1170380758058">
  ...
  <node type="jetbrains.mps.baseLanguage.ClassConcept" id="1170381203537">
    ...
    <node role="method" type="jetbrains.mps.baseLanguage.InstanceMethodDeclaration" id="1170381247570">
      ...
      <node role="body" type="jetbrains.mps.baseLanguage.StatementList" id="1170381247572">
        ...
        <node role="statement" type="jetbrains.mps.baseLanguage.ExpressionStatement" id="1170381976882">
          <node role="expression" type="jetbrains.mps.baseLanguage.InstanceMethodCall" id="1170382174604">
        ...
        <node role="statement" type="jetbrains.mps.baseLanguage.LocalVariableDeclarationStatement" id="1170383816884">
          <node role="localVariableDeclaration" type="jetbrains.mps.baseLanguage.LocalVariableDeclaration" id="1170383816885">
            <property name="name" value="n3" />
            <node role="type" type="jetbrains.mps.baseLanguage.ClassifierType" id="1170383816886">
              <link role="classifier" extResolveInfo="8.[Classifier]FieldDeclaration" />
            </node>
          </node>
        </node>
        <node role="statement" type="jetbrains.mps.baseLanguage.ExpressionStatement" id="1170383816887">
          <node role="expression" type="jetbrains.mps.bootstrap.smodelLanguage.SNodeOperationExpression" id="1170383816888">
            <node role="leftExpression" type="jetbrains.mps.bootstrap.smodelLanguage.SNodeOperationExpression" id="1170383816889">
              <node role="leftExpression" type="jetbrains.mps.baseLanguage.ParameterReference" id="1170383816890">
                <link role="variableDeclaration" targetNodeId="1170381635476" resolveInfo="node" />
              </node>
              <node role="nodeOperation" type="jetbrains.mps.bootstrap.smodelLanguage.SLinkAccess" id="1170383816891">
                <link role="link" targetNodeId="6.1070568237987" />
              </node>
            </node>
            <node role="nodeOperation" type="jetbrains.mps.bootstrap.smodelLanguage.Link_SetTargetOperation" id="1170383816892">
              <node role="parameter" type="jetbrains.mps.baseLanguage.LocalVariableReference" id="1170383816893">
                <link role="variableDeclaration" targetNodeId="1170383816885" resolveInfo="n2" />
              </node>
            </node>
          </node>
        </node>
