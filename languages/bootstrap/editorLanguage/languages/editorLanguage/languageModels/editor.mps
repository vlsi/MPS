...
<model name="jetbrains.mps.bootstrap.editorLanguage.editor">
  ...
  <import index="9" modelUID="jetbrains.mps.bootstrap.editorLanguage.editor" version="-1" />
  <import index="10" modelUID="jetbrains.mps.baseLanguage.editor" version="-1" />
  <import index="11" modelUID="jetbrains.mps.annotations.structure" version="-1" />
  ...
  <import index="15" modelUID="jetbrains.mps.bootstrap.editorLanguage@java_stub" version="-1" />
  ...
  <import index="18" modelUID="java.util@java_stub" version="-1" />
  ...
  <import index="21" modelUID="jetbrains.mps.smodel.action@java_stub" version="-1" />
  <import index="22" modelUID="jetbrains.mps.bootstrap.editorLanguage.structure@java_stub" version="-1" />
  <import index="23" modelUID="jetbrains.mps.core.constraints" version="-1" />
  ...
  <node type="jetbrains.mps.bootstrap.editorLanguage.structure.ConceptEditorDeclaration" id="1158959342696">
    <link role="conceptDeclaration" targetNodeId="2.1139535439104" />
    <node role="cellModel" type="jetbrains.mps.bootstrap.editorLanguage.structure.CellModel_Collection" id="1158959352289">
      <property name="drawBorder" value="false" />
      <node role="childCellModel" type="jetbrains.mps.bootstrap.editorLanguage.structure.CellModel_Constant" id="1158959352290">
        <property name="textFgColor" value="blue" />
        <property name="text" value="&gt;" />
        <property name="attractsFocus" value="1" />
        <property name="fontStyle" value="BOLD" />
      ...
      <node role="childCellModel" type="jetbrains.mps.bootstrap.editorLanguage.structure.CellModel_RefNode" id="1158959352291">
        <property name="drawBorder" value="false" />
        <property name="drawBrackets" value="true" />
        <link role="relationDeclaration" targetNodeId="12.1137022507850" />
      </node>
    </node>
    <node role="inspectedCellModel" type="jetbrains.mps.bootstrap.editorLanguage.structure.CellModel_Collection" id="1158959371957">
      <property name="vertical" value="true" />
      <property name="drawBorder" value="false" />
      <property name="selectable" value="false" />
      <node role="childCellModel" type="jetbrains.mps.bootstrap.editorLanguage.structure.CellModel_Constant" id="1158959371958">
        <property name="textBgColor" value="lightGray" />
        <property name="textFgColor" value="blue" />
        <property name="text" value="cell action" />
        <property name="drawBorder" value="false" />
      </node>
      <node role="childCellModel" type="jetbrains.mps.bootstrap.editorLanguage.structure.CellModel_Constant" id="1158959371959">
        <property name="drawBorder" value="false" />
        <property name="selectable" value="false" />
      </node>
      <node role="childCellModel" type="jetbrains.mps.bootstrap.editorLanguage.structure.CellModel_Constant" id="1158959371960">
        <property name="fontStyle" value="PLAIN" />
        <property name="drawBorder" value="false" />
        <property name="text" value="parameters:" />
      </node>
      <node role="childCellModel" type="jetbrains.mps.bootstrap.editorLanguage.structure.CellModel_Collection" id="1158959371961">
        <property name="vertical" value="true" />
        <property name="drawBorder" value="false" />
        <property name="selectable" value="false" />
        <property name="gridLayout" value="true" />
        <node role="childCellModel" type="jetbrains.mps.bootstrap.editorLanguage.structure.CellModel_Collection" id="1158959371962">
          <property name="drawBorder" value="false" />
          <property name="selectable" value="false" />
          <node role="childCellModel" type="jetbrains.mps.bootstrap.editorLanguage.structure.CellModel_Constant" id="1158959371963">
            <property name="drawBorder" value="false" />
            <property name="text" value="node" />
          </node>
          <node role="childCellModel" type="jetbrains.mps.bootstrap.editorLanguage.structure.CellModel_Constant" id="1158959371964">
            <property name="fontStyle" value="PLAIN" />
            <property name="drawBorder" value="false" />
            <property name="text" value="action node" />
          </node>
        </node>
        <node role="childCellModel" type="jetbrains.mps.bootstrap.editorLanguage.structure.CellModel_Collection" id="1158959371965">
          <property name="drawBorder" value="false" />
          <property name="selectable" value="false" />
          <node role="childCellModel" type="jetbrains.mps.bootstrap.editorLanguage.structure.CellModel_Constant" id="1158959371966">
            <property name="drawBorder" value="false" />
            <property name="text" value="editorContext" />
          </node>
          <node role="childCellModel" type="jetbrains.mps.bootstrap.editorLanguage.structure.CellModel_Constant" id="1158959371967">
            <property name="fontStyle" value="PLAIN" />
            <property name="drawBorder" value="false" />
            <property name="text" value="context (jetbrains.mps.nodeEditor.EditorContext)" />
          </node>
  ...
  <node type="jetbrains.mps.bootstrap.editorLanguage.structure.StyleSheet" id="1186403138470">
    <property name="name" value="StyleSheet" />
    <property name="package" value="Stylesheet" />
    <node role="styleClass" type="jetbrains.mps.bootstrap.editorLanguage.structure.StyleSheetClass" id="1186403684084">
      <property name="name" value="item" />
      <node role="item" type="jetbrains.mps.bootstrap.editorLanguage.structure.FontStyleStyleSheetItem" id="1186404543779">
        <property name="style" value="ITALIC" />
      </node>
      <node role="item" type="jetbrains.mps.bootstrap.editorLanguage.structure.ForegroundColorStyleSheetItem" id="1186406127802">
