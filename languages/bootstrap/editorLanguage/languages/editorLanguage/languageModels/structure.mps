...
<model name="jetbrains.mps.bootstrap.editorLanguage.structure">
  ...
  <import index="34" modelUID="jetbrains.mps.annotations.structure" version="-1" />
  <import index="35" modelUID="java.util@java_stub" version="-1" />
  <import index="36" modelUID="java.lang@java_stub" version="-1" />
  ...
  <node type="jetbrains.mps.bootstrap.structureLanguage.structure.ConceptDeclaration" id="1073389214265">
    ...
    <node role="conceptProperty" type="jetbrains.mps.bootstrap.structureLanguage.structure.StringConceptProperty" id="1162839219692">
