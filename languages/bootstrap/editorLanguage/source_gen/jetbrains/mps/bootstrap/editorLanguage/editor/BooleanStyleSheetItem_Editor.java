...
public class BooleanStyleSheetItem_Editor extends DefaultNodeEditor {
  ...
  private static void setupLabel_FlagCell(EditorCell_Label editorCell, SNode node, EditorContext context) {
  }
  ...
  public EditorCell createRowCell(EditorContext context, SNode node) {
    ...
    BooleanStyleSheetItem_Editor.setupBasic_RowCell(editorCell, node, context);
    editorCell.setGridLayout(false);
    editorCell.setUsesBraces(false);
    editorCell.setCanBeFolded(false);
    editorCell.addEditorCell(this.createCellModel_ConceptProperty(context, node));
    editorCell.addEditorCell(this.createConstantCell(context, node, ":"));
    editorCell.addEditorCell(this.createFlagCell(context, node));
    return editorCell;
  }

  public EditorCell createConstantCell(EditorContext context, SNode node, String text) {
    EditorCell_Constant editorCell = new EditorCell_Constant(context, node, text);
    BooleanStyleSheetItem_Editor.setupBasic_ConstantCell(editorCell, node, context);
    BooleanStyleSheetItem_Editor.setupLabel_ConstantCell(editorCell, node, context);
  ...
  public EditorCell createFlagCell(EditorContext context, SNode node) {
