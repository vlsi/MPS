...
<model name="jetbrains.mps.bootstrap.constraintsLanguage.structure">
  ...
  <import index="10" modelUID="jetbrains.mps.ide@java_stub" version="-1" />
  <import index="11" modelUID="jetbrains.mps.bootstrap.sharedConcepts.structure" version="-1" />
  ...
  <node type="jetbrains.mps.bootstrap.structureLanguage.structure.ConceptDeclaration" id="1148684180339">
    ...
    <node role="conceptLink" type="jetbrains.mps.bootstrap.structureLanguage.structure.AggregationConceptLink" id="1148685281814">
      <link role="conceptLinkDeclaration" targetNodeId="3.1137545148427" />
      <node role="target" type="jetbrains.mps.baseLanguage.structure.ClassifierType" id="1148685793082">
        <link role="classifier" targetNodeId="9.~ISearchScope" resolveInfo="ISearchScope" />
      </node>
    </node>
  ...
  <node type="jetbrains.mps.bootstrap.structureLanguage.structure.ConceptDeclaration" id="1152959968041">
    ...
    <node role="conceptLink" type="jetbrains.mps.bootstrap.structureLanguage.structure.AggregationConceptLink" id="1153138549097">
      <link role="conceptLinkDeclaration" targetNodeId="3.1137546998352" />
      <node role="target" type="jetbrains.mps.bootstrap.structureLanguage.structure.ConceptDeclaration" id="1153138554286">
