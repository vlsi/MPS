...
public class FindModelUsages_ActionGroup extends GeneratedActionGroup {
  ...
  public static final String ID = "jetbrains.mps.lang.core.pluginSolution.plugin.FindModelUsages_ActionGroup";
  ...
  public FindModelUsages_ActionGroup() {
    ...
    this.setPopup(false);
    try {
      FindModelUsages_ActionGroup.this.addAction("jetbrains.mps.lang.core.pluginSolution.plugin.FindModelUsages_Action");
    } catch (Throwable t) {
