...
/*package*/ class NodeAttribute_comment_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createNextEditor_fqq7dl_a() {
    try {
      ...
      getCellFactory().removeCellContextHints(Sequence.fromIterable(getEditorHints_fqq7dl_a0(getNode(), getEditorContext())).toGenericArray(String.class));
      {
  ...
  private Iterable<String> getEditorHints_fqq7dl_a0(SNode node, EditorContext editorContext) {
    ...
    if (check_2lowb9_a1a9(node.getContainmentLink())) {
