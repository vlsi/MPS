...
public class Rename extends BaseRefactoring {
  ...
  public SearchResults getAffectedNodes(final RefactoringContext refactoringContext) {
    return FindUtils.getSearchResults(new EmptyProgressMonitor(), refactoringContext.getSelectedNode(), new GlobalScope(), "jetbrains.mps.lang.structure.findUsages.NodeAndDescendantsUsages_Finder");
  }
}
