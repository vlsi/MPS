...
public class fix_LinkAttribute_name_QuickFix extends QuickFix_Runtime {
  ...
  public String getDescription(SNode node) {
    return "Change name to \"" + LinkAttribute_BehaviorDescriptor.getLink_id1avfQ4BEFo6.invoke(SNodeOperations.as(node, MetaAdapterFactory.getConcept(0xceab519525ea4f22L, 0x9b92103b95ca8c0cL, 0x2eb1ad060897da51L, "jetbrains.mps.lang.core.structure.LinkAttribute"))).getRoleName() + "\"";
  }
  public void execute(SNode node) {
    ...
    SPropertyOperations.set(linkAttribute, MetaAdapterFactory.getProperty(0xceab519525ea4f22L, 0x9b92103b95ca8c0cL, 0x2eb1ad060897da51L, 0x18649a5c82123514L, "linkRole"), LinkAttribute_BehaviorDescriptor.getLink_id1avfQ4BEFo6.invoke(linkAttribute).getRoleName());
  }
}
