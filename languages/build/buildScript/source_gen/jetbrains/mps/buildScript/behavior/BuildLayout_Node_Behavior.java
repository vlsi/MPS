...
public class BuildLayout_Node_Behavior {
  ...
  public static void virtual_appendName_1368030936106665465(SNode thisNode, SNode parent, StringBuilder sb) {
    if (SNodeOperations.isInstanceOf(parent, "jetbrains.mps.buildScript.structure.BuildLayout_Node")) {
      sb.append("/");
    }
  ...
  public static boolean call_isFolder_1368030936106753980(SNode thisNode) {
    BehaviorDescriptor descriptor = ConceptRegistry.getInstance().getBehaviorDescriptorForInstanceNode(thisNode);
    return (Boolean) descriptor.invoke(Boolean.class, SNodeOperations.cast(thisNode, "jetbrains.mps.buildScript.structure.BuildLayout_Node"), "virtual_isFolder_1368030936106753980", PARAMETERS_1368030936106753980);
  }

  public static boolean call_isFile_1368030936106753986(SNode thisNode) {
    BehaviorDescriptor descriptor = ConceptRegistry.getInstance().getBehaviorDescriptorForInstanceNode(thisNode);
    return (Boolean) descriptor.invoke(Boolean.class, SNodeOperations.cast(thisNode, "jetbrains.mps.buildScript.structure.BuildLayout_Node"), "virtual_isFile_1368030936106753986", PARAMETERS_1368030936106753986);
  }
  ...
  public static boolean callSuper_isFolder_1368030936106753980(SNode thisNode, String callerConceptFqName) {
    return (Boolean) BehaviorManager.getInstance().invokeSuper(Boolean.class, SNodeOperations.cast(thisNode, "jetbrains.mps.buildScript.structure.BuildLayout_Node"), callerConceptFqName, "virtual_isFolder_1368030936106753980", PARAMETERS_1368030936106753980);
  }

  public static boolean callSuper_isFile_1368030936106753986(SNode thisNode, String callerConceptFqName) {
    return (Boolean) BehaviorManager.getInstance().invokeSuper(Boolean.class, SNodeOperations.cast(thisNode, "jetbrains.mps.buildScript.structure.BuildLayout_Node"), callerConceptFqName, "virtual_isFile_1368030936106753986", PARAMETERS_1368030936106753986);
  }

  public static void appendName_internal_1368030936106708110(SNode node, StringBuilder sb) {
    SNode parent = SNodeOperations.as(SNodeOperations.getParent(node), "jetbrains.mps.buildScript.structure.BuildLayout_PathElement");
    if (parent != null) {
