...
public class BuildExternalDependency_Behavior {
  ...
  public static Iterable<SNode> callSuper_getDependencyTargets_841011766566205095(SNode thisNode, String callerConceptFqName, VisibleArtifacts artifacts) {
    return (Iterable<SNode>) BehaviorManager.getInstance().invokeSuper(Object.class, SNodeOperations.cast(thisNode, "jetbrains.mps.buildScript.structure.BuildExternalDependency"), callerConceptFqName, "virtual_getDependencyTargets_841011766566205095", PARAMETERS_841011766566205095, artifacts);
  }
}
