...
public class BuildStringPart_Behavior {
  ...
  public static String call_getText_4380385936562037054(SNode thisNode, MacroHelper helper) {
    BehaviorDescriptor descriptor = ConceptRegistry.getInstance().getBehaviorDescriptorForInstanceNode(thisNode);
    return (String) descriptor.invoke(Object.class, SNodeOperations.cast(thisNode, "jetbrains.mps.buildScript.structure.BuildStringPart"), "virtual_getText_4380385936562037054", PARAMETERS_4380385936562037054, helper);
  }
  ...
  public static String callSuper_getText_4380385936562037054(SNode thisNode, String callerConceptFqName, MacroHelper helper) {
    return (String) BehaviorManager.getInstance().invokeSuper(Object.class, SNodeOperations.cast(thisNode, "jetbrains.mps.buildScript.structure.BuildStringPart"), callerConceptFqName, "virtual_getText_4380385936562037054", PARAMETERS_4380385936562037054, helper);
  }
