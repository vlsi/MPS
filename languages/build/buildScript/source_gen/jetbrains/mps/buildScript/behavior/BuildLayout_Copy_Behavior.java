...
public class BuildLayout_Copy_Behavior {
  ...
  public static void virtual_unpack_7128123785277710736(SNode thisNode, UnpackHelper helper) {
    if (SNodeOperations.isInstanceOf(SLinkOperations.getTarget(thisNode, "fileset", true), "jetbrains.mps.buildScript.structure.BuildInputSingleFile")) {
      SNode parent = helper.parent(thisNode);
      String parentLocation = helper.contentLocations().get(parent);
      SNode path = SLinkOperations.getTarget(SNodeOperations.cast(SLinkOperations.getTarget(thisNode, "fileset", true), "jetbrains.mps.buildScript.structure.BuildInputSingleFile"), "path", true);
      if (path != null) {
  ...
  public static boolean virtual_isFile_1368030936106753986(SNode thisNode) {
    return SNodeOperations.isInstanceOf(SLinkOperations.getTarget(thisNode, "fileset", true), "jetbrains.mps.buildScript.structure.BuildInputSingleFile");
  }
  ...
  public static void virtual_appendName_1368030936106665465(SNode thisNode, SNode parent, StringBuilder sb) {
    ...
    BuildLayout_PathElement_Behavior.callSuper_appendName_1368030936106665465(thisNode, "jetbrains.mps.buildScript.structure.BuildLayout_Copy", parent, sb);
  }
}
