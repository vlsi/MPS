...
public class BuildVarRefStringPart_Constraints extends BaseConstraintsDescriptor {
  private static SNodePointer breakingNode_99t0ze_a0a0a0a0a1a0b0a1a0 = new SNodePointer("r:5076fdb3-19c3-4563-aa26-7ace7591e78d(jetbrains.mps.buildScript.constraints)", "4903714810883713096");

  public BuildVarRefStringPart_Constraints() {
    super("jetbrains.mps.buildScript.structure.BuildVarRefStringPart");
  }
