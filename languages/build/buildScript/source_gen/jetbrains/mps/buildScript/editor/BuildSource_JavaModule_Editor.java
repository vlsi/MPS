...
public class BuildSource_JavaModule_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createCollection_kr3er8_a(EditorContext editorContext, SNode node) {
    ...
    editorCell.addEditorCell(this.createRefNodeList_kr3er8_c0(editorContext, node));
    return editorCell;
  }
  ...
  private EditorCell createRefNodeList_kr3er8_c0(EditorContext editorContext, SNode node) {
    AbstractCellListHandler handler = new BuildSource_JavaModule_Editor.contentRootsListHandler_kr3er8_c0(node, "contentRoots", editorContext);
  ...
  private static class contentRootsListHandler_kr3er8_c0 extends RefNodeListHandler {
    public contentRootsListHandler_kr3er8_c0(SNode ownerNode, String childRole, EditorContext context) {
    ...
    public EditorCell createEmptyCell_internal(EditorContext editorContext, SNode node) {
      return this.createConstant_kr3er8_a2a(editorContext, node);
    }
    ...
    private EditorCell createConstant_kr3er8_a2a(EditorContext editorContext, SNode node) {
      EditorCell_Constant editorCell = new EditorCell_Constant(editorContext, node, "<no sources>");
