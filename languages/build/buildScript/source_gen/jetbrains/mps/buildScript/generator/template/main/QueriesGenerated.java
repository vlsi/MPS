...
public class QueriesGenerated {
  ...
  public static boolean ifMacro_Condition_6520682027041189779(final IOperationContext operationContext, final IfMacroContext _context) {
    return new DependenciesHelper(_context, SNodeOperations.getAncestor(_context.getNode(), "jetbrains.mps.buildScript.structure.BuildProject", false, false)).requiresFetch().containsKey(_context.getOriginalCopiedInputNode(_context.getNode()));
  }
  ...
  public static Iterable sourceNodesQuery_4701820937132337542(final IOperationContext operationContext, final SourceSubstituteMacroNodesContext _context) {
    return SNodeOperations.getDescendants(_context.getNode(), "jetbrains.mps.buildScript.structure.BuildLayout_Node", false, new String[]{});
  }
  ...
  public static Object insertMacro_varValue_6520682027041193831(final IOperationContext operationContext, final TemplateQueryContext _context) {
    Iterable<SNode> list = ListSequence.fromList(SLinkOperations.getTargets(_context.getNode(), "dependencies", true)).where(new IWhereFilter<SNode>() {
      public boolean accept(SNode it) {
        return SNodeOperations.isInstanceOf(it, "jetbrains.mps.buildScript.structure.BuildProjectDependency") && (SLinkOperations.getTarget(SNodeOperations.cast(it, "jetbrains.mps.buildScript.structure.BuildProjectDependency"), "artifacts", true) == null) && !(BuildProject_Behavior.call_isPackaged_4129895186893455885(SLinkOperations.getTarget(SNodeOperations.cast(it, "jetbrains.mps.buildScript.structure.BuildProjectDependency"), "script", false), Context.defaultContext(_context)));
      }
    }).select(new ISelector<SNode, SNode>() {
      public SNode select(SNode it) {
        return SNodeOperations.cast(it, "jetbrains.mps.buildScript.structure.BuildProjectDependency");
      }
    });
    String basePath = BuildProject_Behavior.call_getBasePath_4959435991187146924(_context.getNode(), Context.defaultContext(_context));
