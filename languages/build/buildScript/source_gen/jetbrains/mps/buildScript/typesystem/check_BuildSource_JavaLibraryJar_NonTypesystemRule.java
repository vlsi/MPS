    ...
    if (!(relativePath.endsWith("}")) && !(relativePath.endsWith(".jar"))) {
      {
        ...
        IErrorReporter _reporter_2309309498 = typeCheckingContext.reportTypeError(jarEntry, "should end with .jar (or macro)", "r:2349e4dd-6518-4a4c-9022-c7887bed8b52(jetbrains.mps.buildScript.typesystem)", "1258644073389052213", null, errorTarget);
      }
    }
  }
