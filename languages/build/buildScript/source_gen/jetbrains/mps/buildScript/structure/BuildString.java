...
public class BuildString extends BaseConcept {
  public static final String concept = "jetbrains.mps.buildScript.structure.BuildString";
  ...
  public static BuildString newInstance(SModel sm, boolean init) {
    return (BuildString) SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.buildScript.structure.BuildString", sm, GlobalScope.getInstance(), init).getAdapter();
  }
