...
public class BuildSource_JavaModule extends BuildSourceModule implements INamedConcept {
  ...
  public static BuildSource_JavaModule newInstance(SModel sm, boolean init) {
    return (BuildSource_JavaModule) SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.buildScript.structure.BuildSource_JavaModule", sm, GlobalScope.getInstance(), init).getAdapter();
  }
