...
public class BuildLayout_TransparentContainer extends BuildLayout_AbstractContainer {
  public static final String concept = "jetbrains.mps.build.structure.BuildLayout_TransparentContainer";
  ...
  public static BuildLayout_TransparentContainer newInstance(SModel sm, boolean init) {
    return (BuildLayout_TransparentContainer) SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.build.structure.BuildLayout_TransparentContainer", sm, GlobalScope.getInstance(), init).getAdapter();
  }
