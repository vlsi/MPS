...
public class BL_CopyPasteHandlers_PastePostProcessor_0 implements PastePostProcessor {
  ...
  public void postProcesNode(SNode pastedNode) {
    ...
    if (Scope.parent(pastedNode) != null) {
      ...
      if (surroundingScope != null && surroundingScope.contains(IVariableReference_BehaviorDescriptor.getVariable_idSORzhOpB6t.invoke(pastedNode))) {
        ...
        SLinkOperations.setTarget(variableReference, MetaAdapterFactory.getReferenceLink(0xf3061a5392264cc5L, 0xa443f952ceaf5816L, 0xf8c77f1e98L, 0xf8cc6bf960L, "variableDeclaration"), SNodeOperations.cast(IVariableReference_BehaviorDescriptor.getVariable_idSORzhOpB6t.invoke(pastedNode), MetaAdapterFactory.getConcept(0xf3061a5392264cc5L, 0xa443f952ceaf5816L, 0xf8c37a7f6eL, "jetbrains.mps.baseLanguage.structure.VariableDeclaration")));
      }
    }
  }
}
