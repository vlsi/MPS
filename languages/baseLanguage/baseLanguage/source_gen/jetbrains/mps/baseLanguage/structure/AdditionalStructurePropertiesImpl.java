...
public class AdditionalStructurePropertiesImpl extends ConceptPresentationAspectBase {
  ...
  private final ConceptPresentation
      props_AbstractLoopStatement = new ConceptPresentationBuilder().deprecated(MetaAdapterFactory.getProperty(0xf3061a5392264cc5L, 0xa443f952ceaf5816L, 0x10cb1ac5adeL, 0x11745b5371dL, "label")).create();
  ...
  private final ConceptPresentation props_Annotation = new ConceptPresentationBuilder().icon("annotationtype.png", AdditionalStructurePropertiesImpl.class).create();
  ...
  private final ConceptPresentation
      props_AnonymousClass = new ConceptPresentationBuilder().deprecated(MetaAdapterFactory.getReferenceLink(0xf3061a5392264cc5L, 0xa443f952ceaf5816L, 0x1107e0cb103L, 0x1107e0fd2a0L, "classifier")).icon("anonymousClass.png", AdditionalStructurePropertiesImpl.class).create();
  ...
  private final ConceptPresentation props_BaseMethodDeclaration = new ConceptPresentationBuilder().icon("method.png", AdditionalStructurePropertiesImpl.class).create();
  ...
  private final ConceptPresentation
      props_BreakStatement = new ConceptPresentationBuilder().deprecated(MetaAdapterFactory.getProperty(0xf3061a5392264cc5L, 0xa443f952ceaf5816L, 0xfbe39a867fL, 0x11745bfb2d8L, "label")).create();
  ...
  private final ConceptPresentation
      props_ClassConcept = new ConceptPresentationBuilder().deprecated(MetaAdapterFactory.getProperty(0xf3061a5392264cc5L, 0xa443f952ceaf5816L, 0xf8c108ca66L, 0xfa5cee6dfaL, "abstractClass"), MetaAdapterFactory.getProperty(0xf3061a5392264cc5L, 0xa443f952ceaf5816L, 0xf8c108ca66L, 0x11c6af4b284L, "isFinal"), MetaAdapterFactory.getProperty(0xf3061a5392264cc5L, 0xa443f952ceaf5816L, 0xf8c108ca66L, 0x451f9e9f920b7f7dL, "isStatic")).icon("class.png", AdditionalStructurePropertiesImpl.class).create();
  private final ConceptPresentation props_ClassCreator = new ConceptPresentationBuilder().create();
  private final ConceptPresentation
      props_Classifier = new ConceptPresentationBuilder().deprecated(MetaAdapterFactory.getProperty(0xf3061a5392264cc5L, 0xa443f952ceaf5816L, 0x101d9d3ca30L, 0x11a134c900dL, "nestedName"), MetaAdapterFactory.getProperty(0xf3061a5392264cc5L, 0xa443f952ceaf5816L, 0x101d9d3ca30L, 0x11ce63f4b3bL, "isDeprecated"), MetaAdapterFactory.getProperty(0xf3061a5392264cc5L, 0xa443f952ceaf5816L, 0x101d9d3ca30L, 0x73c6d8a8c021f99L, "nonStatic")).create();
  ...
  private final ConceptPresentation props_ConceptFunctionParameter = new ConceptPresentationBuilder().icon("parameter.png", AdditionalStructurePropertiesImpl.class).create();
  ...
  private final ConceptPresentation
      props_ContinueStatement = new ConceptPresentationBuilder().deprecated(MetaAdapterFactory.getProperty(0xf3061a5392264cc5L, 0xa443f952ceaf5816L, 0xfbf3043726L, 0x11745fca58eL, "label")).create();
  ...
  private final ConceptPresentation props_EnumClass = new ConceptPresentationBuilder().icon("enum.png", AdditionalStructurePropertiesImpl.class).create();
  ...
  private final ConceptPresentation props_FieldDeclaration = new ConceptPresentationBuilder().icon("field.png", AdditionalStructurePropertiesImpl.class).create();
  ...
  private final ConceptPresentation
      props_IBLDeprecatable = new ConceptPresentationBuilder().deprecated(MetaAdapterFactory.getProperty(0xf3061a5392264cc5L, 0xa443f952ceaf5816L, 0x11d2ea8a339L, 0x11d2ea948a4L, "isDeprecated")).create();
  ...
  private final ConceptPresentation
      props_InstanceInitializer = new ConceptPresentationBuilder().icon("classInitializer.png", AdditionalStructurePropertiesImpl.class).create();
  private final ConceptPresentation props_InstanceMethodCallOperation = new ConceptPresentationBuilder().create();
  private final ConceptPresentation props_InstanceMethodDeclaration = new ConceptPresentationBuilder().icon("method.png", AdditionalStructurePropertiesImpl.class).create();
  ...
  private final ConceptPresentation props_Interface = new ConceptPresentationBuilder().icon("interfaceType.png", AdditionalStructurePropertiesImpl.class).create();
  ...
  private final ConceptPresentation props_LocalVariableDeclaration = new ConceptPresentationBuilder().icon("variable.png", AdditionalStructurePropertiesImpl.class).create();
  ...
  private final ConceptPresentation props_ParameterDeclaration = new ConceptPresentationBuilder().icon("parameter.png", AdditionalStructurePropertiesImpl.class).create();
  ...
  private final ConceptPresentation props_StaticFieldDeclaration = new ConceptPresentationBuilder().icon("field.png", AdditionalStructurePropertiesImpl.class).create();
  private final ConceptPresentation props_StaticFieldReference = new ConceptPresentationBuilder().create();
  private final ConceptPresentation props_StaticInitializer = new ConceptPresentationBuilder().icon("classInitializer.png", AdditionalStructurePropertiesImpl.class).create();
  ...
  private final ConceptPresentation
      props_SwitchStatement = new ConceptPresentationBuilder().deprecated(MetaAdapterFactory.getProperty(0xf3061a5392264cc5L, 0xa443f952ceaf5816L, 0x10ef02a8c6aL, 0x117b7e94b9bL, "label")).create();
