...
public class StructureAspectDescriptor implements jetbrains.mps.smodel.runtime.StructureAspectDescriptor {
  ...
  public ConceptDescriptor getDescriptor(String conceptFqName) {
    switch (Arrays.binarySearch(stringSwitchCases_1htk8d_a0a0b, conceptFqName)) {
      case 0:
        return new ConceptDescriptorBuilder("jetbrains.mps.baseLanguage.structure.AbstractClassifierReference").super_("jetbrains.mps.baseLanguage.structure.Expression").parents("jetbrains.mps.baseLanguage.structure.Expression").references("classifier").create();
      case 1:
        return new ConceptDescriptorBuilder("jetbrains.mps.baseLanguage.structure.AbstractCreator").super_("jetbrains.mps.lang.core.structure.BaseConcept").parents("jetbrains.mps.lang.core.structure.BaseConcept").abstract_().create();
      case 2:
        return new ConceptDescriptorBuilder("jetbrains.mps.baseLanguage.structure.AbstractForStatement").super_("jetbrains.mps.baseLanguage.structure.AbstractLoopStatement").parents("jetbrains.mps.baseLanguage.structure.AbstractLoopStatement").children(new String[]{"variable"}, new boolean[]{false}).abstract_().create();
      case 3:
        return new ConceptDescriptorBuilder("jetbrains.mps.baseLanguage.structure.AbstractLoopStatement").super_("jetbrains.mps.baseLanguage.structure.Statement").parents("jetbrains.mps.baseLanguage.structure.Statement", "jetbrains.mps.lang.core.structure.IContainer", "jetbrains.mps.baseLanguage.structure.IContainsStatementList", "jetbrains.mps.lang.core.structure.ScopeProvider").properties("label").children(new String[]{"body", "loopLabel"}, new boolean[]{false, false}).abstract_().create();
      case 4:
        return new ConceptDescriptorBuilder("jetbrains.mps.baseLanguage.structure.AbstractOperation").super_("jetbrains.mps.lang.core.structure.BaseConcept").parents("jetbrains.mps.lang.core.structure.BaseConcept", "jetbrains.mps.baseLanguage.structure.IOperation").abstract_().create();
      case 5:
        return new ConceptDescriptorBuilder("jetbrains.mps.baseLanguage.structure.AbstractUnaryNumberOperation").super_("jetbrains.mps.baseLanguage.structure.Expression").parents("jetbrains.mps.baseLanguage.structure.Expression").children(new String[]{"expression"}, new boolean[]{false}).create();
      case 6:
      ...
      case 7:
        return new ConceptDescriptorBuilder("jetbrains.mps.baseLanguage.structure.AndAssignmentExpression").super_("jetbrains.mps.baseLanguage.structure.OperationAssignmentExpression").parents("jetbrains.mps.baseLanguage.structure.OperationAssignmentExpression").alias("&=", "").create();
      case 8:
        return new ConceptDescriptorBuilder("jetbrains.mps.baseLanguage.structure.AndExpression").super_("jetbrains.mps.baseLanguage.structure.BinaryOperation").parents("jetbrains.mps.baseLanguage.structure.BinaryOperation").alias("&&", "conditional-and operation").create();
      case 9:
      ...
      case 10:
        return new ConceptDescriptorBuilder("jetbrains.mps.baseLanguage.structure.AnnotationInstance").super_("jetbrains.mps.baseLanguage.structure.Expression").parents("jetbrains.mps.baseLanguage.structure.Expression", "jetbrains.mps.lang.core.structure.ScopeProvider").references("annotation").children(new String[]{"value"}, new boolean[]{true}).create();
      case 11:
        return new ConceptDescriptorBuilder("jetbrains.mps.baseLanguage.structure.AnnotationInstanceExpression").super_("jetbrains.mps.baseLanguage.structure.Expression").parents("jetbrains.mps.baseLanguage.structure.Expression", "jetbrains.mps.lang.core.structure.IDontSubstituteByDefault").children(new String[]{"annotationInstance"}, new boolean[]{false}).alias("annotation instance", "").create();
      case 12:
      ...
      case 16:
        return new ConceptDescriptorBuilder("jetbrains.mps.baseLanguage.structure.ArrayAccessExpression").super_("jetbrains.mps.baseLanguage.structure.Expression").parents("jetbrains.mps.baseLanguage.structure.Expression").children(new String[]{"array", "index"}, new boolean[]{false, false}).alias("[", "array access expression").create();
      case 17:
        return new ConceptDescriptorBuilder("jetbrains.mps.baseLanguage.structure.ArrayClassExpression").super_("jetbrains.mps.baseLanguage.structure.Expression").parents("jetbrains.mps.baseLanguage.structure.Expression").children(new String[]{"arrayType"}, new boolean[]{false}).create();
      case 18:
        return new ConceptDescriptorBuilder("jetbrains.mps.baseLanguage.structure.ArrayCloneOperation").super_("jetbrains.mps.lang.core.structure.BaseConcept").parents("jetbrains.mps.lang.core.structure.BaseConcept", "jetbrains.mps.baseLanguage.structure.IOperation").alias("clone()", "special public method of array").create();
      case 19:
        return new ConceptDescriptorBuilder("jetbrains.mps.baseLanguage.structure.ArrayCreator").super_("jetbrains.mps.baseLanguage.structure.AbstractCreator").parents("jetbrains.mps.baseLanguage.structure.AbstractCreator").children(new String[]{"componentType", "dimensionExpression"}, new boolean[]{false, true}).alias("array", "").create();
      case 20:
        return new ConceptDescriptorBuilder("jetbrains.mps.baseLanguage.structure.ArrayCreatorWithInitializer").super_("jetbrains.mps.baseLanguage.structure.AbstractCreator").parents("jetbrains.mps.baseLanguage.structure.AbstractCreator").children(new String[]{"componentType", "initValue"}, new boolean[]{false, true}).alias("array with initializer", "").create();
      case 21:
        return new ConceptDescriptorBuilder("jetbrains.mps.baseLanguage.structure.ArrayLengthOperation").super_("jetbrains.mps.lang.core.structure.BaseConcept").parents("jetbrains.mps.lang.core.structure.BaseConcept", "jetbrains.mps.baseLanguage.structure.IOperation").alias("length", "array length readonly property").create();
      case 22:
        return new ConceptDescriptorBuilder("jetbrains.mps.baseLanguage.structure.ArrayLiteral").super_("jetbrains.mps.baseLanguage.structure.Expression").parents("jetbrains.mps.baseLanguage.structure.Expression", "jetbrains.mps.lang.core.structure.IDontSubstituteByDefault").children(new String[]{"item"}, new boolean[]{true}).alias("{", "array literal").create();
      case 23:
        return new ConceptDescriptorBuilder("jetbrains.mps.baseLanguage.structure.ArrayType").super_("jetbrains.mps.baseLanguage.structure.Type").parents("jetbrains.mps.baseLanguage.structure.Type", "jetbrains.mps.baseLanguage.structure.IGenericType", "jetbrains.mps.lang.core.structure.IDontSubstituteByDefault").children(new String[]{"componentType"}, new boolean[]{false}).create();
      case 24:
        return new ConceptDescriptorBuilder("jetbrains.mps.baseLanguage.structure.AsExpression").super_("jetbrains.mps.baseLanguage.structure.Expression").parents("jetbrains.mps.baseLanguage.structure.Expression", "jetbrains.mps.lang.core.structure.IDontSubstituteByDefault").children(new String[]{"expression", "classifierType"}, new boolean[]{false, false}).alias("as", "type case expression or return null").create();
      case 25:
        return new ConceptDescriptorBuilder("jetbrains.mps.baseLanguage.structure.AssertStatement").super_("jetbrains.mps.baseLanguage.structure.Statement").parents("jetbrains.mps.baseLanguage.structure.Statement").children(new String[]{"condition", "message"}, new boolean[]{false, false}).alias("assert", "").create();
      case 26:
        return new ConceptDescriptorBuilder("jetbrains.mps.baseLanguage.structure.AssignmentExpression").super_("jetbrains.mps.baseLanguage.structure.BaseAssignmentExpression").parents("jetbrains.mps.baseLanguage.structure.BaseAssignmentExpression", "jetbrains.mps.baseLanguage.structure.TypeDerivable").alias("=", "").create();
      case 27:
        return new ConceptDescriptorBuilder("jetbrains.mps.baseLanguage.structure.BLBottomType").super_("jetbrains.mps.baseLanguage.structure.Type").parents("jetbrains.mps.baseLanguage.structure.Type", "jetbrains.mps.lang.core.structure.IDontSubstituteByDefault").alias("BLBottom", "").create();
      case 28:
        return new ConceptDescriptorBuilder("jetbrains.mps.baseLanguage.structure.BaseAssignmentExpression").super_("jetbrains.mps.baseLanguage.structure.Expression").parents("jetbrains.mps.baseLanguage.structure.Expression").children(new String[]{"lValue", "rValue"}, new boolean[]{false, false}).abstract_().create();
      case 29:
        return new ConceptDescriptorBuilder("jetbrains.mps.baseLanguage.structure.BaseMethodCall").super_("jetbrains.mps.baseLanguage.structure.Expression").parents("jetbrains.mps.baseLanguage.structure.Expression", "jetbrains.mps.baseLanguage.structure.IMethodCall").abstract_().create();
      case 30:
      ...
      case 31:
        return new ConceptDescriptorBuilder("jetbrains.mps.baseLanguage.structure.BaseStringOperation").super_("jetbrains.mps.lang.core.structure.BaseConcept").parents("jetbrains.mps.lang.core.structure.BaseConcept", "jetbrains.mps.baseLanguage.structure.IOperation").abstract_().create();
      case 32:
      ...
      case 33:
        return new ConceptDescriptorBuilder("jetbrains.mps.baseLanguage.structure.BaseVariableReference").super_("jetbrains.mps.baseLanguage.structure.Expression").parents("jetbrains.mps.baseLanguage.structure.Expression").references("baseVariableDeclaration").abstract_().create();
      case 34:
        return new ConceptDescriptorBuilder("jetbrains.mps.baseLanguage.structure.BinaryBitwiseOperation").super_("jetbrains.mps.baseLanguage.structure.BinaryOperation").parents("jetbrains.mps.baseLanguage.structure.BinaryOperation").abstract_().create();
      case 35:
        return new ConceptDescriptorBuilder("jetbrains.mps.baseLanguage.structure.BinaryCompareOperation").super_("jetbrains.mps.baseLanguage.structure.BinaryOperation").parents("jetbrains.mps.baseLanguage.structure.BinaryOperation").abstract_().create();
      case 36:
        return new ConceptDescriptorBuilder("jetbrains.mps.baseLanguage.structure.BinaryOperation").super_("jetbrains.mps.baseLanguage.structure.Expression").parents("jetbrains.mps.baseLanguage.structure.Expression").children(new String[]{"rightExpression", "leftExpression"}, new boolean[]{false, false}).abstract_().alias("<?>", "abstract binary operation").create();
      case 37:
        return new ConceptDescriptorBuilder("jetbrains.mps.baseLanguage.structure.BitwiseAndExpression").super_("jetbrains.mps.baseLanguage.structure.BinaryBitwiseOperation").parents("jetbrains.mps.baseLanguage.structure.BinaryBitwiseOperation").alias("&", "").create();
      case 38:
        return new ConceptDescriptorBuilder("jetbrains.mps.baseLanguage.structure.BitwiseNotExpression").super_("jetbrains.mps.baseLanguage.structure.Expression").parents("jetbrains.mps.baseLanguage.structure.Expression").children(new String[]{"expression"}, new boolean[]{false}).alias("~(expr)", "bitwise not-expression").create();
      case 39:
        return new ConceptDescriptorBuilder("jetbrains.mps.baseLanguage.structure.BitwiseOrExpression").super_("jetbrains.mps.baseLanguage.structure.BinaryBitwiseOperation").parents("jetbrains.mps.baseLanguage.structure.BinaryBitwiseOperation").alias("|", "").create();
      case 40:
        return new ConceptDescriptorBuilder("jetbrains.mps.baseLanguage.structure.BitwiseXorExpression").super_("jetbrains.mps.baseLanguage.structure.BinaryBitwiseOperation").parents("jetbrains.mps.baseLanguage.structure.BinaryBitwiseOperation").alias("^", "").create();
      case 41:
        return new ConceptDescriptorBuilder("jetbrains.mps.baseLanguage.structure.BlockStatement").super_("jetbrains.mps.baseLanguage.structure.Statement").parents("jetbrains.mps.baseLanguage.structure.Statement").children(new String[]{"statements"}, new boolean[]{false}).alias("{", "block statement").create();
      case 42:
        return new ConceptDescriptorBuilder("jetbrains.mps.baseLanguage.structure.BooleanConstant").super_("jetbrains.mps.baseLanguage.structure.Expression").parents("jetbrains.mps.baseLanguage.structure.Expression", "jetbrains.mps.lang.core.structure.IDontSubstituteByDefault").properties("value").alias("boolean constant", "boolean constant").create();
      case 43:
        return new ConceptDescriptorBuilder("jetbrains.mps.baseLanguage.structure.BooleanType").super_("jetbrains.mps.baseLanguage.structure.PrimitiveType").parents("jetbrains.mps.baseLanguage.structure.PrimitiveType").alias("boolean", "").create();
      case 44:
      ...
      case 45:
        return new ConceptDescriptorBuilder("jetbrains.mps.baseLanguage.structure.ByteType").super_("jetbrains.mps.baseLanguage.structure.PrimitiveType").parents("jetbrains.mps.baseLanguage.structure.PrimitiveType").alias("byte", "").create();
      case 46:
      ...
      case 48:
        return new ConceptDescriptorBuilder("jetbrains.mps.baseLanguage.structure.CharConstant").super_("jetbrains.mps.baseLanguage.structure.Expression").parents("jetbrains.mps.baseLanguage.structure.Expression").properties("charConstant").alias("'", "char constant").create();
      case 49:
        return new ConceptDescriptorBuilder("jetbrains.mps.baseLanguage.structure.CharType").super_("jetbrains.mps.baseLanguage.structure.PrimitiveType").parents("jetbrains.mps.baseLanguage.structure.PrimitiveType").alias("char", "").create();
      case 50:
      ...
      case 58:
        return new ConceptDescriptorBuilder("jetbrains.mps.baseLanguage.structure.ClosureParameterReference").super_("jetbrains.mps.baseLanguage.structure.Expression").parents("jetbrains.mps.baseLanguage.structure.Expression").references("closureParameter").create();
      case 59:
        return new ConceptDescriptorBuilder("jetbrains.mps.baseLanguage.structure.Closureoid").interface_().create();
      case 60:
        return new ConceptDescriptorBuilder("jetbrains.mps.baseLanguage.structure.CommentPart").super_("jetbrains.mps.lang.core.structure.BaseConcept").parents("jetbrains.mps.lang.core.structure.BaseConcept", "jetbrains.mps.lang.core.structure.ISuppressErrors").abstract_().create();
      case 61:
        return new ConceptDescriptorBuilder("jetbrains.mps.baseLanguage.structure.CommentedStatement").super_("jetbrains.mps.baseLanguage.structure.Statement").parents("jetbrains.mps.baseLanguage.structure.Statement", "jetbrains.mps.lang.core.structure.IDontSubstituteByDefault").children(new String[]{"statement"}, new boolean[]{false}).create();
      case 62:
        return new ConceptDescriptorBuilder("jetbrains.mps.baseLanguage.structure.CommentedStatementsBlock").super_("jetbrains.mps.baseLanguage.structure.Statement").parents("jetbrains.mps.baseLanguage.structure.Statement", "jetbrains.mps.baseLanguage.structure.ILocalVariableElementList", "jetbrains.mps.lang.core.structure.ISuppressErrors").children(new String[]{"statement"}, new boolean[]{true}).alias("/*", "").create();
      case 63:
      ...
      case 66:
        return new ConceptDescriptorBuilder("jetbrains.mps.baseLanguage.structure.ConstructorInvocationStatement").super_("jetbrains.mps.baseLanguage.structure.Statement").parents("jetbrains.mps.baseLanguage.structure.Statement", "jetbrains.mps.baseLanguage.structure.IMethodCall").references("constructorDeclaration").abstract_().create();
      case 67:
      ...
      case 70:
        return new ConceptDescriptorBuilder("jetbrains.mps.baseLanguage.structure.DefaultClassCreator").super_("jetbrains.mps.baseLanguage.structure.AbstractCreator").parents("jetbrains.mps.baseLanguage.structure.AbstractCreator").references("classifier").children(new String[]{"typeParameter"}, new boolean[]{true}).create();
      case 71:
      ...
      case 74:
        return new ConceptDescriptorBuilder("jetbrains.mps.baseLanguage.structure.DimensionExpression").super_("jetbrains.mps.lang.core.structure.BaseConcept").parents("jetbrains.mps.lang.core.structure.BaseConcept").children(new String[]{"expression"}, new boolean[]{false}).create();
      case 75:
        return new ConceptDescriptorBuilder("jetbrains.mps.baseLanguage.structure.DivAssignmentExpression").super_("jetbrains.mps.baseLanguage.structure.OperationAssignmentExpression").parents("jetbrains.mps.baseLanguage.structure.OperationAssignmentExpression").alias("/=", "").create();
      case 76:
        return new ConceptDescriptorBuilder("jetbrains.mps.baseLanguage.structure.DivExpression").super_("jetbrains.mps.baseLanguage.structure.BinaryOperation").parents("jetbrains.mps.baseLanguage.structure.BinaryOperation").alias("/", "divide operation").create();
      case 77:
        return new ConceptDescriptorBuilder("jetbrains.mps.baseLanguage.structure.DoWhileStatement").super_("jetbrains.mps.baseLanguage.structure.AbstractLoopStatement").parents("jetbrains.mps.baseLanguage.structure.AbstractLoopStatement").children(new String[]{"condition"}, new boolean[]{false}).alias("do", "do... while loop").create();
      case 78:
        return new ConceptDescriptorBuilder("jetbrains.mps.baseLanguage.structure.DotExpression").super_("jetbrains.mps.baseLanguage.structure.Expression").parents("jetbrains.mps.baseLanguage.structure.Expression", "jetbrains.mps.lang.core.structure.IDontSubstituteByDefault").children(new String[]{"operand", "operation"}, new boolean[]{false, false}).create();
      case 79:
        return new ConceptDescriptorBuilder("jetbrains.mps.baseLanguage.structure.DoubleType").super_("jetbrains.mps.baseLanguage.structure.PrimitiveType").parents("jetbrains.mps.baseLanguage.structure.PrimitiveType").alias("double", "").create();
      case 80:
      ...
      case 82:
        return new ConceptDescriptorBuilder("jetbrains.mps.baseLanguage.structure.EnumConstantDeclaration").super_("jetbrains.mps.lang.core.structure.BaseConcept").parents("jetbrains.mps.lang.core.structure.BaseConcept", "jetbrains.mps.baseLanguage.structure.IValidIdentifier", "jetbrains.mps.lang.core.structure.IResolveInfo", "jetbrains.mps.baseLanguage.structure.HasAnnotation", "jetbrains.mps.baseLanguage.structure.ClassifierMember", "jetbrains.mps.baseLanguage.structure.IMethodCall", "jetbrains.mps.lang.core.structure.InterfacePart").references("constructor").children(new String[]{"method"}, new boolean[]{true}).create();
      case 83:
        return new ConceptDescriptorBuilder("jetbrains.mps.baseLanguage.structure.EnumConstantReference").super_("jetbrains.mps.baseLanguage.structure.Expression").parents("jetbrains.mps.baseLanguage.structure.Expression", "jetbrains.mps.lang.core.structure.ScopeProvider").references("enumClass", "enumConstantDeclaration").alias(".<enum>", "enumeration constant reference").create();
      case 84:
      ...
      case 85:
        return new ConceptDescriptorBuilder("jetbrains.mps.baseLanguage.structure.EnumValuesExpression").super_("jetbrains.mps.baseLanguage.structure.Expression").parents("jetbrains.mps.baseLanguage.structure.Expression", "jetbrains.mps.lang.core.structure.IDontSubstituteByDefault").references("enumClass").alias("values", "").create();
      case 86:
        return new ConceptDescriptorBuilder("jetbrains.mps.baseLanguage.structure.EqualsExpression").super_("jetbrains.mps.baseLanguage.structure.BinaryOperation").parents("jetbrains.mps.baseLanguage.structure.BinaryOperation").alias("==", "equals operation").create();
      case 87:
        return new ConceptDescriptorBuilder("jetbrains.mps.baseLanguage.structure.EscapeOperation").super_("jetbrains.mps.baseLanguage.structure.BaseStringOperation").parents("jetbrains.mps.baseLanguage.structure.BaseStringOperation").alias("escape", "escape quotation marks, back slashes, etc.").create();
      case 88:
        return new ConceptDescriptorBuilder("jetbrains.mps.baseLanguage.structure.Expression").super_("jetbrains.mps.lang.core.structure.BaseConcept").parents("jetbrains.mps.lang.core.structure.BaseConcept").abstract_().create();
      case 89:
        return new ConceptDescriptorBuilder("jetbrains.mps.baseLanguage.structure.ExpressionStatement").super_("jetbrains.mps.baseLanguage.structure.Statement").parents("jetbrains.mps.baseLanguage.structure.Statement", "jetbrains.mps.lang.core.structure.IWrapper").children(new String[]{"expression"}, new boolean[]{false}).alias("", "expression statement").create();
      case 90:
      ...
      case 91:
        return new ConceptDescriptorBuilder("jetbrains.mps.baseLanguage.structure.FieldReferenceOperation").super_("jetbrains.mps.lang.core.structure.BaseConcept").parents("jetbrains.mps.lang.core.structure.BaseConcept", "jetbrains.mps.baseLanguage.structure.IOperation").references("fieldDeclaration").alias("", "instance field reference").create();
      case 92:
        return new ConceptDescriptorBuilder("jetbrains.mps.baseLanguage.structure.FloatType").super_("jetbrains.mps.baseLanguage.structure.PrimitiveType").parents("jetbrains.mps.baseLanguage.structure.PrimitiveType").alias("float", "").create();
      case 93:
      ...
      case 98:
        return new ConceptDescriptorBuilder("jetbrains.mps.baseLanguage.structure.GenericNewExpression").super_("jetbrains.mps.baseLanguage.structure.Expression").parents("jetbrains.mps.baseLanguage.structure.Expression").children(new String[]{"creator"}, new boolean[]{false}).alias("new", "instance creation expression").create();
      case 99:
      ...
      case 100:
        return new ConceptDescriptorBuilder("jetbrains.mps.baseLanguage.structure.GreaterThanExpression").super_("jetbrains.mps.baseLanguage.structure.BinaryCompareOperation").parents("jetbrains.mps.baseLanguage.structure.BinaryCompareOperation").alias(">", "greater than operation").create();
      case 101:
        return new ConceptDescriptorBuilder("jetbrains.mps.baseLanguage.structure.GreaterThanOrEqualsExpression").super_("jetbrains.mps.baseLanguage.structure.BinaryCompareOperation").parents("jetbrains.mps.baseLanguage.structure.BinaryCompareOperation").alias(">=", "greater than or equals operation").create();
      case 102:
      ...
      case 103:
        return new ConceptDescriptorBuilder("jetbrains.mps.baseLanguage.structure.HexIntegerLiteral").super_("jetbrains.mps.baseLanguage.structure.IntegerLiteral").parents("jetbrains.mps.baseLanguage.structure.IntegerLiteral").properties("value").alias("0x", "").create();
      case 104:
      ...
      case 143:
        return new ConceptDescriptorBuilder("jetbrains.mps.baseLanguage.structure.InstanceMethodCallOperation").super_("jetbrains.mps.lang.core.structure.BaseConcept").parents("jetbrains.mps.lang.core.structure.BaseConcept", "jetbrains.mps.baseLanguage.structure.IOperation", "jetbrains.mps.baseLanguage.structure.IMethodCall").references("instanceMethodDeclaration").alias("", "instance method call").create();
      case 144:
        return new ConceptDescriptorBuilder("jetbrains.mps.baseLanguage.structure.InstanceMethodDeclaration").super_("jetbrains.mps.baseLanguage.structure.MethodDeclaration").parents("jetbrains.mps.baseLanguage.structure.MethodDeclaration", "jetbrains.mps.baseLanguage.structure.ClassifierMember", "jetbrains.mps.lang.core.structure.IResolveInfo", "jetbrains.mps.baseLanguage.structure.ITypeApplicable", "jetbrains.mps.lang.core.structure.InterfacePart").properties("isAbstract").alias("method", "").create();
      case 145:
        return new ConceptDescriptorBuilder("jetbrains.mps.baseLanguage.structure.InstanceOfExpression").super_("jetbrains.mps.baseLanguage.structure.Expression").parents("jetbrains.mps.baseLanguage.structure.Expression").children(new String[]{"leftExpression", "classType"}, new boolean[]{false, false}).alias("instanceof", "").create();
      case 146:
        return new ConceptDescriptorBuilder("jetbrains.mps.baseLanguage.structure.IntegerConstant").super_("jetbrains.mps.baseLanguage.structure.IntegerLiteral").parents("jetbrains.mps.baseLanguage.structure.IntegerLiteral", "jetbrains.mps.lang.core.structure.IDontSubstituteByDefault").properties("value").alias("integer constant", "integer constant").create();
      case 147:
        return new ConceptDescriptorBuilder("jetbrains.mps.baseLanguage.structure.IntegerLiteral").super_("jetbrains.mps.baseLanguage.structure.Expression").parents("jetbrains.mps.baseLanguage.structure.Expression").abstract_().create();
      case 148:
        return new ConceptDescriptorBuilder("jetbrains.mps.baseLanguage.structure.IntegerType").super_("jetbrains.mps.baseLanguage.structure.PrimitiveType").parents("jetbrains.mps.baseLanguage.structure.PrimitiveType").alias("int", "").create();
      case 149:
      ...
      case 150:
        return new ConceptDescriptorBuilder("jetbrains.mps.baseLanguage.structure.IsEmptyOperation").super_("jetbrains.mps.baseLanguage.structure.StringBooleanOperation").parents("jetbrains.mps.baseLanguage.structure.StringBooleanOperation").alias("isEmpty", "string is null or empty").create();
      case 151:
        return new ConceptDescriptorBuilder("jetbrains.mps.baseLanguage.structure.IsNotEmptyOperation").super_("jetbrains.mps.baseLanguage.structure.StringBooleanOperation").parents("jetbrains.mps.baseLanguage.structure.StringBooleanOperation").alias("isNotEmpty", "string is not null and not empty").create();
      case 152:
      ...
      case 154:
        return new ConceptDescriptorBuilder("jetbrains.mps.baseLanguage.structure.LeftShiftAssignmentExpression").super_("jetbrains.mps.baseLanguage.structure.OperationAssignmentExpression").parents("jetbrains.mps.baseLanguage.structure.OperationAssignmentExpression").alias("<<=", "").create();
      case 155:
        return new ConceptDescriptorBuilder("jetbrains.mps.baseLanguage.structure.LessThanExpression").super_("jetbrains.mps.baseLanguage.structure.BinaryCompareOperation").parents("jetbrains.mps.baseLanguage.structure.BinaryCompareOperation").alias("<", "less then operation").create();
      case 156:
        return new ConceptDescriptorBuilder("jetbrains.mps.baseLanguage.structure.LessThanOrEqualsExpression").super_("jetbrains.mps.baseLanguage.structure.BinaryCompareOperation").parents("jetbrains.mps.baseLanguage.structure.BinaryCompareOperation").alias("<=", "less then or equals operation").create();
      case 157:
        return new ConceptDescriptorBuilder("jetbrains.mps.baseLanguage.structure.LocalInstanceFieldReference").super_("jetbrains.mps.baseLanguage.structure.VariableReference").parents("jetbrains.mps.baseLanguage.structure.VariableReference", "jetbrains.mps.lang.core.structure.IDontSubstituteByDefault").references("fieldDeclaration").alias("", "local instance field reference").create();
      case 158:
        return new ConceptDescriptorBuilder("jetbrains.mps.baseLanguage.structure.LocalInstanceMethodCall").super_("jetbrains.mps.baseLanguage.structure.LocalMethodCall").parents("jetbrains.mps.baseLanguage.structure.LocalMethodCall", "jetbrains.mps.lang.core.structure.IDontSubstituteByDefault").references("instanceMethodDeclaration").alias("", "local instance method call").create();
      case 159:
        return new ConceptDescriptorBuilder("jetbrains.mps.baseLanguage.structure.LocalMethodCall").super_("jetbrains.mps.baseLanguage.structure.BaseMethodCall").parents("jetbrains.mps.baseLanguage.structure.BaseMethodCall").references("method").alias("", "local method invocation").create();
      case 160:
        return new ConceptDescriptorBuilder("jetbrains.mps.baseLanguage.structure.LocalPropertyReference").super_("jetbrains.mps.baseLanguage.structure.Expression").parents("jetbrains.mps.baseLanguage.structure.Expression").references("property").create();
      case 161:
      ...
      case 162:
        return new ConceptDescriptorBuilder("jetbrains.mps.baseLanguage.structure.LocalStaticMethodCall").super_("jetbrains.mps.baseLanguage.structure.LocalMethodCall").parents("jetbrains.mps.baseLanguage.structure.LocalMethodCall", "jetbrains.mps.lang.core.structure.IDontSubstituteByDefault").references("staticMethodDeclaration").alias("", "local static method invocation").create();
      case 163:
        return new ConceptDescriptorBuilder("jetbrains.mps.baseLanguage.structure.LocalToMethodKind").interface_().create();
      case 164:
        return new ConceptDescriptorBuilder("jetbrains.mps.baseLanguage.structure.LocalVariableDeclaration").super_("jetbrains.mps.baseLanguage.structure.VariableDeclaration").parents("jetbrains.mps.baseLanguage.structure.VariableDeclaration", "jetbrains.mps.lang.core.structure.IResolveInfo", "jetbrains.mps.baseLanguage.structure.IVariableAssignment", "jetbrains.mps.baseLanguage.structure.IVariableDeclaration", "jetbrains.mps.baseLanguage.structure.ILocalDeclaration", "jetbrains.mps.lang.core.structure.ScopeProvider").alias("<type> <var>", "local variable declaration").create();
      case 165:
      ...
      case 166:
        return new ConceptDescriptorBuilder("jetbrains.mps.baseLanguage.structure.LocalVariableReference").super_("jetbrains.mps.baseLanguage.structure.VariableReference").parents("jetbrains.mps.baseLanguage.structure.VariableReference", "jetbrains.mps.lang.core.structure.IDontSubstituteByDefault").references("localVariableDeclaration").alias("", "reference to local variable declaration").create();
      case 167:
        return new ConceptDescriptorBuilder("jetbrains.mps.baseLanguage.structure.LongLiteral").super_("jetbrains.mps.baseLanguage.structure.Expression").parents("jetbrains.mps.baseLanguage.structure.Expression", "jetbrains.mps.lang.core.structure.IDontSubstituteByDefault").properties("value").create();
      case 168:
        return new ConceptDescriptorBuilder("jetbrains.mps.baseLanguage.structure.LongType").super_("jetbrains.mps.baseLanguage.structure.PrimitiveType").parents("jetbrains.mps.baseLanguage.structure.PrimitiveType").alias("long", "").create();
      case 169:
      ...
      case 171:
        return new ConceptDescriptorBuilder("jetbrains.mps.baseLanguage.structure.LowerBoundType").super_("jetbrains.mps.baseLanguage.structure.Type").parents("jetbrains.mps.baseLanguage.structure.Type", "jetbrains.mps.baseLanguage.structure.IGenericType").children(new String[]{"bound"}, new boolean[]{false}).alias("? super", "").create();
      case 172:
      ...
      case 173:
        return new ConceptDescriptorBuilder("jetbrains.mps.baseLanguage.structure.MinusAssignmentExpression").super_("jetbrains.mps.baseLanguage.structure.OperationAssignmentExpression").parents("jetbrains.mps.baseLanguage.structure.OperationAssignmentExpression").alias("-=", "").create();
      case 174:
        return new ConceptDescriptorBuilder("jetbrains.mps.baseLanguage.structure.MinusExpression").super_("jetbrains.mps.baseLanguage.structure.BinaryOperation").parents("jetbrains.mps.baseLanguage.structure.BinaryOperation").alias("-", "minus operation").create();
      case 175:
      ...
      case 176:
        return new ConceptDescriptorBuilder("jetbrains.mps.baseLanguage.structure.MulAssignmentExpression").super_("jetbrains.mps.baseLanguage.structure.OperationAssignmentExpression").parents("jetbrains.mps.baseLanguage.structure.OperationAssignmentExpression").alias("*=", "").create();
      case 177:
        return new ConceptDescriptorBuilder("jetbrains.mps.baseLanguage.structure.MulExpression").super_("jetbrains.mps.baseLanguage.structure.BinaryOperation").parents("jetbrains.mps.baseLanguage.structure.BinaryOperation").alias("*", "multiplication operation").create();
      case 178:
        return new ConceptDescriptorBuilder("jetbrains.mps.baseLanguage.structure.NPEEqualsExpression").super_("jetbrains.mps.baseLanguage.structure.BinaryOperation").parents("jetbrains.mps.baseLanguage.structure.BinaryOperation").alias(":eq:", "NPE-safe equals operation").create();
      case 179:
        return new ConceptDescriptorBuilder("jetbrains.mps.baseLanguage.structure.NPENotEqualsExpression").super_("jetbrains.mps.baseLanguage.structure.BinaryOperation").parents("jetbrains.mps.baseLanguage.structure.BinaryOperation").alias(":ne:", "NPE-safe not equals operation").create();
      case 180:
        return new ConceptDescriptorBuilder("jetbrains.mps.baseLanguage.structure.NotEqualsExpression").super_("jetbrains.mps.baseLanguage.structure.BinaryOperation").parents("jetbrains.mps.baseLanguage.structure.BinaryOperation").alias("!=", "not equals operation").create();
      case 181:
        return new ConceptDescriptorBuilder("jetbrains.mps.baseLanguage.structure.NotExpression").super_("jetbrains.mps.baseLanguage.structure.Expression").parents("jetbrains.mps.baseLanguage.structure.Expression").children(new String[]{"expression"}, new boolean[]{false}).alias("!(expr)", "not-expression").create();
      case 182:
        return new ConceptDescriptorBuilder("jetbrains.mps.baseLanguage.structure.NullLiteral").super_("jetbrains.mps.baseLanguage.structure.Expression").parents("jetbrains.mps.baseLanguage.structure.Expression").alias("null", "").create();
      case 183:
        return new ConceptDescriptorBuilder("jetbrains.mps.baseLanguage.structure.NullType").super_("jetbrains.mps.baseLanguage.structure.PrimitiveType").parents("jetbrains.mps.baseLanguage.structure.PrimitiveType", "jetbrains.mps.lang.core.structure.IDontSubstituteByDefault").alias("nulltype", "").create();
      case 184:
      ...
      case 185:
        return new ConceptDescriptorBuilder("jetbrains.mps.baseLanguage.structure.OperationAssignmentExpression").super_("jetbrains.mps.baseLanguage.structure.BaseAssignmentExpression").parents("jetbrains.mps.baseLanguage.structure.BaseAssignmentExpression").create();
      case 186:
        return new ConceptDescriptorBuilder("jetbrains.mps.baseLanguage.structure.OrAssignmentExpression").super_("jetbrains.mps.baseLanguage.structure.OperationAssignmentExpression").parents("jetbrains.mps.baseLanguage.structure.OperationAssignmentExpression").alias("|=", "").create();
      case 187:
        return new ConceptDescriptorBuilder("jetbrains.mps.baseLanguage.structure.OrExpression").super_("jetbrains.mps.baseLanguage.structure.BinaryOperation").parents("jetbrains.mps.baseLanguage.structure.BinaryOperation").alias("||", "conditional-or operation").create();
      case 188:
        return new ConceptDescriptorBuilder("jetbrains.mps.baseLanguage.structure.ParameterDeclaration").super_("jetbrains.mps.baseLanguage.structure.VariableDeclaration").parents("jetbrains.mps.baseLanguage.structure.VariableDeclaration", "jetbrains.mps.lang.core.structure.IResolveInfo", "jetbrains.mps.baseLanguage.structure.IVariableAssignment", "jetbrains.mps.lang.core.structure.InterfacePart").alias("", "parameter").create();
      case 189:
        return new ConceptDescriptorBuilder("jetbrains.mps.baseLanguage.structure.ParameterReference").super_("jetbrains.mps.baseLanguage.structure.VariableReference").parents("jetbrains.mps.baseLanguage.structure.VariableReference", "jetbrains.mps.lang.core.structure.IDontSubstituteByDefault").references("parameterDeclaration").alias("", "reference to method parameter").create();
      case 190:
        return new ConceptDescriptorBuilder("jetbrains.mps.baseLanguage.structure.ParenthesizedExpression").super_("jetbrains.mps.baseLanguage.structure.Expression").parents("jetbrains.mps.baseLanguage.structure.Expression").children(new String[]{"expression"}, new boolean[]{false}).alias("(expr)", "parenthesis").create();
      case 191:
      ...
      case 193:
        return new ConceptDescriptorBuilder("jetbrains.mps.baseLanguage.structure.PlusAssignmentExpression").super_("jetbrains.mps.baseLanguage.structure.OperationAssignmentExpression").parents("jetbrains.mps.baseLanguage.structure.OperationAssignmentExpression").alias("+=", "").create();
      case 194:
        return new ConceptDescriptorBuilder("jetbrains.mps.baseLanguage.structure.PlusExpression").super_("jetbrains.mps.baseLanguage.structure.BinaryOperation").parents("jetbrains.mps.baseLanguage.structure.BinaryOperation").alias("+", "plus operation").create();
      case 195:
        return new ConceptDescriptorBuilder("jetbrains.mps.baseLanguage.structure.PostfixDecrementExpression").super_("jetbrains.mps.baseLanguage.structure.AbstractUnaryNumberOperation").parents("jetbrains.mps.baseLanguage.structure.AbstractUnaryNumberOperation").alias("postfix decrement", "").create();
      case 196:
        return new ConceptDescriptorBuilder("jetbrains.mps.baseLanguage.structure.PostfixIncrementExpression").super_("jetbrains.mps.baseLanguage.structure.AbstractUnaryNumberOperation").parents("jetbrains.mps.baseLanguage.structure.AbstractUnaryNumberOperation").alias("postfix increment", "").create();
      case 197:
        return new ConceptDescriptorBuilder("jetbrains.mps.baseLanguage.structure.PrefixDecrementExpression").super_("jetbrains.mps.baseLanguage.structure.AbstractUnaryNumberOperation").parents("jetbrains.mps.baseLanguage.structure.AbstractUnaryNumberOperation").alias("--", "").create();
      case 198:
        return new ConceptDescriptorBuilder("jetbrains.mps.baseLanguage.structure.PrefixIncrementExpression").super_("jetbrains.mps.baseLanguage.structure.AbstractUnaryNumberOperation").parents("jetbrains.mps.baseLanguage.structure.AbstractUnaryNumberOperation").alias("++", "").create();
      case 199:
        return new ConceptDescriptorBuilder("jetbrains.mps.baseLanguage.structure.PrimitiveClassExpression").super_("jetbrains.mps.baseLanguage.structure.Expression").parents("jetbrains.mps.baseLanguage.structure.Expression", "jetbrains.mps.lang.core.structure.IDontSubstituteByDefault").children(new String[]{"primitiveType"}, new boolean[]{false}).create();
      case 200:
        return new ConceptDescriptorBuilder("jetbrains.mps.baseLanguage.structure.PrimitiveType").super_("jetbrains.mps.baseLanguage.structure.Type").parents("jetbrains.mps.baseLanguage.structure.Type").abstract_().create();
      case 201:
        return new ConceptDescriptorBuilder("jetbrains.mps.baseLanguage.structure.PrivateVisibility").super_("jetbrains.mps.baseLanguage.structure.Visibility").parents("jetbrains.mps.baseLanguage.structure.Visibility").alias("private", "").create();
      case 202:
      ...
      case 204:
        return new ConceptDescriptorBuilder("jetbrains.mps.baseLanguage.structure.PropertyReference").super_("jetbrains.mps.lang.core.structure.BaseConcept").parents("jetbrains.mps.lang.core.structure.BaseConcept", "jetbrains.mps.baseLanguage.structure.IOperation").references("property").create();
      case 205:
        return new ConceptDescriptorBuilder("jetbrains.mps.baseLanguage.structure.ProtectedVisibility").super_("jetbrains.mps.baseLanguage.structure.Visibility").parents("jetbrains.mps.baseLanguage.structure.Visibility").alias("protected", "").create();
      case 206:
        return new ConceptDescriptorBuilder("jetbrains.mps.baseLanguage.structure.PublicVisibility").super_("jetbrains.mps.baseLanguage.structure.Visibility").parents("jetbrains.mps.baseLanguage.structure.Visibility").alias("public", "").create();
      case 207:
        return new ConceptDescriptorBuilder("jetbrains.mps.baseLanguage.structure.RemAssignmentExpression").super_("jetbrains.mps.baseLanguage.structure.OperationAssignmentExpression").parents("jetbrains.mps.baseLanguage.structure.OperationAssignmentExpression").alias("%=", "").create();
      case 208:
        return new ConceptDescriptorBuilder("jetbrains.mps.baseLanguage.structure.RemExpression").super_("jetbrains.mps.baseLanguage.structure.BinaryOperation").parents("jetbrains.mps.baseLanguage.structure.BinaryOperation").alias("%", "remainder operation").create();
      case 209:
        return new ConceptDescriptorBuilder("jetbrains.mps.baseLanguage.structure.RemarkStatement").super_("jetbrains.mps.baseLanguage.structure.Statement").parents("jetbrains.mps.baseLanguage.structure.Statement", "jetbrains.mps.lang.core.structure.IDontSubstituteByDefault").properties("value").alias("//", "remark").create();
      case 210:
      ...
      case 211:
        return new ConceptDescriptorBuilder("jetbrains.mps.baseLanguage.structure.RightShiftAssignmentExpression").super_("jetbrains.mps.baseLanguage.structure.OperationAssignmentExpression").parents("jetbrains.mps.baseLanguage.structure.OperationAssignmentExpression").alias(">>=", "").create();
      case 212:
      ...
      case 213:
        return new ConceptDescriptorBuilder("jetbrains.mps.baseLanguage.structure.ShiftLeftExpression").super_("jetbrains.mps.baseLanguage.structure.BinaryBitwiseOperation").parents("jetbrains.mps.baseLanguage.structure.BinaryBitwiseOperation").alias("<<", "").create();
      case 214:
        return new ConceptDescriptorBuilder("jetbrains.mps.baseLanguage.structure.ShiftRightExpression").super_("jetbrains.mps.baseLanguage.structure.BinaryBitwiseOperation").parents("jetbrains.mps.baseLanguage.structure.BinaryBitwiseOperation").alias(">>", "").create();
      case 215:
        return new ConceptDescriptorBuilder("jetbrains.mps.baseLanguage.structure.ShiftRightUnsignedExpression").super_("jetbrains.mps.baseLanguage.structure.BinaryBitwiseOperation").parents("jetbrains.mps.baseLanguage.structure.BinaryBitwiseOperation").alias(">>>", "").create();
      case 216:
        return new ConceptDescriptorBuilder("jetbrains.mps.baseLanguage.structure.ShortType").super_("jetbrains.mps.baseLanguage.structure.PrimitiveType").parents("jetbrains.mps.baseLanguage.structure.PrimitiveType").alias("short", "").create();
      case 217:
        return new ConceptDescriptorBuilder("jetbrains.mps.baseLanguage.structure.SingleLineComment").super_("jetbrains.mps.baseLanguage.structure.Statement").parents("jetbrains.mps.baseLanguage.structure.Statement", "jetbrains.mps.lang.core.structure.ScopeProvider").children(new String[]{"commentPart"}, new boolean[]{true}).alias("//", "single-line comment").create();
      case 218:
        return new ConceptDescriptorBuilder("jetbrains.mps.baseLanguage.structure.Statement").super_("jetbrains.mps.lang.core.structure.BaseConcept").parents("jetbrains.mps.lang.core.structure.BaseConcept", "jetbrains.mps.baseLanguage.structure.ILocalVariableElement", "jetbrains.mps.lang.traceable.structure.TraceableConcept", "jetbrains.mps.lang.core.structure.ICanSuppressErrors").alias("<statement>", "").create();
      case 219:
        return new ConceptDescriptorBuilder("jetbrains.mps.baseLanguage.structure.StatementCommentPart").super_("jetbrains.mps.baseLanguage.structure.CommentPart").parents("jetbrains.mps.baseLanguage.structure.CommentPart").children(new String[]{"commentedStatement"}, new boolean[]{false}).create();
      case 220:
        return new ConceptDescriptorBuilder("jetbrains.mps.baseLanguage.structure.StatementList").super_("jetbrains.mps.lang.core.structure.BaseConcept").parents("jetbrains.mps.lang.core.structure.BaseConcept", "jetbrains.mps.lang.core.structure.IContainer", "jetbrains.mps.baseLanguage.structure.ILocalVariableElementList", "jetbrains.mps.lang.traceable.structure.ScopeConcept", "jetbrains.mps.lang.core.structure.ScopeProvider", "jetbrains.mps.lang.core.structure.ScopeFacade").children(new String[]{"statement"}, new boolean[]{true}).create();
      case 221:
        return new ConceptDescriptorBuilder("jetbrains.mps.baseLanguage.structure.StaticFieldDeclaration").super_("jetbrains.mps.baseLanguage.structure.VariableDeclaration").parents("jetbrains.mps.baseLanguage.structure.VariableDeclaration", "jetbrains.mps.baseLanguage.structure.ClassifierMember", "jetbrains.mps.baseLanguage.structure.StaticKind", "jetbrains.mps.lang.core.structure.IResolveInfo", "jetbrains.mps.baseLanguage.structure.IBLDeprecatable", "jetbrains.mps.lang.traceable.structure.TraceableConcept", "jetbrains.mps.lang.core.structure.InterfacePart").alias("static field", "static field declaration").create();
      case 222:
      ...
      case 225:
        return new ConceptDescriptorBuilder("jetbrains.mps.baseLanguage.structure.StaticMethodCall").super_("jetbrains.mps.baseLanguage.structure.BaseMethodCall").parents("jetbrains.mps.baseLanguage.structure.BaseMethodCall").references("classConcept", "staticMethodDeclaration").alias(".<static method>", "static method invocation").create();
      case 226:
        return new ConceptDescriptorBuilder("jetbrains.mps.baseLanguage.structure.StaticMethodDeclaration").super_("jetbrains.mps.baseLanguage.structure.MethodDeclaration").parents("jetbrains.mps.baseLanguage.structure.MethodDeclaration", "jetbrains.mps.baseLanguage.structure.ClassifierMember", "jetbrains.mps.baseLanguage.structure.StaticKind", "jetbrains.mps.lang.core.structure.IResolveInfo", "jetbrains.mps.lang.core.structure.InterfacePart").alias("static method", "").create();
      case 227:
        return new ConceptDescriptorBuilder("jetbrains.mps.baseLanguage.structure.StringBooleanOperation").super_("jetbrains.mps.baseLanguage.structure.BaseStringOperation").parents("jetbrains.mps.baseLanguage.structure.BaseStringOperation").abstract_().create();
      case 228:
        return new ConceptDescriptorBuilder("jetbrains.mps.baseLanguage.structure.StringLiteral").super_("jetbrains.mps.baseLanguage.structure.Expression").parents("jetbrains.mps.baseLanguage.structure.Expression", "jetbrains.mps.lang.core.structure.IDontSubstituteByDefault").properties("value").alias("\"", "string literal").create();
      case 229:
      ...
      case 230:
        return new ConceptDescriptorBuilder("jetbrains.mps.baseLanguage.structure.StringType").super_("jetbrains.mps.baseLanguage.structure.Type").parents("jetbrains.mps.baseLanguage.structure.Type").alias("string", "").create();
      case 231:
      ...
      case 235:
        return new ConceptDescriptorBuilder("jetbrains.mps.baseLanguage.structure.SuperMethodCall").super_("jetbrains.mps.baseLanguage.structure.BaseMethodCall").parents("jetbrains.mps.baseLanguage.structure.BaseMethodCall").references("instanceMethodDeclaration").alias("super", "super method invocation").create();
      case 236:
      ...
      case 239:
        return new ConceptDescriptorBuilder("jetbrains.mps.baseLanguage.structure.SynchronizedStatement").super_("jetbrains.mps.baseLanguage.structure.Statement").parents("jetbrains.mps.baseLanguage.structure.Statement").children(new String[]{"expression", "block"}, new boolean[]{false, false}).alias("synchronized", "").create();
      case 240:
        return new ConceptDescriptorBuilder("jetbrains.mps.baseLanguage.structure.TernaryOperatorExpression").super_("jetbrains.mps.baseLanguage.structure.Expression").parents("jetbrains.mps.baseLanguage.structure.Expression").children(new String[]{"condition", "ifTrue", "ifFalse"}, new boolean[]{false, false, false}).alias("(expr) ? (expr) : expr", "ternary operator").create();
      case 241:
        return new ConceptDescriptorBuilder("jetbrains.mps.baseLanguage.structure.TextCommentPart").super_("jetbrains.mps.baseLanguage.structure.CommentPart").parents("jetbrains.mps.baseLanguage.structure.CommentPart").properties("text").create();
      case 242:
        return new ConceptDescriptorBuilder("jetbrains.mps.baseLanguage.structure.ThisConstructorInvocation").super_("jetbrains.mps.baseLanguage.structure.ConstructorInvocationStatement").parents("jetbrains.mps.baseLanguage.structure.ConstructorInvocationStatement", "jetbrains.mps.lang.core.structure.IDontSubstituteByDefault").alias("this", "this constructor invocation").create();
      case 243:
        return new ConceptDescriptorBuilder("jetbrains.mps.baseLanguage.structure.ThisConstructorKind").interface_().create();
      case 244:
        return new ConceptDescriptorBuilder("jetbrains.mps.baseLanguage.structure.ThisExpression").super_("jetbrains.mps.baseLanguage.structure.Expression").parents("jetbrains.mps.baseLanguage.structure.Expression", "jetbrains.mps.baseLanguage.structure.IThisExpression").references("classConcept").alias("this", "").create();
      case 245:
        return new ConceptDescriptorBuilder("jetbrains.mps.baseLanguage.structure.ThrowStatement").super_("jetbrains.mps.baseLanguage.structure.Statement").parents("jetbrains.mps.baseLanguage.structure.Statement").children(new String[]{"throwable"}, new boolean[]{false}).alias("throw", "").create();
      case 246:
      ...
      case 254:
        return new ConceptDescriptorBuilder("jetbrains.mps.baseLanguage.structure.TypeVariableReference").super_("jetbrains.mps.baseLanguage.structure.Type").parents("jetbrains.mps.baseLanguage.structure.Type", "jetbrains.mps.baseLanguage.structure.IGenericType").references("typeVariableDeclaration").alias("", "reference to type variable").create();
      case 255:
        return new ConceptDescriptorBuilder("jetbrains.mps.baseLanguage.structure.UnaryMinus").super_("jetbrains.mps.baseLanguage.structure.AbstractUnaryNumberOperation").parents("jetbrains.mps.baseLanguage.structure.AbstractUnaryNumberOperation").alias("-", "unary minus").create();
      case 256:
        return new ConceptDescriptorBuilder("jetbrains.mps.baseLanguage.structure.UndefinedType").super_("jetbrains.mps.baseLanguage.structure.Type").parents("jetbrains.mps.baseLanguage.structure.Type", "jetbrains.mps.lang.core.structure.IDontSubstituteByDefault").alias("undefined", "undefined type").create();
      case 257:
        return new ConceptDescriptorBuilder("jetbrains.mps.baseLanguage.structure.UnknownConsCall").super_("jetbrains.mps.baseLanguage.structure.Statement").parents("jetbrains.mps.baseLanguage.structure.Statement", "jetbrains.mps.baseLanguage.structure.IMethodCall", "jetbrains.mps.baseLanguage.structure.IYetUnresolved", "jetbrains.mps.lang.core.structure.IDontSubstituteByDefault").properties("isSuper").create();
      case 258:
        return new ConceptDescriptorBuilder("jetbrains.mps.baseLanguage.structure.UnknownDotCall").super_("jetbrains.mps.baseLanguage.structure.UnknownNameRef").parents("jetbrains.mps.baseLanguage.structure.UnknownNameRef", "jetbrains.mps.baseLanguage.structure.IMethodCall", "jetbrains.mps.baseLanguage.structure.IYetUnresolved", "jetbrains.mps.lang.core.structure.IDontSubstituteByDefault").properties("callee").create();
      case 259:
      ...
      case 261:
        return new ConceptDescriptorBuilder("jetbrains.mps.baseLanguage.structure.UnknownNew").super_("jetbrains.mps.baseLanguage.structure.Expression").parents("jetbrains.mps.baseLanguage.structure.Expression", "jetbrains.mps.baseLanguage.structure.IMethodCall", "jetbrains.mps.baseLanguage.structure.IYetUnresolved", "jetbrains.mps.lang.core.structure.IDontSubstituteByDefault").properties("className").create();
      case 262:
        return new ConceptDescriptorBuilder("jetbrains.mps.baseLanguage.structure.UnresolvedNameReference").super_("jetbrains.mps.baseLanguage.structure.Expression").parents("jetbrains.mps.baseLanguage.structure.Expression", "jetbrains.mps.lang.core.structure.IDontSubstituteByDefault").properties("resolveName").create();
      case 263:
        return new ConceptDescriptorBuilder("jetbrains.mps.baseLanguage.structure.UnsignedRightShiftAssignmentExpression").super_("jetbrains.mps.baseLanguage.structure.OperationAssignmentExpression").parents("jetbrains.mps.baseLanguage.structure.OperationAssignmentExpression").alias(">>>=", "").create();
      case 264:
      ...
      case 265:
        return new ConceptDescriptorBuilder("jetbrains.mps.baseLanguage.structure.UsingStatement").super_("jetbrains.mps.baseLanguage.structure.Statement").parents("jetbrains.mps.baseLanguage.structure.Statement").children(new String[]{"resource", "body"}, new boolean[]{true, false}).alias("using(...)", "").create();
      case 266:
        return new ConceptDescriptorBuilder("jetbrains.mps.baseLanguage.structure.ValueParameter").super_("jetbrains.mps.baseLanguage.structure.Expression").parents("jetbrains.mps.baseLanguage.structure.Expression", "jetbrains.mps.lang.core.structure.IDontSubstituteByDefault").alias("value", "").create();
      case 267:
        return new ConceptDescriptorBuilder("jetbrains.mps.baseLanguage.structure.VarType").super_("jetbrains.mps.baseLanguage.structure.Type").parents("jetbrains.mps.baseLanguage.structure.Type").alias("var", "").create();
      case 268:
        return new ConceptDescriptorBuilder("jetbrains.mps.baseLanguage.structure.VariableArityType").super_("jetbrains.mps.baseLanguage.structure.Type").parents("jetbrains.mps.baseLanguage.structure.Type").children(new String[]{"componentType"}, new boolean[]{false}).create();
      case 269:
      ...
      case 270:
        return new ConceptDescriptorBuilder("jetbrains.mps.baseLanguage.structure.VariableReference").super_("jetbrains.mps.baseLanguage.structure.Expression").parents("jetbrains.mps.baseLanguage.structure.Expression", "jetbrains.mps.baseLanguage.structure.TypeAnnotable", "jetbrains.mps.baseLanguage.structure.IVariableReference", "jetbrains.mps.baseLanguage.structure.ILocalReference").references("variableDeclaration").alias("", "reference to variable").create();
      case 271:
        return new ConceptDescriptorBuilder("jetbrains.mps.baseLanguage.structure.Visibility").super_("jetbrains.mps.lang.core.structure.BaseConcept").parents("jetbrains.mps.lang.core.structure.BaseConcept").abstract_().create();
      case 272:
        return new ConceptDescriptorBuilder("jetbrains.mps.baseLanguage.structure.VoidType").super_("jetbrains.mps.baseLanguage.structure.PrimitiveType").parents("jetbrains.mps.baseLanguage.structure.PrimitiveType").alias("void", "").create();
      case 273:
        return new ConceptDescriptorBuilder("jetbrains.mps.baseLanguage.structure.WhileStatement").super_("jetbrains.mps.baseLanguage.structure.AbstractLoopStatement").parents("jetbrains.mps.baseLanguage.structure.AbstractLoopStatement").children(new String[]{"condition"}, new boolean[]{false}).alias("while", "").create();
      case 274:
        return new ConceptDescriptorBuilder("jetbrains.mps.baseLanguage.structure.WildCardType").super_("jetbrains.mps.baseLanguage.structure.Type").parents("jetbrains.mps.baseLanguage.structure.Type").alias("?", "wildcard type").create();
      case 275:
        return new ConceptDescriptorBuilder("jetbrains.mps.baseLanguage.structure.XorAssignmentExpression").super_("jetbrains.mps.baseLanguage.structure.OperationAssignmentExpression").parents("jetbrains.mps.baseLanguage.structure.OperationAssignmentExpression").alias("^=", "").create();
      default:
