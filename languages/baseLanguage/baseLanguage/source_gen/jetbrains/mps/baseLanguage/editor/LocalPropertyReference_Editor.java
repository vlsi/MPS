...
public class LocalPropertyReference_Editor extends DefaultNodeEditor {
  public EditorCell createEditorCell(EditorContext editorContext, SNode node) {
    return this.createCollection_h4irw0_a(editorContext, node);
  }
  private EditorCell createCollection_h4irw0_a(EditorContext editorContext, SNode node) {
    EditorCell_Collection editorCell = EditorCell_Collection.createIndent2(editorContext, node);
    editorCell.setCellId("Collection_h4irw0_a");
    editorCell.setBig(true);
    editorCell.addEditorCell(this.createRefCell_h4irw0_a0(editorContext, node));
    return editorCell;
  }
  private EditorCell createRefCell_h4irw0_a0(EditorContext editorContext, SNode node) {
  ...
  public static class _Inline_h4irw0_a0a extends InlineCellProvider {
    ...
    public EditorCell createEditorCell(EditorContext editorContext, SNode node) {
      return this.createProperty_h4irw0_a0a0(editorContext, node);
    }
