...
public class StaticFieldDeclaration_ApplySideTransforms extends TransformationMenuBase {
  ...
  protected List<MenuPart<TransformationMenuItem, TransformationMenuContext>> getParts(TransformationMenuContext _context) {
    ...
    if (ListSequence.fromListAndArray(new ArrayList<String>(), MenuLocations.SUBSTITUTE).contains(_context.getMenuLocation())) {
      result.add(new StaticFieldDeclaration_ApplySideTransforms.TransformationMenuPart_IncludeMenu_fy93tp_a1());
    }
    return result;
  }

  public class TransformationMenuPart_IncludeMenu_fy93tp_a0 extends IncludeTransformationMenuTransformationMenuPart {

  }
  public class TransformationMenuPart_IncludeMenu_fy93tp_a1 extends IncludeTransformationMenuTransformationMenuPart {
    @Nullable
    @Override
