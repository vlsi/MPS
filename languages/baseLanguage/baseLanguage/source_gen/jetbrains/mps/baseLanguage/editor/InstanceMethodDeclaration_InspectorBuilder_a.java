...
/*package*/ class InstanceMethodDeclaration_InspectorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public InstanceMethodDeclaration_InspectorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  /*package*/ EditorCell createCell() {
    return createCollection_359zr8_a_0();
  }

  private EditorCell createCollection_359zr8_a_0() {
    EditorCell_Collection editorCell = new EditorCell_Collection(getEditorContext(), myNode, new CellLayout_Indent());
    editorCell.setCellId("Collection_359zr8_a_0");
    editorCell.setBig(true);
    editorCell.setCellContext(getCellFactory().getCellContext());
    editorCell.addEditorCell(createConstant_359zr8_a0());
    editorCell.addEditorCell(createRefNodeList_359zr8_b0());
    editorCell.addEditorCell(createConstant_359zr8_c0_0());
    editorCell.addEditorCell(createProperty_359zr8_d0());
    return editorCell;
  }
  private EditorCell createConstant_359zr8_a0() {
  ...
  private EditorCell createRefNodeList_359zr8_b0() {
    AbstractCellListHandler handler = new InstanceMethodDeclaration_InspectorBuilder_a.annotationListHandler_359zr8_b0(myNode, "annotation", getEditorContext());
  ...
  private static class annotationListHandler_359zr8_b0 extends RefNodeListHandler {
    ...
    public EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(annotationListHandler_359zr8_b0.this.getNode(), MetaAdapterFactory.getContainmentLink(0xf3061a5392264cc5L, 0xa443f952ceaf5816L, 0x114a6be947aL, 0x114a6beb0bdL, "annotation")));
      try {
  ...
  private EditorCell createConstant_359zr8_c0_0() {
  ...
  private EditorCell createProperty_359zr8_d0() {
