...
public class Interface_Editor extends DefaultNodeEditor {
  ...
  private static boolean renderingCondition_4hcgjd_a2a(SNode node, EditorContext editorContext) {
    return Classifier_BehaviorDescriptor.isInner_idsWroEc0xXl.invoke(node) && !(SPropertyOperations.getBoolean(node, MetaAdapterFactory.getProperty(0xf3061a5392264cc5L, 0xa443f952ceaf5816L, 0x101d9d3ca30L, 0x73c6d8a8c021f99L, "nonStatic"))) && !(SNodeOperations.isInstanceOf(SNodeOperations.getParent(node), MetaAdapterFactory.getConcept(0xf3061a5392264cc5L, 0xa443f952ceaf5816L, 0x101edd46144L, "jetbrains.mps.baseLanguage.structure.Interface")));
  }
