...
/*package*/ class StaticMethodCall_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createRefCell_a4wjjz_a0() {
    CellProviderWithRole provider = new RefCellCellProvider(myNode, getEditorContext()) {
      ...
      protected InlineCellProvider createInlineCellProvider(SNode innerCellNode) {
        return new StaticMethodCall_EditorBuilder_a._Inline_a4wjjz_a0a(innerCellNode, myNode);
      }
    };
  ...
  public static class _Inline_a4wjjz_a0a extends InlineCellProvider {
    public _Inline_a4wjjz_a0a(SNode node, SNode refNode) {
      super(node, refNode);
    }
  ...
  private EditorCell createRefCell_a4wjjz_a3a() {
    CellProviderWithRole provider = new RefCellCellProvider(myNode, getEditorContext()) {
      @Override
      protected InlineCellProvider createInlineCellProvider(SNode innerCellNode) {
        return new StaticMethodCall_EditorBuilder_a._Inline_a4wjjz_a0d0(innerCellNode, myNode);
      }
    };
  ...
  public static class _Inline_a4wjjz_a0d0 extends InlineCellProvider {
    public _Inline_a4wjjz_a0d0(SNode node, SNode refNode) {
      super(node, refNode);
    }
    public EditorCell createEditorCell(EditorContext editorContext) {
      return createEditorCell(editorContext, getSNode());
