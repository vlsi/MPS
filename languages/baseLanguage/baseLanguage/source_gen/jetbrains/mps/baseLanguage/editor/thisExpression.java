...
public class thisExpression extends SubstituteMenuBase {
  ...
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new thisExpression.SubstituteMenuPart_Group_bo5td7_a());
    return result;
  }
  public class SubstituteMenuPart_Group_bo5td7_a extends GroupMenuPart<SubstituteMenuItem, SubstituteMenuContext> {
    @Override
    ...
    protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts() {
      return Arrays.<MenuPart<SubstituteMenuItem, SubstituteMenuContext>>asList(new thisExpression.SubstituteMenuPart_Group_bo5td7_a.SubstituteMenuPart_Parameterized_bo5td7_a0());
    }
    private class SubstituteMenuPart_Parameterized_bo5td7_a0 extends ParameterizedMenuPart<SNode, SubstituteMenuItem, SubstituteMenuContext> {
      @NotNull
      @Override
      protected List<SubstituteMenuItem> createItems(SNode parameter, SubstituteMenuContext context) {
        return new thisExpression.SubstituteMenuPart_Group_bo5td7_a.SubstituteMenuPart_Parameterized_bo5td7_a0.SubstituteMenuPart_Action_bo5td7_a0a(parameter).createItems(context);
      }
      @Nullable
      @Override
      ...
      private class SubstituteMenuPart_Action_bo5td7_a0a extends SingleItemSubstituteMenuPart {
        private final SNode myParameterObject;
        public SubstituteMenuPart_Action_bo5td7_a0a(SNode parameterObject) {
        ...
        protected SubstituteMenuItem createItem(SubstituteMenuContext _context) {
          return new thisExpression.SubstituteMenuPart_Group_bo5td7_a.SubstituteMenuPart_Parameterized_bo5td7_a0.SubstituteMenuPart_Action_bo5td7_a0a.Item(_context);
        }
