...
public class FieldReferenceOperation_Editor extends DefaultNodeEditor {
  public EditorCell createEditorCell(EditorContext editorContext, SNode node) {
    return this.createCollection_i6724r_a(editorContext, node);
  }
  ...
  private EditorCell createRefCell_i6724r_a0(EditorContext editorContext, SNode node) {
    CellProviderWithRole provider = new RefCellCellProvider(node, editorContext);
    provider.setRole("fieldDeclaration");
    provider.setNoTargetText("<no fieldDeclaration>");
    EditorCell editorCell;
    provider.setAuxiliaryCellProvider(new FieldReferenceOperation_Editor._Inline_i6724r_a0a());
  ...
  public static class _Inline_i6724r_a0a extends InlineCellProvider {
    ...
    public EditorCell createEditorCell(EditorContext editorContext, SNode node) {
      return this.createProperty_i6724r_a0a0(editorContext, node);
    }

    private EditorCell createProperty_i6724r_a0a0(EditorContext editorContext, SNode node) {
      ...
      editorCell.getStyle().putAll(style);
      DeleteFieldReferenceOperation.setCellActions(editorCell, node, editorContext);
      editorCell.setSubstituteInfo(provider.createDefaultSubstituteInfo());
      SNode attributeConcept = provider.getRoleAttribute();
      Class attributeKind = provider.getRoleAttributeClass();
      if (attributeConcept != null) {
