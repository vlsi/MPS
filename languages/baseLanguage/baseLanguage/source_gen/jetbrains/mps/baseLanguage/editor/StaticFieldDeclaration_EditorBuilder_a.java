...
/*package*/ class StaticFieldDeclaration_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createCollection_t6d1qn_a() {
    ...
    if (renderingCondition_t6d1qn_a2a(myNode, getEditorContext())) {
      editorCell.addEditorCell(createComponent_t6d1qn_c0());
    }
    editorCell.addEditorCell(createConstant_t6d1qn_d0());
    if (renderingCondition_t6d1qn_a4a(myNode, getEditorContext())) {
      editorCell.addEditorCell(createConstant_t6d1qn_e0());
    }
    if (renderingCondition_t6d1qn_a5a(myNode, getEditorContext())) {
      editorCell.addEditorCell(createConstant_t6d1qn_f0());
    }
    if (renderingCondition_t6d1qn_a6a(myNode, getEditorContext())) {
    ...
    if (renderingCondition_t6d1qn_a9a(myNode, getEditorContext())) {
  ...
  private EditorCell createConstant_t6d1qn_d0() {
    ...
    style.set(StyleAttributes.EDITABLE, _StyleParameter_QueryFunction_t6d1qn_a0d0(getEditorContext(), getNode()));
    editorCell.getStyle().putAll(style);
  ...
  private EditorCell createConstant_t6d1qn_e0() {
    ...
    Style style = new StyleImpl();
    new KeyWordStyleClass(getEditorContext(), getNode()).apply(style, editorCell);
    style.set(StyleAttributes.EDITABLE, _StyleParameter_QueryFunction_t6d1qn_a0e0(getEditorContext(), getNode()));
    editorCell.getStyle().putAll(style);
  ...
  private class typeSingleRoleHandler_t6d1qn_h0 extends SingleRoleCellProvider {
    ...
    private void installCellInfo(SNode child, EditorCell editorCell) {
      ...
      if (renderingCondition_t6d1qn_a7a(getNode(), getEditorContext())) {
