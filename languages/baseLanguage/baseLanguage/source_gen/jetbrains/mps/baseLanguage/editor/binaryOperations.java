  ...
  public class TransformationMenuPart_Group_vwyr1i_a0 extends GroupMenuPart<TransformationMenuItem, TransformationMenuContext> {
    ...
    public class TransformationMenuPart_WrapSubstituteMenu_vwyr1i_a0a extends WrapSubstituteMenuTransformationMenuPart {
      ...
      protected void execute(SNode targetNode, SubstituteMenuItem item, TransformationMenuContext _context, String pattern) {
        ...
        SelectionUtil.selectLabelCellAnSetCaret(_context.getEditorContext(), PrecedenceUtil.processRightTransform(targetNode, createdNode), SelectionManager.FIRST_ERROR_CELL + "|" + SelectionManager.FOCUS_POLICY_CELL + "|" + SelectionManager.FIRST_EDITABLE_CELL, -1);
      }
    }
  }
}
