...
public class ElsifClause_Editor extends DefaultNodeEditor {
  ...
  public static class ElsifClause_generic_cellMenu_m61dlm_a0a0 extends AbstractCellMenuPart_Generic_Group {
    ...
    public List<?> createParameterObjects(SNode node, IOperationContext operationContext, EditorContext editorContext) {
      ...
      SNode ifStatement = ElsifClause_BehaviorDescriptor.getIfStatement_idhEwIDu9.invoke(node);
    ...
    public void handleAction_impl(String parameterObject, SNode node, SModel model, IOperationContext operationContext, EditorContext editorContext) {
      if ("else".equals(parameterObject)) {
        ElsifClause_BehaviorDescriptor.convertToElseClause_idhIdko9K.invoke(node);
      }
    }
