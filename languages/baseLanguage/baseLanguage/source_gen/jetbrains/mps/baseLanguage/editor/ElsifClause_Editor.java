...
public class ElsifClause_Editor extends DefaultNodeEditor {
  ...
  public static class ElsifClause_generic_cellMenu_m61dlm_a0a0 extends AbstractCellMenuPart_Generic_Group {
    ...
    protected void handleAction(Object parameterObject, SNode node, org.jetbrains.mps.openapi.model.SModel model, IScope scope, IOperationContext operationContext, EditorContext editorContext) {
      this.handleAction_impl((String) parameterObject, node, model, scope, operationContext, editorContext);
    }

    public void handleAction_impl(String parameterObject, SNode node, org.jetbrains.mps.openapi.model.SModel model, IScope scope, IOperationContext operationContext, EditorContext editorContext) {
