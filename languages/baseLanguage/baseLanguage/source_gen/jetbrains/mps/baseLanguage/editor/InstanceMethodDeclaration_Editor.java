...
public class InstanceMethodDeclaration_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createConstant_359zr8_b3a(EditorContext editorContext, SNode node) {
    ...
    editorCell.setCellId("Constant_359zr8_b3a");
    Style style = new StyleImpl();
    BaseLanguageStyle_StyleSheet.apply_KeyWord(style, editorCell);
  ...
  private static boolean renderingCondition_359zr8_a1d0(SNode node, EditorContext editorContext) {
    return SPropertyOperations.getBoolean(node, MetaAdapterFactory.getProperty(new UUID(-935030926396207931l, -6610165693999523818l), 1068580123132l, 1181808852946l, "isFinal"));
  }
  ...
  private EditorCell createConstant_359zr8_c3a(EditorContext editorContext, SNode node) {
    ...
    editorCell.setCellId("Constant_359zr8_c3a");
    Style style = new StyleImpl();
    BaseLanguageStyle_StyleSheet.apply_KeyWord(style, editorCell);
    style.set(StyleAttributes.EDITABLE, 0, true);
    editorCell.getStyle().putAll(style);
  ...
  private static boolean renderingCondition_359zr8_a2d0(SNode node, EditorContext editorContext) {
    return SPropertyOperations.getBoolean(node, MetaAdapterFactory.getProperty(new UUID(-935030926396207931l, -6610165693999523818l), 1068580123165l, 1178608670077l, "isAbstract"));
  }
  ...
  private EditorCell createConstant_359zr8_d3a(EditorContext editorContext, SNode node) {
    ...
    editorCell.setCellId("Constant_359zr8_d3a");
    Style style = new StyleImpl();
    BaseLanguageStyle_StyleSheet.apply_KeyWord(style, editorCell);
    style.set(StyleAttributes.EDITABLE, 0, true);
    editorCell.getStyle().putAll(style);
  ...
  private static boolean renderingCondition_359zr8_a3d0(SNode node, EditorContext editorContext) {
    return SPropertyOperations.getBoolean(node, MetaAdapterFactory.getProperty(new UUID(-935030926396207931l, -6610165693999523818l), 1068580123132l, 4276006055363816570l, "isSynchronized"));
  }
  ...
  private EditorCell createConstant_359zr8_e3a(EditorContext editorContext, SNode node) {
    ...
    editorCell.setCellId("Constant_359zr8_e3a");
    Style style = new StyleImpl();
    BaseLanguageStyle_StyleSheet.apply_KeyWord(style, editorCell);
    style.set(StyleAttributes.EDITABLE, 0, true);
    editorCell.getStyle().putAll(style);
  ...
  private static boolean renderingCondition_359zr8_a4d0(SNode node, EditorContext editorContext) {
    return SPropertyOperations.getBoolean(node, MetaAdapterFactory.getProperty(new UUID(-935030926396207931l, -6610165693999523818l), 7812454656619025416l, 8355037393041754995l, "isNative"));
  }
  ...
  private static boolean renderingCondition_359zr8_a5d0(SNode node, EditorContext editorContext) {
    return ListSequence.fromList(SLinkOperations.getChildren(node, MetaAdapterFactory.getContainmentLink(new UUID(-935030926396207931l, -6610165693999523818l), 2323553266850475941l, 2323553266850475953l, "modifiers"))).isNotEmpty();
  }
  ...
  private static boolean renderingCondition_359zr8_a01a(SNode node, EditorContext editorContext) {
    return ListSequence.fromList(SLinkOperations.getChildren(node, MetaAdapterFactory.getContainmentLink(new UUID(-935030926396207931l, -6610165693999523818l), 1068580123132l, 1164879685961l, "throwsItem"))).isNotEmpty();
  }
