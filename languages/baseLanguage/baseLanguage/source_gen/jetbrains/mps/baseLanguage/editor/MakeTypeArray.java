...
public class MakeTypeArray extends KeyMapImpl {
  ...
  public static class MakeTypeArray_Action0 extends KeyMapActionImpl {
    ...
    public boolean canExecute(final EditorContext editorContext) {
      ...
      if (!(SNodeUtil.isInstanceOf(contextNode, SConceptRepository.getInstance().getConcept("jetbrains.mps.baseLanguage.structure.Statement")))) {
        return false;
      }
      return true;
    }
    ...
    private void execute_internal(final EditorContext editorContext, final SNode node, final List<SNode> selectedNodes) {
      ...
      SAbstractConcept t = ListSequence.fromList(SConceptOperations.getAllSubConcepts(MetaAdapterFactory.getConcept(0xf3061a5392264cc5L, 0xa443f952ceaf5816L, 0xf8c37f506dL, "jetbrains.mps.baseLanguage.structure.Type"), SNodeOperations.getModel(varStms))).where(new IWhereFilter<SAbstractConcept>() {
        public boolean accept(SAbstractConcept it) {
          return eq_u3xwmg_a0a0a0a0a0a0h0e1(it.getConceptAlias(), text);
        }
      }).first();
      if (t != null) {
        ...
        SNode clazz = ListSequence.fromList(SModelOperations.nodesIncludingImported(SNodeOperations.getModel(varStms), MetaAdapterFactory.getConcept(0xf3061a5392264cc5L, 0xa443f952ceaf5816L, 0x101d9d3ca30L, "jetbrains.mps.baseLanguage.structure.Classifier"))).where(new IWhereFilter<SNode>() {
          public boolean accept(SNode it) {
            return eq_u3xwmg_a0a0a0a0a0a0a0a8a4b(SPropertyOperations.getString(it, MetaAdapterFactory.getProperty(0xceab519525ea4f22L, 0x9b92103b95ca8c0cL, 0x110396eaaa4L, 0x110396ec041L, "name")), text);
          }
        }).first();
        if (clazz != null) {
    ...
    private static boolean eq_u3xwmg_a0a0a0a0a0a0h0e1(Object a, Object b) {
      return (a != null ? a.equals(b) : a == b);
    }
    private static boolean eq_u3xwmg_a0a0a0a0a0a0a0a8a4b(Object a, Object b) {
      return (a != null ? a.equals(b) : a == b);
    }
  }
}
