...
public class StaticMethodDeclaration_ApplySideTransforms_1 extends TransformationMenuBase {
  ...
  protected List<MenuPart<TransformationMenuItem, TransformationMenuContext>> getParts(TransformationMenuContext _context) {
    ...
    if (ListSequence.fromListAndArray(new ArrayList<String>(), MenuLocations.LEFT_SIDE_TRANSFORM, MenuLocations.RIGHT_SIDE_TRANSFORM).contains(_context.getMenuLocation())) {
      result.add(new StaticMethodDeclaration_ApplySideTransforms_1.TransformationMenuPart_IncludeMenu_968v2d_a0());
    }
    if (ListSequence.fromListAndArray(new ArrayList<String>(), MenuLocations.SUBSTITUTE).contains(_context.getMenuLocation())) {
      result.add(new StaticMethodDeclaration_ApplySideTransforms_1.TransformationMenuPart_IncludeMenu_968v2d_a1());
    }
    return result;
  }

  public class TransformationMenuPart_IncludeMenu_968v2d_a0 extends IncludeTransformationMenuTransformationMenuPart {

  }
  public class TransformationMenuPart_IncludeMenu_968v2d_a1 extends IncludeTransformationMenuTransformationMenuPart {
    @Nullable
    @Override
