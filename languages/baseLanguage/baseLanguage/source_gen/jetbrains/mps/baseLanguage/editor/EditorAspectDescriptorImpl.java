...
public class EditorAspectDescriptorImpl implements EditorAspectDescriptor {
  ...
  public Collection<ConceptEditorComponent> getEditorComponents(ConceptDescriptor descriptor, String editorComponentId) {
    switch (Arrays.binarySearch(stringSwitchCases_xbvbvu_a0a0b, descriptor.getConceptFqName())) {
      case 0:
        ...
        break;
      case 1:
        if ("ClassifierMembers_Component".equals(editorComponentId)) {
      ...
      case 3:
        ...
        break;
      case 4:
        if ("HasAnnotation_AnnotationComponent".equals(editorComponentId)) {
          return Collections.<ConceptEditorComponent>singletonList(new HasAnnotation_AnnotationComponent(null));
        }
        break;
      case 5:
        if ("_DeprecatedPart".equals(editorComponentId)) {
  ...
  private static String[] stringSwitchCases_xbvbvu_a0a0a0a1 = new String[]{"BaseMethodDeclaration_BodyComponent", "BaseMethodDeclaration_NameCellComponent"};
  private static String[] stringSwitchCases_xbvbvu_a0a0c0a1 = new String[]{"ConceptFunctionAliased_Component", "ConceptFunction_Component", "ConceptFunction_Folded_Component"};
  private static String[] stringSwitchCases_xbvbvu_a0a0d0a1 = new String[]{"GenericDeclaration_FoldedCodeBlock_Component", "_GenericDeclaration_TypeVariables_Component"};
  private static String[] stringSwitchCases_xbvbvu_a0a0g0a1 = new String[]{"IMethodCall_actualArguments", "IMethodCall_typeArguments"};
