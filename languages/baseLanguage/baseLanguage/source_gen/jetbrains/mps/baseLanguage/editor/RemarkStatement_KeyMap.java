...
public class RemarkStatement_KeyMap extends KeyMapImpl {
  ...
  public static class RemarkStatement_KeyMap_Action0 extends KeyMapActionImpl {
    ...
    private void execute_internal(final EditorContext editorContext, final SNode node, final List<SNode> selectedNodes) {
      ...
      SNode newRemark = SNodeFactoryOperations.createNewNode(MetaAdapterFactory.getConcept(new UUID(-935030926396207931l, -6610165693999523818l), 1168622733562l, "jetbrains.mps.baseLanguage.structure.RemarkStatement"), null);
