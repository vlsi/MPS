...
/*package*/ class AnonymousClass_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createRefCell_msf9u8_a0a() {
    CellProviderWithRole provider = new RefCellCellProvider(myNode, getEditorContext()) {
      ...
      protected InlineCellProvider createInlineCellProvider(SNode innerCellNode) {
        return new AnonymousClass_EditorBuilder_a._Inline_msf9u8_a0a0(innerCellNode, myNode);
      }
    };
  ...
  public static class _Inline_msf9u8_a0a0 extends InlineCellProvider {
    public _Inline_msf9u8_a0a0(SNode node, SNode refNode) {
      super(node, refNode);
    }
  ...
  private static class constructorArgumentListHandler_msf9u8_e0a extends RefNodeListHandler {
    ...
    public EditorCell createNodeCell(SNode elementNode) {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromNode(elementNode, MetaAdapterFactory.getConcept(0xf3061a5392264cc5L, 0xa443f952ceaf5816L, 0xf8c37f506fL, "jetbrains.mps.baseLanguage.structure.Expression")));
