...
public class ArrayInitializers_Delete {
  public static void setCellActions(EditorCell editorCell, SNode node, EditorContext context) {
    editorCell.setAction(CellActionType.DELETE, new ArrayInitializers_Delete.ArrayInitializers_Delete_DELETE(node));
  }

  public static class ArrayInitializers_Delete_DELETE extends AbstractCellAction {
    /*package*/ SNode myNode;

    public ArrayInitializers_Delete_DELETE(SNode node) {
      this.myNode = node;
    }
    ...
    public void execute_internal(EditorContext editorContext, SNode node) {
      SNode creator = SNodeOperations.getAncestor(node, "jetbrains.mps.baseLanguage.structure.ArrayCreatorWithInitializerAndMultipleDimensions", true, false);
      if ((creator != null)) {
