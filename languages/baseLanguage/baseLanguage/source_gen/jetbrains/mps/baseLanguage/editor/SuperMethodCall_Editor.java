...
public class SuperMethodCall_Editor extends DefaultNodeEditor {
  public EditorCell createEditorCell(EditorContext editorContext, SNode node) {
    return this.createComponent_jug38p_a(editorContext, node);
  }
  private EditorCell createComponent_jug38p_a(EditorContext editorContext, SNode node) {
  ...
  private EditorCell createConstant_jug38p_g0(EditorContext editorContext, SNode node) {
    ...
    editorCell.getStyle().putAll(style);
    if (renderingCondition_jug38p_a6a(node, editorContext)) {
      editorCell.getStyle().set(StyleAttributes.FOCUS_POLICY, FocusPolicy.ATTRACTS_FOCUS);
    }
    editorCell.setDefaultText("");
    return editorCell;
  }
  private static boolean renderingCondition_jug38p_a6a(SNode node, EditorContext editorContext) {
