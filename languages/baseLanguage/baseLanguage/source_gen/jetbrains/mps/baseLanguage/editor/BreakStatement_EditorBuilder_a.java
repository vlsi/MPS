...
/*package*/ class BreakStatement_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createCollection_xk0l2m_a() {
    ...
    if (renderingCondition_xk0l2m_a1a(myNode, getEditorContext())) {
      editorCell.addEditorCell(createCollection_xk0l2m_b0());
    }
    if (renderingCondition_xk0l2m_a2a(myNode, getEditorContext())) {
  ...
  private class loopLabelReferenceSingleRoleHandler_xk0l2m_a2a extends SingleRoleCellProvider {
    ...
    private void installCellInfo(SNode child, EditorCell editorCell) {
      if (editorCell.getSubstituteInfo() == null || editorCell.getSubstituteInfo() instanceof DefaultSubstituteInfo) {
        editorCell.setSubstituteInfo(new OldNewCompositeSubstituteInfo(getEditorContext(), new SChildSubstituteInfo(editorCell, getNode(), MetaAdapterFactory.getContainmentLink(0xf3061a5392264cc5L, 0xa443f952ceaf5816L, 0xfbe39a867fL, 0x7dae85d6eb42f8c4L, "loopLabelReference"), child), new DefaultChildSubstituteInfo(getNode(), myContainmentLink.getDeclarationNode(), getEditorContext())));
      }
