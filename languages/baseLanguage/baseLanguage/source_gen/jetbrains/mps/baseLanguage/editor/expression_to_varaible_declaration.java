...
public class expression_to_varaible_declaration extends TransformationMenuBase {
  ...
  protected List<MenuPart<TransformationMenuItem, TransformationMenuContext>> getParts(TransformationMenuContext _context) {
    ...
    if (ListSequence.fromListAndArray(new ArrayList<String>(), MenuLocations.LEFT_SIDE_TRANSFORM).contains(_context.getMenuLocation())) {
      result.add(new expression_to_varaible_declaration.TMP_Group_q2psyq_a0());
    }
    return result;
  }

  public class TMP_Group_q2psyq_a0 extends GroupMenuPart<TransformationMenuItem, TransformationMenuContext> {
    @Override
    ...
    protected List<MenuPart<TransformationMenuItem, TransformationMenuContext>> getParts() {
      return Arrays.<MenuPart<TransformationMenuItem, TransformationMenuContext>>asList(new expression_to_varaible_declaration.TMP_Group_q2psyq_a0.TMP_WrapSM_q2psyq_a0a());
    }
    public class TMP_WrapSM_q2psyq_a0a extends WrapSubstituteMenuTransformationMenuPart {
