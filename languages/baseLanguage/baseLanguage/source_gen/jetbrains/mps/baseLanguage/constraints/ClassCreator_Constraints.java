          ...
          public Scope createScope(final IOperationContext operationContext, final ReferenceConstraintsContext _context) {
            {
              ...
              final Iterable<SNode> memberConstructors = Sequence.fromIterable(SNodeOperations.ofConcept(visibleInheritedNestedClassifiers, MetaAdapterFactory.getConcept(0xf3061a5392264cc5L, 0xa443f952ceaf5816L, 0xf8c108ca66L, "jetbrains.mps.baseLanguage.structure.ClassConcept"))).where(new IWhereFilter<SNode>() {
                public boolean accept(SNode it) {
