...
public class DoWhileStatement_TextGen extends SNodeTextGen {
  public void doGenerateText(SNode node) {
    ...
    textGen.appendNewLine();
    textGen.appendWithIndent("} while (");
    textGen.appendNode(SLinkOperations.getTarget(node, MetaAdapterFactory.getContainmentLink(0xf3061a5392264cc5L, 0xa443f952ceaf5816L, 0x11232674988L, 0x11232679422L, "condition")));
    textGen.append(");");
