...
public class ExpressionStatement_TextGen extends SNodeTextGen {
  public void doGenerateText(SNode node) {
    ...
    this.appendNewLine();
    this.indentBuffer();
    appendNode(SLinkOperations.getTarget(node, MetaAdapterFactory.getContainmentLink(new UUID(-935030926396207931l, -6610165693999523818l), 1068580123155l, 1068580123156l, "expression")));
    this.append(";");
    if (getBuffer().hasPositionsSupport()) {
      {
  ...
  protected static Logger LOG = LogManager.getLogger(ExpressionStatement_TextGen.class);
}
