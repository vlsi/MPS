...
public abstract class BaseLanguageTextGen {
  ...
  public static void annotations(SNode annotable, final TextGenContext ctx) {
    ...
    if (SNodeOperations.isInstanceOf(annotable, MetaAdapterFactory.getInterfaceConcept(0xceab519525ea4f22L, 0x9b92103b95ca8c0cL, 0x11d205fe38dL, "jetbrains.mps.lang.core.structure.IDeprecatable")) && IDeprecatable__BehaviorDescriptor.isDeprecated_idhOwoPtR.invoke(SNodeOperations.cast(annotable, MetaAdapterFactory.getInterfaceConcept(0xceab519525ea4f22L, 0x9b92103b95ca8c0cL, 0x11d205fe38dL, "jetbrains.mps.lang.core.structure.IDeprecatable")))) {
  ...
  public static void fileHeader(SNode cls, final TextGenContext ctx) {
    final TextGenSupport tgs = new TextGenSupport(ctx);
    boolean topClassifier = !(Classifier__BehaviorDescriptor.isInner_idsWroEc0xXl.invoke(cls));
    if (topClassifier) {
