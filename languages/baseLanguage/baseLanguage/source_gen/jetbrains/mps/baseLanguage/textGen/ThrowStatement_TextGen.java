...
public class ThrowStatement_TextGen extends SNodeTextGen {
  public void doGenerateText(SNode node) {
    ...
    textGen.appendWithIndent("throw ");
    textGen.appendNode(SLinkOperations.getTarget(node, MetaAdapterFactory.getContainmentLink(0xf3061a5392264cc5L, 0xa443f952ceaf5816L, 0x10f3ee082d8L, 0x10f3ee0cd6fL, "throwable")));
    textGen.append(";");
