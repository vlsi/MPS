...
public class MakeFieldFinal extends BaseRefactoring {
  ...
  public SearchResults getAffectedNodes(final RefactoringContext refactoringContext) {
    return FindUtils.getSearchResults(new EmptyProgressMonitor(), refactoringContext.getSelectedNode(), new GlobalScope(), "jetbrains.mps.baseLanguage.findUsages.FieldUsages_Finder");
