...
public class IfEqualsNullAll extends DataFlowConstructor {
  ...
  public void performActions(Program o, SNode node) {
    ...
    if (!((int) ListSequence.fromList(SLinkOperations.getTargets(ifTrue, "statement", true)).count() == 1 && SNodeOperations.isInstanceOf(ListSequence.fromList(SLinkOperations.getTargets(ifTrue, "statement", true)).first(), "jetbrains.mps.baseLanguage.structure.ReturnStatement"))) {
      for (SNode var : vars) {
        {
