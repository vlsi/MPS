...
public final class BaseMethodCall__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<Object[]> getActualArguments_idhEwI$gh = new SMethodBuilder<Object[]>(new SJavaCompoundTypeImpl((Class<Object[]>) ((Class) Object.class))).name("getActualArguments").modifiers(SModifiersImpl.create(0, AccessPrivileges.PUBLIC)).concept(CONCEPT).id("hEwI$gh").registry(REGISTRY).build(SParameterImpl.fromList(SJavaCompoundTypeImpl.fromClasses(SModule.class)));
  ...
  protected <T> T invokeSpecial0(@NotNull SNode node, @NotNull SMethod<T> method, @NotNull Object[] parameters) {
    ...
    switch (methodIndex) {
      case 0:
        return (T) getActualArguments_idhEwI$gh(node, (SModule) parameters[0]);
      case 1:
