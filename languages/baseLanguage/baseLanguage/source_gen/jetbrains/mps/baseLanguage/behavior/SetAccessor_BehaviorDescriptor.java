...
public class SetAccessor_BehaviorDescriptor extends BaseConcept_BehaviorDescriptor implements IMethodLike_BehaviorDescriptor, IStatementListContainer_BehaviorDescriptor {
  ...
  public SNode virtual_getBody_1239354440022(SNode thisNode) {
    return SetAccessor_Behavior.virtual_getBody_1239354440022(thisNode);
  }
  public SNode virtual_getExpectedRetType_1239354342632(SNode thisNode) {
    return SetAccessor_Behavior.virtual_getExpectedRetType_1239354342632(thisNode);
  }
  ...
  public List<SNode> virtual_getThrowableTypes_6204026822016975623(SNode thisNode) {
    return SetAccessor_Behavior.virtual_getThrowableTypes_6204026822016975623(thisNode);
  }
