  ...
  public static SNode getConcreteClassifierType(SNode typeWithVars, SNode classifierSubtype) {
    ...
    for (SNode varRef : varRefs) {
      ...
      if (index < ListSequence.fromList(params).count()) {
        ...
        SNodeOperations.replaceWithAnother(varRef, TypeVariableDeclaration_BehaviorDescriptor.getConcreteUpperBound_id3LgQEacCviw.invoke(SLinkOperations.getTarget(varRef, MetaAdapterFactory.getReferenceLink(0xf3061a5392264cc5L, 0xa443f952ceaf5816L, 0x102467229d8L, 0x1024673a581L, "typeVariableDeclaration"))));
      }
    }
    return result;
  }
