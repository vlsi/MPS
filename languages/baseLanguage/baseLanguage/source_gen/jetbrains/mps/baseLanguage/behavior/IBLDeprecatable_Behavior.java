...
public class IBLDeprecatable_Behavior {
  ...
  public static boolean virtual_isDeprecated_1224609060727(SNode thisNode) {
    ...
    if (SNodeOperations.isInstanceOf(thisNode, "jetbrains.mps.baseLanguage.structure.HasAnnotation")) {
      for (SNode annotation : SLinkOperations.getChildren(SNodeOperations.cast(thisNode, "jetbrains.mps.baseLanguage.structure.HasAnnotation"), MetaAdapterFactory.getContainmentLink(new UUID(-935030926396207931l, -6610165693999523818l), 1188208481402l, 1188208488637l, "annotation"))) {
