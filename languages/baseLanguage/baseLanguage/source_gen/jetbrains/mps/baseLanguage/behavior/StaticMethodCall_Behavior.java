...
public class StaticMethodCall_Behavior {
  ...
  public static boolean call_canBeConvertedToLocal_3299924278393499101(SNode thisNode) {
    ...
    SNode classConcept2 = SNodeOperations.getNodeAncestor(thisNode, MetaAdapterFactory.getConcept(new UUID(-935030926396207931l, -6610165693999523818l), 1107461130800l, "jetbrains.mps.baseLanguage.structure.Classifier"), false, false);
