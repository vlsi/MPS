...
public class Classifier_Behavior {
  ...
  private static Class[] PARAMETERS_7343816061617019844 = {SNode.class, SNode.class, List.class};
  ...
  public static Scope virtual_getMembers_2201875424515824604(final SNode thisNode, final SNode kind) {
  ...
  public static Scope virtual_getScope_3734116213129936182(SNode thisNode, final SNode kind, SNode child) {
    ...
    // todo: remove this logic from Classifier 
    {
      SNode concept_e0cb;
      concept_e0cb = kind;
      if (SConceptOperations.isSubConceptOf(concept_e0cb, "jetbrains.mps.baseLanguage.structure.ContextClassifierKind")) {
        return CompositeWithParentScope.from(thisNode, thisNode, kind);
      }
      if (SConceptOperations.isSubConceptOf(concept_e0cb, "jetbrains.mps.baseLanguage.structure.TypeVariableDeclaration")) {
      ...
      if (SConceptOperations.isSubConceptOf(concept_e0cb, "jetbrains.mps.baseLanguage.structure.BaseVariableDeclaration")) {
        {
      ...
      if (SConceptOperations.isSubConceptOf(concept_e0cb, "jetbrains.mps.baseLanguage.structure.BaseMethodDeclaration")) {
      ...
      if (SConceptOperations.isSubConceptOf(concept_e0cb, "jetbrains.mps.baseLanguage.structure.ClassifierMember")) {
        {
  ...
  public static Iterable<SNode> call_doOverride_7343816061617019844(SNode thisNode, SNode kind, List<SNode> equalSignatureMembers) {
    BehaviorDescriptor descriptor = ConceptRegistry.getInstance().getBehaviorDescriptorForInstanceNode(thisNode);
  ...
  public static Iterable<SNode> callSuper_doOverride_7343816061617019844(SNode thisNode, String callerConceptFqName, SNode kind, List<SNode> equalSignatureMembers) {
    ...
    public boolean match(SNode nodeToMatch) {
      {
        ...
        if (!("jetbrains.mps.baseLanguage.structure.ClassifierType".equals(nodeToMatch_Classifier_Behavior_qw8l7c_a0a0a0a52.getConceptFqName()))) {
          return false;
        }
        {
          SNode referent;
          referent = (SNode) this.AntiquotationField_qw8l7c_a0a0a0a0a52;
          if (nodeToMatch_Classifier_Behavior_qw8l7c_a0a0a0a52.getReferent("classifier") != referent) {
            return false;
          }
        }
        {
