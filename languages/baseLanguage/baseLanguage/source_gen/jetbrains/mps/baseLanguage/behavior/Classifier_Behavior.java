...
public class Classifier_Behavior {
  ...
  private static Class[] PARAMETERS_3642561415614722944 = {SNode.class, MembersScope.class, SNode.class};
  ...
  public static void call_populateMembers_3642561415614722944(SNode thisNode, MembersScope scope, SNode contextClassifier) {
    BehaviorDescriptor descriptor = ConceptRegistry.getInstance().getBehaviorDescriptorForInstanceNode(thisNode);
  ...
  public static void callSuper_populateMembers_3642561415614722944(SNode thisNode, String callerConceptFqName, MembersScope scope, SNode contextClassifier) {
