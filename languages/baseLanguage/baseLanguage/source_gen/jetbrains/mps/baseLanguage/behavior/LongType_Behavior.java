...
public class LongType_Behavior {
  ...
  private static SNode _quotation_createNode_1ld2dp_a0a1() {
    ...
    quotedNode_1.setReference("variableDeclaration", SReference.create("variableDeclaration", quotedNode_1, facade.createModelReference("f:java_stub#6354ebe7-c22a-4a0f-ac54-50b52ab9b065#java.lang(JDK/java.lang@java_stub)"), facade.createNodeId("~Integer.TYPE")));
    return quotedNode_1;
  }
}
