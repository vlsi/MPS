...
public final class TypeVariableDeclaration_BehaviorDescriptor extends BaseBHDescriptor {
  ...
  private static String getPresentation_idhEwIMiw(@NotNull SNode __thisNode__) {
    ...
    if ((SLinkOperations.getTarget(__thisNode__, MetaAdapterFactory.getContainmentLink(0xf3061a5392264cc5L, 0xa443f952ceaf5816L, 0x1024639ed74L, 0x11ae375bda0L, "bound")) != null)) {
      buff.append(" extends ").append(BaseConcept_BehaviorDescriptor.getPresentation_idhEwIMiw.invoke(SLinkOperations.getTarget(__thisNode__, MetaAdapterFactory.getContainmentLink(0xf3061a5392264cc5L, 0xa443f952ceaf5816L, 0x1024639ed74L, 0x11ae375bda0L, "bound"))));
    }
    for (SNode bound : ListSequence.fromList(SLinkOperations.getChildren(__thisNode__, MetaAdapterFactory.getContainmentLink(0xf3061a5392264cc5L, 0xa443f952ceaf5816L, 0x1024639ed74L, 0x11ae913a476L, "auxBounds")))) {
      buff.append(" & ").append(BaseConcept_BehaviorDescriptor.getPresentation_idhEwIMiw.invoke(bound));
    }
  ...
  /*package*/ TypeVariableDeclaration_BehaviorDescriptor() {
    super(REGISTRY);
  }
