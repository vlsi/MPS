...
public class SurroundExceptionWithTryCatch_QuickFix extends QuickFix_Runtime {
  ...
  public void execute(SNode node) {
    ...
    if (parentTryStatement != null) {
      ...
      SLinkOperations.setTarget(tryCatchStatement, MetaAdapterFactory.getContainmentLink(new UUID(-935030926396207931l, -6610165693999523818l), 1164879751025l, 1164879758292l, "body"), SConceptOperations.createNewNode(MetaAdapterFactory.getConcept(new UUID(-935030926396207931l, -6610165693999523818l), 1068580123136l, "jetbrains.mps.baseLanguage.structure.StatementList")));
