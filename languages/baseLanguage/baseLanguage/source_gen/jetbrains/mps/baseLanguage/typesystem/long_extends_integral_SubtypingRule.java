...
public class long_extends_integral_SubtypingRule extends SubtypingRule_Runtime implements ISubtypingRule_Runtime {
  ...
  public SNode getSubOrSuperType(SNode longType, TypeCheckingContext typeCheckingContext, IsApplicableStatus status) {
    return SLinkOperations.getTarget(new long_extends_integral_SubtypingRule.QuotationClass_gen3g4_a0a0a0().createNode(typeCheckingContext), "descriptor", false);
  }
  ...
  public static class QuotationClass_gen3g4_a0a0a0 {
    public QuotationClass_gen3g4_a0a0a0() {
    }
    ...
    public SNode createNode(final TypeCheckingContext typeCheckingContext) {
      ...
      SNode quotedNode_1 = null;
      {
        ...
        quotedNode1_2.setReference("descriptor", SReference.create("descriptor", quotedNode1_2, SModelReference.fromString("r:00000000-0000-4000-0000-011c895902de(jetbrains.mps.baseLanguage.blTypes.primitiveDescriptors)"), SNodeId.fromString("1196683481013")));
