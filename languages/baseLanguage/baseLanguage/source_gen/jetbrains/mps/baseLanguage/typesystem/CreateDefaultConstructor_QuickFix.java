...
public class CreateDefaultConstructor_QuickFix extends QuickFix_Runtime {
  ...
  public void execute(SNode node) {
    ...
    ListSequence.fromList(SLinkOperations.getTargets(((SNode) CreateDefaultConstructor_QuickFix.this.getField("classConcept")[0]), "member", true)).addElement(constructor);
  }
}
