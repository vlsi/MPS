      ...
      SNode matchedNode_x4f43m_a0 = SNodeOperations.getParent(variableArityType);
      {
        boolean matches_x4f43m_a0a = false;
        {
          ...
          if (matchingNode_x4f43m_a0a != null) {
            matches_x4f43m_a0a = SModelUtil_new.isAssignableConcept(matchingNode_x4f43m_a0a.getConcept().getQualifiedName(), "jetbrains.mps.baseLanguage.structure.ParameterDeclaration");
          }
        }
