...
public class long_unboxing_SubtypingRule extends SubtypingRule_Runtime implements ISubtypingRule_Runtime {
    ...
    public boolean match(SNode nodeToMatch) {
      {
        ...
        if (!("jetbrains.mps.baseLanguage.structure.ClassifierType".equals(nodeToMatch_long_unboxing_4kdzcp_a0a.getConcept().getConceptId()))) {
          return false;
        }
        {
          SNodeReference pointer = SNODE_POINTER_34hpo3_a0a0a0a0b0c0a0a0a0a0a0e;
          if (!(PatternUtil.matchReferentWithNode(pointer, nodeToMatch_long_unboxing_4kdzcp_a0a.getReferenceTarget("classifier")))) {
            return false;
          }
        }
      }
  ...
  private static SNodeReference SNODE_POINTER_34hpo3_a0a0a0a0b0c0a0a0a0a0a0e = new jetbrains.mps.smodel.SNodePointer("f:java_stub#6354ebe7-c22a-4a0f-ac54-50b52ab9b065#java.lang(JDK/java.lang@java_stub)", "~Long");
}
