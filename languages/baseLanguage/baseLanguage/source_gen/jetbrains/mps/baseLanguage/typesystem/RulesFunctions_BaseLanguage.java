...
__switch__:
  ...
  public static void match_forInnerClassifiers(final TypeCheckingContext typeCheckingContext, SNode declClassifier, SNode instanceType, Map<SNode, List<SNode>> mmap) {
    ...
    SNode constructedType = new RulesFunctions_BaseLanguage.QuotationClass_5ahx9e_a0a5a5().createNode(parentIT, typeCheckingContext);
  ...
  public static boolean isWithinStatic(SNode node) {
    ...
    if ((prevStatementList != null)) {
      {
        SNode matchedNode_5ahx9e_a0f0o = SNodeOperations.getParent(prevStatementList);
        {
          boolean matches_5ahx9e_a0a5a41 = false;
          {
            SNode matchingNode_5ahx9e_a0a5a41 = SNodeOperations.getParent(prevStatementList);
            if (matchingNode_5ahx9e_a0a5a41 != null) {
              matches_5ahx9e_a0a5a41 = SModelUtil_new.isAssignableConcept(matchingNode_5ahx9e_a0a5a41.getConcept().getId(), "jetbrains.mps.baseLanguage.structure.ClassConcept");
            }
          }
          if (matches_5ahx9e_a0a5a41) {
            return SLinkOperations.getTarget(matchedNode_5ahx9e_a0f0o, "staticInitializer", true) == prevStatementList;
          }
        }
      }
    }
        ...
        SNode matchedNode_5ahx9e_b0g0r = anc;
        {
          boolean matches_5ahx9e_a1a6a71 = false;
          {
            ...
            if (matchingNode_5ahx9e_a1a6a71 != null) {
              matches_5ahx9e_a1a6a71 = SModelUtil_new.isAssignableConcept(matchingNode_5ahx9e_a1a6a71.getConcept().getId(), "jetbrains.mps.baseLanguage.structure.TryStatement");
            }
          }
          if (matches_5ahx9e_a1a6a71) {
            ...
            boolean matches_5ahx9e_b1a6a71 = false;
            {
              ...
              if (matchingNode_5ahx9e_b1a6a71 != null) {
                matches_5ahx9e_b1a6a71 = SModelUtil_new.isAssignableConcept(matchingNode_5ahx9e_b1a6a71.getConcept().getId(), "jetbrains.mps.baseLanguage.structure.TryCatchStatement");
              }
            }
  ...
  public static class QuotationClass_5ahx9e_a0a5a5 {
    public QuotationClass_5ahx9e_a0a5a5() {
    }
  ...
  public static class QuotationClass_5ahx9e_a1a0a0a0a0a0a1a71 {
    ...
    public SNode createNode(final TypeCheckingContext typeCheckingContext) {
      ...
      SNode quotedNode_1 = null;
      {
        quotedNode_1 = SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.baseLanguage.structure.ClassifierType", null, GlobalScope.getInstance(), false);
        SNode quotedNode1_2 = quotedNode_1;
        quotedNode1_2.setReference("classifier", SReference.create("classifier", quotedNode1_2, SModelReference.fromString("f:java_stub#6354ebe7-c22a-4a0f-ac54-50b52ab9b065#java.lang(java.lang@java_stub)"), SNodeId.fromString("~Error")));
        result = quotedNode1_2;
      }
      return result;
    }
