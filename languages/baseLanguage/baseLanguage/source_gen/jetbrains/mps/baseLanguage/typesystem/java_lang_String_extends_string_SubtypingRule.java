...
public class java_lang_String_extends_string_SubtypingRule extends SubtypingRule_Runtime implements ISubtypingRule_Runtime {
    ...
    public boolean match(SNode nodeToMatch) {
      {
        ...
        }
        {
          ...
          if (!(PatternUtil.matchReferentWithNode(pointer, nodeToMatch_imi2rc_a0a.getReferenceTarget(MetaAdapterFactory.getReferenceLink(new UUID(-935030926396207931l, -6610165693999523818l), 1107535904670l, 1107535924139l, "classifier"))))) {
            return false;
          }
        }
      }
  ...
  private static SNodePointer SNODE_POINTER_cxnqcy_a0a0a0a0b0b0a0a0a0a0a0e = new SNodePointer("6354ebe7-c22a-4a0f-ac54-50b52ab9b065/f:java_stub#6354ebe7-c22a-4a0f-ac54-50b52ab9b065#java.lang(JDK/java.lang@java_stub)", "~String");
}
