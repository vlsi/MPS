    ...
    public boolean match(SNode nodeToMatch) {
      {
        ...
        }
        {
          ...
          if (!(PatternUtil.matchReferentWithNode(pointer, nodeToMatch_31y3xb_a0a.getReferenceTarget(MetaAdapterFactory.getReferenceLink(new UUID(-935030926396207931l, -6610165693999523818l), 1107535904670l, 1107535924139l, "classifier"))))) {
            return false;
          }
        }
      }
