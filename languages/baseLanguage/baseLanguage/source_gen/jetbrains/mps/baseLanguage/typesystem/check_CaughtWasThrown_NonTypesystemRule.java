...
public class check_CaughtWasThrown_NonTypesystemRule extends AbstractNonTypesystemRule_Runtime implements NonTypesystemRule_Runtime {
  ...
  public void applyRule(final SNode catchClause, final TypeCheckingContext typeCheckingContext, IsApplicableStatus status) {
    ...
    if (SNodeOperations.isInstanceOf(caughtType, "jetbrains.mps.baseLanguage.structure.ClassifierType")) {
      ...
      if (TypeChecker.getInstance().getSubtypingManager().isSubtype(caughtType, _quotation_createNode_r5g8rc_b0a0a0b0b0a()) || TypeChecker.getInstance().getSubtypingManager().isSubtype(caughtType, _quotation_createNode_r5g8rc_b0a0a0b0b0a_0()) || caughtClassifier == SNodeOperations.getNode("f:java_stub#6354ebe7-c22a-4a0f-ac54-50b52ab9b065#java.lang(JDK/java.lang@java_stub)", "~Exception") || caughtClassifier == SNodeOperations.getNode("f:java_stub#6354ebe7-c22a-4a0f-ac54-50b52ab9b065#java.lang(JDK/java.lang@java_stub)", "~Throwable")) {
        // ignore 
      } else {
          ...
          SNode matchedNode_13ophr_b0a1a1a = SNodeOperations.getParent(catchClause);
          {
            boolean matches_13ophr_a1a0b0b0 = false;
            {
              ...
              if (matchingNode_13ophr_a1a0b0b0 != null) {
                matches_13ophr_a1a0b0b0 = SModelUtil_new.isAssignableConcept(matchingNode_13ophr_a1a0b0b0.getConcept().getId(), "jetbrains.mps.baseLanguage.structure.TryCatchStatement");
              }
            }
            if (matches_13ophr_a1a0b0b0) {
              ...
              boolean matches_13ophr_b1a0b0b0 = false;
              {
                ...
                if (matchingNode_13ophr_b1a0b0b0 != null) {
                  matches_13ophr_b1a0b0b0 = SModelUtil_new.isAssignableConcept(matchingNode_13ophr_b1a0b0b0.getConcept().getId(), "jetbrains.mps.baseLanguage.structure.TryStatement");
                }
              }
        ...
        if (!(SetSequence.fromSet(thrown).any(new IWhereFilter<SNode>() {
          public boolean accept(SNode t) {
            return TypeChecker.getInstance().getSubtypingManager().isSubtype(_quotation_createNode_r5g8rc_a0a0a0a0a0d0a1a1a0(t), caughtType) || TypeChecker.getInstance().getSubtypingManager().isSubtype(caughtType, _quotation_createNode_r5g8rc_b0a0a0a0a0d0a1a1a0(t));
          }
        }))) {
          {
  ...
  private static SNode _quotation_createNode_r5g8rc_b0a0a0b0b0a() {
  ...
  private static SNode _quotation_createNode_r5g8rc_b0a0a0b0b0a_0() {
    SNode quotedNode_1 = null;
    quotedNode_1 = SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.baseLanguage.structure.ClassifierType", null, null, GlobalScope.getInstance(), false);
  ...
  private static SNode _quotation_createNode_r5g8rc_a0a0a0a0a0d0a1a1a0(Object parameter_1) {
  ...
  private static SNode _quotation_createNode_r5g8rc_b0a0a0a0a0d0a1a1a0(Object parameter_1) {
    SNode quotedNode_2 = null;
    quotedNode_2 = SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.baseLanguage.structure.ClassifierType", null, null, GlobalScope.getInstance(), false);
    quotedNode_2.setReferenceTarget("classifier", (SNode) parameter_1);
    return quotedNode_2;
