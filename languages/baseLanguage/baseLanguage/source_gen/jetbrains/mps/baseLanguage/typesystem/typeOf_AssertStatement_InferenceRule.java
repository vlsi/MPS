...
public class typeOf_AssertStatement_InferenceRule extends AbstractInferenceRule_Runtime implements InferenceRule_Runtime {
  ...
  public void applyRule(final SNode assertStatement, final TypeCheckingContext typeCheckingContext, IsApplicableStatus status) {
    {
      ...
      typeCheckingContext.createLessThanInequality((SNode) typeCheckingContext.typeOf(_nodeToCheck_1029348928467, "r:00000000-0000-4000-0000-011c895902c5(jetbrains.mps.baseLanguage.typesystem)", "1176899056092", true), (SNode) new typeOf_AssertStatement_InferenceRule.QuotationClass_s4rvw8_a0a0a0().createNode(typeCheckingContext), false, true, _info_12389875345);
    }
    if ((SLinkOperations.getTarget(assertStatement, "message", true) != null)) {
      {
        ...
        typeCheckingContext.createLessThanInequality((SNode) typeCheckingContext.typeOf(_nodeToCheck_1029348928467, "r:00000000-0000-4000-0000-011c895902c5(jetbrains.mps.baseLanguage.typesystem)", "1176899107820", true), (SNode) new typeOf_AssertStatement_InferenceRule.QuotationClass_s4rvw8_a0a0a1a0().createNode(typeCheckingContext), false, true, _info_12389875345);
      }
    }
  }
  ...
  public static class QuotationClass_s4rvw8_a0a0a0 {
    public QuotationClass_s4rvw8_a0a0a0() {
    }
  ...
  public static class QuotationClass_s4rvw8_a0a0a1a0 {
    public QuotationClass_s4rvw8_a0a0a1a0() {
    }
