...
public class ResolvedUnknownNode_QuickFix extends QuickFix_Runtime {
  ...
  public void execute(SNode node) {
    _FunctionTypes._return_P0_E0<? extends SNode> nodeBuilder = IYetUnresolved_BehaviorDescriptor.evaluateSubst_id73E7sj5sxxG.invoke(((SNode) ResolvedUnknownNode_QuickFix.this.getField("unknownNode")[0]));
    if (nodeBuilder != null) {
