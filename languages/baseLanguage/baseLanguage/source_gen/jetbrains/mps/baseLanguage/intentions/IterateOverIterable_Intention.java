...
public class IterateOverIterable_Intention implements IntentionFactory {
  ...
  private boolean isApplicableToNode(final SNode node, final EditorContext editorContext) {
    return (TypeChecker.getInstance().getRuntimeSupport().coerce_(TypeChecker.getInstance().getTypeOf(SLinkOperations.getTarget(node, "expression", true)), new IterateOverIterable_Intention.Pattern_w1n2qe_a1a0a0a0h(), true) != null);
  }
  ...
  public class IntentionImplementation implements IntentionExecutable {
    ...
    public void execute(final SNode node, final EditorContext editorContext) {
      {
        GeneratedMatchingPattern pattern_6isygg_a0a = new IterateOverIterable_Intention.Pattern_w1n2qe_a0a0a0a1a();
  ...
  public static class Pattern_w1n2qe_a1a0a0a0h extends GeneratedMatchingPattern implements IMatchingPattern {
    /*package*/ SNode patternVar_elem;

    public Pattern_w1n2qe_a1a0a0a0h() {
    }
    ...
    public boolean match(SNode nodeToMatch) {
      {
        ...
        {
          SNodePointer pointer = SNODE_POINTER_w1n2qe_a0a0a0a0b0c0a0a0b0a0a0a7;
  ...
  public static class Pattern_w1n2qe_a0a0a0a1a extends GeneratedMatchingPattern implements IMatchingPattern {
    /*package*/ SNode patternVar_elem;

    public Pattern_w1n2qe_a0a0a0a1a() {
    }
    ...
    public boolean match(SNode nodeToMatch) {
      {
        ...
        {
          SNodePointer pointer = SNODE_POINTER_w1n2qe_a0a0a0a0b0c0a0a0a0a0a0b0;
