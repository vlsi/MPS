...
public class UnwrapTryCatch_Intention extends BaseIntention {
  ...
  public SNodeReference getIntentionNodeReference() {
    return new SNodePointer("r:20de48b0-42f2-4107-9f28-986d564d8711(jetbrains.mps.baseLanguage.intentions@3_0)", "7093209195843978568");
  }
  ...
  private boolean isApplicableToNode(final SNode node, final EditorContext editorContext) {
    ...
    for (SNode ancestor : ListSequence.fromList(SNodeOperations.getAncestors(selectedNode, null, true))) {
      if (SNodeOperations.isInstanceOf(ancestor, "jetbrains.mps.baseLanguage.structure.ITryCatchStatement")) {
        return eq_cj56ns_a0a0a0b0i(ancestor, node);
      }
    }
    return false;
  }
  ...
  private static boolean eq_cj56ns_a0a0a0b0i(Object a, Object b) {
    return (a != null ?
      a.equals(b) :
      a == b
    );
