...
public class MigrationsFactory {
  public static AbstractMigrations.ConceptMigrationContext LOCAL_STATIC_METHOD_CALL_MIGRATION_CONTEXT = new AbstractMigrations.ConceptMigrationContext(SConceptOperations.findConceptDeclaration("jetbrains.mps.baseLanguage.structure.LocalStaticMethodCall"), SConceptOperations.findConceptDeclaration("jetbrains.mps.baseLanguage.structure.LocalMethodCall"), new _FunctionTypes._return_P1_E0<SNode, SNode>() {
    public SNode invoke(SNode node) {
      // <node> 
      return new MigrationsFactory.QuotationClass_uzzzvm_a0b0a0a2a0a().createNode(node);
    }
  });
  ...
  public static abstract class SModelMethodMigration extends AbstractMigrationRefactoring {
  ...
  public static class QuotationClass_uzzzvm_a0b0a0a2a0a {
    public QuotationClass_uzzzvm_a0b0a0a2a0a() {
    }
