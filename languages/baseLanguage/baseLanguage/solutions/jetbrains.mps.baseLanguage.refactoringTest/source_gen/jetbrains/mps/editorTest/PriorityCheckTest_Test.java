...
public class PriorityCheckTest_Test extends BaseTransformationTest4 {
  ...
  public static class TestBody extends BaseTestBody {
    public void test_testRotation() throws Exception {
      ...
      jetbrains.mps.smodel.SNode op = SConceptOperations.createNewNode("jetbrains.mps.baseLanguage.structure.PlusExpression", null);
      jetbrains.mps.smodel.SNode constant = SConceptOperations.createNewNode("jetbrains.mps.baseLanguage.structure.IntegerConstant", null);
