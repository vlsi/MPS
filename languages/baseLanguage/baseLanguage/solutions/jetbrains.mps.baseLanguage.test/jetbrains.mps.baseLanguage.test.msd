...
<solution name="jetbrains.mps.baseLanguage.test" uuid="9c8b4b95-5d89-4201-ad78-0b2db3a22768" pluginKind="PLUGIN_OTHER" compileInMPS="true" generatorOutputPath="${module}/source_gen">
  <models>
  ...
  <dependencies>
    ...
    <dependency reexport="false">b5734616-c4b0-4639-9c6a-f3a1cf5dc4db(testDefaultEditor)</dependency>
  </dependencies>
  <usedLanguages>
    ...
    <usedLanguage>b5734616-c4b0-4639-9c6a-f3a1cf5dc4db(testDefaultEditor)</usedLanguage>
    <usedLanguage>e228eea1-07ef-499c-8826-9c47a7e369db(testMoveElements)</usedLanguage>
  </usedLanguages>
  <usedDevKits>
