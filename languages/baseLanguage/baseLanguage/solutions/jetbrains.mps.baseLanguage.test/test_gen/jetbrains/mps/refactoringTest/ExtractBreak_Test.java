...
public class ExtractBreak_Test extends BaseTransformationTest {
  ...
  public static class TestBody extends BaseTestBody {
    public void test_ExtractBreak() throws Exception {
      ...
      ref.doRefactor();
      {
        List<SNode> nodesBefore = ListSequence.fromListAndArray(new ArrayList<SNode>(), SNodeOperations.cast(this.getNodeById("1230052480334"), "jetbrains.mps.baseLanguage.structure.ClassConcept"));
        List<SNode> nodesAfter = ListSequence.fromListAndArray(new ArrayList<SNode>(), SNodeOperations.cast(this.getNodeById("1230052480362"), "jetbrains.mps.baseLanguage.structure.ClassConcept"));
