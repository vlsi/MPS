...
@MPSLaunch
public class PasteExpressionAsText_Test extends BaseTransformationTest4 {
  public PasteExpressionAsText_Test() {
  }

  @Test
  public void test_PasteExpressionAsText() throws Throwable {
    this.initTest("${mps_home}", "r:914ee49a-537d-44b2-a5fb-bac87a54743d(jetbrains.mps.editorTest@tests)");
    this.runTest("jetbrains.mps.editorTest.PasteExpressionAsText_Test$TestBody", "testMethod", false);
  }
