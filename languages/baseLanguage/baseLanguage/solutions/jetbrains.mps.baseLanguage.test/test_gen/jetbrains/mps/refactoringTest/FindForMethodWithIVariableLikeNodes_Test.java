...
public class FindForMethodWithIVariableLikeNodes_Test extends BaseTransformationTest {
  ...
  public static class TestBody extends BaseTestBody {
    public void test_FindForMethodWithIVariableLikeNodesTest() throws Exception {
      ...
      {
        List<SNode> nodesBefore = ListSequence.fromListAndArray(new ArrayList<SNode>(), SNodeOperations.cast(this.getNodeById("1300615610528534004"), "jetbrains.mps.baseLanguage.structure.ClassConcept"));
        List<SNode> nodesAfter = ListSequence.fromListAndArray(new ArrayList<SNode>(), SNodeOperations.cast(this.getNodeById("1300615610528534194"), "jetbrains.mps.baseLanguage.structure.ClassConcept"));
