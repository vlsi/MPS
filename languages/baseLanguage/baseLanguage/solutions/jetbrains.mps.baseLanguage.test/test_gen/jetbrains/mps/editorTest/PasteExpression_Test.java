...
@MPSLaunch
public class PasteExpression_Test extends BaseTransformationTest4 {
  public PasteExpression_Test() {
  }

  @Test
  public void test_PasteExpression() throws Throwable {
    this.initTest("${mps_home}", "r:914ee49a-537d-44b2-a5fb-bac87a54743d(jetbrains.mps.editorTest@tests)");
    this.runTest("jetbrains.mps.editorTest.PasteExpression_Test$TestBody", "testMethod", false);
  }
  ...
  public static class TestBody extends BaseEditorTestBody {
    ...
    public void testMethodImpl() throws Exception {
      final Editor editor = TestBody.this.initEditor("1236160248682540401", "1236160248682544031");
