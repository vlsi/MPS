...
public class SurrondWithParenthesisTest_Test extends BaseTransformationTest4 {
  ...
  public static class TestBody extends BaseTestBody {
    public void test_noBinaryOperation() throws Exception {
      ...
      Assert.assertNull("nodes '" + SNodeOperations.cast(this.getNodeById("3852894662483077210"), "jetbrains.mps.baseLanguage.structure.ParenthesizedExpression") + "' and '" + result + "' do not match!", NodesMatcher.matchNodes(ListSequence.fromListAndArray(new ArrayList<SNode>(), SNodeOperations.cast(this.getNodeById("3852894662483077210"), "jetbrains.mps.baseLanguage.structure.ParenthesizedExpression")), ListSequence.fromListAndArray(new ArrayList<SNode>(), result)));
    }
    ...
    public void test_treeRotation() throws Exception {
      ...
      Assert.assertNull("nodes '" + SNodeOperations.cast(this.getNodeById("3852894662483240425"), "jetbrains.mps.baseLanguage.structure.ExpressionStatement") + "' and '" + SNodeOperations.cast(this.getNodeById("3852894662483240400"), "jetbrains.mps.baseLanguage.structure.ExpressionStatement") + "' do not match!", NodesMatcher.matchNodes(ListSequence.fromListAndArray(new ArrayList<SNode>(), SNodeOperations.cast(this.getNodeById("3852894662483240425"), "jetbrains.mps.baseLanguage.structure.ExpressionStatement")), ListSequence.fromListAndArray(new ArrayList<SNode>(), SNodeOperations.cast(this.getNodeById("3852894662483240400"), "jetbrains.mps.baseLanguage.structure.ExpressionStatement"))));
    }
  }
}
