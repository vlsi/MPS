...
@MPSLaunch
public class ParenthesiseMethodCall_Test extends BaseTransformationTest4 {
  public ParenthesiseMethodCall_Test() {
  }

  @Test
  public void test_ParenthesiseMethodCall() throws Throwable {
    this.initTest("${mps_home}", "r:914ee49a-537d-44b2-a5fb-bac87a54743d(jetbrains.mps.editorTest@tests)");
    this.runTest("jetbrains.mps.editorTest.ParenthesiseMethodCall_Test$TestBody", "testMethod", false);
  }
  ...
  public static class TestBody extends BaseEditorTestBody {
    ...
    public void testMethodImpl() throws Exception {
      final Editor editor = TestBody.this.initEditor("341917192555036876", "341917192555048372");
