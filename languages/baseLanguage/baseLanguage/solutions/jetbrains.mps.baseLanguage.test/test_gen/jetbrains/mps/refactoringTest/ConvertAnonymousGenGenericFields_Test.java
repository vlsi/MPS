...
public class ConvertAnonymousGenGenericFields_Test extends BaseTransformationTest {
  ...
  public static class TestBody extends BaseTestBody {
    public void test_TypeParametersTest() throws Exception {
      ...
      {
        List<SNode> nodesBefore = ListSequence.fromListAndArray(new ArrayList<SNode>(), SNodeOperations.cast(this.getNodeById("5907083257159818800"), "jetbrains.mps.baseLanguage.structure.ClassConcept"));
        List<SNode> nodesAfter = ListSequence.fromListAndArray(new ArrayList<SNode>(), SNodeOperations.cast(this.getNodeById("5907083257159818959"), "jetbrains.mps.baseLanguage.structure.ClassConcept"));
