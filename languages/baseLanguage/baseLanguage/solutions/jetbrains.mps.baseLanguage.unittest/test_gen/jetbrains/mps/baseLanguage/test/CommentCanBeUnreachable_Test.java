...
public class CommentCanBeUnreachable_Test extends BaseTransformationTest4 {
  @Test
  public void test_NodeRuleCheck2736903840391132362() throws Throwable {
    this.initTest("${mps_home}", "r:00000000-0000-4000-0000-011c895902c7(jetbrains.mps.baseLanguage.test@tests)");
    this.runTest("jetbrains.mps.baseLanguage.test.CommentCanBeUnreachable_Test$TestBody", "test_NodeRuleCheck2736903840391132362", true);
  }
  ...
  public static class TestBody extends BaseTestBody {
    public void test_NodeRuleCheck2736903840391132362() throws Exception {
