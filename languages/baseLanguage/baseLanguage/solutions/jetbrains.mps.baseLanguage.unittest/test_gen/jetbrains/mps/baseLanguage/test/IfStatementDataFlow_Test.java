...
public class IfStatementDataFlow_Test extends BaseTransformationTest4 {
  ...
  @Test
  public void test_NodeRuleCheck1239365538955() throws Throwable {
    this.initTest("${mps_home}", "r:00000000-0000-4000-0000-011c895902c7(jetbrains.mps.baseLanguage.test@tests)");
    this.runTest("jetbrains.mps.baseLanguage.test.IfStatementDataFlow_Test$TestBody", "test_NodeRuleCheck1239365538955", true);
  }
  ...
  public static class TestBody extends BaseTestBody {
    ...
    public void test_NodeRuleCheck1239365538955() throws Exception {
