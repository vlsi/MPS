...
public class UnexpectedReturnInAnonymousClass_Test extends BaseTransformationTest4 {
  ...
  @Test
  public void test_NodeReturnExpectedErrorCheck5872607264944541567() throws Throwable {
    this.initTest("${mps_home}", "r:00000000-0000-4000-0000-011c895902c7(jetbrains.mps.baseLanguage.test@tests)");
    this.runTest("jetbrains.mps.baseLanguage.test.UnexpectedReturnInAnonymousClass_Test$TestBody", "test_NodeReturnExpectedErrorCheck5872607264944541567", true);
  }
  ...
  public static class TestBody extends BaseTestBody {
    ...
    public void test_NodeReturnExpectedErrorCheck5872607264944541567() throws Exception {
      SNode operation = SNodeOperations.cast(this.getRealNodeById("5872607264944541567"), "jetbrains.mps.lang.test.structure.NodeCheckOperation");
