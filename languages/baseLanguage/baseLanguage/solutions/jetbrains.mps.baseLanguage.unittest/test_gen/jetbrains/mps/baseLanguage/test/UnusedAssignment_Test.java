...
public class UnusedAssignment_Test extends BaseTransformationTest {
  ...
  public static class TestBody extends BaseTestBody {
    public void test_UnusedAssignment() throws Exception {
      NodeCheckerUtil.checkNodeForErrorMessages(SNodeOperations.cast(this.getRealNodeById("1215444198388"), "jetbrains.mps.baseLanguage.structure.ConstructorDeclaration"), false, false);
    }
