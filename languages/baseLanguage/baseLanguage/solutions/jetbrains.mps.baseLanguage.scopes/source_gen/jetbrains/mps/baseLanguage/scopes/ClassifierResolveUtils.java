...
public class ClassifierResolveUtils {
  ...
  public static SNode resolveNonSpecialSyntax(@NotNull String classifierName, @NotNull SNode contextNode) {
    ...
    Iterable<SModule> visibleModules = check_8z6r2b_a0a9a2(check_8z6r2b_a0a0j0c(SNodeOperations.getModel(contextNode))).getVisibleModules();
  ...
  public static SNode resolve(@NotNull String refText, @NotNull SNode contextNode, IScope moduleScope, ModelPlusImportedScope modelsPlusImported, boolean includeAncestors) {
    ...
    // try to resolve as fq name in current scope 
    Iterable<SModule> visibleModules = check_8z6r2b_a0a06a21(check_8z6r2b_a0a0ic0m(SNodeOperations.getModel(contextNode))).getVisibleModules();
    result = resolveClassifierByFqNameWithNonStubPriority(Sequence.fromIterable(visibleModules).translate(new ITranslator2<SModule, SModel>() {
      public Iterable<SModel> translate(SModule it) {
        return it.getModels();
      }
  ...
  private static IScope check_8z6r2b_a0a9a2(SModule checkedDotOperand) {
  ...
  private static SModule check_8z6r2b_a0a0j0c(SModel checkedDotOperand) {
    if (null != checkedDotOperand) {
  ...
  private static IScope check_8z6r2b_a0d0d(SModule checkedDotOperand) {
    if (null != checkedDotOperand) {
      return ((AbstractModule) checkedDotOperand).getScope();
    }
    return null;
  ...
  private static SModule check_8z6r2b_a0a3a3(SModel checkedDotOperand) {
    if (null != checkedDotOperand) {
      return checkedDotOperand.getModule();
    }
    return null;
  ...
  private static IScope check_8z6r2b_a0a06a21(SModule checkedDotOperand) {
    if (null != checkedDotOperand) {
      return ((AbstractModule) checkedDotOperand).getScope();
    }
    return null;
  ...
  private static SModule check_8z6r2b_a0a0ic0m(SModel checkedDotOperand) {
    if (null != checkedDotOperand) {
      return checkedDotOperand.getModule();
    }
    return null;
