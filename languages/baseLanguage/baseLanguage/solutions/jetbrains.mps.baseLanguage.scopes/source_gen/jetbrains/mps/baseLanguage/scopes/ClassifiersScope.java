...
public class ClassifiersScope extends FilteringScope {
  ...
  public SNode resolve(SNode contextNode, String refText) {
    ...
    if (targetModelReference != null && targetModelReference.getSModelId() != null) {
      targetModel = check_npo0wh_a0a0g0f(scope.getModelDescriptor(targetModelReference));
    }
  ...
  private static SModel check_npo0wh_a0a0g0f(SModelDescriptor checkedDotOperand) {
  ...
  private static IModule check_npo0wh_a0b0a0e0g(SModelDescriptor checkedDotOperand) {
    if (null != checkedDotOperand) {
  ...
  private static SModelDescriptor check_npo0wh_a0a1a0a4a6(SModel checkedDotOperand) {
    if (null != checkedDotOperand) {
  ...
  private static IModule check_npo0wh_a0b0a0e0g_0(SModelDescriptor checkedDotOperand) {
    if (null != checkedDotOperand) {
      return checkedDotOperand.getModule();
    }
    return null;
  ...
  private static SModelDescriptor check_npo0wh_a0a1a0a4a6_0(SModel checkedDotOperand) {
    if (null != checkedDotOperand) {
      return checkedDotOperand.getModelDescriptor();
    }
    return null;
