...
public class MigrationScopes {
  ...
  public static Scope forVariables(SAbstractConcept declarationConcept, SNode contextNode, String contextRole, int position) {
  ...
  public static Scope forMethods(SAbstractConcept declarationConcept, SNode contextNode, String contextRole, int position) {
