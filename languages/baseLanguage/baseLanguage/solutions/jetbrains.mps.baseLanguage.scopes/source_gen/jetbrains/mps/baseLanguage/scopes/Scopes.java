...
public class Scopes {
  ...
  public static Scope forVariables(SNode kind, Scope variablesScope, @Nullable Scope parentScope) {
    ...
    return new HidingByNameScope(MetaAdapterFactory.getInterfaceConcept(0xf3061a5392264cc5L, 0xa443f952ceaf5816L, 0x4b64b50fb2fc7720L, "jetbrains.mps.baseLanguage.structure.IVariableDeclaration"), MetaAdapterByDeclaration.getConcept(kind), variablesScope, parentScope);
  }
  @Deprecated
  @ToRemove(version = 3.3)
  ...
  public static Scope forMethods(SNode kind, Scope methodsScope, @Nullable Scope parentScope) {
    ...
    return new HidingByNameScope(MetaAdapterFactory.getConcept(0xf3061a5392264cc5L, 0xa443f952ceaf5816L, 0xf8cc56b1fcL, "jetbrains.mps.baseLanguage.structure.BaseMethodDeclaration"), MetaAdapterByDeclaration.getConcept(kind), methodsScope, parentScope);
  }
  @Deprecated
  @ToRemove(version = 3.3)
  public static Scope defaultWithNameHiding(SNode kind, Scope scope, @Nullable Scope parentScope) {
    ...
    return new HidingByNameScope(MetaAdapterFactory.getInterfaceConcept(0xceab519525ea4f22L, 0x9b92103b95ca8c0cL, 0x110396eaaa4L, "jetbrains.mps.lang.core.structure.INamedConcept"), MetaAdapterByDeclaration.getConcept(kind), scope, parentScope);
  }
