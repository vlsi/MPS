...
/*package*/ class ExtractMethodWithOutputVariable extends ExtractMethodFromStatementsRefactoring {
    ...
    ModelAccess.instance().runWriteActionInCommand(new Runnable() {
      public void run() {
        ...
        if ((ExtractMethodWithOutputVariable.this.myDeclarationStatement != null)) {
          ...
          SLinkOperations.setTarget(newStatement, "expression", new ExtractMethodWithOutputVariable.QuotationClass_n3576q_a2a1a0c0a0a0a2().createNode(ExtractMethodWithOutputVariable.this.myOutputVariable, methodCall), true);
  ...
  public static class QuotationClass_n3576q_a2a1a0c0a0a0a2 {
    public QuotationClass_n3576q_a2a1a0c0a0a0a2() {
    }
