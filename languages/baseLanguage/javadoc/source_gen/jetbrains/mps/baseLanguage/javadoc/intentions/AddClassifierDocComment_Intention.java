...
public class AddClassifierDocComment_Intention implements IntentionFactory {
  ...
  public class IntentionImplementation implements IntentionExecutable {
    ...
    public void execute(final SNode node, final EditorContext editorContext) {
      ...
      for (SNode typeVariableDeclaration : ListSequence.fromList(SLinkOperations.getTargets(node, "typeVariableDeclaration", true))) {
        ...
        SLinkOperations.setTarget(paramTag, "parameter", new AddClassifierDocComment_Intention.QuotationClass_nmk0m3_a2a1a5a1a().createNode(typeVariableDeclaration), true);
  ...
  public static class QuotationClass_nmk0m3_a2a1a5a1a {
    public QuotationClass_nmk0m3_a2a1a5a1a() {
    }
