...
public class AddMethodDocComment_Intention extends BaseIntention {
  ...
  public SNodeReference getIntentionNodeReference() {
    return new SNodePointer("r:2167abe7-3634-479b-a698-2bff67ab958a(jetbrains.mps.baseLanguage.javadoc.intentions@2_0)", "3196018662491292781");
  }
  ...
  public void execute(final SNode node, final EditorContext editorContext) {
    ...
    for (SNode parameterDeclaration : ListSequence.fromList(SLinkOperations.getTargets(node, "parameter", true))) {
      ...
      SLinkOperations.setTarget(paramTag, "parameter", new AddMethodDocComment_Intention.QuotationClass_en9z97_a2a1a4a8().createNode(parameterDeclaration), true);
    ...
    for (SNode typeVariableDeclaration : ListSequence.fromList(SLinkOperations.getTargets(node, "typeVariableDeclaration", true))) {
      SNode paramTag = SNodeFactoryOperations.createNewNode("jetbrains.mps.baseLanguage.javadoc.structure.ParameterBlockDocTag", null);
      SLinkOperations.setTarget(paramTag, "parameter", new AddMethodDocComment_Intention.QuotationClass_en9z97_a2a1a7a8().createNode(typeVariableDeclaration), true);
      ListSequence.fromList(SLinkOperations.getTargets(AttributeOperations.getAttribute(node, new IAttributeDescriptor.NodeAttribute(SConceptOperations.findConceptDeclaration("jetbrains.mps.baseLanguage.javadoc.structure.MethodDocComment"))), "param", true)).addElement(paramTag);
    }
  ...
  public static class QuotationClass_en9z97_a2a1a4a8 {
    public QuotationClass_en9z97_a2a1a4a8() {
    }
  ...
  public static class QuotationClass_en9z97_a2a1a7a8 {
    public QuotationClass_en9z97_a2a1a7a8() {
    }
