...
public class ClassifierDocComment_Editor extends DefaultNodeEditor {
  ...
  private static boolean renderingCondition_q2jz9e_a4a(SNode node, EditorContext editorContext) {
    return !(BaseDocComment__BehaviorDescriptor.isTagSectionEmpty_id7lVCwDcz6WN.invoke(node));
  }
  ...
  private static boolean renderingCondition_q2jz9e_a5e0(SNode node, EditorContext editorContext) {
    return ListSequence.fromList(SLinkOperations.getChildren(node, MetaAdapterFactory.getContainmentLink(0xf280165065d5424eL, 0xbb1b463a8781b786L, 0x1cb65d9fe66a764cL, 0x1cb65d9fe66a764eL, "param"))).isNotEmpty();
  }
  ...
  private static boolean renderingCondition_q2jz9e_a6e0(SNode node, EditorContext editorContext) {
    return IDeprecatable__BehaviorDescriptor.isDeprecated_idhOwoPtR.invoke(SNodeOperations.cast(SNodeOperations.getParent(node), MetaAdapterFactory.getInterfaceConcept(0xf3061a5392264cc5L, 0xa443f952ceaf5816L, 0x11d2ea8a339L, "jetbrains.mps.baseLanguage.structure.IBLDeprecatable")));
  }
  ...
  private static boolean _StyleParameter_QueryFunction_q2jz9e_a1f0(EditorContext editorContext, SNode node) {
    return BaseDocComment__BehaviorDescriptor.hasTags_id4iGwz$GSfd_.invoke(node) || !(BaseDocComment__BehaviorDescriptor.isTagSectionEmpty_id7lVCwDcz6WN.invoke(node));
  }
