      ...
      if (caretPosition == 0) {
        ...
        if (isFirstPart) {
          if (isFirstLine) {
            ...
            CommentLine__BehaviorDescriptor.tryMergeToRight_idooaTF_3fF3.invoke(prevLine, index);
        ...
        if (isNotEmptyString(selectedCell.getSelectedText())) {
          ...
          if (isLastPart) {
            if (isLastLine) {
              ...
              CommentLine__BehaviorDescriptor.tryMergeToRight_idooaTF_3fF3.invoke(curLine, index);
