...
<language namespace="jetbrains.mps.baseLanguage.doubleDispatch" uuid="7db4447f-913e-4b81-bd75-c9a473319ac6" languageVersion="0" moduleVersion="0">
  ...
  <accessoryModels />
  <generators>
    <generator alias="main" namespace="jetbrains.mps.baseLanguage.doubleDispatch#4496691318496554192" uuid="ee235186-b3b4-4b1e-ada8-109db9fa8810" reflective-queries="false">
      <models>
        <modelRoot contentPath="${module}" type="default">
