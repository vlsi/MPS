...
/*package*/ class NamedTupleType_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createCollection_2ojjgh_a() {
    ...
    if (renderingCondition_2ojjgh_a0a(myNode, getEditorContext())) {
      editorCell.addEditorCell(createCollection_2ojjgh_a0());
    }
    if (renderingCondition_2ojjgh_a1a(myNode, getEditorContext())) {
      editorCell.addEditorCell(createCollection_2ojjgh_b0());
    }
    if (renderingCondition_2ojjgh_a2a(myNode, getEditorContext())) {
  ...
  private EditorCell createReadOnlyModelAccessor_2ojjgh_a0a() {
    EditorCell_Property editorCell = EditorCell_Property.create(getEditorContext(), new ModelAccessor() {
      public String getText() {
        return (String) NamedTupleType__BehaviorDescriptor.getLeftBracket_id1653mnvAgn0.invoke(SNodeOperations.asSConcept(SNodeOperations.getConceptDeclaration(myNode)));
      }
  ...
  private EditorCell createReadOnlyModelAccessor_2ojjgh_c0a() {
    EditorCell_Property editorCell = EditorCell_Property.create(getEditorContext(), new ModelAccessor() {
      public String getText() {
        return (String) NamedTupleType__BehaviorDescriptor.getRightBracket_id1653mnvAgq6.invoke(SNodeOperations.asSConcept(SNodeOperations.getConceptDeclaration(myNode)));
      }
      public void setText(String s) {
      }
      public boolean isValidText(String s) {
  ...
  private class parameterTypeListHandler_2ojjgh_b2a extends RefNodeListHandler {
