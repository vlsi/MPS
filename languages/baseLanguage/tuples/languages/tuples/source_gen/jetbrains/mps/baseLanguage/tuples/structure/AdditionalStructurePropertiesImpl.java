...
public class AdditionalStructurePropertiesImpl extends ConceptPresentationAspectBase {
  ...
  private final ConceptPresentation props_NamedTupleDeclaration = new ConceptPresentationBuilder().icon("namedTuple.png", AdditionalStructurePropertiesImpl.class).create();
