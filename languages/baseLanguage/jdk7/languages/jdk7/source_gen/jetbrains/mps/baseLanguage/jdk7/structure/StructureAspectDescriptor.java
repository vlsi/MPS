...
public class StructureAspectDescriptor implements BaseStructureAspectDescriptor {
  ...
  public StructureAspectDescriptor() {
    myFqNameToConcept.put("jetbrains.mps.baseLanguage.jdk7.structure.StringSwitchStatement", null);
  }
  ...
  private ConceptDescriptor initLazy(String conceptFqName) {
    ...
    switch (Arrays.binarySearch(stringSwitchCases_1htk8d_a0d0i, conceptFqName)) {
      case 0:
        conceptDescriptor = new ConceptDescriptorBuilder("jetbrains.mps.baseLanguage.jdk7.structure.StringSwitchStatement").super_("jetbrains.mps.baseLanguage.structure.SwitchStatement").parents("jetbrains.mps.baseLanguage.structure.SwitchStatement").alias("switch", "").staticScope(StaticScope.NONE).create();
        break;
      default:
  ...
  private static String[] stringSwitchCases_1htk8d_a0d0i = new String[]{"jetbrains.mps.baseLanguage.jdk7.structure.StringSwitchStatement"};
}
