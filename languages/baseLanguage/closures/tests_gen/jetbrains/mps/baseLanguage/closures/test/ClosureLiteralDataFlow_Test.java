...
@MPSLaunch
public class ClosureLiteralDataFlow_Test extends BaseTransformationTest4 {
  @Test
  public void test_ClosureLiteralDataFlow() throws Throwable {
    this.initTest("${mps_home}", "r:3d6db45f-d7e0-45ba-9835-ff824ffe21a1(jetbrains.mps.baseLanguage.closures.test)");
