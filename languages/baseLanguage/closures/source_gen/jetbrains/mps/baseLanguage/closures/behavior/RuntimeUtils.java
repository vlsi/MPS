...
public class RuntimeUtils {
  ...
  private static SNode _quotation_createNode_hadnfw_a0a0a3() {
    ...
    quotedNode_1.setReference("classifier", SReference.create("classifier", quotedNode_1, SModelReference.fromString("f:java_stub#4c6a28d1-2c60-478d-b36e-db9b3cbb21fb#jetbrains.mps.baseLanguage.closures.runtime(closures.runtime/jetbrains.mps.baseLanguage.closures.runtime@java_stub)"), jetbrains.mps.smodel.SNodeId.fromString("~_UnrestrictedClosures")));
    return quotedNode_1;
  }
  ...
  private static SNode _quotation_createNode_hadnfw_a0a0a4() {
    SNode quotedNode_1 = null;
    quotedNode_1 = SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.baseLanguage.structure.ClassifierType", null, null, GlobalScope.getInstance(), false);
    quotedNode_1.setReference("classifier", SReference.create("classifier", quotedNode_1, SModelReference.fromString("r:35e808a0-0758-4b03-9053-4675a7ced44c(jetbrains.mps.baseLanguage.closures.runtime)"), jetbrains.mps.smodel.SNodeId.fromString("5571879668402581510")));
    return quotedNode_1;
  }
}
