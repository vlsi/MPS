...
public final class ClosureLiteral__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<String> getFunctionInterfaceName_idhEwI$6K = new SMethodBuilder<String>(new SJavaCompoundTypeImpl(String.class)).name("getFunctionInterfaceName").modifiers(SModifiersImpl.create(0, AccessPrivileges.PUBLIC)).concept(CONCEPT).id("hEwI$6K").registry(REGISTRY).build(SParameterImpl.fromList(SJavaCompoundTypeImpl.fromClasses()));
  public static final SMethod<SNode> getType_idhTgUC0Q = new SMethodBuilder<SNode>(new SJavaCompoundTypeImpl((Class<SNode>) ((Class) Object.class))).name("getType").modifiers(SModifiersImpl.create(8, AccessPrivileges.PUBLIC)).concept(CONCEPT).id("hTgUC0Q").registry(REGISTRY).build(SParameterImpl.fromList(SJavaCompoundTypeImpl.fromClasses((Class<List<SNode>>) ((Class) Object.class), (Class<SNode>) ((Class) Object.class), (Class<SNode>) ((Class) Object.class), (Class<SNode>) ((Class) Object.class), (Class<List<SNode>>) ((Class) Object.class))));
  public static final SMethod<Boolean> isStatementListCompactable_idi0zvp2S = new SMethodBuilder<Boolean>(new SJavaCompoundTypeImpl(Boolean.TYPE)).name("isStatementListCompactable").modifiers(SModifiersImpl.create(8, AccessPrivileges.PUBLIC)).concept(CONCEPT).id("i0zvp2S").registry(REGISTRY).build(SParameterImpl.fromList(SJavaCompoundTypeImpl.fromClasses()));
  ...
  public static final SMethod<Boolean> implicitThrows_id4kX30tnJ9kz = new SMethodBuilder<Boolean>(new SJavaCompoundTypeImpl(Boolean.TYPE)).name("implicitThrows").modifiers(SModifiersImpl.create(8, AccessPrivileges.PUBLIC)).concept(CONCEPT).id("4kX30tnJ9kz").registry(REGISTRY).build(SParameterImpl.fromList(SJavaCompoundTypeImpl.fromClasses()));
  public static final SMethod<Boolean> isClosure_id2P5W1FWMZPJ = new SMethodBuilder<Boolean>(new SJavaCompoundTypeImpl(Boolean.TYPE)).name("isClosure").modifiers(SModifiersImpl.create(8, AccessPrivileges.PUBLIC)).concept(CONCEPT).id("2P5W1FWMZPJ").registry(REGISTRY).build(SParameterImpl.fromList(SJavaCompoundTypeImpl.fromClasses()));
  ...
  private static String getFunctionInterfaceName_idhEwI$6K(@NotNull SNode __thisNode__) {
    return "_function_" + ((SNode) __thisNode__).getNodeId().toString();
  }
  private static SNode getType_idhTgUC0Q(@NotNull SNode __thisNode__, List<SNode> paramTypes, SNode resultType, SNode returnType, SNode termType, List<SNode> throwsTypes) {
    return _quotation_createNode_l77foe_a0a2(paramTypes, resultType, throwsTypes);
  }
  private static Boolean isStatementListCompactable_idi0zvp2S(@NotNull SNode __thisNode__) {
  ...
  private static Boolean implicitThrows_id4kX30tnJ9kz(@NotNull SNode __thisNode__) {
    return true;
  }
  private static Boolean isClosure_id2P5W1FWMZPJ(@NotNull SNode __thisNode__) {
    return true;
  }
  ...
  protected <T> T invokeSpecial0(@NotNull SNode node, @NotNull SMethod<T> method, @NotNull Object[] parameters) {
    ...
    switch (methodIndex) {
      ...
      case 1:
        return (T) getFunctionInterfaceName_idhEwI$6K(node);
      case 2:
        return (T) getType_idhTgUC0Q(node, (List<SNode>) parameters[0], (SNode) parameters[1], (SNode) parameters[2], (SNode) parameters[3], (List<SNode>) parameters[4]);
      case 3:
        return (T) isStatementListCompactable_idi0zvp2S(node);
      case 4:
      ...
      case 7:
        return (T) implicitThrows_id4kX30tnJ9kz(node);
      case 8:
        return (T) isClosure_id2P5W1FWMZPJ(node);
      case 9:
