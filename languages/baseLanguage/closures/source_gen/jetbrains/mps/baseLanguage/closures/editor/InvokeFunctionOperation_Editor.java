...
public class InvokeFunctionOperation_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createRefNodeList_9wclje_c0(EditorContext editorContext, SNode node) {
    ...
    if (renderingCondition_9wclje_a2a(node, editorContext)) {
  ...
  private static class parameterListHandler_9wclje_c0 extends RefNodeListHandler {
    ...
    public EditorCell createEmptyCell(EditorContext editorContext) {
      ...
      editorContext.getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(parameterListHandler_9wclje_c0.this.getOwner(), MetaAdapterFactory.getContainmentLink(0xfd3920347849419dL, 0x907112563d152375L, 0x11d67349093L, 0x11d67375fccL, "parameter")));
      try {
    ...
    public void installElementCellActions(SNode listOwner, SNode elementNode, EditorCell elementCell, EditorContext editorContext) {
      if (elementCell.getUserObject(AbstractCellListHandler.ELEMENT_CELL_ACTIONS_SET) == null) {
        ...
        if (elementCell.getSubstituteInfo() == null || elementCell.getSubstituteInfo() instanceof DefaultSubstituteInfo) {
          elementCell.setSubstituteInfo(new OldNewCompositeSubstituteInfo(myEditorContext, new SChildSubstituteInfo(elementCell, myOwnerNode, MetaAdapterFactory.getContainmentLink(0xfd3920347849419dL, 0x907112563d152375L, 0x11d67349093L, 0x11d67375fccL, "parameter"), elementNode), new DefaultChildSubstituteInfo(myOwnerNode, elementNode, super.getLinkDeclaration(), myEditorContext)));
        }
      }
    }
    @Override
  ...
  private EditorCell createConstant_9wclje_d0(EditorContext editorContext, SNode node) {
    ...
    editorCell.getStyle().putAll(style);
    if (renderingCondition_9wclje_a3a(node, editorContext)) {
