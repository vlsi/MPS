...
public class ClosureLiteralUtil {
  ...
  public static SNode fillParams(SNode targetIfaceErase, SNode funType) {
    ...
    SNode meth = Sequence.fromIterable(Classifier_Behavior.call_methods_5292274854859311639(SLinkOperations.getTarget(targetIfaceErase, MetaAdapterFactory.getReferenceLink(0xf3061a5392264cc5L, 0xa443f952ceaf5816L, 0x101de48bf9eL, 0x101de490babL, "classifier")))).first();
    if ((meth == null)) {
      return null;
    }
