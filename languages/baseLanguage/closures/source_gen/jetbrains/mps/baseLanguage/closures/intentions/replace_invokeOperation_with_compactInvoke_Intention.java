...
public class replace_invokeOperation_with_compactInvoke_Intention extends BaseIntention {
  ...
  public SNodeReference getIntentionNodeReference() {
    return new SNodePointer("r:539733f4-9063-4002-b53b-67e3c92dcc39(jetbrains.mps.baseLanguage.closures.intentions@2_0)", "1235748072133");
  }
  ...
  public void execute(final SNode node, final EditorContext editorContext) {
    ...
    SNodeOperations.replaceWithAnother(parent, new replace_invokeOperation_with_compactInvoke_Intention.QuotationClass_fknil1_a1a1a01().createNode(SLinkOperations.getTargets(SNodeOperations.cast(SLinkOperations.getTarget(parent, "operation", true), "jetbrains.mps.baseLanguage.closures.structure.InvokeFunctionOperation"), "parameter", true), SLinkOperations.getTarget(parent, "operand", true)));
  }

  public static class QuotationClass_fknil1_a1a1a01 {
    public QuotationClass_fknil1_a1a1a01() {
    }
