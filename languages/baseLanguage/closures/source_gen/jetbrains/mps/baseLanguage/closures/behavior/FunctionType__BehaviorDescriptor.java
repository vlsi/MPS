...
public final class FunctionType_BehaviorDescriptor extends BaseBHDescriptor {
  ...
  private static String getPresentation_idhEwIMiw(@NotNull SNode __thisNode__) {
    ...
    sb.append("=>").append(BaseConcept_BehaviorDescriptor.getPresentation_idhEwIMiw.invoke(SLinkOperations.getTarget(__thisNode__, MetaAdapterFactory.getContainmentLink(0xfd3920347849419dL, 0x907112563d152375L, 0x1174a4d19ffL, 0x1174a4d5371L, "resultType"))));
  ...
  private static SNode getResultType_idhTY4wo3(@NotNull SNode __thisNode__) {
    ...
    rt = FunctionType_BehaviorDescriptor.unmeet_idi0lWwAi.invoke(__thisNode__, SNodeOperations.copyNode(rt));
...
with_throws:
  ...
  protected static Logger LOG = LogManager.getLogger(FunctionType_BehaviorDescriptor.class);
