...
/*package*/ class ClosureControlStatement_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createCollection_2saq3j_a() {
    ...
    if (renderingCondition_2saq3j_a1a(myNode, getEditorContext())) {
  ...
  private EditorCell createCollection_2saq3j_b0() {
    ...
    if (renderingCondition_2saq3j_a2b0(myNode, getEditorContext())) {
  ...
  /*package*/ static class Inline_Builder_2saq3j_a1b0 extends AbstractEditorBuilder {
    ...
    private class parameterListHandler_2saq3j_a0a1b0 extends RefNodeListHandler {
  ...
  private EditorCell createCollection_2saq3j_c1a() {
    ...
    style.set(StyleAttributes.SELECTABLE, false);
    editorCell.getStyle().putAll(style);
    if (renderingCondition_2saq3j_a0c1a(myNode, getEditorContext())) {
  ...
  private class actualParameterListHandler_2saq3j_b2b0 extends RefNodeListHandler {
  ...
  private class controlClosureSingleRoleHandler_2saq3j_d0 extends SingleRoleCellProvider {
    ...
    private void installCellInfo(SNode child, EditorCell editorCell) {
      if (editorCell.getSubstituteInfo() == null || editorCell.getSubstituteInfo() instanceof DefaultSubstituteInfo) {
        editorCell.setSubstituteInfo(new OldNewCompositeSubstituteInfo(getEditorContext(), new SChildSubstituteInfo(editorCell, getNode(), MetaAdapterFactory.getContainmentLink(0xfd3920347849419dL, 0x907112563d152375L, 0x11e49cfed99L, 0x11ef552e307L, "controlClosure"), child), new DefaultChildSubstituteInfo(getNode(), myContainmentLink.getDeclarationNode(), getEditorContext())));
      }
      if (editorCell.getRole() == null) {
        editorCell.setRole("controlClosure");
      }
