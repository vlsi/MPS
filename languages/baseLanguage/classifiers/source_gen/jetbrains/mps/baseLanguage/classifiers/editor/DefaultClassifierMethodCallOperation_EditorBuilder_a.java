...
/*package*/ class DefaultClassifierMethodCallOperation_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createRefCell_c9gv4j_a0() {
    CellProviderWithRole provider = new RefCellCellProvider(myNode, getEditorContext()) {
      ...
      protected InlineCellProvider createInlineCellProvider(SNode innerCellNode) {
        return new DefaultClassifierMethodCallOperation_EditorBuilder_a._Inline_c9gv4j_a0a(innerCellNode, myNode);
      }
    };
  ...
  public static class _Inline_c9gv4j_a0a extends InlineCellProvider {
    public _Inline_c9gv4j_a0a(SNode node, SNode refNode) {
      super(node, refNode);
    }
