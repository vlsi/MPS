...
public class DefaultClassifierMethodCallOperation_Editor extends DefaultNodeEditor {
  ...
  private static class actualArgumentListHandler_c9gv4j_c0 extends RefNodeListHandler {
    ...
    public EditorCell createEmptyCell(EditorContext editorContext) {
      editorContext.getCellFactory().pushCellContext();
      editorContext.getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(actualArgumentListHandler_c9gv4j_c0.this.getOwner(), MetaAdapterFactory.getContainmentLink(0x443f4c36fcf54eb6L, 0x95008d06ed259e3eL, 0x118bd711e29L, 0x118bd877799L, "actualArgument")));
      try {
