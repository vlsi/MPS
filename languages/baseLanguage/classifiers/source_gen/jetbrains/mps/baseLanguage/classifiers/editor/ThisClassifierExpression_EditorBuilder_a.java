...
/*package*/ class ThisClassifierExpression_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public ThisClassifierExpression_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  /*package*/ EditorCell createCell() {
    return createAlternation_kpqhey_a();
  }
  ...
  private EditorCell createAlternation_kpqhey_a() {
    ...
    if (alternationCondition) {
      ...
      editorCell = createConstant_kpqhey_a0();
    }
  ...
  private EditorCell createCollection_kpqhey_a0() {
    ...
    editorCell.addEditorCell(createRefCell_kpqhey_a0a());
    editorCell.addEditorCell(createConstant_kpqhey_b0a());
    editorCell.addEditorCell(createConstant_kpqhey_c0a());
    return editorCell;
  }
  private EditorCell createRefCell_kpqhey_a0a() {
    CellProviderWithRole provider = new RefCellCellProvider(myNode, getEditorContext()) {
      @Override
      protected InlineCellProvider createInlineCellProvider(SNode innerCellNode) {
        return new ThisClassifierExpression_EditorBuilder_a._Inline_kpqhey_a0a0(innerCellNode, myNode);
      }
    };
  ...
  public static class _Inline_kpqhey_a0a0 extends InlineCellProvider {
    public _Inline_kpqhey_a0a0(SNode node, SNode refNode) {
      super(node, refNode);
    }
    ...
    public EditorCell createEditorCell(EditorContext editorContext, SNode node) {
      ...
      return new ThisClassifierExpression_EditorBuilder_a.Inline_Builder_kpqhey_a0a0(editorContext, getRefNode(), node).createCell();
    }
  }
  /*package*/ static class Inline_Builder_kpqhey_a0a0 extends AbstractEditorBuilder {
    @NotNull
    private SNode myNode;
    private SNode myReferencingNode;

    /*package*/ Inline_Builder_kpqhey_a0a0(@NotNull EditorContext context, SNode referencingNode, @NotNull SNode node) {
      super(context);
    ...
    /*package*/ EditorCell createCell() {
      return createProperty_kpqhey_a0a0a();
    }
    ...
    private EditorCell createProperty_kpqhey_a0a0a() {
  ...
  private EditorCell createConstant_kpqhey_b0a() {
  ...
  private EditorCell createConstant_kpqhey_c0a() {
  ...
  private EditorCell createConstant_kpqhey_a0() {
    EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, "this");
