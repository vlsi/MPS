...
public class typeof_ThisClassifierExpresson_InferenceRule extends AbstractInferenceRule_Runtime implements InferenceRule_Runtime {
  ...
  public void applyRule(final SNode nodeToCheck, final TypeCheckingContext typeCheckingContext, IsApplicableStatus status) {
    SNode classifier = ThisClassifierExpression__BehaviorDescriptor.getClassifier_idhEwJeDN.invoke(nodeToCheck);
    if (classifier != null) {
      {
        ...
        typeCheckingContext.createEquation((SNode) typeCheckingContext.typeOf(_nodeToCheck_1029348928467, "r:00000000-0000-4000-0000-011c89590371(jetbrains.mps.baseLanguage.classifiers.typesystem)", "1205753197519", true), (SNode) IClassifier__BehaviorDescriptor.createType_idhEwJimy.invoke(classifier), _info_12389875345);
      }
    } else {
      {
