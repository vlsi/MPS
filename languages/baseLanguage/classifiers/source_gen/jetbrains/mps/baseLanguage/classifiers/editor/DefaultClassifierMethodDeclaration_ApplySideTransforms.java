...
public class DefaultClassifierMethodDeclaration_ApplySideTransforms extends TransformationMenuBase {
  ...
  protected List<MenuPart<TransformationMenuItem, TransformationMenuContext>> getParts(TransformationMenuContext _context) {
    ...
    if (ListSequence.fromListAndArray(new ArrayList<String>(), MenuLocations.LEFT_SIDE_TRANSFORM, MenuLocations.RIGHT_SIDE_TRANSFORM).contains(_context.getMenuLocation())) {
      result.add(new DefaultClassifierMethodDeclaration_ApplySideTransforms.TransformationMenuPart_IncludeMenu_tthcgy_a0());
      result.add(new DefaultClassifierMethodDeclaration_ApplySideTransforms.TransformationMenuPart_IncludeMenu_tthcgy_b0());
    }
    return result;
  }

  public class TransformationMenuPart_IncludeMenu_tthcgy_a0 extends IncludeTransformationMenuTransformationMenuPart {
    @Nullable
    @Override
  ...
  public class TransformationMenuPart_IncludeMenu_tthcgy_b0 extends IncludeTransformationMenuTransformationMenuPart {
    @Nullable
    @Override
    protected TransformationMenuLookup getMenuLookup(TransformationMenuContext _context) {
      final SNode node = _context.getNode();
