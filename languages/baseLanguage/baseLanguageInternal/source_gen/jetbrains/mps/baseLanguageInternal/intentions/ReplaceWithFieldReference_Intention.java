...
public class ReplaceWithFieldReference_Intention implements IntentionFactory {
  ...
  private static SNode _quotation_createNode_6kpc5h_a0a0a(Object parameter_1) {
    ...
    quotedNode_2.setReference("classifier", SReference.create("classifier", quotedNode_2, SModelReference.fromString("r:c8f09818-27d0-4e31-9cdf-dedd92fee7ef(jetbrains.mps.baseLanguage.closures.util)"), jetbrains.mps.smodel.SNodeId.fromString("1225980323340")));
