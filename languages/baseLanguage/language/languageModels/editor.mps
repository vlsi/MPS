...
<model name="jetbrains.mps.baseLanguage.editor">
            ...
            <node role="statement" type="jetbrains.mps.baseLanguage.ReturnStatement" id="1171628216019">
              <node role="expression" type="jetbrains.mps.baseLanguage.NotEqualsExpression" id="1171628234230">
                ...
                <node role="leftExpression" type="jetbrains.mps.bootstrap.smodelLanguage.SNodeOperationExpression" id="1171628226507">
                  ...
                  <node role="leftExpression" type="jetbrains.mps.bootstrap.editorLanguage.NodeCondition_FunctionParm_node" id="1171628225240" />
                </node>
              </node>
            </node>
          </node>
                ...
                <node role="expression" type="jetbrains.mps.baseLanguage.GreaterThanExpression" id="1165410808116">
                  ...
                  <node role="leftExpression" type="jetbrains.mps.bootstrap.smodelLanguage.SNodeOperationExpression" id="1165410808118">
                    <node role="leftExpression" type="jetbrains.mps.bootstrap.smodelLanguage.SNodeOperationExpression" id="1165410808119">
                      <node role="leftExpression" type="jetbrains.mps.bootstrap.editorLanguage.NodeCondition_FunctionParm_node" id="1165410808120" />
        ...
        <node role="statement" type="jetbrains.mps.baseLanguage.LocalVariableDeclarationStatement" id="1163710683368">
          <node role="localVariableDeclaration" type="jetbrains.mps.baseLanguage.LocalVariableDeclaration" id="1163710683369">
            ...
            <node role="initializer" type="jetbrains.mps.baseLanguage.StaticMethodCall" id="1170779577114">
              <link role="baseMethodDeclaration" extResolveInfo="20.static method ([Classifier]BaseAdapter).([StaticMethodDeclaration]toNodes((jetbrains.mps.baseLanguage.types.classifier/jetbrains.mps.baseLanguage.types.classifier [List])) : (jetbrains.mps.baseLanguage.types.classifier/jetbrains.mps.baseLanguage.types.classifier [List, &lt;jetbrains.mps.baseLanguage.types.classifier [Object]&gt;]))" />
              <link role="classConcept" extResolveInfo="20.[Classifier]BaseAdapter" />
  ...
  <node type="jetbrains.mps.bootstrap.editorLanguage.CellKeyMapDeclaration" id="1172011382536">
    <property name="everyModel" value="true" />
    <property name="name" value="StaticFieldReference_KeyMap" />
    <node role="item" type="jetbrains.mps.bootstrap.editorLanguage.CellKeyMapItem" id="1172011431415">
      <property name="showInPopup" value="true" />
      <property name="description" value="convert to local static field reference" />
      <node role="keystroke" type="jetbrains.mps.bootstrap.editorLanguage.CellKeyMapKeystroke" id="1172011431416">
        <property name="modifiers" value="alt" />
        <property name="keycode" value="VK_ENTER" />
      </node>
      <node role="executeFunction" type="jetbrains.mps.bootstrap.editorLanguage.CellKeyMap_ExecuteFunction" id="1172011431417">
        <node role="body" type="jetbrains.mps.baseLanguage.StatementList" id="1172011431418">
          <node role="statement" type="jetbrains.mps.baseLanguage.LocalVariableDeclarationStatement" id="1172011743391">
            <node role="localVariableDeclaration" type="jetbrains.mps.baseLanguage.LocalVariableDeclaration" id="1172011743392">
              <property name="name" value="staticFieldReference" />
              <node role="type" type="jetbrains.mps.bootstrap.smodelLanguage.SNodeType" id="1172011743393">
                <link role="concept" targetNodeId="17.1070533707846" />
              </node>
              <node role="initializer" type="jetbrains.mps.bootstrap.smodelLanguage.SNodeOperationExpression" id="1172011743394">
                <node role="leftExpression" type="jetbrains.mps.bootstrap.editorLanguage.CellKeyMap_FunctionParm_selectedNode" id="1172011743395" />
                <node role="nodeOperation" type="jetbrains.mps.bootstrap.smodelLanguage.Node_GetAncestorOperation" id="1172011743396">
                  <node role="parameter" type="jetbrains.mps.bootstrap.smodelLanguage.OperationParm_Inclusion" id="1172011743397" />
                  <node role="parameter" type="jetbrains.mps.bootstrap.smodelLanguage.OperationParm_Concept" id="1172011743398">
                    <link role="concept" targetNodeId="17.1070533707846" />
                  </node>
                </node>
              </node>
          ...
          <node role="statement" type="jetbrains.mps.baseLanguage.LocalVariableDeclarationStatement" id="1172011790796">
            <node role="localVariableDeclaration" type="jetbrains.mps.baseLanguage.LocalVariableDeclaration" id="1172011790797">
              <property name="name" value="localStaticFieldReference" />
              <node role="type" type="jetbrains.mps.bootstrap.smodelLanguage.SNodeType" id="1172011790799">
                <link role="concept" targetNodeId="17.1172008963197" />
              </node>
              <node role="initializer" type="jetbrains.mps.bootstrap.smodelLanguage.SNodeOperationExpression" id="1172011759075">
                <node role="leftExpression" type="jetbrains.mps.baseLanguage.LocalVariableReference" id="1172011757809">
                  <link role="variableDeclaration" targetNodeId="1172011743392" resolveInfo="staticFieldReference" />
                </node>
                <node role="nodeOperation" type="jetbrains.mps.bootstrap.smodelLanguage.Node_ReplaceWithNewOperation" id="1172011771983">
                  <link role="concept" targetNodeId="17.1172008963197" />
                </node>
              </node>
            </node>
          </node>
          <node role="statement" type="jetbrains.mps.baseLanguage.ExpressionStatement" id="1172011801582">
            <node role="expression" type="jetbrains.mps.bootstrap.smodelLanguage.SNodeOperationExpression" id="1172011816633">
              <node role="leftExpression" type="jetbrains.mps.bootstrap.smodelLanguage.SNodeOperationExpression" id="1172011802412">
                <node role="leftExpression" type="jetbrains.mps.baseLanguage.LocalVariableReference" id="1172011801583">
                  <link role="variableDeclaration" targetNodeId="1172011790797" resolveInfo="localStaticFieldReference" />
                </node>
                <node role="nodeOperation" type="jetbrains.mps.bootstrap.smodelLanguage.SLinkAccess" id="1172011815445">
                  <link role="link" targetNodeId="17.1172008963202" />
                </node>
              </node>
              <node role="nodeOperation" type="jetbrains.mps.bootstrap.smodelLanguage.Link_SetTargetOperation" id="1172011821900">
                <node role="parameter" type="jetbrains.mps.bootstrap.smodelLanguage.SNodeOperationExpression" id="1172011840043">
                  <node role="leftExpression" type="jetbrains.mps.baseLanguage.LocalVariableReference" id="1172011838277">
                    <link role="variableDeclaration" targetNodeId="1172011743392" resolveInfo="staticFieldReference" />
                  </node>
                  <node role="nodeOperation" type="jetbrains.mps.bootstrap.smodelLanguage.SLinkAccess" id="1172011845513">
                    <link role="link" targetNodeId="17.1070568178160" />
                  </node>
                </node>
              </node>
      ...
      <node role="isApplicableFunction" type="jetbrains.mps.bootstrap.editorLanguage.CellKeyMap_IsApplicableFunction" id="1172011477966">
        <node role="body" type="jetbrains.mps.baseLanguage.StatementList" id="1172011477967">
          <node role="statement" type="jetbrains.mps.baseLanguage.LocalVariableDeclarationStatement" id="1172011599928">
            <node role="localVariableDeclaration" type="jetbrains.mps.baseLanguage.LocalVariableDeclaration" id="1172011599929">
              <property name="name" value="staticFieldReference" />
              <node role="type" type="jetbrains.mps.bootstrap.smodelLanguage.SNodeType" id="1172011599931">
                <link role="concept" targetNodeId="17.1070533707846" />
              </node>
              <node role="initializer" type="jetbrains.mps.bootstrap.smodelLanguage.SNodeOperationExpression" id="1172011547938">
                <node role="leftExpression" type="jetbrains.mps.bootstrap.editorLanguage.CellKeyMap_FunctionParm_selectedNode" id="1172011546234" />
                <node role="nodeOperation" type="jetbrains.mps.bootstrap.smodelLanguage.Node_GetAncestorOperation" id="1172011550455">
                  <node role="parameter" type="jetbrains.mps.bootstrap.smodelLanguage.OperationParm_Inclusion" id="1172011583208" />
                  <node role="parameter" type="jetbrains.mps.bootstrap.smodelLanguage.OperationParm_Concept" id="1172011557425">
                    <link role="concept" targetNodeId="17.1070533707846" />
                  </node>
                </node>
              </node>
          ...
          <node role="statement" type="jetbrains.mps.baseLanguage.IfStatement" id="1172011622652">
            <node role="condition" type="jetbrains.mps.bootstrap.smodelLanguage.SNodeOperationExpression" id="1172011626031">
              <node role="leftExpression" type="jetbrains.mps.baseLanguage.LocalVariableReference" id="1172011624639">
                <link role="variableDeclaration" targetNodeId="1172011599929" resolveInfo="staticFieldReference" />
              </node>
              <node role="nodeOperation" type="jetbrains.mps.bootstrap.smodelLanguage.Node_IsNullOperation" id="1172011627891" />
            </node>
            <node role="ifTrue" type="jetbrains.mps.baseLanguage.StatementList" id="1172011622654">
              <node role="statement" type="jetbrains.mps.baseLanguage.ReturnStatement" id="1172011629767">
                <node role="expression" type="jetbrains.mps.baseLanguage.BooleanConstant" id="1172011631628" />
              </node>
            </node>
          </node>
          <node role="statement" type="jetbrains.mps.baseLanguage.LocalVariableDeclarationStatement" id="1172011664822">
            <node role="localVariableDeclaration" type="jetbrains.mps.baseLanguage.LocalVariableDeclaration" id="1172011664823">
              <property name="name" value="classifier1" />
              <node role="type" type="jetbrains.mps.bootstrap.smodelLanguage.SNodeType" id="1172011664825">
                <link role="concept" targetNodeId="17.1107461130800" />
              </node>
              <node role="initializer" type="jetbrains.mps.bootstrap.smodelLanguage.SNodeOperationExpression" id="1172011646210">
                <node role="leftExpression" type="jetbrains.mps.baseLanguage.LocalVariableReference" id="1172011645522">
                  <link role="variableDeclaration" targetNodeId="1172011599929" resolveInfo="staticFieldReference" />
                </node>
                <node role="nodeOperation" type="jetbrains.mps.bootstrap.smodelLanguage.SLinkAccess" id="1172011658430">
                  <link role="link" targetNodeId="17.1144433057691" />
                </node>
              </node>
            </node>
          </node>
          <node role="statement" type="jetbrains.mps.baseLanguage.LocalVariableDeclarationStatement" id="1172011696879">
            <node role="localVariableDeclaration" type="jetbrains.mps.baseLanguage.LocalVariableDeclaration" id="1172011696880">
              <property name="name" value="classifier2" />
              <node role="type" type="jetbrains.mps.bootstrap.smodelLanguage.SNodeType" id="1172011696882">
                <link role="concept" targetNodeId="17.1107461130800" />
              </node>
              <node role="initializer" type="jetbrains.mps.bootstrap.smodelLanguage.SNodeOperationExpression" id="1172011679563">
                <node role="leftExpression" type="jetbrains.mps.baseLanguage.LocalVariableReference" id="1172011677734">
                  <link role="variableDeclaration" targetNodeId="1172011599929" resolveInfo="staticFieldReference" />
                </node>
                <node role="nodeOperation" type="jetbrains.mps.bootstrap.smodelLanguage.Node_GetAncestorOperation" id="1172011680845">
                  <node role="parameter" type="jetbrains.mps.bootstrap.smodelLanguage.OperationParm_Concept" id="1172011686065">
                    <link role="concept" targetNodeId="17.1107461130800" />
                  </node>
                </node>
              </node>
          ...
          <node role="statement" type="jetbrains.mps.baseLanguage.ReturnStatement" id="1172011704181">
            <node role="expression" type="jetbrains.mps.baseLanguage.EqualsExpression" id="1172011708777">
              <node role="rightExpression" type="jetbrains.mps.baseLanguage.LocalVariableReference" id="1172011711015">
                <link role="variableDeclaration" targetNodeId="1172011696880" resolveInfo="classifier2" />
              </node>
              <node role="leftExpression" type="jetbrains.mps.baseLanguage.LocalVariableReference" id="1172011706167">
                <link role="variableDeclaration" targetNodeId="1172011664823" resolveInfo="classifier1" />
              </node>
            </node>
          </node>
        </node>
