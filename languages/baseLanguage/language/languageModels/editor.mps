              ...
              <node role="body" type="jetbrains.mps.baseLanguage.StatementList" id="1180617976062">
                ...
                <node role="statement" type="jetbrains.mps.baseLanguage.IfStatement" id="1180619149538">
                  <node role="ifTrue" type="jetbrains.mps.baseLanguage.StatementList" id="1180619149539">
                    ...
                    <node role="statement" type="jetbrains.mps.baseLanguage.IfStatement" id="1180619251604">
                      <node role="ifTrue" type="jetbrains.mps.baseLanguage.StatementList" id="1180619251605">
                        <node role="statement" type="jetbrains.mps.baseLanguage.ExpressionStatement" id="1180619365089">
                          <node role="expression" type="jetbrains.mps.baseLanguage.InstanceMethodCall" id="1180619371991">
                            <link role="baseMethodDeclaration" extResolveInfo="19.method ([Classifier]List).([InstanceMethodDeclaration]add((jetbrains.mps.baseLanguage.types.any/jetbrains.mps.baseLanguage.types.any)) : (jetbrains.mps.baseLanguage.types.boolean/jetbrains.mps.baseLanguage.types.boolean))" />
                            <node role="instance" type="jetbrains.mps.baseLanguage.LocalVariableReference" id="1180619365090">
                              <link role="variableDeclaration" targetNodeId="1180618054462" resolveInfo="result" />
                            </node>
                            <node role="actualArgument" type="jetbrains.mps.baseLanguage.InstanceMethodCall" id="1180619433664">
                              ...
                              <node role="instance" type="jetbrains.mps.baseLanguage.LocalVariableReference" id="1180619427065">
                                <link role="variableDeclaration" targetNodeId="1180619172329" resolveInfo="name" />
                              </node>
                              <node role="actualArgument" type="jetbrains.mps.baseLanguage.IntegerConstant" id="1180619439501">
                                <property name="value" value="0" />
                              </node>
                              <node role="actualArgument" type="jetbrains.mps.baseLanguage.IntegerConstant" id="1180619442450">
                      ...
                      <node role="condition" type="jetbrains.mps.bootstrap.smodelLanguage.SNodeOperationExpression" id="1180619259731">
                        <node role="nodeOperation" type="jetbrains.mps.bootstrap.smodelLanguage.Node_IsInstanceOfOperation" id="1180619262206">
                          <node role="conceptArgument" type="jetbrains.mps.bootstrap.smodelLanguage.RefConcept_Reference" id="1180619267336">
                            <link role="conceptDeclaration" targetNodeId="17.1164118113764" />
                          </node>
                        </node>
                        <node role="leftExpression" type="jetbrains.mps.baseLanguage.LocalVariableReference" id="1180619257804">
                          <link role="variableDeclaration" targetNodeId="1180619128044" resolveInfo="nodeType" />
                        </node>
                      </node>
                      <node role="ifFalseStatement" type="jetbrains.mps.baseLanguage.BlockStatement" id="1180620430798">
                        <node role="statements" type="jetbrains.mps.baseLanguage.StatementList" id="1180620430799">
                          <node role="statement" type="jetbrains.mps.baseLanguage.ExpressionStatement" id="1180620434835">
                            <node role="expression" type="jetbrains.mps.baseLanguage.InstanceMethodCall" id="1180620434836">
                              <link role="baseMethodDeclaration" extResolveInfo="19.method ([Classifier]List).([InstanceMethodDeclaration]add((jetbrains.mps.baseLanguage.types.any/jetbrains.mps.baseLanguage.types.any)) : (jetbrains.mps.baseLanguage.types.boolean/jetbrains.mps.baseLanguage.types.boolean))" />
                              <node role="instance" type="jetbrains.mps.baseLanguage.LocalVariableReference" id="1180620434837">
                                <link role="variableDeclaration" targetNodeId="1180618054462" resolveInfo="result" />
                              </node>
                              <node role="actualArgument" type="jetbrains.mps.baseLanguage.StaticMethodCall" id="1180620434838">
                                <link role="baseMethodDeclaration" extResolveInfo="52.static method ([Classifier]NameUtil).([StaticMethodDeclaration]toValidCamelIdentifier((jetbrains.mps.baseLanguage.types.classifier/jetbrains.mps.baseLanguage.types.classifier [String])) : (jetbrains.mps.baseLanguage.types.classifier/jetbrains.mps.baseLanguage.types.classifier [String]))" />
                                <link role="classConcept" extResolveInfo="52.[Classifier]NameUtil" />
                                <node role="actualArgument" type="jetbrains.mps.baseLanguage.LocalVariableReference" id="1180620434839">
                                  <link role="variableDeclaration" targetNodeId="1180619172329" resolveInfo="name" />
                                </node>
                              </node>
                            </node>
