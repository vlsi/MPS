...
<model name="jetbrains.mps.baseLanguage.constraints">
  ...
  <node type="jetbrains.mps.bootstrap.constraintsLanguage.ConceptBehavior" id="1178181704925">
    ...
    <node role="method" type="jetbrains.mps.bootstrap.constraintsLanguage.ConceptMethodDeclaration" id="1184949950947">
      ...
      <node role="body" type="jetbrains.mps.baseLanguage.StatementList" id="1184949950949">
        <node role="statement" type="jetbrains.mps.baseLanguage.LocalVariableDeclarationStatement" id="1184957983749">
          <node role="localVariableDeclaration" type="jetbrains.mps.baseLanguage.LocalVariableDeclaration" id="1184957983750">
            <property name="name" value="parameterTypes" />
            <node role="type" type="jetbrains.mps.baseLanguage.ArrayType" id="1184957983751">
              <node role="componentType" type="jetbrains.mps.baseLanguage.ClassifierType" id="1184957983752">
                <link role="classifier" extResolveInfo="13.[Classifier]Class" />
              </node>
            </node>
            <node role="initializer" type="jetbrains.mps.bootstrap.smodelLanguage.SNodeOperationExpression" id="1184957977901">
              <node role="nodeOperation" type="jetbrains.mps.bootstrap.smodelLanguage.Node_ConceptMethodCall" id="1184957979654">
                <link role="conceptMethodDeclaration" targetNodeId="1184950182063" resolveInfo="getParameterTypes" />
              </node>
              <node role="leftExpression" type="jetbrains.mps.bootstrap.constraintsLanguage.ThisNodeExpression" id="1184957977306" />
            </node>
          </node>
        </node>
        <node role="statement" type="jetbrains.mps.baseLanguage.LocalVariableDeclarationStatement" id="1184958791371">
          <node role="localVariableDeclaration" type="jetbrains.mps.baseLanguage.LocalVariableDeclaration" id="1184958791372">
            <property name="name" value="method" />
            <node role="type" type="jetbrains.mps.baseLanguage.ClassifierType" id="1184958791373">
              <link role="classifier" extResolveInfo="28.[Classifier]Method" />
            </node>
            <node role="initializer" type="jetbrains.mps.baseLanguage.StaticMethodCall" id="1184958771664">
              ...
              <node role="actualArgument" type="jetbrains.mps.bootstrap.smodelLanguage.SNodeOperationExpression" id="1184958775374">
                <node role="nodeOperation" type="jetbrains.mps.bootstrap.smodelLanguage.Node_GetParentOperation" id="1184958777799" />
                <node role="leftExpression" type="jetbrains.mps.bootstrap.constraintsLanguage.ThisNodeExpression" id="1184958774733" />
              </node>
              <node role="actualArgument" type="jetbrains.mps.bootstrap.smodelLanguage.SNodeOperationExpression" id="1184958784318">
                <node role="nodeOperation" type="jetbrains.mps.bootstrap.smodelLanguage.SPropertyAccess" id="1184958785290">
                  <link role="property" targetNodeId="1.1083152972672" />
                </node>
                <node role="leftExpression" type="jetbrains.mps.bootstrap.constraintsLanguage.ThisNodeExpression" id="1184958783645" />
              </node>
              <node role="actualArgument" type="jetbrains.mps.baseLanguage.LocalVariableReference" id="1184958788073">
                <link role="variableDeclaration" targetNodeId="1184957983750" resolveInfo="parameterTypes" />
              </node>
            </node>
          </node>
        </node>
        <node role="statement" type="jetbrains.mps.baseLanguage.ExpressionStatement" id="1184949950960">
          <node role="expression" type="jetbrains.mps.baseLanguage.InstanceMethodCall" id="1184949950961">
            <link role="baseMethodDeclaration" extResolveInfo="29.method ([Classifier]PrintStream).([InstanceMethodDeclaration]println((jetbrains.mps.baseLanguage.types.classifier/jetbrains.mps.baseLanguage.types.classifier [String])) : (jetbrains.mps.baseLanguage.types.void/jetbrains.mps.baseLanguage.types.void))" />
            <node role="instance" type="jetbrains.mps.baseLanguage.StaticFieldReference" id="1184949950962">
              <link role="classifier" extResolveInfo="13.[Classifier]System" />
              <link role="variableDeclaration" extResolveInfo="13.static field ([Classifier]System).([StaticFieldDeclaration]out : (jetbrains.mps.baseLanguage.types.classifier/jetbrains.mps.baseLanguage.types.classifier [PrintStream]))" />
            </node>
            <node role="actualArgument" type="jetbrains.mps.baseLanguage.LocalVariableReference" id="1184958796280">
              <link role="variableDeclaration" targetNodeId="1184958791372" resolveInfo="method" />
            </node>
          </node>
        </node>
        <node role="statement" type="jetbrains.mps.baseLanguage.ExpressionStatement" id="1184949950964">
          <node role="expression" type="jetbrains.mps.baseLanguage.NullLiteral" id="1184949950965" />
        </node>
      </node>
    </node>
    <node role="method" type="jetbrains.mps.bootstrap.constraintsLanguage.ConceptMethodDeclaration" id="1184950182063">
      ...
      <node role="body" type="jetbrains.mps.baseLanguage.StatementList" id="1184950182065">
        ...
        <node role="statement" type="jetbrains.mps.baseLanguage.LocalVariableDeclarationStatement" id="1184957472116">
          <node role="localVariableDeclaration" type="jetbrains.mps.baseLanguage.LocalVariableDeclaration" id="1184957472117">
            <property name="name" value="size" />
            <node role="type" type="jetbrains.mps.baseLanguage.IntegerType" id="1184957472118" />
            <node role="initializer" type="jetbrains.mps.baseLanguage.ext.collections.lang.SequenceOperationExpression" id="1184957060634">
            ...
            <node role="initializer" type="jetbrains.mps.baseLanguage.GenericNewExpression" id="1184950329403">
              <node role="creator" type="jetbrains.mps.baseLanguage.ArrayCreator" id="1184956933677">
                ...
                <node role="dimensionExpression" type="jetbrains.mps.baseLanguage.DimensionExpression" id="1184956933679">
                  <node role="expression" type="jetbrains.mps.baseLanguage.LocalVariableReference" id="1184957472119">
                    <link role="variableDeclaration" targetNodeId="1184957472117" resolveInfo="size" />
                  </node>
                </node>
              </node>
            </node>
        ...
        <node role="statement" type="jetbrains.mps.baseLanguage.ForStatement" id="1184957451183">
          <node role="variable" type="jetbrains.mps.baseLanguage.LocalVariableDeclaration" id="1184957451184">
            <property name="name" value="i" />
            <node role="type" type="jetbrains.mps.baseLanguage.IntegerType" id="1184957455140" />
            <node role="initializer" type="jetbrains.mps.baseLanguage.IntegerConstant" id="1184957460752">
              <property name="value" value="0" />
            </node>
          </node>
          <node role="body" type="jetbrains.mps.baseLanguage.StatementList" id="1184957451186">
            <node role="statement" type="jetbrains.mps.baseLanguage.ExpressionStatement" id="1184957500942">
              <node role="expression" type="jetbrains.mps.baseLanguage.AssignmentExpression" id="1184957506105">
                <node role="rValue" type="jetbrains.mps.bootstrap.smodelLanguage.SNodeOperationExpression" id="1184957828802">
                  <node role="nodeOperation" type="jetbrains.mps.bootstrap.smodelLanguage.Node_ConceptMethodCall" id="1184957830180">
                    <link role="conceptMethodDeclaration" targetNodeId="1184957630722" resolveInfo="getClass" />
                  </node>
                  <node role="leftExpression" type="jetbrains.mps.baseLanguage.ext.collections.lang.SequenceOperationExpression" id="1184957518062">
                    <node role="leftExpression" type="jetbrains.mps.baseLanguage.LocalVariableReference" id="1184957516326">
                      <link role="variableDeclaration" targetNodeId="1184957048475" resolveInfo="parameterDeclarations" />
                    </node>
                    <node role="operation" type="jetbrains.mps.baseLanguage.ext.collections.lang.GetElementOperation" id="1184957519078">
                      <node role="argument" type="jetbrains.mps.baseLanguage.LocalVariableReference" id="1184957523330">
                        <link role="variableDeclaration" targetNodeId="1184957451184" resolveInfo="i" />
                      </node>
                    </node>
                  </node>
                </node>
                <node role="lValue" type="jetbrains.mps.baseLanguage.ArrayAccessExpression" id="1184957501913">
                  <node role="index" type="jetbrains.mps.baseLanguage.LocalVariableReference" id="1184957503760">
                    <link role="variableDeclaration" targetNodeId="1184957451184" resolveInfo="i" />
                  </node>
                  <node role="array" type="jetbrains.mps.baseLanguage.LocalVariableReference" id="1184957500943">
          ...
          <node role="condition" type="jetbrains.mps.baseLanguage.LessThanExpression" id="1184957465972">
            <node role="rightExpression" type="jetbrains.mps.baseLanguage.LocalVariableReference" id="1184957475917">
              <link role="variableDeclaration" targetNodeId="1184957472117" resolveInfo="size" />
            </node>
            <node role="leftExpression" type="jetbrains.mps.baseLanguage.LocalVariableReference" id="1184957464003">
              <link role="variableDeclaration" targetNodeId="1184957451184" resolveInfo="i" />
            </node>
          </node>
          <node role="iteration" type="jetbrains.mps.baseLanguage.AssignmentExpression" id="1184957483684">
            <node role="rValue" type="jetbrains.mps.baseLanguage.PlusExpression" id="1184957487720">
              <node role="rightExpression" type="jetbrains.mps.baseLanguage.IntegerConstant" id="1184957488785">
                <property name="value" value="1" />
              </node>
              <node role="leftExpression" type="jetbrains.mps.baseLanguage.LocalVariableReference" id="1184957486000">
                <link role="variableDeclaration" targetNodeId="1184957451184" resolveInfo="i" />
              </node>
            </node>
            <node role="lValue" type="jetbrains.mps.baseLanguage.LocalVariableReference" id="1184957482230">
              <link role="variableDeclaration" targetNodeId="1184957451184" resolveInfo="i" />
            </node>
          </node>
        </node>
  ...
  <node type="jetbrains.mps.bootstrap.constraintsLanguage.ConceptBehavior" id="1178181704950">
    ...
    <node role="method" type="jetbrains.mps.bootstrap.constraintsLanguage.ConceptMethodDeclaration" id="1184957630722">
      <property name="name" value="getClass" />
      <node role="returnType" type="jetbrains.mps.baseLanguage.ClassifierType" id="1184957634288">
        <link role="classifier" extResolveInfo="13.[Classifier]Class" />
      </node>
      <node role="body" type="jetbrains.mps.baseLanguage.StatementList" id="1184957630724">
        <node role="statement" type="jetbrains.mps.baseLanguage.ExpressionStatement" id="1184957659054">
          <node role="expression" type="jetbrains.mps.baseLanguage.StaticMethodCall" id="1184957660541">
            <link role="classConcept" extResolveInfo="30.[Classifier]ReflectionUtil" />
            ...
            <node role="actualArgument" type="jetbrains.mps.bootstrap.smodelLanguage.SNodeOperationExpression" id="1184959516210">
              <node role="nodeOperation" type="jetbrains.mps.bootstrap.smodelLanguage.SLinkAccess" id="1184959516211">
                <link role="link" targetNodeId="1.1107535924139" />
              </node>
              <node role="leftExpression" type="jetbrains.mps.bootstrap.helgins.CoerceExpression" id="1184959516212">
                <node role="pattern" type="jetbrains.mps.bootstrap.helgins.ConceptReference" id="1184959516213">
                  <property name="name" value="classifierType" />
                  <link role="concept" targetNodeId="1.1107535904670" />
                </node>
                <node role="nodeToCoerce" type="jetbrains.mps.bootstrap.smodelLanguage.SNodeOperationExpression" id="1184959516214">
                  <node role="nodeOperation" type="jetbrains.mps.bootstrap.smodelLanguage.SLinkAccess" id="1184959516215">
                    <link role="link" targetNodeId="1.1068431790188" />
                  </node>
                  <node role="leftExpression" type="jetbrains.mps.bootstrap.constraintsLanguage.ThisNodeExpression" id="1184959516216" />
                </node>
              </node>
            </node>
          </node>
