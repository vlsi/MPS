...
<model name="jetbrains.mps.baseLanguage.structure">
  ...
  <node type="jetbrains.mps.bootstrap.structureLanguage.ConceptDeclaration" id="1068498886294">
    ...
    <node role="conceptProperty" type="jetbrains.mps.bootstrap.structureLanguage.StringConceptProperty"
          id="1107215415034">
  ...
  <node type="jetbrains.mps.bootstrap.structureLanguage.ConceptDeclaration" id="1068499141036">
    ...
    <link role="extends" targetNodeId="1068431790191"/>
    <node role="conceptProperty" type="jetbrains.mps.bootstrap.structureLanguage.BooleanConceptProperty"
          id="1137987266052">
  ...
  <node type="jetbrains.mps.bootstrap.structureLanguage.ConceptDeclaration" id="1068431790191">
    ...
    <node role="conceptPropertyDeclaration"
          type="jetbrains.mps.bootstrap.structureLanguage.BooleanConceptPropertyDeclaration" id="1146528679895">
  ...
  <node type="jetbrains.mps.bootstrap.structureLanguage.ConceptDeclaration" id="1068390468198">
    ...
    <node role="propertyDeclaration" type="jetbrains.mps.bootstrap.structureLanguage.PropertyDeclaration"
          id="1075300953594">
  ...
  <node type="jetbrains.mps.bootstrap.structureLanguage.ConceptDeclaration" id="1068580123152">
    ...
    <node role="conceptProperty" type="jetbrains.mps.bootstrap.structureLanguage.IntegerConceptProperty"
          id="1166618247261">
  ...
  <node type="jetbrains.mps.bootstrap.structureLanguage.ConceptDeclaration" id="1081773326031">
    ...
    <link role="extends" targetNodeId="1068431790191"/>
    <node role="conceptPropertyDeclaration"
          type="jetbrains.mps.bootstrap.structureLanguage.IntegerConceptPropertyDeclaration" id="1166617629900">
  ...
  <node type="jetbrains.mps.bootstrap.structureLanguage.ConceptDeclaration" id="1107135704075">
    ...
    <node role="conceptLinkDeclaration"
          type="jetbrains.mps.bootstrap.structureLanguage.AggregationConceptLinkDeclaration" id="1137545963098">
  ...
  <node type="jetbrains.mps.bootstrap.structureLanguage.ConceptDeclaration" id="1137021947720">
    ...
    <node role="conceptLinkDeclaration"
          type="jetbrains.mps.bootstrap.structureLanguage.AggregationConceptLinkDeclaration" id="1137545148427">
      <property name="name" value="conceptFunctionReturnType"/>
      <link role="targetType" targetNodeId="1068431790189"/>
    </node>
    <node role="conceptLinkDeclaration"
          type="jetbrains.mps.bootstrap.structureLanguage.AggregationConceptLinkDeclaration" id="1137546998352">
      <property name="name" value="conceptFunctionParameter"/>
      <link role="targetType" targetNodeId="37.1071489090640"/>
    </node>
    <node role="conceptLinkDeclaration" type="jetbrains.mps.bootstrap.structureLanguage.ReferenceConceptLinkDeclaration"
          id="1161119487665">
