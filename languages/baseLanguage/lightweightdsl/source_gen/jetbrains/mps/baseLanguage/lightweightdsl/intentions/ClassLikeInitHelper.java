...
public class ClassLikeInitHelper {
  public static void init(final SNode node, SNode descriptor, SModel futureModel) {
    ...
    Sequence.fromIterable(DSLDescriptor_BehaviorDescriptor.getClassLikeMembers_id2iCqkkxuhoj.invoke(descriptor)).visitAll(new IVisitor<SNode>() {
      public void visit(SNode it) {
        SNode newMember = DSLClassMember_BehaviorDescriptor.createForClass_id5BD$AU437jJ.invoke(it, node);
        if ((newMember == null)) {
          return;
        }
    ...
    DSLDescriptor_BehaviorDescriptor.initializeInstance_id2VRROcY8CaS.invoke(descriptor, node, futureModel);
  }
  ...
  public static void renew(final SNode node, SNode descriptor) {
    ...
    Sequence.fromIterable(DSLDescriptor_BehaviorDescriptor.getClassLikeMembers_id2iCqkkxuhoj.invoke(descriptor)).where(new IWhereFilter<SNode>() {
