...
public class PropertyDescriptor_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createCollection_ram8ac_a(EditorContext editorContext, SNode node) {
    ...
    editorCell.addEditorCell(this.createRefCell_ram8ac_d0(editorContext, node));
  ...
  private EditorCell createRefCell_ram8ac_d0(EditorContext editorContext, SNode node) {
  ...
  public static class _Inline_ram8ac_a3a extends InlineCellProvider {
    ...
    public EditorCell createEditorCell(EditorContext editorContext, SNode node) {
      return this.createProperty_ram8ac_a0d0(editorContext, node);
    }
    private EditorCell createProperty_ram8ac_a0d0(EditorContext editorContext, SNode node) {
      CellProviderWithRole provider = new PropertyCellProvider(node, editorContext);
      provider.setRole("name");
      provider.setNoTargetText("<no name>");
  ...
  private static class modifierListHandler_ram8ac_f0 extends RefNodeListHandler {
    ...
    public EditorCell createEmptyCell(EditorContext editorContext) {
      editorContext.getCellFactory().pushCellContext();
      editorContext.getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(modifierListHandler_ram8ac_f0.this.getOwner(), MetaAdapterFactory.getContainmentLink(0xc7d5b9dda05f4be2L, 0xbc73f2e16994cc67L, 0x72b255a0447fe4c7L, 0x2f38f33681e6c568L, "modifier")));
      try {
