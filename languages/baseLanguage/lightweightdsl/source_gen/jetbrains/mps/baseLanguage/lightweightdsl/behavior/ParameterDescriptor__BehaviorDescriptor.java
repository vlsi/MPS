...
public final class ParameterDescriptor_BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<SNode> create_id2h59CdJp99Y = new SMethodBuilder<SNode>(new SJavaCompoundTypeImpl((Class<SNode>) ((Class) Object.class))).name("create").modifiers(SModifiersImpl.create(0, AccessPrivileges.PUBLIC)).concept(CONCEPT).id("2h59CdJp99Y").registry(REGISTRY).build(SParameterImpl.fromList(SJavaCompoundTypeImpl.fromClasses((Class<SNode>) ((Class) Object.class))));
  public static final SMethod<Boolean> isNeeded_id7GXvAHO1j1d = new SMethodBuilder<Boolean>(new SJavaCompoundTypeImpl(Boolean.TYPE)).name("isNeeded").modifiers(SModifiersImpl.create(0, AccessPrivileges.PUBLIC)).concept(CONCEPT).id("7GXvAHO1j1d").registry(REGISTRY).build(SParameterImpl.fromList(SJavaCompoundTypeImpl.fromClasses((Class<SNode>) ((Class) Object.class))));
  public static final SMethod<String> getGeneratedMethodName_id7GXvAHO1heb = new SMethodBuilder<String>(new SJavaCompoundTypeImpl(String.class)).name("getGeneratedMethodName").modifiers(SModifiersImpl.create(0, AccessPrivileges.PUBLIC)).concept(CONCEPT).id("7GXvAHO1heb").registry(REGISTRY).build(SParameterImpl.fromList(SJavaCompoundTypeImpl.fromClasses()));
  ...
  private static SNode create_id2h59CdJp99Y(@NotNull SNode __thisNode__, SNode point) {
  ...
  private static Boolean isNeeded_id7GXvAHO1j1d(@NotNull SNode __thisNode__, SNode node) {
    try {
  ...
  private static String getGeneratedMethodName_id7GXvAHO1heb(@NotNull SNode __thisNode__) {
  ...
  /*package*/ ParameterDescriptor_BehaviorDescriptor() {
    super(REGISTRY);
  }
  ...
  protected <T> T invokeSpecial0(@NotNull SNode node, @NotNull SMethod<T> method, @NotNull Object[] parameters) {
    ...
    switch (methodIndex) {
      case 0:
        return (T) create_id2h59CdJp99Y(node, (SNode) parameters[0]);
      case 1:
        return (T) isNeeded_id7GXvAHO1j1d(node, (SNode) parameters[0]);
      case 2:
        return (T) getGeneratedMethodName_id7GXvAHO1heb(node);
      default:
        throw new BHMethodNotFoundException(this, method);
    }
  }
