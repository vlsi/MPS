...
<language namespace="jetbrains.mps.baseLanguage.lightweightdsl" uuid="c7d5b9dd-a05f-4be2-bc73-f2e16994cc67" languageVersion="1" moduleVersion="0">
  ...
  <accessoryModels />
  <generators>
    <generator alias="" namespace="jetbrains.mps.baseLanguage.lightweightdsl#3751132065236752909" uuid="cedbe277-2e6e-42bf-ae23-90ac9db5a8e3" reflective-queries="false">
      <models>
        <modelRoot contentPath="${module}" type="default">
