...
<language namespace="jetbrains.mps.baseLanguage.lightweightdsl" uuid="c7d5b9dd-a05f-4be2-bc73-f2e16994cc67" version="0">
  ...
  <accessoryModels />
  <generators>
    <generator name="jetbrains.mps.baseLanguage.lightweightdsl" generatorUID="jetbrains.mps.baseLanguage.lightweightdsl" uuid="cedbe277-2e6e-42bf-ae23-90ac9db5a8e3">
      <models>
        <modelRoot contentPath="${module}" type="default">
