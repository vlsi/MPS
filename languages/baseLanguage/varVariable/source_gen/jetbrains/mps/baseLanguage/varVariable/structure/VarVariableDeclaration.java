...
public class VarVariableDeclaration extends LocalVariableDeclaration implements INamedConcept {
  public static final String concept = "jetbrains.mps.baseLanguage.varVariable.structure.VarVariableDeclaration";
  ...
  public static VarVariableDeclaration newInstance(SModel sm, boolean init) {
    return (VarVariableDeclaration) SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.baseLanguage.varVariable.structure.VarVariableDeclaration", sm, GlobalScope.getInstance(), init).getAdapter();
  }
