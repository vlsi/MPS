...
public class AdditionalStructurePropertiesImpl extends BaseAdditionalStructureProperties {
  private final AdditionalConceptProperties props_VarVariableDeclaration = new ConceptPropsBuilder().create();
  ...
  private static final Map<SAbstractConcept, Integer> indices_4qogsf_a0c = buildConceptIndices(MetaAdapterFactory.getConcept(0x515552c7fcc04ab4L, 0x97892f3c49344e85L, 0x11ff0aa3699L, "VarVariableDeclaration"));
}
