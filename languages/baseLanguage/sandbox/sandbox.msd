...
<solution name="sandbox" generatorOutputPath="${mps_home}\source_gen">
  <models>
  ...
  <languages>
    ...
    <moduleRoot path="${mps_home}\languages\baseLanguage\languages\refactoringTest\refactoringTest.mpl" />
  </languages>
  <classPath>
