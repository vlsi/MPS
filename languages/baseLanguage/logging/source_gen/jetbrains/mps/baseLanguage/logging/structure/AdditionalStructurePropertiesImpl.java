...
public class AdditionalStructurePropertiesImpl extends BaseAdditionalStructureProperties {
  private final AdditionalConceptProperties props_LogStatement = new ConceptPropsBuilder().create();
  private final AdditionalConceptProperties props_PrintStatement = new ConceptPropsBuilder().create();
  ...
  private static final Map<SAbstractConcept, Integer> indices_4qogsf_a0d = buildConceptIndices(MetaAdapterFactory.getConcept(0x760a0a8ceabb4521L, 0x8bfd65db761a9ba3L, 0x10fc428b1dfL, "LogStatement"), MetaAdapterFactory.getConcept(0x760a0a8ceabb4521L, 0x8bfd65db761a9ba3L, 0x1100a2cc320L, "PrintStatement"));
}
