...
public class logging_nodeSubstitute_Contribution extends SubstituteMenuBase {
  ...
  private class SMP_Param_85vuih_a extends ParameterizedMenuPart<SEnumerationLiteral, SubstituteMenuItem, SubstituteMenuContext> {
    @NotNull
    @Override
    ...
    private class SMP_Action_85vuih_a0 extends SingleItemSubstituteMenuPart {
      ...
      public SMP_Action_85vuih_a0(SEnumerationLiteral parameterObject) {
      ...
      private class Item extends DefaultSubstituteMenuItem {
        ...
        public SNode createNode(@NotNull String pattern) {
          ...
          SPropertyOperations.set(logStatement, MetaAdapterFactory.getProperty(0x760a0a8ceabb4521L, 0x8bfd65db761a9ba3L, 0x10fc428b1dfL, 0x10fc541df63L, "severity"), SEnumOperations.getMemberValue(myParameterObject));
        ...
        public String getMatchingText(@NotNull String pattern) {
          return SEnumOperations.getMemberValue(myParameterObject);
        }
        @Nullable
        @Override
