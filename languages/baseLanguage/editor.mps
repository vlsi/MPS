...
<semanticModel namespace="baseLanguage">
  ...
  <node type="jetbrains.mps.bootstrap.editorLanguage.SemanticTypeEditorDeclaration" id="1075310040203">
    <link role="semanticTypeDeclaration" targetNodeId="8.1068498886290" />
    <link role="actionSetDeclaration" metaClass="aggregation">
      <node type="jetbrains.mps.bootstrap.editorLanguage.CellActionSetDeclaration" id="1075908517781">
        <link role="specializes" targetNodeId="1082130590765" />
        <link role="actionDeclaration" metaClass="aggregation">
          <node type="jetbrains.mps.bootstrap.editorLanguage.ActionModel_SubstituteNode" id="1075908517783">
            <link role="substituteQueryBody" targetNodeId="1081927994537" />
            <link role="substituteQueryMethod" metaClass="aggregation">
              <node type="jetbrains.mps.baseLanguage.InstanceMethodDeclaration" id="1081927994531">
                <link role="parameter" metaClass="aggregation">
                  <node type="jetbrains.mps.baseLanguage.ParameterDeclaration" id="1081927994532">
                    <link role="type" metaClass="aggregation">
                      <node type="jetbrains.mps.baseLanguage.JavaClassType" id="1081927994533">
                        <link role="javaClass" targetNodeId="13.1081508090545" />
                ...
                <link role="body" metaClass="aggregation">
                  <node type="jetbrains.mps.baseLanguage.StatementList" id="1081927994537">
                    <link role="statement" metaClass="aggregation">
                      <node type="jetbrains.mps.baseLanguage.ReturnStatement" id="1081950385271">
                        <link role="expression" metaClass="aggregation">
                          <node type="jetbrains.mps.baseLanguage.MethodCall" id="1081950385272">
                            <link role="baseMethodDeclaration" targetNodeId="13.1081929156800" />
                            <link role="actualArgument" metaClass="aggregation">
                              <node type="jetbrains.mps.baseLanguage.ParameterReference" id="1081950385274">
                                <link role="variableDeclaration" targetNodeId="1081927994532" />
                                <property name="name" />
                              </node>
                            </link>
                            <link role="actualArgument" metaClass="aggregation">
                              <node type="jetbrains.mps.baseLanguage.ParameterReference" id="1081950385276">
                                <link role="variableDeclaration" targetNodeId="1081927994534" />
                                <property name="name" />
                              </node>
                            </link>
                            <property name="name" />
            ...
            <property name="substituteHandlerId" value="ActualArgumentExpressionAcceptor" />
            <property name="name" />
          </node>
        </link>
    ...
    <link role="cellModel" metaClass="aggregation">
      <node type="jetbrains.mps.bootstrap.editorLanguage.CellModel_Collection" id="1080559245687">
        <link role="childCellModel" metaClass="aggregation">
          <node type="jetbrains.mps.bootstrap.editorLanguage.CellModel_RefNode" id="1080559429532">
            <link role="actionSet" targetNodeId="1075908517781" />
            <link role="linkDeclaration" targetNodeId="8.1068498886293" />
            <property name="actionSetId" />
            <property name="name" />
          </node>
        </link>
    ...
    <property name="name" value="ActualArgument_Editor" />
  </node>
