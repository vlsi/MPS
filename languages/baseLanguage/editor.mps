...
<model namespace="jetbrains.mps.baseLanguage">
  ...
  <node type="jetbrains.mps.bootstrap.editorLanguage.CellKeyMapDeclaration" id="1081427357000">
    ...
    <node role="entry" type="jetbrains.mps.bootstrap.editorLanguage.CellKeyMapEntry" id="1104592149287">
      <property name="keycode" value="*" />
      <property name="actionProviderId" value="Expression_Mul" />
    </node>
    <node role="entry" type="jetbrains.mps.bootstrap.editorLanguage.CellKeyMapEntry" id="1104592180804">
      <property name="keycode" value="/" />
      <property name="actionProviderId" value="Expression_Div" />
    </node>
