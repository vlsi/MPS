  ...
  <node type="jetbrains.mps.baseLanguage.ClassConcept" id="1115664491666">
    ...
    <node role="staticMethod" type="jetbrains.mps.baseLanguage.StaticMethodDeclaration" id="1115664493170">
      ...
      <node role="body" type="jetbrains.mps.baseLanguage.StatementList" id="1115664493176">
        ...
        <node role="statement" type="jetbrains.mps.baseLanguage.IfStatement" id="1127094234230">
          <node role="condition" type="jetbrains.mps.baseLanguage.InstanceOfExpression" id="1127094263915">
            <node role="leftExpression" type="jetbrains.mps.baseLanguage.ParameterReference" id="1127094305160">
              <link role="variableDeclaration" targetNodeId="1115664493173" />
            </node>
            <node role="classType" type="jetbrains.mps.baseLanguage.ClassType" id="1127094263917">
              <link role="classifier" extResolveInfo="19.[ClassConcept]BaseMethodDeclaration" />
            </node>
          </node>
          <node role="ifTrue" type="jetbrains.mps.baseLanguage.StatementList" id="1127094332149">
            <node role="statement" type="jetbrains.mps.baseLanguage.ExpressionStatement" id="1127094337206">
              <node role="expression" type="jetbrains.mps.baseLanguage.InstanceMethodCall" id="1127094337207">
                <link role="baseMethodDeclaration" targetNodeId="19.1113723507412" />
                <node role="instance" type="jetbrains.mps.baseLanguage.LocalVariableReference" id="1127094337208">
                  <link role="variableDeclaration" targetNodeId="1115664493178" />
                </node>
                <node role="actualArgument" type="jetbrains.mps.baseLanguage.CastExpression" id="1127094337209">
                  <node role="type" type="jetbrains.mps.baseLanguage.ClassType" id="1127094337210">
                    <link role="classifier" targetNodeId="19.1109971953619" />
                  </node>
                  <node role="expression" type="jetbrains.mps.baseLanguage.ParameterReference" id="1127094337211">
                    <link role="variableDeclaration" targetNodeId="1115664493173" />
                  </node>
                </node>
              </node>
