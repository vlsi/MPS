...
public class CustomArgumentClause_Editor extends DefaultNodeEditor {
  ...
  private static class parameterListHandler_iqoiiv_a0 extends RefNodeListHandler {
    ...
    public EditorCell createSeparatorCell(EditorContext editorContext, SNode prevNode, SNode nextNode) {
      ...
      editorCell.setAction(CellActionType.BACKSPACE, new CellAction_DeleteNode(prevNode, true));
      editorCell.setAction(CellActionType.DELETE, new CellAction_DeleteNode(prevNode, false));
      return editorCell;
    }
  }
}
