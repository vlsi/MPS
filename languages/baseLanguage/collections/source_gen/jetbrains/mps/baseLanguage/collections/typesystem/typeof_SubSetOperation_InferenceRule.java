...
public class typeof_SubSetOperation_InferenceRule extends AbstractInferenceRule_Runtime implements InferenceRule_Runtime {
  ...
  public void applyRule(final SNode operation, final TypeCheckingContext typeCheckingContext, IsApplicableStatus status) {
    final SNode ELEMENT_TYPE_typevar_1240251732387 = typeCheckingContext.createNewRuntimeTypesVariable();
    {
      ...
      typeCheckingContext.createGreaterThanInequality((SNode) _quotation_createNode_9sowee_a0b0a(typeCheckingContext.getRepresentative(ELEMENT_TYPE_typevar_1240251732387)), (SNode) typeCheckingContext.typeOf(_nodeToCheck_1029348928467, "r:00000000-0000-4000-0000-011c8959032b(jetbrains.mps.baseLanguage.collections.typesystem)", "1240251732397", true), false, true, _info_12389875345);
    }
    ...
    }
    {
      ...
      typeCheckingContext.createEquation((SNode) typeCheckingContext.typeOf(_nodeToCheck_1029348928467, "r:00000000-0000-4000-0000-011c8959032b(jetbrains.mps.baseLanguage.collections.typesystem)", "1240251732417", true), (SNode) _quotation_createNode_9sowee_a0e0a(typeCheckingContext.getRepresentative(ELEMENT_TYPE_typevar_1240251732387)), _info_12389875345);
    }
  }
  ...
  private static SNode _quotation_createNode_9sowee_a0b0a(Object parameter_1) {
  ...
  private static SNode _quotation_createNode_9sowee_a0e0a(Object parameter_1) {
    SNode quotedNode_2 = null;
    SNode quotedNode_3 = null;
    quotedNode_2 = SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.baseLanguage.collections.structure.SortedSetType", null, null, GlobalScope.getInstance(), false);
    quotedNode_3 = (SNode) parameter_1;
