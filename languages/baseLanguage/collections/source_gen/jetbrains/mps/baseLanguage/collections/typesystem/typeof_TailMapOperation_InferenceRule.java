...
public class typeof_TailMapOperation_InferenceRule extends AbstractInferenceRule_Runtime implements InferenceRule_Runtime {
  ...
  public void applyRule(final SNode operation, final TypeCheckingContext typeCheckingContext, IsApplicableStatus status) {
    ...
    final SNode VALUE_TYPE_typevar_1240240157657 = typeCheckingContext.createNewRuntimeTypesVariable();
    {
      ...
      EquationInfo _info_12389875345 = new EquationInfo(_nodeToCheck_1029348928467, null, "r:00000000-0000-4000-0000-011c8959032b(jetbrains.mps.baseLanguage.collections.typesystem)", "1240240157658", 0, null);
      typeCheckingContext.createLessThanInequality((SNode) typeCheckingContext.typeOf(_nodeToCheck_1029348928467, "r:00000000-0000-4000-0000-011c8959032b(jetbrains.mps.baseLanguage.collections.typesystem)", "1240240157669", true), (SNode) new typeof_TailMapOperation_InferenceRule.QuotationClass_w0botb_a0a2a0().createNode(typeCheckingContext.getRepresentative(KEY_TYPE_typevar_1240240157656), typeCheckingContext.getRepresentative(VALUE_TYPE_typevar_1240240157657), typeCheckingContext), false, true, _info_12389875345);
    }
    {
