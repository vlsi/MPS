...
public class typeof_RemoveAllSetElementsOperation_InferenceRule extends AbstractInferenceRule_Runtime implements InferenceRule_Runtime {
  ...
  public void applyRule(final SNode operation, final TypeCheckingContext typeCheckingContext, IsApplicableStatus status) {
    final SNode elementType_typevar_1226594108923 = typeCheckingContext.createNewRuntimeTypesVariable();
    {
      ...
      typeCheckingContext.createGreaterThanInequality((SNode) new typeof_RemoveAllSetElementsOperation_InferenceRule.QuotationClass_t2vuix_a0a1a0().createNode(typeCheckingContext.getRepresentative(elementType_typevar_1226594108923), typeCheckingContext), (SNode) typeCheckingContext.typeOf(_nodeToCheck_1029348928467, "r:00000000-0000-4000-0000-011c8959032b(jetbrains.mps.baseLanguage.collections.typesystem)", "1226594108932", true), false, false, _info_12389875345);
    }
