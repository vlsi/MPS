...
public class IApplicableToCollection_Behavior {
  public static void init(SNode thisNode) {
  }
  public static List<SNode> virtual_getApplicableTypes_5994574781955586127(SAbstractConcept thisConcept) {
    List<SNode> result = BehaviorReflection.invokeSuperStatic((Class<List<SNode>>) ((Class) Object.class), SNodeOperations.asSConcept(thisConcept), "jetbrains.mps.baseLanguage.collections.structure.IApplicableToList", "virtual_getApplicableTypes_5994574781955586127", new Object[]{});
