...
public class IteratorType_Behavior {
  ...
  private static SNode _quotation_createNode_cgg16c_a0a3() {
    ...
    quotedNode_1.setReference("classifier", SReference.create("classifier", quotedNode_1, SModelReference.fromString("f:java_stub#6354ebe7-c22a-4a0f-ac54-50b52ab9b065#java.util(JDK/java.util@java_stub)"), jetbrains.mps.smodel.SNodeId.fromString("~Iterator")));
    return quotedNode_1;
  }
}
