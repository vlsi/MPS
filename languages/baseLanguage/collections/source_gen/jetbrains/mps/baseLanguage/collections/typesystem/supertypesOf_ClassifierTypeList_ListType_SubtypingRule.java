    ...
    public boolean match(SNode nodeToMatch) {
      {
        ...
        }
        {
          ...
          {
            SNode childVar_supertypesOf_ClassifierTypeList_ListType_h8kiwa_a0a0 = nodeToMatch_supertypesOf_ClassifierTypeList_ListType_h8kiwa_a0a.getChildren(childRole_supertypesOf_ClassifierTypeList_ListType_h8kiwa_).iterator().next();
