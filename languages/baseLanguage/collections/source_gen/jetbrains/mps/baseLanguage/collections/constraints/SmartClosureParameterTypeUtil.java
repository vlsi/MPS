...
public class SmartClosureParameterTypeUtil {
  ...
  @InferenceMethod
  public static void equateInputType(SNode scpd, SNode InputType, final TypeCheckingContext typeCheckingContext) {
  ...
  @InferenceMethod
  public static void equateResolveType(SNode scpd, SNode InputType, final TypeCheckingContext typeCheckingContext) {
