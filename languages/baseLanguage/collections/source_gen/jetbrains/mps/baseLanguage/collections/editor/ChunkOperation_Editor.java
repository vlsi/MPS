...
public class ChunkOperation_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createComponent_fc60h5_a0(EditorContext editorContext, SNode node) {
    ...
    editorCell.setSubstituteInfo(new CompositeSubstituteInfo(editorContext, new BasicCellContext(node), new SubstituteInfoPartExt[]{new ChunkOperation_Editor.ReplaceWith_SequenceOperation_cellMenu_a0a0_3()}));
    return editorCell;
  }
