...
public class supertypesOf_IteratorType_SubtypingRule extends SubtypingRule_Runtime implements ISubtypingRule_Runtime {
  ...
  public SNode getSubOrSuperType(SNode iteratorType, TypeCheckingContext typeCheckingContext, IsApplicableStatus status) {
    return new supertypesOf_IteratorType_SubtypingRule.QuotationClass_3m2hv_a0a0a().createNode(SLinkOperations.getTarget(iteratorType, "elementType", true), typeCheckingContext);
  }
  ...
  public static class QuotationClass_3m2hv_a0a0a {
    public QuotationClass_3m2hv_a0a0a() {
    }
    ...
    public SNode createNode(Object parameter_5, final TypeCheckingContext typeCheckingContext) {
      ...
      SNode quotedNode_2 = null;
      {
        ...
        quotedNode1_3.setReference("classifier", SReference.create("classifier", quotedNode1_3, SModelReference.fromString("f:java_stub#6354ebe7-c22a-4a0f-ac54-50b52ab9b065#java.util(JDK/java.util@java_stub)"), SNodeId.fromString("~Iterator")));
        {
