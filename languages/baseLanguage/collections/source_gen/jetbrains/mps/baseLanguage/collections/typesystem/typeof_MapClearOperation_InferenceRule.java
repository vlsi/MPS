...
public class typeof_MapClearOperation_InferenceRule extends AbstractInferenceRule_Runtime implements InferenceRule_Runtime {
  ...
  public void applyRule(final SNode nodeToCheck, final TypeCheckingContext typeCheckingContext, IsApplicableStatus status) {
    ...
    final SNode VALUE_typevar_1208542413609 = typeCheckingContext.createNewRuntimeTypesVariable();
    {
      ...
      typeCheckingContext.createGreaterThanInequality((SNode) new typeof_MapClearOperation_InferenceRule.QuotationClass_hpo6r3_a0a2a0().createNode(typeCheckingContext.getRepresentative(VALUE_typevar_1208542413609), typeCheckingContext.getRepresentative(KEY_typevar_1208542413607), typeCheckingContext), (SNode) typeCheckingContext.typeOf(_nodeToCheck_1029348928467, "r:00000000-0000-4000-0000-011c8959032b(jetbrains.mps.baseLanguage.collections.typesystem)", "1208542413612", true), false, true, _info_12389875345);
    }
    {
