...
public class set_weakSupertypeOf_ClassifierType_Set_SubtypingRule extends SubtypingRule_Runtime implements ISubtypingRule_Runtime {
    ...
    public boolean match(SNode nodeToMatch) {
      {
        ...
        {
          SNodeReference pointer = SNODE_POINTER_lt6k7h_a0a0a0a0b0c0a0a0a0a0a0e;
        ...
        }
        {
          ...
          {
            SNode childVar_set_weakSupertypeOf_ClassifierType_Set_n7314j_a0a0 = IterableUtil.get(nodeToMatch_set_weakSupertypeOf_ClassifierType_Set_n7314j_a0a.getChildren(childRole_set_weakSupertypeOf_ClassifierType_Set_n7314j_), 0);
  ...
  private static SNodeReference SNODE_POINTER_lt6k7h_a0a0a0a0b0c0a0a0a0a0a0e = new jetbrains.mps.smodel.SNodePointer("f:java_stub#6354ebe7-c22a-4a0f-ac54-50b52ab9b065#java.util(JDK/java.util@java_stub)", "~Set");
}
