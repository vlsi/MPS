...
public class queue_supertypeOf_deque_SubtypingRule extends SubtypingRule_Runtime implements ISubtypingRule_Runtime {
  ...
  public SNode getSubOrSuperType(SNode dequeType, TypeCheckingContext typeCheckingContext, IsApplicableStatus status) {
    return _quotation_createNode_if93vt_a0a0(SLinkOperations.getTarget(dequeType, "elementType", true));
  }
  ...
  private static SNode _quotation_createNode_if93vt_a0a0(Object parameter_1) {
