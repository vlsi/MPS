...
public class supertypesOf_CollectionType_SequenceType_SubtypingRule extends SubtypingRule_Runtime implements ISubtypingRule_Runtime {
  ...
  public SNode getSubOrSuperType(SNode ct, TypeCheckingContext typeCheckingContext, IsApplicableStatus status) {
    return new supertypesOf_CollectionType_SequenceType_SubtypingRule.QuotationClass_ligzty_a0a0a().createNode(SLinkOperations.getTarget(ct, "elementType", true), typeCheckingContext);
  }
  ...
  public static class QuotationClass_ligzty_a0a0a {
    public QuotationClass_ligzty_a0a0a() {
    }
