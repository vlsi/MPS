...
public class typeof_ValueAccessOperation_InferenceRule extends AbstractInferenceRule_Runtime implements InferenceRule_Runtime {
  ...
  public void applyRule(final SNode operation, final TypeCheckingContext typeCheckingContext, IsApplicableStatus status) {
    ...
    final SNode VALUE_typevar_1240825516045 = typeCheckingContext.createNewRuntimeTypesVariable();
    {
      ...
      EquationInfo _info_12389875345 = new EquationInfo(_nodeToCheck_1029348928467, null, "r:00000000-0000-4000-0000-011c8959032b(jetbrains.mps.baseLanguage.collections.typesystem)", "1240825542671", 0, null);
      typeCheckingContext.createLessThanInequality((SNode) typeCheckingContext.typeOf(_nodeToCheck_1029348928467, "r:00000000-0000-4000-0000-011c8959032b(jetbrains.mps.baseLanguage.collections.typesystem)", "1240825522780", true), (SNode) new typeof_ValueAccessOperation_InferenceRule.QuotationClass_gdu5gr_a0a2a0().createNode(typeCheckingContext.getRepresentative(KEY_typevar_1240825584221), typeCheckingContext.getRepresentative(VALUE_typevar_1240825516045), typeCheckingContext), false, true, _info_12389875345);
    }
    {
  ...
  public static class QuotationClass_gdu5gr_a0a2a0 {
    public QuotationClass_gdu5gr_a0a2a0() {
    }
