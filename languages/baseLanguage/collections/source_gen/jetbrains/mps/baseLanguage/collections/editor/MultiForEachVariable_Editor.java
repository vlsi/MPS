...
public class MultiForEachVariable_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createProperty_bqabhr_a0(EditorContext editorContext, SNode node) {
    ...
    editorCell.setSubstituteInfo(new CompositeSubstituteInfo(editorContext, provider.getCellContext(), new SubstituteInfoPartExt[]{new MultiForEachVariable_Editor.MultiForEachVariable_name_postfixCellMenu_bqabhr_a0a0(), new SChildSubstituteInfoPartEx(editorCell)}));
