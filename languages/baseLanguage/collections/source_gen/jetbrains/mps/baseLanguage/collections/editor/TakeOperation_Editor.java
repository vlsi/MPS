...
public class TakeOperation_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createConstant_rla3h2_a0(EditorContext editorContext, SNode node) {
    ...
    editorCell.setSubstituteInfo(new CompositeSubstituteInfo(editorContext, new BasicCellContext(node), new SubstituteInfoPartExt[]{new TakeOperation_Editor.ReplaceWith_SequenceOperation_cellMenu_a0a0_1()}));
    return editorCell;
  }
