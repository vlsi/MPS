...
public class typeof_IsNotEmptyOperation_InferenceRule extends AbstractInferenceRule_Runtime implements InferenceRule_Runtime {
      ...
      SNode matchedNode_rn73y2_a0 = SNodeOperations.getParent(op);
      {
        boolean matches_rn73y2_a0a = false;
        {
          ...
          if (matchingNode_rn73y2_a0a != null) {
            matches_rn73y2_a0a = SModelUtil_new.isAssignableConcept(matchingNode_rn73y2_a0a.getConcept().getId(), "jetbrains.mps.baseLanguage.structure.DotExpression");
          }
        }
        if (matches_rn73y2_a0a) {
          {
            ...
            typeCheckingContext.createEquation((SNode) typeCheckingContext.typeOf(_nodeToCheck_1029348928467, "r:00000000-0000-4000-0000-011c8959032b(jetbrains.mps.baseLanguage.collections.typesystem)", "1219443359861", true), (SNode) _quotation_createNode_30ohwl_a0a0a0c0b0a0a(), _info_12389875345);
          }
        } else {
          {
  ...
  private static SNode _quotation_createNode_30ohwl_a0a0a0c0b0a0a() {
