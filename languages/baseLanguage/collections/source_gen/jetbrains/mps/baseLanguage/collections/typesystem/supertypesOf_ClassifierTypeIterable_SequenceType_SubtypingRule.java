...
public class supertypesOf_ClassifierTypeIterable_SequenceType_SubtypingRule extends SubtypingRule_Runtime implements ISubtypingRule_Runtime {
    ...
    public boolean match(SNode nodeToMatch) {
      {
        ...
        if (!("jetbrains.mps.baseLanguage.structure.ClassifierType".equals(nodeToMatch_supertypesOf_ClassifierTypeIterable_SequenceType_z7dq1d_a0a.getConcept().getConceptId()))) {
          return false;
        }
        {
          SNodeReference pointer = SNODE_POINTER_x5x8gb_a0a0a0a0b0c0a0a0a0a0a0e;
        ...
        }
        {
          ...
          {
            SNode childVar_supertypesOf_ClassifierTypeIterable_SequenceType_z7dq1d_a0a0 = IterableUtil.get(nodeToMatch_supertypesOf_ClassifierTypeIterable_SequenceType_z7dq1d_a0a.getChildren(childRole_supertypesOf_ClassifierTypeIterable_SequenceType_z7dq1d_), 0);
  ...
  private static SNodeReference SNODE_POINTER_x5x8gb_a0a0a0a0b0c0a0a0a0a0a0e = new jetbrains.mps.smodel.SNodePointer("f:java_stub#6354ebe7-c22a-4a0f-ac54-50b52ab9b065#java.lang(JDK/java.lang@java_stub)", "~Iterable");
}
