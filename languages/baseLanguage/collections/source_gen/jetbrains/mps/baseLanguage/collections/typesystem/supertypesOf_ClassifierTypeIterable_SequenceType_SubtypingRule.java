...
public class supertypesOf_ClassifierTypeIterable_SequenceType_SubtypingRule extends SubtypingRule_Runtime implements ISubtypingRule_Runtime {
  ...
  public IsApplicableStatus isApplicableAndPattern(SNode argument) {
    {
      GeneratedMatchingPattern pattern = new Pattern_f1kjn23r(_quotation_createNode_x5x8gb_a0a0a0a0e());
  ...
  private static SNode _quotation_createNode_x5x8gb_a0a0a0a0e() {
    PersistenceFacade facade = PersistenceFacade.getInstance();
