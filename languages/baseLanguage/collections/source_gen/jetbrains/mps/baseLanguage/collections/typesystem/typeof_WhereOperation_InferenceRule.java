...
public class typeof_WhereOperation_InferenceRule extends AbstractInferenceRule_Runtime implements InferenceRule_Runtime {
  ...
  public void applyRule(final SNode wo, final TypeCheckingContext typeCheckingContext, IsApplicableStatus status) {
    final SNode paramType_typevar_1203177832282 = typeCheckingContext.createNewRuntimeTypesVariable();
    {
      ...
      typeCheckingContext.createGreaterThanInequality((SNode) new typeof_WhereOperation_InferenceRule.QuotationClass_pin8c2_a0a1a0().createNode(typeCheckingContext.getRepresentative(paramType_typevar_1203177832282), typeCheckingContext), (SNode) typeCheckingContext.typeOf(_nodeToCheck_1029348928467, "r:00000000-0000-4000-0000-011c8959032b(jetbrains.mps.baseLanguage.collections.typesystem)", "1225885301838", true), false, true, _info_12389875345);
    }
    {
      ...
      typeCheckingContext.createLessThanInequality((SNode) typeCheckingContext.typeOf(_nodeToCheck_1029348928467, "r:00000000-0000-4000-0000-011c8959032b(jetbrains.mps.baseLanguage.collections.typesystem)", "1225884077244", true), (SNode) new typeof_WhereOperation_InferenceRule.QuotationClass_pin8c2_a0a2a0().createNode(typeCheckingContext.getRepresentative(paramType_typevar_1203177832282), typeCheckingContext), false, true, _info_12389875345);
    }
    {
