    ...
    if (!(typeCheckingContext.isSingleTypeComputation())) {
      {
        ...
        typeCheckingContext.createLessThanInequality((SNode) typeCheckingContext.typeOf(_nodeToCheck_1029348928467, "r:00000000-0000-4000-0000-011c8959032b(jetbrains.mps.baseLanguage.collections.typesystem)", "1225884077244", true), (SNode) new typeof_WhereOperation_InferenceRule.QuotationClass_pin8c2_a0a2a0().createNode(typeCheckingContext.getRepresentative(paramType_typevar_1203177832282), typeCheckingContext), true, true, _info_12389875345);
      }
    }
    {
