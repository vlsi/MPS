...
public class supertypesOf_EnumeratorType_SubtypingRule extends SubtypingRule_Runtime implements ISubtypingRule_Runtime {
  ...
  private static SNode _quotation_createNode_w8ob7y_a0a1(Object parameter_1) {
    ...
    quotedNode_2.setReference("classifier", SReference.create("classifier", quotedNode_2, SModelReference.fromString("r:fc76aa36-3cff-41c7-b94b-eee0e8341932(jetbrains.mps.internal.collections.runtime)"), jetbrains.mps.smodel.SNodeId.fromString("6543581031674024971")));
