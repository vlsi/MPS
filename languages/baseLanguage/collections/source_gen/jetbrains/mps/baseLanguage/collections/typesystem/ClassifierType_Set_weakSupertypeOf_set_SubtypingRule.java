    ...
    public boolean match(SNode nodeToMatch) {
      {
        ...
        if (!("jetbrains.mps.baseLanguage.collections.structure.SetType".equals(nodeToMatch_ClassifierType_Set_weakSupertypeOf_set_nbr2nf_a0a.getConcept().getQualifiedName()))) {
          return false;
        }
        {
