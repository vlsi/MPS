...
public class SequenceOperation_Constraints extends BaseConstraintsDescriptor {
  public SequenceOperation_Constraints() {
    super(MetaIdFactory.conceptId(new UUID(-8968771020793164004l, -7182180101671965361l), 1151701983961l));
  }
  @Override
  ...
  public static boolean static_canBeAChild(SNode node, SNode parentNode, SNode link, SNode childConcept, final IOperationContext operationContext) {
    if (SConceptOperations.isSubConceptOf(SNodeOperations.asSConcept(childConcept), MetaAdapterFactory.getConcept(new UUID(-8968771020793164004l, -7182180101671965361l), 5994574781936691958l, "jetbrains.mps.baseLanguage.collections.structure.IApplicableToNothing"))) {
      ...
      if ((opnd != null)) {
        ...
        for (SNode exptype : (IApplicableToNothing_Behavior.call_getAllApplicableTypes_5994574781955687463(SConceptRepository.getInstance().getConcept(NameUtil.nodeFQName(SNodeOperations.castConcept(((SNode) childConcept), MetaAdapterFactory.getConcept(new UUID(-8968771020793164004l, -7182180101671965361l), 5994574781936691958l, "jetbrains.mps.baseLanguage.collections.structure.IApplicableToNothing"))))))) {
