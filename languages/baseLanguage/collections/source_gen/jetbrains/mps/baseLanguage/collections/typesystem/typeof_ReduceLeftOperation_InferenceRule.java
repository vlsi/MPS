...
public class typeof_ReduceLeftOperation_InferenceRule extends AbstractInferenceRule_Runtime implements InferenceRule_Runtime {
  ...
  public void applyRule(final SNode operation, final TypeCheckingContext typeCheckingContext, IsApplicableStatus status) {
    final SNode elementType_typevar_1522217801069359744 = typeCheckingContext.createNewRuntimeTypesVariable();
    {
      ...
      typeCheckingContext.createGreaterThanInequality((SNode) _quotation_createNode_lspyj5_a0b0a(typeCheckingContext.getRepresentative(elementType_typevar_1522217801069359744)), (SNode) typeCheckingContext.typeOf(_nodeToCheck_1029348928467, "r:00000000-0000-4000-0000-011c8959032b(jetbrains.mps.baseLanguage.collections.typesystem)", "1522217801069359753", true), false, true, _info_12389875345);
    }
    {
    ...
    if (!(typeCheckingContext.isSingleTypeComputation())) {
      {
        ...
        typeCheckingContext.createLessThanInequality((SNode) typeCheckingContext.typeOf(_nodeToCheck_1029348928467, "r:00000000-0000-4000-0000-011c8959032b(jetbrains.mps.baseLanguage.collections.typesystem)", "1522217801069359774", true), (SNode) _quotation_createNode_lspyj5_a0d0a(typeCheckingContext.getRepresentative(elementType_typevar_1522217801069359744), typeCheckingContext.getRepresentative(elementType_typevar_1522217801069359744), typeCheckingContext.getRepresentative(elementType_typevar_1522217801069359744)), true, true, _info_12389875345);
      }
    }
  }
  ...
  private static SNode _quotation_createNode_lspyj5_a0b0a(Object parameter_1) {
  ...
  private static SNode _quotation_createNode_lspyj5_a0d0a(Object parameter_1, Object parameter_2, Object parameter_3) {
