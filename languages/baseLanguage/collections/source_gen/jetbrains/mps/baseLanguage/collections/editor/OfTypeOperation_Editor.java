...
public class OfTypeOperation_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createCollection_f8yh7v_a(EditorContext editorContext, SNode node) {
    ...
    editorCell.addEditorCell(this.createConceptProperty_f8yh7v_a0(editorContext, node));
  ...
  private EditorCell createConceptProperty_f8yh7v_a0(EditorContext editorContext, SNode node) {
