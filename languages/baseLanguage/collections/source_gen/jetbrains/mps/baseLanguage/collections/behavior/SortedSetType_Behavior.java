...
public class SortedSetType_Behavior {
  ...
  public static class QuotationClass_7p913d_a0a0b0b {
    ...
    public SNode createNode(Object parameter_5) {
      ...
      {
        quotedNode_1 = SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.baseLanguage.collections.structure.TreeSetCreator", null, null, GlobalScope.getInstance(), false);
  ...
  public static class QuotationClass_7p913d_a0a0c {
    ...
    public SNode createNode() {
      ...
      SNode quotedNode_1 = null;
      {
        ...
        quotedNode1_2.setReference("classifier", SReference.create("classifier", quotedNode1_2, SModelReference.fromString("f:java_stub#6354ebe7-c22a-4a0f-ac54-50b52ab9b065#java.util(JDK/java.util@java_stub)"), SNodeId.fromString("~SortedSet")));
