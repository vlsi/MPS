...
public class PageOperation_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createConstant_328ize_a0(EditorContext editorContext, SNode node) {
    ...
    editorCell.setSubstituteInfo(new CompositeSubstituteInfo(editorContext, new BasicCellContext(node), new SubstituteInfoPartExt[]{new PageOperation_Editor.ReplaceWith_SequenceOperation_cellMenu_a0a0_0()}));
    return editorCell;
  }
