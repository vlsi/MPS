...
public class PageOperation_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createConstant_328ize_a0(EditorContext editorContext, SNode node) {
    EditorCell_Constant editorCell = new EditorCell_Constant((jetbrains.mps.nodeEditor.EditorContext) editorContext, node, "page");
    editorCell.setCellId("Constant_328ize_a0");
    Collections_Style_StyleSheet.getOperation(editorCell).apply(editorCell);
    editorCell.setDefaultText("");
    editorCell.setSubstituteInfo(new CompositeSubstituteInfo(editorContext, new BasicCellContext(node), new SubstituteInfoPartExt[]{new PageOperation_Editor.ReplaceWith_SequenceOperation_cellMenu_a0a0_1()}));
    return editorCell;
  }
