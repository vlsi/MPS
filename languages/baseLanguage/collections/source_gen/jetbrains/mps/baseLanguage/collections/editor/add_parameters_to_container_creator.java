...
public class add_parameters_to_container_creator extends TransformationMenuBase {
  ...
  protected List<MenuPart<TransformationMenuItem, TransformationMenuContext>> getParts(TransformationMenuContext _context) {
    ...
    if (ListSequence.fromListAndArray(new ArrayList<String>(), MenuLocations.RIGHT_SIDE_TRANSFORM).contains(_context.getMenuLocation())) {
      result.add(new add_parameters_to_container_creator.TMP_Group_wtne74_a0());
    }
    return result;
  }
  ...
  public class TMP_Group_wtne74_a0 extends GroupMenuPart<TransformationMenuItem, TransformationMenuContext> {
    ...
    private class TMP_Action_wtne74_a0a extends SingleItemMenuPart<TransformationMenuItem, TransformationMenuContext> {
      ...
      protected TransformationMenuItem createItem(TransformationMenuContext context) {
        return new add_parameters_to_container_creator.TMP_Group_wtne74_a0.TMP_Action_wtne74_a0a.Item(context);
      }
    ...
    private class TMP_Action_wtne74_b0a extends SingleItemMenuPart<TransformationMenuItem, TransformationMenuContext> {
      @Nullable
      protected TransformationMenuItem createItem(TransformationMenuContext context) {
        return new add_parameters_to_container_creator.TMP_Group_wtne74_a0.TMP_Action_wtne74_b0a.Item(context);
      }
