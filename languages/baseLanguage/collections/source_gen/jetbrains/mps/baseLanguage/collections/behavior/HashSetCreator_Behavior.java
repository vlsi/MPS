...
public class HashSetCreator_Behavior {
  ...
  public static SNode virtual_createType_1237722437229(SNode thisNode) {
    return _quotation_createNode_4sjjrg_a0a0(SLinkOperations.getTarget(thisNode, MetaAdapterFactory.getContainmentLink(new UUID(-8968771020793164004l, -7182180101671965361l), 1237721394592l, 1237721435807l, "elementType")));
  }
