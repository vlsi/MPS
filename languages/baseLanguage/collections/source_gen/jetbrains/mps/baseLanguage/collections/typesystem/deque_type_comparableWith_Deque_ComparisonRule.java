...
public class deque_type_comparableWith_Deque_ComparisonRule extends ComparisonRule_Runtime {
  ...
  public IsApplicableStatus isApplicableSecond(SNode node) {
    {
      GeneratedMatchingPattern pattern = new deque_type_comparableWith_Deque_ComparisonRule.Pattern_9xe6am_a0a0a0a5();
  ...
  public static class Pattern_9xe6am_a0a0a0a5 extends GeneratedMatchingPattern implements IMatchingPattern {
    ...
    public boolean match(SNode nodeToMatch) {
      {
        ...
        {
          SContainmentLink childRole_drfijn_ = MetaAdapterFactory.getContainmentLink(0xf3061a5392264cc5L, 0xa443f952ceaf5816L, 0x101de48bf9eL, 0x102419671abL, "parameter");
  ...
  private static SNodePointer SNODE_POINTER_9xe6am_a0a0a0a0b0b0a0b0a0a0a0f = new SNodePointer("6354ebe7-c22a-4a0f-ac54-50b52ab9b065/java:java.util(JDK/)", "~Deque");
}
