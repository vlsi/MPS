    ...
    public boolean match(SNode nodeToMatch) {
      {
        ...
        if (!("jetbrains.mps.baseLanguage.structure.ClassifierType".equals(nodeToMatch_deque_type_comparableWith_Deque_drfijn_a0a.getConcept().getConceptId()))) {
          return false;
        }
        {
          SNodePointer pointer = SNODE_POINTER_9xe6am_a0a0a0a0b0c0a0a0a0a0a0f;
        ...
        }
        {
          ...
          {
            SNode childVar_deque_type_comparableWith_Deque_drfijn_a0a0 = nodeToMatch_deque_type_comparableWith_Deque_drfijn_a0a.getChildren(childRole_deque_type_comparableWith_Deque_drfijn_).get(0);
