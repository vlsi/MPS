...
public class typeof_AllOperation_InferenceRule extends AbstractInferenceRule_Runtime implements InferenceRule_Runtime {
  ...
  public void applyRule(final SNode operation, final TypeCheckingContext typeCheckingContext, IsApplicableStatus status) {
    final SNode elementType_typevar_1235566876897 = typeCheckingContext.createNewRuntimeTypesVariable();
    {
      ...
      EquationInfo _info_12389875345 = new EquationInfo(_nodeToCheck_1029348928467, null, "r:00000000-0000-4000-0000-011c8959032b(jetbrains.mps.baseLanguage.collections.typesystem)", "1235566876898", 0, null);
      typeCheckingContext.createLessThanInequality((SNode) typeCheckingContext.typeOf(_nodeToCheck_1029348928467, "r:00000000-0000-4000-0000-011c8959032b(jetbrains.mps.baseLanguage.collections.typesystem)", "1235566876906", true), (SNode) new typeof_AllOperation_InferenceRule.QuotationClass_49xx2t_a0a1a0().createNode(typeCheckingContext.getRepresentative(elementType_typevar_1235566876897), typeCheckingContext), false, true, _info_12389875345);
    }
    {
    ...
    }
    {
      ...
      typeCheckingContext.createLessThanInequality((SNode) typeCheckingContext.typeOf(_nodeToCheck_1029348928467, "r:00000000-0000-4000-0000-011c8959032b(jetbrains.mps.baseLanguage.collections.typesystem)", "1235566876927", true), (SNode) new typeof_AllOperation_InferenceRule.QuotationClass_49xx2t_a0a3a0().createNode(typeCheckingContext.getRepresentative(elementType_typevar_1235566876897), typeCheckingContext), false, true, _info_12389875345);
    }
  }
