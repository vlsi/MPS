...
public class SetType_Behavior {
  ...
  public static List<SNode> call_getAbstractCreators_7602110602933345893(SNode thisNode, SModel targetModel) {
    ...
    return (List<SNode>) descriptor.invoke(Object.class, SNodeOperations.cast(thisNode, "jetbrains.mps.baseLanguage.collections.structure.SetType"), "virtual_getAbstractCreators_7602110602933317830", PARAMETERS_7602110602933345893, new Object[]{targetModel});
  }

  public static List<SNode> callSuperNew_getAbstractCreators_7602110602933345893(SNode thisNode, String callerConceptFqName, SModel targetModel) {
    return (List<SNode>) BehaviorManager.getInstance().invokeSuperNew(Object.class, SNodeOperations.cast(thisNode, "jetbrains.mps.baseLanguage.collections.structure.SetType"), callerConceptFqName, "virtual_getAbstractCreators_7602110602933317830", PARAMETERS_7602110602933345893, new Object[]{targetModel});
  }
  ...
  public static List<SNode> callSuper_getAbstractCreators_7602110602933345893(SNode thisNode, String callerConceptFqName, SModel targetModel) {
    return (List<SNode>) BehaviorManager.getInstance().invokeSuper(Object.class, SNodeOperations.cast(thisNode, "jetbrains.mps.baseLanguage.collections.structure.SetType"), callerConceptFqName, "virtual_getAbstractCreators_7602110602933317830", PARAMETERS_7602110602933345893, new Object[]{targetModel});
  }
  ...
  public static class QuotationClass_q66uze_a0a0b0f {
    ...
    public SNode createNode(Object parameter_5) {
      ...
      {
        quotedNode_1 = SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.baseLanguage.collections.structure.HashSetCreator", null, null, GlobalScope.getInstance(), false);
  ...
  public static class QuotationClass_q66uze_a0a0c0f {
    ...
    public SNode createNode(Object parameter_5) {
      ...
      SNode quotedNode_2 = null;
      {
        quotedNode_1 = SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.baseLanguage.collections.structure.LinkedHashSetCreator", null, null, GlobalScope.getInstance(), false);
        SNode quotedNode1_3 = quotedNode_1;
        {
          quotedNode_2 = (SNode) parameter_5;
          SNode quotedNode1_4;
  ...
  public static class QuotationClass_q66uze_a0a0g {
    ...
    public SNode createNode() {
      ...
      SNode quotedNode_1 = null;
      {
        ...
        quotedNode1_2.setReference("classifier", SReference.create("classifier", quotedNode1_2, SModelReference.fromString("f:java_stub#6354ebe7-c22a-4a0f-ac54-50b52ab9b065#java.util(JDK/java.util@java_stub)"), SNodeId.fromString("~Set")));
