...
public class typeof_TestRemoveElementOperation_InferenceRule extends AbstractInferenceRule_Runtime implements InferenceRule_Runtime {
  ...
  public void applyRule(final SNode tro, final TypeCheckingContext typeCheckingContext, IsApplicableStatus status) {
    final SNode ELEMENT_typevar_4073682006117732270 = typeCheckingContext.createNewRuntimeTypesVariable();
    {
      ...
      typeCheckingContext.createGreaterThanInequality((SNode) _quotation_createNode_agfpky_a0b0a(typeCheckingContext.getRepresentative(ELEMENT_typevar_4073682006117732270)), (SNode) typeCheckingContext.typeOf(_nodeToCheck_1029348928467, "r:00000000-0000-4000-0000-011c8959032b(jetbrains.mps.baseLanguage.collections.typesystem)", "4073682006117732273", true), false, true, _info_12389875345);
    }
    ...
    }
    {
      ...
      typeCheckingContext.createEquation((SNode) typeCheckingContext.typeOf(_nodeToCheck_1029348928467, "r:00000000-0000-4000-0000-011c8959032b(jetbrains.mps.baseLanguage.collections.typesystem)", "4073682006117732293", true), (SNode) _quotation_createNode_agfpky_a0d0a(), _info_12389875345);
    }
  }
  ...
  private static SNode _quotation_createNode_agfpky_a0b0a(Object parameter_1) {
  ...
  private static SNode _quotation_createNode_agfpky_a0d0a() {
