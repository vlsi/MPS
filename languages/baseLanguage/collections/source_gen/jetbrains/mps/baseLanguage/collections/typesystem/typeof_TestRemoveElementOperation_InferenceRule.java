...
public class typeof_TestRemoveElementOperation_InferenceRule extends AbstractInferenceRule_Runtime implements InferenceRule_Runtime {
  ...
  public void applyRule(final SNode tro, final TypeCheckingContext typeCheckingContext, IsApplicableStatus status) {
    final SNode ELEMENT_typevar_4073682006117732270 = typeCheckingContext.createNewRuntimeTypesVariable();
    {
      ...
      EquationInfo _info_12389875345 = new EquationInfo(_nodeToCheck_1029348928467, null, "r:00000000-0000-4000-0000-011c8959032b(jetbrains.mps.baseLanguage.collections.typesystem)", "4073682006117732271", 0, null);
      typeCheckingContext.createLessThanInequality((SNode) typeCheckingContext.typeOf(_nodeToCheck_1029348928467, "r:00000000-0000-4000-0000-011c8959032b(jetbrains.mps.baseLanguage.collections.typesystem)", "4073682006117732273", true), (SNode) new typeof_TestRemoveElementOperation_InferenceRule.QuotationClass_agfpky_a0a1a0().createNode(typeCheckingContext.getRepresentative(ELEMENT_typevar_4073682006117732270), typeCheckingContext), false, true, _info_12389875345);
    }
    {
    ...
    }
    {
      ...
      typeCheckingContext.createEquation((SNode) typeCheckingContext.typeOf(_nodeToCheck_1029348928467, "r:00000000-0000-4000-0000-011c8959032b(jetbrains.mps.baseLanguage.collections.typesystem)", "4073682006117732293", true), (SNode) new typeof_TestRemoveElementOperation_InferenceRule.QuotationClass_agfpky_a0a3a0().createNode(typeCheckingContext), _info_12389875345);
    }
  }
  ...
  public static class QuotationClass_agfpky_a0a1a0 {
    public QuotationClass_agfpky_a0a1a0() {
    }
  ...
  public static class QuotationClass_agfpky_a0a3a0 {
    public QuotationClass_agfpky_a0a3a0() {
    }
