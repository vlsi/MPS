...
public class list_type_comparableWith_List_ComparisonRule extends ComparisonRule_Runtime {
    ...
    public boolean match(SNode nodeToMatch) {
      {
        ...
        if (!("jetbrains.mps.baseLanguage.structure.ClassifierType".equals(nodeToMatch_list_type_comparableWith_List_ho857w_a0a.getConcept().getConceptId()))) {
          return false;
        }
        {
  ...
  private static SNodeReference SNODE_POINTER_ovtchh_a0a0a0a0b0c0a0a0a0a0a0f = new jetbrains.mps.smodel.SNodePointer("f:java_stub#6354ebe7-c22a-4a0f-ac54-50b52ab9b065#java.util(JDK/java.util@java_stub)", "~List");
}
