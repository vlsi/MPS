...
public class list_type_comparableWith_List_ComparisonRule extends ComparisonRule_Runtime {
  ...
  public IsApplicableStatus isApplicableSecond(SNode node) {
    {
      GeneratedMatchingPattern pattern = new Pattern_fub4907e(_quotation_createNode_ovtchh_a0a0a0a0f());
  ...
  private static SNode _quotation_createNode_ovtchh_a0a0a0a0f() {
