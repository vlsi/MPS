  ...
  public void processInequation(final SNode subtype, final SNode supertype, final EquationInfo equationInfo, final TypeCheckingContext typeCheckingContext, IsApplicable2Status status, final boolean inequalityIsWeak, final boolean inequalityIsLessThan) {
    {
      ...
      typeCheckingContext.createLessThanInequality((SNode) SLinkOperations.getTarget(subtype, MetaAdapterFactory.getContainmentLink(new UUID(-8968771020793164004l, -7182180101671965361l), 5686963296372573083l, 5686963296372573084l, "elementType")), (SNode) SLinkOperations.getTarget(SNodeOperations.as(SLinkOperations.getTarget(supertype, MetaAdapterFactory.getContainmentLink(new UUID(-8968771020793164004l, -7182180101671965361l), 5686963296372573083l, 5686963296372573084l, "elementType")), "jetbrains.mps.baseLanguage.structure.UpperBoundType"), MetaAdapterFactory.getContainmentLink(new UUID(-935030926396207931l, -6610165693999523818l), 1171903916106l, 1171903916107l, "bound")), false, true, _info_12389875345);
    }
  }
    ...
    public boolean match(SNode nodeToMatch) {
      {
        ...
        {
          SContainmentLink childRole_otuqx5_ = MetaAdapterFactory.getContainmentLink(new UUID(-8968771020793164004l, -7182180101671965361l), 5686963296372573083l, 5686963296372573084l, "elementType");
          if (!(PatternUtil.hasNChildren(nodeToMatch_otuqx5_a0a, childRole_otuqx5_, 1))) {
            return false;
          }
          {
            SNode childVar_otuqx5_a0a0 = IterableUtil.get(nodeToMatch_otuqx5_a0a.getChildren(childRole_otuqx5_), 0);
            this.patternVar_SUB = childVar_otuqx5_a0a0;
          }
        }
      }
      return true;
    ...
    public boolean match(SNode nodeToMatch) {
      {
        ...
        {
          SContainmentLink childRole_otuqx5__0 = MetaAdapterFactory.getContainmentLink(new UUID(-8968771020793164004l, -7182180101671965361l), 5686963296372573083l, 5686963296372573084l, "elementType");
          if (!(PatternUtil.hasNChildren(nodeToMatch_otuqx5_a0a_0, childRole_otuqx5__0, 1))) {
            return false;
          }
          {
            SNode childVar_otuqx5_a0a0_0 = IterableUtil.get(nodeToMatch_otuqx5_a0a_0.getChildren(childRole_otuqx5__0), 0);
            this.patternVar_SUPER = childVar_otuqx5_a0a0_0;
          }
        }
      }
      return true;
