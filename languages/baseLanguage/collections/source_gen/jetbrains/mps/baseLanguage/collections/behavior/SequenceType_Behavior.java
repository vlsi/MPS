...
public class SequenceType_Behavior {
  ...
  public static List<SNode> virtual_getAbstractCreators_1226945293888(SNode thisNode) {
    ...
    SNode seqCreator = SConceptOperations.createNewNode(SNodeOperations.asInstanceConcept(MetaAdapterFactory.getConcept(new UUID(-8968771020793164004l, -7182180101671965361l), 1224414427926l, "jetbrains.mps.baseLanguage.collections.structure.SequenceCreator")));
    ...
    SNode singCreator = SConceptOperations.createNewNode(SNodeOperations.asInstanceConcept(MetaAdapterFactory.getConcept(new UUID(-8968771020793164004l, -7182180101671965361l), 1235573135402l, "jetbrains.mps.baseLanguage.collections.structure.SingletonSequenceCreator")));
