...
public class HeadListOperation_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createComponent_v360wx_a0(EditorContext editorContext, SNode node) {
    ...
    editorCell.setSubstituteInfo(new CompositeSubstituteInfo(editorContext, new BasicCellContext(node), new SubstituteInfoPartExt[]{new HeadListOperation_Editor.ReplaceWith_IOperation_cellMenu_v360wx_a0a0(), new SChildSubstituteInfoPartEx(editorCell)}));
    return editorCell;
  }
