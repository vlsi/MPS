    ...
    public boolean match(SNode nodeToMatch) {
      {
        ...
        if (!("jetbrains.mps.baseLanguage.structure.ClassifierType".equals(nodeToMatch_sequence_type_comparableWith_Iterable_wnlwmt_a0a.getConcept().getConceptId()))) {
          return false;
        }
        {
          SNodePointer pointer = SNODE_POINTER_sh3asd_a0a0a0a0b0c0a0a0a0a0a0f;
        ...
        }
        {
          ...
          {
            SNode childVar_sequence_type_comparableWith_Iterable_wnlwmt_a0a0 = nodeToMatch_sequence_type_comparableWith_Iterable_wnlwmt_a0a.getChildren(childRole_sequence_type_comparableWith_Iterable_wnlwmt_).iterator().next();
