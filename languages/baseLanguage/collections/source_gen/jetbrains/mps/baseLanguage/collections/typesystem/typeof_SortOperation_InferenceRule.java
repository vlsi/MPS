...
public class typeof_SortOperation_InferenceRule extends AbstractInferenceRule_Runtime implements InferenceRule_Runtime {
  ...
  public void applyRule(final SNode so, final TypeCheckingContext typeCheckingContext, IsApplicableStatus status) {
    final SNode paramType_typevar_1205680579640 = typeCheckingContext.createNewRuntimeTypesVariable();
    {
      ...
      typeCheckingContext.createGreaterThanInequality((SNode) _quotation_createNode_6zmwfs_a0b0a(typeCheckingContext.getRepresentative(paramType_typevar_1205680579640)), (SNode) typeCheckingContext.typeOf(_nodeToCheck_1029348928467, "r:00000000-0000-4000-0000-011c8959032b(jetbrains.mps.baseLanguage.collections.typesystem)", "1225885283625", true), false, true, _info_12389875345);
    }
    if (!(typeCheckingContext.isSingleTypeComputation())) {
      {
        ...
        typeCheckingContext.createLessThanInequality((SNode) typeCheckingContext.typeOf(_nodeToCheck_1029348928467, "r:00000000-0000-4000-0000-011c8959032b(jetbrains.mps.baseLanguage.collections.typesystem)", "1205680514461", true), (SNode) _quotation_createNode_6zmwfs_a0c0a(typeCheckingContext.getRepresentative(paramType_typevar_1205680579640)), true, true, _info_12389875345);
      }
    }
    // todo: unmeet closure 
    if (!(typeCheckingContext.isSingleTypeComputation())) {
      {
        ...
        typeCheckingContext.createLessThanInequality((SNode) typeCheckingContext.typeOf(_nodeToCheck_1029348928467, "r:00000000-0000-4000-0000-011c8959032b(jetbrains.mps.baseLanguage.collections.typesystem)", "1205680791173", true), (SNode) _quotation_createNode_6zmwfs_a0e0a(), true, true, _info_12389875345);
      }
    }
    {
      ...
      typeCheckingContext.createEquation((SNode) typeCheckingContext.typeOf(_nodeToCheck_1029348928467, "r:00000000-0000-4000-0000-011c8959032b(jetbrains.mps.baseLanguage.collections.typesystem)", "1205737511200", true), (SNode) _quotation_createNode_6zmwfs_a0f0a(typeCheckingContext.getRepresentative(paramType_typevar_1205680579640)), _info_12389875345);
    }
  }
  ...
  private static SNode _quotation_createNode_6zmwfs_a0b0a(Object parameter_1) {
  ...
  private static SNode _quotation_createNode_6zmwfs_a0c0a(Object parameter_1) {
    SNode quotedNode_2 = null;
    SNode quotedNode_3 = null;
  ...
  private static SNode _quotation_createNode_6zmwfs_a0e0a() {
  ...
  private static SNode _quotation_createNode_6zmwfs_a0f0a(Object parameter_1) {
    SNode quotedNode_2 = null;
    SNode quotedNode_3 = null;
    quotedNode_2 = SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.baseLanguage.collections.structure.SequenceType", null, null, GlobalScope.getInstance(), false);
    quotedNode_3 = (SNode) parameter_1;
