...
public class supertypesOf_ClassifierType_Collection_SubtypingRule extends SubtypingRule_Runtime implements ISubtypingRule_Runtime {
  ...
  public SNode getSubOrSuperType(SNode ct, TypeCheckingContext typeCheckingContext, IsApplicableStatus status) {
    return new supertypesOf_ClassifierType_Collection_SubtypingRule.QuotationClass_832k9i_a0a0a().createNode(((SNode) status.getPattern().getFieldValue("patternVar_ELEMENT")), typeCheckingContext);
  }
  ...
  public static class QuotationClass_832k9i_a0a0a {
    public QuotationClass_832k9i_a0a0a() {
    }
