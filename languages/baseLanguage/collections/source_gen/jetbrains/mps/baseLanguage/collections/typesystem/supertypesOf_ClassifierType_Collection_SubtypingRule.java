...
public class supertypesOf_ClassifierType_Collection_SubtypingRule extends SubtypingRule_Runtime implements ISubtypingRule_Runtime {
  ...
  public SNode getSubOrSuperType(SNode ct, TypeCheckingContext typeCheckingContext, IsApplicableStatus status) {
    return _quotation_createNode_832k9i_a0a2(status.getPattern().getMatchedNode("ELEMENT"));
  }
  ...
  public IsApplicableStatus isApplicableAndPattern(SNode argument) {
    {
      GeneratedMatchingPattern pattern = new Pattern_nbq1ucdxxmi7(_quotation_createNode_832k9i_a0a0a0a0e());
  ...
  private static SNode _quotation_createNode_832k9i_a0a0a0a0e() {
    PersistenceFacade facade = PersistenceFacade.getInstance();
