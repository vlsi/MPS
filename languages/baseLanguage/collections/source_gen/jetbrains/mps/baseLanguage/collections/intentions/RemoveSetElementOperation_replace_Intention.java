...
public class RemoveSetElementOperation_replace_Intention extends BaseIntention {
  ...
  public SNodeReference getIntentionNodeReference() {
    return new SNodePointer("r:2058b266-ad9c-45a1-bf9f-8bf4c09ab223(jetbrains.mps.baseLanguage.collections.intentions@3_0)", "4863683935051453872");
  }
  ...
  public void execute(final SNode node, final EditorContext editorContext) {
    SNodeOperations.replaceWithAnother(node, new RemoveSetElementOperation_replace_Intention.QuotationClass_wpx8v9_a1a0a8().createNode(SNodeOperations.copyNode(SLinkOperations.getTarget(node, "argument", true))));
  }

  public static class QuotationClass_wpx8v9_a1a0a8 {
    public QuotationClass_wpx8v9_a1a0a8() {
    }
