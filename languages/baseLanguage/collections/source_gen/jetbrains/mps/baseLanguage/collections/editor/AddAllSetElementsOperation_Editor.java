...
public class AddAllSetElementsOperation_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createConstant_az6if3_a0(EditorContext editorContext, SNode node) {
    EditorCell_Constant editorCell = new EditorCell_Constant((jetbrains.mps.nodeEditor.EditorContext) editorContext, node, "addAll");
    ...
    editorCell.setSubstituteInfo(new CompositeSubstituteInfo(editorContext, new BasicCellContext(node), new SubstituteInfoPartExt[]{new AddAllSetElementsOperation_Editor.ReplaceWith_SequenceOperation_cellMenu_a0a0_11()}));
    return editorCell;
  }
  ...
  public static class ReplaceWith_SequenceOperation_cellMenu_a0a0_11 extends AbstractCellMenuPart_ReplaceNode_CustomNodeConcept {
    public ReplaceWith_SequenceOperation_cellMenu_a0a0_11() {
    }
