...
public class supertypesOf_ClassifierType_Queue_QueueType_SubtypingRule extends SubtypingRule_Runtime implements ISubtypingRule_Runtime {
    ...
    public boolean match(SNode nodeToMatch) {
      {
        ...
        if (!(MetaAdapterFactory.getConcept(0xf3061a5392264cc5L, 0xa443f952ceaf5816L, 0x101de48bf9eL, "jetbrains.mps.baseLanguage.structure.ClassifierType").equals(nodeToMatch_jsixhd_a0a.getConcept()))) {
          return false;
        }
        {
          SNodeReference pointer = SNODE_POINTER_4viu4b_a0a0a0a0b0b0a0b0a0a0a0e;
  ...
  private static SNodePointer SNODE_POINTER_4viu4b_a0a0a0a0b0b0a0b0a0a0a0e = new SNodePointer("6354ebe7-c22a-4a0f-ac54-50b52ab9b065/f:java_stub#6354ebe7-c22a-4a0f-ac54-50b52ab9b065#java.util(JDK/java.util@java_stub)", "~Queue");
}
