...
public class BinaryOperation_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createComponent_tdrdn7_a0(EditorContext editorContext, SNode node) {
    ...
    editorCell.setSubstituteInfo(new CompositeSubstituteInfo(editorContext, new BasicCellContext(node), new SubstituteInfoPartExt[]{new BinaryOperation_Editor.ReplaceWith_SequenceOperation_cellMenu_a0a0_2()}));
    return editorCell;
  }
