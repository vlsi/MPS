...
public class SubSetOperation_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createConceptProperty_og2bir_a0(EditorContext editorContext, SNode node) {
    ...
    editorCell.setSubstituteInfo(new CompositeSubstituteInfo(editorContext, provider.getCellContext(), new SubstituteInfoPartExt[]{new SubSetOperation_Editor.ReplaceWith_SequenceOperation_cellMenu_a0a0_17()}));
    SNode attributeConcept = provider.getRoleAttribute();
    Class attributeKind = provider.getRoleAttributeClass();
    if (attributeConcept != null) {
      IOperationContext opContext = editorContext.getOperationContext();
