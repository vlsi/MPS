...
public class TypecheckingErrors_Test extends BaseTransformationTest4 {
  ...
  public static class TestBody extends BaseTestBody {
    ...
    public void test_lbt_subtypeof_param() throws Exception {
      ...
      this.addNodeById("360223900466871399");
      this.addNodeById("5532302989585163343");
      SubtreeChecker.checkNodeForErrors(SNodeOperations.cast(this.getNodeById("360223900466887047"), "jetbrains.mps.baseLanguage.structure.InstanceMethodDeclaration"));
    }
    ...
    public void test_meet_with_variable_excluded_from_lcs() throws Exception {
      ...
      this.addNodeById("360223900466871399");
      this.addNodeById("5532302989585163343");
      SubtreeChecker.checkNodeForErrors(SNodeOperations.cast(this.getNodeById("6368058149914761648"), "jetbrains.mps.baseLanguage.structure.InstanceMethodDeclaration"));
    }
  }
}
