...
import jetbrains.mps.intentions.BaseIntentionFactory;
...
import jetbrains.mps.intentions.TreeTransformer;
import java.util.Collection;
import jetbrains.mps.internal.collections.runtime.CollectionSequence;
import java.util.ArrayList;

public class ConvertIntention extends BaseIntentionFactory {
  ...
  public TreeTransformerFactory.Priority getPriority() {
    return TreeTransformerFactory.Priority.NORMAL;
  }
  ...
  public Iterable<TreeTransformer> getTreeTransformers(SNode node, EditorContext editorContext) {
    Collection<TreeTransformer> result = CollectionSequence.fromCollection(new ArrayList<TreeTransformer>());
    CollectionSequence.fromCollection(result).addElement(new TreeTransformer() {
      public void execute(SNode node, EditorContext editorContext) {
      ...
      public TreeTransformerFactory getFactory() {
