  ...
  public LanguageAspectDescriptor get() {
    return new LanguageAspectDescriptor() {
      ...
      public Collection<SLanguage> getMainLanguages() {
        return ListSequence.fromListAndArray(new ArrayList<SLanguage>(), MetaAdapterFactory.getLanguage(MetaIdFactory.langId(0xd7a92d38f7db40d0L, 0x8431763b0c3c9f20L), "jetbrains.mps.lang.intentions"));
      }
      @Nullable
      ...
      public String getHelpUrl() {
        return "http://confluence.jetbrains.com/display/MPSD33/Intentions";
      }
      ...
      private final Icon ICON = IconResourceBundle_IntentionsAspect.getInstance().getResource("INTENTINSMODEL");
