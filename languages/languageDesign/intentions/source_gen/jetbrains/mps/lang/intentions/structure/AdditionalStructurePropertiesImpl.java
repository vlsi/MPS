...
public class AdditionalStructurePropertiesImpl extends ConceptPresentationAspectBase {
  ...
  private final ConceptPresentation props_Intention = new ConceptPresentationBuilder().icon("intentionBulb.png", AdditionalStructurePropertiesImpl.class).create();
  private final ConceptPresentation props_IntentionDeclaration = new ConceptPresentationBuilder().icon("intentionBulb.png", AdditionalStructurePropertiesImpl.class).create();
  ...
  private final ConceptPresentation
      props_SurroundWithIntentionDeclaration = new ConceptPresentationBuilder().icon("surroundWithIntention.png", AdditionalStructurePropertiesImpl.class).create();
