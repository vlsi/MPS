...
<model ref="r:dbde341a-c09d-4dfc-8b0a-5ed08f460369(jetbrains.mps.lang.intentions.plugin)">
  ...
  <node concept="3vrhyV" id="2LiUEk8oQ$g">
    ...
    <node concept="3vrm2R" id="2LiUEk8oQ$h" role="3vrhxp">
      <node concept="2V$Bhx" id="7XWR6$5i3OC" role="2V$M_3">
    ...
    <node concept="1QGGSu" id="4lJsQ5yF4MG" role="3vqPLo">
      <node concept="1QGGTA" id="P5ZkC6w5e5" role="3xaMm5">
        <node concept="1QGGSu" id="P5ZkC6w5e7" role="1QGGTw">
          <property role="1QGGTI" value="${module}/icons/intentionsModel.png" />
        </node>
      </node>
    </node>
    <node concept="1sEMCm" id="4lJsQ5yF8Ox" role="1sFm88">
      <property role="1sEMCp" value="http://confluence.jetbrains.com/display/MPSD33/Intentions" />
    </node>
  </node>
</model>
