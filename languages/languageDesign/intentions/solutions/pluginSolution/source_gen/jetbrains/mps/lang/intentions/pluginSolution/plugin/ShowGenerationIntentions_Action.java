...
public class ShowGenerationIntentions_Action extends BaseAction {
  ...
  protected static Log log = LogFactory.getLog(ShowGenerationIntentions_Action.class);
  ...
  public boolean isApplicable(AnActionEvent event, final Map<String, Object> _params) {
    ActionGroup group = ((BaseGroup) ActionManager.getInstance().getAction("jetbrains.mps.lang.intentions.pluginSolution.plugin.GenerationIntentions_ActionGroup"));
    group.update(event);
