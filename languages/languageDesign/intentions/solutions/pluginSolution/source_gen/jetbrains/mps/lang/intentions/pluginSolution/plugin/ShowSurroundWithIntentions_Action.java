...
public class ShowSurroundWithIntentions_Action extends BaseAction {
  ...
  public boolean isApplicable(AnActionEvent event, final Map<String, Object> _params) {
    ...
    ActionGroup group = ((BaseGroup) ActionManager.getInstance().getAction("jetbrains.mps.lang.intentions.pluginSolution.plugin.SurroundWithIntentions_ActionGroup"));
    group.update(event);
