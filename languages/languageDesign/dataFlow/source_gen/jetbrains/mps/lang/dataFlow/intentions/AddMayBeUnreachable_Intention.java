...
public class AddMayBeUnreachable_Intention implements IntentionFactory {
  ...
  public class IntentionImplementation implements IntentionExecutable {
    ...
    public void execute(final SNode node, final EditorContext editorContext) {
      SNode result = SNodeFactoryOperations.createNewNode(SNodeFactoryOperations.asInstanceConcept(MetaAdapterFactory.getConcept(new UUID(9196683164725627254l, -5405980172761227084l), 1206534235764l, "jetbrains.mps.lang.dataFlow.structure.EmitMayBeUnreachable")), null);
