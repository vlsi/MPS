...
<model ref="r:4c5ac278-3ad7-4902-ab86-6c60b350f168(jetbrains.mps.lang.customAspect.generator.template.main@generator)">
  ...
  <node concept="320BPa" id="2Y$EcRKO3dK">
    ...
    <node concept="30mAcN" id="2Y$EcRKO3dM" role="lGtFl">
      <ref role="30mx6e" to="9n97:ghIDlF6CZM" resolve="LanguageAspect" />
    </node>
                  ...
                  <node concept="3NFfHV" id="2Y$EcRKOnYX" role="xEYEz">
                    <node concept="3clFbS" id="2Y$EcRKOnYY" role="2VODD2">
                      <node concept="3clFbF" id="2Y$EcRKOo08" role="3cqZAp">
                        <node concept="2OqwBi" id="2Y$EcRKOo2_" role="3clFbG">
                          <node concept="30H73N" id="2Y$EcRKOo07" role="2Oq$k0" />
                          <node concept="3TrEf2" id="2Y$EcRKOojO" role="2OqNvi">
                            <ref role="3Tt5mk" to="hfbu:2Y$EcRKMr2k" />
                          </node>
                        </node>
                      </node>
                    </node>
    ...
    <node concept="2tJIrI" id="2Y$EcRKO3ef" role="jymVt" />
