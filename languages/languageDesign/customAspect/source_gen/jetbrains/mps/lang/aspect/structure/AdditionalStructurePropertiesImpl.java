...
public class AdditionalStructurePropertiesImpl extends BaseAdditionalStructureProperties {
  private final AdditionalConceptProperties props_AspectMethodDescriptor = new ConceptPropsBuilder().create();
  private final AdditionalConceptProperties props_GenerationDescriptor = new ConceptPropsBuilder().create();
  private final AdditionalConceptProperties props_GenerationDescriptor_ByInterface = new ConceptPropsBuilder().create();
  private final AdditionalConceptProperties props_GenerationDescriptor_Class = new ConceptPropsBuilder().create();
  private final AdditionalConceptProperties props_HelpURL = new ConceptPropsBuilder().create();
  private final AdditionalConceptProperties props_IAspectConcept = new ConceptPropsBuilder().create();
  private final AdditionalConceptProperties props_LanguageAspectDescriptor = new ConceptPropsBuilder().create();
  private final AdditionalConceptProperties props_LanguageReference = new ConceptPropsBuilder().create();
  private final AdditionalConceptProperties props_SimpleLanguageAspectDescriptor = new ConceptPropsBuilder().deprecated(MetaAdapterFactory.getProperty(0xf159adf43c9340f9L, 0x9c5a1f245a8697afL, 0x2fa4a8cdf0c9b076L, 0x2fa4a8cdf0c9b099L, "helpUrl")).create();
