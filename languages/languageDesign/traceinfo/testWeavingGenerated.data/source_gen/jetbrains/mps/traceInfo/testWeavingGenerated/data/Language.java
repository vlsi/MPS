...
import jetbrains.mps.traceInfo.testWeavingGenerated.data.typesystem.TypesystemDescriptor;

public class Language extends LanguageRuntime {
  private static final Logger LOG = LogManager.getLogger(jetbrains.mps.smodel.Language.class);
  public static final String MODULE_REF = "ce517356-fc9a-4e78-8606-6e7a36ff0671(jetbrains.mps.traceInfo.testWeavingGenerated.data)";
  public Language() {
  }
  @Override
  ...
  public SLanguageId getId() {
    return new SLanguageId(UUID.fromString("ce517356-fc9a-4e78-8606-6e7a36ff0671"));
  }
  @Override
    ...
    try {
      if (aspectClass.getName().equals("jetbrains.mps.smodel.runtime.BehaviorAspectDescriptor")) {
        if (aspectClass == BehaviorAspectDescriptor.class) {
          return (T) new jetbrains.mps.traceInfo.testWeavingGenerated.data.behavior.BehaviorAspectDescriptor();
        }
      }
      if (aspectClass.getName().equals("jetbrains.mps.smodel.runtime.ConstraintsAspectDescriptor")) {
        if (aspectClass == ConstraintsAspectDescriptor.class) {
          return (T) new jetbrains.mps.traceInfo.testWeavingGenerated.data.constraints.ConstraintsAspectDescriptor();
        }
      }
