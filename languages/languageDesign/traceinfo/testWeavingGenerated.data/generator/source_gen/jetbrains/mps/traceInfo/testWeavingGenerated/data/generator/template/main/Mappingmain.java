...
public class Mappingmain implements TemplateMappingConfiguration {
  ...
  public class WeavingRule0 implements TemplateWeavingRule {
    ...
    public SNode getContextNode(TemplateExecutionEnvironment environment, TemplateContext context) {
      return QueriesGenerated.weaving_MappingRule_ContextNodeQuery_6186432342008490339(new WeavingMappingRuleContext(context.getInput(), weavingRule_417xrn_a0a1t, environment.getGenerator()));
    }
    ...
    public boolean apply(final TemplateExecutionEnvironment environment, final TemplateContext context, final SNode outputContextNode) throws GenerationException {
      ...
      Iterable<SNode> weaveEachList1 = QueriesGenerated.sourceNodesQuery_6186432342008490342(new SourceSubstituteMacroNodesContext(context.getInput(), weavingConseq_417xrn_a0a1a6t, null, context, environment.getGenerator()));
  ...
  public class WeavingRule1 implements TemplateWeavingRule {
    ...
    public SNode getContextNode(TemplateExecutionEnvironment environment, TemplateContext context) {
      return QueriesGenerated.weaving_MappingRule_ContextNodeQuery_6186432342008522529(new WeavingMappingRuleContext(context.getInput(), weavingRule_417xrn_a0a1u, environment.getGenerator()));
    }

    public boolean apply(final TemplateExecutionEnvironment environment, final TemplateContext context, final SNode outputContextNode) throws GenerationException {
      final List<SNode> tlist1 = new ArrayList<SNode>();
      environment.getTracer().pushRuleConsequence(weavingConseq_417xrn_a0a1a6u);
      Iterable<SNode> weaveEachList1 = QueriesGenerated.sourceNodesQuery_6186432342008522532(new SourceSubstituteMacroNodesContext(context.getInput(), weavingConseq_417xrn_a0a1a6u, null, context, environment.getGenerator()));
      for (SNode itnode1 : weaveEachList1) {
        if (itnode1 == null) {
          continue;
        }
  ...
  public class WeavingRule2 implements TemplateWeavingRule {
    ...
    public SNode getContextNode(TemplateExecutionEnvironment environment, TemplateContext context) {
      return QueriesGenerated.weaving_MappingRule_ContextNodeQuery_6186432342008533384(new WeavingMappingRuleContext(context.getInput(), weavingRule_417xrn_a0a1v, environment.getGenerator()));
    }

    public boolean apply(final TemplateExecutionEnvironment environment, final TemplateContext context, final SNode outputContextNode) throws GenerationException {
      final List<SNode> tlist1 = new ArrayList<SNode>();
      environment.getTracer().pushRuleConsequence(weavingConseq_417xrn_a0a1a6v);
      Iterable<SNode> weaveEachList1 = QueriesGenerated.sourceNodesQuery_6186432342008533377(new SourceSubstituteMacroNodesContext(context.getInput(), weavingConseq_417xrn_a0a1a6v, null, context, environment.getGenerator()));
      for (SNode itnode1 : weaveEachList1) {
        if (itnode1 == null) {
          continue;
        }
  ...
  public class WeavingRule3 implements TemplateWeavingRule {
    ...
    public SNode getContextNode(TemplateExecutionEnvironment environment, TemplateContext context) {
      return QueriesGenerated.weaving_MappingRule_ContextNodeQuery_6186432342008533368(new WeavingMappingRuleContext(context.getInput(), weavingRule_417xrn_a0a1w, environment.getGenerator()));
    }

    public boolean apply(final TemplateExecutionEnvironment environment, final TemplateContext context, final SNode outputContextNode) throws GenerationException {
      final List<SNode> tlist1 = new ArrayList<SNode>();
      environment.getTracer().pushRuleConsequence(weavingConseq_417xrn_a0a1a6w);
      Iterable<SNode> weaveEachList1 = QueriesGenerated.sourceNodesQuery_6186432342008533362(new SourceSubstituteMacroNodesContext(context.getInput(), weavingConseq_417xrn_a0a1a6w, null, context, environment.getGenerator()));
      for (SNode itnode1 : weaveEachList1) {
        if (itnode1 == null) {
          continue;
        }
