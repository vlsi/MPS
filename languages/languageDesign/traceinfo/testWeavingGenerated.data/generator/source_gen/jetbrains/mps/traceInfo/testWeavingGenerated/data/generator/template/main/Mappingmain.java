...
public class Mappingmain implements TemplateMappingConfiguration {
  ...
  public class WeavingRule0 implements TemplateWeavingRule {
    ...
    public boolean apply(final TemplateExecutionEnvironment environment, final TemplateContext context, final SNode outputContextNode) throws GenerationException {
      ...
      Iterable<SNode> weaveEachList1 = QueriesGenerated.sourceNodesQuery_6186432342008490342(environment.getOperationContext(), new SourceSubstituteMacroNodesContext(context, weavingConseq_417xrn_a0a1a6t, null, environment.getGenerator()));
  ...
  public class WeavingRule1 implements TemplateWeavingRule {
    ...
    public boolean apply(final TemplateExecutionEnvironment environment, final TemplateContext context, final SNode outputContextNode) throws GenerationException {
      ...
      Iterable<SNode> weaveEachList1 = QueriesGenerated.sourceNodesQuery_6186432342008522532(environment.getOperationContext(), new SourceSubstituteMacroNodesContext(context, weavingConseq_417xrn_a0a1a6u, null, environment.getGenerator()));
      for (SNode itnode1 : weaveEachList1) {
        if (itnode1 == null) {
          continue;
        }
  ...
  public class WeavingRule3 implements TemplateWeavingRule {
    ...
    public boolean apply(final TemplateExecutionEnvironment environment, final TemplateContext context, final SNode outputContextNode) throws GenerationException {
      ...
      Iterable<SNode> weaveEachList1 = QueriesGenerated.sourceNodesQuery_6186432342008533362(environment.getOperationContext(), new SourceSubstituteMacroNodesContext(context, weavingConseq_417xrn_a0a1a6w, null, environment.getGenerator()));
      for (SNode itnode1 : weaveEachList1) {
        if (itnode1 == null) {
          continue;
        }
