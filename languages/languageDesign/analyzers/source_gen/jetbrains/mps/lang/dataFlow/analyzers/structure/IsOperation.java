...
public class IsOperation extends Expression {
  public static final String concept = "jetbrains.mps.lang.dataFlow.analyzers.structure.IsOperation";
  ...
  public static IsOperation newInstance(SModel sm, boolean init) {
    return (IsOperation) SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.lang.dataFlow.analyzers.structure.IsOperation", sm, GlobalScope.getInstance(), init).getAdapter();
  }
