...
public class Rule extends BaseConcept implements INamedConcept {
  public static final String concept = "jetbrains.mps.lang.dataFlow.analyzers.structure.Rule";
  ...
  public static Rule newInstance(SModel sm, boolean init) {
    return (Rule) SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.lang.dataFlow.analyzers.structure.Rule", sm, GlobalScope.getInstance(), init).getAdapter();
  }
