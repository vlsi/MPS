...
public class EmitInstruction extends ActionStatement {
  public static final String concept = "jetbrains.mps.lang.dataFlow.analyzers.structure.EmitInstruction";
  ...
  public static EmitInstruction newInstance(SModel sm, boolean init) {
    return (EmitInstruction) SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.lang.dataFlow.analyzers.structure.EmitInstruction", sm, GlobalScope.getInstance(), init).getAdapter();
  }
