...
public class PatternCondition extends ApplicableCondition {
  public static final String concept = "jetbrains.mps.lang.dataFlow.analyzers.structure.PatternCondition";
  ...
  public static PatternCondition newInstance(SModel sm, boolean init) {
    return (PatternCondition) SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.lang.dataFlow.analyzers.structure.PatternCondition", sm, GlobalScope.getInstance(), init).getAdapter();
  }
