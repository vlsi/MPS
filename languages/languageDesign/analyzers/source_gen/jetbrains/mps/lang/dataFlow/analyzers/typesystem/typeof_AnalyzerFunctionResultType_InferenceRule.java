  ...
  public void applyRule(final SNode resultType, final TypeCheckingContext typeCheckingContext, IsApplicableStatus status) {
    {
      ...
      typeCheckingContext.createEquation((SNode) SLinkOperations.getTarget(SNodeOperations.getAncestor(resultType, "jetbrains.mps.lang.dataFlow.analyzers.structure.Analyzer", false, false), "latticeElementType", true), (SNode) resultType, _info_12389875345);
    }
  }
