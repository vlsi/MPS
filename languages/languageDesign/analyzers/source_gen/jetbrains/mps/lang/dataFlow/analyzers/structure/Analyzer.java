...
public class Analyzer extends BaseConcept implements INamedConcept {
  public static final String concept = "jetbrains.mps.lang.dataFlow.analyzers.structure.Analyzer";
  ...
  public static Analyzer newInstance(SModel sm, boolean init) {
    return (Analyzer) SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.lang.dataFlow.analyzers.structure.Analyzer", sm, GlobalScope.getInstance(), init).getAdapter();
  }
