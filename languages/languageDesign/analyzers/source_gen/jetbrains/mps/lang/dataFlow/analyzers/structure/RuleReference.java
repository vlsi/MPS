...
public class RuleReference extends BaseConcept {
  public static final String concept = "jetbrains.mps.lang.dataFlow.analyzers.structure.RuleReference";
  ...
  public static RuleReference newInstance(SModel sm, boolean init) {
    return (RuleReference) SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.lang.dataFlow.analyzers.structure.RuleReference", sm, GlobalScope.getInstance(), init).getAdapter();
  }
