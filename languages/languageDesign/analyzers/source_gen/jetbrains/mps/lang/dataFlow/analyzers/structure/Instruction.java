...
public class Instruction extends BaseConcept implements INamedConcept {
  public static final String concept = "jetbrains.mps.lang.dataFlow.analyzers.structure.Instruction";
  ...
  public static Instruction newInstance(SModel sm, boolean init) {
    return (Instruction) SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.lang.dataFlow.analyzers.structure.Instruction", sm, GlobalScope.getInstance(), init).getAdapter();
  }
