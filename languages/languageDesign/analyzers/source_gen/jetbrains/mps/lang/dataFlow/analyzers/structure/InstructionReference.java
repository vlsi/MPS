...
public class InstructionReference extends BaseConcept {
  public static final String concept = "jetbrains.mps.lang.dataFlow.analyzers.structure.InstructionReference";
  ...
  public static InstructionReference newInstance(SModel sm, boolean init) {
    return (InstructionReference) SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.lang.dataFlow.analyzers.structure.InstructionReference", sm, GlobalScope.getInstance(), init).getAdapter();
  }
