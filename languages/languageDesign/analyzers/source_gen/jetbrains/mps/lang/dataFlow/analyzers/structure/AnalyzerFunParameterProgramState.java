...
public class AnalyzerFunParameterProgramState extends ConceptFunctionParameter {
  public static final String concept = "jetbrains.mps.lang.dataFlow.analyzers.structure.AnalyzerFunParameterProgramState";
  ...
  public static AnalyzerFunParameterProgramState newInstance(SModel sm, boolean init) {
    return (AnalyzerFunParameterProgramState) SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.lang.dataFlow.analyzers.structure.AnalyzerFunParameterProgramState", sm, GlobalScope.getInstance(), init).getAdapter();
  }
