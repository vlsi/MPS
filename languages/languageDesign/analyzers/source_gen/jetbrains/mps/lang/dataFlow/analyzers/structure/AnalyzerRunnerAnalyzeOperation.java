...
public class AnalyzerRunnerAnalyzeOperation extends BaseConcept implements IOperation {
  public static final String concept = "jetbrains.mps.lang.dataFlow.analyzers.structure.AnalyzerRunnerAnalyzeOperation";
  ...
  public static AnalyzerRunnerAnalyzeOperation newInstance(SModel sm, boolean init) {
    return (AnalyzerRunnerAnalyzeOperation) SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.lang.dataFlow.analyzers.structure.AnalyzerRunnerAnalyzeOperation", sm, GlobalScope.getInstance(), init).getAdapter();
  }
