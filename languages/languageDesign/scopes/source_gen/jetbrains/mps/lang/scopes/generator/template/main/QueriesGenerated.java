...
public class QueriesGenerated {
  public static Object referenceMacro_GetReferent_8077936094962965172(final IOperationContext operationContext, final ReferenceMacroContext _context) {
    return SLinkOperations.getTarget(SLinkOperations.getTarget(_context.getNode(), "link", false), "target", false);
  }

  public static Object referenceMacro_GetReferent_8077936094962965254(final IOperationContext operationContext, final ReferenceMacroContext _context) {
    return SLinkOperations.getTarget(_context.getNode(), "link", false);
  }

  public static Object referenceMacro_GetReferent_8077936094962965339(final IOperationContext operationContext, final ReferenceMacroContext _context) {
    return SLinkOperations.getTarget(SLinkOperations.getTarget(_context.getNode(), "link", false), "target", false);
  }

  public static Object referenceMacro_GetReferent_8077936094962965348(final IOperationContext operationContext, final ReferenceMacroContext _context) {
    return SLinkOperations.getTarget(_context.getNode(), "link", false);
  }
