...
<model ref="r:e9b03271-b52a-47ee-a82c-3d061109bb59(jetbrains.mps.lang.actions.plugin)">
  ...
  <node concept="3vrhyV" id="2LiUEk8oQ$g">
    ...
    <node concept="3vrm2R" id="2LiUEk8oQ$h" role="3vrhxp">
      <node concept="2V$Bhx" id="qmfyRQP9Gz" role="2V$M_3">
    ...
    <node concept="1QGGSu" id="4lJsQ5yF4MG" role="3vqPLo">
      <node concept="1QGGTA" id="P5ZkC6vTg0" role="3xaMm5">
        <node concept="1QGGSu" id="P5ZkC6vTg2" role="1QGGTw">
          <property role="1QGGTI" value="${module}/icons/actionsModel.png" />
        </node>
      </node>
    </node>
    <node concept="1sEMCm" id="4lJsQ5yF8Ox" role="1sFm88">
      <property role="1sEMCp" value="http://confluence.jetbrains.com/display/MPSD33/Editor+Actions" />
    </node>
  </node>
</model>
