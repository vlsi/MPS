...
public class QueryFunction_IconNode_Behavior {
  ...
  public static List<SNode> virtual_getParameters_1213877374450(SNode thisNode) {
    ...
    if (SNodeOperations.isInstanceOf(SNodeOperations.getParent(thisNode), MetaAdapterFactory.getConcept(new UUID(-5842916035344972280l, -5840605745428443715l), 1177323652379l, "jetbrains.mps.lang.actions.structure.SubstituteMenuPart"))) {
