...
/*package*/ class NF_Model_CreateNewRootNodeOperation_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createRefCell_w725d4_c0() {
    ...
    provider.setAuxiliaryCellProvider(new NF_Model_CreateNewRootNodeOperation_EditorBuilder_a._Inline_w725d4_a2a());
  ...
  public static class _Inline_w725d4_a2a extends InlineCellProvider {
    ...
    public EditorCell createEditorCell(EditorContext editorContext, SNode node) {
      ...
      return new NF_Model_CreateNewRootNodeOperation_EditorBuilder_a.Inline_Builder_w725d4_a2a(editorContext, getRefNode(), node).createCell();
    }
  }
  ...
  private class prototypeSingleRoleHandler_w725d4_e0 extends SingleRoleCellProvider {
    ...
    private void installCellInfo(SNode child, EditorCell editorCell) {
      if (editorCell.getSubstituteInfo() == null || editorCell.getSubstituteInfo() instanceof DefaultSubstituteInfo) {
        editorCell.setSubstituteInfo(new OldNewCompositeSubstituteInfo(getEditorContext(), new SChildSubstituteInfo(editorCell, getNode(), MetaAdapterFactory.getContainmentLink(0xaee9cad2acd44608L, 0xaef20004f6a1cdbdL, 0x4c0fd74709e9f70cL, 0x3425402a54bf52e8L, "prototype"), child), new DefaultChildSubstituteInfo(getNode(), myContainmentLink.getDeclarationNode(), getEditorContext())));
      }
      if (editorCell.getRole() == null) {
