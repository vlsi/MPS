...
public class AdditionalStructurePropertiesImpl extends ConceptPresentationAspectBase {
  ...
  private final ConceptPresentation props_NodeFactories = new ConceptPresentationBuilder().icon("nodeFactories.png", AdditionalStructurePropertiesImpl.class).create();
  ...
  private final ConceptPresentation props_NodeSubstituteActions = new ConceptPresentationBuilder().icon("actions.png", AdditionalStructurePropertiesImpl.class).create();
  ...
  private final ConceptPresentation props_PasteWrappers = new ConceptPresentationBuilder().icon("pasteWrapper.png", AdditionalStructurePropertiesImpl.class).create();
  ...
  private final ConceptPresentation
      props_SideTransformHintSubstituteActions = new ConceptPresentationBuilder().icon("rightTransform.png", AdditionalStructurePropertiesImpl.class).create();
  ...
  private final ConceptPresentation props_SmartEditorActions = new ConceptPresentationBuilder().icon("smartActions.png", AdditionalStructurePropertiesImpl.class).create();
