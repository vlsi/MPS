...
public class QueryFunction_CanSubstitute_Behavior {
  ...
  public static List<SNode> virtual_getParameters_1213877374450(SNode thisNode) {
    ...
    ListSequence.fromList(result).addElement(SConceptOperations.findConceptDeclaration("jetbrains.mps.lang.actions.structure.ConceptFunctionParameter_strictly"));
