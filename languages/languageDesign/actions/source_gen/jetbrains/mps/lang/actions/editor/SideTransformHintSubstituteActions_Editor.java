...
public class SideTransformHintSubstituteActions_Editor extends DefaultNodeEditor {
  ...
  private static class actionsBuilderListHandler_lbq9sy_a2a extends RefNodeListHandler {
    ...
    public EditorCell createEmptyCell(EditorContext editorContext) {
      editorContext.getCellFactory().pushCellContext();
      editorContext.getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(actionsBuilderListHandler_lbq9sy_a2a.this.getOwner(), MetaAdapterFactory.getContainmentLink(0xaee9cad2acd44608L, 0xaef20004f6a1cdbdL, 0x108fad1c116L, 0x108fad1c117L, "actionsBuilder")));
      try {
