...
public class NodeSubstituteActions_Behavior {
  ...
  public static void virtual_setBaseConcept_6261424444345963020(SNode thisNode, SNode baseConcept) {
    jetbrains.mps.smodel.SNode actionsBuilder = SConceptOperations.createNewNode("jetbrains.mps.lang.actions.structure.NodeSubstituteActionsBuilder", null);
  ...
  public static void callSuper_setBaseConcept_6261424444345978468(SNode thisNode, String callerConceptFqName, SNode baseConcept) {
    BehaviorManager.getInstance().invokeSuper(Void.class, SNodeOperations.cast(thisNode, "jetbrains.mps.lang.actions.structure.NodeSubstituteActions"), callerConceptFqName, "virtual_setBaseConcept_6261424444345963020", new Class[]{SNode.class, SNode.class}, new Object[]{baseConcept});
  }
}
