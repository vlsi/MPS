...
public class StructureAspectDescriptor implements jetbrains.mps.smodel.runtime.StructureAspectDescriptor {
  ...
  public ConceptDescriptor getDescriptor(String conceptFqName) {
    switch (Arrays.binarySearch(stringSwitchCases_1htk8d_a0a0b, conceptFqName)) {
      ...
      case 27:
        return new ConceptDescriptorBuilder("jetbrains.mps.lang.actions.structure.CopyPreProcessFunction").super_("jetbrains.mps.baseLanguage.structure.ConceptFunction").parents("jetbrains.mps.baseLanguage.structure.ConceptFunction").alias("paste pre process function", "").create();
      case 28:
      ...
      case 29:
        return new ConceptDescriptorBuilder("jetbrains.mps.lang.actions.structure.ExecuteSmartActionFunction").super_("jetbrains.mps.baseLanguage.structure.ConceptFunction").parents("jetbrains.mps.baseLanguage.structure.ConceptFunction").create();
      case 30:
      ...
      case 32:
        return new ConceptDescriptorBuilder("jetbrains.mps.lang.actions.structure.GetActionUIFunction").super_("jetbrains.mps.baseLanguage.structure.ConceptFunction").parents("jetbrains.mps.baseLanguage.structure.ConceptFunction").create();
      case 33:
      ...
      case 36:
        return new ConceptDescriptorBuilder("jetbrains.mps.lang.actions.structure.IsSmartActionApplicableFunction").super_("jetbrains.mps.baseLanguage.structure.ConceptFunction").parents("jetbrains.mps.baseLanguage.structure.ConceptFunction").create();
      case 37:
      ...
      case 38:
        return new ConceptDescriptorBuilder("jetbrains.mps.lang.actions.structure.NF_Concept_NewInstance").super_("jetbrains.mps.lang.smodel.structure.Concept_NewInstance").parents("jetbrains.mps.lang.smodel.structure.Concept_NewInstance").children(new String[]{"prototype"}, new boolean[]{false}).alias("new initialized instance", "create new initialized node").create();
      case 39:
        return new ConceptDescriptorBuilder("jetbrains.mps.lang.actions.structure.NF_LinkList_AddNewChildOperation").super_("jetbrains.mps.lang.smodel.structure.LinkList_AddNewChildOperation").parents("jetbrains.mps.lang.smodel.structure.LinkList_AddNewChildOperation").alias("add new initialized", "add new initialized child").create();
      case 40:
        return new ConceptDescriptorBuilder("jetbrains.mps.lang.actions.structure.NF_Link_SetNewChildOperation").super_("jetbrains.mps.lang.smodel.structure.Link_SetNewChildOperation").parents("jetbrains.mps.lang.smodel.structure.Link_SetNewChildOperation").alias("set new initialized", "set new initialized child").create();
      case 41:
        return new ConceptDescriptorBuilder("jetbrains.mps.lang.actions.structure.NF_Model_CreateNewNodeOperation").super_("jetbrains.mps.lang.smodel.structure.Model_CreateNewNodeOperation").parents("jetbrains.mps.lang.smodel.structure.Model_CreateNewNodeOperation").children(new String[]{"prototype"}, new boolean[]{false}).alias("new initialized node", "").create();
      case 42:
        return new ConceptDescriptorBuilder("jetbrains.mps.lang.actions.structure.NF_Model_CreateNewRootNodeOperation").super_("jetbrains.mps.lang.smodel.structure.Model_CreateNewRootNodeOperation").parents("jetbrains.mps.lang.smodel.structure.Model_CreateNewRootNodeOperation").children(new String[]{"prototype"}, new boolean[]{false}).alias("new initialized root node", "").create();
      case 43:
        return new ConceptDescriptorBuilder("jetbrains.mps.lang.actions.structure.NF_Node_InsertNewNextSiblingOperation").super_("jetbrains.mps.lang.smodel.structure.Node_InsertNewNextSiblingOperation").parents("jetbrains.mps.lang.smodel.structure.Node_InsertNewNextSiblingOperation").alias("new initialized next-sibling", "").create();
      case 44:
        return new ConceptDescriptorBuilder("jetbrains.mps.lang.actions.structure.NF_Node_InsertNewPrevSiblingOperation").super_("jetbrains.mps.lang.smodel.structure.Node_InsertNewPrevSiblingOperation").parents("jetbrains.mps.lang.smodel.structure.Node_InsertNewPrevSiblingOperation").alias("new initialized prev-sibling", "").create();
      case 45:
        return new ConceptDescriptorBuilder("jetbrains.mps.lang.actions.structure.NF_Node_ReplaceWithNewOperation").super_("jetbrains.mps.lang.smodel.structure.Node_ReplaceWithNewOperation").parents("jetbrains.mps.lang.smodel.structure.Node_ReplaceWithNewOperation").alias("replace with new initialized", "").create();
      case 46:
      ...
      case 48:
        return new ConceptDescriptorBuilder("jetbrains.mps.lang.actions.structure.NodeSetupFunction").super_("jetbrains.mps.baseLanguage.structure.ConceptFunction").parents("jetbrains.mps.baseLanguage.structure.ConceptFunction").alias("node setup function", "").create();
      case 49:
        return new ConceptDescriptorBuilder("jetbrains.mps.lang.actions.structure.NodeSetupFunction_EnclosingNode").super_("jetbrains.mps.baseLanguage.structure.ConceptFunctionParameter").parents("jetbrains.mps.baseLanguage.structure.ConceptFunctionParameter").alias("enclosingNode", "").create();
      case 50:
        return new ConceptDescriptorBuilder("jetbrains.mps.lang.actions.structure.NodeSetupFunction_NewNode").super_("jetbrains.mps.baseLanguage.structure.ConceptFunctionParameter").parents("jetbrains.mps.baseLanguage.structure.ConceptFunctionParameter").alias("newNode", "").create();
      case 51:
        return new ConceptDescriptorBuilder("jetbrains.mps.lang.actions.structure.NodeSetupFunction_SampleNode").super_("jetbrains.mps.baseLanguage.structure.ConceptFunctionParameter").parents("jetbrains.mps.baseLanguage.structure.ConceptFunctionParameter").alias("sampleNode", "").create();
      case 52:
      ...
      case 58:
        return new ConceptDescriptorBuilder("jetbrains.mps.lang.actions.structure.PastePostProcessFunction").super_("jetbrains.mps.baseLanguage.structure.ConceptFunction").parents("jetbrains.mps.baseLanguage.structure.ConceptFunction").alias("paste post process function", "").create();
      case 59:
      ...
      case 62:
        return new ConceptDescriptorBuilder("jetbrains.mps.lang.actions.structure.QueryFunction_ActionType").super_("jetbrains.mps.baseLanguage.structure.ConceptFunction").parents("jetbrains.mps.baseLanguage.structure.ConceptFunction").alias("", "return result type for this action, used for smart completion").create();
      case 63:
        return new ConceptDescriptorBuilder("jetbrains.mps.lang.actions.structure.QueryFunction_CanSubstitute").super_("jetbrains.mps.baseLanguage.structure.ConceptFunction").parents("jetbrains.mps.baseLanguage.structure.ConceptFunction").alias("", "return false if this action should be excluded from the substitute menu").create();
      case 64:
        return new ConceptDescriptorBuilder("jetbrains.mps.lang.actions.structure.QueryFunction_GenericSubstituteMenuPart").super_("jetbrains.mps.baseLanguage.structure.ConceptFunction").parents("jetbrains.mps.baseLanguage.structure.ConceptFunction").alias("", "return collection of custom SubstituteActions").create();
      case 65:
        return new ConceptDescriptorBuilder("jetbrains.mps.lang.actions.structure.QueryFunction_IconNode").super_("jetbrains.mps.baseLanguage.structure.ConceptFunction").parents("jetbrains.mps.baseLanguage.structure.ConceptFunction").alias("", "return concept<> or node<>. Icon associated with this concept<> or a concept of this node<> will be used for this menu item.").create();
      case 66:
        return new ConceptDescriptorBuilder("jetbrains.mps.lang.actions.structure.QueryFunction_ParameterizedSideTransform_Handler").super_("jetbrains.mps.baseLanguage.structure.ConceptFunction").parents("jetbrains.mps.baseLanguage.structure.ConceptFunction").create();
      case 67:
        return new ConceptDescriptorBuilder("jetbrains.mps.lang.actions.structure.QueryFunction_ParameterizedSideTransform_Query").super_("jetbrains.mps.baseLanguage.structure.ConceptFunction").parents("jetbrains.mps.baseLanguage.structure.ConceptFunction").create();
      case 68:
        return new ConceptDescriptorBuilder("jetbrains.mps.lang.actions.structure.QueryFunction_ParameterizedSubstitute_Handler").super_("jetbrains.mps.baseLanguage.structure.ConceptFunction").parents("jetbrains.mps.baseLanguage.structure.ConceptFunction").alias("", "return node<> to substitute currentTargetNode with").create();
      case 69:
        return new ConceptDescriptorBuilder("jetbrains.mps.lang.actions.structure.QueryFunction_ParameterizedSubstitute_Icon").super_("jetbrains.mps.baseLanguage.structure.ConceptFunction").parents("jetbrains.mps.baseLanguage.structure.ConceptFunction").create();
      case 70:
        return new ConceptDescriptorBuilder("jetbrains.mps.lang.actions.structure.QueryFunction_ParameterizedSubstitute_Query").super_("jetbrains.mps.baseLanguage.structure.ConceptFunction").parents("jetbrains.mps.baseLanguage.structure.ConceptFunction").alias("", "return collection of substitute menu part parameters").create();
      case 71:
        return new ConceptDescriptorBuilder("jetbrains.mps.lang.actions.structure.QueryFunction_ParameterizedSubstitute_String").super_("jetbrains.mps.baseLanguage.structure.ConceptFunction").parents("jetbrains.mps.baseLanguage.structure.ConceptFunction").alias("", "return text string").create();
      case 72:
        return new ConceptDescriptorBuilder("jetbrains.mps.lang.actions.structure.QueryFunction_PasteWrapper").super_("jetbrains.mps.baseLanguage.structure.ConceptFunction").parents("jetbrains.mps.baseLanguage.structure.ConceptFunction").create();
      case 73:
        return new ConceptDescriptorBuilder("jetbrains.mps.lang.actions.structure.QueryFunction_RemoveBy_Condition").super_("jetbrains.mps.baseLanguage.structure.ConceptFunction").parents("jetbrains.mps.baseLanguage.structure.ConceptFunction").alias("", "return true if corresponding substitute action should be removed from the completion menu").create();
      case 74:
        return new ConceptDescriptorBuilder("jetbrains.mps.lang.actions.structure.QueryFunction_ReturnSmallPart").super_("jetbrains.mps.baseLanguage.structure.ConceptFunction").parents("jetbrains.mps.baseLanguage.structure.ConceptFunction").alias("", "return true if wrapped node should be used to setup selection in editor").create();
      case 75:
        return new ConceptDescriptorBuilder("jetbrains.mps.lang.actions.structure.QueryFunction_STVariableInitializer").super_("jetbrains.mps.baseLanguage.structure.ConceptFunction").parents("jetbrains.mps.baseLanguage.structure.ConceptFunction").create();
      case 76:
        return new ConceptDescriptorBuilder("jetbrains.mps.lang.actions.structure.QueryFunction_ST_CommonInitializer").super_("jetbrains.mps.baseLanguage.structure.ConceptFunction").parents("jetbrains.mps.baseLanguage.structure.ConceptFunction").create();
      case 77:
        return new ConceptDescriptorBuilder("jetbrains.mps.lang.actions.structure.QueryFunction_ST_RemoveBy_Condition").super_("jetbrains.mps.baseLanguage.structure.ConceptFunction").parents("jetbrains.mps.baseLanguage.structure.ConceptFunction").create();
      case 78:
        return new ConceptDescriptorBuilder("jetbrains.mps.lang.actions.structure.QueryFunction_SideTransform_ConceptHandler").super_("jetbrains.mps.baseLanguage.structure.ConceptFunction").parents("jetbrains.mps.baseLanguage.structure.ConceptFunction").create();
      case 79:
        return new ConceptDescriptorBuilder("jetbrains.mps.lang.actions.structure.QueryFunction_SideTransform_Handler").super_("jetbrains.mps.baseLanguage.structure.ConceptFunction").parents("jetbrains.mps.baseLanguage.structure.ConceptFunction").create();
      case 80:
        return new ConceptDescriptorBuilder("jetbrains.mps.lang.actions.structure.QueryFunction_SideTransform_Icon").super_("jetbrains.mps.baseLanguage.structure.ConceptFunction").parents("jetbrains.mps.baseLanguage.structure.ConceptFunction").alias("icon", "").create();
      case 81:
        return new ConceptDescriptorBuilder("jetbrains.mps.lang.actions.structure.QueryFunction_SideTransform_NodeQuery").super_("jetbrains.mps.baseLanguage.structure.ConceptFunction").parents("jetbrains.mps.baseLanguage.structure.ConceptFunction").create();
      case 82:
        return new ConceptDescriptorBuilder("jetbrains.mps.lang.actions.structure.QueryFunction_SideTransform_String").super_("jetbrains.mps.baseLanguage.structure.ConceptFunction").parents("jetbrains.mps.baseLanguage.structure.ConceptFunction", "jetbrains.mps.lang.actions.structure.ISideTransform_String").alias("get text", "").create();
      case 83:
        return new ConceptDescriptorBuilder("jetbrains.mps.lang.actions.structure.QueryFunction_SubstituteIcon").super_("jetbrains.mps.baseLanguage.structure.ConceptFunction").parents("jetbrains.mps.baseLanguage.structure.ConceptFunction").create();
      case 84:
      ...
      case 85:
        return new ConceptDescriptorBuilder("jetbrains.mps.lang.actions.structure.QueryFunction_SubstituteVariableInitializer").super_("jetbrains.mps.baseLanguage.structure.ConceptFunction").parents("jetbrains.mps.baseLanguage.structure.ConceptFunction").alias("", "return initial value of the variable").create();
      case 86:
        return new ConceptDescriptorBuilder("jetbrains.mps.lang.actions.structure.QueryFunction_SubstituteWrapper").super_("jetbrains.mps.baseLanguage.structure.ConceptFunction").parents("jetbrains.mps.baseLanguage.structure.ConceptFunction").alias("", "create new instance of output concept wrapping (containing) passed nodeToWrap").create();
      case 87:
        return new ConceptDescriptorBuilder("jetbrains.mps.lang.actions.structure.QueryFunction_Substitute_CommonInitializer").super_("jetbrains.mps.baseLanguage.structure.ConceptFunction").parents("jetbrains.mps.baseLanguage.structure.ConceptFunction").alias("", "common init block").create();
      case 88:
        return new ConceptDescriptorBuilder("jetbrains.mps.lang.actions.structure.QueryFunction_Substitute_Handler").super_("jetbrains.mps.baseLanguage.structure.ConceptFunction").parents("jetbrains.mps.baseLanguage.structure.ConceptFunction").alias("", "return node<> to substitute currentTargetNode with").create();
      case 89:
        return new ConceptDescriptorBuilder("jetbrains.mps.lang.actions.structure.QueryFunction_Substitute_SelectionHandler").super_("jetbrains.mps.baseLanguage.structure.ConceptFunction").parents("jetbrains.mps.baseLanguage.structure.ConceptFunction").alias("", "return node to select or null if selection API was directly called from the query").create();
      case 90:
      ...
      case 97:
        return new ConceptDescriptorBuilder("jetbrains.mps.lang.actions.structure.SideTransformHintSubstitutePreconditionFunction").super_("jetbrains.mps.baseLanguage.structure.ConceptFunction").parents("jetbrains.mps.baseLanguage.structure.ConceptFunction").alias("precondition", "").create();
      case 98:
      ...
      case 101:
        return new ConceptDescriptorBuilder("jetbrains.mps.lang.actions.structure.SideTransformVariableReference").super_("jetbrains.mps.baseLanguage.structure.VariableReference").parents("jetbrains.mps.baseLanguage.structure.VariableReference").references("rightTransformVariableDeclaration").create();
      case 102:
        return new ConceptDescriptorBuilder("jetbrains.mps.lang.actions.structure.SideTransform_SimpleString").super_("jetbrains.mps.lang.core.structure.BaseConcept").parents("jetbrains.mps.lang.core.structure.BaseConcept", "jetbrains.mps.lang.actions.structure.ISideTransform_String").properties("text").alias("simple string", "").create();
      case 103:
      ...
      case 106:
        return new ConceptDescriptorBuilder("jetbrains.mps.lang.actions.structure.SmartActionParameterReference").super_("jetbrains.mps.baseLanguage.structure.Expression").parents("jetbrains.mps.baseLanguage.structure.Expression").references("smartActionParameter").create();
      case 107:
      ...
      case 110:
        return new ConceptDescriptorBuilder("jetbrains.mps.lang.actions.structure.SubstituteNodeBuilderVariableReference").super_("jetbrains.mps.baseLanguage.structure.VariableReference").parents("jetbrains.mps.baseLanguage.structure.VariableReference").references("nodeBuilderVariableDeclaration").create();
      case 111:
