...
public class QueryFunction_ParameterizedSideTransform_Handler_Behavior {
  ...
  public static boolean virtual_usesParameterObjectFor_1213877374432(SNode thisNode, SNode parameter) {
    ...
    if (SNodeOperations.isInstanceOf(parameter, MetaAdapterFactory.getConcept(0xaee9cad2acd44608L, 0xaef20004f6a1cdbdL, 0x1121ecda6bbL, "jetbrains.mps.lang.actions.structure.ConceptFunctionParameter_parameterObject"))) {
      return false;
    }
