...
public final class PastePostProcessor_BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<String> getClassName_id4IXs4YUz$e_ = new SMethodBuilder<String>(new SJavaCompoundTypeImpl(String.class)).name("getClassName").modifiers(SModifiersImpl.create(0, AccessPrivileges.PUBLIC)).concept(CONCEPT).id("4IXs4YUz$e_").registry(REGISTRY).build(SParameterImpl.fromList(SJavaCompoundTypeImpl.fromClasses()));
  ...
  private static String getClassName_id4IXs4YUz$e_(@NotNull SNode __thisNode__) {
  ...
  /*package*/ PastePostProcessor_BehaviorDescriptor() {
    super(REGISTRY);
  }
  ...
  protected <T> T invokeSpecial0(@NotNull SNode node, @NotNull SMethod<T> method, @NotNull Object[] parameters) {
    ...
    switch (methodIndex) {
      case 0:
        return (T) getClassName_id4IXs4YUz$e_(node);
      default:
        throw new BHMethodNotFoundException(this, method);
    }
  }
