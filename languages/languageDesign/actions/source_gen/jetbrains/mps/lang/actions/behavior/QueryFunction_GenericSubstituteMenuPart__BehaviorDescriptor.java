...
public final class QueryFunction_GenericSubstituteMenuPart__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  /*package*/ static List<SConcept> getParameterConcepts_id2xELmDxyi2v(@NotNull SNode __thisNode__) {
    ...
    ListSequence.fromList(result).addElement(MetaAdapterFactory.getConcept(0xaee9cad2acd44608L, 0xaef20004f6a1cdbdL, 0x1175fd19500L, "jetbrains.mps.lang.actions.structure.ConceptFunctionParameter_childSetter"));
  ...
  /*package*/ QueryFunction_GenericSubstituteMenuPart__BehaviorDescriptor() {
    super(REGISTRY);
  }
