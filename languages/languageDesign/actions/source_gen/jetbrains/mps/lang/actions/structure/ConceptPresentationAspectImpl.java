...
public class ConceptPresentationAspectImpl extends ConceptPresentationAspectBase {
  ...
  private final ConceptPresentation props_ConceptFunctionParameter_childConcept = new ConceptPresentationBuilder().shortDesc("substitution node<> should be instance of this concept or one of it's subconcepts").create();
  private final ConceptPresentation props_ConceptFunctionParameter_childSetter = new ConceptPresentationBuilder().shortDesc("IChildNodeSetter instance which should be used to set new child for this parent node").create();
  private final ConceptPresentation props_ConceptFunctionParameter_concept = new ConceptPresentationBuilder().shortDesc("outputConcept of substitute action").create();
  private final ConceptPresentation props_ConceptFunctionParameter_createdNode = new ConceptPresentationBuilder().shortDesc("node<> returned from create child node block").create();
  private final ConceptPresentation props_ConceptFunctionParameter_currentTargetNode = new ConceptPresentationBuilder().shortDesc("node<> to substitute").create();
  private final ConceptPresentation props_ConceptFunctionParameter_link = new ConceptPresentationBuilder().shortDesc("containment LinkDeclaration for where result of this substitution will be saved or null if LinkDeclaration was not determined").create();
  ...
  private final ConceptPresentation props_ConceptFunctionParameter_nodeToWrap = new ConceptPresentationBuilder().shortDesc("instance of wrapped concept created by another substitute action").create();
  private final ConceptPresentation props_ConceptFunctionParameter_parameterObject = new ConceptPresentationBuilder().shortDesc("one of parameters returned from the parameters query").create();
  private final ConceptPresentation props_ConceptFunctionParameter_parentNode = new ConceptPresentationBuilder().shortDesc("the parent node<> of the node<> to substitute").create();
  private final ConceptPresentation props_ConceptFunctionParameter_pattern = new ConceptPresentationBuilder().shortDesc("string entered by user inside competion pop-up, used to hide those actions which matching text was not matched with the pattern").create();
  ...
  private final ConceptPresentation props_ConceptFunctionParameter_strictly = new ConceptPresentationBuilder().shortDesc("true if matching text should match specified pattern completely, false if only beggining of matching text should match this pattern").create();
  private final ConceptPresentation props_ConceptFunctionParameter_targetNode = new ConceptPresentationBuilder().create();
  private final ConceptPresentation props_ConceptFunctionParameter_wrapped = new ConceptPresentationBuilder().shortDesc("boolean property specifying if the result of this substite action will be wrapped into another concept instance before injecting it into the model").create();
  ...
  private final ConceptPresentation props_NodeSubstitutePreconditionFunction = new ConceptPresentationBuilder().shortDesc("return true if this substitute actions builder should be used to build substitute menu").create();
  ...
  private final ConceptPresentation props_QueryFunction_ActionType = new ConceptPresentationBuilder().shortDesc("return result type for this action, used for smart completion").create();
  private final ConceptPresentation props_QueryFunction_CanSubstitute = new ConceptPresentationBuilder().shortDesc("return false if this action should be excluded from the substitute menu").create();
  private final ConceptPresentation props_QueryFunction_GenericSubstituteMenuPart = new ConceptPresentationBuilder().shortDesc("return collection of custom SubstituteActions").create();
  private final ConceptPresentation props_QueryFunction_IconNode = new ConceptPresentationBuilder().shortDesc("return concept<> or node<>. Icon associated with this concept<> or a concept of this node<> will be used for this menu item.").create();
  ...
  private final ConceptPresentation props_QueryFunction_ParameterizedSubstitute_Handler = new ConceptPresentationBuilder().shortDesc("return node<> to substitute currentTargetNode with").create();
  ...
  private final ConceptPresentation props_QueryFunction_ParameterizedSubstitute_Query = new ConceptPresentationBuilder().shortDesc("return collection of substitute menu part parameters").create();
  private final ConceptPresentation props_QueryFunction_ParameterizedSubstitute_String = new ConceptPresentationBuilder().shortDesc("return text string").create();
  private final ConceptPresentation props_QueryFunction_PasteWrapper = new ConceptPresentationBuilder().create();
  private final ConceptPresentation props_QueryFunction_RemoveBy_Condition = new ConceptPresentationBuilder().shortDesc("return true if corresponding substitute action should be removed from the completion menu").create();
  private final ConceptPresentation props_QueryFunction_ReturnSmallPart = new ConceptPresentationBuilder().shortDesc("return true if wrapped node should be used to setup selection in editor").create();
  ...
  private final ConceptPresentation props_QueryFunction_SubstituteString = new ConceptPresentationBuilder().shortDesc("return text string").create();
  private final ConceptPresentation props_QueryFunction_SubstituteVariableInitializer = new ConceptPresentationBuilder().shortDesc("return initial value of the variable").create();
  private final ConceptPresentation props_QueryFunction_SubstituteWrapper = new ConceptPresentationBuilder().shortDesc("create new instance of output concept wrapping (containing) passed nodeToWrap").create();
  private final ConceptPresentation props_QueryFunction_Substitute_CommonInitializer = new ConceptPresentationBuilder().shortDesc("common init block").create();
  private final ConceptPresentation props_QueryFunction_Substitute_Handler = new ConceptPresentationBuilder().shortDesc("return node<> to substitute currentTargetNode with").create();
  private final ConceptPresentation props_QueryFunction_Substitute_SelectionHandler = new ConceptPresentationBuilder().shortDesc("return node to select or null if selection API was directly called from the query").create();
