  ...
  public LanguageAspectDescriptor get() {
    return new LanguageAspectDescriptor() {
      ...
      public Collection<SLanguage> getMainLanguages() {
        return ListSequence.fromListAndArray(new ArrayList<SLanguage>(), MetaAdapterFactory.getLanguage(MetaIdFactory.langId(0xaee9cad2acd44608L, 0xaef20004f6a1cdbdL), "jetbrains.mps.lang.actions"));
      }
      @Nullable
      ...
      public String getHelpUrl() {
        return "http://confluence.jetbrains.com/display/MPSD33/Editor+Actions";
      }
      ...
      private final Icon ICON = IconResourceBundle_ActionsAspect.getInstance().getResource("ACTIONSMODEL");
