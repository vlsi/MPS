...
public class MapSrcNodeMacro_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createConstant_dms3bp_a0_0(EditorContext editorContext, SNode node) {
    EditorCell_Constant editorCell = new EditorCell_Constant((jetbrains.mps.nodeEditor.EditorContext) editorContext, node, "$MAP_SRC$");
    ...
    editorCell.setDefaultText("");
    editorCell.setSubstituteInfo(new CompositeSubstituteInfo(editorContext, new BasicCellContext(node), new SubstituteInfoPartExt[]{new MapSrcNodeMacro_Editor.MapSrcNodeMacro_component_cellMenu_a0a0()}));
    return editorCell;
  }
  ...
  public static class MapSrcNodeMacro_component_cellMenu_a0a0 implements SubstituteInfoPartExt {
