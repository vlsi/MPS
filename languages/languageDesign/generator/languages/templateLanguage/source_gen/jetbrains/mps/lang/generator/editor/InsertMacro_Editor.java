...
public class InsertMacro_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createConstant_iwpawc_a0(EditorContext editorContext, SNode node) {
    ...
    editorCell.setSubstituteInfo(new CompositeSubstituteInfo(editorContext, new BasicCellContext(node), new SubstituteInfoPartExt[]{new InsertMacro_Editor.InsertMacro_component_cellMenu_iwpawc_a0a0(), new SChildSubstituteInfoPartEx(editorCell)}));
    return editorCell;
  }
  ...
  private EditorCell createConstant_iwpawc_a0_0(EditorContext editorContext, SNode node) {
    EditorCell_Constant editorCell = new EditorCell_Constant(editorContext, node, "insert a node ");
  ...
  private EditorCell createCollection_iwpawc_c0(EditorContext editorContext, SNode node) {
    ...
    editorCell.addEditorCell(this.createComponent_iwpawc_a2a(editorContext, node));
    editorCell.addEditorCell(this.createComponent_iwpawc_b2a(editorContext, node));
    editorCell.addEditorCell(this.createCollection_iwpawc_c2a(editorContext, node));
    return editorCell;
  }
  private EditorCell createComponent_iwpawc_a2a(EditorContext editorContext, SNode node) {
  ...
  private EditorCell createComponent_iwpawc_b2a(EditorContext editorContext, SNode node) {
  ...
  private EditorCell createRefNode_iwpawc_c2c0(EditorContext editorContext, SNode node) {
    SingleRoleCellProvider provider = new InsertMacro_Editor.createNodeQuerySingleRoleHandler_iwpawc_c2c0(node, MetaAdapterFactory.getContainmentLink(0xb401a68083254110L, 0x8fd384331ff25befL, 0x1231e32ff7a958ceL, 0x1231e32ff7a9efcdL, "createNodeQuery"), editorContext);
  ...
  private class createNodeQuerySingleRoleHandler_iwpawc_c2c0 extends SingleRoleCellProvider {
    ...
    protected EditorCell createChildCell(SNode child) {
      ...
      try {
        ...
        editorCell.setAction(CellActionType.DELETE, new CellAction_DeleteSmart(myOwnerNode, MetaAdapterFactory.getContainmentLink(0xb401a68083254110L, 0x8fd384331ff25befL, 0x1231e32ff7a958ceL, 0x1231e32ff7a9efcdL, "createNodeQuery"), child));
        editorCell.setAction(CellActionType.BACKSPACE, new CellAction_DeleteSmart(myOwnerNode, MetaAdapterFactory.getContainmentLink(0xb401a68083254110L, 0x8fd384331ff25befL, 0x1231e32ff7a958ceL, 0x1231e32ff7a9efcdL, "createNodeQuery"), child));
    ...
    private void installCellInfo(SNode child, EditorCell editorCell) {
      if (editorCell.getSubstituteInfo() == null || editorCell.getSubstituteInfo() instanceof DefaultSubstituteInfo) {
        editorCell.setSubstituteInfo(new OldNewCompositeSubstituteInfo(myEditorContext, new SChildSubstituteInfo(editorCell, myOwnerNode, MetaAdapterFactory.getContainmentLink(0xb401a68083254110L, 0x8fd384331ff25befL, 0x1231e32ff7a958ceL, 0x1231e32ff7a9efcdL, "createNodeQuery"), child), new DefaultChildSubstituteInfo(myOwnerNode, myContainmentLink.getDeclarationNode(), myEditorContext)));
      }
    ...
    protected EditorCell createEmptyCell() {
      myEditorContext.getCellFactory().pushCellContext();
      myEditorContext.getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(myOwnerNode, MetaAdapterFactory.getContainmentLink(0xb401a68083254110L, 0x8fd384331ff25befL, 0x1231e32ff7a958ceL, 0x1231e32ff7a9efcdL, "createNodeQuery")));
      try {
