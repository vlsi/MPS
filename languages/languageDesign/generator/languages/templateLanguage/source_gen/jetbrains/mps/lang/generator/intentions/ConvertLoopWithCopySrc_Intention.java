      ...
      for (SNode n : nodes) {
        if (seen) {
          if (SNodeOperations.isInstanceOf(n, MetaAdapterFactory.getConcept(new UUID(-5475912601019530992l, -8082971551085732881l), 1114706874351l, "jetbrains.mps.lang.generator.structure.CopySrcNodeMacro"))) {
            ...
            SNodeFactoryOperations.replaceWithNewChild(node, MetaAdapterFactory.getConcept(new UUID(-5475912601019530992l, -8082971551085732881l), 1114729360583l, "jetbrains.mps.lang.generator.structure.CopySrcListMacro"));
          }
          return;
        } else if (n == node) {
          seen = true;
