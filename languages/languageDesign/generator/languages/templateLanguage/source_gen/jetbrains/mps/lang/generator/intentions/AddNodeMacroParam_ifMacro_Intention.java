...
public final class AddNodeMacroParam_ifMacro_Intention extends IntentionDescriptorBase implements IntentionFactory {
  public AddNodeMacroParam_ifMacro_Intention() {
    super(MetaAdapterFactory.getConcept(0xceab519525ea4f22L, 0x9b92103b95ca8c0cL, 0x10802efe25aL, "jetbrains.mps.lang.core.structure.BaseConcept"), IntentionType.NORMAL, false, new SNodePointer("r:00000000-0000-4000-0000-011c895902e5(jetbrains.mps.lang.generator.intentions)", "1240572960649"));
  }
  @Override
  ...
  private List<SNode> parameter(final SNode node, final EditorContext editorContext) {
    ...
    return ListSequence.fromList(AbstractConceptDeclaration_BehaviorDescriptor.getPropertyDeclarations_idhEwILLM.invoke(SNodeOperations.asNode(sourceNode))).where(new IWhereFilter<SNode>() {
      public boolean accept(SNode it) {
        return DataTypeDeclaration_BehaviorDescriptor.isSimpleBoolean_idhKtGpIQ.invoke(SLinkOperations.getTarget(it, MetaAdapterFactory.getReferenceLink(0xc72da2b97cce4447L, 0x8389f407dc1158b7L, 0xf979bd086bL, 0xfc26f42fe5L, "dataType")));
      }
    }).toListSequence();
  }
  /*package*/ final class IntentionImplementation extends IntentionExecutableBase {
    ...
    public void execute(final SNode node, final EditorContext editorContext) {
      ...
      SNode ifMacro = SNodeFactoryOperations.createNewNode(SNodeFactoryOperations.asInstanceConcept(MetaAdapterFactory.getConcept(0xb401a68083254110L, 0x8fd384331ff25befL, 0x1047c1472deL, "jetbrains.mps.lang.generator.structure.IfMacro")), null);
      SNodeOperations.replaceWithAnother(nodeMacro, ifMacro);
      SNode ifMacro_Condition = SNodeFactoryOperations.createNewNode(SNodeFactoryOperations.asInstanceConcept(MetaAdapterFactory.getConcept(0xb401a68083254110L, 0x8fd384331ff25befL, 0x10feefdbd6eL, "jetbrains.mps.lang.generator.structure.IfMacro_Condition")), null);
