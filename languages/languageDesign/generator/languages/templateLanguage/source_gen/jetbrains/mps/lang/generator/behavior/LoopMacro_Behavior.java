    ...
    public boolean match(SNode nodeToMatch) {
      {
        ...
        }
        {
          ...
          {
            SNode childVar_LoopMacro_Behavior_cdqxf8_a0a0a0a = IterableUtil.asList(nodeToMatch_LoopMacro_Behavior_cdqxf8_a0a0a0.getChildren(childRole_LoopMacro_Behavior_cdqxf8_)).get(0);
            {
