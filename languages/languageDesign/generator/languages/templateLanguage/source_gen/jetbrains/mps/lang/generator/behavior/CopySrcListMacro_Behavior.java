    ...
    public boolean match(SNode nodeToMatch) {
      {
        ...
        }
        {
          ...
          {
            SNode childVar_CopySrcListMacro_Behavior_26ny8p_a0a0b0a = IterableUtil.asList(nodeToMatch_CopySrcListMacro_Behavior_26ny8p_a0a1a0.getChildren(childRole_CopySrcListMacro_Behavior_26ny8p_)).get(0);
            {
