    ...
    if (SLinkOperations.getTarget(nodeToCheck, "label", false) != null) {
      {
        ...
        typeCheckingContext.createLessThanInequality((SNode) new typeof_CreateRootRule_InferenceRule.QuotationClass_nbqazj_a0a0a0a0().createNode(SNodeOperations.getConceptDeclaration(SLinkOperations.getTarget(nodeToCheck, "templateNode", false)), typeCheckingContext), (SNode) new typeof_CreateRootRule_InferenceRule.QuotationClass_nbqazj_a0a0a0a0_0().createNode(SLinkOperations.getTarget(SLinkOperations.getTarget(nodeToCheck, "label", false), "targetConcept", false), typeCheckingContext), false, false, _info_12389875345);
      }
    }
  }
