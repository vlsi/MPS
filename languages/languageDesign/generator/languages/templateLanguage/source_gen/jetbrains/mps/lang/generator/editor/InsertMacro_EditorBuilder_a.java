...
/*package*/ class InsertMacro_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  /*package*/ EditorCell createCell() {
    return createCollection_iwpawc_a();
  }

  private EditorCell createCollection_iwpawc_a() {
    EditorCell_Collection editorCell = EditorCell_Collection.createHorizontal(getEditorContext(), myNode);
    editorCell.setCellId("Collection_iwpawc_a");
    editorCell.setBig(true);
    editorCell.setCellContext(getCellFactory().getCellContext());
    editorCell.addEditorCell(createConstant_iwpawc_a0());
    editorCell.addEditorCell(createComponent_iwpawc_b0());
    return editorCell;
  }
  private EditorCell createConstant_iwpawc_a0() {
    ...
    editorCell.setSubstituteInfo(new CompositeSubstituteInfo(getEditorContext(), new BasicCellContext(myNode), new SubstituteInfoPartExt[]{new InsertMacro_EditorBuilder_a.InsertMacro_component_cellMenu_iwpawc_a0a0(), new SChildSubstituteInfoPartEx(editorCell)}));
    return editorCell;
  }
  ...
  private EditorCell createComponent_iwpawc_b0() {
