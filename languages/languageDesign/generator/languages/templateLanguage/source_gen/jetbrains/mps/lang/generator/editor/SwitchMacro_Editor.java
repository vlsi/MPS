...
public class SwitchMacro_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createReadOnlyModelAccessor_31t0mi_b0(final EditorContext editorContext, final SNode node) {
    EditorCell_Property editorCell = EditorCell_Property.create(editorContext, new ModelAccessor() {
      public String getText() {
        return SPropertyOperations.getString(SLinkOperations.getTarget(node, MetaAdapterFactory.getReferenceLink(0xb401a68083254110L, 0x8fd384331ff25befL, 0x10313f84dd6L, 0x10313f93662L, "templateSwitch")), MetaAdapterFactory.getProperty(0xceab519525ea4f22L, 0x9b92103b95ca8c0cL, 0x110396eaaa4L, 0x110396ec041L, "name"));
      }
    ...
    style.set(StyleAttributes.NAVIGATABLE_REFERENCE, 0, "templateSwitch");
    editorCell.getStyle().putAll(style);
    return editorCell;
  }
  private static boolean renderingCondition_31t0mi_a1a(SNode node, EditorContext editorContext) {
    return (SLinkOperations.getTarget(node, MetaAdapterFactory.getReferenceLink(0xb401a68083254110L, 0x8fd384331ff25befL, 0x10313f84dd6L, 0x10313f93662L, "templateSwitch")) != null) && isNotEmptyString(SPropertyOperations.getString(SLinkOperations.getTarget(node, MetaAdapterFactory.getReferenceLink(0xb401a68083254110L, 0x8fd384331ff25befL, 0x10313f84dd6L, 0x10313f93662L, "templateSwitch")), MetaAdapterFactory.getProperty(0xceab519525ea4f22L, 0x9b92103b95ca8c0cL, 0x110396eaaa4L, 0x110396ec041L, "name")));
  }
  ...
  private EditorCell createCollection_31t0mi_c0(EditorContext editorContext, SNode node) {
    ...
    editorCell.addEditorCell(this.createComponent_31t0mi_a2a(editorContext, node));
    editorCell.addEditorCell(this.createComponent_31t0mi_b2a(editorContext, node));
  ...
  private EditorCell createComponent_31t0mi_a2a(EditorContext editorContext, SNode node) {
  ...
  private EditorCell createComponent_31t0mi_b2a(EditorContext editorContext, SNode node) {
  ...
  private EditorCell createRefNode_31t0mi_c2c0(EditorContext editorContext, SNode node) {
    SingleRoleCellProvider provider = new SwitchMacro_Editor.sourceNodeQuerySingleRoleHandler_31t0mi_c2c0(node, MetaAdapterFactory.getContainmentLink(0xb401a68083254110L, 0x8fd384331ff25befL, 0x10313f84dd6L, 0x11008e5fed8L, "sourceNodeQuery"), editorContext);
    return provider.createCell();
  }
  private class sourceNodeQuerySingleRoleHandler_31t0mi_c2c0 extends SingleRoleCellProvider {
    public sourceNodeQuerySingleRoleHandler_31t0mi_c2c0(SNode ownerNode, SContainmentLink containmentLink, EditorContext context) {
  ...
  private EditorCell createRefCell_31t0mi_c4c0(EditorContext editorContext, SNode node) {
    ...
    if (editorCell.getRole() == null) {
      ...
      editorCell.setRole("templateSwitch");
    }
    if (true) {
