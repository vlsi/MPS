...
public class EditorAspectDescriptorImpl extends EditorAspectDescriptorBase {
  ...
  public Collection<ConceptEditorComponent> getDeclaredEditorComponents(SAbstractConcept concept, String editorComponentId) {
    {
      ...
      switch (index_xbvbvu_a0c.index(cncpt)) {
        ...
        case 4:
          if (true) {
            switch (Arrays.binarySearch(stringSwitchCases_xbvbvu_a0a0a0e1a0a2, editorComponentId)) {
              case 0:
  ...
  private static String[] stringSwitchCases_xbvbvu_a0a0a0b1a0a2 = new String[]{"jetbrains.mps.lang.generator.editor.BaseMappingRule_premise", "jetbrains.mps.lang.generator.editor.MappingRuleCommonFields"};
  private static String[] stringSwitchCases_xbvbvu_a0a0a0e1a0a2 = new String[]{"jetbrains.mps.lang.generator.editor.NodeMacro_label_inspector", "jetbrains.mps.lang.generator.editor.NodeMacro_postfix"};
}
