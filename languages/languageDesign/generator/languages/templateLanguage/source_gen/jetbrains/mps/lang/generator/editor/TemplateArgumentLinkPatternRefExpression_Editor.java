...
public class TemplateArgumentLinkPatternRefExpression_Editor extends DefaultNodeEditor {
  public EditorCell createEditorCell(EditorContext editorContext, SNode node) {
    return this.createCollection_f8ef2o_a(editorContext, node);
  }
  ...
  public static class _Inline_f8ef2o_a0a extends InlineCellProvider {
    ...
    public EditorCell createEditorCell(EditorContext editorContext, SNode node) {
      return this.createProperty_f8ef2o_a0a0(editorContext, node);
    }
    private EditorCell createProperty_f8ef2o_a0a0(EditorContext editorContext, SNode node) {
