...
public final class TemplateSwitchMacro_BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<SNode> getTemplateSwitch_idQzR6Ththuv = new SMethodBuilder<SNode>(new SJavaCompoundTypeImpl((Class<SNode>) ((Class) Object.class))).name("getTemplateSwitch").modifiers(SModifiersImpl.create(0, AccessPrivileges.PUBLIC)).concept(CONCEPT).id("QzR6Ththuv").registry(REGISTRY).build(SParameterImpl.fromList(SJavaCompoundTypeImpl.fromClasses()));
  ...
  private static SNode getTemplateSwitch_idQzR6Ththuv(@NotNull SNode __thisNode__) {
  ...
  /*package*/ TemplateSwitchMacro_BehaviorDescriptor() {
    super(REGISTRY);
  }
  ...
  protected <T> T invokeSpecial0(@NotNull SNode node, @NotNull SMethod<T> method, @NotNull Object[] parameters) {
    ...
    switch (methodIndex) {
      case 0:
        return (T) getTemplateSwitch_idQzR6Ththuv(node);
      default:
        throw new BHMethodNotFoundException(this, method);
    }
  }
