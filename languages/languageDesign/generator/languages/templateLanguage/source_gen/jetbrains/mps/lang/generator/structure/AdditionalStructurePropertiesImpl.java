...
public class AdditionalStructurePropertiesImpl extends ConceptPresentationAspectBase {
  ...
  private final ConceptPresentation props_MappingConfiguration = new ConceptPresentationBuilder().icon("mappingConf.png", AdditionalStructurePropertiesImpl.class).create();
  ...
  private final ConceptPresentation props_MappingScript = new ConceptPresentationBuilder().icon("generatorScript.png", AdditionalStructurePropertiesImpl.class).create();
  ...
  private final ConceptPresentation
      props_TemplateDeclaration = new ConceptPresentationBuilder().icon("templateFragment.png", AdditionalStructurePropertiesImpl.class).create();
  private final ConceptPresentation props_TemplateDeclarationReference = new ConceptPresentationBuilder().create();
  private final ConceptPresentation
      props_TemplateFragment = new ConceptPresentationBuilder().deprecated(MetaAdapterFactory.getReferenceLink(0xb401a68083254110L, 0x8fd384331ff25befL, 0xff1b29b76cL, 0x1179c366b2fL, "labelDeclaration")).create();
  ...
  private final ConceptPresentation props_TemplateSwitch = new ConceptPresentationBuilder().icon("switch.png", AdditionalStructurePropertiesImpl.class).create();
