...
public class AdditionalStructurePropertiesImpl extends BaseAdditionalStructureProperties {
  private final AdditionalConceptProperties props_AbandonInput_RuleConsequence = new ConceptPropsBuilder().create();
  private final AdditionalConceptProperties props_AbstractMacro = new ConceptPropsBuilder().create();
  private final AdditionalConceptProperties props_BaseMappingRule = new ConceptPropsBuilder().create();
  private final AdditionalConceptProperties props_BaseMappingRule_Condition = new ConceptPropsBuilder().create();
  private final AdditionalConceptProperties props_ContextVariableDeclaration = new ConceptPropsBuilder().create();
  private final AdditionalConceptProperties props_ContextVariableProvider = new ConceptPropsBuilder().create();
  private final AdditionalConceptProperties props_CopySrcListMacro = new ConceptPropsBuilder().create();
  private final AdditionalConceptProperties props_CopySrcNodeMacro = new ConceptPropsBuilder().create();
  private final AdditionalConceptProperties props_CreateRootRule = new ConceptPropsBuilder().create();
  private final AdditionalConceptProperties props_CreateRootRule_Condition = new ConceptPropsBuilder().create();
  private final AdditionalConceptProperties props_DismissTopMappingRule = new ConceptPropsBuilder().create();
  private final AdditionalConceptProperties props_DropAttributeRule = new ConceptPropsBuilder().create();
  private final AdditionalConceptProperties props_DropAttributeRule_Condition = new ConceptPropsBuilder().create();
  private final AdditionalConceptProperties props_DropRootRule = new ConceptPropsBuilder().create();
  private final AdditionalConceptProperties props_DropRootRule_Condition = new ConceptPropsBuilder().create();
  private final AdditionalConceptProperties props_ExportEntry = new ConceptPropsBuilder().create();
  private final AdditionalConceptProperties props_ExportLabel = new ConceptPropsBuilder().create();
  private final AdditionalConceptProperties props_ExportLabelParameter_inputNode = new ConceptPropsBuilder().create();
  private final AdditionalConceptProperties props_ExportLabelParameter_keeper = new ConceptPropsBuilder().create();
  private final AdditionalConceptProperties props_ExportLabelParameter_outputNode = new ConceptPropsBuilder().create();
  private final AdditionalConceptProperties props_ExportMacro = new ConceptPropsBuilder().create();
  private final AdditionalConceptProperties props_GeneratorDebug_LabelEntry = new ConceptPropsBuilder().create();
  private final AdditionalConceptProperties props_GeneratorDebug_Mappings = new ConceptPropsBuilder().create();
  private final AdditionalConceptProperties props_GeneratorDebug_NodeMapEntry = new ConceptPropsBuilder().create();
  private final AdditionalConceptProperties props_GeneratorDebug_NodeRef = new ConceptPropsBuilder().create();
  private final AdditionalConceptProperties props_GeneratorInternal_AbstractReferenceDescriptor = new ConceptPropsBuilder().create();
  private final AdditionalConceptProperties props_GeneratorInternal_InternalReferenceDescriptor = new ConceptPropsBuilder().create();
  ...
  private final AdditionalConceptProperties props_GeneratorMessage = new ConceptPropsBuilder().create();
  private final AdditionalConceptProperties props_GeneratorParameterReference = new ConceptPropsBuilder().create();
  private final AdditionalConceptProperties props_IGeneratorParameter = new ConceptPropsBuilder().create();
  private final AdditionalConceptProperties props_IParameterizedTemplate = new ConceptPropsBuilder().create();
  private final AdditionalConceptProperties props_ITemplateCall = new ConceptPropsBuilder().create();
  private final AdditionalConceptProperties props_IfMacro = new ConceptPropsBuilder().create();
  private final AdditionalConceptProperties props_IfMacro_Condition = new ConceptPropsBuilder().create();
  private final AdditionalConceptProperties props_IncludeMacro = new ConceptPropsBuilder().create();
  private final AdditionalConceptProperties props_InlineSwitch_Case = new ConceptPropsBuilder().create();
  private final AdditionalConceptProperties props_InlineSwitch_RuleConsequence = new ConceptPropsBuilder().create();
  private final AdditionalConceptProperties props_InlineTemplateWithContext_RuleConsequence = new ConceptPropsBuilder().create();
  private final AdditionalConceptProperties props_InlineTemplate_RuleConsequence = new ConceptPropsBuilder().create();
  private final AdditionalConceptProperties props_InsertMacro = new ConceptPropsBuilder().create();
  private final AdditionalConceptProperties props_InsertMacro_CreateNodeQuery = new ConceptPropsBuilder().create();
  private final AdditionalConceptProperties props_LabelMacro = new ConceptPropsBuilder().create();
  private final AdditionalConceptProperties props_LoopMacro = new ConceptPropsBuilder().create();
  private final AdditionalConceptProperties props_MapSrcListMacro = new ConceptPropsBuilder().create();
  private final AdditionalConceptProperties props_MapSrcMacro_MapperFunction = new ConceptPropsBuilder().create();
  private final AdditionalConceptProperties props_MapSrcMacro_PostMapperFunction = new ConceptPropsBuilder().create();
  private final AdditionalConceptProperties props_MapSrcNodeMacro = new ConceptPropsBuilder().create();
  private final AdditionalConceptProperties props_MappingConfiguration = new ConceptPropsBuilder().icon("mappingConf.png", AdditionalStructurePropertiesImpl.class).create();
  private final AdditionalConceptProperties props_MappingConfiguration_Condition = new ConceptPropsBuilder().create();
  private final AdditionalConceptProperties props_MappingLabelDeclaration = new ConceptPropsBuilder().create();
  private final AdditionalConceptProperties props_MappingScript = new ConceptPropsBuilder().icon("generatorScript.png", AdditionalStructurePropertiesImpl.class).create();
  private final AdditionalConceptProperties props_MappingScriptReference = new ConceptPropsBuilder().create();
  private final AdditionalConceptProperties props_MappingScript_CodeBlock = new ConceptPropsBuilder().create();
  private final AdditionalConceptProperties props_MarshalFunction = new ConceptPropsBuilder().create();
  private final AdditionalConceptProperties props_ModelIdentity = new ConceptPropsBuilder().create();
  private final AdditionalConceptProperties props_NodeIdentity = new ConceptPropsBuilder().create();
  private final AdditionalConceptProperties props_NodeMacro = new ConceptPropsBuilder().create();
  private final AdditionalConceptProperties props_PatternReduction_MappingRule = new ConceptPropsBuilder().create();
  private final AdditionalConceptProperties props_PropertyMacro = new ConceptPropsBuilder().create();
  private final AdditionalConceptProperties props_PropertyMacro_GetPropertyValue = new ConceptPropsBuilder().create();
  private final AdditionalConceptProperties props_ReductionRule = new ConceptPropsBuilder().create();
  private final AdditionalConceptProperties props_Reduction_MappingRule = new ConceptPropsBuilder().create();
  private final AdditionalConceptProperties props_ReferenceMacro = new ConceptPropsBuilder().create();
  private final AdditionalConceptProperties props_ReferenceMacro_GetReferent = new ConceptPropsBuilder().create();
  private final AdditionalConceptProperties props_RootTemplateAnnotation = new ConceptPropsBuilder().create();
  private final AdditionalConceptProperties props_Root_MappingRule = new ConceptPropsBuilder().create();
  private final AdditionalConceptProperties props_RuleConsequence = new ConceptPropsBuilder().create();
  private final AdditionalConceptProperties props_SourceSubstituteMacro = new ConceptPropsBuilder().create();
  private final AdditionalConceptProperties props_SourceSubstituteMacro_SourceNodeQuery = new ConceptPropsBuilder().create();
  private final AdditionalConceptProperties props_SourceSubstituteMacro_SourceNodesQuery = new ConceptPropsBuilder().create();
  private final AdditionalConceptProperties props_TemplateArgumentLinkPatternRefExpression = new ConceptPropsBuilder().create();
  private final AdditionalConceptProperties props_TemplateArgumentParameterExpression = new ConceptPropsBuilder().create();
  private final AdditionalConceptProperties props_TemplateArgumentPatternRef = new ConceptPropsBuilder().create();
  private final AdditionalConceptProperties props_TemplateArgumentPatternVarRefExpression = new ConceptPropsBuilder().create();
  private final AdditionalConceptProperties props_TemplateArgumentPropertyPatternRefExpression = new ConceptPropsBuilder().create();
  private final AdditionalConceptProperties props_TemplateArgumentQuery = new ConceptPropsBuilder().create();
  private final AdditionalConceptProperties props_TemplateArgumentQueryExpression = new ConceptPropsBuilder().create();
  private final AdditionalConceptProperties props_TemplateArgumentVariableRefExpression = new ConceptPropsBuilder().create();
  private final AdditionalConceptProperties props_TemplateCallMacro = new ConceptPropsBuilder().create();
  private final AdditionalConceptProperties props_TemplateDeclaration = new ConceptPropsBuilder().icon("templateFragment.png", AdditionalStructurePropertiesImpl.class).create();
  private final AdditionalConceptProperties props_TemplateDeclarationReference = new ConceptPropsBuilder().create();
  private final AdditionalConceptProperties props_TemplateFragment = new ConceptPropsBuilder().deprecated(MetaAdapterFactory.getReferenceLink(0xb401a68083254110L, 0x8fd384331ff25befL, 0xff1b29b76cL, 0x1179c366b2fL, "labelDeclaration")).create();
  private final AdditionalConceptProperties props_TemplateFragment_ContextNodeQuery = new ConceptPropsBuilder().deprecated().create();
  private final AdditionalConceptProperties props_TemplateFunctionParameter_mainContextNode = new ConceptPropsBuilder().create();
  private final AdditionalConceptProperties props_TemplateFunctionParameter_outputNode = new ConceptPropsBuilder().create();
  private final AdditionalConceptProperties props_TemplateFunctionParameter_parentOutputNode = new ConceptPropsBuilder().create();
  private final AdditionalConceptProperties props_TemplateFunctionParameter_sourceNode = new ConceptPropsBuilder().create();
  private final AdditionalConceptProperties props_TemplateFunctionParameter_templatePropertyValue = new ConceptPropsBuilder().create();
  private final AdditionalConceptProperties props_TemplateFunctionParameter_templateReferent = new ConceptPropsBuilder().create();
  private final AdditionalConceptProperties props_TemplateParameterDeclaration = new ConceptPropsBuilder().create();
  private final AdditionalConceptProperties props_TemplateQueryBase = new ConceptPropsBuilder().create();
  private final AdditionalConceptProperties props_TemplateSwitch = new ConceptPropsBuilder().icon("switch.png", AdditionalStructurePropertiesImpl.class).create();
  private final AdditionalConceptProperties props_TemplateSwitchMacro = new ConceptPropsBuilder().create();
  private final AdditionalConceptProperties props_TemplateSwitchReference = new ConceptPropsBuilder().create();
  private final AdditionalConceptProperties props_TraceMacro = new ConceptPropsBuilder().create();
  private final AdditionalConceptProperties props_TrivialModelId = new ConceptPropsBuilder().create();
  private final AdditionalConceptProperties props_TrivialNodeId = new ConceptPropsBuilder().create();
  private final AdditionalConceptProperties props_UnmarshalFunction = new ConceptPropsBuilder().create();
  private final AdditionalConceptProperties props_VarMacro = new ConceptPropsBuilder().create();
  private final AdditionalConceptProperties props_VarMacro_ValueQuery = new ConceptPropsBuilder().create();
  private final AdditionalConceptProperties props_WeaveEach_RuleConsequence = new ConceptPropsBuilder().create();
  private final AdditionalConceptProperties props_WeaveMacro = new ConceptPropsBuilder().create();
  private final AdditionalConceptProperties props_WeavingAnchorQuery = new ConceptPropsBuilder().create();
  private final AdditionalConceptProperties props_Weaving_MappingRule = new ConceptPropsBuilder().create();
  private final AdditionalConceptProperties props_Weaving_MappingRule_ContextNodeQuery = new ConceptPropsBuilder().create();
  ...
  public AdditionalConceptProperties getDescriptor(SAbstractConcept c) {
    {
      ...
      Integer preIndex = indices_4qogsf_a0ee.get(cncpt);
