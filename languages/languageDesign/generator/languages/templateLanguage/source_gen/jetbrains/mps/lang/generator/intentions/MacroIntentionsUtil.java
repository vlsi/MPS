    ...
    public boolean match(SNode nodeToMatch) {
      {
        ...
        }
        {
          ...
          {
            SNode childVar_MacroIntentionsUtil_iiuth6_a0a0a0a3a2 = IterableUtil.asList(nodeToMatch_MacroIntentionsUtil_iiuth6_a0a0a0d0c.getChildren(childRole_MacroIntentionsUtil_iiuth6_)).get(0);
            {
