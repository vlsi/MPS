...
public class typeof_BaseMappingRule_InferenceRule extends AbstractInferenceRule_Runtime implements InferenceRule_Runtime {
  ...
  public void applyRule(final SNode nodeToCheck, final TypeCheckingContext typeCheckingContext, IsApplicableStatus status) {
    if (SLinkOperations.getTarget(SLinkOperations.getTarget(nodeToCheck, "labelDeclaration", false), "sourceConcept", false) != null) {
      ...
      }
      {
        ...
        typeCheckingContext.createLessThanInequality((SNode) _quotation_createNode_dxi99s_a0b0a0a(BehaviorReflection.invokeVirtual((Class<SNode>) ((Class) Object.class), nodeToCheck, "virtual_getTemplateType_1213877498511", new Object[]{})), (SNode) _quotation_createNode_dxi99s_a0b0a0a_0(SLinkOperations.getTarget(SLinkOperations.getTarget(nodeToCheck, "labelDeclaration", false), "targetConcept", false)), false, false, _info_12389875345);
      }
    }
  }
  ...
  private static SNode _quotation_createNode_dxi99s_a0b0a0a(Object parameter_1) {
  ...
  private static SNode _quotation_createNode_dxi99s_a0b0a0a_0(Object parameter_1) {
    SNode quotedNode_2 = null;
    quotedNode_2 = SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.lang.smodel.structure.SNodeType", null, null, GlobalScope.getInstance(), false);
    quotedNode_2.setReferenceTarget("concept", (SNode) parameter_1);
    return quotedNode_2;
