...
/*package*/ class WeaveMacro_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public WeaveMacro_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  /*package*/ EditorCell createCell() {
    return createCollection_1n0h5d_a();
  }

  private EditorCell createCollection_1n0h5d_a() {
    EditorCell_Collection editorCell = EditorCell_Collection.createIndent2(getEditorContext(), myNode);
    editorCell.setCellId("Collection_1n0h5d_a");
    editorCell.setBig(true);
    editorCell.setCellContext(getCellFactory().getCellContext());
    editorCell.addEditorCell(createConstant_1n0h5d_a0());
    editorCell.addEditorCell(createComponent_1n0h5d_b0());
    return editorCell;
  }
  private EditorCell createConstant_1n0h5d_a0() {
    ...
    editorCell.setSubstituteInfo(new CompositeSubstituteInfo(getEditorContext(), new BasicCellContext(myNode), new SubstituteInfoPartExt[]{new WeaveMacro_EditorBuilder_a.WeaveMacro_component_cellMenu_1n0h5d_a0a0(), new SChildSubstituteInfoPartEx(editorCell)}));
    return editorCell;
  }
  ...
  private EditorCell createComponent_1n0h5d_b0() {
