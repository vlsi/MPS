...
public class TemplateArgumentLinkPatternRefExpression_Behavior {
  ...
  public static String virtual_getVariableName_2902001550281937661(SNode thisNode) {
    return PatternVarsUtil.getFieldName(SLinkOperations.getTarget(thisNode, MetaAdapterFactory.getReferenceLink(0xb401a68083254110L, 0x8fd384331ff25befL, 0x42d71bfbeb1a5de8L, 0x42d71bfbeb1a5deaL, "patternVar")));
  }
}
