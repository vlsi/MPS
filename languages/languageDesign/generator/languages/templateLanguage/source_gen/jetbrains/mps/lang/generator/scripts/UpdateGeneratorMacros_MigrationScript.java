  ...
  public UpdateGeneratorMacros_MigrationScript(IOperationContext operationContext) {
    ...
    this.addRefactoring(new AbstractMigrationRefactoring(operationContext) {
      ...
      public boolean isApplicableInstanceNode(SNode node) {
        if ((SLinkOperations.getTarget(node, "mappingLabel", false) == null) || isEmptyString(SPropertyOperations.getString(SLinkOperations.getTarget(node, "mappingLabel", false), "name"))) {
          return false;
        }
