...
public class Templatedescriptor extends TemplateDeclarationBase implements TemplateDeclaration {
  ...
  public Collection<SNode> apply(@NotNull final TemplateExecutionEnvironment environment, @NotNull final TemplateContext context) throws GenerationException {
    ...
    try {
      ...
      {
        SNode tnode2 = null;
        final SNode insertInput2 = QueriesGenerated.insertMacro_Query_1509962061695074412(new TemplateQueryContextWithMacro(context1, insertMacro_e20rlw_b0a0a1a2a1a2));
        tnode2 = environment.insertNode(insertInput2, insertMacro_e20rlw_b0a0a1a2a1a2, context1);
        if (tnode2 != null) {
  ...
  private static SNodePointer insertMacro_e20rlw_b0a0a1a2a1a2 = new SNodePointer("r:1dfaf07d-c77a-451e-91d3-b6f80f0f8508(jetbrains.mps.lang.descriptor.generator.template.main@generator)", "1509962061695074411");
}
