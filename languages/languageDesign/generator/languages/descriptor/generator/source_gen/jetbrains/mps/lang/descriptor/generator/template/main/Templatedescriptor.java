    ...
    try {
...

      {
        ...
        try {
          ...
          final SNode insertInput2 = QueriesGenerated.insertMacro_Query_1509962061695074412(environment.getOperationContext(), new TemplateQueryContextWithMacro(context, insertMacro_e20rlw_a0a0a1a3a1a2, environment.getGenerator()));
