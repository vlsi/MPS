...
public class LanguageDescriptor_Behavior {
  ...
  public static boolean call_isLanguageAspectEmpty_3064888218669923940(SNode thisNode, LanguageAspect languageAspect, TemplateQueryContext genContext) {
    Language l = ModuleRepositoryFacade.getInstance().getModule(ModuleReference.fromString(Module_Behavior.call_getModuleReference_9020561928507315628(SLinkOperations.getTarget(thisNode, "language", true))), Language.class);
    if (l == null) {
