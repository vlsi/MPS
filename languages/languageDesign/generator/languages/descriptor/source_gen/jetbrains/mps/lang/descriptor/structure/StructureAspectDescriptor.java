...
public class StructureAspectDescriptor implements BaseStructureAspectDescriptor {
  ...
  public StructureAspectDescriptor() {
    myFqNameToConcept.put("jetbrains.mps.lang.descriptor.structure.LanguageDescriptor", null);
  }
  ...
  private ConceptDescriptor initLazy(String conceptFqName) {
    ...
    switch (Arrays.binarySearch(stringSwitchCases_1htk8d_a0d0i, conceptFqName)) {
      case 0:
        conceptDescriptor = new ConceptDescriptorBuilder("jetbrains.mps.lang.descriptor.structure.LanguageDescriptor").super_("jetbrains.mps.lang.core.structure.BaseConcept").parents("jetbrains.mps.lang.core.structure.BaseConcept", "jetbrains.mps.lang.core.structure.INamedConcept").children(new String[]{"language"}, new boolean[]{false}).create();
        break;
      default:
  ...
  private static String[] stringSwitchCases_1htk8d_a0d0i = new String[]{"jetbrains.mps.lang.descriptor.structure.LanguageDescriptor"};
}
