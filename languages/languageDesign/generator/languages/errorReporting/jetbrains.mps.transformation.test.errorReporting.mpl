...
<language namespace="jetbrains.mps.transformation.test.errorReporting" uuid="99a58581-8518-40c8-81f1-e364306f5ffc" languageVersion="0" moduleVersion="0">
  ...
  <accessoryModels />
  <generators>
    <generator alias="generator" namespace="jetbrains.mps.transformation.test.errorReporting#7287346816896111110" uuid="c8f0806e-aaf9-46ca-bf04-85538f65af1d" reflective-queries="false">
      <models>
        <modelRoot contentPath="${module}" type="default">
