...
/*package*/ class GenerationContextOp_RegisterLabel_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private static class inputNodeSingleRoleHandler_hi1ek1_b0 extends SingleRoleCellProvider {
    ...
    private void installCellInfo(SNode child, EditorCell editorCell) {
      if (editorCell.getSubstituteInfo() == null || editorCell.getSubstituteInfo() instanceof DefaultSubstituteInfo) {
        editorCell.setSubstituteInfo(new SChildSubstituteInfo(editorCell, myNode, MetaAdapterFactory.getContainmentLink(0xd7706f639be2479cL, 0xa3daae92af1e64d5L, 0x4def01254aef34cdL, 0x4def01254aef7b6eL, "inputNode"), child));
      }
  ...
  private static class outputNodeSingleRoleHandler_hi1ek1_d0 extends SingleRoleCellProvider {
    ...
    private void installCellInfo(SNode child, EditorCell editorCell) {
      if (editorCell.getSubstituteInfo() == null || editorCell.getSubstituteInfo() instanceof DefaultSubstituteInfo) {
        editorCell.setSubstituteInfo(new SChildSubstituteInfo(editorCell, myNode, MetaAdapterFactory.getContainmentLink(0xd7706f639be2479cL, 0xa3daae92af1e64d5L, 0x4def01254aef34cdL, 0x4def01254aef7b78L, "outputNode"), child));
      }
      if (editorCell.getRole() == null) {
      ...
      protected EditorCell createRefCell(EditorContext context, final SNode effectiveNode, SNode node) {
        EditorCell cell = getUpdateSession().updateReferencedNodeCell(new Computable<EditorCell>() {
          public EditorCell compute() {
            return new GenerationContextOp_RegisterLabel_EditorBuilder_a.Inline_Builder_hi1ek1_a5a(getEditorContext(), myNode, effectiveNode).createCell();
          }
        }, effectiveNode, "label");
