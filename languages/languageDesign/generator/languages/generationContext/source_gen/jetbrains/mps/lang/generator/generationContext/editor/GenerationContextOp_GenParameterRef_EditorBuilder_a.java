...
/*package*/ class GenerationContextOp_GenParameterRef_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createRefCell_h52dks_a0() {
    CellProviderWithRole provider = new RefCellCellProvider(myNode, getEditorContext()) {
      ...
      protected InlineCellProvider createInlineCellProvider(SNode innerCellNode) {
        return new GenerationContextOp_GenParameterRef_EditorBuilder_a._Inline_h52dks_a0a(innerCellNode, myNode);
      }
    };
  ...
  public static class _Inline_h52dks_a0a extends InlineCellProvider {
    public _Inline_h52dks_a0a(SNode node, SNode refNode) {
      super(node, refNode);
    }
