...
<language namespace="jetbrains.mps.transformation.test.outputLang" uuid="157a9668-bf58-417b-893e-53d86388dc56">
  ...
  <accessoryModels />
  <generators>
    <generator name="self" generatorUID="jetbrains.mps.transformation.test.outputLang#1209603905948" uuid="de2f9603-575d-4d84-b063-776b6d27a0b9" generate-templates="true" needs-opctx="false">
      <models>
        <modelRoot contentPath="${module}" type="default">
