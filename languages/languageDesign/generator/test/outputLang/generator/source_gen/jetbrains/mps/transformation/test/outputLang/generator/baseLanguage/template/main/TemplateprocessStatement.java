...
public class TemplateprocessStatement implements TemplateDeclarationWeavingAware {
            ...
            try {
...

              {
                ...
                try {
                  ...
                  SNodeAccessUtil.setProperty(tnode4, "text", TemplateUtil.asString(QueriesGenerated.propertyMacro_GetPropertyValue_2681305894288695070(environment.getOperationContext(), new PropertyMacroContext(context, "aa", propertyMacro_slzep9_c0b0c0c0b0d0b0d0b0d0b0i, environment.getGenerator()))));
              ...
              }
              {
                ...
                try {
                  ...
                  SNodeAccessUtil.setProperty(tnode5, "text", TemplateUtil.asString(QueriesGenerated.propertyMacro_GetPropertyValue_2163819695913280744(environment.getOperationContext(), new PropertyMacroContext(context, "ss", propertyMacro_slzep9_c0b0c0c0b0e0b0d0b0d0b0i, environment.getGenerator()))));
            ...
            try {
...

              {
                ...
                try {
                  ...
                  SNodeAccessUtil.setProperty(tnode7, "name", TemplateUtil.asString(QueriesGenerated.propertyMacro_GetPropertyValue_2681305894288695040(environment.getOperationContext(), new PropertyMacroContext(context, "nvar", propertyMacro_slzep9_c0b0c0c0b0d0b0e0b0d0b0i, environment.getGenerator()))));
                  ...
                  }
                  {
                    ...
                    try {
                      ...
                      final SNode copySrcInput9 = QueriesGenerated.sourceNodeQuery_2681305894288695056(environment.getOperationContext(), new SourceSubstituteMacroNodeContext(context, copySrcMacro_slzep9_a0a0a1a5a1a3a1a4a1a3a1a8, environment.getGenerator()));
  ...
  private static SNodePointer templateNode_slzep9_a0a0a1a3a1a3a1a4a1a3a1a9 = new SNodePointer("r:00000000-0000-4000-0000-011c89590606(jetbrains.mps.transformation.test.outputLang.generator.baseLanguage.template.main@generator)", "4265636116363100026");
