...
public class TemplateRootCustom extends TemplateDeclarationBase implements TemplateDeclaration {
              ...
              TemplateContext context9 = context6.subContext();
              {
                ...
                try {
                  ...
                  TemplateContext context10 = context9.subContext();
                  {
                    ...
                    final Object varValue11 = QueriesGenerated.insertMacro_varValue_5015072279636761109(new TemplateVarContext(context10, varMacroRef_kyghau_b0a0a1a2a1a2a1a4a1a5a1a2));
                    ...
                    try {
                      ...
                      TemplateContext context17 = context16.subContext();
                      {
                        ...
                        try {
                          ...
                          environment.resolveInTemplateLater(tnode18, "variableDeclaration", templateNode_kyghau_c0a1a1a2a1a2a1a3a1a4a1a5a1a2, "tpl/r:00000000-0000-4000-0000-011c89590606/5015072279636761135", "q", context17);
                        } finally {
                        }
                        if (tnode18 != null) {
                      ...
                      }
                      {
                        ...
                        try {
                          ...
                          environment.resolveInTemplateLater(tnode19, "variableDeclaration", templateNode_kyghau_c0a1a1a3a1a2a1a3a1a4a1a5a1a2, "tpl/r:00000000-0000-4000-0000-011c89590606/5015072279636761103", "i", context17);
                        } finally {
                        }
                        if (tnode19 != null) {
      ...
      }
      {
        ...
        try {
          ...
          }
          {
            ...
            final SNode copySrcInput23 = QueriesGenerated.sourceNodeQuery_4146564171992412788(new SourceSubstituteMacroNodeContext(context20, copySrcMacro_kyghau_b0a0c0f0b0g0b0c));
            tlist23 = environment.copyNodes(TemplateUtil.singletonList(copySrcInput23), copySrcMacro_kyghau_b0a0c0f0b0g0b0c, "tpl/r:00000000-0000-4000-0000-011c89590606/4146564171992412785", context20);
  ...
  private static SNodePointer varMacroRef_kyghau_b0a0a1a2a1a2a1a4a1a5a1a2 = new SNodePointer("r:00000000-0000-4000-0000-011c89590606(jetbrains.mps.transformation.test.outputLang.generator.baseLanguage.template.main@generator)", "5015072279636761108");
  private static SNodePointer propertyMacro_kyghau_c0a0c0b0b0e0e0c0b0c0b0e0b0f0b0c = new SNodePointer("r:00000000-0000-4000-0000-011c89590606(jetbrains.mps.transformation.test.outputLang.generator.baseLanguage.template.main@generator)", "2721957369897795323");
  private static SNodePointer templateNode_kyghau_c0a1a1a2a1a2a1a3a1a4a1a5a1a2 = new SNodePointer("r:00000000-0000-4000-0000-011c89590606(jetbrains.mps.transformation.test.outputLang.generator.baseLanguage.template.main@generator)", "3021153905120210705");
  private static SNodePointer templateNode_kyghau_c0a1a1a3a1a2a1a3a1a4a1a5a1a2 = new SNodePointer("r:00000000-0000-4000-0000-011c89590606(jetbrains.mps.transformation.test.outputLang.generator.baseLanguage.template.main@generator)", "4265636116363088829");
  private static SNodePointer copySrcMacro_kyghau_b0a0c0f0b0g0b0c = new SNodePointer("r:00000000-0000-4000-0000-011c89590606(jetbrains.mps.transformation.test.outputLang.generator.baseLanguage.template.main@generator)", "4146564171992412787");
}
