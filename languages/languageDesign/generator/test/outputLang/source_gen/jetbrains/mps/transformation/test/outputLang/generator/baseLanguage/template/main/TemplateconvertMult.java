...
public class TemplateconvertMult implements TemplateDeclarationWeavingAware {
  ...
  protected SNode applyPart0(@NotNull final TemplateExecutionEnvironment environment, @NotNull final TemplateContext context) throws GenerationException {
    ...
    try {
      ...
      {
        final jetbrains.mps.smodel.SNode tnode2 = new jetbrains.mps.smodel.SNode("jetbrains.mps.baseLanguage.structure.MulAssignmentExpression");
        try {
...

          {
            ...
            try {
              ...
              tlist3 = environment.copyNodes(TemplateUtil.singletonList(copySrcInput3), copySrcMacro_eum2xg_a0a0a1a3a1a3a1a5, "tpl/r:00000000-0000-4000-0000-011c89590606/4146564171992617075", null, context);
            } finally {
          ...
          environment.getTracer().closeTemplateNode(templateNode_eum2xg_a0a0a1a3a1a5);
        }
        if (tnode2 != null) {
      ...
      environment.getTracer().closeTemplateNode(templateNode_eum2xg_a0a0a1a5);
    }
    return tnode1;
  }
