...
public class Templategen__static__method implements TemplateDeclarationWeavingAware {
  ...
  protected SNode applyPart1(@NotNull final TemplateExecutionEnvironment environment, @NotNull final TemplateContext context) throws GenerationException {
    final jetbrains.mps.smodel.SNode tnode22 = new jetbrains.mps.smodel.SNode("jetbrains.mps.baseLanguage.structure.StaticMethodDeclaration");
    try {
      ...
      {
        final jetbrains.mps.smodel.SNode tnode23 = new jetbrains.mps.smodel.SNode("jetbrains.mps.baseLanguage.structure.VoidType");
        try {
        ...
        try {
...

          {
            ...
            try {
              ...
              {
                final jetbrains.mps.smodel.SNode tnode27 = new jetbrains.mps.smodel.SNode("jetbrains.mps.baseLanguage.structure.LocalStaticMethodCall");
                try {
                  ...
                  {
                    final jetbrains.mps.smodel.SNode tnode28 = new jetbrains.mps.smodel.SNode("jetbrains.mps.baseLanguage.structure.IntegerConstant");
                    try {
