...
public class TwoVarStatement_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createCollection_4qqx9o_a(EditorContext editorContext, SNode node) {
    ...
    editorCell.addEditorCell(this.createConstant_4qqx9o_d0(editorContext, node));
    editorCell.addEditorCell(this.createProperty_4qqx9o_e0(editorContext, node));
  ...
  private EditorCell createConstant_4qqx9o_a0(EditorContext editorContext, SNode node) {
    EditorCell_Constant editorCell = new EditorCell_Constant((jetbrains.mps.nodeEditor.EditorContext) editorContext, node, "twovarroot");
  ...
  private EditorCell createProperty_4qqx9o_c0(EditorContext editorContext, SNode node) {
    ...
    provider.setNoTargetText("<no name1>");
