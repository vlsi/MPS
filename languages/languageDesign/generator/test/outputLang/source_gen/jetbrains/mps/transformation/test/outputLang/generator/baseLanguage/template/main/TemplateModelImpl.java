...
public class TemplateModelImpl implements TemplateModel {
  ...
  private static SModelReference modelRef_wo91o7_a0a5 = new SModelReference(new SModelFqName("jetbrains.mps.transformation.test.outputLang.generator.baseLanguage.template.main", "generator"), SModelId.regular(new UUID(16384L, 1222075024902L)));
}
