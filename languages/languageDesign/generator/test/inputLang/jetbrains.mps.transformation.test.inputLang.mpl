...
<language namespace="jetbrains.mps.transformation.test.inputLang" uuid="ab0ae915-e3b5-4f35-b55a-c655d649a03c" languageVersion="0" moduleVersion="0">
  <models>
  ...
  <accessoryModels />
  <generators>
    <generator alias="tests" namespace="jetbrains.mps.transformation.test.inputLang#1195164860857" uuid="45250695-332a-4a0e-94bc-014e09fa751d" generate-templates="true">
      <models>
        <modelRoot contentPath="${module}" type="default">
      ...
      <dependencyVersions>
        ...
        <module reference="45250695-332a-4a0e-94bc-014e09fa751d(jetbrains.mps.transformation.test.inputLang#1195164860857)" version="0" />
        <module reference="157a9668-bf58-417b-893e-53d86388dc56(jetbrains.mps.transformation.test.outputLang)" version="0" />
      </dependencyVersions>
      <mapping-priorities />
    </generator>
  </generators>
