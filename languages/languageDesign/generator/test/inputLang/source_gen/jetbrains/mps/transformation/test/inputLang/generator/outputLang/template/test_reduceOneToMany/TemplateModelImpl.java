...
public class TemplateModelImpl implements TemplateModel {
  ...
  private static SModelReference modelRef_wo91o7_a0a5 = new SModelReference(new SModelFqName("jetbrains.mps.transformation.test.inputLang.generator.outputLang.template.test_reduceOneToMany", "generator"), jetbrains.mps.smodel.SModelId.regular(new UUID(-1393615837373575713L, -7082312862102583663L)));
}
