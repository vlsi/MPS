...
public class TemplateOutputRoot__1 implements TemplateDeclaration {
  ...
  protected Collection<SNode> applyNode0(@NotNull final TemplateExecutionEnvironment environment, @NotNull final TemplateContext context) throws GenerationException {
    ...
    try {
      ...
      final Iterable<SNode> sourceList1 = QueriesGenerated.sourceNodesQuery_1233603475878(environment.getOperationContext(), new SourceSubstituteMacroNodesContext(context.getInput(), null, mapsrclMacroRef_ewlaka_a0a0a1a2, context, environment.getGenerator()));
                        ...
                        try {
...

                          {
                            ...
                            try {
                              ...
                              SNodeAccessUtil.setProperty(tnode6, "text", TemplateUtil.asString(QueriesGenerated.propertyMacro_GetPropertyValue_1202327274819(environment.getOperationContext(), new PropertyMacroContext(context3.getInput(), "_root_level_was_", propertyMacro_ewlaka_c0b0c0c0b0e0c0d0c0c0d0c0c0c0d0d0b0c, context3, environment.getGenerator()))));
                            ...
                            try {
                              ...
                              if (QueriesGenerated.ifMacro_Condition_1202332796047(environment.getOperationContext(), new IfMacroContext(context3.getInput(), ifMacroRef_ewlaka_a0a0a1a5a2a3a2a2a3a2a2a2a3a3a1a2, context3, environment.getGenerator()))) {
                                ...
                                try {
                                  ...
                                  SNodeAccessUtil.setProperty(tnode8, "text", TemplateUtil.asString(QueriesGenerated.propertyMacro_GetPropertyValue_1202327887568(environment.getOperationContext(), new PropertyMacroContext(context3.getInput(), "_level_1_was_", propertyMacro_ewlaka_c0b0c0c0b0b0b0f0c0d0c0c0d0c0c0c0d0d0b0c, context3, environment.getGenerator()))));
                          ...
                          }
                          {
                            ...
                            try {
                              ...
                              SNodeAccessUtil.setProperty(tnode10, "text", TemplateUtil.asString(QueriesGenerated.propertyMacro_GetPropertyValue_1202327970031(environment.getOperationContext(), new PropertyMacroContext(context3.getInput(), "_level_2_was_", propertyMacro_ewlaka_c0b0c0c0b0g0c0d0c0c0d0c0c0c0d0d0b0c, context3, environment.getGenerator()))));
                        ...
                        if (tnode5 != null) {
                          ...
                          environment.postProcess(new PostProcessor() {
                            public void process(SNode outputNode, TemplateContext postProcessContext) {
                              QueriesGenerated.mapSrcMacro_post_mapper_1225236165359(environment.getOperationContext(), new MapSrcMacroPostProcContext(postProcessContext.getInput(), mapsrcMacroRef_ewlaka_b0b0a0a0a0a0b0d0d0c0c0d0c0c0c0d0d0b0c, outputNode, postProcessContext, environment.getGenerator()));
                            }
                          }, tnode5, context3);
                        }
                      } finally {
  ...
  public Collection<SNode> apply(@NotNull final TemplateExecutionEnvironment environment, @NotNull final TemplateContext context) throws GenerationException {
    ...
    try {
      ...
      environment.getTracer().closeTemplateNode(templateNode_ewlaka_a0a0a1a3);
    }
    return TemplateUtil.singletonList(tnode1);
  }

  private static SNodeReference template_ewlaka_a0a1 = new jetbrains.mps.smodel.SNodePointer("r:00000000-0000-4000-0000-011c895905f7(jetbrains.mps.transformation.test.inputLang.generator.outputLang.template.test_getPrevInput@generator)", "1202255620269");
  private static SNodeReference mapsrclMacroRef_ewlaka_a0a0a1a2 = new jetbrains.mps.smodel.SNodePointer("r:00000000-0000-4000-0000-011c895905f7(jetbrains.mps.transformation.test.inputLang.generator.outputLang.template.test_getPrevInput@generator)", "1233603475877");
  private static SNodeReference loopMacroRef_ewlaka_a0a0a2a3a3a1a2 = new jetbrains.mps.smodel.SNodePointer("r:00000000-0000-4000-0000-011c895905f7(jetbrains.mps.transformation.test.inputLang.generator.outputLang.template.test_getPrevInput@generator)", "1202256587516");
  private static SNodeReference loopMacroRef_ewlaka_a0a0a3a2a2a2a3a3a1a2 = new jetbrains.mps.smodel.SNodePointer("r:00000000-0000-4000-0000-011c895905f7(jetbrains.mps.transformation.test.inputLang.generator.outputLang.template.test_getPrevInput@generator)", "1202256594379");
  private static SNodeReference mapsrcMacroRef_ewlaka_a0a0a3a2a2a3a2a2a2a3a3a1a2 = new jetbrains.mps.smodel.SNodePointer("r:00000000-0000-4000-0000-011c895905f7(jetbrains.mps.transformation.test.inputLang.generator.outputLang.template.test_getPrevInput@generator)", "1202337434278");
  private static SNodeReference templateNode_ewlaka_a0a0a2a3a2a2a3a2a2a2a3a3a1a2 = new jetbrains.mps.smodel.SNodePointer("r:00000000-0000-4000-0000-011c895905f7(jetbrains.mps.transformation.test.inputLang.generator.outputLang.template.test_getPrevInput@generator)", "1202256495546");
  private static SNodeReference propertyMacro_ewlaka_c0b0c0c0c0d0c0c0d0c0c0c0d0d0b0c = new jetbrains.mps.smodel.SNodePointer("r:00000000-0000-4000-0000-011c895905f7(jetbrains.mps.transformation.test.inputLang.generator.outputLang.template.test_getPrevInput@generator)", "1202326517570");
  private static SNodeReference templateNode_ewlaka_a0a0a1a4a2a3a2a2a3a2a2a2a3a3a1a2 = new jetbrains.mps.smodel.SNodePointer("r:00000000-0000-4000-0000-011c895905f7(jetbrains.mps.transformation.test.inputLang.generator.outputLang.template.test_getPrevInput@generator)", "1202327206676");
  private static SNodeReference propertyMacro_ewlaka_c0b0c0c0b0e0c0d0c0c0d0c0c0c0d0d0b0c = new jetbrains.mps.smodel.SNodePointer("r:00000000-0000-4000-0000-011c895905f7(jetbrains.mps.transformation.test.inputLang.generator.outputLang.template.test_getPrevInput@generator)", "1202327274818");
  private static SNodeReference ifMacroRef_ewlaka_a0a0a1a5a2a3a2a2a3a2a2a2a3a3a1a2 = new jetbrains.mps.smodel.SNodePointer("r:00000000-0000-4000-0000-011c895905f7(jetbrains.mps.transformation.test.inputLang.generator.outputLang.template.test_getPrevInput@generator)", "1202332796046");
  private static SNodeReference templateNode_ewlaka_a0a0a1a1a1a5a2a3a2a2a3a2a2a2a3a3a1a2 = new jetbrains.mps.smodel.SNodePointer("r:00000000-0000-4000-0000-011c895905f7(jetbrains.mps.transformation.test.inputLang.generator.outputLang.template.test_getPrevInput@generator)", "1202327778745");
  private static SNodeReference propertyMacro_ewlaka_c0b0c0c0b0b0b0f0c0d0c0c0d0c0c0c0d0d0b0c = new jetbrains.mps.smodel.SNodePointer("r:00000000-0000-4000-0000-011c895905f7(jetbrains.mps.transformation.test.inputLang.generator.outputLang.template.test_getPrevInput@generator)", "1202327887567");
  private static SNodeReference templateNode_ewlaka_a0a0a1a6a2a3a2a2a3a2a2a2a3a3a1a2 = new jetbrains.mps.smodel.SNodePointer("r:00000000-0000-4000-0000-011c895905f7(jetbrains.mps.transformation.test.inputLang.generator.outputLang.template.test_getPrevInput@generator)", "1202327949446");
  private static SNodeReference propertyMacro_ewlaka_c0b0c0c0b0g0c0d0c0c0d0c0c0c0d0d0b0c = new jetbrains.mps.smodel.SNodePointer("r:00000000-0000-4000-0000-011c895905f7(jetbrains.mps.transformation.test.inputLang.generator.outputLang.template.test_getPrevInput@generator)", "1202327970030");
  private static SNodeReference mapsrcMacroRef_ewlaka_b0b0a0a0a0a0b0d0d0c0c0d0c0c0c0d0d0b0c = new jetbrains.mps.smodel.SNodePointer("r:00000000-0000-4000-0000-011c895905f7(jetbrains.mps.transformation.test.inputLang.generator.outputLang.template.test_getPrevInput@generator)", "1202337434278");
  private static SNodeReference templateNode_ewlaka_a0a0a1a3 = new jetbrains.mps.smodel.SNodePointer("r:00000000-0000-4000-0000-011c895905f7(jetbrains.mps.transformation.test.inputLang.generator.outputLang.template.test_getPrevInput@generator)", "1202255620269");
}
