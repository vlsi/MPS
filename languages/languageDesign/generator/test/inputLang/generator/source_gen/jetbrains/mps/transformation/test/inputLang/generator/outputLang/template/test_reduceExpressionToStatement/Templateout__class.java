...
@Generated
public class Templateout__class extends TemplateDeclarationBase implements TemplateDeclaration {
      ...
      }
      {
        ...
        try {
          ...
          }
          {
            ...
            final SNode copySrcInput6 = QueriesGenerated.sourceNodeQuery_1209150187921(new SourceSubstituteMacroNodeContext(context3, copySrcMacro_lohefm_b0a0c0f0b0e0b0c));
            tlist6 = environment.copyNodes(TemplateUtil.singletonList(copySrcInput6), copySrcMacro_lohefm_b0a0c0f0b0e0b0c, "tpl/r:00000000-0000-4000-0000-011c895905f8/1209150155199", context3);
  ...
  private static SNodePointer copySrcMacro_lohefm_b0a0c0f0b0e0b0c = new SNodePointer("r:00000000-0000-4000-0000-011c895905f8(jetbrains.mps.transformation.test.inputLang.generator.outputLang.template.test_reduceExpressionToStatement@generator)", "1209150187920");
}
