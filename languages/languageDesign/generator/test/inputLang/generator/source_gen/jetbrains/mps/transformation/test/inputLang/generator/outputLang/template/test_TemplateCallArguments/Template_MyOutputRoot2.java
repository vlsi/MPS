...
public class Template_MyOutputRoot2 extends TemplateDeclarationBase implements TemplateDeclaration {
  ...
  public Collection<SNode> apply(@NotNull final TemplateExecutionEnvironment environment, @NotNull final TemplateContext context) throws GenerationException {
    ...
    try {
      ...
      TemplateContext context1 = context.subContext();
      {
        ...
        final Iterable<SNode> copyListInput2 = QueriesGenerated.sourceNodesQuery_7496726876599914779(new SourceSubstituteMacroNodesContext(context1, copySrcListMacro_930b4v_b0a0a1a4a1a7));
        tlist2 = environment.copyNodes(copyListInput2, copySrcListMacro_930b4v_b0a0a1a4a1a7, "tpl/r:f37420d7-c952-44cf-aaac-346288c56298/7496726876599914771", context1);
  ...
  private static SNodePointer template_930b4v_a0a6 = new SNodePointer("r:f37420d7-c952-44cf-aaac-346288c56298(jetbrains.mps.transformation.test.inputLang.generator.outputLang.template.test_TemplateCallArguments@generator)", "6736062018948453396");
  private static SNodePointer copySrcListMacro_930b4v_b0a0a1a4a1a7 = new SNodePointer("r:f37420d7-c952-44cf-aaac-346288c56298(jetbrains.mps.transformation.test.inputLang.generator.outputLang.template.test_TemplateCallArguments@generator)", "7496726876599914776");
}
