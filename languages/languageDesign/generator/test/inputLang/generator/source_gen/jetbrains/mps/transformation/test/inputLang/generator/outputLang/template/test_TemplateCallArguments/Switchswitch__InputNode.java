...
@Generated
public class Switchswitch__InputNode extends TemplateSwitchBase implements TemplateSwitchMapping {
  private final Iterable<TemplateReductionRule> rules;
  public Switchswitch__InputNode() {
    rules = TemplateUtil.<TemplateReductionRule>asIterable(new Switchswitch__InputNode.ReductionRule0(), new Switchswitch__InputNode.ReductionRule1(), new Switchswitch__InputNode.ReductionRule2());
  }
  ...
  public final class ReductionRule1 extends ReductionRuleBase {
    ...
    public Collection<SNode> apply(@NotNull final TemplateContext context) throws GenerationException {
      ...
      final Object varValue1 = QueriesGenerated.insertMacro_varValue_6736062018948583815(new TemplateVarContext(context, varMacroRef_irasky_b0a0a2a1i));
      TemplateContext context1 = context.withVariable("var:xxx", varValue1);
      Collection<SNode> tlist2 = null;
      tlist2 = new Templateproduce__OutputNode(((String) context1.getVariable("var:xxx"))).apply(environment, context1);
      tlist1 = tlist2;
      return tlist1;
    }
  }
  public final class ReductionRule2 extends ReductionRuleBase {
    ...
    public Collection<SNode> apply(@NotNull final TemplateContext context) throws GenerationException {
      final TemplateExecutionEnvironment environment = context.getEnvironment();
      Collection<SNode> tlist1 = null;
      tlist1 = new Templateproduce__OutputNode(((String) QueriesGenerated.templateArgumentQuery_6736062018948608740(new TemplateArgumentContext(context, new SNodePointer("r:f37420d7-c952-44cf-aaac-346288c56298(jetbrains.mps.transformation.test.inputLang.generator.outputLang.template.test_TemplateCallArguments@generator)", "6736062018948608740"))))).apply(environment, context);
      return tlist1;
    }
  }
  private static SNodePointer varMacroRef_irasky_b0a0a2a1i = new SNodePointer("r:f37420d7-c952-44cf-aaac-346288c56298(jetbrains.mps.transformation.test.inputLang.generator.outputLang.template.test_TemplateCallArguments@generator)", "6736062018948583813");
}
