...
@Generated
public class Templateproduce__OutputNode extends TemplateDeclarationBase implements TemplateDeclarationWeavingAware {
  private String myText;
  public Templateproduce__OutputNode(String text) {
    this.myText = text;
  }
  ...
  protected SNode applyPart0(@NotNull final TemplateExecutionEnvironment environment, @NotNull final TemplateContext context) throws GenerationException {
    ...
    try {
      ...
      SNodeAccessUtil.setProperty(tnode1, MetaAdapterFactory.getProperty(0x157a9668bf58417bL, 0x893e53d86388dc56L, 0x1164564a526L, 0x11645b5a797L, "text"), TemplateUtil.asString(QueriesGenerated.propertyMacro_GetPropertyValue_6736062018948578789(new PropertyMacroContext(context, "x", propertyMacro_tja8us_c0a0c0b0b0e))));
    } finally {
    }
    return tnode1;
  }
  ...
  public Collection<SNode> weave(@NotNull TemplateExecutionEnvironment environment, @NotNull TemplateContext context, @NotNull SNode outputContextNode) throws GenerationException {
    ...
    SNodeReference weaveTf0 = new SNodePointer("r:f37420d7-c952-44cf-aaac-346288c56298(jetbrains.mps.transformation.test.inputLang.generator.outputLang.template.test_TemplateCallArguments@generator)", "6736062018948578784");
  ...
  private static SNodePointer propertyMacro_tja8us_c0a0c0b0b0e = new SNodePointer("r:f37420d7-c952-44cf-aaac-346288c56298(jetbrains.mps.transformation.test.inputLang.generator.outputLang.template.test_TemplateCallArguments@generator)", "6736062018948578788");
}
