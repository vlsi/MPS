...
public class AdditionalStructurePropertiesImpl extends ConceptPresentationAspectBase {
  ...
  private final ConceptPresentation props_ConceptTextGenDeclaration = new ConceptPresentationBuilder().icon("textGen.png", AdditionalStructurePropertiesImpl.class).create();
  ...
  private final ConceptPresentation
      props_LanguageTextGenDeclaration = new ConceptPresentationBuilder().icon("textGenComponent.png", AdditionalStructurePropertiesImpl.class).create();
