...
import jetbrains.mps.lang.textGen.behavior.LanguageTextGenDeclaration_BehaviorDescriptor;
    ...
    List<SubstituteAction> result = ListSequence.fromList(new ArrayList<SubstituteAction>());
    {
      Iterable<SNode> queryResult = new Computable<Iterable<SNode>>() {
        public Iterable<SNode> compute() {
          ...
          if (langTextGen != null) {
            return LanguageTextGenDeclaration_BehaviorDescriptor.getParameters_idhXZLLl0.invoke(langTextGen);
          } else {
