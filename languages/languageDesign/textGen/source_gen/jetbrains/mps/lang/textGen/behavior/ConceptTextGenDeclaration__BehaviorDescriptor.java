...
public final class ConceptTextGenDeclaration__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<Boolean> shallProduceOutputUnit_id3fG6dkhfrk3 = new SMethodBuilder<Boolean>(new SJavaCompoundTypeImpl(Boolean.TYPE)).name("shallProduceOutputUnit").modifiers(SModifiersImpl.create(0, AccessPrivileges.PUBLIC)).concept(CONCEPT).id("3fG6dkhfrk3").registry(REGISTRY).build(SParameterImpl.fromList(SJavaCompoundTypeImpl.fromClasses()));

  private static final List<SMethod<?>> BH_METHODS = Arrays.<SMethod<?>>asList(getAvailableOperations_idhXYHpEa, getBaseConcept_id2hxg_BDjKM8, setBaseConcept_id5r_35Ihc58c, shallProduceOutputUnit_id3fG6dkhfrk3);
  ...
  private static Boolean shallProduceOutputUnit_id3fG6dkhfrk3(@NotNull SNode __thisNode__) {
  ...
  protected <T> T invokeSpecial0(@NotNull SNode node, @NotNull SMethod<T> method, @NotNull Object[] parameters) {
    ...
    switch (methodIndex) {
      ...
      case 2:
        ...
        return null;
      case 3:
        return (T) shallProduceOutputUnit_id3fG6dkhfrk3(node);
      default:
        throw new BHMethodNotFoundException(this, method);
    }
  }
