...
<language namespace="jetbrains.mps.diagramEditor.editor" uuid="eb39f327-b818-413f-965b-ffce0270b64d">
  ...
  <accessoryModels />
  <generators>
    <generator name="" generatorUID="jetbrains.mps.diagramEditor.editor#8079565114666170352" uuid="ffe575a8-745e-4975-b791-0bba75b69a3c">
      <models>
        <modelRoot contentPath="${module}" type="default">
      ...
      <mapping-priorities>
        <mapping-priority-rule kind="strictly_together">
          <greater-priority-mapping>
            <generator generatorUID="ffe575a8-745e-4975-b791-0bba75b69a3c(jetbrains.mps.diagramEditor.editor#8079565114666170352)" />
            <external-mapping>
              <mapping-node modelUID="r:cf57beef-1dd0-4fd5-902c-b761ef94e609(jetbrains.mps.diagramEditor.editor.generator.template.main@generator)" nodeID="8079565114666170353" />
            </external-mapping>
          </greater-priority-mapping>
