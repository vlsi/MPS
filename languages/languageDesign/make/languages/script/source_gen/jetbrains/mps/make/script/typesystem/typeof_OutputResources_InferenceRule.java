    ...
    if (!(typeCheckingContext.isSingleTypeComputation())) {
      {
        ...
        typeCheckingContext.createLessThanInequality((SNode) typeCheckingContext.typeOf(_nodeToCheck_1029348928467, "r:b90ae0cf-6b91-458a-92d0-e5bf2ada7de4(jetbrains.mps.make.script.typesystem)", "2360002718792622208", true), (SNode) new typeof_OutputResources_InferenceRule.QuotationClass_rptc1i_a0a0a0().createNode(typeCheckingContext), true, true, _info_12389875345);
      }
    }
  }
