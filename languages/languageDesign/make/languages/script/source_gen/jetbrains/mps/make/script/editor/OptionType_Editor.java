...
public class OptionType_Editor extends DefaultNodeEditor {
  public EditorCell createEditorCell(EditorContext editorContext, SNode node) {
    return this.createCollection_xgjw32_a(editorContext, node);
  }
  ...
  private EditorCell createCollection_xgjw32_a(EditorContext editorContext, SNode node) {
    ...
    editorCell.addEditorCell(this.createConceptProperty_xgjw32_a0(editorContext, node));
    ...
    editorCell.addEditorCell(this.createConstant_xgjw32_d0(editorContext, node));
    return editorCell;
  }

  private EditorCell createConstant_xgjw32_b0(EditorContext editorContext, SNode node) {
  ...
  private EditorCell createRefCell_xgjw32_c0(EditorContext editorContext, SNode node) {
  ...
  private EditorCell createConceptProperty_xgjw32_a0(EditorContext editorContext, SNode node) {
  ...
  public static class _Inline_xgjw32_a2a extends InlineCellProvider {
    ...
    public EditorCell createEditorCell(EditorContext editorContext, SNode node) {
      return this.createProperty_xgjw32_a0c0(editorContext, node);
    }

    private EditorCell createProperty_xgjw32_a0c0(EditorContext editorContext, SNode node) {
