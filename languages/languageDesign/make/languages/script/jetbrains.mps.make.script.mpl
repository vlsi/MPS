...
<language namespace="jetbrains.mps.make.script" uuid="95f8a3e6-f994-4ca0-a65e-763c9bae2d3b" generatorOutputPath="${module}/source_gen">
  <models>
  ...
  <accessoryModels />
  <generators>
    <generator name="java" generatorUID="jetbrains.mps.make.script#4629164904928166564" uuid="aaee1c4d-a7f9-41f6-9218-3a0ebac06eb4" needs-opctx="false">
      <models>
        <modelRoot contentPath="${module}" type="default">
