...
<language namespace="jetbrains.mps.make.script" uuid="95f8a3e6-f994-4ca0-a65e-763c9bae2d3b" languageVersion="0" moduleVersion="0">
  <models>
  ...
  <accessoryModels />
  <generators>
    <generator alias="java" namespace="jetbrains.mps.make.script#4629164904928166564" uuid="aaee1c4d-a7f9-41f6-9218-3a0ebac06eb4" reflective-queries="false">
      <models>
        <modelRoot contentPath="${module}" type="default">
      ...
      <dependencies>
        ...
        <dependency reexport="false">3349c57b-62f9-4ce2-a22d-d9bd99edc6a6(jetbrains.mps.make.facet#5086995156117116954)</dependency>
      </dependencies>
      <languageVersions>
