...
public class AdditionalStructurePropertiesImpl extends BaseAdditionalStructureProperties {
  private final AdditionalConceptProperties props_ExtendsFacetReference = new ConceptPropsBuilder().create();
  private final AdditionalConceptProperties props_FacetDeclaration = new ConceptPropsBuilder().icon("facetDeclaration.png", AdditionalStructurePropertiesImpl.class).create();
  private final AdditionalConceptProperties props_FacetJavaClassExpression = new ConceptPropsBuilder().create();
  private final AdditionalConceptProperties props_FacetReference = new ConceptPropsBuilder().create();
  private final AdditionalConceptProperties props_FacetReferenceExpression = new ConceptPropsBuilder().create();
  private final AdditionalConceptProperties props_ForeignParametersComponentExpression = new ConceptPropsBuilder().create();
  private final AdditionalConceptProperties props_ForeignParametersExpression = new ConceptPropsBuilder().create();
  private final AdditionalConceptProperties props_IFacet = new ConceptPropsBuilder().create();
  private final AdditionalConceptProperties props_IPropertyExpression = new ConceptPropsBuilder().create();
  private final AdditionalConceptProperties props_LocalParametersComponentExpression = new ConceptPropsBuilder().create();
  private final AdditionalConceptProperties props_LocalParametersExpression = new ConceptPropsBuilder().create();
  private final AdditionalConceptProperties props_NamedFacetReference = new ConceptPropsBuilder().create();
  private final AdditionalConceptProperties props_ParametersDeclaration = new ConceptPropsBuilder().create();
  private final AdditionalConceptProperties props_RelatedFacetReference = new ConceptPropsBuilder().create();
  private final AdditionalConceptProperties props_ResourceClassifierType = new ConceptPropsBuilder().create();
  private final AdditionalConceptProperties props_ResourceSpecificPropertiesExpression = new ConceptPropsBuilder().create();
  private final AdditionalConceptProperties props_ResourceTypeDeclaration = new ConceptPropsBuilder().create();
  private final AdditionalConceptProperties props_TargetDeclaration = new ConceptPropsBuilder().create();
  private final AdditionalConceptProperties props_TargetDependency = new ConceptPropsBuilder().create();
  private final AdditionalConceptProperties props_TargetReferenceExpression = new ConceptPropsBuilder().create();
