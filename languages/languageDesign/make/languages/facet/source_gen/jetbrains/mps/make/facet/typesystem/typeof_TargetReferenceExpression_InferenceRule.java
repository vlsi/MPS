...
public class typeof_TargetReferenceExpression_InferenceRule extends AbstractInferenceRule_Runtime implements InferenceRule_Runtime {
  ...
  private static SNode _quotation_createNode_kzmuql_a0a0b() {
    ...
    quotedNode_1.setReference("classifier", SReference.create("classifier", quotedNode_1, SModelReference.fromString("r:71895ceb-c89d-4545-aa38-89d1cd891f17(jetbrains.mps.make.facet)"), jetbrains.mps.smodel.SNodeId.fromString("6168415856807657135")));
    return quotedNode_1;
  }
}
