...
public final class MigrationScriptPart_Instance_Predicate_BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0xeddeefac2d64437L, 0xbc2cde50fd4ce470L, 0x11225f8301cL, "jetbrains.mps.lang.script.structure.MigrationScriptPart_Instance_Predicate");
  ...
  private static SNode getExpectedReturnType_idhEwIGRD(@NotNull SNode __thisNode__) {
    return _quotation_createNode_uvheco_a0a1();
  }

  /*package*/ MigrationScriptPart_Instance_Predicate_BehaviorDescriptor() {
    super(REGISTRY);
  }
  ...
  private static SNode _quotation_createNode_uvheco_a0a1() {
