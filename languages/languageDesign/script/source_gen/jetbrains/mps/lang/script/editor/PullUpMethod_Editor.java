...
public class PullUpMethod_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createCollection_errt5h_a(EditorContext editorContext, SNode node) {
    ...
    editorCell.addEditorCell(this.createConceptProperty_errt5h_a0(editorContext, node));
    editorCell.addEditorCell(this.createRefCell_errt5h_b0(editorContext, node));
  ...
  private EditorCell createConceptProperty_errt5h_a0(EditorContext editorContext, SNode node) {
