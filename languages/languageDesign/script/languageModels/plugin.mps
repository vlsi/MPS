...
<model ref="r:db7af0ad-3d1a-4f64-a9bf-f3dc73570877(jetbrains.mps.lang.script.plugin)">
  ...
  <node concept="3vrhyV" id="2LiUEk8oQ$g">
    ...
    <node concept="3vrm2R" id="2LiUEk8oQ$h" role="3vrhxp">
      <node concept="2V$Bhx" id="4r4fzRRxNib" role="2V$M_3">
    ...
    <node concept="1QGGSu" id="4lJsQ5yF4MG" role="3vqPLo">
      <node concept="1QGGTy" id="4lJsQ5yF4MI" role="3xaMm5">
        <ref role="1QGGTH" node="4lJsQ5yENiu" resolve="SCRIPTSMODEL" />
      </node>
    </node>
  ...
  <node concept="1QGGSo" id="4lJsQ5yENit">
    <property role="TrG5h" value="ScriptsAspect" />
