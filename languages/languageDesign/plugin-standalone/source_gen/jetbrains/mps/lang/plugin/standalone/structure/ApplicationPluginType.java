...
public class ApplicationPluginType extends BaseClassifierType {
  public static final String concept = "jetbrains.mps.lang.plugin.standalone.structure.ApplicationPluginType";
  ...
  public static ApplicationPluginType newInstance(SModel sm, boolean init) {
    return (ApplicationPluginType) SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.lang.plugin.standalone.structure.ApplicationPluginType", sm, GlobalScope.getInstance(), init).getAdapter();
  }
