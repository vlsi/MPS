...
public class ProjectPluginType extends BaseClassifierType {
  public static final String concept = "jetbrains.mps.lang.plugin.standalone.structure.ProjectPluginType";
  ...
  public static ProjectPluginType newInstance(SModel sm, boolean init) {
    return (ProjectPluginType) SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.lang.plugin.standalone.structure.ProjectPluginType", sm, GlobalScope.getInstance(), init).getAdapter();
  }
