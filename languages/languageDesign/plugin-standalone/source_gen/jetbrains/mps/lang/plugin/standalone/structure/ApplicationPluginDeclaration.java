...
public class ApplicationPluginDeclaration extends BaseConcept implements IClassifier {
  public static final String concept = "jetbrains.mps.lang.plugin.standalone.structure.ApplicationPluginDeclaration";
  ...
  public static ApplicationPluginDeclaration newInstance(SModel sm, boolean init) {
    return (ApplicationPluginDeclaration) SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.lang.plugin.standalone.structure.ApplicationPluginDeclaration", sm, GlobalScope.getInstance(), init).getAdapter();
  }
