...
public class ProjectPluginDeclaration extends BaseConcept implements IClassifier {
  public static final String concept = "jetbrains.mps.lang.plugin.standalone.structure.ProjectPluginDeclaration";
  ...
  public static ProjectPluginDeclaration newInstance(SModel sm, boolean init) {
    return (ProjectPluginDeclaration) SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.lang.plugin.standalone.structure.ProjectPluginDeclaration", sm, GlobalScope.getInstance(), init).getAdapter();
  }
