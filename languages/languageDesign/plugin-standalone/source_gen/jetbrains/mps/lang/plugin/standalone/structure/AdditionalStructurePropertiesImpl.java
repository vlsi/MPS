...
public class AdditionalStructurePropertiesImpl extends ConceptPresentationAspectBase {
  private final ConceptPresentation
      props_ApplicationPluginDeclaration = new ConceptPresentationBuilder().icon("applicationPlugin.png", AdditionalStructurePropertiesImpl.class).create();
  ...
  private final ConceptPresentation
      props_ProjectPluginDeclaration = new ConceptPresentationBuilder().icon("projectPlugin.png", AdditionalStructurePropertiesImpl.class).create();
