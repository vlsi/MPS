...
public final class MappingConfigNormalRef_BehaviorDescriptor extends BaseBHDescriptor {
  ...
  private static Boolean isComplete_id2n3WChplftH(@NotNull SNode __thisNode__) {
    ...
    if (SPropertyOperations.getString(__thisNode__, MetaAdapterFactory.getProperty(0x86ef829012bb4ca7L, 0x947f093788f263a9L, 0x25c3f28459572777L, 0x25c3f28459572778L, "modelUID")).equals("*")) {
      return true;
    }
  ...
  /*package*/ MappingConfigNormalRef_BehaviorDescriptor() {
    super(REGISTRY);
  }
