...
<model ref="r:7be9d1d9-acb4-4fe3-8096-96178feee8f5(jetbrains.mps.lang.findUsages.plugin)">
  ...
  <node concept="3vrhyV" id="2LiUEk8oQ$g">
    ...
    <node concept="3vrm2R" id="2LiUEk8oQ$h" role="3vrhxp">
      <node concept="2V$Bhx" id="57HLayrBoxQ" role="2V$M_3">
    ...
    <node concept="1QGGSu" id="4lJsQ5yF4MG" role="3vqPLo">
      <node concept="1QGGTA" id="P5ZkC6w5dO" role="3xaMm5">
        <node concept="1QGGSu" id="P5ZkC6w5dQ" role="1QGGTw">
          <property role="1QGGTI" value="${module}/icons/findUsagesModel.png" />
        </node>
      </node>
    </node>
    <node concept="1sEMCm" id="4lJsQ5yF8Ox" role="1sFm88">
      <property role="1sEMCp" value="http://confluence.jetbrains.com/display/MPSD33/Find+usages" />
    </node>
  </node>
</model>
