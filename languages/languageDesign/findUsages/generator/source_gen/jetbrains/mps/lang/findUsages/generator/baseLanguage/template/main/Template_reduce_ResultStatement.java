...
@Generated
public class Template_reduce_ResultStatement extends TemplateDeclarationBase {
  public Template_reduce_ResultStatement() {
  }
  ...
  protected SNode applyPart0(@NotNull final TemplateContext context) throws GenerationException {
    ...
    try {
      ...
      TemplateContext context1 = context.subContext();
      {
        ...
        try {
          environment.nodeCopied(context1, tnode2, "tpl/r:00000000-0000-4000-0000-011c8959035c/1206533844012");
          TemplateContext context2 = context1.subContext();
          {
            ...
            try {
              environment.nodeCopied(context2, tnode3, "tpl/r:00000000-0000-4000-0000-011c8959035c/3021153905151704221");
              environment.resolveInTemplateLater(tnode3, "variableDeclaration", templateNode_qqjy1b_c0a1a1a2a1a2a2a2, "tpl/r:00000000-0000-4000-0000-011c8959035c/1207142326869", "_results", context2);
            } finally {
            }
            if (tnode3 != null) {
          ...
          }
          {
            ...
            try {
              environment.nodeCopied(context2, tnode4, "tpl/r:00000000-0000-4000-0000-011c8959035c/1206533844014");
              TemplateContext context4 = context2.subContext();
              {
                Collection<SNode> tlist5 = null;
                final SNode copySrcInput5 = QueriesGenerated.sourceNodeQuery_1206533844017(new SourceSubstituteMacroNodeContext(context4, copySrcMacro_qqjy1b_b0a0c0c0b0d0b0c0c0c));
                tlist5 = environment.copyNodes(TemplateUtil.singletonList(copySrcInput5), copySrcMacro_qqjy1b_b0a0c0c0b0d0b0c0c0c, "tpl/r:00000000-0000-4000-0000-011c8959035c/1206533844015", context4);
  ...
  private static SNodePointer templateNode_qqjy1b_c0a1a1a2a1a2a2a2 = new SNodePointer("r:00000000-0000-4000-0000-011c8959035c(jetbrains.mps.lang.findUsages.generator.baseLanguage.template.main@generator)", "3021153905151704221");
  private static SNodePointer copySrcMacro_qqjy1b_b0a0c0c0b0d0b0c0c0c = new SNodePointer("r:00000000-0000-4000-0000-011c8959035c(jetbrains.mps.lang.findUsages.generator.baseLanguage.template.main@generator)", "1206533844016");
}
