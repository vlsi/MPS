...
public class Mappingmain implements TemplateMappingConfiguration {
  ...
  public class ReductionRule4 implements TemplateReductionRule {
    ...
    private Collection<SNode> apply(final TemplateContext context, final TemplateExecutionEnvironment environment) throws GenerationException {
      ...
      final jetbrains.mps.smodel.SNode tnode1 = new jetbrains.mps.smodel.SNode("jetbrains.mps.baseLanguage.structure.StaticMethodCall");
      try {
...

        {
          ...
          try {
            ...
            if (QueriesGenerated.ifMacro_Condition_4192433084863763888(environment.getOperationContext(), new IfMacroContext(context.getInput(), ifMacroRef_417xrn_a0a0a1a5a2a5v, context, environment.getGenerator()))) {
              ...
              final jetbrains.mps.smodel.SNode tnode4 = new jetbrains.mps.smodel.SNode("jetbrains.mps.baseLanguage.structure.GenericNewExpression");
              try {
                ...
                {
                  final jetbrains.mps.smodel.SNode tnode5 = new jetbrains.mps.smodel.SNode("jetbrains.mps.baseLanguage.structure.ClassCreator");
                  try {
        ...
        }
        {
          ...
          try {
            ...
            if (QueriesGenerated.ifMacro_Condition_4192433084863763916(environment.getOperationContext(), new IfMacroContext(context.getInput(), ifMacroRef_417xrn_a0a0a1a7a2a5v, context, environment.getGenerator()))) {
              ...
              final jetbrains.mps.smodel.SNode tnode11 = new jetbrains.mps.smodel.SNode("jetbrains.mps.baseLanguage.structure.StaticMethodCall");
              try {
          ...
          try {
            ...
            for (SNode itnode2 : loopList2) {
              ...
              try {
                ...
                final jetbrains.mps.smodel.SNode tnode3 = new jetbrains.mps.smodel.SNode("jetbrains.mps.baseLanguage.structure.StaticMethodCall");
                try {
                  ...
                  {
                    final jetbrains.mps.smodel.SNode tnode4 = new jetbrains.mps.smodel.SNode("jetbrains.mps.baseLanguage.structure.StringLiteral");
                    try {
