  ...
  public class ReductionRule4 implements TemplateReductionRule {
    ...
    private Collection<SNode> apply(final TemplateContext context, final TemplateExecutionEnvironment environment) throws GenerationException {
      ...
      try {
        ...
        tnode1.setReference("classConcept", SReference.create("classConcept", tnode1, SModelReference.fromString("f:java_stub#6ed54515-acc8-4d1e-a16c-9fd6cfe951ea#jetbrains.mps.ide.findusages.view(MPS.Core/jetbrains.mps.ide.findusages.view@java_stub)"), jetbrains.mps.smodel.SNodeId.fromString("~FindUtils")));
        tnode1.setReference("baseMethodDeclaration", SReference.create("baseMethodDeclaration", tnode1, SModelReference.fromString("f:java_stub#6ed54515-acc8-4d1e-a16c-9fd6cfe951ea#jetbrains.mps.ide.findusages.view(MPS.Core/jetbrains.mps.ide.findusages.view@java_stub)"), jetbrains.mps.smodel.SNodeId.fromString("~FindUtils.getSearchResults(jetbrains.mps.progress.ProgressMonitor,org.jetbrains.mps.openapi.model.SNode,jetbrains.mps.smodel.IScope,java.lang.String...):jetbrains.mps.ide.findusages.model.SearchResults")));
              ...
              try {
...

                {
                  ...
                  try {
                    ...
                    tnode5.setReference("baseMethodDeclaration", SReference.create("baseMethodDeclaration", tnode5, SModelReference.fromString("f:java_stub#6ed54515-acc8-4d1e-a16c-9fd6cfe951ea#jetbrains.mps.progress(MPS.Core/jetbrains.mps.progress@java_stub)"), jetbrains.mps.smodel.SNodeId.fromString("~EmptyProgressMonitor.<init>()")));
          ...
          try {
            ...
            if (QueriesGenerated.ifMacro_Condition_4192433084863763916(environment.getOperationContext(), new IfMacroContext(context.getInput(), ifMacroRef_417xrn_a0a0a1a7a2a5v, context, environment.getGenerator()))) {
              ...
              try {
                ...
                tnode11.setReference("classConcept", SReference.create("classConcept", tnode11, SModelReference.fromString("f:java_stub#6ed54515-acc8-4d1e-a16c-9fd6cfe951ea#jetbrains.mps.project(MPS.Core/jetbrains.mps.project@java_stub)"), jetbrains.mps.smodel.SNodeId.fromString("~GlobalScope")));
                tnode11.setReference("baseMethodDeclaration", SReference.create("baseMethodDeclaration", tnode11, SModelReference.fromString("f:java_stub#6ed54515-acc8-4d1e-a16c-9fd6cfe951ea#jetbrains.mps.project(MPS.Core/jetbrains.mps.project@java_stub)"), jetbrains.mps.smodel.SNodeId.fromString("~GlobalScope.getInstance():jetbrains.mps.project.GlobalScope")));
  ...
  public class ReductionRule5 implements TemplateReductionRule {
    ...
    private Collection<SNode> apply(final TemplateContext context, final TemplateExecutionEnvironment environment) throws GenerationException {
      ...
      try {
        ...
        tnode1.setReference("baseMethodDeclaration", SReference.create("baseMethodDeclaration", tnode1, SModelReference.fromString("f:java_stub#6ed54515-acc8-4d1e-a16c-9fd6cfe951ea#jetbrains.mps.ide.findusages.view(MPS.Core/jetbrains.mps.ide.findusages.view@java_stub)"), jetbrains.mps.smodel.SNodeId.fromString("~FindUtils.makeProvider(jetbrains.mps.ide.findusages.findalgorithm.finders.IFinder...):jetbrains.mps.ide.findusages.model.IResultProvider")));
        tnode1.setReference("classConcept", SReference.create("classConcept", tnode1, SModelReference.fromString("f:java_stub#6ed54515-acc8-4d1e-a16c-9fd6cfe951ea#jetbrains.mps.ide.findusages.view(MPS.Core/jetbrains.mps.ide.findusages.view@java_stub)"), jetbrains.mps.smodel.SNodeId.fromString("~FindUtils")));
            ...
            for (SNode itnode2 : loopList2) {
              ...
              try {
                ...
                try {
                  ...
                  tnode3.setReference("baseMethodDeclaration", SReference.create("baseMethodDeclaration", tnode3, SModelReference.fromString("f:java_stub#6ed54515-acc8-4d1e-a16c-9fd6cfe951ea#jetbrains.mps.ide.findusages.view(MPS.Core/jetbrains.mps.ide.findusages.view@java_stub)"), jetbrains.mps.smodel.SNodeId.fromString("~FindUtils.getFinderByClassName(java.lang.String):jetbrains.mps.ide.findusages.findalgorithm.finders.GeneratedFinder")));
                  tnode3.setReference("classConcept", SReference.create("classConcept", tnode3, SModelReference.fromString("f:java_stub#6ed54515-acc8-4d1e-a16c-9fd6cfe951ea#jetbrains.mps.ide.findusages.view(MPS.Core/jetbrains.mps.ide.findusages.view@java_stub)"), jetbrains.mps.smodel.SNodeId.fromString("~FindUtils")));
