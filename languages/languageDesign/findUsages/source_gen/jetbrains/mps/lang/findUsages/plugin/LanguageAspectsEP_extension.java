  ...
  public LanguageAspectDescriptor get() {
    return new LanguageAspectDescriptor() {
      ...
      public Collection<SLanguage> getMainLanguages() {
        return ListSequence.fromListAndArray(new ArrayList<SLanguage>(), MetaAdapterFactory.getLanguage(MetaIdFactory.langId(0x64d34fcdad024e73L, 0xaff8a581124c2e30L), "jetbrains.mps.lang.findUsages"));
      }
      @Nullable
      ...
      public String getHelpUrl() {
        return "http://confluence.jetbrains.com/display/MPSD33/Find+usages";
      }
      ...
      private final Icon ICON = IconResourceBundle_UsagesAspect.getInstance().getResource("USAGESMODEL");
