...
public class Language extends LanguageRuntime {
  public static final String MODULE_REF = "982eb8df-2c96-4bd7-9963-11712ea622e5(jetbrains.mps.lang.resources)";
  public Language() {
  }
  @Override
  ...
  public SLanguageId getId() {
    return new SLanguageId(UUID.fromString("982eb8df-2c96-4bd7-9963-11712ea622e5"));
  }
  @Override
  ...
  protected <T extends ILanguageAspect> T createAspect(Class<T> aspectClass) {
    ...
    if (aspectClass.getName().equals("jetbrains.mps.smodel.runtime.BehaviorAspectDescriptor")) {
      if (aspectClass == BehaviorAspectDescriptor.class) {
        return (T) new jetbrains.mps.lang.resources.behavior.BehaviorAspectDescriptor();
      }
    }
    if (aspectClass.getName().equals("jetbrains.mps.smodel.runtime.ConstraintsAspectDescriptor")) {
      if (aspectClass == ConstraintsAspectDescriptor.class) {
        return (T) new jetbrains.mps.lang.resources.constraints.ConstraintsAspectDescriptor();
      }
    }
