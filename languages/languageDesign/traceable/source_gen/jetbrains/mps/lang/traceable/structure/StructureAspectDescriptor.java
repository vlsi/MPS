...
public class StructureAspectDescriptor implements BaseStructureAspectDescriptor {
  ...
  public StructureAspectDescriptor() {
    myFqNameToConcept.put("jetbrains.mps.lang.traceable.structure.ScopeConcept", null);
    myFqNameToConcept.put("jetbrains.mps.lang.traceable.structure.TraceableConcept", null);
    myFqNameToConcept.put("jetbrains.mps.lang.traceable.structure.UnitConcept", null);
  }
  ...
  private ConceptDescriptor initLazy(String conceptFqName) {
    ...
    switch (Arrays.binarySearch(stringSwitchCases_1htk8d_a0d0i, conceptFqName)) {
      case 0:
        conceptDescriptor = new ConceptDescriptorBuilder("jetbrains.mps.lang.traceable.structure.ScopeConcept").interface_().create();
        break;
      case 1:
        conceptDescriptor = new ConceptDescriptorBuilder("jetbrains.mps.lang.traceable.structure.TraceableConcept").interface_().create();
        break;
      case 2:
        conceptDescriptor = new ConceptDescriptorBuilder("jetbrains.mps.lang.traceable.structure.UnitConcept").interface_().create();
        break;
      default:
  ...
  private static String[] stringSwitchCases_1htk8d_a0d0i = new String[]{"jetbrains.mps.lang.traceable.structure.ScopeConcept", "jetbrains.mps.lang.traceable.structure.TraceableConcept", "jetbrains.mps.lang.traceable.structure.UnitConcept"};
}
