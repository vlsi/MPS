...
public class ScopesExpectedNode_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createCollection_pnhdpl_a(EditorContext editorContext, SNode node) {
    ...
    editorCell.addEditorCell(this.createRefCell_pnhdpl_a0(editorContext, node));
    return editorCell;
  }

  private EditorCell createRefCell_pnhdpl_a0(EditorContext editorContext, SNode node) {
