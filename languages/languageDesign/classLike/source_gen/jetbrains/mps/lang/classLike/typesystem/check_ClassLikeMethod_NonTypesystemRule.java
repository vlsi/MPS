  ...
  public void applyRule(final SNode classLikeMethod, final TypeCheckingContext typeCheckingContext, IsApplicableStatus status) {
    ...
    if (ListSequence.fromList(SLinkOperations.getTargets(classLikeMethod, "parameter", true)).count() == ListSequence.fromList(SLinkOperations.getTargets(SLinkOperations.getTarget(classLikeMethod, "decl", false), "param", true)).count()) {
      for (int i = 0; i < ListSequence.fromList(SLinkOperations.getTargets(classLikeMethod, "parameter", true)).count(); i++) {
        ...
        error |= neq_p6nv7a_a0a1a0a2a1(SPropertyOperations.getString(ListSequence.fromList(SLinkOperations.getTargets(SLinkOperations.getTarget(classLikeMethod, "decl", false), "param", true)).getElement(i), "name"), SPropertyOperations.getString(ListSequence.fromList(SLinkOperations.getTargets(classLikeMethod, "parameter", true)).getElement(i), "name"));
      }
    } else {
      error = true;
    }
