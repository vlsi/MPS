...
public class ConceptFunc_Behavior {
  public static void init(SNode thisNode) {
    ConceptFuncInfo info = ConceptFunc_Behavior.call_getInfo_3751132065236798379(thisNode);
    if (info != null) {
      ConceptFunc_Behavior.call_fillFromInfo_3751132065236798394(thisNode, info);
    }
  }
  public static ConceptFuncInfo call_getInfo_3751132065236798379(SNode thisNode) {
    return MapSequence.fromMap(BehaviorReflection.invokeVirtual((Class<Map<String, ConceptFuncInfo>>) ((Class) Object.class), SNodeOperations.as(SNodeOperations.getParent(thisNode), "jetbrains.mps.lang.classLike.structure.ConceptFuncContainter"), "virtual_getConceptFuncs_3751132065236798156", new Object[]{})).get(SPropertyOperations.getString(thisNode, "name"));
  }
  public static void call_fillFromInfo_3751132065236798394(SNode thisNode, ConceptFuncInfo info) {
  ...
  public static String call_getHeader_3751132065236798497(SNode thisNode) {
