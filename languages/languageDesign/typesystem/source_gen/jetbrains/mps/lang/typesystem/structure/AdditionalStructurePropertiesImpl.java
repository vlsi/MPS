...
public class AdditionalStructurePropertiesImpl extends ConceptPresentationAspectBase {
  ...
  private final ConceptPresentation props_ComparisonRule = new ConceptPresentationBuilder().icon("comparison.png", AdditionalStructurePropertiesImpl.class).create();
  ...
  private final ConceptPresentation
      props_InequationReplacementRule = new ConceptPresentationBuilder().icon("replacement.png", AdditionalStructurePropertiesImpl.class).create();
  private final ConceptPresentation props_InferenceRule = new ConceptPresentationBuilder().deprecated().icon("rule.png", AdditionalStructurePropertiesImpl.class).create();
  ...
  private final ConceptPresentation props_NonTypesystemRule = new ConceptPresentationBuilder().icon("nontypesystem.png", AdditionalStructurePropertiesImpl.class).create();
  ...
  private final ConceptPresentation
      props_OverloadedOpRulesContainer = new ConceptPresentationBuilder().icon("overloadedRules.png", AdditionalStructurePropertiesImpl.class).create();
  ...
  private final ConceptPresentation props_SubstituteTypeRule = new ConceptPresentationBuilder().icon("substitute.png", AdditionalStructurePropertiesImpl.class).create();
  private final ConceptPresentation props_SubtypingRule = new ConceptPresentationBuilder().icon("subtyping.png", AdditionalStructurePropertiesImpl.class).create();
  ...
  private final ConceptPresentation props_TypesystemQuickFix = new ConceptPresentationBuilder().icon("quickFix.png", AdditionalStructurePropertiesImpl.class).create();
  ...
  private final ConceptPresentation
      props_VariableConvertersContainer = new ConceptPresentationBuilder().icon("variableReplacement.png", AdditionalStructurePropertiesImpl.class).create();
