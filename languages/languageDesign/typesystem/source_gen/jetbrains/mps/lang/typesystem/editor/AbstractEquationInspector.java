...
public class AbstractEquationInspector implements ConceptEditorComponent {
  @NotNull
  ...
  private EditorCell createRefNode_gj4y2c_b0a(EditorContext editorContext, SNode node) {
    SingleRoleCellProvider provider = new AbstractEquationInspector.nodeToCheckSingleRoleHandler_gj4y2c_b0a(node, MetaAdapterFactory.getContainmentLink(0x7a5dda6291404668L, 0xab76d5ed1746f2b2L, 0x1117f3c1ffaL, 0x1117f58cf99L, "nodeToCheck"), editorContext);
  ...
  private EditorCell createRefNode_gj4y2c_b1a(EditorContext editorContext, SNode node) {
    SingleRoleCellProvider provider = new AbstractEquationInspector.errorStringSingleRoleHandler_gj4y2c_b1a(node, MetaAdapterFactory.getContainmentLink(0x7a5dda6291404668L, 0xab76d5ed1746f2b2L, 0x1117f3c1ffaL, 0x112d82366d0L, "errorString"), editorContext);
    return provider.createCell();
  }
  ...
  private static class helginsIntentionListHandler_gj4y2c_g0 extends RefNodeListHandler {
    ...
    public EditorCell createEmptyCell(EditorContext editorContext) {
      editorContext.getCellFactory().pushCellContext();
      editorContext.getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(helginsIntentionListHandler_gj4y2c_g0.this.getOwner(), MetaAdapterFactory.getContainmentLink(0x7a5dda6291404668L, 0xab76d5ed1746f2b2L, 0x1117f3c1ffaL, 0x11b2b6fabb9L, "helginsIntention")));
      try {
