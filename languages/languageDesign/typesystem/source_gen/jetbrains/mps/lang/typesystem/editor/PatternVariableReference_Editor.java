...
public class PatternVariableReference_Editor extends DefaultNodeEditor {
  public EditorCell createEditorCell(EditorContext editorContext, SNode node) {
    return this.createCollection_bm8m1i_a(editorContext, node);
  }
  ...
  private EditorCell createRefCell_bm8m1i_a0(EditorContext editorContext, SNode node) {
  ...
  public static class _Inline_bm8m1i_a0a extends InlineCellProvider {
    ...
    public EditorCell createEditorCell(EditorContext editorContext, SNode node) {
      return this.createProperty_bm8m1i_a0a0(editorContext, node);
    }
    private EditorCell createProperty_bm8m1i_a0a0(EditorContext editorContext, SNode node) {
