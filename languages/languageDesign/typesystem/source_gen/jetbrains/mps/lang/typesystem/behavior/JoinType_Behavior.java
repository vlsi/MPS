...
public class JoinType_Behavior {
  ...
  public static String virtual_getPresentation_1213877396640(SNode thisNode) {
    ...
    List<SNode> nodes = SLinkOperations.getChildren(thisNode, MetaAdapterFactory.getContainmentLink(new UUID(8817443762339858024l, -6091446231697526094l), 1179479408386l, 1179479418730l, "argument"));
    for (SNode arg : nodes) {
