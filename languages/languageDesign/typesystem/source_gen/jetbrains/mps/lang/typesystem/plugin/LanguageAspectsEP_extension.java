  ...
  public LanguageAspectDescriptor get() {
    return new LanguageAspectDescriptor() {
      ...
      public Collection<SLanguage> getMainLanguages() {
        return ListSequence.fromListAndArray(new ArrayList<SLanguage>(), MetaAdapterFactory.getLanguage(MetaIdFactory.langId(0x7a5dda6291404668L, 0xab76d5ed1746f2b2L), "jetbrains.mps.lang.typesystem"));
      }
      @Nullable
      ...
      public String getHelpUrl() {
        return "http://confluence.jetbrains.com/display/MPSD33/Typesystem";
      }
      ...
      private final Icon ICON = IconResourceBundle_TypesystemAspect.getInstance().getResource("TYPESYSTEMMODEL");
