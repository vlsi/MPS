...
public class ReportErrorStatement_Behavior {
  ...
  public static void virtual_attachNewMessageAnnotation_8489045168661849665(SNode thisNode) {
    SNode newAnnotation = SNodeFactoryOperations.createNewNode(SNodeFactoryOperations.asInstanceConcept(MetaAdapterFactory.getConcept(new UUID(8817443762339858024l, -6091446231697526094l), 7992060018732187438l, "jetbrains.mps.lang.typesystem.structure.ReportErrorStatementAnnotation")), null);
  ...
  public static String virtual_getName_1597542831856389237(SNode thisNode) {
    if ((AttributeOperations.getAttribute(thisNode, new IAttributeDescriptor.NodeAttribute("jetbrains.mps.lang.typesystem.structure.MessageStatementAnnotation")) != null)) {
      ...
      String nameGenerated = MessageStatementUtil.generateNameFromExpression(SLinkOperations.getTarget(thisNode, MetaAdapterFactory.getContainmentLink(new UUID(8817443762339858024l, -6091446231697526094l), 1175517767210l, 1175517851849l, "errorString")));
