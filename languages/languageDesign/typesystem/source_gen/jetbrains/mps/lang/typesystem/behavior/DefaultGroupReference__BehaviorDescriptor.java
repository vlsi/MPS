...
public final class DefaultGroupReference_BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<String> createGeneratedNodeId_id6nAedb8XAuf = new SMethodBuilder<String>(new SJavaCompoundTypeImpl(String.class)).name("createGeneratedNodeId").modifiers(SModifiersImpl.create(8, AccessPrivileges.PUBLIC)).concept(CONCEPT).id("6nAedb8XAuf").registry(REGISTRY).build(SParameterImpl.fromList(SJavaCompoundTypeImpl.fromClasses()));
  ...
  private static String createGeneratedNodeId_id6nAedb8XAuf(@NotNull SNode __thisNode__) {
    return "default";
  }
  ...
  protected <T> T invokeSpecial0(@NotNull SNode node, @NotNull SMethod<T> method, @NotNull Object[] parameters) {
    ...
    switch (methodIndex) {
      case 0:
        return (T) createGeneratedNodeId_id6nAedb8XAuf(node);
      default:
        throw new BHMethodNotFoundException(this, method);
    }
  }
