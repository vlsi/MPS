...
public class LinkPatternVariableReference_Editor extends DefaultNodeEditor {
  public EditorCell createEditorCell(EditorContext editorContext, SNode node) {
    return this.createCollection_wvkzjd_a(editorContext, node);
  }
  ...
  private EditorCell createRefCell_wvkzjd_a0(EditorContext editorContext, SNode node) {
  ...
  public static class _Inline_wvkzjd_a0a extends InlineCellProvider {
    ...
    public EditorCell createEditorCell(EditorContext editorContext, SNode node) {
      return this.createProperty_wvkzjd_a0a0(editorContext, node);
    }
    private EditorCell createProperty_wvkzjd_a0a0(EditorContext editorContext, SNode node) {
