    ...
    if (kind == SConceptOperations.findConceptDeclaration("jetbrains.mps.lang.structure.structure.PropertyDeclaration")) {
      {
        ...
        if (coercedNode_wbtxu4_a0a0c != null) {
          return new SimpleScope(AbstractConceptDeclaration_Behavior.call_getPropertyDeclarations_1213877394546(SLinkOperations.getTarget(coercedNode_wbtxu4_a0a0c, "concept", false))) {
            @Nullable
