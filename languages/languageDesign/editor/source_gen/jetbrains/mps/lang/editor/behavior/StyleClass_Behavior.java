  ...
  public static int call_getPriority_1938068300780663696(SNode thisNode) {
    ...
    while (ListSequence.fromList(extendsTree).isNotEmpty()) {
      ...
      if (ListSequence.fromList(extendsTree).tail(ListSequence.fromList(extendsTree).count() - 1).contains(ListSequence.fromList(extendsTree).first())) {
        ...
        if ((SLinkOperations.getTarget(ListSequence.fromList(extendsTree).first(), "extendedStyleClassList", true) != null) && ListSequence.fromList(SLinkOperations.getTargets(SLinkOperations.getTarget(ListSequence.fromList(extendsTree).first(), "extendedStyleClassList", true), "element", true)).isNotEmpty()) {
          MapSequence.fromMap(priorities).put(ListSequence.fromList(extendsTree).first(), (Sequence.fromIterable(SNodeOperations.ofConcept(SLinkOperations.getTargets(SLinkOperations.getTarget(ListSequence.fromList(extendsTree).first(), "extendedStyleClassList", true), "element", true), "jetbrains.mps.lang.editor.structure.SimpleOverrideItem")).isEmpty() ? -1 : 1));
          ListSequence.fromList(extendsTree).insertElement(0, SLinkOperations.getTarget(Sequence.fromIterable(SNodeOperations.ofConcept(SLinkOperations.getTargets(SLinkOperations.getTarget(ListSequence.fromList(extendsTree).first(), "extendedStyleClassList", true), "element", true), "jetbrains.mps.lang.editor.structure.StyleClassReference")).first(), "styleClass", false));

          ListSequence.fromList(childNums).insertElement(0, 0);
        } else if ((SLinkOperations.getTarget(ListSequence.fromList(extendsTree).first(), "extendedStyleClassList", true) != null)) {
        ...
        assert newIndex <= ListSequence.fromList(SLinkOperations.getTargets(SLinkOperations.getTarget(ListSequence.fromList(extendsTree).getElement(1), "extendedStyleClassList", true), "element", true)).count();
        ...
        while (newIndex < ListSequence.fromList(SLinkOperations.getTargets(SLinkOperations.getTarget(ListSequence.fromList(extendsTree).first(), "extendedStyleClassList", true), "element", true)).count() && SNodeOperations.isInstanceOf(ListSequence.fromList(SLinkOperations.getTargets(SLinkOperations.getTarget(ListSequence.fromList(extendsTree).first(), "extendedStyleClassList", true), "element", true)).getElement(newIndex), "jetbrains.mps.lang.editor.structure.StyleClassReference")) {
          newIndex++;
        ...
        if (newIndex < ListSequence.fromList(SLinkOperations.getTargets(SLinkOperations.getTarget(ListSequence.fromList(extendsTree).first(), "extendedStyleClassList", true), "element", true)).count()) {
          ListSequence.fromList(extendsTree).insertElement(0, SLinkOperations.getTarget(SNodeOperations.cast(ListSequence.fromList(SLinkOperations.getTargets(SLinkOperations.getTarget(ListSequence.fromList(extendsTree).first(), "extendedStyleClassList", true), "element", true)).getElement(newIndex), "jetbrains.mps.lang.editor.structure.StyleClassReference"), "styleClass", false));
