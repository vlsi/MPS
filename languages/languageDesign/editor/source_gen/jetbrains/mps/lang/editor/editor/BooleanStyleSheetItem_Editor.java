...
import jetbrains.mps.lang.editor.behavior.BooleanStyleSheetItem_BehaviorDescriptor;
...
public class BooleanStyleSheetItem_Editor extends DefaultNodeEditor {
  ...
  private static boolean renderingCondition_689p1d_a3a(SNode node, EditorContext editorContext) {
    return (SLinkOperations.getTarget(node, MetaAdapterFactory.getContainmentLink(0x18bc659203a64e29L, 0xa83a7ff23bde13baL, 0x1143bd1283bL, 0x11cd79149a9L, "query")) != null) && BooleanStyleSheetItem_BehaviorDescriptor.useQuery_idhNn$rq2.invoke(node);
  }
}
