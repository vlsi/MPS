...
public final class QueryFunction_ContextAssistantExecuteFunction__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0x18bc659203a64e29L, 0xa83a7ff23bde13baL, 0x16be955f384f95eeL, "jetbrains.mps.lang.editor.structure.QueryFunction_ContextAssistantExecuteFunction");
  ...
  private static final List<SMethod<?>> BH_METHODS = Arrays.<SMethod<?>>asList(showName_id1653mnvAgry, getName_idhGVcmek);
  ...
  /*package*/ QueryFunction_ContextAssistantExecuteFunction__BehaviorDescriptor() {
    super(REGISTRY);
  }
