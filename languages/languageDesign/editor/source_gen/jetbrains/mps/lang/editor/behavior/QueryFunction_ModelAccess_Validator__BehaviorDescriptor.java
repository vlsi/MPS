...
public final class QueryFunction_ModelAccess_Validator__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  /*package*/ static List<SConcept> getParameterConcepts_id2xELmDxyi2v(@NotNull SNode __thisNode__) {
    ...
    ListSequence.fromList(result).addElement(MetaAdapterFactory.getConcept(0x18bc659203a64e29L, 0xa83a7ff23bde13baL, 0x111faaffcc5L, "jetbrains.mps.lang.editor.structure.ConceptFunctionParameter_oldText"));
  ...
  /*package*/ QueryFunction_ModelAccess_Validator__BehaviorDescriptor() {
    super(REGISTRY);
  }
