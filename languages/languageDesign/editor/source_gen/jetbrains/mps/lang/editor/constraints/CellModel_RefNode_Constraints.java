...
public class CellModel_RefNode_Constraints extends BaseConstraintsDescriptor {
  public CellModel_RefNode_Constraints() {
    super(MetaIdFactory.conceptId(0x18bc659203a64e29L, 0xa83a7ff23bde13baL, 0xf9eb05cdc7L));
  }
  @Override
      ...
      public ReferenceScopeProvider getScopeProvider() {
        return new BaseReferenceScopeProvider() {
          ...
          public Object createSearchScopeOrListOfNodes(final IOperationContext operationContext, final ReferenceConstraintsContext _context) {
            ...
            List<SNode> links = AbstractConceptDeclaration_BehaviorDescriptor.getAggregationLinkDeclarations_idhEwILLp.invoke(editedConcept);
          ...
          public SNodeReference getSearchScopeValidatorNode() {
            return breakingNode_l5izay_a0a1a0a0a1a0b0a1a1;
          }
        };
      }
    });
  ...
  private static SNodePointer breakingNode_l5izay_a0a1a0a0a1a0b0a1a1 = new SNodePointer("r:00000000-0000-4000-0000-011c89590298(jetbrains.mps.lang.editor.constraints)", "1213104860581");
}
