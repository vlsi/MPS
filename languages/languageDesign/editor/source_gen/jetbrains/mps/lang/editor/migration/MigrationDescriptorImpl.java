...
public class MigrationDescriptorImpl implements MigrationDescriptor {
  private Map<Integer, MigrationScript> myScripts = MapSequence.<Integer, MigrationScript>fromMapAndKeysArray(new HashMap<Integer, MigrationScript>(), 0).withValues(new MigrateShowIfConditionRespectingChildAttributes());
