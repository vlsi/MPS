...
public class CellModel_TransactionalProperty_Constraints extends BaseConstraintsDescriptor {
  private static SNodePointer breakingNode_bnan1a_a0a1a0a0a1a0b0a1a0 = new SNodePointer("r:00000000-0000-4000-0000-011c89590298(jetbrains.mps.lang.editor.constraints)", "1216381244848");

  public CellModel_TransactionalProperty_Constraints() {
    super("jetbrains.mps.lang.editor.structure.CellModel_TransactionalProperty");
  }
      ...
      public ReferenceScopeProvider getScopeProvider() {
        return new BaseReferenceScopeProvider() {
          ...
          public SNodePointer getSearchScopeValidatorNode() {
            return breakingNode_bnan1a_a0a1a0a0a1a0b0a1a0;
          }
        };
      }
    });
