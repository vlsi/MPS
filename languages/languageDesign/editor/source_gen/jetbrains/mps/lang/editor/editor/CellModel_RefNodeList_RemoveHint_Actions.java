...
public class CellModel_RefNodeList_RemoveHint_Actions {
  ...
  public static class CellModel_RefNodeList_RemoveHint_Actions_INSERT extends AbstractCellAction {
    ...
    public void execute_internal(EditorContext editorContext, SNode node) {
      SLinkOperations.setTarget(node, MetaAdapterFactory.getContainmentLink(new UUID(1782411230332735017l, -6324602048325217350l), 1073390211982l, 7279578193766667847l, "removeHints"), SConceptOperations.createNewNode("jetbrains.mps.lang.editor.structure.ExplicitHintsSpecification", null));
    }
  }
