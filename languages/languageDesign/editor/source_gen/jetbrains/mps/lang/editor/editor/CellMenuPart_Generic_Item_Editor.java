...
public class CellMenuPart_Generic_Item_Editor extends DefaultNodeEditor {
  ...
  private class handlerFunctionSingleRoleHandler_9wjygj_c1b1a extends SingleRoleCellProvider {
    ...
    protected EditorCell createEmptyCell() {
      ...
      editorCell.setTransformationMenuLookup(new DefaultEmptyCellSubstituteMenuLookup(MetaAdapterFactory.getContainmentLink(0x18bc659203a64e29L, 0xa83a7ff23bde13baL, 0x10f58b5e5f6L, 0x10f58b5e5f8L, "handlerFunction")));
