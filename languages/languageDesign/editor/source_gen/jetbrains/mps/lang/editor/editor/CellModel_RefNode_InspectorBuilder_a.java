...
/*package*/ class CellModel_RefNode_InspectorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createCollection_2hk56f_d0() {
    ...
    if (renderingCondition_2hk56f_a1d0(myNode, getEditorContext())) {
      editorCell.addEditorCell(createCollection_2hk56f_b3a());
    }
    if (renderingCondition_2hk56f_a2d0(myNode, getEditorContext())) {
  ...
  private EditorCell createRefCell_2hk56f_b0d0() {
    ...
    provider.setAuxiliaryCellProvider(new CellModel_RefNode_InspectorBuilder_a._Inline_2hk56f_a1a3a());
  ...
  public static class _Inline_2hk56f_a1a3a extends InlineCellProvider {
    ...
    public EditorCell createEditorCell(EditorContext editorContext, SNode node) {
      ...
      return new CellModel_RefNode_InspectorBuilder_a.Inline_Builder_2hk56f_a1a3a(editorContext, getRefNode(), node).createCell();
    }
  }
  ...
  private class addHintsSingleRoleHandler_2hk56f_b4d0 extends SingleRoleCellProvider {
    ...
    private void installCellInfo(SNode child, EditorCell editorCell) {
      if (editorCell.getSubstituteInfo() == null || editorCell.getSubstituteInfo() instanceof DefaultSubstituteInfo) {
        editorCell.setSubstituteInfo(new OldNewCompositeSubstituteInfo(getEditorContext(), new SChildSubstituteInfo(editorCell, getNode(), MetaAdapterFactory.getContainmentLink(0x18bc659203a64e29L, 0xa83a7ff23bde13baL, 0xf9eb05cdc7L, 0x51568a5db0d45e0fL, "addHints"), child), new DefaultChildSubstituteInfo(getNode(), myContainmentLink.getDeclarationNode(), getEditorContext())));
      }
      if (editorCell.getRole() == null) {
  ...
  private class removeHintsSingleRoleHandler_2hk56f_b5d0 extends SingleRoleCellProvider {
    ...
    private void installCellInfo(SNode child, EditorCell editorCell) {
      if (editorCell.getSubstituteInfo() == null || editorCell.getSubstituteInfo() instanceof DefaultSubstituteInfo) {
        editorCell.setSubstituteInfo(new OldNewCompositeSubstituteInfo(getEditorContext(), new SChildSubstituteInfo(editorCell, getNode(), MetaAdapterFactory.getContainmentLink(0x18bc659203a64e29L, 0xa83a7ff23bde13baL, 0xf9eb05cdc7L, 0x51568a5db0d45e10L, "removeHints"), child), new DefaultChildSubstituteInfo(getNode(), myContainmentLink.getDeclarationNode(), getEditorContext())));
      }
      if (editorCell.getRole() == null) {
