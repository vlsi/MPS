...
/*package*/ class SubstituteBuildersMigrationHelper {
      ...
      if (SNodeOperations.isInstanceOf(oldPart, MetaAdapterFactory.getConcept(0xaee9cad2acd44608L, 0xaef20004f6a1cdbdL, 0x1121dfa84e4L, "jetbrains.mps.lang.actions.structure.AddMenuPart"))) {
        for (SNode oldSubPart : ListSequence.fromList(SLinkOperations.getChildren(SNodeOperations.cast(oldPart, MetaAdapterFactory.getConcept(0xaee9cad2acd44608L, 0xaef20004f6a1cdbdL, 0x1121dfa84e4L, "jetbrains.mps.lang.actions.structure.AddMenuPart")), MetaAdapterFactory.getContainmentLink(0xaee9cad2acd44608L, 0xaef20004f6a1cdbdL, 0x1121e8bfbfdL, 0x1121e8c6f00L, "part")))) {
          if (SNodeOperations.isInstanceOf(oldSubPart, MetaAdapterFactory.getConcept(0xaee9cad2acd44608L, 0xaef20004f6a1cdbdL, 0x1121e328443L, "jetbrains.mps.lang.actions.structure.SimpleItemSubstitutePart"))) {
            SNode action = createSimpleAction(SNodeOperations.cast(oldSubPart, MetaAdapterFactory.getConcept(0xaee9cad2acd44608L, 0xaef20004f6a1cdbdL, 0x1121e328443L, "jetbrains.mps.lang.actions.structure.SimpleItemSubstitutePart")), oldVariableToNew);
            result.add(action);
  ...
  private SNode createSimpleAction(SNode oldPart, Map<SNode, SNode> oldVariableToNew) {
    ...
    SNode action = createTransformationMenuAction(oldMatchingText, oldVariableToNew, oldDescriptionText, oldActionType, oldHandlerBody, oldSelectionHandlerBody, false);
    return action;
  }
  ...
  private SNode createTransformationMenuAction(SNode oldMatchingText, Map<SNode, SNode> oldVariableToNew, SNode oldDescriptionText, SNode oldActionType, SNode oldHandlerBody, SNode oldSelectionHandlerBody, boolean isParameterized) {
    ...
    SNode lastStatement = ListSequence.fromList(SLinkOperations.getChildren(SLinkOperations.getTarget(SLinkOperations.getTarget(action, MetaAdapterFactory.getContainmentLink(0x18bc659203a64e29L, 0xa83a7ff23bde13baL, 0x16be955f384f93e6L, 0x16be955f384f93e9L, "executeFunction")), MetaAdapterFactory.getContainmentLink(0xf3061a5392264cc5L, 0xa443f952ceaf5816L, 0x108bbca0f48L, 0x108bbd29b4aL, "body")), MetaAdapterFactory.getContainmentLink(0xf3061a5392264cc5L, 0xa443f952ceaf5816L, 0xf8cc56b200L, 0xf8cc6bf961L, "statement"))).reversedList().findFirst(new IWhereFilter<SNode>() {
      public boolean accept(SNode it) {
        return !((eq_uzg6hh_a0a0a0a0a0a0a8a6(SNodeOperations.getConcept(it), MetaAdapterFactory.getConcept(0xf3061a5392264cc5L, 0xa443f952ceaf5816L, 0xf8cc56b215L, "jetbrains.mps.baseLanguage.structure.Statement"))));
      }
    });
  ...
  private SNode createSelectingOperation(SNode returnExpression) {
    ...
    SLinkOperations.setTarget(select, MetaAdapterFactory.getContainmentLink(0x18bc659203a64e29L, 0xa83a7ff23bde13baL, 0x329d4406465c63a0L, 0x1b0a9b8c0eb90bdeL, "cellSelector"), _quotation_createNode_uzg6hh_a0e0i());
  ...
  private void fillText(SNode oldPartText, SNode newPartText, Map<SNode, SNode> oldVariableToNew, boolean isParameterized) {
    if ((oldPartText == null)) {
      ...
      if (isParameterized) {
        ...
        ListSequence.fromList(SLinkOperations.getChildren(SLinkOperations.getTarget(newPartText, MetaAdapterFactory.getContainmentLink(0xf3061a5392264cc5L, 0xa443f952ceaf5816L, 0x108bbca0f48L, 0x108bbd29b4aL, "body")), MetaAdapterFactory.getContainmentLink(0xf3061a5392264cc5L, 0xa443f952ceaf5816L, 0xf8cc56b200L, 0xf8cc6bf961L, "statement"))).addElement(_quotation_createNode_uzg6hh_a0a0a0b0a0j());
      }
    ...
    for (SNode ref : ListSequence.fromList(varRefs)) {
      ...
      while (parent != null) {
        ...
        SNode applicant = ListSequence.fromList(varDecls).findFirst(new IWhereFilter<SNode>() {
          public boolean accept(SNode it) {
            return eq_uzg6hh_a0a0a0a0a0a2a1a01a41(SPropertyOperations.getString(it, MetaAdapterFactory.getProperty(0xceab519525ea4f22L, 0x9b92103b95ca8c0cL, 0x110396eaaa4L, 0x110396ec041L, "name")), name);
          }
        });
        if (applicant != null) {
  ...
  private static boolean eq_uzg6hh_a0a0a0a0a0a0a8a6(Object a, Object b) {
    return (a != null ? a.equals(b) : a == b);
  }
  private static SNode _quotation_createNode_uzg6hh_a0e0i() {
  ...
  private static SNode _quotation_createNode_uzg6hh_a0a0a0b0a0j() {
    PersistenceFacade facade = PersistenceFacade.getInstance();
    SNode quotedNode_1 = null;
    SNode quotedNode_2 = null;
  ...
  private static boolean eq_uzg6hh_a0a0a0a0a0a2a1a01a41(Object a, Object b) {
    return (a != null ? a.equals(b) : a == b);
  }
}
