...
public final class CellModel_Collection_BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<Boolean> isVertical_idi0pAV23 = new SMethodBuilder<Boolean>(new SJavaCompoundTypeImpl(Boolean.TYPE)).name("isVertical").modifiers(SModifiersImpl.create(0, AccessPrivileges.PUBLIC)).concept(CONCEPT).id("i0pAV23").registry(REGISTRY).build(SParameterImpl.fromList(SJavaCompoundTypeImpl.fromClasses()));
  public static final SMethod<Boolean> isVerticalGrid_idi2IbWq8 = new SMethodBuilder<Boolean>(new SJavaCompoundTypeImpl(Boolean.TYPE)).name("isVerticalGrid").modifiers(SModifiersImpl.create(0, AccessPrivileges.PUBLIC)).concept(CONCEPT).id("i2IbWq8").registry(REGISTRY).build(SParameterImpl.fromList(SJavaCompoundTypeImpl.fromClasses()));
  public static final SMethod<Boolean> isHorizontal_idi0pB4gH = new SMethodBuilder<Boolean>(new SJavaCompoundTypeImpl(Boolean.TYPE)).name("isHorizontal").modifiers(SModifiersImpl.create(0, AccessPrivileges.PUBLIC)).concept(CONCEPT).id("i0pB4gH").registry(REGISTRY).build(SParameterImpl.fromList(SJavaCompoundTypeImpl.fromClasses()));
  public static final SMethod<Boolean> isIndentLayout_idi0pB9jQ = new SMethodBuilder<Boolean>(new SJavaCompoundTypeImpl(Boolean.TYPE)).name("isIndentLayout").modifiers(SModifiersImpl.create(0, AccessPrivileges.PUBLIC)).concept(CONCEPT).id("i0pB9jQ").registry(REGISTRY).build(SParameterImpl.fromList(SJavaCompoundTypeImpl.fromClasses()));
  public static final SMethod<Boolean> isFoldingEnabled_id1_9L3A4DrOF = new SMethodBuilder<Boolean>(new SJavaCompoundTypeImpl(Boolean.TYPE)).name("isFoldingEnabled").modifiers(SModifiersImpl.create(0, AccessPrivileges.PUBLIC)).concept(CONCEPT).id("1_9L3A4DrOF").registry(REGISTRY).build(SParameterImpl.fromList(SJavaCompoundTypeImpl.fromClasses()));
  public static final SMethod<Boolean> isVerticalIndent_idi0tOX1j = new SMethodBuilder<Boolean>(new SJavaCompoundTypeImpl(Boolean.TYPE)).name("isVerticalIndent").modifiers(SModifiersImpl.create(0, AccessPrivileges.PUBLIC)).concept(CONCEPT).id("i0tOX1j").registry(REGISTRY).build(SParameterImpl.fromList(SJavaCompoundTypeImpl.fromClasses()));
  ...
  /*package*/ static final SMethod<Boolean> canBeSynchronized_id3wXm3h1BRps = new SMethodBuilder<Boolean>(new SJavaCompoundTypeImpl(Boolean.TYPE)).name("canBeSynchronized").modifiers(SModifiersImpl.create(0, AccessPrivileges.PRIVATE)).concept(CONCEPT).id("3wXm3h1BRps").registry(REGISTRY).build(SParameterImpl.fromList(SJavaCompoundTypeImpl.fromClasses((Class<SNode>) ((Class) Object.class))));

  private static final List<SMethod<?>> BH_METHODS = Arrays.<SMethod<?>>asList(getOpeningText_idhKxU$w9, getClosingText_idhKxUEwj, isVertical_idi0pAV23, isVerticalGrid_idi2IbWq8, isHorizontal_idi0pB4gH, isIndentLayout_idi0pB9jQ, isFoldingEnabled_id1_9L3A4DrOF, isVerticalIndent_idi0tOX1j, shellBeSynchronized_id3TPTV99_TMT, shellBeSynchronized_id3TPTV99Aiv4, canBeSynchronized_id3wXm3h1AYM7, canBeSynchronized_id3wXm3h1BRps);

  private static void ___init___(@NotNull SNode __thisNode__) {
  }

  private static String getOpeningText_idhKxU$w9(@NotNull SNode __thisNode__) {
    if (CellModel_Collection_BehaviorDescriptor.isVertical_idi0pAV23.invoke(__thisNode__)) {
      return "[/";
    } else if (CellModel_Collection_BehaviorDescriptor.isIndentLayout_idi0pB9jQ.invoke(__thisNode__)) {
      return "[-";
    } else {
      return "[>";
    }
  ...
  private static Boolean isVertical_idi0pAV23(@NotNull SNode __thisNode__) {
  ...
  private static Boolean isVerticalGrid_idi2IbWq8(@NotNull SNode __thisNode__) {
  ...
  private static Boolean isHorizontal_idi0pB4gH(@NotNull SNode __thisNode__) {
  ...
  private static Boolean isIndentLayout_idi0pB9jQ(@NotNull SNode __thisNode__) {
  ...
  private static Boolean isFoldingEnabled_id1_9L3A4DrOF(@NotNull SNode __thisNode__) {
  ...
  private static Boolean isVerticalIndent_idi0tOX1j(@NotNull SNode __thisNode__) {
  ...
  private static Boolean shellBeSynchronized_id3TPTV99_TMT(@NotNull final SNode __thisNode__) {
    return ListSequence.fromList(SLinkOperations.getChildren(__thisNode__, MetaAdapterFactory.getContainmentLink(0x18bc659203a64e29L, 0xa83a7ff23bde13baL, 0xf9eaff2517L, 0xf9eaff2518L, "childCellModel"))).any(new IWhereFilter<SNode>() {
      public boolean accept(SNode it) {
        return CellModel_Collection_BehaviorDescriptor.shellBeSynchronized_id3TPTV99Aiv4.invoke(__thisNode__, it);
      }
    }) || CellModel_Collection_BehaviorDescriptor.shellBeSynchronized_id3TPTV99Aiv4.invoke(__thisNode__, SLinkOperations.getTarget(__thisNode__, MetaAdapterFactory.getContainmentLink(0x18bc659203a64e29L, 0xa83a7ff23bde13baL, 0xf9eaff2517L, 0x6b2f47204d99c5f5L, "foldedCellModel")));
  }
  private static Boolean shellBeSynchronized_id3TPTV99Aiv4(@NotNull SNode __thisNode__, SNode childCell) {
  ...
  private static Boolean canBeSynchronized_id3wXm3h1AYM7(@NotNull final SNode __thisNode__) {
    return ListSequence.fromList(SLinkOperations.getChildren(__thisNode__, MetaAdapterFactory.getContainmentLink(0x18bc659203a64e29L, 0xa83a7ff23bde13baL, 0xf9eaff2517L, 0xf9eaff2518L, "childCellModel"))).all(new IWhereFilter<SNode>() {
      public boolean accept(SNode it) {
        return CellModel_Collection_BehaviorDescriptor.canBeSynchronized_id3wXm3h1BRps.invoke(__thisNode__, it);
      }
    }) && CellModel_Collection_BehaviorDescriptor.canBeSynchronized_id3wXm3h1BRps.invoke(__thisNode__, SLinkOperations.getTarget(__thisNode__, MetaAdapterFactory.getContainmentLink(0x18bc659203a64e29L, 0xa83a7ff23bde13baL, 0xf9eaff2517L, 0x6b2f47204d99c5f5L, "foldedCellModel")));
  }
  private static Boolean canBeSynchronized_id3wXm3h1BRps(@NotNull SNode __thisNode__, SNode childCell) {
  ...
  /*package*/ CellModel_Collection_BehaviorDescriptor() {
    super(REGISTRY);
  }
  ...
  protected <T> T invokeSpecial0(@NotNull SNode node, @NotNull SMethod<T> method, @NotNull Object[] parameters) {
    ...
    switch (methodIndex) {
      ...
      case 2:
        return (T) isVertical_idi0pAV23(node);
      case 3:
        return (T) isVerticalGrid_idi2IbWq8(node);
      case 4:
        return (T) isHorizontal_idi0pB4gH(node);
      case 5:
        return (T) isIndentLayout_idi0pB9jQ(node);
      case 6:
        return (T) isFoldingEnabled_id1_9L3A4DrOF(node);
      case 7:
        return (T) isVerticalIndent_idi0tOX1j(node);
      case 8:
        return (T) shellBeSynchronized_id3TPTV99_TMT(node);
      case 9:
        return (T) shellBeSynchronized_id3TPTV99Aiv4(node, (SNode) parameters[0]);
      case 10:
        return (T) canBeSynchronized_id3wXm3h1AYM7(node);
      case 11:
        return (T) canBeSynchronized_id3wXm3h1BRps(node, (SNode) parameters[0]);
      default:
        throw new BHMethodNotFoundException(this, method);
    }
  }
