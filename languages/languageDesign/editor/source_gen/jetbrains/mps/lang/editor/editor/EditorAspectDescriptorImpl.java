  ...
  public Collection<ConceptEditor> getDeclaredEditors(SAbstractConcept concept) {
    {
      ...
      switch (switchIndex) {
        ...
        case 3:
          if (true) {
            return Collections.<ConceptEditor>singletonList(new AddConceptMenuItem_Editor());
          }
          break;
        case 4:
          if (true) {
