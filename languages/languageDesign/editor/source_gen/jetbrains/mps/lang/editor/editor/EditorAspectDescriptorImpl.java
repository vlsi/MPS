...
public class EditorAspectDescriptorImpl implements EditorAspectDescriptor {
  ...
  private Map<String, StyleAttribute> myStyleAttributes = MapSequence.<String, StyleAttribute>fromMapAndKeysArray(new HashMap<String, StyleAttribute>(), "test-attribute").withValues(new InheritableStyleAttribute<Boolean>("test-attribute", true));
  ...
  public Collection<ConceptEditorComponent> getEditorComponents(ConceptDescriptor descriptor, String editorComponentId) {
    switch (Arrays.binarySearch(stringSwitchCases_xbvbvu_a0a0e, descriptor.getConceptFqName())) {
      ...
      case 1:
        ...
        break;
      case 2:
        switch (Arrays.binarySearch(stringSwitchCases_xbvbvu_a0a0c0a4, editorComponentId)) {
          case 0:
  ...
  public StyleAttribute getSA(String attributeName) {
    return MapSequence.fromMap(myStyleAttributes).get(attributeName);
  }



  public StyleAttribute getStyleAttribute(String attributeName) {
    switch (Arrays.binarySearch(stringSwitchCases_xbvbvu_a0a0k, attributeName)) {
      case 0:
        return new InheritableStyleAttribute<Boolean>("test-attribute", true);
      default:
    }
    return null;
  }
