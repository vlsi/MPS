...
public class EditorAspectDescriptorImpl implements EditorAspectDescriptor {
  ...
  private Map<String, StyleAttribute> myStyleAttributes = MapSequence.<String, StyleAttribute>fromMapAndKeysArray(new HashMap<String, StyleAttribute>(), "test-attribute").withValues(new InheritableStyleAttribute<Integer>("test-attribute", 0));
