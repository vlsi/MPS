...
public class ConceptEditor_DefaultContextHintLabel extends KeyMapImpl {
  ...
  public static class ConceptEditor_DefaultContextHintLabel_Action0 extends KeyMapActionImpl {
    ...
    private void execute_internal(final EditorContext editorContext, final SNode node, final List<SNode> selectedNodes) {
      SNodeFactoryOperations.addNewChild(node, MetaAdapterFactory.getContainmentLink(new UUID(1782411230332735017l, -6324602048325217350l), 1071666914219l, 2597348684684069742l, "contextHints"), "jetbrains.mps.lang.editor.structure.ConceptEditorHintDeclarationReference");
    }
