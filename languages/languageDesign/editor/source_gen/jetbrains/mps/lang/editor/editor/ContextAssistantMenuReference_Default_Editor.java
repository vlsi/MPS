...
public class ContextAssistantMenuReference_Default_Editor extends DefaultNodeEditor {
  public EditorCell createEditorCell(EditorContext editorContext, SNode node) {
    return this.createCollection_ps2hza_a(editorContext, node);
  }
  private EditorCell createCollection_ps2hza_a(EditorContext editorContext, SNode node) {
    EditorCell_Collection editorCell = EditorCell_Collection.createHorizontal(editorContext, node);
    editorCell.setCellId("Collection_ps2hza_a");
    editorCell.setBig(true);
    editorCell.addEditorCell(this.createComponent_ps2hza_a0(editorContext, node));
    editorCell.addEditorCell(this.createConstant_ps2hza_b0(editorContext, node));
    editorCell.addEditorCell(this.createRefCell_ps2hza_c0(editorContext, node));
    return editorCell;
  }
  ...
  private EditorCell createConstant_ps2hza_b0(EditorContext editorContext, SNode node) {
    EditorCell_Constant editorCell = new EditorCell_Constant(editorContext, node, "for");
    editorCell.setCellId("Constant_ps2hza_b0");
    editorCell.setDefaultText("");
    return editorCell;
  }
  private EditorCell createRefCell_ps2hza_c0(EditorContext editorContext, SNode node) {
    CellProviderWithRole provider = new RefCellCellProvider(node, editorContext);
    provider.setRole("concept");
    provider.setNoTargetText("<no concept>");
    EditorCell editorCell;
    provider.setAuxiliaryCellProvider(new ContextAssistantMenuReference_Default_Editor._Inline_ps2hza_a2a());
  ...
  public static class _Inline_ps2hza_a2a extends InlineCellProvider {
    public _Inline_ps2hza_a2a() {
      super();
    }
    ...
    public EditorCell createEditorCell(EditorContext editorContext, SNode node) {
      return this.createProperty_ps2hza_a0c0(editorContext, node);
    }
    private EditorCell createProperty_ps2hza_a0c0(EditorContext editorContext, SNode node) {
