...
public final class StyleClassItem_BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<SNode> getStyleContainer_id6VCLXpKS8DC = new SMethodBuilder<SNode>(new SJavaCompoundTypeImpl((Class<SNode>) ((Class) Object.class))).name("getStyleContainer").modifiers(SModifiersImpl.create(0, AccessPrivileges.PUBLIC)).concept(CONCEPT).id("6VCLXpKS8DC").registry(REGISTRY).build(SParameterImpl.fromList(SJavaCompoundTypeImpl.fromClasses()));
  ...
  private static SNode getStyleContainer_id6VCLXpKS8DC(@NotNull SNode __thisNode__) {
  ...
  /*package*/ StyleClassItem_BehaviorDescriptor() {
    super(REGISTRY);
  }
  ...
  protected <T> T invokeSpecial0(@NotNull SNode node, @NotNull SMethod<T> method, @NotNull Object[] parameters) {
    ...
    switch (methodIndex) {
      ...
      case 1:
        return (T) getStyleContainer_id6VCLXpKS8DC(node);
      default:
        throw new BHMethodNotFoundException(this, method);
    }
  }
