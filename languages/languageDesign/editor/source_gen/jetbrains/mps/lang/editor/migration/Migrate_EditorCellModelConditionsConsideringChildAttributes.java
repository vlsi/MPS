...
public class Migrate_EditorCellModelConditionsConsideringChildAttributes extends MigrationScriptBase {
  ...
  public SNode execute(final SModule m) {
    {
      ...
      Collection<SNode> allCellModels = CommandUtil.instances(CommandUtil.createConsoleScope(null, false, context), MetaAdapterFactory.getConcept(0x18bc659203a64e29L, 0xa83a7ff23bde13baL, 0xf9eafb9a39L, "jetbrains.mps.lang.editor.structure.EditorCellModel"));
  ...
  private boolean isChildOfNotNullOrNotEqualsToNullExpression(SNode node) {
    ...
    if (SNodeOperations.isInstanceOf(parent, MetaAdapterFactory.getConcept(0xf3061a5392264cc5L, 0xa443f952ceaf5816L, 0x116b46a08c4L, "jetbrains.mps.baseLanguage.structure.DotExpression"))) {
      ...
      if (eq_3lt69g_a0a0a1a6(node.getContainmentLink(), MetaAdapterFactory.getContainmentLink(0xf3061a5392264cc5L, 0xa443f952ceaf5816L, 0xfbdeb6fecfL, 0xfbdeb7a11cL, "leftExpression"))) {
  ...
  private boolean isChildSizeEqualsToZeroExpression(SNode node) {
    ...
    boolean isLeft = eq_3lt69g_a0a6a9(parent.getContainmentLink(), MetaAdapterFactory.getContainmentLink(0xf3061a5392264cc5L, 0xa443f952ceaf5816L, 0xfbdeb6fecfL, 0xfbdeb7a11cL, "leftExpression"));
    ...
    }
    {
      ...
      if (SConceptOperations.isSubConceptOf(SNodeOperations.asSConcept(cncpt), MetaAdapterFactory.getConcept(0xf3061a5392264cc5L, 0xa443f952ceaf5816L, 0xf9e20e303fL, "jetbrains.mps.baseLanguage.structure.NotEqualsExpression"))) {
        matchedCase = true;
        return true;
      }
      if (SConceptOperations.isSubConceptOf(SNodeOperations.asSConcept(cncpt), MetaAdapterFactory.getConcept(0xf3061a5392264cc5L, 0xa443f952ceaf5816L, 0xfbced38fcfL, "jetbrains.mps.baseLanguage.structure.GreaterThanExpression"))) {
        matchedCase = true;
        return isLeft;
      }
      if (SConceptOperations.isSubConceptOf(SNodeOperations.asSConcept(cncpt), MetaAdapterFactory.getConcept(0xf3061a5392264cc5L, 0xa443f952ceaf5816L, 0xfbced3b82aL, "jetbrains.mps.baseLanguage.structure.LessThanExpression"))) {
        matchedCase = true;
        return !(isLeft);
      }
      if (!(matchedCase)) {
  ...
  private void replaceLinkAccessWithChildAndAttributesOperation(SNode operand, SNode link) {
    SNode newLinkAccess = SConceptOperations.createNewNode(SNodeOperations.asInstanceConcept(MetaAdapterFactory.getConcept(0x7866978ea0f04cc7L, 0x81bc4d213d9375e1L, 0x6cbc725f4b35314cL, "jetbrains.mps.lang.smodel.structure.Node_GetChildrenAndChildAttributesOperation")));
  ...
  private static boolean eq_3lt69g_a0a0a1a6(Object a, Object b) {
    return (a != null ? a.equals(b) : a == b);
  }
  private static boolean eq_3lt69g_a0a6a9(Object a, Object b) {
    return (a != null ? a.equals(b) : a == b);
  }
}
