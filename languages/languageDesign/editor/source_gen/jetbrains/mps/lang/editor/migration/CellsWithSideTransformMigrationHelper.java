...
public class CellsWithSideTransformMigrationHelper {
  ...
  /*package*/ void migrate() {
    {
      ...
      for (SNode cell : Sequence.fromIterable(cellsWithTagsOrApplySideTransforms)) {
        ...
        for (String tag : sideTransformTags) {
          if (eq_o8m9jz_a0a0a9a6a0a4_0(tag, null) || eq_o8m9jz_a0a0a9a6a0a4(tag, DEFAULT_TAG_NAME)) {
        ...
        if (!(menuReferences.isEmpty())) {
          ListSequence.fromList(SLinkOperations.getChildren(includeSection, MetaAdapterFactory.getContainmentLink(0x18bc659203a64e29L, 0xa83a7ff23bde13baL, 0x6ec02d9918b4efbcL, 0x6ec02d9918b4efbdL, "locations"))).addElement(_quotation_createNode_o8m9jz_a0a0a02a4a0a4());
          for (SNode menuReference : ListSequence.fromList(menuReferences)) {
            ListSequence.fromList(SLinkOperations.getChildren(includeSection, MetaAdapterFactory.getContainmentLink(0x18bc659203a64e29L, 0xa83a7ff23bde13baL, 0x6ec02d9918b4efbcL, 0x6ec02d9918b4efbfL, "parts"))).addElement(_quotation_createNode_o8m9jz_a0a0a1a02a4a0a4(menuReference));
          }
        } else {
          ListSequence.fromList(SLinkOperations.getChildren(includeSection, MetaAdapterFactory.getContainmentLink(0x18bc659203a64e29L, 0xa83a7ff23bde13baL, 0x6ec02d9918b4efbcL, 0x6ec02d9918b4efbfL, "parts"))).addElement(_quotation_createNode_o8m9jz_a0a0a0u0e0a0e());
        }
        ...
        ListSequence.fromList(SLinkOperations.getChildren(section, MetaAdapterFactory.getContainmentLink(0x18bc659203a64e29L, 0xa83a7ff23bde13baL, 0x6ec02d9918b4efbcL, 0x6ec02d9918b4efbdL, "locations"))).addElement(_quotation_createNode_o8m9jz_a0a42a4a0a4());
        ...
        for (SNode apply : Sequence.fromIterable(applySideTransforms)) {
          ...
          if (tag == null || eq_o8m9jz_a0a4a82a6a0a4(tag, DEFAULT_TAG_NAME)) {
            menuWasFound = true;
  ...
  private static boolean eq_o8m9jz_a0a0a9a6a0a4(Object a, Object b) {
    return (a != null ? a.equals(b) : a == b);
  }
  private static boolean eq_o8m9jz_a0a0a9a6a0a4_0(Object a, Object b) {
    return (a != null ? a.equals(b) : a == b);
  }
  private static SNode _quotation_createNode_o8m9jz_a0a0a02a4a0a4() {
  ...
  private static SNode _quotation_createNode_o8m9jz_a0a0a1a02a4a0a4(Object parameter_1) {
    PersistenceFacade facade = PersistenceFacade.getInstance();
    SNode quotedNode_2 = null;
    SNode quotedNode_3 = null;
  ...
  private static SNode _quotation_createNode_o8m9jz_a0a0a0u0e0a0e() {
    PersistenceFacade facade = PersistenceFacade.getInstance();
    SNode quotedNode_1 = null;
  ...
  private static SNode _quotation_createNode_o8m9jz_a0a42a4a0a4() {
    PersistenceFacade facade = PersistenceFacade.getInstance();
    SNode quotedNode_1 = null;
  ...
  private static boolean eq_o8m9jz_a0a4a82a6a0a4(Object a, Object b) {
    return (a != null ? a.equals(b) : a == b);
  }
}
