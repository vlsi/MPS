...
/*package*/ class BooleanStyleSheetItem_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createCollection_689p1d_a() {
    ...
    if (renderingCondition_689p1d_a2a(myNode, getEditorContext())) {
      editorCell.addEditorCell(createProperty_689p1d_c0());
    }
    if (renderingCondition_689p1d_a3a(myNode, getEditorContext())) {
  ...
  private class querySingleRoleHandler_689p1d_d0 extends SingleRoleCellProvider {
    ...
    private void installCellInfo(SNode child, EditorCell editorCell) {
      if (editorCell.getSubstituteInfo() == null || editorCell.getSubstituteInfo() instanceof DefaultSubstituteInfo) {
        editorCell.setSubstituteInfo(new OldNewCompositeSubstituteInfo(getEditorContext(), new SChildSubstituteInfo(editorCell, getNode(), MetaAdapterFactory.getContainmentLink(0x18bc659203a64e29L, 0xa83a7ff23bde13baL, 0x1143bd1283bL, 0x11cd79149a9L, "query"), child), new DefaultChildSubstituteInfo(getNode(), myContainmentLink.getDeclarationNode(), getEditorContext())));
      }
