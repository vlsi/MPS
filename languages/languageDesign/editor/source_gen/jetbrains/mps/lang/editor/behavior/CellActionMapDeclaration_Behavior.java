...
public class CellActionMapDeclaration_Behavior {
  ...
  public static SNode call_getBaseConcept_5270353093116096517(SNode thisNode) {
    ...
    return (SNode) descriptor.invoke(Object.class, SNodeOperations.cast(thisNode, "jetbrains.mps.lang.editor.structure.CellActionMapDeclaration"), "virtual_getBaseConcept_2621449412040133768", PARAMETERS_5270353093116096517);
  }

  public static void call_setBaseConcept_6261424444345978736(SNode thisNode, SNode baseConcept) {
    BehaviorDescriptor descriptor = ConceptRegistry.getInstance().getBehaviorDescriptorForInstanceNode(thisNode);
    descriptor.invoke(Object.class, SNodeOperations.cast(thisNode, "jetbrains.mps.lang.editor.structure.CellActionMapDeclaration"), "virtual_setBaseConcept_6261424444345963020", PARAMETERS_6261424444345978736, baseConcept);
  }
