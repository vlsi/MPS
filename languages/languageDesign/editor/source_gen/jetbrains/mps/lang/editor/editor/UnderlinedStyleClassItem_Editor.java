...
public class UnderlinedStyleClassItem_Editor extends DefaultNodeEditor {
  ...
  private static boolean renderingCondition_4fi5xp_a2a(SNode node, EditorContext editorContext) {
    return SLinkOperations.getTarget(node, MetaAdapterFactory.getContainmentLink(new UUID(1782411230332735017l, -6324602048325217350l), 1186414999511l, 1221219051630l, "query")) == null;
  }
  ...
  public static class UnderlinedStyleClassItem_generic_cellMenu_4fi5xp_b0c0 extends AbstractCellMenuPart_Generic_Item {
    ...
    public void handleAction(SNode node, SModel model, IOperationContext operationContext, EditorContext editorContext) {
      SNodeFactoryOperations.setNewChild(node, MetaAdapterFactory.getContainmentLink(new UUID(1782411230332735017l, -6324602048325217350l), 1186414999511l, 1221219051630l, "query"), "jetbrains.mps.lang.editor.structure.QueryFunction_Underlined");
    }
