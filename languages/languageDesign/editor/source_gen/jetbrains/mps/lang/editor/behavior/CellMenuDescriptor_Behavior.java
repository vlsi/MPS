...
public class CellMenuDescriptor_Behavior {
  ...
  public static SNode call_getEditedFeature_1220342015727(SNode thisNode) {
    ...
    if (SNodeOperations.isInstanceOf(owner, "jetbrains.mps.lang.editor.structure.CellModel_WithRole")) {
      return SLinkOperations.getTarget(SNodeOperations.cast(owner, "jetbrains.mps.lang.editor.structure.CellModel_WithRole"), MetaAdapterFactory.getReferenceLink(new UUID(1782411230332735017l, -6324602048325217350l), 1139848536355l, 1140103550593l, "relationDeclaration"));
