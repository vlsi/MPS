...
public class CellKeyMapDeclaration_Editor extends DefaultNodeEditor {
  ...
  private static class itemListHandler_zabbeg_i0 extends RefNodeListHandler {
    ...
    public EditorCell createEmptyCell(EditorContext editorContext) {
      editorContext.getCellFactory().pushCellContext();
      editorContext.getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(itemListHandler_zabbeg_i0.this.getOwner(), MetaAdapterFactory.getContainmentLink(0x18bc659203a64e29L, 0xa83a7ff23bde13baL, 0xfbc216b31bL, 0x108b65d7766L, "item")));
      try {
