...
public final class QueryFunction_NodeListFilter_BehaviorDescriptor extends BaseBHDescriptor {
  ...
  private static List<SNode> getApplicableConceptFunctionParameter_id2D1PBM_bxJg(@NotNull SAbstractConcept __thisConcept__) {
    ...
    ListSequence.fromList(result).addElement(SNodeOperations.getNode("r:00000000-0000-4000-0000-011c8959029e(jetbrains.mps.lang.editor.structure)", "1182233249301"));
    return result;
  }
  ...
  /*package*/ QueryFunction_NodeListFilter_BehaviorDescriptor() {
    super(REGISTRY);
  }
