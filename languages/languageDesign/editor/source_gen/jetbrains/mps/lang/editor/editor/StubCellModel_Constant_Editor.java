...
public class StubCellModel_Constant_Editor extends DefaultNodeEditor {
  public EditorCell createEditorCell(EditorContext editorContext, SNode node) {
    return this.createComponent_nb3gmp_a(editorContext, node);
  }
  private EditorCell createComponent_nb3gmp_a(EditorContext editorContext, SNode node) {
