...
public class SubstituteMenuPart_AddConcept_Editor extends DefaultNodeEditor {
  public EditorCell createEditorCell(EditorContext editorContext, SNode node) {
    return this.createCollection_d4k5h5_a(editorContext, node);
  }
  private EditorCell createCollection_d4k5h5_a(EditorContext editorContext, SNode node) {
  ...
  public static class _Inline_d4k5h5_a1a extends InlineCellProvider {
    ...
    public EditorCell createEditorCell(EditorContext editorContext, SNode node) {
      return this.createProperty_d4k5h5_a0b0(editorContext, node);
    }
    private EditorCell createProperty_d4k5h5_a0b0(EditorContext editorContext, SNode node) {
