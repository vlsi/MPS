...
public class EditorComponentDeclaration_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createConstant_qbcy69_a0a(EditorContext editorContext, SNode node) {
    EditorCell_Constant editorCell = new EditorCell_Constant((jetbrains.mps.nodeEditor.EditorContext) editorContext, node, "editor component");
  ...
  private EditorCell createConstant_qbcy69_b1c0(EditorContext editorContext, SNode node) {
    EditorCell_Constant editorCell = new EditorCell_Constant((jetbrains.mps.nodeEditor.EditorContext) editorContext, node, "component cell layout:");
