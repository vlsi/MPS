...
public class CellMenuDescriptor_Editor extends DefaultNodeEditor {
  ...
  private static class cellMenuPartListHandler_g1wmr2_b0 extends RefNodeListHandler {
    ...
    public EditorCell createEmptyCell(EditorContext editorContext) {
      ...
      editorContext.getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(cellMenuPartListHandler_g1wmr2_b0.this.getOwner(), MetaAdapterFactory.getContainmentLink(0x18bc659203a64e29L, 0xa83a7ff23bde13baL, 0x10f34f6aaacL, 0x10f34f82910L, "cellMenuPart")));
      try {
