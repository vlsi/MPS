...
public class MigrateAttributeConstant_MigrationScript extends BaseMigrationScript {
  ...
  private static SNode _quotation_createNode_cqduyy_a0a0a4a0a(Object parameter_1) {
    ...
    quotedNode_3.setReference("overriddenMethod", SReference.create("overriddenMethod", quotedNode_3, SModelReference.fromString("r:00000000-0000-4000-0000-011c89590297(jetbrains.mps.lang.editor.behavior)"), jetbrains.mps.smodel.SNodeId.fromString("2554389230519612632")));
    ...
    quotedNode_6.setReference("classifier", SReference.create("classifier", quotedNode_6, SModelReference.fromString("f:java_stub#1ed103c3-3aa6-49b7-9c21-6765ee11f224#jetbrains.mps.nodeEditor.style(MPS.Editor/jetbrains.mps.nodeEditor.style@java_stub)"), jetbrains.mps.smodel.SNodeId.fromString("~StyleAttribute")));
