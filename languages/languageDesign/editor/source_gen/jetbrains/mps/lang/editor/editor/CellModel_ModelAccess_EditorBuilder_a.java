...
/*package*/ class CellModel_ModelAccess_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createConstant_j8ahcr_b0() {
    ...
    style.set(StyleAttributes.TEXT_BACKGROUND_COLOR, StyleRegistry.getInstance().getSimpleColor(_StyleParameter_QueryFunction_j8ahcr_a1b0(getEditorContext(), getNode())));
    style.set(StyleAttributes.BACKGROUND_COLOR, StyleRegistry.getInstance().getSimpleColor(_StyleParameter_QueryFunction_j8ahcr_a2b0(getEditorContext(), getNode())));
    style.set(StyleAttributes.TEXT_COLOR, StyleRegistry.getInstance().getSimpleColor(_StyleParameter_QueryFunction_j8ahcr_a3b0(getEditorContext(), getNode())));
    style.set(StyleAttributes.FONT_STYLE, _StyleParameter_QueryFunction_j8ahcr_a4b0(getEditorContext(), getNode()));
    style.set(StyleAttributes.UNDERLINED, _StyleParameter_QueryFunction_j8ahcr_a5b0(getEditorContext(), getNode()));
    editorCell.getStyle().putAll(style);
