...
public class CellModel_Collection_Editor extends DefaultNodeEditor {
  ...
  private static boolean renderingCondition_cvgoyj_a0(SNode node, EditorContext editorContext) {
    return !(CellModel_Collection__BehaviorDescriptor.isIndentLayout_idi0pB9jQ.invoke(node));
  }
  ...
  private static boolean renderingCondition_cvgoyj_a0a0(SNode node, EditorContext editorContext) {
    return CellModel_Collection__BehaviorDescriptor.isVertical_idi0pAV23.invoke(node);
  }
  ...
  private static class childCellModelListHandler_cvgoyj_b1a0a extends RefNodeListHandler {
    ...
    public SNode nodeFactory(SNode node, EditorContext editorContext) {
      return SConceptOperations.createNewNode(SNodeOperations.asInstanceConcept(MetaAdapterFactory.getConcept(0x18bc659203a64e29L, 0xa83a7ff23bde13baL, 0xf9eb01232eL, "jetbrains.mps.lang.editor.structure.CellModel_Constant")));
    }
  ...
  private static boolean renderingCondition_cvgoyj_a2a0a(SNode node, EditorContext editorContext) {
    return CellModel_Collection__BehaviorDescriptor.isFoldingEnabled_id1_9L3A4DrOF.invoke(node);
  }
  ...
  private static boolean renderingCondition_cvgoyj_a1a0(SNode node, EditorContext editorContext) {
    return !(CellModel_Collection__BehaviorDescriptor.isVertical_idi0pAV23.invoke(node)) && !(CellModel_Collection__BehaviorDescriptor.isIndentLayout_idi0pB9jQ.invoke(node));
  }
  ...
  private static boolean _StyleParameter_QueryFunction_cvgoyj_a0a0a(EditorContext editorContext, SNode node) {
    return CellModel_Collection__BehaviorDescriptor.isVerticalIndent_idi0tOX1j.invoke(node);
  }
  ...
  private EditorCell createRefNode_cvgoyj_b3d0(EditorContext editorContext, SNode node) {
    SingleRoleCellProvider provider = new CellModel_Collection_Editor.addHintsSingleRoleHandler_cvgoyj_b3d0(node, MetaAdapterFactory.getContainmentLink(0x18bc659203a64e29L, 0xa83a7ff23bde13baL, 0xf9eaff2517L, 0x3ae0865e9aa66fc9L, "addHints"), editorContext);
    return provider.createCell();
  }
  private class addHintsSingleRoleHandler_cvgoyj_b3d0 extends SingleRoleCellProvider {
    public addHintsSingleRoleHandler_cvgoyj_b3d0(SNode ownerNode, SContainmentLink containmentLink, EditorContext context) {
      super(ownerNode, containmentLink, context);
    }
    public EditorCell createChildCell(EditorContext editorContext, SNode child) {
      EditorCell editorCell = super.createChildCell(editorContext, child);
  ...
  private EditorCell createRefNode_cvgoyj_b4d0(EditorContext editorContext, SNode node) {
    SingleRoleCellProvider provider = new CellModel_Collection_Editor.removeHintsSingleRoleHandler_cvgoyj_b4d0(node, MetaAdapterFactory.getContainmentLink(0x18bc659203a64e29L, 0xa83a7ff23bde13baL, 0xf9eaff2517L, 0x3ae0865e9aa67219L, "removeHints"), editorContext);
    return provider.createCell();
  }
  private class removeHintsSingleRoleHandler_cvgoyj_b4d0 extends SingleRoleCellProvider {
    public removeHintsSingleRoleHandler_cvgoyj_b4d0(SNode ownerNode, SContainmentLink containmentLink, EditorContext context) {
      super(ownerNode, containmentLink, context);
    }
    public EditorCell createChildCell(EditorContext editorContext, SNode child) {
      EditorCell editorCell = super.createChildCell(editorContext, child);
