...
public class CellModel_Collection_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createRefNodeList_cvgoyj_b1a0a(EditorContext editorContext, SNode node) {
    ...
    style.set(StyleAttributes.DRAW_BORDER, 0, true);
    editorCell.getStyle().putAll(style);
    editorCell.setAction(CellActionType.COMMENT, new CellAction_CommentOrUncommentChild(node, MetaAdapterFactory.getContainmentLink(0x18bc659203a64e29L, 0xa83a7ff23bde13baL, 0xf9eaff2517L, 0xf9eaff2518L, "childCellModel")));
  ...
  private static boolean renderingCondition_cvgoyj_a1a0(SNode node, EditorContext editorContext) {
    return !((boolean) CellModel_Collection__BehaviorDescriptor.isVertical_idi0pAV23.invoke(node)) && !((boolean) CellModel_Collection__BehaviorDescriptor.isIndentLayout_idi0pB9jQ.invoke(node));
  }
