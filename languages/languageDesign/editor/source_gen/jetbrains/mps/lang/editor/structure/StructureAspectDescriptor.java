...
public class StructureAspectDescriptor implements jetbrains.mps.smodel.runtime.StructureAspectDescriptor {
  ...
  public ConceptDescriptor getDescriptor(String conceptFqName) {
    switch (Arrays.binarySearch(stringSwitchCases_1htk8d_a0a0b, conceptFqName)) {
      ...
      case 1:
        return new ConceptDescriptorBuilder("jetbrains.mps.lang.editor.structure.AbstractPaddingStyleClassItem").super_("jetbrains.mps.lang.editor.structure.FloatStyleClassItem").parents("jetbrains.mps.lang.editor.structure.FloatStyleClassItem").properties("measure").abstract_().create();
      case 2:
        return new ConceptDescriptorBuilder("jetbrains.mps.lang.editor.structure.AbstractStyledTextOperation").super_("jetbrains.mps.lang.core.structure.BaseConcept").parents("jetbrains.mps.lang.core.structure.BaseConcept", "jetbrains.mps.baseLanguage.structure.IOperation", "jetbrains.mps.lang.core.structure.IDontSubstituteByDefault").children(new String[]{"actualArgument"}, new boolean[]{true}).abstract_().create();
      case 3:
        return new ConceptDescriptorBuilder("jetbrains.mps.lang.editor.structure.AppendTextOperation").super_("jetbrains.mps.lang.editor.structure.AbstractStyledTextOperation").parents("jetbrains.mps.lang.editor.structure.AbstractStyledTextOperation").alias("append", "").create();
      case 4:
        return new ConceptDescriptorBuilder("jetbrains.mps.lang.editor.structure.AutoDeletableStyleClassItem").super_("jetbrains.mps.lang.editor.structure.BooleanStyleSheetItem").parents("jetbrains.mps.lang.editor.structure.BooleanStyleSheetItem").alias("auto-deletable", "").create();
      case 5:
        return new ConceptDescriptorBuilder("jetbrains.mps.lang.editor.structure.BackgroundColorStyleClassItem").super_("jetbrains.mps.lang.editor.structure.ColorStyleClassItem").parents("jetbrains.mps.lang.editor.structure.ColorStyleClassItem").alias("background-color", "").create();
      case 6:
        return new ConceptDescriptorBuilder("jetbrains.mps.lang.editor.structure.BaseEditorComponent").super_("jetbrains.mps.lang.editor.structure.AbstractComponent").parents("jetbrains.mps.lang.editor.structure.AbstractComponent").children(new String[]{"cellModel"}, new boolean[]{false}).abstract_().create();
      case 7:
        return new ConceptDescriptorBuilder("jetbrains.mps.lang.editor.structure.BaseLineCell").super_("jetbrains.mps.lang.editor.structure.BooleanStyleSheetItem").parents("jetbrains.mps.lang.editor.structure.BooleanStyleSheetItem").alias("base-line-cell", "").create();
      case 8:
        return new ConceptDescriptorBuilder("jetbrains.mps.lang.editor.structure.BooleanStyleSheetItem").super_("jetbrains.mps.lang.editor.structure.StyleClassItem").parents("jetbrains.mps.lang.editor.structure.StyleClassItem").properties("flag").children(new String[]{"query"}, new boolean[]{false}).abstract_().create();
      case 9:
        return new ConceptDescriptorBuilder("jetbrains.mps.lang.editor.structure.BracketColorStyleClassItem").super_("jetbrains.mps.lang.editor.structure.ColorStyleClassItem").parents("jetbrains.mps.lang.editor.structure.ColorStyleClassItem").alias("bracket-color", "").create();
      case 10:
      ...
      case 13:
        return new ConceptDescriptorBuilder("jetbrains.mps.lang.editor.structure.CellActionMap_ExecuteFunction").super_("jetbrains.mps.baseLanguage.structure.ConceptFunction").parents("jetbrains.mps.baseLanguage.structure.ConceptFunction").alias("execute block", "").create();
      case 14:
        return new ConceptDescriptorBuilder("jetbrains.mps.lang.editor.structure.CellActionMap_FunctionParm_selectedNode").super_("jetbrains.mps.baseLanguage.structure.ConceptFunctionParameter").parents("jetbrains.mps.baseLanguage.structure.ConceptFunctionParameter").alias("node", "selected node (action map function parameter)").create();
      case 15:
      ...
      case 18:
        return new ConceptDescriptorBuilder("jetbrains.mps.lang.editor.structure.CellKeyMap_AbstractFunction").super_("jetbrains.mps.baseLanguage.structure.ConceptFunction").parents("jetbrains.mps.baseLanguage.structure.ConceptFunction").abstract_().create();
      case 19:
        return new ConceptDescriptorBuilder("jetbrains.mps.lang.editor.structure.CellKeyMap_ExecuteFunction").super_("jetbrains.mps.lang.editor.structure.CellKeyMap_AbstractFunction").parents("jetbrains.mps.lang.editor.structure.CellKeyMap_AbstractFunction").alias("execute block", "").create();
      case 20:
        return new ConceptDescriptorBuilder("jetbrains.mps.lang.editor.structure.CellKeyMap_FunctionParm_selectedNode").super_("jetbrains.mps.baseLanguage.structure.ConceptFunctionParameter").parents("jetbrains.mps.baseLanguage.structure.ConceptFunctionParameter").alias("node", "keymap function parameter").create();
      case 21:
        return new ConceptDescriptorBuilder("jetbrains.mps.lang.editor.structure.CellKeyMap_FunctionParm_selectedNodes").super_("jetbrains.mps.baseLanguage.structure.ConceptFunctionParameter").parents("jetbrains.mps.baseLanguage.structure.ConceptFunctionParameter").alias("selectedNodes", "keymap function parameter").create();
      case 22:
        return new ConceptDescriptorBuilder("jetbrains.mps.lang.editor.structure.CellKeyMap_IsApplicableFunction").super_("jetbrains.mps.lang.editor.structure.CellKeyMap_AbstractFunction").parents("jetbrains.mps.lang.editor.structure.CellKeyMap_AbstractFunction").alias("is applicable block", "").create();
      case 23:
        return new ConceptDescriptorBuilder("jetbrains.mps.lang.editor.structure.CellLayout").super_("jetbrains.mps.lang.core.structure.BaseConcept").parents("jetbrains.mps.lang.core.structure.BaseConcept").abstract_().create();
      case 24:
        return new ConceptDescriptorBuilder("jetbrains.mps.lang.editor.structure.CellLayout_Flow").super_("jetbrains.mps.lang.editor.structure.CellLayout").parents("jetbrains.mps.lang.editor.structure.CellLayout").alias("flow", "").create();
      case 25:
        return new ConceptDescriptorBuilder("jetbrains.mps.lang.editor.structure.CellLayout_Horizontal").super_("jetbrains.mps.lang.editor.structure.CellLayout").parents("jetbrains.mps.lang.editor.structure.CellLayout").alias("horizontal", "").create();
      case 26:
        return new ConceptDescriptorBuilder("jetbrains.mps.lang.editor.structure.CellLayout_Indent").super_("jetbrains.mps.lang.editor.structure.CellLayout").parents("jetbrains.mps.lang.editor.structure.CellLayout").alias("indent", "").create();
      case 27:
        return new ConceptDescriptorBuilder("jetbrains.mps.lang.editor.structure.CellLayout_Indent_Old").super_("jetbrains.mps.lang.editor.structure.CellLayout").parents("jetbrains.mps.lang.editor.structure.CellLayout").alias("indent_old", "").create();
      case 28:
        return new ConceptDescriptorBuilder("jetbrains.mps.lang.editor.structure.CellLayout_Superscript").super_("jetbrains.mps.lang.editor.structure.CellLayout").parents("jetbrains.mps.lang.editor.structure.CellLayout").alias("superscript", "").create();
      case 29:
        return new ConceptDescriptorBuilder("jetbrains.mps.lang.editor.structure.CellLayout_Table").super_("jetbrains.mps.lang.editor.structure.CellLayout").parents("jetbrains.mps.lang.editor.structure.CellLayout").alias("table", "").create();
      case 30:
        return new ConceptDescriptorBuilder("jetbrains.mps.lang.editor.structure.CellLayout_Vertical").super_("jetbrains.mps.lang.editor.structure.CellLayout").parents("jetbrains.mps.lang.editor.structure.CellLayout").alias("vertical", "").create();
      case 31:
        return new ConceptDescriptorBuilder("jetbrains.mps.lang.editor.structure.CellLayout_VerticalGrid").super_("jetbrains.mps.lang.editor.structure.CellLayout_Vertical").parents("jetbrains.mps.lang.editor.structure.CellLayout_Vertical").alias("vertical grid", "").create();
      case 32:
      ...
      case 39:
        return new ConceptDescriptorBuilder("jetbrains.mps.lang.editor.structure.CellMenuPart_AbstractGroup_DescriptionText").super_("jetbrains.mps.baseLanguage.structure.ConceptFunction").parents("jetbrains.mps.baseLanguage.structure.ConceptFunction").alias("description text", "").create();
      case 40:
        return new ConceptDescriptorBuilder("jetbrains.mps.lang.editor.structure.CellMenuPart_AbstractGroup_MatchingText").super_("jetbrains.mps.baseLanguage.structure.ConceptFunction").parents("jetbrains.mps.baseLanguage.structure.ConceptFunction").alias("matching text", "").create();
      case 41:
        return new ConceptDescriptorBuilder("jetbrains.mps.lang.editor.structure.CellMenuPart_AbstractGroup_Query").super_("jetbrains.mps.baseLanguage.structure.ConceptFunction").parents("jetbrains.mps.baseLanguage.structure.ConceptFunction").alias("get objects", "").create();
      case 42:
        return new ConceptDescriptorBuilder("jetbrains.mps.lang.editor.structure.CellMenuPart_AbstractGroup_parameterObject").super_("jetbrains.mps.baseLanguage.structure.ConceptFunctionParameter").parents("jetbrains.mps.baseLanguage.structure.ConceptFunctionParameter", "jetbrains.mps.lang.core.structure.IDontSubstituteByDefault").alias("parameterObject", "").create();
      case 43:
      ...
      case 47:
        return new ConceptDescriptorBuilder("jetbrains.mps.lang.editor.structure.CellMenuPart_Generic_Group_Handler").super_("jetbrains.mps.baseLanguage.structure.ConceptFunction").parents("jetbrains.mps.baseLanguage.structure.ConceptFunction").alias("generic handler", "").create();
      case 48:
      ...
      case 49:
        return new ConceptDescriptorBuilder("jetbrains.mps.lang.editor.structure.CellMenuPart_Generic_Item_Handler").super_("jetbrains.mps.baseLanguage.structure.ConceptFunction").parents("jetbrains.mps.baseLanguage.structure.ConceptFunction").create();
      case 50:
      ...
      case 51:
        return new ConceptDescriptorBuilder("jetbrains.mps.lang.editor.structure.CellMenuPart_PropertyPostfixHints_GetPostfixes").super_("jetbrains.mps.baseLanguage.structure.ConceptFunction").parents("jetbrains.mps.baseLanguage.structure.ConceptFunction").alias("postfixes", "").create();
      case 52:
      ...
      case 53:
        return new ConceptDescriptorBuilder("jetbrains.mps.lang.editor.structure.CellMenuPart_PropertyValues_GetValues").super_("jetbrains.mps.baseLanguage.structure.ConceptFunction").parents("jetbrains.mps.baseLanguage.structure.ConceptFunction").alias("property values", "").create();
      case 54:
      ...
      case 57:
        return new ConceptDescriptorBuilder("jetbrains.mps.lang.editor.structure.CellMenuPart_ReplaceChild_CustomChildConcept_Query").super_("jetbrains.mps.baseLanguage.structure.ConceptFunction").parents("jetbrains.mps.baseLanguage.structure.ConceptFunction").alias("get child concept", "").create();
      case 58:
      ...
      case 59:
        return new ConceptDescriptorBuilder("jetbrains.mps.lang.editor.structure.CellMenuPart_ReplaceChild_Group_Create").super_("jetbrains.mps.baseLanguage.structure.ConceptFunction").parents("jetbrains.mps.baseLanguage.structure.ConceptFunction").alias("create new child", "").create();
      case 60:
        return new ConceptDescriptorBuilder("jetbrains.mps.lang.editor.structure.CellMenuPart_ReplaceChild_Group_Query").super_("jetbrains.mps.baseLanguage.structure.ConceptFunction").parents("jetbrains.mps.baseLanguage.structure.ConceptFunction").alias("get objects", "").create();
      case 61:
      ...
      case 67:
        return new ConceptDescriptorBuilder("jetbrains.mps.lang.editor.structure.CellMenuPart_ReplaceNode_Group_Create").super_("jetbrains.mps.baseLanguage.structure.ConceptFunction").parents("jetbrains.mps.baseLanguage.structure.ConceptFunction").alias("create replacement node", "").create();
      case 68:
      ...
      case 79:
        return new ConceptDescriptorBuilder("jetbrains.mps.lang.editor.structure.CellModel_Constant").super_("jetbrains.mps.lang.editor.structure.CellModel_AbstractLabel").parents("jetbrains.mps.lang.editor.structure.CellModel_AbstractLabel").properties("text", "nullText").alias("constant", "text label").create();
      case 80:
      ...
      case 98:
        return new ConceptDescriptorBuilder("jetbrains.mps.lang.editor.structure.ColorStyleClassItem").super_("jetbrains.mps.lang.editor.structure.StyleClassItem").parents("jetbrains.mps.lang.editor.structure.StyleClassItem").properties("color").children(new String[]{"query"}, new boolean[]{false}).abstract_().create();
      case 99:
      ...
      case 108:
        return new ConceptDescriptorBuilder("jetbrains.mps.lang.editor.structure.ConceptFunctionParameter_prevNode").super_("jetbrains.mps.baseLanguage.structure.ConceptFunctionParameter").parents("jetbrains.mps.baseLanguage.structure.ConceptFunctionParameter", "jetbrains.mps.lang.core.structure.IDontSubstituteByDefault").alias("prevNode", "function parameter").create();
      case 109:
        return new ConceptDescriptorBuilder("jetbrains.mps.lang.editor.structure.ConceptFunctionParameter_selectedNode").super_("jetbrains.mps.baseLanguage.structure.ConceptFunctionParameter").parents("jetbrains.mps.baseLanguage.structure.ConceptFunctionParameter", "jetbrains.mps.lang.core.structure.IDontSubstituteByDefault").alias("node", "selected node").create();
      case 110:
        return new ConceptDescriptorBuilder("jetbrains.mps.lang.editor.structure.ConceptFunctionParameter_text").super_("jetbrains.mps.baseLanguage.structure.ConceptFunctionParameter").parents("jetbrains.mps.baseLanguage.structure.ConceptFunctionParameter", "jetbrains.mps.lang.core.structure.IDontSubstituteByDefault").alias("text", "function parameter").create();
      case 111:
        return new ConceptDescriptorBuilder("jetbrains.mps.lang.editor.structure.ContextHintsSpecification").super_("jetbrains.mps.lang.core.structure.BaseConcept").parents("jetbrains.mps.lang.core.structure.BaseConcept").abstract_().create();
      case 112:
        return new ConceptDescriptorBuilder("jetbrains.mps.lang.editor.structure.DefaultBaseLine").super_("jetbrains.mps.lang.editor.structure.StyleClassItem").parents("jetbrains.mps.lang.editor.structure.StyleClassItem").properties("baseline").alias("default-baseline", "").create();
      case 113:
        return new ConceptDescriptorBuilder("jetbrains.mps.lang.editor.structure.DefaultCaretPositionStyleClassItem").super_("jetbrains.mps.lang.editor.structure.StyleClassItem").parents("jetbrains.mps.lang.editor.structure.StyleClassItem").properties("position").alias("default-caret-position", "").create();
      case 114:
        return new ConceptDescriptorBuilder("jetbrains.mps.lang.editor.structure.DrawBorderStyleClassItem").super_("jetbrains.mps.lang.editor.structure.BooleanStyleSheetItem").parents("jetbrains.mps.lang.editor.structure.BooleanStyleSheetItem").alias("draw-border", "").create();
      case 115:
        return new ConceptDescriptorBuilder("jetbrains.mps.lang.editor.structure.DrawBracketsStyleClassItem").super_("jetbrains.mps.lang.editor.structure.BooleanStyleSheetItem").parents("jetbrains.mps.lang.editor.structure.BooleanStyleSheetItem").alias("draw-brackets", "").create();
      case 116:
        return new ConceptDescriptorBuilder("jetbrains.mps.lang.editor.structure.EditableStyleClassItem").super_("jetbrains.mps.lang.editor.structure.BooleanStyleSheetItem").parents("jetbrains.mps.lang.editor.structure.BooleanStyleSheetItem").alias("editable", "").create();
      case 117:
        return new ConceptDescriptorBuilder("jetbrains.mps.lang.editor.structure.EditorCellModel").super_("jetbrains.mps.lang.core.structure.BaseConcept").parents("jetbrains.mps.lang.core.structure.BaseConcept", "jetbrains.mps.lang.editor.structure.IStyleContainer").properties("attractsFocus").references("actionMap", "keyMap", "styleClass").children(new String[]{"renderingCondition", "menuDescriptor", "focusPolicyApplicable"}, new boolean[]{false, false, false}).abstract_().create();
      case 118:
        return new ConceptDescriptorBuilder("jetbrains.mps.lang.editor.structure.EditorComponentDeclaration").super_("jetbrains.mps.lang.editor.structure.BaseEditorComponent").parents("jetbrains.mps.lang.editor.structure.BaseEditorComponent", "jetbrains.mps.lang.core.structure.INamedConcept", "jetbrains.mps.lang.structure.structure.IConceptAspect").alias("Editor Component", "").create();
      case 119:
        return new ConceptDescriptorBuilder("jetbrains.mps.lang.editor.structure.ExplicitHintsSpecification").super_("jetbrains.mps.lang.editor.structure.ContextHintsSpecification").parents("jetbrains.mps.lang.editor.structure.ContextHintsSpecification").children(new String[]{"hints"}, new boolean[]{true}).create();
      case 120:
        return new ConceptDescriptorBuilder("jetbrains.mps.lang.editor.structure.FirstPositionAllowedStyleClassItem").super_("jetbrains.mps.lang.editor.structure.BooleanStyleSheetItem").parents("jetbrains.mps.lang.editor.structure.BooleanStyleSheetItem").alias("first-position-allowed", "").create();
      case 121:
        return new ConceptDescriptorBuilder("jetbrains.mps.lang.editor.structure.FloatStyleClassItem").super_("jetbrains.mps.lang.editor.structure.StyleClassItem").parents("jetbrains.mps.lang.editor.structure.StyleClassItem").properties("value").abstract_().create();
      case 122:
        return new ConceptDescriptorBuilder("jetbrains.mps.lang.editor.structure.FontSizeStyleClassItem").super_("jetbrains.mps.lang.editor.structure.StyleClassItem").parents("jetbrains.mps.lang.editor.structure.StyleClassItem").properties("value").children(new String[]{"query"}, new boolean[]{false}).alias("font-size", "").create();
      case 123:
        return new ConceptDescriptorBuilder("jetbrains.mps.lang.editor.structure.FontStyleStyleClassItem").super_("jetbrains.mps.lang.editor.structure.StyleClassItem").parents("jetbrains.mps.lang.editor.structure.StyleClassItem").properties("style").children(new String[]{"query"}, new boolean[]{false}).alias("font-style", "").create();
      case 124:
        return new ConceptDescriptorBuilder("jetbrains.mps.lang.editor.structure.ForegroundColorStyleClassItem").super_("jetbrains.mps.lang.editor.structure.ColorStyleClassItem").parents("jetbrains.mps.lang.editor.structure.ColorStyleClassItem").alias("text-foreground-color", "").create();
      case 125:
        return new ConceptDescriptorBuilder("jetbrains.mps.lang.editor.structure.ForegroundNullColorStyleClassItem").super_("jetbrains.mps.lang.editor.structure.ColorStyleClassItem").parents("jetbrains.mps.lang.editor.structure.ColorStyleClassItem").alias("text-foreground-null-color", "").create();
      case 126:
        return new ConceptDescriptorBuilder("jetbrains.mps.lang.editor.structure.HorizontalAlign").super_("jetbrains.mps.lang.editor.structure.StyleClassItem").parents("jetbrains.mps.lang.editor.structure.StyleClassItem").properties("align").alias("horizontal-align", "").create();
      case 127:
        return new ConceptDescriptorBuilder("jetbrains.mps.lang.editor.structure.HorizontalGapStyleClassItem").super_("jetbrains.mps.lang.editor.structure.AbstractPaddingStyleClassItem").parents("jetbrains.mps.lang.editor.structure.AbstractPaddingStyleClassItem").alias("horizontal-gap", "").create();
      case 128:
      ...
      case 130:
        return new ConceptDescriptorBuilder("jetbrains.mps.lang.editor.structure.IndentLayoutIndentAnchorStyleClassItem").super_("jetbrains.mps.lang.editor.structure.BooleanStyleSheetItem").parents("jetbrains.mps.lang.editor.structure.BooleanStyleSheetItem").alias("indent-layout-indent-anchor", "").create();
      case 131:
        return new ConceptDescriptorBuilder("jetbrains.mps.lang.editor.structure.IndentLayoutIndentStyleClassItem").super_("jetbrains.mps.lang.editor.structure.BooleanStyleSheetItem").parents("jetbrains.mps.lang.editor.structure.BooleanStyleSheetItem").alias("indent-layout-indent", "").create();
      case 132:
        return new ConceptDescriptorBuilder("jetbrains.mps.lang.editor.structure.IndentLayoutNewLineChildrenStyleClassItem").super_("jetbrains.mps.lang.editor.structure.BooleanStyleSheetItem").parents("jetbrains.mps.lang.editor.structure.BooleanStyleSheetItem").alias("indent-layout-new-line-children", "").create();
      case 133:
        return new ConceptDescriptorBuilder("jetbrains.mps.lang.editor.structure.IndentLayoutNewLineStyleClassItem").super_("jetbrains.mps.lang.editor.structure.BooleanStyleSheetItem").parents("jetbrains.mps.lang.editor.structure.BooleanStyleSheetItem").alias("indent-layout-new-line", "").create();
      case 134:
        return new ConceptDescriptorBuilder("jetbrains.mps.lang.editor.structure.IndentLayoutNoWrapClassItem").super_("jetbrains.mps.lang.editor.structure.BooleanStyleSheetItem").parents("jetbrains.mps.lang.editor.structure.BooleanStyleSheetItem").alias("indent-layout-no-wrap", "").create();
      case 135:
        return new ConceptDescriptorBuilder("jetbrains.mps.lang.editor.structure.IndentLayoutOnNewLineStyleClassItem").super_("jetbrains.mps.lang.editor.structure.BooleanStyleSheetItem").parents("jetbrains.mps.lang.editor.structure.BooleanStyleSheetItem").alias("indent-layout-on-new-line", "").create();
      case 136:
        return new ConceptDescriptorBuilder("jetbrains.mps.lang.editor.structure.IndentLayoutWrapAnchorStyleClassItem").super_("jetbrains.mps.lang.editor.structure.BooleanStyleSheetItem").parents("jetbrains.mps.lang.editor.structure.BooleanStyleSheetItem").alias("indent-layout-wrap-anchor", "").create();
      case 137:
      ...
      case 139:
        return new ConceptDescriptorBuilder("jetbrains.mps.lang.editor.structure.LastPositionAllowedStyleClassItem").super_("jetbrains.mps.lang.editor.structure.BooleanStyleSheetItem").parents("jetbrains.mps.lang.editor.structure.BooleanStyleSheetItem").alias("last-position-allowed", "").create();
      case 140:
        return new ConceptDescriptorBuilder("jetbrains.mps.lang.editor.structure.LayoutConstraintStyleClassItem").super_("jetbrains.mps.lang.editor.structure.StyleClassItem").parents("jetbrains.mps.lang.editor.structure.StyleClassItem").properties("layoutConstraint").alias("layout constraint", "").create();
      case 141:
        return new ConceptDescriptorBuilder("jetbrains.mps.lang.editor.structure.MatchingLabelStyleClassItem").super_("jetbrains.mps.lang.editor.structure.StyleClassItem").parents("jetbrains.mps.lang.editor.structure.StyleClassItem").properties("labelName", "hasNoLabel").children(new String[]{"query"}, new boolean[]{false}).alias("matching-label", "").create();
      case 142:
        return new ConceptDescriptorBuilder("jetbrains.mps.lang.editor.structure.MaxWidthStyleClassItem").super_("jetbrains.mps.lang.editor.structure.StyleClassItem").parents("jetbrains.mps.lang.editor.structure.StyleClassItem").properties("value").children(new String[]{"query"}, new boolean[]{false}).alias("max-width", "").create();
      case 143:
      ...
      case 144:
        return new ConceptDescriptorBuilder("jetbrains.mps.lang.editor.structure.NavigatableNodeStyleClassItem").super_("jetbrains.mps.lang.editor.structure.StyleClassItem").parents("jetbrains.mps.lang.editor.structure.StyleClassItem").children(new String[]{"functionNode"}, new boolean[]{false}).alias("navigatable-node", "").create();
      case 145:
        return new ConceptDescriptorBuilder("jetbrains.mps.lang.editor.structure.NavigatableReferenceStyleClassItem").super_("jetbrains.mps.lang.editor.structure.StyleClassItem").parents("jetbrains.mps.lang.editor.structure.StyleClassItem").references("link").alias("navigatable-reference", "").create();
      case 146:
        return new ConceptDescriptorBuilder("jetbrains.mps.lang.editor.structure.PaddingBottomStyleClassItem").super_("jetbrains.mps.lang.editor.structure.AbstractPaddingStyleClassItem").parents("jetbrains.mps.lang.editor.structure.AbstractPaddingStyleClassItem").alias("padding-bottom", "").create();
      case 147:
        return new ConceptDescriptorBuilder("jetbrains.mps.lang.editor.structure.PaddingLeftStyleClassItem").super_("jetbrains.mps.lang.editor.structure.AbstractPaddingStyleClassItem").parents("jetbrains.mps.lang.editor.structure.AbstractPaddingStyleClassItem").alias("padding-left", "").create();
      case 148:
        return new ConceptDescriptorBuilder("jetbrains.mps.lang.editor.structure.PaddingRightStyleClassItem").super_("jetbrains.mps.lang.editor.structure.AbstractPaddingStyleClassItem").parents("jetbrains.mps.lang.editor.structure.AbstractPaddingStyleClassItem").alias("padding-right", "").create();
      case 149:
        return new ConceptDescriptorBuilder("jetbrains.mps.lang.editor.structure.PaddingTopStyleClassItem").super_("jetbrains.mps.lang.editor.structure.AbstractPaddingStyleClassItem").parents("jetbrains.mps.lang.editor.structure.AbstractPaddingStyleClassItem").alias("padding-top", "").create();
      case 150:
      ...
      case 151:
        return new ConceptDescriptorBuilder("jetbrains.mps.lang.editor.structure.ParametersInformationStyleClassItem").super_("jetbrains.mps.lang.editor.structure.StyleClassItem").parents("jetbrains.mps.lang.editor.structure.StyleClassItem").references("parametersInformation").alias("parameters-information", "").create();
      case 152:
        return new ConceptDescriptorBuilder("jetbrains.mps.lang.editor.structure.PositionChildrenStyleClassItem").super_("jetbrains.mps.lang.editor.structure.StyleClassItem").parents("jetbrains.mps.lang.editor.structure.StyleClassItem").properties("position").alias("position-children", "").create();
      case 153:
        return new ConceptDescriptorBuilder("jetbrains.mps.lang.editor.structure.PositionStyleClassItem").super_("jetbrains.mps.lang.editor.structure.StyleClassItem").parents("jetbrains.mps.lang.editor.structure.StyleClassItem").properties("position").alias("position", "").create();
      case 154:
        return new ConceptDescriptorBuilder("jetbrains.mps.lang.editor.structure.PreDefinedStyleClassItem").super_("jetbrains.mps.lang.editor.structure.StyleClassItem").parents("jetbrains.mps.lang.editor.structure.StyleClassItem").references("key").children(new String[]{"query", "queryStyle"}, new boolean[]{false, false}).alias("pre-defined-style", "").create();
      case 155:
      ...
      case 156:
        return new ConceptDescriptorBuilder("jetbrains.mps.lang.editor.structure.PunctuationLeftStyleClassItem").super_("jetbrains.mps.lang.editor.structure.BooleanStyleSheetItem").parents("jetbrains.mps.lang.editor.structure.BooleanStyleSheetItem").alias("punctuation-left", "").create();
      case 157:
        return new ConceptDescriptorBuilder("jetbrains.mps.lang.editor.structure.PunctuationRightStyleClassItem").super_("jetbrains.mps.lang.editor.structure.BooleanStyleSheetItem").parents("jetbrains.mps.lang.editor.structure.BooleanStyleSheetItem").alias("punctuation-right", "").create();
      case 158:
        return new ConceptDescriptorBuilder("jetbrains.mps.lang.editor.structure.QueryFunction_Boolean").super_("jetbrains.mps.lang.editor.structure.QueryFunction_StyleParameter").parents("jetbrains.mps.lang.editor.structure.QueryFunction_StyleParameter").alias("boolean function", "").create();
      case 159:
        return new ConceptDescriptorBuilder("jetbrains.mps.lang.editor.structure.QueryFunction_CellProvider").super_("jetbrains.mps.baseLanguage.structure.ConceptFunction").parents("jetbrains.mps.baseLanguage.structure.ConceptFunction").alias("cell provider", "embedded block of code").create();
      case 160:
      ...
      case 161:
        return new ConceptDescriptorBuilder("jetbrains.mps.lang.editor.structure.QueryFunction_FontStyle").super_("jetbrains.mps.lang.editor.structure.QueryFunction_StyleParameter").parents("jetbrains.mps.lang.editor.structure.QueryFunction_StyleParameter").alias("font style function", "").create();
      case 162:
        return new ConceptDescriptorBuilder("jetbrains.mps.lang.editor.structure.QueryFunction_ImagePath").super_("jetbrains.mps.baseLanguage.structure.ConceptFunction").parents("jetbrains.mps.baseLanguage.structure.ConceptFunction").alias("string", "embedded block of code").create();
      case 163:
        return new ConceptDescriptorBuilder("jetbrains.mps.lang.editor.structure.QueryFunction_Integer").super_("jetbrains.mps.lang.editor.structure.QueryFunction_StyleParameter").parents("jetbrains.mps.lang.editor.structure.QueryFunction_StyleParameter").alias("int function", "").create();
      case 164:
        return new ConceptDescriptorBuilder("jetbrains.mps.lang.editor.structure.QueryFunction_IsMethodCurrent").super_("jetbrains.mps.baseLanguage.structure.ConceptFunction").parents("jetbrains.mps.baseLanguage.structure.ConceptFunction").create();
      case 165:
        return new ConceptDescriptorBuilder("jetbrains.mps.lang.editor.structure.QueryFunction_JComponent").super_("jetbrains.mps.baseLanguage.structure.ConceptFunction").parents("jetbrains.mps.baseLanguage.structure.ConceptFunction").alias("component", "embedded block of code").create();
      case 166:
        return new ConceptDescriptorBuilder("jetbrains.mps.lang.editor.structure.QueryFunction_MethodPresentation").super_("jetbrains.mps.baseLanguage.structure.ConceptFunction").parents("jetbrains.mps.baseLanguage.structure.ConceptFunction").create();
      case 167:
        return new ConceptDescriptorBuilder("jetbrains.mps.lang.editor.structure.QueryFunction_ModelAccess_Getter").super_("jetbrains.mps.baseLanguage.structure.ConceptFunction").parents("jetbrains.mps.baseLanguage.structure.ConceptFunction").alias("condition", "embedded block of code").create();
      case 168:
        return new ConceptDescriptorBuilder("jetbrains.mps.lang.editor.structure.QueryFunction_ModelAccess_Setter").super_("jetbrains.mps.baseLanguage.structure.ConceptFunction").parents("jetbrains.mps.baseLanguage.structure.ConceptFunction").alias("condition", "embedded block of code").create();
      case 169:
        return new ConceptDescriptorBuilder("jetbrains.mps.lang.editor.structure.QueryFunction_ModelAccess_Validator").super_("jetbrains.mps.baseLanguage.structure.ConceptFunction").parents("jetbrains.mps.baseLanguage.structure.ConceptFunction").alias("condition", "embedded block of code").create();
      case 170:
        return new ConceptDescriptorBuilder("jetbrains.mps.lang.editor.structure.QueryFunction_NodeCondition").super_("jetbrains.mps.baseLanguage.structure.ConceptFunction").parents("jetbrains.mps.baseLanguage.structure.ConceptFunction").alias("condition", "embedded block of code").create();
      case 171:
        return new ConceptDescriptorBuilder("jetbrains.mps.lang.editor.structure.QueryFunction_NodeFactory").super_("jetbrains.mps.baseLanguage.structure.ConceptFunction").parents("jetbrains.mps.baseLanguage.structure.ConceptFunction").alias("node factory", "embedded block of code").create();
      case 172:
        return new ConceptDescriptorBuilder("jetbrains.mps.lang.editor.structure.QueryFunction_NodeListFilter").super_("jetbrains.mps.baseLanguage.structure.ConceptFunction").parents("jetbrains.mps.baseLanguage.structure.ConceptFunction").alias("node list provider", "embedded block of code").create();
      case 173:
        return new ConceptDescriptorBuilder("jetbrains.mps.lang.editor.structure.QueryFunction_ParametersList").super_("jetbrains.mps.baseLanguage.structure.ConceptFunction").parents("jetbrains.mps.baseLanguage.structure.ConceptFunction").create();
      case 174:
        return new ConceptDescriptorBuilder("jetbrains.mps.lang.editor.structure.QueryFunction_SNode").super_("jetbrains.mps.lang.editor.structure.QueryFunction_StyleParameter").parents("jetbrains.mps.lang.editor.structure.QueryFunction_StyleParameter").alias("snode function", "").create();
      case 175:
        return new ConceptDescriptorBuilder("jetbrains.mps.lang.editor.structure.QueryFunction_SeparatorText").super_("jetbrains.mps.baseLanguage.structure.ConceptFunction").parents("jetbrains.mps.baseLanguage.structure.ConceptFunction").alias("separator text", "embedded block of code").create();
      case 176:
        return new ConceptDescriptorBuilder("jetbrains.mps.lang.editor.structure.QueryFunction_String").super_("jetbrains.mps.baseLanguage.structure.ConceptFunction").parents("jetbrains.mps.baseLanguage.structure.ConceptFunction").create();
      case 177:
        return new ConceptDescriptorBuilder("jetbrains.mps.lang.editor.structure.QueryFunction_Style").super_("jetbrains.mps.lang.editor.structure.QueryFunction_StyleParameter").parents("jetbrains.mps.lang.editor.structure.QueryFunction_StyleParameter").create();
      case 178:
        return new ConceptDescriptorBuilder("jetbrains.mps.lang.editor.structure.QueryFunction_StyleParameter").super_("jetbrains.mps.baseLanguage.structure.ConceptFunction").parents("jetbrains.mps.baseLanguage.structure.ConceptFunction").abstract_().alias("", "embedded block of code").create();
      case 179:
        return new ConceptDescriptorBuilder("jetbrains.mps.lang.editor.structure.QueryFunction_Underlined").super_("jetbrains.mps.lang.editor.structure.QueryFunction_StyleParameter").parents("jetbrains.mps.lang.editor.structure.QueryFunction_StyleParameter").alias("underlined function", "").create();
      case 180:
      ...
      case 183:
        return new ConceptDescriptorBuilder("jetbrains.mps.lang.editor.structure.ScriptKindClassItem").super_("jetbrains.mps.lang.editor.structure.StyleClassItem").parents("jetbrains.mps.lang.editor.structure.StyleClassItem").properties("script").alias("script-kind", "").create();
      case 184:
        return new ConceptDescriptorBuilder("jetbrains.mps.lang.editor.structure.SelectOperation").super_("jetbrains.mps.lang.smodel.structure.SNodeOperation").parents("jetbrains.mps.lang.smodel.structure.SNodeOperation").children(new String[]{"editorContext", "selectLaterParameter"}, new boolean[]{false, true}).alias("select", "").create();
      case 185:
      ...
      case 187:
        return new ConceptDescriptorBuilder("jetbrains.mps.lang.editor.structure.SelectableStyleSheetItem").super_("jetbrains.mps.lang.editor.structure.BooleanStyleSheetItem").parents("jetbrains.mps.lang.editor.structure.BooleanStyleSheetItem").alias("selectable", "").create();
      case 188:
        return new ConceptDescriptorBuilder("jetbrains.mps.lang.editor.structure.SetBoldOperation").super_("jetbrains.mps.lang.editor.structure.AbstractStyledTextOperation").parents("jetbrains.mps.lang.editor.structure.AbstractStyledTextOperation").alias("setBold", "").create();
      case 189:
        return new ConceptDescriptorBuilder("jetbrains.mps.lang.editor.structure.SideTransformAnchorTagStyleClassItem").super_("jetbrains.mps.lang.editor.structure.StyleClassItem").parents("jetbrains.mps.lang.editor.structure.StyleClassItem").properties("tag").children(new String[]{"tags"}, new boolean[]{true}).alias("side-transform-anchor-tag", "").create();
      case 190:
        return new ConceptDescriptorBuilder("jetbrains.mps.lang.editor.structure.StrikeOutStyleSheet").super_("jetbrains.mps.lang.editor.structure.BooleanStyleSheetItem").parents("jetbrains.mps.lang.editor.structure.BooleanStyleSheetItem").alias("strike-out", "").create();
      case 191:
        return new ConceptDescriptorBuilder("jetbrains.mps.lang.editor.structure.StyleClassItem").super_("jetbrains.mps.lang.core.structure.BaseConcept").parents("jetbrains.mps.lang.core.structure.BaseConcept").abstract_().create();
      case 192:
      ...
      case 197:
        return new ConceptDescriptorBuilder("jetbrains.mps.lang.editor.structure.StyledTextType").super_("jetbrains.mps.baseLanguage.structure.Type").parents("jetbrains.mps.baseLanguage.structure.Type").alias("styled text", "").create();
      case 198:
        return new ConceptDescriptorBuilder("jetbrains.mps.lang.editor.structure.TableComponentStyleClassItem").super_("jetbrains.mps.lang.editor.structure.StyleClassItem").parents("jetbrains.mps.lang.editor.structure.StyleClassItem").properties("tableComponent").alias("table-component", "").create();
      case 199:
        return new ConceptDescriptorBuilder("jetbrains.mps.lang.editor.structure.TextBackgroundColorSelectedStyleClassItem").super_("jetbrains.mps.lang.editor.structure.ColorStyleClassItem").parents("jetbrains.mps.lang.editor.structure.ColorStyleClassItem").alias("text-background-color-selected", "").create();
      case 200:
        return new ConceptDescriptorBuilder("jetbrains.mps.lang.editor.structure.TextBackgroundColorStyleClassItem").super_("jetbrains.mps.lang.editor.structure.ColorStyleClassItem").parents("jetbrains.mps.lang.editor.structure.ColorStyleClassItem").alias("text-background-color", "").create();
      case 201:
        return new ConceptDescriptorBuilder("jetbrains.mps.lang.editor.structure.TransactionPropertyHandler_newValue").super_("jetbrains.mps.baseLanguage.structure.ConceptFunctionParameter").parents("jetbrains.mps.baseLanguage.structure.ConceptFunctionParameter", "jetbrains.mps.lang.core.structure.IDontSubstituteByDefault").alias("newValue", "").create();
      case 202:
        return new ConceptDescriptorBuilder("jetbrains.mps.lang.editor.structure.TransactionPropertyHandler_oldValue").super_("jetbrains.mps.baseLanguage.structure.ConceptFunctionParameter").parents("jetbrains.mps.baseLanguage.structure.ConceptFunctionParameter").alias("oldValue", "").create();
      case 203:
        return new ConceptDescriptorBuilder("jetbrains.mps.lang.editor.structure.TransactionalPropertyHandler").super_("jetbrains.mps.baseLanguage.structure.ConceptFunction").parents("jetbrains.mps.baseLanguage.structure.ConceptFunction").create();
      case 204:
