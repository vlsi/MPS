...
/*package*/ class TransformationMenuReference_Default_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createRefCell_9zto5v_b0() {
    CellProviderWithRole provider = new RefCellCellProvider(myNode, getEditorContext()) {
      ...
      protected InlineCellProvider createInlineCellProvider(SNode innerCellNode) {
        return new TransformationMenuReference_Default_EditorBuilder_a._Inline_9zto5v_a1a(innerCellNode, myNode);
      }
    };
  ...
  public static class _Inline_9zto5v_a1a extends InlineCellProvider {
    public _Inline_9zto5v_a1a(SNode node, SNode refNode) {
      super(node, refNode);
    }
