...
public class CellMenuPart_PropertyPostfixHints_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createConstant_nmnci2_a0a(EditorContext editorContext, SNode node) {
    EditorCell_Constant editorCell = new EditorCell_Constant((jetbrains.mps.nodeEditor.EditorContext) editorContext, node, "property postfix hints");
  ...
  private EditorCell createConstant_nmnci2_b1a(EditorContext editorContext, SNode node) {
    EditorCell_Constant editorCell = new EditorCell_Constant((jetbrains.mps.nodeEditor.EditorContext) editorContext, node, "postfixes");
