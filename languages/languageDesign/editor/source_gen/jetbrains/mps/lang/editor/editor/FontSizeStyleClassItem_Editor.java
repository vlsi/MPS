...
public class FontSizeStyleClassItem_Editor extends DefaultNodeEditor {
  ...
  private static boolean renderingCondition_xqkmqp_a2a(SNode node, EditorContext editorContext) {
    return SLinkOperations.getTarget(node, MetaAdapterFactory.getContainmentLink(new UUID(1782411230332735017l, -6324602048325217350l), 1186415722038l, 1221064706952l, "query")) == null;
  }
  public static class FontSizeStyleClassItem_generic_cellMenu_xqkmqp_a0c0 extends AbstractCellMenuPart_Generic_Item {
    ...
    public void handleAction(SNode node, SModel model, IOperationContext operationContext, EditorContext editorContext) {
      SNodeFactoryOperations.setNewChild(node, MetaAdapterFactory.getContainmentLink(new UUID(1782411230332735017l, -6324602048325217350l), 1186415722038l, 1221064706952l, "query"), MetaAdapterFactory.getConcept(new UUID(1782411230332735017l, -6324602048325217350l), 1221057094638l, "jetbrains.mps.lang.editor.structure.QueryFunction_Integer"));
    }
