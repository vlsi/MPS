...
public class DataCellActionMap {
  public static void setCellActions(EditorCell editorCell, SNode node, EditorContext context) {
    ...
    editorCell.setAction(CellActionType.BACKSPACE, new DataCellActionMap.DataCellActionMap_BACKSPACE(node));
  }
  ...
  public static class DataCellActionMap_BACKSPACE extends AbstractCellAction {
    /*package*/ SNode myNode;
    public DataCellActionMap_BACKSPACE(SNode node) {
      this.myNode = node;
    }
    public String getDescriptionText() {
      return "delete";
