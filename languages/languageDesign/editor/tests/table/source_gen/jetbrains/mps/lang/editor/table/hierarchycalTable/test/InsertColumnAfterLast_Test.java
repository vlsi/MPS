...
@MPSLaunch
public class InsertColumnAfterLast_Test extends BaseTransformationTest4 {
  public InsertColumnAfterLast_Test() {
  }

  @Test
  public void test_InsertColumnAfterLast() throws Throwable {
    this.initTest("${mps_home}", "r:67b81510-37ee-448c-9923-c51275863bef(jetbrains.mps.lang.editor.table.hierarchycalTable.test)");
  ...
  public static class TestBody extends BaseEditorTestBody {
    ...
    public void testMethodImpl() throws Exception {
      final Editor editor = TestBody.this.initEditor("5171926735592482853", "5171926735592482884");
