...
@MPSLaunch
public class CreateY_Test extends BaseTransformationTest4 {
  public CreateY_Test() {
  }

  @Test
  public void test_CreateY() throws Throwable {
    this.initTest("${mps_home}", "r:8bac3b50-f9ad-4677-8274-76544dbc0da8(jetbrains.mps.lang.editor.table.matrix.test)");
