...
@MPSLaunch
public class LocalHomeFromColumnSelection_Test extends BaseTransformationTest4 {
  public LocalHomeFromColumnSelection_Test() {
  }

  @Test
  public void test_LocalHomeFromColumnSelection() throws Throwable {
    this.initTest("${mps_home}", "r:e02ee75b-0624-4ff2-b4d9-d2277a157ff4(jetbrains.mps.lang.editor.table.genericTable.test)");
  ...
  public static class TestBody extends BaseEditorTestBody {
    ...
    public void testMethodImpl() throws Exception {
      ...
      BaseEditorTestBody.invokeAction(editorComponent, "jetbrains.mps.ide.editor.actions.LocalHome_Action");
    }
  }
}
