...
@MPSLaunch
public class MoveTransitionToAnotherRow_Test extends BaseTransformationTest4 {
  public MoveTransitionToAnotherRow_Test() {
  }

  @Test
  public void test_MoveTransitionToAnotherRow() throws Throwable {
    this.initTest("${mps_home}", "r:dc1400b5-0aa4-448e-8f15-11fb0ccb5c23(jetbrains.mps.lang.editor.table.stateMachine.test)");
  ...
  public static class TestBody extends BaseEditorTestBody {
    ...
    public void testMethodImpl() throws Exception {
      final Editor editor = TestBody.this.initEditor("6170050146384285903", "6170050146384300225");
