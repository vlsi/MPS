...
@MPSLaunch
public class HomeFromColumnSelection_Test extends BaseTransformationTest4 {
  public HomeFromColumnSelection_Test() {
  }

  @Test
  public void test_HomeFromColumnSelection() throws Throwable {
    this.initTest("${mps_home}/MPS.mpr", "r:e02ee75b-0624-4ff2-b4d9-d2277a157ff4(jetbrains.mps.lang.editor.table.genericTable.test@tests)");
