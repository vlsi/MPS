...
@MPSLaunch
public class RemoveY_Test extends BaseTransformationTest4 {
  public RemoveY_Test() {
  }

  @Test
  public void test_RemoveY() throws Throwable {
    this.initTest("${mps_home}/MPS.mpr", "r:8bac3b50-f9ad-4677-8274-76544dbc0da8(jetbrains.mps.lang.editor.table.matrix.test@@tests)");
