...
public class TransformationMenuPart_Intention_Constraints extends BaseConstraintsDescriptor {
  public TransformationMenuPart_Intention_Constraints() {
    super(MetaAdapterFactory.getConcept(0xcffe907ed3de433fL, 0x89d657d9c449c0e2L, 0x289dadfa24b57a51L, "jetbrains.mps.lang.intentions.contextAssistant.structure.TransformationMenuPart_Intention"));
  }
  @Override
  ...
  private static boolean check_qffvkf_a0e0a0a0a0a0b0a0a0b0a1a0b0b(SNode checkedDotOperand, SNode intentionConcept) {
  ...
  private static SNode check_qffvkf_a0a4a0a0a0a0a1a0a0a1a0b0a1a1(SNode checkedDotOperand) {
    if (null != checkedDotOperand) {
      return ITransformationMenu__BehaviorDescriptor.getApplicableConcept_id5OVd5tVoadE.invoke(checkedDotOperand);
    }
    return null;
  }
  private static SNodePointer breakingNode_qffvkf_a0a0a0a0a1a0b0a1a1 = new SNodePointer("r:bb97162f-2dcb-4ef8-802a-23987a8537bd(jetbrains.mps.lang.intentions.contextAssistant.constraints)", "4736696158596338905");
}
