...
public final class Node_GetConceptOperation__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0x7866978ea0f04cc7L, 0x81bc4d213d9375e1L, 0x110f3e65fdcL, "jetbrains.mps.lang.smodel.structure.Node_GetConceptOperation");
  ...
  private static final List<SMethod<?>> BH_METHODS = Arrays.<SMethod<?>>asList(applicableToLink_id1653mnvAgvK, applicableToNode_id1653mnvAgrs, applicableToConcept_id1653mnvAgvQ);
  ...
  /*package*/ Node_GetConceptOperation__BehaviorDescriptor() {
    super(REGISTRY);
  }
