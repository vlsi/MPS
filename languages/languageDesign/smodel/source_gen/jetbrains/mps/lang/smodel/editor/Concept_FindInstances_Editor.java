...
public class Concept_FindInstances_Editor extends DefaultNodeEditor {
  public EditorCell createEditorCell(EditorContext editorContext, SNode node) {
    return this.createCollection_2v58n3_a(editorContext, node);
  }
  ...
  private EditorCell createCollection_2v58n3_a(EditorContext editorContext, SNode node) {
    ...
    editorCell.addEditorCell(this.createConstant_2v58n3_d0(editorContext, node));
    return editorCell;
  }

  private EditorCell createComponent_2v58n3_a0(EditorContext editorContext, SNode node) {
    AbstractCellProvider provider = new ReplaceableAlias_Comp(node);
    EditorCell editorCell = provider.createEditorCell(editorContext);
    return editorCell;
  }

  private EditorCell createConstant_2v58n3_b0(EditorContext editorContext, SNode node) {
    EditorCell_Constant editorCell = new EditorCell_Constant(editorContext, node, "(");
    editorCell.setCellId("Constant_2v58n3_b0");
  ...
  private EditorCell createConstant_2v58n3_d0(EditorContext editorContext, SNode node) {
    EditorCell_Constant editorCell = new EditorCell_Constant(editorContext, node, ")");
    editorCell.setCellId("Constant_2v58n3_d0");
    Style style = new StyleImpl();
