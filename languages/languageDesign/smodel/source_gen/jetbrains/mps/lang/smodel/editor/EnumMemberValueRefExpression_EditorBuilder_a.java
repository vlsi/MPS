...
/*package*/ class EnumMemberValueRefExpression_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createRefCell_ldpt2z_c0() {
    CellProviderWithRole provider = new RefCellCellProvider(myNode, getEditorContext()) {
      ...
      protected InlineCellProvider createInlineCellProvider(SNode innerCellNode) {
        return new EnumMemberValueRefExpression_EditorBuilder_a._Inline_ldpt2z_a2a(innerCellNode, myNode);
      }
    };
  ...
  public static class _Inline_ldpt2z_a2a extends InlineCellProvider {
    public _Inline_ldpt2z_a2a(SNode node, SNode refNode) {
      super(node, refNode);
    }
    ...
    public EditorCell createEditorCell(EditorContext editorContext, SNode node) {
      ...
      return new EnumMemberValueRefExpression_EditorBuilder_a.Inline_Builder_ldpt2z_a2a(editorContext, getRefNode(), node).createCell();
    }
  }
  ...
  private EditorCell createRefCell_ldpt2z_e0() {
    CellProviderWithRole provider = new RefCellCellProvider(myNode, getEditorContext()) {
      @Override
      protected InlineCellProvider createInlineCellProvider(SNode innerCellNode) {
        return new EnumMemberValueRefExpression_EditorBuilder_a._Inline_ldpt2z_a4a(innerCellNode, myNode);
      }
    };
  ...
  public static class _Inline_ldpt2z_a4a extends InlineCellProvider {
    public _Inline_ldpt2z_a4a(SNode node, SNode refNode) {
      super(node, refNode);
    }
    public EditorCell createEditorCell(EditorContext editorContext) {
      return createEditorCell(editorContext, getSNode());
    ...
    public EditorCell createEditorCell(EditorContext editorContext, SNode node) {
      // looks like getRefNode() == node 
      return new EnumMemberValueRefExpression_EditorBuilder_a.Inline_Builder_ldpt2z_a4a(editorContext, getRefNode(), node).createCell();
    }
  }
  /*package*/ static class Inline_Builder_ldpt2z_a4a extends AbstractEditorBuilder {
    ...
    private EditorCell createReferencePresentation_ldpt2z_a0e0() {
      EditorCell_Property editorCell = EditorCell_RefPresentation.create(getEditorContext(), myNode, myReferencingNode, "member");
