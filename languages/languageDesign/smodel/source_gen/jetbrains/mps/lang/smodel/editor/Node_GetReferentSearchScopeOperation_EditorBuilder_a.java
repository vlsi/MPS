...
/*package*/ class Node_GetReferentSearchScopeOperation_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createRefCell_8agmue_c0() {
    CellProviderWithRole provider = new RefCellCellProvider(myNode, getEditorContext()) {
      ...
      protected InlineCellProvider createInlineCellProvider(SNode innerCellNode) {
        return new Node_GetReferentSearchScopeOperation_EditorBuilder_a._Inline_8agmue_a2a(innerCellNode, myNode);
      }
    };
  ...
  public static class _Inline_8agmue_a2a extends InlineCellProvider {
    public _Inline_8agmue_a2a(SNode node, SNode refNode) {
      super(node, refNode);
    }
