...
public class ModuleReferenceExpression_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createConstant_c6z1wa_a0(EditorContext editorContext, SNode node) {
    EditorCell_Constant editorCell = new EditorCell_Constant((jetbrains.mps.nodeEditor.EditorContext) editorContext, node, "module uid");
  ...
  private EditorCell createProperty_c6z1wa_c0(EditorContext editorContext, SNode node) {
    ...
    editorCell.setSubstituteInfo(new CompositeSubstituteInfo(editorContext, provider.getCellContext(), new SubstituteInfoPartExt[]{new ModuleReferenceExpression_Editor.ModuleReferenceExpression_generic_cellMenu_a0c0()}));
