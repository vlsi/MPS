...
public class ConvertInstanceofToNodeInstanceof_Intention implements IntentionFactory {
  ...
  public class IntentionImplementation implements IntentionExecutable {
    ...
    public void execute(final SNode node, final EditorContext editorContext) {
      ...
      SNode conceptReference = SLinkOperations.setNewChild(operation, MetaAdapterFactory.getContainmentLink(new UUID(8675788371017092295l, -9098312342032910879l), 1139621453865l, 1177027386292l, "conceptArgument"), "jetbrains.mps.lang.smodel.structure.RefConcept_Reference");
