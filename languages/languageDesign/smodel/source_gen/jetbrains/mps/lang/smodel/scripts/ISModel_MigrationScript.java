...
public class ISModel_MigrationScript extends BaseMigrationScript {
  public ISModel_MigrationScript(IOperationContext operationContext) {
    ...
    this.addRefactoring(new AbstractMigrationRefactoring(operationContext) {
      public String getName() {
        return "Replacing static field references referencing static fields declared in jetbrains.mps.smodel.SModelDescriptor classified with static fields from org.jetbrains.mps.openapi.model.SModel";
      }
    ...
    this.addRefactoring(new AbstractMigrationRefactoring(operationContext) {
      public String getName() {
        return "Pull up and remove all methods from jetbrains.mps.smodel.SModelDescriptor to org.jetbrains.mps.openapi.model.SModel";
      }
