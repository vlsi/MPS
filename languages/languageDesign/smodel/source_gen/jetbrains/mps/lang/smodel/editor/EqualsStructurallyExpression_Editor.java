...
public class EqualsStructurallyExpression_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createComponent_5qomut_b0(EditorContext editorContext, SNode node) {
    ...
    editorCell.setSubstituteInfo(new CompositeSubstituteInfo(editorContext, new BasicCellContext(node), new SubstituteInfoPartExt[]{new EqualsStructurallyExpression_Editor.ReplaceWith_BinaryOperation_cellMenu_5qomut_a0b0(), new SChildSubstituteInfoPartEx(editorCell)}));
    return editorCell;
  }
