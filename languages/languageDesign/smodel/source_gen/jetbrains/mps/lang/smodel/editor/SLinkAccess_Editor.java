...
public class SLinkAccess_Editor extends DefaultNodeEditor {
  public EditorCell createEditorCell(EditorContext editorContext, SNode node) {
    return this.createCollection_35c8z1_a(editorContext, node);
  }
  ...
  private EditorCell createRefCell_35c8z1_a0(EditorContext editorContext, SNode node) {
    CellProviderWithRole provider = new RefCellCellProvider(node, editorContext);
    provider.setRole("link");
    provider.setNoTargetText("<no link>");
    EditorCell editorCell;
    provider.setAuxiliaryCellProvider(new SLinkAccess_Editor._Inline_35c8z1_a0a("link"));
  ...
  public static class _Inline_35c8z1_a0a extends InlineCellProvider {
    public _Inline_35c8z1_a0a(String role) {
      super(role);
    }
    ...
    public EditorCell createEditorCell(EditorContext editorContext, SNode node) {
      return this.createProperty_35c8z1_a0a0(editorContext, node);
    }
