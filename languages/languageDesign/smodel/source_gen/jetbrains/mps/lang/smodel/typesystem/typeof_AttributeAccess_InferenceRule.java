...
public class typeof_AttributeAccess_InferenceRule extends AbstractInferenceRule_Runtime implements InferenceRule_Runtime {
    ...
    if (SConceptPropertyOperations.getBoolean(attr, "multiple") || SNodeOperations.isInstanceOf(SLinkOperations.getTarget(operation, "qualifier", true), "jetbrains.mps.lang.smodel.structure.AllAttributeQualifier")) {
      {
        ...
        typeCheckingContext.createEquation((SNode) typeCheckingContext.typeOf(_nodeToCheck_1029348928467, "r:00000000-0000-4000-0000-011c895902fe(jetbrains.mps.lang.smodel.typesystem)", "2788452359612125333", true), (SNode) _quotation_createNode_dktlpw_a0a0b0a(attr), _info_12389875345);
      }
    } else {
      {
        SNode _nodeToCheck_1029348928467 = operation;
        ...
        typeCheckingContext.createEquation((SNode) typeCheckingContext.typeOf(_nodeToCheck_1029348928467, "r:00000000-0000-4000-0000-011c895902fe(jetbrains.mps.lang.smodel.typesystem)", "2788452359612125355", true), (SNode) _quotation_createNode_dktlpw_a0a0a1a0(attr), _info_12389875345);
      }
    }
  }
  ...
  private static SNode _quotation_createNode_dktlpw_a0a0b0a(Object parameter_1) {
  ...
  private static SNode _quotation_createNode_dktlpw_a0a0a1a0(Object parameter_1) {
    SNode quotedNode_2 = null;
