...
public class OperationParm_ConceptList_Editor extends DefaultNodeEditor {
  ...
  private static class conceptListHandler_cly5ih_b0 extends RefNodeListHandler {
    ...
    public EditorCell createEmptyCell(EditorContext editorContext) {
      editorContext.getCellFactory().pushCellContext();
      editorContext.getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(conceptListHandler_cly5ih_b0.this.getOwner(), MetaAdapterFactory.getContainmentLink(0x7866978ea0f04cc7L, 0x81bc4d213d9375e1L, 0x10cd05bec71L, 0x10cd05bec73L, "concept")));
      try {
