...
public class ModelReferenceExpression_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createCollection_uy53zt_a(EditorContext editorContext, SNode node) {
    ...
    editorCell.addEditorCell(this.createConceptProperty_uy53zt_a0(editorContext, node));
  ...
  private EditorCell createProperty_uy53zt_c0(EditorContext editorContext, SNode node) {
    ...
    editorCell.setSubstituteInfo(new CompositeSubstituteInfo(editorContext, provider.getCellContext(), new SubstituteInfoPart[]{new ModelReferenceExpression_Editor.ModelReferenceExpression_generic_cellMenu_a0c0()}));
  ...
  private EditorCell createConceptProperty_uy53zt_a0(EditorContext editorContext, SNode node) {
  ...
  public static class ModelReferenceExpression_generic_cellMenu_a0c0 extends AbstractCellMenuPart_Generic_Group {
    ...
    public void handleAction_impl(SModelDescriptor parameterObject, SNode node, SModel model, IScope scope, IOperationContext operationContext, jetbrains.mps.nodeEditor.EditorContext editorContext) {
