...
public class typeOf_Node_GetAdapterOperation_InferenceRule extends AbstractInferenceRule_Runtime implements InferenceRule_Runtime {
  ...
  public void applyRule(final SNode node, final TypeCheckingContext typeCheckingContext, IsApplicableStatus status) {
    ...
    RulesUtil.equate_inputNodeConcept(typeCheckingContext, node, typeCheckingContext.getRepresentative(Concept_typevar_1205967245422));
    {
      ...
      typeCheckingContext.whenConcrete(C, new Runnable() {
        public void run() {
          SNode inputNodeConcept = SNodeOperations.cast(typeCheckingContext.getExpandedNode(C), "jetbrains.mps.lang.structure.structure.AbstractConceptDeclaration");
          {
    ...
    {
      SNode _nodeToCheck_1029348928467 = node;
      EquationInfo _info_12389875345 = new EquationInfo(_nodeToCheck_1029348928467, null, "r:00000000-0000-4000-0000-011c895902fe(jetbrains.mps.lang.smodel.typesystem)", "1186057690603", 0, null);
      typeCheckingContext.createLessThanInequality((SNode) typeCheckingContext.typeOf(_nodeToCheck_1029348928467, "r:00000000-0000-4000-0000-011c895902fe(jetbrains.mps.lang.smodel.typesystem)", "1186057680866", true), (SNode) new typeOf_Node_GetAdapterOperation_InferenceRule.QuotationClass_j10w9m_a0a3a0().createNode(typeCheckingContext), false, true, _info_12389875345);
    }
  }
  ...
  public static class QuotationClass_j10w9m_a0a3a0 {
    public QuotationClass_j10w9m_a0a3a0() {
    }
