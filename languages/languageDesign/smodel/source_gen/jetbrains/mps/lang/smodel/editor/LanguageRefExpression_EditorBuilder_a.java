  ...
  private static class languageIdSingleRoleHandler_9pn6lo_c0 extends SingleRoleCellProvider {
    ...
    private void installCellInfo(SNode child, EditorCell editorCell) {
      if (editorCell.getSubstituteInfo() == null || editorCell.getSubstituteInfo() instanceof DefaultSubstituteInfo) {
        editorCell.setSubstituteInfo(new CompositeSubstituteInfo(getEditorContext(), new AggregationCellContext(myNode, child, myContainmentLink.getDeclarationNode()), new SubstituteInfoPartExt[]{new LanguageRefExpression_EditorBuilder_a.languageIdSingleRoleHandler_9pn6lo_c0.LanguageRefExpression_generic_cellMenu_9pn6lo_a0c0(), new SChildSubstituteInfoPartEx(editorCell)}));
      }
