...
public final class ConvertPropertySetToAssignment_Intention extends IntentionDescriptorBase implements IntentionFactory {
  ...
  /*package*/ final class IntentionImplementation extends IntentionExecutableBase {
    ...
    public void execute(final SNode node, final EditorContext editorContext) {
      SNode lValue = IOperation_BehaviorDescriptor.getOperand_idhEwIP$m.invoke(node);
      ...
      SNode dotExpr = IOperation_BehaviorDescriptor.getDotExpression_idhO_4GYO.invoke(node);
