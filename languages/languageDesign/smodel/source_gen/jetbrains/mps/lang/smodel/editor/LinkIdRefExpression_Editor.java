...
public class LinkIdRefExpression_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createCollection_1ktdi3_a(EditorContext editorContext, SNode node) {
    ...
    editorCell.addEditorCell(this.createRefCell_1ktdi3_c0(editorContext, node));
    editorCell.addEditorCell(this.createConstant_1ktdi3_d0(editorContext, node));
    editorCell.addEditorCell(this.createRefCell_1ktdi3_e0(editorContext, node));
  ...
  private EditorCell createRefCell_1ktdi3_c0(EditorContext editorContext, SNode node) {
    ...
    provider.setAuxiliaryCellProvider(new LinkIdRefExpression_Editor._Inline_1ktdi3_a2a());
  ...
  private EditorCell createRefCell_1ktdi3_e0(EditorContext editorContext, SNode node) {
    ...
    EditorCell editorCell;
    provider.setAuxiliaryCellProvider(new LinkIdRefExpression_Editor._Inline_1ktdi3_a4a());
    editorCell = provider.createEditorCell(editorContext);
    if (editorCell.getRole() == null) {
      editorCell.setReferenceCell(true);
