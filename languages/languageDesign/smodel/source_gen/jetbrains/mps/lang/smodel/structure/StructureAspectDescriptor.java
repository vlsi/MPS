...
public class StructureAspectDescriptor implements jetbrains.mps.smodel.runtime.StructureAspectDescriptor {
  ...
  public ConceptDescriptor getDescriptor(String conceptFqName) {
    switch (Arrays.binarySearch(stringSwitchCases_1htk8d_a0a0b, conceptFqName)) {
      ...
      case 10:
        return new ConceptDescriptorBuilder("jetbrains.mps.lang.smodel.structure.ConceptIdRefExpression").super_("jetbrains.mps.baseLanguage.structure.Expression").parents("jetbrains.mps.baseLanguage.structure.Expression").references("conceptDeclaration").alias("concept id/<name>/", "").staticScope(StaticScope.NONE).create();
      case 11:
      ...
      case 41:
        return new ConceptDescriptorBuilder("jetbrains.mps.lang.smodel.structure.LinkIdRefExpression").super_("jetbrains.mps.baseLanguage.structure.Expression").parents("jetbrains.mps.baseLanguage.structure.Expression").references("conceptDeclaration", "linkDeclaration").alias("link id/<role>/", "name").staticScope(StaticScope.NONE).create();
      case 42:
      ...
      case 107:
        return new ConceptDescriptorBuilder("jetbrains.mps.lang.smodel.structure.PropertyIdRefExpression").super_("jetbrains.mps.baseLanguage.structure.Expression").parents("jetbrains.mps.baseLanguage.structure.Expression").references("conceptDeclaration", "propertyDeclaration").alias("property id/<role>/", "").staticScope(StaticScope.NONE).create();
      case 108:
