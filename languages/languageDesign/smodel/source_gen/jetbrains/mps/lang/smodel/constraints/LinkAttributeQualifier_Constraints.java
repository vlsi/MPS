      ...
      public ReferenceScopeProvider getScopeProvider() {
        return new BaseReferenceScopeProvider() {
          ...
          public Object createSearchScopeOrListOfNodes(final IOperationContext operationContext, final ReferenceConstraintsContext _context) {
            return AttributeQualifier_Behavior.call_getApplicableRoles_959482772563105834(SConceptRepository.getInstance().getConcept(NameUtil.nodeFQName(SConceptOperations.findConceptDeclaration("jetbrains.mps.lang.smodel.structure.AttributeQualifier"))), _context.getEnclosingNode(), "jetbrains.mps.lang.core.structure.LinkAttribute", _context.getModel(), operationContext.getScope());
          }
