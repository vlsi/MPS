...
public class supertypesOf_SetType_SetType_elementSNode_SubtypingRule extends SubtypingRule_Runtime implements ISubtypingRule_Runtime {
  ...
  public List<SNode> getSubOrSuperTypes(SNode setType, TypeCheckingContext typeCheckingContext, IsApplicableStatus status) {
    ...
    if (SLinkOperations.getTarget(classifierType, "classifier", false) == SLinkOperations.getTarget(new supertypesOf_SetType_SetType_elementSNode_SubtypingRule.QuotationClass_6rkyoe_a0a0c0a().createNode(typeCheckingContext), "classifier", false)) {
      ListSequence.fromList(result).addElement(new supertypesOf_SetType_SetType_elementSNode_SubtypingRule.QuotationClass_6rkyoe_a0a0a0c0a().createNode(typeCheckingContext));
    }
    return result;
  }
  ...
  public static class QuotationClass_6rkyoe_a0a0a0c0a {
    public QuotationClass_6rkyoe_a0a0a0c0a() {
    }
  ...
  public static class QuotationClass_6rkyoe_a0a0c0a {
    public QuotationClass_6rkyoe_a0a0c0a() {
    }
