  ...
  public SNode execute(SModule m) {
    {
      ...
      Sequence.fromIterable(((Iterable<SModel>) m.getModels())).translate(new ITranslator2<SModel, SNode>() {
        ...
        public boolean accept(SNode op) {
          ...
          if (BaseConcept_BehaviorDescriptor.getMetaLevel_id3t0v3yFOD1A.invoke(op) != 0 && SNodeOperations.getContainingRoot(op) == SNodeOperations.getNode("r:18ddb7a1-bae8-47e8-a653-f672ff99522d(jetbrains.mps.lang.smodel.migration)", "3164834233148532313")) {
            return false;
          }
          return true;
        }
            ...
            public void invoke(SNode oldNode, SNode newNode) {
              ...
              ListSequence.fromList(attributes).visitAll(new IVisitor<SNode>() {
                public void visit(SNode it) {
                  LinkAttribute_BehaviorDescriptor.setLink_id6Gg5KlvuxxF.invoke(it, MetaAdapterFactory.getReferenceLink(0x7866978ea0f04cc7L, 0x81bc4d213d9375e1L, 0x1120c45902cL, 0x1120c45d024L, "conceptDeclaration"));
                }
              });
