  ...
  public Collection<ConceptEditor> getDeclaredEditors(SAbstractConcept concept) {
    {
      ...
      switch (switchIndex) {
        ...
        case 34:
          if (true) {
            return Collections.<ConceptEditor>singletonList(new LinkId_Editor());
          }
          break;
        case 35:
          if (true) {
        ...
        case 110:
          if (true) {
            return Collections.<ConceptEditor>singletonList(new ReferenceId_Editor());
          }
          break;
        case 111:
          if (true) {
