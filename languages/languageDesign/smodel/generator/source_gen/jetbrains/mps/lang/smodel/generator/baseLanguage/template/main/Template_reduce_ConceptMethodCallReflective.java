...
public class Template_reduce_ConceptMethodCallReflective extends TemplateDeclarationBase {
  ...
  protected Collection<SNode> applyPart0(@NotNull final TemplateContext context) throws GenerationException {
    ...
    {
      final SNode switchInput1 = QueriesGenerated.sourceNodeQuery_6862765979525924594(new SourceSubstituteMacroNodeContext(context, switchMacroRef_fdl98n_b0a0a0a2a4));
      if (switchInput1 == null) {
        ...
        tlist1 = environment.trySwitch(templateSwitchNode_fdl98n_a0a0c0a1a2a4, switchContext1);
        if (tlist1 == null) {
  ...
  private static SNodePointer switchMacroRef_fdl98n_b0a0a0a2a4 = new SNodePointer("r:00000000-0000-4000-0000-011c89590303(jetbrains.mps.lang.smodel.generator.baseLanguage.template.main@generator)", "6862765979525924593");
  private static SNodePointer templateSwitchNode_fdl98n_a0a0c0a1a2a4 = new SNodePointer("r:00000000-0000-4000-0000-011c89590303(jetbrains.mps.lang.smodel.generator.baseLanguage.template.main@generator)", "6862765979525798685");
}
