...
public class Template_reduce_GetAncestor_whereConceptInList_SameML extends TemplateDeclarationBase {
            ...
            try {
              ...
              }
              {
                ...
                for (SNode itnode7 : loopList7) {
                  ...
                  try {
                    SNode callInputNode8 = QueriesGenerated.sourceNodeQuery_3902354333653818152(new SourceSubstituteMacroNodeContext(context4, includeMacro_nv63xn_b0a0a0a3a2a2a1a1a1a4a2a4));
  ...
  private static SNodePointer includeMacro_nv63xn_b0a0a0a3a2a2a1a1a1a4a2a4 = new SNodePointer("r:00000000-0000-4000-0000-011c89590303(jetbrains.mps.lang.smodel.generator.baseLanguage.template.main@generator)", "3902354333653814673");
