...
public class Template_reduce_ConceptId_SConcept extends TemplateDeclarationBase {
  ...
  protected SNode applyPart0(@NotNull final TemplateContext context) throws GenerationException {
    ...
    try {
      ...
      TemplateContext context1 = context.subContext();
      {
        ...
        {
          final SNode switchInput2 = QueriesGenerated.sourceNodeQuery_6911370362349556077(new SourceSubstituteMacroNodeContext(context1, switchMacroRef_r2ji7m_b0a0a0a1a3a2a4));
          if (switchInput2 == null) {
            {
              TemplateSwitchMapping switch2 = environment.getGenerator().getSwitch(templateSwitchNode_r2ji7m_a0a0c0a1a1a3a2a4);
              if (switch2 != null) {
                switch2.processNull(environment, templateSwitchNode_r2ji7m_a0a0c0a1a1a3a2a4, context1);
              }
            }
            ...
            tlist2 = environment.trySwitch(templateSwitchNode_r2ji7m_a0a0c0a1a1a3a2a4, switchContext2);
            if (tlist2 == null) {
      ...
      }
      {
        ...
        try {
          SNodeAccessUtil.setProperty(tnode5, myProperties[0], TemplateUtil.asString(QueriesGenerated.propertyMacro_GetPropertyValue_6911370362349555640(new PropertyMacroContext(context1, "0L", propertyMacro_r2ji7m_c0a0c0a0b0e0c0e))));
        } finally {
        }
      ...
      }
      {
        ...
        try {
          SNodeAccessUtil.setProperty(tnode6, myProperties[1], TemplateUtil.asString(QueriesGenerated.propertyMacro_GetPropertyValue_6911370362349555653(new PropertyMacroContext(context1, "", propertyMacro_r2ji7m_c0a0c0a0b0f0c0e))));
        } finally {
        }
  ...
  private static SNodePointer switchMacroRef_r2ji7m_b0a0a0a1a3a2a4 = new SNodePointer("r:00000000-0000-4000-0000-011c89590303(jetbrains.mps.lang.smodel.generator.baseLanguage.template.main@generator)", "6911370362349555900");
  private static SNodePointer templateSwitchNode_r2ji7m_a0a0c0a1a1a3a2a4 = new SNodePointer("r:00000000-0000-4000-0000-011c89590303(jetbrains.mps.lang.smodel.generator.baseLanguage.template.main@generator)", "2944629966652298601");
  private static SNodePointer propertyMacro_r2ji7m_c0a0c0a0b0e0c0e = new SNodePointer("r:00000000-0000-4000-0000-011c89590303(jetbrains.mps.lang.smodel.generator.baseLanguage.template.main@generator)", "6911370362349555639");
  private static SNodePointer propertyMacro_r2ji7m_c0a0c0a0b0f0c0e = new SNodePointer("r:00000000-0000-4000-0000-011c89590303(jetbrains.mps.lang.smodel.generator.baseLanguage.template.main@generator)", "6911370362349555652");
}
