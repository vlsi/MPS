...
public class Template_reduce_Model_NodesOperation_old extends TemplateDeclarationBase {
  ...
  protected SNode applyPart0(@NotNull final TemplateContext context) throws GenerationException {
    ...
    try {
      ...
      TemplateContext context1 = context.subContext();
      {
        ...
        final SNode copySrcInput2 = QueriesGenerated.sourceNodeQuery_1171324405767(new SourceSubstituteMacroNodeContext(context1, copySrcMacro_68unms_b0a0c0d0c0e));
        tlist2 = environment.copyNodes(TemplateUtil.singletonList(copySrcInput2), copySrcMacro_68unms_b0a0c0d0c0e, "tpl/r:00000000-0000-4000-0000-011c89590303/1171324405765", context1);
      ...
      }
      {
        ...
        try {
          SNode callInputNode4 = QueriesGenerated.sourceNodeQuery_6246743999000739439(new SourceSubstituteMacroNodeContext(context1, includeMacro_68unms_b0a0a0a1a4a2a4));
  ...
  private static SNodePointer copySrcMacro_68unms_b0a0c0d0c0e = new SNodePointer("r:00000000-0000-4000-0000-011c89590303(jetbrains.mps.lang.smodel.generator.baseLanguage.template.main@generator)", "1171324405766");
  private static SNodePointer includeMacro_68unms_b0a0a0a1a4a2a4 = new SNodePointer("r:00000000-0000-4000-0000-011c89590303(jetbrains.mps.lang.smodel.generator.baseLanguage.template.main@generator)", "6246743999000739080");
}
