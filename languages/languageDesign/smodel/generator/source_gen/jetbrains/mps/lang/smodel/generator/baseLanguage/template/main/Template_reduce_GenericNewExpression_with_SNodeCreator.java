...
public class Template_reduce_GenericNewExpression_with_SNodeCreator extends TemplateDeclarationBase {
  ...
  protected SNode applyPart0(@NotNull final TemplateContext context) throws GenerationException {
    ...
    try {
      tnode1.setReference(myAssociationLinks[0], SReference.create(myAssociationLinks[0], tnode1, PersistenceFacade.getInstance().createModelReference("r:c3548bac-30eb-4a2a-937c-0111d5697309(jetbrains.mps.lang.smodel.generator.smodelAdapter)"), PersistenceFacade.getInstance().createNodeId("1917749888335174992")));
      tnode1.setReference(myAssociationLinks[1], SReference.create(myAssociationLinks[1], tnode1, PersistenceFacade.getInstance().createModelReference("r:c3548bac-30eb-4a2a-937c-0111d5697309(jetbrains.mps.lang.smodel.generator.smodelAdapter)"), PersistenceFacade.getInstance().createNodeId("6599163591527270726")));
      TemplateContext context1 = context.subContext();
      {
        Collection<SNode> tlist2 = null;
        try {
          SNode callInputNode2 = QueriesGenerated.sourceNodeQuery_5091528797226417731(new SourceSubstituteMacroNodeContext(context1, includeMacro_8mair_b0a0a0a1a3a2a6));
  ...
  private static SNodePointer includeMacro_8mair_b0a0a0a1a3a2a6 = new SNodePointer("r:00000000-0000-4000-0000-011c89590303(jetbrains.mps.lang.smodel.generator.baseLanguage.template.main@generator)", "5091528797226417730");
}
