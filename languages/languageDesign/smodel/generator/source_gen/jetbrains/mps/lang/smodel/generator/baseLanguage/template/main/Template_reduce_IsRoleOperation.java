...
public class Template_reduce_IsRoleOperation extends TemplateDeclarationBase {
  ...
  protected SNode applyPart0(@NotNull final TemplateContext context) throws GenerationException {
    ...
    try {
      ...
      TemplateContext context1 = context.subContext();
      {
        ...
        final SNode copySrcInput2 = QueriesGenerated.sourceNodeQuery_1170444043092(new SourceSubstituteMacroNodeContext(context1, copySrcMacro_kk1kyx_b0a0c0d0c0e));
        tlist2 = environment.copyNodes(TemplateUtil.singletonList(copySrcInput2), copySrcMacro_kk1kyx_b0a0c0d0c0e, "tpl/r:00000000-0000-4000-0000-011c89590303/1144196353857", context1);
      ...
      }
      {
        ...
        try {
          SNode callInputNode4 = QueriesGenerated.sourceNodeQuery_3902354333654295374(new SourceSubstituteMacroNodeContext(context1, includeMacro_kk1kyx_b0a0a0a1a4a2a4));
  ...
  private static SNodePointer copySrcMacro_kk1kyx_b0a0c0d0c0e = new SNodePointer("r:00000000-0000-4000-0000-011c89590303(jetbrains.mps.lang.smodel.generator.baseLanguage.template.main@generator)", "1144196353858");
  private static SNodePointer includeMacro_kk1kyx_b0a0a0a1a4a2a4 = new SNodePointer("r:00000000-0000-4000-0000-011c89590303(jetbrains.mps.lang.smodel.generator.baseLanguage.template.main@generator)", "3902354333654295104");
}
