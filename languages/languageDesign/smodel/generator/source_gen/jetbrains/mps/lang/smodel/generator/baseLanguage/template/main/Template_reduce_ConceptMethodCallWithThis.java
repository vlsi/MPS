...
@Generated
public class Template_reduce_ConceptMethodCallWithThis extends TemplateDeclarationBase {

  public Template_reduce_ConceptMethodCallWithThis() {
  }

  public SNodeReference getTemplateNode() {
    return new SNodePointer("r:00000000-0000-4000-0000-011c89590303(jetbrains.mps.lang.smodel.generator.baseLanguage.template.main@generator)", "3099391750892188134");
  }
  protected Collection<SNode> applyPart0(@NotNull final TemplateContext context) throws GenerationException {
    ...
    if (QueriesGenerated.ifMacro_Condition_3099391750892188156(new IfMacroContext(context, ifMacroRef_rcvm0b_b0a0c0e))) {
      ...
      Collection<SNode> tlist8 = new Template_reduce_invokeWithThis().apply(environment, context);
      tlist1 = tlist8;
    }
    return tlist1;
  }
  ...
  private static SNodePointer copySrcMacro_rcvm0b_b0a0c0c0b0b0b0c0e = new SNodePointer("r:00000000-0000-4000-0000-011c89590303(jetbrains.mps.lang.smodel.generator.baseLanguage.template.main@generator)", "3099391750892188145");
  private static SNodePointer ifMacroRef_rcvm0b_b0a0c0e = new SNodePointer("r:00000000-0000-4000-0000-011c89590303(jetbrains.mps.lang.smodel.generator.baseLanguage.template.main@generator)", "3099391750892188155");
}
