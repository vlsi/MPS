...
public class Template_reduce_Model_CreateNewRootNode extends TemplateDeclarationBase {
  ...
  protected SNode applyPart0(@NotNull final TemplateContext context) throws GenerationException {
    ...
    try {
      ...
      tnode1.setReference(myAssociationLinks[1], SReference.create(myAssociationLinks[1], tnode1, PersistenceFacade.getInstance().createModelReference("r:c3548bac-30eb-4a2a-937c-0111d5697309(jetbrains.mps.lang.smodel.generator.smodelAdapter)"), PersistenceFacade.getInstance().createNodeId("9116031298985583863")));
      TemplateContext context1 = context.subContext();
      {
        Collection<SNode> tlist2 = null;
        final SNode copySrcInput2 = QueriesGenerated.sourceNodeQuery_1169070779095(new SourceSubstituteMacroNodeContext(context1, copySrcMacro_vvu7kv_b0a0c0d0c0e));
        tlist2 = environment.copyNodes(TemplateUtil.singletonList(copySrcInput2), copySrcMacro_vvu7kv_b0a0c0d0c0e, "tpl/r:00000000-0000-4000-0000-011c89590303/1166648267352", context1);
      ...
      }
      {
        ...
        try {
          SNode callInputNode4 = QueriesGenerated.sourceNodeQuery_9116031298985646045(new SourceSubstituteMacroNodeContext(context1, includeMacro_vvu7kv_b0a0a0a1a4a2a4));
  ...
  private static SNodePointer copySrcMacro_vvu7kv_b0a0c0d0c0e = new SNodePointer("r:00000000-0000-4000-0000-011c89590303(jetbrains.mps.lang.smodel.generator.baseLanguage.template.main@generator)", "1166648267353");
  private static SNodePointer includeMacro_vvu7kv_b0a0a0a1a4a2a4 = new SNodePointer("r:00000000-0000-4000-0000-011c89590303(jetbrains.mps.lang.smodel.generator.baseLanguage.template.main@generator)", "9116031298985645706");
}
