...
@Generated
public class Template_reduce_GetPrevSiblingsOperation extends TemplateDeclarationBase {

  public Template_reduce_GetPrevSiblingsOperation() {
  }

  public SNodeReference getTemplateNode() {
    return new SNodePointer("r:00000000-0000-4000-0000-011c89590303(jetbrains.mps.lang.smodel.generator.baseLanguage.template.main@generator)", "1145573188503");
  }
  protected SNode applyPart0(@NotNull final TemplateContext context) throws GenerationException {
    ...
    try {
      ...
      tnode1.setReference(myAssociationLinks[1], SReference.create(myAssociationLinks[1], tnode1, PersistenceFacade.getInstance().createModelReference("r:c3548bac-30eb-4a2a-937c-0111d5697309(jetbrains.mps.lang.smodel.generator.smodelAdapter)"), PersistenceFacade.getInstance().createNodeId("6599163591527294180")));
      TemplateContext context1 = context.subContext();
      {
        Collection<SNode> tlist2 = null;
        final SNode copySrcInput2 = QueriesGenerated.sourceNodeQuery_1170442775025(new SourceSubstituteMacroNodeContext(context1, copySrcMacro_ha6uio_b0a0c0d0c0e));
        tlist2 = environment.copyNodes(TemplateUtil.singletonList(copySrcInput2), copySrcMacro_ha6uio_b0a0c0d0c0e, "tpl/r:00000000-0000-4000-0000-011c89590303/1145573188506", context1);
      ...
      }
      {
        ...
        try {
          SNodeAccessUtil.setProperty(tnode4, myProperties[0], TemplateUtil.asString(QueriesGenerated.propertyMacro_GetPropertyValue_1170442795984(new PropertyMacroContext(context1, null, propertyMacro_ha6uio_c0a0c0a0b0e0c0e))));
        } finally {
        }
  ...
  private static SNodePointer copySrcMacro_ha6uio_b0a0c0d0c0e = new SNodePointer("r:00000000-0000-4000-0000-011c89590303(jetbrains.mps.lang.smodel.generator.baseLanguage.template.main@generator)", "1145573188507");
  private static SNodePointer propertyMacro_ha6uio_c0a0c0a0b0e0c0e = new SNodePointer("r:00000000-0000-4000-0000-011c89590303(jetbrains.mps.lang.smodel.generator.baseLanguage.template.main@generator)", "1145573188509");
}
