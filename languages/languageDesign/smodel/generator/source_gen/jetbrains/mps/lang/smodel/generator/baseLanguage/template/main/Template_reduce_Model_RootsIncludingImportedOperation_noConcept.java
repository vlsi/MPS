...
@Generated
public class Template_reduce_Model_RootsIncludingImportedOperation_noConcept extends TemplateDeclarationBase {

  public Template_reduce_Model_RootsIncludingImportedOperation_noConcept() {
  }

  public SNodeReference getTemplateNode() {
    return new SNodePointer("r:00000000-0000-4000-0000-011c89590303(jetbrains.mps.lang.smodel.generator.baseLanguage.template.main@generator)", "1176109959275");
  }
  protected SNode applyPart0(@NotNull final TemplateContext context) throws GenerationException {
    final TemplateExecutionEnvironment environment = context.getEnvironment();
    final SNode tnode1 = environment.createOutputNode(myConcepts[0]);
    try {
      tnode1.setReference(myAssociationLinks[0], SReference.create(myAssociationLinks[0], tnode1, PersistenceFacade.getInstance().createModelReference("r:c3548bac-30eb-4a2a-937c-0111d5697309(jetbrains.mps.lang.smodel.generator.smodelAdapter)"), PersistenceFacade.getInstance().createNodeId("9116031298984721859")));
      ...
      TemplateContext context1 = context.subContext();
      {
        ...
        final SNode copySrcInput2 = QueriesGenerated.sourceNodeQuery_2702976628215407194(new SourceSubstituteMacroNodeContext(context1, copySrcMacro_c4ut5y_b0a0c0d0c0e));
        tlist2 = environment.copyNodes(TemplateUtil.singletonList(copySrcInput2), copySrcMacro_c4ut5y_b0a0c0d0c0e, "tpl/r:00000000-0000-4000-0000-011c89590303/2702976628215407192", context1);
  ...
  private static SNodePointer copySrcMacro_c4ut5y_b0a0c0d0c0e = new SNodePointer("r:00000000-0000-4000-0000-011c89590303(jetbrains.mps.lang.smodel.generator.baseLanguage.template.main@generator)", "2702976628215407193");
}
