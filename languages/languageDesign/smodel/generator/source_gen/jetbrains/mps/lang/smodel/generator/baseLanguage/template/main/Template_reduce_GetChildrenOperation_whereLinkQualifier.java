...
public class Template_reduce_GetChildrenOperation_whereLinkQualifier extends TemplateDeclarationBase {
  ...
  protected SNode applyPart0(@NotNull final TemplateContext context) throws GenerationException {
    ...
    try {
      ...
      tnode1.setReference(myAssociationLinks[1], SReference.create(myAssociationLinks[1], tnode1, PersistenceFacade.getInstance().createModelReference("r:c3548bac-30eb-4a2a-937c-0111d5697309(jetbrains.mps.lang.smodel.generator.smodelAdapter)"), PersistenceFacade.getInstance().createNodeId("6599163591527294042")));
      TemplateContext context1 = context.subContext();
      {
        Collection<SNode> tlist2 = null;
        final SNode copySrcInput2 = QueriesGenerated.sourceNodeQuery_6138621529960423807(new SourceSubstituteMacroNodeContext(context1, copySrcMacro_hixxyp_b0a0c0d0c0e));
      ...
      }
      {
        ...
        {
          final SNode switchInput4 = QueriesGenerated.sourceNodeQuery_3902354333653166075(new SourceSubstituteMacroNodeContext(context1, switchMacroRef_hixxyp_b0a0a0a1a4a2a4));
