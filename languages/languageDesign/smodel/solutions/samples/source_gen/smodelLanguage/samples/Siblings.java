...
public class Siblings {
  public void nextSibling(SNode statement) {
    ...
    SNode next3 = SNodeOperations.insertNewNextSiblingChild(statement, SNodeOperations.asInstanceConcept(MetaAdapterFactory.getConcept(new UUID(-935030926396207931l, -6610165693999523818l), 1068580123159l, "jetbrains.mps.baseLanguage.structure.IfStatement")));
