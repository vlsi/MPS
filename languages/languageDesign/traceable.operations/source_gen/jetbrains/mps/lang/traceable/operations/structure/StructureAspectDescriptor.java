...
public class StructureAspectDescriptor extends BaseStructureAspectDescriptor {
  ...
  /*package*/ final ConceptDescriptor myConceptNList_CopyWithTraceOperation = new ConceptDescriptorBuilder("jetbrains.mps.lang.traceable.operations.structure.NList_CopyWithTraceOperation", MetaIdFactory.conceptId(UUID.fromString("eba1dbb3-0bc4-4ce9-a184-05c9135353be"), 2603522263179374343L)).super_("jetbrains.mps.baseLanguage.structure.Expression").super_(MetaIdFactory.conceptId(UUID.fromString("f3061a53-9226-4cc5-a443-f952ceaf5816"), 1068431790191L)).parents("jetbrains.mps.baseLanguage.structure.Expression").parentIds(MetaIdFactory.conceptId(UUID.fromString("f3061a53-9226-4cc5-a443-f952ceaf5816"), 1068431790191L)).childDescriptors(new ConceptDescriptorBuilder.Link(2603522263179374348L, "argument", MetaIdFactory.conceptId(UUID.fromString("f3061a53-9226-4cc5-a443-f952ceaf5816"), 1068431790191L), false, false, false)).children(new String[]{"argument"}, new boolean[]{false}).alias("copy list with trace", "copies a list of nodes with trace").staticScope(StaticScope.NONE).create();
  /*package*/ final ConceptDescriptor myConceptNode_CopyWithTraceOperation = new ConceptDescriptorBuilder("jetbrains.mps.lang.traceable.operations.structure.Node_CopyWithTraceOperation", MetaIdFactory.conceptId(UUID.fromString("eba1dbb3-0bc4-4ce9-a184-05c9135353be"), 6942529559415680891L)).super_("jetbrains.mps.lang.smodel.structure.SNodeOperation").super_(MetaIdFactory.conceptId(UUID.fromString("7866978e-a0f0-4cc7-81bc-4d213d9375e1"), 1138411891628L)).parents("jetbrains.mps.lang.smodel.structure.SNodeOperation").parentIds(MetaIdFactory.conceptId(UUID.fromString("7866978e-a0f0-4cc7-81bc-4d213d9375e1"), 1138411891628L)).alias("copy with trace", "copy a node with trace").staticScope(StaticScope.NONE).create();
