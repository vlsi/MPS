...
public class MigrationScriptBody_Behavior {
  ...
  public static List<SNode> virtual_getParameters_1213877374450(SNode thisNode) {
    ...
    if (MigrationScript_Behavior.call_hasData_586712031920013598(SNodeOperations.as(SNodeOperations.getParent(thisNode), "jetbrains.mps.lang.migration.structure.MigrationScript"))) {
      ListSequence.fromList(result).addElement(SConceptOperations.findConceptDeclaration("jetbrains.mps.lang.migration.structure.ConceptFunctionParameter_MigrationScriptData"));
    }
    return result;
  }
}
