...
public class QueriesGenerated {
  ...
  public static Object referenceMacro_GetReferent_19209059688187330(final ReferenceMacroContext _context) {
    return MigrationScript_Behavior.call_getProducedData_8585153554445933384(_context.getNode());
  }
  public static Object referenceMacro_GetReferent_19209059688185119(final ReferenceMacroContext _context) {
    return MigrationScript_Behavior.call_getProducedData_8585153554445933384(_context.getNode());
  }
  ...
  public static SNode sourceNodeQuery_3290421837437864010(final SourceSubstituteMacroNodeContext _context) {
    return SLinkOperations.getTarget(Sequence.fromIterable(SNodeOperations.ofConcept(SLinkOperations.getTargets(_context.getNode(), "member", true), "jetbrains.mps.lang.classLike.structure.ClassLikeMethod")).findFirst(new IWhereFilter<SNode>() {
      public boolean accept(SNode it) {
        return SLinkOperations.getTarget(it, "decl", false) == SNodeOperations.getNode("90746344-04fd-4286-97d5-b46ae6a81709/r:52a3d974-bd4f-4651-ba6e-a2de5e336d95(jetbrains.mps.lang.migration/jetbrains.mps.lang.migration.methods)", "5155329496662709038");
      }
    }), "body", true);
  }
