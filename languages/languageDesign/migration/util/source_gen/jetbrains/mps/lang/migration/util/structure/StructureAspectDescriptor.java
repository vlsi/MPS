...
public class StructureAspectDescriptor extends BaseStructureAspectDescriptor {
  ...
  /*package*/ final ConceptDescriptor myConceptMoveConceptMemberUp = new ConceptDescriptorBuilder("jetbrains.mps.lang.migration.util.structure.MoveConceptMemberUp", MetaIdFactory.conceptId(0x9882f4ad195546feL, 0x826994189e5dbbf2L, 0x2b3f57492c1741b8L)).super_("jetbrains.mps.lang.migration.util.structure.MoveNodeSpecialization").super_(MetaIdFactory.conceptId(0x9882f4ad195546feL, 0x826994189e5dbbf2L, 0x2b3f57492c165c5dL)).parents("jetbrains.mps.lang.migration.util.structure.MoveNodeSpecialization").parentIds(MetaIdFactory.conceptId(0x9882f4ad195546feL, 0x826994189e5dbbf2L, 0x2b3f57492c165c5dL)).create();
  /*package*/ final ConceptDescriptor myConceptMoveContainmentLinkUp = new ConceptDescriptorBuilder("jetbrains.mps.lang.migration.util.structure.MoveContainmentLinkUp", MetaIdFactory.conceptId(0x9882f4ad195546feL, 0x826994189e5dbbf2L, 0x2b3f57492c1741baL)).super_("jetbrains.mps.lang.migration.util.structure.MoveConceptMemberUp").super_(MetaIdFactory.conceptId(0x9882f4ad195546feL, 0x826994189e5dbbf2L, 0x2b3f57492c1741b8L)).parents("jetbrains.mps.lang.migration.util.structure.MoveConceptMemberUp").parentIds(MetaIdFactory.conceptId(0x9882f4ad195546feL, 0x826994189e5dbbf2L, 0x2b3f57492c1741b8L)).create();
  ...
  /*package*/ final ConceptDescriptor myConceptMovePropertyUp = new ConceptDescriptorBuilder("jetbrains.mps.lang.migration.util.structure.MovePropertyUp", MetaIdFactory.conceptId(0x9882f4ad195546feL, 0x826994189e5dbbf2L, 0x2b3f57492c1741b9L)).super_("jetbrains.mps.lang.migration.util.structure.MoveConceptMemberUp").super_(MetaIdFactory.conceptId(0x9882f4ad195546feL, 0x826994189e5dbbf2L, 0x2b3f57492c1741b8L)).parents("jetbrains.mps.lang.migration.util.structure.MoveConceptMemberUp").parentIds(MetaIdFactory.conceptId(0x9882f4ad195546feL, 0x826994189e5dbbf2L, 0x2b3f57492c1741b8L)).create();
  /*package*/ final ConceptDescriptor myConceptMoveReferenceLinkUp = new ConceptDescriptorBuilder("jetbrains.mps.lang.migration.util.structure.MoveReferenceLinkUp", MetaIdFactory.conceptId(0x9882f4ad195546feL, 0x826994189e5dbbf2L, 0x2b3f57492c1741b7L)).super_("jetbrains.mps.lang.migration.util.structure.MoveConceptMemberUp").super_(MetaIdFactory.conceptId(0x9882f4ad195546feL, 0x826994189e5dbbf2L, 0x2b3f57492c1741b8L)).parents("jetbrains.mps.lang.migration.util.structure.MoveConceptMemberUp").parentIds(MetaIdFactory.conceptId(0x9882f4ad195546feL, 0x826994189e5dbbf2L, 0x2b3f57492c1741b8L)).create();
  ...
  public Collection<ConceptDescriptor> getDescriptors() {
    return Arrays.asList(myConceptAbstractNodeReference, myConceptDirectNodeReference, myConceptMigrationScriptReference, myConceptMoveConcept, myConceptMoveConceptMemberUp, myConceptMoveContainmentLinkUp, myConceptMoveNode, myConceptMoveNodeSpecialization, myConceptMovePropertyUp, myConceptMoveReferenceLinkUp, myConceptRefactoringStep, myConceptRefactoringStepItem, myConceptReflectionNodeReference, myConceptStepData, myConceptStringData);
  }
  ...
  public ConceptDescriptor getDescriptor(String conceptFqName) {
    switch (Arrays.binarySearch(stringSwitchCases_1htk8d_a0a0t, conceptFqName)) {
      ...
      case 4:
        return myConceptMoveConceptMemberUp;
      case 5:
        return myConceptMoveContainmentLinkUp;
      case 6:
        return myConceptMoveNode;
      case 7:
        return myConceptMoveNodeSpecialization;
      case 8:
        return myConceptMovePropertyUp;
      case 9:
        return myConceptMoveReferenceLinkUp;
      case 10:
  ...
  private static String[] stringSwitchCases_1htk8d_a0a0t = new String[]{"jetbrains.mps.lang.migration.util.structure.AbstractNodeReference", "jetbrains.mps.lang.migration.util.structure.DirectNodeReference", "jetbrains.mps.lang.migration.util.structure.MigrationScriptReference", "jetbrains.mps.lang.migration.util.structure.MoveConcept", "jetbrains.mps.lang.migration.util.structure.MoveConceptMemberUp", "jetbrains.mps.lang.migration.util.structure.MoveContainmentLinkUp", "jetbrains.mps.lang.migration.util.structure.MoveNode", "jetbrains.mps.lang.migration.util.structure.MoveNodeSpecialization", "jetbrains.mps.lang.migration.util.structure.MovePropertyUp", "jetbrains.mps.lang.migration.util.structure.MoveReferenceLinkUp", "jetbrains.mps.lang.migration.util.structure.RefactoringStep", "jetbrains.mps.lang.migration.util.structure.RefactoringStepItem", "jetbrains.mps.lang.migration.util.structure.ReflectionNodeReference", "jetbrains.mps.lang.migration.util.structure.StepData", "jetbrains.mps.lang.migration.util.structure.StringData"};
}
