...
public class AdditionalStructurePropertiesImpl extends BaseAdditionalStructureProperties {
  private final AdditionalConceptProperties props_StepData = new ConceptPropsBuilder().create();
  private final AdditionalConceptProperties props_StringData = new ConceptPropsBuilder().create();
  ...
  private static final Map<SAbstractConcept, Integer> indices_4qogsf_a0d = buildConceptIndices(MetaAdapterFactory.getConcept(0x9882f4ad195546feL, 0x826994189e5dbbf2L, 0x66eed171c5f82709L, "StepData"), MetaAdapterFactory.getConcept(0x9882f4ad195546feL, 0x826994189e5dbbf2L, 0x2c90e78b233c3efeL, "StringData"));
}
