...
public class EditorAspectDescriptorImpl implements EditorAspectDescriptor {
  private Collection<ConceptEditorHint> myHints;

  {
    myHints = Arrays.<ConceptEditorHint>asList(new ConceptEditorHintImpl("rich", "Use colourful presentation of child nodes"), new ConceptEditorHintImpl("compact", "Use compact presentation of child nodes"), new ConceptEditorHintImpl("unsupported", "Use presentation which is not supported in testLanguage"), new ConceptEditorHintImpl("haha", "haha"));
  }
