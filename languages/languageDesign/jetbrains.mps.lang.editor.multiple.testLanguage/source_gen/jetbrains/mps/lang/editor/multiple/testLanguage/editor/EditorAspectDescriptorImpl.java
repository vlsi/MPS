...
public class EditorAspectDescriptorImpl implements EditorAspectDescriptor {
  ...
  {
    myHints = Arrays.asList(new EditorContextHint("rich", "Use colourful presentation of child nodes"), new EditorContextHint("compact", "Use compact presentation of child nodes"), new EditorContextHint("unsupported", "Use presentation which is not supported in testLanguage"), new EditorContextHint("haha", "haha"));
  }
