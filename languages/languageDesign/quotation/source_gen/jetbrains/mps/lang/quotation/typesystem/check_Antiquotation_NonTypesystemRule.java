    ...
    SNode annotatedNode = SNodeOperations.getParent(antiquotation);
    {
      SNode matchedNode_6y0fd_b0 = SNodeOperations.getParent(annotatedNode);
      {
        ...
        if (matches_6y0fd_a1a) {
          if (SLinkOperations.getTarget(matchedNode_6y0fd_b0, MetaAdapterFactory.getContainmentLink(new UUID(4184707567256882268l, -4914423608129972907l), 1196350785113l, 1196350785114l, "quotedNode")) == annotatedNode) {
            {
