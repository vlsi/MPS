...
/*package*/ class NodeBuilderRef_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createRefCell_xqbs61_a0() {
    CellProviderWithRole provider = new RefCellCellProvider(myNode, getEditorContext()) {
      ...
      protected InlineCellProvider createInlineCellProvider(SNode innerCellNode) {
        return new NodeBuilderRef_EditorBuilder_a._Inline_xqbs61_a0a(innerCellNode, myNode);
      }
    };
  ...
  public static class _Inline_xqbs61_a0a extends InlineCellProvider {
    public _Inline_xqbs61_a0a(SNode node, SNode refNode) {
      super(node, refNode);
    }
    ...
    public EditorCell createEditorCell(EditorContext editorContext, SNode node) {
      ...
      return new NodeBuilderRef_EditorBuilder_a.Inline_Builder_xqbs61_a0a(editorContext, getRefNode(), node).createCell();
    }
  }
