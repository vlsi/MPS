      ...
      SNode matchedNode_5jb8fe_b0 = SNodeOperations.getParent(annotatedNode);
      {
        boolean matches_5jb8fe_a1a = false;
        {
          ...
          if (matchingNode_5jb8fe_a1a != null) {
            matches_5jb8fe_a1a = SModelUtil_new.isAssignableConcept(matchingNode_5jb8fe_a1a.getConcept().getConceptId(), "jetbrains.mps.lang.quotation.structure.Quotation");
          }
        }
