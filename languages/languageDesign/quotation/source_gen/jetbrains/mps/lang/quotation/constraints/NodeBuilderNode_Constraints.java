...
public class NodeBuilderNode_Constraints extends BaseConstraintsDescriptor {
  ...
  private static SNodePointer breakingNode_ij2gcp_a0a0a0a0a1a0b0a1a2 = new SNodePointer("r:abd7937b-2ad1-4cfc-8256-a7fa45a55f0f(jetbrains.mps.lang.quotation.constraints)", "8182547171709535913");
      ...
      public ReferenceScopeProvider getScopeProvider() {
        return new BaseScopeProvider() {
          ...
          public SNodePointer getSearchScopeValidatorNode() {
            return breakingNode_ij2gcp_a0a0a0a0a1a0b0a1a2;
          }
          ...
          public Scope createScope(final IOperationContext operationContext, final ReferenceConstraintsContext _context) {
            {
              ...
              if (SNodeOperations.isInstanceOf(n, "jetbrains.mps.lang.quotation.structure.NodeBuilderInitLink")) {
                ...
                for (String cname : SetSequence.fromSet(LanguageHierarchyCache.getInstance().getAllDescendantsOfConcept(INamedConcept_Behavior.call_getFqName_1213877404258(target)))) {
