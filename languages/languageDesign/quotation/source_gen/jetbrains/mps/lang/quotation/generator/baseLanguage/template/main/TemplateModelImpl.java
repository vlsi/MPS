...
public class TemplateModelImpl implements TemplateModel {
  ...
  private static SModelReference modelRef_wo91o7_a0a5 = new SModelReference(new SModelFqName("jetbrains.mps.lang.quotation.generator.baseLanguage.template.main", "generator"), jetbrains.mps.smodel.SModelId.regular(new UUID(16384L, 1222075024204L)));
}
