...
public class PropertyAntiquotation_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createConstant_dqkua3_a0(EditorContext editorContext, SNode node) {
    ...
    style.set(StyleAttributes.TEXT_COLOR, 0, StyleRegistry.getInstance().getSimpleColor(PropertyAntiquotation_Editor._StyleParameter_QueryFunction_dqkua3_a0a0(editorContext, node)));
  ...
  private EditorCell createProperty_dqkua3_b0(EditorContext editorContext, SNode node) {
    ...
    Style style = new StyleImpl();
    style.set(StyleAttributes.TEXT_COLOR, 0, StyleRegistry.getInstance().getSimpleColor(PropertyAntiquotation_Editor._StyleParameter_QueryFunction_dqkua3_a0b0(editorContext, node)));
    editorCell.getStyle().putAll(style);
  ...
  private EditorCell createConstant_dqkua3_d0(EditorContext editorContext, SNode node) {
    ...
    Style style = new StyleImpl();
    style.set(StyleAttributes.TEXT_COLOR, 0, StyleRegistry.getInstance().getSimpleColor(PropertyAntiquotation_Editor._StyleParameter_QueryFunction_dqkua3_a0d0(editorContext, node)));
    editorCell.getStyle().putAll(style);
    editorCell.setDefaultText("");
    return editorCell;
  }
