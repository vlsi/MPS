    ...
    for (String property : propertyNames) {
      ...
      if (attribute != null) {
        ...
        SLinkOperations.setTarget(pval, "expression", (DataTypeDeclaration_Behavior.call_isSimpleBoolean_1220268891062(dataType) ?
          _quotation_createNode_aytayy_a0a1a0d0l0d(Boolean.toString(quotationNode.getBooleanProperty(property))) :
          (DataTypeDeclaration_Behavior.call_isSimpleInteger_1220268868375(dataType) ?
            _quotation_createNode_aytayy_a0a0b0a3a11a3(Integer.toString(quotationNode.getIntegerProperty(property))) :
