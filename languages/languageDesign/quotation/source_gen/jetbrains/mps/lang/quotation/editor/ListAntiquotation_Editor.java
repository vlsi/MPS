...
public class ListAntiquotation_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createConstant_yxrtdc_a0(EditorContext editorContext, SNode node) {
    ...
    style.set(StyleAttributes.TEXT_COLOR, 0, StyleRegistry.getInstance().getSimpleColor(ListAntiquotation_Editor._StyleParameter_QueryFunction_yxrtdc_a0a0(editorContext, node)));
  ...
  private EditorCell createProperty_yxrtdc_b0(EditorContext editorContext, SNode node) {
    ...
    Style style = new StyleImpl();
    style.set(StyleAttributes.TEXT_COLOR, 0, StyleRegistry.getInstance().getSimpleColor(ListAntiquotation_Editor._StyleParameter_QueryFunction_yxrtdc_a0b0(editorContext, node)));
    editorCell.getStyle().putAll(style);
  ...
  private EditorCell createConstant_yxrtdc_d0(EditorContext editorContext, SNode node) {
    ...
    Style style = new StyleImpl();
    style.set(StyleAttributes.TEXT_COLOR, 0, StyleRegistry.getInstance().getSimpleColor(ListAntiquotation_Editor._StyleParameter_QueryFunction_yxrtdc_a0d0(editorContext, node)));
    editorCell.getStyle().putAll(style);
    editorCell.setDefaultText("");
    return editorCell;
  }
