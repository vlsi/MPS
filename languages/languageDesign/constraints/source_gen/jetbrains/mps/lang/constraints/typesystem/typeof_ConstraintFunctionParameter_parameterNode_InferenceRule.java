...
public class typeof_ConstraintFunctionParameter_parameterNode_InferenceRule extends AbstractInferenceRule_Runtime implements InferenceRule_Runtime {
  ...
  public void applyRule(final SNode node, final TypeCheckingContext typeCheckingContext, IsApplicableStatus status) {
    if ((SNodeOperations.getAncestor(node, "jetbrains.mps.lang.constraints.structure.NodeReferentConstraint", false, false) != null)) {
      SNode constraint = SNodeOperations.getAncestor(node, "jetbrains.mps.lang.constraints.structure.NodeReferentConstraint", false, false);
      {
        ...
        typeCheckingContext.createEquation((SNode) typeCheckingContext.typeOf(_nodeToCheck_1029348928467, "r:00000000-0000-4000-0000-011c89590309(jetbrains.mps.lang.constraints.typesystem)", "6768994795311836919", true), (SNode) _quotation_createNode_10ia44_a0b0a0a(SLinkOperations.getTarget(SLinkOperations.getTarget(constraint, "applicableLink", false), "target", false)), _info_12389875345);
      }
      ...
      SNode defaultScope = SNodeOperations.getAncestor(node, "jetbrains.mps.lang.constraints.structure.NodeDefaultSearchScope", false, false);
      {
        ...
        typeCheckingContext.createEquation((SNode) typeCheckingContext.typeOf(_nodeToCheck_1029348928467, "r:00000000-0000-4000-0000-011c89590309(jetbrains.mps.lang.constraints.typesystem)", "6768994795311836987", true), (SNode) _quotation_createNode_10ia44_a0b0a0a0(NodeDefaultSearchScope_Behavior.call_getReferentConcept_1213877261403(defaultScope)), _info_12389875345);
      }
    } else {
      {
        SNode _nodeToCheck_1029348928467 = node;
        ...
        typeCheckingContext.createEquation((SNode) typeCheckingContext.typeOf(_nodeToCheck_1029348928467, "r:00000000-0000-4000-0000-011c89590309(jetbrains.mps.lang.constraints.typesystem)", "6768994795311837013", true), (SNode) _quotation_createNode_10ia44_a0a0a0a0(), _info_12389875345);
      }
    }
  }
  ...
  private static SNode _quotation_createNode_10ia44_a0b0a0a(Object parameter_1) {
  ...
  private static SNode _quotation_createNode_10ia44_a0b0a0a0(Object parameter_1) {
    SNode quotedNode_2 = null;
    quotedNode_2 = SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.lang.smodel.structure.SNodeType", null, null, GlobalScope.getInstance(), false);
    quotedNode_2.setReferenceTarget("concept", (SNode) parameter_1);
    return quotedNode_2;
  ...
  private static SNode _quotation_createNode_10ia44_a0a0a0a0() {
