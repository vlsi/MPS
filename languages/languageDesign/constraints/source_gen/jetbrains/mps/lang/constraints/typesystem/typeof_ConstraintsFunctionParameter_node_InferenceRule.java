...
public class typeof_ConstraintsFunctionParameter_node_InferenceRule extends AbstractInferenceRule_Runtime implements InferenceRule_Runtime {
    ...
    if ((applicableConcept == null)) {
      {
        ...
        typeCheckingContext.createEquation((SNode) typeCheckingContext.typeOf(_nodeToCheck_1029348928467, "r:00000000-0000-4000-0000-011c89590309(jetbrains.mps.lang.constraints.typesystem)", "1212093388354", true), (SNode) _quotation_createNode_5j2flj_a0a0c0a(), _info_12389875345);
      }
    } else {
      {
        SNode _nodeToCheck_1029348928467 = node;
        ...
        typeCheckingContext.createEquation((SNode) typeCheckingContext.typeOf(_nodeToCheck_1029348928467, "r:00000000-0000-4000-0000-011c89590309(jetbrains.mps.lang.constraints.typesystem)", "1212093393092", true), (SNode) _quotation_createNode_5j2flj_a0a0a2a0(applicableConcept), _info_12389875345);
      }
    }
  }
  ...
  private static SNode _quotation_createNode_5j2flj_a0a0c0a() {
  ...
  private static SNode _quotation_createNode_5j2flj_a0a0a2a0(Object parameter_1) {
