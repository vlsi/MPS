...
public class AdditionalStructurePropertiesImpl extends BaseAdditionalStructureProperties {
  private final AdditionalConceptProperties props_ImageGenerator = new ConceptPropsBuilder().icon("imageGenerator.png", AdditionalStructurePropertiesImpl.class).create();
