...
public class AdditionalStructurePropertiesImpl extends BaseAdditionalStructureProperties {
  private final AdditionalConceptProperties props_ConceptBehavior = new ConceptPropsBuilder().icon("behavior.png", AdditionalStructurePropertiesImpl.class).create();
  private final AdditionalConceptProperties props_ConceptConstructorDeclaration = new ConceptPropsBuilder().create();
  private final AdditionalConceptProperties props_ConceptMethodDeclaration = new ConceptPropsBuilder().deprecated(MetaAdapterFactory.getProperty(0xaf65afd8f0dd4942L, 0x87d963a55f2a9db1L, 0x11d4348057eL, 0x11d43480580L, "isVirtual"), MetaAdapterFactory.getProperty(0xaf65afd8f0dd4942L, 0x87d963a55f2a9db1L, 0x11d4348057eL, 0x11d43480581L, "isPrivate"), MetaAdapterFactory.getProperty(0xaf65afd8f0dd4942L, 0x87d963a55f2a9db1L, 0x11d4348057eL, 0x11d43480582L, "isAbstract"), MetaAdapterFactory.getProperty(0xaf65afd8f0dd4942L, 0x87d963a55f2a9db1L, 0x11d4348057eL, 0x51613f7fe129b24dL, "isStatic"), MetaAdapterFactory.getReferenceLink(0xaf65afd8f0dd4942L, 0x87d963a55f2a9db1L, 0x11d4348057eL, 0x11d4348057fL, "overriddenMethod")).create();
  private final AdditionalConceptProperties props_InternalConceptDeclarationReference = new ConceptPropsBuilder().deprecated().create();
  private final AdditionalConceptProperties props_InternalConceptDeclarationsHolder = new ConceptPropsBuilder().deprecated().create();
  private final AdditionalConceptProperties props_LocalBehaviorMethodCall = new ConceptPropsBuilder().create();
  private final AdditionalConceptProperties props_SuperNodeExpression = new ConceptPropsBuilder().create();
  private final AdditionalConceptProperties props_ThisNodeExpression = new ConceptPropsBuilder().create();
