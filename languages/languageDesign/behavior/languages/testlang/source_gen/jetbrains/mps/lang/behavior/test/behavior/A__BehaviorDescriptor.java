...
public final class A__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<String> nonVirtualMethod_id46FlynTbAz8 = new SMethodBuilder<String>(new SJavaCompoundTypeImpl(String.class)).name("nonVirtualMethod").modifiers(SModifiersImpl.create(0, AccessPrivileges.PUBLIC)).concept(CONCEPT).id("46FlynTbAz8").registry(REGISTRY).build(SParameterImpl.fromList(SJavaCompoundTypeImpl.fromClasses(String.class, Integer.TYPE)));
  ...
  public static final SMethod<String> finalVirtualMethod_id46FlynTbB7_ = new SMethodBuilder<String>(new SJavaCompoundTypeImpl(String.class)).name("finalVirtualMethod").modifiers(SModifiersImpl.create(10, AccessPrivileges.PUBLIC)).concept(CONCEPT).id("46FlynTbB7_").registry(REGISTRY).build(SParameterImpl.fromList(SJavaCompoundTypeImpl.fromClasses(String.class, Integer.TYPE)));
  public static final SMethod<String> staticMethod_id46FlynTbAAs = new SMethodBuilder<String>(new SJavaCompoundTypeImpl(String.class)).name("staticMethod").modifiers(SModifiersImpl.create(1, AccessPrivileges.PUBLIC)).concept(CONCEPT).id("46FlynTbAAs").registry(REGISTRY).build(SParameterImpl.fromList(SJavaCompoundTypeImpl.fromClasses(String.class, Integer.TYPE)));
  ...
  public static final SMethod<Void> doInvokeAll_id46FlynTbBkw = new SMethodBuilder<Void>(new SJavaCompoundTypeImpl(Void.class)).name("doInvokeAll").modifiers(SModifiersImpl.create(0, AccessPrivileges.PUBLIC)).concept(CONCEPT).id("46FlynTbBkw").registry(REGISTRY).build(SParameterImpl.fromList(SJavaCompoundTypeImpl.fromClasses()));
  ...
  private static String nonVirtualMethod_id46FlynTbAz8(@NotNull SNode __thisNode__, String in, int dummy) {
    return "A";
  }
  private static String virtualMethod_id46FlynTbAzL(@NotNull SNode __thisNode__, String in, int dummy) {
    return "A";
  }
  private static String finalVirtualMethod_id46FlynTbB7_(@NotNull SNode __thisNode__, String in, int dummy) {
    return in;
  }
  private static String staticMethod_id46FlynTbAAs(@NotNull SAbstractConcept __thisConcept__, String in, int dummy) {
    return in;
  }
  ...
  protected <T> T invokeSpecial0(@NotNull SNode node, @NotNull SMethod<T> method, @NotNull Object[] parameters) {
    ...
    switch (methodIndex) {
      case 0:
        return (T) nonVirtualMethod_id46FlynTbAz8(node, (String) parameters[0], (Integer) parameters[1]);
      case 1:
        return (T) virtualMethod_id46FlynTbAzL(node, (String) parameters[0], (Integer) parameters[1]);
      case 2:
        return (T) finalVirtualMethod_id46FlynTbB7_(node, (String) parameters[0], (Integer) parameters[1]);
      case 5:
  ...
  protected <T> T invokeSpecial0(@NotNull SAbstractConcept concept, @NotNull SMethod<T> method, @NotNull Object[] parameters) {
    ...
    switch (methodIndex) {
      case 3:
        return (T) staticMethod_id46FlynTbAAs(concept, (String) parameters[0], (Integer) parameters[1]);
      case 4:
