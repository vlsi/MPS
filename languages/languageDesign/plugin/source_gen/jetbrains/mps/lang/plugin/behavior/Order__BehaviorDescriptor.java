...
public final class Order__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<String> getGeneratedClassName_id2CFL3ni7zCY = new SMethodBuilder<String>(new SJavaCompoundTypeImpl(String.class)).name("getGeneratedClassName").modifiers(SModifiersImpl.create(0, AccessPrivileges.PUBLIC)).concept(CONCEPT).id("2CFL3ni7zCY").registry(REGISTRY).build(SParameterImpl.fromList(SJavaCompoundTypeImpl.fromClasses()));
  ...
  private static String getGeneratedClassName_id2CFL3ni7zCY(@NotNull SNode __thisNode__) {
    String n;
  ...
  private static Boolean presents_id1jgMklchcXk(@NotNull SNode __thisNode__, final SNode tab) {
    return ListSequence.fromList(SLinkOperations.getChildren(__thisNode__, MetaAdapterFactory.getContainmentLink(0x28f9e4973b424291L, 0xaeba0a1039153ab1L, 0x22035699bdd78147L, 0x22035699bdd78149L, "tab"))).where(new IWhereFilter<SNode>() {
  ...
  protected <T> T invokeSpecial0(@NotNull SNode node, @NotNull SMethod<T> method, @NotNull Object[] parameters) {
    ...
    switch (methodIndex) {
      case 0:
        return (T) getGeneratedClassName_id2CFL3ni7zCY(node);
      case 1:
