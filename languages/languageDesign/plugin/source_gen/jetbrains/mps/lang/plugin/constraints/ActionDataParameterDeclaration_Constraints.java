...
public class ActionDataParameterDeclaration_Constraints extends BaseConstraintsDescriptor {
  public ActionDataParameterDeclaration_Constraints() {
    super(MetaIdFactory.conceptId(new UUID(2952642368903463569l, -5856357300648461647l), 1217252042208l));
  }
  @Override
  protected Map<SReferenceLinkId, ReferenceConstraintsDescriptor> getNotDefaultSReferenceLinks() {
    Map<SReferenceLinkId, ReferenceConstraintsDescriptor> references = new HashMap<SReferenceLinkId, ReferenceConstraintsDescriptor>();
    references.put(MetaIdFactory.refId(new UUID(2952642368903463569l, -5856357300648461647l), 1217252042208l, 1217252646389l), new BaseReferenceConstraintsDescriptor(MetaIdFactory.refId(new UUID(2952642368903463569l, -5856357300648461647l), 1217252042208l, 1217252646389l), this) {
      @Override
      ...
      public ReferenceScopeProvider getScopeProvider() {
        return new BaseReferenceScopeProvider() {
          ...
          public Object createSearchScopeOrListOfNodes(final IOperationContext operationContext, final ReferenceConstraintsContext _context) {
            ...
            ListSequence.fromList(dataKeys).addSequence(Sequence.fromIterable(Classifier_Behavior.call_staticFields_5292274854859223538(SNodeOperations.cast(SLinkOperations.getTarget(_quotation_createNode_lb7xg4_a0a0a0d0a0(), MetaAdapterFactory.getReferenceLink(new UUID(-935030926396207931l, -6610165693999523818l), 1107535904670l, 1107535924139l, "classifier")), MetaAdapterFactory.getConcept(new UUID(-935030926396207931l, -6610165693999523818l), 1068390468198l, "jetbrains.mps.baseLanguage.structure.ClassConcept")))));
            ...
            for (SModel importedModel : SModelOperations.allImportedModels(_context.getModel())) {
              if (jetbrains.mps.util.SNodeOperations.getModelLongName(importedModel).equals("jetbrains.mps.workbench")) {
                for (SNode root : importedModel.getRootNodes()) {
                  if (SNodeOperations.isInstanceOf(root, MetaAdapterFactory.getConcept(new UUID(-935030926396207931l, -6610165693999523818l), 1068390468198l, "jetbrains.mps.baseLanguage.structure.ClassConcept")) && "MPSDataKeys".equals(SPropertyOperations.getString(SNodeOperations.cast(root, MetaAdapterFactory.getConcept(new UUID(-935030926396207931l, -6610165693999523818l), 1068390468198l, "jetbrains.mps.baseLanguage.structure.ClassConcept")), MetaAdapterFactory.getProperty(new UUID(-3554657779850784990l, -7236703803128771572l), 1169194658468l, 1169194664001l, "name")))) {
                    ListSequence.fromList(dataKeys).addSequence(Sequence.fromIterable(Classifier_Behavior.call_staticFields_5292274854859223538(SNodeOperations.cast(root, MetaAdapterFactory.getConcept(new UUID(-935030926396207931l, -6610165693999523818l), 1068390468198l, "jetbrains.mps.baseLanguage.structure.ClassConcept")))));
                  }
                }
