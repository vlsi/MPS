            ...
            for (SModel importedModel : SModelOperations.allImportedModels(_context.getModel())) {
              if (jetbrains.mps.util.SNodeOperations.getModelLongName(importedModel).equals("jetbrains.mps.workbench")) {
                for (SNode root : importedModel.getRootNodes()) {
                  if (SNodeOperations.isInstanceOf(root, "jetbrains.mps.baseLanguage.structure.ClassConcept") && "MPSDataKeys".equals(SPropertyOperations.getString(SNodeOperations.cast(root, "jetbrains.mps.baseLanguage.structure.ClassConcept"), MetaAdapterFactory.getProperty(new UUID(-3554657779850784990l, -7236703803128771572l), 1169194658468l, 1169194664001l, "name")))) {
