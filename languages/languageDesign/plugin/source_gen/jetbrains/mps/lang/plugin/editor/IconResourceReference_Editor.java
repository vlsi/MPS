...
public class IconResourceReference_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createCollection_yu3d6c_a(EditorContext editorContext, SNode node) {
    ...
    editorCell.addEditorCell(this.createConceptProperty_yu3d6c_a0(editorContext, node));
  ...
  private EditorCell createConceptProperty_yu3d6c_a0(EditorContext editorContext, SNode node) {
