...
public class InterfaceGroup_Editor extends DefaultNodeEditor {
  ...
  private class contentsSingleRoleHandler_ttb7ur_b0 extends SingleRoleCellProvider {
    ...
    protected EditorCell createChildCell(SNode child) {
      myEditorContext.getCellFactory().pushCellContext();
      myEditorContext.getCellFactory().setNodeLocation(new SNodeLocation.FromNode(child, MetaAdapterFactory.getConcept(0x28f9e4973b424291L, 0xaeba0a1039153ab1L, 0x1190f756bc5L, "jetbrains.mps.lang.plugin.structure.ElementListContents")));
      try {
        EditorCell editorCell = super.createChildCell(child);
