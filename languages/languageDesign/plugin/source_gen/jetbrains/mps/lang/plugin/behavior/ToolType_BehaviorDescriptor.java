...
public final class ToolType_BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0x28f9e4973b424291L, 0xaeba0a1039153ab1L, 0x11961ebbf24L, "jetbrains.mps.lang.plugin.structure.ToolType");
  ...
  private static List<SNode> getMembers_idhEwINC$(@NotNull SNode __thisNode__, SNode contextNode) {
    return IClassifier_BehaviorDescriptor.getMembers_idhEwJioW.invoke(SLinkOperations.getTarget(__thisNode__, MetaAdapterFactory.getReferenceLink(0x28f9e4973b424291L, 0xaeba0a1039153ab1L, 0x11961ebbf24L, 0x11961f94babL, "tool")));
  }
  private static SNode getClassExpression_idhEwIzOd(@NotNull SNode __thisNode__) {
    return null;
  }

  /*package*/ ToolType_BehaviorDescriptor() {
    super(REGISTRY);
  }
