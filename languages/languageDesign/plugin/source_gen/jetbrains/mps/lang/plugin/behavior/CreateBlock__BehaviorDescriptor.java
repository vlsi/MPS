...
public final class CreateBlock__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  /*package*/ static List<SConcept> getParameterConcepts_id2xELmDxyi2v(@NotNull SNode __thisNode__) {
    ...
    ListSequence.fromList(result).addElement(MetaAdapterFactory.getConcept(0x28f9e4973b424291L, 0xaeba0a1039153ab1L, 0x6785022a196ed912L, "jetbrains.mps.lang.plugin.structure.ConceptFunctionParameter_SConceptClass"));
    ListSequence.fromList(result).addElement(MetaAdapterFactory.getConcept(0x28f9e4973b424291L, 0xaeba0a1039153ab1L, 0x1184b3b848fL, "jetbrains.mps.lang.plugin.structure.ConceptFunctionParameter_node"));
    return result;
  }
  /*package*/ static SNode getExpectedReturnType_idhEwIGRD(@NotNull SNode __thisNode__) {
    return _quotation_createNode_8ubmkw_a0a2();
  }

  /*package*/ CreateBlock__BehaviorDescriptor() {
    super(REGISTRY);
  }
  ...
  private static SNode _quotation_createNode_8ubmkw_a0a2() {
