...
public class ActionParameter_Hint extends AbstractCellProvider {
  ...
  private static SNode _quotation_createNode_xpsq7t_a0a0a0a0a0a0a0a0a0a() {
    ...
    quotedNode_1.setReference("classifier", SReference.create("classifier", quotedNode_1, SModelReference.fromString("f:java_stub#742f6602-5a2f-4313-aa6e-ae1cd4ffdc61#jetbrains.mps.ide.actions(MPS.Platform/jetbrains.mps.ide.actions@java_stub)"), jetbrains.mps.smodel.SNodeId.fromString("~MPSCommonDataKeys$Description")));
    return quotedNode_1;
  }
