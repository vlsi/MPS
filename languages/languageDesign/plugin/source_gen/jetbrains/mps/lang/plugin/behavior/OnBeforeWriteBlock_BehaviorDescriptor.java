...
public final class OnBeforeWriteBlock_BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0x28f9e4973b424291L, 0xaeba0a1039153ab1L, 0x119e1f3f82bL, "jetbrains.mps.lang.plugin.structure.OnBeforeWriteBlock");
  ...
  private static SNode getExpectedReturnType_idhEwIGRD(@NotNull SNode __thisNode__) {
    return _quotation_createNode_b02eya_a0a2();
  }

  /*package*/ OnBeforeWriteBlock_BehaviorDescriptor() {
    super(REGISTRY);
  }
  ...
  private static SNode _quotation_createNode_b02eya_a0a2() {
