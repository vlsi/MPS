...
public final class KeyMapKeystroke_BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<String> getKeyStroke_idhEwIlzu = new SMethodBuilder<String>(new SJavaCompoundTypeImpl(String.class)).name("getKeyStroke").modifiers(SModifiersImpl.create(0, AccessPrivileges.PUBLIC)).concept(CONCEPT).id("hEwIlzu").registry(REGISTRY).build(SParameterImpl.fromList(SJavaCompoundTypeImpl.fromClasses()));
  ...
  private static String getKeyStroke_idhEwIlzu(@NotNull SNode __thisNode__) {
  ...
  /*package*/ KeyMapKeystroke_BehaviorDescriptor() {
    super(REGISTRY);
  }
  ...
  protected <T> T invokeSpecial0(@NotNull SNode node, @NotNull SMethod<T> method, @NotNull Object[] parameters) {
    ...
    switch (methodIndex) {
      case 0:
        return (T) getKeyStroke_idhEwIlzu(node);
      default:
        throw new BHMethodNotFoundException(this, method);
    }
  }
