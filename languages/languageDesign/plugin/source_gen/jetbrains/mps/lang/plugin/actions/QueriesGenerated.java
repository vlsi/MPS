...
public class QueriesGenerated {
  ...
  private static SNode _quotation_createNode_tuayuq_a0a0a0b0a0c0() {
    ...
    quotedNode_1.setReference("classifier", SReference.create("classifier", quotedNode_1, SModelReference.fromString("f:java_stub#742f6602-5a2f-4313-aa6e-ae1cd4ffdc61#com.intellij.openapi.actionSystem(MPS.Platform/com.intellij.openapi.actionSystem@java_stub)"), jetbrains.mps.smodel.SNodeId.fromString("~PlatformDataKeys")));
    return quotedNode_1;
  }
  ...
  private static SNode _quotation_createNode_tuayuq_a0a0a0c0a0c0() {
    SNode quotedNode_1 = null;
    quotedNode_1 = SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.baseLanguage.structure.ClassifierType", null, null, GlobalScope.getInstance(), false);
    quotedNode_1.setReference("classifier", SReference.create("classifier", quotedNode_1, SModelReference.fromString("f:java_stub#1ed103c3-3aa6-49b7-9c21-6765ee11f224#jetbrains.mps.ide.editor(MPS.Editor/jetbrains.mps.ide.editor@java_stub)"), jetbrains.mps.smodel.SNodeId.fromString("~MPSEditorDataKeys")));
    return quotedNode_1;
  }
  ...
  private static SNode _quotation_createNode_tuayuq_a0a0a0d0a0c0() {
    SNode quotedNode_1 = null;
    quotedNode_1 = SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.baseLanguage.structure.ClassifierType", null, null, GlobalScope.getInstance(), false);
    quotedNode_1.setReference("classifier", SReference.create("classifier", quotedNode_1, SModelReference.fromString("f:java_stub#742f6602-5a2f-4313-aa6e-ae1cd4ffdc61#jetbrains.mps.ide.actions(MPS.Platform/jetbrains.mps.ide.actions@java_stub)"), jetbrains.mps.smodel.SNodeId.fromString("~MPSCommonDataKeys")));
    return quotedNode_1;
  }
}
