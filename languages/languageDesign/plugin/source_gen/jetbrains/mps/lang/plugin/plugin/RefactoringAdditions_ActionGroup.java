...
public class RefactoringAdditions_ActionGroup extends GeneratedActionGroup {
  ...
  public static final String ID = "jetbrains.mps.lang.plugin.plugin.RefactoringAdditions_ActionGroup";
  ...
  public RefactoringAdditions_ActionGroup() {
    ...
    this.setPopup(false);
    try {
      RefactoringAdditions_ActionGroup.this.addAction("jetbrains.mps.lang.plugin.plugin.SortKeymapMembers_Action");
    } catch (Throwable t) {
