...
public class ToStringConceptFunction_Behavior {
...
;  public static List<SNode> virtual_getApplicableConceptFunctionParameter_3044950653914717136(SAbstractConcept thisConcept) {
    ...
    ListSequence.fromList(result).addElement(SNodeOperations.getNode("r:00000000-0000-4000-0000-011c89590368(jetbrains.mps.lang.plugin.structure)", "1227019310584"));
    return result;
  };;
;  public static SNode virtual_getExpectedReturnType_1213877374441(SNode thisNode) {
    return _quotation_createNode_w4edji_a0a2();
  };;
;  private static SNode _quotation_createNode_w4edji_a0a2() {
