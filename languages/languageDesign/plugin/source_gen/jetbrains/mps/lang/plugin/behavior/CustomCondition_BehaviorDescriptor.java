...
public final class CustomCondition_BehaviorDescriptor extends BaseBHDescriptor {
  ...
  private static List<SNode> getApplicableConceptFunctionParameter_id2D1PBM_bxJg(@NotNull SAbstractConcept __thisConcept__) {
    ...
    ListSequence.fromList(result).addElement(SNodeOperations.getNode("r:00000000-0000-4000-0000-011c89590368(jetbrains.mps.lang.plugin.structure)", "5538333046911348647"));
    return result;
  }
  ...
  /*package*/ CustomCondition_BehaviorDescriptor() {
    super(REGISTRY);
  }
