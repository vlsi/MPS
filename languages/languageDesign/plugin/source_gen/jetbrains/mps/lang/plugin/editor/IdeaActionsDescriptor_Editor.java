...
public class IdeaActionsDescriptor_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createRefNodeList_rofybv_b1a(EditorContext editorContext, SNode node) {
    ...
    editorCell.getStyle().putAll(style);
    editorCell.setAction(CellActionType.COMMENT, new CellAction_CommentOrUncommentChild(node, MetaAdapterFactory.getContainmentLink(0x28f9e4973b424291L, 0xaeba0a1039153ab1L, 0x498be7ea73fa71eL, 0x498be7ea73fa722L, "actionGroups")));
  ...
  private EditorCell createRefNodeList_rofybv_e1a(EditorContext editorContext, SNode node) {
    ...
    style.set(StyleAttributes.INDENT_LAYOUT_CHILDREN_NEWLINE, 0, true);
    editorCell.getStyle().putAll(style);
    editorCell.setAction(CellActionType.COMMENT, new CellAction_CommentOrUncommentChild(node, MetaAdapterFactory.getContainmentLink(0x28f9e4973b424291L, 0xaeba0a1039153ab1L, 0x498be7ea73fa71eL, 0x498be7ea73fa880L, "keymapsRef")));
    editorCell.setRole(handler.getElementRole());
    return editorCell;
  }
