...
/*package*/ class ActionDataParameterDeclaration_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createRefCell_d8l4wt_d0() {
    ...
    provider.setAuxiliaryCellProvider(new ActionDataParameterDeclaration_EditorBuilder_a._Inline_d8l4wt_a3a());
    ...
    style.set(StyleAttributes.STRIKE_OUT, _StyleParameter_QueryFunction_d8l4wt_a0d0(getEditorContext(), getNode()));
  ...
  public static class _Inline_d8l4wt_a3a extends InlineCellProvider {
    ...
    public EditorCell createEditorCell(EditorContext editorContext, SNode node) {
      ...
      return new ActionDataParameterDeclaration_EditorBuilder_a.Inline_Builder_d8l4wt_a3a(editorContext, getRefNode(), node).createCell();
    }
  }
  ...
  private class conditionListHandler_d8l4wt_e0 extends RefNodeListHandler {
