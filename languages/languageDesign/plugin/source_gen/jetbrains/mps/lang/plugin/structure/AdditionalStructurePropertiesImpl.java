...
public class AdditionalStructurePropertiesImpl extends ConceptPresentationAspectBase {
  ...
  private final ConceptPresentation props_ActionDeclaration = new ConceptPresentationBuilder().helpUrl("http://confluence.jetbrains.com/display/MPSD33/Plugin#Plugin-actionsandactiongroups").icon("actionNew.png", AdditionalStructurePropertiesImpl.class).create();
  private final ConceptPresentation
      props_ActionGroupDeclaration = new ConceptPresentationBuilder().icon("actionGroupNew.png", AdditionalStructurePropertiesImpl.class).create();
  ...
  private final ConceptPresentation
      props_ActionParameter = new ConceptPresentationBuilder().deprecated(MetaAdapterFactory.getProperty(0x28f9e4973b424291L, 0xaeba0a1039153ab1L, 0x11b737a6b7cL, 0x11c71345faaL, "isOptional")).create();
  ...
  private final ConceptPresentation
      props_CreateTabBlock = new ConceptPresentationBuilder().deprecated(MetaAdapterFactory.getProperty(0x28f9e4973b424291L, 0xaeba0a1039153ab1L, 0x16c373ab7fdbb667L, 0x16c373ab7fdbb66eL, "commandOnCreate")).create();
  ...
  private final ConceptPresentation
      props_IdeaInitializerDescriptor = new ConceptPresentationBuilder().icon("ideaPluginDeclaration.png", AdditionalStructurePropertiesImpl.class).create();
  ...
  private final ConceptPresentation
      props_KeymapChangesDeclaration = new ConceptPresentationBuilder().icon("keymapChangesDeclaration.png", AdditionalStructurePropertiesImpl.class).create();
  ...
  private final ConceptPresentation
      props_PreferencesComponentDeclaration = new ConceptPresentationBuilder().icon("preferences.png", AdditionalStructurePropertiesImpl.class).create();
