...
/*package*/ class PropertyRefExpression_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private class nodeExprSingleRoleHandler_hd00ff_c0 extends SingleRoleCellProvider {
    ...
    private void installCellInfo(SNode child, EditorCell editorCell) {
      if (editorCell.getSubstituteInfo() == null || editorCell.getSubstituteInfo() instanceof DefaultSubstituteInfo) {
        editorCell.setSubstituteInfo(new OldNewCompositeSubstituteInfo(getEditorContext(), new SChildSubstituteInfo(editorCell, getNode(), MetaAdapterFactory.getContainmentLink(0xfe9d76d7580945c9L, 0xae28a40915b4d6ffL, 0x433c3c31e7218f39L, 0x433c3c31e7218f3aL, "nodeExpr"), child), new DefaultChildSubstituteInfo(getNode(), myContainmentLink.getDeclarationNode(), getEditorContext())));
      }
  ...
  private EditorCell createRefCell_hd00ff_e0() {
    ...
    provider.setAuxiliaryCellProvider(new PropertyRefExpression_EditorBuilder_a._Inline_hd00ff_a4a());
