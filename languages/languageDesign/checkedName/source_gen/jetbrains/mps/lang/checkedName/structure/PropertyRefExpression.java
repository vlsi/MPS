...
public class PropertyRefExpression extends Expression {
  public static final String concept = "jetbrains.mps.lang.checkedName.structure.PropertyRefExpression";
  ...
  public static PropertyRefExpression newInstance(SModel sm, boolean init) {
    return (PropertyRefExpression) SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.lang.checkedName.structure.PropertyRefExpression", sm, GlobalScope.getInstance(), init).getAdapter();
  }
