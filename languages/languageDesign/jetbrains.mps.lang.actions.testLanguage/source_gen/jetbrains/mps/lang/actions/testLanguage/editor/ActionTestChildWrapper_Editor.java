...
public class ActionTestChildWrapper_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createCollection_rv073a_a(EditorContext editorContext, SNode node) {
    ...
    editorCell.addEditorCell(this.createRefNodeList_rv073a_f0(editorContext, node));
    editorCell.addEditorCell(this.createConstant_rv073a_g0(editorContext, node));
    editorCell.addEditorCell(this.createConstant_rv073a_h0(editorContext, node));
    return editorCell;
  }
  ...
  private EditorCell createConstant_rv073a_e0(EditorContext editorContext, SNode node) {
    ...
    Style style = new StyleImpl();
    style.set(StyleAttributes.PUNCTUATION_LEFT, true);
    style.set(StyleAttributes.MATCHING_LABEL, "paren-childToWrap");
    style.set(StyleAttributes.PUNCTUATION_RIGHT, true);
    editorCell.getStyle().putAll(style);
    editorCell.setDefaultText("");
    return editorCell;
  ...
  private EditorCell createRefNodeList_rv073a_f0(EditorContext editorContext, SNode node) {
    AbstractCellListHandler handler = new ActionTestChildWrapper_Editor.childToWrapListHandler_rv073a_f0(node, "childToWrap", editorContext);
    EditorCell_Collection editorCell = handler.createCells(editorContext, new CellLayout_Indent(), false);
    editorCell.setCellId("refNodeList_childToWrap");
    editorCell.setRole(handler.getElementRole());
    return editorCell;
  }

  private static class childToWrapListHandler_rv073a_f0 extends RefNodeListHandler {
    public childToWrapListHandler_rv073a_f0(SNode ownerNode, String childRole, EditorContext context) {
  ...
  private EditorCell createConstant_rv073a_h0(EditorContext editorContext, SNode node) {
    EditorCell_Constant editorCell = new EditorCell_Constant(editorContext, node, ")");
    editorCell.setCellId("Constant_rv073a_h0");
    Style style = new StyleImpl();
    style.set(StyleAttributes.PUNCTUATION_LEFT, true);
    style.set(StyleAttributes.MATCHING_LABEL, "body-paren");
    editorCell.getStyle().putAll(style);
