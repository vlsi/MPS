  ...
  public void applyRule(final SNode eog, final TypeCheckingContext typeCheckingContext, IsApplicableStatus status) {
    {
      ...
      typeCheckingContext.createLessThanInequality((SNode) BehaviorReflection.invokeVirtual((Class<SNode>) ((Class) Object.class), eog, "virtual_getExpectedReturnType_1213877374441", new Object[]{}), (SNode) SLinkOperations.getTarget(SLinkOperations.getTarget(SNodeOperations.as(SNodeOperations.getParent(eog), "jetbrains.mps.lang.extension.structure.ExtensionDeclaration"), MetaAdapterFactory.getReferenceLink(new UUID(-4609422916437195432l, -4690047243382094519l), 3729007189729192404l, 3729007189729192405l, "extensionPoint")), MetaAdapterFactory.getContainmentLink(new UUID(-4609422916437195432l, -4690047243382094519l), 3729007189729192406l, 8029776554053057803l, "objectType")), false, true, _info_12389875345);
    }
  }
