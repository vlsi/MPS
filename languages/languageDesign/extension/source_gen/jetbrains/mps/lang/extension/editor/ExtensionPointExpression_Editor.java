...
public class ExtensionPointExpression_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createCollection_hr8njl_a(EditorContext editorContext, SNode node) {
    ...
    editorCell.addEditorCell(this.createConceptProperty_hr8njl_a0(editorContext, node));
  ...
  private EditorCell createConceptProperty_hr8njl_a0(EditorContext editorContext, SNode node) {
