...
public class Patternv1_Test extends BaseTransformationTest4 {
  ...
  public static class TestBody extends BaseTestBody {
    ...
    public boolean match() {
      SNode nodeToMatch = _quotation_createNode_o71ow3_a0a0b0();
      ...
      }
      {
        ...
        int i = 0;
        Assert.assertEquals(null, NodesMatcher.matchNodes(ListSequence.fromListAndArray(new ArrayList<SNode>(), list.get(i)), ListSequence.fromListAndArray(new ArrayList<SNode>(), _quotation_createNode_o71ow3_a0a2a6a1a())));
        i++;
        Assert.assertEquals(null, NodesMatcher.matchNodes(ListSequence.fromListAndArray(new ArrayList<SNode>(), list.get(i)), ListSequence.fromListAndArray(new ArrayList<SNode>(), _quotation_createNode_o71ow3_a0a3a6a1a())));
        i++;
      }
      return true;
    }

    private static SNode _quotation_createNode_o71ow3_a0a0b0() {
    ...
    private static SNode _quotation_createNode_o71ow3_a0a2a6a1a() {
      SNode quotedNode_1 = null;
    ...
    private static SNode _quotation_createNode_o71ow3_a0a3a6a1a() {
      SNode quotedNode_1 = null;
      quotedNode_1 = SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.baseLanguage.structure.IntegerConstant", null, null, GlobalScope.getInstance(), false);
      quotedNode_1.setProperty("value", "10");
      return quotedNode_1;
