...
public class PatternListPattern_Test extends BaseTransformationTest {
  ...
  public static class TestBody extends BaseTestBody {
      ...
      public boolean match(SNode nodeToMatch) {
        {
          ...
          {
            SContainmentLink childRole_i79cpz_ = MetaAdapterFactory.getContainmentLink(new UUID(-935030926396207931l, -6610165693999523818l), 1197027756228l, 1197027771414l, "operand");
            if (!(PatternUtil.hasNChildren(nodeToMatch_i79cpz_a0a1a2c, childRole_i79cpz_, 1))) {
              return false;
            }
            {
              SNode childVar_i79cpz_a0a0b0c2 = IterableUtil.get(nodeToMatch_i79cpz_a0a1a2c.getChildren(childRole_i79cpz_), 0);
              {
                ...
                patternVar_className = nodeToMatch_i79cpz_a0a0b0c2.getReferenceTarget(MetaAdapterFactory.getReferenceLink(new UUID(-935030926396207931l, -6610165693999523818l), 1070533707846l, 1144433057691l, "classifier"));
                patternVar_field = nodeToMatch_i79cpz_a0a0b0c2.getReferenceTarget(MetaAdapterFactory.getReferenceLink(new UUID(-935030926396207931l, -6610165693999523818l), 1068498886296l, 1068581517664l, "variableDeclaration"));
              }
            }
          }
          {
            SContainmentLink childRole_i79cpz__0 = MetaAdapterFactory.getContainmentLink(new UUID(-935030926396207931l, -6610165693999523818l), 1197027756228l, 1197027833540l, "operation");
            if (!(PatternUtil.hasNChildren(nodeToMatch_i79cpz_a0a1a2c, childRole_i79cpz__0, 1))) {
              return false;
            }
            {
              SNode childVar_i79cpz_a0a0b0c2_0 = IterableUtil.get(nodeToMatch_i79cpz_a0a1a2c.getChildren(childRole_i79cpz__0), 0);
              {
                ...
                patternVar_method = nodeToMatch_i79cpz_a0a0b0c2_0.getReferenceTarget(MetaAdapterFactory.getReferenceLink(new UUID(-935030926396207931l, -6610165693999523818l), 1204053956946l, 1068499141037l, "baseMethodDeclaration"));
                {
                  SContainmentLink childRole_i79cpz__1 = MetaAdapterFactory.getContainmentLink(new UUID(-935030926396207931l, -6610165693999523818l), 1204053956946l, 1068499141038l, "actualArgument");
                  this.patternVar_list = ListSequence.fromList(new ArrayList<SNode>());
                  patternVar_ignore = null;
                  for (SNode childVar : nodeToMatch_i79cpz_a0a0b0c2_0.getChildren(childRole_i79cpz__1)) {
    ...
    private static SNode _quotation_createNode_i79cpz_a0a0c2() {
      ...
      SNodeAccessUtil.setProperty(quotedNode_4, MetaAdapterFactory.getProperty(new UUID(-935030926396207931l, -6610165693999523818l), 1068580320020l, 1068580320021l, "value"), "10");
      ...
      SNodeAccessUtil.setProperty(quotedNode_5, MetaAdapterFactory.getProperty(new UUID(-935030926396207931l, -6610165693999523818l), 1068580320020l, 1068580320021l, "value"), "10");
    ...
    private static SNode _quotation_createNode_i79cpz_a0a2a6a2c() {
      ...
      SNodeAccessUtil.setProperty(quotedNode_1, MetaAdapterFactory.getProperty(new UUID(-935030926396207931l, -6610165693999523818l), 1068580320020l, 1068580320021l, "value"), "10");
      return quotedNode_1;
    }
