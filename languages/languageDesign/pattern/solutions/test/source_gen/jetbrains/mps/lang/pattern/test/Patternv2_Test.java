...
public class Patternv2_Test extends BaseTransformationTest {
  ...
  public static class TestBody extends BaseTestBody {
      ...
      public boolean match(SNode nodeToMatch) {
        {
          ...
          if (!("jetbrains.mps.baseLanguage.structure.StatementList".equals(nodeToMatch_1fi_a0.getConcept().getQualifiedName()))) {
            return false;
          }
          {
            String childRole_1fi_ = "statement";
            if (!(PatternUtil.hasNChildren(nodeToMatch_1fi_a0, childRole_1fi_, 3))) {
              return false;
            }
            {
            ...
            {
              SNode childVar_1fi_b0a = IterableUtil.get(nodeToMatch_1fi_a0.getChildren(childRole_1fi_), 1);
              {
                SNode nodeToMatch_1fi_b0a = childVar_1fi_b0a;
                if (!("jetbrains.mps.baseLanguage.structure.IfStatement".equals(nodeToMatch_1fi_b0a.getConcept().getQualifiedName()))) {
                  return false;
                }
                {
                  String childRole_1fi__0 = "condition";
                  if (!(PatternUtil.hasNChildren(nodeToMatch_1fi_b0a, childRole_1fi__0, 1))) {
                    return false;
                  }
                  {
                    SNode childVar_1fi_a1a0 = IterableUtil.get(nodeToMatch_1fi_b0a.getChildren(childRole_1fi__0), 0);
                    {
                      SNode nodeToMatch_1fi_a1a0 = childVar_1fi_a1a0;
                      if (!("jetbrains.mps.baseLanguage.structure.NotEqualsExpression".equals(nodeToMatch_1fi_a1a0.getConcept().getQualifiedName()))) {
                        return false;
                      }
                      {
                        String childRole_1fi__1 = "rightExpression";
                        if (!(PatternUtil.hasNChildren(nodeToMatch_1fi_a1a0, childRole_1fi__1, 1))) {
                          return false;
                        }
                        {
                          SNode childVar_1fi_a0b0a = IterableUtil.get(nodeToMatch_1fi_a1a0.getChildren(childRole_1fi__1), 0);
                          {
                            SNode nodeToMatch_1fi_a0b0a = childVar_1fi_a0b0a;
                            if (!("jetbrains.mps.baseLanguage.structure.NullLiteral".equals(nodeToMatch_1fi_a0b0a.getConcept().getQualifiedName()))) {
                              return false;
                            }
                          }
                        }
                      }
                      {
                        ...
                        if (!(PatternUtil.hasNChildren(nodeToMatch_1fi_a1a0, childRole_1fi__2, 1))) {
                          return false;
                        }
                        {
                          SNode childVar_1fi_a0b0a_0 = IterableUtil.get(nodeToMatch_1fi_a1a0.getChildren(childRole_1fi__2), 0);
                          this.patternVar_p = childVar_1fi_a0b0a_0;
                        }
                      }
                    }
                  }
                ...
                {
                  String childRole_1fi__3 = "ifTrue";
                  if (!(PatternUtil.hasNChildren(nodeToMatch_1fi_b0a, childRole_1fi__3, 1))) {
                    return false;
                  }
                  {
                    SNode childVar_1fi_a1a0_0 = IterableUtil.get(nodeToMatch_1fi_b0a.getChildren(childRole_1fi__3), 0);
            ...
            {
              SNode childVar_1fi_c0a = IterableUtil.get(nodeToMatch_1fi_a0.getChildren(childRole_1fi_), 2);
            }
          }
        }
        return true;
    ...
    private static SNode _quotation_createNode_ofki36_a0a0c2() {
      ...
      quotedNode_14.setReference("classifier", SReference.create("classifier", quotedNode_14, facade.createModelReference("f:java_stub#6354ebe7-c22a-4a0f-ac54-50b52ab9b065#java.lang(JDK/java.lang@java_stub)"), facade.createNodeId("~System")));
      quotedNode_14.setReference("variableDeclaration", SReference.create("variableDeclaration", quotedNode_14, facade.createModelReference("f:java_stub#6354ebe7-c22a-4a0f-ac54-50b52ab9b065#java.lang(JDK/java.lang@java_stub)"), facade.createNodeId("~System.out")));
      ...
      quotedNode_15.setReference("baseMethodDeclaration", SReference.create("baseMethodDeclaration", quotedNode_15, facade.createModelReference("f:java_stub#6354ebe7-c22a-4a0f-ac54-50b52ab9b065#java.io(JDK/java.io@java_stub)"), facade.createNodeId("~PrintStream.println(java.lang.String):void")));
    ...
    private static SNode _quotation_createNode_ofki36_a6a2c() {
      ...
      quotedNode_5.setReference("classifier", SReference.create("classifier", quotedNode_5, facade.createModelReference("f:java_stub#6354ebe7-c22a-4a0f-ac54-50b52ab9b065#java.lang(JDK/java.lang@java_stub)"), facade.createNodeId("~System")));
      quotedNode_5.setReference("variableDeclaration", SReference.create("variableDeclaration", quotedNode_5, facade.createModelReference("f:java_stub#6354ebe7-c22a-4a0f-ac54-50b52ab9b065#java.lang(JDK/java.lang@java_stub)"), facade.createNodeId("~System.out")));
      ...
      quotedNode_6.setReference("baseMethodDeclaration", SReference.create("baseMethodDeclaration", quotedNode_6, facade.createModelReference("f:java_stub#6354ebe7-c22a-4a0f-ac54-50b52ab9b065#java.io(JDK/java.io@java_stub)"), facade.createNodeId("~PrintStream.println(java.lang.String):void")));
