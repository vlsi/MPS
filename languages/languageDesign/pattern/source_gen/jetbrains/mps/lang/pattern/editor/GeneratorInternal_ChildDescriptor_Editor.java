...
public class GeneratorInternal_ChildDescriptor_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createConstant_s0kiw8_a0(EditorContext editorContext, SNode node) {
    EditorCell_Constant editorCell = new EditorCell_Constant((jetbrains.mps.nodeEditor.EditorContext) editorContext, node, "generator internal_ child descriptor");
  ...
  private EditorCell createConstant_s0kiw8_c0(EditorContext editorContext, SNode node) {
    EditorCell_Constant editorCell = new EditorCell_Constant((jetbrains.mps.nodeEditor.EditorContext) editorContext, node, "child link declaration");
