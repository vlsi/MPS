...
public class AdditionalStructurePropertiesImpl extends BaseAdditionalStructureProperties {
  private final AdditionalConceptProperties props_ActionAsPattern = new ConceptPropsBuilder().create();
  private final AdditionalConceptProperties props_ActionStatement = new ConceptPropsBuilder().create();
  private final AdditionalConceptProperties props_AsPattern = new ConceptPropsBuilder().create();
  private final AdditionalConceptProperties props_GeneratorInternal_ChildDescriptor = new ConceptPropsBuilder().create();
  ...
  private final AdditionalConceptProperties props_LinkPatternVariableDeclaration = new ConceptPropsBuilder().create();
  private final AdditionalConceptProperties props_ListPattern = new ConceptPropsBuilder().create();
  private final AdditionalConceptProperties props_OrPattern = new ConceptPropsBuilder().create();
  private final AdditionalConceptProperties props_OrPatternClause = new ConceptPropsBuilder().create();
  private final AdditionalConceptProperties props_OrPatternVariableReference = new ConceptPropsBuilder().create();
  private final AdditionalConceptProperties props_Pattern = new ConceptPropsBuilder().create();
  private final AdditionalConceptProperties props_PatternExpression = new ConceptPropsBuilder().deprecated().create();
  private final AdditionalConceptProperties props_PatternVariableDeclaration = new ConceptPropsBuilder().create();
  private final AdditionalConceptProperties props_PatternVariableReference = new ConceptPropsBuilder().create();
  private final AdditionalConceptProperties props_PropertyPatternVariableDeclaration = new ConceptPropsBuilder().create();
  private final AdditionalConceptProperties props_WildcardPattern = new ConceptPropsBuilder().create();
