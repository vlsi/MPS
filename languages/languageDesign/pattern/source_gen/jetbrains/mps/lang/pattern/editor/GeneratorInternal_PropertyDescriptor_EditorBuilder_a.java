...
/*package*/ class GeneratorInternal_PropertyDescriptor_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createRefCell_6n82d8_b0() {
    CellProviderWithRole provider = new RefCellCellProvider(myNode, getEditorContext()) {
      ...
      protected InlineCellProvider createInlineCellProvider(SNode innerCellNode) {
        return new GeneratorInternal_PropertyDescriptor_EditorBuilder_a._Inline_6n82d8_a1a(innerCellNode, myNode);
      }
    };
  ...
  public static class _Inline_6n82d8_a1a extends InlineCellProvider {
    public _Inline_6n82d8_a1a(SNode node, SNode refNode) {
      super(node, refNode);
    }
  ...
  private EditorCell createRefCell_6n82d8_d0() {
    CellProviderWithRole provider = new RefCellCellProvider(myNode, getEditorContext()) {
      @Override
      protected InlineCellProvider createInlineCellProvider(SNode innerCellNode) {
        return new GeneratorInternal_PropertyDescriptor_EditorBuilder_a._Inline_6n82d8_a3a(innerCellNode, myNode);
      }
    };
  ...
  public static class _Inline_6n82d8_a3a extends InlineCellProvider {
    public _Inline_6n82d8_a3a(SNode node, SNode refNode) {
      super(node, refNode);
    }
    public EditorCell createEditorCell(EditorContext editorContext) {
      return createEditorCell(editorContext, getSNode());
