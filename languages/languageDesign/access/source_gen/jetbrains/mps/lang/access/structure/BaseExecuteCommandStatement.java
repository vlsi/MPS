...
public class BaseExecuteCommandStatement extends Statement {
  public static final String concept = "jetbrains.mps.lang.access.structure.BaseExecuteCommandStatement";
  ...
  public static BaseExecuteCommandStatement newInstance(SModel sm, boolean init) {
    return (BaseExecuteCommandStatement) SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.lang.access.structure.BaseExecuteCommandStatement", sm, GlobalScope.getInstance(), init).getAdapter();
  }
