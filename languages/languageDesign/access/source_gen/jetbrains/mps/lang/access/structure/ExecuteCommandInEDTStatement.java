...
public class ExecuteCommandInEDTStatement extends BaseExecuteCommandStatement {
  public static final String concept = "jetbrains.mps.lang.access.structure.ExecuteCommandInEDTStatement";
  ...
  public static ExecuteCommandInEDTStatement newInstance(SModel sm, boolean init) {
    return (ExecuteCommandInEDTStatement) SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.lang.access.structure.ExecuteCommandInEDTStatement", sm, GlobalScope.getInstance(), init).getAdapter();
  }
