...
public class CommandClosureLiteral extends ClosureLiteral {
  public static final String concept = "jetbrains.mps.lang.access.structure.CommandClosureLiteral";
  ...
  public static CommandClosureLiteral newInstance(SModel sm, boolean init) {
    return (CommandClosureLiteral) SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.lang.access.structure.CommandClosureLiteral", sm, GlobalScope.getInstance(), init).getAdapter();
  }
