...
public class ExecuteLightweightCommandStatement extends BaseExecuteCommandStatementSync {
  public static final String concept = "jetbrains.mps.lang.access.structure.ExecuteLightweightCommandStatement";
  ...
  public static ExecuteLightweightCommandStatement newInstance(SModel sm, boolean init) {
    return (ExecuteLightweightCommandStatement) SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.lang.access.structure.ExecuteLightweightCommandStatement", sm, GlobalScope.getInstance(), init).getAdapter();
  }
