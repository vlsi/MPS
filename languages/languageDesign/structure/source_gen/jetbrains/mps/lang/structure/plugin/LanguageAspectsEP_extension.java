  ...
  public LanguageAspectDescriptor get() {
    return new LanguageAspectDescriptor() {
      ...
      public Collection<SLanguage> getMainLanguages() {
        return ListSequence.fromListAndArray(new ArrayList<SLanguage>(), MetaAdapterFactory.getLanguage(MetaIdFactory.langId(0xc72da2b97cce4447L, 0x8389f407dc1158b7L), "jetbrains.mps.lang.structure"));
      }
      @Nullable
      ...
      public String getHelpUrl() {
        return "http://confluence.jetbrains.com/display/MPSD33/Structure";
      }
      ...
      private final Icon ICON = IconResourceBundle_StructureAspect.getInstance().getResource("STRUCTUREMODEL");
