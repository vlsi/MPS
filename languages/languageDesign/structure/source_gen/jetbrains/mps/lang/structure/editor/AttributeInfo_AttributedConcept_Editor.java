...
public class AttributeInfo_AttributedConcept_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createRefCell_hwjzf4_a0(EditorContext editorContext, SNode node) {
    ...
    provider.setAuxiliaryCellProvider(new AttributeInfo_AttributedConcept_Editor._Inline_hwjzf4_a0a());
