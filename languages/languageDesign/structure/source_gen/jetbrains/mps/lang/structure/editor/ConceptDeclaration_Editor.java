...
public class ConceptDeclaration_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createCollection_ueqr71_b2a(EditorContext editorContext, SNode node) {
    ...
    editorCell.addEditorCell(this.createComponent_ueqr71_r1c0(editorContext, node));
    return editorCell;
  }
  ...
  private static class linkDeclarationListHandler_ueqr71_m1c0 extends RefNodeListHandler {
    ...
    public EditorCell createNodeCell(EditorContext editorContext, SNode elementNode) {
      EditorCell elementCell = super.createNodeCell(editorContext, elementNode);
      this.installElementCellActions(this.getOwner(), elementNode, elementCell, editorContext);
      CellAction_CreateChildRangeSelection selectNextPrevAction = new CellAction_CreateChildRangeSelection(elementNode, new ConceptDeclaration_Editor.RangeSelectionFilter_ueqr71_m1c0(), editorContext);
  ...
  private static class linkDeclarationListHandler_ueqr71_p1c0 extends RefNodeListHandler {
    ...
    public EditorCell createNodeCell(EditorContext editorContext, SNode elementNode) {
      EditorCell elementCell = super.createNodeCell(editorContext, elementNode);
      this.installElementCellActions(this.getOwner(), elementNode, elementCell, editorContext);
      CellAction_CreateChildRangeSelection selectNextPrevAction = new CellAction_CreateChildRangeSelection(elementNode, new ConceptDeclaration_Editor.RangeSelectionFilter_ueqr71_p1c0(), editorContext);
      elementCell.setAction(CellActionType.SELECT_NEXT, selectNextPrevAction);
      elementCell.setAction(CellActionType.SELECT_PREVIOUS, selectNextPrevAction);
      return elementCell;
    }
  ...
  private EditorCell createComponent_ueqr71_r1c0(EditorContext editorContext, SNode node) {
  ...
  private static boolean renderingCondition_ueqr71_a1a(SNode node, EditorContext editorContext) {
    ...
    String s = MacrosFactory.forModule(l).expandPath(SPropertyOperations.getString(node, "iconPath"));
    if (s == null) {
      return false;
    }
