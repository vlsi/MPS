...
public class ConceptDeclaration_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createRefNodeList_ueqr71_b1e0a(EditorContext editorContext, SNode node) {
    ...
    BaseLanguageStyle_StyleSheet.apply_ConceptName(style, editorCell);
    editorCell.getStyle().putAll(style);
    editorCell.setAction(CellActionType.COMMENT, new CellAction_CommentOrUncommentChild(node, MetaAdapterFactory.getContainmentLink(0xc72da2b97cce4447L, 0x8389f407dc1158b7L, 0xf979ba0450L, 0x110358d693eL, "implements")));
  ...
  private EditorCell createCollection_ueqr71_a_0(EditorContext editorContext, SNode node) {
    ...
    editorCell.addEditorCell(this.createAlternation_ueqr71_c0(editorContext, node));
  ...
  private EditorCell createAlternation_ueqr71_c0(EditorContext editorContext, SNode node) {
    boolean alternationCondition = true;
    alternationCondition = ConceptDeclaration_Editor.renderingCondition_ueqr71_a2a(node, editorContext);
    EditorCell editorCell = null;
    if (alternationCondition) {
      editorCell = this.createImage_ueqr71_a2a(editorContext, node);
    } else {
      editorCell = this.createConstant_ueqr71_a2a(editorContext, node);
    }
    return editorCell;
  }
