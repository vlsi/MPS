...
/*package*/ class ConceptDeclaration_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createCollection_ueqr71_a0() {
    ...
    if (renderingCondition_ueqr71_a0a0(myNode, getEditorContext())) {
      editorCell.addEditorCell(createConstant_ueqr71_a0a());
    }
    if (renderingCondition_ueqr71_a1a0(myNode, getEditorContext())) {
  ...
  private EditorCell createConstant_ueqr71_c0a() {
    ...
    Style style = new StyleImpl();
    new KeywordStyleClass(getEditorContext(), getNode()).apply(style, editorCell);
    style.set(StyleAttributes.EDITABLE, _StyleParameter_QueryFunction_ueqr71_a0c0a(getEditorContext(), getNode()));
    editorCell.getStyle().putAll(style);
  ...
  private EditorCell createRefCell_ueqr71_b0e0a() {
    ...
    provider.setAuxiliaryCellProvider(new ConceptDeclaration_EditorBuilder_a._Inline_ueqr71_a1a4a0());
  ...
  public static class _Inline_ueqr71_a1a4a0 extends InlineCellProvider {
    ...
    public EditorCell createEditorCell(EditorContext editorContext, SNode node) {
      ...
      return new ConceptDeclaration_EditorBuilder_a.Inline_Builder_ueqr71_a1a4a0(editorContext, getRefNode(), node).createCell();
    }
  }
  ...
  private class implementsListHandler_ueqr71_b1e0a extends RefNodeListHandler {
    ...
    public void installElementCellActions(SNode elementNode, EditorCell elementCell) {
      if (elementCell.getUserObject(AbstractCellListHandler.ELEMENT_CELL_ACTIONS_SET) == null) {
        ...
        if (elementCell.getSubstituteInfo() == null || elementCell.getSubstituteInfo() instanceof DefaultSubstituteInfo) {
          elementCell.setSubstituteInfo(new OldNewCompositeSubstituteInfo(getEditorContext(), new SChildSubstituteInfo(elementCell, getNode(), MetaAdapterFactory.getContainmentLink(0xc72da2b97cce4447L, 0x8389f407dc1158b7L, 0xf979ba0450L, 0x110358d693eL, "implements"), elementNode), new DefaultChildSubstituteInfo(getNode(), elementNode, super.getLinkDeclaration(), getEditorContext())));
        }
      }
    }
  ...
  private EditorCell createCollection_ueqr71_b2a() {
    ...
    if (renderingCondition_ueqr71_a2b2a(myNode, getEditorContext())) {
    ...
    if (renderingCondition_ueqr71_a61b2a(myNode, getEditorContext())) {
  ...
  private class propertyDeclarationListHandler_ueqr71_j1c0 extends RefNodeListHandler {
    ...
    public void installElementCellActions(SNode elementNode, EditorCell elementCell) {
      if (elementCell.getUserObject(AbstractCellListHandler.ELEMENT_CELL_ACTIONS_SET) == null) {
        ...
        if (elementCell.getSubstituteInfo() == null || elementCell.getSubstituteInfo() instanceof DefaultSubstituteInfo) {
          elementCell.setSubstituteInfo(new OldNewCompositeSubstituteInfo(getEditorContext(), new SChildSubstituteInfo(elementCell, getNode(), MetaAdapterFactory.getContainmentLink(0xc72da2b97cce4447L, 0x8389f407dc1158b7L, 0x1103553c5ffL, 0xf979c3ba6cL, "propertyDeclaration"), elementNode), new DefaultChildSubstituteInfo(getNode(), elementNode, super.getLinkDeclaration(), getEditorContext())));
        }
      }
    }
  ...
  private class linkDeclarationListHandler_ueqr71_m1c0 extends RefNodeListHandler {
    ...
    public void installElementCellActions(SNode elementNode, EditorCell elementCell) {
      if (elementCell.getUserObject(AbstractCellListHandler.ELEMENT_CELL_ACTIONS_SET) == null) {
        ...
        if (elementCell.getSubstituteInfo() == null || elementCell.getSubstituteInfo() instanceof DefaultSubstituteInfo) {
          elementCell.setSubstituteInfo(new OldNewCompositeSubstituteInfo(getEditorContext(), new SChildSubstituteInfo(elementCell, getNode(), MetaAdapterFactory.getContainmentLink(0xc72da2b97cce4447L, 0x8389f407dc1158b7L, 0x1103553c5ffL, 0xf979c3ba6bL, "linkDeclaration"), elementNode), new DefaultChildSubstituteInfo(getNode(), elementNode, super.getLinkDeclaration(), getEditorContext())));
        }
      }
    }
  ...
  private class linkDeclarationListHandler_ueqr71_p1c0 extends RefNodeListHandler {
  ...
  private EditorCell createRefCell_ueqr71_g61b2a() {
    ...
    EditorCell editorCell;
    provider.setAuxiliaryCellProvider(new ConceptDeclaration_EditorBuilder_a._Inline_ueqr71_a6q1c0());
    editorCell = provider.createEditorCell(getEditorContext());
    if (editorCell.getRole() == null) {
      editorCell.setReferenceCell(true);
  ...
  public static class _Inline_ueqr71_a6q1c0 extends InlineCellProvider {
    ...
    public EditorCell createEditorCell(EditorContext editorContext, SNode node) {
      // looks like getRefNode() == node 
      return new ConceptDeclaration_EditorBuilder_a.Inline_Builder_ueqr71_a6q1c0(editorContext, getRefNode(), node).createCell();
    }
  }
