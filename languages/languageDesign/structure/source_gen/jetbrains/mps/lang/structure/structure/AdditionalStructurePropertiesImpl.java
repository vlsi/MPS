...
public class AdditionalStructurePropertiesImpl extends ConceptPresentationAspectBase {
  ...
  private final ConceptPresentation
      props_EnumerationDataTypeDeclaration = new ConceptPresentationBuilder().icon("enum.png", AdditionalStructurePropertiesImpl.class).create();
  ...
  private final ConceptPresentation
      props_InterfaceConceptDeclaration = new ConceptPresentationBuilder().icon("interfaceStructure.png", AdditionalStructurePropertiesImpl.class).create();
  private final ConceptPresentation props_InterfaceConceptReference = new ConceptPresentationBuilder().create();
  private final ConceptPresentation props_LinkDeclaration = new ConceptPresentationBuilder().icon("link.png", AdditionalStructurePropertiesImpl.class).create();
  private final ConceptPresentation
      props_PrimitiveDataTypeDeclaration = new ConceptPresentationBuilder().icon("primitiveTD.png", AdditionalStructurePropertiesImpl.class).create();
  private final ConceptPresentation props_PropertyDeclaration = new ConceptPresentationBuilder().icon("property.png", AdditionalStructurePropertiesImpl.class).create();
