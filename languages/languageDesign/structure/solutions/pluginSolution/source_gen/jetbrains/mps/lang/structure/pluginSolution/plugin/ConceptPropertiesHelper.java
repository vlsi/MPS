...
public class ConceptPropertiesHelper {
    ...
    RefactoringAccess.getInstance().showRefactoringView(ideaProject, new RefactoringViewAction() {
      ...
      private void replaceAccessUsages(SNode node) {
        ...
        if (SNodeOperations.isInstanceOf(type, "jetbrains.mps.lang.smodel.structure.SConceptType") || (SNodeOperations.isInstanceOf(type, "jetbrains.mps.lang.smodel.structure.SNodeType") && SConceptOperations.isSubConceptOf(SLinkOperations.getTarget(SNodeOperations.cast(type, "jetbrains.mps.lang.smodel.structure.SNodeType"), "concept", false), "jetbrains.mps.lang.structure.structure.AbstractConceptDeclaration"))) {
          SNodeOperations.replaceWithAnother(node, new ConceptPropertiesHelper.QuotationClass_azpnkk_a1a0a3a2a0b0a21a2().createNode(operand));
        } else {
          SNodeOperations.replaceWithAnother(node, new ConceptPropertiesHelper.QuotationClass_azpnkk_a1a0a0d0c0a1a0m0c().createNode(operand));
        }
        if (SNodeOperations.isInstanceOf(parent, "jetbrains.mps.baseLanguage.structure.DotExpression") && SNodeOperations.isInstanceOf(SLinkOperations.getTarget(SNodeOperations.cast(parent, "jetbrains.mps.baseLanguage.structure.DotExpression"), "operation", true), "jetbrains.mps.lang.smodel.structure.ConceptProperty_SetOperation")) {
          ...
          SNodeOperations.replaceWithAnother(setOperation, SLinkOperations.getTarget(new ConceptPropertiesHelper.QuotationClass_azpnkk_a0b0b0e0c0a1a0m0c().createNode(SLinkOperations.getTarget(setOperation, "value", true)), "operation", true));
        }
      }
  ...
  public static class QuotationClass_azpnkk_a0a0a0e0c {
    public QuotationClass_azpnkk_a0a0a0e0c() {
    }
  ...
  public static class QuotationClass_azpnkk_a0a0a1a0b0a21a2 {
    public QuotationClass_azpnkk_a0a0a1a0b0a21a2() {
    }
    ...
    public SNode createNode(Object parameter_3) {
      ...
      SNode quotedNode_1 = null;
      {
        quotedNode_1 = SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.lang.editor.structure.CellModel_Component", null, GlobalScope.getInstance(), false);
  ...
  public static class QuotationClass_azpnkk_a1a0a3a2a0b0a21a2 {
    public QuotationClass_azpnkk_a1a0a3a2a0b0a21a2() {
    }
    ...
    public SNode createNode(Object parameter_7) {
      ...
      SNode quotedNode_3 = null;
      {
        ...
        }
        {
          ...
          quotedNode1_6.setReference("property", SReference.create("property", quotedNode1_6, SModelReference.fromString("r:00000000-0000-4000-0000-011c89590292(jetbrains.mps.lang.structure.structure)"), SNodeId.fromString("5092175715804935370")));
  ...
  public static class QuotationClass_azpnkk_a1a0a0d0c0a1a0m0c {
    public QuotationClass_azpnkk_a1a0a0d0c0a1a0m0c() {
    }
      ...
      SNode quotedNode_5 = null;
      {
        ...
        SNode quotedNode1_6 = quotedNode_1;
        {
          ...
          SNode quotedNode1_7 = quotedNode_2;
          {
            ...
            quotedNode_2.addChild("operation", quotedNode1_8);
          }
          {
        ...
        }
        {
          ...
          quotedNode1_10.setReference("property", SReference.create("property", quotedNode1_10, SModelReference.fromString("r:00000000-0000-4000-0000-011c89590292(jetbrains.mps.lang.structure.structure)"), SNodeId.fromString("5092175715804935370")));
  ...
  public static class QuotationClass_azpnkk_a0b0b0e0c0a1a0m0c {
    public QuotationClass_azpnkk_a0b0b0e0c0a1a0m0c() {
    }
      ...
      SNode quotedNode_10 = null;
      {
        ...
        SNode quotedNode1_11 = quotedNode_1;
        {
          ...
          SNode quotedNode1_12 = quotedNode_2;
          {
            ...
            {
              quotedNode_7 = SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.baseLanguage.structure.GenericNewExpression", null, GlobalScope.getInstance(), false);
              SNode quotedNode1_14 = quotedNode_7;
              {
                quotedNode_9 = SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.lang.smodel.structure.SNodeCreator", null, GlobalScope.getInstance(), false);
                SNode quotedNode1_15 = quotedNode_9;
                {
                  quotedNode_10 = SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.lang.smodel.structure.SNodeType", null, GlobalScope.getInstance(), false);
            ...
            {
              quotedNode_8 = SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.lang.smodel.structure.Node_GetConceptOperation", null, GlobalScope.getInstance(), false);
          ...
          {
            quotedNode_5 = SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.lang.smodel.structure.SPropertyAccess", null, GlobalScope.getInstance(), false);
        ...
        {
          quotedNode_3 = SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.lang.smodel.structure.Property_SetOperation", null, GlobalScope.getInstance(), false);
