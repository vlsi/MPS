...
public class HelpHelper {
  public static HelpHelper.HelpType getDefaultHelpFor(IModule contextModule, SModel contextModel, SNode node) {
  ...
  public static void showHelpFor(IModule contextModule, SModel contextModel, SNode node) {
  ...
  public static boolean helpForAspectIsAvailable(IModule module, SModel model) {
  ...
  public static void showHelpForAspect(IModule contextModule, SModel contextModel) {
