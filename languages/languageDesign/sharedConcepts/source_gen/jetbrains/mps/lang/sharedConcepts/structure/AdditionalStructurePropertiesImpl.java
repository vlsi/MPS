...
public class AdditionalStructurePropertiesImpl extends BaseAdditionalStructureProperties {
  ...
  private final AdditionalConceptProperties props_ConceptFunctionParameter_operationContext = new ConceptPropsBuilder().deprecated().create();
  private final AdditionalConceptProperties props_ConceptFunctionParameter_progressMonitor = new ConceptPropsBuilder().create();
  private final AdditionalConceptProperties props_ConceptFunctionParameter_scope = new ConceptPropsBuilder().create();
