...
public final class InstancesExpression_BehaviorDescriptor extends BaseBHDescriptor {
  ...
  private static String getDisplayString_id5YxQmqOFZEf(@NotNull SAbstractConcept __thisConcept__) {
    return QueryExpression_BehaviorDescriptor.getDisplayString_id5YxQmqOFZEf.invokeSpecial(__thisConcept__) + "(concept)";
  }

  /*package*/ InstancesExpression_BehaviorDescriptor() {
    super(REGISTRY);
  }
