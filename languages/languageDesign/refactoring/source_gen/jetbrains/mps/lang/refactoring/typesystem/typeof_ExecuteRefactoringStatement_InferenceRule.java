...
public class typeof_ExecuteRefactoringStatement_InferenceRule extends AbstractInferenceRule_Runtime implements InferenceRule_Runtime {
  ...
  public void applyRule(final SNode statement, final TypeCheckingContext typeCheckingContext, IsApplicableStatus status) {
    ...
    if (SPropertyOperations.getBoolean(target, "allowMultiple") == false) {
    ...
    } else {
      {
        ...
        typeCheckingContext.createLessThanInequality((SNode) typeCheckingContext.typeOf(_nodeToCheck_1029348928467, "r:00000000-0000-4000-0000-011c89590316(jetbrains.mps.lang.refactoring.typesystem)", "2298239814950983856", true), (SNode) new typeof_ExecuteRefactoringStatement_InferenceRule.QuotationClass_yfen1i_a0a0a0b0a().createNode(typeCheckingContext.typeOf(target, "r:00000000-0000-4000-0000-011c89590316(jetbrains.mps.lang.refactoring.typesystem)", "2298239814950983865", true), typeCheckingContext), false, true, _info_12389875345);
      }
    }
    {
      ...
      typeCheckingContext.createLessThanInequality((SNode) typeCheckingContext.typeOf(_nodeToCheck_1029348928467, "r:00000000-0000-4000-0000-011c89590316(jetbrains.mps.lang.refactoring.typesystem)", "2298239814950983872", true), (SNode) new typeof_ExecuteRefactoringStatement_InferenceRule.QuotationClass_yfen1i_a0a2a0().createNode(typeCheckingContext), false, true, _info_12389875345);
    }
  ...
  public static class QuotationClass_yfen1i_a0a0a0b0a {
    public QuotationClass_yfen1i_a0a0a0b0a() {
    }
  ...
  public static class QuotationClass_yfen1i_a0a2a0 {
    public QuotationClass_yfen1i_a0a2a0() {
    }
