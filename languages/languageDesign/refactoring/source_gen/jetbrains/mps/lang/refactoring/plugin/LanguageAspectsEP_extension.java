  ...
  public LanguageAspectDescriptor get() {
    return new LanguageAspectDescriptor() {
      ...
      public Collection<SLanguage> getMainLanguages() {
        return ListSequence.fromListAndArray(new ArrayList<SLanguage>(), MetaAdapterFactory.getLanguage(MetaIdFactory.langId(0x3ecd7c84cde345deL, 0x886c135ecc69b742L), "jetbrains.mps.lang.refactoring"));
      }
      @Nullable
      ...
      public String getHelpUrl() {
        return "http://confluence.jetbrains.com/display/MPSD33/Refactoring";
      }
      ...
      private final Icon ICON = IconResourceBundle_RefactoringsAspect.getInstance().getResource("REFACTORINGMODEL");
