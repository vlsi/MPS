...
public final class IsApplicableToModuleClause_BehaviorDescriptor extends BaseBHDescriptor {
  ...
  private static List<SNode> getApplicableConceptFunctionParameter_id2D1PBM_bxJg(@NotNull SAbstractConcept __thisConcept__) {
    ...
    ListSequence.fromList(result).addElement(SNodeOperations.getNode("r:00000000-0000-4000-0000-011c89590319(jetbrains.mps.lang.refactoring.structure)", "6895093993902310775"));
    return result;
  }
  ...
  /*package*/ IsApplicableToModuleClause_BehaviorDescriptor() {
    super(REGISTRY);
  }
