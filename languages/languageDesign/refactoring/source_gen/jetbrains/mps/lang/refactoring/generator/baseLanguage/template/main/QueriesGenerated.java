...
public class QueriesGenerated {
  ...
  public static Object referenceMacro_GetReferent_4177632300646356772(final IOperationContext operationContext, final ReferenceMacroContext _context) {
    if (SNodeOperations.isInstanceOf(_context.getNode(), "jetbrains.mps.lang.refactoring.structure.NodeTarget")) {
      return SLinkOperations.getTarget(_quotation_createNode_x583g4_a0a0a0kb(), "enumConstantDeclaration", false);
    } else if (SNodeOperations.isInstanceOf(_context.getNode(), "jetbrains.mps.lang.refactoring.structure.ModelTarget")) {
      return SLinkOperations.getTarget(_quotation_createNode_x583g4_a0a0a0a63(), "enumConstantDeclaration", false);
    } else if (SNodeOperations.isInstanceOf(_context.getNode(), "jetbrains.mps.lang.refactoring.structure.ModuleTarget")) {
      return SLinkOperations.getTarget(_quotation_createNode_x583g4_a0a0b0a63(), "enumConstantDeclaration", false);
    }
    return null;
  }
  ...
  private static SNode _quotation_createNode_x583g4_a0a0a0kb() {
    ...
    quotedNode_1.setReference("enumConstantDeclaration", jetbrains.mps.smodel.SReference.create("enumConstantDeclaration", quotedNode_1, SModelReference.fromString("r:bd8551c6-e2e3-4499-a261-45b0c886d1d1(jetbrains.mps.refactoring.framework)"), SNodeId.fromString("4792031542972815538")));
    quotedNode_1.setReference("enumClass", jetbrains.mps.smodel.SReference.create("enumClass", quotedNode_1, SModelReference.fromString("r:bd8551c6-e2e3-4499-a261-45b0c886d1d1(jetbrains.mps.refactoring.framework)"), SNodeId.fromString("4792031542972811326")));
    return quotedNode_1;
  }

  private static SNode _quotation_createNode_x583g4_a0a0a0a63() {
    SNode quotedNode_1 = null;
    quotedNode_1 = SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.baseLanguage.structure.EnumConstantReference", null, null, GlobalScope.getInstance(), false);
    quotedNode_1.setReference("enumConstantDeclaration", jetbrains.mps.smodel.SReference.create("enumConstantDeclaration", quotedNode_1, SModelReference.fromString("r:bd8551c6-e2e3-4499-a261-45b0c886d1d1(jetbrains.mps.refactoring.framework)"), SNodeId.fromString("4792031542972815539")));
    quotedNode_1.setReference("enumClass", jetbrains.mps.smodel.SReference.create("enumClass", quotedNode_1, SModelReference.fromString("r:bd8551c6-e2e3-4499-a261-45b0c886d1d1(jetbrains.mps.refactoring.framework)"), SNodeId.fromString("4792031542972811326")));
    return quotedNode_1;
  }

  private static SNode _quotation_createNode_x583g4_a0a0b0a63() {
    SNode quotedNode_1 = null;
    quotedNode_1 = SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.baseLanguage.structure.EnumConstantReference", null, null, GlobalScope.getInstance(), false);
    quotedNode_1.setReference("enumConstantDeclaration", jetbrains.mps.smodel.SReference.create("enumConstantDeclaration", quotedNode_1, SModelReference.fromString("r:bd8551c6-e2e3-4499-a261-45b0c886d1d1(jetbrains.mps.refactoring.framework)"), SNodeId.fromString("4792031542972815540")));
    quotedNode_1.setReference("enumClass", jetbrains.mps.smodel.SReference.create("enumClass", quotedNode_1, SModelReference.fromString("r:bd8551c6-e2e3-4499-a261-45b0c886d1d1(jetbrains.mps.refactoring.framework)"), SNodeId.fromString("4792031542972811326")));
    return quotedNode_1;
  }
}
