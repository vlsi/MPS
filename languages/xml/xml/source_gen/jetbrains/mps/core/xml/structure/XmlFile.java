...
public class XmlFile extends BaseConcept implements INamedConcept, UnitConcept {
  public static final String concept = "jetbrains.mps.core.xml.structure.XmlFile";
  ...
  public XmlDocument getDocument() {
    return (XmlDocument) this.getChild(XmlDocument.class, XmlFile.DOCUMENT);
  }

  public void setDocument(XmlDocument node) {
  ...
  public static XmlFile newInstance(SModel sm, boolean init) {
    return (XmlFile) SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.core.xml.structure.XmlFile", sm, GlobalScope.getInstance(), init).getAdapter();
  }
