...
public class CheckLocalInstanceFieldReferenceScopes_MigrationScript extends BaseMigrationScript {
  public CheckLocalInstanceFieldReferenceScopes_MigrationScript(IOperationContext operationContext) {
    super("Check local instance field reference scopes");
    this.addRefactoring(new AbstractMigrationRefactoring(operationContext) {
      ...
      public boolean isApplicableInstanceNode(SNode node) {
        ...
        SReference ref = SNodeOperations.getReference(node, SLinkOperations.findLinkDeclaration("jetbrains.mps.baseLanguage.structure.LocalInstanceFieldReference", "fieldDeclaration"));
