...
public class CheckPropertyScopes_MigrationScript extends BaseMigrationScript {
  public CheckPropertyScopes_MigrationScript(IOperationContext operationContext) {
    super("Check property scopes");
    this.addRefactoring(new AbstractMigrationRefactoring(operationContext) {
      ...
      public boolean isApplicableInstanceNode(SNode node) {
        ...
        String name = SPropertyOperations.getString(SLinkOperations.getTarget(node, "property", false), "name");
