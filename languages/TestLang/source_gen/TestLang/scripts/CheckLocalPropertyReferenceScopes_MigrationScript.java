...
public class CheckLocalPropertyReferenceScopes_MigrationScript extends BaseMigrationScript {
  public CheckLocalPropertyReferenceScopes_MigrationScript(IOperationContext operationContext) {
    super("Check local property reference scopes");
    this.addRefactoring(new AbstractMigrationRefactoring(operationContext) {
      ...
      public boolean isApplicableInstanceNode(SNode node) {
        ...
        SReference ref = SNodeOperations.getReference(node, SLinkOperations.findLinkDeclaration("jetbrains.mps.baseLanguage.structure.LocalPropertyReference", "property"));
