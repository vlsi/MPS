...
public class CheckAnnotationInstanceValueScopes_MigrationScript extends BaseMigrationScript {
  public CheckAnnotationInstanceValueScopes_MigrationScript(IOperationContext operationContext) {
    super("Check annotation instance value scopes");
