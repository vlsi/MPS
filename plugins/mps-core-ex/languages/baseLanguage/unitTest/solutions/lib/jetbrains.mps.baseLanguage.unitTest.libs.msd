...
<solution name="jetbrains.mps.baseLanguage.unitTest.libs" uuid="83f155ff-422c-4b5a-a2f2-b459302dd215" compileInMPS="false">
  <models>
    ...
    <modelRoot path="${module}/lib/jmock-2.5.1/hamcrest-library-1.1.jar" type="java_classes" />
    <modelRoot path="${module}/lib/jmock-2.5.1/jmock-2.5.1.jar" type="java_classes" />
    <modelRoot path="${module}/lib/jmock-2.5.1/jmock-junit3-2.5.1.jar" type="java_classes" />
    <modelRoot path="${module}/lib/jmock-2.5.1/jmock-junit4-2.5.1.jar" type="java_classes" />
