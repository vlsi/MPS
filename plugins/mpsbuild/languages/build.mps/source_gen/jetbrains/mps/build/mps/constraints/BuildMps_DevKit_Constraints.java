...
public class BuildMps_DevKit_Constraints extends BaseConstraintsDescriptor {
  private static SNodePointer canBeChildBreakingPoint = new SNodePointer("r:76dda237-5120-4688-b749-201ab5c5059d(jetbrains.mps.build.mps.constraints)", "7670275304420320850");

  public BuildMps_DevKit_Constraints() {
    super("jetbrains.mps.build.mps.structure.BuildMps_DevKit");
  }
