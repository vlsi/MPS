...
public class StructureAspectDescriptor implements jetbrains.mps.smodel.runtime.StructureAspectDescriptor {
  private static String[] stringSwitchCases_1htk8d_a0a0a = new String[]{"jetbrains.mps.build.structure.BuildAspect", "jetbrains.mps.build.structure.BuildCompositePath", "jetbrains.mps.build.structure.BuildCustomWorkflow", "jetbrains.mps.build.structure.BuildDependency", "jetbrains.mps.build.structure.BuildExternalDependency", "jetbrains.mps.build.structure.BuildFileExcludeSelector", "jetbrains.mps.build.structure.BuildFileIncludeSelector", "jetbrains.mps.build.structure.BuildFileSelector", "jetbrains.mps.build.structure.BuildFolderMacro", "jetbrains.mps.build.structure.BuildInputDirSet", "jetbrains.mps.build.structure.BuildInputFileSet", "jetbrains.mps.build.structure.BuildInputFiles", "jetbrains.mps.build.structure.BuildInputResourceSet", "jetbrains.mps.build.structure.BuildInputSingleFile", "jetbrains.mps.build.structure.BuildJavaPlugin", "jetbrains.mps.build.structure.BuildLayout", "jetbrains.mps.build.structure.BuildLayout_AbstractContainer", "jetbrains.mps.build.structure.BuildLayout_Container", "jetbrains.mps.build.structure.BuildLayout_ContainerAcceptingFileSet", "jetbrains.mps.build.structure.BuildLayout_Copy", "jetbrains.mps.build.structure.BuildLayout_FileSet", "jetbrains.mps.build.structure.BuildLayout_Folder", "jetbrains.mps.build.structure.BuildLayout_Import", "jetbrains.mps.build.structure.BuildLayout_Jar", "jetbrains.mps.build.structure.BuildLayout_JavaLibrary", "jetbrains.mps.build.structure.BuildLayout_JavaOutput", "jetbrains.mps.build.structure.BuildLayout_NamedContainer", "jetbrains.mps.build.structure.BuildLayout_Node", "jetbrains.mps.build.structure.BuildLayout_PathElement", "jetbrains.mps.build.structure.BuildLayout_TransparentContainer", "jetbrains.mps.build.structure.BuildLayout_Zip", "jetbrains.mps.build.structure.BuildMacro", "jetbrains.mps.build.structure.BuildNamedLayout", "jetbrains.mps.build.structure.BuildPlugin", "jetbrains.mps.build.structure.BuildProject", "jetbrains.mps.build.structure.BuildProjectDependency", "jetbrains.mps.build.structure.BuildProjectPart", "jetbrains.mps.build.structure.BuildRelativePath", "jetbrains.mps.build.structure.BuildSourceMacroRelativePath", "jetbrains.mps.build.structure.BuildSourcePath", "jetbrains.mps.build.structure.BuildSourceProjectRelativePath", "jetbrains.mps.build.structure.BuildSource_JavaContentFolder", "jetbrains.mps.build.structure.BuildSource_JavaContentRoot", "jetbrains.mps.build.structure.BuildSource_JavaDependency", "jetbrains.mps.build.structure.BuildSource_JavaDependencyLibrary", "jetbrains.mps.build.structure.BuildSource_JavaDependencyModule", "jetbrains.mps.build.structure.BuildSource_JavaFiles", "jetbrains.mps.build.structure.BuildSource_JavaLibrary", "jetbrains.mps.build.structure.BuildSource_JavaLibraryClassFiles", "jetbrains.mps.build.structure.BuildSource_JavaLibraryClasses", "jetbrains.mps.build.structure.BuildSource_JavaLibraryElement", "jetbrains.mps.build.structure.BuildSource_JavaLibraryJar", "jetbrains.mps.build.structure.BuildSource_JavaModule", "jetbrains.mps.build.structure.BuildSource_JavaSources", "jetbrains.mps.build.structure.BuildString", "jetbrains.mps.build.structure.BuildStringNotEmpty", "jetbrains.mps.build.structure.BuildStringPart", "jetbrains.mps.build.structure.BuildTextStringPart", "jetbrains.mps.build.structure.BuildVarRefStringPart", "jetbrains.mps.build.structure.BuildVariableMacro"};
  ...
  public ConceptDescriptor getDescriptor(String conceptFqName) {
    switch (Arrays.binarySearch(stringSwitchCases_1htk8d_a0a0a, conceptFqName)) {
      ...
      case 9:
        return new CompiledConceptDescriptor("jetbrains.mps.build.structure.BuildInputDirSet", "jetbrains.mps.build.structure.BuildInputResourceSet", false, new String[]{"jetbrains.mps.build.structure.BuildInputResourceSet"}, new String[]{}, new String[]{});
      case 10:
      ...
      case 13:
        return new CompiledConceptDescriptor("jetbrains.mps.build.structure.BuildInputSingleFile", "jetbrains.mps.build.structure.BuildInputFileSet", false, new String[]{"jetbrains.mps.build.structure.BuildInputFileSet", "jetbrains.mps.build.structure.BuildLayout_FileSet"}, new String[]{}, new String[]{});
      case 14:
      ...
      case 15:
        return new CompiledConceptDescriptor("jetbrains.mps.build.structure.BuildLayout", "jetbrains.mps.build.structure.BuildLayout_AbstractContainer", false, new String[]{"jetbrains.mps.build.structure.BuildLayout_AbstractContainer", "jetbrains.mps.build.structure.BuildLayout_Container"}, new String[]{}, new String[]{});
      case 16:
      ...
      case 21:
        return new CompiledConceptDescriptor("jetbrains.mps.build.structure.BuildLayout_Folder", "jetbrains.mps.build.structure.BuildLayout_NamedContainer", false, new String[]{"jetbrains.mps.build.structure.BuildLayout_NamedContainer"}, new String[]{}, new String[]{});
      case 22:
        return new CompiledConceptDescriptor("jetbrains.mps.build.structure.BuildLayout_Import", "jetbrains.mps.build.structure.BuildLayout_Node", false, new String[]{"jetbrains.mps.build.structure.BuildLayout_Node", "jetbrains.mps.build.structure.BuildExternalDependency"}, new String[]{}, new String[]{"target"});
      case 23:
        return new CompiledConceptDescriptor("jetbrains.mps.build.structure.BuildLayout_Jar", "jetbrains.mps.build.structure.BuildLayout_NamedContainer", false, new String[]{"jetbrains.mps.build.structure.BuildLayout_NamedContainer", "jetbrains.mps.build.structure.BuildLayout_ContainerAcceptingFileSet"}, new String[]{}, new String[]{});
      case 24:
        return new CompiledConceptDescriptor("jetbrains.mps.build.structure.BuildLayout_JavaLibrary", "jetbrains.mps.build.structure.BuildLayout_TransparentContainer", false, new String[]{"jetbrains.mps.build.structure.BuildLayout_TransparentContainer"}, new String[]{}, new String[]{"library"});
      case 25:
        return new CompiledConceptDescriptor("jetbrains.mps.build.structure.BuildLayout_JavaOutput", "jetbrains.mps.build.structure.BuildLayout_Node", false, new String[]{"jetbrains.mps.build.structure.BuildLayout_Node", "jetbrains.mps.build.structure.BuildLayout_FileSet"}, new String[]{}, new String[]{"module"});
      case 26:
      ...
      case 48:
        return new CompiledConceptDescriptor("jetbrains.mps.build.structure.BuildSource_JavaLibraryClassFiles", "jetbrains.mps.build.structure.BuildInputFiles", false, new String[]{"jetbrains.mps.build.structure.BuildInputFiles"}, new String[]{}, new String[]{});
      case 49:
        return new CompiledConceptDescriptor("jetbrains.mps.build.structure.BuildSource_JavaLibraryClasses", "jetbrains.mps.build.structure.BuildSource_JavaLibraryElement", false, new String[]{"jetbrains.mps.build.structure.BuildSource_JavaLibraryElement"}, new String[]{}, new String[]{});
      case 50:
      ...
      case 51:
        return new CompiledConceptDescriptor("jetbrains.mps.build.structure.BuildSource_JavaLibraryJar", "jetbrains.mps.build.structure.BuildInputSingleFile", false, new String[]{"jetbrains.mps.build.structure.BuildInputSingleFile"}, new String[]{}, new String[]{});
      case 52:
        return new CompiledConceptDescriptor("jetbrains.mps.build.structure.BuildSource_JavaModule", "jetbrains.mps.build.structure.BuildProjectPart", false, new String[]{"jetbrains.mps.build.structure.BuildProjectPart", "jetbrains.mps.lang.core.structure.INamedConcept"}, new String[]{}, new String[]{});
      case 53:
