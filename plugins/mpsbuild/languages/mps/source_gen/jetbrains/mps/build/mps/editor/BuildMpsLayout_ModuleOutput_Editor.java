...
public class BuildMpsLayout_ModuleOutput_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createCollection_x4tsfq_a(EditorContext editorContext, SNode node) {
    ...
    editorCell.addEditorCell(this.createConstant_x4tsfq_a0(editorContext, node));
    editorCell.addEditorCell(this.createRefCell_x4tsfq_b0(editorContext, node));
    return editorCell;
  }

  private EditorCell createConstant_x4tsfq_a0(EditorContext editorContext, SNode node) {
    EditorCell_Constant editorCell = new EditorCell_Constant(editorContext, node, "compile output of");
    editorCell.setCellId("Constant_x4tsfq_a0");
    ...
    editorCell.setSubstituteInfo(new CompositeSubstituteInfo(editorContext, new BasicCellContext(node), new SubstituteInfoPart[]{new BuildMpsLayout_ModuleOutput_Editor.ReplaceWith_BuildLayout_Node_cellMenu_a0a0_0()}));
    return editorCell;
  }
