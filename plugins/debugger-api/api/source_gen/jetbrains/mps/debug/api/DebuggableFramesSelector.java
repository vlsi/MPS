...
public class DebuggableFramesSelector implements IDebuggableFramesSelector {
  ...
  private IPositionProvider myProvider;

  public DebuggableFramesSelector(Project project, IPositionProvider provider) {
    myProject = project;
    myProvider = provider;
  }
  ...
  public boolean isDebuggableFrame(@NotNull IStackFrame frame) {
    return myProvider.getPosition(frame.getLocation()) != null;
  }

  @Override
  public boolean isDebuggablePosition(@NonNls String unitName, @NonNls String fileName, int position) {
    return myProvider.getPosition(unitName, fileName, position) != null;
  }
  ...
  public boolean isSamePosition(String lastUnitName, String lastFileName, int lastLineNumber, int lastFrameCount, String nextUnitName, String nextFileName, int nextLineNumber, int nextFrameCount) {
    ...
    SourcePosition lastPointer = myProvider.getPosition(lastUnitName, lastFileName, lastLineNumber);
    SourcePosition nextPointer = myProvider.getPosition(nextUnitName, nextFileName, nextLineNumber);
