...
public class ConceptFunctionParameter_ScopeNode extends ConceptFunctionParameter {
  public static final String concept = "jetbrains.mps.debugger.api.lang.structure.ConceptFunctionParameter_ScopeNode";
  ...
  public static ConceptFunctionParameter_ScopeNode newInstance(SModel sm, boolean init) {
    return (ConceptFunctionParameter_ScopeNode) SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.debugger.api.lang.structure.ConceptFunctionParameter_ScopeNode", sm, GlobalScope.getInstance(), init).getAdapter();
  }
