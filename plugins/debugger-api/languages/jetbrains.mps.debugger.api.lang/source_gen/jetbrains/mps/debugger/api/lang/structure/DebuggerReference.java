...
public class DebuggerReference extends Expression {
  public static final String concept = "jetbrains.mps.debugger.api.lang.structure.DebuggerReference";
  ...
  public static DebuggerReference newInstance(SModel sm, boolean init) {
    return (DebuggerReference) SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.debugger.api.lang.structure.DebuggerReference", sm, GlobalScope.getInstance(), init).getAdapter();
  }
