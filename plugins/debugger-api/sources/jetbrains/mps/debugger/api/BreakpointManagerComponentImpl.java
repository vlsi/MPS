...
public class BreakpointManagerComponentImpl extends BreakpointManagerComponent implements ProjectComponent, PersistentStateComponent<Element> {
  private static final Logger LOG = Logger.getLogger(BreakpointManagerComponentImpl.class);
  ...
  private final BreakpointManagerComponentImpl.MyEditorOpenListener myEditorOpenListener = new BreakpointManagerComponentImpl.MyEditorOpenListener();
  private final List<IBreakpointManagerListener> myListeners = new ArrayList<IBreakpointManagerListener>();
  private final FileEditorManager myFileEditorManager;

  public BreakpointManagerComponentImpl(Project project, DebugInfoManager debugInfoManager, BreakpointProvidersManager providersManager, FileEditorManager fileEditorManager) {
    myProject = project;
