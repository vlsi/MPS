...
public class RemoveExclamationMark_Intention implements IntentionFactory {
  ...
  public Collection<IntentionExecutable> instances(final SNode node, final EditorContext context) {
    if (myCachedExecutable == null) {
      myCachedExecutable = Collections.<IntentionExecutable>singletonList(new RemoveExclamationMark_Intention.IntentionImplementation());
    }
  ...
  public class IntentionImplementation implements IntentionExecutable {
    ...
    public IntentionDescriptor getDescriptor() {
      return RemoveExclamationMark_Intention.this;
    }
  }
}
