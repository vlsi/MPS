      ...
      SNode matchedNode_vxuw1n_b0 = parent;
      {
        boolean matches_vxuw1n_a1a = false;
        {
          ...
          if (matchingNode_vxuw1n_a1a != null) {
            matches_vxuw1n_a1a = SModelUtil_new.isAssignableConcept(matchingNode_vxuw1n_a1a.getConcept().getConceptId(), "jetbrains.mps.ypath.structure.TreePathOperationExpression");
          }
        }
