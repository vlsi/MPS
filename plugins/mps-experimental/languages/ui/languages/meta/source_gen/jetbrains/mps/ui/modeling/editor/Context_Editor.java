...
public class Context_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createRefCell_d0e2am_a0(EditorContext editorContext, SNode node) {
  ...
  public static class _Inline_d0e2am_a0a extends InlineCellProvider {
    public _Inline_d0e2am_a0a(String role) {
      super(role);
    }

    public _Inline_d0e2am_a0a() {
      super();
    }
    ...
    public EditorCell createEditorCell(EditorContext editorContext, SNode node) {
      return this.createProperty_d0e2am_a0a0(editorContext, node);
    }

    private EditorCell createProperty_d0e2am_a0a0(EditorContext editorContext, SNode node) {
