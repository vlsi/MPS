...
public class IAspectParameterHolder_Component extends AbstractCellProvider implements ConceptEditorComponent {
  ...
  public EditorCell createEditorCell(EditorContext editorContext, SNode node) {
    return this.createCollection_qkwmzt_a(editorContext, node);
  }
  ...
  private static class aspectParameterListHandler_qkwmzt_a0 extends RefNodeListHandler {
    public aspectParameterListHandler_qkwmzt_a0(SNode ownerNode, String childRole, EditorContext context) {
    ...
    public EditorCell createEmptyCell_internal(EditorContext editorContext, SNode node) {
      return this.createConstant_qkwmzt_a0a(editorContext, node);
    }
    ...
    private EditorCell createConstant_qkwmzt_a0a(EditorContext editorContext, SNode node) {
      EditorCell_Constant editorCell = new EditorCell_Constant(editorContext, node, "");
      editorCell.setCellId("Constant_qkwmzt_a0a");
