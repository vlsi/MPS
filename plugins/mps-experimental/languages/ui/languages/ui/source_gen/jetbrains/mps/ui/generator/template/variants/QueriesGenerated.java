...
public class QueriesGenerated {
  ...
  private static SNode _quotation_createNode_x583g4_a0a2a22(Object parameter_1) {
    ...
    quotedNode_2.setReference("annotation", SReference.create("annotation", quotedNode_2, facade.createModelReference("r:36693452-2637-4608-8caa-ab32ee7c1be3(jetbrains.mps.ui.multiplexing)"), facade.createNodeId("8590671622324574702")));
    ...
    quotedNode_3.setReference("key", SReference.create("key", quotedNode_3, facade.createModelReference("r:36693452-2637-4608-8caa-ab32ee7c1be3(jetbrains.mps.ui.multiplexing)"), facade.createNodeId("8590671622324574704")));
  ...
  private static SNode _quotation_createNode_x583g4_a0a1a3a22(Object parameter_1) {
    ...
    quotedNode_2 = SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.baseLanguage.structure.AnnotationInstance", null, null, GlobalScope.getInstance(), false);
    quotedNode_2.setReference("annotation", SReference.create("annotation", quotedNode_2, facade.createModelReference("r:36693452-2637-4608-8caa-ab32ee7c1be3(jetbrains.mps.ui.multiplexing)"), facade.createNodeId("8590671622324268192")));
    quotedNode_3 = SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.baseLanguage.structure.AnnotationInstanceValue", null, null, GlobalScope.getInstance(), false);
    quotedNode_3.setReference("key", SReference.create("key", quotedNode_3, facade.createModelReference("r:36693452-2637-4608-8caa-ab32ee7c1be3(jetbrains.mps.ui.multiplexing)"), facade.createNodeId("8590671622324287920")));
