  ...
  public void applyRule(final SNode icvar, final TypeCheckingContext typeCheckingContext, IsApplicableStatus status) {
    ...
    if ((oexp != null)) {
      final SNode UIOT_typevar_2459884175397753215 = typeCheckingContext.createNewRuntimeTypesVariable();
      {
        ...
        typeCheckingContext.createLessThanInequality((SNode) typeCheckingContext.typeOf(_nodeToCheck_1029348928467, "r:f2d87002-eac7-4f98-addf-b2caa99c13a5(jetbrains.mps.ui.typesystem)", "2459884175397753198", true), (SNode) _quotation_createNode_dmnw7g_a0b0b0b(typeCheckingContext.getRepresentative(UIOT_typevar_2459884175397753215)), false, true, _info_12389875345);
      }
      {
        ...
        typeCheckingContext.createEquation((SNode) typeCheckingContext.typeOf(_nodeToCheck_1029348928467, "r:f2d87002-eac7-4f98-addf-b2caa99c13a5(jetbrains.mps.ui.typesystem)", "2459884175397753227", true), (SNode) _quotation_createNode_dmnw7g_a0c0b0b(typeCheckingContext.getRepresentative(UIOT_typevar_2459884175397753215)), _info_12389875345);
      }
    } else {
      SNode uio = SLinkOperations.getTarget(BehaviorReflection.invokeVirtual((Class<SNode>) ((Class) Object.class), SNodeOperations.getAncestor(icvar, "jetbrains.mps.ui.structure.IUIObjectContextProvider", false, false), "virtual_getContainer_8923564134258257521", new Object[]{}), "allows", false);
      {
        ...
        typeCheckingContext.createEquation((SNode) typeCheckingContext.typeOf(_nodeToCheck_1029348928467, "r:f2d87002-eac7-4f98-addf-b2caa99c13a5(jetbrains.mps.ui.typesystem)", "2459884175397578626", true), (SNode) _quotation_createNode_dmnw7g_a0b0a1a1(uio), _info_12389875345);
      }
    }
  }
