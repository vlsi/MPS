...
public class StructureAspectDescriptor implements jetbrains.mps.smodel.runtime.StructureAspectDescriptor {
  ...
  public ConceptDescriptor getDescriptor(String conceptFqName) {
    switch (Arrays.binarySearch(stringSwitchCases_1htk8d_a0a0b, conceptFqName)) {
      case 0:
        return new ConceptDescriptorBuilder("jetbrains.mps.ui.structure.AccessUIPropertyOperation").super_("jetbrains.mps.baseLanguage.structure.AbstractOperation").parents("jetbrains.mps.baseLanguage.structure.AbstractOperation").references("property").staticScope(StaticScope.NONE).create();
      case 1:
        return new ConceptDescriptorBuilder("jetbrains.mps.ui.structure.AppendUIObjectStatement").super_("jetbrains.mps.ui.structure.UIObjectStatement").parents("jetbrains.mps.ui.structure.UIObjectStatement").alias("append", "").staticScope(StaticScope.NONE).create();
      case 2:
      ...
      case 3:
        return new ConceptDescriptorBuilder("jetbrains.mps.ui.structure.CallUIActionOperation").super_("jetbrains.mps.baseLanguage.structure.AbstractOperation").parents("jetbrains.mps.baseLanguage.structure.AbstractOperation").references("action").staticScope(StaticScope.NONE).create();
      case 4:
      ...
      case 9:
        return new ConceptDescriptorBuilder("jetbrains.mps.ui.structure.ContainerType").super_("jetbrains.mps.baseLanguage.structure.Type").parents("jetbrains.mps.baseLanguage.structure.Type").references("container", "uiObject").alias("container", "").staticScope(StaticScope.NONE).create();
      case 10:
      ...
      case 13:
        return new ConceptDescriptorBuilder("jetbrains.mps.ui.structure.EnclosingContextCompartmentExpression").super_("jetbrains.mps.baseLanguage.structure.Expression").parents("jetbrains.mps.baseLanguage.structure.Expression").alias("enclosing", "").staticScope(StaticScope.NONE).create();
      case 14:
        return new ConceptDescriptorBuilder("jetbrains.mps.ui.structure.EventHandingBlock").super_("jetbrains.mps.baseLanguage.closures.structure.ClosureLiteral").parents("jetbrains.mps.baseLanguage.closures.structure.ClosureLiteral").staticScope(StaticScope.NONE).create();
      case 15:
        return new ConceptDescriptorBuilder("jetbrains.mps.ui.structure.EventPropertyAccessOp").super_("jetbrains.mps.lang.core.structure.BaseConcept").parents("jetbrains.mps.lang.core.structure.BaseConcept", "jetbrains.mps.baseLanguage.structure.IOperation").references("property").staticScope(StaticScope.NONE).create();
      case 16:
        return new ConceptDescriptorBuilder("jetbrains.mps.ui.structure.EventType").super_("jetbrains.mps.baseLanguage.structure.Type").parents("jetbrains.mps.baseLanguage.structure.Type").references("event").alias("event", "").staticScope(StaticScope.NONE).create();
      case 17:
      ...
      case 18:
        return new ConceptDescriptorBuilder("jetbrains.mps.ui.structure.ForceLayoutStatement").super_("jetbrains.mps.baseLanguage.structure.Statement").parents("jetbrains.mps.baseLanguage.structure.Statement").alias("force layout", "").staticScope(StaticScope.NONE).create();
      case 19:
      ...
      case 23:
        return new ConceptDescriptorBuilder("jetbrains.mps.ui.structure.InsertUIObjectStatement").super_("jetbrains.mps.ui.structure.UIObjectStatement").parents("jetbrains.mps.ui.structure.UIObjectStatement").children(new String[]{"before"}, new boolean[]{false}).alias("insert before", "").staticScope(StaticScope.NONE).create();
      case 24:
        return new ConceptDescriptorBuilder("jetbrains.mps.ui.structure.IterateContentsStatement").super_("jetbrains.mps.baseLanguage.structure.AbstractLoopStatement").parents("jetbrains.mps.baseLanguage.structure.AbstractLoopStatement").children(new String[]{"variable"}, new boolean[]{false}).alias("foreach in contents", "").staticScope(StaticScope.NONE).create();
      case 25:
      ...
      case 26:
        return new ConceptDescriptorBuilder("jetbrains.mps.ui.structure.IterateContentsVariableReference").super_("jetbrains.mps.baseLanguage.structure.Expression").parents("jetbrains.mps.baseLanguage.structure.Expression").references("variable").staticScope(StaticScope.NONE).create();
      case 27:
        return new ConceptDescriptorBuilder("jetbrains.mps.ui.structure.RemoveUIObjectStatement").super_("jetbrains.mps.baseLanguage.structure.Statement").parents("jetbrains.mps.baseLanguage.structure.Statement").children(new String[]{"argument"}, new boolean[]{false}).alias("remove", "").staticScope(StaticScope.NONE).create();
      case 28:
        return new ConceptDescriptorBuilder("jetbrains.mps.ui.structure.UIObjectProviderStatement").super_("jetbrains.mps.baseLanguage.structure.Statement").parents("jetbrains.mps.baseLanguage.structure.Statement", "jetbrains.mps.ui.structure.IUIObjectContextProvider").children(new String[]{"context", "body"}, new boolean[]{false, false}).alias("in context", "").staticScope(StaticScope.NONE).create();
      case 29:
        return new ConceptDescriptorBuilder("jetbrains.mps.ui.structure.UIObjectReference").super_("jetbrains.mps.baseLanguage.structure.Expression").parents("jetbrains.mps.baseLanguage.structure.Expression", "jetbrains.mps.baseLanguage.structure.ILocalReference").references("declaration").staticScope(StaticScope.NONE).create();
      case 30:
        return new ConceptDescriptorBuilder("jetbrains.mps.ui.structure.UIObjectStatement").super_("jetbrains.mps.baseLanguage.structure.Statement").parents("jetbrains.mps.baseLanguage.structure.Statement", "jetbrains.mps.lang.core.structure.IDontSubstituteByDefault").references("uiObject").children(new String[]{"viewBinding", "controllerBinding", "compartment", "aspect"}, new boolean[]{true, true, true, true}).abstract_().alias("create", "").staticScope(StaticScope.NONE).create();
      case 31:
        return new ConceptDescriptorBuilder("jetbrains.mps.ui.structure.UIObjectType").super_("jetbrains.mps.baseLanguage.structure.Type").parents("jetbrains.mps.baseLanguage.structure.Type").references("uiObject").alias("uiObject", "").staticScope(StaticScope.NONE).create();
      case 32:
        return new ConceptDescriptorBuilder("jetbrains.mps.ui.structure.ValidateBlock").super_("jetbrains.mps.baseLanguage.closures.structure.ClosureLiteral").parents("jetbrains.mps.baseLanguage.closures.structure.ClosureLiteral").staticScope(StaticScope.NONE).create();
      case 33:
