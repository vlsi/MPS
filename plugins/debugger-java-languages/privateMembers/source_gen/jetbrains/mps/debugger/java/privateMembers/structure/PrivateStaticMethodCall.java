...
public class PrivateStaticMethodCall extends StaticMethodCall {
  public static final String concept = "jetbrains.mps.debugger.java.privateMembers.structure.PrivateStaticMethodCall";
  ...
  public static PrivateStaticMethodCall newInstance(SModel sm, boolean init) {
    return (PrivateStaticMethodCall) SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.debugger.java.privateMembers.structure.PrivateStaticMethodCall", sm, GlobalScope.getInstance(), init).getAdapter();
  }
