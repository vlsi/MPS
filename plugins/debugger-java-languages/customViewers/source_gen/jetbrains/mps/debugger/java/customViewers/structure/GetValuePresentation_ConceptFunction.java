...
public class GetValuePresentation_ConceptFunction extends ConceptFunction {
  public static final String concept = "jetbrains.mps.debugger.java.customViewers.structure.GetValuePresentation_ConceptFunction";
  ...
  public static GetValuePresentation_ConceptFunction newInstance(SModel sm, boolean init) {
    return (GetValuePresentation_ConceptFunction) SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.debugger.java.customViewers.structure.GetValuePresentation_ConceptFunction", sm, GlobalScope.getInstance(), init).getAdapter();
  }
