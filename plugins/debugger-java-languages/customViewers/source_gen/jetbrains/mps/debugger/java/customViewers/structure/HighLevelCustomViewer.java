...
public class HighLevelCustomViewer extends BaseConcept implements INamedConcept {
  public static final String concept = "jetbrains.mps.debugger.java.customViewers.structure.HighLevelCustomViewer";
  ...
  public static HighLevelCustomViewer newInstance(SModel sm, boolean init) {
    return (HighLevelCustomViewer) SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.debugger.java.customViewers.structure.HighLevelCustomViewer", sm, GlobalScope.getInstance(), init).getAdapter();
  }
