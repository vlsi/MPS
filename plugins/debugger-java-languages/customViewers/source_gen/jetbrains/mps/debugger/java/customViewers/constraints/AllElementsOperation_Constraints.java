...
public class AllElementsOperation_Constraints extends BaseConstraintsDescriptor {
  ...
  public static boolean static_canBeAChild(final IOperationContext operationContext, final CanBeAChildContext _context) {
    return TypeChecker.getInstance().getSubtypingManager().isSubtype(TypeChecker.getInstance().getTypeOf(SLinkOperations.getTarget(SNodeOperations.as(_context.getParentNode(), "jetbrains.mps.baseLanguage.structure.DotExpression"), "operand", true)), new AllElementsOperation_Constraints.QuotationClass_4d9cg3_a1a0a0a().createNode());
  }
