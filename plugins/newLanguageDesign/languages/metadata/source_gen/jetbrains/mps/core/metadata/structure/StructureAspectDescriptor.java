...
public class StructureAspectDescriptor implements jetbrains.mps.smodel.runtime.StructureAspectDescriptor {
  ...
  public ConceptDescriptor getDescriptor(String conceptFqName) {
    switch (Arrays.binarySearch(stringSwitchCases_1htk8d_a0a0b, conceptFqName)) {
      ...
      case 1:
        return new ConceptDescriptorBuilder("jetbrains.mps.core.metadata.structure.SConceptAnnotationChildLink").super_("jetbrains.mps.core.metadata.structure.SConceptAnnotationMember").parents("jetbrains.mps.core.metadata.structure.SConceptAnnotationMember", "jetbrains.mps.core.structure.structure.IIdentifier", "jetbrains.mps.core.structure.structure.SCardinalityContainer").references("type").children(new String[]{"cardinality"}, new boolean[]{false}).create();
      case 2:
      ...
      case 6:
        return new ConceptDescriptorBuilder("jetbrains.mps.core.metadata.structure.SConceptAnnotationNodeRef").super_("jetbrains.mps.core.metadata.structure.SConceptAnnotationMember").parents("jetbrains.mps.core.metadata.structure.SConceptAnnotationMember", "jetbrains.mps.core.structure.structure.IIdentifier").references("target").children(new String[]{"cardinality"}, new boolean[]{false}).final_().alias("ref", "node reference").create();
      case 7:
        return new ConceptDescriptorBuilder("jetbrains.mps.core.metadata.structure.SConceptAnnotationProperty").super_("jetbrains.mps.core.metadata.structure.SConceptAnnotationMember").parents("jetbrains.mps.core.metadata.structure.SConceptAnnotationMember", "jetbrains.mps.core.structure.structure.IIdentifier", "jetbrains.mps.lang.core.structure.IDontSubstituteByDefault").children(new String[]{"type", "defaultValue"}, new boolean[]{false, false}).final_().create();
      case 8:
        return new ConceptDescriptorBuilder("jetbrains.mps.core.metadata.structure.SConceptAnnotationType").super_("jetbrains.mps.core.structure.structure.SStructureElement").parents("jetbrains.mps.core.structure.structure.SStructureElement", "jetbrains.mps.core.structure.structure.IIdentifier", "jetbrains.mps.lang.core.structure.ScopeProvider").children(new String[]{"members"}, new boolean[]{true}).alias("concept annotation", "").create();
      case 9:
