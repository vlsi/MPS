...
public class SConceptAnnotationProperty_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createRefNode_b5ax6h_a0(EditorContext editorContext, SNode node) {
    ...
    editorCell.setSubstituteInfo(new CompositeSubstituteInfo(editorContext, provider.getCellContext(), new SubstituteInfoPartExt[]{new SConceptAnnotationProperty_Editor.ReplaceWith_SConceptAnnotationChildLink_cellMenu_b5ax6h_a0a0(), new SConceptAnnotationProperty_Editor.SConceptAnnotationProperty_type_cellMenu_b5ax6h_b0a0()}));
  ...
  public static class ReplaceWith_SConceptAnnotationChildLink_cellMenu_b5ax6h_a0a0 extends AbstractCellMenuPart_ReplaceNode_CustomNodeConcept {
    public ReplaceWith_SConceptAnnotationChildLink_cellMenu_b5ax6h_a0a0() {
    }
  ...
  public static class SConceptAnnotationProperty_type_cellMenu_b5ax6h_b0a0 extends PrimaryReplaceChildMenuCellMenuPart {
    public SConceptAnnotationProperty_type_cellMenu_b5ax6h_b0a0() {
    }
  }
