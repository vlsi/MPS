...
public class StructureAspectDescriptor implements jetbrains.mps.smodel.runtime.StructureAspectDescriptor {
  ...
  public ConceptDescriptor getDescriptor(String conceptFqName) {
    switch (Arrays.binarySearch(stringSwitchCases_1htk8d_a0a0b, conceptFqName)) {
      case 0:
        return new ConceptDescriptorBuilder("jetbrains.mps.core.structure.structure.IIdentifier").interface_().parents("jetbrains.mps.lang.core.structure.INamedConcept").create();
      case 1:
        return new ConceptDescriptorBuilder("jetbrains.mps.core.structure.structure.SAbstractConcept").super_("jetbrains.mps.core.structure.structure.SStructureElement").parents("jetbrains.mps.core.structure.structure.SStructureElement", "jetbrains.mps.core.structure.structure.IIdentifier", "jetbrains.mps.lang.core.structure.ScopeProvider").children(new String[]{"annotations", "members"}, new boolean[]{true, true}).abstract_().create();
      case 2:
      ...
      case 8:
        return new ConceptDescriptorBuilder("jetbrains.mps.core.structure.structure.SConceptFeature").super_("jetbrains.mps.core.structure.structure.SConceptMember").parents("jetbrains.mps.core.structure.structure.SConceptMember", "jetbrains.mps.core.structure.structure.IIdentifier").abstract_().create();
      case 9:
      ...
      case 19:
        return new ConceptDescriptorBuilder("jetbrains.mps.core.structure.structure.SEnumerationMember").super_("jetbrains.mps.lang.core.structure.BaseConcept").parents("jetbrains.mps.lang.core.structure.BaseConcept", "jetbrains.mps.core.structure.structure.IIdentifier").create();
      case 20:
