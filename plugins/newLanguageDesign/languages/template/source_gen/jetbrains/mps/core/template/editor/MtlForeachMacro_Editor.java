...
public class MtlForeachMacro_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createAlternation_xhx8xu_a0(EditorContext editorContext, SNode node) {
    ...
    alternationCondition = MtlForeachMacro_Editor.renderingCondition_xhx8xu_a0a(node, editorContext);
  ...
  private static boolean renderingCondition_xhx8xu_a0a(SNode node, EditorContext editorContext) {
  ...
  private EditorCell createConstant_xhx8xu_a0a0(EditorContext editorContext, SNode node) {
    ...
    editorCell.setSubstituteInfo(new CompositeSubstituteInfo(editorContext, new BasicCellContext(node), new SubstituteInfoPartExt[]{new MtlForeachMacro_Editor.MtlForeachMacro_component_cellMenu_xhx8xu_a0a0a0()}));
    return editorCell;
  }

  public static class MtlForeachMacro_component_cellMenu_xhx8xu_a0a0a0 implements SubstituteInfoPartExt {
    private replace_nodeMacro myComponent;

    public MtlForeachMacro_component_cellMenu_xhx8xu_a0a0a0() {
  ...
  private EditorCell createConstant_xhx8xu_a0a0_0(EditorContext editorContext, SNode node) {
    ...
    delete_nodeMacro.setCellActions(editorCell, node, editorContext);
    editorCell.setDefaultText("");
    editorCell.setSubstituteInfo(new CompositeSubstituteInfo(editorContext, new BasicCellContext(node), new SubstituteInfoPartExt[]{new MtlForeachMacro_Editor.MtlForeachMacro_component_cellMenu_xhx8xu_a0a0a0_0()}));
    return editorCell;
  }

  public static class MtlForeachMacro_component_cellMenu_xhx8xu_a0a0a0_0 implements SubstituteInfoPartExt {
    private replace_nodeMacro myComponent;

    public MtlForeachMacro_component_cellMenu_xhx8xu_a0a0a0_0() {
      this.myComponent = new replace_nodeMacro();
    }
