...
public class SNotationConceptContext_Editor extends DefaultNodeEditor {
  ...
  private static SNode _StyleParameter_QueryFunction_tvsk60_a0b1a(EditorContext editorContext, SNode node) {
    return SNotationConceptContext_Behavior.call_getBaseNotation_8200039929379506936(node);
  }

  public static class SNotationConceptContext_generic_cellMenu_tvsk60_a0b1a extends AbstractCellMenuPart_Generic_Group {
    ...
    public List<?> createParameterObjects(final SNode node, IScope scope, IOperationContext operationContext, EditorContext editorContext) {
      ...
      Iterable<String> result = Sequence.fromIterable(lscope.getAvailableElements(null)).where(new IWhereFilter<SNode>() {
        public boolean accept(SNode it) {
          return SNodeOperations.isInstanceOf(it, "jetbrains.mps.core.notation.structure.SNotation") && SNodeOperations.isInstanceOf(SLinkOperations.getTarget(SNodeOperations.cast(it, "jetbrains.mps.core.notation.structure.SNotation"), "context", true), "jetbrains.mps.core.notation.structure.SNotationConceptContext") && BehaviorReflection.invokeVirtual(Boolean.TYPE, SLinkOperations.getTarget(node, "element", false), "virtual_isSubConceptOf_5938997310819191538", new Object[]{SLinkOperations.getTarget(SNodeOperations.cast(SLinkOperations.getTarget(SNodeOperations.cast(it, "jetbrains.mps.core.notation.structure.SNotation"), "context", true), "jetbrains.mps.core.notation.structure.SNotationConceptContext"), "element", false)});
        }
