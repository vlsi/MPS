...
public class SNotationStyleSelector_Editor extends DefaultNodeEditor {
  public EditorCell createEditorCell(EditorContext editorContext, SNode node) {
    return this.createCollection_ycx4so_a(editorContext, node);
  }

  private EditorCell createCollection_ycx4so_a(EditorContext editorContext, SNode node) {
    ...
    editorCell.addEditorCell(this.createRefNodeList_ycx4so_d0(editorContext, node));
    return editorCell;
  }
  ...
  private EditorCell createRefNode_ycx4so_b0(EditorContext editorContext, SNode node) {
    ...
    if (editorCell.getRole() == null) {
      editorCell.setRole("notationSelector");
    }
  ...
  private EditorCell createRefNodeList_ycx4so_d0(EditorContext editorContext, SNode node) {
    AbstractCellListHandler handler = new SNotationStyleSelector_Editor.termSelectorListHandler_ycx4so_d0(node, "termSelector", editorContext);
    EditorCell_Collection editorCell = handler.createCells(editorContext, new CellLayout_Indent(), false);
    editorCell.setCellId("refNodeList_termSelector");
    editorCell.setRole(handler.getElementRole());
    return editorCell;
  }

  private static class termSelectorListHandler_ycx4so_d0 extends RefNodeListHandler {
    public termSelectorListHandler_ycx4so_d0(SNode ownerNode, String childRole, EditorContext context) {
