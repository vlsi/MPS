...
public class SNotationConceptContext_Behavior {
  ...
  public static SNode call_getBaseNotation_8200039929379506936(final SNode thisNode) {
    ...
    Iterable<SNode> result = Sequence.fromIterable(lscope.getAvailableElements(null)).where(new IWhereFilter<SNode>() {
      public boolean accept(SNode it) {
        return SNodeOperations.isInstanceOf(it, "jetbrains.mps.core.notation.structure.SNotation") && it != SNodeOperations.getParent(thisNode) && SNodeOperations.isInstanceOf(SLinkOperations.getTarget(SNodeOperations.cast(it, "jetbrains.mps.core.notation.structure.SNotation"), "context", true), "jetbrains.mps.core.notation.structure.SNotationConceptContext") && BehaviorReflection.invokeVirtual(Boolean.TYPE, SLinkOperations.getTarget(thisNode, "element", false), "virtual_isSubConceptOf_5938997310819191538", new Object[]{SLinkOperations.getTarget(SNodeOperations.cast(SLinkOperations.getTarget(SNodeOperations.cast(it, "jetbrains.mps.core.notation.structure.SNotation"), "context", true), "jetbrains.mps.core.notation.structure.SNotationConceptContext"), "element", false)});
      }
  ...
  public static boolean virtual_isApplicable_5566195403253848024(SNode thisNode, NotationContext context) {
    return !(context.isMultiple()) && SNodeOperations.isInstanceOf(context.getNode(), "jetbrains.mps.core.structure.structure.SAbstractConcept") && BehaviorReflection.invokeVirtual(Boolean.TYPE, SNodeOperations.cast(context.getNode(), "jetbrains.mps.core.structure.structure.SAbstractConcept"), "virtual_isSubConceptOf_5938997310819191538", new Object[]{SLinkOperations.getTarget(thisNode, "element", false)});
  }
