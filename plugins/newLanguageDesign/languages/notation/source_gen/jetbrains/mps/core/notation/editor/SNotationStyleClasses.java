...
public class SNotationStyleClasses implements ConceptEditorComponent {
  ...
  public EditorCell createEditorCell(EditorContext editorContext, SNode node) {
    return this.createCollection_hu0sdh_a(editorContext, node);
  }
  ...
  private static class styleClassListHandler_hu0sdh_a0 extends RefNodeListHandler {
    public styleClassListHandler_hu0sdh_a0(SNode ownerNode, String childRole, EditorContext context) {
