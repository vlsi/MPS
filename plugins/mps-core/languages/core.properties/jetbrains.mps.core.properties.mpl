...
<language namespace="jetbrains.mps.core.properties" uuid="58f98fef-90ad-4b72-a390-fad66ec7005a" version="0">
  <models>
  ...
  <accessoryModels />
  <generators>
    <generator name="void" generatorUID="jetbrains.mps.core.properties#6896005762093550227" uuid="ae6a71ff-9b6b-4518-969c-289320a7c8e2">
      <models>
        <modelRoot contentPath="${module}" type="default">
