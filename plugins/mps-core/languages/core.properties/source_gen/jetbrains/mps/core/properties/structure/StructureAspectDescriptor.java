...
public class StructureAspectDescriptor extends BaseStructureAspectDescriptor {
  ...
  /*package*/ final ConceptDescriptor myConceptPropertiesDeclaration = new ConceptDescriptorBuilder("jetbrains.mps.core.properties.structure.PropertiesDeclaration", MetaIdFactory.conceptId(UUID.fromString("58f98fef-90ad-4b72-a390-fad66ec7005a"), 3961775458390522561L)).super_("jetbrains.mps.core.properties.structure.PropertiesLine").super_(MetaIdFactory.conceptId(UUID.fromString("58f98fef-90ad-4b72-a390-fad66ec7005a"), 3961775458390522562L)).parents("jetbrains.mps.core.properties.structure.PropertiesLine", "jetbrains.mps.lang.core.structure.INamedConcept").parentIds(MetaIdFactory.conceptId(UUID.fromString("58f98fef-90ad-4b72-a390-fad66ec7005a"), 3961775458390522562L), MetaIdFactory.conceptId(UUID.fromString("ceab5195-25ea-4f22-9b92-103b95ca8c0c"), 1169194658468L)).propertyDescriptors(new ConceptDescriptorBuilder.Prop(3961775458390522596L, "value")).properties("value").alias("property", "").create();
  /*package*/ final ConceptDescriptor myConceptPropertiesFile = new ConceptDescriptorBuilder("jetbrains.mps.core.properties.structure.PropertiesFile", MetaIdFactory.conceptId(UUID.fromString("58f98fef-90ad-4b72-a390-fad66ec7005a"), 3961775458390517588L)).super_("jetbrains.mps.lang.core.structure.BaseConcept").super_(MetaIdFactory.conceptId(UUID.fromString("ceab5195-25ea-4f22-9b92-103b95ca8c0c"), 1133920641626L)).parents("jetbrains.mps.lang.core.structure.BaseConcept", "jetbrains.mps.lang.core.structure.INamedConcept", "jetbrains.mps.lang.traceable.structure.UnitConcept").parentIds(MetaIdFactory.conceptId(UUID.fromString("ceab5195-25ea-4f22-9b92-103b95ca8c0c"), 1133920641626L), MetaIdFactory.conceptId(UUID.fromString("ceab5195-25ea-4f22-9b92-103b95ca8c0c"), 1169194658468L), MetaIdFactory.conceptId(UUID.fromString("9ded098b-ad6a-4657-bfd9-48636cfe8bc3"), 5067982036267369892L)).childDescriptors(new ConceptDescriptorBuilder.Link(3961775458390522563L, "lines", MetaIdFactory.conceptId(UUID.fromString("58f98fef-90ad-4b72-a390-fad66ec7005a"), 3961775458390522562L), true, true, false)).children(new String[]{"lines"}, new boolean[]{true}).alias("properties file", "").create();
  /*package*/ final ConceptDescriptor myConceptPropertiesLine = new ConceptDescriptorBuilder("jetbrains.mps.core.properties.structure.PropertiesLine", MetaIdFactory.conceptId(UUID.fromString("58f98fef-90ad-4b72-a390-fad66ec7005a"), 3961775458390522562L)).super_("jetbrains.mps.lang.core.structure.BaseConcept").super_(MetaIdFactory.conceptId(UUID.fromString("ceab5195-25ea-4f22-9b92-103b95ca8c0c"), 1133920641626L)).parents("jetbrains.mps.lang.core.structure.BaseConcept").parentIds(MetaIdFactory.conceptId(UUID.fromString("ceab5195-25ea-4f22-9b92-103b95ca8c0c"), 1133920641626L)).alias("<empty line>", "").create();
