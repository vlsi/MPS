...
/*package*/ class XmlEntityRef_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createConstant_40aq2x_a0() {
    ...
    style.set(StyleAttributes.PUNCTUATION_LEFT, _StyleParameter_QueryFunction_40aq2x_a1a0(getEditorContext(), getNode()));
  ...
  private EditorCell createConstant_40aq2x_c0() {
    ...
    style.set(StyleAttributes.PUNCTUATION_RIGHT, _StyleParameter_QueryFunction_40aq2x_a1c0(getEditorContext(), getNode()));
    editorCell.getStyle().putAll(style);
    editorCell.setDefaultText("");
    return editorCell;
  }
