...
/*package*/ class XmlCDATA_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createConstant_ei20sr_a0() {
    ...
    style.set(StyleAttributes.PUNCTUATION_LEFT, _StyleParameter_QueryFunction_ei20sr_a1a0(getEditorContext(), getNode()));
  ...
  private EditorCell createConstant_ei20sr_c0() {
    ...
    style.set(StyleAttributes.PUNCTUATION_RIGHT, _StyleParameter_QueryFunction_ei20sr_a1c0(getEditorContext(), getNode()));
    editorCell.getStyle().putAll(style);
    editorCell.setDefaultText("");
    return editorCell;
  }
