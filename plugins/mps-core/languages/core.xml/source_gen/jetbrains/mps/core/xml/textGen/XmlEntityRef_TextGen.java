...
public class XmlEntityRef_TextGen extends SNodeTextGen {
  public void doGenerateText(SNode node) {
    ...
    this.append("&");
    this.append(SPropertyOperations.getString(node, MetaAdapterFactory.getProperty(0x479c7a8c02f943b5L, 0x9139d910cb22f298L, 0x16838b3fce9c6f4dL, 0x16838b3fce9c6f8fL, "entityName")));
    this.append(";");
  }
}
