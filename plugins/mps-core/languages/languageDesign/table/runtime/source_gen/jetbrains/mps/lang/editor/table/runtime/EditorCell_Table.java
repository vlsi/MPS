...
public class EditorCell_Table extends EditorCell_Collection {
  ...
  private EditorCell createRowOutermostCell(final int rowNumber, String cellId, boolean beggining) {
    ...
    emptyCell.setAction(CellActionType.DELETE, new CellAction_DeleteNode(getSNode(), false));
    emptyCell.setAction(CellActionType.BACKSPACE, new CellAction_DeleteNode(getSNode(), true));
    if (beggining) {
