...
public class CellModel_Checkbox_Constraints extends BaseConstraintsDescriptor {
  public CellModel_Checkbox_Constraints() {
    super(MetaIdFactory.conceptId(0x602c36adcc5547ffL, 0x8c4073d7f12f035cL, 0x455f8dda63d6378L));
  }
  @Override
  protected Map<SReferenceLinkId, ReferenceConstraintsDescriptor> getNotDefaultSReferenceLinks() {
    Map<SReferenceLinkId, ReferenceConstraintsDescriptor> references = new HashMap<SReferenceLinkId, ReferenceConstraintsDescriptor>();
    references.put(MetaIdFactory.refId(0x602c36adcc5547ffL, 0x8c4073d7f12f035cL, 0x455f8dda63d6378L, 0x334adf8cb15f3fdfL), new BaseReferenceConstraintsDescriptor(MetaIdFactory.refId(0x602c36adcc5547ffL, 0x8c4073d7f12f035cL, 0x455f8dda63d6378L, 0x334adf8cb15f3fdfL), this) {
      @Override
      ...
      public ReferenceScopeProvider getScopeProvider() {
        return new BaseReferenceScopeProvider() {
          ...
          public SNodeReference getSearchScopeValidatorNode() {
            return breakingNode_glszdl_a0a1a0a0a1a0b0a1a1;
          }
        };
      }
    });
  ...
  private static SNodePointer breakingNode_glszdl_a0a1a0a0a1a0b0a1a1 = new SNodePointer("r:de912216-b4aa-4118-a243-c861c965b4d9(jetbrains.mps.lang.editor.forms.constraints)", "7569401714696485317");
}
