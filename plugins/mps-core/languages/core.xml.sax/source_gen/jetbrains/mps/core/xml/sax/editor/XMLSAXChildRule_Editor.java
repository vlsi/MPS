...
public class XMLSAXChildRule_Editor extends DefaultNodeEditor {
  ...
  private static boolean renderingCondition_wbyfib_a1a(SNode node, EditorContext editorContext, IScope scope) {
    return (SLinkOperations.getTarget(node, "rule", false) != null) && (isEmpty_wbyfib_a0a0a0a5(SPropertyOperations.getString(SLinkOperations.getTarget(node, "rule", false), "tagName")) || SPropertyOperations.getBoolean(node, "overrideTag"));
  }
  ...
  private static boolean renderingCondition_wbyfib_a0a(SNode node, EditorContext editorContext, IScope scope) {
    return (SLinkOperations.getTarget(node, "rule", false) != null) && (isEmpty_wbyfib_a0a0a0a41(SPropertyOperations.getString(SLinkOperations.getTarget(node, "rule", false), "tagName")) || SPropertyOperations.getBoolean(node, "overrideTag"));
  }
  ...
  private static boolean renderingCondition_wbyfib_a1a_0(SNode node, EditorContext editorContext, IScope scope) {
    return (SLinkOperations.getTarget(node, "rule", false) != null) && isNotEmpty_wbyfib_a0a0a81(SPropertyOperations.getString(SLinkOperations.getTarget(node, "rule", false), "tagName"));
  }
  ...
  public static boolean isEmpty_wbyfib_a0a0a0a5(String str) {
    return str == null || str.length() == 0;
  }

  public static boolean isEmpty_wbyfib_a0a0a0a41(String str) {
    return str == null || str.length() == 0;
  }

  public static boolean isNotEmpty_wbyfib_a0a0a81(String str) {
    return str != null && str.length() > 0;
  }
}
