...
public class FullASTConverter extends ASTConverter {
  ...
  public List<SNode> convertStatementsOf(AbstractMethodDeclaration x, SNode bodyInto) throws ReflectException {
    ...
    if (expression instanceof Literal) {
      ...
      if (expression.constant != null) {
        if (expression.constant != Constant.NotAConstant) {
          ...
          result = _quotation_createNode_f46ocm_a0b0a0a1a1a01(NameUtil.escapeString(new String(((Literal) expression).source())));
        }
      }
    }
    if ((result == null)) {
  ...
  /*package*/ SNode convertStatement(ForStatement x) throws ReflectException {
    ...
    if (ListSequence.fromList(init).any(new IWhereFilter<SNode>() {
      ...
      result = _quotation_createNode_f46ocm_a0b0d0y(init, forStatement);
  ...
  public SNode convertExpression(Expression exp) {
    if (exp instanceof TrueLiteral) {
      return _quotation_createNode_f46ocm_a0a0a27();
    } else if (exp instanceof FalseLiteral) {
      return _quotation_createNode_f46ocm_a0a0a0uc();
    } else if (exp instanceof StringLiteral) {
      return _quotation_createNode_f46ocm_a0a1a0uc(new String(((StringLiteral) exp).source()));
      ...
      // FIXME 
      return _quotation_createNode_f46ocm_a1a4a0uc();
    } else {
  ...
  private static SNode _quotation_createNode_f46ocm_a0b0a0a1a1a01(Object parameter_1) {
  ...
  private static SNode _quotation_createNode_f46ocm_a0b0d0y(Object parameter_1, Object parameter_2) {
  ...
  private static SNode _quotation_createNode_f46ocm_a0a0a27() {
  ...
  private static SNode _quotation_createNode_f46ocm_a0a0a0uc() {
    SNode quotedNode_1 = null;
    quotedNode_1 = SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.baseLanguage.structure.BooleanConstant", null, null, GlobalScope.getInstance(), false);
    return quotedNode_1;
  }

  private static SNode _quotation_createNode_f46ocm_a0a1a0uc(Object parameter_1) {
    SNode quotedNode_2 = null;
    quotedNode_2 = SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.baseLanguage.structure.StringLiteral", null, null, GlobalScope.getInstance(), false);
    quotedNode_2.setProperty("value", (String) parameter_1);
    return quotedNode_2;
  ...
  private static SNode _quotation_createNode_f46ocm_a1a4a0uc() {
    SNode quotedNode_1 = null;
