...
public class OverrideImplementMethodsHelper {
  ...
  private static SNode _quotation_createNode_tfz3o4_a0a0a2a3a8() {
    ...
    quotedNode_1.setReference("annotation", jetbrains.mps.smodel.SReference.create("annotation", quotedNode_1, SModelReference.fromString("f:java_stub#6354ebe7-c22a-4a0f-ac54-50b52ab9b065#java.lang(JDK/java.lang@java_stub)"), SNodeId.fromString("~Override")));
    return quotedNode_1;
  }
