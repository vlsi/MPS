...
public class ASTConverter {
  ...
  private List<Tuples._4<SNode, CompilationUnitDeclaration, Integer, Integer>> myBlocks = ListSequence.fromList(new ArrayList<Tuples._4<SNode, CompilationUnitDeclaration, Integer, Integer>>());
  ...
  public SNode convertExpressionRefl(Expression expression) {
    ...
    if (expression instanceof Literal && expression.constant != null) {
      if (expression.constant != Constant.NotAConstant) {
        ...
        result = new ASTConverter.QuotationClass_rbndtb_a0a1a0a0b0n().createNode(NameUtil.escapeString(new String(((Literal) expression).source())));
      }
    }
    if ((result == null)) {
  ...
  /*package*/ SNode convertStatement(Block x) {
    ...
    SLinkOperations.getTargets(statementList, "statement", true).addAll(convertStatements(x.statements));
  ...
  /*package*/ SNode convertStatement(ExplicitConstructorCall x) {
    throw new UnsupportedOperationException("TBD: Explicit constructor call");
  }
  ...
  /*package*/ SNode processStatement(ForStatement x) {
    ...
    if (ListSequence.fromList(init).any(new IWhereFilter<SNode>() {
      ...
      result = new ASTConverter.QuotationClass_rbndtb_a0a1a3a72().createNode(init, forStatement);
  ...
  /*package*/ SNode processStatement(IfStatement x) {
    ...
    SNode elseStmt = convertStatementRefl(x.elseStatement);
  ...
  /*package*/ SNode processExpression(SingleNameReference x) {
    throw new JavaParseException("WILL IMPLEMENT IT IN A SECOND");
  }
  ...
  public SNode convertExpression(Expression exp) {
    if (exp instanceof TrueLiteral) {
      return new ASTConverter.QuotationClass_rbndtb_a0a0a0oc().createNode();
    } else if (exp instanceof FalseLiteral) {
      return new ASTConverter.QuotationClass_rbndtb_a0a0a0a66().createNode();
    } else if (exp instanceof StringLiteral) {
      return new ASTConverter.QuotationClass_rbndtb_a0a0b0a66().createNode(new String(((StringLiteral) exp).source()));
      ...
      // FIXME 
      return new ASTConverter.QuotationClass_rbndtb_a0b0e0a66().createNode();
    } else {
  ...
  private void addBlock(SNode node, int start, int end) {
    ListSequence.fromList(myBlocks).addElement(MultiTuple.<SNode,CompilationUnitDeclaration,Integer,Integer>from(node, myCud, Math.abs(start), Math.abs(end)));
  }
  ...
  public static class QuotationClass_rbndtb_a0a1a0a0b0n {
    public QuotationClass_rbndtb_a0a1a0a0b0n() {
    }
  ...
  public static class QuotationClass_rbndtb_a0a1a3a72 {
    public QuotationClass_rbndtb_a0a1a3a72() {
    }
  ...
  public static class QuotationClass_rbndtb_a0a0a0oc {
    public QuotationClass_rbndtb_a0a0a0oc() {
    }
  ...
  public static class QuotationClass_rbndtb_a0a0a0a66 {
    public QuotationClass_rbndtb_a0a0a0a66() {
    }
  ...
  public static class QuotationClass_rbndtb_a0a0b0a66 {
    public QuotationClass_rbndtb_a0a0b0a66() {
    }
  ...
  public static class QuotationClass_rbndtb_a0b0e0a66 {
    public QuotationClass_rbndtb_a0b0e0a66() {
    }
