...
public class ASTConverter {
  ...
  /*package*/ SNode convertExpression(QualifiedNameReference x) {
    ...
    for (int i = 0; i < tokens.length; i++) {
      ...
      ListSequence.fromList(SLinkOperations.getTargets(unkName, "token", true)).addElement(new ASTConverter.QuotationClass_rbndtb_a0a0b0f0tc().createNode(tokens[i]));
    }
  ...
  public SNode convertExpression(Expression exp) {
    if (exp instanceof TrueLiteral) {
      return new ASTConverter.QuotationClass_rbndtb_a0a0a0dd().createNode();
    } else if (exp instanceof FalseLiteral) {
      return new ASTConverter.QuotationClass_rbndtb_a0a0a0a18().createNode();
    } else if (exp instanceof StringLiteral) {
      return new ASTConverter.QuotationClass_rbndtb_a0a0b0a18().createNode(new String(((StringLiteral) exp).source()));
      ...
      // FIXME 
      return new ASTConverter.QuotationClass_rbndtb_a0b0e0a18().createNode();
    } else {
  ...
  public static class QuotationClass_rbndtb_a0a0b0f0tc {
    public QuotationClass_rbndtb_a0a0b0f0tc() {
    }
  ...
  public static class QuotationClass_rbndtb_a0a0a0j0g0a8a37 {
    public QuotationClass_rbndtb_a0a0a0j0g0a8a37() {
    }
  ...
  public static class QuotationClass_rbndtb_a0a0a0dd {
    public QuotationClass_rbndtb_a0a0a0dd() {
    }
  ...
  public static class QuotationClass_rbndtb_a0a0a0a18 {
    public QuotationClass_rbndtb_a0a0a0a18() {
    }
  ...
  public static class QuotationClass_rbndtb_a0a0b0a18 {
    public QuotationClass_rbndtb_a0a0b0a18() {
    }
  ...
  public static class QuotationClass_rbndtb_a0b0e0a18 {
    public QuotationClass_rbndtb_a0b0e0a18() {
    }
