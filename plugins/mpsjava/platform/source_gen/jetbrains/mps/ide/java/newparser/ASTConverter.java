...
public class ASTConverter {
  ...
  public ASTConverter(String pkg, CompilationUnitDeclaration cud, boolean ignoreMethodBodies, TypeNameResolver typeResolver) {
    if (typeResolver == null) {
      myTypeResolver = new TypeNameResolver(pkg);
    } else {
      myTypeResolver = typeResolver;
    }
    myConvertBodies = !(ignoreMethodBodies);
  }
    ...
    if (expression instanceof Literal) {
      ...
      if (expression.constant != null) {
        if (expression.constant != Constant.NotAConstant) {
          ...
          result = new ASTConverter.QuotationClass_rbndtb_a0a1a0a0b0b0o().createNode(NameUtil.escapeString(new String(((Literal) expression).source())));
        }
      }
    }
    if ((result == null)) {
  ...
  /*package*/ SNode convertStatement(ForStatement x) {
    ...
    if (ListSequence.fromList(init).any(new IWhereFilter<SNode>() {
      ...
      result = new ASTConverter.QuotationClass_rbndtb_a0a1a3a82().createNode(init, forStatement);
  ...
  /*package*/ SNode convertExpression(QualifiedNameReference x) {
    ...
    for (int i = 0; i < tokens.length; i++) {
      ...
      ListSequence.fromList(SLinkOperations.getTargets(unkName, "token", true)).addElement(new ASTConverter.QuotationClass_rbndtb_a0a0b0f0oc().createNode(tokens[i]));
    }
    ...
    if (x.receiver instanceof ThisReference && ((ThisReference) x.receiver).isImplicitThis()) {
      ...
      if (receiver instanceof NameReference) {
        ...
        for (String tok : tokens) {
          ListSequence.fromList(SLinkOperations.getTargets(unkDotCall, "token", true)).addElement(new ASTConverter.QuotationClass_rbndtb_a0a0a0j0g0a8a86().createNode(tok));
        }
  ...
  /*package*/ SNode convertExpression(AllocationExpression x) {
    ...
    x.type.printExpression(0, sb2);
    String typeName2 = sb2.toString();
    SPropertyOperations.set(unkNew, "className", typeName2);
  ...
  public SNode convertExpression(Expression exp) {
    if (exp instanceof TrueLiteral) {
      return new ASTConverter.QuotationClass_rbndtb_a0a0a0yc().createNode();
    } else if (exp instanceof FalseLiteral) {
      return new ASTConverter.QuotationClass_rbndtb_a0a0a0a67().createNode();
    } else if (exp instanceof StringLiteral) {
      return new ASTConverter.QuotationClass_rbndtb_a0a0b0a67().createNode(new String(((StringLiteral) exp).source()));
      ...
      // FIXME 
      return new ASTConverter.QuotationClass_rbndtb_a0b0e0a67().createNode();
    } else {
  ...
  public static class QuotationClass_rbndtb_a0a1a0a0b0b0o {
    public QuotationClass_rbndtb_a0a1a0a0b0b0o() {
    }
  ...
  public static class QuotationClass_rbndtb_a0a1a3a82 {
    public QuotationClass_rbndtb_a0a1a3a82() {
    }
  ...
  public static class QuotationClass_rbndtb_a0a0b0f0oc {
    public QuotationClass_rbndtb_a0a0b0f0oc() {
    }
  ...
  public static class QuotationClass_rbndtb_a0a0a0j0g0a8a86 {
    public QuotationClass_rbndtb_a0a0a0j0g0a8a86() {
    }
  ...
  public static class QuotationClass_rbndtb_a0a0a0yc {
    public QuotationClass_rbndtb_a0a0a0yc() {
    }
  ...
  public static class QuotationClass_rbndtb_a0a0a0a67 {
    public QuotationClass_rbndtb_a0a0a0a67() {
    }
  ...
  public static class QuotationClass_rbndtb_a0a0b0a67 {
    public QuotationClass_rbndtb_a0a0b0a67() {
    }
  ...
  public static class QuotationClass_rbndtb_a0b0e0a67 {
    public QuotationClass_rbndtb_a0b0e0a67() {
    }
