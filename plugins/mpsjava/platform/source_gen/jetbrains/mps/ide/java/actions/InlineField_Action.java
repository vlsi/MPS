...
public class InlineField_Action extends BaseAction {
  ...
  public boolean isApplicable(AnActionEvent event, final Map<String, Object> _params) {
    ...
    return (isFieldDeclaration || isStaticFieldDeclaration) && !(((EditorComponent) MapSequence.fromMap(_params).get("editorComponent")).isReadOnly());
  }
      ...
      ModelAccess.instance().runReadAction(new Runnable() {
        public void run() {
          if (SNodeOperations.isInstanceOf(((SNode) MapSequence.fromMap(_params).get("node")), "jetbrains.mps.baseLanguage.structure.FieldDeclaration") || SNodeOperations.isInstanceOf(((SNode) MapSequence.fromMap(_params).get("node")), "jetbrains.mps.baseLanguage.structure.StaticFieldDeclaration")) {
            ...
            int nodesCount = Sequence.fromIterable(inlineVARef.findAllReferences(fieldDeclaration)).count();
            if (nodesCount == 0) {
