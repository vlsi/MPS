...
<solution name="jetbrains.mps.ide.java.platform" uuid="f33a6c9c-f660-4bdb-aecd-2d144c61f7d2" pluginKind="PLUGIN_OTHER" compileInMPS="false" generatorOutputPath="${solution_descriptor}/source_gen">
  <models>
