...
public class JavaToMps_Test extends BaseTransformationTest {
  ...
  public static class TestBody extends BaseTestBody {
    ...
    public void test_LittleSource() throws Exception {
      ...
      addNodeById("1218582063869484737");
      addNodeById("8083368042256419833");
      Utils.checkSourceModel(myProject, PathManager.getHomePath() + "/plugins/mpsjava/tests/singleFiles/statements", SModelRepository.getInstance().getModelDescriptor("jetbrains.mps.ide.java.testMaterial.singleFiles"));
    }
