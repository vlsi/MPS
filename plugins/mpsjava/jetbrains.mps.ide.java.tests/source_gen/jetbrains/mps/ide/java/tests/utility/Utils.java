...
public class Utils {
  ...
  public static void buildMethodsNodeMap(SNode left, SNode right, Map<SNode, SNode> nodeMap) {
    ...
    ListSequence.fromList(leftMethods).addSequence(Sequence.fromIterable(Classifier_BehaviorDescriptor.methods_id4_LVZ3pBKCn.invoke(left)));
    ListSequence.fromList(rightMethods).addSequence(Sequence.fromIterable(Classifier_BehaviorDescriptor.methods_id4_LVZ3pBKCn.invoke(right)));
