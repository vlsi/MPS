...
<solution name="jetbrains.mps.ide.java.sourceStubs" uuid="77cb6858-037c-4d16-bec3-aa1eda698a48" pluginKind="PLUGIN_CORE" compileInMPS="true">
  <models>
  ...
  <stubModelEntries>
    <stubModelEntry path="${mps_home}/plugins/mpsjava/lib/mps-java-core.jar">
      <manager moduleId="f3061a53-9226-4cc5-a443-f952ceaf5816" className="jetbrains.mps.baseLanguage.stubs.JavaStubs" />
    </stubModelEntry>
  </stubModelEntries>
  <sourcePath />
