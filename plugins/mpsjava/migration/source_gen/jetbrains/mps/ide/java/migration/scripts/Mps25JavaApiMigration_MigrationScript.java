...
public class Mps25JavaApiMigration_MigrationScript extends BaseMigrationScript {
  public Mps25JavaApiMigration_MigrationScript(IOperationContext operationContext) {
    ...
    this.addRefactoring(new AbstractMigrationRefactoring(operationContext) {
      ...
      public boolean isApplicableInstanceNode(SNode node) {
        return StubRefUtil.isClassCreator(node, "r:00000000-0000-4000-0000-011c895902c8(jetbrains.mps.baseLanguage.plugin)", "1208785806875");
      }
  ...
  private static SNode _quotation_createNode_w2cjpg_a0a2a0a() {
    ...
    quotedNode_1.setReference("variableDeclaration", SReference.create("variableDeclaration", quotedNode_1, facade.createModelReference("f:java_stub#6354ebe7-c22a-4a0f-ac54-50b52ab9b065#java.awt(JDK/java.awt@java_stub)"), facade.createNodeId("~Color.BLUE")));
    return quotedNode_1;
  }
  ...
  private static SNode _quotation_createNode_w2cjpg_b0d0a0(Object parameter_1) {
    ...
    quotedNode_3.setReference("classifier", SReference.create("classifier", quotedNode_3, facade.createModelReference("f:java_stub#1ed103c3-3aa6-49b7-9c21-6765ee11f224#jetbrains.mps.nodeEditor(MPS.Editor/jetbrains.mps.nodeEditor@java_stub)"), facade.createNodeId("~DefaultEditorMessage")));
    quotedNode_3.setReference("baseMethodDeclaration", SReference.create("baseMethodDeclaration", quotedNode_3, facade.createModelReference("f:java_stub#1ed103c3-3aa6-49b7-9c21-6765ee11f224#jetbrains.mps.nodeEditor(MPS.Editor/jetbrains.mps.nodeEditor@java_stub)"), facade.createNodeId("~DefaultEditorMessage.<init>(org.jetbrains.mps.openapi.model.SNode,java.awt.Color,java.lang.String,jetbrains.mps.openapi.editor.message.EditorMessageOwner)")));
    {
    ...
    quotedNode_14.setReference("classifier", SReference.create("classifier", quotedNode_14, facade.createModelReference("f:java_stub#6354ebe7-c22a-4a0f-ac54-50b52ab9b065#java.awt(JDK/java.awt@java_stub)"), facade.createNodeId("~Graphics")));
    ...
    quotedNode_15.setReference("classifier", SReference.create("classifier", quotedNode_15, facade.createModelReference("f:java_stub#1ed103c3-3aa6-49b7-9c21-6765ee11f224#jetbrains.mps.nodeEditor(MPS.Editor/jetbrains.mps.nodeEditor@java_stub)"), facade.createNodeId("~EditorComponent")));
    ...
    quotedNode_16.setReference("classifier", SReference.create("classifier", quotedNode_16, facade.createModelReference("f:java_stub#1ed103c3-3aa6-49b7-9c21-6765ee11f224#jetbrains.mps.nodeEditor.cells(MPS.Editor/jetbrains.mps.nodeEditor.cells@java_stub)"), facade.createNodeId("~EditorCell")));
    ...
    quotedNode_13.setReference("annotation", SReference.create("annotation", quotedNode_13, facade.createModelReference("f:java_stub#6354ebe7-c22a-4a0f-ac54-50b52ab9b065#java.lang(JDK/java.lang@java_stub)"), facade.createNodeId("~Override")));
