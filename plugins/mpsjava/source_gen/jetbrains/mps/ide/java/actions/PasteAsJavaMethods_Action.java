...
public class PasteAsJavaMethods_Action extends GeneratedAction {
  ...
  public boolean isApplicable(AnActionEvent event, final Map<String, Object> _params) {
    return (SNodeOperations.getAncestor(((SNode) ((SNode) MapSequence.<String,Object>fromMap(_params).get("anchorNode"))), "jetbrains.mps.baseLanguage.structure.Classifier", true, false) != null) && JavaPaster.areDataAvailableInClipboard();
  }
  ...
  public void doExecute(@NotNull final AnActionEvent event, final Map<String, Object> _params) {
    try {
      new JavaPaster().pasteJava(((SNode) MapSequence.<String,Object>fromMap(_params).get("anchorNode")), ((IOperationContext) MapSequence.<String,Object>fromMap(_params).get("operationContext")), FeatureKind.CLASS_CONTENT);
    } catch (Throwable t) {
      if (log.isErrorEnabled()) {
