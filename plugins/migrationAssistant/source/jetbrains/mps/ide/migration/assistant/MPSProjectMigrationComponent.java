...
public class MPSProjectMigrationComponent extends AbstractProjectComponent implements
    PersistentStateComponent<MPSProjectMigrationComponent.MyState> {

  private Object myAgent;
  private MyState myState;

  protected MPSProjectMigrationComponent(com.intellij.openapi.project.Project project, MPSProjectVersion version) {
    super(project);
  }
