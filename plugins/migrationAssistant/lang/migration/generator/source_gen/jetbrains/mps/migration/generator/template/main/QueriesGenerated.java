...
public class QueriesGenerated {
  ...
  public static Object propertyMacro_GetPropertyValue_4436301628118955289(final PropertyMacroContext _context) {
    return ModuleReferenceExpression_Behavior.call_getModule_4040588429969043137(SLinkOperations.getTarget(SNodeOperations.as(SLinkOperations.getTarget(_context.getNode(), "body", true), "jetbrains.mps.migration.structure.SecondaryMigrationScriptBody"), "module", true)).getModuleName();
  }

  public static Object propertyMacro_GetPropertyValue_4436301628118955319(final PropertyMacroContext _context) {
    return SPropertyOperations.getInteger(SNodeOperations.as(SLinkOperations.getTarget(_context.getNode(), "body", true), "jetbrains.mps.migration.structure.SecondaryMigrationScriptBody"), "primaryFrom");
  }

  public static Object propertyMacro_GetPropertyValue_4436301628118955345(final PropertyMacroContext _context) {
    return SPropertyOperations.getInteger(SNodeOperations.as(SLinkOperations.getTarget(_context.getNode(), "body", true), "jetbrains.mps.migration.structure.SecondaryMigrationScriptBody"), "primaryTo");
  }
