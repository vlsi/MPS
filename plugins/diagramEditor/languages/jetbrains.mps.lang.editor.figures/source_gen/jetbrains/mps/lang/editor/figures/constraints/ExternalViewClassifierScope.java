...
public class ExternalViewClassifierScope extends FilteringScope {
  ...
  public boolean isExcluded(SNode node) {
    ...
    return !(ListSequence.fromList(ClassConcept_Behavior.call_getAllSuperClassifiers_4892662966716545618(classConcept)).contains(SNodeOperations.getNode("f:java_stub#67b3c41d-58b3-4756-b971-30bf8a9d63e6#jetbrains.jetpad.projectional.view(Jetpad.Editor/jetbrains.jetpad.projectional.view@java_stub)", "~View")));
  }
}
