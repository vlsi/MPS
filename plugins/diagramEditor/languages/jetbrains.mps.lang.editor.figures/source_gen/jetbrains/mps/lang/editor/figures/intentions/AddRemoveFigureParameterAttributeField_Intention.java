  ...
  public class IntentionImplementation implements IntentionExecutable {
    ...
    public void execute(final SNode node, final EditorContext editorContext) {
      if (AttributeOperations.getAttribute(node, new IAttributeDescriptor.NodeAttribute("jetbrains.mps.lang.editor.figures.structure.FigureParameterAttributeField")) != null) {
        ...
        AttributeOperations.setAttribute(node, new IAttributeDescriptor.NodeAttribute("jetbrains.mps.lang.editor.figures.structure.FigureParameterAttributeField"), SConceptOperations.createNewNode(SNodeOperations.asInstanceConcept(MetaAdapterFactory.getConcept(new UUID(-2922223385321452486l, -5907006357078305369l), 2084788800270473590l, "jetbrains.mps.lang.editor.figures.structure.FigureParameterAttributeField"))));
      }
    }
