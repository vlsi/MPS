...
public final class FigureParameterAttributeField__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<SNode> getFieldDeclaration_id6RaK14zk5fe = new SMethodBuilder<SNode>(new SJavaCompoundTypeImpl((Class<SNode>) ((Class) Object.class))).name("getFieldDeclaration").modifiers(SModifiersImpl.create(0, AccessPrivileges.PUBLIC)).concept(CONCEPT).id("6RaK14zk5fe").registry(REGISTRY).build();
