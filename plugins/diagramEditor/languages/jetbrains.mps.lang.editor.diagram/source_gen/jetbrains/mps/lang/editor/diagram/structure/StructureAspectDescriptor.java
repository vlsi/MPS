...
public class StructureAspectDescriptor implements jetbrains.mps.smodel.runtime.StructureAspectDescriptor {
  ...
  public ConceptDescriptor getDescriptor(String conceptFqName) {
    switch (Arrays.binarySearch(stringSwitchCases_1htk8d_a0a0b, conceptFqName)) {
      ...
      case 6:
        return new ConceptDescriptorBuilder("jetbrains.mps.lang.editor.diagram.structure.ConnectionEndQualifier").super_("jetbrains.mps.lang.core.structure.BaseConcept").parents("jetbrains.mps.lang.core.structure.BaseConcept").references("link").children(new String[]{"pointID"}, new boolean[]{false}).create();
      case 7:
