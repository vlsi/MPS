...
public class AbstractDiagramCreation_Behavior {
  ...
  public static SNode call_getQueryDotExpression_2154068179222323285(SNode thisNode) {
    return SNodeOperations.as(SLinkOperations.getTarget(thisNode, MetaAdapterFactory.getContainmentLink(new UUID(6991546026468590289l, -9160623158338601007l), 1301388602725986966l, 1301388602726005547l, "query")), MetaAdapterFactory.getConcept(new UUID(-935030926396207931l, -6610165693999523818l), 1197027756228l, "jetbrains.mps.baseLanguage.structure.DotExpression"));
  }
}
