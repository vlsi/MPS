...
public abstract class DiagramCell extends AbstractJetpadCell implements EditorCell_WithComponent {
  ...
  public RootMapper getRootMapper() {
    if (myRootMapper == null) {
      myRootMapper = new RootMapper(getSNode(), createMapper(), myComponent.container());
    }
    return myRootMapper;
  }
