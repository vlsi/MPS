...
/*package*/ class ConnectorInstance_diagram_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  public ConnectorInstance_diagram_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  /*package*/ EditorCell createCell() {
    return createDiagramConnector_z1vupn_a();
  }

  private EditorCell createDiagramConnector_z1vupn_a() {
    final ConnectorCell editorCell = new ConnectorInstance_diagram_EditorBuilder_a.ConnectorCellImpl_z1vupn_a(getEditorContext(), myNode);
    editorCell.setCellId("DiagramConnector_z1vupn_a");
    editorCell.setBig(true);
    editorCell.setCellContext(getCellFactory().getCellContext());
    ConnectorActionMap.setCellActions(editorCell, myNode, getEditorContext());
    return editorCell;
  }
