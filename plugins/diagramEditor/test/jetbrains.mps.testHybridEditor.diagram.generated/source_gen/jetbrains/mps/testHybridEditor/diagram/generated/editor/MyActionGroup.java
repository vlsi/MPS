...
public class MyActionGroup implements PaletteActionGroup {
  ...
  public PaletteElement[] getElements() {
    ...
    for (SNode node : Sequence.fromIterable(myNodes).where(new IWhereFilter<SNode>() {
      ...
      ListSequence.fromList(paletteElements).addElement(new MyBlockCreationAction(myDiagramCell, SNodeOperations.cast(node, "jetbrains.mps.testHybridEditor.structure.MetaBlock")));
    }
