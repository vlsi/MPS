      ...
      myTrait = new ViewTraitBuilder().on(ViewEvents.MOUSE_DRAGGED, new ViewEventHandler<MouseEvent>() {
        ...
        public void handle(View view, MouseEvent event) {
          ...
          ModelAccess.instance().runWriteActionInCommand(new Runnable() {
            public void run() {
              SNode connectorInstance = SConceptOperations.createNewNode(SNodeOperations.asInstanceConcept(MetaAdapterFactory.getConcept(new UUID(-7982035075869357830l, -5979686021354407916l), 2353136177974088982l, "jetbrains.mps.testHybridEditor.structure.ConnectorInstance")));
              SLinkOperations.setTarget(connectorInstance, MetaAdapterFactory.getContainmentLink(new UUID(-7982035075869357830l, -5979686021354407916l), 2353136177974088982l, 5288989961863964096l, "source"), SConceptOperations.createNewNode(SNodeOperations.asInstanceConcept(MetaAdapterFactory.getConcept(new UUID(-7982035075869357830l, -5979686021354407916l), 5288989961863963745l, "jetbrains.mps.testHybridEditor.structure.ConnectorEndInstance"))));
