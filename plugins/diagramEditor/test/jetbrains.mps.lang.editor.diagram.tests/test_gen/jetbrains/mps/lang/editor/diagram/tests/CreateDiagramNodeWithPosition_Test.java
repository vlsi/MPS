  ...
  public static class TestBody extends BaseEditorTestBody {
    ...
    public void testMethodImpl() throws Exception {
      ...
      EditorComponent editorComponent = (EditorComponent) editor.getCurrentEditorComponent();
      {
        int x_a0_1 = 150;
        int y_a0 = 150;
        Component eventTargetComponent_a0_1 = BaseEditorTestBody.processMouseEvent(editorComponent, x_a0_1, y_a0, MouseEvent.MOUSE_PRESSED);
        BaseEditorTestBody.processSecondaryMouseEvent(eventTargetComponent_a0_1, x_a0_1, y_a0, MouseEvent.MOUSE_RELEASED);
        BaseEditorTestBody.processSecondaryMouseEvent(eventTargetComponent_a0_1, x_a0_1, y_a0, MouseEvent.MOUSE_CLICKED);
      }
