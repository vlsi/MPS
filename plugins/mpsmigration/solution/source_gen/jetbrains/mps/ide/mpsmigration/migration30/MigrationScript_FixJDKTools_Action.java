...
public class MigrationScript_FixJDKTools_Action extends BaseAction {
  private static final Icon ICON = null;

  public MigrationScript_FixJDKTools_Action() {
    super("Fix JDK.Tools references", "", ICON);
  ...
  public void doUpdate(@NotNull AnActionEvent event, final Map<String, Object> _params) {
    try {
      ...
      if (LOG.isEnabledFor(Priority.ERROR)) {
        LOG.error("User's action doUpdate method failed. Action:" + "MigrationScript_FixJDKTools", t);
      }
  ...
  public void doExecute(@NotNull final AnActionEvent event, final Map<String, Object> _params) {
    try {
      ...
      if (LOG.isEnabledFor(Priority.ERROR)) {
        LOG.error("User's action execute method failed. Action:" + "MigrationScript_FixJDKTools", t);
      }
    }
  }

  protected static Logger LOG = LogManager.getLogger(MigrationScript_FixJDKTools_Action.class);
}
