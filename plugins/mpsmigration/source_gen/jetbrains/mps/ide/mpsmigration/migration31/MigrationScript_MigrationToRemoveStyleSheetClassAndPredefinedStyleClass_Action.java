...
public class MigrationScript_MigrationToRemoveStyleSheetClassAndPredefinedStyleClass_Action extends BaseAction {
  ...
  public void doUpdate(@NotNull AnActionEvent event, final Map<String, Object> _params) {
    try {
      ...
      if (LOG.isEnabledFor(Level.ERROR)) {
        LOG.error("User's action doUpdate method failed. Action:" + "MigrationScript_MigrationToRemoveStyleSheetClassAndPredefinedStyleClass", t);
      }
  ...
  public void doExecute(@NotNull final AnActionEvent event, final Map<String, Object> _params) {
    try {
      ...
      MigrationScriptExecutor executor = new MigrationScriptExecutor(script, "EditorStylesMigration", ((IOperationContext) MapSequence.fromMap(_params).get("context")), ((Project) MapSequence.fromMap(_params).get("project")));
      ...
      if (LOG.isEnabledFor(Level.ERROR)) {
        LOG.error("User's action execute method failed. Action:" + "MigrationScript_MigrationToRemoveStyleSheetClassAndPredefinedStyleClass", t);
      }
    }
  }
