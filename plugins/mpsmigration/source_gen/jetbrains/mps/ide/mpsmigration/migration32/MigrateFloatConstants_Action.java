...
public class MigrateFloatConstants_Action extends BaseAction {
  ...
  public void doUpdate(@NotNull AnActionEvent event, final Map<String, Object> _params) {
    try {
      ...
      if (LOG.isEnabledFor(Level.ERROR)) {
        LOG.error("User's action doUpdate method failed. Action:" + "MigrateFloatConstants", t);
      }
  ...
  public void doExecute(@NotNull final AnActionEvent event, final Map<String, Object> _params) {
    try {
      ...
      if (LOG.isEnabledFor(Level.ERROR)) {
        LOG.error("User's action execute method failed. Action:" + "MigrateFloatConstants", t);
      }
    }
  }
  protected static Logger LOG = LogManager.getLogger(MigrateFloatConstants_Action.class);
}
