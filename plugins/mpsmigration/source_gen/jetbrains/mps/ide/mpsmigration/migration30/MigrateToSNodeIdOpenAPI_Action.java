...
public class MigrateToSNodeIdOpenAPI_Action extends BaseAction {
  ...
  public void doExecute(@NotNull final AnActionEvent event, final Map<String, Object> _params) {
    try {
      new ApiMigrationHelper(((MPSProject) MapSequence.fromMap(_params).get("project")), ((Project) MapSequence.fromMap(_params).get("iproject")), new ProjectScope(((MPSProject) MapSequence.fromMap(_params).get("project")))).migrateSNodeId();
    } catch (Throwable t) {
      if (LOG.isEnabledFor(Priority.ERROR)) {
