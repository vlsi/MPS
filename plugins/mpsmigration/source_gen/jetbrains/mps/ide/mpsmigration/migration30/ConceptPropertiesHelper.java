...
public class ConceptPropertiesHelper {
  ...
  private boolean needToMigrate(SNode node) {
    ...
    if ((SNodeOperations.isInstanceOf(node, "jetbrains.mps.lang.structure.structure.ConceptLink") || SNodeOperations.isInstanceOf(node, "jetbrains.mps.lang.structure.structure.ConceptProperty") || SNodeOperations.isInstanceOf(node, "jetbrains.mps.lang.structure.structure.ConceptPropertyDeclaration") || SNodeOperations.isInstanceOf(node, "jetbrains.mps.lang.structure.structure.ConceptLinkDeclaration")) && !(SNodeOperations.isInstanceOf(root, "jetbrains.mps.lang.structure.structure.AbstractConceptDeclaration"))) {
      return false;
    }
    return true;
  }
  ...
  private SNode replaceConceptPropertyDeclarations(SNode conceptPropertyDeclaration, Set<SNode> conceptProperties) {
    ...
    if (SConceptOperations.isExactly(((SNode) conceptNode), "jetbrains.mps.lang.core.structure.BaseConcept") && (eq_azpnkk_a0a0a0a0c0z_0(propName, ConceptPropertiesHelper.abstractName) || eq_azpnkk_a0a0a0a0c0z(propName, ConceptPropertiesHelper.finalName) || eq_azpnkk_a0a0a0a2a52(propName, ConceptPropertiesHelper.shortDescriptionName) || eq_azpnkk_a0a0a0c0z(propName, ConceptPropertiesHelper.aliasName) || eq_azpnkk_a0a0a2a52(propName, ConceptPropertiesHelper.dontSubstituteName))) {
      return null;
    }
    boolean valueIsDefault = true;
  ...
  private void replaceConceptLinkUsages(SNode conceptLink, SNode overridenMethod, Map<SNode, List<SNode>> completedConceptsByLinkDeclaration) {
    ...
    for (SNode superNode : SetSequence.fromSet(superNodes)) {
      ...
      ListSequence.fromList(SLinkOperations.getTargets(SLinkOperations.getTarget(method, "body", true), "statement", true)).addElement(_quotation_createNode_azpnkk_a0a6a71a62(superNodeExpression, superMethodCall, reference));
    }
    ...
    for (SNode link : SetSequence.fromSet(allLinks)) {
      SNode refExpression = SConceptOperations.createNewNode("jetbrains.mps.lang.smodel.structure.NodeRefExpression", null);
      SLinkOperations.setTarget(refExpression, "referentNode", SNodeOperations.cast(SLinkOperations.getTarget(SNodeOperations.cast(link, "jetbrains.mps.lang.structure.structure.ReferenceConceptLink"), "target", false), "jetbrains.mps.lang.core.structure.INamedConcept"), false);
      ListSequence.fromList(SLinkOperations.getTargets(SLinkOperations.getTarget(method, "body", true), "statement", true)).addElement(_quotation_createNode_azpnkk_a0a2a02a62(reference, refExpression));
    }

    ListSequence.fromList(SLinkOperations.getTargets(SLinkOperations.getTarget(method, "body", true), "statement", true)).addElement(_quotation_createNode_azpnkk_a0a22a62(reference));
  ...
  private void replaceConceptPropertyUsages(SNode conceptProperty, SNode overridenMethod) {
    ...
    if (SNodeOperations.getAncestor(SLinkOperations.getTarget(conceptProperty, "conceptPropertyDeclaration", false), "jetbrains.mps.lang.structure.structure.AbstractConceptDeclaration", false, false) == SConceptOperations.findConceptDeclaration("jetbrains.mps.lang.core.structure.BaseConcept")) {
      ...
      if (eq_azpnkk_a0b0e0bb(name, ConceptPropertiesHelper.aliasName)) {
        SPropertyOperations.set(conceptNode, "conceptAlias", SConceptPropertyOperations.getString(conceptNode, "alias"));
        return;
      } else if (eq_azpnkk_a0a1a4a72(name, ConceptPropertiesHelper.shortDescriptionName)) {
        ...
        return;
      } else if (eq_azpnkk_a0b1a4a72(name, ConceptPropertiesHelper.abstractName)) {
        SPropertyOperations.set(conceptNode, "abstract", "" + (SConceptPropertyOperations.getBoolean(conceptNode, "abstract")));
        return;
      } else if (eq_azpnkk_a0c1a4a72(name, ConceptPropertiesHelper.finalName)) {
        SPropertyOperations.set(conceptNode, "final", "" + (SConceptPropertyOperations.getBoolean(conceptNode, "final")));
        return;
      } else if (eq_azpnkk_a0d1a4a72(name, ConceptPropertiesHelper.dontSubstituteName)) {
  ...
  private boolean addMethodToBehavior(SNode concept, SNode method) {
    ...
    if (childConceptBehavior == null) {
      if (LOG.isEnabledFor(Priority.ERROR)) {
        LOG.error("ERROR. Behavior for concept " + BehaviorReflection.invokeNonVirtual(String.class, concept, "jetbrains.mps.lang.structure.structure.AbstractConceptDeclaration", "call_getPresentation_2450081617266859256", new Object[]{}) + " does not exist or cannot be created");
      }
      return false;
    } else {
  ...
  public SNode createMethod(String name, boolean isVirtual, SNode overridenMethod, SNode returnType) {
    ...
    SPropertyOperations.set(method, "name", NameUtil.toValidIdentifier(name));
  ...
  private void replaceAccessUsages(SNode accessOperation, SNode method) {
    ...
    if (SNodeOperations.getAncestor(SLinkOperations.getTarget(accessOperation, "conceptProperty", false), "jetbrains.mps.lang.structure.structure.AbstractConceptDeclaration", false, false) == SConceptOperations.findConceptDeclaration("jetbrains.mps.lang.core.structure.BaseConcept")) {
      if (eq_azpnkk_a0a0e0fb(accessName, ConceptPropertiesHelper.aliasName)) {
  ...
  private void replaceCellUsages(SNode cell, SNode method) {
    ...
    if (conceptNode == SConceptOperations.findConceptDeclaration("jetbrains.mps.lang.core.structure.BaseConcept")) {
      if (eq_azpnkk_a0a0c0jb(SPropertyOperations.getString(SLinkOperations.getTarget(cell, "relationDeclaration", false), "name"), ConceptPropertiesHelper.aliasName)) {
      ...
      } else if (eq_azpnkk_a0a0a2a53(SPropertyOperations.getString(SLinkOperations.getTarget(cell, "relationDeclaration", false), "name"), ConceptPropertiesHelper.shortDescriptionName)) {
    ...
    if (modelComponent == null) {
      ...
      SNode cellModel_ReadOnlyModelAccessor = _quotation_createNode_azpnkk_a0e0d0jb();
      ...
      SNode returnStatement;
      if (conceptNode == SConceptOperations.findConceptDeclaration("jetbrains.mps.lang.core.structure.BaseConcept") && eq_azpnkk_a0a7a3a53(SPropertyOperations.getString(SLinkOperations.getTarget(cell, "relationDeclaration", false), "name"), ConceptPropertiesHelper.dontSubstituteName)) {
        returnStatement = _quotation_createNode_azpnkk_a0a0h0d0jb(conceptFunctionParameter_node);
      } else {
        returnStatement = _quotation_createNode_azpnkk_a0a0a7a3a53(methodCall, conceptFunctionParameter_node);
      }
  ...
  private static SNode _quotation_createNode_azpnkk_a0a6a71a62(Object parameter_1, Object parameter_2, Object parameter_3) {
    PersistenceFacade facade = PersistenceFacade.getInstance();
    SNode quotedNode_4 = null;
    SNode quotedNode_5 = null;
    SNode quotedNode_6 = null;
  ...
  private static SNode _quotation_createNode_azpnkk_a0a2a02a62(Object parameter_1, Object parameter_2) {
    PersistenceFacade facade = PersistenceFacade.getInstance();
    SNode quotedNode_3 = null;
    SNode quotedNode_4 = null;
    SNode quotedNode_5 = null;
  ...
  private static SNode _quotation_createNode_azpnkk_a0a22a62(Object parameter_1) {
    PersistenceFacade facade = PersistenceFacade.getInstance();
    SNode quotedNode_2 = null;
    SNode quotedNode_3 = null;
    quotedNode_2 = SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.baseLanguage.structure.ReturnStatement", null, null, GlobalScope.getInstance(), false);
  ...
  private static SNode _quotation_createNode_azpnkk_b0a0a0e0fb(Object parameter_1) {
    ...
    quotedNode_3.setReference("property", SReference.create("property", quotedNode_3, facade.createModelReference("r:00000000-0000-4000-0000-011c89590292(jetbrains.mps.lang.structure.structure)"), facade.createNodeId("5092175715804935370")));
  ...
  private static SNode _quotation_createNode_azpnkk_a0a0b0b0a0e0fb(Object parameter_1) {
    ...
    quotedNode_11.setReference("concept", SReference.create("concept", quotedNode_11, facade.createModelReference("r:00000000-0000-4000-0000-011c89590288(jetbrains.mps.lang.core.structure)"), facade.createNodeId("1133920641626")));
    ...
    quotedNode_6.setReference("property", SReference.create("property", quotedNode_6, facade.createModelReference("r:00000000-0000-4000-0000-011c89590292(jetbrains.mps.lang.structure.structure)"), facade.createNodeId("5092175715804935370")));
  ...
  private static SNode _quotation_createNode_azpnkk_b0a0a0a4a13(Object parameter_1) {
    ...
    quotedNode_2 = SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.baseLanguage.structure.DotExpression", null, null, GlobalScope.getInstance(), false);
    quotedNode_3 = SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.lang.smodel.structure.SPropertyAccess", null, null, GlobalScope.getInstance(), false);
    quotedNode_3.setReference("property", SReference.create("property", quotedNode_3, facade.createModelReference("r:00000000-0000-4000-0000-011c89590288(jetbrains.mps.lang.core.structure)"), facade.createNodeId("1156234966388")));
    quotedNode_2.addChild("operation", quotedNode_3);
    quotedNode_4 = (SNode) parameter_1;
    if (quotedNode_4 != null) {
      quotedNode_2.addChild("operand", HUtil.copyIfNecessary(quotedNode_4));
  ...
  private static SNode _quotation_createNode_azpnkk_b0a0b0a4a13(Object parameter_1) {
    ...
    quotedNode_2 = SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.baseLanguage.structure.DotExpression", null, null, GlobalScope.getInstance(), false);
    quotedNode_3 = SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.lang.smodel.structure.SPropertyAccess", null, null, GlobalScope.getInstance(), false);
    quotedNode_3.setReference("property", SReference.create("property", quotedNode_3, facade.createModelReference("r:00000000-0000-4000-0000-011c89590292(jetbrains.mps.lang.structure.structure)"), facade.createNodeId("4628067390765956807")));
    quotedNode_2.addChild("operation", quotedNode_3);
    quotedNode_4 = (SNode) parameter_1;
    if (quotedNode_4 != null) {
      quotedNode_2.addChild("operand", HUtil.copyIfNecessary(quotedNode_4));
  ...
  private static SNode _quotation_createNode_azpnkk_b0a0c0a4a13(Object parameter_1) {
    ...
    quotedNode_2 = SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.baseLanguage.structure.DotExpression", null, null, GlobalScope.getInstance(), false);
    quotedNode_3 = SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.lang.smodel.structure.SPropertyAccess", null, null, GlobalScope.getInstance(), false);
    quotedNode_3.setReference("property", SReference.create("property", quotedNode_3, facade.createModelReference("r:00000000-0000-4000-0000-011c89590292(jetbrains.mps.lang.structure.structure)"), facade.createNodeId("4628067390765956802")));
    quotedNode_2.addChild("operation", quotedNode_3);
    quotedNode_4 = (SNode) parameter_1;
    if (quotedNode_4 != null) {
      quotedNode_2.addChild("operand", HUtil.copyIfNecessary(quotedNode_4));
  ...
  private static SNode _quotation_createNode_azpnkk_b0a0d0a4a13(Object parameter_1) {
    ...
    quotedNode_5.setReference("conceptDeclaration", SReference.create("conceptDeclaration", quotedNode_5, facade.createModelReference("r:00000000-0000-4000-0000-011c89590288(jetbrains.mps.lang.core.structure)"), facade.createNodeId("1835621062190663819")));
  ...
  private static SNode _quotation_createNode_azpnkk_a0e0d0jb() {
    PersistenceFacade facade = PersistenceFacade.getInstance();
    SNode quotedNode_1 = null;
    SNode quotedNode_2 = null;
    SNode quotedNode_3 = null;
  ...
  private static SNode _quotation_createNode_azpnkk_a0a0h0d0jb(Object parameter_1) {
    PersistenceFacade facade = PersistenceFacade.getInstance();
    SNode quotedNode_2 = null;
    SNode quotedNode_3 = null;
    SNode quotedNode_4 = null;
    ...
    quotedNode_7.setReference("conceptDeclaration", SReference.create("conceptDeclaration", quotedNode_7, facade.createModelReference("r:00000000-0000-4000-0000-011c89590288(jetbrains.mps.lang.core.structure)"), facade.createNodeId("1835621062190663819")));
  ...
  private static SNode _quotation_createNode_azpnkk_a0a0a7a3a53(Object parameter_1, Object parameter_2) {
    PersistenceFacade facade = PersistenceFacade.getInstance();
    SNode quotedNode_3 = null;
    SNode quotedNode_4 = null;
    SNode quotedNode_5 = null;
