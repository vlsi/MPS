...
public class MigrateToSReferenceOpenAPI_Action extends BaseAction {
  ...
  public MigrateToSReferenceOpenAPI_Action() {
    super("Migrate to sreference OpenAPI", "", ICON);
  ...
  public void doExecute(@NotNull final AnActionEvent event, final Map<String, Object> _params) {
    try {
      new ApiMigrationHelper(((MPSProject) MapSequence.fromMap(_params).get("project")), ((Project) MapSequence.fromMap(_params).get("iproject"))).migrateSReference();
    } catch (Throwable t) {
      if (LOG.isEnabledFor(Priority.ERROR)) {
