...
public class MigrateToSNodeReferenceOpenAPI_Action extends BaseAction {
  ...
  public void doExecute(@NotNull final AnActionEvent event, final Map<String, Object> _params) {
    try {
      new ApiMigrationHelper(((MPSProject) MapSequence.fromMap(_params).get("project")), ((Project) MapSequence.fromMap(_params).get("iproject"))).migrateSNodeReference();
    } catch (Throwable t) {
      if (LOG.isEnabledFor(Priority.ERROR)) {
  ...
  protected static Logger LOG = LogManager.getLogger(MigrateToSNodeReferenceOpenAPI_Action.class);
}
