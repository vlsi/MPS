...
public class Migrations33 implements ApplicationComponent {
  private final ProjectMigration[] myMigrations = new ProjectMigration[]{new CleanSourcesMigration(), new Persistence8Elimination(), new UpdateModuleUsedLang(), new FixMigrationVersions_33_331(), new FixLanguageVersions()};
