...
public class CopyThisDown_Action extends GeneratedAction {
  ...
  public boolean isApplicable(AnActionEvent event, final Map<String, Object> _params) {
    return ListSequence.<SNode>fromList(((List<SNode>) MapSequence.<String,Object>fromMap(_params).get("inputNodes"))).count() > 0 && !(((EditorComponent) MapSequence.<String,Object>fromMap(_params).get("editorComponent")).isReadOnly());
  }
  ...
  protected boolean collectActionData(AnActionEvent event, final Map<String, Object> _params) {
    ...
    }
    {
      ...
      if (error || nodes == null) {
        MapSequence.<String,Object>fromMap(_params).put("inputNodes", null);
      } else {
        MapSequence.<String,Object>fromMap(_params).put("inputNodes", ListSequence.<SNode>fromListWithValues(new ArrayList<SNode>(), nodes));
      }
    }
    if (MapSequence.<String,Object>fromMap(_params).get("inputNodes") == null) {
      return false;
    }
