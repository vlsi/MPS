...
public class SelectNext_Action extends GeneratedAction {
  ...
  public void doExecute(@NotNull final AnActionEvent event, final Map<String, Object> _params) {
    try {
      ((EditorComponent) MapSequence.<String,Object>fromMap(_params).get("editorComponent")).getSelectionManager().getSelection().executeAction(CellActionType.SELECT_NEXT);
    } catch (Throwable t) {
      if (log.isErrorEnabled()) {
