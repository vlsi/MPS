...
<model modelUID="r:3b11b092-1d35-4fd8-b30e-ef91402b7717(jetbrains.mps.execution.common.editor)">
  ...
  <root type="tpc2.StyleSheet" typeId="tpc2.1186402211651" id="946964771156905360" nodeInfo="ng">
    ...
    <node role="styleClass" roleId="tpc2.1186402402630" type="tpc2.StyleClass" typeId="tpc2.3383245079137382180" id="1900280919949829366" nodeInfo="ng">
    ...
    <node role="styleClass" roleId="tpc2.1186402402630" type="tpc2.StyleClass" typeId="tpc2.3383245079137382180" id="1900280919949810800" nodeInfo="ng">
    ...
    <node role="styleClass" roleId="tpc2.1186402402630" type="tpc2.StyleClass" typeId="tpc2.3383245079137382180" id="1900280919949824917" nodeInfo="ng">
    ...
    <node role="styleClass" roleId="tpc2.1186402402630" type="tpc2.StyleClass" typeId="tpc2.3383245079137382180" id="1900280919949858239" nodeInfo="ng">
      <property name="name" nameId="tpck.1169194664001" value="leftOperationBrace" />
      <node role="styleItem" roleId="tpc2.1219418656006" type="tpc2.ApplyStyleClass" typeId="tpc2.1950447826681509042" id="1900280919949824920" nodeInfo="ng">
        <node role="target" roleId="tpc2.1950447826683828796" type="tpc2.StyleReference" typeId="tpc2.9122903797312246523" id="1900280919949824921" nodeInfo="ng">
          <link role="style" roleId="tpc2.9122903797312247166" targetNodeId="1900280919949824917" resolveInfo="operation" />
        </node>
      </node>
    ...
    <node role="styleClass" roleId="tpc2.1186402402630" type="tpc2.StyleClass" typeId="tpc2.3383245079137382180" id="1900280919949858325" nodeInfo="ng">
      <property name="name" nameId="tpck.1169194664001" value="rightOperationBrace" />
      <node role="styleItem" roleId="tpc2.1219418656006" type="tpc2.ApplyStyleClass" typeId="tpc2.1950447826681509042" id="1900280919949824918" nodeInfo="ng">
        <node role="target" roleId="tpc2.1950447826683828796" type="tpc2.StyleReference" typeId="tpc2.9122903797312246523" id="1900280919949824919" nodeInfo="ng">
          <link role="style" roleId="tpc2.9122903797312247166" targetNodeId="1900280919949824917" resolveInfo="operation" />
        </node>
      </node>
    ...
    <node role="styleClass" roleId="tpc2.1186402402630" type="tpc2.StyleClass" typeId="tpc2.3383245079137382180" id="1900280919949858210" nodeInfo="ng">
      <property name="name" nameId="tpck.1169194664001" value="constructorParameter" />
      <node role="styleItem" roleId="tpc2.1219418656006" type="tpc2.ApplyStyleClass" typeId="tpc2.1950447826681509042" id="1900280919949793917" nodeInfo="ng">
        <node role="target" roleId="tpc2.1950447826683828796" type="tpc2.StyleReference" typeId="tpc2.9122903797312246523" id="1900280919949793918" nodeInfo="ng">
          <link role="style" roleId="tpc2.9122903797312247166" targetNodeId="tpen.1900280919949788423" resolveInfo="Field" />
        </node>
      </node>
    ...
    <node role="styleClass" roleId="tpc2.1186402402630" type="tpc2.StyleClass" typeId="tpc2.3383245079137382180" id="1900280919949819484" nodeInfo="ng">
