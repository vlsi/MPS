...
public final class IGeneratedToClass__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<String> getSuffix_idO$iR4JBsSb = new SMethodBuilder<String>(new SJavaCompoundTypeImpl(String.class)).name("getSuffix").modifiers(SModifiersImpl.create(12, AccessPrivileges.PUBLIC)).concept(CONCEPT).id("O$iR4JBsSb").registry(REGISTRY).build(SParameterImpl.fromList(SJavaCompoundTypeImpl.fromClasses()));
  ...
  public static final SMethod<String> getFullName_idO$iR4JBsSv = new SMethodBuilder<String>(new SJavaCompoundTypeImpl(String.class)).name("getFullName").modifiers(SModifiersImpl.create(8, AccessPrivileges.PUBLIC)).concept(CONCEPT).id("O$iR4JBsSv").registry(REGISTRY).build(SParameterImpl.fromList(SJavaCompoundTypeImpl.fromClasses()));
  public static final SMethod<String> getValidClassName_id2eOtvO7hJjT = new SMethodBuilder<String>(new SJavaCompoundTypeImpl(String.class)).name("getValidClassName").modifiers(SModifiersImpl.create(0, AccessPrivileges.PROTECTED)).concept(CONCEPT).id("2eOtvO7hJjT").registry(REGISTRY).build(SParameterImpl.fromList(SJavaCompoundTypeImpl.fromClasses(String.class)));
  public static final SMethod<String> getGeneratedClassName_idO$iR4JBsSG = new SMethodBuilder<String>(new SJavaCompoundTypeImpl(String.class)).name("getGeneratedClassName").modifiers(SModifiersImpl.create(0, AccessPrivileges.PROTECTED)).concept(CONCEPT).id("O$iR4JBsSG").registry(REGISTRY).build(SParameterImpl.fromList(SJavaCompoundTypeImpl.fromClasses(String.class)));
  ...
  public static final SMethod<String> getNamespace_id1XgDflG1h$6 = new SMethodBuilder<String>(new SJavaCompoundTypeImpl(String.class)).name("getNamespace").modifiers(SModifiersImpl.create(0, AccessPrivileges.PUBLIC)).concept(CONCEPT).id("1XgDflG1h$6").registry(REGISTRY).build(SParameterImpl.fromList(SJavaCompoundTypeImpl.fromClasses()));
  public static final SMethod<String> replaceProhibitedSymbol_idO$iR4JBsQI = new SMethodBuilder<String>(new SJavaCompoundTypeImpl(String.class)).name("replaceProhibitedSymbol").modifiers(SModifiersImpl.create(1, AccessPrivileges.PUBLIC)).concept(CONCEPT).id("O$iR4JBsQI").registry(REGISTRY).build(SParameterImpl.fromList(SJavaCompoundTypeImpl.fromClasses(String.class, String.class)));
  public static final SMethod<String> makeUpperCase_idO$iR4JBsRn = new SMethodBuilder<String>(new SJavaCompoundTypeImpl(String.class)).name("makeUpperCase").modifiers(SModifiersImpl.create(1, AccessPrivileges.PUBLIC)).concept(CONCEPT).id("O$iR4JBsRn").registry(REGISTRY).build(SParameterImpl.fromList(SJavaCompoundTypeImpl.fromClasses(String.class, Integer.TYPE)));
  public static final SMethod<String> getValidClassName_id3gpm$NHlLi1 = new SMethodBuilder<String>(new SJavaCompoundTypeImpl(String.class)).name("getValidClassName").modifiers(SModifiersImpl.create(1, AccessPrivileges.PUBLIC)).concept(CONCEPT).id("3gpm$NHlLi1").registry(REGISTRY).build(SParameterImpl.fromList(SJavaCompoundTypeImpl.fromClasses(String.class)));
  ...
  private static String makeUpperCase_idO$iR4JBsRn(@NotNull SAbstractConcept __thisConcept__, @NonNls String string, int index) {
  ...
  private static String getValidClassName_id3gpm$NHlLi1(@NotNull SAbstractConcept __thisConcept__, @NonNls String name) {
    // in between 
    name = RegexpOperations.replace(name, REGEXP_iaa26s_b0a1a62, new _Replacer_iaa26s_a0a0b0ab(null, null));
    // in the end 
  ...
  protected <T> T invokeSpecial0(@NotNull SNode node, @NotNull SMethod<T> method, @NotNull Object[] parameters) {
    ...
    switch (methodIndex) {
      ...
      case 2:
        return (T) getFullName_idO$iR4JBsSv(node);
      case 3:
        return (T) getValidClassName_id2eOtvO7hJjT(node, (String) parameters[0]);
      case 4:
        return (T) getGeneratedClassName_idO$iR4JBsSG(node, (String) parameters[0]);
      case 5:
        return (T) getBaseName_id3MnZbusxcPI(node);
      case 6:
        return (T) getNamespace_id1XgDflG1h$6(node);
      default:
        throw new BHMethodNotFoundException(this, method);
    }
  }
  ...
  protected <T> T invokeSpecial0(@NotNull SAbstractConcept concept, @NotNull SMethod<T> method, @NotNull Object[] parameters) {
    ...
    switch (methodIndex) {
      case 7:
        return (T) replaceProhibitedSymbol_idO$iR4JBsQI(concept, (String) parameters[0], (String) parameters[1]);
      case 8:
        return (T) makeUpperCase_idO$iR4JBsRn(concept, (String) parameters[0], (Integer) parameters[1]);
      case 9:
        return (T) getValidClassName_id3gpm$NHlLi1(concept, (String) parameters[0]);
      default:
        throw new BHMethodNotFoundException(this, method);
    }
  }
  ...
  private static Pattern REGEXP_iaa26s_b0a1a62 = Pattern.compile("(\\w)\\W+(\\w)", 0);
  private static Pattern REGEXP_iaa26s_b0a3a62 = Pattern.compile("(.)\\W+$", 0);
  private static Pattern REGEXP_iaa26s_b0a5a62 = Pattern.compile("^\\W+(\\w)", 0);
}
