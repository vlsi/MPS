...
public class _Replacer_tq53pp_a0a0f0f implements Replacer {
  public String replace(Matcher matcher) {
    return matcher.group(1).toUpperCase();
  }
  /*package*/ IGeneratedToClass_Behavior _enclosingClass;
  /*package*/ Object _closureContext;
  public _Replacer_tq53pp_a0a0f0f(IGeneratedToClass_Behavior enclosingClass, Object closureContext) {
