...
public final class ResetFrom_Function__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  private static SNode getJavaMethod_idO$iR4J$gaJ(@NotNull SNode __thisNode__) {
    return EditorOperationDeclaration__BehaviorDescriptor.getMethodbyName_idO$iR4J$gaP.invoke(__thisNode__, "resetEditorFrom");
  }
  private static SNode getPublicJavaMethod_idbkrofm9Fgz(@NotNull SNode __thisNode__) {
    return EditorOperationDeclaration__BehaviorDescriptor.getMethodbyName_idO$iR4J$gaP.invoke(__thisNode__, "resetFrom");
  }
