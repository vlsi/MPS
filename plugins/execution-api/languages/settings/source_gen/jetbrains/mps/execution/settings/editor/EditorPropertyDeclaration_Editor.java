...
public class EditorPropertyDeclaration_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createRefNode_ey0oay_a0(EditorContext editorContext, SNode node) {
    SingleRoleCellProvider provider = new EditorPropertyDeclaration_Editor.typeSingleRoleHandler_ey0oay_a0(node, MetaAdapterFactory.getContainmentLink(0xf3061a5392264cc5L, 0xa443f952ceaf5816L, 0x450368d90ce15bc3L, 0x4ed4d318133c80ceL, "type"), editorContext);
  ...
  private EditorCell createRefNode_ey0oay_b2a(EditorContext editorContext, SNode node) {
    SingleRoleCellProvider provider = new EditorPropertyDeclaration_Editor.initializerSingleRoleHandler_ey0oay_b2a(node, MetaAdapterFactory.getContainmentLink(0xf3061a5392264cc5L, 0xa443f952ceaf5816L, 0xf8c37a7f6eL, 0xf8c37f506eL, "initializer"), editorContext);
    return provider.createCell();
  }
