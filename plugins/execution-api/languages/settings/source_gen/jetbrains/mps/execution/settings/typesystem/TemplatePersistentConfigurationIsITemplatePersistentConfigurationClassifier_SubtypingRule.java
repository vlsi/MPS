...
public class TemplatePersistentConfigurationIsITemplatePersistentConfigurationClassifier_SubtypingRule extends SubtypingRule_Runtime implements ISubtypingRule_Runtime {
  ...
  private static SNode _quotation_createNode_ov7vps_a0a1() {
    ...
    quotedNode_1.setReference("classifier", jetbrains.mps.smodel.SReference.create("classifier", quotedNode_1, SModelReference.fromString("r:76273c4a-4818-4f7c-8673-bfc2aeb6debb(jetbrains.mps.execution.api.settings)"), SNodeId.fromString("3908032508224771790")));
    return quotedNode_1;
  }
}
