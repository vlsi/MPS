...
/*package*/ class TemplatePersistentConfigurationType_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createCollection_1clvom_a() {
    ...
    if (renderingCondition_1clvom_a0a(myNode, getEditorContext())) {
      editorCell.addEditorCell(createRefCell_1clvom_a0());
    }
    if (renderingCondition_1clvom_a1a(myNode, getEditorContext())) {
  ...
  public static class _Inline_1clvom_a0a extends InlineCellProvider {
    ...
    public EditorCell createEditorCell(EditorContext editorContext, SNode node) {
      ...
      return new TemplatePersistentConfigurationType_EditorBuilder_a.Inline_Builder_1clvom_a0a(editorContext, getRefNode(), node).createCell();
    }
  }
  ...
  public static class _Inline_1clvom_a1a extends InlineCellProvider {
    ...
    public EditorCell createEditorCell(EditorContext editorContext, SNode node) {
      // looks like getRefNode() == node 
      return new TemplatePersistentConfigurationType_EditorBuilder_a.Inline_Builder_1clvom_a1a(editorContext, getRefNode(), node).createCell();
    }
  }
