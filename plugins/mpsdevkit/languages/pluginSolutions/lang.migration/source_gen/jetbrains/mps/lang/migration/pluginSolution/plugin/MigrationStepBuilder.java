...
public class MigrationStepBuilder implements MoveNodesBuilder {
  ...
  public MigrationStepBuilder(Language language) {
    myModel = LanguageAspect.MIGRATION.getOrCreate(language);
    myStep = SModelOperations.addRootNode(myModel, createRefactoringStep_x8stao_a0a0b0g());
  }
  ...
  private static SNode createMoveNode_x8stao_a0e0k(Object p0, Object p1) {
    PersistenceFacade facade = PersistenceFacade.getInstance();
  ...
  private static boolean neq_x8stao_a0d0k(Object a, Object b) {
