...
public class MovePropertyUp extends MoveFeatureUp {
  ...
  public boolean isApplicable(MPSProject project, final List<SNode> target) {
    ...
    ModelAccess.instance().runReadAction(new Runnable() {
      public void run() {
        result.value = SNodeOperations.hasRole(ListSequence.fromList(target).first(), MetaAdapterFactory.getContainmentLink(0xc72da2b97cce4447L, 0x8389f407dc1158b7L, 0x1103553c5ffL, 0xf979c3ba6cL, "propertyDeclaration"));
      }
    });
    return result.value;
  }
  ...
  public MoveFeatureUp.FeatureSpecificMigrations migrations(SNode oldProperty, SNode newProperty) {
    SNode oldPropVariable = _quotation_createNode_vnzymo_a0a0h(SNodeOperations.cast(SNodeOperations.getParent(oldProperty), MetaAdapterFactory.getConcept(0xc72da2b97cce4447L, 0x8389f407dc1158b7L, 0x1103553c5ffL, "jetbrains.mps.lang.structure.structure.AbstractConceptDeclaration")), oldProperty);
    SNode newPropVariable = _quotation_createNode_vnzymo_a0b0h(SNodeOperations.cast(SNodeOperations.getParent(newProperty), MetaAdapterFactory.getConcept(0xc72da2b97cce4447L, 0x8389f407dc1158b7L, 0x1103553c5ffL, "jetbrains.mps.lang.structure.structure.AbstractConceptDeclaration")), newProperty);
    SNode refactorClosure = _quotation_createNode_vnzymo_a0c0h(oldPropVariable, newPropVariable);
    return new MoveFeatureUp.FeatureSpecificMigrations(oldPropVariable, newPropVariable, refactorClosure);
  }

  private static SNode _quotation_createNode_vnzymo_a0a0h(Object parameter_1, Object parameter_2) {
  ...
  private static SNode _quotation_createNode_vnzymo_a0b0h(Object parameter_1, Object parameter_2) {
    PersistenceFacade facade = PersistenceFacade.getInstance();
    SNode quotedNode_3 = null;
    SNode quotedNode_4 = null;
    SNode quotedNode_5 = null;
  ...
  private static SNode _quotation_createNode_vnzymo_a0c0h(Object parameter_1, Object parameter_2) {
    PersistenceFacade facade = PersistenceFacade.getInstance();
    SNode quotedNode_3 = null;
    SNode quotedNode_4 = null;
    SNode quotedNode_5 = null;
