...
public class MovePropertyUp extends MoveFeatureUp {
  ...
  public boolean isApplicable(MPSProject project, final List<SNode> target) {
    ...
    ModelAccess.instance().runReadAction(new Runnable() {
      public void run() {
        result.value = ListSequence.fromList(target).count() == 1 && SNodeOperations.hasRole(ListSequence.fromList(target).first(), MetaAdapterFactory.getContainmentLink(0xc72da2b97cce4447L, 0x8389f407dc1158b7L, 0x1103553c5ffL, 0xf979c3ba6cL, "propertyDeclaration"));
      }
    });
    return result.value;
  }
  public void apply(MPSProject project, List<SNode> target) {
    execute(project, SNodeOperations.cast(ListSequence.fromList(target).first(), MetaAdapterFactory.getConcept(0xc72da2b97cce4447L, 0x8389f407dc1158b7L, 0xf979bd086bL, "jetbrains.mps.lang.structure.structure.PropertyDeclaration")));
  }
  ...
  public void markOldFeature(SNode oldProperty) {
    SPropertyOperations.set(SNodeOperations.cast(oldProperty, MetaAdapterFactory.getConcept(0xc72da2b97cce4447L, 0x8389f407dc1158b7L, 0xf979bd086bL, "jetbrains.mps.lang.structure.structure.PropertyDeclaration")), MetaAdapterFactory.getProperty(0xceab519525ea4f22L, 0x9b92103b95ca8c0cL, 0x110396eaaa4L, 0x110396ec041L, "name"), SPropertyOperations.getString_def(SNodeOperations.cast(oldProperty, MetaAdapterFactory.getConcept(0xc72da2b97cce4447L, 0x8389f407dc1158b7L, 0xf979bd086bL, "jetbrains.mps.lang.structure.structure.PropertyDeclaration")), MetaAdapterFactory.getProperty(0xceab519525ea4f22L, 0x9b92103b95ca8c0cL, 0x110396eaaa4L, 0x110396ec041L, "name"), "") + "_old");
  }
  public MoveFeatureUp.FeatureSpecificMigrations migrations(SNode oldProperty, SNode newProperty) {
    SNode oldPropVariable = _quotation_createNode_vnzymo_a0a0i(SNodeOperations.cast(SNodeOperations.getParent(oldProperty), MetaAdapterFactory.getConcept(0xc72da2b97cce4447L, 0x8389f407dc1158b7L, 0x1103553c5ffL, "jetbrains.mps.lang.structure.structure.AbstractConceptDeclaration")), oldProperty);
    SNode newPropVariable = _quotation_createNode_vnzymo_a0b0i(SNodeOperations.cast(SNodeOperations.getParent(newProperty), MetaAdapterFactory.getConcept(0xc72da2b97cce4447L, 0x8389f407dc1158b7L, 0x1103553c5ffL, "jetbrains.mps.lang.structure.structure.AbstractConceptDeclaration")), newProperty);
    SNode refactorClosure = _quotation_createNode_vnzymo_a0c0i(oldPropVariable, newPropVariable);
    return new MoveFeatureUp.FeatureSpecificMigrations(oldPropVariable, newPropVariable, refactorClosure);
  }

  private static SNode _quotation_createNode_vnzymo_a0a0i(Object parameter_1, Object parameter_2) {
  ...
  private static SNode _quotation_createNode_vnzymo_a0b0i(Object parameter_1, Object parameter_2) {
    PersistenceFacade facade = PersistenceFacade.getInstance();
    SNode quotedNode_3 = null;
    SNode quotedNode_4 = null;
    SNode quotedNode_5 = null;
  ...
  private static SNode _quotation_createNode_vnzymo_a0c0i(Object parameter_1, Object parameter_2) {
    PersistenceFacade facade = PersistenceFacade.getInstance();
    SNode quotedNode_3 = null;
    SNode quotedNode_4 = null;
    SNode quotedNode_5 = null;
