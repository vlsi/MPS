...
public class ModelQuery_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createConstant_1kyme_a0a(EditorContext editorContext, SNode node) {
    EditorCell_Constant editorCell = new EditorCell_Constant((jetbrains.mps.nodeEditor.EditorContext) editorContext, node, "search query");
  ...
  private EditorCell createConstant_1kyme_a1a(EditorContext editorContext, SNode node) {
    EditorCell_Constant editorCell = new EditorCell_Constant((jetbrains.mps.nodeEditor.EditorContext) editorContext, node, "find all");
