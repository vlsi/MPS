...
public class SurroundWithIntentions_ActionGroup extends GeneratedActionGroup {
  ...
  public static final String ID = "jetbrains.mps.ide.devkit.actions.SurroundWithIntentions_ActionGroup";
    ...
    try {
      ...
      ListSequence.fromList(groupItems).sort(new Comparator<Tuples._2<Intention, SNode>>() {
        ...
        public void visit(Tuples._2<Intention, SNode> it) {
          SurroundWithIntentions_ActionGroup.this.addParameterizedAction(new SurroundIntentionAction_Action((SurroundWithIntention) it._0(), it._1()), PluginId.getId("jetbrains.mps.ide.mpsdevkit"), (SurroundWithIntention) it._0(), it._1());
        }
      });
    } catch (Throwable t) {
      LOG.error("User group error", t);
