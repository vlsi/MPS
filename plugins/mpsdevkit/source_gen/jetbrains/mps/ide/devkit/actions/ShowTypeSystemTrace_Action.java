  ...
  public void doExecute(@NotNull final AnActionEvent event, final Map<String, Object> _params) {
    try {
      ...
      if (typeCheckingContext instanceof TypeCheckingContextNew) {
        ...
        tool.buildTrace(tcc, ((IOperationContext) MapSequence.<String,Object>fromMap(_params).get("context")), ((SNode) MapSequence.<String,Object>fromMap(_params).get("node")), ((EditorComponent) MapSequence.<String,Object>fromMap(_params).get("editorComponent")), true);
