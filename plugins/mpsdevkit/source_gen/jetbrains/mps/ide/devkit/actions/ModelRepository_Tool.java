...
public class ModelRepository_Tool extends GeneratedTool {
  ...
  public ModelRepository_Tool(Project project) {
    super(project, "Model Repository Viewer", -1, IconManager.loadIcon(MacrosUtil.expandPath("${mps_home}/workbench/source/jetbrains/mps/ide/projectPane/nodes/model.png", "jetbrains.mps.ide.mpsdevkit"), true), ToolWindowAnchor.BOTTOM, false);
  }
