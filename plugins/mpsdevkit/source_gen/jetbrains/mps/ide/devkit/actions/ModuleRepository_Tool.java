...
public class ModuleRepository_Tool extends GeneratedTool {
  ...
  public ModuleRepository_Tool(Project project) {
    super(project, "Module Repository Viewer", -1, IconManager.loadIcon(MacrosUtil.expandPath("${mps_home}/workbench/source/jetbrains/mps/ide/projectPane/nodes/project.png", "jetbrains.mps.ide.mpsdevkit"), true), ToolWindowAnchor.BOTTOM, false);
  }
