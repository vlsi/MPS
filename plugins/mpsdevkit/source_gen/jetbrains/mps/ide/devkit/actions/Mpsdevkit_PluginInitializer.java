...
public class Mpsdevkit_PluginInitializer implements ApplicationComponent {
  protected static Log log = LogFactory.getLog(Mpsdevkit_PluginInitializer.class);

  private final LibraryContributor myContributor = new Mpsdevkit_PluginInitializer.MyLibraryContributor();
