...
public class DevkitProperties_Action extends GeneratedAction {
  private static final Icon ICON = IconManager.loadIcon(MacrosUtil.expandPath("${solution_descriptor}/icons/languageProperties.png", "jetbrains.mps.ide.mpsdevkit"), true);
  ...
  public boolean isApplicable(AnActionEvent event, final Map<String, Object> _params) {
    return ((IModule) MapSequence.fromMap(_params).get("module")) instanceof DevKit;
  }
  ...
  public void doExecute(@NotNull final AnActionEvent event, final Map<String, Object> _params) {
    try {
      final DevKit devkit = ((DevKit) ((IModule) MapSequence.fromMap(_params).get("module")));
      final Wrappers._T<DevKitPropertiesDialog> dialog = new Wrappers._T<DevKitPropertiesDialog>();
      ModelAccess.instance().runReadAction(new Runnable() {
        public void run() {
          dialog.value = StandardDialogs.createDevKitPropertiesDialog(devkit, ((IOperationContext) MapSequence.fromMap(_params).get("context")));
        }
      });
