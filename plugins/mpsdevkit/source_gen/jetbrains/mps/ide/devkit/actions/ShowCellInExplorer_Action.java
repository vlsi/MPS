...
public class ShowCellInExplorer_Action extends GeneratedAction {
  ...
  public void doExecute(@NotNull final AnActionEvent event, final Map<String, Object> _params) {
    try {
      ((IOperationContext) MapSequence.<String,Object>fromMap(_params).get("context")).getComponent(CellExplorerView.class).showCell(((EditorCell) MapSequence.<String,Object>fromMap(_params).get("cell")));
    } catch (Throwable t) {
      if (log.isErrorEnabled()) {
