...
public class Data_Flow_TabDescriptor extends EditorTabDescriptor {
  ...
  public SNode getNode(SNode node) {
    List<SNode> nodes = ((List<SNode>) BehaviorManager.getInstance().invoke(Object.class, SNodeOperations.cast(node, "jetbrains.mps.lang.structure.structure.AbstractConceptDeclaration"), "call_findConceptAspectCollection_1567570417158062208", new Class[]{SNode.class, LanguageAspect.class}, LanguageAspect.DATA_FLOW));
