...
public class Refactorings_TabDescriptor extends EditorTabDescriptor {
  ...
  public List<SNode> getNodes(SNode node) {
    return ((List<SNode>) BehaviorManager.getInstance().invoke(Object.class, SNodeOperations.cast(node, "jetbrains.mps.lang.structure.structure.AbstractConceptDeclaration"), "call_findConceptAspectCollection_1567570417158062208", new Class[]{SNode.class, LanguageAspect.class}, LanguageAspect.REFACTORINGS));
  }
