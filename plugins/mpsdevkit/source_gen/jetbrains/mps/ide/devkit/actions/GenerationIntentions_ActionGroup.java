...
public class GenerationIntentions_ActionGroup extends GeneratedActionGroup {
  ...
  public static final String ID = "jetbrains.mps.ide.devkit.actions.GenerationIntentions_ActionGroup";
    ...
    try {
      ...
      ListSequence.fromList(groupItems).sort(new Comparator<Tuples._2<Intention, SNode>>() {
        ...
        public void visit(Tuples._2<Intention, SNode> it) {
          GenerationIntentions_ActionGroup.this.addParameterizedAction(new GenerateIntentionAction_Action((GenerateIntention) it._0(), it._1()), PluginId.getId("jetbrains.mps.ide.mpsdevkit"), (GenerateIntention) it._0(), it._1());
        }
      });
    } catch (Throwable t) {
      LOG.error("User group error", t);
