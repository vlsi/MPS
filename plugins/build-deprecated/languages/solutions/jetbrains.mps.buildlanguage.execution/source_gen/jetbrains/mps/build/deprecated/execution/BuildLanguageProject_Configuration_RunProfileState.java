  ...
  public ExecutionResult execute(Executor executor, @NotNull ProgramRunner runner) throws ExecutionException {
    Project project = myEnvironment.getProject();
    {
      ProcessHandler _processHandler = new Ant_Command().setAntLocation_String((myRunConfiguration.getSettings().getUseOtherAntLocation() ?
        ...
        null
      )).setOptions_String(myRunConfiguration.getSettings().getAntOptions()).setTarget_NodeINamedConcept(myRunConfiguration.getTarget()).createProcess(SNodeOperations.cast(myRunConfiguration.getNode().getNode(), "jetbrains.mps.buildlanguage.structure.Project"));
