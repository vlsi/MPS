...
public class GenerateBuild_BeforeTask extends BaseMpsBeforeTaskProvider<GenerateBuild_BeforeTask.GenerateBuild_BeforeTask_RunTask> {
  private static final Key<GenerateBuild_BeforeTask.GenerateBuild_BeforeTask_RunTask> KEY = Key.create("jetbrains.mps.execution.configurations.implementation.plugin.GenerateBuild_BeforeTask");
