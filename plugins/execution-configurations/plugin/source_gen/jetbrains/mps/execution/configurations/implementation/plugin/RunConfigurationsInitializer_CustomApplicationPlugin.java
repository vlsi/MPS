...
public class RunConfigurationsInitializer_CustomApplicationPlugin extends BaseCustomApplicationPlugin {
  ...
  public void doInit() {
    ...
    {
      ConfigurationType configurationType = ContainerUtil.findInstance(configurationExtensionPoint.getExtensions(), getClassFunction.invoke("jetbrains.mps.execution.configurations.implementation.plugin.JavaApplication_Kind"));
    ...
    {
      ConfigurationType configurationType = ContainerUtil.findInstance(configurationExtensionPoint.getExtensions(), getClassFunction.invoke("jetbrains.mps.execution.configurations.implementation.plugin.JUnitTests_Kind"));
      if (configurationType != null) {
    ...
    {
      ConfigurationType configurationType = ContainerUtil.findInstance(configurationExtensionPoint.getExtensions(), getClassFunction.invoke("jetbrains.mps.execution.configurations.implementation.plugin.Ant_Kind"));
      if (configurationType != null) {
