...
public class LanguageTestWrapper extends AbstractTestWrapper<SNode> {
  ...
  public Tuples._3<String, List<String>, List<String>> getTestRunParameters() {
    ...
    if (BehaviorReflection.invokeVirtual(Boolean.TYPE, node, "virtual_isMpsStartRequired_3310779261129403089", new Object[]{})) {
      ...
      return MultiTuple.<String,List<String>,List<String>>from("jetbrains.mps.baseLanguage.unitTest.execution.server.TransformationTestExecutor", ListSequence.fromList(ListSequence.fromListAndArray(new ArrayList<String>(), "-Xmx1024m", "-XX:PermSize=256m")).union(SetSequence.fromSet(userMacroNames).select(new ISelector<String, String>() {
  ...
  public String getFqName() {
    if (isTestCase()) {
      return check_9og6tg_a0a0a9(SNodeOperations.cast(getNode(), "jetbrains.mps.baseLanguage.unitTest.structure.ITestCase"), this);
    }
  ...
  public String getName() {
    if (isTestMethod()) {
      return check_9og6tg_a0a0a01(SNodeOperations.cast(getNode(), "jetbrains.mps.baseLanguage.unitTest.structure.ITestMethod"), this);
    }
