...
public class JUnitConfigurationEditorComponent extends JBPanel {
  private final JBCheckBox myLightExecCheckBox;
  ...
  public JUnitConfigurationEditorComponent(Project project) {
    ...
    myLightExecCheckBox = new JBCheckBox("Try to execute in the same process ", true);
  ...
  public JBCheckBox getLightCheckBox() {
    return myLightExecCheckBox;
  }
