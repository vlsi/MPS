...
public class JUnitConfigurationEditorComponent extends JBPanel {
  ...
  private final JBTextField myProjectName;
  ...
  public JUnitConfigurationEditorComponent(Project project) {
    ...
    myProjectName = new JBTextField(myProject.getName());
    myProjectName.setEditable(false);
    projectPanel.add(myProjectName, LayoutUtil.createPanelConstraints(1));
    ...
    myClassesList = new TestListPanel(myProject, false);
    myMethodsList = new TestListPanel(myProject, true);
