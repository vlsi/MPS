...
public class Java_Command {
  ...
  private static SNode _quotation_createNode_yvpt_a0a0a0a1a0a0a1a0c0a1a1() {
    ...
    quotedNode_7.setReference("classifier", jetbrains.mps.smodel.SReference.create("classifier", quotedNode_7, SModelReference.fromString("f:java_stub#6354ebe7-c22a-4a0f-ac54-50b52ab9b065#java.lang(JDK/java.lang@java_stub)"), SNodeId.fromString("~String")));
