...
public class Java_Command {
          ...
          if (ListSequence.fromList(unitForNode).isEmpty()) {
            ...
            for (final TraceablePositionInfo position : SetSequence.fromSet(infoRoot.getPositions())) {
              if (eq_kk96hj_a0a0b0a1a0c0a0a0a0b0c(position.getConceptFqName(), "jetbrains.mps.baseLanguage.structure.StaticMethodDeclaration")) {
                if (eq_kk96hj_a0a0a0b0a1a0c0a0a0a0b0c(position.getPropertyString(), TraceableConcept_Behavior.call_getTraceableProperty_5067982036267369901(new Java_Command.QuotationClass_kk96hj_a0a0a0a0b0a1a0c0a0a1a2().createNode()))) {
  ...
  public static class QuotationClass_kk96hj_a0a0a0a0b0a1a0c0a0a1a2 {
    public QuotationClass_kk96hj_a0a0a0a0b0a1a0c0a0a1a2() {
    }
