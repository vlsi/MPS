...
public abstract class ToolController implements ItemExecutor {
  protected final IProject myProject;
  protected final ToolComponent myToolComponent;
  ...
  public ToolController(IProject project, ToolComponent toolComponent) {
    myProject = project;
  ...
  protected abstract List<ToolComponent.IItem> queryItems(@NotNull Selection selection);
  ...
  private void checkActiveEditorChanged() {
    ...
    if (check_ae45oa_a0c0r(myLastSelection) == null) {
      return;
    }
    if (activeEditor == check_ae45oa_a0d0r(myLastSelection)) {
      return;
    }
    if (activeEditor == check_ae45oa_a0e0r(myNextSelection)) {
      return;
    }
  ...
  private static jetbrains.mps.openapi.editor.EditorComponent check_ae45oa_a0c0r(Selection checkedDotOperand) {
    if (null != checkedDotOperand) {
      return checkedDotOperand.getEditorComponent();
    }
    return null;
  }
  private static jetbrains.mps.openapi.editor.EditorComponent check_ae45oa_a0d0r(Selection checkedDotOperand) {
    if (null != checkedDotOperand) {
      return checkedDotOperand.getEditorComponent();
    }
    return null;
  }
  private static jetbrains.mps.openapi.editor.EditorComponent check_ae45oa_a0e0r(Selection checkedDotOperand) {
    if (null != checkedDotOperand) {
      return checkedDotOperand.getEditorComponent();
    }
    return null;
