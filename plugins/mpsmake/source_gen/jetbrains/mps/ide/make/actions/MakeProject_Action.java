...
public class MakeProject_Action extends GeneratedAction {
  ...
  public void doExecute(@NotNull final AnActionEvent event, final Map<String, Object> _params) {
    try {
      new MakeActionImpl(((IOperationContext) MapSequence.<String,Object>fromMap(_params).get("context")), new MakeActionParameters(((IOperationContext) MapSequence.<String,Object>fromMap(_params).get("context")), null, null, ((MPSProject) MapSequence.<String,Object>fromMap(_params).get("mpsProject")).getModules(), null), false).executeAction();
    } catch (Throwable t) {
      if (log.isErrorEnabled()) {
