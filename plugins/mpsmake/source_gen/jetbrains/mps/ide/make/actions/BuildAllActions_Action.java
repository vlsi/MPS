...
public class BuildAllActions_Action extends BaseAction {
  ...
  public void doUpdate(@NotNull AnActionEvent event, final Map<String, Object> _params) {
    try {
      ...
      LOG.error("User's action doUpdate method failed. Action:" + "BuildAllActions", t);
  ...
  public void doExecute(@NotNull final AnActionEvent event, final Map<String, Object> _params) {
    try {
        ...
        public void run() {
          ...
          models.value = ListSequence.fromListWithValues(new ArrayList<SModel>(), Sequence.fromIterable(allModels).where(new IWhereFilter<SModel>() {
            public boolean accept(SModel it) {
              return SNodeOperations.isGeneratable(it) && LanguageAspect.ACTIONS.is(it);
            }
          }));
        }
      });
      ...
      LOG.error("User's action execute method failed. Action:" + "BuildAllActions", t);
    }
  }

  private static Logger LOG = Logger.getLogger(BuildAllActions_Action.class);
}
