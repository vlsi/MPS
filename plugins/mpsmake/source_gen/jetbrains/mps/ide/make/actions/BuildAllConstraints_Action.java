...
public class BuildAllConstraints_Action extends BaseAction {
        ...
        public void run() {
          ...
          models.value = ListSequence.fromListWithValues(new ArrayList<SModel>(), Sequence.fromIterable(allModels).where(new IWhereFilter<SModel>() {
            public boolean accept(SModel it) {
              return SNodeOperations.isGeneratable(it) && LanguageAspect.CONSTRAINTS.is(it);
            }
          }));
        }
      });
  ...
  protected static Logger LOG = LogManager.getLogger(BuildAllConstraints_Action.class);
}
