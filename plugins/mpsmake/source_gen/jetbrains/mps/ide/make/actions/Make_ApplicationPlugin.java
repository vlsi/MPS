...
public class Make_ApplicationPlugin extends BaseApplicationPlugin {
  ...
  public void createGroups() {
    ...
    addGroup(new SaveTransientModelsSettings_ActionGroup());
  ...
  public void adjustRegularGroups() {
    ...
    insertGroupIntoAnother(SaveTransientModels_ActionGroup.ID, "SaveTransientModelsMainToolBarGroup", null);
