  ...
  public void doUpdate(@NotNull AnActionEvent event, final Map<String, Object> _params) {
    try {
      ...
      if (LOG.isEnabledFor(Level.ERROR)) {
        LOG.error("User's action doUpdate method failed. Action:" + "BuildAllIntentions", t);
      }
    ...
    try {
      ...
      ModelAccess.instance().runReadAction(new Runnable() {
        public void run() {
          ...
          }).select(new ISelector<SModule, EditableSModelDescriptor>() {
            public EditableSModelDescriptor select(SModule it) {
              return LanguageAspect.INTENTIONS.get((Language) it);
            }
      ...
      if (LOG.isEnabledFor(Level.ERROR)) {
        LOG.error("User's action execute method failed. Action:" + "BuildAllIntentions", t);
      }
    }
  }

  protected static Logger LOG = LogManager.getLogger(BuildAllIntentions_Action.class);
}
