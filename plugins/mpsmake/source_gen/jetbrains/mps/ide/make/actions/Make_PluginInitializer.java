...
public class Make_PluginInitializer implements ApplicationComponent {
  protected static Log log = LogFactory.getLog(Make_PluginInitializer.class);

  private final LibraryContributor myContributor = new Make_PluginInitializer.MyLibraryContributor();
