...
public class AspectDependenciesChecker extends SpecificChecker {
    ...
    if (module instanceof Language) {
      ...
      if (moduleFqName.equals("MPS.Classpath")) {
        ...
        if (SNodeOperations.isInstanceOf(refTargetRoot, "jetbrains.mps.baseLanguage.structure.Classifier")) {
          ...
          if (findInModule(editorModule, model.getLongName(), cName)) {
            return EDITOR;
          }
          return WORKBENCH;
        }
  ...
  public static boolean findInModule(IModule module, String modelFqName, String rootName) {
    for (SModelDescriptor d : module.getOwnModelDescriptors()) {
      if (d.getLongName().equals(modelFqName)) {
        SModel model = d.getSModel();
        for (SNode n : model.roots()) {
