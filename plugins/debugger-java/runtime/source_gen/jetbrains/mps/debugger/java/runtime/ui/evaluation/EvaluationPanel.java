...
public class EvaluationPanel extends EvaluationUi {
  ...
  private SimpleEmbeddableEditor myResultEditor;
  ...
  public EvaluationPanel(Project project, @NotNull DebugSession session, IEvaluationContainer evaluationModel, boolean autoUpdate) {
    ...
    ModelAccess.instance().runWriteActionInCommand(new Runnable() {
      public void run() {
        ...
        myEditor = new SimpleEmbeddableEditor(myEvaluationModel.getContext().getProject(), true);
    ...
    ApplicationManager.getApplication().invokeLater(new Runnable() {
      public void run() {
        if (myResultEditor == null) {
          ModelAccess.instance().runWriteActionInCommand(new Runnable() {
            public void run() {
              myResultEditor = new SimpleEmbeddableEditor(myEvaluationModel.getContext().getProject(), true);
            }
          });
