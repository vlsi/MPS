...
public class EvaluationUtilsImpl extends EvaluationUtils {
  ...
  private static SNode _quotation_createNode_wi3cqi_a0c0a0a0a0a0a0a0a52() {
    ...
    quotedNode_4.setReference("classifier", SReference.create("classifier", quotedNode_4, SModelReference.fromString("f:java_stub#6354ebe7-c22a-4a0f-ac54-50b52ab9b065#java.lang(JDK/java.lang@java_stub)"), jetbrains.mps.smodel.SNodeId.fromString("~String")));
