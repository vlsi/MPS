...
public class ExceptionChooserDialog extends StubsClassChooserDialog {
  ...
  protected boolean isValid(SNode node) {
    final SNode throwableClassifier = new SNodePointer("6354ebe7-c22a-4a0f-ac54-50b52ab9b065/f:java_stub#6354ebe7-c22a-4a0f-ac54-50b52ab9b065#java.lang(JDK/java.lang@java_stub)", "~Throwable").resolve(myProject.getRepository());
    SNode base = node;
