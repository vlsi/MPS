...
public class StructureAspectDescriptor extends BaseStructureAspectDescriptor {
  ...
  /*package*/ final ConceptDescriptor myConceptDoNotTransformAnnotation = new ConceptDescriptorBuilder("jetbrains.mps.debugger.java.evaluation.structure.DoNotTransformAnnotation", MetaIdFactory.conceptId(0x7da4580f9d754603L, 0x816251a896d78375L, 0x7eed83c2376f34a5L)).super_("jetbrains.mps.debugger.java.evaluation.structure.GenerationHelperAnnotation").super_(MetaIdFactory.conceptId(0x7da4580f9d754603L, 0x816251a896d78375L, 0x17b1c8f7ef7ab40cL)).parents("jetbrains.mps.debugger.java.evaluation.structure.GenerationHelperAnnotation").parentIds(MetaIdFactory.conceptId(0x7da4580f9d754603L, 0x816251a896d78375L, 0x17b1c8f7ef7ab40cL)).alias("do not transform", "").sourceNode(new SNodePointer("r:3a27a6eb-dfce-419d-9e4c-ca44cc01a2e2(jetbrains.mps.debugger.java.evaluation.structure)", "9146111288436274341")).create();
  ...
  /*package*/ final ConceptDescriptor myConceptIEvaluatorConcept = new ConceptDescriptorBuilder("jetbrains.mps.debugger.java.evaluation.structure.IEvaluatorConcept", MetaIdFactory.conceptId(0x7da4580f9d754603L, 0x816251a896d78375L, 0x7f4a99699cea367bL)).interface_().sourceNode(new SNodePointer("r:3a27a6eb-dfce-419d-9e4c-ca44cc01a2e2(jetbrains.mps.debugger.java.evaluation.structure)", "9172312269976647291")).create();
  ...
  /*package*/ final ConceptDescriptor myConceptLowLevelVariableReference = new ConceptDescriptorBuilder("jetbrains.mps.debugger.java.evaluation.structure.LowLevelVariableReference", MetaIdFactory.conceptId(0x7da4580f9d754603L, 0x816251a896d78375L, 0x7d9a547f857a394bL)).super_("jetbrains.mps.baseLanguage.structure.BaseVariableReference").super_(MetaIdFactory.conceptId(0xf3061a5392264cc5L, 0xa443f952ceaf5816L, 0x4c4b92003e49a704L)).parents("jetbrains.mps.baseLanguage.structure.BaseVariableReference").parentIds(MetaIdFactory.conceptId(0xf3061a5392264cc5L, 0xa443f952ceaf5816L, 0x4c4b92003e49a704L)).staticScope(StaticScope.NONE).sourceNode(new SNodePointer("r:3a27a6eb-dfce-419d-9e4c-ca44cc01a2e2(jetbrains.mps.debugger.java.evaluation.structure)", "9050639307831392587")).create();
  /*package*/ final ConceptDescriptor myConceptToEvaluateAnnotation = new ConceptDescriptorBuilder("jetbrains.mps.debugger.java.evaluation.structure.ToEvaluateAnnotation", MetaIdFactory.conceptId(0x7da4580f9d754603L, 0x816251a896d78375L, 0x4135c73fbe7fc985L)).super_("jetbrains.mps.debugger.java.evaluation.structure.GenerationHelperAnnotation").super_(MetaIdFactory.conceptId(0x7da4580f9d754603L, 0x816251a896d78375L, 0x17b1c8f7ef7ab40cL)).parents("jetbrains.mps.debugger.java.evaluation.structure.GenerationHelperAnnotation").parentIds(MetaIdFactory.conceptId(0x7da4580f9d754603L, 0x816251a896d78375L, 0x17b1c8f7ef7ab40cL)).sourceNode(new SNodePointer("r:3a27a6eb-dfce-419d-9e4c-ca44cc01a2e2(jetbrains.mps.debugger.java.evaluation.structure)", "4698880862823893381")).create();
  ...
  /*package*/ final ConceptDescriptor myConceptUnprocessedAnnotation = new ConceptDescriptorBuilder("jetbrains.mps.debugger.java.evaluation.structure.UnprocessedAnnotation", MetaIdFactory.conceptId(0x7da4580f9d754603L, 0x816251a896d78375L, 0x50b810dd5c871ea2L)).super_("jetbrains.mps.debugger.java.evaluation.structure.GenerationHelperAnnotation").super_(MetaIdFactory.conceptId(0x7da4580f9d754603L, 0x816251a896d78375L, 0x17b1c8f7ef7ab40cL)).parents("jetbrains.mps.debugger.java.evaluation.structure.GenerationHelperAnnotation").parentIds(MetaIdFactory.conceptId(0x7da4580f9d754603L, 0x816251a896d78375L, 0x17b1c8f7ef7ab40cL)).alias("unprocessed", "").sourceNode(new SNodePointer("r:3a27a6eb-dfce-419d-9e4c-ca44cc01a2e2(jetbrains.mps.debugger.java.evaluation.structure)", "5816417461675171490")).create();
