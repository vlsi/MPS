  ...
  public static class QuotationClass_x583g4_a0a0a0a0a93 {
    ...
    public SNode createNode() {
      ...
      SNode quotedNode_1 = null;
      {
        ...
        quotedNode1_2.setReference("classifier", SReference.create("classifier", quotedNode1_2, SModelReference.fromString("r:ac4cce94-c169-4971-be8f-807482637028(jetbrains.mps.debug.runtime.java.programState.proxies)"), SNodeId.fromString("3432969378036017270")));
