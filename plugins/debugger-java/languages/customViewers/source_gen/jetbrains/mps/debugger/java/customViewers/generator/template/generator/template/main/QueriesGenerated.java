...
public class QueriesGenerated {
  ...
  private static SNode _quotation_createNode_x583g4_a0a0a0a0nb() {
    ...
    quotedNode_1.setReference("classifier", SReference.create("classifier", quotedNode_1, SModelReference.fromString("r:ac4cce94-c169-4971-be8f-807482637028(jetbrains.mps.debugger.java.api.state.proxy)"), jetbrains.mps.smodel.SNodeId.fromString("3432969378036017270")));
    return quotedNode_1;
  }
