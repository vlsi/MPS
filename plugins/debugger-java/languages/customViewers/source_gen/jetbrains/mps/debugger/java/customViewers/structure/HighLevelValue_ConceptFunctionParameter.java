...
public class HighLevelValue_ConceptFunctionParameter extends ConceptFunctionParameter {
  public static final String concept = "jetbrains.mps.debugger.java.customViewers.structure.HighLevelValue_ConceptFunctionParameter";
  ...
  public static HighLevelValue_ConceptFunctionParameter newInstance(SModel sm, boolean init) {
    return (HighLevelValue_ConceptFunctionParameter) SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.debugger.java.customViewers.structure.HighLevelValue_ConceptFunctionParameter", sm, GlobalScope.getInstance(), init).getAdapter();
  }
