...
public class CustomViewer extends BaseConcept implements INamedConcept {
  public static final String concept = "jetbrains.mps.debugger.java.customViewers.structure.CustomViewer";
  ...
  public static CustomViewer newInstance(SModel sm, boolean init) {
    return (CustomViewer) SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.debugger.java.customViewers.structure.CustomViewer", sm, GlobalScope.getInstance(), init).getAdapter();
  }
