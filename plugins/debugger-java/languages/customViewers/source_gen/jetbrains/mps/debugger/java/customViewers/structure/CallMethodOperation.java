...
public class CallMethodOperation extends BaseConcept implements IOperation {
  public static final String concept = "jetbrains.mps.debugger.java.customViewers.structure.CallMethodOperation";
  ...
  public static CallMethodOperation newInstance(SModel sm, boolean init) {
    return (CallMethodOperation) SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.debugger.java.customViewers.structure.CallMethodOperation", sm, GlobalScope.getInstance(), init).getAdapter();
  }
