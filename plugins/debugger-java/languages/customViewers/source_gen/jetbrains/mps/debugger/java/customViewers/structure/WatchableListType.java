...
public class WatchableListType extends Type {
  public static final String concept = "jetbrains.mps.debugger.java.customViewers.structure.WatchableListType";
  ...
  public static WatchableListType newInstance(SModel sm, boolean init) {
    return (WatchableListType) SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.debugger.java.customViewers.structure.WatchableListType", sm, GlobalScope.getInstance(), init).getAdapter();
  }
