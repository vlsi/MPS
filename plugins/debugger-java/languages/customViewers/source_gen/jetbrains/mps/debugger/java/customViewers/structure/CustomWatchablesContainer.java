...
public class CustomWatchablesContainer extends BaseConcept implements INamedConcept {
  public static final String concept = "jetbrains.mps.debugger.java.customViewers.structure.CustomWatchablesContainer";
  ...
  public static CustomWatchablesContainer newInstance(SModel sm, boolean init) {
    return (CustomWatchablesContainer) SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.debugger.java.customViewers.structure.CustomWatchablesContainer", sm, GlobalScope.getInstance(), init).getAdapter();
  }
