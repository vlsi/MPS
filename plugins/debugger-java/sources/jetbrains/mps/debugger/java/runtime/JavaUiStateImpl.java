...
public class JavaUiStateImpl extends JavaUiState {
  ...
  JavaUiStateImpl(@Nullable SuspendContext context, DebugSession debugSession) {
    super(debugSession);
  ...
  JavaUiStateImpl(@NotNull JavaUiStateImpl previousState, @Nullable JavaThread thread, DebugSession debugSession) {
    super(debugSession);
    myDebugSession = debugSession;
    if (thread == null) {
      myContext = null;
  ...
  JavaUiStateImpl(@NotNull JavaUiStateImpl previousState, int frameIndex, DebugSession debugSession) {
    super(debugSession);
    myDebugSession = debugSession;
  ...
  @NotNull
  JavaUiStateImpl paused(SuspendContext context) {
  ...
  @NotNull
  JavaUiStateImpl resumed(SuspendContext context) {
