...
public abstract class DebugConnectionSettings implements IDebuggerSettings {
  ...
  public String getCommandLine(boolean application) {
    ...
    return DebugConnectionSettings.getCommandLine(serverMode, myUseSockets, isSuspend(), myHostName, myPort, mySharedMemoryAddress);
  }
  ...
  public String getAddress() {
    return DebugConnectionSettings.getAddress(myUseSockets, myHostName, myPort, mySharedMemoryAddress);
  }
  ...
  protected static String getCommandLine(boolean serverMode, boolean useSockets, boolean suspend, String host, int port, String sharedMemoryAddress) {
    return DebugConnectionSettings.getCommandLine(serverMode, useSockets, suspend, DebugConnectionSettings.getAddress(useSockets, host, port, sharedMemoryAddress));
  }
