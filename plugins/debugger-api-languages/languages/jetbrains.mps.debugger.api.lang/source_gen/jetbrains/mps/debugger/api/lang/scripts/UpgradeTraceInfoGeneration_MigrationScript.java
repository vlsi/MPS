...
public class UpgradeTraceInfoGeneration_MigrationScript extends BaseMigrationScript {
  public UpgradeTraceInfoGeneration_MigrationScript(IOperationContext operationContext) {
      ...
      public void doUpdateInstanceNode(SNode node) {
        if (ListSequence.fromList(SLinkOperations.getTargets(node, "conceptsToDebug", true)).isNotEmpty() && ListSequence.fromList(SModelOperations.getRoots(SNodeOperations.getModel(node), "jetbrains.mps.debugger.api.lang.structure.BreakpointCreator")).isEmpty() && ListSequence.fromList(SLinkOperations.getTargets(node, "conceptsToDebug", true)).findFirst(new IWhereFilter<SNode>() {
          ...
          for (SNode conceptToDebug : ListSequence.fromList(SLinkOperations.getTargets(node, "conceptsToDebug", true))) {
            ListSequence.fromList(SLinkOperations.getTargets(debugInfoProvider, "breakpointableConcepts", true)).addElement(new UpgradeTraceInfoGeneration_MigrationScript.QuotationClass_eean50_a0a0a0c0a0e0a0a0b0a().createNode(SLinkOperations.getTarget(SLinkOperations.getTarget(conceptToDebug, "createBreakpoint", true), "body", true), SLinkOperations.getTarget(conceptToDebug, "declaration", false), SLinkOperations.getTarget(conceptToDebug, "declaration", false)));
          ...
          for (SNode nodeRef : ListSequence.fromList(SNodeOperations.getDescendants(debugInfoProvider, "jetbrains.mps.debugger.api.lang.structure.ConceptFunctionParameter_DebuggableNode_Deprecated", false, new String[]{}))) {
            SNodeOperations.replaceWithAnother(nodeRef, SConceptOperations.createNewNode("jetbrains.mps.debugger.api.lang.structure.ConceptFunctionParameter_DebuggableNode_Deprecated", null));
          }
        ...
        for (SNode traceableConcept : ListSequence.fromList(SLinkOperations.getTargets(node, "conceptsToDebug", true)).where(new IWhereFilter<SNode>() {
          public boolean accept(SNode it) {
            return ListSequence.fromList(SLinkOperations.getTargets(SLinkOperations.getTarget(it, "declaration", false), "implements", true)).findFirst(new IWhereFilter<SNode>() {
              public boolean accept(SNode interfaceRef) {
                return eq_eean50_a0a0a0a0a0a0a0a0a0a7a4a0a0a1a0(SLinkOperations.getTarget(interfaceRef, "intfc", false), SLinkOperations.getTarget(new UpgradeTraceInfoGeneration_MigrationScript.QuotationClass_eean50_a0a0a0a0a0a0a0a7a4a0a0a1a0().createNode(), "intfc", false));
              }
            }) == null;
          }
        })) {
          SNode conceptDeclaration = SLinkOperations.getTarget(traceableConcept, "declaration", false);
          ListSequence.fromList(SLinkOperations.getTargets(conceptDeclaration, "implements", true)).addElement(new UpgradeTraceInfoGeneration_MigrationScript.QuotationClass_eean50_a0a0b0h0e0a0a0b0a().createNode());
          if ((SLinkOperations.getTarget(traceableConcept, "propertyStringGetter", true) != null)) {
            ...
            SNode methodImpl = new UpgradeTraceInfoGeneration_MigrationScript.QuotationClass_eean50_a0a1a2a7a4a0a0a1a0().createNode();
            ...
            for (SNode debuggableNode : ListSequence.fromList(SNodeOperations.getDescendants(methodImpl, "jetbrains.mps.debugger.api.lang.structure.ConceptFunctionParameter_DebuggableNode_Deprecated", false, new String[]{}))) {
              SNodeOperations.replaceWithAnother(debuggableNode, new UpgradeTraceInfoGeneration_MigrationScript.QuotationClass_eean50_a1a0a4a2a7a4a0a0a1a0().createNode());
            }
          }
        }
        ...
        for (SNode scopeConcept : ListSequence.fromList(SLinkOperations.getTargets(node, "scopeConcepts", true)).where(new IWhereFilter<SNode>() {
          public boolean accept(SNode it) {
            return ListSequence.fromList(SLinkOperations.getTargets(SLinkOperations.getTarget(it, "scopeConcept", false), "implements", true)).findFirst(new IWhereFilter<SNode>() {
              public boolean accept(SNode interfaceRef) {
                return eq_eean50_a0a0a0a0a0a0a0a0a0a01a4a0a0a1a0(SLinkOperations.getTarget(interfaceRef, "intfc", false), SLinkOperations.getTarget(new UpgradeTraceInfoGeneration_MigrationScript.QuotationClass_eean50_a0a0a0a0a0a0a0a01a4a0a0a1a0().createNode(), "intfc", false));
              }
            }) == null;
          }
        })) {
          SNode conceptDeclaration = SLinkOperations.getTarget(scopeConcept, "scopeConcept", false);
          ListSequence.fromList(SLinkOperations.getTargets(conceptDeclaration, "implements", true)).addElement(new UpgradeTraceInfoGeneration_MigrationScript.QuotationClass_eean50_a0a0b0k0e0a0a0b0a().createNode());
          SNode conceptBehavior = getOrCreateBehavior.invoke(conceptDeclaration);
          SNode methodImpl = new UpgradeTraceInfoGeneration_MigrationScript.QuotationClass_eean50_a0a3a01a4a0a0a1a0().createNode();
          ...
          ListSequence.fromList(SLinkOperations.getTargets(conceptBehavior, "method", true)).addElement(methodImpl);
          for (SNode scopeNode : ListSequence.fromList(SNodeOperations.getDescendants(methodImpl, "jetbrains.mps.debugger.api.lang.structure.ConceptFunctionParameter_ScopeNode", false, new String[]{}))) {
            SNodeOperations.replaceWithAnother(scopeNode, new UpgradeTraceInfoGeneration_MigrationScript.QuotationClass_eean50_a1a0a6a01a4a0a0a1a0().createNode());
          }
        }
        ...
        for (SNode unitConcept : ListSequence.fromList(SLinkOperations.getTargets(node, "unitConcepts", true)).where(new IWhereFilter<SNode>() {
          public boolean accept(SNode it) {
            return ListSequence.fromList(SLinkOperations.getTargets(SLinkOperations.getTarget(it, "unitConcept", false), "implements", true)).findFirst(new IWhereFilter<SNode>() {
              public boolean accept(SNode interfaceRef) {
                return eq_eean50_a0a0a0a0a0a0a0a0a0a31a4a0a0a1a0(SLinkOperations.getTarget(interfaceRef, "intfc", false), SLinkOperations.getTarget(new UpgradeTraceInfoGeneration_MigrationScript.QuotationClass_eean50_a0a0a0a0a0a0a0a31a4a0a0a1a0().createNode(), "intfc", false));
              }
            }) == null;
          }
        })) {
          SNode conceptDeclaration = SLinkOperations.getTarget(unitConcept, "unitConcept", false);
          ListSequence.fromList(SLinkOperations.getTargets(conceptDeclaration, "implements", true)).addElement(new UpgradeTraceInfoGeneration_MigrationScript.QuotationClass_eean50_a0a0b0n0e0a0a0b0a().createNode());
          SNode conceptBehavior = getOrCreateBehavior.invoke(conceptDeclaration);
          SNode methodImpl = new UpgradeTraceInfoGeneration_MigrationScript.QuotationClass_eean50_a0a3a31a4a0a0a1a0().createNode();
          ...
          ListSequence.fromList(SLinkOperations.getTargets(conceptBehavior, "method", true)).addElement(methodImpl);
          for (SNode unitNode : ListSequence.fromList(SNodeOperations.getDescendants(methodImpl, "jetbrains.mps.debugger.api.lang.structure.ConceptFunctionParameter_UnitNode", false, new String[]{}))) {
            SNodeOperations.replaceWithAnother(unitNode, new UpgradeTraceInfoGeneration_MigrationScript.QuotationClass_eean50_a1a0a6a31a4a0a0a1a0().createNode());
          }
        }
  ...
  private static boolean eq_eean50_a0a0a0a0a0a0a0a0a0a7a4a0a0a1a0(Object a, Object b) {
    return (a != null ?
      a.equals(b) :
      a == b
    );
  ...
  private static boolean eq_eean50_a0a0a0a0a0a0a0a0a0a01a4a0a0a1a0(Object a, Object b) {
    return (a != null ?
      a.equals(b) :
      a == b
    );
  ...
  private static boolean eq_eean50_a0a0a0a0a0a0a0a0a0a31a4a0a0a1a0(Object a, Object b) {
    return (a != null ?
      a.equals(b) :
      a == b
    );
  ...
  public static class QuotationClass_eean50_a0a0a0c0a0e0a0a0b0a {
  ...
  public static class QuotationClass_eean50_a0a0b0h0e0a0a0b0a {
    public QuotationClass_eean50_a0a0b0h0e0a0a0b0a() {
    }
  ...
  public static class QuotationClass_eean50_a0a1a2a7a4a0a0a1a0 {
    public QuotationClass_eean50_a0a1a2a7a4a0a0a1a0() {
    }
  ...
  public static class QuotationClass_eean50_a1a0a4a2a7a4a0a0a1a0 {
    public QuotationClass_eean50_a1a0a4a2a7a4a0a0a1a0() {
    }
  ...
  public static class QuotationClass_eean50_a0a0a0a0a0a0a0a7a4a0a0a1a0 {
    public QuotationClass_eean50_a0a0a0a0a0a0a0a7a4a0a0a1a0() {
    }
  ...
  public static class QuotationClass_eean50_a0a0b0k0e0a0a0b0a {
    public QuotationClass_eean50_a0a0b0k0e0a0a0b0a() {
    }
  ...
  public static class QuotationClass_eean50_a0a3a01a4a0a0a1a0 {
    public QuotationClass_eean50_a0a3a01a4a0a0a1a0() {
    }
  ...
  public static class QuotationClass_eean50_a1a0a6a01a4a0a0a1a0 {
    public QuotationClass_eean50_a1a0a6a01a4a0a0a1a0() {
    }
  ...
  public static class QuotationClass_eean50_a0a0a0a0a0a0a0a01a4a0a0a1a0 {
    public QuotationClass_eean50_a0a0a0a0a0a0a0a01a4a0a0a1a0() {
    }
  ...
  public static class QuotationClass_eean50_a0a0b0n0e0a0a0b0a {
    public QuotationClass_eean50_a0a0b0n0e0a0a0b0a() {
    }
  ...
  public static class QuotationClass_eean50_a0a3a31a4a0a0a1a0 {
    public QuotationClass_eean50_a0a3a31a4a0a0a1a0() {
    }
  ...
  public static class QuotationClass_eean50_a1a0a6a31a4a0a0a1a0 {
    public QuotationClass_eean50_a1a0a6a31a4a0a0a1a0() {
    }
  ...
  public static class QuotationClass_eean50_a0a0a0a0a0a0a0a31a4a0a0a1a0 {
    public QuotationClass_eean50_a0a0a0a0a0a0a0a31a4a0a0a1a0() {
    }
