...
public class UnitNodeItem extends BaseConcept {
  public static final String concept = "jetbrains.mps.debugger.api.lang.structure.UnitNodeItem";
  ...
  public static UnitNodeItem newInstance(SModel sm, boolean init) {
    return (UnitNodeItem) SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.debugger.api.lang.structure.UnitNodeItem", sm, GlobalScope.getInstance(), init).getAdapter();
  }
