...
public class DebugInfoInitializer extends BaseConcept {
  public static final String concept = "jetbrains.mps.debugger.api.lang.structure.DebugInfoInitializer";
  ...
  public static DebugInfoInitializer newInstance(SModel sm, boolean init) {
    return (DebugInfoInitializer) SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.debugger.api.lang.structure.DebugInfoInitializer", sm, GlobalScope.getInstance(), init).getAdapter();
  }
