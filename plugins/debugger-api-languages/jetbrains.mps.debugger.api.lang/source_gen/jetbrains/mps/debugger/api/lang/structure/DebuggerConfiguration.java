...
public class DebuggerConfiguration extends BaseConcept {
  public static final String concept = "jetbrains.mps.debugger.api.lang.structure.DebuggerConfiguration";
  ...
  public static DebuggerConfiguration newInstance(SModel sm, boolean init) {
    return (DebuggerConfiguration) SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.debugger.api.lang.structure.DebuggerConfiguration", sm, GlobalScope.getInstance(), init).getAdapter();
  }
