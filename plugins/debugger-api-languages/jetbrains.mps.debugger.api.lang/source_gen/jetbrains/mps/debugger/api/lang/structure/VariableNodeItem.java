...
public class VariableNodeItem extends BaseConcept {
  public static final String concept = "jetbrains.mps.debugger.api.lang.structure.VariableNodeItem";
  ...
  public static VariableNodeItem newInstance(SModel sm, boolean init) {
    return (VariableNodeItem) SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.debugger.api.lang.structure.VariableNodeItem", sm, GlobalScope.getInstance(), init).getAdapter();
  }
