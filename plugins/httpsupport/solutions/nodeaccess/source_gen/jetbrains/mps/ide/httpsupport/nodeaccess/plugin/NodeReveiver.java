...
public class NodeReveiver extends HttpRequestHandlerBase {
  ...
  protected void initParameterValues() {
    this.node = ListSequence.fromList(request.getParameterValue("node")).getElement(0);
  ...
  public void handle(@NotNull HttpRequest request) throws Exception {
    ...
    project.getModelAccess().executeCommandInEDT(new Runnable() {
      public void run() {
        try {
          ...
          EditableModelDescriptor tmpModel = as_rm47i7_a0a3a0a0a0a0a5a41(TemporaryModels.getInstance().create(false, TempModuleOptions.forDefaultModule()), EditableModelDescriptor.class);
          ...
          ReceivedNodeDialog dialog = new ReceivedNodeDialog(as_rm47i7_a0a0a21a0a0a0a0a5a41(project, MPSProject.class), loadedNode);
          dialog.show();
  ...
  private static <T> T as_rm47i7_a0a3a0a0a0a0a5a41(Object o, Class<T> type) {
    return (type.isInstance(o) ? (T) o : null);
  }
  private static <T> T as_rm47i7_a0a0a21a0a0a0a0a5a41(Object o, Class<T> type) {
    return (type.isInstance(o) ? (T) o : null);
  }
}
