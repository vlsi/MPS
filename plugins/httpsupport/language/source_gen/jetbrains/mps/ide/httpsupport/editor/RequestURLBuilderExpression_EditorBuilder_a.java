...
/*package*/ class RequestURLBuilderExpression_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createRefCell_9zlrxo_b0() {
    ...
    provider.setAuxiliaryCellProvider(new RequestURLBuilderExpression_EditorBuilder_a._Inline_9zlrxo_a1a());
  ...
  public static class _Inline_9zlrxo_a1a extends InlineCellProvider {
    public _Inline_9zlrxo_a1a() {
      super();
    }
    ...
    public EditorCell createEditorCell(EditorContext editorContext, SNode node) {
      ...
      return new RequestURLBuilderExpression_EditorBuilder_a.Inline_Builder_9zlrxo_a1a(editorContext, getRefNode(), node).createCell();
    }
  }
  /*package*/ static class Inline_Builder_9zlrxo_a1a extends AbstractEditorBuilder {
    ...
    private EditorCell createReferencePresentation_9zlrxo_a0b0() {
      EditorCell_Property editorCell = EditorCell_RefPresentation.create(getEditorContext(), myNode, myReferencingNode, "requestHandler");
  ...
  private class initializerListHandler_9zlrxo_e0 extends RefNodeListHandler {
    ...
    public void installElementCellActions(SNode elementNode, EditorCell elementCell) {
      if (elementCell.getUserObject(AbstractCellListHandler.ELEMENT_CELL_ACTIONS_SET) == null) {
        ...
        if (elementCell.getSubstituteInfo() == null || elementCell.getSubstituteInfo() instanceof DefaultSubstituteInfo) {
          elementCell.setSubstituteInfo(new OldNewCompositeSubstituteInfo(getEditorContext(), new SChildSubstituteInfo(elementCell, getNode(), MetaAdapterFactory.getContainmentLink(0x817e4e70961e4a95L, 0x98a115e9f32231f1L, 0x4027f9073ff5ce93L, 0x4027f9073ff652f7L, "initializer"), elementNode), new DefaultChildSubstituteInfo(getNode(), elementNode, super.getLinkDeclaration(), getEditorContext())));
        }
      }
    }
  }
