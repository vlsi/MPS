  ...
  public void doExecute(@NotNull final AnActionEvent event, final Map<String, Object> _params) {
    try {
      for (IModule module : ListSequence.fromList(MPSModuleRepository.getInstance().getAllModules())) {
        ...
        Iterator<ModelRoot> mr_it = ListSequence.fromList(descriptor.getModelRoots()).iterator();
        ModelRoot mr_var;
        while (mr_it.hasNext()) {
          mr_var = mr_it.next();
        ...
        Iterator<ModelRoot> sm_it = ListSequence.fromList(descriptor.getStubModelEntries()).iterator();
        ModelRoot sm_var;
        while (sm_it.hasNext()) {
          sm_var = sm_it.next();
