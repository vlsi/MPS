...
public final class ITestCase__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<String> getSimpleClassName_idhSQIE8p = new SMethodBuilder<String>(new SJavaCompoundTypeImpl(String.class)).name("getSimpleClassName").modifiers(SModifiersImpl.create(8, AccessPrivileges.PUBLIC)).concept(CONCEPT).id("hSQIE8p").registry(REGISTRY).build(SParameterImpl.fromList(SJavaCompoundTypeImpl.fromClasses()));
  ...
  public static final SMethod<Boolean> canRunInProcess_id5_jSk8paieB = new SMethodBuilder<Boolean>(new SJavaCompoundTypeImpl(Boolean.TYPE)).name("canRunInProcess").modifiers(SModifiersImpl.create(10, AccessPrivileges.PUBLIC)).concept(CONCEPT).id("5_jSk8paieB").registry(REGISTRY).build(SParameterImpl.fromList(SJavaCompoundTypeImpl.fromClasses()));
  ...
  private static Boolean canRunInProcess_id5_jSk8paieB(@NotNull SNode __thisNode__) {
  ...
  protected <T> T invokeSpecial0(@NotNull SNode node, @NotNull SMethod<T> method, @NotNull Object[] parameters) {
    ...
    switch (methodIndex) {
      ...
      case 2:
        return (T) getSimpleClassName_idhSQIE8p(node);
      case 3:
        return (T) getTestMethods_id1RfJDyhAUar(node);
      case 4:
        return (T) canRunInProcess_id5_jSk8paieB(node);
      default:
        throw new BHMethodNotFoundException(this, method);
    }
  }
