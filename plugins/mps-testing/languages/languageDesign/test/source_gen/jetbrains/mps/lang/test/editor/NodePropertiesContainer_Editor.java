...
public class NodePropertiesContainer_Editor extends DefaultNodeEditor {
  ...
  private static class nodeCheckOperationsListHandler_ow7a4w_c0 extends RefNodeListHandler {
    ...
    public EditorCell createEmptyCell(EditorContext editorContext) {
      editorContext.getCellFactory().pushCellContext();
      editorContext.getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(nodeCheckOperationsListHandler_ow7a4w_c0.this.getOwner(), MetaAdapterFactory.getContainmentLink(0x8585453e6bfb4d80L, 0x98deb16074f1d86cL, 0x11b01e50b53L, 0x11b01eac99fL, "nodeCheckOperations")));
      try {
