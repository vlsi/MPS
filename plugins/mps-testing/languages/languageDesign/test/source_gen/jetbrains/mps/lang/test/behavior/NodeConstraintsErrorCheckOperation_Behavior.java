...
public class NodeConstraintsErrorCheckOperation_Behavior {
  ...
  public static void virtual_attachReference_2893471348147987863(SNode thisNode, SNode reference) {
    ...
    SLinkOperations.setTarget(thisNode, MetaAdapterFactory.getContainmentLink(new UUID(-8825571760360698496l, -7431307307277756308l), 8333855927540283103l, 8333855927548182241l, "errorRef"), SConceptOperations.createNewNode(SNodeOperations.asInstanceConcept(MetaAdapterFactory.getConcept(new UUID(-8825571760360698496l, -7431307307277756308l), 7691029917083831655l, "jetbrains.mps.lang.test.structure.UnknownRuleReference"))));
