...
public class AdditionalStructurePropertiesImpl extends ConceptPresentationAspectBase {
  ...
  private final ConceptPresentation props_EditorTestCase = new ConceptPresentationBuilder().icon("nodesTest.png", AdditionalStructurePropertiesImpl.class).create();
  ...
  private final ConceptPresentation props_NodesTestCase = new ConceptPresentationBuilder().icon("nodesTest.png", AdditionalStructurePropertiesImpl.class).create();
