...
/*package*/ class NodeTypeSystemWarningCheckOperation_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  /*package*/ EditorCell createCell() {
    return createCollection_p012vy_a();
  }

  private EditorCell createCollection_p012vy_a() {
    EditorCell_Collection editorCell = EditorCell_Collection.createHorizontal(getEditorContext(), myNode);
    editorCell.setCellId("Collection_p012vy_a");
    editorCell.setBig(true);
    editorCell.setCellContext(getCellFactory().getCellContext());
    editorCell.addEditorCell(createComponent_p012vy_a0());
    if (SNodeAccessUtil.hasProperty(myNode, MetaAdapterFactory.getProperty(0xceab519525ea4f22L, 0x9b92103b95ca8c0cL, 0x110396eaaa4L, 0x110396ec041L, "name"))) {
      editorCell.addEditorCell(createNonEmptyProperty_p012vy_b0());
    }
    return editorCell;
  }
  private EditorCell createComponent_p012vy_a0() {
  ...
  private EditorCell createNonEmptyProperty_p012vy_b0() {
