...
public class NodeOperationsContainer_Behavior {
  ...
  public static String virtual_getRole_1262430001741497900(SAbstractConcept thisConcept) {
    return "nodeOpraretionsMark";
  }

  public static List<SNode> virtual_getAttributed_3044950653914717013(SAbstractConcept thisConcept) {
    List<SNode> result = BehaviorReflection.invokeSuperStatic((Class<List<SNode>>) ((Class) Object.class), thisConcept, "jetbrains.mps.lang.test.structure.INodeAnnotattion", "virtual_getAttributed_3044950653914717013", new Object[]{});
