...
public class StructureAspectDescriptor implements jetbrains.mps.smodel.runtime.StructureAspectDescriptor {
  ...
  public ConceptDescriptor getDescriptor(String conceptFqName) {
    switch (Arrays.binarySearch(stringSwitchCases_1htk8d_a0a0b, conceptFqName)) {
      ...
      case 17:
        return new ConceptDescriptorBuilder("jetbrains.mps.lang.test.structure.IRuleReference").interface_().create();
      case 18:
      ...
      case 29:
        return new ConceptDescriptorBuilder("jetbrains.mps.lang.test.structure.NodeRuleCheckOperation").super_("jetbrains.mps.lang.test.structure.NodeCheckOperation").parents("jetbrains.mps.lang.test.structure.NodeCheckOperation", "jetbrains.mps.lang.test.structure.IAllowsErrors", "jetbrains.mps.lang.test.structure.IReferenceAttachable").abstract_().alias("", "check specific rule").create();
      case 30:
      ...
      case 33:
        return new ConceptDescriptorBuilder("jetbrains.mps.lang.test.structure.NodeTypeSystemRuleCheckOperation").super_("jetbrains.mps.lang.test.structure.NodeCheckOperation").parents("jetbrains.mps.lang.test.structure.NodeCheckOperation", "jetbrains.mps.lang.test.structure.IAllowsErrors").abstract_().create();
      case 34:
