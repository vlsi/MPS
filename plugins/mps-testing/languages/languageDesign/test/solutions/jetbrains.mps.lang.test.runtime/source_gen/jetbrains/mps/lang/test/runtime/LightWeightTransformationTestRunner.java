...
public class LightWeightTransformationTestRunner extends TransformationTestRunner {
  ...
  private Project findProject(@NotNull String projectPath) {
    ...
    for (Project project : ProjectManager.getInstance().getOpenProjects()) {
      if (LightWeightTransformationTestRunner.projectHasPath(project, projectFile)) {
        return project;
      }
    }
    return null;
  ...
  protected static Logger LOG = LogManager.getLogger(LightWeightTransformationTestRunner.class);
}
