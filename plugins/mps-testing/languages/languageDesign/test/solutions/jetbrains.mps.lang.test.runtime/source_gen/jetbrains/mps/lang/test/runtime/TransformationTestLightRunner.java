...
import jetbrains.mps.execution.configurations.implementation.plugin.plugin.TestLightRunState;
import jetbrains.mps.execution.configurations.implementation.plugin.plugin.TestLightExecutor;
...
public class TransformationTestLightRunner extends TransformationTestRunner {
  ...
  private boolean isRunTerminating() {
    TestLightRunState runState = TestLightExecutor.getRunState(Thread.currentThread().getId());
