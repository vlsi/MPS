...
public class LightTransformationTestRunner extends TransformationTestRunner {
  ...
  private Project findProject(@NotNull String projectPath) {
    ...
    for (Project project : ProjectManager.getInstance().getOpenProjects()) {
      if (LightTransformationTestRunner.projectHasPath(project, projectFile)) {
        return project;
      }
    }
    return null;
  ...
  protected static Logger LOG = LogManager.getLogger(LightTransformationTestRunner.class);
}
