...
/*package*/ class ReferenceContainerSubConcept_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createRefCell_j13i3b_b0b1a() {
    CellProviderWithRole provider = new RefCellCellProvider(myNode, getEditorContext()) {
      ...
      protected InlineCellProvider createInlineCellProvider(SNode innerCellNode) {
        return new ReferenceContainerSubConcept_EditorBuilder_a._Inline_j13i3b_a1a1b0(innerCellNode, myNode);
      }
    };
  ...
  public static class _Inline_j13i3b_a1a1b0 extends InlineCellProvider {
    public _Inline_j13i3b_a1a1b0(SNode node, SNode refNode) {
      super(node, refNode);
    }
  ...
  private EditorCell createRefCell_j13i3b_b1b1a() {
    CellProviderWithRole provider = new RefCellCellProvider(myNode, getEditorContext()) {
      @Override
      protected InlineCellProvider createInlineCellProvider(SNode innerCellNode) {
        return new ReferenceContainerSubConcept_EditorBuilder_a._Inline_j13i3b_a1b1b0(innerCellNode, myNode);
      }
    };
  ...
  public static class _Inline_j13i3b_a1b1b0 extends InlineCellProvider {
    public _Inline_j13i3b_a1b1b0(SNode node, SNode refNode) {
      super(node, refNode);
    }
    public EditorCell createEditorCell(EditorContext editorContext) {
      return createEditorCell(editorContext, getSNode());
  ...
  private EditorCell createRefCell_j13i3b_b2b1a() {
    CellProviderWithRole provider = new RefCellCellProvider(myNode, getEditorContext()) {
      @Override
      protected InlineCellProvider createInlineCellProvider(SNode innerCellNode) {
        return new ReferenceContainerSubConcept_EditorBuilder_a._Inline_j13i3b_a1c1b0(innerCellNode, myNode);
      }
    };
  ...
  public static class _Inline_j13i3b_a1c1b0 extends InlineCellProvider {
    public _Inline_j13i3b_a1c1b0(SNode node, SNode refNode) {
      super(node, refNode);
    }
    public EditorCell createEditorCell(EditorContext editorContext) {
      return createEditorCell(editorContext, getSNode());
