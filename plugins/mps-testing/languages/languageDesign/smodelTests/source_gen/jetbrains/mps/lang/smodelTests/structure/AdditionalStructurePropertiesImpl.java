...
public class AdditionalStructurePropertiesImpl extends BaseAdditionalStructureProperties {
  ...
  private final AdditionalConceptProperties props_ChildSubConcept = new ConceptPropsBuilder().create();
  private final AdditionalConceptProperties props_GrandChild = new ConceptPropsBuilder().create();
  private final AdditionalConceptProperties props_ReferenceContainer = new ConceptPropsBuilder().create();
  private final AdditionalConceptProperties props_ReferenceContainerSubConcept = new ConceptPropsBuilder().create();
