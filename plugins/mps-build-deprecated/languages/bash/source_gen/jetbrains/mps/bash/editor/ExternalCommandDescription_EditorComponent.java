...
public class ExternalCommandDescription_EditorComponent implements ConceptEditorComponent {
  ...
  private static boolean renderingCondition_3xyrme_a0a(SNode node, EditorContext editorContext, IScope scope) {
    return isNotEmpty_3xyrme_a0a0d(SPropertyOperations.getString(node, "description"));
  }
  ...
  public static boolean isNotEmpty_3xyrme_a0a0d(String str) {
