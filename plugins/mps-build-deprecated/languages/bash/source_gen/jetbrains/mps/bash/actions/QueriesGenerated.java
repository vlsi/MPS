...
public class QueriesGenerated {
    ...
    }
    {
      ...
      if (outputConcept == null || SConceptOperations.isSuperConceptOf(childConcept, NameUtil.nodeFQName(outputConcept))) {
        ListSequence.fromList(result).addElement(new DefaultSimpleSubstituteAction(outputConcept, _context.getParentNode(), _context.getCurrentTargetNode(), _context.getChildSetter(), operationContext.getScope()) {
          ...
          public boolean canSubstitute_internal(String pattern, boolean strictly) {
            return REGEXP_x583g4_a0a0a2a0a0a0a2a0a2a1.matcher(pattern).matches();
          }
    ...
    }
    {
      ...
      if (outputConcept == null || SConceptOperations.isSuperConceptOf(childConcept, NameUtil.nodeFQName(outputConcept))) {
        ListSequence.fromList(result).addElement(new DefaultSimpleSubstituteAction(outputConcept, _context.getParentNode(), _context.getCurrentTargetNode(), _context.getChildSetter(), operationContext.getScope()) {
          ...
          public boolean canSubstitute_internal(String pattern, boolean strictly) {
            return REGEXP_x583g4_a0a0a2a0a0a0a2a0a3a1.matcher(pattern).matches();
          }
      ...
      if (outputConcept == null || SConceptOperations.isSuperConceptOf(childConcept, NameUtil.nodeFQName(outputConcept))) {
        ListSequence.fromList(result).addElement(new DefaultSimpleSubstituteAction(outputConcept, _context.getParentNode(), _context.getCurrentTargetNode(), _context.getChildSetter(), operationContext.getScope()) {
          ...
          public boolean canSubstitute_internal(String pattern, boolean strictly) {
            ...
            return REGEXP_x583g4_a0a2a2a0a0a0a2a0a1a3.matcher(pattern).matches();
          }
  ...
  private static Pattern REGEXP_x583g4_a0a0a0a2a0a0a0a2a0a1a0 = Pattern.compile("[^\"`']+", 0);
  private static Pattern REGEXP_x583g4_a0a0a0a0c0a0a0a0c0a0b0a = Pattern.compile("[^\"`']*", 0);
  ...
  private static Pattern REGEXP_x583g4_a0a0a2a0a0a0a2a0a2a1 = Pattern.compile("\\d+[#]\\d+", 0);
  private static Pattern REGEXP_x583g4_a0a0a2a0a0a0a2a0a3a1 = Pattern.compile("0x[A-F\\d]+", 0);
  private static Pattern REGEXP_x583g4_a0a2a2a0a0a0a2a0a1a2 = Pattern.compile("\\w+[=]", 0);
  private static Pattern REGEXP_x583g4_a0a2a2a0a0a0a2a0a1a3 = Pattern.compile("\\w*", 0);
}
