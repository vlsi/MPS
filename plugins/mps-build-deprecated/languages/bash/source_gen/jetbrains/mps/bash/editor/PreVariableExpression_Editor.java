...
public class PreVariableExpression_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createReadOnlyModelAccessor_f3l2sa_a0(final EditorContext editorContext, final SNode node) {
    EditorCell_Property editorCell = EditorCell_Property.create(editorContext, new ModelAccessor() {
      public String getText() {
        return BehaviorReflection.invokeVirtualStatic(String.class, SConceptRepository.getInstance().getConcept(NameUtil.nodeFQName(SNodeOperations.getConceptDeclaration(node))), "virtual_getSign_1262430001741498229", new Object[]{});
      }
    ...
    editorCell.setCellId("ReadOnlyModelAccessor_f3l2sa_a0");
