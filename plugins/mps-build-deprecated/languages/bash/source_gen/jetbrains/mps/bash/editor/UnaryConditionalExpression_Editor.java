...
public class UnaryConditionalExpression_Editor extends DefaultNodeEditor {
  public EditorCell createEditorCell(EditorContext editorContext, SNode node) {
    return this.createCollection_ejkdta_a(editorContext, node);
  }
  ...
  private EditorCell createReadOnlyModelAccessor_ejkdta_b0(final EditorContext editorContext, final SNode node) {
    EditorCell_Property editorCell = EditorCell_Property.create(editorContext, new ModelAccessor() {
      public String getText() {
        return BehaviorReflection.invokeVirtualStatic(String.class, SConceptRepository.getInstance().getConcept(NameUtil.nodeFQName(SNodeOperations.getConceptDeclaration(node))), "virtual_getOp_1262430001741497951", new Object[]{});
      }
  ...
  private EditorCell createRefNode_ejkdta_c0(EditorContext editorContext, SNode node) {
