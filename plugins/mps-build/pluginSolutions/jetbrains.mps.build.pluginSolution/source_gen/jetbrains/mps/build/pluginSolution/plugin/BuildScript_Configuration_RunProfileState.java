  ...
  public ExecutionResult execute(Executor executor, @NotNull ProgramRunner runner) throws ExecutionException {
    ...
    ModelAccess.instance().runReadAction(new Runnable() {
      public void run() {
        ...
        String scriptsPath = BuildProject_BehaviorDescriptor.getScriptsPath_id4ahc858UcHk.invoke(node, Context.defaultContext());
        if (scriptsPath != null) {
          file.value = FileSystem.getInstance().getFileByPath(scriptsPath);
          // todo 
          file.value = file.value.getDescendant(BuildProject_BehaviorDescriptor.getOutputFileName_id4gSHdTptyu0.invoke(node));
          // todo select task 
