...
public class AdditionalStructurePropertiesImpl extends BaseAdditionalStructureProperties {
  private final AdditionalConceptProperties props_ClassPathItem = new ConceptPropsBuilder().create();
  private final AdditionalConceptProperties props_MpsStartupScript = new ConceptPropsBuilder().create();
  private final AdditionalConceptProperties props_SimpleVmOptions = new ConceptPropsBuilder().create();
  private final AdditionalConceptProperties props_TextFile = new ConceptPropsBuilder().create();
  private final AdditionalConceptProperties props_TextLine = new ConceptPropsBuilder().create();
  private final AdditionalConceptProperties props_VmOptions = new ConceptPropsBuilder().create();
