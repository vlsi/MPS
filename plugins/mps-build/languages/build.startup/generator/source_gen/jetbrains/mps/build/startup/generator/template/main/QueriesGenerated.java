...
public class QueriesGenerated {
  ...
  public static Object propertyMacro_GetPropertyValue_8979762117546981953(final PropertyMacroContext _context) {
    ...
    List<SNode> classPathItemList = SLinkOperations.getChildren(_context.getNode(), MetaAdapterFactory.getContainmentLink(new UUID(-3097565121670396746l, -5546031393255049985l), 3885435385580582152l, 3885435385580582696l, "bootClasspath"));
    for (SNode cpItem : ListSequence.fromList(classPathItemList).cut(1)) {
      pathString += prefix + SPropertyOperations.getString(cpItem, MetaAdapterFactory.getProperty(new UUID(-3097565121670396746l, -5546031393255049985l), 3885435385580582153l, 3885435385580582154l, "path")).replace("\\", "/") + ":";
    }
    pathString += prefix + SPropertyOperations.getString(ListSequence.fromList(classPathItemList).last(), MetaAdapterFactory.getProperty(new UUID(-3097565121670396746l, -5546031393255049985l), 3885435385580582153l, 3885435385580582154l, "path")).replace("\\", "/");
    return pathString;
  }
  public static Object propertyMacro_GetPropertyValue_8979762117546982017(final PropertyMacroContext _context) {
    return SPropertyOperations.getString(_context.getNode(), MetaAdapterFactory.getProperty(new UUID(-3097565121670396746l, -5546031393255049985l), 3885435385580582152l, 3885435385580631186l, "startupClass"));
  }
  ...
  public static Object propertyMacro_GetPropertyValue_8979762117546982098(final PropertyMacroContext _context) {
    return _context.getTemplateValue() + "/" + SPropertyOperations.getString(_context.getNode(), MetaAdapterFactory.getProperty(new UUID(-3097565121670396746l, -5546031393255049985l), 3885435385580582152l, 3885435385580582155l, "startupFolder"));
  }
  public static Object propertyMacro_GetPropertyValue_1731640411964942144(final PropertyMacroContext _context) {
    return _context.getTemplateValue() + SPropertyOperations.getString(_context.getNode(), MetaAdapterFactory.getProperty(new UUID(-3097565121670396746l, -5546031393255049985l), 3885435385580582152l, 3885435385580631186l, "startupClass"));
  }
  ...
  public static Object propertyMacro_GetPropertyValue_1731640411964953768(final PropertyMacroContext _context) {
    return _context.getTemplateValue() + SPropertyOperations.getString(_context.getNode(), MetaAdapterFactory.getProperty(new UUID(-3097565121670396746l, -5546031393255049985l), 3885435385580582732l, 3885435385580582733l, "options"));
  }
  ...
  public static Object propertyMacro_GetPropertyValue_1731640411965070846(final PropertyMacroContext _context) {
    return _context.getTemplateValue() + SPropertyOperations.getString(ListSequence.fromList(SLinkOperations.getChildren(_context.getNode(), MetaAdapterFactory.getContainmentLink(new UUID(-3097565121670396746l, -5546031393255049985l), 3885435385580582152l, 3885435385580582696l, "bootClasspath"))).first(), MetaAdapterFactory.getProperty(new UUID(-3097565121670396746l, -5546031393255049985l), 3885435385580582153l, 3885435385580582154l, "path")).replace("/", "\\");
  }
  public static Object propertyMacro_GetPropertyValue_1731640411965084740(final PropertyMacroContext _context) {
    return _context.getTemplateValue() + SPropertyOperations.getString(_context.getNode(), MetaAdapterFactory.getProperty(new UUID(-3097565121670396746l, -5546031393255049985l), 3885435385580582153l, 3885435385580582154l, "path")).replace("/", "\\");
  }
  ...
  public static Object propertyMacro_GetPropertyValue_1731640411964801466(final PropertyMacroContext _context) {
    return SPropertyOperations.getString(_context.getNode(), MetaAdapterFactory.getProperty(new UUID(-3554657779850784990l, -7236703803128771572l), 1169194658468l, 1169194664001l, "name")) + ".bat";
  }
  public static Object propertyMacro_GetPropertyValue_1731640411967557625(final PropertyMacroContext _context) {
    return SPropertyOperations.getString(_context.getNode(), MetaAdapterFactory.getProperty(new UUID(-3554657779850784990l, -7236703803128771572l), 1169194658468l, 1169194664001l, "name")) + "." + MpsStartupScript_Behavior.call_getVmOptionsExtension_5842819808956911479(_context.getNode());
  }
  public static Object propertyMacro_GetPropertyValue_4487788881657620080(final PropertyMacroContext _context) {
    String startupDir = SPropertyOperations.getString(_context.getNode(), MetaAdapterFactory.getProperty(new UUID(-3097565121670396746l, -5546031393255049985l), 3885435385580582152l, 3885435385580582155l, "startupFolder"));
  ...
  public static Object propertyMacro_GetPropertyValue_4487788881657840185(final PropertyMacroContext _context) {
    return _context.getTemplateValue() + SPropertyOperations.getString(_context.getNode(), MetaAdapterFactory.getProperty(new UUID(-3097565121670396746l, -5546031393255049985l), 3885435385580582153l, 3885435385580582154l, "path"));
  }
  public static Object propertyMacro_GetPropertyValue_2693344784288480128(final PropertyMacroContext _context) {
    return SPropertyOperations.getString(_context.getNode(), MetaAdapterFactory.getProperty(new UUID(-3554657779850784990l, -7236703803128771572l), 1169194658468l, 1169194664001l, "name")) + "64." + MpsStartupScript_Behavior.call_getVmOptionsExtension_5842819808956911479(_context.getNode());
  }
  ...
  public static Iterable<SNode> sourceNodesQuery_1731640411965079018(final SourceSubstituteMacroNodesContext _context) {
    return ListSequence.fromList(SLinkOperations.getChildren(_context.getNode(), MetaAdapterFactory.getContainmentLink(new UUID(-3097565121670396746l, -5546031393255049985l), 3885435385580582152l, 3885435385580582696l, "bootClasspath"))).skip(1);
  }
  ...
  public static Iterable<SNode> sourceNodesQuery_4487788881657835967(final SourceSubstituteMacroNodesContext _context) {
    return SLinkOperations.getChildren(_context.getNode(), MetaAdapterFactory.getContainmentLink(new UUID(-3097565121670396746l, -5546031393255049985l), 3885435385580582152l, 3885435385580582696l, "bootClasspath"));
  }
