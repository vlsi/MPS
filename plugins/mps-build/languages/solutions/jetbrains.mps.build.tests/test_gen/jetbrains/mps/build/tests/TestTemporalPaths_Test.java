...
public class TestTemporalPaths_Test extends BaseTransformationTest4 {
  ...
  public static class TestBody extends BaseTestBody {
    ...
    public void test_folderInJar() throws Exception {
      this.addNodeById("4045247515868358884");
      TestContext testContext = new TestContext(SModelRepository.getInstance().getModelDescriptor(new jetbrains.mps.smodel.SModelReference("jetbrains.mps.build.tests", "tests")));
