...
public class TestTemporalPaths_Test extends BaseTransformationTest {
  ...
  public static class TestBody extends BaseTestBody {
    public void test_topLevelJar() throws Exception {
      ...
      Assert.assertEquals(TestContext.DEPLOY + "/test.jar", BuildLayout_NamedContainer_Behavior.call_getOutputPath_WithMacro_280273048052535414(SNodeOperations.cast(this.getNodeById("280273048052535266"), MetaAdapterFactory.getConcept(new UUID(8755280088213897754l, -5075149991798053422l), 7389400916848050074l, "jetbrains.mps.build.structure.BuildLayout_Jar")), new TestContext(SModelRepository.getInstance().getModelDescriptor("jetbrains.mps.build.tests@tests"))));
    }
    public void test_topLevelFolder() throws Exception {
      this.addNodeById("4045247515868358884");
      Assert.assertEquals(TestContext.DEPLOY + "/folder", BuildLayout_NamedContainer_Behavior.call_getOutputPath_WithMacro_280273048052535414(SNodeOperations.cast(this.getNodeById("280273048052535287"), MetaAdapterFactory.getConcept(new UUID(8755280088213897754l, -5075149991798053422l), 7389400916848036984l, "jetbrains.mps.build.structure.BuildLayout_Folder")), new TestContext(SModelRepository.getInstance().getModelDescriptor("jetbrains.mps.build.tests@tests"))));
    }
    public void test_topInternalFolder() throws Exception {
      this.addNodeById("4045247515868358884");
      Assert.assertEquals(TestContext.DEPLOY + "/folder/internal", BuildLayout_NamedContainer_Behavior.call_getOutputPath_WithMacro_280273048052535414(SNodeOperations.cast(this.getNodeById("7422876504327290551"), MetaAdapterFactory.getConcept(new UUID(8755280088213897754l, -5075149991798053422l), 7389400916848036984l, "jetbrains.mps.build.structure.BuildLayout_Folder")), new TestContext(SModelRepository.getInstance().getModelDescriptor("jetbrains.mps.build.tests@tests"))));
    }
    public void test_jarInFolder() throws Exception {
      this.addNodeById("4045247515868358884");
      Assert.assertEquals(TestContext.DEPLOY + "/folder/test.jar", BuildLayout_NamedContainer_Behavior.call_getOutputPath_WithMacro_280273048052535414(SNodeOperations.cast(this.getNodeById("280273048052535289"), MetaAdapterFactory.getConcept(new UUID(8755280088213897754l, -5075149991798053422l), 7389400916848050074l, "jetbrains.mps.build.structure.BuildLayout_Jar")), new TestContext(SModelRepository.getInstance().getModelDescriptor("jetbrains.mps.build.tests@tests"))));
    }
