...
public class BuildSourceArchiveRelativePath_Editor extends DefaultNodeEditor {
  ...
  private class compositePartSingleRoleHandler_4z471d_c0 extends SingleRoleCellProvider {
    ...
    public void installCellInfo(SNode node, EditorCell editorCell) {
      if (node != null) {
        BuildSourceArchiveRelativePath_Delete.setCellActions(editorCell, node, myEditorContext);
      }
      editorCell.setSubstituteInfo(new CompositeSubstituteInfo(myEditorContext, new AggregationCellContext(myOwnerNode, node, myContainmentLink.getDeclarationNode()), new SubstituteInfoPartExt[]{new BuildSourceArchiveRelativePath_Editor.BuildSourceArchiveRelativePath_generic_cellMenu_4z471d_a0c0()}));
      if (editorCell.getRole() == null) {
