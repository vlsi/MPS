...
public class BuildLayout_CopyGlobMapper_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createCollection_wl5djv_a(EditorContext editorContext, SNode node) {
    ...
    editorCell.addEditorCell(this.createConceptProperty_wl5djv_a0(editorContext, node));
  ...
  private EditorCell createConceptProperty_wl5djv_a0(EditorContext editorContext, SNode node) {
