...
public final class BuildSource_JavaLibrary_BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<Boolean> canExportByParts_id4RsV8qJGJnM = new SMethodBuilder<Boolean>(new SJavaCompoundTypeImpl(Boolean.TYPE)).name("canExportByParts").modifiers(SModifiersImpl.create(0, AccessPrivileges.PUBLIC)).concept(CONCEPT).id("4RsV8qJGJnM").registry(REGISTRY).build(SParameterImpl.fromList(SJavaCompoundTypeImpl.fromClasses()));
  ...
  private static Boolean canExportByParts_id4RsV8qJGJnM(@NotNull SNode __thisNode__) {
  ...
  /*package*/ BuildSource_JavaLibrary_BehaviorDescriptor() {
    super(REGISTRY);
  }
  ...
  protected <T> T invokeSpecial0(@NotNull SNode node, @NotNull SMethod<T> method, @NotNull Object[] parameters) {
    ...
    switch (methodIndex) {
      case 0:
        return (T) canExportByParts_id4RsV8qJGJnM(node);
      default:
        throw new BHMethodNotFoundException(this, method);
    }
  }
