...
public class BuildSourceMacroRelativePath_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createConstant_3is4rg_a0(EditorContext editorContext, SNode node) {
    ...
    editorCell.setSubstituteInfo(new CompositeSubstituteInfo(editorContext, new BasicCellContext(node), new SubstituteInfoPartExt[]{new BuildSourceMacroRelativePath_Editor.ReplaceWith_BuildSourceProjectRelativePath_cellMenu_3is4rg_a0a0(), new SChildSubstituteInfoPartEx(editorCell)}));
    return editorCell;
  }
  ...
  private class compositePartSingleRoleHandler_3is4rg_d0 extends SingleRoleCellProvider {
    ...
    protected EditorCell createEmptyCell() {
      ...
      editorCell.setTransformationMenuLookup(new DefaultEmptyCellSubstituteMenuLookup(MetaAdapterFactory.getContainmentLink(0x798100da4f0a421aL, 0xb99171f8c50ce5d2L, 0x65997a657729f6fbL, 0x65997a65772aebcbL, "compositePart")));
  ...
  private static boolean renderingCondition_3is4rg_a3a(SNode node, EditorContext editorContext) {
