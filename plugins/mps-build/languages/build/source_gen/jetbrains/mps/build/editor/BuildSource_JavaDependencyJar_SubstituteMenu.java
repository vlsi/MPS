...
public class BuildSource_JavaDependencyJar_SubstituteMenu extends SubstituteMenuBase {
  ...
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new BuildSource_JavaDependencyJar_SubstituteMenu.SubstituteMenuPart_Wrapper_90rflc_a());
    return result;
  }
  private class SubstituteMenuPart_Wrapper_90rflc_a extends WrapperSubstituteMenuPart {
    ...
    protected SubstituteMenuLookup getLookup(SubstituteMenuContext _context) {
      ...
      return new DefaultSubstituteMenuLookup(LanguageRegistry.getInstance(editorContext.getRepository()), MetaAdapterFactory.getConcept(0x798100da4f0a421aL, 0xb99171f8c50ce5d2L, 0x11779a1dbcff551aL, "jetbrains.mps.build.structure.BuildSource_JavaJar"));
    }
  }
}
