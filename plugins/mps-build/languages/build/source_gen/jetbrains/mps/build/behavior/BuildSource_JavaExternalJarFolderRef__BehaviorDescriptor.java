...
public final class BuildSource_JavaExternalJarFolderRef_BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<SNode> getDependencyTarget_id4RsV8qJH_ED = new SMethodBuilder<SNode>(new SJavaCompoundTypeImpl((Class<SNode>) ((Class) Object.class))).name("getDependencyTarget").modifiers(SModifiersImpl.create(0, AccessPrivileges.PUBLIC)).concept(CONCEPT).id("4RsV8qJH_ED").registry(REGISTRY).build(SParameterImpl.fromList(SJavaCompoundTypeImpl.fromClasses(VisibleArtifacts.class)));
  ...
  private static SNode getDependencyTarget_id4RsV8qJH_ED(@NotNull SNode __thisNode__, VisibleArtifacts artifacts) {
  ...
  protected <T> T invokeSpecial0(@NotNull SNode node, @NotNull SMethod<T> method, @NotNull Object[] parameters) {
    ...
    switch (methodIndex) {
      case 0:
        return (T) getDependencyTarget_id4RsV8qJH_ED(node, (VisibleArtifacts) parameters[0]);
      default:
        throw new BHMethodNotFoundException(this, method);
    }
  }
