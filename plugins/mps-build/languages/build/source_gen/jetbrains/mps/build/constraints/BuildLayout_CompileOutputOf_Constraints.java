...
public class BuildLayout_CompileOutputOf_Constraints extends BaseConstraintsDescriptor {
  public BuildLayout_CompileOutputOf_Constraints() {
    super(MetaIdFactory.conceptId(new UUID(8755280088213897754l, -5075149991798053422l), 2591537044435828004l));
  }
  @Override
  ...
  protected Map<SReferenceLinkId, ReferenceConstraintsDescriptor> getNotDefaultSReferenceLinks() {
    ...
    references.put(MetaIdFactory.refId(new UUID(8755280088213897754l, -5075149991798053422l), 2591537044435828004l, 2591537044435828006l), new BaseReferenceConstraintsDescriptor(MetaIdFactory.refId(new UUID(8755280088213897754l, -5075149991798053422l), 2591537044435828004l, 2591537044435828006l), this) {
      @Override
  ...
  public static boolean static_canBeAChild(SNode node, SNode parentNode, SNode link, SNode childConcept, final IOperationContext operationContext) {
    return SNodeOperations.isInstanceOf(parentNode, MetaAdapterFactory.getConcept(new UUID(8755280088213897754l, -5075149991798053422l), 7389400916848050074l, "jetbrains.mps.build.structure.BuildLayout_Jar"));
  }
