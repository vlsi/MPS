...
public class BuildLayout_File_Behavior {
  ...
  public static void virtual_appendName_1368030936106665465(SNode thisNode, SNode parent, StringBuilder sb) {
    if ((SLinkOperations.getTarget(thisNode, "path", true) != null)) {
      String lastSegment = BuildSourcePath_Behavior.call_getLastSegment_1368030936106771141(SLinkOperations.getTarget(thisNode, "path", true), null);
      if (lastSegment != null) {
  ...
  public static boolean call_canHaveFilemode_9126048691955221297(SNode thisNode) {
    ...
    return (filesetLayoutContainer != null) && BuildLayout_ContainerAcceptingFileSet_Behavior.call_hasFileModeAttribute_6408167411310575237(filesetLayoutContainer);
  }
