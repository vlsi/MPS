...
public class ScopeUtil {
  ...
  public static Scope getVisibleArtifactsScope(SNode project, boolean includeLayoutRoots) {
    if (SNodeOperations.getModel(project).getModule() instanceof TransientModelsModule) {
      ...
      return new ModelPlusImportedScope(SNodeOperations.getModel(project), false, ((IModule) transientModule).getScope(), "jetbrains.mps.build.structure.BuildLayout_Node");
    }
  ...
  public static Scope getVisibleJarsScope(SNode project) {
    if (SNodeOperations.getModel(project).getModule() instanceof TransientModelsModule) {
      SModule transientModule = SNodeOperations.getModel(project).getModule();
      return new ModelPlusImportedScope(SNodeOperations.getModel(project), false, ((IModule) transientModule).getScope(), "jetbrains.mps.build.structure.BuildSource_SingleFile");
    }
  ...
  public static Scope getVisibleJarFoldersScope(SNode project) {
    if (SNodeOperations.getModel(project).getModule() instanceof TransientModelsModule) {
      SModule transientModule = SNodeOperations.getModel(project).getModule();
      return new ModelPlusImportedScope(SNodeOperations.getModel(project), false, ((IModule) transientModule).getScope(), "jetbrains.mps.build.structure.BuildSource_SingleFolder");
    }
