...
public final class BuildSource_JavaExternalJarRef_BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<Tuples._2<SNode, Boolean>> getDependencyTarget_id4RsV8qJGJqY = new SMethodBuilder<Tuples._2<SNode, Boolean>>(new SJavaCompoundTypeImpl((Class<Tuples._2<SNode, Boolean>>) ((Class) Object.class))).name("getDependencyTarget").modifiers(SModifiersImpl.create(0, AccessPrivileges.PUBLIC)).concept(CONCEPT).id("4RsV8qJGJqY").registry(REGISTRY).build(SParameterImpl.fromList(SJavaCompoundTypeImpl.fromClasses(VisibleArtifacts.class)));
  ...
  private static Tuples._2<SNode, Boolean> getDependencyTarget_id4RsV8qJGJqY(@NotNull SNode __thisNode__, VisibleArtifacts artifacts) {
  ...
  /*package*/ BuildSource_JavaExternalJarRef_BehaviorDescriptor() {
    super(REGISTRY);
  }
  ...
  protected <T> T invokeSpecial0(@NotNull SNode node, @NotNull SMethod<T> method, @NotNull Object[] parameters) {
    ...
    switch (methodIndex) {
      case 0:
        return (T) getDependencyTarget_id4RsV8qJGJqY(node, (VisibleArtifacts) parameters[0]);
      default:
        throw new BHMethodNotFoundException(this, method);
    }
  }
