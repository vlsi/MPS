...
/*package*/ class BuildSource_JavaLibraryExternalJarFolder_InspectorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public BuildSource_JavaLibraryExternalJarFolder_InspectorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createProperty_onthxk_b0() {
    ...
    provider.setRole("includeRecursively");
    provider.setNoTargetText("<no includeRecursively>");
    EditorCell editorCell;
    editorCell = provider.createEditorCell(getEditorContext());
    editorCell.setCellId("property_includeRecursively");
