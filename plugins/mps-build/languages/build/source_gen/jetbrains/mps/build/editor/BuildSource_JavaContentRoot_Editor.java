...
public class BuildSource_JavaContentRoot_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createRefNodeList_p3v1g4_c0(EditorContext editorContext, SNode node) {
    ...
    style.set(StyleAttributes.INDENT_LAYOUT_NEW_LINE, 0, true);
    editorCell.getStyle().putAll(style);
    editorCell.setAction(CellActionType.COMMENT, new CellAction_CommentOrUncommentChild(node, MetaAdapterFactory.getContainmentLink(0x798100da4f0a421aL, 0xb99171f8c50ce5d2L, 0x668c6cfbafacdc52L, 0x263ae7d4319546cdL, "folders")));
