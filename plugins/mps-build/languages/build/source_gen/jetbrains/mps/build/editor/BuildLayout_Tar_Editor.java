...
public class BuildLayout_Tar_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createComponent_9nqz5z_a0(EditorContext editorContext, SNode node) {
    ...
    editorCell.setSubstituteInfo(new CompositeSubstituteInfo(editorContext, new BasicCellContext(node), new SubstituteInfoPartExt[]{new BuildLayout_Tar_Editor.ReplaceWith_BuildLayout_NamedContainer_cellMenu_9nqz5z_a0a0(), new SChildSubstituteInfoPartEx(editorCell)}));
    return editorCell;
  }
  ...
  private EditorCell createRefNode_9nqz5z_b0(EditorContext editorContext, SNode node) {
    SingleRoleCellProvider provider = new BuildLayout_Tar_Editor.containerNameSingleRoleHandler_9nqz5z_b0(node, MetaAdapterFactory.getContainmentLink(0x798100da4f0a421aL, 0xb99171f8c50ce5d2L, 0x668c6cfbafac7f8cL, 0x3cca41cd0fe75496L, "containerName"), editorContext);
