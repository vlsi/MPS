  ...
  private EditorCell createReadOnlyModelAccessor_vny568_b0g0(final EditorContext editorContext, final SNode node) {
    EditorCell_Property editorCell = EditorCell_Property.create(editorContext, new ModelAccessor() {
      public String getText() {
        String basePath = BuildProject_BehaviorDescriptor.getBasePath_id4jjtc7WZOyG.invoke(node, Context.defaultContext());
  ...
  private EditorCell createReadOnlyModelAccessor_vny568_b1a(final EditorContext editorContext, final SNode node) {
    EditorCell_Property editorCell = EditorCell_Property.create(editorContext, new ModelAccessor() {
      public String getText() {
        ...
        return (scriptsPath == null ? "<not available>" : scriptsPath + "/" + BuildProject_BehaviorDescriptor.getOutputFileName_id4gSHdTptyu0.invoke(node));
