...
public class BuildLayout_File_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createConceptProperty_1ol6d0_a0(EditorContext editorContext, SNode node) {
    ...
    buildStyles_StyleSheet.getKeyword(editorCell).apply(editorCell);
    editorCell.setSubstituteInfo(new CompositeSubstituteInfo(editorContext, provider.getCellContext(), new SubstituteInfoPart[]{new BuildLayout_File_Editor.ReplaceWith_BuildLayout_Node_cellMenu_a0a0_2()}));
    SNode attributeConcept = provider.getRoleAttribute();
    Class attributeKind = provider.getRoleAttributeClass();
    if (attributeConcept != null) {
      IOperationContext opContext = editorContext.getOperationContext();
