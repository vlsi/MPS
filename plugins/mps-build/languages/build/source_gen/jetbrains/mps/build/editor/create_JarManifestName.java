...
public class create_JarManifestName extends KeyMapImpl {
  ...
  public static class create_JarManifestName_Action0 extends KeyMapActionImpl {
    ...
    public boolean canExecute(final EditorContext editorContext) {
      ...
      if (!(SNodeUtil.isInstanceOf(contextNode, SConceptRepository.getInstance().getConcept("jetbrains.mps.build.structure.BuildLayout_JarManifest")))) {
        return false;
      }
    ...
    private void execute_internal(final EditorContext editorContext, final SNode node, final List<SNode> selectedNodes) {
      SNodeFactoryOperations.setNewChild(node, MetaAdapterFactory.getContainmentLink(new UUID(8755280088213897754l, -5075149991798053422l), 1251221292903960366l, 7471276865245798337l, "name"), "jetbrains.mps.build.structure.BuildStringNotEmpty");
    }
