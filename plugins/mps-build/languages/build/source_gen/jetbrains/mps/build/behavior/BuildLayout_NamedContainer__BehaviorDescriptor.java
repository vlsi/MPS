...
public final class BuildLayout_NamedContainer__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<Boolean> hasInputDir_id1653mnvAgqQ = new SMethodBuilder<Boolean>(new SJavaCompoundTypeImpl(Boolean.TYPE)).name("hasInputDir").modifiers(SModifiersImpl.create(9, AccessPrivileges.PUBLIC)).concept(CONCEPT).id("1653mnvAgqQ").registry(REGISTRY).build(SParameterImpl.fromList(SJavaCompoundTypeImpl.fromClasses()));
  ...
  private static Boolean hasInputDir_id1653mnvAgqQ(@NotNull SAbstractConcept __thisConcept__) {
    return false;
  }
  ...
  protected <T> T invokeSpecial0(@NotNull SAbstractConcept concept, @NotNull SMethod<T> method, @NotNull Object[] parameters) {
    ...
    switch (methodIndex) {
      case 5:
        return (T) hasInputDir_id1653mnvAgqQ(concept);
      default:
        throw new BHMethodNotFoundException(this, method);
    }
  }
