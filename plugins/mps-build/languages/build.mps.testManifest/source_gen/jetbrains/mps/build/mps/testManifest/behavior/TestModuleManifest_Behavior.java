...
public class TestModuleManifest_Behavior {
  ...
  public static List<Tuples._3<String, String, String>> call_languagesToInclude_3298469228705308574(SNode thisNode, Project project) {
  ...
  public static List<Tuples._3<String, String, String>> call_testModulesToInclude_8645252814069066668(SNode thisNode, Project project) {

    List<Tuples._3<String, String, String>> result = ListSequence.fromList(new ArrayList<Tuples._3<String, String, String>>());
    SModule sModule = SNodeOperations.getModel(thisNode).getModule();
    if (sModule != null && project.isProjectModule(sModule) && sModule instanceof AbstractModule) {
      IFile descriptorIFile = ((AbstractModule) sModule).getDescriptorFile();
