...
public class add_dependencies_BwfSubTask_ext_3 extends TransformationMenuBase {
  ...
  protected List<MenuPart<TransformationMenuItem, TransformationMenuContext>> getParts(TransformationMenuContext _context) {
    ...
    if (ListSequence.fromListAndArray(new ArrayList<String>(), MenuLocations.RIGHT_SIDE_TRANSFORM).contains(_context.getMenuLocation())) {
      result.add(new add_dependencies_BwfSubTask_ext_3.TransformationMenuPart_Group_cfx569_a0());
    }
    return result;
  }

  public class TransformationMenuPart_Group_cfx569_a0 extends GroupMenuPart<TransformationMenuItem, TransformationMenuContext> {
    @Override
    ...
    protected List<MenuPart<TransformationMenuItem, TransformationMenuContext>> getParts() {
      return Arrays.<MenuPart<TransformationMenuItem, TransformationMenuContext>>asList(new add_dependencies_BwfSubTask_ext_3.TransformationMenuPart_Group_cfx569_a0.TransformationMenuPart_Action_cfx569_a0a());
    }
    private class TransformationMenuPart_Action_cfx569_a0a extends SingleItemMenuPart<TransformationMenuItem, TransformationMenuContext> {
      @Nullable
      protected TransformationMenuItem createItem(TransformationMenuContext context) {
        return new add_dependencies_BwfSubTask_ext_3.TransformationMenuPart_Group_cfx569_a0.TransformationMenuPart_Action_cfx569_a0a.Item(context);
      }
