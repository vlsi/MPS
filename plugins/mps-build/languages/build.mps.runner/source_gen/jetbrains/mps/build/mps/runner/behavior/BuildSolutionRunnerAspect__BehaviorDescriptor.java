...
public final class BuildSolutionRunnerAspect__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  /*package*/ static void fetchDependencies_id57YmpYyL8F1(@NotNull SNode __thisNode__, VisibleArtifacts artifacts, RequiredDependenciesBuilder builder) {
    ...
    for (SNode m : Sequence.fromIterable(modules)) {
      SNode artifact;
      SNode originalModule = artifacts.toOriginalNode(m);
      ...
      if (artifact != null) {
        builder.add(SNodeOperations.as(artifacts.toOriginalNode(artifact), MetaAdapterFactory.getConcept(0x798100da4f0a421aL, 0xb99171f8c50ce5d2L, 0x668c6cfbafac4c85L, "jetbrains.mps.build.structure.BuildLayout_Node")), originalModule);
