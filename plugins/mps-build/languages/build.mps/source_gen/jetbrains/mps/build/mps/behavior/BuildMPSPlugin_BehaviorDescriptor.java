...
public final class BuildMPSPlugin_BehaviorDescriptor extends BaseBHDescriptor {
  ...
  private static Iterable<SNode> getImportedLibraries_id3zFnP6MwWdL(@NotNull SNode __thisNode__) {
    return Sequence.<SNode>singleton(BuildMPSPlugin_BehaviorDescriptor.getMpsLibrary_id3zFnP6MM9ge.invoke(SNodeOperations.asSConcept(MetaAdapterFactory.getConcept(0xcf935df46994e9cL, 0xa132fa109541cba3L, 0xc0bde9fc71699d9L, "jetbrains.mps.build.mps.structure.BuildMPSPlugin").getDeclarationNode())));
  }
  ...
  /*package*/ BuildMPSPlugin_BehaviorDescriptor() {
    super(REGISTRY);
  }
