...
public class BuildMpsLayout_PluginDescriptor_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createCollection_bzzv1n_a(EditorContext editorContext, SNode node) {
    ...
    editorCell.addEditorCell(this.createConceptProperty_bzzv1n_a0(editorContext, node));
  ...
  private EditorCell createConceptProperty_bzzv1n_a0(EditorContext editorContext, SNode node) {
