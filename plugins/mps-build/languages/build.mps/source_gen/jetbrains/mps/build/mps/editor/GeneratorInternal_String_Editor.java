...
public class GeneratorInternal_String_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createCollection_g2v6ye_a(EditorContext editorContext, SNode node) {
    ...
    editorCell.addEditorCell(this.createProperty_g2v6ye_a0(editorContext, node));
    return editorCell;
  }
  private EditorCell createProperty_g2v6ye_a0(EditorContext editorContext, SNode node) {
