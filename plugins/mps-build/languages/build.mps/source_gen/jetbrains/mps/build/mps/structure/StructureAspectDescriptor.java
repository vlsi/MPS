...
public class StructureAspectDescriptor implements jetbrains.mps.smodel.runtime.StructureAspectDescriptor {
  ...
  public ConceptDescriptor getDescriptor(String conceptFqName) {
    switch (Arrays.binarySearch(stringSwitchCases_1htk8d_a0a0b, conceptFqName)) {
      ...
      case 10:
        return new ConceptDescriptorBuilder("jetbrains.mps.build.mps.structure.BuildMps_AbstractModule").super_("jetbrains.mps.build.structure.BuildProjectPart").parents("jetbrains.mps.build.structure.BuildProjectPart", "jetbrains.mps.lang.core.structure.INamedConcept").properties("uuid", "compact").children(new String[]{"path", "generatorOptions"}, new boolean[]{false, false}).abstract_().create();
      case 11:
      ...
      case 39:
        return new ConceptDescriptorBuilder("jetbrains.mps.build.mps.structure.BuildMps_ModuleGenerationOptions").super_("jetbrains.mps.lang.core.structure.BaseConcept").parents("jetbrains.mps.lang.core.structure.BaseConcept").references("options").alias("apply generation options", "").create();
      case 40:
