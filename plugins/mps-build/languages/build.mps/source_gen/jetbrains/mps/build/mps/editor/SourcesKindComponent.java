...
public class SourcesKindComponent extends AbstractCellProvider {
  public SourcesKindComponent(SNode node) {
    super(node);
  }
  ...
  private static boolean renderingCondition_qubgco_a0a(SNode node, EditorContext editorContext, IScope scope) {
    return isNotEmpty_qubgco_a0a0a6(SPropertyOperations.getString_def(node, "sourcesKind", null)) && !(SPropertyOperations.getString_def(node, "sourcesKind", null).equals("sources"));
  }
  ...
  public static boolean isNotEmpty_qubgco_a0a0a6(String str) {
