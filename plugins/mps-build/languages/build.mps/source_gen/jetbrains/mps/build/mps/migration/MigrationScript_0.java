...
public class MigrationScript_0 extends MigrationScriptBase {
  ...
  public SNode execute(SModule m, DataCollector collector_) {
    ...
    projects = Sequence.fromIterable(projects).where(new IWhereFilter<SNode>() {
    ...
    for (SNode project : Sequence.fromIterable(projects)) {
      ...
      if ((javaOptions == null)) {
        ...
        SNode newOptions = SConceptOperations.createNewNode(SNodeOperations.asInstanceConcept(MetaAdapterFactory.getConcept(0x798100da4f0a421aL, 0xb99171f8c50ce5d2L, 0xcdff0e1a96739c2L, "jetbrains.mps.build.structure.BuildSource_JavaOptions")));
