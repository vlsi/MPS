...
public class QueriesGenerated {
  ...
  public static Object propertyMacro_GetPropertyValue_4743026300739052426(final IOperationContext operationContext, final PropertyMacroContext _context) {
    ...
    String result = ListSequence.fromList(SLinkOperations.getTargets(((Tuples._3<LocalArtifacts, SNode, SNode>) _context.getVariable("var:files"))._2(), "jarLocations", true)).where(new IWhereFilter<SNode>() {
      public boolean accept(SNode it) {
        return eq_x583g4_a0a0a0a0a0a0a3a61(BuildSourcePath_Behavior.call_getRelativePath_5481553824944787371(SLinkOperations.getTarget(it, "path", true)), pathText);
      }
    }).select(new ISelector<SNode, String>() {
      public String select(SNode it) {
        return SPropertyOperations.getString(it, "packagedLocation");
  ...
  public static Object propertyMacro_GetPropertyValue_8514706502350017845(final IOperationContext operationContext, final PropertyMacroContext _context) {
    SNode mpsAspect = SNodeOperations.cast(ListSequence.fromList(SLinkOperations.getTargets(_context.getNode(), "aspects", true)).findFirst(new IWhereFilter<SNode>() {
      public boolean accept(SNode it) {
        return SNodeOperations.isInstanceOf(it, "jetbrains.mps.build.mps.structure.BuildMpsAspect");
      }
    }), "jetbrains.mps.build.mps.structure.BuildMpsAspect");

    int heapSize;
    // 0 as default value and 0 as heap size should be distinguished 
    if ((mpsAspect != null) && (isNotEmpty_x583g4_a0a0e0nc(mpsAspect.getProperty("generationMaxHeapSizeInMb")))) {
  ...
  public static Iterable sourceNodesQuery_978600701690054686(final IOperationContext operationContext, final SourceSubstituteMacroNodesContext _context) {
    return Sequence.fromIterable(Sequence.fromArray(((String[]) _context.getVariable("var:requiredPlugins")))).select(new ISelector<String, SNode>() {
      public SNode select(String it) {
        return createGeneratorInternal_String_x583g4_a0a0a0a0xf(it);
      }
    });
  }
  ...
  public static Iterable sourceNodesQuery_5970181360960745073(final IOperationContext operationContext, final SourceSubstituteMacroNodesContext _context) {
    ...
    return Sequence.fromIterable(((MPSModulesPartitioner) _context.getVariable("var:closure")).getExternal()).sort(new ISelector<SNode, Comparable<?>>() {
      ...
      public String select(SNode module) {
        ...
        String val = BuildLayout_PathElement_Behavior.call_location_7117056644539862594(layoutNode, helper, mpsModule);
        if (val == null) {
  ...
  public static Iterable sourceNodesQuery_8845345751178284914(final IOperationContext operationContext, final SourceSubstituteMacroNodesContext _context) {
    return SetSequence.fromSet(((MPSModulesPartitioner.Chunk) _context.getVariable("var:chunk")).getModules()).sort(new ISelector<SNode, Comparable<?>>() {
      public Comparable<?> select(SNode it) {
        return SPropertyOperations.getString(it, "name");
      }
    }, true);
  ...
  public static Object insertMacro_varValue_3340252814672973526(final IOperationContext operationContext, final TemplateQueryContext _context) {
    ...
    if ((jmAntJar != null)) {
      return BuildLayout_PathElement_Behavior.call_location_7117056644539862594(jmAntJar, helper, artifact);
    }
  ...
  public static Object insertMacro_varValue_3340252814673340855(final IOperationContext operationContext, final TemplateQueryContext _context) {
    ...
    if ((jar != null)) {
      return BuildLayout_PathElement_Behavior.call_location_7117056644539862594(jar, helper, artifact);
    }
    if (!(ListSequence.fromList(SLinkOperations.getTargets(_context.getNode(), "macros", true)).any(new IWhereFilter<SNode>() {
      public boolean accept(SNode it) {
        return SNodeOperations.isInstanceOf(it, "jetbrains.mps.build.structure.BuildFolderMacro") && "mps_home".equals(SPropertyOperations.getString(SNodeOperations.cast(it, "jetbrains.mps.build.structure.BuildFolderMacro"), "name"));
  ...
  private static SNode createGeneratorInternal_String_x583g4_a0a0a0a0xf(Object p0) {
  ...
  public static boolean isNotEmpty_x583g4_a0a0e0nc(String str) {
    return str != null && str.length() > 0;
  }
