...
public abstract class MergeDriverPacker {
  ...
  private static final Iterable<String> ideaLibJars = Arrays.asList("asm-all.jar", "xstream-1.4.3.jar", "guava-17.0.1.jar", "jdom.jar", "log4j.jar", "trove4j.jar", "annotations.jar");
