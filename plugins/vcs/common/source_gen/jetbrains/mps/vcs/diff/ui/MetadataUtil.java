...
public class MetadataUtil {
  ...
  public static SModel createMetadataModel(SModel model) {
    SModel metadataModel = new SModel(new jetbrains.mps.smodel.SModelReference(new SModelFqName(SNodeOperations.getModelLongName(model.getModelDescriptor()), "metadata"), SModelId.generate()));
  ...
  public static void applyMetadataChanges(final SModel model, SModel metadataModel) {
    ...
    Set<SModelReference> imports = SetSequence.fromSetWithValues(new LinkedHashSet<SModelReference>(), ListSequence.fromList(SLinkOperations.getTargets(root, "import", true)).select(new ISelector<SNode, SModelReference>() {
      public SModelReference select(SNode it) {
        return new jetbrains.mps.smodel.SModelReference(new SModelFqName(SPropertyOperations.getString(it, "qualifiedName"), SPropertyOperations.getString(it, "stereotype")), SModelId.fromString(SPropertyOperations.getString(it, "uuid")));
      }
    }));
