...
public class ChangeEditorMessage extends EditorMessageWithTarget {
  ...
  private void repaintConflictedMessages(Graphics graphics, EditorCell cell) {
    ...
    if (parent != null && parent.getCellsCount() == 1) {
      SimpleEditorMessage messageToRepaint = ListSequence.fromList(parent.getMessages()).findFirst(new IWhereFilter<SimpleEditorMessage>() {
      ...
      if (messageToRepaint != null) {
        ((ChangeEditorMessage)(messageToRepaint)).paint(graphics, cell.getEditor(), (EditorCell) parent);
      }
    }
  }
