...
public class CurrentDifference {
  ...
  public CurrentDifference(@NotNull CurrentDifferenceRegistry registry, @NotNull DefaultSModelDescriptor modelDescriptor) {
  ...
  /*package*/ DefaultSModelDescriptor getModelDescriptor() {
