...
public class CurrentDifference {
  ...
  public CurrentDifference(@NotNull CurrentDifferenceRegistry registry, @NotNull BaseEditableSModelDescriptor modelDescriptor) {
  ...
  /*package*/ BaseEditableSModelDescriptor getModelDescriptor() {
