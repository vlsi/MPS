...
import jetbrains.mps.persistence.PersistenceUtil.MultiStreamDataSourceBase;
...
public class BaseVersionUtil {
  ...
  public static SModel loadPerRootModel(final Map<String, Object> content) {
    FolderModelFactory factory = PersistenceRegistry.getInstance().getFolderModelFactory(PersistenceUtil.PER_ROOT_PERSISTENCE_FACTORY);
