...
/*package*/ class SvnInstaller extends AbstractInstaller {
  ...
  @NotNull
  private AbstractInstaller.State createScript(boolean dryRun) {
  ...
  private static boolean neq_k2wvr2_a0a2a2a3a1a8a0(Object a, Object b) {
    return !((a != null ?
      a.equals(b) :
      a == b
    ));
  ...
  private static boolean eq_k2wvr2_a0a0a51a0(Object a, Object b) {
    return (a != null ?
      a.equals(b) :
      a == b
    );
  ...
  private static boolean neq_k2wvr2_a0a0a0b0a0a0d0b(Object a, Object b) {
    return !((a != null ?
      a.equals(b) :
      a == b
    ));
