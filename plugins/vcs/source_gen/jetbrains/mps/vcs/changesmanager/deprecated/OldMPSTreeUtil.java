...
public class OldMPSTreeUtil {
  public OldMPSTreeUtil() {
  }
  ...
  /*package*/ static PropertyTreeNode findPropertyTreeNode(final SNodeTreeNode _this, String propertyName) {
    for (MPSTreeNode child : Sequence.fromIterable(OldMPSTreeUtil.findPropertiesTreeNode(_this))) {
  ...
  /*package*/ static ReferenceTreeNode findReferenceTreeNode(final SNodeTreeNode _this, String role) {
    for (MPSTreeNode child : Sequence.fromIterable(OldMPSTreeUtil.findReferencesTreeNode(_this))) {
  ...
  /*package*/ static Iterable<MPSTreeNode> getDescendants(final MPSTreeNode _this) {
    ...
    for (MPSTreeNode child : Sequence.fromIterable(_this)) {
      ...
      descendants = Sequence.fromIterable(descendants).concat(Sequence.fromIterable(OldMPSTreeUtil.getDescendants(child)));
    }
