...
public class TreeHighlighter implements TreeMessageOwner {
  ...
  @Nullable
  private static FileStatus getModelFileStatus(@NotNull DefaultSModelDescriptor emd, @NotNull Project project) {
  ...
  private class MyFileStatusListener implements FileStatusListener {
    ...
    public void fileStatusChanged(@NotNull VirtualFile file) {
      ...
      BaseSModelDescriptorWithSource emd = SModelFileTracker.getInstance().findModel(ifile);
      if (emd != null) {
