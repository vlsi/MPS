...
public class ChangesStrip_ActionGroup extends GeneratedActionGroup {
  ...
  public ChangesStrip_ActionGroup() {
    ...
    try {
      ...
      ChangesStrip_ActionGroup.this.addAction("jetbrains.mps.vcs.plugin.ShowDiffFromChanges_Action");
      ChangesStrip_ActionGroup.this.addAction("jetbrains.mps.vcs.plugin.CopyOldNodes_Action");
    } catch (Throwable t) {
