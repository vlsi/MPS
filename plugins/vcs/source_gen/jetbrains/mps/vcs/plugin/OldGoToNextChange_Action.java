...
public class OldGoToNextChange_Action extends GeneratedAction {
  private static final Icon ICON = getIcon();
  protected static Log log = LogFactory.getLog(OldGoToNextChange_Action.class);

  public OldGoToNextChange_Action() {
  ...
  public void doUpdate(@NotNull AnActionEvent event, final Map<String, Object> _params) {
    try {
      ...
      if (log.isErrorEnabled()) {
        log.error("User's action doUpdate method failed. Action:" + "OldGoToNextChange", t);
      }
  ...
  public void doExecute(@NotNull final AnActionEvent event, final Map<String, Object> _params) {
    try {
      ...
      if (log.isErrorEnabled()) {
        log.error("User's action execute method failed. Action:" + "OldGoToNextChange", t);
      }
    }
  }
  ...
  private static Icon getIcon() {
    try {
      return new ImageIcon(StreamUtil.loadFromStream(OldGoToNextChange_Action.class.getResourceAsStream("nextOccurence.png")));
    } catch (IOException e) {
      if (log.isWarnEnabled()) {
        log.warn("Couldn't load icon for OldGoToNextChange", e);
      }
      return null;
    }
  }
