...
public class MergeConfirmation {
  ...
  public static void showMergeConfirmationAndTakeAction(BaseDialog dialog, MergeSession mergeSession, Iterable<ModelChange> allRelevantChanges, final _FunctionTypes._void_P0_E0 resolveTask, final _FunctionTypes._void_P0_E0 saveAndCloseTask) {
  ...
  private static int showMergeConfirmationIfNeeded(BaseDialog dialog, final MergeSession mergeSession, Iterable<ModelChange> allRelevantChanges) {
