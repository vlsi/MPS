...
public class MergeRootsDialogNew extends DialogWrapper {
  ...
  public MergeRootsDialogNew(MergeModelsDialogNew mergeModelsDialog, MergeSession mergeSession, SNodeId rootId, String rootName) {
    ...
    MergeRootsDialogNew.MyGoToNeighbourRootActions neighbourActions = new MergeRootsDialogNew.MyGoToNeighbourRootActions();
    NextPreviousTraverser neighbourTraverser = new NextPreviousTraverser(myChangeGroupLayouts, myResultEditor.getMainEditor());
    DefaultActionGroup actionGroup = ActionUtils.groupFromActions(new ApplyNonConflictsForRootNew(this), Separator.getInstance(), neighbourActions.previous(), neighbourActions.next(), Separator.getInstance(), neighbourTraverser.previousAction(), neighbourTraverser.nextAction());
  ...
  private void linkEditors(boolean mine, boolean inspector) {
    ...
    MergeButtonsPainterNew.addTo(this, (mine ?
      myMineEditor :
      myRepositoryEditor
    ), layout, inspector);
  }
  ...
  /*package*/ MergeModelsDialogNew getModelsDialog() {
  ...
  protected void doOKAction() {
    MergeConfirmationNew.showMergeConfirmationAndTakeAction(this, myMergeSession, myMergeSession.getChangesForRoot(myRootId), new _FunctionTypes._void_P0_E0() {
      public void invoke() {
