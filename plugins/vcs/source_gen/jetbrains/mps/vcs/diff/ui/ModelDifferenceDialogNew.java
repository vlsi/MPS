...
public class ModelDifferenceDialogNew extends DialogWrapper {
  ...
  private ModelDifferenceDialogNew.ModelDifferenceTree myTree;
  ...
  public ModelDifferenceDialogNew(final SModel oldModel, final SModel newModel, DiffRequest diffRequest) {
    ...
    myTree = new ModelDifferenceDialogNew.ModelDifferenceTree();

    DefaultActionGroup actionGroup = ActionUtils.groupFromActions(new InvokeTextDiffActionNew("View as Text", "View model difference using as text difference of XML contents", this, diffRequest, DiffManager.getInstance().getIdeaDiffTool()));
  ...
  private class ModelDifferenceTree extends DiffModelTree {
    ...
    protected Iterable<BaseAction> getRootActions() {
      return Arrays.<BaseAction>asList(new InvokeRootDifferenceActionNew(ModelDifferenceDialogNew.this), new RevertRootsActionNew(ModelDifferenceDialogNew.this) {
        ...
        protected void after() {
          ModelDifferenceDialogNew.this.rebuildChangeSet();
        }
      });
    }
