...
public class NewDiffEditorComponent extends EditorComponent {
  private InspectorEditorComponent myInspector;

  public NewDiffEditorComponent(IOperationContext context, SNode node) {
    super(context);
  ...
  public void synchronizeViewWith(final NewDiffEditorComponent otherComponent) {
