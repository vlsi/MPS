...
public class RootDifferenceDialogNew extends DialogWrapper {
  private ModelDifferenceDialogNew myModelDialog;
  ...
  public RootDifferenceDialogNew(ModelDifferenceDialogNew modelDialog, SNodeId rootId, String rootName, Frame frame, @Nullable Bounds firstChange) {
    super(frame, true);
    setTitle("Difference for " + rootName);
    init(modelDialog, rootId, firstChange);
  }
  ...
  private void init(ModelDifferenceDialogNew modelDialog, SNodeId rootId, @Nullable final Bounds firstChange) {
  ...
  private void linkEditors(boolean inspector) {
    ...
    if (!(myModelDialog.getChangeSet().getNewModel().isNotEditable())) {
      DiffButtonsPainterNew.addTo(this, myOldEditor, layout, inspector);
      DiffButtonsPainterNew.addTo(this, myNewEditor, layout, inspector);
    }
  }
