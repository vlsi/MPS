...
public class InvokeMergeRootsActionNew extends BaseDiffModelTreeAction {
  private MergeModelsDialogNew myModelsDialog;

  public InvokeMergeRootsActionNew(MergeModelsDialogNew modelsDialog) {
    super("", null);
