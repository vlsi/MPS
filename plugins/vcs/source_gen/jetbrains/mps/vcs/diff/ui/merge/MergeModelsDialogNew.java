...
import jetbrains.mps.vcs.diff.ui.common.InvokeTextDiffActionNew;
...
public class MergeModelsDialogNew extends DialogWrapper {
  ...
  private MergeModelsDialogNew.MergeModelsTree myMergeTree;
  ...
  public MergeModelsDialogNew(SModel baseModel, SModel mineModel, SModel repositoryModel, DiffRequest request) {
    ...
    myMergeTree = new MergeModelsDialogNew.MergeModelsTree();

    DefaultActionGroup actionGroup = ActionUtils.groupFromActions(new ResetStateNew(this), new MergeNonConflictingRootsNew(this), Separator.getInstance(), AcceptYoursTheirsNew.yoursInstance(this), AcceptYoursTheirsNew.theirsInstance(this), Separator.getInstance(), new InvokeTextDiffActionNew("Merge as Text (Use Carefully!)", "Merge models using text merge for XML contents", this, request, new MergeTool()));
  ...
  protected void doOKAction() {
    MergeConfirmationNew.showMergeConfirmationAndTakeAction(this, myMergeSession, myMergeSession.getAllChanges(), new _FunctionTypes._void_P0_E0() {
      public void invoke() {
  ...
  public void invokeMergeRoots(final SNodeId rootId) {
    ...
    final Wrappers._T<MergeRootsDialogNew> mergeRootsDialog = new Wrappers._T<MergeRootsDialogNew>();
    ModelAccess.instance().runReadAction(new Runnable() {
      public void run() {
        mergeRootsDialog.value = new MergeRootsDialogNew(MergeModelsDialogNew.this, myMergeSession, rootId, myMergeTree.getNameForRoot(rootId));
      }
    });
  ...
  private class MergeModelsTree extends DiffModelTree {
    ...
    protected Iterable<BaseAction> getRootActions() {
      MergeModelsDialogNew md = MergeModelsDialogNew.this;
      return Arrays.asList(new InvokeMergeRootsActionNew(md), AcceptYoursTheirsNew.yoursInstance(md), AcceptYoursTheirsNew.theirsInstance(md));
    }
