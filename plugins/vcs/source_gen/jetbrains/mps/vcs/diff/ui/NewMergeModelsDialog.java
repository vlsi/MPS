...
public class NewMergeModelsDialog extends BaseDialog {
  private Project myProject;
  private IOperationContext myOperationContext;
  private MergeContext myMergeContext;
  private NewMergeModelsDialog.MergeModelsTree myMergeModelsTree;
  private boolean myCancelled = false;

  public NewMergeModelsDialog(Project project, IOperationContext operationContext, SModel baseModel, SModel mineModel, SModel repositoryModel) {
    ...
    myMergeModelsTree = new NewMergeModelsDialog.MergeModelsTree();
  }
  ...
  private class MergeModelsTree extends MPSTree {
    ...
    protected MPSTreeNode rebuild() {
      NewMergeModelsDialog.MyModelTreeNode modelNode = new NewMergeModelsDialog.MyModelTreeNode();
      for (SNodeId rootId : SetSequence.fromSet(myMergeContext.getAffectedRoots())) {
        modelNode.add(new NewMergeModelsDialog.MyRootTreeNode(rootId));
      }
      return modelNode;
    }
  }
  ...
  private class MyRootTreeNode extends MPSTreeNode {
    ...
    public void doubleClick() {
      final Wrappers._T<NewMergeRootsDialog> mergeRootsDialog = new Wrappers._T<NewMergeRootsDialog>();
      ModelAccess.instance().runReadAction(new Runnable() {
        public void run() {
          mergeRootsDialog.value = new NewMergeRootsDialog(NewMergeModelsDialog.this, myMergeContext, myRootId, myPresentations);
        }
      });
