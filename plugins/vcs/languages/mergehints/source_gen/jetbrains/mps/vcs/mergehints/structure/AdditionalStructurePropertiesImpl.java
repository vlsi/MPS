...
public class AdditionalStructurePropertiesImpl extends BaseAdditionalStructureProperties {
  private final AdditionalConceptProperties props_MergeHint = new ConceptPropsBuilder().create();
  ...
  private static final Map<SAbstractConcept, Integer> indices_4qogsf_a0c = buildConceptIndices(MetaAdapterFactory.getConcept(0x37e03aa1728949bcL, 0x826930de5eceec76L, 0x657f08af7deb331aL, "MergeHint"));
}
