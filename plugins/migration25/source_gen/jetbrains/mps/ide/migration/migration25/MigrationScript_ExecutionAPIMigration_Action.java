...
public class MigrationScript_ExecutionAPIMigration_Action extends BaseAction {
  ...
  public void doExecute(@NotNull final AnActionEvent event, final Map<String, Object> _params) {
    try {
      SNodeReference script = new jetbrains.mps.smodel.SNodePointer("r:83c125b8-b4d0-4336-9b15-bfcb8c8e465e(jetbrains.mps.execution.migration.scripts)", "8166483729924360116");
  ...
  private static Logger LOG = Logger.getLogger(MigrationScript_ExecutionAPIMigration_Action.class);
}
