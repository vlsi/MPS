...
public class MigrationScript_JavaAPIMigration_Action extends BaseAction {
  ...
  public void doExecute(@NotNull final AnActionEvent event, final Map<String, Object> _params) {
    try {
      SNodeReference script = new jetbrains.mps.smodel.SNodePointer("r:3e625b1a-6e5a-478f-9fe5-a307d84995c3(jetbrains.mps.ide.java.migration.scripts)", "4397798827966744636");
  ...
  private static Logger LOG = Logger.getLogger(MigrationScript_JavaAPIMigration_Action.class);
}
