...
public class MigrationScript_DebuggerMoved_Action extends BaseAction {
  ...
  public void doExecute(@NotNull final AnActionEvent event, final Map<String, Object> _params) {
    try {
      SNodeReference script = new jetbrains.mps.smodel.SNodePointer("r:89ed2c62-93d2-424b-93aa-b8a2e95c351f(jetbrains.mps.debugger.api.lang.scripts)", "4899606958030665162");
  ...
  private static Logger LOG = Logger.getLogger(MigrationScript_DebuggerMoved_Action.class);
}
