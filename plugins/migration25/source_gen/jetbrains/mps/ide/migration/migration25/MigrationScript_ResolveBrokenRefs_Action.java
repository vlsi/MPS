...
public class MigrationScript_ResolveBrokenRefs_Action extends BaseAction {
  ...
  public void doExecute(@NotNull final AnActionEvent event, final Map<String, Object> _params) {
    try {
      SNodeReference script = new SNodePointer("r:00000000-0000-4000-0000-011c89590367(jetbrains.mps.lang.plugin.scripts)", "4214874532454943783");
  ...
  protected static Logger LOG = LogManager.getLogger(MigrationScript_ResolveBrokenRefs_Action.class);
}
