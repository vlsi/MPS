...
public class MigrationScript_ResolveBrokenRefs_Action extends BaseAction {
  private static final Icon ICON = null;

  public MigrationScript_ResolveBrokenRefs_Action() {
  ...
  public void doUpdate(@NotNull AnActionEvent event, final Map<String, Object> _params) {
    try {
      ...
      LOG.error("User's action doUpdate method failed. Action:" + "MigrationScript_ResolveBrokenRefs", t);
  ...
  public void doExecute(@NotNull final AnActionEvent event, final Map<String, Object> _params) {
    try {
      SNodeReference script = new jetbrains.mps.smodel.SNodePointer("r:00000000-0000-4000-0000-011c89590367(jetbrains.mps.lang.plugin.scripts)", "4214874532454943783");
      ...
      LOG.error("User's action execute method failed. Action:" + "MigrationScript_ResolveBrokenRefs", t);
    }
  }

  private static Logger LOG = Logger.getLogger(MigrationScript_ResolveBrokenRefs_Action.class);
}
