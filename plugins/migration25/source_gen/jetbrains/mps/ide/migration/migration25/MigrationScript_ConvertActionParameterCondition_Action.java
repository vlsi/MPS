...
public class MigrationScript_ConvertActionParameterCondition_Action extends BaseAction {
  ...
  public void doExecute(@NotNull final AnActionEvent event, final Map<String, Object> _params) {
    try {
      SNodeReference script = new SNodePointer("r:00000000-0000-4000-0000-011c89590367(jetbrains.mps.lang.plugin.scripts)", "5538333046911349083");
  ...
  protected static Logger LOG = LogManager.getLogger(MigrationScript_ConvertActionParameterCondition_Action.class);
}
