...
public class MigrationScript_ConvertActionParameterCondition_Action extends BaseAction {
  ...
  public void doUpdate(@NotNull AnActionEvent event, final Map<String, Object> _params) {
    try {
      ...
      LOG.error("User's action doUpdate method failed. Action:" + "MigrationScript_ConvertActionParameterCondition", t);
  ...
  public void doExecute(@NotNull final AnActionEvent event, final Map<String, Object> _params) {
    try {
      SNodeReference script = new jetbrains.mps.smodel.SNodePointer("r:00000000-0000-4000-0000-011c89590367(jetbrains.mps.lang.plugin.scripts)", "5538333046911349083");
      ...
      LOG.error("User's action execute method failed. Action:" + "MigrationScript_ConvertActionParameterCondition", t);
    }
  }

  private static Logger LOG = Logger.getLogger(MigrationScript_ConvertActionParameterCondition_Action.class);
}
