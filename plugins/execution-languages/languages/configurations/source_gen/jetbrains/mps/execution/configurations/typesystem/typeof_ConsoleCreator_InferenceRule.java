...
public class typeof_ConsoleCreator_InferenceRule extends AbstractInferenceRule_Runtime implements InferenceRule_Runtime {
  ...
  public void applyRule(final SNode consoleCreator, final TypeCheckingContext typeCheckingContext, IsApplicableStatus status) {
    ...
    {
      SNode _nodeToCheck_1029348928467 = SLinkOperations.getTarget(consoleCreator, MetaAdapterFactory.getContainmentLink(new UUID(2515029821120661198l, -8934183642121722347l), 1594211126127774346l, 1594211126127774925l, "project"));
    ...
    {
      SNode _nodeToCheck_1029348928467 = SLinkOperations.getTarget(consoleCreator, MetaAdapterFactory.getContainmentLink(new UUID(2515029821120661198l, -8934183642121722347l), 1594211126127774346l, 1594211126127774926l, "viewer"));
  ...
  private static SNode createConsoleType_c6o0kc_a0a0b() {
    ...
    SNode n1 = SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.execution.configurations.structure.ConsoleType", null, false);
    return n1;
  }
