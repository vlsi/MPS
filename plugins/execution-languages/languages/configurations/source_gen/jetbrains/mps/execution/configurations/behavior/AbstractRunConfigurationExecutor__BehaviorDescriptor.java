...
public final class AbstractRunConfigurationExecutor__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<String> getCanExecuteMethodName_id6LlKjXrMerG = new SMethodBuilder<String>(new SJavaCompoundTypeImpl(String.class)).name("getCanExecuteMethodName").modifiers(SModifiersImpl.create(0, AccessPrivileges.PUBLIC)).concept(CONCEPT).id("6LlKjXrMerG").registry(REGISTRY).build(SParameterImpl.fromList(SJavaCompoundTypeImpl.fromClasses()));
  ...
  public static final SMethod<String> getGeneratedClassName_idO$iR4JBsSg = new SMethodBuilder<String>(new SJavaCompoundTypeImpl(String.class)).name("getGeneratedClassName").modifiers(SModifiersImpl.create(8, AccessPrivileges.PUBLIC)).concept(CONCEPT).id("O$iR4JBsSg").registry(REGISTRY).build(SParameterImpl.fromList(SJavaCompoundTypeImpl.fromClasses()));
  ...
  private static String getCanExecuteMethodName_id6LlKjXrMerG(@NotNull SNode __thisNode__) {
    return "canExecute";
  }
  @NonNls
  ...
  protected <T> T invokeSpecial0(@NotNull SNode node, @NotNull SMethod<T> method, @NotNull Object[] parameters) {
    ...
    switch (methodIndex) {
      case 0:
        return (T) getCanExecuteMethodName_id6LlKjXrMerG(node);
      case 1:
        return (T) getSuffix_idO$iR4JBsSb(node);
      case 2:
        return (T) getGeneratedClassName_idO$iR4JBsSg(node);
      default:
        throw new BHMethodNotFoundException(this, method);
    }
  }
