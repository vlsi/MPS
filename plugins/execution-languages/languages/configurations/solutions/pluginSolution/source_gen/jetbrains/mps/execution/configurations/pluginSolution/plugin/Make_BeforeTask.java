...
public class Make_BeforeTask extends BaseMpsBeforeTaskProvider<Make_BeforeTask.Make_BeforeTask_RunTask> {
  private static final Key<Make_BeforeTask.Make_BeforeTask_RunTask> KEY = Key.create("jetbrains.mps.execution.configurations.pluginSolution.plugin.Make_BeforeTask");
