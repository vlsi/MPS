...
public abstract class AbstractMainNodeChooser extends BaseChooserComponent {
  ...
  public SNode getNode() {
    return this.myNodePointer.resolve(MPSModuleRepository.getInstance());
  }
  ...
  public void setNode(SNode node) {
    ...
    if (node == null) {
      ...
      this.myNodePointer = new jetbrains.mps.smodel.SNodePointer(node);
  ...
  private void fireNodeChanged() {
    ListSequence.fromList(this.myListeners).visitAll(new IVisitor<_FunctionTypes._void_P1_E0<? super SNode>>() {
      public void visit(_FunctionTypes._void_P1_E0<? super SNode> it) {
        it.invoke(AbstractMainNodeChooser.this.myNodePointer.resolve(MPSModuleRepository.getInstance()));
      }
    });
  }
  ...
  private static SNode check_wlpn4v_a0a0i(SNodeReference checkedDotOperand, AbstractMainNodeChooser checkedDotThisExpression) {
