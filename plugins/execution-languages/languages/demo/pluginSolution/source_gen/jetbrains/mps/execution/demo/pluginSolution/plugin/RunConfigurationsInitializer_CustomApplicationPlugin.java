...
public class RunConfigurationsInitializer_CustomApplicationPlugin extends BaseCustomApplicationPlugin {
  private static final Logger LOG = LogManager.getLogger(RunConfigurationsInitializer_CustomApplicationPlugin.class);
  ...
  public void doInit() {
    ...
    {
      Demo_Kind runConfigurationKind = new Demo_Kind();
    ...
    {
      ConfigurationType configurationType = ContainerUtil.findInstance(configurationExtensionPoint.getExtensions(), getClassFunction.invoke("jetbrains.mps.execution.demo.pluginSolution.plugin.Demo_Kind"));
      if (configurationType != null) {
        List<RuntimeConfigurationProducer> configurationProducers = DemoApplication_Producer.getProducers(configurationType);
