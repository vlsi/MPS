...
<solution name="jetbrains.mps.execution.demo.pluginSolution" uuid="e2beadc1-8519-4f66-bcdf-046892bd0d20" pluginKind="PLUGIN_OTHER" compileInMPS="true" generatorOutputPath="${module}/source_gen">
  <models>
