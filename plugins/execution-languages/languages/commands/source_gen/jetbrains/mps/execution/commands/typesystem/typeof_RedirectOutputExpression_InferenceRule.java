  ...
  public static class QuotationClass_91b0fg_a0a1a0 {
    ...
    public SNode createNode(final TypeCheckingContext typeCheckingContext) {
      ...
      SNode quotedNode_1 = null;
      {
        ...
        SNode quotedNode1_2 = quotedNode_1;
        quotedNode1_2.addReference(SReference.create("classifier", quotedNode1_2, SModelReference.fromString("f:java_stub#86441d7a-e194-42da-81a5-2161ec62a379#com.intellij.execution.process(MPS.Workbench/com.intellij.execution.process@java_stub)"), SNodeId.fromString("~ProcessListener")));
        result = quotedNode1_2;
      }
      return result;
    }
