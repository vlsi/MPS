...
public class ConvertToList_Intention extends BaseIntention {
  ...
  public SNodeReference getIntentionNodeReference() {
    return new SNodePointer("r:b3ba2978-d9e1-42da-a40c-ee739f2edfbf(jetbrains.mps.execution.commands.intentions@1_0)", "2168104298250389155");
  }
  ...
  private boolean isVisibleInChild(final SNode node, final SNode childNode, final EditorContext editorContext) {
    return eq_63cojg_a0a0j(SNodeOperations.getContainingLinkRole(childNode), "items");
  }
  ...
  public void execute(final SNode node, final EditorContext editorContext) {
    ...
    SLinkOperations.setTarget(node, "list", new ConvertToList_Intention.QuotationClass_63cojg_a0a0c0l().createNode(items), true);
  }

  private static boolean eq_63cojg_a0a0j(Object a, Object b) {
    return (a != null ?
      a.equals(b) :
      a == b
    );
  ...
  public static class QuotationClass_63cojg_a0a0c0l {
    public QuotationClass_63cojg_a0a0c0l() {
    }
