...
public final class CommandParameterDeclaration__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<String> getSetterName_id6mJVBGGsi5s = new SMethodBuilder<String>(new SJavaCompoundTypeImpl(String.class)).name("getSetterName").modifiers(SModifiersImpl.create(0, AccessPrivileges.PUBLIC)).concept(CONCEPT).id("6mJVBGGsi5s").registry(REGISTRY).build(SParameterImpl.fromList(SJavaCompoundTypeImpl.fromClasses()));
  public static final SMethod<String> getSetterLongName_id3gpm$NHlR8F = new SMethodBuilder<String>(new SJavaCompoundTypeImpl(String.class)).name("getSetterLongName").modifiers(SModifiersImpl.create(0, AccessPrivileges.PUBLIC)).concept(CONCEPT).id("3gpm$NHlR8F").registry(REGISTRY).build(SParameterImpl.fromList(SJavaCompoundTypeImpl.fromClasses()));
  /*package*/ static final SMethod<String> getUpperCaseName_id6mJVBGGsi5H = new SMethodBuilder<String>(new SJavaCompoundTypeImpl(String.class)).name("getUpperCaseName").modifiers(SModifiersImpl.create(0, AccessPrivileges.PRIVATE)).concept(CONCEPT).id("6mJVBGGsi5H").registry(REGISTRY).build(SParameterImpl.fromList(SJavaCompoundTypeImpl.fromClasses()));
  public static final SMethod<String> getFieldName_id6mJVBGGspQq = new SMethodBuilder<String>(new SJavaCompoundTypeImpl(String.class)).name("getFieldName").modifiers(SModifiersImpl.create(0, AccessPrivileges.PUBLIC)).concept(CONCEPT).id("6mJVBGGspQq").registry(REGISTRY).build(SParameterImpl.fromList(SJavaCompoundTypeImpl.fromClasses()));
  public static final SMethod<String> getFieldName_id6mJVBGGsi69 = new SMethodBuilder<String>(new SJavaCompoundTypeImpl(String.class)).name("getFieldName").modifiers(SModifiersImpl.create(1, AccessPrivileges.PUBLIC)).concept(CONCEPT).id("6mJVBGGsi69").registry(REGISTRY).build(SParameterImpl.fromList(SJavaCompoundTypeImpl.fromClasses(String.class)));
  public static final SMethod<String> getTypeSuffix_id3gpm$NHlXW7 = new SMethodBuilder<String>(new SJavaCompoundTypeImpl(String.class)).name("getTypeSuffix").modifiers(SModifiersImpl.create(1, AccessPrivileges.PUBLIC)).concept(CONCEPT).id("3gpm$NHlXW7").registry(REGISTRY).build(SParameterImpl.fromList(SJavaCompoundTypeImpl.fromClasses((Class<SNode>) ((Class) Object.class))));
  public static final SMethod<String> getUpperCaseName_id6mJVBGGsi5Q = new SMethodBuilder<String>(new SJavaCompoundTypeImpl(String.class)).name("getUpperCaseName").modifiers(SModifiersImpl.create(1, AccessPrivileges.PUBLIC)).concept(CONCEPT).id("6mJVBGGsi5Q").registry(REGISTRY).build(SParameterImpl.fromList(SJavaCompoundTypeImpl.fromClasses(String.class)));
  ...
  private static String getSetterName_id6mJVBGGsi5s(@NotNull SNode __thisNode__) {
    return "set" + CommandParameterDeclaration__BehaviorDescriptor.getUpperCaseName_id6mJVBGGsi5H.invoke(__thisNode__);
  }
  private static String getSetterLongName_id3gpm$NHlR8F(@NotNull SNode __thisNode__) {
  ...
  private static String getUpperCaseName_id6mJVBGGsi5H(@NotNull SNode __thisNode__) {
  ...
  private static String getFieldName_id6mJVBGGspQq(@NotNull SNode __thisNode__) {
  ...
  private static String getFieldName_id6mJVBGGsi69(@NotNull SAbstractConcept __thisConcept__, String name) {
  ...
  private static String getTypeSuffix_id3gpm$NHlXW7(@NotNull SAbstractConcept __thisConcept__, SNode type) {
  ...
  private static String getUpperCaseName_id6mJVBGGsi5Q(@NotNull SAbstractConcept __thisConcept__, String name) {
  ...
  protected <T> T invokeSpecial0(@NotNull SNode node, @NotNull SMethod<T> method, @NotNull Object[] parameters) {
    ...
    switch (methodIndex) {
      ...
      case 2:
        return (T) getSetterName_id6mJVBGGsi5s(node);
      case 3:
        return (T) getSetterLongName_id3gpm$NHlR8F(node);
      case 4:
        return (T) getUpperCaseName_id6mJVBGGsi5H(node);
      case 5:
        return (T) getFieldName_id6mJVBGGspQq(node);
      default:
        throw new BHMethodNotFoundException(this, method);
    }
  }
  ...
  protected <T> T invokeSpecial0(@NotNull SAbstractConcept concept, @NotNull SMethod<T> method, @NotNull Object[] parameters) {
    ...
    switch (methodIndex) {
      case 6:
        return (T) getFieldName_id6mJVBGGsi69(concept, (String) parameters[0]);
      case 7:
        return (T) getTypeSuffix_id3gpm$NHlXW7(concept, (SNode) parameters[0]);
      case 8:
        return (T) getUpperCaseName_id6mJVBGGsi5Q(concept, (String) parameters[0]);
      default:
        throw new BHMethodNotFoundException(this, method);
    }
  }
