...
public class StructureAspectDescriptor implements jetbrains.mps.smodel.runtime.StructureAspectDescriptor {
  ...
  public ConceptDescriptor getDescriptor(String conceptFqName) {
    switch (Arrays.binarySearch(stringSwitchCases_1htk8d_a0a0a, conceptFqName)) {
      ...
      case 10:
        return new CompiledConceptDescriptor("jetbrains.mps.execution.commands.structure.CommandPartLengthOperation", "jetbrains.mps.lang.core.structure.BaseConcept", false, new String[]{"jetbrains.mps.lang.core.structure.BaseConcept", "jetbrains.mps.baseLanguage.structure.IOperation"}, new String[]{}, new String[]{});
      case 11:
        return new CompiledConceptDescriptor("jetbrains.mps.execution.commands.structure.CommandPartToListOperation", "jetbrains.mps.lang.core.structure.BaseConcept", false, new String[]{"jetbrains.mps.lang.core.structure.BaseConcept", "jetbrains.mps.baseLanguage.structure.IOperation"}, new String[]{}, new String[]{});
      case 12:
      ...
      case 18:
        return new CompiledConceptDescriptor("jetbrains.mps.execution.commands.structure.KeyValueCommandPart", "jetbrains.mps.execution.commands.structure.ProcessBuilderCommandPart", false, new String[]{"jetbrains.mps.execution.commands.structure.ProcessBuilderCommandPart"}, new String[]{"dash"}, new String[]{});
      case 19:
        return new CompiledConceptDescriptor("jetbrains.mps.execution.commands.structure.ListCommandPart", "jetbrains.mps.execution.commands.structure.ProcessBuilderCommandPart", false, new String[]{"jetbrains.mps.execution.commands.structure.ProcessBuilderCommandPart"}, new String[]{}, new String[]{});
      case 20:
        return new CompiledConceptDescriptor("jetbrains.mps.execution.commands.structure.NewProcessBuilderExpression", "jetbrains.mps.baseLanguage.structure.Expression", false, new String[]{"jetbrains.mps.baseLanguage.structure.Expression"}, new String[]{}, new String[]{});
      case 21:
        return new CompiledConceptDescriptor("jetbrains.mps.execution.commands.structure.ProcessBuilderCommandPart", "jetbrains.mps.baseLanguage.structure.Expression", false, new String[]{"jetbrains.mps.baseLanguage.structure.Expression"}, new String[]{}, new String[]{});
      case 22:
        return new CompiledConceptDescriptor("jetbrains.mps.execution.commands.structure.ProcessBuilderCommandPartType", "jetbrains.mps.baseLanguage.structure.Type", false, new String[]{"jetbrains.mps.baseLanguage.structure.Type"}, new String[]{}, new String[]{});
      case 23:
      ...
      case 27:
        return new CompiledConceptDescriptor("jetbrains.mps.execution.commands.structure.PropertyCommandPart", "jetbrains.mps.execution.commands.structure.ProcessBuilderCommandPart", false, new String[]{"jetbrains.mps.execution.commands.structure.ProcessBuilderCommandPart"}, new String[]{}, new String[]{});
      case 28:
