...
public class ExecuteCommandPart_Behavior {
  ...
  private static SNode _quotation_createNode_qal9w4_a0a0a3() {
    ...
    quotedNode_1.setReference("classifier", SReference.create("classifier", quotedNode_1, SModelReference.fromString("f:java_stub#742f6602-5a2f-4313-aa6e-ae1cd4ffdc61#com.intellij.execution(MPS.Platform/com.intellij.execution@java_stub)"), jetbrains.mps.smodel.SNodeId.fromString("~ExecutionException")));
    return quotedNode_1;
  }
  ...
  private static SNode _quotation_createNode_qal9w4_a0a5() {
    ...
    quotedNode_3.setReference("classifier", SReference.create("classifier", quotedNode_3, SModelReference.fromString("f:java_stub#742f6602-5a2f-4313-aa6e-ae1cd4ffdc61#com.intellij.execution.process(MPS.Platform/com.intellij.execution.process@java_stub)"), jetbrains.mps.smodel.SNodeId.fromString("~ProcessHandler")));
