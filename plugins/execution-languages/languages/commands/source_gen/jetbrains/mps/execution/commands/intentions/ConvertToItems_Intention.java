...
public class ConvertToItems_Intention extends BaseIntention {
  ...
  private boolean isVisibleInChild(final SNode node, final SNode childNode, final EditorContext editorContext) {
    return eq_icoqxr_a0a0j(SNodeOperations.getContainingLinkRole(childNode), "list");
  }
  ...
  private static boolean eq_icoqxr_a0a0j(Object a, Object b) {
    return (a != null ?
      a.equals(b) :
      a == b
    );
