...
public class StructureAspectDescriptor extends BaseStructureAspectDescriptor {
  ...
  /*package*/ final ConceptDescriptor myConceptOverridingPrimFloatType = new ConceptDescriptorBuilder("testOverridingType.structure.OverridingPrimFloatType", MetaIdFactory.conceptId(0x394e385732564e8bL, 0x96015abe7ad354d9L, 0x5b362c13a4993604L)).super_("testAnnotatedType.structure.PrimFloatType").super_(MetaIdFactory.conceptId(0x2f74e72e3e3d480eL, 0xbae1cc709d588366L, 0x58e32a0782beb1bdL)).parents("testAnnotatedType.structure.PrimFloatType").parentIds(MetaIdFactory.conceptId(0x2f74e72e3e3d480eL, 0xbae1cc709d588366L, 0x58e32a0782beb1bdL)).alias("_float_overridden", "").sourceNode(new SNodePointer("r:b840b070-fa0a-4e7f-8980-8fcd6f3fd146(testOverridingType.structure)", "6572489169071322628")).create();
  /*package*/ final ConceptDescriptor myConceptOverridingPrimIntType = new ConceptDescriptorBuilder("testOverridingType.structure.OverridingPrimIntType", MetaIdFactory.conceptId(0x394e385732564e8bL, 0x96015abe7ad354d9L, 0x5b362c13a49935f1L)).super_("testAnnotatedType.structure.PrimIntType").super_(MetaIdFactory.conceptId(0x2f74e72e3e3d480eL, 0xbae1cc709d588366L, 0x58e32a0782be609eL)).parents("testAnnotatedType.structure.PrimIntType").parentIds(MetaIdFactory.conceptId(0x2f74e72e3e3d480eL, 0xbae1cc709d588366L, 0x58e32a0782be609eL)).alias("_int_overridden", "").sourceNode(new SNodePointer("r:b840b070-fa0a-4e7f-8980-8fcd6f3fd146(testOverridingType.structure)", "6572489169071322609")).create();
  /*package*/ final ConceptDescriptor myConceptOverridingPrimNumConstant = new ConceptDescriptorBuilder("testOverridingType.structure.OverridingPrimNumConstant", MetaIdFactory.conceptId(0x394e385732564e8bL, 0x96015abe7ad354d9L, 0x5b362c13a4988795L)).super_("testAnnotatedType.structure.PrimNumConstant").super_(MetaIdFactory.conceptId(0x2f74e72e3e3d480eL, 0xbae1cc709d588366L, 0x1469c391a09a5eefL)).parents("testAnnotatedType.structure.PrimNumConstant").parentIds(MetaIdFactory.conceptId(0x2f74e72e3e3d480eL, 0xbae1cc709d588366L, 0x1469c391a09a5eefL)).propertyDescriptors(new ConceptDescriptorBuilder.Prop(0x5b362c13a498895bL, "isOverriding")).properties("isOverriding").sourceNode(new SNodePointer("r:b840b070-fa0a-4e7f-8980-8fcd6f3fd146(testOverridingType.structure)", "6572489169071277973")).create();
