...
public class StructureAspectDescriptor extends BaseStructureAspectDescriptor {
  ...
  /*package*/ final ConceptDescriptor myConceptPrimNumConstant = new ConceptDescriptorBuilder("testAnnotatedType.structure.PrimNumConstant", MetaIdFactory.conceptId(0x2f74e72e3e3d480eL, 0xbae1cc709d588366L, 0x1469c391a09a5eefL)).super_("jetbrains.mps.baseLanguage.structure.Expression").super_(MetaIdFactory.conceptId(0xf3061a5392264cc5L, 0xa443f952ceaf5816L, 0xf8c37f506fL)).parents("jetbrains.mps.baseLanguage.structure.Expression").parentIds(MetaIdFactory.conceptId(0xf3061a5392264cc5L, 0xa443f952ceaf5816L, 0xf8c37f506fL)).propertyDescriptors(new ConceptDescriptorBuilder.Prop(0x1469c391a09bd6aaL, "value"), new ConceptDescriptorBuilder.Prop(0x1469c391a09a5ef0L, "isFloat")).properties("value", "isFloat").sourceNode(new SNodePointer("r:c0db73ed-f604-44cb-9fd9-3e3424a144b7(testAnnotatedType.structure)", "1470921783545323247")).create();
