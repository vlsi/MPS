...
public class AdditionalStructurePropertiesImpl extends BaseAdditionalStructureProperties {
  private final AdditionalConceptProperties props_PresenceCondition = new ConceptPropsBuilder().create();
  private final AdditionalConceptProperties props_PrimDoubleType = new ConceptPropsBuilder().create();
  private final AdditionalConceptProperties props_PrimFloatType = new ConceptPropsBuilder().create();
  private final AdditionalConceptProperties props_PrimIntType = new ConceptPropsBuilder().create();
  private final AdditionalConceptProperties props_PrimLongType = new ConceptPropsBuilder().create();
  private final AdditionalConceptProperties props_PrimNumConstant = new ConceptPropsBuilder().create();
  private final AdditionalConceptProperties props_PrimType = new ConceptPropsBuilder().create();
  private final AdditionalConceptProperties props_SubstituteAnnotation = new ConceptPropsBuilder().create();
