...
public class NodeGroupChange extends ModelChange {
  ...
  public SNodeReference getMergeHint() {
    ...
    if (!(myMergeHintLoaded)) {
      ...
      SNode linkDecl = SNodeOperations.as(SModelSearchUtil.findLinkDeclaration(c, myRole), MetaAdapterFactory.getConcept(0xc72da2b97cce4447L, 0x8389f407dc1158b7L, 0xf979bd086aL, "jetbrains.mps.lang.structure.structure.LinkDeclaration"));
