...
public class MergeSession {
  ...
  public static MergeSession createMergeSession(final jetbrains.mps.smodel.SModel base, final jetbrains.mps.smodel.SModel mine, final jetbrains.mps.smodel.SModel repository) {
    // TODO generalize merge for any SModel
    jetbrains.mps.smodel.SModel resModel = CopyUtil.copyModel(base);
    SModel resMD = resModel.getModelDescriptor();
