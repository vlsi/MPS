...
public abstract class BaseConsoleTab extends JPanel implements Disposable {
  ...
  protected void initConsoleTab(@Nullable final String history) {
    ...
    myHighlighter = check_6q36mf_a0q0ic(myTool.getProject());
  ...
  private static Highlighter check_6q36mf_a0q0ic(com.intellij.openapi.project.Project checkedDotOperand) {
    if (null != checkedDotOperand) {
