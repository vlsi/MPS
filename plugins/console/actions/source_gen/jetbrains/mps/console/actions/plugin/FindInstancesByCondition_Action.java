...
public class FindInstancesByCondition_Action extends BaseAction {
  ...
  private static SNode _quotation_createNode_flklsf_a0c0a(Object parameter_1) {
    ...
    quotedNode_3 = SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.console.blCommand.structure.ShowExpression", null, null, GlobalScope.getInstance(), false);
    ...
    quotedNode_5 = SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.console.blCommand.structure.InstancesExpression", null, null, GlobalScope.getInstance(), false);
    ...
    quotedNode_8 = SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.console.blCommand.structure.QueryParameterList", null, null, GlobalScope.getInstance(), false);
    quotedNode_5.addChild("parameter", quotedNode_8);
    quotedNode_4.addChild("operand", quotedNode_5);
    quotedNode_6 = SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.baseLanguage.collections.structure.WhereOperation", null, null, GlobalScope.getInstance(), false);
    ...
    quotedNode_11 = SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.baseLanguage.collections.structure.SmartClosureParameterDeclaration", null, null, GlobalScope.getInstance(), false);
    SNodeAccessUtil.setProperty(quotedNode_11, "name", "it");
    quotedNode_12 = SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.baseLanguage.structure.UndefinedType", null, null, GlobalScope.getInstance(), false);
