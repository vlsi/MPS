...
public class ExceptionHolder_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createCollection_hbc894_a(EditorContext editorContext, SNode node) {
    ...
    editorCell.addEditorCell(this.createRefNode_hbc894_b0(editorContext, node));
    return editorCell;
  }
  ...
  private EditorCell createRefNode_hbc894_b0(EditorContext editorContext, SNode node) {
    CellProviderWithRole provider = new RefNodeCellProvider(node, editorContext);
    provider.setRole("clickable");
    provider.setNoTargetText("<no clickable>");
    EditorCell editorCell;
    editorCell = provider.createEditorCell(editorContext);
    if (editorCell.getRole() == null) {
      editorCell.setRole("clickable");
    }
