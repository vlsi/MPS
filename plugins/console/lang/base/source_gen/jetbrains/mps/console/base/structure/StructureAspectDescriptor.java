...
public class StructureAspectDescriptor implements jetbrains.mps.smodel.runtime.StructureAspectDescriptor {
  ...
  public ConceptDescriptor getDescriptor(String conceptFqName) {
    switch (Arrays.binarySearch(stringSwitchCases_1htk8d_a0a0b, conceptFqName)) {
      ...
      case 4:
        return new ConceptDescriptorBuilder("jetbrains.mps.console.base.structure.CommandResultPart").super_("jetbrains.mps.lang.core.structure.BaseConcept").parents("jetbrains.mps.lang.core.structure.BaseConcept", "jetbrains.mps.lang.core.structure.IDontSubstituteByDefault").abstract_().create();
      case 5:
        return new ConceptDescriptorBuilder("jetbrains.mps.console.base.structure.ExceptionResultPart").super_("jetbrains.mps.console.base.structure.NodeWithClosureResultPart").parents("jetbrains.mps.console.base.structure.NodeWithClosureResultPart").create();
      case 6:
      ...
      case 13:
        return new ConceptDescriptorBuilder("jetbrains.mps.console.base.structure.NodeReferenceResultPart").super_("jetbrains.mps.console.base.structure.CommandResultPart").parents("jetbrains.mps.console.base.structure.CommandResultPart", "jetbrains.mps.console.base.structure.INodeWithClickableReference").references("target").create();
      case 14:
      ...
      case 15:
        return new ConceptDescriptorBuilder("jetbrains.mps.console.base.structure.NodeWithClosureResultPart").super_("jetbrains.mps.console.base.structure.CommandResultPart").parents("jetbrains.mps.console.base.structure.CommandResultPart", "jetbrains.mps.console.base.structure.INodeWithClosure").properties("text").create();
      case 16:
  ...
  private static String[] stringSwitchCases_1htk8d_a0a0b = new String[]{"jetbrains.mps.console.base.structure.Command", "jetbrains.mps.console.base.structure.CommandHolder", "jetbrains.mps.console.base.structure.CommandResult", "jetbrains.mps.console.base.structure.CommandResultLine", "jetbrains.mps.console.base.structure.CommandResultPart", "jetbrains.mps.console.base.structure.ExceptionResultPart", "jetbrains.mps.console.base.structure.GeneratedCommand", "jetbrains.mps.console.base.structure.History", "jetbrains.mps.console.base.structure.HistoryItem", "jetbrains.mps.console.base.structure.IActionHolder", "jetbrains.mps.console.base.structure.INodeWithClickableReference", "jetbrains.mps.console.base.structure.INodeWithClosure", "jetbrains.mps.console.base.structure.InterpretedCommand", "jetbrains.mps.console.base.structure.NodeReferenceResultPart", "jetbrains.mps.console.base.structure.NodeResultPart", "jetbrains.mps.console.base.structure.NodeWithClosureResultPart", "jetbrains.mps.console.base.structure.PastedNodeReference", "jetbrains.mps.console.base.structure.Result", "jetbrains.mps.console.base.structure.TextResultPart"};
}
