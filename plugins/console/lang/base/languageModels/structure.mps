...
<model modelUID="r:359b1d2b-77c4-46df-9bf2-b25cbea32254(jetbrains.mps.console.base.structure)" version="0">
  ...
  <root type="tpce.ConceptDeclaration" typeId="tpce.1071489090640" id="529843215038987952" nodeInfo="ig">
    ...
    <node role="linkDeclaration" roleId="tpce.1071489727083" type="tpce.LinkDeclaration" typeId="tpce.1071489288298" id="6322385757200866456" nodeInfo="ig">
  ...
  <root type="tpce.ConceptDeclaration" typeId="tpce.1071489090640" id="2699636778859335756" nodeInfo="ig">
    <property name="virtualPackage" nameId="tpck.1193676396447" value="result" />
    <property name="name" nameId="tpck.1169194664001" value="ExceptionResultPart" />
    <link role="extends" roleId="tpce.1071489389519" targetNodeId="1111629987770987206" resolveInfo="NodeWithClosureResultPart" />
  </root>
  <root type="tpce.ConceptDeclaration" typeId="tpce.1071489090640" id="2699636778859335853" nodeInfo="ig">
    ...
    <property name="final" nameId="tpce.4628067390765956807" value="false" />
    <link role="extends" roleId="tpce.1071489389519" targetNodeId="tpck.1133920641626" resolveInfo="BaseConcept" />
    <node role="implements" roleId="tpce.1169129564478" type="tpce.InterfaceConceptReference" typeId="tpce.1169127622168" id="2699636778859335969" nodeInfo="ig">
      <link role="intfc" roleId="tpce.1169127628841" targetNodeId="tpck.1835621062190663819" resolveInfo="IDontSubstituteByDefault" />
    </node>
  </root>
</model>
