...
<language namespace="jetbrains.mps.console.ideCommands" uuid="a5e4de53-46a3-44da-aab3-68fdf1c34ed0">
  <models>
  ...
  <accessoryModels />
  <generators>
    <generator generatorUID="jetbrains.mps.console.ideCommands#7935955022005272663" uuid="cb761471-7219-4984-9a63-b9c8b4d27e89">
      <models>
        <modelRoot contentPath="${module}" type="default">
