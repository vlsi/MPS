...
<model modelUID="r:135a606f-0376-4c5c-9ab8-4030f051a062(jetbrains.mps.console.ideCommands.structure)">
  ...
  <root type="tpce.ConceptDeclaration" typeId="tpce.1071489090640" id="7490254719522540696" nodeInfo="ig">
    ...
    <property name="conceptShortDescription" nameId="tpce.4628067390765907488" value="display statistics" />
    <link role="extends" roleId="tpce.1071489389519" targetNodeId="eynw.1769790395579407461" resolveInfo="InterpretedCommand" />
  ...
  <root type="tpce.ConceptDeclaration" typeId="tpce.1071489090640" id="7057947030097724900" nodeInfo="ig">
    ...
    <property name="conceptShortDescription" nameId="tpce.4628067390765907488" value="show generation plan" />
    <link role="extends" roleId="tpce.1071489389519" targetNodeId="eynw.1769790395579407461" resolveInfo="InterpretedCommand" />
  ...
  <root type="tpce.ConceptDeclaration" typeId="tpce.1071489090640" id="5582028874769074093" nodeInfo="ig">
    ...
    <property name="conceptShortDescription" nameId="tpce.4628067390765907488" value="call IDE action with custom parameters" />
    <property name="virtualPackage" nameId="tpck.1193676396447" value="expression.callAction" />
  ...
  <root type="tpce.ConceptDeclaration" typeId="tpce.1071489090640" id="5582028874769074099" nodeInfo="ig">
    ...
    <node role="implements" roleId="tpce.1169129564478" type="tpce.InterfaceConceptReference" typeId="tpce.1169127622168" id="7185170375692818667" nodeInfo="ig">
      <link role="intfc" roleId="tpce.1169127628841" targetNodeId="tpck.1835621062190663819" resolveInfo="IDontSubstituteByDefault" />
    </node>
  </root>
  ...
  <root type="tpce.ConceptDeclaration" typeId="tpce.1071489090640" id="2840424593938220297" nodeInfo="ig">
    <property name="virtualPackage" nameId="tpck.1193676396447" value="make" />
  ...
  <root type="tpce.ConceptDeclaration" typeId="tpce.1071489090640" id="2840424593984889498" nodeInfo="ig">
    <property name="virtualPackage" nameId="tpck.1193676396447" value="make" />
    <property name="name" nameId="tpck.1169194664001" value="AbsractMake" />
    <property name="abstract" nameId="tpce.4628067390765956802" value="true" />
    <property name="final" nameId="tpce.4628067390765956807" value="false" />
    <link role="extends" roleId="tpce.1071489389519" targetNodeId="3xdn.4307205004131544317" resolveInfo="QueryExpression" />
    <node role="linkDeclaration" roleId="tpce.1071489727083" type="tpce.LinkDeclaration" typeId="tpce.1071489288298" id="2840424593984889584" nodeInfo="ig">
      <property name="metaClass" nameId="tpce.1071599937831" value="aggregation" />
  ...
  <root type="tpce.ConceptDeclaration" typeId="tpce.1071489090640" id="5932042262275638696" nodeInfo="ig">
    ...
    <property name="conceptShortDescription" nameId="tpce.4628067390765907488" value="filter models by aspect" />
    ...
    <node role="linkDeclaration" roleId="tpce.1071489727083" type="tpce.LinkDeclaration" typeId="tpce.1071489288298" id="5932042262275696048" nodeInfo="ig">
      <property name="metaClass" nameId="tpce.1071599937831" value="reference" />
      <property name="sourceCardinality" nameId="tpce.1071599893252" value="1" />
      <property name="role" nameId="tpce.1071599776563" value="requestedAspect" />
      <link role="target" roleId="tpce.1071599976176" targetNodeId="tpee.1083245299891" resolveInfo="EnumConstantDeclaration" />
    </node>
    <node role="implements" roleId="tpce.1169129564478" type="tpce.InterfaceConceptReference" typeId="tpce.1169127622168" id="5932042262275684757" nodeInfo="ig">
