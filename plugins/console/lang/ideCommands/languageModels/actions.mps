...
<model modelUID="r:02073207-e767-4759-a6fd-2e43f805a438(jetbrains.mps.console.ideCommands.actions)">
  ...
  <root type="tpdg.NodeSubstituteActions" typeId="tpdg.1112056943463" id="5932042262275855252" nodeInfo="ng">
    <property name="virtualPackage" nameId="tpck.1193676396447" value="make" />
    <node role="actionsBuilder" roleId="tpdg.1112058057696" type="tpdg.NodeSubstituteActionsBuilder" typeId="tpdg.1112058030570" id="5932042262275855253" nodeInfo="ng">
      <link role="applicableConcept" roleId="tpdg.1112058088712" targetNodeId="caxt.5932042262275638696" resolveInfo="OfAspectOperation" />
      <node role="part" roleId="tpdg.1177324142645" type="tpdg.RemoveByConditionPart" typeId="tpdg.1177413882405" id="5932042262275855360" nodeInfo="ng">
        <node role="condition" roleId="tpdg.1177414109676" type="tpdg.QueryFunction_RemoveBy_Condition" typeId="tpdg.1177413954598" id="5932042262275855361" nodeInfo="nn">
          <node role="body" roleId="tpee.1137022507850" type="tpee.StatementList" typeId="tpee.1068580123136" id="5932042262275855362" nodeInfo="sn">
                  ...
                  <node role="condition" roleId="tpee.1068580123160" type="tpd4.IsSubtypeExpression" typeId="tpd4.1176543928247" id="1926293835606282924" nodeInfo="nn">
                    <node role="supertypeExpression" roleId="tpd4.1176543950311" type="tp3r.Quotation" typeId="tp3r.1196350785113" id="1926293835606285046" nodeInfo="nn">
                      <node role="quotedNode" roleId="tp3r.1196350785114" type="tp2q.SequenceType" typeId="tp2q.1151689724996" id="1926293835606286136" nodeInfo="in">
                        <node role="elementType" roleId="tp2q.1151689745422" type="tp25.SModelType" typeId="tp25.1143226024141" id="5932042262275858205" nodeInfo="in" />
                      </node>
                    </node>
