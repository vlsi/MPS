...
public class EditorAspectDescriptorImpl implements EditorAspectDescriptor {
  ...
  private static String[] stringSwitchCases_xbvbvu_a0a0c = new String[]{"jetbrains.mps.console.scripts.structure.ConsoleScript", "jetbrains.mps.console.scripts.structure.Execute"};
}
