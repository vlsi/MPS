...
public class BLExpression_Actions {
  ...
  public static class BLExpression_Actions_INSERT extends AbstractCellAction {
    ...
    public void execute_internal(EditorContext editorContext, SNode node) {
      SNode blCommand = SConceptOperations.createNewNode(SNodeOperations.asInstanceConcept(MetaAdapterFactory.getConcept(new UUID(1911026821630280634l, -8343922105556474022l), 5464054275389846505l, "jetbrains.mps.console.blCommand.structure.BLCommand")));
      SLinkOperations.setTarget(blCommand, MetaAdapterFactory.getContainmentLink(new UUID(1911026821630280634l, -8343922105556474022l), 5464054275389846505l, 1769790395579689573l, "body"), SConceptOperations.createNewNode(SNodeOperations.asInstanceConcept(MetaAdapterFactory.getConcept(new UUID(-935030926396207931l, -6610165693999523818l), 1068580123136l, "jetbrains.mps.baseLanguage.structure.StatementList"))));
