...
public class ConsoleTool extends BaseProjectTool implements ConsoleStream {
  ...
  protected void initMainComponent() {
    ...
    ModelAccess.instance().runWriteActionInCommand(new Runnable() {
      public void run() {
        ...
        ((SModelInternal) myModel).addLanguage(
            ModuleRepositoryFacade.getInstance().getModule("jetbrains.mps.console.lang", Language.class).getModuleReference());
        ((SModelInternal) myModel).addLanguage(
            ModuleRepositoryFacade.getInstance().getModule("jetbrains.mps.console.lang.commands", Language.class).getModuleReference());
        ((SModelInternal) myModel).addLanguage(
            ModuleRepositoryFacade.getInstance().getModule("jetbrains.mps.baseLanguage", Language.class).getModuleReference());
  ...
  private SNode getLastResult() {
    SNode last = SNodeOperations.as(ListSequence.fromList(SLinkOperations.getTargets(myRoot, "item", true)).last(),
        "jetbrains.mps.console.lang.commands.structure.BLCommandResult");
    if (last != null) {
      return last;
    }
  ...
  private static SNode _quotation_createNode_xg3v07_a0a0a72(Object parameter_1) {
    ...
    quotedNode_2 =
        SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.console.lang.commands.structure.TextResultPart", null, null, GlobalScope.getInstance(),
            false);
  ...
  private static SNode _quotation_createNode_xg3v07_a0a0cb() {
    ...
    quotedNode_1 =
        SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.console.lang.commands.structure.NodeResultPart", null, null, GlobalScope.getInstance(),
            false);
    return quotedNode_1;
  }
}
