...
public class ImportAntStuff_Action extends BaseAction {
  ...
  public void doExecute(@NotNull final AnActionEvent event, final Map<String, Object> _params) {
    try {
      ...
      ImportAntStuff_Action.this.importTasks(language, SModelRepository.getInstance().getModelDescriptor(new SModelReference("jetbrains.mps.build.generictasks.generated", "")).getSModel(), Generator.Modes.CORE, _params);
      ImportAntStuff_Action.this.importTasks(language, SModelRepository.getInstance().getModelDescriptor(new SModelReference("jetbrains.mps.build.generictasks.optional", "")).getSModel(), Generator.Modes.JUNIT, _params);
