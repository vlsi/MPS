...
public class ProjectPaneModelAddition_ActionGroup extends GeneratedActionGroup {
  ...
  public static final String ID = "jetbrains.mps.build.deprecated.execution.ProjectPaneModelAddition_ActionGroup";
  ...
  public ProjectPaneModelAddition_ActionGroup() {
    ...
    this.setPopup(false);
    try {
      ProjectPaneModelAddition_ActionGroup.this.addAction("jetbrains.mps.build.deprecated.execution.GenerateBuildAction_Action");
    } catch (Throwable t) {
