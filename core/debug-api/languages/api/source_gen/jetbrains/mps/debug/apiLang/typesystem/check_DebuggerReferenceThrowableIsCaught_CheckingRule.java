...
public class check_DebuggerReferenceThrowableIsCaught_CheckingRule extends AbstractNonTypesystemRule_Runtime implements Rule_Runtime {
  public check_DebuggerReferenceThrowableIsCaught_CheckingRule() {
  }
  ...
  public void applyRule(final SNode debuggerReference, final TypeCheckingContext typeCheckingContext, IsApplicableStatus status) {
    if (SNodeOperations.isInstanceOf(SNodeOperations.getContainingRoot(debuggerReference), "jetbrains.mps.debug.apiLang.structure.DebugInfoProvider")) {
      Set<SNode> throwables = SetSequence.fromSet(new HashSet<SNode>());
      SetSequence.fromSet(throwables).addElement(new check_DebuggerReferenceThrowableIsCaught_CheckingRule.QuotationClass_1aa1mp_a0a0b0a0a().createNode(typeCheckingContext));
  ...
  public static class QuotationClass_1aa1mp_a0a0b0a0a {
    public QuotationClass_1aa1mp_a0a0b0a0a() {
    }
