...
public class ScopeNodeItem extends BaseConcept {
  public static final String concept = "jetbrains.mps.debugger.api.lang.structure.ScopeNodeItem";
  ...
  public static ScopeNodeItem newInstance(SModel sm, boolean init) {
    return (ScopeNodeItem) SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.debugger.api.lang.structure.ScopeNodeItem", sm, GlobalScope.getInstance(), init).getAdapter();
  }
