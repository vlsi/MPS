...
public class BreakpointCreator extends BaseConcept {
  public static final String concept = "jetbrains.mps.debugger.api.lang.structure.BreakpointCreator";
  ...
  public static BreakpointCreator newInstance(SModel sm, boolean init) {
    return (BreakpointCreator) SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.debugger.api.lang.structure.BreakpointCreator", sm, GlobalScope.getInstance(), init).getAdapter();
  }
