...
public class RelayQueryOperation_Editor extends DefaultNodeEditor {
  public EditorCell createEditorCell(EditorContext editorContext, SNode node) {
    return this.createCollection_9hjxv2_a(editorContext, node);
  }

  private EditorCell createCollection_9hjxv2_a(EditorContext editorContext, SNode node) {
    EditorCell_Collection editorCell = EditorCell_Collection.createIndent2(editorContext, node);
    editorCell.setCellId("Collection_9hjxv2_a");
  ...
  private EditorCell createRefCell_9hjxv2_c0(EditorContext editorContext, SNode node) {
    CellProviderWithRole provider = new RefCellCellProvider(node, editorContext);
    provider.setRole("query");
    provider.setNoTargetText("<no query>");
    EditorCell editorCell;
    provider.setAuxiliaryCellProvider(new RelayQueryOperation_Editor._Inline_9hjxv2_a2a());
  ...
  private EditorCell createConceptProperty_9hjxv2_a0(EditorContext editorContext, SNode node) {
  ...
  public static class _Inline_9hjxv2_a2a extends InlineCellProvider {
    public _Inline_9hjxv2_a2a() {
      super();
    }
    ...
    public EditorCell createEditorCell(EditorContext editorContext, SNode node) {
      return this.createProperty_9hjxv2_a0c0(editorContext, node);
    }

    private EditorCell createProperty_9hjxv2_a0c0(EditorContext editorContext, SNode node) {
