...
<model modelUID="r:71895ceb-c89d-4545-aa38-89d1cd891f17(jetbrains.mps.make.facet)">
  ...
  <languageAspect modelUID="r:71895ceb-c89d-4545-aa38-89d1cd891f17(jetbrains.mps.make.facet)" version="-1" />
  ...
  <node type="jetbrains.mps.baseLanguage.structure.Interface:3" id="6168415856807657134">
    ...
    <node role="method:3" type="jetbrains.mps.baseLanguage.structure.InstanceMethodDeclaration:3" id="7320828025189492112">
      ...
      <node role="typeVariableDeclaration:3" type="jetbrains.mps.baseLanguage.structure.TypeVariableDeclaration:3" id="3344436107829960273">
        <property name="name:3" value="T" />
      </node>
      <node role="parameter:3" type="jetbrains.mps.baseLanguage.structure.ParameterDeclaration:3" id="3344436107829960275">
        <property name="name:3" value="varCls" />
        <node role="type:3" type="jetbrains.mps.baseLanguage.structure.ClassifierType:3" id="3344436107829960276">
          <link role="classifier:3" targetNodeId="2v.~Class" resolveInfo="Class" />
          <node role="parameter:3" type="jetbrains.mps.baseLanguage.structure.TypeVariableReference:3" id="3344436107829960278">
            <link role="typeVariableDeclaration:3" targetNodeId="3344436107829960273" resolveInfo="T" />
          </node>
        </node>
      </node>
