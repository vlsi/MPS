...
<model modelUID="r:5ff047e0-2953-4750-806a-bdc16824aa89(jetbrains.mps.smodel)">
  ...
  <import index="12" modelUID="f:java_stub#37a3367b-1fb2-44d8-aa6b-18075e74e003#jetbrains.mps.project.structure.modules(jetbrains.mps.project.structure.modules@java_stub)" version="-1" />
  <import index="13" modelUID="f:java_stub#37a3367b-1fb2-44d8-aa6b-18075e74e003#jetbrains.mps.smodel(jetbrains.mps.smodel@java_stub)" version="-1" />
  ...
  <node type="jetbrains.mps.baseLanguage.structure.ClassConcept:3" id="5073169472575923460">
    ...
    <node role="staticField:3" type="jetbrains.mps.baseLanguage.structure.StaticFieldDeclaration:3" id="263434549788685398">
      <property name="isFinal:3" value="true" />
      <property name="name:3" value="GENERATOR_PARAMETERS" />
      <node role="visibility:3" type="jetbrains.mps.baseLanguage.structure.PublicVisibility:3" id="263434549788685399" />
      <node role="type:3" type="jetbrains.mps.baseLanguage.structure.ClassifierType:3" id="263434549788685400">
        <link role="classifier:3" targetNodeId="12.~ModuleReference" resolveInfo="ModuleReference" />
      </node>
      <node role="initializer:3" type="jetbrains.mps.lang.smodel.structure.CheckedModuleReference:16" id="263434549788685401">
        <property name="moduleId:16" value="289fcc83-6543-41e8-a5ca-768235715ce4(jetbrains.mps.lang.generator.generationParameters)" />
      </node>
    </node>
    ...
    <node role="staticMethod:3" type="jetbrains.mps.baseLanguage.structure.StaticMethodDeclaration:3" id="5073169472575923466">
      ...
      <node role="returnType:3" type="jetbrains.mps.baseLanguage.structure.ClassifierType:3" id="5073169472575923468">
        <link role="classifier:3" targetNodeId="13.~Language" />
      </node>
          ...
          <node role="expression:3" type="jetbrains.mps.baseLanguage.structure.CastExpression:3" id="5073169472575947729">
            <node role="expression:3" type="jetbrains.mps.baseLanguage.structure.DotExpression:3" id="5073169472575947730">
              <node role="operand:3" type="jetbrains.mps.baseLanguage.structure.StaticMethodCall:3" id="5073169472575947731">
                <link role="classConcept:3" targetNodeId="13.~MPSModuleRepository" />
                <link role="baseMethodDeclaration:3" targetNodeId="13.~MPSModuleRepository.getInstance():jetbrains.mps.smodel.MPSModuleRepository" />
              </node>
              <node role="operation:3" type="jetbrains.mps.baseLanguage.structure.InstanceMethodCallOperation:3" id="5073169472575947732">
                <link role="baseMethodDeclaration:3" targetNodeId="13.~MPSModuleRepository.getModule(jetbrains.mps.project.structure.modules.ModuleReference):jetbrains.mps.project.IModule" />
          ...
          <node role="expression:3" type="jetbrains.mps.baseLanguage.structure.CastExpression:3" id="5073169472575947738">
            <node role="expression:3" type="jetbrains.mps.baseLanguage.structure.DotExpression:3" id="5073169472575947739">
              <node role="operand:3" type="jetbrains.mps.baseLanguage.structure.StaticMethodCall:3" id="5073169472575947740">
                <link role="classConcept:3" targetNodeId="13.~MPSModuleRepository" resolveInfo="MPSModuleRepository" />
                <link role="baseMethodDeclaration:3" targetNodeId="13.~MPSModuleRepository.getInstance():jetbrains.mps.smodel.MPSModuleRepository" resolveInfo="getInstance" />
              </node>
              <node role="operation:3" type="jetbrains.mps.baseLanguage.structure.InstanceMethodCallOperation:3" id="5073169472575947741">
                <link role="baseMethodDeclaration:3" targetNodeId="13.~MPSModuleRepository.getModule(jetbrains.mps.project.structure.modules.ModuleReference):jetbrains.mps.project.IModule" resolveInfo="getModule" />
            ...
            <node role="type:3" type="jetbrains.mps.baseLanguage.structure.ClassifierType:3" id="5073169472575947743">
              <link role="classifier:3" targetNodeId="13.~Language" resolveInfo="Language" />
            </node>
          </node>
        </node>
      </node>
    ...
    <node role="staticMethod:3" type="jetbrains.mps.baseLanguage.structure.StaticMethodDeclaration:3" id="263434549788685386">
      <property name="name:3" value="generatorParametersLanguage" />
      <node role="visibility:3" type="jetbrains.mps.baseLanguage.structure.PublicVisibility:3" id="263434549788685387" />
      <node role="returnType:3" type="jetbrains.mps.baseLanguage.structure.ClassifierType:3" id="263434549788685388">
        <link role="classifier:3" targetNodeId="13.~Language" resolveInfo="Language" />
      </node>
      <node role="body:3" type="jetbrains.mps.baseLanguage.structure.StatementList:3" id="263434549788685389">
        <node role="statement:3" type="jetbrains.mps.baseLanguage.structure.ReturnStatement:3" id="263434549788685390">
          <node role="expression:3" type="jetbrains.mps.baseLanguage.structure.CastExpression:3" id="263434549788685391">
            <node role="expression:3" type="jetbrains.mps.baseLanguage.structure.DotExpression:3" id="263434549788685392">
              <node role="operand:3" type="jetbrains.mps.baseLanguage.structure.StaticMethodCall:3" id="263434549788685393">
                <link role="classConcept:3" targetNodeId="13.~MPSModuleRepository" resolveInfo="MPSModuleRepository" />
                <link role="baseMethodDeclaration:3" targetNodeId="13.~MPSModuleRepository.getInstance():jetbrains.mps.smodel.MPSModuleRepository" resolveInfo="getInstance" />
              </node>
              <node role="operation:3" type="jetbrains.mps.baseLanguage.structure.InstanceMethodCallOperation:3" id="263434549788685394">
                <link role="baseMethodDeclaration:3" targetNodeId="13.~MPSModuleRepository.getModule(jetbrains.mps.project.structure.modules.ModuleReference):jetbrains.mps.project.IModule" resolveInfo="getModule" />
                <node role="actualArgument:3" type="jetbrains.mps.baseLanguage.structure.LocalStaticFieldReference:3" id="263434549788685402">
                  <link role="variableDeclaration:3" targetNodeId="263434549788685398" resolveInfo="GENERATOR_PARAMETERS" />
                </node>
              </node>
            </node>
            <node role="type:3" type="jetbrains.mps.baseLanguage.structure.ClassifierType:3" id="263434549788685396">
              <link role="classifier:3" targetNodeId="13.~Language" resolveInfo="Language" />
            </node>
          </node>
        </node>
  ...
  <node type="jetbrains.mps.baseLanguage.structure.ClassConcept:3" id="2274990519051114059">
          ...
          <node role="expression:3" type="jetbrains.mps.baseLanguage.structure.DotExpression:3" id="8339862546319981389">
            <node role="operand:3" type="jetbrains.mps.baseLanguage.structure.DotExpression:3" id="8339862546319979465">
              ...
              <node role="operation:3" type="jetbrains.mps.baseLanguage.structure.InstanceMethodCallOperation:3" id="8339862546319981388">
                <link role="baseMethodDeclaration:3" targetNodeId="13.~SNode.getConceptFqName():java.lang.String" resolveInfo="getConceptFqName" />
              </node>
            </node>
            <node role="operation:3" type="jetbrains.mps.baseLanguage.structure.InstanceMethodCallOperation:3" id="8339862546319981393">
              <link role="baseMethodDeclaration:3" targetNodeId="14.~String.equals(java.lang.Object):boolean" resolveInfo="equals" />
    ...
    <node role="staticMethod:3" type="jetbrains.mps.baseLanguage.structure.StaticMethodDeclaration:3" id="2773260032861973346">
      <property name="name:3" value="getLinkDeclaration_IsSingular" />
      <node role="returnType:3" type="jetbrains.mps.baseLanguage.structure.BooleanType:3" id="2773260032861991487" />
      <node role="visibility:3" type="jetbrains.mps.baseLanguage.structure.PublicVisibility:3" id="2773260032861973348" />
      <node role="body:3" type="jetbrains.mps.baseLanguage.structure.StatementList:3" id="2773260032861973349">
        <node role="statement:3" type="jetbrains.mps.baseLanguage.structure.ExpressionStatement:3" id="2773260032861973892">
          <node role="expression:3" type="jetbrains.mps.baseLanguage.structure.DotExpression:3" id="2773260032861973894">
            <node role="operand:3" type="jetbrains.mps.baseLanguage.structure.ParameterReference:3" id="2773260032861973893">
              <link role="variableDeclaration:3" targetNodeId="2773260032861973890" resolveInfo="link" />
            </node>
            <node role="operation:3" type="jetbrains.mps.lang.smodel.structure.Node_ConceptMethodCall:16" id="2773260032861973898">
              <property name="directCall:16" value="true" />
              <link role="baseMethodDeclaration:16" targetNodeId="3v.1213877254557" resolveInfo="isSingular" />
            </node>
          </node>
        </node>
      </node>
      <node role="parameter:3" type="jetbrains.mps.baseLanguage.structure.ParameterDeclaration:3" id="2773260032861973890">
        <property name="name:3" value="link" />
        <node role="type:3" type="jetbrains.mps.lang.smodel.structure.SNodeType:16" id="2773260032861973891">
          <link role="concept:16" targetNodeId="6.1071489288298:0" resolveInfo="LinkDeclaration" />
        </node>
      </node>
    </node>
            ...
            <node role="statementList:3" type="jetbrains.mps.baseLanguage.structure.StatementList:3" id="4554834459336353940">
              <node role="statement:3" type="jetbrains.mps.baseLanguage.structure.ReturnStatement:3" id="4554834459336353949">
                <node role="expression:3" type="jetbrains.mps.baseLanguage.structure.StaticFieldReference:3" id="4554834459336353959">
                  <link role="classifier:3" targetNodeId="14.~Boolean" resolveInfo="Boolean" />
                  <link role="variableDeclaration:3" targetNodeId="14.~Boolean.TRUE" resolveInfo="TRUE" />
                </node>
              </node>
            </node>
          </node>
