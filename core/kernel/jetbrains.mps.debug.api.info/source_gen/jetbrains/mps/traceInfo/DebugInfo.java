...
public class DebugInfo {
  ...
  private DebugInfoRoot getOrCreateDebugInfoRoot(SNode rootNode) {
    SNodeReference ref = rootNode.getReference();
  ...
  public DebugInfoRoot getRootInfo(@Nullable SNode root) {
    return MapSequence.fromMap(myRoots).get(root.getReference());
  }
  ...
  public TraceablePositionInfo getPositionForNode(String nodeId) {
    ...
    for (TraceablePositionInfo element : Sequence.fromIterable(MapSequence.fromMap(myRoots).values()).translate(new ITranslator2<DebugInfoRoot, TraceablePositionInfo>() {
      ...
      if (eq_exfyrk_a0a0b0m(element.getNodeId(), nodeId)) {
        return element;
      }
    }
    return null;
  ...
  public TraceablePositionInfo getPositionForNode(final SNode node) {
    // used in mbeddr 
    DebugInfoRoot root = MapSequence.fromMap(myRoots).get(SNodeOperations.getContainingRoot(node).getReference());
    if (root == null) {
      return null;
    }
  ...
  public Set<TraceablePositionInfo> getPositions(final SNodeReference rootRef) {
    ...
    return SetSequence.fromSetWithValues(new HashSet<TraceablePositionInfo>(), SetSequence.fromSet(MapSequence.fromMap(myRoots).keySet()).where(new IWhereFilter<SNodeReference>() {
      public boolean accept(SNodeReference it) {
        return eq_exfyrk_a0a0a0a0a0b0b0o(it, rootRef);
      }
  ...
  public Set<TraceablePositionInfo> getPositions(SNode rootNode) {
    ...
    DebugInfoRoot root = MapSequence.fromMap(myRoots).get(rootNode.getReference());
    if (root == null) {
  ...
  public List<UnitPositionInfo> getUnitsForNode(SNode node) {
    final SNodeReference ref = node.getReference();
    final DebugInfoRoot debugInfoRoot = MapSequence.fromMap(myRoots).get(SNodeOperations.getContainingRoot(node).getReference());
    if (debugInfoRoot != null) {
      return SetSequence.fromSet(debugInfoRoot.getUnitPositions()).sort(new ISelector<UnitPositionInfo, Integer>() {
        ...
        public boolean accept(UnitPositionInfo it) {
          return eq_exfyrk_a0a0a0a0a0a0a2a61(new SNodePointer(debugInfoRoot.getNodeRef().getModelReference().toString(), it.getNodeId()), ref);
        }
      }).toListSequence();
    }
    ...
    if (myRoots != null) {
      Iterable<SNodeReference> sorted = SetSequence.fromSet(MapSequence.fromMap(myRoots).keySet()).sort(new ISelector<SNodeReference, String>() {
        public String select(SNodeReference it) {
          return it.getModelReference().getModelName();
        }
      }, true);
  ...
  public static DebugInfo fromXml(Element root, SModelDescriptor descriptor) {
    ...
    try {
      ...
      for (Element re : ((List<Element>) root.getChildren(DebugInfo.ROOT))) {
        ...
        SNodePointer rootRef = SNodePointer.deserialize(rootId);
  ...
  public static SNodePointer nodePointerFrom(@NotNull Tuples._2<String, String> tuple) {
    if (isEmpty_exfyrk_a0a0a62_0(tuple._0()) || isEmpty_exfyrk_a0a0a62(tuple._1())) {
      return null;
    }
    return new SNodePointer(SModelReference.fromString(tuple._1()), SNodeId.fromString(tuple._0()));
  }

  private static boolean eq_exfyrk_a0a0b0m(Object a, Object b) {
    return (a != null ?
      a.equals(b) :
      a == b
    );
  ...
  private static boolean eq_exfyrk_a0a0a0a0a0b0b0o(Object a, Object b) {
    return (a != null ?
      a.equals(b) :
      a == b
    );
  ...
  private static boolean eq_exfyrk_a0a0a0a0a0a0a2a61(Object a, Object b) {
    return (a != null ?
      a.equals(b) :
      a == b
    );
  ...
  public static boolean isEmpty_exfyrk_a0a0a62(String str) {
    return str == null || str.length() == 0;
  }

  public static boolean isEmpty_exfyrk_a0a0a62_0(String str) {
    return str == null || str.length() == 0;
  }
}
