...
public class HistoryReaderHandler extends XMLSAXHandler<List<StructureModification>> {
  ...
  private List<StructureModification> myResult;
  private ReadHelper fieldhelper;

  public HistoryReaderHandler() {
  }

  public List<StructureModification> getResult() {
    return myResult;
  }
  ...
  public void endElement(String uri, String localName, String qName) throws SAXException {
    ...
    if (current != null) {
      ...
      if (myHandlersStack.empty()) {
        myResult = (List<StructureModification>) childValue;
      } else {
  ...
  public class historyElementHandler extends HistoryReaderHandler.ElementHandler {
    ...
    @Override
    protected List<StructureModification> createObject(Attributes attrs) {
      return ListSequence.fromList(new ArrayList<StructureModification>());
    }
    ...
    @Override
    protected void handleChild(Object resultObject, String tagName, Object value) throws SAXException {
      List<StructureModification> result = (List<StructureModification>) resultObject;
      if ("StructureModification".equals(tagName)) {
