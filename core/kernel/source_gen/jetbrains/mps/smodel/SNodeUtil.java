...
public class SNodeUtil {
  ...
  public static String getDetailedPresentation(SNode node) {
    return ((String) BehaviorManager.getInstance().invoke(Object.class, node, "virtual_getDetailedPresentation_2354269628709769373", new Class[]{SNode.class}));
  }

  public static boolean isDefaultSubstitutable(SNode node) {
    return ((Boolean) BehaviorManager.getInstance().invoke(Boolean.class, node, "call_isDefaultSubstitutable_7429110134803670673", new Class[]{SNode.class}));
  }

  public static List<SNode> findAllAspects(SNode node) {
    return ((List<SNode>) BehaviorManager.getInstance().invoke(Object.class, node, "call_findAllAspects_7754459869734028917", new Class[]{SNode.class}));
  }

  public static int getMetaLevel(SNode node) {
    return ((Integer) BehaviorManager.getInstance().invoke(Integer.class, node, "virtual_getMetaLevel_3981318653438234726", new Class[]{SNode.class}));
  }
  ...
  public static boolean isInstanceOfConceptDeclaration(SNode node) {
    ...
    return node.getConcept().getId().equals("jetbrains.mps.lang.structure.structure.ConceptDeclaration");
  }
  ...
  public static boolean isInstanceOfInterfaceConceptDeclaration(SNode node) {
    ...
    return node.getConcept().getId().equals("jetbrains.mps.lang.structure.structure.InterfaceConceptDeclaration");
  }
  ...
  public static boolean getLinkDeclaration_IsSingular(SNode link) {
    return ((Boolean) BehaviorManager.getInstance().invoke(Boolean.class, link, "call_isSingular_1213877254557", new Class[]{SNode.class}));
  }
