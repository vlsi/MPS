...
public class SNodeUtil {
  ...
  public static final SAbstractConcept concept_IResolveInfo = MetaAdapterFactory.getInterfaceConcept(new UUID(-3554657779850784990l, -7236703803128771572l), 1196978630214l, "jetbrains.mps.lang.core.structure.IResolveInfo");
  public static final String conceptName_INamedConcept = "jetbrains.mps.lang.core.structure.INamedConcept";
  public static final SAbstractConcept concept_INamedConcept = MetaAdapterFactory.getInterfaceConcept(new UUID(-3554657779850784990l, -7236703803128771572l), 1169194658468l, "jetbrains.mps.lang.core.structure.INamedConcept");
  public static final String conceptName_BaseConcept = "jetbrains.mps.lang.core.structure.BaseConcept";
  public static final SAbstractConcept concept_BaseConcept = MetaAdapterFactory.getConcept(new UUID(-3554657779850784990l, -7236703803128771572l), 1133920641626l, "jetbrains.mps.lang.core.structure.BaseConcept");
  ...
  public static final SAbstractConcept concept_AbstractConceptDeclaration = MetaAdapterFactory.getConcept(new UUID(-4094437568663370681l, -8968368868337559369l), 1169125787135l, "jetbrains.mps.lang.structure.structure.AbstractConceptDeclaration");
  public static final String conceptName_ConceptDeclaration = "jetbrains.mps.lang.structure.structure.ConceptDeclaration";
  public static final SAbstractConcept concept_ConceptDeclaration = MetaAdapterFactory.getConcept(new UUID(-4094437568663370681l, -8968368868337559369l), 1071489090640l, "jetbrains.mps.lang.structure.structure.ConceptDeclaration");
  ...
  public static final SAbstractConcept concept_InterfaceConceptDeclaration = MetaAdapterFactory.getConcept(new UUID(-4094437568663370681l, -8968368868337559369l), 1169125989551l, "jetbrains.mps.lang.structure.structure.InterfaceConceptDeclaration");
  public static final String conceptName_LinkDeclaration = "jetbrains.mps.lang.structure.structure.LinkDeclaration";
  public static final SAbstractConcept concept_LinkDeclaration = MetaAdapterFactory.getConcept(new UUID(-4094437568663370681l, -8968368868337559369l), 1071489288298l, "jetbrains.mps.lang.structure.structure.LinkDeclaration");
  public static final String conceptName_InterfacePart = "jetbrains.mps.lang.core.structure.InterfacePart";
  public static final SAbstractConcept concept_InterfacePart = MetaAdapterFactory.getInterfaceConcept(new UUID(-3554657779850784990l, -7236703803128771572l), 1319728274784973096l, "jetbrains.mps.lang.core.structure.InterfacePart");
  public static final String conceptName_ImplementationPart = "jetbrains.mps.lang.core.structure.ImplementationPart";
  public static final SAbstractConcept concept_ImplementationPart = MetaAdapterFactory.getInterfaceConcept(new UUID(-3554657779850784990l, -7236703803128771572l), 1319728274783077719l, "jetbrains.mps.lang.core.structure.ImplementationPart");
  ...
  public static final SAbstractConcept concept_ImplementationWithStubPart = MetaAdapterFactory.getInterfaceConcept(new UUID(-3554657779850784990l, -7236703803128771572l), 6999738288738427190l, "jetbrains.mps.lang.core.structure.ImplementationWithStubPart");
  public static final SAbstractConcept concept_RuntimeTypeVariable = MetaAdapterFactory.getConcept(new UUID(8817443762339858024l, -6091446231697526094l), 1185281562363l, "jetbrains.mps.lang.typesystem.structure.RuntimeTypeVariable");
