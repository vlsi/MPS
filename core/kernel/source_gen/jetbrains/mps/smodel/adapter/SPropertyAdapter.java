...
public class SPropertyAdapter implements SProperty {
  private SProperty myPropertyId;
  ...
  public SPropertyAdapter(SProperty propertyId) {
    this.myPropertyId = propertyId;
  }

  @Override
  public SProperty getId() {
    fillBothIds();
    return myPropertyId;
  }
  @Override
  ...
  public boolean fillBothIds() {
    ...
    if (myPropertyId == null) {
      ...
      myPropertyId = new SProperty(cid, IdHelper.getNodeId((jetbrains.mps.smodel.SNode) propNode));
    } else {
