...
public abstract class SBaseAbstractConceptAdapter implements SAbstractConcept {
  protected String myFqName;

  protected SBaseAbstractConceptAdapter(String fqName) {
    myFqName = fqName;
  }

  public abstract boolean isSameConcept(SBaseAbstractConceptAdapter c);
