...
public class SContainmentLinkAdapter extends SAbstractLinkAdapter implements SContainmentLink {
  protected SContainmentLink111 myRoleId;

  public SContainmentLinkAdapter(String conceptName, String role) {
    super(conceptName, role);
  }

  public SContainmentLinkAdapter(SContainmentLink111 roleId) {
    super(null, null);
    myRoleId = roleId;
  }
  ...
  public boolean fillBothIds() {
    ...
    if (myRoleId == null) {
      ...
      myRoleId = new SContainmentLink111(cid, IdHelper.getNodeId((jetbrains.mps.smodel.SNode) linkNode));
    } else {
