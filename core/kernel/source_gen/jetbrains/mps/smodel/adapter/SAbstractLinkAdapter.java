...
public abstract class SAbstractLinkAdapter implements SAbstractLink {
  ...
  public SAbstractConcept getTargetConcept() {
    ...
    SInterfaceConceptAdapter res = LangUtil.getConceptId(t)!=null?new SInterfaceConceptAdapter(LangUtil.getConceptId(t)):new SInterfaceConceptAdapter(NameUtil.nodeFQName(t));
    return (SNodeOperations.isInstanceOf(t, "jetbrains.mps.lang.structure.structure.InterfaceConceptDeclaration") ? res : SConceptRepository.getInstance().getConcept(NameUtil.nodeFQName(t)));
  }
