...
public class StubRefUtil {
  ...
  public static void replaceReference(SNode oldNode, SReference reference) {
    ...
    oldNode.addReference(new StaticReference(reference.getRole(), oldNode, reference.getTargetSModelReference(), reference.getTargetNodeId(), reference.getResolveInfo()));
