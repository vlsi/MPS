...
public class SNodeOperations {
  ...
  public static boolean isUnknown(SNode node) {
    // sNode.getConcept() might be a non-null value for illegal concept, make sure the concept is known 
    SAbstractConcept c = SConceptRepository.getInstance().getConcept(node.getConcept().getQualifiedName());
