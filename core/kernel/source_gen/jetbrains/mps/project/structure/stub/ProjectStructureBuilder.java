...
public class ProjectStructureBuilder {
  ...
  public SNode convertLanguage() {
    ...
    SNode result = SModelOperations.createNewNode(myModel, new SNodeId.Foreign("~root"), SNodeOperations.asInstanceConcept(MetaAdapterFactory.getConcept(0x86ef829012bb4ca7L, 0x947f093788f263a9L, 0x5869770da61dfe1fL, "jetbrains.mps.lang.project.structure.Language")));
    fillModule(result);
  ...
  private SNode convertSolution() {
    ...
    SNode result = SModelOperations.createNewNode(myModel, new SNodeId.Foreign("~root"), SNodeOperations.asInstanceConcept(MetaAdapterFactory.getConcept(0x86ef829012bb4ca7L, 0x947f093788f263a9L, 0x5869770da61dfe20L, "jetbrains.mps.lang.project.structure.Solution")));
    fillModule(result);
  ...
  private SNode convertDevkit() {
    ...
    SNode result = SModelOperations.createNewNode(myModel, new SNodeId.Foreign("~root"), SNodeOperations.asInstanceConcept(MetaAdapterFactory.getConcept(0x86ef829012bb4ca7L, 0x947f093788f263a9L, 0x5869770da61dfe2fL, "jetbrains.mps.lang.project.structure.DevKit")));
    fillModule(result);
  ...
  private SNode convert(SModelReference source) {
    SNode result = SModelOperations.createNewNode(myModel, null, SNodeOperations.asInstanceConcept(MetaAdapterFactory.getConcept(0x86ef829012bb4ca7L, 0x947f093788f263a9L, 0x5869770da61dfe27L, "jetbrains.mps.lang.project.structure.ModelReference")));
  ...
  private void fillModule(SNode module) {
    ...
    for (String path : mySource.getAdditionalJavaStubPaths()) {
      SNode node = SModelOperations.createNewNode(myModel, null, SNodeOperations.asInstanceConcept(MetaAdapterFactory.getConcept(0x86ef829012bb4ca7L, 0x947f093788f263a9L, 0x19bfb4173fb52422L, "jetbrains.mps.lang.project.structure.StubEntry")));
  ...
  private SNode convert(ModelRootDescriptor source) {
    SNode result = SModelOperations.createNewNode(myModel, null, SNodeOperations.asInstanceConcept(MetaAdapterFactory.getConcept(0x86ef829012bb4ca7L, 0x947f093788f263a9L, 0x19bfb4173fb52426L, "jetbrains.mps.lang.project.structure.ModelRoot")));
  ...
  private SNode convertSourcePath(String s) {
    SNode result = SModelOperations.createNewNode(myModel, null, SNodeOperations.asInstanceConcept(MetaAdapterFactory.getConcept(0x86ef829012bb4ca7L, 0x947f093788f263a9L, 0x3be012d639dffb7L, "jetbrains.mps.lang.project.structure.SourcePath")));
  ...
  private SNode convert(Dependency source) {
    SNode dep = SModelOperations.createNewNode(myModel, null, SNodeOperations.asInstanceConcept(MetaAdapterFactory.getConcept(0x86ef829012bb4ca7L, 0x947f093788f263a9L, 0x5869770da61dfe28L, "jetbrains.mps.lang.project.structure.ModuleDependency")));
  ...
  public SNode convertGenerator() {
    ...
    SNode generator = SModelOperations.createNewNode(myModel, null, SNodeOperations.asInstanceConcept(MetaAdapterFactory.getConcept(0x86ef829012bb4ca7L, 0x947f093788f263a9L, 0x5869770da61dfe21L, "jetbrains.mps.lang.project.structure.Generator")));
  ...
  private SNode convert(SModuleReference ref) {
    ...
    SNode result = SModelOperations.createNewNode(myModel, null, SNodeOperations.asInstanceConcept(MetaAdapterFactory.getConcept(0x86ef829012bb4ca7L, 0x947f093788f263a9L, 0x19bfb4173fb5210cL, "jetbrains.mps.lang.project.structure.ModuleReference")));
  ...
  private SNode convert(MappingConfig_AbstractRef source) {
    if (source instanceof MappingConfig_RefAllGlobal) {
      return SModelOperations.createNewNode(myModel, null, SNodeOperations.asInstanceConcept(MetaAdapterFactory.getConcept(0x86ef829012bb4ca7L, 0x947f093788f263a9L, 0x25c3f2845954f70fL, "jetbrains.mps.lang.project.structure.MappingConfigRefAllGlobal")));
    } else if (source instanceof MappingConfig_RefAllLocal) {
      return SModelOperations.createNewNode(myModel, null, SNodeOperations.asInstanceConcept(MetaAdapterFactory.getConcept(0x86ef829012bb4ca7L, 0x947f093788f263a9L, 0x25c3f284595702d4L, "jetbrains.mps.lang.project.structure.MappingConfigRefAllLocal")));
    } else if (source instanceof MappingConfig_RefSet) {
      SNode result = SModelOperations.createNewNode(myModel, null, SNodeOperations.asInstanceConcept(MetaAdapterFactory.getConcept(0x86ef829012bb4ca7L, 0x947f093788f263a9L, 0x25c3f2845957030bL, "jetbrains.mps.lang.project.structure.MappingConfigRefSet")));
      ...
      SNode result = SModelOperations.createNewNode(myModel, null, SNodeOperations.asInstanceConcept(MetaAdapterFactory.getConcept(0x86ef829012bb4ca7L, 0x947f093788f263a9L, 0x25c3f284595727e1L, "jetbrains.mps.lang.project.structure.MappingConfigExternalRef")));
      ...
      SNode result = SModelOperations.createNewNode(myModel, null, SNodeOperations.asInstanceConcept(MetaAdapterFactory.getConcept(0x86ef829012bb4ca7L, 0x947f093788f263a9L, 0x25c3f28459572777L, "jetbrains.mps.lang.project.structure.MappingConfigNormalRef")));
