...
public abstract class ProjectStructureBuilder {
  ...
  private void fill(SNode module, ModuleDescriptor source) {
    ...
    for (jetbrains.mps.project.structure.model.ModelRoot root : source.getModelRoots()) {
  ...
  private SNode convert(jetbrains.mps.project.structure.model.ModelRoot source) {
