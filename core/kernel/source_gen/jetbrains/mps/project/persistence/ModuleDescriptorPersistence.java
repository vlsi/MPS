...
public class ModuleDescriptorPersistence {
  ...
  public static List<jetbrains.mps.project.structure.model.ModelRoot> loadModelRoots(List<Element> modelRootElements, final IFile file, final Macros macros) {
    return ListSequence.fromList(modelRootElements).<jetbrains.mps.project.structure.model.ModelRoot>select(new ISelector<Element, jetbrains.mps.project.structure.model.ModelRoot>() {
      public jetbrains.mps.project.structure.model.ModelRoot select(Element mre) {
        return loadModelRoot(mre, file, macros);
      }
    }).toListSequence();
  }

  private static jetbrains.mps.project.structure.model.ModelRoot loadModelRoot(final Element modelRootElement, final IFile file, final Macros macros) {
    return new _FunctionTypes._return_P0_E0<jetbrains.mps.project.structure.model.ModelRoot>() {
      public jetbrains.mps.project.structure.model.ModelRoot invoke() {
        final jetbrains.mps.project.structure.model.ModelRoot result_dxyzb6_a0a0a5 = new jetbrains.mps.project.structure.model.ModelRoot();
  ...
  public static void saveModelRoots(Element modelsElement, List<jetbrains.mps.project.structure.model.ModelRoot> modelRoots, IFile file, Macros macros) {
    Element result_dxyzb6_a0a8 = modelsElement;
    for (jetbrains.mps.project.structure.model.ModelRoot root : ListSequence.fromList(modelRoots)) {
