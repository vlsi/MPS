...
public class RemoteDebugProcessHandler extends ProcessHandler {
  ...
  public void startNotify() {
    ...
    final DebugSession session = debugManager.getDebugSession(this);
  ...
  protected void destroyProcessImpl() {
    DebugSession debugProcess = DebugManagerComponent.getInstance(myProject).getDebugSession(this);
