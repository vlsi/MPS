...
public class WatchableCreator_watchable_ReferentConstraint extends BaseNodeReferenceSearchScopeProvider implements IModelConstraints {
  public WatchableCreator_watchable_ReferentConstraint() {
  }

  public void registerSelf(ModelConstraintsManager manager) {
    manager.registerNodeReferentSearchScopeProvider("jetbrains.mps.debug.customViewers.structure.WatchableCreator", "watchable", this);
  }

  public void unRegisterSelf(ModelConstraintsManager manager) {
    manager.unRegisterNodeReferentSearchScopeProvider("jetbrains.mps.debug.customViewers.structure.WatchableCreator", "watchable");
  }
