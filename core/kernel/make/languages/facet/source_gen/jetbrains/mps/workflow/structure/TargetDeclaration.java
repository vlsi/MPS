...
public class TargetDeclaration extends BaseConcept implements INamedConcept {
  public static final String concept = "jetbrains.mps.workflow.structure.TargetDeclaration";
  ...
  public static TargetDeclaration newInstance(SModel sm, boolean init) {
    return (TargetDeclaration) SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.workflow.structure.TargetDeclaration", sm, GlobalScope.getInstance(), init).getAdapter();
  }
