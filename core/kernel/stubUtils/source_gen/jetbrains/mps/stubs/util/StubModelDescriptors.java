...
public abstract class StubModelDescriptors {
  ...
  public StubModelDescriptors(String stereotype, ModelRoot mr, SModule module) {
    this(stereotype, Sequence.<ModelRoot>singleton(mr), module);
  }

  public StubModelDescriptors(String stereotype, Iterable<ModelRoot> roots, SModule module) {
  ...
  public abstract StubModelDataSource createStubsSource(SModuleReference origin, ModelRoot root);
