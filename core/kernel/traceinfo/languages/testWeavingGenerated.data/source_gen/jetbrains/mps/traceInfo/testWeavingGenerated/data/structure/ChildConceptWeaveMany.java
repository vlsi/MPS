...
public class ChildConceptWeaveMany extends BaseConcept implements INamedConcept {
  public static final String concept = "jetbrains.mps.traceInfo.testWeavingGenerated.data.structure.ChildConceptWeaveMany";
  ...
  public static ChildConceptWeaveMany newInstance(SModel sm, boolean init) {
    return (ChildConceptWeaveMany) SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.traceInfo.testWeavingGenerated.data.structure.ChildConceptWeaveMany", sm, GlobalScope.getInstance(), init).getAdapter();
  }
