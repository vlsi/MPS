...
public class ChildConceptWeaveEachMany extends BaseConcept implements INamedConcept {
  public static final String concept = "jetbrains.mps.traceInfo.testWeavingInterpreted.data.structure.ChildConceptWeaveEachMany";
  ...
  public static ChildConceptWeaveEachMany newInstance(SModel sm, boolean init) {
    return (ChildConceptWeaveEachMany) SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.traceInfo.testWeavingInterpreted.data.structure.ChildConceptWeaveEachMany", sm, GlobalScope.getInstance(), init).getAdapter();
  }
