...
public class ChildConceptWeave extends BaseConcept implements INamedConcept {
  public static final String concept = "jetbrains.mps.traceInfo.testWeavingInterpreted.data.structure.ChildConceptWeave";
  ...
  public static ChildConceptWeave newInstance(SModel sm, boolean init) {
    return (ChildConceptWeave) SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.traceInfo.testWeavingInterpreted.data.structure.ChildConceptWeave", sm, GlobalScope.getInstance(), init).getAdapter();
  }
