...
public class RootConcept extends BaseConcept implements INamedConcept {
  public static final String concept = "jetbrains.mps.traceInfo.testWeavingInterpreted.data.structure.RootConcept";
  ...
  public static RootConcept newInstance(SModel sm, boolean init) {
    return (RootConcept) SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.traceInfo.testWeavingInterpreted.data.structure.RootConcept", sm, GlobalScope.getInstance(), init).getAdapter();
  }
