...
public class Mappingmain implements TemplateMappingConfiguration {
  private static SNodePointer reductionRule_417xrn_a0a2a = new SNodePointer("r:75f95d80-1d60-4222-8b1e-a09f089fee3e(jetbrains.mps.traceInfo.tracemacro.testlang.generator.template.main@generator)", "7980748436587788165");
  private static SNodePointer conseq_417xrn_a0a0a4a = new SNodePointer("r:75f95d80-1d60-4222-8b1e-a09f089fee3e(jetbrains.mps.traceInfo.tracemacro.testlang.generator.template.main@generator)", "7980748436587788169");
  private static SNodePointer templateNode_417xrn_a0a0a2a4a = new SNodePointer("r:75f95d80-1d60-4222-8b1e-a09f089fee3e(jetbrains.mps.traceInfo.tracemacro.testlang.generator.template.main@generator)", "7980748436587788171");
  private static SNodePointer copySrcMacro_417xrn_a0a0a1a3a2a4a = new SNodePointer("r:75f95d80-1d60-4222-8b1e-a09f089fee3e(jetbrains.mps.traceInfo.tracemacro.testlang.generator.template.main@generator)", "7980748436587788177");
  private static SNodePointer copySrcMacro_417xrn_a0a0a1a4a2a4a = new SNodePointer("r:75f95d80-1d60-4222-8b1e-a09f089fee3e(jetbrains.mps.traceInfo.tracemacro.testlang.generator.template.main@generator)", "7980748436587788198");
  private static SNodePointer traceMacro_417xrn_a0a0a1a5a2a4a = new SNodePointer("r:75f95d80-1d60-4222-8b1e-a09f089fee3e(jetbrains.mps.traceInfo.tracemacro.testlang.generator.template.main@generator)", "7980748436587793692");
  private static SNodePointer templateNode_417xrn_a0a0a5a1a5a2a4a = new SNodePointer("r:75f95d80-1d60-4222-8b1e-a09f089fee3e(jetbrains.mps.traceInfo.tracemacro.testlang.generator.template.main@generator)", "7980748436587793601");
  private static SNodePointer propertyMacro_417xrn_c0b0b0a2a5a1a5a2a4a = new SNodePointer("r:75f95d80-1d60-4222-8b1e-a09f089fee3e(jetbrains.mps.traceInfo.tracemacro.testlang.generator.template.main@generator)", "7980748436587793602");
  private static SNodePointer reductionRule_417xrn_a0a2b = new SNodePointer("r:75f95d80-1d60-4222-8b1e-a09f089fee3e(jetbrains.mps.traceInfo.tracemacro.testlang.generator.template.main@generator)", "7980748436587793686");
    ...
    private Collection<SNode> apply(final TemplateContext context, final TemplateExecutionEnvironment environment) throws GenerationException {
      ...
      try {
...

        {
          ...
          try {
            environment.getTracer().pushMacro(copySrcMacro_417xrn_a0a0a1a3a2a4a);
            final SNode copySrcInput2 = QueriesGenerated.sourceNodeQuery_7980748436587788180(environment.getOperationContext(), new SourceSubstituteMacroNodeContext(context.getInput(), copySrcMacro_417xrn_a0a0a1a3a2a4a, context, environment.getGenerator()));
            tlist2 = environment.copyNodes(TemplateUtil.singletonList(copySrcInput2), copySrcMacro_417xrn_a0a0a1a3a2a4a, "tpl/r:75f95d80-1d60-4222-8b1e-a09f089fee3e/7980748436587788173", null, context);
          } finally {
            environment.getTracer().closeMacro(copySrcMacro_417xrn_a0a0a1a3a2a4a);
          }
        ...
        }
        {
          ...
          try {
            ...
            final SNode copySrcInput4 = QueriesGenerated.sourceNodeQuery_7980748436587788201(environment.getOperationContext(), new SourceSubstituteMacroNodeContext(context.getInput(), copySrcMacro_417xrn_a0a0a1a4a2a4a, context, environment.getGenerator()));
            tlist4 = environment.copyNodes(TemplateUtil.singletonList(copySrcInput4), copySrcMacro_417xrn_a0a0a1a4a2a4a, "tpl/r:75f95d80-1d60-4222-8b1e-a09f089fee3e/7980748436587788174", null, context);
          } finally {
        ...
        }
        {
          ...
          try {
            environment.getTracer().pushMacro(traceMacro_417xrn_a0a0a1a5a2a4a);
            // calculate input 
  ...
  public class ReductionRule1 implements TemplateReductionRule {
    ...
    public Collection<SNode> tryToApply(final TemplateExecutionEnvironment environment, final TemplateContext context) throws GenerationException {
      if (!(QueriesGenerated.baseMappingRule_Condition_7980748436587793846(environment.getOperationContext(), new BaseMappingRuleContext(context.getInput(), reductionRule_417xrn_a0a2b, environment.getGenerator())))) {
        return null;
      }
