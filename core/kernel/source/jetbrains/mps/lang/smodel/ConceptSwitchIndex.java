...
/**
 * Effective translation from {@link org.jetbrains.mps.openapi.language.SAbstractConcept SConcept} to integer value.
...
public final class ConceptSwitchIndex {
   ...
   */
  public int index(@Nullable SAbstractConcept c) {
    if (c == null) {
      return -1;
    }
