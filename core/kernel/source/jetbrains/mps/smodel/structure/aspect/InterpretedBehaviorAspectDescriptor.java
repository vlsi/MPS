...
public class InterpretedBehaviorAspectDescriptor extends BehaviorAspectDescriptor {
  ...
  private static final DescriptorProvider<BehaviorDescriptor> BEHAVIOR_PROVIDER = MixedDescriptorProvider.of(COMPILED_BEHAVIOR, INTERPRETED_BEHAVIOR);

  private final Language language;

  public InterpretedBehaviorAspectDescriptor(Language language) {
  ...
  private class InterpretedDescriptorInitializer extends DescriptorInitializer {
    ...
    @Override
    public BehaviorDescriptor initDescriptor() {
      return BEHAVIOR_PROVIDER.getDescriptor(fqName);
    }
  }
}
