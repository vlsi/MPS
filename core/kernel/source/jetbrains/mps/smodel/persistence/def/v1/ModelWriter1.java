...
public class ModelWriter1 implements IModelWriter {
  ...
  protected SModelReference upgradeModelUID(SModelReference modelReference) {
  ...
  public Document saveModel(SModel sourceModel) {
    ...
    Iterator<ImportElement> imports = sourceModel.importedModels().iterator();
    ...
    Iterator<SNode> iterator = sourceModel.rootsIterator();
