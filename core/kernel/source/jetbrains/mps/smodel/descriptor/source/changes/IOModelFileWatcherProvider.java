...
public class IOModelFileWatcherProvider implements ModelFileWatcherProvider {
  public void startListening(FileBasedModelDataSource source, Collection<String> files) {

  }

  public void stopListening(FileBasedModelDataSource source, Collection<String> remove) {
