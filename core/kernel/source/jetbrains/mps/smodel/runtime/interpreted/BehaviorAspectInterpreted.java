...
public class BehaviorAspectInterpreted implements BehaviorAspectDescriptor {
  ...
  public static class InterpretedBehaviorDescriptor extends BaseBehaviorDescriptor {
    ...
    public <T> T invoke(Class<T> returnType, SNode node, String methodName, Class[] parametersTypes, Object... parameters) {
      return node == null ? defaultValue(returnType) : OldBehaviorManager.getInstance().invokeWithConceptFqName(returnType, node, fqName, methodName, parametersTypes, parameters);
    }
