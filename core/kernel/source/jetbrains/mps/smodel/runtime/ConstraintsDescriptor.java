...
public interface ConstraintsDescriptor {
  ...
  boolean canBeAncestor(@NotNull SNode node, @Nullable SNode childNode, @NotNull SAbstractConcept childConcept, IOperationContext operationContext,
  ...
  @Deprecated
  @ToRemove(version = 3.5)
  boolean canBeAncestor(SNode node, @Nullable SNode childNode, @Deprecated SNode childConcept, IOperationContext operationContext,
      @Nullable CheckingNodeContext checkingNodeContext);
