...
public class ModernTestRunner {
  ...
  public static void main(String[] args) throws ClassNotFoundException, FileNotFoundException, IOException {
    ...
    core.addListener(new ModernTestRunner.MyRunListener(out, err));
  ...
  private static class MyRunListener extends RunListener {
    ...
    public void testFinished(Description description) throws Exception {
      this.printSyncToken(ModernTestEvent.END_TEST_PREFIX, description);
    ...
    public void testStarted(Description description) throws Exception {
      printSyncToken(ModernTestEvent.START_TEST_PREFIX, description);
      super.testStarted(description);
    }

    private void printSyncToken(String tokenPrefix, Description description) {
      ModernTestEvent testEvent = new ModernTestEvent(tokenPrefix, description);
