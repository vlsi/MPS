...
public class BTestCase extends jetbrains.mps.baseLanguage.structure.ClassConcept implements jetbrains.mps.baseLanguage.unitTest.structure.ITestCase {
  ...
  public jetbrains.mps.baseLanguage.unitTest.structure.TestMethodList getTestMethodList() {
    return (jetbrains.mps.baseLanguage.unitTest.structure.TestMethodList)this.getChild(TestMethodList.class, BTestCase.TEST_METHOD_LIST);
  }

  public void setTestMethodList(jetbrains.mps.baseLanguage.unitTest.structure.TestMethodList node) {
