...
public class typeof_Message_InferenceRule extends AbstractInferenceRule_Runtime implements InferenceRule_Runtime {
  ...
  public static class QuotationClass_t8mumf_a0a0a0 {
    ...
    public SNode createNode(final TypeCheckingContext typeCheckingContext) {
      ...
      SNode quotedNode_t8mumf_a0a0a0 = null;
      {
        quotedNode_t8mumf_a0a0a0 = SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.baseLanguage.structure.StringType", TypeChecker.getInstance().getRuntimeTypesModel(), GlobalScope.getInstance(), false);
        SNode quotedNode1_t8mumf_a0a0a0 = quotedNode_t8mumf_a0a0a0;
        result = quotedNode1_t8mumf_a0a0a0;
      }
      return result;
    }
