...
public class Fail extends jetbrains.mps.baseLanguage.structure.Statement implements jetbrains.mps.baseLanguage.unitTest.structure.MessageHolder {
  ...
  public jetbrains.mps.baseLanguage.unitTest.structure.Message getMessage() {
    return (jetbrains.mps.baseLanguage.unitTest.structure.Message)this.getChild(Message.class, Fail.MESSAGE);
  }
