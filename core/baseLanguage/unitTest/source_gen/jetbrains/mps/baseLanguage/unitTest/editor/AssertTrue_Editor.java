...
public class AssertTrue_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createCollection_9112_0(EditorContext context, SNode node) {
    ...
    editorCell.addEditorCell(this.createRefNode_9112_0(context, node));
    editorCell.addEditorCell(this.createConstant_9112_1(context, node, ";"));
    return editorCell;
  }

  private EditorCell createConstant_9112_0(EditorContext context, SNode node, String text) {
  ...
  private EditorCell createConstant_9112_1(EditorContext context, SNode node, String text) {
    EditorCell_Constant editorCell = new EditorCell_Constant(context, node, text);
  ...
  private EditorCell createRefNode_9112_0(EditorContext context, SNode node) {
