...
public class JUnitConfigFromLanguageTestCases extends BaseConfigCreator<List> implements Cloneable {
  ...
  private void createConfig(final List<SNode> parameter) {
...

    {
      ...
      DefaultJUnit_Configuration _config = new DefaultJUnit_Configuration(JUnitConfigFromLanguageTestCases.this.getContext().getProject(), findFactory(configType, "jetbrains.mps.baseLanguage.unitTest.plugin.DefaultJUnit_Factory"), "NewConfig") {
        @Override
