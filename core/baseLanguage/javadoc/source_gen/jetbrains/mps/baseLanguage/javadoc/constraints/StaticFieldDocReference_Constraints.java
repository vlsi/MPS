...
public class StaticFieldDocReference_Constraints extends ConstraintsDataHolder {
      ...
      public Object createSearchScopeOrListOfNodes(final IOperationContext operationContext, final ReferentConstraintContext _context) {
        return ListSequence.fromList(SModelOperations.getNodesIncludingImported(_context.getModel(), operationContext.getScope(), "jetbrains.mps.baseLanguage.structure.StaticFieldDeclaration")).removeWhere(new IWhereFilter<SNode>() {
          public boolean accept(SNode it) {
            return SLinkOperations.getTarget(it, "visibility", true) == new StaticFieldDocReference_Constraints.QuotationClass_9aygvv_a0a0a0a0a0c0a1a0b0i().createNode();
          }
        });
      }
  ...
  public static class QuotationClass_9aygvv_a0a0a0a0a0c0a1a0b0i {
    public QuotationClass_9aygvv_a0a0a0a0a0c0a1a0b0i() {
    }
