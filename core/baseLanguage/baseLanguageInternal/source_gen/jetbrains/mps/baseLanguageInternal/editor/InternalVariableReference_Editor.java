...
public class InternalVariableReference_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createCollection_8666_0(EditorContext context, SNode node) {
    EditorCell_Collection editorCell = EditorCell_Collection.createIndent2(context, node);
    editorCell.setCellId("Collection_8666_0");
    editorCell.addEditorCell(this.createConstant_8666_0(context, node, "["));
    editorCell.addEditorCell(this.createRefNode_8666_0(context, node));
    editorCell.addEditorCell(this.createConstant_8666_1(context, node, "]"));
    editorCell.addEditorCell(this.createProperty_8666_0(context, node));
    return editorCell;
  }

  private EditorCell createConstant_8666_0(EditorContext context, SNode node, String text) {
  ...
  private EditorCell createConstant_8666_1(EditorContext context, SNode node, String text) {
    EditorCell_Constant editorCell = new EditorCell_Constant(context, node, text);
  ...
  private EditorCell createRefNode_8666_0(EditorContext context, SNode node) {
  ...
  private EditorCell createProperty_8666_0(EditorContext context, SNode node) {
