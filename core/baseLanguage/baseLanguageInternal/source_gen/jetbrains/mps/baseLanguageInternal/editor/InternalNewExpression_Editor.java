...
public class InternalNewExpression_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createCollection_svbh7s_a(EditorContext editorContext, SNode node) {
    ...
    editorCell.addEditorCell(this.createComponent_svbh7s_i0(editorContext, node));
    return editorCell;
  }
  ...
  private EditorCell createComponent_svbh7s_i0(EditorContext editorContext, SNode node) {
