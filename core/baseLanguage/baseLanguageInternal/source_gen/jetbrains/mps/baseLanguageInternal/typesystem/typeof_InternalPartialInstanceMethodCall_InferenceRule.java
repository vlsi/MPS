  ...
  public void applyRule(final SNode mc, final TypeCheckingContext typeCheckingContext) {
    {
      ...
      EquationInfo info = new EquationInfo(_nodeToCheck_1029348928467, null, "r:00000000-0000-4000-0000-011c895903ab(jetbrains.mps.baseLanguageInternal.typesystem)", "1204072569920", 0, intentionProvider);
      typeCheckingContext.createEquation((SNode)typeCheckingContext.typeOf(_nodeToCheck_1029348928467, "r:00000000-0000-4000-0000-011c895903ab(jetbrains.mps.baseLanguageInternal.typesystem)", "1204072569922", true), (SNode)SLinkOperations.getTarget(mc, "returnType", true), info);
    }
  }
