...
public class InternalVariableReference extends Expression {
  public static final String concept = "jetbrains.mps.baseLanguage.internal.structure.InternalVariableReference";
  ...
  public static InternalVariableReference newInstance(SModel sm, boolean init) {
    return (InternalVariableReference)SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.baseLanguage.internal.structure.InternalVariableReference", sm, GlobalScope.getInstance(), init).getAdapter();
  }
