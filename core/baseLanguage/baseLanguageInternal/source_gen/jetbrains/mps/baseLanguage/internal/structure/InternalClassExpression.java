...
public class InternalClassExpression extends Expression {
  public static final String concept = "jetbrains.mps.baseLanguage.internal.structure.InternalClassExpression";
  ...
  public static InternalClassExpression newInstance(SModel sm, boolean init) {
    return (InternalClassExpression)SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.baseLanguage.internal.structure.InternalClassExpression", sm, GlobalScope.getInstance(), init).getAdapter();
  }
