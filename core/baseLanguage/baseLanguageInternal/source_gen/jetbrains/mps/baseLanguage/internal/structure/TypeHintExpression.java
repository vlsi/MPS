...
public class TypeHintExpression extends Expression {
  public static final String concept = "jetbrains.mps.baseLanguage.internal.structure.TypeHintExpression";
  ...
  public static TypeHintExpression newInstance(SModel sm, boolean init) {
    return (TypeHintExpression)SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.baseLanguage.internal.structure.TypeHintExpression", sm, GlobalScope.getInstance(), init).getAdapter();
  }
