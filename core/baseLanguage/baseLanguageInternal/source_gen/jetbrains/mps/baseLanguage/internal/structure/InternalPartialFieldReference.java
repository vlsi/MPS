...
public class InternalPartialFieldReference extends Expression implements IOperation {
  public static final String concept = "jetbrains.mps.baseLanguage.internal.structure.InternalPartialFieldReference";
  ...
  public static InternalPartialFieldReference newInstance(SModel sm, boolean init) {
    return (InternalPartialFieldReference)SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.baseLanguage.internal.structure.InternalPartialFieldReference", sm, GlobalScope.getInstance(), init).getAdapter();
  }
