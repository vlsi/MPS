...
public class InternalClassifierType extends ClassifierType {
  public static final String concept = "jetbrains.mps.baseLanguage.internal.structure.InternalClassifierType";
  ...
  public static InternalClassifierType newInstance(SModel sm, boolean init) {
    return (InternalClassifierType)SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.baseLanguage.internal.structure.InternalClassifierType", sm, GlobalScope.getInstance(), init).getAdapter();
  }
