...
public class InternalNewExpression extends BaseMethodCall {
  public static final String concept = "jetbrains.mps.baseLanguage.internal.structure.InternalNewExpression";
  ...
  public static InternalNewExpression newInstance(SModel sm, boolean init) {
    return (InternalNewExpression)SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.baseLanguage.internal.structure.InternalNewExpression", sm, GlobalScope.getInstance(), init).getAdapter();
  }
