...
public class InternalStaticFieldReference extends Expression {
  public static final String concept = "jetbrains.mps.baseLanguage.internal.structure.InternalStaticFieldReference";
  ...
  public static InternalStaticFieldReference newInstance(SModel sm, boolean init) {
    return (InternalStaticFieldReference)SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.baseLanguage.internal.structure.InternalStaticFieldReference", sm, GlobalScope.getInstance(), init).getAdapter();
  }
