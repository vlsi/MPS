...
public class DateTimePropertyConfiguration extends jetbrains.mps.lang.core.structure.BaseConcept implements jetbrains.mps.lang.core.structure.INamedConcept {
  ...
  public Iterator<jetbrains.mps.baseLanguage.datesInternal.structure.DateTimePropertyFormatType> dateTimePropertyFormatTypes() {
    return this.children(DateTimePropertyFormatType.class, DateTimePropertyConfiguration.DATE_TIME_PROPERTY_FORMAT_TYPE);
  }

  public List<jetbrains.mps.baseLanguage.datesInternal.structure.DateTimePropertyFormatType> getDateTimePropertyFormatTypes() {
    return this.getChildren(DateTimePropertyFormatType.class, DateTimePropertyConfiguration.DATE_TIME_PROPERTY_FORMAT_TYPE);
  }

  public void addDateTimePropertyFormatType(jetbrains.mps.baseLanguage.datesInternal.structure.DateTimePropertyFormatType node) {
    this.addChild(DateTimePropertyConfiguration.DATE_TIME_PROPERTY_FORMAT_TYPE, node);
  }

  public void insertDateTimePropertyFormatType(jetbrains.mps.baseLanguage.datesInternal.structure.DateTimePropertyFormatType prev, jetbrains.mps.baseLanguage.datesInternal.structure.DateTimePropertyFormatType node) {
