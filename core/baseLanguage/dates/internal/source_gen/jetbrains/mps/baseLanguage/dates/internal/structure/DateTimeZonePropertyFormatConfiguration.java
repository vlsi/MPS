...
public class DateTimeZonePropertyFormatConfiguration extends DateTimePropertyConfiguration {
  public static final String concept = "jetbrains.mps.baseLanguage.dates.internal.structure.DateTimeZonePropertyFormatConfiguration";
  ...
  public static DateTimeZonePropertyFormatConfiguration newInstance(SModel sm, boolean init) {
    return (DateTimeZonePropertyFormatConfiguration)SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.baseLanguage.dates.internal.structure.DateTimeZonePropertyFormatConfiguration", sm, GlobalScope.getInstance(), init).getAdapter();
  }
