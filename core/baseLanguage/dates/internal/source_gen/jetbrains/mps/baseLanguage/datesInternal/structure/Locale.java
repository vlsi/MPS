...
public class Locale extends jetbrains.mps.lang.core.structure.BaseConcept implements jetbrains.mps.lang.core.structure.INamedConcept {
  ...
  public jetbrains.mps.baseLanguage.structure.Expression getJavaLocale() {
    return (jetbrains.mps.baseLanguage.structure.Expression)this.getChild(Expression.class, Locale.JAVA_LOCALE);
  }

  public void setJavaLocale(jetbrains.mps.baseLanguage.structure.Expression node) {
