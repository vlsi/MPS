...
public class DateTimeIntPropertyFormatConfiguration_name_PropertyConstraint implements IModelConstraints, INodePropertyGetter {
  ...
  public void registerSelf(ModelConstraintsManager manager) {
    manager.registerNodePropertyGetter("jetbrains.mps.baseLanguage.dates.internal.structure.DateTimeIntPropertyFormatConfiguration", "name", this);
  }

  public void unRegisterSelf(ModelConstraintsManager manager) {
    manager.unRegisterNodePropertyGetter("jetbrains.mps.baseLanguage.dates.internal.structure.DateTimeIntPropertyFormatConfiguration", "name");
  }
