    ...
    try {
      {
        ...
        this.add(ActionFactory.getInstance().acquireRegisteredAction(module.getClass("jetbrains.mps.baseLanguage.dates.plugin.ConvertDateTimeOperations_Action"), module.getModuleFqName(), null));
      }
    } catch (Throwable t) {
