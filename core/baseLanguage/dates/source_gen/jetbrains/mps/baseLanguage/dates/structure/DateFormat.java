...
public class DateFormat extends jetbrains.mps.lang.core.structure.BaseConcept implements jetbrains.mps.baseLanguage.datesInternal.structure.IDateFormat {
  ...
  public Iterator<jetbrains.mps.baseLanguage.dates.structure.FormatToken> tokens() {
    return this.children(FormatToken.class, DateFormat.TOKEN);
  }

  public List<jetbrains.mps.baseLanguage.dates.structure.FormatToken> getTokens() {
    return this.getChildren(FormatToken.class, DateFormat.TOKEN);
  }

  public void addToken(jetbrains.mps.baseLanguage.dates.structure.FormatToken node) {
    this.addChild(DateFormat.TOKEN, node);
  }

  public void insertToken(jetbrains.mps.baseLanguage.dates.structure.FormatToken prev, jetbrains.mps.baseLanguage.dates.structure.FormatToken node) {
