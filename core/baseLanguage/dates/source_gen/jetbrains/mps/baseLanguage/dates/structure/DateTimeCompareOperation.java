...
public class DateTimeCompareOperation extends jetbrains.mps.baseLanguage.structure.Expression {
  ...
  public jetbrains.mps.baseLanguage.datesInternal.structure.DateTimeProperty getDatetimeProperty() {
    return (jetbrains.mps.baseLanguage.datesInternal.structure.DateTimeProperty)this.getReferent(DateTimeProperty.class, DateTimeCompareOperation.DATETIME_PROPERTY);
  }
  ...
  public jetbrains.mps.baseLanguage.structure.Expression getOp1() {
    return (jetbrains.mps.baseLanguage.structure.Expression)this.getChild(Expression.class, DateTimeCompareOperation.OP1);
  }

  public void setOp1(jetbrains.mps.baseLanguage.structure.Expression node) {
    super.setChild(DateTimeCompareOperation.OP1, node);
  }

  public jetbrains.mps.baseLanguage.structure.Expression getOp2() {
    return (jetbrains.mps.baseLanguage.structure.Expression)this.getChild(Expression.class, DateTimeCompareOperation.OP2);
  }

  public void setOp2(jetbrains.mps.baseLanguage.structure.Expression node) {
