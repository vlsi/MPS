...
public class ChainedOperations_Test extends Util_Test {
  ...
  public void test_chainedCall() throws Exception {
    Sequence<String> test = Sequence.fromIterable(this.input5()).select(new ISelector <Integer, Integer>() {

      public Integer select(Integer it) {
        return it * 3;
      }

    }).map(new IMapper <Integer, String>() {

      public Sequence<String> map(final Integer it) {
