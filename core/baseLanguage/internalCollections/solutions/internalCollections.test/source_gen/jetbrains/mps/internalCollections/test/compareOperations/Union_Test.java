...
public class Union_Test extends Util_Test {
  ...
  public void test_unionMethod() throws Exception {
    Sequence<Integer> input = Sequence.fromArray(1, 2, 3, 3);
    Sequence<Integer> test = input.union(Sequence.fromArray(2, 2, 3, 4));
  ...
  public void test_unionOperation() throws Exception {
    ...
    Iterable<Integer> test = Sequence.fromIterable(input).union(Sequence.fromIterable(Arrays.asList(2, 2, 3, 4)));
    this.assertIterableEqualsIgnoreOrder(Arrays.asList(1, 2, 2, 3, 3, 4), test);
  }
