        ...
        <node role="body" type="jetbrains.mps.baseLanguage.structure.StatementList" id="1223466644667">
          <node role="statement" type="jetbrains.mps.baseLanguage.structure.LocalVariableDeclarationStatement" id="1223476564203">
            <node role="localVariableDeclaration" type="jetbrains.mps.baseLanguage.structure.LocalVariableDeclaration" id="1223476564204">
              ...
              <node role="type" type="jetbrains.mps.baseLanguage.ext.collections.lang.structure.SequenceType" id="1223476564205">
          ...
          <node role="statement" type="jetbrains.mps.baseLanguage.structure.ExpressionStatement" id="1223557028161">
            <node role="expression" type="jetbrains.mps.baseLanguage.structure.DotExpression" id="1223557028433">
              <node role="operation" type="jetbrains.mps.baseLanguage.structure.InstanceMethodCallOperation" id="1223557030357">
                ...
                <node role="actualArgument" type="jetbrains.mps.closures.structure.ClosureLiteral" id="1223557032297">
                  <node role="parameter" type="jetbrains.mps.baseLanguage.ext.collections.lang.structure.SmartClosureParameterDeclaration" id="1223557036345">
                    <property name="name" value="it" />
                  ...
                  <node role="body" type="jetbrains.mps.baseLanguage.structure.StatementList" id="1223557032298">
                    <node role="statement" type="jetbrains.mps.closures.structure.YieldStatement" id="1223557040448">
          ...
          <node role="statement" type="jetbrains.mps.baseLanguage.structure.ExpressionStatement" id="1223635888910">
            <node role="expression" type="jetbrains.mps.baseLanguage.structure.DotExpression" id="1223636452706">
              <node role="operand" type="jetbrains.mps.bootstrap.smodelLanguage.structure.NodeRefExpression" id="1223635888911">
                <link role="referentNode" targetNodeId="10.1107461130800" resolveInfo="Classifier" />
              </node>
              <node role="operation" type="jetbrains.mps.bootstrap.smodelLanguage.structure.Node_ConceptMethodCall" id="1223636535189">
                <link role="conceptMethodDeclaration" targetNodeId="null" resolveInfo="getFqName" />
              </node>
            </node>
          </node>
        </node>
