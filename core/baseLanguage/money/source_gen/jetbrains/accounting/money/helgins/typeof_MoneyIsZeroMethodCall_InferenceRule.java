  ...
  public void applyRule(final SNode moneyIsZeroMethodCall, final TypeCheckingContext typeCheckingContext) {
    {
      ...
      TypeChecker.getInstance().getRuntimeSupport().createEquation(TypeChecker.getInstance().getRuntimeSupport().typeOf(moneyIsZeroMethodCall, "r:00000000-0000-4000-0000-011c895903f6(jetbrains.accounting.money.helgins)", "1187618229155", true), new QuotationClass_7().createNode(), _nodeToCheck_1029348928467, null, "r:00000000-0000-4000-0000-011c895903f6(jetbrains.accounting.money.helgins)", "1187618239848", intentionProvider);
    }
  }
