...
<solution name="internalCollections.test" uuid="b5660d3a-8a0d-4815-881b-7c884f61c9c7" compileInMPS="false" java-stubs-enabled="true">
  <models>
    <modelRoot path="${solution_descriptor}/" namespacePrefix="" />
  </models>
  <stubModelEntries>
    <stubModelEntry path="${mps_home}/core/baseLanguage/collections/classes" include="false">
  ...
  <dependencies>
    ...
    <dependency reexport="false">TransientModule 0</dependency>
  </dependencies>
  <usedLanguages>
