...
public class SubtractTest_Test extends Util_Test {
  ...
  public void test_subtractOperation() throws Exception {
    ...
    Iterable<Integer> test = Sequence.<Integer>fromIterable(input).subtract(ListSequence.<Integer>fromList(Arrays.asList(2, 3, 4, 4, 5)));
    this.assertIterableEqualsIgnoreOrder(Arrays.asList(1, 2, 3, 3), test);
  }

  public void test_nextWithoutHasNext() throws Exception {
    Iterator<Integer> it = ListSequence.<Integer>fromList(ListSequence.<Integer>fromListAndArray(new ArrayList<Integer>(), 1, 2, 3, 4, 5)).subtract(ListSequence.<Integer>fromList(ListSequence.<Integer>fromListAndArray(new ArrayList<Integer>(), 3, 2))).iterator();
