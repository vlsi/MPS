...
<model modelUID="r:cf23edd7-256f-4b20-82d2-696c87889d85(jetbrains.mps.baseLanguage.collections.plugin)">
  ...
  <languageAspect modelUID="r:cf23edd7-256f-4b20-82d2-696c87889d85(jetbrains.mps.baseLanguage.collections.plugin)" version="-1" />
  ...
  <node type="jetbrains.mps.debug.customViewers.structure.CustomWatchablesContainer:0" id="8423890115754358686">
    ...
    <property name="virtualPackage:0" value="debug" />
  ...
  <node type="jetbrains.mps.debug.customViewers.structure.HighLevelCustomViewer:0" id="5116701553466303326">
    ...
    <node role="getWatchables:0" type="jetbrains.mps.debug.customViewers.structure.GetHighLevelWatchablesBlock_ConceptFunction:0" id="5116701553466303330">
      <node role="body:0" type="jetbrains.mps.baseLanguage.structure.StatementList:3" id="5116701553466303331">
        <node role="statement:3" type="jetbrains.mps.baseLanguage.structure.LocalVariableDeclarationStatement:3" id="6367352481823138411">
          <node role="localVariableDeclaration:3" type="jetbrains.mps.baseLanguage.structure.LocalVariableDeclaration:3" id="6367352481823138412">
            <property name="name:3" value="watchables" />
            <node role="initializer:3" type="jetbrains.mps.baseLanguage.structure.GenericNewExpression:3" id="6367352481823138417">
              <node role="creator:3" type="jetbrains.mps.debug.customViewers.structure.WatchablesListCreator:0" id="1842653058275008948" />
            </node>
            <node role="type:3" type="jetbrains.mps.debug.customViewers.structure.WatchableListType:0" id="1842653058275008947" />
          </node>
        </node>
        <node role="statement:3" type="jetbrains.mps.baseLanguage.structure.Statement:3" id="6367352481823138410" />
        <node role="statement:3" type="jetbrains.mps.baseLanguage.structure.LocalVariableDeclarationStatement:3" id="6367352481823138403">
          <node role="localVariableDeclaration:3" type="jetbrains.mps.baseLanguage.structure.LocalVariableDeclaration:3" id="6367352481823138404">
            <property name="name:3" value="size" />
            <node role="type:3" type="jetbrains.mps.baseLanguage.structure.IntegerType:3" id="6367352481823138405" />
            <node role="initializer:3" type="jetbrains.mps.baseLanguage.structure.DotExpression:3" id="6367352481823138406">
              <node role="operand:3" type="jetbrains.mps.debug.customViewers.structure.HighLevelValue_ConceptFunctionParameter:0" id="6367352481823138407" />
              <node role="operation:3" type="jetbrains.mps.baseLanguage.structure.InstanceMethodCallOperation:3" id="6367352481823138408">
                <link role="baseMethodDeclaration:3" targetNodeId="8.~List.size():int" resolveInfo="size" />
              </node>
            </node>
          </node>
        </node>
        <node role="statement:3" type="jetbrains.mps.baseLanguage.structure.ExpressionStatement:3" id="1067996875388370558">
          <node role="expression:3" type="jetbrains.mps.baseLanguage.structure.DotExpression:3" id="1067996875388370560">
            <node role="operand:3" type="jetbrains.mps.baseLanguage.structure.LocalVariableReference:3" id="1067996875388370559">
              <link role="variableDeclaration:3" targetNodeId="6367352481823138412" resolveInfo="watchables" />
            </node>
            <node role="operation:3" type="jetbrains.mps.baseLanguage.structure.InstanceMethodCallOperation:3" id="1067996875388372928">
              <link role="baseMethodDeclaration:3" targetNodeId="8.~List.add(java.lang.Object):boolean" resolveInfo="add" />
              <node role="actualArgument:3" type="jetbrains.mps.baseLanguage.structure.GenericNewExpression:3" id="1067996875388372931">
                <node role="creator:3" type="jetbrains.mps.debug.customViewers.structure.HighLevelWatchableCreator:0" id="1067996875388372932">
                  <link role="watchable:0" targetNodeId="4489446533979526102" resolveInfo="size" />
                  <node role="value:0" type="jetbrains.mps.baseLanguage.structure.LocalVariableReference:3" id="1067996875388372933">
                    <link role="variableDeclaration:3" targetNodeId="6367352481823138404" resolveInfo="size" />
                  </node>
                </node>
              </node>
            </node>
        ...
        <node role="statement:3" type="jetbrains.mps.baseLanguage.structure.Statement:3" id="1842653058275013458" />
        <node role="statement:3" type="jetbrains.mps.baseLanguage.structure.ForeachStatement:3" id="6367352481823164548">
          <node role="variable:3" type="jetbrains.mps.baseLanguage.structure.LocalVariableDeclaration:3" id="6367352481823164549">
            <property name="name:3" value="element" />
            <node role="type:3" type="jetbrains.mps.baseLanguage.structure.ClassifierType:3" id="6367352481823164554">
              <link role="classifier:3" targetNodeId="2.~Object" resolveInfo="Object" />
            </node>
          </node>
          <node role="body:3" type="jetbrains.mps.baseLanguage.structure.StatementList:3" id="6367352481823164550">
            <node role="statement:3" type="jetbrains.mps.baseLanguage.structure.ExpressionStatement:3" id="1067996875388372935">
              <node role="expression:3" type="jetbrains.mps.baseLanguage.structure.DotExpression:3" id="1067996875388372937">
                <node role="operand:3" type="jetbrains.mps.baseLanguage.structure.LocalVariableReference:3" id="1067996875388372936">
                  <link role="variableDeclaration:3" targetNodeId="6367352481823138412" resolveInfo="watchables" />
                </node>
                <node role="operation:3" type="jetbrains.mps.baseLanguage.structure.InstanceMethodCallOperation:3" id="1067996875388372941">
                  <link role="baseMethodDeclaration:3" targetNodeId="8.~List.add(java.lang.Object):boolean" resolveInfo="add" />
                  <node role="actualArgument:3" type="jetbrains.mps.baseLanguage.structure.GenericNewExpression:3" id="1067996875388372942">
                    <node role="creator:3" type="jetbrains.mps.debug.customViewers.structure.HighLevelWatchableCreator:0" id="1067996875388372943">
                      <link role="watchable:0" targetNodeId="8423890115754358692" resolveInfo="element" />
                      <node role="value:0" type="jetbrains.mps.baseLanguage.structure.LocalVariableReference:3" id="1067996875388372944">
                        <link role="variableDeclaration:3" targetNodeId="6367352481823164549" resolveInfo="element" />
                      </node>
                    </node>
                  </node>
                </node>
          ...
          <node role="iterable:3" type="jetbrains.mps.debug.customViewers.structure.HighLevelValue_ConceptFunctionParameter:0" id="6367352481823164555" />
        </node>
        <node role="statement:3" type="jetbrains.mps.baseLanguage.structure.Statement:3" id="6367352481823138420" />
        <node role="statement:3" type="jetbrains.mps.baseLanguage.structure.ReturnStatement:3" id="6367352481823138422">
          <node role="expression:3" type="jetbrains.mps.baseLanguage.structure.LocalVariableReference:3" id="6367352481823138424">
            <link role="variableDeclaration:3" targetNodeId="6367352481823138412" resolveInfo="watchables" />
          </node>
        </node>
      </node>
  ...
  <node type="jetbrains.mps.debug.customViewers.structure.HighLevelCustomViewer:0" id="7785669630792406965">
    <property name="name:0" value="MapEntryViewer" />
    <property name="virtualPackage:0" value="debug" />
    <node role="valueType:0" type="jetbrains.mps.baseLanguage.structure.ClassifierType:3" id="7785669630792426020">
      <link role="classifier:3" targetNodeId="8.~Map$Entry" resolveInfo="Map.Entry" />
    </node>
    <node role="getWatchables:0" type="jetbrains.mps.debug.customViewers.structure.GetHighLevelWatchablesBlock_ConceptFunction:0" id="7785669630792406967">
      <node role="body:0" type="jetbrains.mps.baseLanguage.structure.StatementList:3" id="7785669630792406968">
        <node role="statement:3" type="jetbrains.mps.baseLanguage.structure.LocalVariableDeclarationStatement:3" id="7785669630792487826">
          <node role="localVariableDeclaration:3" type="jetbrains.mps.baseLanguage.structure.LocalVariableDeclaration:3" id="7785669630792487827">
            <property name="name:3" value="result" />
            <node role="type:3" type="jetbrains.mps.debug.customViewers.structure.WatchableListType:0" id="7785669630792487828" />
            <node role="initializer:3" type="jetbrains.mps.baseLanguage.structure.GenericNewExpression:3" id="7785669630792487830">
              <node role="creator:3" type="jetbrains.mps.debug.customViewers.structure.WatchablesListCreator:0" id="7785669630792487832" />
            </node>
          </node>
        </node>
        <node role="statement:3" type="jetbrains.mps.baseLanguage.structure.LocalVariableDeclarationStatement:3" id="7785669630792487812">
          <node role="localVariableDeclaration:3" type="jetbrains.mps.baseLanguage.structure.LocalVariableDeclaration:3" id="7785669630792487813">
            <property name="name:3" value="key" />
            <node role="type:3" type="jetbrains.mps.baseLanguage.structure.ClassifierType:3" id="7785669630792487814">
              <link role="classifier:3" targetNodeId="2.~Object" resolveInfo="Object" />
            </node>
            <node role="initializer:3" type="jetbrains.mps.baseLanguage.structure.DotExpression:3" id="7785669630792487815">
              <node role="operand:3" type="jetbrains.mps.debug.customViewers.structure.HighLevelValue_ConceptFunctionParameter:0" id="7785669630792487816" />
              <node role="operation:3" type="jetbrains.mps.baseLanguage.structure.InstanceMethodCallOperation:3" id="7785669630792487817">
                <link role="baseMethodDeclaration:3" targetNodeId="8.~Map$Entry.getKey():java.lang.Object" resolveInfo="getKey" />
              </node>
            </node>
          </node>
        </node>
        <node role="statement:3" type="jetbrains.mps.baseLanguage.structure.LocalVariableDeclarationStatement:3" id="7785669630792487818">
          <node role="localVariableDeclaration:3" type="jetbrains.mps.baseLanguage.structure.LocalVariableDeclaration:3" id="7785669630792487819">
            <property name="name:3" value="entryValue" />
            <node role="type:3" type="jetbrains.mps.baseLanguage.structure.ClassifierType:3" id="7785669630792487820">
              <link role="classifier:3" targetNodeId="2.~Object" resolveInfo="Object" />
            </node>
            <node role="initializer:3" type="jetbrains.mps.baseLanguage.structure.DotExpression:3" id="7785669630792487821">
              <node role="operand:3" type="jetbrains.mps.debug.customViewers.structure.HighLevelValue_ConceptFunctionParameter:0" id="7785669630792487822" />
              <node role="operation:3" type="jetbrains.mps.baseLanguage.structure.InstanceMethodCallOperation:3" id="7785669630792487823">
                <link role="baseMethodDeclaration:3" targetNodeId="8.~Map$Entry.getValue():java.lang.Object" resolveInfo="getValue" />
              </node>
            </node>
          </node>
        </node>
        <node role="statement:3" type="jetbrains.mps.baseLanguage.structure.ExpressionStatement:3" id="7785669630792487833">
          <node role="expression:3" type="jetbrains.mps.baseLanguage.structure.DotExpression:3" id="7785669630792487835">
            <node role="operand:3" type="jetbrains.mps.baseLanguage.structure.LocalVariableReference:3" id="7785669630792487834">
              <link role="variableDeclaration:3" targetNodeId="7785669630792487827" resolveInfo="result" />
            </node>
            <node role="operation:3" type="jetbrains.mps.baseLanguage.structure.InstanceMethodCallOperation:3" id="7785669630792487839">
              <link role="baseMethodDeclaration:3" targetNodeId="8.~List.add(java.lang.Object):boolean" resolveInfo="add" />
              <node role="actualArgument:3" type="jetbrains.mps.baseLanguage.structure.GenericNewExpression:3" id="7785669630792487840">
                <node role="creator:3" type="jetbrains.mps.debug.customViewers.structure.HighLevelWatchableCreator:0" id="7785669630792487842">
                  <link role="watchable:0" targetNodeId="1549837254988610010" resolveInfo="key" />
                  <node role="value:0" type="jetbrains.mps.baseLanguage.structure.LocalVariableReference:3" id="7785669630792487844">
                    <link role="variableDeclaration:3" targetNodeId="7785669630792487813" resolveInfo="key" />
                  </node>
                </node>
              </node>
            </node>
        ...
        <node role="statement:3" type="jetbrains.mps.baseLanguage.structure.ExpressionStatement:3" id="7785669630792487845">
          <node role="expression:3" type="jetbrains.mps.baseLanguage.structure.DotExpression:3" id="7785669630792487846">
            <node role="operand:3" type="jetbrains.mps.baseLanguage.structure.LocalVariableReference:3" id="7785669630792487847">
              <link role="variableDeclaration:3" targetNodeId="7785669630792487827" resolveInfo="result" />
            </node>
            <node role="operation:3" type="jetbrains.mps.baseLanguage.structure.InstanceMethodCallOperation:3" id="7785669630792487848">
              <link role="baseMethodDeclaration:3" targetNodeId="8.~List.add(java.lang.Object):boolean" resolveInfo="add" />
              <node role="actualArgument:3" type="jetbrains.mps.baseLanguage.structure.GenericNewExpression:3" id="7785669630792487849">
                <node role="creator:3" type="jetbrains.mps.debug.customViewers.structure.HighLevelWatchableCreator:0" id="7785669630792487850">
                  <link role="watchable:0" targetNodeId="1549837254988610011" resolveInfo="value" />
                  <node role="value:0" type="jetbrains.mps.baseLanguage.structure.LocalVariableReference:3" id="7785669630792487852">
                    <link role="variableDeclaration:3" targetNodeId="7785669630792487819" resolveInfo="entryValue" />
                  </node>
                </node>
              </node>
            </node>
        ...
        <node role="statement:3" type="jetbrains.mps.baseLanguage.structure.ReturnStatement:3" id="7785669630792487854">
          <node role="expression:3" type="jetbrains.mps.baseLanguage.structure.LocalVariableReference:3" id="7785669630792487856">
            <link role="variableDeclaration:3" targetNodeId="7785669630792487827" resolveInfo="result" />
          </node>
        </node>
      </node>
    </node>
    <node role="getPresentation:0" type="jetbrains.mps.debug.customViewers.structure.GetHighLevelValuePresentation_ConceptFunction:0" id="7785669630792426021">
      <node role="body:0" type="jetbrains.mps.baseLanguage.structure.StatementList:3" id="7785669630792426022">
        <node role="statement:3" type="jetbrains.mps.baseLanguage.structure.LocalVariableDeclarationStatement:3" id="7785669630792487769">
          <node role="localVariableDeclaration:3" type="jetbrains.mps.baseLanguage.structure.LocalVariableDeclaration:3" id="7785669630792487770">
            <property name="name:3" value="key" />
            <node role="type:3" type="jetbrains.mps.baseLanguage.structure.ClassifierType:3" id="7785669630792487771">
              <link role="classifier:3" targetNodeId="2.~Object" resolveInfo="Object" />
            </node>
            <node role="initializer:3" type="jetbrains.mps.baseLanguage.structure.DotExpression:3" id="7785669630792487772">
              <node role="operand:3" type="jetbrains.mps.debug.customViewers.structure.HighLevelValue_ConceptFunctionParameter:0" id="7785669630792487773" />
              <node role="operation:3" type="jetbrains.mps.baseLanguage.structure.InstanceMethodCallOperation:3" id="7785669630792487774">
                <link role="baseMethodDeclaration:3" targetNodeId="8.~Map$Entry.getKey():java.lang.Object" resolveInfo="getKey" />
              </node>
            </node>
          </node>
        </node>
        <node role="statement:3" type="jetbrains.mps.baseLanguage.structure.LocalVariableDeclarationStatement:3" id="7785669630792487783">
          <node role="localVariableDeclaration:3" type="jetbrains.mps.baseLanguage.structure.LocalVariableDeclaration:3" id="7785669630792487784">
            <property name="name:3" value="entryValue" />
            <node role="type:3" type="jetbrains.mps.baseLanguage.structure.ClassifierType:3" id="7785669630792487785">
              <link role="classifier:3" targetNodeId="2.~Object" resolveInfo="Object" />
            </node>
            <node role="initializer:3" type="jetbrains.mps.baseLanguage.structure.DotExpression:3" id="7785669630792487786">
              <node role="operand:3" type="jetbrains.mps.debug.customViewers.structure.HighLevelValue_ConceptFunctionParameter:0" id="7785669630792487787" />
              <node role="operation:3" type="jetbrains.mps.baseLanguage.structure.InstanceMethodCallOperation:3" id="7785669630792487788">
                <link role="baseMethodDeclaration:3" targetNodeId="8.~Map$Entry.getValue():java.lang.Object" resolveInfo="getValue" />
              </node>
            </node>
          </node>
  ...
  <node type="jetbrains.mps.debug.customViewers.structure.HighLevelCustomViewer:0" id="7785669630792592640">
    <property name="name:0" value="MapViewer" />
    <property name="virtualPackage:0" value="debug" />
    <node role="valueType:0" type="jetbrains.mps.baseLanguage.structure.ClassifierType:3" id="7785669630792592644">
      <link role="classifier:3" targetNodeId="8.~Map" resolveInfo="Map" />
    </node>
    <node role="getWatchables:0" type="jetbrains.mps.debug.customViewers.structure.GetHighLevelWatchablesBlock_ConceptFunction:0" id="7785669630792592642">
      <node role="body:0" type="jetbrains.mps.baseLanguage.structure.StatementList:3" id="7785669630792592643">
        <node role="statement:3" type="jetbrains.mps.baseLanguage.structure.LocalVariableDeclarationStatement:3" id="7785669630792592660">
          <node role="localVariableDeclaration:3" type="jetbrains.mps.baseLanguage.structure.LocalVariableDeclaration:3" id="7785669630792592661">
            <property name="name:3" value="result" />
            <node role="type:3" type="jetbrains.mps.debug.customViewers.structure.WatchableListType:0" id="7785669630792592662" />
            <node role="initializer:3" type="jetbrains.mps.baseLanguage.structure.GenericNewExpression:3" id="7785669630792592664">
              <node role="creator:3" type="jetbrains.mps.debug.customViewers.structure.WatchablesListCreator:0" id="7785669630792592666" />
            </node>
          </node>
        </node>
        <node role="statement:3" type="jetbrains.mps.baseLanguage.structure.Statement:3" id="7785669630792592667" />
        <node role="statement:3" type="jetbrains.mps.baseLanguage.structure.LocalVariableDeclarationStatement:3" id="7785669630792592652">
          <node role="localVariableDeclaration:3" type="jetbrains.mps.baseLanguage.structure.LocalVariableDeclaration:3" id="7785669630792592653">
            <property name="name:3" value="size" />
            <node role="type:3" type="jetbrains.mps.baseLanguage.structure.IntegerType:3" id="7785669630792592654" />
            <node role="initializer:3" type="jetbrains.mps.baseLanguage.structure.DotExpression:3" id="7785669630792592655">
              <node role="operand:3" type="jetbrains.mps.debug.customViewers.structure.HighLevelValue_ConceptFunctionParameter:0" id="7785669630792592656" />
              <node role="operation:3" type="jetbrains.mps.baseLanguage.structure.InstanceMethodCallOperation:3" id="7785669630792592657">
                <link role="baseMethodDeclaration:3" targetNodeId="8.~Map.size():int" resolveInfo="size" />
              </node>
            </node>
          </node>
        </node>
        ...
        <node role="statement:3" type="jetbrains.mps.baseLanguage.structure.LocalVariableDeclarationStatement:3" id="7785669630792592675">
          <node role="localVariableDeclaration:3" type="jetbrains.mps.baseLanguage.structure.LocalVariableDeclaration:3" id="7785669630792592676">
            ...
            <node role="type:3" type="jetbrains.mps.baseLanguage.structure.ClassifierType:3" id="7785669630792592677">
              <link role="classifier:3" targetNodeId="8.~Set" resolveInfo="Set" />
              <node role="parameter:3" type="jetbrains.mps.baseLanguage.structure.ClassifierType:3" id="7785669630792592695">
                <link role="classifier:3" targetNodeId="8.~Map$Entry" resolveInfo="Map.Entry" />
              </node>
            </node>
            <node role="initializer:3" type="jetbrains.mps.baseLanguage.structure.DotExpression:3" id="7785669630792592678">
              <node role="operand:3" type="jetbrains.mps.debug.customViewers.structure.HighLevelValue_ConceptFunctionParameter:0" id="7785669630792592679" />
              <node role="operation:3" type="jetbrains.mps.baseLanguage.structure.InstanceMethodCallOperation:3" id="7785669630792592680">
                <link role="baseMethodDeclaration:3" targetNodeId="8.~Map.entrySet():java.util.Set" resolveInfo="entrySet" />
              </node>
            </node>
          </node>
        </node>
        <node role="statement:3" type="jetbrains.mps.baseLanguage.structure.ForeachStatement:3" id="7785669630792592688">
          <node role="variable:3" type="jetbrains.mps.baseLanguage.structure.LocalVariableDeclaration:3" id="7785669630792592689">
            <property name="name:3" value="entry" />
            <node role="type:3" type="jetbrains.mps.baseLanguage.structure.ClassifierType:3" id="7785669630792592696">
              <link role="classifier:3" targetNodeId="8.~Map$Entry" resolveInfo="Map.Entry" />
            </node>
          </node>
          <node role="body:3" type="jetbrains.mps.baseLanguage.structure.StatementList:3" id="7785669630792592690">
            <node role="statement:3" type="jetbrains.mps.baseLanguage.structure.ExpressionStatement:3" id="7785669630792592697">
              <node role="expression:3" type="jetbrains.mps.baseLanguage.structure.DotExpression:3" id="7785669630792592699">
                <node role="operand:3" type="jetbrains.mps.baseLanguage.structure.LocalVariableReference:3" id="7785669630792592698">
                  <link role="variableDeclaration:3" targetNodeId="7785669630792592661" resolveInfo="result" />
                </node>
                <node role="operation:3" type="jetbrains.mps.baseLanguage.structure.InstanceMethodCallOperation:3" id="7785669630792592703">
                  <link role="baseMethodDeclaration:3" targetNodeId="8.~List.add(java.lang.Object):boolean" resolveInfo="add" />
                  <node role="actualArgument:3" type="jetbrains.mps.baseLanguage.structure.GenericNewExpression:3" id="7785669630792592704">
                    <node role="creator:3" type="jetbrains.mps.debug.customViewers.structure.HighLevelWatchableCreator:0" id="7785669630792592706">
                      <link role="watchable:0" targetNodeId="1549837254988592393" resolveInfo="entry" />
                      <node role="value:0" type="jetbrains.mps.baseLanguage.structure.LocalVariableReference:3" id="7785669630792592708">
                        <link role="variableDeclaration:3" targetNodeId="7785669630792592689" resolveInfo="entry" />
                      </node>
                    </node>
                  </node>
                </node>
          ...
          <node role="iterable:3" type="jetbrains.mps.baseLanguage.structure.LocalVariableReference:3" id="7785669630792592693">
            <link role="variableDeclaration:3" targetNodeId="7785669630792592676" resolveInfo="entries" />
          </node>
        </node>
        <node role="statement:3" type="jetbrains.mps.baseLanguage.structure.Statement:3" id="7785669630792592709" />
        <node role="statement:3" type="jetbrains.mps.baseLanguage.structure.ReturnStatement:3" id="7785669630792592711">
          <node role="expression:3" type="jetbrains.mps.baseLanguage.structure.LocalVariableReference:3" id="7785669630792592713">
            <link role="variableDeclaration:3" targetNodeId="7785669630792592661" resolveInfo="result" />
          </node>
        </node>
      </node>
  ...
  <node type="jetbrains.mps.debug.customViewers.structure.HighLevelCustomViewer:0" id="7785669630792592730">
    <property name="name:0" value="SetViewer" />
    <property name="virtualPackage:0" value="debug" />
    <node role="valueType:0" type="jetbrains.mps.baseLanguage.structure.ClassifierType:3" id="7785669630792592734">
      <link role="classifier:3" targetNodeId="8.~Set" resolveInfo="Set" />
    </node>
    <node role="getWatchables:0" type="jetbrains.mps.debug.customViewers.structure.GetHighLevelWatchablesBlock_ConceptFunction:0" id="7785669630792592732">
      <node role="body:0" type="jetbrains.mps.baseLanguage.structure.StatementList:3" id="7785669630792592733">
        <node role="statement:3" type="jetbrains.mps.baseLanguage.structure.SingleLineComment:3" id="7785669630792592775">
          <node role="commentPart:3" type="jetbrains.mps.baseLanguage.structure.TextCommentPart:3" id="7785669630792592776">
            <property name="text:3" value="again, same as ListViewer" />
          </node>
        </node>
        <node role="statement:3" type="jetbrains.mps.baseLanguage.structure.LocalVariableDeclarationStatement:3" id="7785669630792592738">
          <node role="localVariableDeclaration:3" type="jetbrains.mps.baseLanguage.structure.LocalVariableDeclaration:3" id="7785669630792592739">
            <property name="name:3" value="watchables" />
            <node role="initializer:3" type="jetbrains.mps.baseLanguage.structure.GenericNewExpression:3" id="7785669630792592740">
              <node role="creator:3" type="jetbrains.mps.debug.customViewers.structure.WatchablesListCreator:0" id="7785669630792592741" />
            </node>
            <node role="type:3" type="jetbrains.mps.debug.customViewers.structure.WatchableListType:0" id="7785669630792592742" />
          </node>
        </node>
        <node role="statement:3" type="jetbrains.mps.baseLanguage.structure.Statement:3" id="7785669630792592743" />
        <node role="statement:3" type="jetbrains.mps.baseLanguage.structure.LocalVariableDeclarationStatement:3" id="7785669630792592744">
          <node role="localVariableDeclaration:3" type="jetbrains.mps.baseLanguage.structure.LocalVariableDeclaration:3" id="7785669630792592745">
            <property name="name:3" value="size" />
            <node role="type:3" type="jetbrains.mps.baseLanguage.structure.IntegerType:3" id="7785669630792592746" />
            <node role="initializer:3" type="jetbrains.mps.baseLanguage.structure.DotExpression:3" id="7785669630792592747">
              <node role="operand:3" type="jetbrains.mps.debug.customViewers.structure.HighLevelValue_ConceptFunctionParameter:0" id="7785669630792592773" />
              <node role="operation:3" type="jetbrains.mps.baseLanguage.structure.InstanceMethodCallOperation:3" id="7785669630792592749">
                <link role="baseMethodDeclaration:3" targetNodeId="8.~Set.size():int" resolveInfo="size" />
              </node>
            </node>
          </node>
        </node>
        <node role="statement:3" type="jetbrains.mps.baseLanguage.structure.ExpressionStatement:3" id="7785669630792592750">
          <node role="expression:3" type="jetbrains.mps.baseLanguage.structure.DotExpression:3" id="7785669630792592751">
            <node role="operand:3" type="jetbrains.mps.baseLanguage.structure.LocalVariableReference:3" id="7785669630792592752">
              <link role="variableDeclaration:3" targetNodeId="7785669630792592739" resolveInfo="watchables" />
            </node>
            <node role="operation:3" type="jetbrains.mps.baseLanguage.structure.InstanceMethodCallOperation:3" id="7785669630792592753">
              <link role="baseMethodDeclaration:3" targetNodeId="8.~List.add(java.lang.Object):boolean" resolveInfo="add" />
              <node role="actualArgument:3" type="jetbrains.mps.baseLanguage.structure.GenericNewExpression:3" id="7785669630792592754">
                <node role="creator:3" type="jetbrains.mps.debug.customViewers.structure.HighLevelWatchableCreator:0" id="7785669630792592755">
                  <link role="watchable:0" targetNodeId="4489446533979526102" resolveInfo="size" />
                  <node role="value:0" type="jetbrains.mps.baseLanguage.structure.LocalVariableReference:3" id="7785669630792592756">
                    <link role="variableDeclaration:3" targetNodeId="7785669630792592745" resolveInfo="size" />
                  </node>
                </node>
              </node>
            </node>
        ...
        <node role="statement:3" type="jetbrains.mps.baseLanguage.structure.Statement:3" id="7785669630792592757" />
        <node role="statement:3" type="jetbrains.mps.baseLanguage.structure.ForeachStatement:3" id="7785669630792592758">
          <node role="variable:3" type="jetbrains.mps.baseLanguage.structure.LocalVariableDeclaration:3" id="7785669630792592759">
            <property name="name:3" value="element" />
            <node role="type:3" type="jetbrains.mps.baseLanguage.structure.ClassifierType:3" id="7785669630792592760">
              <link role="classifier:3" targetNodeId="2.~Object" resolveInfo="Object" />
            </node>
          </node>
          <node role="body:3" type="jetbrains.mps.baseLanguage.structure.StatementList:3" id="7785669630792592761">
            <node role="statement:3" type="jetbrains.mps.baseLanguage.structure.ExpressionStatement:3" id="7785669630792592762">
              <node role="expression:3" type="jetbrains.mps.baseLanguage.structure.DotExpression:3" id="7785669630792592763">
                <node role="operand:3" type="jetbrains.mps.baseLanguage.structure.LocalVariableReference:3" id="7785669630792592764">
                  <link role="variableDeclaration:3" targetNodeId="7785669630792592739" resolveInfo="watchables" />
                </node>
                <node role="operation:3" type="jetbrains.mps.baseLanguage.structure.InstanceMethodCallOperation:3" id="7785669630792592765">
                  <link role="baseMethodDeclaration:3" targetNodeId="8.~List.add(java.lang.Object):boolean" resolveInfo="add" />
                  <node role="actualArgument:3" type="jetbrains.mps.baseLanguage.structure.GenericNewExpression:3" id="7785669630792592766">
                    <node role="creator:3" type="jetbrains.mps.debug.customViewers.structure.HighLevelWatchableCreator:0" id="7785669630792592767">
                      <link role="watchable:0" targetNodeId="8423890115754358692" resolveInfo="element" />
                      <node role="value:0" type="jetbrains.mps.baseLanguage.structure.LocalVariableReference:3" id="7785669630792592768">
                        <link role="variableDeclaration:3" targetNodeId="7785669630792592759" resolveInfo="element" />
                      </node>
                    </node>
                  </node>
                </node>
          ...
          <node role="iterable:3" type="jetbrains.mps.debug.customViewers.structure.HighLevelValue_ConceptFunctionParameter:0" id="7785669630792592769" />
        </node>
        <node role="statement:3" type="jetbrains.mps.baseLanguage.structure.Statement:3" id="7785669630792592770" />
        <node role="statement:3" type="jetbrains.mps.baseLanguage.structure.ReturnStatement:3" id="7785669630792592771">
          <node role="expression:3" type="jetbrains.mps.baseLanguage.structure.LocalVariableReference:3" id="7785669630792592772">
            <link role="variableDeclaration:3" targetNodeId="7785669630792592739" resolveInfo="watchables" />
          </node>
        </node>
      </node>
