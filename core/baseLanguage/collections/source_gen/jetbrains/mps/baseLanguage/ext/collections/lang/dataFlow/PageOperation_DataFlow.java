...
public class PageOperation_DataFlow extends DataFlowBuilder {
  ...
  public void build(final IOperationContext operationContext, final DataFlowBuilderContext _context) {
    _context.getBuilder().build(SLinkOperations.getTarget(_context.getNode(), "fromElement", true));
    _context.getBuilder().build(SLinkOperations.getTarget(_context.getNode(), "toElement", true));
  }
