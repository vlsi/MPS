...
public class MapClearOperation extends MapOperation {
  public static final String concept = "jetbrains.mps.baseLanguage.ext.collections.lang.structure.MapClearOperation";
  ...
  public static MapClearOperation newInstance(SModel sm, boolean init) {
    return (MapClearOperation)SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.baseLanguage.ext.collections.lang.structure.MapClearOperation", sm, GlobalScope.getInstance(), init).getAdapter();
  }
