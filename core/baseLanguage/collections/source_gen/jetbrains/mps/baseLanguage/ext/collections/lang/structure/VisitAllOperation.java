...
public class VisitAllOperation extends InternalSequenceOperation {
  public static final String concept = "jetbrains.mps.baseLanguage.ext.collections.lang.structure.VisitAllOperation";
  ...
  public static VisitAllOperation newInstance(SModel sm, boolean init) {
    return (VisitAllOperation)SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.baseLanguage.ext.collections.lang.structure.VisitAllOperation", sm, GlobalScope.getInstance(), init).getAdapter();
  }
