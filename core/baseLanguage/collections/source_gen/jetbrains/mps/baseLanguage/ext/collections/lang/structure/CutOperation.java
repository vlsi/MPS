...
public class CutOperation extends ChunkOperation {
  public static final String concept = "jetbrains.mps.baseLanguage.ext.collections.lang.structure.CutOperation";
  ...
  public static CutOperation newInstance(SModel sm, boolean init) {
    return (CutOperation)SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.baseLanguage.ext.collections.lang.structure.CutOperation", sm, GlobalScope.getInstance(), init).getAdapter();
  }
