...
public class typeof_ContainsKeyOperation_InferenceRule implements InferenceRule_Runtime {
  ...
  public void applyRule(final SNode containsKeyOperation) {
    TypeChecker.getInstance().getRuntimeSupport().createEquation(TypeChecker.getInstance().getRuntimeSupport().typeOf(containsKeyOperation, "jetbrains.mps.baseLanguage.ext.collections.lang.helgins", "1201873003944", true), new QuotationClass_57().createNode(), containsKeyOperation, null, "jetbrains.mps.baseLanguage.ext.collections.lang.helgins", "1201873006966");
    ...
    TypeChecker.getInstance().getRuntimeSupport().createLessThanInequation(TypeChecker.getInstance().getRuntimeSupport().typeOf(IOperation_Behavior.call_getOperand_1197028596169(containsKeyOperation), "jetbrains.mps.baseLanguage.ext.collections.lang.helgins", "1201874242447", true), new QuotationClass_58().createNode(TypeChecker.getInstance().getEquationManager().getRepresentator(VALUE_typevar_1201874216771), TypeChecker.getInstance().getEquationManager().getRepresentator(KEY_typevar_1201873088202)), IOperation_Behavior.call_getOperand_1197028596169(containsKeyOperation), null, "jetbrains.mps.baseLanguage.ext.collections.lang.helgins", "1201874242445");
