...
public class SequenceOperation_Editor extends DefaultNodeEditor {
  ...
  public EditorCell createEditorCell(EditorContext context, SNode node) {
    return this.create_ErrorCell18332_0(context, node);
  }

  public EditorCell create_ErrorCell18332_0(EditorContext context, SNode node) {
    EditorCell_Error editorCell = new EditorCell_Error(context, node, "<oper>");
    setupBasic_ErrorCell18332_0(editorCell, node, context);
    setupLabel_ErrorCell18332_0(editorCell, node, context);
    return editorCell;
  }
