...
public class TailOperation extends ChunkOperation {
  public static final String concept = "jetbrains.mps.baseLanguage.ext.collections.lang.structure.TailOperation";
  ...
  public static TailOperation newInstance(SModel sm, boolean init) {
    return (TailOperation)SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.baseLanguage.ext.collections.lang.structure.TailOperation", sm, GlobalScope.getInstance(), init).getAdapter();
  }
