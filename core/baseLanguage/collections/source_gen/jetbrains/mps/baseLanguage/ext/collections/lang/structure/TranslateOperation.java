...
public class TranslateOperation extends InternalSequenceOperation {
  public static final String concept = "jetbrains.mps.baseLanguage.ext.collections.lang.structure.TranslateOperation";
  ...
  public static TranslateOperation newInstance(SModel sm, boolean init) {
    return (TranslateOperation)SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.baseLanguage.ext.collections.lang.structure.TranslateOperation", sm, GlobalScope.getInstance(), init).getAdapter();
  }
