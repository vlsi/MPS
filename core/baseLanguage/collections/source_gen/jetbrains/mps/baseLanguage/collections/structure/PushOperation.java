...
public class PushOperation extends SingleArgumentSequenceOperation implements IStackOperation, IDequeOperation {
  ...
  public int get_$attributesCount() {
    return this.getChildCount(PushOperation._$ATTRIBUTE);
  }

  public Iterator<Attribute> _$attributes() {
    return this.children(Attribute.class, PushOperation._$ATTRIBUTE);
  }

  public List<Attribute> get_$attributes() {
    return this.getChildren(Attribute.class, PushOperation._$ATTRIBUTE);
  }

  public void add_$attribute(Attribute node) {
    this.addChild(PushOperation._$ATTRIBUTE, node);
  }

  public void insert_$attribute(Attribute prev, Attribute node) {
    this.insertChild(prev, PushOperation._$ATTRIBUTE, node);
  }
