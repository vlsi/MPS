...
public class typeof_SingletonSequenceCreator_InferenceRule extends AbstractInferenceRule_Runtime implements InferenceRule_Runtime {
  ...
  public static class QuotationClass_kyakf6_a0a2a0 {
    ...
    public SNode createNode(Object parameter_kyakf6_a0a0a0c0a, final TypeCheckingContext typeCheckingContext) {
      SNode result = null;
      Set<SNode> _parameterValues_129834374 = new HashSet<SNode>();
      SNode quotedNode_kyakf6_a0a2a0 = null;
      SNode quotedNode_kyakf6_a0a0c0a = null;
      {
        quotedNode_kyakf6_a0a2a0 = SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.baseLanguage.collections.structure.SequenceType", TypeChecker.getInstance().getRuntimeTypesModel(), GlobalScope.getInstance(), false);
        SNode quotedNode1_kyakf6_a0a2a0 = quotedNode_kyakf6_a0a2a0;
        {
          quotedNode_kyakf6_a0a0c0a = (SNode) parameter_kyakf6_a0a0a0c0a;
          SNode quotedNode1_kyakf6_a0a0c0a;
          if (_parameterValues_129834374.contains(quotedNode_kyakf6_a0a0c0a)) {
            quotedNode1_kyakf6_a0a0c0a = CopyUtil.copy(quotedNode_kyakf6_a0a0c0a);
          } else {
            _parameterValues_129834374.add(quotedNode_kyakf6_a0a0c0a);
            quotedNode1_kyakf6_a0a0c0a = quotedNode_kyakf6_a0a0c0a;
          }
          if (quotedNode1_kyakf6_a0a0c0a != null) {
            quotedNode_kyakf6_a0a2a0.addChild("elementType", HUtil.copyIfNecessary(quotedNode1_kyakf6_a0a0c0a, typeCheckingContext));
          }
        }
        result = quotedNode1_kyakf6_a0a2a0;
      }
      return result;
    }

    public SNode createNode(Object parameter_kyakf6_a0a0a0c0a) {
      SNode result = null;
      Set<SNode> _parameterValues_129834374 = new HashSet<SNode>();
      SNode quotedNode_kyakf6_a0a2a0 = null;
      SNode quotedNode_kyakf6_a0a0c0a = null;
      {
        ...
        SNode quotedNode1_kyakf6_a0a2a0 = quotedNode_kyakf6_a0a2a0;
        {
          ...
          if (quotedNode1_kyakf6_a0a0c0a != null) {
            quotedNode_kyakf6_a0a2a0.addChild("elementType", HUtil.copyIfNecessary(quotedNode1_kyakf6_a0a0c0a));
          }
        }
        result = quotedNode1_kyakf6_a0a2a0;
      }
