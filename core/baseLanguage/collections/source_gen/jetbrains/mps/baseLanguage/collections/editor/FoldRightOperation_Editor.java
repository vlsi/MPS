...
public class FoldRightOperation_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createConceptProperty_bapds0_a0(EditorContext editorContext, SNode node) {
    ...
    editorCell.setSubstituteInfo(provider.createDefaultSubstituteInfo());
    editorCell.setSubstituteInfo(new CompositeSubstituteInfo(editorContext, provider.getCellContext(), new SubstituteInfoPart[]{new FoldRightOperation_Editor.FoldRightOperation_Editor_replaceWith_SequenceOperation_cellMenu_a0a0()}));
    SNode attributeConcept = provider.getRoleAttribute();
    Class attributeKind = provider.getRoleAttributeClass();
    if (attributeConcept != null) {
      IOperationContext opContext = editorContext.getOperationContext();
  ...
  public static class FoldRightOperation_Editor_replaceWith_SequenceOperation_cellMenu_a0a0 extends AbstractCellMenuPart_ReplaceNode_CustomNodeConcept {
    public FoldRightOperation_Editor_replaceWith_SequenceOperation_cellMenu_a0a0() {
    }
