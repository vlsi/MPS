...
public class BinaryOperation_Editor extends DefaultNodeEditor {
  ...
  public EditorCell createCollection_4282_0(EditorContext context, SNode node) {
    ...
    editorCell.addEditorCell(this.createConstant_4282_0(context, node, "("));
    editorCell.addEditorCell(this.createRefNode_4282_1(context, node));
    editorCell.addEditorCell(this.createConstant_4282_1(context, node, ")"));
    return editorCell;
  }

  public EditorCell createConstant_4282_0(EditorContext context, SNode node, String text) {
    EditorCell_Constant editorCell = new EditorCell_Constant(context, node, text);
    setupBasic_Constant_4282_0(editorCell, node, context);
    setupLabel_Constant_4282_0(editorCell, node, context);
    editorCell.setDefaultText("");
    return editorCell;
  }

  public EditorCell createConstant_4282_1(EditorContext context, SNode node, String text) {
    EditorCell_Constant editorCell = new EditorCell_Constant(context, node, text);
    setupBasic_Constant_4282_1(editorCell, node, context);
    setupLabel_Constant_4282_1(editorCell, node, context);
    editorCell.setDefaultText("");
    return editorCell;
  }
  ...
  private static void setupBasic_Constant_4282_0(EditorCell editorCell, SNode node, EditorContext context) {
    editorCell.setCellId("Constant_4282_0");
  ...
  private static void setupBasic_Constant_4282_1(EditorCell editorCell, SNode node, EditorContext context) {
    editorCell.setCellId("Constant_4282_1");
  ...
  private static void setupLabel_Constant_4282_0(EditorCell_Label editorCell, SNode node, EditorContext context) {
  }

  private static void setupLabel_RefNode_4282_0(EditorCell_Label editorCell, SNode node, EditorContext context) {
  }

  private static void setupLabel_Constant_4282_1(EditorCell_Label editorCell, SNode node, EditorContext context) {
  }
