...
public class supertypesOf_set_collection_SubtypingRule extends SubtypingRule_Runtime implements ISubtypingRule_Runtime {
  ...
  public SNode getSubOrSuperType(SNode st, TypeCheckingContext typeCheckingContext, IsApplicableStatus status) {
    return new supertypesOf_set_collection_SubtypingRule.QuotationClass_6kyuqk_a0a0a().createNode(SLinkOperations.getTarget(st, "elementType", true), typeCheckingContext);
  }
  ...
  public static class QuotationClass_6kyuqk_a0a0a {
    public QuotationClass_6kyuqk_a0a0a() {
    }
