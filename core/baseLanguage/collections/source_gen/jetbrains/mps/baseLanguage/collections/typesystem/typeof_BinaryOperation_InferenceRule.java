...
public class typeof_BinaryOperation_InferenceRule extends AbstractInferenceRule_Runtime implements InferenceRule_Runtime {
  ...
  public void applyRule(final SNode op, final TypeCheckingContext typeCheckingContext) {
    ...
    final SNode sequenceType_typevar_1184848409899 = typeCheckingContext.createNewRuntimeTypesVariable();
    {
      ...
      typeCheckingContext.createEquation((SNode) typeCheckingContext.getEquationManager().getRepresentator(sequenceType_typevar_1184848409899), (SNode) new typeof_BinaryOperation_InferenceRule.QuotationClass_nog713_a0a4a0().createNode(typeCheckingContext.getEquationManager().getRepresentator(elementType_typevar_1184848397564), typeCheckingContext), _info_12389875345);
    }
    {
  ...
  public static class QuotationClass_nog713_a0a4a0 {
    ...
    public SNode createNode(Object parameter_nog713_a0a0a0e0a, final TypeCheckingContext typeCheckingContext) {
      SNode result = null;
      Set<SNode> _parameterValues_129834374 = new HashSet<SNode>();
      SNode quotedNode_nog713_a0a4a0 = null;
      SNode quotedNode_nog713_a0a0e0a = null;
      {
        quotedNode_nog713_a0a4a0 = SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.baseLanguage.collections.structure.SequenceType", TypeChecker.getInstance().getRuntimeTypesModel(), GlobalScope.getInstance(), false);
        SNode quotedNode1_nog713_a0a4a0 = quotedNode_nog713_a0a4a0;
        {
          quotedNode_nog713_a0a0e0a = (SNode) parameter_nog713_a0a0a0e0a;
          SNode quotedNode1_nog713_a0a0e0a;
          if (_parameterValues_129834374.contains(quotedNode_nog713_a0a0e0a)) {
            quotedNode1_nog713_a0a0e0a = CopyUtil.copy(quotedNode_nog713_a0a0e0a);
          } else {
            _parameterValues_129834374.add(quotedNode_nog713_a0a0e0a);
            quotedNode1_nog713_a0a0e0a = quotedNode_nog713_a0a0e0a;
          }
          if (quotedNode1_nog713_a0a0e0a != null) {
            quotedNode_nog713_a0a4a0.addChild("elementType", HUtil.copyIfNecessary(quotedNode1_nog713_a0a0e0a, typeCheckingContext));
          }
        }
        result = quotedNode1_nog713_a0a4a0;
      }
      return result;
    }

    public SNode createNode(Object parameter_nog713_a0a0a0e0a) {
      SNode result = null;
      Set<SNode> _parameterValues_129834374 = new HashSet<SNode>();
      SNode quotedNode_nog713_a0a4a0 = null;
      SNode quotedNode_nog713_a0a0e0a = null;
      {
        ...
        SNode quotedNode1_nog713_a0a4a0 = quotedNode_nog713_a0a4a0;
        {
          ...
          if (quotedNode1_nog713_a0a0e0a != null) {
            quotedNode_nog713_a0a4a0.addChild("elementType", HUtil.copyIfNecessary(quotedNode1_nog713_a0a0e0a));
          }
        }
        result = quotedNode1_nog713_a0a4a0;
      }
