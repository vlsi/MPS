...
public class StopStatement_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createCollection_4255_0(EditorContext editorContext, SNode node) {
    ...
    editorCell.addEditorCell(this.createConstant_4255_0(editorContext, node, "stop"));
    editorCell.addEditorCell(this.createConstant_4255_1(editorContext, node, ";"));
    return editorCell;
  }

  private EditorCell createConstant_4255_0(EditorContext editorContext, SNode node, String text) {
  ...
  private EditorCell createConstant_4255_1(EditorContext editorContext, SNode node, String text) {
    EditorCell_Constant editorCell = new EditorCell_Constant(editorContext, node, text);
