...
public class RemoveElementOperation extends SingleArgumentSequenceOperation implements IListOperation, IQueueOperation, IStackOperation {
  ...
  public int get_$attributesCount() {
    return this.getChildCount(RemoveElementOperation._$ATTRIBUTE);
  }

  public Iterator<Attribute> _$attributes() {
    return this.children(Attribute.class, RemoveElementOperation._$ATTRIBUTE);
  }

  public List<Attribute> get_$attributes() {
    return this.getChildren(Attribute.class, RemoveElementOperation._$ATTRIBUTE);
  }

  public void add_$attribute(Attribute node) {
    this.addChild(RemoveElementOperation._$ATTRIBUTE, node);
  }

  public void insert_$attribute(Attribute prev, Attribute node) {
    this.insertChild(prev, RemoveElementOperation._$ATTRIBUTE, node);
  }
