            ...
            if (coercedNode_0 != null) {
              {
                ...
                typeCheckingContext.createEquation((SNode)typeCheckingContext.typeOf(expression, "r:00000000-0000-4000-0000-011c8959032b(jetbrains.mps.baseLanguage.collections.typesystem)", "1228231710394", true), (SNode)ClassifierTypeUtil.getTypeCoercedToClassifierType(coercedNode_0), _nodeToCheck_1029348928467, null, "r:00000000-0000-4000-0000-011c8959032b(jetbrains.mps.baseLanguage.collections.typesystem)", "1228231787457", intentionProvider);
              }
            } else
            {
            }
