...
public class SequenceOperation extends BaseConcept implements IOperation {
  ...
  public int get_$attributesCount() {
    return this.getChildCount(SequenceOperation._$ATTRIBUTE);
  }

  public Iterator<Attribute> _$attributes() {
    return this.children(Attribute.class, SequenceOperation._$ATTRIBUTE);
  }

  public List<Attribute> get_$attributes() {
    return this.getChildren(Attribute.class, SequenceOperation._$ATTRIBUTE);
  }

  public void add_$attribute(Attribute node) {
    this.addChild(SequenceOperation._$ATTRIBUTE, node);
  }

  public void insert_$attribute(Attribute prev, Attribute node) {
    this.insertChild(prev, SequenceOperation._$ATTRIBUTE, node);
  }
