...
public class StackType_Behavior {
  ...
  public static class QuotationClass_pawenb_a0a0b0b {
    ...
    public SNode createNode(Object parameter_5) {
      ...
      {
        quotedNode_1 = SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.baseLanguage.collections.structure.LinkedListCreator", TypeChecker.getInstance().getRuntimeTypesModel(), GlobalScope.getInstance(), false);
