...
public class RemoveFirstElementOperation extends NoArgumentsSequenceOperation implements IListOperation, IQueueOperation, IStackOperation {
  ...
  public int get_$attributesCount() {
    return this.getChildCount(RemoveFirstElementOperation._$ATTRIBUTE);
  }

  public Iterator<Attribute> _$attributes() {
    return this.children(Attribute.class, RemoveFirstElementOperation._$ATTRIBUTE);
  }

  public List<Attribute> get_$attributes() {
    return this.getChildren(Attribute.class, RemoveFirstElementOperation._$ATTRIBUTE);
  }

  public void add_$attribute(Attribute node) {
    this.addChild(RemoveFirstElementOperation._$ATTRIBUTE, node);
  }

  public void insert_$attribute(Attribute prev, Attribute node) {
    this.insertChild(prev, RemoveFirstElementOperation._$ATTRIBUTE, node);
  }
