...
public class ListType extends jetbrains.mps.baseLanguage.structure.Type {
  ...
  public jetbrains.mps.baseLanguage.structure.Type getElementType() {
    return (jetbrains.mps.baseLanguage.structure.Type)this.getChild(Type.class, ListType.ELEMENT_TYPE);
  }
