...
public class RemoveAllElementsOperation extends SingleArgumentSequenceOperation implements IListOperation, IQueueOperation, IStackOperation {
  ...
  public int get_$attributesCount() {
    return this.getChildCount(RemoveAllElementsOperation._$ATTRIBUTE);
  }

  public Iterator<Attribute> _$attributes() {
    return this.children(Attribute.class, RemoveAllElementsOperation._$ATTRIBUTE);
  }

  public List<Attribute> get_$attributes() {
    return this.getChildren(Attribute.class, RemoveAllElementsOperation._$ATTRIBUTE);
  }

  public void add_$attribute(Attribute node) {
    this.addChild(RemoveAllElementsOperation._$ATTRIBUTE, node);
  }

  public void insert_$attribute(Attribute prev, Attribute node) {
    this.insertChild(prev, RemoveAllElementsOperation._$ATTRIBUTE, node);
  }
