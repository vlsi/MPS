...
public class GetValuesOperation_Editor extends DefaultNodeEditor {
  ...
  public EditorCell createConceptProperty_9901_0_internal(EditorContext context, SNode node, CellProviderWithRole aProvider) {
    ...
    if (editorCell instanceof EditorCell_Label) {
      setupLabel_ConceptProperty_9901_0((EditorCell_Label)editorCell, node, context);
    }
    editorCell.setSubstituteInfo(provider.createDefaultSubstituteInfo());
    return editorCell;
  }

  public EditorCell createConceptProperty_9901_1(EditorContext context, SNode node) {
    CellProviderWithRole provider = new ConceptPropertyCellProvider(node, context);
    provider.setRole("alias");
    provider.setNoTargetText("<no alias>");
    provider.setReadOnly(false);
    provider.setAllowsEmptyTarget(false);
    EditorCell cellWithRole = this.createConceptProperty_9901_0_internal(context, node, provider);
  ...
  private static void setupLabel_ConceptProperty_9901_0(EditorCell_Label editorCell, SNode node, EditorContext context) {
  }
