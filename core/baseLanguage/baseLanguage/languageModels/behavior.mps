...
<model modelUID="r:00000000-0000-4000-0000-011c895902c0(jetbrains.mps.baseLanguage.behavior)">
  ...
  <node type="jetbrains.mps.lang.behavior.structure.ConceptBehavior" id="1213877327381">
    ...
    <node role="method" type="jetbrains.mps.lang.behavior.structure.ConceptMethodDeclaration" id="1231760744190">
      <property name="name" value="addVariableDeclarationBefore" />
      <link role="overriddenMethod" targetNodeId="1231760097557" resolveInfo="addVariableDeclarationBefore" />
      <node role="body" type="jetbrains.mps.baseLanguage.structure.StatementList" id="1231760744192">
        <node role="statement" type="jetbrains.mps.baseLanguage.structure.AssertStatement" id="1231760770271">
          <node role="condition" type="jetbrains.mps.baseLanguage.structure.EqualsExpression" id="1231760807509">
            <node role="rightExpression" type="jetbrains.mps.lang.behavior.structure.ThisNodeExpression" id="1231760811058" />
            <node role="leftExpression" type="jetbrains.mps.baseLanguage.structure.DotExpression" id="1231760776023">
              <node role="operand" type="jetbrains.mps.baseLanguage.structure.ParameterReference" id="1231760774256">
                <link role="variableDeclaration" targetNodeId="1231760752802" resolveInfo="statement" />
              </node>
              <node role="operation" type="jetbrains.mps.lang.smodel.structure.Node_GetParentOperation" id="1231760806367" />
            </node>
          </node>
        </node>
        <node role="statement" type="jetbrains.mps.baseLanguage.structure.LocalVariableDeclarationStatement" id="1231761210544">
          <node role="localVariableDeclaration" type="jetbrains.mps.baseLanguage.structure.LocalVariableDeclaration" id="1231761210545">
            <property name="name" value="newStatement" />
            <node role="initializer" type="jetbrains.mps.lang.quotation.structure.Quotation" id="1231761210546">
              <node role="quotedNode" type="jetbrains.mps.baseLanguage.structure.LocalVariableDeclarationStatement" id="1231761210547">
                <node role="localVariableDeclaration" type="jetbrains.mps.baseLanguage.structure.LocalVariableDeclaration" id="1231761210548">
                  <property name="name" value="s" />
                  <node role="type" type="jetbrains.mps.baseLanguage.structure.Type" id="1231761210549">
                    <node role="_attr_$attribute" type="jetbrains.mps.lang.quotation.structure.Antiquotation" id="1231761210550">
                      <node role="expression" type="jetbrains.mps.baseLanguage.structure.ParameterReference" id="1231764174286">
                        <link role="variableDeclaration" targetNodeId="1231764092241" resolveInfo="type" />
                      </node>
                    </node>
                  </node>
                  <node role="initializer" type="jetbrains.mps.baseLanguage.structure.Expression" id="1231761210556">
                    <node role="_attr_$attribute" type="jetbrains.mps.lang.quotation.structure.Antiquotation" id="1231761210557">
                      <node role="expression" type="jetbrains.mps.baseLanguage.structure.ParameterReference" id="1231764183869">
                        <link role="variableDeclaration" targetNodeId="1231764154626" resolveInfo="expression" />
                      </node>
                    </node>
                  </node>
                  <node role="propertyAntiquotation$property_attribute$name" type="jetbrains.mps.lang.quotation.structure.PropertyAntiquotation" id="1231761210563">
                    <node role="expression" type="jetbrains.mps.baseLanguage.structure.ParameterReference" id="1231764178351">
                      <link role="variableDeclaration" targetNodeId="1231764149560" resolveInfo="name" />
                    </node>
                  </node>
                </node>
              </node>
            </node>
            <node role="type" type="jetbrains.mps.lang.smodel.structure.SNodeType" id="1231761210567">
              <link role="concept" targetNodeId="1.1068581242864" resolveInfo="LocalVariableDeclarationStatement" />
            </node>
          </node>
        </node>
        <node role="statement" type="jetbrains.mps.baseLanguage.structure.ExpressionStatement" id="1231761189910">
          <node role="expression" type="jetbrains.mps.baseLanguage.structure.DotExpression" id="1231761190787">
            <node role="operand" type="jetbrains.mps.baseLanguage.structure.ParameterReference" id="1231761189911">
              <link role="variableDeclaration" targetNodeId="1231760752802" resolveInfo="statement" />
            </node>
            <node role="operation" type="jetbrains.mps.lang.smodel.structure.Node_InsertPrevSiblingOperation" id="1231761193837">
              <node role="insertedNode" type="jetbrains.mps.baseLanguage.structure.LocalVariableReference" id="1231761229196">
                <link role="variableDeclaration" targetNodeId="1231761210545" resolveInfo="newStatement" />
              </node>
            </node>
          </node>
        </node>
        <node role="statement" type="jetbrains.mps.baseLanguage.structure.ReturnStatement" id="1231761231558">
          <node role="expression" type="jetbrains.mps.baseLanguage.structure.DotExpression" id="1231761244217">
            <node role="operand" type="jetbrains.mps.baseLanguage.structure.LocalVariableReference" id="1231761243435">
              <link role="variableDeclaration" targetNodeId="1231761210545" resolveInfo="newStatement" />
            </node>
            <node role="operation" type="jetbrains.mps.lang.smodel.structure.SLinkAccess" id="1231761249174">
              <link role="link" targetNodeId="1.1068581242865" />
            </node>
          </node>
        </node>
      </node>
      <node role="parameter" type="jetbrains.mps.baseLanguage.structure.ParameterDeclaration" id="1231760752802">
        <property name="name" value="statement" />
        <node role="type" type="jetbrains.mps.lang.smodel.structure.SNodeType" id="1231760785899">
          <link role="concept" targetNodeId="1.1231760582267" resolveInfo="IStatement" />
        </node>
      </node>
      <node role="parameter" type="jetbrains.mps.baseLanguage.structure.ParameterDeclaration" id="1231764092241">
        <property name="name" value="type" />
        <node role="type" type="jetbrains.mps.lang.smodel.structure.SNodeType" id="1231764144762">
          <link role="concept" targetNodeId="1.1068431790189" resolveInfo="Type" />
        </node>
      </node>
      <node role="parameter" type="jetbrains.mps.baseLanguage.structure.ParameterDeclaration" id="1231764149560">
        <property name="name" value="name" />
        <node role="type" type="jetbrains.mps.baseLanguage.structure.StringType" id="1231764152578" />
      </node>
      <node role="parameter" type="jetbrains.mps.baseLanguage.structure.ParameterDeclaration" id="1231764154626">
        <property name="name" value="expression" />
        <node role="type" type="jetbrains.mps.lang.smodel.structure.SNodeType" id="1231764157034">
          <link role="concept" targetNodeId="1.1231758812390" resolveInfo="IExpression" />
        </node>
      </node>
      <node role="returnType" type="jetbrains.mps.lang.smodel.structure.SNodeType" id="1231760752804">
        <link role="concept" targetNodeId="1.1231760123645" resolveInfo="IVariableDeclaration" />
      </node>
      <node role="visibility" type="jetbrains.mps.baseLanguage.structure.PublicVisibility" id="1231761255972" />
    </node>
  ...
  <node type="jetbrains.mps.lang.behavior.structure.ConceptBehavior" id="1231760090415">
    <property name="package" value="refactoring" />
    <link role="concept" targetNodeId="1.1231758709942" resolveInfo="IStatementList" />
    <node role="method" type="jetbrains.mps.lang.behavior.structure.ConceptMethodDeclaration" id="1231760097557">
      <property name="name" value="addVariableDeclarationBefore" />
      <property name="isVirtual" value="true" />
      <property name="isAbstract" value="true" />
      <node role="returnType" type="jetbrains.mps.lang.smodel.structure.SNodeType" id="1231760111994">
        <link role="concept" targetNodeId="1.1231760123645" resolveInfo="IVariableDeclaration" />
      </node>
      <node role="parameter" type="jetbrains.mps.baseLanguage.structure.ParameterDeclaration" id="1231760181037">
        <property name="name" value="statement" />
        <node role="type" type="jetbrains.mps.lang.smodel.structure.SNodeType" id="1231760796946">
          <link role="concept" targetNodeId="1.1231760582267" resolveInfo="IStatement" />
        </node>
      </node>
      <node role="parameter" type="jetbrains.mps.baseLanguage.structure.ParameterDeclaration" id="1231765399304">
        <property name="name" value="type" />
        <node role="type" type="jetbrains.mps.lang.smodel.structure.SNodeType" id="1231765400670">
          <link role="concept" targetNodeId="1.1068431790189" resolveInfo="Type" />
        </node>
      </node>
      <node role="parameter" type="jetbrains.mps.baseLanguage.structure.ParameterDeclaration" id="1231766382031">
        <property name="name" value="name" />
        <node role="type" type="jetbrains.mps.baseLanguage.structure.ClassifierType" id="1231766707997">
          <link role="classifier" targetNodeId="2.~String" resolveInfo="String" />
        </node>
      </node>
      <node role="parameter" type="jetbrains.mps.baseLanguage.structure.ParameterDeclaration" id="1231765415245">
        <property name="name" value="expression" />
        <node role="type" type="jetbrains.mps.lang.smodel.structure.SNodeType" id="1231765416501">
          <link role="concept" targetNodeId="1.1068431790191" resolveInfo="Expression" />
        </node>
      </node>
      <node role="visibility" type="jetbrains.mps.baseLanguage.structure.PublicVisibility" id="1231760194048" />
    </node>
    <node role="constructor" type="jetbrains.mps.lang.behavior.structure.ConceptConstructorDeclaration" id="1231760090416">
      <node role="body" type="jetbrains.mps.baseLanguage.structure.StatementList" id="1231760090417" />
    </node>
  </node>
  <node type="jetbrains.mps.lang.behavior.structure.ConceptBehavior" id="1231761605071">
    <property name="package" value="refactoring" />
    <link role="concept" targetNodeId="1.1231760123645" resolveInfo="IVariableDeclaration" />
    <node role="method" type="jetbrains.mps.lang.behavior.structure.ConceptMethodDeclaration" id="1231761607590">
      <property name="name" value="createReference" />
      <property name="isVirtual" value="true" />
      <property name="isAbstract" value="true" />
      <node role="body" type="jetbrains.mps.baseLanguage.structure.StatementList" id="1231761607592" />
      <node role="returnType" type="jetbrains.mps.lang.smodel.structure.SNodeType" id="1231761662513">
        <link role="concept" targetNodeId="1.1231761629592" resolveInfo="IVariableReference" />
      </node>
      <node role="visibility" type="jetbrains.mps.baseLanguage.structure.PublicVisibility" id="1231761671498" />
    </node>
    <node role="constructor" type="jetbrains.mps.lang.behavior.structure.ConceptConstructorDeclaration" id="1231761605072">
      <node role="body" type="jetbrains.mps.baseLanguage.structure.StatementList" id="1231761605073" />
    </node>
  </node>
</model>
