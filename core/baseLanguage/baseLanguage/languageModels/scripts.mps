...
<model name="jetbrains.mps.baseLanguage.scripts">
  ...
  <import index="15" modelUID="jetbrains.mps.ide.progress@java_stub" version="-1" />
  <import index="16" modelUID="jetbrains.mps.project@java_stub" version="-1" />
  <import index="17" modelUID="jetbrains.mps.bootstrap.structureLanguage.findUsages@java_stub" version="-1" />
  <import index="18" modelUID="jetbrains.mps.ide.findusages.model@java_stub" version="-1" />
  <import index="19" modelUID="jetbrains.mps.ide.findusages.findalgorithm.resultproviders@java_stub" version="-1" />
        ...
        <node role="body" type="jetbrains.mps.baseLanguage.structure.StatementList" id="1208945034719">
          ...
          <node role="statement" type="jetbrains.mps.baseLanguage.structure.LocalVariableDeclarationStatement" id="1208945192422">
            <node role="localVariableDeclaration" type="jetbrains.mps.baseLanguage.structure.LocalVariableDeclaration" id="1208945192423">
              ...
              <node role="initializer" type="jetbrains.mps.baseLanguage.structure.NewExpression" id="1208945208331">
  ...
  <node type="jetbrains.mps.logging.refactoring.structure.Refactoring" id="1209830001419">
    ...
    <node role="affectedNodesClause" type="jetbrains.mps.logging.refactoring.structure.AffectedNodesClause" id="1209830543081">
      <node role="body" type="jetbrains.mps.baseLanguage.structure.StatementList" id="1209830543082">
        <node role="statement" type="jetbrains.mps.baseLanguage.structure.LocalVariableDeclarationStatement" id="1209830557331">
          <node role="localVariableDeclaration" type="jetbrains.mps.baseLanguage.structure.LocalVariableDeclaration" id="1209830557332">
            <property name="name" value="searchQuery" />
            <node role="type" type="jetbrains.mps.baseLanguage.structure.ClassifierType" id="1209830557333">
              <link role="classifier" targetNodeId="18.~SearchQuery" resolveInfo="SearchQuery" />
            </node>
            <node role="initializer" type="jetbrains.mps.baseLanguage.structure.NewExpression" id="1209830557334">
              <link role="baseMethodDeclaration" targetNodeId="18.~SearchQuery.&lt;init&gt;(jetbrains.mps.smodel.SNode,jetbrains.mps.smodel.IScope)" resolveInfo="SearchQuery" />
              <node role="actualArgument" type="jetbrains.mps.baseLanguage.structure.DotExpression" id="1209830557335">
                <node role="operand" type="jetbrains.mps.logging.refactoring.structure.ConceptFunctionParameter_ActionContext" id="1209830557336" />
                <node role="operation" type="jetbrains.mps.baseLanguage.structure.InstanceMethodCallOperation" id="1209830557337">
                  <link role="baseMethodDeclaration" targetNodeId="10.~ActionContext.getNode():jetbrains.mps.smodel.SNode" resolveInfo="getNode" />
                </node>
              </node>
              <node role="actualArgument" type="jetbrains.mps.baseLanguage.structure.StaticMethodCall" id="1209830557338">
                <link role="baseMethodDeclaration" targetNodeId="16.~GlobalScope.getInstance():jetbrains.mps.project.GlobalScope" resolveInfo="getInstance" />
                <link role="classConcept" targetNodeId="16.~GlobalScope" resolveInfo="GlobalScope" />
              </node>
            </node>
          </node>
        </node>
        <node role="statement" type="jetbrains.mps.baseLanguage.structure.LocalVariableDeclarationStatement" id="1209830557348">
          <node role="localVariableDeclaration" type="jetbrains.mps.baseLanguage.structure.LocalVariableDeclaration" id="1209830557349">
            ...
            <node role="type" type="jetbrains.mps.baseLanguage.structure.ClassifierType" id="1209830557350">
        ...
        <node role="statement" type="jetbrains.mps.baseLanguage.structure.LocalVariableDeclarationStatement" id="1209830557358">
          <node role="localVariableDeclaration" type="jetbrains.mps.baseLanguage.structure.LocalVariableDeclaration" id="1209830557359">
            <property name="name" value="resultProvider" />
            <node role="type" type="jetbrains.mps.baseLanguage.structure.ClassifierType" id="1209830557360">
              <link role="classifier" targetNodeId="18.~IResultProvider" resolveInfo="IResultProvider" />
            </node>
            <node role="initializer" type="jetbrains.mps.baseLanguage.structure.StaticMethodCall" id="1209830557361">
              <link role="baseMethodDeclaration" targetNodeId="19.~TreeBuilder.forFinder(jetbrains.mps.ide.findusages.findalgorithm.finders.BaseFinder):jetbrains.mps.ide.findusages.model.IResultProvider" resolveInfo="forFinder" />
              <link role="classConcept" targetNodeId="19.~TreeBuilder" resolveInfo="TreeBuilder" />
              <node role="actualArgument" type="jetbrains.mps.baseLanguage.structure.NewExpression" id="1209830656209">
                <link role="baseMethodDeclaration" targetNodeId="17.~NodeUsages_Finder.&lt;init&gt;()" resolveInfo="NodeUsages_Finder" />
              </node>
            </node>
          </node>
        </node>
        <node role="statement" type="jetbrains.mps.baseLanguage.structure.LocalVariableDeclarationStatement" id="1209830557363">
          <node role="localVariableDeclaration" type="jetbrains.mps.baseLanguage.structure.LocalVariableDeclaration" id="1209830557364">
            ...
            <node role="initializer" type="jetbrains.mps.baseLanguage.structure.DotExpression" id="1209830557366">
              <node role="operand" type="jetbrains.mps.baseLanguage.structure.LocalVariableReference" id="1209830557367">
                <link role="variableDeclaration" targetNodeId="1209830557359" resolveInfo="resultProvider" />
              </node>
              <node role="operation" type="jetbrains.mps.baseLanguage.structure.InstanceMethodCallOperation" id="1209830557368">
                <link role="baseMethodDeclaration" targetNodeId="18.~IResultProvider.getResults(jetbrains.mps.ide.findusages.model.SearchQuery,jetbrains.mps.ide.progress.IAdaptiveProgressMonitor):jetbrains.mps.ide.findusages.model.SearchResults" resolveInfo="getResults" />
                <node role="actualArgument" type="jetbrains.mps.baseLanguage.structure.LocalVariableReference" id="1209830557369">
                  <link role="variableDeclaration" targetNodeId="1209830557332" resolveInfo="searchQuery" />
                </node>
                <node role="actualArgument" type="jetbrains.mps.baseLanguage.structure.LocalVariableReference" id="1209830557370">
                  <link role="variableDeclaration" targetNodeId="1209830557349" resolveInfo="monitor" />
                </node>
              </node>
            </node>
          </node>
        ...
        <node role="statement" type="jetbrains.mps.baseLanguage.structure.LocalVariableDeclarationStatement" id="1209830714319">
          <node role="localVariableDeclaration" type="jetbrains.mps.baseLanguage.structure.LocalVariableDeclaration" id="1209830714320">
            ...
            <node role="initializer" type="jetbrains.mps.baseLanguage.structure.NewExpression" id="1209830733584">
