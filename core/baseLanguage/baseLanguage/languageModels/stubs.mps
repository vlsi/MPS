  ...
  <node type="jetbrains.mps.lang.stubs.structure.StubsCreatorDeclaration" id="5516999836374025628">
    ...
    <node role="method" type="jetbrains.mps.baseLanguage.classifiers.structure.DefaultClassifierMethodDeclaration:0" id="5516999836375009819">
      ...
      <node role="body:0" type="jetbrains.mps.baseLanguage.structure.StatementList:3" id="5516999836375009824">
        <node role="statement:3" type="jetbrains.mps.baseLanguage.structure.TryCatchStatement:3" id="1414612301320821941">
          <node role="body:3" type="jetbrains.mps.baseLanguage.structure.StatementList:3" id="1414612301320821942">
            <node role="statement:3" type="jetbrains.mps.baseLanguage.structure.ReturnStatement:3" id="1414612301320822056">
              <node role="expression:3" type="jetbrains.mps.baseLanguage.structure.StaticMethodCall:3" id="1414612301320822057">
                <link role="classConcept:3" targetNodeId="6.~AbstractClassPathItem" resolveInfo="AbstractClassPathItem" />
                <link role="baseMethodDeclaration:3" targetNodeId="6.~AbstractClassPathItem.createFromPath(java.lang.String):jetbrains.mps.reloading.IClassPathItem" resolveInfo="createFromPath" />
                <node role="actualArgument:3" type="jetbrains.mps.baseLanguage.structure.DotExpression:3" id="1414612301320822058">
                  <node role="operand:3" type="jetbrains.mps.baseLanguage.structure.ParameterReference:3" id="1414612301320822059">
                    <link role="variableDeclaration:3" targetNodeId="5516999836375009822" resolveInfo="location" />
                  </node>
                  <node role="operation:3" type="jetbrains.mps.baseLanguage.structure.InstanceMethodCallOperation:3" id="1414612301320822060">
          ...
          <node role="catchClause:3" type="jetbrains.mps.baseLanguage.structure.CatchClause:3" id="1414612301320821944">
            ...
            <node role="catchBody:3" type="jetbrains.mps.baseLanguage.structure.StatementList:3" id="1414612301320821947">
              <node role="statement:3" type="jetbrains.mps.baseLanguage.logging.structure.LogStatement:0" id="1414612301320822053">
                <property name="severity:0" value="error" />
                <property name="hasException:0" value="true" />
                <node role="logExpression:0" type="jetbrains.mps.baseLanguage.structure.StringLiteral:3" id="1414612301320822054" />
                <node role="exception:0" type="jetbrains.mps.baseLanguage.structure.LocalVariableReference:3" id="1414612301320822055">
                  <link role="variableDeclaration:3" targetNodeId="1414612301320821945" resolveInfo="e" />
                </node>
              </node>
              <node role="statement:3" type="jetbrains.mps.baseLanguage.structure.ReturnStatement:3" id="1414612301320822063">
                <node role="expression:3" type="jetbrains.mps.baseLanguage.structure.NullLiteral:3" id="1414612301320822065" />
              </node>
            </node>
          </node>
        </node>
