...
<model name="jetbrains.mps.baseLanguage.structure">
  ...
  <refactoringHistory>
    <refactoringContext modelVersion="0">
      ...
      <conceptFeatureMap>
        <entry>
          <key featureName="Annotable" conceptFQName="jetbrains.mps.baseLanguage.structure.Annotable"
               featureKind="CONCEPT"/>
          <value featureName="HasAnnotation" conceptFQName="jetbrains.mps.baseLanguage.structure.HasAnnotation"
                 featureKind="CONCEPT"/>
        </entry>
      </conceptFeatureMap>
    </refactoringContext>
  ...
  <node type="jetbrains.mps.bootstrap.structureLanguage.structure.ConceptDeclaration" id="1068580123152">
    ...
    <node role="conceptProperty" type="jetbrains.mps.bootstrap.structureLanguage.structure.IntegerConceptProperty"
          id="1166618247261">
  ...
  <node type="jetbrains.mps.bootstrap.structureLanguage.structure.ConceptDeclaration" id="1081773326031">
    ...
    <link role="extends" targetNodeId="1068431790191" resolveInfo="Expression"/>
    <node role="conceptPropertyDeclaration"
          type="jetbrains.mps.bootstrap.structureLanguage.structure.IntegerConceptPropertyDeclaration"
          id="1166617629900">
  ...
  <node type="jetbrains.mps.bootstrap.structureLanguage.structure.ConceptDeclaration" id="1107135704075">
    ...
    <node role="conceptLinkDeclaration"
          type="jetbrains.mps.bootstrap.structureLanguage.structure.AggregationConceptLinkDeclaration"
          id="1137545963098">
  ...
  <node type="jetbrains.mps.bootstrap.structureLanguage.structure.ConceptDeclaration" id="1137021947720">
    ...
    <node role="conceptLinkDeclaration"
          type="jetbrains.mps.bootstrap.structureLanguage.structure.ReferenceConceptLinkDeclaration" id="1161119487665">
