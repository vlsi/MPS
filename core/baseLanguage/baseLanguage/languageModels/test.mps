...
<model modelUID="r:00000000-0000-4000-0000-011c895902c7(jetbrains.mps.baseLanguage.test)">
  ...
  <node type="jetbrains.mps.lang.test.structure.NodesTestCase:4" id="1230544103882">
    <property name="package:4" value="dataFlow.nullable" />
    <property name="name:4" value="NullableDataFlow" />
    <node role="testMethods:4" type="jetbrains.mps.lang.test.structure.SimpleNodeTest:4" id="1230544200866">
      <property name="name:4" value="NullableDataFlow" />
      <node role="returnType:4" type="jetbrains.mps.baseLanguage.structure.VoidType:3" id="1230544200867" />
      <node role="body:4" type="jetbrains.mps.baseLanguage.structure.StatementList:3" id="1230544200868">
        <node role="statement:3" type="jetbrains.mps.baseLanguage.structure.LocalVariableDeclarationStatement:3" id="1230544270996">
          <node role="localVariableDeclaration:3" type="jetbrains.mps.baseLanguage.structure.LocalVariableDeclaration:3" id="1230544270997">
            <property name="name:3" value="p" />
            <node role="type:3" type="jetbrains.mps.baseLanguage.structure.ClassifierType:3" id="1230544270998">
              <link role="classifier:3" targetNodeId="41.~Program" resolveInfo="Program" />
            </node>
            <node role="initializer:3" type="jetbrains.mps.baseLanguage.structure.DotExpression:3" id="1230544441425">
              <node role="operand:3" type="jetbrains.mps.baseLanguage.structure.StaticMethodCall:3" id="1230544438674">
                <link role="baseMethodDeclaration:3" targetNodeId="43.~DataFlowManager.getInstance():jetbrains.mps.lang.dataFlow.DataFlowManager" resolveInfo="getInstance" />
                <link role="classConcept:3" targetNodeId="43.~DataFlowManager" resolveInfo="DataFlowManager" />
              </node>
              <node role="operation:3" type="jetbrains.mps.baseLanguage.structure.InstanceMethodCallOperation:3" id="1230544448538">
                <link role="baseMethodDeclaration:3" targetNodeId="43.~DataFlowManager.buildProgramFor(jetbrains.mps.smodel.SNode):jetbrains.mps.lang.dataFlow.framework.Program" resolveInfo="buildProgramFor" />
                <node role="actualArgument:3" type="jetbrains.mps.lang.test.structure.TestNodeReference:4" id="1230544459945">
                  <link role="declaration:4" targetNodeId="1230544214448" resolveInfo="statements" />
                </node>
              </node>
            </node>
          </node>
        </node>
        <node role="statement:3" type="jetbrains.mps.baseLanguage.structure.LocalVariableDeclarationStatement:3" id="1230544492760">
          <node role="localVariableDeclaration:3" type="jetbrains.mps.baseLanguage.structure.LocalVariableDeclaration:3" id="1230544492761">
            <property name="name:3" value="result" />
            <node role="type:3" type="jetbrains.mps.baseLanguage.structure.ClassifierType:3" id="1230544492762">
              <link role="classifier:3" targetNodeId="41.~AnalysisResult" resolveInfo="AnalysisResult" />
              <node role="parameter:3" type="jetbrains.mps.baseLanguage.collections.structure.MapType:7" id="1230544499702">
                <node role="keyType:7" type="jetbrains.mps.lang.smodel.structure.SNodeType:16" id="1230544503580" />
                <node role="valueType:7" type="jetbrains.mps.baseLanguage.structure.ClassifierType:3" id="1230544511425">
                  <link role="classifier:3" targetNodeId="44.1230466569958" resolveInfo="NullableVariableState" />
                </node>
              </node>
            </node>
            <node role="initializer:3" type="jetbrains.mps.baseLanguage.structure.DotExpression:3" id="1230544518943">
              <node role="operand:3" type="jetbrains.mps.baseLanguage.structure.LocalVariableReference:3" id="1230544518224">
                <link role="variableDeclaration:3" targetNodeId="1230544270997" resolveInfo="p" />
              </node>
              <node role="operation:3" type="jetbrains.mps.baseLanguage.structure.InstanceMethodCallOperation:3" id="1230544522775">
                <link role="baseMethodDeclaration:3" targetNodeId="41.~Program.analyze(jetbrains.mps.lang.dataFlow.framework.DataFlowAnalyzer):jetbrains.mps.lang.dataFlow.framework.AnalysisResult" resolveInfo="analyze" />
                <node role="actualArgument:3" type="jetbrains.mps.baseLanguage.structure.GenericNewExpression:3" id="1230544525777">
                  <node role="creator:3" type="jetbrains.mps.baseLanguage.structure.ClassCreator:3" id="1230544533187">
                    <link role="baseMethodDeclaration:3" targetNodeId="44.1230465993865" resolveInfo="NullableAnalyser" />
                    <node role="typeParameter:3" type="jetbrains.mps.lang.smodel.structure.SNodeType:16" id="1230544537033" />
                  </node>
                </node>
              </node>
            </node>
        ...
        <node role="statement:3" type="jetbrains.mps.baseLanguage.structure.LocalVariableDeclarationStatement:3" id="1230544609652">
          <node role="localVariableDeclaration:3" type="jetbrains.mps.baseLanguage.structure.LocalVariableDeclaration:3" id="1230544609653">
            <property name="name:3" value="map" />
            <node role="type:3" type="jetbrains.mps.baseLanguage.collections.structure.MapType:7" id="1230544611343">
              <node role="keyType:7" type="jetbrains.mps.lang.smodel.structure.SNodeType:16" id="1230544611344" />
              <node role="valueType:7" type="jetbrains.mps.baseLanguage.structure.ClassifierType:3" id="1230544611345">
                <link role="classifier:3" targetNodeId="44.1230466569958" resolveInfo="NullableVariableState" />
              </node>
            </node>
            <node role="initializer:3" type="jetbrains.mps.baseLanguage.structure.DotExpression:3" id="1230544626191">
              <node role="operand:3" type="jetbrains.mps.baseLanguage.structure.LocalVariableReference:3" id="1230544626192">
                <link role="variableDeclaration:3" targetNodeId="1230544492761" resolveInfo="result" />
              </node>
              <node role="operation:3" type="jetbrains.mps.baseLanguage.structure.InstanceMethodCallOperation:3" id="1230544626193">
                <link role="baseMethodDeclaration:3" targetNodeId="41.~AnalysisResult.get(jetbrains.mps.lang.dataFlow.framework.instructions.Instruction):java.lang.Object" resolveInfo="get" />
                <node role="actualArgument:3" type="jetbrains.mps.baseLanguage.collections.structure.ListElementAccessExpression:7" id="1238597790933">
                  <node role="list:7" type="jetbrains.mps.baseLanguage.structure.ParenthesizedExpression:3" id="1238597731928">
                    <node role="expression:3" type="jetbrains.mps.baseLanguage.structure.CastExpression:3" id="1238597731929">
                      <node role="expression:3" type="jetbrains.mps.baseLanguage.structure.DotExpression:3" id="1238597731930">
                        <node role="operand:3" type="jetbrains.mps.baseLanguage.structure.LocalVariableReference:3" id="1238597731931">
                          <link role="variableDeclaration:3" targetNodeId="1230544270997" resolveInfo="p" />
                        </node>
                        <node role="operation:3" type="jetbrains.mps.baseLanguage.structure.InstanceMethodCallOperation:3" id="1238597731932">
                          <link role="baseMethodDeclaration:3" targetNodeId="41.~Program.getInstructionsFor(java.lang.Object):java.util.List" resolveInfo="getInstructionsFor" />
                          <node role="actualArgument:3" type="jetbrains.mps.lang.test.structure.TestNodeReference:4" id="1238597731933">
                            <link role="declaration:4" targetNodeId="1230544235012" resolveInfo="reference" />
                          </node>
                        </node>
                      </node>
                      <node role="type:3" type="jetbrains.mps.baseLanguage.collections.structure.ListType:7" id="1238597736171">
                        <node role="elementType:7" type="jetbrains.mps.baseLanguage.structure.ClassifierType:3" id="1238597742945">
                          <link role="classifier:3" targetNodeId="46.~Instruction" resolveInfo="Instruction" />
                        </node>
                      </node>
                    </node>
                  </node>
                  <node role="index:7" type="jetbrains.mps.baseLanguage.structure.IntegerConstant:3" id="1238597790934">
                    <property name="value:3" value="0" />
                  </node>
                </node>
              </node>
        ...
        <node role="statement:3" type="jetbrains.mps.baseLanguage.unitTest.structure.AssertEquals" id="1230544639256">
          <node role="expected" type="jetbrains.mps.baseLanguage.structure.EnumConstantReference:3" id="1230544650979">
            <link role="enumConstantDeclaration:3" targetNodeId="44.1230466710001" resolveInfo="NULLABLE" />
            <link role="enumClass:3" targetNodeId="44.1230466569958" resolveInfo="NullableVariableState" />
          </node>
          <node role="actual" type="jetbrains.mps.baseLanguage.collections.structure.MapElement:7" id="1238582947928">
            <node role="key:7" type="jetbrains.mps.lang.test.structure.TestNodeReference:4" id="1238582947929">
              <link role="declaration:4" targetNodeId="1230544223917" resolveInfo="declaration" />
            </node>
            <node role="map:7" type="jetbrains.mps.baseLanguage.structure.LocalVariableReference:3" id="1230544654652">
              <link role="variableDeclaration:3" targetNodeId="1230544609653" resolveInfo="map" />
            </node>
          </node>
        </node>
      </node>
    </node>
    <node role="nodesToCheck:4" type="jetbrains.mps.lang.test.structure.TestNode:4" id="1230544118134">
      <node role="nodeToCheck:4" type="jetbrains.mps.baseLanguage.structure.InstanceMethodDeclaration:3" id="1230544125947">
        <property name="name:3" value="method" />
        <node role="returnType:3" type="jetbrains.mps.baseLanguage.structure.StringType:3" id="4859441577819743987" />
        <node role="visibility:3" type="jetbrains.mps.baseLanguage.structure.PublicVisibility:3" id="1230544125949" />
        <node role="body:3" type="jetbrains.mps.baseLanguage.structure.StatementList:3" id="1230544125950">
          <node role="statement:3" type="jetbrains.mps.baseLanguage.structure.LocalVariableDeclarationStatement:3" id="1230544157047">
            <node role="localVariableDeclaration:3" type="jetbrains.mps.baseLanguage.structure.LocalVariableDeclaration:3" id="1230544157048">
              <property name="name:3" value="s" />
              <node role="type:3" type="jetbrains.mps.baseLanguage.structure.StringType:3" id="4859441577819743986" />
              <node role="testNode$attribute:3" type="jetbrains.mps.lang.test.structure.TestNodeAnnotation:4" id="1230544223917">
                <property name="name:4" value="declaration" />
              </node>
            </node>
          </node>
          <node role="statement:3" type="jetbrains.mps.baseLanguage.structure.IfStatement:3" id="1230544164569">
            <node role="ifTrue:3" type="jetbrains.mps.baseLanguage.structure.StatementList:3" id="1230544164570">
              <node role="statement:3" type="jetbrains.mps.baseLanguage.structure.ExpressionStatement:3" id="1230544170172">
                <node role="expression:3" type="jetbrains.mps.baseLanguage.structure.AssignmentExpression:3" id="1230544171065">
                  <node role="rValue:3" type="jetbrains.mps.baseLanguage.structure.NullLiteral:3" id="1230544171708" />
                  <node role="lValue:3" type="jetbrains.mps.baseLanguage.structure.LocalVariableReference:3" id="1230544170173">
                    <link role="variableDeclaration:3" targetNodeId="1230544157048" resolveInfo="s" />
                  </node>
                </node>
              </node>
            </node>
            <node role="condition:3" type="jetbrains.mps.baseLanguage.structure.GreaterThanExpression:3" id="1230544167449">
              <node role="rightExpression:3" type="jetbrains.mps.baseLanguage.structure.IntegerConstant:3" id="1230544167952">
                <property name="value:3" value="0" />
              </node>
              <node role="leftExpression:3" type="jetbrains.mps.baseLanguage.structure.ParameterReference:3" id="1230544166229">
                <link role="variableDeclaration:3" targetNodeId="1230544162552" resolveInfo="p" />
              </node>
            </node>
            <node role="ifFalseStatement:3" type="jetbrains.mps.baseLanguage.structure.BlockStatement:3" id="1230544174991">
              <node role="statements:3" type="jetbrains.mps.baseLanguage.structure.StatementList:3" id="1230544174992">
                <node role="statement:3" type="jetbrains.mps.baseLanguage.structure.ExpressionStatement:3" id="1230544176899">
                  <node role="expression:3" type="jetbrains.mps.baseLanguage.structure.AssignmentExpression:3" id="1230544178573">
                    <node role="rValue:3" type="jetbrains.mps.baseLanguage.structure.StringLiteral:3" id="1230544178888">
                      <property name="value:3" value="" />
                    </node>
                    <node role="lValue:3" type="jetbrains.mps.baseLanguage.structure.LocalVariableReference:3" id="1230544176900">
                      <link role="variableDeclaration:3" targetNodeId="1230544157048" resolveInfo="s" />
                    </node>
                  </node>
                </node>
          ...
          <node role="statement:3" type="jetbrains.mps.baseLanguage.structure.ReturnStatement:3" id="1230544183250">
            <node role="expression:3" type="jetbrains.mps.baseLanguage.structure.LocalVariableReference:3" id="1230544185658">
              <link role="variableDeclaration:3" targetNodeId="1230544157048" resolveInfo="s" />
              <node role="testNode$attribute:3" type="jetbrains.mps.lang.test.structure.TestNodeAnnotation:4" id="1230544235012">
                <property name="name:4" value="reference" />
              </node>
            </node>
          </node>
          <node role="testNode$attribute:3" type="jetbrains.mps.lang.test.structure.TestNodeAnnotation:4" id="1230544214448">
            <property name="name:4" value="statements" />
          </node>
        </node>
        <node role="parameter:3" type="jetbrains.mps.baseLanguage.structure.ParameterDeclaration:3" id="1230544162552">
          <property name="name:3" value="p" />
          <node role="type:3" type="jetbrains.mps.baseLanguage.structure.IntegerType:3" id="1230544162553" />
        </node>
      </node>
    </node>
  </node>
  <node type="jetbrains.mps.lang.test.structure.NodesTestCase:4" id="1230558053036">
    <property name="package:4" value="dataFlow.nullable" />
    <property name="name:4" value="NullableAnnotations" />
    <node role="testMethods:4" type="jetbrains.mps.lang.test.structure.SimpleNodeTest:4" id="1230558242107">
      <property name="name:4" value="NullableAnnotations" />
      <node role="returnType:4" type="jetbrains.mps.baseLanguage.structure.VoidType:3" id="1230558242108" />
      <node role="body:4" type="jetbrains.mps.baseLanguage.structure.StatementList:3" id="1230558242109">
        <node role="statement:3" type="jetbrains.mps.baseLanguage.structure.LocalVariableDeclarationStatement:3" id="1230558243485">
          <node role="localVariableDeclaration:3" type="jetbrains.mps.baseLanguage.structure.LocalVariableDeclaration:3" id="1230558243486">
            <property name="name:3" value="p" />
            <node role="type:3" type="jetbrains.mps.baseLanguage.structure.ClassifierType:3" id="1230558243487">
              <link role="classifier:3" targetNodeId="41.~Program" resolveInfo="Program" />
            </node>
            <node role="initializer:3" type="jetbrains.mps.baseLanguage.structure.DotExpression:3" id="1230558243488">
              <node role="operand:3" type="jetbrains.mps.baseLanguage.structure.StaticMethodCall:3" id="1230558243489">
                <link role="classConcept:3" targetNodeId="43.~DataFlowManager" resolveInfo="DataFlowManager" />
                <link role="baseMethodDeclaration:3" targetNodeId="43.~DataFlowManager.getInstance():jetbrains.mps.lang.dataFlow.DataFlowManager" resolveInfo="getInstance" />
              </node>
              <node role="operation:3" type="jetbrains.mps.baseLanguage.structure.InstanceMethodCallOperation:3" id="1230558243490">
                <link role="baseMethodDeclaration:3" targetNodeId="43.~DataFlowManager.buildProgramFor(jetbrains.mps.smodel.SNode):jetbrains.mps.lang.dataFlow.framework.Program" resolveInfo="buildProgramFor" />
                <node role="actualArgument:3" type="jetbrains.mps.lang.test.structure.TestNodeReference:4" id="1230558318554">
                  <link role="declaration:4" targetNodeId="1230558294662" resolveInfo="statements" />
                </node>
              </node>
            </node>
          </node>
        </node>
        <node role="statement:3" type="jetbrains.mps.baseLanguage.structure.LocalVariableDeclarationStatement:3" id="1230558243492">
          <node role="localVariableDeclaration:3" type="jetbrains.mps.baseLanguage.structure.LocalVariableDeclaration:3" id="1230558243493">
            <property name="name:3" value="result" />
            <node role="type:3" type="jetbrains.mps.baseLanguage.structure.ClassifierType:3" id="1230558243494">
              <link role="classifier:3" targetNodeId="41.~AnalysisResult" resolveInfo="AnalysisResult" />
              <node role="parameter:3" type="jetbrains.mps.baseLanguage.collections.structure.MapType:7" id="1230558243495">
                <node role="keyType:7" type="jetbrains.mps.lang.smodel.structure.SNodeType:16" id="1230558243496" />
                <node role="valueType:7" type="jetbrains.mps.baseLanguage.structure.ClassifierType:3" id="1230558243497">
                  <link role="classifier:3" targetNodeId="44.1230466569958" resolveInfo="NullableVariableState" />
                </node>
              </node>
            </node>
            <node role="initializer:3" type="jetbrains.mps.baseLanguage.structure.DotExpression:3" id="1230558243498">
              <node role="operand:3" type="jetbrains.mps.baseLanguage.structure.LocalVariableReference:3" id="1230558243499">
                <link role="variableDeclaration:3" targetNodeId="1230558243486" resolveInfo="p" />
              </node>
              <node role="operation:3" type="jetbrains.mps.baseLanguage.structure.InstanceMethodCallOperation:3" id="1230558243500">
                <link role="baseMethodDeclaration:3" targetNodeId="41.~Program.analyze(jetbrains.mps.lang.dataFlow.framework.DataFlowAnalyzer):jetbrains.mps.lang.dataFlow.framework.AnalysisResult" resolveInfo="analyze" />
                <node role="actualArgument:3" type="jetbrains.mps.baseLanguage.structure.GenericNewExpression:3" id="1230558243501">
                  <node role="creator:3" type="jetbrains.mps.baseLanguage.structure.ClassCreator:3" id="1230558243502">
                    <link role="baseMethodDeclaration:3" targetNodeId="44.1230465993865" resolveInfo="NullableAnalyser" />
                    <node role="typeParameter:3" type="jetbrains.mps.lang.smodel.structure.SNodeType:16" id="1230558243503" />
                  </node>
                </node>
              </node>
            </node>
        ...
        <node role="statement:3" type="jetbrains.mps.baseLanguage.structure.LocalVariableDeclarationStatement:3" id="1230558243504">
          <node role="localVariableDeclaration:3" type="jetbrains.mps.baseLanguage.structure.LocalVariableDeclaration:3" id="1230558243505">
            <property name="name:3" value="map" />
            <node role="type:3" type="jetbrains.mps.baseLanguage.collections.structure.MapType:7" id="1230558243506">
              <node role="keyType:7" type="jetbrains.mps.lang.smodel.structure.SNodeType:16" id="1230558243507" />
              <node role="valueType:7" type="jetbrains.mps.baseLanguage.structure.ClassifierType:3" id="1230558243508">
                <link role="classifier:3" targetNodeId="44.1230466569958" resolveInfo="NullableVariableState" />
              </node>
            </node>
            <node role="initializer:3" type="jetbrains.mps.baseLanguage.structure.DotExpression:3" id="1230558243509">
              <node role="operand:3" type="jetbrains.mps.baseLanguage.structure.LocalVariableReference:3" id="1230558243510">
                <link role="variableDeclaration:3" targetNodeId="1230558243493" resolveInfo="result" />
              </node>
              <node role="operation:3" type="jetbrains.mps.baseLanguage.structure.InstanceMethodCallOperation:3" id="1230558243511">
                <link role="baseMethodDeclaration:3" targetNodeId="41.~AnalysisResult.get(jetbrains.mps.lang.dataFlow.framework.instructions.Instruction):java.lang.Object" resolveInfo="get" />
                <node role="actualArgument:3" type="jetbrains.mps.baseLanguage.collections.structure.ListElementAccessExpression:7" id="1238597790929">
                  <node role="list:7" type="jetbrains.mps.baseLanguage.structure.ParenthesizedExpression:3" id="1238597661777">
                    <node role="expression:3" type="jetbrains.mps.baseLanguage.structure.CastExpression:3" id="1238597661778">
                      <node role="expression:3" type="jetbrains.mps.baseLanguage.structure.DotExpression:3" id="1238597661779">
                        <node role="operand:3" type="jetbrains.mps.baseLanguage.structure.LocalVariableReference:3" id="1238597661780">
                          <link role="variableDeclaration:3" targetNodeId="1230558243486" resolveInfo="p" />
                        </node>
                        <node role="operation:3" type="jetbrains.mps.baseLanguage.structure.InstanceMethodCallOperation:3" id="1238597661781">
                          <link role="baseMethodDeclaration:3" targetNodeId="41.~Program.getInstructionsFor(java.lang.Object):java.util.List" resolveInfo="getInstructionsFor" />
                          <node role="actualArgument:3" type="jetbrains.mps.lang.test.structure.TestNodeReference:4" id="1238597661782">
                            <link role="declaration:4" targetNodeId="1230558538488" resolveInfo="reference" />
                          </node>
                        </node>
                      </node>
                      <node role="type:3" type="jetbrains.mps.baseLanguage.collections.structure.ListType:7" id="1238597673033">
                        <node role="elementType:7" type="jetbrains.mps.baseLanguage.structure.ClassifierType:3" id="1238597719844">
                          <link role="classifier:3" targetNodeId="46.~Instruction" resolveInfo="Instruction" />
                        </node>
                      </node>
                    </node>
                  </node>
                  <node role="index:7" type="jetbrains.mps.baseLanguage.structure.IntegerConstant:3" id="1238597790930">
                    <property name="value:3" value="0" />
                  </node>
                </node>
              </node>
        ...
        <node role="statement:3" type="jetbrains.mps.baseLanguage.unitTest.structure.AssertEquals" id="1230558243519">
          <node role="expected" type="jetbrains.mps.baseLanguage.structure.EnumConstantReference:3" id="1230558243520">
            <link role="enumClass:3" targetNodeId="44.1230466569958" resolveInfo="NullableVariableState" />
            <link role="enumConstantDeclaration:3" targetNodeId="44.1230466710001" resolveInfo="NULLABLE" />
          </node>
          <node role="actual" type="jetbrains.mps.baseLanguage.collections.structure.MapElement:7" id="1238582947909">
            <node role="key:7" type="jetbrains.mps.lang.test.structure.TestNodeReference:4" id="1238582947910">
              <link role="declaration:4" targetNodeId="1230558468329" resolveInfo="declaration" />
            </node>
            <node role="map:7" type="jetbrains.mps.baseLanguage.structure.LocalVariableReference:3" id="1230558243522">
              <link role="variableDeclaration:3" targetNodeId="1230558243505" resolveInfo="map" />
            </node>
          </node>
        </node>
      </node>
    </node>
    <node role="nodesToCheck:4" type="jetbrains.mps.lang.test.structure.TestNode:4" id="1230558175127">
      <node role="nodeToCheck:4" type="jetbrains.mps.baseLanguage.structure.ClassConcept:3" id="1230558227251">
        <property name="name:3" value="Clazz" />
        <node role="field:3" type="jetbrains.mps.baseLanguage.structure.FieldDeclaration:3" id="1230558331608">
          <property name="name:3" value="nullable" />
          <node role="visibility:3" type="jetbrains.mps.baseLanguage.structure.PrivateVisibility:3" id="1230558331609" />
          <node role="type:3" type="jetbrains.mps.baseLanguage.structure.StringType:3" id="4859441577819743977" />
          <node role="annotation:3" type="jetbrains.mps.baseLanguage.structure.AnnotationInstance:3" id="1230558372912">
            <link role="annotation:3" targetNodeId="45.~Nullable" resolveInfo="Nullable" />
          </node>
        </node>
        <node role="method:3" type="jetbrains.mps.baseLanguage.structure.InstanceMethodDeclaration:3" id="1230558381512">
          <property name="name:3" value="notNullable" />
          <node role="returnType:3" type="jetbrains.mps.baseLanguage.structure.StringType:3" id="4859441577819743978" />
          <node role="visibility:3" type="jetbrains.mps.baseLanguage.structure.PublicVisibility:3" id="1230558381514" />
          <node role="body:3" type="jetbrains.mps.baseLanguage.structure.StatementList:3" id="1230558381515">
            <node role="statement:3" type="jetbrains.mps.baseLanguage.structure.ReturnStatement:3" id="1230558427397">
              <node role="expression:3" type="jetbrains.mps.baseLanguage.structure.StringLiteral:3" id="1230558433276">
                <property name="value:3" value="" />
              </node>
            </node>
          </node>
          <node role="annotation:3" type="jetbrains.mps.baseLanguage.structure.AnnotationInstance:3" id="1230558410379">
            <link role="annotation:3" targetNodeId="45.~NotNull" resolveInfo="NotNull" />
          </node>
        </node>
        <node role="method:3" type="jetbrains.mps.baseLanguage.structure.InstanceMethodDeclaration:3" id="1230558270486">
          <property name="name:3" value="method" />
          <node role="returnType:3" type="jetbrains.mps.baseLanguage.structure.VoidType:3" id="1230558270487" />
          <node role="visibility:3" type="jetbrains.mps.baseLanguage.structure.PublicVisibility:3" id="1230558270488" />
          <node role="body:3" type="jetbrains.mps.baseLanguage.structure.StatementList:3" id="1230558270489">
            <node role="testNode$attribute:3" type="jetbrains.mps.lang.test.structure.TestNodeAnnotation:4" id="1230558294662">
              <property name="name:4" value="statements" />
            </node>
            <node role="statement:3" type="jetbrains.mps.baseLanguage.structure.LocalVariableDeclarationStatement:3" id="1230558440965">
              <node role="localVariableDeclaration:3" type="jetbrains.mps.baseLanguage.structure.LocalVariableDeclaration:3" id="1230558440966">
                <property name="name:3" value="str" />
                <node role="type:3" type="jetbrains.mps.baseLanguage.structure.StringType:3" id="4859441577819743979" />
                <node role="testNode$attribute:3" type="jetbrains.mps.lang.test.structure.TestNodeAnnotation:4" id="1230558468329">
                  <property name="name:4" value="declaration" />
                </node>
              </node>
            </node>
            <node role="statement:3" type="jetbrains.mps.baseLanguage.structure.IfStatement:3" id="1230558480486">
              <node role="ifTrue:3" type="jetbrains.mps.baseLanguage.structure.StatementList:3" id="1230558480487">
                <node role="statement:3" type="jetbrains.mps.baseLanguage.structure.ExpressionStatement:3" id="1230558493419">
                  <node role="expression:3" type="jetbrains.mps.baseLanguage.structure.AssignmentExpression:3" id="1230558495234">
                    <node role="rValue:3" type="jetbrains.mps.baseLanguage.structure.DotExpression:3" id="1230558503112">
                      <node role="operation:3" type="jetbrains.mps.baseLanguage.structure.FieldReferenceOperation:3" id="1230558503113">
                        <link role="fieldDeclaration:3" targetNodeId="1230558331608" resolveInfo="nullable" />
                      </node>
                      <node role="operand:3" type="jetbrains.mps.baseLanguage.structure.ThisExpression:3" id="1230558503114" />
                    </node>
                    <node role="lValue:3" type="jetbrains.mps.baseLanguage.structure.LocalVariableReference:3" id="1230558493420">
                      <link role="variableDeclaration:3" targetNodeId="1230558440966" resolveInfo="str" />
                    </node>
                  </node>
                </node>
              </node>
              <node role="condition:3" type="jetbrains.mps.baseLanguage.structure.GreaterThanExpression:3" id="1230558487727">
                <node role="rightExpression:3" type="jetbrains.mps.baseLanguage.structure.IntegerConstant:3" id="1230558488434">
                  <property name="value:3" value="0" />
                </node>
                <node role="leftExpression:3" type="jetbrains.mps.baseLanguage.structure.ParameterReference:3" id="1230558486242">
                  <link role="variableDeclaration:3" targetNodeId="1230558483334" resolveInfo="p" />
                </node>
              </node>
              <node role="ifFalseStatement:3" type="jetbrains.mps.baseLanguage.structure.BlockStatement:3" id="1230558507162">
                <node role="statements:3" type="jetbrains.mps.baseLanguage.structure.StatementList:3" id="1230558507163">
                  <node role="statement:3" type="jetbrains.mps.baseLanguage.structure.ExpressionStatement:3" id="1230558513289">
                    <node role="expression:3" type="jetbrains.mps.baseLanguage.structure.AssignmentExpression:3" id="1230558515838">
                      <node role="rValue:3" type="jetbrains.mps.baseLanguage.structure.DotExpression:3" id="1230558519653">
                        <node role="operation:3" type="jetbrains.mps.baseLanguage.structure.InstanceMethodCallOperation:3" id="1230558519654">
                          <link role="baseMethodDeclaration:3" targetNodeId="1230558381512" resolveInfo="notNullable" />
                        </node>
                        <node role="operand:3" type="jetbrains.mps.baseLanguage.structure.ThisExpression:3" id="1230558519655" />
                      </node>
                      <node role="lValue:3" type="jetbrains.mps.baseLanguage.structure.LocalVariableReference:3" id="1230558513290">
                        <link role="variableDeclaration:3" targetNodeId="1230558440966" resolveInfo="str" />
                      </node>
                    </node>
                  </node>
            ...
            <node role="statement:3" type="jetbrains.mps.baseLanguage.structure.ExpressionStatement:3" id="1230558533798">
              <node role="expression:3" type="jetbrains.mps.baseLanguage.structure.LocalVariableReference:3" id="1230558533799">
                <link role="variableDeclaration:3" targetNodeId="1230558440966" resolveInfo="str" />
                <node role="testNode$attribute:3" type="jetbrains.mps.lang.test.structure.TestNodeAnnotation:4" id="1230558538488">
                  <property name="name:4" value="reference" />
                </node>
              </node>
            </node>
          </node>
          <node role="parameter:3" type="jetbrains.mps.baseLanguage.structure.ParameterDeclaration:3" id="1230558483334">
            <property name="name:3" value="p" />
            <node role="type:3" type="jetbrains.mps.baseLanguage.structure.IntegerType:3" id="1230558483335" />
          </node>
        </node>
        <node role="visibility:3" type="jetbrains.mps.baseLanguage.structure.PublicVisibility:3" id="1230558227252" />
      </node>
    </node>
  </node>
