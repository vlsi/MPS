...
<model name="jetbrains.mps.baseLanguage.plugin">
  ...
  <node type="jetbrains.mps.bootstrap.pluginLanguage.structure.Tool" id="1209126436954">
    ...
    <node role="component" type="jetbrains.mps.baseLanguage.structure.NewExpression" id="1209126436955">
      <link role="baseMethodDeclaration" targetNodeId="32.~TodoViewer.&lt;init&gt;(jetbrains.mps.ide.IDEProjectFrame)" resolveInfo="TodoViewer" />
      <node role="actualArgument" type="jetbrains.mps.baseLanguage.structure.DotExpression" id="1209126436956">
        <node role="operand" type="jetbrains.mps.baseLanguage.structure.DotExpression" id="1209126436957">
          ...
          <node role="operation" type="jetbrains.mps.baseLanguage.structure.InstanceMethodCallOperation" id="1209126436959">
            <link role="baseMethodDeclaration" targetNodeId="37.~BaseTool.getProject():jetbrains.mps.project.MPSProject" resolveInfo="getProject" />
          </node>
        </node>
        <node role="operation" type="jetbrains.mps.baseLanguage.structure.InstanceMethodCallOperation" id="1209126436960">
          <link role="baseMethodDeclaration" targetNodeId="10.~MPSProject.getComponent(java.lang.Class):java.lang.Object" resolveInfo="getComponent" />
          <node role="actualArgument" type="jetbrains.mps.baseLanguage.structure.ClassifierClassExpression" id="1209126436961">
