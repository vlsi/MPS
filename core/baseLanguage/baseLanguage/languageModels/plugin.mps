...
<model name="jetbrains.mps.baseLanguage.plugin">
  ...
  <import index="56" modelUID="jetbrains.mps.helgins.inference@java_stub" version="-1" />
  <import index="57" modelUID="jetbrains.mps.util@java_stub" version="-1" />
              ...
              <node role="creator" type="jetbrains.mps.baseLanguage.structure.ClassCreator" id="1213034546432">
                ...
                <node role="actualArgument" type="jetbrains.mps.baseLanguage.structure.GenericNewExpression" id="1213874106574">
                  <node role="creator" type="jetbrains.mps.baseLanguage.structure.ClassCreator" id="1213874154461">
                    ...
                    <node role="actualArgument" type="jetbrains.mps.bootstrap.pluginLanguage.structure.ConceptFunctionParameter_AnActionEvent" id="1213874157243" />
                  </node>
                </node>
              </node>
            </node>
            ...
            <node role="initializer" type="jetbrains.mps.baseLanguage.structure.DotExpression" id="1220256094396">
              <node role="operand" type="jetbrains.mps.baseLanguage.structure.DotExpression" id="1220256094397">
                <node role="operand" type="jetbrains.mps.baseLanguage.structure.StaticMethodCall" id="1220256094398">
                  <link role="baseMethodDeclaration" targetNodeId="56.~TypeChecker.getInstance():jetbrains.mps.helgins.inference.TypeChecker" resolveInfo="getInstance" />
                  <link role="classConcept" targetNodeId="56.~TypeChecker" resolveInfo="TypeChecker" />
                </node>
                <node role="operation" type="jetbrains.mps.baseLanguage.structure.InstanceMethodCallOperation" id="1220256094399">
                  <link role="baseMethodDeclaration" targetNodeId="56.~TypeChecker.getSubtypingManager():jetbrains.mps.helgins.inference.SubtypingManager" resolveInfo="getSubtypingManager" />
                </node>
              </node>
              <node role="operation" type="jetbrains.mps.baseLanguage.structure.InstanceMethodCallOperation" id="1220256094400">
                <link role="baseMethodDeclaration" targetNodeId="56.~SubtypingManager.mostSpecificType(java.util.Set):jetbrains.mps.smodel.SNode" resolveInfo="mostSpecificType" />
                <node role="actualArgument" type="jetbrains.mps.baseLanguage.structure.StaticMethodCall" id="1220256214563">
                  <link role="classConcept" targetNodeId="57.~CollectionUtil" resolveInfo="CollectionUtil" />
                  <link role="baseMethodDeclaration" targetNodeId="57.~CollectionUtil.asSet(java.lang.Object...):java.util.Set" resolveInfo="asSet" />
