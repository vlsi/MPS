      ...
      <node role="body" type="jetbrains.mps.baseLanguage.structure.StatementList" id="1207052992294">
        <node role="statement" type="jetbrains.mps.baseLanguage.structure.LocalVariableDeclarationStatement"
          ...
          <node role="localVariableDeclaration" type="jetbrains.mps.baseLanguage.structure.LocalVariableDeclaration"
            ...
            <node role="type" type="jetbrains.mps.baseLanguage.structure.ClassifierType" id="1207058709497">
              <link role="classifier" targetNodeId="23.~ExtractMethodRefactoringProcessor"
            ...
            <node role="initializer" type="jetbrains.mps.baseLanguage.structure.NewExpression" id="1207058713108">
              <link role="baseMethodDeclaration"
                    targetNodeId="23.~ExtractMethodRefactoringProcessor.&lt;init&gt;(java.util.List)"
                    resolveInfo="ExtractMethodRefactoringProcessor"/>
              <node role="actualArgument" type="jetbrains.mps.baseLanguage.structure.StaticMethodCall"
                    id="1207058743420">
                <link role="baseMethodDeclaration"
                      targetNodeId="5.~BaseAdapter.toAdapters(java.lang.Class,java.util.List):java.util.List"
                      resolveInfo="toAdapters"/>
        ...
        <node role="statement" type="jetbrains.mps.baseLanguage.structure.ExpressionStatement" id="1207058806689">
          <node role="expression" type="jetbrains.mps.baseLanguage.structure.DotExpression" id="1207058815910">
            ...
            <node role="operation" type="jetbrains.mps.baseLanguage.structure.InstanceMethodCallOperation"
                  id="1207058818240">
              <link role="baseMethodDeclaration" targetNodeId="23.~ExtractMethodRefactoringProcessor.dump():void"
                    resolveInfo="dump"/>
            </node>
          </node>
        </node>
