...
<model modelUID="r:00000000-0000-4000-0000-011c89590393(jetbrains.mps.baseLanguage.sandbox.genTest)">
  ...
  <node type="jetbrains.mps.baseLanguage.structure.ClassConcept:3" id="3764553758271149919">
    ...
    <node role="method:3" type="jetbrains.mps.baseLanguage.structure.InstanceMethodDeclaration:3" id="8149292034787910838">
      <property name="name:3" value="bar" />
      <node role="parameter:3" type="jetbrains.mps.baseLanguage.structure.ParameterDeclaration:3" id="684456904424056768">
        <property name="name:3" value="methods" />
        <node role="type:3" type="jetbrains.mps.baseLanguage.structure.ClassifierType:3" id="684456904424056769">
          <link role="classifier:3" targetNodeId="20.~List" resolveInfo="List" />
          <node role="parameter:3" type="jetbrains.mps.baseLanguage.structure.UpperBoundType:3" id="684456904424056770">
            <node role="bound:3" type="jetbrains.mps.baseLanguage.structure.ClassifierType:3" id="684456904424056771">
              <link role="classifier:3" targetNodeId="22.~BaseMethodDeclaration" resolveInfo="BaseMethodDeclaration" />
            </node>
          </node>
        </node>
      </node>
      ...
      <node role="body:3" type="jetbrains.mps.baseLanguage.structure.StatementList:3" id="8149292034787910841">
        <node role="statement:3" type="jetbrains.mps.baseLanguage.structure.ExpressionStatement:3" id="684456904424121853">
          <node role="expression:3" type="jetbrains.mps.baseLanguage.structure.DotExpression:3" id="684456904424121854">
            <node role="operand:3" type="jetbrains.mps.baseLanguage.structure.ParameterReference:3" id="684456904424121855">
              <link role="variableDeclaration:3" targetNodeId="684456904424056768" resolveInfo="methods" />
            </node>
            <node role="operation:3" type="jetbrains.mps.baseLanguage.structure.InstanceMethodCallOperation:3" id="684456904424121856">
              <link role="baseMethodDeclaration:3" targetNodeId="20.~List.get(int):java.lang.Object" resolveInfo="get" />
              <node role="actualArgument:3" type="jetbrains.mps.baseLanguage.structure.IntegerConstant:3" id="684456904424121857">
  ...
  <node type="jetbrains.mps.baseLanguage.structure.ClassConcept:3" id="5569019188765049940">
    ...
    <node role="staticMethod:3" type="jetbrains.mps.baseLanguage.structure.StaticMethodDeclaration:3" id="4691618959158120590">
      <property name="name:3" value="srt" />
      <node role="returnType:3" type="jetbrains.mps.baseLanguage.structure.VoidType:3" id="4691618959158120591" />
      <node role="visibility:3" type="jetbrains.mps.baseLanguage.structure.PublicVisibility:3" id="4691618959158120592" />
      <node role="body:3" type="jetbrains.mps.baseLanguage.structure.StatementList:3" id="4691618959158120593" />
      <node role="parameter:3" type="jetbrains.mps.baseLanguage.structure.ParameterDeclaration:3" id="4691618959158120594">
        <property name="name:3" value="l" />
        <node role="type:3" type="jetbrains.mps.baseLanguage.structure.ClassifierType:3" id="4691618959158120595">
          <link role="classifier:3" targetNodeId="20.~List" resolveInfo="List" />
          <node role="parameter:3" type="jetbrains.mps.baseLanguage.structure.TypeVariableReference:3" id="4691618959158120599">
            <link role="typeVariableDeclaration:3" targetNodeId="4691618959158120598" resolveInfo="G" />
          </node>
        </node>
      </node>
      <node role="parameter:3" type="jetbrains.mps.baseLanguage.structure.ParameterDeclaration:3" id="4691618959158120600">
        <property name="name:3" value="cmp" />
        <node role="type:3" type="jetbrains.mps.baseLanguage.structure.ClassifierType:3" id="4691618959158120602">
          <link role="classifier:3" targetNodeId="20.~Comparator" resolveInfo="Comparator" />
          <node role="parameter:3" type="jetbrains.mps.baseLanguage.structure.UpperBoundType:3" id="4691618959158120605">
            <node role="bound:3" type="jetbrains.mps.baseLanguage.structure.TypeVariableReference:3" id="4691618959158120607">
              <link role="typeVariableDeclaration:3" targetNodeId="4691618959158120598" resolveInfo="G" />
            </node>
          </node>
        </node>
      </node>
      <node role="typeVariableDeclaration:3" type="jetbrains.mps.baseLanguage.structure.TypeVariableDeclaration:3" id="4691618959158120598">
    ...
    <node role="method:3" type="jetbrains.mps.baseLanguage.structure.InstanceMethodDeclaration:3" id="5569019188765049947">
      ...
      <node role="body:3" type="jetbrains.mps.baseLanguage.structure.StatementList:3" id="5569019188765049950">
        <node role="statement:3" type="jetbrains.mps.baseLanguage.structure.LocalVariableDeclarationStatement:3" id="4691618959158060623">
          <node role="localVariableDeclaration:3" type="jetbrains.mps.baseLanguage.structure.LocalVariableDeclaration:3" id="4691618959158060624">
            <property name="name:3" value="l" />
            <node role="type:3" type="jetbrains.mps.baseLanguage.structure.ClassifierType:3" id="4691618959158060625">
              <link role="classifier:3" targetNodeId="20.~List" resolveInfo="List" />
              <node role="parameter:3" type="jetbrains.mps.baseLanguage.structure.ClassifierType:3" id="4691618959158060731">
                <link role="classifier:3" targetNodeId="14.~Double" resolveInfo="Double" />
              </node>
            </node>
            <node role="initializer:3" type="jetbrains.mps.baseLanguage.structure.NullLiteral:3" id="4691618959158060733" />
          </node>
        </node>
        <node role="statement:3" type="jetbrains.mps.baseLanguage.structure.LocalVariableDeclarationStatement:3" id="4691618959158060736">
          <node role="localVariableDeclaration:3" type="jetbrains.mps.baseLanguage.structure.LocalVariableDeclaration:3" id="4691618959158060737">
            <property name="name:3" value="c" />
            <node role="type:3" type="jetbrains.mps.baseLanguage.structure.ClassifierType:3" id="4691618959158060738">
              <link role="classifier:3" targetNodeId="20.~Comparator" resolveInfo="Comparator" />
              <node role="parameter:3" type="jetbrains.mps.baseLanguage.structure.ClassifierType:3" id="4691618959158060740">
                <link role="classifier:3" targetNodeId="14.~Double" resolveInfo="Double" />
              </node>
            </node>
            <node role="initializer:3" type="jetbrains.mps.baseLanguage.structure.NullLiteral:3" id="4691618959158060742" />
          </node>
        </node>
        <node role="statement:3" type="jetbrains.mps.baseLanguage.structure.VarVariableDeclaration:3" id="4691618959158120617">
          <property name="name:3" value="c1" />
        </node>
        <node role="statement:3" type="jetbrains.mps.baseLanguage.structure.ExpressionStatement:3" id="4691618959158060744">
          <node role="expression:3" type="jetbrains.mps.baseLanguage.structure.StaticMethodCall:3" id="4691618959158060746">
            <link role="classConcept:3" targetNodeId="20.~Collections" resolveInfo="Collections" />
            <link role="baseMethodDeclaration:3" targetNodeId="20.~Collections.sort(java.util.List,java.util.Comparator):void" resolveInfo="sort" />
            <node role="actualArgument:3" type="jetbrains.mps.baseLanguage.structure.LocalVariableReference:3" id="4691618959158060747">
              <link role="variableDeclaration:3" targetNodeId="4691618959158060624" resolveInfo="l" />
            </node>
            <node role="actualArgument:3" type="jetbrains.mps.baseLanguage.structure.LocalVariableReference:3" id="9035533713284171058">
              <link role="variableDeclaration:3" targetNodeId="4691618959158060737" resolveInfo="c" />
            </node>
          </node>
        </node>
        <node role="statement:3" type="jetbrains.mps.baseLanguage.structure.ExpressionStatement:3" id="4691618959158120609">
          <node role="expression:3" type="jetbrains.mps.baseLanguage.structure.LocalStaticMethodCall:3" id="4691618959158120610">
            <link role="baseMethodDeclaration:3" targetNodeId="4691618959158120590" resolveInfo="srt" />
            <node role="actualArgument:3" type="jetbrains.mps.baseLanguage.structure.LocalVariableReference:3" id="4691618959158120611">
              <link role="variableDeclaration:3" targetNodeId="4691618959158060624" resolveInfo="l" />
            </node>
            <node role="actualArgument:3" type="jetbrains.mps.baseLanguage.structure.LocalVariableReference:3" id="4691618959158120613">
              <link role="variableDeclaration:3" targetNodeId="4691618959158060737" resolveInfo="c" />
            </node>
          </node>
        </node>
        <node role="statement:3" type="jetbrains.mps.baseLanguage.structure.ReturnStatement:3" id="4691618959158060751">
          <node role="expression:3" type="jetbrains.mps.baseLanguage.structure.NullLiteral:3" id="4691618959158060753" />
        </node>
      </node>
    </node>
  ...
  <node type="jetbrains.mps.baseLanguage.structure.ClassConcept:3" id="684456904423879532">
    <property name="name:3" value="Collections" />
    <node role="method:3" type="jetbrains.mps.baseLanguage.structure.InstanceMethodDeclaration:3" id="684456904423879538">
      <property name="name:3" value="foo" />
      <node role="returnType:3" type="jetbrains.mps.baseLanguage.structure.VoidType:3" id="684456904423879539" />
      <node role="visibility:3" type="jetbrains.mps.baseLanguage.structure.PublicVisibility:3" id="684456904423879540" />
      <node role="body:3" type="jetbrains.mps.baseLanguage.structure.StatementList:3" id="684456904423879541">
        <node role="statement:3" type="jetbrains.mps.baseLanguage.structure.LocalVariableDeclarationStatement:3" id="684456904423879544">
          <node role="localVariableDeclaration:3" type="jetbrains.mps.baseLanguage.structure.LocalVariableDeclaration:3" id="684456904423879545">
            <property name="name:3" value="mis" />
            <node role="type:3" type="jetbrains.mps.baseLanguage.structure.ClassifierType:3" id="684456904423879546">
              <link role="classifier:3" targetNodeId="20.~Map" resolveInfo="Map" />
              <node role="parameter:3" type="jetbrains.mps.baseLanguage.structure.ClassifierType:3" id="684456904423879549">
                <link role="classifier:3" targetNodeId="14.~Integer" resolveInfo="Integer" />
              </node>
              <node role="parameter:3" type="jetbrains.mps.baseLanguage.structure.ClassifierType:3" id="684456904423879550">
                <link role="classifier:3" targetNodeId="14.~String" resolveInfo="String" />
              </node>
            </node>
            <node role="initializer:3" type="jetbrains.mps.baseLanguage.structure.NullLiteral:3" id="684456904423879552" />
          </node>
        </node>
        <node role="statement:3" type="jetbrains.mps.baseLanguage.structure.ExpressionStatement:3" id="684456904423879554">
          <node role="expression:3" type="jetbrains.mps.baseLanguage.structure.DotExpression:3" id="684456904423879583">
            <node role="operand:3" type="jetbrains.mps.baseLanguage.structure.DotExpression:3" id="684456904423879555">
              <node role="operand:3" type="jetbrains.mps.baseLanguage.structure.StaticMethodCall:3" id="684456904423879556">
                <link role="baseMethodDeclaration:3" targetNodeId="24.~SetSequence.fromSet(java.util.Set):jetbrains.mps.internal.collections.runtime.ISetSequence" resolveInfo="fromSet" />
                <link role="classConcept:3" targetNodeId="24.~SetSequence" resolveInfo="SetSequence" />
                <node role="actualArgument:3" type="jetbrains.mps.baseLanguage.structure.DotExpression:3" id="684456904423879557">
                  <node role="operand:3" type="jetbrains.mps.baseLanguage.structure.StaticMethodCall:3" id="684456904423879558">
                    <link role="baseMethodDeclaration:3" targetNodeId="24.~MapSequence.fromMap(java.util.Map):jetbrains.mps.internal.collections.runtime.IMapSequence" resolveInfo="fromMap" />
                    <link role="classConcept:3" targetNodeId="24.~MapSequence" resolveInfo="MapSequence" />
                    <node role="actualArgument:3" type="jetbrains.mps.baseLanguage.structure.LocalVariableReference:3" id="684456904423879559">
                      <link role="variableDeclaration:3" targetNodeId="684456904423879545" resolveInfo="mis" />
                    </node>
                  </node>
                  <node role="operation:3" type="jetbrains.mps.baseLanguage.structure.InstanceMethodCallOperation:3" id="684456904423879560">
                    <link role="baseMethodDeclaration:3" targetNodeId="24.~IMapSequence.mappingsSet():jetbrains.mps.internal.collections.runtime.ISetSequence" resolveInfo="mappingsSet" />
                  </node>
                </node>
              </node>
              <node role="operation:3" type="jetbrains.mps.baseLanguage.structure.InstanceMethodCallOperation:3" id="684456904423879561">
                <link role="baseMethodDeclaration:3" targetNodeId="24.~ISequence.toListSequence():jetbrains.mps.internal.collections.runtime.IListSequence" resolveInfo="toListSequence" />
              </node>
            </node>
            <node role="operation:3" type="jetbrains.mps.baseLanguage.structure.InstanceMethodCallOperation:3" id="684456904423879587">
              <link role="baseMethodDeclaration:3" targetNodeId="24.~ISequence.visitAll(jetbrains.mps.internal.collections.runtime.IVisitor):void" resolveInfo="visitAll" />
              <node role="actualArgument:3" type="jetbrains.mps.baseLanguage.closures.structure.ClosureLiteral:3" id="684456904423879588">
                <node role="parameter:3" type="jetbrains.mps.baseLanguage.collections.structure.SmartClosureParameterDeclaration:7" id="684456904423879589">
                  <property name="name:7" value="m" />
                  <node role="type:7" type="jetbrains.mps.baseLanguage.structure.WildCardType:3" id="684456904423879590" />
                </node>
                <node role="body:3" type="jetbrains.mps.baseLanguage.structure.StatementList:3" id="684456904423879591">
                  <node role="statement:3" type="jetbrains.mps.baseLanguage.structure.ExpressionStatement:3" id="684456904423879618">
                    <node role="expression:3" type="jetbrains.mps.baseLanguage.structure.BooleanConstant:3" id="684456904423879619">
    ...
    <node role="visibility:3" type="jetbrains.mps.baseLanguage.structure.PublicVisibility:3" id="684456904423879533" />
    <node role="constructor:3" type="jetbrains.mps.baseLanguage.structure.ConstructorDeclaration:3" id="684456904423879534">
      <node role="returnType:3" type="jetbrains.mps.baseLanguage.structure.VoidType:3" id="684456904423879535" />
      <node role="visibility:3" type="jetbrains.mps.baseLanguage.structure.PublicVisibility:3" id="684456904423879536" />
      <node role="body:3" type="jetbrains.mps.baseLanguage.structure.StatementList:3" id="684456904423879537" />
    </node>
  </node>
</model>
