...
public class typeof_PropertyReference_InferenceRule implements InferenceRule_Runtime {
  ...
  public void applyRule(final SNode propertyReference) {
    ...
    if((property != null)) {
      ...
      TypeChecker.getInstance().getRuntimeSupport().createLessThanInequationStrong(TypeChecker.getInstance().getRuntimeSupport().typeOf(IOperation_Behavior.call_getOperand_1197028596169(propertyReference), "jetbrains.mps.baseLanguage.helgins", "1201468086552", true), new QuotationClass_81().createNode(SNodeOperations.getAncestor(property, "jetbrains.mps.baseLanguage.structure.Classifier", false, false)), IOperation_Behavior.call_getOperand_1197028596169(propertyReference), null, "jetbrains.mps.baseLanguage.helgins", "1201468086542");
    }
  }
