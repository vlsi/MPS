...
public class typeOf_thisExpr_InferenceRule implements InferenceRule_Runtime {
  ...
  public void applyRule(final SNode thisExpr) {
    ...
    }
    {
      ...
      TypeChecker.getInstance().getRuntimeSupport().createEquation(TypeChecker.getInstance().getRuntimeSupport().typeOf(thisExpr, "jetbrains.mps.baseLanguage.helgins", "1215004810739", true), new QuotationClass_102().createNode(typeVarRefs, classConcept), _nodeToCheck_1029348928467, null, "jetbrains.mps.baseLanguage.helgins", "1215004810737", intentionProvider);
    }
  }
