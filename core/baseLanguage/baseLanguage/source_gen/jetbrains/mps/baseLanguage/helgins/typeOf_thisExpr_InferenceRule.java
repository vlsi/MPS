...
public class typeOf_thisExpr_InferenceRule implements InferenceRule_Runtime {
  ...
  public void applyRule(final SNode thisExpr) {
    ...
    for(SNode typeVariableDeclaration : SLinkOperations.getTargets(classConcept, "typeVariableDeclaration", true)) {
      ListSequence.fromList(typeVarRefs).addElement(new QuotationClass_86().createNode(typeVariableDeclaration));
    }
    {
      SNode _nodeToCheck_1029348928467 = thisExpr;
      BaseIntentionProvider intentionProvider = null;
      TypeChecker.getInstance().getRuntimeSupport().createEquation(TypeChecker.getInstance().getRuntimeSupport().typeOf(thisExpr, "jetbrains.mps.baseLanguage.helgins", "1215004810739", true), new QuotationClass_100().createNode(typeVarRefs, classConcept), _nodeToCheck_1029348928467, null, "jetbrains.mps.baseLanguage.helgins", "1215004810737", intentionProvider);
    }
  }
