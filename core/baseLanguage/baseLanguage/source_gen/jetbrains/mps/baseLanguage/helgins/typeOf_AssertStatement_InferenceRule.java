  ...
  public void applyRule(final SNode assertStatement) {
    {
      ...
      TypeChecker.getInstance().getRuntimeSupport().createLessThanInequation(TypeChecker.getInstance().getRuntimeSupport().typeOf(_nodeToCheck_1029348928467, "jetbrains.mps.baseLanguage.helgins", "1176899056092", true), new QuotationClass_29().createNode(), _nodeToCheck_1029348928467, null, "jetbrains.mps.baseLanguage.helgins", "1176899078020", false, 0, intentionProvider);
    }
    if ((SLinkOperations.getTarget(assertStatement, "message", true) != null)) {
      {
        ...
        BaseIntentionProvider intentionProvider = null;
        TypeChecker.getInstance().getRuntimeSupport().createLessThanInequation(TypeChecker.getInstance().getRuntimeSupport().typeOf(_nodeToCheck_1029348928467, "jetbrains.mps.baseLanguage.helgins", "1176899107820", true), new QuotationClass_30().createNode(), _nodeToCheck_1029348928467, null, "jetbrains.mps.baseLanguage.helgins", "1176899115123", false, 0, intentionProvider);
      }
    }
  }
