...
public class typeof_FieldReferenceOperation_InferenceRule implements InferenceRule_Runtime {
  ...
  public void applyRule(final SNode fieldReference) {
    ...
    final SNode InstanceType_typevar_1206554174334 = TypeChecker.getInstance().getRuntimeSupport().createNewRuntimeTypesVariable();
    {
      ...
      TypeChecker.getInstance().getRuntimeSupport().createEquation(TypeChecker.getInstance().getRuntimeSupport().typeOf(_nodeToCheck_1029348928467, "jetbrains.mps.baseLanguage.helgins@5_0", "1215614095047", true), TypeChecker.getInstance().getEquationManager().getRepresentator(InstanceType_typevar_1206554174334), _nodeToCheck_1029348928467, null, "jetbrains.mps.baseLanguage.helgins@5_0", "1215614095044");
    }
    ...
    }
    {
      ...
      TypeChecker.getInstance().getRuntimeSupport().whenConcrete(IT, new Runnable() {
        ...
        public void run() {
          ...
          {
            SNode _nodeToCheck_1029348928467 = fieldReference;
            TypeChecker.getInstance().getRuntimeSupport().createEquation(TypeChecker.getInstance().getRuntimeSupport().typeOf(_nodeToCheck_1029348928467, "jetbrains.mps.baseLanguage.helgins@5_0", "1215614095089", true), matchedType, _nodeToCheck_1029348928467, null, "jetbrains.mps.baseLanguage.helgins@5_0", "1215614095087");
          }
