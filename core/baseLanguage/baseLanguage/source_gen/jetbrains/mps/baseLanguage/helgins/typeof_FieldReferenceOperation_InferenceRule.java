...
public class typeof_FieldReferenceOperation_InferenceRule implements InferenceRule_Runtime {
  ...
  public void applyRule(final SNode fieldReference) {
    ...
    if((fieldDeclaration != null)) {
      ...
      TypeChecker.getInstance().getRuntimeSupport().createLessThanInequationStrong(TypeChecker.getInstance().getRuntimeSupport().typeOf(IOperation_Behavior.call_getOperand_1197028596169(fieldReference), "jetbrains.mps.baseLanguage.helgins", "1197030122319", true), new QuotationClass_85().createNode(SNodeOperations.getAncestor(fieldDeclaration, "jetbrains.mps.baseLanguage.structure.Classifier", false, false)), IOperation_Behavior.call_getOperand_1197028596169(fieldReference), null, "jetbrains.mps.baseLanguage.helgins", "1197030157476");
    }
  }
