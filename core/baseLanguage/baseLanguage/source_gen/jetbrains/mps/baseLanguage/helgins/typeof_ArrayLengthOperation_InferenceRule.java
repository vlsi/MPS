  ...
  public void applyRule(final SNode lengthOperation, final TypeCheckingContext typeCheckingContext) {
    {
      ...
      TypeChecker.getInstance().getRuntimeSupport().createEquation(typeCheckingContext.typeOf(lengthOperation, "r:00000000-0000-4000-0000-011c895902c5(jetbrains.mps.baseLanguage.helgins)", "1208891064552", true), new QuotationClass_81().createNode(), _nodeToCheck_1029348928467, null, "r:00000000-0000-4000-0000-011c895902c5(jetbrains.mps.baseLanguage.helgins)", "1208891068843", intentionProvider);
    }
  }
