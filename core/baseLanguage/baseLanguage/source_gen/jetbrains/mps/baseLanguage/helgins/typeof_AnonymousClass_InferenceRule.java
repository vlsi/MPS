...
public class typeof_AnonymousClass_InferenceRule implements InferenceRule_Runtime {
  ...
  public void applyRule(final SNode nodeToCheck) {
    TypeChecker.getInstance().getRuntimeSupport().createEquation(TypeChecker.getInstance().getRuntimeSupport().typeOf(nodeToCheck, "jetbrains.mps.baseLanguage.helgins", "1194623855703", true), new QuotationClass_78().createNode(SLinkOperations.getTarget(nodeToCheck, "classifier", false), SLinkOperations.getTargets(nodeToCheck, "typeParameter", true)), nodeToCheck, null, "jetbrains.mps.baseLanguage.helgins", "1194623862628");
  }
