...
public class typeof_AnnotationInstanceExpression_InferenceRule implements InferenceRule_Runtime {
  ...
  public void applyRule(final SNode annotationInstanceExpression) {
    ...
    TypeChecker.getInstance().getRuntimeSupport().createEquation(TypeChecker.getInstance().getRuntimeSupport().typeOf(annotationInstanceExpression, "jetbrains.mps.baseLanguage.helgins", "1188221584618", true), new QuotationClass_76().createNode(annotation), annotationInstanceExpression, null, "jetbrains.mps.baseLanguage.helgins", "1188221689320");
  }
