    ...
    if (SNodeOperations.isInstanceOf(conceptFunction, "jetbrains.mps.baseLanguage.structure.Closure")) {
      {
        ...
        TypeChecker.getInstance().reportTypeError(parameter, "concept function parameter can not be used in closure", "r:1222183538981(jetbrains.mps.baseLanguage.helgins@3_0)", "1222183885749", intentionProvider);
      }
    } else
    {
      ...
      if (Sequence.fromIterable(seq).isEmpty()) {
        {
          BaseIntentionProvider intentionProvider = null;
          TypeChecker.getInstance().reportTypeError(parameter, "not applicable in this context", "r:1222183538981(jetbrains.mps.baseLanguage.helgins@3_0)", "1222183885782", intentionProvider);
        }
      }
    }
  }
