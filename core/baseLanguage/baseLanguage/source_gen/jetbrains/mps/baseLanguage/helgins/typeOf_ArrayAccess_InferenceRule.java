...
public class typeOf_ArrayAccess_InferenceRule implements InferenceRule_Runtime {
  ...
  public void applyRule(final SNode arrayAccess) {
    ...
    TypeChecker.getInstance().getRuntimeSupport().createLessThanInequation(TypeChecker.getInstance().getRuntimeSupport().typeOf(SLinkOperations.getTarget(arrayAccess, "index", true), "jetbrains.mps.baseLanguage.helgins", "1175603547412", true), new QuotationClass_10().createNode(), SLinkOperations.getTarget(arrayAccess, "index", true), null, "jetbrains.mps.baseLanguage.helgins", "1175603546475", false);
  }
