...
public class check_VariableArityType_NonTypesystemRule implements NonTypesystemRule_Runtime {
  ...
  public void applyRule(final SNode variableArityType) {
    do {
          ...
          if ((SNodeOperations.getNextSibling(matchedNode_2) != null)) {
            {
              ...
              TypeChecker.getInstance().reportTypeError(matchedNode_2, "parameter of variable arity must be a last one", "jetbrains.mps.baseLanguage.helgins@3_0", "1221637913196", intentionProvider);
            }
          }
          break;
        }
      ...
      {
        BaseIntentionProvider intentionProvider = null;
        TypeChecker.getInstance().reportTypeError(variableArityType, "variable arity types should only be used in method parameters", "jetbrains.mps.baseLanguage.helgins@3_0", "1221637913202", intentionProvider);
      }
    } while(false);
  }
