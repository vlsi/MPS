...
public class check_VariableArityType_NonTypesystemRule implements NonTypesystemRule_Runtime {
  ...
  public void applyRule(final SNode variableArityType) {
    do {
          ...
          if ((SNodeOperations.getNextSibling(matchedNode_2) != null)) {
            {
              ...
              TypeChecker.getInstance().reportTypeError(matchedNode_2, "parameter of variable arity must be a last one", "r:1222094342530(jetbrains.mps.baseLanguage.helgins@21_0)", "1222095231340", intentionProvider);
            }
          }
          break;
        }
      ...
      {
        BaseIntentionProvider intentionProvider = null;
        TypeChecker.getInstance().reportTypeError(variableArityType, "variable arity types should only be used in method parameters", "r:1222094342530(jetbrains.mps.baseLanguage.helgins@21_0)", "1222095231346", intentionProvider);
      }
    } while(false);
  }
