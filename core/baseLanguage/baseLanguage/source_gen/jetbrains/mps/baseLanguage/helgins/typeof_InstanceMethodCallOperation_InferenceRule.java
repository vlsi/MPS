...
public class typeof_InstanceMethodCallOperation_InferenceRule implements InferenceRule_Runtime {
  ...
  public void applyRule(final SNode imco) {
    ...
    TypeChecker.getInstance().getRuntimeSupport().createLessThanInequationStrong(TypeChecker.getInstance().getEquationManager().getRepresentator(instanceType_typevar_1204064731338), new QuotationClass_83().createNode(methodClassifier), imco, null, "jetbrains.mps.baseLanguage.helgins", "1204065906120", true);
