...
public class typeof_ArrayLiteral_InferenceRule implements InferenceRule_Runtime {
  ...
  public void applyRule(final SNode arrayLiteral) {
    ...
    }
    {
      ...
      TypeChecker.getInstance().getRuntimeSupport().createEquation(TypeChecker.getInstance().getRuntimeSupport().typeOf(_nodeToCheck_1029348928467, "jetbrains.mps.baseLanguage.helgins", "1188221454647", true), new QuotationClass_68().createNode(TypeChecker.getInstance().getEquationManager().getRepresentator(elementType_typevar_1188221443596)), _nodeToCheck_1029348928467, null, "jetbrains.mps.baseLanguage.helgins", "1188221467376");
    }
  }
