...
public class checkThrowedByThrowIsCaught_NonTypesystemRule implements NonTypesystemRule_Runtime {
  ...
  public void applyRule(final SNode throwStatement) {
    ...
    {
      final SNode ThrowableType = TypeChecker.getInstance().getRuntimeSupport().typeOf(throwable, "jetbrains.mps.baseLanguage.helgins@5_0", "1215619087534", true);
      ...
      }, "jetbrains.mps.baseLanguage.helgins", "1210182438695");
    }
  }
