...
public class EnumConstantReference extends BaseConcept {
  ...
  public INodeAdapter getEnumClass() {
    return (INodeAdapter)this.getReferent(, EnumConstantReference.ENUM_CLASS);
  }
  ...
  public INodeAdapter getEnumConstantDeclaration() {
    return (INodeAdapter)this.getReferent(, EnumConstantReference.ENUM_CONSTANT_DECLARATION);
  }

  public void setEnumConstantDeclaration(INodeAdapter node) {
