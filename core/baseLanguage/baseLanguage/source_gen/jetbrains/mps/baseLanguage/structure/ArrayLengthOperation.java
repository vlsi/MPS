...
public class ArrayLengthOperation extends BaseConcept implements IOperation {
  ...
  public int get_$attributesCount() {
    return this.getChildCount(ArrayLengthOperation._$ATTRIBUTE);
  }

  public Iterator<Attribute> _$attributes() {
    return this.children(Attribute.class, ArrayLengthOperation._$ATTRIBUTE);
  }

  public List<Attribute> get_$attributes() {
    return this.getChildren(Attribute.class, ArrayLengthOperation._$ATTRIBUTE);
  }

  public void add_$attribute(Attribute node) {
    this.addChild(ArrayLengthOperation._$ATTRIBUTE, node);
  }

  public void insert_$attribute(Attribute prev, Attribute node) {
    this.insertChild(prev, ArrayLengthOperation._$ATTRIBUTE, node);
  }
