...
public class VariableReference extends jetbrains.mps.baseLanguage.structure.Expression implements jetbrains.mps.baseLanguage.structure.TypeAnnotable {
  ...
  public jetbrains.mps.baseLanguage.structure.VariableDeclaration getVariableDeclaration() {
    return (jetbrains.mps.baseLanguage.structure.VariableDeclaration)this.getReferent(VariableDeclaration.class, VariableReference.VARIABLE_DECLARATION);
  }

  public void setVariableDeclaration(jetbrains.mps.baseLanguage.structure.VariableDeclaration node) {
