...
public class PropertyReference extends BaseConcept implements BaseScope {
  ...
  public INodeAdapter getProperty() {
    return (INodeAdapter)this.getReferent(, PropertyReference.PROPERTY);
  }

  public void setProperty(INodeAdapter node) {
