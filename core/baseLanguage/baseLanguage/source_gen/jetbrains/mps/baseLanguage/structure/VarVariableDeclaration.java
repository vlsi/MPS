...
public class VarVariableDeclaration extends jetbrains.mps.baseLanguage.structure.Statement implements jetbrains.mps.lang.core.structure.INamedConcept {
  ...
  public jetbrains.mps.baseLanguage.structure.Expression getInit() {
    return (jetbrains.mps.baseLanguage.structure.Expression)this.getChild(Expression.class, VarVariableDeclaration.INIT);
  }

  public void setInit(jetbrains.mps.baseLanguage.structure.Expression node) {
