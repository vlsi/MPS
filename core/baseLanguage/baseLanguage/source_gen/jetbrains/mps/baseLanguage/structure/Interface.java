...
public class Interface extends BaseConcept implements BaseScope {
  ...
  public Iterator<INodeAdapter> extendedInterfaces() {
    return this.children(, Interface.EXTENDED_INTERFACE);
  }

  public List<INodeAdapter> getExtendedInterfaces() {
    return this.getChildren(, Interface.EXTENDED_INTERFACE);
  }

  public void addExtendedInterface(INodeAdapter node) {
    this.addChild(Interface.EXTENDED_INTERFACE, node);
  }

  public void insertExtendedInterface(INodeAdapter prev, INodeAdapter node) {
