...
public class ForStatement extends jetbrains.mps.baseLanguage.structure.AbstractForStatement {
  ...
  public jetbrains.mps.baseLanguage.structure.Expression getCondition() {
    return (jetbrains.mps.baseLanguage.structure.Expression)this.getChild(Expression.class, ForStatement.CONDITION);
  }
  ...
  public jetbrains.mps.baseLanguage.structure.Expression getIteration() {
    return (jetbrains.mps.baseLanguage.structure.Expression)this.getChild(Expression.class, ForStatement.ITERATION);
  }

  public void setIteration(jetbrains.mps.baseLanguage.structure.Expression node) {
