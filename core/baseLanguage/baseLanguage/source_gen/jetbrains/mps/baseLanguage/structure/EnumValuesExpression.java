...
public class EnumValuesExpression extends jetbrains.mps.baseLanguage.structure.Expression {
  ...
  public jetbrains.mps.baseLanguage.structure.EnumClass getEnumClass() {
    return (jetbrains.mps.baseLanguage.structure.EnumClass)this.getReferent(EnumClass.class, EnumValuesExpression.ENUM_CLASS);
  }

  public void setEnumClass(jetbrains.mps.baseLanguage.structure.EnumClass node) {
