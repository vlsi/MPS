...
public class AssignmentExpression extends BaseAssignmentExpression implements TypeDerivable {
  ...
  public int get_$attributesCount() {
    return this.getChildCount(AssignmentExpression._$ATTRIBUTE);
  }

  public Iterator<Attribute> _$attributes() {
    return this.children(Attribute.class, AssignmentExpression._$ATTRIBUTE);
  }

  public List<Attribute> get_$attributes() {
    return this.getChildren(Attribute.class, AssignmentExpression._$ATTRIBUTE);
  }

  public void add_$attribute(Attribute node) {
    this.addChild(AssignmentExpression._$ATTRIBUTE, node);
  }

  public void insert_$attribute(Attribute prev, Attribute node) {
    this.insertChild(prev, AssignmentExpression._$ATTRIBUTE, node);
  }
