...
public class ExpressionStatement extends jetbrains.mps.baseLanguage.structure.Statement implements jetbrains.mps.lang.core.structure.IWrapper {
  ...
  public jetbrains.mps.baseLanguage.structure.Expression getExpression() {
    return (jetbrains.mps.baseLanguage.structure.Expression)this.getChild(Expression.class, ExpressionStatement.EXPRESSION);
  }
