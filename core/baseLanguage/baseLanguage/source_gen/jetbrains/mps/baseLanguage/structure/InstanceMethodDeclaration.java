...
public class InstanceMethodDeclaration extends BaseConcept implements BaseScope, BaseScope {
  ...
  public INodeAdapter getVisibility() {
    return (INodeAdapter)this.getChild(, InstanceMethodDeclaration.VISIBILITY);
  }
