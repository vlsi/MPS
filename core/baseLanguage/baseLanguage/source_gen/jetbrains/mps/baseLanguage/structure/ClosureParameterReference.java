...
public class ClosureParameterReference extends BaseConcept {
  ...
  public INodeAdapter getClosureParameter() {
    return (INodeAdapter)this.getReferent(, ClosureParameterReference.CLOSURE_PARAMETER);
  }

  public void setClosureParameter(INodeAdapter node) {
