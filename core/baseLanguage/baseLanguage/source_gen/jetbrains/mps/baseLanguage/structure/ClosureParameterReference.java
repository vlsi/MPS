...
public class ClosureParameterReference extends jetbrains.mps.baseLanguage.structure.Expression {
  ...
  public jetbrains.mps.baseLanguage.structure.ClosureParameter getClosureParameter() {
    return (jetbrains.mps.baseLanguage.structure.ClosureParameter)this.getReferent(ClosureParameter.class, ClosureParameterReference.CLOSURE_PARAMETER);
  }

  public void setClosureParameter(jetbrains.mps.baseLanguage.structure.ClosureParameter node) {
