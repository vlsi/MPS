...
import jetbrains.mps.baseLanguage.structure.VarVariableDeclaration;
import jetbrains.mps.smodel.SModel;
import jetbrains.mps.smodel.SModelUtil_new;
import jetbrains.mps.project.GlobalScope;

public class VarVariableReference extends jetbrains.mps.baseLanguage.structure.Expression {
  ...
  public jetbrains.mps.baseLanguage.structure.VarVariableDeclaration getDeclaration() {
    return (jetbrains.mps.baseLanguage.structure.VarVariableDeclaration)this.getReferent(VarVariableDeclaration.class, VarVariableReference.DECLARATION);
  }

  public void setDeclaration(jetbrains.mps.baseLanguage.structure.VarVariableDeclaration node) {
