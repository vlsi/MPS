...
public class BaseAssignmentExpression extends BaseConcept {
  ...
  public INodeAdapter getLValue() {
    return (INodeAdapter)this.getChild(, BaseAssignmentExpression.L_VALUE);
  }

  public void setLValue(INodeAdapter node) {
    super.setChild(BaseAssignmentExpression.L_VALUE, node);
  }

  public INodeAdapter getRValue() {
    return (INodeAdapter)this.getChild(, BaseAssignmentExpression.R_VALUE);
  }

  public void setRValue(INodeAdapter node) {
