...
public class TernaryOperatorExpression extends jetbrains.mps.baseLanguage.structure.Expression {
  ...
  public jetbrains.mps.baseLanguage.structure.Expression getCondition() {
    return (jetbrains.mps.baseLanguage.structure.Expression)this.getChild(Expression.class, TernaryOperatorExpression.CONDITION);
  }
  ...
  public jetbrains.mps.baseLanguage.structure.Expression getIfTrue() {
    return (jetbrains.mps.baseLanguage.structure.Expression)this.getChild(Expression.class, TernaryOperatorExpression.IF_TRUE);
  }

  public void setIfTrue(jetbrains.mps.baseLanguage.structure.Expression node) {
    super.setChild(TernaryOperatorExpression.IF_TRUE, node);
  }

  public jetbrains.mps.baseLanguage.structure.Expression getIfFalse() {
    return (jetbrains.mps.baseLanguage.structure.Expression)this.getChild(Expression.class, TernaryOperatorExpression.IF_FALSE);
  }

  public void setIfFalse(jetbrains.mps.baseLanguage.structure.Expression node) {
