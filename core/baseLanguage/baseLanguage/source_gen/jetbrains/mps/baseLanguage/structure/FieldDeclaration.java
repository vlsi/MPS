...
public class FieldDeclaration extends BaseConcept implements BaseScope, BaseScope, BaseScope {
  ...
  public INodeAdapter getVisibility() {
    return (INodeAdapter)this.getChild(, FieldDeclaration.VISIBILITY);
  }
