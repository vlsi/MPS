...
public class FieldReferenceOperation extends BaseConcept implements BaseScope {
  ...
  public INodeAdapter getFieldDeclaration() {
    return (INodeAdapter)this.getReferent(, FieldReferenceOperation.FIELD_DECLARATION);
  }

  public void setFieldDeclaration(INodeAdapter node) {
