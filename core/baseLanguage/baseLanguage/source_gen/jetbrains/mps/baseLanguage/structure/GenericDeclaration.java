...
public class GenericDeclaration extends jetbrains.mps.lang.core.structure.BaseConcept implements jetbrains.mps.lang.core.structure.INamedConcept {
  ...
  public Iterator<jetbrains.mps.baseLanguage.structure.TypeVariableDeclaration> typeVariableDeclarations() {
    return this.children(TypeVariableDeclaration.class, GenericDeclaration.TYPE_VARIABLE_DECLARATION);
  }

  public List<jetbrains.mps.baseLanguage.structure.TypeVariableDeclaration> getTypeVariableDeclarations() {
    return this.getChildren(TypeVariableDeclaration.class, GenericDeclaration.TYPE_VARIABLE_DECLARATION);
  }

  public void addTypeVariableDeclaration(jetbrains.mps.baseLanguage.structure.TypeVariableDeclaration node) {
    this.addChild(GenericDeclaration.TYPE_VARIABLE_DECLARATION, node);
  }

  public void insertTypeVariableDeclaration(jetbrains.mps.baseLanguage.structure.TypeVariableDeclaration prev, jetbrains.mps.baseLanguage.structure.TypeVariableDeclaration node) {
