...
public class RenameVariable_Action extends GeneratedAction {
  ...
  public boolean isApplicable(AnActionEvent event, final Map<String, Object> _params) {
    return !(((EditorComponent) MapSequence.<String,Object>fromMap(_params).get("editorComponent")).isReadOnly());
  }
  ...
  public void doExecute(@NotNull final AnActionEvent event, final Map<String, Object> _params) {
    try {
      ...
      ModelAccess.instance().runReadAction(new Runnable() {
        public void run() {
          varDeclNode.value = SLinkOperations.getTarget(((SNode) MapSequence.<String,Object>fromMap(_params).get("node")), "variableDeclaration", false);
        }
      });
      new RenameRefactoringDialog(((Frame) MapSequence.<String,Object>fromMap(_params).get("frame")), "Variable", varDeclNode.value).showDialog();
    } catch (Throwable t) {
