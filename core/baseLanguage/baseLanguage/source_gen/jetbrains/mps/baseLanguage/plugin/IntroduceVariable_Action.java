...
public class IntroduceVariable_Action extends GeneratedAction {
  ...
  public boolean isApplicable(AnActionEvent event, final Map<String, Object> _params) {
    return IntroduceLocalVariableRefactoring.isApplicable(((SNode) MapSequence.<String,Object>fromMap(_params).get("node"))) && !(((EditorComponent) MapSequence.<String,Object>fromMap(_params).get("component")).isReadOnly());
  }
  ...
  public void doExecute(@NotNull final AnActionEvent event, final Map<String, Object> _params) {
    try {
      ...
      ModelAccess.instance().runReadAction(new Runnable() {
        public void run() {
          error.value = refactoring.init(((SNode) MapSequence.<String,Object>fromMap(_params).get("node")), ((EditorComponent) MapSequence.<String,Object>fromMap(_params).get("component")));
        }
      });
      if (error.value == null) {
        final LocalVariableIntroducer introducer = new LocalVariableIntroducer(((Frame) MapSequence.<String,Object>fromMap(_params).get("frame")), refactoring, ((EditorComponent) MapSequence.<String,Object>fromMap(_params).get("component")), ((EditorContext) MapSequence.<String,Object>fromMap(_params).get("context")));
