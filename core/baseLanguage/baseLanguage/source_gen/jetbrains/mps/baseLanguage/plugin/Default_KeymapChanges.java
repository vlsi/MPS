...
public class Default_KeymapChanges extends BaseKeymapChanges {
  public Default_KeymapChanges() {
    ...
    addSimpleShortcut("jetbrains.mps.baseLanguage.plugin.ConvertAnonymousClass_Action", getShortcut(" F6"));
    ...
    addSimpleShortcut("jetbrains.mps.baseLanguage.plugin.MoveStaticMethod_Action", getShortcut(" F6"));
