...
public class StaticInitializer_Editor extends DefaultNodeEditor {
  ...
  public EditorCell createCollection_3016_0(EditorContext context, SNode node) {
    ...
    editorCell.addEditorCell(this.createCollection_3016_2(context, node));
    editorCell.addEditorCell(this.createCollection_3016_1(context, node));
  ...
  public EditorCell createCollection_3016_1(EditorContext context, SNode node) {
    EditorCell_Collection editorCell = EditorCell_Collection.createHorizontal(context, node);
    setupBasic_Collection_3016_1(editorCell, node, context);
    editorCell.setGridLayout(false);
    editorCell.setUsesBraces(false);
    editorCell.setCanBeFolded(false);
  ...
  public EditorCell createCollection_3016_2(EditorContext context, SNode node) {
    EditorCell_Collection editorCell = EditorCell_Collection.createHorizontal(context, node);
    setupBasic_Collection_3016_2(editorCell, node, context);
    editorCell.setGridLayout(false);
    editorCell.setUsesBraces(false);
    editorCell.setCanBeFolded(false);
  ...
  public EditorCell createConstant_3016_0(EditorContext context, SNode node, String text) {
    ...
    setupLabel_Constant_3016_0(editorCell, node, context);
  ...
  public EditorCell createConstant_3016_1(EditorContext context, SNode node, String text) {
    ...
    setupLabel_Constant_3016_1(editorCell, node, context);
    editorCell.setDefaultText("");
    return editorCell;
  }
  ...
  public EditorCell createConstant_3016_2(EditorContext context, SNode node, String text) {
    ...
    setupLabel_Constant_3016_2(editorCell, node, context);
    editorCell.setDefaultText("");
    return editorCell;
  }
  ...
  public EditorCell createConstant_3016_3(EditorContext context, SNode node, String text) {
    ...
    setupLabel_Constant_3016_3(editorCell, node, context);
    editorCell.setDefaultText("");
    return editorCell;
  }
  ...
  public EditorCell createRefNode_3016_0_internal(EditorContext context, SNode node, CellProviderWithRole aProvider) {
    ...
    if (editorCell instanceof EditorCell_Label) {
      setupLabel_RefNode_3016_0((EditorCell_Label)editorCell, node, context);
    }
  ...
  private static void setupBasic_Collection_3016_1(EditorCell editorCell, SNode node, EditorContext context) {
    editorCell.setCellId("Collection_3016_1");
    {
  ...
  private static void setupBasic_Indent_3016_0(EditorCell editorCell, SNode node, EditorContext context) {
    editorCell.setCellId("Indent_3016_0");
    {
      Style inlineStyle = new Style(editorCell) {
        {
          this.set(StyleAttributes.SELECTABLE, false);
  ...
  private static void setupBasic_Collection_3016_2(EditorCell editorCell, SNode node, EditorContext context) {
    editorCell.setCellId("Collection_3016_2");
    {
      Style inlineStyle = new Style(editorCell) {
        {
          this.set(StyleAttributes.SELECTABLE, false);
  ...
  private static void setupLabel_RefNode_3016_0(EditorCell_Label editorCell, SNode node, EditorContext context) {
  }

  private static void setupLabel_Constant_3016_0(EditorCell_Label editorCell, SNode node, EditorContext context) {
  }

  private static void setupLabel_Constant_3016_1(EditorCell_Label editorCell, SNode node, EditorContext context) {
  }

  private static void setupLabel_Constant_3016_2(EditorCell_Label editorCell, SNode node, EditorContext context) {
  }

  private static void setupLabel_Constant_3016_3(EditorCell_Label editorCell, SNode node, EditorContext context) {
  }
