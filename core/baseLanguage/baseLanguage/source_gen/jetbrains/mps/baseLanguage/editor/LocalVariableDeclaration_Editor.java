...
public class LocalVariableDeclaration_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createRefNodeList_2231_0(EditorContext context, SNode node) {
    AbstractCellListHandler handler = new LocalVariableDeclaration_Editor.annotationListHandler_2231_0(node, "annotation", context);
  ...
  private EditorCell createRefNodeList_2231_1(EditorContext context, SNode node) {
    AbstractCellListHandler handler = new LocalVariableDeclaration_Editor.annotationListHandler_2231_1(node, "annotation", context);
    EditorCell_Collection editorCell = handler.createCells(context, new CellLayout_Indent(), false);
