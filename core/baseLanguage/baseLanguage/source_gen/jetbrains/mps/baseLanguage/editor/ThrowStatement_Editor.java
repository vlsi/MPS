...
public class ThrowStatement_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createCollection_2637_0(EditorContext editorContext, SNode node) {
    ...
    editorCell.addEditorCell(this.createConstant_2637_0(editorContext, node, "throw"));
  ...
  private EditorCell createConstant_2637_0(EditorContext editorContext, SNode node, String text) {
  ...
  private EditorCell createConstant_2637_1(EditorContext editorContext, SNode node, String text) {
    EditorCell_Constant editorCell = new EditorCell_Constant(editorContext, node, text);
