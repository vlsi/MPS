...
public class BreakStatement_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createCollection_0420_0(EditorContext editorContext, SNode node) {
    ...
    if (renderingCondition0420_1(node, editorContext, editorContext.getOperationContext().getScope())) {
      editorCell.addEditorCell(this.createCollection_0420_2(editorContext, node));
    }
  ...
  private EditorCell createCollection_0420_2(EditorContext editorContext, SNode node) {
    EditorCell_Collection editorCell = EditorCell_Collection.createIndent2(editorContext, node);
    editorCell.setCellId("Collection_0420_2");
    {
      Style style = editorCell.getStyle();
      style.set(StyleAttributes.SELECTABLE, false);
    }
    editorCell.addEditorCell(this.createRefNode_0420_0(editorContext, node));
    return editorCell;
  }
  ...
  private EditorCell createRefNode_0420_0(EditorContext editorContext, SNode node) {
  ...
  private static boolean renderingCondition0420_1(SNode node, EditorContext editorContext, IScope scope) {
