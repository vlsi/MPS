...
public class ConstructorDeclaration_Editor extends DefaultNodeEditor {
  ...
  public EditorCell createAnnotationList(EditorContext context, SNode node) {
    if(this.myAnnotationListHandler_annotationList_ == null) {
      this.myAnnotationListHandler_annotationList_ = new ConstructorDeclaration_Editor._RefNodeListHandler11(node, "annotation", context);
    }
  ...
  public EditorCell createParameterList(EditorContext context, SNode node) {
    if(this.myParameterListHandler_parameterList_ == null) {
      this.myParameterListHandler_parameterList_ = new ConstructorDeclaration_Editor._RefNodeListHandler12(node, "parameter", context);
    }
  ...
  public EditorCell createThrowsItemList(EditorContext context, SNode node) {
    if(this.myThrowsItemListHandler_throwsItemList_ == null) {
      this.myThrowsItemListHandler_throwsItemList_ = new ConstructorDeclaration_Editor._RefNodeListHandler13(node, "throwsItem", context);
    }
  ...
  public EditorCell createAnnotationList1(EditorContext context, SNode node) {
    if(this.myAnnotationListHandler_annotationList1_ == null) {
      this.myAnnotationListHandler_annotationList1_ = new ConstructorDeclaration_Editor._RefNodeListHandler14(node, "annotation", context);
    }
  ...
  public static class _RefNodeListHandler12 extends RefNodeListHandler {
    ...
    public EditorCell createConstantCell1(EditorContext context, SNode node, String text) {
      EditorCell_Constant editorCell = new EditorCell_Constant(context, node, text);
      ConstructorDeclaration_Editor._RefNodeListHandler12.setupBasic_ConstantCell1(editorCell, node, context);
      ConstructorDeclaration_Editor._RefNodeListHandler12.setupLabel_ConstantCell1(editorCell, node, context);
      editorCell.setDefaultText("");
      return editorCell;
    }
