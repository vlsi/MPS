...
public class ContinueStatement_Editor extends DefaultNodeEditor {
  ...
  private static void setupBasic_LabelCell(EditorCell editorCell, SNode node, EditorContext context) {
    editorCell.putUserObject(EditorCell.CELL_ID, node.getId() + "_1199470083776");
  ...
  public EditorCell createRowCell(EditorContext context, SNode node) {
    ...
    if (ContinueStatement_Editor._QueryFunction_NodeCondition_1199470083816(node, context, context.getOperationContext().getScope())) {
  ...
  public EditorCell createLabelCellinternal(EditorContext context, SNode node, CellProviderWithRole aProvider) {
    ...
    ContinueStatement_Editor.setupBasic_LabelCell(editorCell, node, context);
    if (editorCell instanceof EditorCell_Label) {
      ContinueStatement_Editor.setupLabel_LabelCell((EditorCell_Label)editorCell, node, context);
    }
