...
public class Annotation_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createCollection_9459_0(EditorContext editorContext, SNode node) {
    ...
    editorCell.addEditorCell(this.createConstant_9459_0(editorContext, node, "@interface"));
  ...
  private EditorCell createCollection_9459_2(EditorContext editorContext, SNode node) {
    ...
    editorCell.addEditorCell(this.createConstant_9459_4(editorContext, node, "annotations:"));
  ...
  private EditorCell createConstant_9459_0(EditorContext editorContext, SNode node, String text) {
  ...
  private EditorCell createConstant_9459_1(EditorContext editorContext, SNode node, String text) {
    EditorCell_Constant editorCell = new EditorCell_Constant(editorContext, node, text);
  ...
  private EditorCell createConstant_9459_3(EditorContext editorContext, SNode node, String text) {
    EditorCell_Constant editorCell = new EditorCell_Constant(editorContext, node, text);
  ...
  private EditorCell createConstant_9459_4(EditorContext editorContext, SNode node, String text) {
    EditorCell_Constant editorCell = new EditorCell_Constant(editorContext, node, text);
  ...
  private static class annotationMethodListHandler_9459_0 extends RefNodeListHandler {
    ...
    public EditorCell createEmptyCell_internal(EditorContext editorContext, SNode node) {
      return this.createConstant_9459_2(editorContext, node, "<< methods >>");
    }
    ...
    private EditorCell createConstant_9459_2(EditorContext editorContext, SNode node, String text) {
      EditorCell_Constant editorCell = new EditorCell_Constant(editorContext, node, text);
