...
public class Annotation_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createCollection_mr1gse_a(EditorContext editorContext, SNode node) {
    ...
    if (renderingCondition_mr1gse_a0a(node, editorContext, editorContext.getOperationContext().getScope())) {
      editorCell.addEditorCell(this.createCollection_mr1gse_a0(editorContext, node));
    }
  ...
  private EditorCell createCollection_mr1gse_a0(EditorContext editorContext, SNode node) {
    EditorCell_Collection editorCell = EditorCell_Collection.createIndent2(editorContext, node);
    ...
    editorCell.addEditorCell(this.createRefNodeList_mr1gse_a0a(editorContext, node));
    return editorCell;
  }
  ...
  private EditorCell createRefNodeList_mr1gse_a0a(EditorContext editorContext, SNode node) {
    AbstractCellListHandler handler = new Annotation_Editor.annotationListHandler_mr1gse_a0a(node, "annotation", editorContext);
  ...
  private static class annotationListHandler_mr1gse_a0a extends RefNodeListHandler {
    public annotationListHandler_mr1gse_a0a(SNode ownerNode, String childRole, EditorContext context) {
