...
public class FieldDeclaration_keyMap extends EditorCellKeyMap {
  ...
  public static class FieldDeclaration_keyMap_Action0 extends EditorCellKeyMapAction {
    ...
    private void execute_internal(KeyEvent keyEvent, EditorContext editorContext, SNode node, List<SNode> selectedNodes) {
      SNode g;
      g = new QuotationClass_().createNode(FieldDeclaration_Behavior.call_getGetterName_1184160785366(node), SNodeOperations.copyNode(SLinkOperations.getTarget(node, "type", true)), node);
  ...
  public static class FieldDeclaration_keyMap_Action1 extends EditorCellKeyMapAction {
    ...
    private void execute_internal(KeyEvent keyEvent, EditorContext editorContext, SNode node, List<SNode> selectedNodes) {
      SNode s;
      s = new QuotationClass_1().createNode(FieldDeclaration_Behavior.call_getSetterName_1184160800181(node), node, SPropertyOperations.getString(node, "name"), SNodeOperations.copyNode(SLinkOperations.getTarget(node, "type", true)));
