...
public class Property_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createConstant_8551_0(EditorContext editorContext, SNode node) {
  ...
  private EditorCell createConstant_8551_1(EditorContext editorContext, SNode node) {
    EditorCell_Constant editorCell = new EditorCell_Constant(editorContext, node, "}");
  ...
  private EditorCell createConstant_8551_2(EditorContext editorContext, SNode node) {
    EditorCell_Constant editorCell = new EditorCell_Constant(editorContext, node, "{");
  ...
  private EditorCell createConstant_8551_3(EditorContext editorContext, SNode node) {
    EditorCell_Constant editorCell = new EditorCell_Constant(editorContext, node, "}");
