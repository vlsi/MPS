...
public class ValueParameter_Editor extends DefaultNodeEditor {
  ...
  public EditorCell createEditorCell(EditorContext context, SNode node) {
    return this.createConceptProperty1202576424794(context, node);
  }

  public EditorCell createConceptProperty1202576424794_internal(EditorContext context, SNode node, CellProviderWithRole aProvider) {
  ...
  public EditorCell createConceptProperty1202576424794(EditorContext context, SNode node) {
    CellProviderWithRole provider = new ConceptPropertyCellProvider(node, context);
    provider.setRole("alias");
    provider.setNoTargetText("<no alias>");
    provider.setReadOnly(false);
    provider.setAllowsEmptyTarget(false);
    EditorCell cellWithRole = this.createConceptProperty1202576424794_internal(context, node, provider);
