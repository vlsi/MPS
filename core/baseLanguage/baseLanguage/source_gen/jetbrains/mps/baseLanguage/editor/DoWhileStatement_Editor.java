...
public class DoWhileStatement_Editor extends DefaultNodeEditor {
  ...
  public EditorCell create_CollectionCell11373_03(EditorContext context, SNode node) {
    ...
    editorCell.setUsesBraces(false);
    editorCell.setCanBeFolded(false);
    editorCell.addEditorCell(this.create_ConstantCell11373_03(context, node, "}"));
    editorCell.addEditorCell(this.create_ConstantCell11373_04(context, node, "while"));
  ...
  public EditorCell create_CollectionCell11373_04(EditorContext context, SNode node) {
    ...
    editorCell.addEditorCell(this.create_ConstantCell11373_07(context, node, ":"));
    return editorCell;
  }
  ...
  public EditorCell create_CollectionCell11373_06(EditorContext context, SNode node) {
    ...
    editorCell.setUsesBraces(false);
    editorCell.setCanBeFolded(false);
    editorCell.addEditorCell(this.create_ConstantCell11373_08(context, node, "label"));
