...
public class DefaultSetAccessor_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createCollection_6452_0(EditorContext editorContext, SNode node) {
    ...
    editorCell.addEditorCell(this.createConstant_6452_0(editorContext, node, "set"));
    editorCell.addEditorCell(this.createConstant_6452_1(editorContext, node, ";"));
    return editorCell;
  }

  private EditorCell createConstant_6452_0(EditorContext editorContext, SNode node, String text) {
  ...
  private EditorCell createConstant_6452_1(EditorContext editorContext, SNode node, String text) {
    EditorCell_Constant editorCell = new EditorCell_Constant(editorContext, node, text);
