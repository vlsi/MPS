...
public class LowerBoundType_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createCollection_8181_0(EditorContext context, SNode node) {
    ...
    editorCell.addEditorCell(this.createRefNode_8181_0(context, node));
    return editorCell;
  }

  private EditorCell createConstant_8181_0(EditorContext context, SNode node, String text) {
  ...
  private EditorCell createConstant_8181_1(EditorContext context, SNode node, String text) {
    EditorCell_Constant editorCell = new EditorCell_Constant(context, node, text);
  ...
  private EditorCell createRefNode_8181_0(EditorContext context, SNode node) {
