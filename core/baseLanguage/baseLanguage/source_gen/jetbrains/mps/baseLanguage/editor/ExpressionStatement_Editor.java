...
public class ExpressionStatement_Editor extends DefaultNodeEditor {
  ...
  public EditorCell createConstant_9211_0(EditorContext context, SNode node, String text) {
    ...
    setupLabel_Constant_9211_0(editorCell, node, context);
  ...
  public EditorCell createRefNode_9211_0_internal(EditorContext context, SNode node, CellProviderWithRole aProvider) {
    ...
    if (editorCell instanceof EditorCell_Label) {
      setupLabel_RefNode_9211_0((EditorCell_Label)editorCell, node, context);
    }
  ...
  private static void setupLabel_RefNode_9211_0(EditorCell_Label editorCell, SNode node, EditorContext context) {
  }

  private static void setupLabel_Constant_9211_0(EditorCell_Label editorCell, SNode node, EditorContext context) {
  }
