...
import jetbrains.mps.baseLanguage.editor.BitwiseNotExpression_Parens_Actions;
import jetbrains.mps.baseLanguage.editor.BaseLanguageStyle_StyleSheet;
import jetbrains.mps.baseLanguage.editor.NotExpression_Parens_Actions;
...
public class BitwiseNotExpression_Editor extends DefaultNodeEditor {
  ...
  public EditorCell createConstant_3810_0(EditorContext context, SNode node, String text) {
    ...
    setupLabel_Constant_3810_0(editorCell, node, context);
  ...
  public EditorCell createConstant_3810_1(EditorContext context, SNode node, String text) {
    ...
    setupLabel_Constant_3810_1(editorCell, node, context);
    editorCell.setDefaultText("");
    return editorCell;
  }
  ...
  public EditorCell createConstant_3810_2(EditorContext context, SNode node, String text) {
    ...
    setupLabel_Constant_3810_2(editorCell, node, context);
    editorCell.setDefaultText("");
    return editorCell;
  }
  ...
  public EditorCell createRefNode_3810_0_internal(EditorContext context, SNode node, CellProviderWithRole aProvider) {
    ...
    if (editorCell instanceof EditorCell_Label) {
      setupLabel_RefNode_3810_0((EditorCell_Label)editorCell, node, context);
    }
  ...
  private static void setupLabel_Constant_3810_0(EditorCell_Label editorCell, SNode node, EditorContext context) {
  }

  private static void setupLabel_Constant_3810_1(EditorCell_Label editorCell, SNode node, EditorContext context) {
  }

  private static void setupLabel_RefNode_3810_0(EditorCell_Label editorCell, SNode node, EditorContext context) {
  }

  private static void setupLabel_Constant_3810_2(EditorCell_Label editorCell, SNode node, EditorContext context) {
  }
