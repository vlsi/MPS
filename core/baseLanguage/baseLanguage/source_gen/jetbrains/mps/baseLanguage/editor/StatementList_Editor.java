...
public class StatementList_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createRefNodeList_6577_0(EditorContext context, SNode node) {
    AbstractCellListHandler handler = new StatementList_Editor.statementListHandler_6577_0(node, "statement", context);
  ...
  private EditorCell createRefNodeList_6577_1(EditorContext context, SNode node) {
    AbstractCellListHandler handler = new StatementList_Editor.statementListHandler_6577_1(node, "statement", context);
    EditorCell_Collection editorCell = handler.createCells(context, new CellLayout_Indent(), false);
