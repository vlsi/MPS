...
public class Interface_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createRefNodeList_8963_0(EditorContext context, SNode node) {
    AbstractCellListHandler handler = new Interface_Editor.methodListHandler_8963_0(node, "method", context);
  ...
  private EditorCell createRefNodeList_8963_1(EditorContext context, SNode node) {
    AbstractCellListHandler handler = new Interface_Editor.extendedInterfaceListHandler_8963_0(node, "extendedInterface", context);
    EditorCell_Collection editorCell = handler.createCells(context, new CellLayout_Indent(), false);
  ...
  private EditorCell createRefNodeList_8963_2(EditorContext context, SNode node) {
    AbstractCellListHandler handler = new Interface_Editor.staticFieldListHandler_8963_0(node, "staticField", context);
    EditorCell_Collection editorCell = handler.createCells(context, new CellLayout_Indent(), false);
  ...
  private EditorCell createRefNodeList_8963_3(EditorContext context, SNode node) {
    AbstractCellListHandler handler = new Interface_Editor.annotationListHandler_8963_0(node, "annotation", context);
    EditorCell_Collection editorCell = handler.createCells(context, new CellLayout_Indent(), false);
  ...
  private EditorCell createRefNodeList_8963_4(EditorContext context, SNode node) {
    AbstractCellListHandler handler = new Interface_Editor.annotationListHandler_8963_1(node, "annotation", context);
    EditorCell_Collection editorCell = handler.createCells(context, new CellLayout_Indent(), false);
