...
public class BlockStatement_Editor extends DefaultNodeEditor {
  ...
  public static boolean _QueryFunction_NodeCondition_1145916598814(SNode node, EditorContext editorContext, IScope scope) {
    return !(SNodeOperations.hasRole(node, "jetbrains.mps.baseLanguage.structure.IfStatement", "ifFalseStatement"));
  }

  public static boolean _QueryFunction_NodeCondition_1145916692407(SNode node, EditorContext editorContext, IScope scope) {
    return !(SNodeOperations.hasRole(node, "jetbrains.mps.baseLanguage.structure.IfStatement", "ifFalseStatement"));
  }

  public static boolean _QueryFunction_NodeCondition_1145916702929(SNode node, EditorContext editorContext, IScope scope) {
    return !(SNodeOperations.hasRole(node, "jetbrains.mps.baseLanguage.structure.IfStatement", "ifFalseStatement"));
  }
  ...
  public EditorCell createColumnCell(EditorContext context, SNode node) {
    ...
    if (BlockStatement_Editor._QueryFunction_NodeCondition_1145916598814(node, context, context.getOperationContext().getScope())) {
      editorCell.addEditorCell(this.createConstantCell(context, node, "{"));
    }
    editorCell.addEditorCell(this.createRowCell(context, node));
    if (BlockStatement_Editor._QueryFunction_NodeCondition_1145916702929(node, context, context.getOperationContext().getScope())) {
  ...
  public EditorCell createRowCell(EditorContext context, SNode node) {
    ...
    editorCell.setUsesBraces(false);
    editorCell.setCanBeFolded(false);
    if (BlockStatement_Editor._QueryFunction_NodeCondition_1145916692407(node, context, context.getOperationContext().getScope())) {
  ...
  public EditorCell createStatementsCellinternal(EditorContext context, SNode node, CellProviderWithRole aProvider) {
    ...
    BlockStatement_Editor.setupBasic_StatementsCell(editorCell, node, context);
    if (editorCell instanceof EditorCell_Label) {
      BlockStatement_Editor.setupLabel_StatementsCell((EditorCell_Label)editorCell, node, context);
    }
