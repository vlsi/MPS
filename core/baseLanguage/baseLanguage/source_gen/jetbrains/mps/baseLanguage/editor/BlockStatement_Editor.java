...
public class BlockStatement_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createCollection_6106_0(EditorContext context, SNode node) {
  ...
  private EditorCell createConstant_6106_0(EditorContext context, SNode node, String text) {
  ...
  private EditorCell createConstant_6106_1(EditorContext context, SNode node, String text) {
    EditorCell_Constant editorCell = new EditorCell_Constant(context, node, text);
  ...
  private EditorCell createRefNode_6106_0(EditorContext context, SNode node) {
