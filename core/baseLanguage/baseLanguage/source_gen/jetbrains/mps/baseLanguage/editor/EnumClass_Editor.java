...
public class EnumClass_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createRefNodeList_3195_0(EditorContext context, SNode node) {
    AbstractCellListHandler handler = new EnumClass_Editor.fieldListHandler_3195_0(node, "field", context);
  ...
  private EditorCell createRefNodeList_3195_1(EditorContext context, SNode node) {
    AbstractCellListHandler handler = new EnumClass_Editor.enumConstantListHandler_3195_0(node, "enumConstant", context);
    EditorCell_Collection editorCell = handler.createCells(context, new CellLayout_Indent(), false);
  ...
  private EditorCell createRefNodeList_3195_2(EditorContext context, SNode node) {
    AbstractCellListHandler handler = new EnumClass_Editor.constructorListHandler_3195_0(node, "constructor", context);
    EditorCell_Collection editorCell = handler.createCells(context, new CellLayout_Indent(), false);
  ...
  private EditorCell createRefNodeList_3195_3(EditorContext context, SNode node) {
    AbstractCellListHandler handler = new EnumClass_Editor.methodListHandler_3195_0(node, "method", context);
    EditorCell_Collection editorCell = handler.createCells(context, new CellLayout_Indent(), false);
  ...
  private EditorCell createRefNodeList_3195_4(EditorContext context, SNode node) {
    AbstractCellListHandler handler = new EnumClass_Editor.staticMethodListHandler_3195_0(node, "staticMethod", context);
    EditorCell_Collection editorCell = handler.createCells(context, new CellLayout_Indent(), false);
  ...
  private EditorCell createRefNodeList_3195_5(EditorContext context, SNode node) {
    AbstractCellListHandler handler = new EnumClass_Editor.implementedInterfaceListHandler_3195_0(node, "implementedInterface", context);
    EditorCell_Collection editorCell = handler.createCells(context, new CellLayout_Indent(), false);
