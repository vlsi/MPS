...
public class LocalStaticFieldReference_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createCollection_6606_0(EditorContext context, SNode node) {
    EditorCell_Collection editorCell = EditorCell_Collection.createIndent2(context, node);
    editorCell.setCellId("Collection_6606_0");
    editorCell.addEditorCell(this.createRefCell_6606_0(context, node));
    return editorCell;
  }

  private EditorCell createRefCell_6606_0(EditorContext context, SNode node) {
  ...
  public static class _Inline6606_0 extends AbstractCellProvider {
    ...
    public EditorCell createEditorCell(EditorContext context, SNode node) {
      return this.createProperty_6606_0(context, node);
    }

    private EditorCell createProperty_6606_0(EditorContext context, SNode node) {
