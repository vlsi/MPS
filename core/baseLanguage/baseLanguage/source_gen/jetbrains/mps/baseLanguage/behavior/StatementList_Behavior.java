...
public class StatementList_Behavior {
  ...
  public static List<SNode> call_getDeclaredVariables_2496361171403550911(SNode thisNode) {
    return (List<SNode>) BehaviorManager.getInstance().invoke(Object.class, SNodeOperations.cast(thisNode, "jetbrains.mps.baseLanguage.structure.StatementList"), "virtual_getDeclaredVariables_3822000666564591100", PARAMETERS_2496361171403550911);
  }

  public static List<SNode> callSuper_getDeclaredVariables_2496361171403550911(SNode thisNode, String callerConceptFqName) {
    return (List<SNode>) BehaviorManager.getInstance().invokeSuper(Object.class, SNodeOperations.cast(thisNode, "jetbrains.mps.baseLanguage.structure.StatementList"), callerConceptFqName, "virtual_getDeclaredVariables_3822000666564591100", PARAMETERS_2496361171403550911);
  }
}
