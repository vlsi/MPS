...
public class CatchClause_Behavior {
  ...
  public static List<SNode> call_getScopeVariables_2496361171403550981(SNode thisNode) {
    return (List<SNode>) BehaviorManager.getInstance().invoke(Object.class, SNodeOperations.cast(thisNode, "jetbrains.mps.baseLanguage.structure.CatchClause"), "virtual_getScopeVariables_3822000666564591100", PARAMETERS_2496361171403550981);
  }

  public static List<SNode> callSuper_getScopeVariables_2496361171403550981(SNode thisNode, String callerConceptFqName) {
    return (List<SNode>) BehaviorManager.getInstance().invokeSuper(Object.class, SNodeOperations.cast(thisNode, "jetbrains.mps.baseLanguage.structure.CatchClause"), callerConceptFqName, "virtual_getScopeVariables_3822000666564591100", PARAMETERS_2496361171403550981);
  }
}
