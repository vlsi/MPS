...
/*package*/ class ParametersPanel extends JPanel {
  ...
  private void initPanel() {
    ...
    final JButton upButton = this.createParametersRowMoveButton(parametersTable, "Move up", -1, 0);
    final JButton downButton = this.createParametersRowMoveButton(parametersTable, "Move down", 1, 1);
  ...
  private JButton createParametersRowMoveButton(final JTable parametersTable, String name, final int dr, int y) {
    GridBagConstraints c = new GridBagConstraints();
