...
public class MoveStaticMethodRefactoring extends BasicMoveRefactoring {
  ...
  public static class QuotationClass_f5lqsg_a0a0a1a1a3 {
    ...
    public SNode createNode(Object parameter_3) {
      ...
      SNode quotedNode_1 = null;
      {
        quotedNode_1 = SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.baseLanguage.structure.LocalStaticMethodCall", TypeChecker.getInstance().getRuntimeTypesModel(), GlobalScope.getInstance(), false);
        SNode quotedNode1_2 = quotedNode_1;
