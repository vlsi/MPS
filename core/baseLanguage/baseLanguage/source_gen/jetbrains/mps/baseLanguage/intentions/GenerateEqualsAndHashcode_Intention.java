...
public class GenerateEqualsAndHashcode_Intention extends GenerateIntention {
  ...
  public void execute(final SNode node, final EditorContext editorContext) {
    ...
    SLinkOperations.addChild(SLinkOperations.getTarget(equalsDeclaration, "body", true), "statement", new _Quotations.QuotationClass_32().createNode());
    ...
    for (final SNode field : fields) {
      ...
      if (SNodeOperations.isInstanceOf(SLinkOperations.getTarget(field, "type", true), "jetbrains.mps.baseLanguage.structure.IntegerType")) {
        ...
        calcStatement = new _Quotations.QuotationClass_33().createNode(resultReference, plusExpression, thisExp, field, thisExp, field);
        ...
        calcStatement = new _Quotations.QuotationClass_34().createNode(resultReference, plusExpression, fieldRefOperation, fieldRefOperation);
      } else if (SNodeOperations.isInstanceOf(SLinkOperations.getTarget(field, "type", true), "jetbrains.mps.baseLanguage.structure.ArrayType")) {
        calcStatement = new _Quotations.QuotationClass_35().createNode(plusExpression, thisExp, fieldRefOperation, thisExp, fieldRefOperation, resultReference);
      } else {
        calcStatement = new _Quotations.QuotationClass_36().createNode(thisExp, fieldRefOperation, thisExp, fieldRefOperation, plusExpression, resultReference);
      }
