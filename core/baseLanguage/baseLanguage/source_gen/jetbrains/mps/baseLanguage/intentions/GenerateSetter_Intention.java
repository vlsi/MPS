...
public class GenerateSetter_Intention extends GenerateIntention {
  ...
  public void execute(final SNode node, final EditorContext editorContext) {
    ...
    for (final SNode field : fields) {
      ...
      SLinkOperations.addChild(classConcept, "method", new _Quotations.QuotationClass_22().createNode(thisExpression, field, SLinkOperations.getTarget(field, "type", true), SPropertyOperations.getString(field, "name"), setterName));
    }
  }
