  ...
  public void applyRule(final SNode nodeToCheck, final TypeCheckingContext typeCheckingContext) {
    if (!(SPropertyOperations.hasValue(nodeToCheck, "label", null))) {
      ...
      if (!(Sequence.fromIterable(matchingLoops).isNotEmpty())) {
        ...
        typeCheckingContext.reportTypeError(nodeToCheck, "No such label", "r:00000000-0000-4000-0000-011c895902c5(jetbrains.mps.baseLanguage.typesystem)", "1199469904373", intentionProvider, errorTarget);
      }
    }
  }
