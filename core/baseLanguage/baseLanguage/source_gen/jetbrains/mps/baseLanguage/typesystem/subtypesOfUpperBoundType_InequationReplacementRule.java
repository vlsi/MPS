    ...
    if (SNodeOperations.isInstanceOf(subtype, "jetbrains.mps.baseLanguage.structure.UpperBoundType")) {
      {
        ...
        typeCheckingContext.createLessThanInequality((SNode) SLinkOperations.getTarget(SNodeOperations.cast(subtype, "jetbrains.mps.baseLanguage.structure.UpperBoundType"), "bound", true), (SNode) SLinkOperations.getTarget(supertype, "bound", true), false, inequalityIsWeak, inequalityIsLessThan, _info_12389875345);
      }
    } else {
      {
        SNode _nodeToCheck_1029348928467 = equationInfo.getNodeWithError();
        ...
        _info_12389875345.getOuterRulesIdFromInfo(equationInfo);
        typeCheckingContext.createLessThanInequality((SNode) subtype, (SNode) SLinkOperations.getTarget(supertype, "bound", true), false, inequalityIsWeak, inequalityIsLessThan, _info_12389875345);
      }
    }
  }
