...
public class check_ConceptFunctionReturns_CheckingRule extends AbstractNonTypesystemRule_Runtime implements Rule_Runtime {
  public check_ConceptFunctionReturns_CheckingRule() {
  }
  ...
  public void applyRule(final SNode func, final TypeCheckingContext typeCheckingContext, IsApplicableStatus status) {
    ...
    boolean noReturnExpected = ((expectedRetType == null) || TypeChecker.getInstance().getSubtypingManager().isSubtype(expectedRetType, new check_ConceptFunctionReturns_CheckingRule.QuotationClass_7b9ct9_a1a0a0a1a0().createNode(typeCheckingContext)));
  ...
  public static class QuotationClass_7b9ct9_a1a0a0a1a0 {
    public QuotationClass_7b9ct9_a1a0a0a1a0() {
    }
