  ...
  public void applyRule(final SNode propertyReference, final TypeCheckingContext typeCheckingContext) {
    ...
    if ((property != null)) {
      ...
      }
      {
        SNode _nodeToCheck_1029348928467 = propertyReference;
        BaseIntentionProvider intentionProvider = null;
        typeCheckingContext.createLessThanInequationStrong(typeCheckingContext.typeOf(IOperation_Behavior.call_getOperand_1213877410070(propertyReference), "r:00000000-0000-4000-0000-011c895902c5(jetbrains.mps.baseLanguage.typesystem)", "1201468086552", true), new _Quotations.QuotationClass_78().createNode(SNodeOperations.getAncestor(property, "jetbrains.mps.baseLanguage.structure.Classifier", false, false), typeCheckingContext), _nodeToCheck_1029348928467, null, "r:00000000-0000-4000-0000-011c895902c5(jetbrains.mps.baseLanguage.typesystem)", "1201468086542", false, 0, intentionProvider);
      }
    }
  }
