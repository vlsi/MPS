...
public class check_ClassifierType_CheckingRule extends AbstractNonTypesystemRule_Runtime implements Rule_Runtime {
  public check_ClassifierType_CheckingRule() {
  }
  ...
  public void applyRule(final SNode classifierType, final TypeCheckingContext typeCheckingContext, IsApplicableStatus status) {
    ...
    for (SNode typeParameter : SLinkOperations.getTargets(classifierType, "parameter", true)) {
      if (!(!(TypeChecker.getInstance().getSubtypingManager().isSubtype(typeParameter, SLinkOperations.getTarget(new check_ClassifierType_CheckingRule.QuotationClass_ikkq2p_a0b0a0a0e0a().createNode(typeCheckingContext), "descriptor", false), false)))) {
        MessageTarget errorTarget = new NodeMessageTarget();
  ...
  public static class QuotationClass_ikkq2p_a0b0a0a0e0a {
    public QuotationClass_ikkq2p_a0b0a0a0e0a() {
    }
