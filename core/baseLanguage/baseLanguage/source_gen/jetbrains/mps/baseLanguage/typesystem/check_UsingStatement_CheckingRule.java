...
public class check_UsingStatement_CheckingRule extends AbstractNonTypesystemRule_Runtime implements Rule_Runtime {
  public check_UsingStatement_CheckingRule() {
  }
...
outer:
    for (SNode resource : SLinkOperations.getTargets(usingStatement, "resource", true)) {
      ...
      if (TypeChecker.getInstance().getSubtypingManager().isSubtype(type, new check_UsingStatement_CheckingRule.QuotationClass_2uinyx_a1a0b0a0a().createNode(typeCheckingContext))) {
        continue;
      }
  ...
  public static class QuotationClass_2uinyx_a1a0b0a0a {
    public QuotationClass_2uinyx_a1a0b0a0a() {
    }
