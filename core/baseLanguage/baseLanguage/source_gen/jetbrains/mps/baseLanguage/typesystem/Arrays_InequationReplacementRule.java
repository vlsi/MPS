    ...
    if (!(SNodeOperations.isInstanceOf(SLinkOperations.getTarget(subtype, "componentType", true), "jetbrains.mps.baseLanguage.structure.PrimitiveType"))) {
      {
        ...
        typeCheckingContext.createLessThanInequation((SNode) SLinkOperations.getTarget(subtype, "componentType", true), (SNode) SLinkOperations.getTarget(supertype, "componentType", true), false, _info_12389875345);
      }
    } else {
      {
        SNode _nodeToCheck_1029348928467 = equationInfo.getNodeWithError();
