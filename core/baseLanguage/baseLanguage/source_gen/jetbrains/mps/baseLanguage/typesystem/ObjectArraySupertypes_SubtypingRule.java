...
public class ObjectArraySupertypes_SubtypingRule extends SubtypingRule_Runtime implements ISubtypingRule_Runtime {
  ...
  public List<SNode> getSubOrSuperTypes(SNode objectArrayType) {
    // see JLS 3.0
    return CollectionUtil.asList(new _Quotations.QuotationClass_80().createNode(), new _Quotations.QuotationClass_81().createNode(), new _Quotations.QuotationClass_82().createNode());
  }
