...
public class check_CaughtWasThrown_CheckingRule extends AbstractNonTypesystemRule_Runtime implements Rule_Runtime {
  public check_CaughtWasThrown_CheckingRule() {
  }
  ...
  public void applyRule(final SNode catchClause, final TypeCheckingContext typeCheckingContext, IsApplicableStatus status) {
    ...
    if (SNodeOperations.isInstanceOf(caughtType, "jetbrains.mps.baseLanguage.structure.ClassifierType")) {
      ...
      if (TypeChecker.getInstance().getSubtypingManager().isSubtype(caughtType, new check_CaughtWasThrown_CheckingRule.QuotationClass_z90v9n_a1a0a0a1a1a0().createNode(typeCheckingContext)) || TypeChecker.getInstance().getSubtypingManager().isSubtype(caughtType, new check_CaughtWasThrown_CheckingRule.QuotationClass_z90v9n_a1a0a0a1a1a0_0().createNode(typeCheckingContext)) || caughtClassifier == SNodeOperations.getNode("f:java_stub#6354ebe7-c22a-4a0f-ac54-50b52ab9b065#java.lang(JDK/java.lang@java_stub)", "~Exception") || caughtClassifier == SNodeOperations.getNode("f:java_stub#6354ebe7-c22a-4a0f-ac54-50b52ab9b065#java.lang(JDK/java.lang@java_stub)", "~Throwable")) {
        // ignore 
      } else {
        ...
        if (!(SetSequence.fromSet(thrown).any(new IWhereFilter<SNode>() {
          public boolean accept(SNode t) {
            return TypeChecker.getInstance().getSubtypingManager().isSubtype(new check_CaughtWasThrown_CheckingRule.QuotationClass_z90v9n_a0a0a0a0a0a3a0b0b0a().createNode(t, typeCheckingContext), caughtType) || TypeChecker.getInstance().getSubtypingManager().isSubtype(caughtType, new check_CaughtWasThrown_CheckingRule.QuotationClass_z90v9n_a1a0a0a0a0a3a0b0b0a().createNode(t, typeCheckingContext));
          }
        }))) {
          {
  ...
  public static class QuotationClass_z90v9n_a1a0a0a1a1a0 {
    public QuotationClass_z90v9n_a1a0a0a1a1a0() {
    }
  ...
  public static class QuotationClass_z90v9n_a1a0a0a1a1a0_0 {
    public QuotationClass_z90v9n_a1a0a0a1a1a0_0() {
    }
  ...
  public static class QuotationClass_z90v9n_a0a0a0a0a0a3a0b0b0a {
    public QuotationClass_z90v9n_a0a0a0a0a0a3a0b0b0a() {
    }
  ...
  public static class QuotationClass_z90v9n_a1a0a0a0a0a3a0b0b0a {
    public QuotationClass_z90v9n_a1a0a0a0a0a3a0b0b0a() {
    }
