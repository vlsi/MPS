  ...
  public void applyRule(final SNode elsifClause, final TypeCheckingContext typeCheckingContext) {
    {
      ...
      typeCheckingContext.createLessThanInequation((SNode)typeCheckingContext.typeOf(_nodeToCheck_1029348928467, "r:00000000-0000-4000-0000-011c895902c5(jetbrains.mps.baseLanguage.typesystem)", "1206069320266", true), (SNode)new _Quotations.QuotationClass_64().createNode(typeCheckingContext), false, _info_12389875345);
    }
  }
