...
public class check_ForeachWithErasure_CheckingRule extends AbstractNonTypesystemRule_Runtime implements Rule_Runtime {
  private static SNodePointer SNODE_POINTER_f6xdea_a0a0a0a0b0c0a0a0a0a0c0a = new SNodePointer("f:java_stub#6354ebe7-c22a-4a0f-ac54-50b52ab9b065#java.lang(JDK/java.lang@java_stub)", "~Iterable");

  public check_ForeachWithErasure_CheckingRule() {
  }
  ...
  public void applyRule(final SNode foreachStatement, final TypeCheckingContext typeCheckingContext, IsApplicableStatus status) {
    ...
    {
      GeneratedMatchingPattern pattern_gn1qzs_c0 = new check_ForeachWithErasure_CheckingRule.Pattern_f6xdea_a0a0a2a0();
      ...
      if (coercedNode_gn1qzs_c0 != null) {
        ...
        if (!(MatchingUtil.matchNodes(SLinkOperations.getTarget(SLinkOperations.getTarget(foreachStatement, "variable", true), "type", true), new check_ForeachWithErasure_CheckingRule.QuotationClass_f6xdea_a0a0b0a2a2a0().createNode(typeCheckingContext)))) {
          {
  ...
  public static class Pattern_f6xdea_a0a0a2a0 extends GeneratedMatchingPattern implements IMatchingPattern {
    /*package*/ SNode patternVar_p;

    public Pattern_f6xdea_a0a0a2a0() {
    }
    ...
    public boolean match(SNode nodeToMatch) {
      {
        ...
        {
          SNodePointer pointer = SNODE_POINTER_f6xdea_a0a0a0a0b0c0a0a0a0a0c0a;
  ...
  public static class QuotationClass_f6xdea_a0a0b0a2a2a0 {
    public QuotationClass_f6xdea_a0a0b0a2a2a0() {
    }
