...
public class check_StringTypeClassifierType_CheckingRule extends AbstractNonTypesystemRule_Runtime implements Rule_Runtime {
  public check_StringTypeClassifierType_CheckingRule() {
  }

  public void applyRule(final SNode node, final TypeCheckingContext typeCheckingContext, IsApplicableStatus status) {
    if (SLinkOperations.getTarget(node, "classifier", false) == SLinkOperations.getTarget(new check_StringTypeClassifierType_CheckingRule.QuotationClass_e3nsdo_a0a0a0a().createNode(typeCheckingContext), "classifier", false)) {
      {
  ...
  public static class QuotationClass_e3nsdo_a0a0a0a {
    public QuotationClass_e3nsdo_a0a0a0a() {
    }
