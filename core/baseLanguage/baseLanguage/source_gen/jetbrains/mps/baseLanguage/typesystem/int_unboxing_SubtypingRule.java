...
public class int_unboxing_SubtypingRule extends SubtypingRule_Runtime implements ISubtypingRule_Runtime {
  private static SNodePointer SNODE_POINTER_nhleq2_a0a1a0a1a2a0a0a0a0a0a2 = new SNodePointer("f:java_stub#6354ebe7-c22a-4a0f-ac54-50b52ab9b065#java.lang(JDK/java.lang@java_stub)", "~Integer");
    ...
    public boolean match(SNode nodeToMatch) {
      {
        ...
        {
          SNode referent;
          referent = SNODE_POINTER_nhleq2_a0a1a0a1a2a0a0a0a0a0a2.getNode();
