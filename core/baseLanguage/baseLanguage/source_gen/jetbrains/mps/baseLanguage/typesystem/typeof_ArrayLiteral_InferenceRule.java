...
public class typeof_ArrayLiteral_InferenceRule extends AbstractInferenceRule_Runtime implements InferenceRule_Runtime {
  ...
  public void applyRule(final SNode arrayLiteral, final TypeCheckingContext typeCheckingContext) {
    ...
    }
    {
      ...
      typeCheckingContext.createEquation((SNode) typeCheckingContext.typeOf(_nodeToCheck_1029348928467, "r:00000000-0000-4000-0000-011c895902c5(jetbrains.mps.baseLanguage.typesystem)", "1188221454647", true), (SNode) new typeof_ArrayLiteral_InferenceRule.QuotationClass_8lb61p_a0a2a0().createNode(typeCheckingContext.getEquationManager().getRepresentator(elementType_typevar_1188221443596), typeCheckingContext), _info_12389875345);
    }
  }
  ...
  public static class QuotationClass_8lb61p_a0a2a0 {
    ...
    public SNode createNode(Object parameter_8lb61p_a0a0a0c0a, final TypeCheckingContext typeCheckingContext) {
      ...
      SNode quotedNode_8lb61p_a0a2a0 = null;
      SNode quotedNode_8lb61p_a0a0c0a = null;
      {
        quotedNode_8lb61p_a0a2a0 = SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.baseLanguage.structure.ArrayType", TypeChecker.getInstance().getRuntimeTypesModel(), GlobalScope.getInstance(), false);
        SNode quotedNode1_8lb61p_a0a2a0 = quotedNode_8lb61p_a0a2a0;
        {
          quotedNode_8lb61p_a0a0c0a = (SNode) parameter_8lb61p_a0a0a0c0a;
          SNode quotedNode1_8lb61p_a0a0c0a;
          if (_parameterValues_129834374.contains(quotedNode_8lb61p_a0a0c0a)) {
            quotedNode1_8lb61p_a0a0c0a = CopyUtil.copy(quotedNode_8lb61p_a0a0c0a);
          } else {
            _parameterValues_129834374.add(quotedNode_8lb61p_a0a0c0a);
            quotedNode1_8lb61p_a0a0c0a = quotedNode_8lb61p_a0a0c0a;
          }
          if (quotedNode1_8lb61p_a0a0c0a != null) {
            quotedNode_8lb61p_a0a2a0.addChild("componentType", HUtil.copyIfNecessary(quotedNode1_8lb61p_a0a0c0a, typeCheckingContext));
          }
        }
        result = quotedNode1_8lb61p_a0a2a0;
      }
      return result;
    }
    ...
    public SNode createNode(Object parameter_8lb61p_a0a0a0c0a) {
      ...
      SNode quotedNode_8lb61p_a0a0c0a = null;
      {
        ...
        SNode quotedNode1_8lb61p_a0a2a0 = quotedNode_8lb61p_a0a2a0;
        {
          ...
          if (quotedNode1_8lb61p_a0a0c0a != null) {
            quotedNode_8lb61p_a0a2a0.addChild("componentType", HUtil.copyIfNecessary(quotedNode1_8lb61p_a0a0c0a));
          }
        }
        result = quotedNode1_8lb61p_a0a2a0;
      }
