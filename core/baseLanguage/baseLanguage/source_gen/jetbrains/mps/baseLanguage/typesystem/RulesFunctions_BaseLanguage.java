    ...
    if (ListSequence.fromList(SLinkOperations.getTargets(methodCall, "typeArgument", true)).isNotEmpty() && (SLinkOperations.getTarget(methodCall, "baseMethodDeclaration", false) != null) && mmap != null && !(MapSequence.fromMap(mmap).isEmpty())) {
      ...
      while (tvd_it.hasNext() && arg_it.hasNext()) {
        ...
        if (nodes != null) {
          ...
          {
            SNode _nodeToCheck_1029348928467 = null;
            EquationInfo _info_12389875345 = new EquationInfo(_nodeToCheck_1029348928467, null, "r:00000000-0000-4000-0000-011c895902c5(jetbrains.mps.baseLanguage.typesystem)", "6376899660218018325", 0, null);
    ...
    if (SNodeOperations.isInstanceOf(SLinkOperations.getTarget(ListSequence.fromList(parameterDeclarations).last(), "type", true), "jetbrains.mps.baseLanguage.structure.VariableArityType")) {
              ...
              if ((int) ListSequence.fromList(SLinkOperations.getTargets(mc, "actualArgument", true)).count() == (int) ListSequence.fromList(parameterDeclarations).count()) {
                ...
                final SNode actual = actualIterator.next();
                {
                  ...
                  typeCheckingContext.whenConcrete(actualType, new Runnable() {
                    public void run() {
                      if (SNodeOperations.isInstanceOf(typeCheckingContext.getExpandedType(actualType), "jetbrains.mps.baseLanguage.structure.ArrayType")) {
                        {
                          ...
                          typeCheckingContext.createGreaterThanInequality((SNode) matchedType, (SNode) SLinkOperations.getTarget(SNodeOperations.cast(typeCheckingContext.getExpandedType(actualType), "jetbrains.mps.baseLanguage.structure.ArrayType"), "componentType", true), false, true, _info_12389875345);
                        }
                      } else {
                        SNode _nodeToCheck_1029348928467 = actual;
                        ...
                        typeCheckingContext.createGreaterThanInequality((SNode) matchedType, (SNode) typeCheckingContext.getExpandedType(actualType), false, true, _info_12389875345);
                      }
                    }
      ...
      while (arg_it.hasNext() && param_it.hasNext()) {
        ...
        SNode matchedType = inference_matchTypeWithTypeVariables(typeCheckingContext, SLinkOperations.getTarget(param_var, "type", true), mmap);
        {
          ...
          EquationInfo _info_12389875345 = new EquationInfo(_nodeToCheck_1029348928467, null, "r:00000000-0000-4000-0000-011c895902c5(jetbrains.mps.baseLanguage.typesystem)", "6376899660218018357", 0, null);
          typeCheckingContext.createGreaterThanInequality((SNode) matchedType, (SNode) typeCheckingContext.typeOf(arg_var, "r:00000000-0000-4000-0000-011c895902c5(jetbrains.mps.baseLanguage.typesystem)", "6376899660218018359", true), false, true, _info_12389875345);
        }
      }
    }
    if (returnType != null) {
