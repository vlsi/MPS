...
public class RulesFunctions_BaseLanguage {
  ...
  public static Iterable<SNode> collectReturnStatements(SNode node) {
    Iterable<SNode> returnStatements = ListSequence.fromList(SNodeOperations.getChildren(node)).translate(new ITranslator2 <?, SNode>() {

      public Iterable<SNode> translate(final ? it) {
    ...
    for(SNode statementList : statementLists) {
      ...
      if (SNodeOperations.isInstanceOf(parent, "jetbrains.mps.baseLanguage.structure.BaseMethodDeclaration") && SLinkOperations.getTarget(parent, "body", true) == statementList) {
        ...
        if (!(throwables.isEmpty())) {
          ...
          {
            BaseIntentionProvider intentionProvider = null;
            intentionProvider = new BaseIntentionProvider("r:7281435b-afbb-4eb7-b1d9-400543a5f5db(jetbrains.mps.baseLanguage.typesystem@15_0).AddExceptionToMethodSignature_QuickFix", false);
