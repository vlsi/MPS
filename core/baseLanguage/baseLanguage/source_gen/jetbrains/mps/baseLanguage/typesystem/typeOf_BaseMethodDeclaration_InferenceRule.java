    ...
    for(SNode throwsItem : SLinkOperations.getTargets(bmd, "throwsItem", true)) {
      {
        ...
        typeCheckingContext.createLessThanInequation((SNode)throwsItem, (SNode)new _Quotations.QuotationClass_30().createNode(typeCheckingContext), _nodeToCheck_1029348928467, null, "r:00000000-0000-4000-0000-011c895902c5(jetbrains.mps.baseLanguage.typesystem)", "1215105338790", false, 0, intentionProvider);
      }
    }
    // ==========
