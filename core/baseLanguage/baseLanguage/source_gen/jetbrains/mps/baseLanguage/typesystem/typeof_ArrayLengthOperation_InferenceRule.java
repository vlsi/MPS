...
public class typeof_ArrayLengthOperation_InferenceRule extends AbstractInferenceRule_Runtime implements InferenceRule_Runtime {
  ...
  public static class QuotationClass_8652_0 {
    ...
    public SNode createNode(final TypeCheckingContext typeCheckingContext) {
      ...
      {
        quotedNode_110 = SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.baseLanguage.structure.IntegerType", TypeChecker.getInstance().getRuntimeTypesModel(), GlobalScope.getInstance(), false);
        SNode quotedNode1_108 = quotedNode_110;
