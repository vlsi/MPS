    ...
    if (!(StringLiteral_Behavior.call_isCorrect_1221565233201(stringLiteral))) {
      {
        ...
        typeCheckingContext.reportTypeError(stringLiteral, "Incorrect string literal", "r:00000000-0000-4000-0000-011c895902c5(jetbrains.mps.baseLanguage.typesystem)", "1221566486911", intentionProvider, errorTarget);
      }
    }
  }
