    ...
    if (!(b)) {
      {
        ...
        intentionProvider = new BaseIntentionProvider("r:ed6478fc-2afe-47f0-bab4-a562aa3c7d79(jetbrains.mps.baseLanguage.typesystem@17_0).ChooseAppropriateMethodDeclaration_QuickFix", true);
