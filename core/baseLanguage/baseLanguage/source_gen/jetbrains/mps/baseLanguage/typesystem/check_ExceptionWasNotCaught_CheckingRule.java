...
public class check_ExceptionWasNotCaught_CheckingRule extends AbstractNonTypesystemRule_Runtime implements Rule_Runtime {
  public check_ExceptionWasNotCaught_CheckingRule() {
  }
  ...
  public void applyRule(final SNode iTryCatchStatement, final TypeCheckingContext typeCheckingContext, IsApplicableStatus status) {
    ...
    for (SNode catchClause : ITryCatchStatement_Behavior.call_getCatchClauses_3718132079121388582(iTryCatchStatement)) {
      ...
      if (TypeChecker.getInstance().getSubtypingManager().isSubtype(catchType, new check_ExceptionWasNotCaught_CheckingRule.QuotationClass_fm8ea3_a1a0b0b0a().createNode(typeCheckingContext))) {
  ...
  public static class QuotationClass_fm8ea3_a1a0b0b0a {
    public QuotationClass_fm8ea3_a1a0b0b0a() {
    }
