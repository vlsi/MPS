                ...
                for (TreePath path : paths) {
                  ...
                  if (node instanceof MPSTreeNodeEx) {
                    ...
                    if (SNodeOperations.isInstanceOf(snode, "jetbrains.mps.baseLanguage.structure.FieldDeclaration")) {
                      ListSequence.<SNode>fromList(((List<SNode>) (getSmartActionContext()).get("fields")[0])).addElement(SNodeOperations.cast(snode, "jetbrains.mps.baseLanguage.structure.FieldDeclaration"));
                    }
                  }
                }
              }
