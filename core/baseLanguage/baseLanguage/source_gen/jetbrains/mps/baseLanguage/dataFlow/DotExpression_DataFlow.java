...
public class DotExpression_DataFlow extends DataFlowBuilder {
  ...
  public void build(final IOperationContext operationContext, final DataFlowBuilderContext _context) {
    _context.getBuilder().build(SLinkOperations.getTarget(_context.getNode(), "operand", true));
    _context.getBuilder().build(SLinkOperations.getTarget(_context.getNode(), "operation", true));
  }
