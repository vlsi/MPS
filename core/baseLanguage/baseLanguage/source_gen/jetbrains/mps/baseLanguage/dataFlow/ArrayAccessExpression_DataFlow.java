...
public class ArrayAccessExpression_DataFlow extends DataFlowBuilder {
  ...
  public void build(final IOperationContext operationContext, final DataFlowBuilderContext _context) {
    _context.getBuilder().build(SLinkOperations.getTarget(_context.getNode(), "index", true));
    _context.getBuilder().build(SLinkOperations.getTarget(_context.getNode(), "array", true));
  }
