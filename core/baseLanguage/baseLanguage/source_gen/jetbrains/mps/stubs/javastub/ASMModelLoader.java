...
public abstract class ASMModelLoader {
  ...
  private void updateInstanceFields(ASMClass refCls, ClassConcept cls) {
    ...
    for (ASMField field : refCls.getDeclaredFields()) {
      if (field.isPrivate() && SKIP_PRIVATE) {
        continue;
      }
      if (field.isStatic()) {
        continue;
