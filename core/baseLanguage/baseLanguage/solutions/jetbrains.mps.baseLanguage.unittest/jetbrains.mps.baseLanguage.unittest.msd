...
<solution name="jetbrains.mps.baseLanguage.unittest" uuid="e60b351d-8d80-4c13-8ad4-3e4759e2a3ea" compileInMPS="true" generatorOutputPath="${mps_home}/core/baseLanguage/baseLanguage/tests_gen">
  <models>
    <modelRoot path="${solution_descriptor}/" namespacePrefix="" />
  </models>
  <stubModelEntries>
    <stubModelEntry path="${mps_home}/core/languageDesign/test/testclasses" include="false">
