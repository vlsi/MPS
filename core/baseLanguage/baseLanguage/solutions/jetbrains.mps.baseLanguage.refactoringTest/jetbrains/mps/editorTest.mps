...
<model modelUID="r:914ee49a-537d-44b2-a5fb-bac87a54743d(jetbrains.mps.editorTest)">
  ...
  <node type="jetbrains.mps.lang.test.structure.EditorTestCase" id="6925365911337389220">
    <property name="package" value="selection" />
    <property name="name" value="GoByCurrentReference" />
    <node role="nodeToEdit" type="jetbrains.mps.baseLanguage.structure.StatementList" id="6925365911337413313">
      <node role="statement" type="jetbrains.mps.baseLanguage.structure.LocalVariableDeclarationStatement" id="6925365911337413314">
        <node role="localVariableDeclaration" type="jetbrains.mps.baseLanguage.structure.LocalVariableDeclaration" id="6925365911337413315">
          <property name="name" value="varInt" />
          <node role="type" type="jetbrains.mps.baseLanguage.structure.IntegerType" id="6925365911337413316" />
          <node role="initializer" type="jetbrains.mps.baseLanguage.structure.IntegerConstant" id="6925365911337413318">
            <property name="value" value="2" />
          </node>
        </node>
      </node>
      <node role="statement" type="jetbrains.mps.baseLanguage.structure.ExpressionStatement" id="6925365911337413324">
        <node role="expression" type="jetbrains.mps.baseLanguage.structure.PostfixIncrementExpression" id="6925365911337413339">
          <node role="expression" type="jetbrains.mps.baseLanguage.structure.LocalVariableReference" id="6925365911337413340">
            <link role="variableDeclaration" targetNodeId="6925365911337413315" resolveInfo="varInt" />
            <node role="testNode$attribute" type="jetbrains.mps.lang.test.structure.AnonymousCellAnnotation" id="6925365911337413342">
              <property name="isLastPosition" value="true" />
              <property name="cellId" value="property_name" />
            </node>
          </node>
    ...
    <node role="code" type="jetbrains.mps.baseLanguage.structure.StatementList" id="6925365911337413308">
      <node role="statement" type="jetbrains.mps.lang.test.structure.PressKeyStatement" id="6925365911337413309">
        <node role="keyStrokes" type="jetbrains.mps.lang.plugin.structure.KeyMapKeystroke" id="6925365911337413310">
          <property name="modifiers" value="ctrl" />
          <property name="keycode" value="VK_B" />
        </node>
      </node>
    </node>
    <node role="result" type="jetbrains.mps.baseLanguage.structure.StatementList" id="6925365911337413345">
      <node role="statement" type="jetbrains.mps.baseLanguage.structure.LocalVariableDeclarationStatement" id="6925365911337413346">
        <node role="localVariableDeclaration" type="jetbrains.mps.baseLanguage.structure.LocalVariableDeclaration" id="6925365911337413347">
          <property name="name" value="varInt" />
          <node role="type" type="jetbrains.mps.baseLanguage.structure.IntegerType" id="6925365911337413348" />
          <node role="initializer" type="jetbrains.mps.baseLanguage.structure.IntegerConstant" id="6925365911337413349">
            <property name="value" value="2" />
          </node>
          <node role="testNode$attribute" type="jetbrains.mps.lang.test.structure.AnonymousCellAnnotation" id="6925365911337413365">
            <property name="caretPosition" value="0" />
            <property name="cellId" value="Collection_2231_1" />
          </node>
        </node>
      </node>
      <node role="statement" type="jetbrains.mps.baseLanguage.structure.ExpressionStatement" id="6925365911337413350">
        <node role="expression" type="jetbrains.mps.baseLanguage.structure.PostfixIncrementExpression" id="6925365911337413351">
          <node role="expression" type="jetbrains.mps.baseLanguage.structure.LocalVariableReference" id="6925365911337413352">
            <link role="variableDeclaration" targetNodeId="6925365911337413347" resolveInfo="varInt" />
          </node>
        </node>
      </node>
    </node>
