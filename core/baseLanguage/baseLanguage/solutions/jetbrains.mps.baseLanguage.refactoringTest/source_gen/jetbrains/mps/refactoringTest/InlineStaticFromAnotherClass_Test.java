...
public class InlineStaticFromAnotherClass_Test extends BaseTransformationTest {
  ...
  public static class TestBody extends BaseTestBody {
    ...
    public void test_InlineStaticFromAnotherClass() throws Exception {
      ...
      ref.doRefactor();
      Assert.assertEquals(null, NodesMatcher.matchNodes(ListSequence.<SNode>fromArray(SNodeOperations.cast(this.getNodeById("1230053223847"), "jetbrains.mps.baseLanguage.structure.ClassConcept")), ListSequence.<SNode>fromArray(SNodeOperations.cast(this.getNodeById("1230053223858"), "jetbrains.mps.baseLanguage.structure.ClassConcept"))));
    }
