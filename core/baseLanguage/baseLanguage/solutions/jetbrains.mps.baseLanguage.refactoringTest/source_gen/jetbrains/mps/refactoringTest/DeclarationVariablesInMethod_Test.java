...
public class DeclarationVariablesInMethod_Test extends BaseTransformationTest {
  ...
  public void test_DeclarationVariablesInMethod() throws Throwable {
    ...
    this.runTest("jetbrains.mps.refactoringTest.DeclarationVariablesInMethod_Test$TestBody", "test_DeclarationVariablesInMethod", true);
  }
  ...
  public static class TestBody extends BaseTestBody {
    public void test_DeclarationVariablesInMethod() throws Exception {
      ...
      ref.doRefactor();
      Assert.assertEquals(null, NodesMatcher.matchNodes(ListSequence.<SNode>fromListAndArray(new ArrayList<SNode>(), SNodeOperations.cast(this.getNodeById("1230052989009"), "jetbrains.mps.baseLanguage.structure.ClassConcept")), ListSequence.<SNode>fromListAndArray(new ArrayList<SNode>(), SNodeOperations.cast(this.getNodeById("1230052989036"), "jetbrains.mps.baseLanguage.structure.ClassConcept"))));
    }
  }
}
