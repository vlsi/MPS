...
public class InlineMethodWithVoidType_Test extends BaseTransformationTest {
  ...
  public void test_InlineMethodWithVoidType() throws Throwable {
    ...
    this.runTest(this.getClass().getCanonicalName() + "$TestBody", "test_InlineMethodWithVoidType", true);
  }
  ...
  public static class TestBody extends BaseTestBody {
    ...
    public void test_InlineMethodWithVoidType() throws Exception {
      ...
      InlineMethodRefactoring ref = new InlineMethodRefactoring(this.getNodeById("1230053187766"));
      ref.doRefactor();
      Assert.assertEquals(null, NodesMatcher.matchNodes(ListSequence.<SNode>fromArray(this.getNodeById("1230053187754")), ListSequence.<SNode>fromArray(this.getNodeById("1230053187789"))));
    }
