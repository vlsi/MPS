...
public class NodeAfterSubstitutionHasNoErrorCell_Test extends BaseTransformationTest {
  ...
  public void test_NodeAfterSubstitutionHasNoErrorCell() throws Throwable {
    ...
    this.runTest("NodeAfterSubstitutionHasNoErrorCell_Test$TestBody", "testMethod", false);
  }
  ...
  public static class TestBody extends BaseEditorTestBody {
    public void testMethod() throws Exception {
      ...
      SwingUtilities.invokeAndWait(new Runnable() {
        public void run() {
          try {
            editorWrap[0] = TestBody.this.initEditor("3727822333335546447", "8664476900639779216");
          } catch (Exception e) {
            e.printStackTrace();
          }
        }
