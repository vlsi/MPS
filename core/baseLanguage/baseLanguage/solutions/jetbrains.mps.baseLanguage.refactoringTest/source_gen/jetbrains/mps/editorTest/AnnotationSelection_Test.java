...
public class AnnotationSelection_Test extends BaseTransformationTest {
  ...
  public void test_AnnotationSelection() throws Throwable {
    ...
    this.runTest("AnnotationSelection_Test$TestBody", "testMethod", false);
  }
  ...
  public static class TestBody extends BaseEditorTestBody {
    public void testMethod() throws Exception {
      ...
      SwingUtilities.invokeAndWait(new Runnable() {
        public void run() {
          try {
            editorWrap[0] = TestBody.this.initEditor("1235221839249", "1235221888081");
          } catch (Exception e) {
            e.printStackTrace();
          }
        }
      ...
      BaseEditorTestBody.pressKeys(editorComponent, ListSequence.fromListAndArray(new ArrayList<String>(), " END"));
