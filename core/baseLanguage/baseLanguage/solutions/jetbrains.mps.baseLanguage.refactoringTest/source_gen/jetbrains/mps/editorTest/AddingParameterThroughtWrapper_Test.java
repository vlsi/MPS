...
public class AddingParameterThroughtWrapper_Test extends BaseTransformationTest {
  ...
  public void test_AddingParameterThroughtWrapper() throws Throwable {
    ...
    this.runTest("AddingParameterThroughtWrapper_Test$TestBody", "testMethod", false);
  }
  ...
  public static class TestBody extends BaseEditorTestBody {
    public void testMethod() throws Exception {
      ...
      SwingUtilities.invokeAndWait(new Runnable() {
        public void run() {
          try {
            editorWrap[0] = TestBody.this.initEditor("3891087596588953785", "3891087596588953790");
          } catch (Exception e) {
            e.printStackTrace();
          }
        }
