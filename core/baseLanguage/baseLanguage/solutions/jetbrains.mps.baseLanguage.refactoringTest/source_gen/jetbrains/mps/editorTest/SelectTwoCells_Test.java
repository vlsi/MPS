...
public class SelectTwoCells_Test extends BaseTransformationTest {
  ...
  public void test_SelectTwoCells() throws Throwable {
    ...
    this.runTest("SelectTwoCells_Test$TestBody", "testMethod", false);
  }
  ...
  public static class TestBody extends BaseEditorTestBody {
    public void testMethod() throws Exception {
      ...
      SwingUtilities.invokeAndWait(new Runnable() {
        public void run() {
          try {
            editorWrap[0] = TestBody.this.initEditor("1230119716735", "1230119724125");
          } catch (Exception e) {
            e.printStackTrace();
          }
        }
      ...
      BaseEditorTestBody.pressKeys(editorComponent, ListSequence.fromListAndArray(new ArrayList<String>(), "shift RIGHT", "shift RIGHT"));
