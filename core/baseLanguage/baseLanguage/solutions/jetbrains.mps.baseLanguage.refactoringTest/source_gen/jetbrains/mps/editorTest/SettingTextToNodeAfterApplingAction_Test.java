...
public class SettingTextToNodeAfterApplingAction_Test extends BaseTransformationTest {
  ...
  public void test_SettingTextToNodeAfterApplingAction() throws Throwable {
    ...
    this.runTest("SettingTextToNodeAfterApplingAction_Test$TestBody", "testMethod", false);
  }
  ...
  public static class TestBody extends BaseEditorTestBody {
    public void testMethod() throws Exception {
      ...
      SwingUtilities.invokeAndWait(new Runnable() {
        public void run() {
          try {
            editorWrap[0] = TestBody.this.initEditor("4360574204777372534", "4360574204777374264");
          } catch (Exception e) {
            e.printStackTrace();
          }
        }
