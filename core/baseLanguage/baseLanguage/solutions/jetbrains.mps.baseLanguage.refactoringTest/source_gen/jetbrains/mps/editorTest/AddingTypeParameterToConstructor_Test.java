...
public class AddingTypeParameterToConstructor_Test extends BaseTransformationTest {
  ...
  public void test_AddingTypeParameterToConstructor() throws Throwable {
    ...
    this.runTest("AddingTypeParameterToConstructor_Test$TestBody", "testMethod", false);
  }
  ...
  public static class TestBody extends BaseEditorTestBody {
    public void testMethod() throws Exception {
      ...
      SwingUtilities.invokeAndWait(new Runnable() {
        public void run() {
          try {
            editorWrap[0] = TestBody.this.initEditor("1883175908513199132", "1883175908513199136");
          } catch (Exception e) {
            e.printStackTrace();
          }
        }
