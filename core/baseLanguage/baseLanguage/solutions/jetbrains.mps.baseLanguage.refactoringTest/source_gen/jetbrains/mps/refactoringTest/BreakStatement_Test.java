...
public class BreakStatement_Test extends BaseTransformationTest {
  ...
  public void test_noBreaks() throws Throwable {
    ...
    this.runTest("BreakStatement_Test$TestBody", "test_noBreaks", true);
  }

  @Test
  public void test_oneBreak() throws Throwable {
    this.initTest("${mps_home}/core/baseLanguage/baseLanguage/baseLanguage.mpr", "r:4dc6ffb5-4bbb-4773-b0b7-e52989ceb56f(jetbrains.mps.refactoringTest)");
    this.runTest("BreakStatement_Test$TestBody", "test_oneBreak", true);
  }

  @Test
  public void test_oneContionue() throws Throwable {
    this.initTest("${mps_home}/core/baseLanguage/baseLanguage/baseLanguage.mpr", "r:4dc6ffb5-4bbb-4773-b0b7-e52989ceb56f(jetbrains.mps.refactoringTest)");
    this.runTest("BreakStatement_Test$TestBody", "test_oneContionue", true);
  }

  @Test
  public void test_breakAndContinue() throws Throwable {
    this.initTest("${mps_home}/core/baseLanguage/baseLanguage/baseLanguage.mpr", "r:4dc6ffb5-4bbb-4773-b0b7-e52989ceb56f(jetbrains.mps.refactoringTest)");
    this.runTest("BreakStatement_Test$TestBody", "test_breakAndContinue", true);
  }
