...
public class AddThrowDeclaration_Test extends BaseTransformationTest {
  ...
  public static class TestBody extends BaseTestBody {
    ...
    public void test_AddThrowDeclaration() throws Exception {
      ...
      ChangeMethodSignatureParameters params = new ChangeMethodSignatureParameters(this.getNodeById("1230052902928"));
      SLinkOperations.addChild(params.getDeclaration(), "throwsItem", new _Quotations.QuotationClass_0().createNode());
      ChangeMethodSignatureRefactoring ref = new ChangeMethodSignatureRefactoring(params, this.getNodeById("1230052902928"));
      ref.doRefactoring();
      Assert.assertEquals(null, NodesMatcher.matchNodes(ListSequence.<SNode>fromArray(this.getNodeById("1230052902927")), ListSequence.<SNode>fromArray(this.getNodeById("1230052902936"))));
    }
