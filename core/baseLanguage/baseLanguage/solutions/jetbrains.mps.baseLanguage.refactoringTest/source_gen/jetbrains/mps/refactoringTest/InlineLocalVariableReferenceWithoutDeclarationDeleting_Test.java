...
public class InlineLocalVariableReferenceWithoutDeclarationDeleting_Test extends BaseTransformationTest {
  ...
  public static class TestBody extends BaseTestBody {
    public void test_InlineLocalVariableReferenceWithoutDeclarationDeleting() throws Exception {
      ...
      ref.doRefactoring();
      Assert.assertEquals(null, NodesMatcher.matchNodes(ListSequence.<SNode>fromListAndArray(new ArrayList<SNode>(), SNodeOperations.cast(this.getNodeById("1230053266437"), "jetbrains.mps.baseLanguage.structure.ClassConcept")), ListSequence.<SNode>fromListAndArray(new ArrayList<SNode>(), SNodeOperations.cast(this.getNodeById("1230053266458"), "jetbrains.mps.baseLanguage.structure.ClassConcept"))));
    }
  }
}
