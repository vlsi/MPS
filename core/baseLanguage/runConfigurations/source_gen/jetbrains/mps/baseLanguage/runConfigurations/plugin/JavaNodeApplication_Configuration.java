...
public class JavaNodeApplication_Configuration extends BaseRunConfig {
  @Tag(value = "state")
  private JavaNodeApplication_Configuration.MyState myState = new JavaNodeApplication_Configuration.MyState();

  public JavaNodeApplication_Configuration(Project p, ConfigurationFactory f, String name) {
    super(p, f, name);
  }

  public RunConfiguration clone() {
    try {
      JavaNodeApplication_Configuration result = ((JavaNodeApplication_Configuration) super.clone());
      result.myState = ((JavaNodeApplication_Configuration.MyState) this.myState.clone());
      return result;
  ...
  public void checkConfiguration() throws RuntimeConfigurationException {
    ...
    try {
      String paramsReport = JavaNodeApplication_Configuration.this.getStateObject().myJavaRunParameters.getErrorReport();
      ...
      String errorReport;
      {
        Tuples._2<SNode, String> _tmp_pjkntd_e0a0b0b = JavaNodeApplication_Configuration.this.checkNode();
        node = _tmp_pjkntd_e0a0b0b._0();
        errorReport = _tmp_pjkntd_e0a0b0b._1();
      }
      if (node == null) {
      ...
      Logger.getLogger(JavaNodeApplication_Configuration.class).error(t_22042010);
    }
  ...
  public RunProfileState getState(@NotNull final Executor executor, @NotNull final ExecutionEnvironment environment) throws ExecutionException {
    return new RunProfileState() {
      ...
      public ExecutionResult execute(Executor executor, @NotNull ProgramRunner runner) throws ExecutionException {
        ...
        // user's execute code 
        try {
          final ConfigRunParameters javaRunParameters = JavaNodeApplication_Configuration.this.getStateObject().myJavaRunParameters.copy();
          final SNode node = JavaNodeApplication_Configuration.this.getNodeForExecution(environment.getProject(), (javaRunParameters).getMake());
          {
            // calculate parameter 
              ...
              public DefaultProcessHandler invoke() throws ExecutionException {
                try {
                  ...
                  ModelAccess.instance().runReadAction(new Runnable() {
                    public void run() {
                      className.value = IMainClass_Behavior.call_getUnitName_4482685194810363969(node);
                    }
                  });
                  if (StringUtils.isEmpty(className.value)) {
                    throw new ExecutionException("Class name of a node is empty. Cant run.");
                  }
          ...
          if (t instanceof ExecutionException) {
            ...
            Logger.getLogger(JavaNodeApplication_Configuration.class).error(t);
        ...
        return new JavaNodeApplication_Configuration.MyExecutionResult(handler_22042010, ListSequence.fromList(actions_22042010).toGenericArray(AnAction.class), new JavaNodeApplication_Configuration.MyExecutionConsole(consoleComponent_22042010, consoleDispose_22042010));
      }
  ...
  public SettingsEditor<? extends RunConfiguration> getConfigurationEditor() {
    return new JavaNodeApplication_Configuration.MySettingsEditor();
  }
  ...
  public JavaNodeApplication_Configuration.MyState getStateObject() {
    return this.myState;
  }

  public SNode getNode() {
    if (JavaNodeApplication_Configuration.this.getStateObject().modelId == null || JavaNodeApplication_Configuration.this.getStateObject().nodeId == null) {
      return null;
    }
    final Wrappers._T<SNode> node = new Wrappers._T<SNode>();
    ModelAccess.instance().runReadAction(new Runnable() {
      public void run() {
        node.value = new SNodePointer(JavaNodeApplication_Configuration.this.getStateObject().modelId, JavaNodeApplication_Configuration.this.getStateObject().nodeId).getNode();
      }
    });
    return node.value;
  }
  ...
  public void setNode(final SNode node) {
    if (node == null) {
      JavaNodeApplication_Configuration.this.getStateObject().modelId = null;
      JavaNodeApplication_Configuration.this.getStateObject().nodeId = null;
      return;
    }
    ModelAccess.instance().runReadAction(new Runnable() {
      public void run() {
        JavaNodeApplication_Configuration.this.getStateObject().modelId = node.getModel().getModelDescriptor().getSModelReference().toString();
        JavaNodeApplication_Configuration.this.getStateObject().nodeId = node.getId();
      }
    });
  }

  private SNode getNodeForExecution(Project project, boolean make) {
    return JavaNodeApplication_Configuration.this.getNode();
  }
  ...
  private static class MySettingsEditor extends SettingsEditor<JavaNodeApplication_Configuration> {
    private JavaNodeApplication_Editor myComponent = null;

    public MySettingsEditor() {
    }

    protected void resetEditorFrom(JavaNodeApplication_Configuration c) {
      try {
    ...
    protected void applyEditorTo(JavaNodeApplication_Configuration c) {
      try {
    ...
    protected JComponent createEditor() {
      try {
        this.myComponent = new JavaNodeApplication_Editor();
  ...
  public static class MyState implements Cloneable {
    ...
    public Object clone() throws CloneNotSupportedException {
      JavaNodeApplication_Configuration.MyState object = (JavaNodeApplication_Configuration.MyState) super.clone();
