...
<solution name="jetbrains.mps.baseLanguage.runConfigurations.runtime" uuid="c2b4d111-b1a9-4476-8bfc-454cbf1a6e6c" compileInMPS="false">
  <models>
    <modelRoot path="${solution_descriptor}/languageModels" namespacePrefix="" />
  </models>
  <stubModelEntries>
    <stubModelEntry path="${mps_home}/core/baseLanguage/runConfigurations/classes" include="false">
