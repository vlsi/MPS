...
public class CustomConstructorContainer_Editor extends DefaultNodeEditor {
  public EditorCell createEditorCell(EditorContext editorContext, SNode node) {
    return this.createCollection_9w29gq_a(editorContext, node);
  }
  ...
  private EditorCell createCollection_9w29gq_c0(EditorContext editorContext, SNode node) {
    EditorCell_Collection editorCell = EditorCell_Collection.createIndent2(editorContext, node);
    ...
    editorCell.addEditorCell(this.createRefNodeList_9w29gq_a2a(editorContext, node));
    return editorCell;
  }
