...
public class DefaultClassifierMethodDeclaration_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createRefNodeList_7205_0(EditorContext context, SNode node) {
    AbstractCellListHandler handler = new DefaultClassifierMethodDeclaration_Editor.annotationListHandler_7205_0(node, "annotation", context);
  ...
  private EditorCell createRefNodeList_7205_1(EditorContext context, SNode node) {
    AbstractCellListHandler handler = new DefaultClassifierMethodDeclaration_Editor.parameterListHandler_7205_0(node, "parameter", context);
    EditorCell_Collection editorCell = handler.createCells(context, new CellLayout_Indent(), false);
  ...
  private EditorCell createRefNodeList_7205_2(EditorContext context, SNode node) {
    AbstractCellListHandler handler = new DefaultClassifierMethodDeclaration_Editor.throwsItemListHandler_7205_0(node, "throwsItem", context);
    EditorCell_Collection editorCell = handler.createCells(context, new CellLayout_Indent(), false);
  ...
  private EditorCell createRefNodeList_7205_3(EditorContext context, SNode node) {
    AbstractCellListHandler handler = new DefaultClassifierMethodDeclaration_Editor.annotationListHandler_7205_1(node, "annotation", context);
    EditorCell_Collection editorCell = handler.createCells(context, new CellLayout_Indent(), false);
