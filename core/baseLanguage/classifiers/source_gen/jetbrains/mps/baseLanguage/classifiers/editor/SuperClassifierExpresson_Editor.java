...
public class SuperClassifierExpresson_Editor extends DefaultNodeEditor {
  public EditorCell createEditorCell(EditorContext editorContext, SNode node) {
    return this.createConstant_5353_fja4in26(editorContext, node);
  }

  private EditorCell createConstant_5353_fja4in26(EditorContext editorContext, SNode node) {
    EditorCell_Constant editorCell = new EditorCell_Constant(editorContext, node, "super");
    editorCell.setCellId("Constant_5353_fja4in26");
