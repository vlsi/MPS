...
public class QueriesGenerated {
  ...
  public static boolean baseMappingRule_Condition_1202834518311(final IOperationContext operationContext, final BaseMappingRuleContext _context) {
    return PrepStatementUtil.getFlag(_context.getNode(), _context.getGenerator()) != null;
  }
  ...
  public static boolean baseMappingRule_Condition_1202837501183(final IOperationContext operationContext, final BaseMappingRuleContext _context) {
  ...
  public static Object propertyMacro_GetPropertyValue_1201048260874(final IOperationContext operationContext, final PropertyMacroContext _context) {
    {
      IMatchingPattern pattern_1202917382406 = HUtil.createMatchingPatternByConceptFQName("jetbrains.mps.baseLanguage.ext.collections.lang.structure.SequenceType");
      SNode coercedNode_1202917382388 = TypeChecker.getInstance().getRuntimeSupport().coerce(SLinkOperations.getTarget(TypeChecker.getInstance().getTypeOf(_context.getNode()), "resultType", true), pattern_1202917382406);
      if(coercedNode_1202917382388 != null) {
        return BaseConcept_Behavior.call_getPresentation_1180102203531(SLinkOperations.getTarget(coercedNode_1202917382388, "elementType", true));
      }
    }
    return null;
  }
  ...
  public static Object propertyMacro_GetPropertyValue_1202839346898(final IOperationContext operationContext, final PropertyMacroContext _context) {
  ...
  public static SNode sourceNodeQuery_1202834560823(final IOperationContext operationContext, final SourceSubstituteMacroNodeContext _context) {
    ...
    SPropertyOperations.set(copy, "isFinal", "" + (true));
    return copy;
  }
  ...
  public static void mappingScript_CodeBlock_1201011417446(final IOperationContext operationContext, final MappingScriptContext _context) {
    for(SNode cl : SModelOperations.getNodes(_context.getModel(), "jetbrains.mps.closures.structure.ClosureLiteral")) {
      ...
      for(SNode vd : ClosureLiteralUtil.collectNonFinalVariableDeclarations(cl)) {
        PrepStatementUtil.setFlag(vd, _context.getGenerator());
      }
    }
  }
  ...
  public static void mappingScript_CodeBlock_1201686683809(final IOperationContext operationContext, final MappingScriptContext _context) {
    ...
    for(SNode bmc : bmcs) {
      ...
      if(args.size() != pdecls.size()) {
        _context.getGenerator().showErrorMessage(bmc, "Actual arguments count != parameter declarations count");
        continue;
      }
      int idx = 0;
