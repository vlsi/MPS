...
<model modelUID="r:00000000-0000-4000-0000-011c89590338(jetbrains.mps.baseLanguage.closures.structure)">
    ...
    <refactoringContext modelVersion="3">
      ...
      <conceptFeatureMap>
        <entry>
          ...
          <value featureName="controlClosure" conceptFQName="jetbrains.mps.baseLanguage.closures.structure.ClosureControlStatement" featureKind="CHILD" />
        </entry>
      </conceptFeatureMap>
    </refactoringContext>
  </refactoringHistory>
  ...
  <node type="jetbrains.mps.lang.structure.structure.ConceptDeclaration" id="1229598881739">
    ...
    <node role="conceptProperty" type="jetbrains.mps.lang.structure.structure.BooleanConceptProperty" id="8889998649496382716">
      <link role="conceptPropertyDeclaration" targetNodeId="1.1137473994950" resolveInfo="dontSubstituteByDefault" />
    </node>
  </node>
  <node type="jetbrains.mps.lang.structure.structure.ConceptDeclaration" id="1229599010201">
    ...
    <node role="linkDeclaration" type="jetbrains.mps.lang.structure.structure.LinkDeclaration" id="1232476496647">
      <property name="metaClass" value="aggregation" />
      <property name="role" value="controlClosure" />
      <property name="sourceCardinality" value="1" />
  ...
  <node type="jetbrains.mps.lang.structure.structure.ConceptDeclaration" id="1229708828035">
    ...
    <node role="conceptProperty" type="jetbrains.mps.lang.structure.structure.BooleanConceptProperty" id="8889998649496382560">
      <link role="conceptPropertyDeclaration" targetNodeId="1.1137473994950" resolveInfo="dontSubstituteByDefault" />
    </node>
  </node>
