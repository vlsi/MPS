...
public class UnrestrictedFunctionType_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createRefNodeList_8986_0(EditorContext context, SNode node) {
    AbstractCellListHandler handler = new UnrestrictedFunctionType_Editor.parameterTypeListHandler_8986_0(node, "parameterType", context);
  ...
  private EditorCell createRefNodeList_8986_1(EditorContext context, SNode node) {
    AbstractCellListHandler handler = new UnrestrictedFunctionType_Editor.throwsTypeListHandler_8986_0(node, "throwsType", context);
    EditorCell_Collection editorCell = handler.createCells(context, new CellLayout_Indent(), false);
