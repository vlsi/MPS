...
public class ControlAbstractionContainer_Editor extends DefaultNodeEditor {
  ...
  public EditorCell createCollection_0500_0(EditorContext context, SNode node) {
    ...
    editorCell.addEditorCell(this.createCollection_0500_4(context, node));
  ...
  public EditorCell createCollection_0500_2(EditorContext context, SNode node) {
    ...
    if (renderingCondition0500_2(node, context, context.getOperationContext().getScope())) {
      editorCell.addEditorCell(this.createCollection_0500_3(context, node));
    }
    editorCell.addEditorCell(this.createConstant_0500_3(context, node, "{"));
    return editorCell;
  }

  public EditorCell createCollection_0500_3(EditorContext context, SNode node) {
    EditorCell_Collection editorCell = EditorCell_Collection.createHorizontal(context, node);
    setupBasic_Collection_0500_3(editorCell, node, context);
    editorCell.setGridLayout(false);
    editorCell.setUsesBraces(false);
    editorCell.setCanBeFolded(false);
  ...
  public EditorCell createCollection_0500_4(EditorContext context, SNode node) {
    EditorCell_Collection editorCell = EditorCell_Collection.createHorizontal(context, node);
    setupBasic_Collection_0500_4(editorCell, node, context);
    editorCell.setGridLayout(false);
    editorCell.setUsesBraces(false);
    editorCell.setCanBeFolded(false);
    editorCell.addEditorCell(this.createIndentCell0500_0(context, node));
  ...
  public EditorCell createIndentCell0500_0(EditorContext context, SNode node) {
  ...
  private static void setupBasic_Collection_0500_3(EditorCell editorCell, SNode node, EditorContext context) {
    editorCell.setCellId("Collection_0500_3");
    {
      Style inlineStyle = new Style(editorCell) {
        {
          this.set(StyleAttributes.SELECTABLE, false);
  ...
  private static void setupBasic_Collection_0500_4(EditorCell editorCell, SNode node, EditorContext context) {
    editorCell.setCellId("Collection_0500_4");
    {
      Style inlineStyle = new Style(editorCell) {
        {
  ...
  private static void setupBasic_Indent_0500_0(EditorCell editorCell, SNode node, EditorContext context) {
    editorCell.setCellId("Indent_0500_0");
  }
