...
public class InvokeFunctionExpression_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createCollection_1988_0(EditorContext editorContext, SNode node) {
    ...
    editorCell.addEditorCell(this.createConstant_1988_1(editorContext, node, "invoke"));
  ...
  private EditorCell createConstant_1988_0(EditorContext editorContext, SNode node, String text) {
  ...
  private EditorCell createConstant_1988_1(EditorContext editorContext, SNode node, String text) {
    EditorCell_Constant editorCell = new EditorCell_Constant(editorContext, node, text);
  ...
  private EditorCell createConstant_1988_2(EditorContext editorContext, SNode node, String text) {
    EditorCell_Constant editorCell = new EditorCell_Constant(editorContext, node, text);
  ...
  private EditorCell createConstant_1988_3(EditorContext editorContext, SNode node, String text) {
    EditorCell_Constant editorCell = new EditorCell_Constant(editorContext, node, text);
  ...
  private static class parameterListHandler_1988_0 extends RefNodeListHandler {
    ...
    private EditorCell createConstant_1988_4(EditorContext editorContext, SNode node, String text) {
      EditorCell_Constant editorCell = new EditorCell_Constant(editorContext, node, text);
