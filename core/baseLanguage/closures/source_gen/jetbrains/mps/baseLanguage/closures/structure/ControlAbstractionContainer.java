...
import jetbrains.mps.baseLanguage.closures.structure.ControlAbstractionDeclaration;
import java.util.List;
import jetbrains.mps.smodel.SModel;
import jetbrains.mps.smodel.SModelUtil_new;
import jetbrains.mps.project.GlobalScope;

public class ControlAbstractionContainer extends jetbrains.mps.baseLanguage.structure.Classifier {
  ...
  public Iterator<jetbrains.mps.baseLanguage.closures.structure.ControlAbstractionDeclaration> controlAbstractions() {
    return this.children(ControlAbstractionDeclaration.class, ControlAbstractionContainer.CONTROL_ABSTRACTION);
  }

  public List<jetbrains.mps.baseLanguage.closures.structure.ControlAbstractionDeclaration> getControlAbstractions() {
    return this.getChildren(ControlAbstractionDeclaration.class, ControlAbstractionContainer.CONTROL_ABSTRACTION);
  }

  public void addControlAbstraction(jetbrains.mps.baseLanguage.closures.structure.ControlAbstractionDeclaration node) {
    this.addChild(ControlAbstractionContainer.CONTROL_ABSTRACTION, node);
  }

  public void insertControlAbstraction(jetbrains.mps.baseLanguage.closures.structure.ControlAbstractionDeclaration prev, jetbrains.mps.baseLanguage.closures.structure.ControlAbstractionDeclaration node) {
