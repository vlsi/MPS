    ...
    synchronized (RuntimeUtils.class) {
      if (runtimeClassifiers == null) {
        ...
        for (SNode cls : SModelOperations.getNodes(getRuntimeModel(), "jetbrains.mps.baseLanguage.structure.Classifier")) {
          MapSequence.fromMap(runtimeClassifiers).put("_FunctionTypes."+SPropertyOperations.getString(cls, "name"), cls);
        }
  ...
  public static class QuotationClass_hadnfw_a0a0a0a {
    ...
    public SNode createNode() {
      ...
      SNode quotedNode_1 = null;
      {
        ...
        quotedNode1_2.addReference(SReference.create("classifier", quotedNode1_2, SModelReference.fromString("f:java_stub#jetbrains.mps.baseLanguage.closures.runtime(jetbrains.mps.baseLanguage.closures.runtime@java_stub)"), SNodeId.fromString("~YieldingIterator")));
