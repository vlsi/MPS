...
public class ControlAbstractionDeclaration extends jetbrains.mps.baseLanguage.structure.GenericDeclaration implements jetbrains.mps.baseLanguage.structure.ClassifierMember, jetbrains.mps.lang.core.structure.IResolveInfo, jetbrains.mps.baseLanguage.structure.HasAnnotation {
  ...
  public jetbrains.mps.baseLanguage.structure.StatementList getBody() {
    return (jetbrains.mps.baseLanguage.structure.StatementList)this.getChild(StatementList.class, ControlAbstractionDeclaration.BODY);
  }
  ...
  public jetbrains.mps.baseLanguage.structure.Visibility getVisibility() {
    return (jetbrains.mps.baseLanguage.structure.Visibility)this.getChild(Visibility.class, ControlAbstractionDeclaration.VISIBILITY);
  }
