...
import jetbrains.mps.closures.generator.baseLanguage.template.helper.WrappersUtils;
...
public class QueriesGenerated {
  ...
  public static boolean baseMappingRule_Condition_1207146630681(final IOperationContext operationContext, final BaseMappingRuleContext _context) {
    return (TypeChecker.getInstance().getRuntimeSupport().coerce(TypeChecker.getInstance().getTypeOf(_context.getNode()), HUtil.createMatchingPatternByConceptFQName("jetbrains.mps.baseLanguage.structure.ClassifierType"), true) != null);
  }
  ...
  public static Object propertyMacro_GetPropertyValue_1201048260874(final IOperationContext operationContext, final PropertyMacroContext _context) {
    {
      IMatchingPattern pattern_1210181149213 = HUtil.createMatchingPatternByConceptFQName("jetbrains.mps.baseLanguage.ext.collections.lang.structure.SequenceType");
      SNode coercedNode_1210181149197 = TypeChecker.getInstance().getRuntimeSupport().coerce(SLinkOperations.getTarget(TypeChecker.getInstance().getTypeOf(_context.getNode()), "resultType", true), pattern_1210181149213);
      if (coercedNode_1210181149197 != null) {
        return BaseConcept_Behavior.call_getPresentation_1180102203531(SLinkOperations.getTarget(coercedNode_1210181149197, "elementType", true));
      }
    }
    return null;
  }
  ...
  public static Object propertyMacro_GetPropertyValue_1203245282594(final IOperationContext operationContext, final PropertyMacroContext _context) {
    ...
    if (ct == null) {
      ct = ClassifierTypeUtil.getClassifierType(TypeChecker.getInstance().getTypeOf(_context.getNode()));
    }
  ...
  public static Object referenceMacro_GetReferent_1199624866931(final IOperationContext operationContext, final ReferenceMacroContext _context) {
    ...
    return SLinkOperations.getTarget(ClassifierTypeUtil.getClassifierType(TypeChecker.getInstance().getTypeOf(_context.getNode())), "classifier", false);
  }
  ...
  public static SNode sourceNodeQuery_1207146647758(final IOperationContext operationContext, final SourceSubstituteMacroNodeContext _context) {
    return TypeChecker.getInstance().getRuntimeSupport().coerce(TypeChecker.getInstance().getTypeOf(_context.getNode()), HUtil.createMatchingPatternByConceptFQName("jetbrains.mps.baseLanguage.structure.ClassifierType"), true);
  }
  ...
  public static List sourceNodesQuery_1203686370624(final IOperationContext operationContext, final SourceSubstituteMacroNodesContext _context) {
    ...
    if (true || ct == null || ((SNode)ct).getUserObject("returnType") == null) {
      return Collections.singletonList(FunctionType_Behavior.call_getNormalizedSequenceParameterReturnType_1201527054112(TypeChecker.getInstance().getTypeOf(_context.getNode())));
    } else
    {
      Object retClassifier = ((SNode)ct).getUserObject("returnType");
  ...
  public static SNode mapSrcMacro_mapper_1207147150424(final IOperationContext operationContext, final MapSrcMacroContext _context) {
    ...
    SNode newDecl = _context.getGenerator().findOutputNodeByInputNodeAndMappingName(oldDecl, "wrapped_localVar");
  ...
  public static void mappingScript_CodeBlock_1203244875243(final IOperationContext operationContext, final MappingScriptContext _context) {
    for(SNode cl : SModelOperations.getNodes(_context.getModel(), "jetbrains.mps.closures.structure.ClosureLiteral")) {
      SNode ct = ClosureLiteralUtil.getAdaptableClosureLiteralTarget(cl, _context.getGenerator());
      if (ct == null) {
        SNode ft = TypeChecker.getInstance().getTypeOf(cl);
        ...
        for(SNode ice : SModelOperations.getNodes(SNodeOperations.getModel(SLinkOperations.getTarget(new QuotationClass_1().createNode(), "classifier", false)), "jetbrains.mps.baseLanguage.structure.Interface")) {
          if (rtSig.equals(SPropertyOperations.getString(ice, "name"))) {
            SNode ict = SConceptOperations.createNewNode("jetbrains.mps.baseLanguage.structure.ClassifierType", null);
            SLinkOperations.setTarget(ict, "classifier", ice, false);
            ClosureLiteralUtil.addAdaptableClosureLiteralTarget(cl, ict, _context.getGenerator());
            break;
          }
        }
      }
  ...
  public static void mappingScript_CodeBlock_1207145159000(final IOperationContext operationContext, final MappingScriptContext _context) {
    for(SNode cl : SModelOperations.getNodes(_context.getModel(), "jetbrains.mps.closures.structure.ClosureLiteral")) {
      for(SNode lvd : WrappersUtils.collectLocalVariableDeclarationsToWrap(cl)) {
        WrappersUtils.putPrepData(lvd, "needs_wrapping", _context.getGenerator());
