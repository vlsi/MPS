...
public class RulesUtil_Closures {
  ...
  public static List<SNode> getInterfaces() {
    if (ourInterfaces == null) {
      ourInterfaces = SModelOperations.getNodes(SNodeOperations.getModel(SLinkOperations.getTarget(new QuotationClass_5().createNode(), "classifier", false)), "jetbrains.mps.baseLanguage.structure.Interface");
