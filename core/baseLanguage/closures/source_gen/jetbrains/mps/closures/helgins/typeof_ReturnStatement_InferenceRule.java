...
public class typeof_ReturnStatement_InferenceRule extends AbstractInferenceRule_Runtime implements InferenceRule_Runtime {
  ...
  public void applyRule(final SNode returnStatement, final TypeCheckingContext typeCheckingContext) {
    ...
    if (false && (SNodeOperations.getAncestor(returnStatement, "jetbrains.mps.closures.structure.ClosureLiteral", false, false) != null)) {
      if (!(false)) {
        TypeChecker.getInstance().reportTypeError(returnStatement, "return is not allowed within closure literal", "r:00000000-0000-4000-0000-011c89590337(jetbrains.mps.closures.helgins)", "1200829870877");
      }
    }
  }
