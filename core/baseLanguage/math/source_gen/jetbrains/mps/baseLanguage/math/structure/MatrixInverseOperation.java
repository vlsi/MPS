...
public class MatrixInverseOperation extends Expression {
  ...
  public Expression getExpression() {
    return (Expression)this.getChild(Expression.class, MatrixInverseOperation.EXPRESSION);
  }

  public void setExpression(Expression node) {
    super.setChild(MatrixInverseOperation.EXPRESSION, node);
  }
