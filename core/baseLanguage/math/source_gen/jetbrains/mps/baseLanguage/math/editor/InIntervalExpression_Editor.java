...
public class InIntervalExpression_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createConstant_34pshx_b0(EditorContext editorContext, SNode node) {
    ...
    editorCell.setSubstituteInfo(new CompositeSubstituteInfo(editorContext, new BasicCellContext(node), new SubstituteInfoPart[]{new InIntervalExpression_Editor.InIntervalExpression_Editor_replaceWith_BinaryOperation_cellMenu_a0b0()}));
    return editorCell;
  }
  ...
  public static class InIntervalExpression_Editor_replaceWith_BinaryOperation_cellMenu_a0b0 extends AbstractCellMenuPart_ReplaceNode_CustomNodeConcept {
    public InIntervalExpression_Editor_replaceWith_BinaryOperation_cellMenu_a0b0() {
    }
