...
public class IntervalType_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createCollection_1347_0(EditorContext editorContext, SNode node) {
    ...
    editorCell.addEditorCell(this.createConstant_1347_0(editorContext, node, "interval"));
  ...
  private EditorCell createConstant_1347_0(EditorContext editorContext, SNode node, String text) {
  ...
  private EditorCell createConstant_1347_1(EditorContext editorContext, SNode node, String text) {
    EditorCell_Constant editorCell = new EditorCell_Constant(editorContext, node, text);
  ...
  private EditorCell createConstant_1347_2(EditorContext editorContext, SNode node, String text) {
    EditorCell_Constant editorCell = new EditorCell_Constant(editorContext, node, text);
