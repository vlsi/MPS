...
public class Tuples_Test extends TestCase {

  @Test()
  public void test_empty() throws Exception {
    Tuples._0 empty = MultiTuple.empty0().assign(null);
  ...
  public void test_writeVar() throws Exception {
    ...
    {
      Tuples._1<Integer> _tmp5578_0 = MultiTuple.from(1);
      a = _tmp5578_0._0();
    };
    ...
    {
      Tuples._2<Integer, Character> _tmp5578_1 = MultiTuple.from(2, 'b');
      a = _tmp5578_1._0();
      c = _tmp5578_1._1();
    };
  ...
  public void test_swapVars() throws Exception {
    ...
    {
      Tuples._2<String, String> _tmp5578_2 = MultiTuple.from(bar, foo);
      foo = _tmp5578_2._0();
      bar = _tmp5578_2._1();
    };
