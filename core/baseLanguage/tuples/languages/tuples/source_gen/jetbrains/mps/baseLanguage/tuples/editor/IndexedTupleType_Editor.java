...
public class IndexedTupleType_Editor extends DefaultNodeEditor {
  ...
  public EditorCell createConceptProperty_8965_0_internal(EditorContext context, SNode node, CellProviderWithRole aProvider) {
  ...
  public EditorCell createConceptProperty_8965_2_internal(EditorContext context, SNode node, CellProviderWithRole aProvider) {
    CellProviderWithRole provider = aProvider;
    provider.setAuxiliaryCellProvider(null);
    EditorCell editorCell = provider.createEditorCell(context);
  ...
  private static void setupBasic_Collection_8965_0(EditorCell editorCell, SNode node, EditorContext context) {
    editorCell.setCellId("Collection_8965_0");
  }

  private static void setupBasic_ConceptProperty_8965_0(EditorCell editorCell, SNode node, EditorContext context) {
