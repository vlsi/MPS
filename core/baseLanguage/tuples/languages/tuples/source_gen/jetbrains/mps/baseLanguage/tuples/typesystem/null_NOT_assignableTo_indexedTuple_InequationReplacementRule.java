...
public class null_NOT_assignableTo_indexedTuple_InequationReplacementRule extends AbstractInequationReplacementRule_Runtime {
  ...
  public void processInequation(final SNode subtype, final SNode supertype, final EquationInfo equationInfo, final TypeCheckingContext typeCheckingContext) {
    if (!(false)) {
      ...
      typeCheckingContext.reportTypeError(equationInfo.getNodeWithError(), "Null is not compatible with tuple type", "r:e119dbbd-3529-4067-8bad-6b9edd79d0b6(jetbrains.mps.baseLanguage.tuples.typesystem)", "1239724876893", intentionProvider, errorTarget);
    }
  }
