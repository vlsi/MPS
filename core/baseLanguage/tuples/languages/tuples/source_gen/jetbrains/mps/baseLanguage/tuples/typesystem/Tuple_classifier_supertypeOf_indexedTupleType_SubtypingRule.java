...
public class Tuple_classifier_supertypeOf_indexedTupleType_SubtypingRule extends SubtypingRule_Runtime implements ISubtypingRule_Runtime {
  ...
  public static class QuotationClass_tm6bn3_a0a0a2a0 {
    ...
    public SNode createNode(final TypeCheckingContext typeCheckingContext) {
      ...
      SNode quotedNode_tm6bn3_a0a0a2a0 = null;
      {
        quotedNode_tm6bn3_a0a0a2a0 = SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.baseLanguage.structure.ClassifierType", TypeChecker.getInstance().getRuntimeTypesModel(), GlobalScope.getInstance(), false);
        SNode quotedNode1_tm6bn3_a0a0a2a0 = quotedNode_tm6bn3_a0a0a2a0;
        quotedNode1_tm6bn3_a0a0a2a0.addReference(SReference.create("classifier", quotedNode1_tm6bn3_a0a0a2a0, SModelReference.fromString("f:java_stub#jetbrains.mps.baseLanguage.tuples.runtime(jetbrains.mps.baseLanguage.tuples.runtime@java_stub)"), SNodeId.fromString("~Tuples")));
        result = quotedNode1_tm6bn3_a0a0a2a0;
      }
      return result;
    }
  ...
  public static class QuotationClass_tm6bn3_a0a0a0a3a0 {
    ...
    public SNode createNode(Object parameter_tm6bn3_a0a0a0a0a3a0, final TypeCheckingContext typeCheckingContext) {
      SNode result = null;
      Set<SNode> _parameterValues_129834374 = new HashSet<SNode>();
      SNode quotedNode_tm6bn3_a0a0a0a3a0 = null;
      {
        quotedNode_tm6bn3_a0a0a0a3a0 = SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.baseLanguage.structure.ClassifierType", TypeChecker.getInstance().getRuntimeTypesModel(), GlobalScope.getInstance(), false);
        SNode quotedNode1_tm6bn3_a0a0a0a3a0 = quotedNode_tm6bn3_a0a0a0a3a0;
        quotedNode1_tm6bn3_a0a0a0a3a0.setReferent("classifier", (SNode) parameter_tm6bn3_a0a0a0a0a3a0);
        result = quotedNode1_tm6bn3_a0a0a0a3a0;
      }
      return result;
    }

    public SNode createNode(Object parameter_tm6bn3_a0a0a0a0a3a0) {
      SNode result = null;
      Set<SNode> _parameterValues_129834374 = new HashSet<SNode>();
      SNode quotedNode_tm6bn3_a0a0a0a3a0 = null;
      {
