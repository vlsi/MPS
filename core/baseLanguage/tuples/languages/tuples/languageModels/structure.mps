...
<model modelUID="r:309aeee7-bee8-445c-b31d-35928d1da75f(jetbrains.mps.baseLanguage.tuples.structure)">
  ...
  <node type="jetbrains.mps.lang.structure.structure.ConceptDeclaration:0" id="1239360506533">
    ...
    <node role="linkDeclaration:0" type="jetbrains.mps.lang.structure.structure.LinkDeclaration:0" id="322547369016009796">
      <property name="metaClass:0" value="aggregation" />
      <property name="role:0" value="extended" />
      <link role="target:0" targetNodeId="1239531918181:2" resolveInfo="NamedTupleType" />
    </node>
  ...
  <node type="jetbrains.mps.lang.structure.structure.ConceptDeclaration:0" id="1239462176079">
    ...
    <node role="implements:0" type="jetbrains.mps.lang.structure.structure.InterfaceConceptReference:0" id="1239462414588">
      <link role="intfc:0" targetNodeId="2.1201183863028:3" resolveInfo="TypeDerivable" />
    </node>
    <node role="implements:0" type="jetbrains.mps.lang.structure.structure.InterfaceConceptReference:0" id="1239462414589">
      <link role="intfc:0" targetNodeId="2.1233920926773:3" resolveInfo="TypeAnnotable" />
    </node>
    <node role="implements:0" type="jetbrains.mps.lang.structure.structure.InterfaceConceptReference:0" id="1239462445302">
      <link role="intfc:0" targetNodeId="2v.1196978630214:0" resolveInfo="IResolveInfo" />
    </node>
  </node>
  <node type="jetbrains.mps.lang.structure.structure.ConceptDeclaration:0" id="1239531918181">
    ...
    <link role="extends:0" targetNodeId="2.1107535904670:3" resolveInfo="ClassifierType" />
    <node role="linkDeclaration:0" type="jetbrains.mps.lang.structure.structure.LinkDeclaration:0" id="1239548562987">
      ...
      <property name="sourceCardinality:0" value="0..n" />
      <link role="target:0" targetNodeId="2.1068431790189:3" resolveInfo="Type" />
      <link role="specializedLink:0" targetNodeId="2.1109201940907:3" />
    </node>
    ...
    <node role="conceptProperty:0" type="jetbrains.mps.lang.structure.structure.BooleanConceptProperty:0" id="6880792723345032128">
      <link role="conceptPropertyDeclaration:0" targetNodeId="2v.1137473994950:0" resolveInfo="dontSubstituteByDefault" />
    </node>
    <node role="linkDeclaration:0" type="jetbrains.mps.lang.structure.structure.LinkDeclaration:0" id="1239531948650">
      ...
      <link role="specializedLink:0" targetNodeId="2.1107535924139:3" />
    </node>
  </node>
