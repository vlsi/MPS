...
public class SourceSubstituteMacroNodesContext extends TemplateQueryContextWithMacro {
  ...
  public SourceSubstituteMacroNodesContext(SNode node, SNodePointer ruleNode, SNodePointer macroNode, @NotNull TemplateContext context, ITemplateGenerator generator) {
    super(node, macroNode, context, generator);
    myRule = null;
