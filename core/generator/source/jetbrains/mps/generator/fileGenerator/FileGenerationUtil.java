...
public class FileGenerationUtil {
  ...
  public static File getDefaultOutputDir(SModelDescriptor inputModelDescriptor, File outputRootDir) {
    return getDefaultOutputDir(inputModelDescriptor, FileSystem.getInstance().getFileByPath(outputRootDir.getAbsolutePath())).toFile();
  }
  ...
  public static File getDefaultOutputDir(SModelReference inputModel, File outputRootDir) {
    return getDefaultOutputDir(inputModel, FileSystem.getInstance().getFileByPath(outputRootDir.getAbsolutePath())).toFile();
  }
