...
public class MPSClasspathUtil {
  ...
  private static final String[] CLASSPATH = new String[]{"trove4j.jar", "mps-collections.jar", "mps-closures.jar", "mps-tuples.jar", "mps-openapi.jar", "mps-core.jar", "mps-tool.jar", "jetbrains.mps.lang.behavior.api.jar", "jetbrains.mps.lang.behavior.runtime.jar"};
  private static final String[] FORK_CLASSPATH = new String[]{"jdom.jar", "log4j.jar", "ecj-4.4.jar", "xstream-1.4.3.jar", "asm4-all.jar", "asm-all.jar", "diffutils-1.2.1.jar", "junit-4.11.jar"};
