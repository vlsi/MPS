...
public class RefactoringNodeMembersAccessModifier implements NodeMemberAccessModifier {
  private static final Logger LOG = LogManager.getLogger(RefactoringNodeMembersAccessModifier.class);
  ...
  public void addModelsToModify(Collection<SModel> models) {
    LOG.assertLog(ModelAccess.instance().canRead(), "Should be able to read models");
