...
public class EvaluatorsSuperMethodCall extends BaseMethodCall {
  public static final String concept = "jetbrains.mps.debugger.java.evaluation.structure.EvaluatorsSuperMethodCall";
  ...
  public static EvaluatorsSuperMethodCall newInstance(SModel sm, boolean init) {
    return (EvaluatorsSuperMethodCall) SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.debugger.java.evaluation.structure.EvaluatorsSuperMethodCall", sm, GlobalScope.getInstance(), init).getAdapter();
  }
