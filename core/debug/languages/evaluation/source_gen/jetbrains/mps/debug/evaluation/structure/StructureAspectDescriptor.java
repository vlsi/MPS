...
public class StructureAspectDescriptor implements jetbrains.mps.smodel.runtime.StructureAspectDescriptor {
  private static String[] stringSwitchCases_1htk8d_a0a0a = new String[]{"jetbrains.mps.debug.evaluation.structure.DoNotTransformAnnotation", "jetbrains.mps.debug.evaluation.structure.EvaluatorConcept", "jetbrains.mps.debug.evaluation.structure.EvaluatorsSuperMethodCall", "jetbrains.mps.debug.evaluation.structure.EvaluatorsThisExpression", "jetbrains.mps.debug.evaluation.structure.GenerationHelperAnnotation", "jetbrains.mps.debug.evaluation.structure.IEvaluatorConcept", "jetbrains.mps.debug.evaluation.structure.LowLevelVariable", "jetbrains.mps.debug.evaluation.structure.LowLevelVariableReference", "jetbrains.mps.debug.evaluation.structure.ToEvaluateAnnotation", "jetbrains.mps.debug.evaluation.structure.UnprocessedAnnotation"};
