...
public class UnitNode extends BaseConcept {
  public static final String concept = "jetbrains.mps.debug.evaluation.structure.UnitNode";
  ...
  public static UnitNode newInstance(SModel sm, boolean init) {
    return (UnitNode) SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.debug.evaluation.structure.UnitNode", sm, GlobalScope.getInstance(), init).getAdapter();
  }
