...
public class DebuggedType extends Type {
  public static final String concept = "jetbrains.mps.debug.evaluation.structure.DebuggedType";
  ...
  public static DebuggedType newInstance(SModel sm, boolean init) {
    return (DebuggedType) SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.debug.evaluation.structure.DebuggedType", sm, GlobalScope.getInstance(), init).getAdapter();
  }
