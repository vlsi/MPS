...
public class PrivateFieldReferenceOperation extends FieldReferenceOperation {
  public static final String concept = "jetbrains.mps.debugger.java.privateMembers.structure.PrivateFieldReferenceOperation";
  ...
  public static PrivateFieldReferenceOperation newInstance(SModel sm, boolean init) {
    return (PrivateFieldReferenceOperation) SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.debugger.java.privateMembers.structure.PrivateFieldReferenceOperation", sm, GlobalScope.getInstance(), init).getAdapter();
  }
