...
public class StringValueType extends Type {
  public static final String concept = "jetbrains.mps.debugger.java.customViewers.structure.StringValueType";
  ...
  public static StringValueType newInstance(SModel sm, boolean init) {
    return (StringValueType) SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.debugger.java.customViewers.structure.StringValueType", sm, GlobalScope.getInstance(), init).getAdapter();
  }
