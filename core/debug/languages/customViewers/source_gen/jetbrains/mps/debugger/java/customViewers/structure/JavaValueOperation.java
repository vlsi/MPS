...
public class JavaValueOperation extends BaseConcept implements IOperation {
  public static final String concept = "jetbrains.mps.debugger.java.customViewers.structure.JavaValueOperation";
  ...
  public static JavaValueOperation newInstance(SModel sm, boolean init) {
    return (JavaValueOperation) SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.debugger.java.customViewers.structure.JavaValueOperation", sm, GlobalScope.getInstance(), init).getAdapter();
  }
