...
public class IsInstanceOfOperation extends BaseConcept implements IOperation {
  public static final String concept = "jetbrains.mps.debugger.java.customViewers.structure.IsInstanceOfOperation";
  ...
  public static IsInstanceOfOperation newInstance(SModel sm, boolean init) {
    return (IsInstanceOfOperation) SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.debugger.java.customViewers.structure.IsInstanceOfOperation", sm, GlobalScope.getInstance(), init).getAdapter();
  }
