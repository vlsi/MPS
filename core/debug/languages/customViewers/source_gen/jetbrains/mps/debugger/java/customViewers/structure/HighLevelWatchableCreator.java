...
public class HighLevelWatchableCreator extends AbstractCreator {
  public static final String concept = "jetbrains.mps.debugger.java.customViewers.structure.HighLevelWatchableCreator";
  ...
  public static HighLevelWatchableCreator newInstance(SModel sm, boolean init) {
    return (HighLevelWatchableCreator) SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.debugger.java.customViewers.structure.HighLevelWatchableCreator", sm, GlobalScope.getInstance(), init).getAdapter();
  }
