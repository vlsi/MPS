...
<model modelUID="r:2511ce90-005c-4fc7-b4ac-484077b841e4(jetbrains.mps.debug.evaluation.generator.template.main@generator)">
  ...
  <node type="jetbrains.mps.lang.generator.structure.MappingConfiguration:2" id="1620955434532218412">
    ...
    <node role="mappingLabel:2" type="jetbrains.mps.lang.generator.structure.MappingLabelDeclaration:2" id="3580153239052993233">
      <property name="name:2" value="map_EvaluatorConceptToClassConcept" />
      <link role="sourceConcept:2" targetNodeId="1.6036237525966182693" resolveInfo="EvaluatorConcept" />
      <link role="targetConcept:2" targetNodeId="11.1068390468198:3" resolveInfo="ClassConcept" />
    </node>
    <node role="rootMappingRule:2" type="jetbrains.mps.lang.generator.structure.Root_MappingRule:2" id="1620955434532218413">
      <link role="applicableConcept:2" targetNodeId="1.6036237525966182693" resolveInfo="EvaluatorConcept" />
      <link role="template:2" targetNodeId="1620955434532219968" resolveInfo="EvaluatorInstance" />
      <link role="labelDeclaration:2" targetNodeId="3580153239052993233" resolveInfo="map_EvaluatorConceptToClassConcept" />
    </node>
  </node>
  <node type="jetbrains.mps.baseLanguage.structure.ClassConcept:3" id="1620955434532219968">
    <property name="name:3" value="EvaluatorInstance" />
    <node role="visibility:3" type="jetbrains.mps.baseLanguage.structure.PublicVisibility:3" id="1620955434532219969" />
    <node role="constructor:3" type="jetbrains.mps.baseLanguage.structure.ConstructorDeclaration:3" id="1620955434532219970">
      <node role="returnType:3" type="jetbrains.mps.baseLanguage.structure.VoidType:3" id="1620955434532219971" />
    ...
    <node role="rootTemplateAnnotation$attribute:3" type="jetbrains.mps.lang.generator.structure.RootTemplateAnnotation:2" id="1620955434532219974">
      <link role="applicableConcept:2" targetNodeId="1.6036237525966182693" resolveInfo="EvaluatorConcept" />
    </node>
    <node role="superclass:3" type="jetbrains.mps.baseLanguage.structure.ClassifierType:3" id="1620955434532220119">
      <link role="classifier:3" targetNodeId="3.~Evaluator" resolveInfo="Evaluator" />
    </node>
    <node role="method:3" type="jetbrains.mps.baseLanguage.structure.InstanceMethodDeclaration:3" id="1620955434532226507">
      ...
      <node role="body:3" type="jetbrains.mps.baseLanguage.structure.StatementList:3" id="1620955434532226510">
        <node role="statement:3" type="jetbrains.mps.baseLanguage.structure.LocalVariableDeclarationStatement:3" id="1496492112286760823">
          <node role="localVariableDeclaration:3" type="jetbrains.mps.baseLanguage.structure.LocalVariableDeclaration:3" id="1496492112286760824">
            <property name="name:3" value="lowLevelVar" />
            <node role="type:3" type="jetbrains.mps.baseLanguage.structure.IntegerType:3" id="1496492112286760825" />
          </node>
          <node role="nodeMacro$attribute:3" type="jetbrains.mps.lang.generator.structure.CopySrcListMacro:2" id="1496492112286760827">
            <node role="sourceNodesQuery:2" type="jetbrains.mps.lang.generator.structure.SourceSubstituteMacro_SourceNodesQuery:2" id="1496492112286760828">
              <node role="body:2" type="jetbrains.mps.baseLanguage.structure.StatementList:3" id="1496492112286760829">
                <node role="statement:3" type="jetbrains.mps.baseLanguage.structure.ExpressionStatement:3" id="1496492112286760830">
                  <node role="expression:3" type="jetbrains.mps.baseLanguage.structure.DotExpression:3" id="1496492112286760832">
                    <node role="operand:3" type="jetbrains.mps.lang.generator.structure.TemplateFunctionParameter_sourceNode:2" id="1496492112286760831" />
                    <node role="operation:3" type="jetbrains.mps.lang.smodel.structure.SLinkListAccess:16" id="1496492112286760836">
        ...
        <node role="statement:3" type="jetbrains.mps.baseLanguage.structure.Statement:3" id="3256629802151523251">
          <node role="nodeMacro$attribute:3" type="jetbrains.mps.lang.generator.structure.CopySrcNodeMacro:2" id="5885457541676789229">
            <node role="sourceNodeQuery:2" type="jetbrains.mps.lang.generator.structure.SourceSubstituteMacro_SourceNodeQuery:2" id="5885457541676789230">
              <node role="body:2" type="jetbrains.mps.baseLanguage.structure.StatementList:3" id="5885457541676789231">
                <node role="statement:3" type="jetbrains.mps.baseLanguage.structure.ExpressionStatement:3" id="5885457541676789232">
                  <node role="expression:3" type="jetbrains.mps.baseLanguage.structure.DotExpression:3" id="5885457541676789234">
                    <node role="operand:3" type="jetbrains.mps.lang.generator.structure.TemplateFunctionParameter_sourceNode:2" id="5885457541676789233" />
                    <node role="operation:3" type="jetbrains.mps.lang.smodel.structure.SLinkAccess:16" id="5885457541676789238">
      ...
      <node role="throwsItem:3" type="jetbrains.mps.baseLanguage.structure.ClassifierType:3" id="4142860792081542519">
        <link role="classifier:3" targetNodeId="3.~EvaluationException" resolveInfo="EvaluationException" />
      </node>
    </node>
  </node>
</model>
