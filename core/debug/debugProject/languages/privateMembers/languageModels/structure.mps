...
<model modelUID="r:886e64b3-d82c-4444-8cd9-9ede48ec4a0f(jetbrains.mps.debug.privateMembers.structure)">
  ...
  <node type="jetbrains.mps.lang.structure.structure.ConceptDeclaration:0" id="6825241477451043705">
    <property name="name:0" value="PrivateFieldReferenceOperation" />
    <link role="extends:0" targetNodeId="2.1197029447546:3" resolveInfo="FieldReferenceOperation" />
  </node>
  <node type="jetbrains.mps.lang.structure.structure.ConceptDeclaration:0" id="6825241477451051014">
    <property name="name:0" value="PrivateInstanceMethodCallOperation" />
    <link role="extends:0" targetNodeId="2.1202948039474:3" resolveInfo="InstanceMethodCallOperation" />
  </node>
</model>
