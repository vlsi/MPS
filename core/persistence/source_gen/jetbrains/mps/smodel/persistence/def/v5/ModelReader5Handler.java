...
public class ModelReader5Handler extends XMLSAXHandler<ModelLoadResult> {
  ...
  public class ModelElementHandler extends ModelReader5Handler.ElementHandler {
    ...
    protected void handleChild(Object resultObject, String tagName, Object value) throws SAXException {
      ...
      if ("languageAspect".equals(tagName)) {
        ...
        (fieldmodel).addAdditionalModelVersion(jetbrains.mps.smodel.SModelReference.fromString(child[0]), version);
        return;
      }
      if ("language".equals(tagName)) {
        String child = (String) value;
  ...
  public class ImportElementHandler extends ModelReader5Handler.ElementHandler {
    ...
    protected SModel.ImportElement createObject(Attributes attrs) {
      ...
      return new SModel.ImportElement(jetbrains.mps.smodel.SModelReference.fromString(attrs.getValue("modelUID")), indexValue, versionValue);
    }
