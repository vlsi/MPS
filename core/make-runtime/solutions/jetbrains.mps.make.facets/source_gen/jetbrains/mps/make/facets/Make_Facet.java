...
public class Make_Facet extends IFacet.Stub {
  ...
  public static class Target_reconcile implements ITargetEx2 {
    ...
    private ITarget.Name name = new ITarget.Name("Make.reconcile");
  ...
  public static class Target_make implements ITargetEx2 {
    ...
    private static Class<? extends IResource>[] EXPECTED_OUTPUT = (Class<? extends IResource>[]) new Class[]{};
    private ITarget.Name name = new ITarget.Name("Make.make");
    ...
    public void storeValues(Map<String, String> store, IPropertiesPool properties) {
      {
        ...
        if (properties.hasProperties(name)) {
          ...
          MapSequence.fromMap(store).put("Make.reconcile.skipReconcile", String.valueOf(props.skipReconcile()));
        }
      }
      {
        ...
        if (properties.hasProperties(name)) {
          ...
          MapSequence.fromMap(store).put("Make.make.pathToFile", null);
        }
      }
    }
