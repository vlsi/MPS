    ...
    <node role="executeFunction" type="jetbrains.mps.bootstrap.intentionsLanguage.structure.ExecuteBlock" id="1204990433127">
      <node role="body" type="jetbrains.mps.baseLanguage.structure.StatementList" id="1204990433128">
        ...
        <node role="statement" type="jetbrains.mps.baseLanguage.structure.ExpressionStatement" id="1204990992075">
          <node role="expression" type="jetbrains.mps.baseLanguage.ext.collections.lang.structure.SequenceOperationExpression" id="1204991007126">
            <node role="operand" type="jetbrains.mps.baseLanguage.structure.DotExpression" id="1204990993140">
              ...
              <node role="operation" type="jetbrains.mps.bootstrap.smodelLanguage.structure.SLinkListAccess" id="1204991005969">
                <link role="link" targetNodeId="1.1203087991474" />
              </node>
            </node>
            <node role="operation" type="jetbrains.mps.bootstrap.smodelLanguage.structure.LinkList_AddAllOperation" id="1204991016942">
              <node role="parameter" type="jetbrains.mps.baseLanguage.structure.DotExpression" id="1204991022788">
                <node role="operand" type="jetbrains.mps.bootstrap.intentionsLanguage.structure.ConceptFunctionParameter_node" id="1204991021959" />
                <node role="operation" type="jetbrains.mps.bootstrap.smodelLanguage.structure.SLinkListAccess" id="1204991024650">
                  <link role="link" targetNodeId="1.1203087991474" />
                </node>
              </node>
            </node>
