...
<model name="jetbrains.mps.bootstrap.pluginLanguage.generator.baseLanguage.template.util">
  ...
  <import index="1" modelUID="jetbrains.mps.bootstrap.pluginLanguage.generator.baseLanguage.template.main@templates" version="-1" />
  <import index="2" modelUID="java.util@java_stub" version="-1" />
  <import index="3" modelUID="jetbrains.mps.plugins.custom@java_stub" version="-1" />
  <import index="4" modelUID="jetbrains.mps.plugins@java_stub" version="-1" />
