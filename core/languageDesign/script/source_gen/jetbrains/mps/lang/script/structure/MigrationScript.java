...
public class MigrationScript extends BaseConcept implements INamedConcept {
  ...
  public int get_$attributesCount() {
    return this.getChildCount(MigrationScript._$ATTRIBUTE);
  }

  public Iterator<Attribute> _$attributes() {
    return this.children(Attribute.class, MigrationScript._$ATTRIBUTE);
  }

  public List<Attribute> get_$attributes() {
    return this.getChildren(Attribute.class, MigrationScript._$ATTRIBUTE);
  }

  public void add_$attribute(Attribute node) {
    this.addChild(MigrationScript._$ATTRIBUTE, node);
  }

  public void insert_$attribute(Attribute prev, Attribute node) {
    this.insertChild(prev, MigrationScript._$ATTRIBUTE, node);
  }
