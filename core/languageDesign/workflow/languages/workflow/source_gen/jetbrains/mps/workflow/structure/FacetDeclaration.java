...
public class FacetDeclaration extends BaseConcept implements INamedConcept {
  public static final String concept = "jetbrains.mps.workflow.structure.FacetDeclaration";
  ...
  public static FacetDeclaration newInstance(SModel sm, boolean init) {
    return (FacetDeclaration) SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.workflow.structure.FacetDeclaration", sm, GlobalScope.getInstance(), init).getAdapter();
  }
