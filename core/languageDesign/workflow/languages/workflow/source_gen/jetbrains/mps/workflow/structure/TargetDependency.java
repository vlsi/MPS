...
public class TargetDependency extends BaseConcept {
  public static final String concept = "jetbrains.mps.workflow.structure.TargetDependency";
  ...
  public static TargetDependency newInstance(SModel sm, boolean init) {
    return (TargetDependency) SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.workflow.structure.TargetDependency", sm, GlobalScope.getInstance(), init).getAdapter();
  }
