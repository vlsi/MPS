...
public class TypeVarReference extends jetbrains.mps.baseLanguage.structure.Expression {
  ...
  public jetbrains.mps.lang.typesystem.structure.TypeVarDeclaration getTypeVarDeclaration() {
    return (jetbrains.mps.lang.typesystem.structure.TypeVarDeclaration)this.getReferent(TypeVarDeclaration.class, TypeVarReference.TYPE_VAR_DECLARATION);
  }

  public void setTypeVarDeclaration(jetbrains.mps.lang.typesystem.structure.TypeVarDeclaration node) {
