...
public class check_MethodCall_CheckingRule extends AbstractNonTypesystemRule_Runtime implements Rule_Runtime {
  public check_MethodCall_CheckingRule() {
  }
  ...
  public void applyRule(final SNode baseMethodCall, final TypeCheckingContext typeCheckingContext, IsApplicableStatus status) {
    for (SNode annotationInstance : SLinkOperations.getTargets(SLinkOperations.getTarget(baseMethodCall, "baseMethodDeclaration", false), "annotation", true)) {
      if (SLinkOperations.getTarget(annotationInstance, "annotation", false) == SLinkOperations.getTarget(new check_MethodCall_CheckingRule.QuotationClass_fmdvnz_a0a0a0a0a().createNode(typeCheckingContext), "classifier", false)) {
        ...
        return;
      } else if (SLinkOperations.getTarget(annotationInstance, "annotation", false) == SLinkOperations.getTarget(new check_MethodCall_CheckingRule.QuotationClass_fmdvnz_a0a0a0a0a0().createNode(typeCheckingContext), "classifier", false)) {
  ...
  public static class QuotationClass_fmdvnz_a0a0a0a0a {
    public QuotationClass_fmdvnz_a0a0a0a0a() {
    }
  ...
  public static class QuotationClass_fmdvnz_a0a0a0a0a0 {
    public QuotationClass_fmdvnz_a0a0a0a0a0() {
    }
