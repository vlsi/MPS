...
public class AbstractRule extends BaseConcept implements INamedConcept, IConceptAspect {
  ...
  public int get_$attributesCount() {
    return this.getChildCount(AbstractRule._$ATTRIBUTE);
  }

  public Iterator<Attribute> _$attributes() {
    return this.children(Attribute.class, AbstractRule._$ATTRIBUTE);
  }

  public List<Attribute> get_$attributes() {
    return this.getChildren(Attribute.class, AbstractRule._$ATTRIBUTE);
  }

  public void add_$attribute(Attribute node) {
    this.addChild(AbstractRule._$ATTRIBUTE, node);
  }

  public void insert_$attribute(Attribute prev, Attribute node) {
    this.insertChild(prev, AbstractRule._$ATTRIBUTE, node);
  }
