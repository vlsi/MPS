...
public class WhenConcreteStatement extends jetbrains.mps.baseLanguage.structure.Statement implements jetbrains.mps.baseLanguage.structure.Closureoid {
  ...
  public jetbrains.mps.baseLanguage.structure.StatementList getBody() {
    return (jetbrains.mps.baseLanguage.structure.StatementList)this.getChild(StatementList.class, WhenConcreteStatement.BODY);
  }
  ...
  public jetbrains.mps.baseLanguage.structure.Expression getArgument() {
    return (jetbrains.mps.baseLanguage.structure.Expression)this.getChild(Expression.class, WhenConcreteStatement.ARGUMENT);
  }
  ...
  public jetbrains.mps.lang.typesystem.structure.WhenConcreteVariableDeclaration getArgumentRepresentator() {
    return (jetbrains.mps.lang.typesystem.structure.WhenConcreteVariableDeclaration)this.getChild(WhenConcreteVariableDeclaration.class, WhenConcreteStatement.ARGUMENT_REPRESENTATOR);
  }

  public void setArgumentRepresentator(jetbrains.mps.lang.typesystem.structure.WhenConcreteVariableDeclaration node) {
