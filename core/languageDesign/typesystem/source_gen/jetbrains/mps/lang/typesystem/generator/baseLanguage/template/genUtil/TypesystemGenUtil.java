  ...
  public static boolean isInRuleWithContext(SNode node) {
    ...
    if ((baseMethodDeclaration != null)) {
      for(SNode annotationInstance : SLinkOperations.getTargets(baseMethodDeclaration, "annotation", true)) {
        ...
        if (annotation == SLinkOperations.getTarget(new QuotationClass_0().createNode(), "classifier", false) || annotation == SLinkOperations.getTarget(new QuotationClass_1().createNode(), "classifier", false)) {
          return true;
        }
      }
    }
