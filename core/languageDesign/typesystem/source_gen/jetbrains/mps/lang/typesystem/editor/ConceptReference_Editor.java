...
public class ConceptReference_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createCollection_4215_0(EditorContext context, SNode node) {
    ...
    editorCell.addEditorCell(this.createProperty_4215_1(context, node));
    return editorCell;
  }

  private EditorCell createConstant_4215_0(EditorContext context, SNode node, String text) {
  ...
  private EditorCell createConstant_4215_1(EditorContext context, SNode node, String text) {
    EditorCell_Constant editorCell = new EditorCell_Constant(context, node, text);
  ...
  private EditorCell createConstant_4215_2(EditorContext context, SNode node, String text) {
    EditorCell_Constant editorCell = new EditorCell_Constant(context, node, text);
  ...
  private EditorCell createProperty_4215_1(EditorContext context, SNode node) {
