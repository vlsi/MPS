    ...
    if ((typeRule != null)) {
      {
        ...
        typeCheckingContext.createEquation(typeCheckingContext.typeOf(concept_parameter, "r:00000000-0000-4000-0000-011c895902b1(jetbrains.mps.lang.typesystem.typesystem)", "1236083427979", true), new _Quotations.QuotationClass_35().createNode(SLinkOperations.getTarget(SLinkOperations.getTarget(typeRule, "leftOperandConcept", true), "concept", false), typeCheckingContext), _nodeToCheck_1029348928467, null, "r:00000000-0000-4000-0000-011c895902b1(jetbrains.mps.lang.typesystem.typesystem)", "1236083427968", intentionProvider);
      }
    }
  }
