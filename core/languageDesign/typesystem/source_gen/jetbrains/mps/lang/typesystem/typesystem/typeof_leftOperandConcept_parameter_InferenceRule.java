  ...
  public void applyRule(final SNode concept_parameter, final TypeCheckingContext typeCheckingContext) {
    ...
    if ((typeRule != null)) {
    ...
    } else {
      {
        ...
        typeCheckingContext.createEquation((SNode)typeCheckingContext.typeOf(_nodeToCheck_1029348928467, "r:00000000-0000-4000-0000-011c895902b1(jetbrains.mps.lang.typesystem.typesystem)", "3841122719873945999", true), (SNode)new _Quotations.QuotationClass_52().createNode(typeCheckingContext), _info_12389875345);
      }
    }
  }
