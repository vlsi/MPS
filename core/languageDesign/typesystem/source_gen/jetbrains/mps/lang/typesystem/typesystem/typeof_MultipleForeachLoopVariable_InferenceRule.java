  ...
  public void applyRule(final SNode forEachVar, final TypeCheckingContext typeCheckingContext, IsApplicableStatus status) {
    ...
    if ((inputSequence != null) && (variable != null)) {
      final SNode elementType_typevar_8290446284380616563 = typeCheckingContext.createNewRuntimeTypesVariable();
      {
        ...
        typeCheckingContext.createGreaterThanInequation((SNode) new typeof_MultipleForeachLoopVariable_InferenceRule.QuotationClass_aqgyap_a0a1a2a0().createNode(typeCheckingContext.getRepresentative(elementType_typevar_8290446284380616563), typeCheckingContext.getRepresentative(elementType_typevar_8290446284380616563), typeCheckingContext), (SNode) typeCheckingContext.typeOf(_nodeToCheck_1029348928467, "r:00000000-0000-4000-0000-011c895902b1(jetbrains.mps.lang.typesystem.typesystem)", "8290446284380616577", true), false, _info_12389875345);
      }
      {
