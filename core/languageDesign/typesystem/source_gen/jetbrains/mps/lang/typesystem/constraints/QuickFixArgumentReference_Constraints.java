...
public class QuickFixArgumentReference_Constraints extends BaseConstraintsDescriptor {
  private static SNodePointer breakingNode_tpj9r2_a0a1a0a0a1a0b0a1a0 = new SNodePointer("r:00000000-0000-4000-0000-011c895902ae(jetbrains.mps.lang.typesystem.constraints)", "1216390512066");
      ...
      public ReferenceScopeProvider getScopeProvider() {
        return new BaseReferenceScopeProvider() {
          ...
          public Object createSearchScopeOrListOfNodes(final IOperationContext operationContext, final ReferenceConstraintsContext _context) {
            ...
            if ((quickFix != null)) {
              ListSequence.<SNode>fromList(nodes).addSequence(ListSequence.<SNode>fromList(SLinkOperations.getTargets(quickFix, "quickFixArgument", true)));
            }
            return nodes;
          }
          ...
          public SNodePointer getSearchScopeValidatorNode() {
            return breakingNode_tpj9r2_a0a1a0a0a1a0b0a1a0;
          }
        };
      }
    });
