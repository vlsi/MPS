...
public class InfoStatement_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createCollection_x0qgth_a_0(EditorContext editorContext, SNode node) {
    ...
    editorCell.addEditorCell(this.createRefNode_x0qgth_e0(editorContext, node));
  ...
  private EditorCell createRefNode_x0qgth_e0(EditorContext editorContext, SNode node) {
    CellProviderWithRole provider = new RefNodeCellProvider(node, editorContext);
