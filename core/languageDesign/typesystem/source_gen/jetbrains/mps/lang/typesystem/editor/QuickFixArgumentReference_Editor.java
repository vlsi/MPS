...
public class QuickFixArgumentReference_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createCollection_9926_0(EditorContext context, SNode node) {
    EditorCell_Collection editorCell = EditorCell_Collection.createIndent2(context, node);
    editorCell.setCellId("Collection_9926_0");
    editorCell.addEditorCell(this.createRefCell_9926_0(context, node));
    return editorCell;
  }

  private EditorCell createRefCell_9926_0(EditorContext context, SNode node) {
  ...
  public static class _Inline9926_0 extends AbstractCellProvider {
    ...
    public EditorCell createEditorCell(EditorContext context, SNode node) {
      return this.createProperty_9926_0(context, node);
    }

    private EditorCell createProperty_9926_0(EditorContext context, SNode node) {
