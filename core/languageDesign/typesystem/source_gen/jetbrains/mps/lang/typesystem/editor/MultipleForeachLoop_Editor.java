...
public class MultipleForeachLoop_Editor extends DefaultNodeEditor {
      ...
      Style inlineStyle = new Style(editorCell) {
        {
          this.set(StyleAttributes.SELECTABLE, new AttributeCalculator <Boolean>() {
            ...
            public Boolean calculate(EditorCell cell) {
              return MultipleForeachLoop_Editor.calculateBoolean4210_0(cell);
            }
      ...
      Style inlineStyle = new Style(editorCell) {
        {
          this.set(StyleAttributes.SELECTABLE, new AttributeCalculator <Boolean>() {
            ...
            public Boolean calculate(EditorCell cell) {
              return MultipleForeachLoop_Editor.calculateBoolean4210_1(cell);
            }
  ...
  public static Boolean calculateBoolean4210_0(EditorCell cell) {
    boolean result;
    result = false;
    return result;
  }

  public static Boolean calculateBoolean4210_1(EditorCell cell) {
    boolean result;
    result = false;
    return result;
  }
