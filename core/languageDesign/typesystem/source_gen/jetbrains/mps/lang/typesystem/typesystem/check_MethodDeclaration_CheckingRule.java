...
public class check_MethodDeclaration_CheckingRule extends AbstractNonTypesystemRule_Runtime implements Rule_Runtime {
  public check_MethodDeclaration_CheckingRule() {
  }
  ...
  public void applyRule(final SNode baseMethodDeclaration, final TypeCheckingContext typeCheckingContext, IsApplicableStatus status) {
    for (SNode annotationInstance : SLinkOperations.getTargets(baseMethodDeclaration, "annotation", true)) {
      if (SLinkOperations.getTarget(annotationInstance, "annotation", false) == SLinkOperations.getTarget(new check_MethodDeclaration_CheckingRule.QuotationClass_lll08p_a0a0a0a0a().createNode(typeCheckingContext), "classifier", false)) {
  ...
  public static class QuotationClass_lll08p_a0a0a0a0a {
    public QuotationClass_lll08p_a0a0a0a0a() {
    }
