...
import jetbrains.mps.newTypesystem.presentation.difference.ShowTypeSystemTrace2;
  ...
  public void doExecute(@NotNull final AnActionEvent event, final Map<String, Object> _params) {
    try {
      ...
      if (typeCheckingContext instanceof TypeCheckingContextNew) {
        ...
        new ShowTypeSystemTrace2(t, ((IOperationContext) MapSequence.fromMap(_params).get("context")), ((Frame) MapSequence.fromMap(_params).get("frame")), ((SNode) MapSequence.fromMap(_params).get("node")), false);
      }
    } catch (Throwable t) {
