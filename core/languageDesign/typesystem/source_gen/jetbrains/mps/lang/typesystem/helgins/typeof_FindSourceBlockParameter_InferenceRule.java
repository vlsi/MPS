    ...
    if ((dependency != null)) {
      {
        ...
        typeCheckingContext.createEquation(typeCheckingContext.typeOf(findSourceBlockParameter, "r:00000000-0000-4000-0000-011c895902b1(jetbrains.mps.lang.typesystem.helgins)", "1193734407573", true), new QuotationClass_17().createNode(SLinkOperations.getTarget(dependency, "targetConcept", false), typeCheckingContext), _nodeToCheck_1029348928467, null, "r:00000000-0000-4000-0000-011c895902b1(jetbrains.mps.lang.typesystem.helgins)", "1193734407570", intentionProvider);
      }
    }
  }
