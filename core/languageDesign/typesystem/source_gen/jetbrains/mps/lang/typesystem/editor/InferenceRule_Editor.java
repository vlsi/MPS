...
public class InferenceRule_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createRefNodeList_8985_0(EditorContext context, SNode node) {
    AbstractCellListHandler handler = new InferenceRule_Editor.dependencyListHandler_8985_0(node, "dependency", context);
  ...
  private EditorCell createRefNodeList_8985_1(EditorContext context, SNode node) {
    AbstractCellListHandler handler = new InferenceRule_Editor.childTypeRestrictionListHandler_8985_0(node, "childTypeRestriction", context);
    EditorCell_Collection editorCell = handler.createCells(context, new CellLayout_Vertical(), false);
