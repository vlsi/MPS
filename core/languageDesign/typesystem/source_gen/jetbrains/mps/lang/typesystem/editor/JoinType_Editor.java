...
public class JoinType_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createCollection_3192_0(EditorContext editorContext, SNode node) {
    ...
    editorCell.addEditorCell(this.createConstant_3192_0(editorContext, node, "join"));
  ...
  private EditorCell createConstant_3192_0(EditorContext editorContext, SNode node, String text) {
  ...
  private EditorCell createConstant_3192_1(EditorContext editorContext, SNode node, String text) {
    EditorCell_Constant editorCell = new EditorCell_Constant(editorContext, node, text);
  ...
  private EditorCell createConstant_3192_2(EditorContext editorContext, SNode node, String text) {
    EditorCell_Constant editorCell = new EditorCell_Constant(editorContext, node, text);
