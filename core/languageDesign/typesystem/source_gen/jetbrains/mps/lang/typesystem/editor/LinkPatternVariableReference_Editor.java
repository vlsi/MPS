...
public class LinkPatternVariableReference_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createCollection_7485_0(EditorContext context, SNode node) {
    EditorCell_Collection editorCell = EditorCell_Collection.createIndent2(context, node);
    editorCell.setCellId("Collection_7485_0");
    editorCell.addEditorCell(this.createRefCell_7485_0(context, node));
    return editorCell;
  }

  private EditorCell createRefCell_7485_0(EditorContext context, SNode node) {
  ...
  public static class _Inline7485_0 extends AbstractCellProvider {
    ...
    public EditorCell createEditorCell(EditorContext context, SNode node) {
      return this.createProperty_7485_0(context, node);
    }

    private EditorCell createProperty_7485_0(EditorContext context, SNode node) {
