...
public class QuickFixArgument extends jetbrains.mps.lang.core.structure.BaseConcept implements jetbrains.mps.lang.core.structure.INamedConcept {
  ...
  public jetbrains.mps.baseLanguage.structure.Type getArgumentType() {
    return (jetbrains.mps.baseLanguage.structure.Type)this.getChild(Type.class, QuickFixArgument.ARGUMENT_TYPE);
  }
