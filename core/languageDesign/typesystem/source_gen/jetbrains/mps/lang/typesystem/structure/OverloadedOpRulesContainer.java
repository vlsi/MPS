...
public class OverloadedOpRulesContainer extends jetbrains.mps.lang.core.structure.BaseConcept implements jetbrains.mps.lang.core.structure.INamedConcept {
  ...
  public Iterator<jetbrains.mps.lang.typesystem.structure.OverloadedOperatorTypeRule> rules() {
    return this.children(OverloadedOperatorTypeRule.class, OverloadedOpRulesContainer.RULE);
  }

  public List<jetbrains.mps.lang.typesystem.structure.OverloadedOperatorTypeRule> getRules() {
    return this.getChildren(OverloadedOperatorTypeRule.class, OverloadedOpRulesContainer.RULE);
  }

  public void addRule(jetbrains.mps.lang.typesystem.structure.OverloadedOperatorTypeRule node) {
    this.addChild(OverloadedOpRulesContainer.RULE, node);
  }

  public void insertRule(jetbrains.mps.lang.typesystem.structure.OverloadedOperatorTypeRule prev, jetbrains.mps.lang.typesystem.structure.OverloadedOperatorTypeRule node) {
