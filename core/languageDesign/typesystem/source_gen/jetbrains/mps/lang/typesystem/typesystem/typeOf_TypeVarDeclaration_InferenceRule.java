  ...
  public void applyRule(final SNode typeVarDeclaration, final TypeCheckingContext typeCheckingContext) {
    {
      ...
      typeCheckingContext.createEquation((SNode)typeCheckingContext.typeOf(_nodeToCheck_1029348928467, "r:00000000-0000-4000-0000-011c895902b1(jetbrains.mps.lang.typesystem.typesystem)", "1185878023858", true), (SNode)new _Quotations.QuotationClass_14().createNode(typeCheckingContext), _info_12389875345);
    }
  }
