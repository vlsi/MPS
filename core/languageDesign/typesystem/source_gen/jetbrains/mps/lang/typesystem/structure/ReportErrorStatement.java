...
public class ReportErrorStatement extends jetbrains.mps.baseLanguage.structure.Statement implements jetbrains.mps.lang.typesystem.structure.MessageStatement {
  ...
  public jetbrains.mps.baseLanguage.structure.Expression getErrorString() {
    return (jetbrains.mps.baseLanguage.structure.Expression)this.getChild(Expression.class, ReportErrorStatement.ERROR_STRING);
  }
  ...
  public jetbrains.mps.baseLanguage.structure.Expression getNodeToReport() {
    return (jetbrains.mps.baseLanguage.structure.Expression)this.getChild(Expression.class, ReportErrorStatement.NODE_TO_REPORT);
  }
  ...
  public jetbrains.mps.lang.typesystem.structure.HelginsIntention getHelginsIntention() {
    return (jetbrains.mps.lang.typesystem.structure.HelginsIntention)this.getChild(HelginsIntention.class, ReportErrorStatement.HELGINS_INTENTION);
  }
  ...
  public jetbrains.mps.lang.typesystem.structure.MessageTarget getMessageTarget() {
    return (jetbrains.mps.lang.typesystem.structure.MessageTarget)this.getChild(MessageTarget.class, ReportErrorStatement.MESSAGE_TARGET);
  }
