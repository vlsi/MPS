...
<model modelUID="r:00000000-0000-4000-0000-011c895902b0(jetbrains.mps.lang.typesystem.editor)">
    ...
    <node role="cellModel:32" type="jetbrains.mps.lang.editor.structure.CellModel_Collection:32" id="1174643213528">
      ...
      <node role="childCellModel:32" type="jetbrains.mps.lang.editor.structure.CellModel_Collection:32" id="1198243759887">
        ...
        <node role="childCellModel:32" type="jetbrains.mps.lang.editor.structure.CellModel_Collection:32" id="1198243759888">
          ...
          <node role="childCellModel:32" type="jetbrains.mps.lang.editor.structure.CellModel_Collection:32" id="1212574473111">
            <property name="vertical:32" value="false" />
            <node role="childCellModel:32" type="jetbrains.mps.lang.editor.structure.CellModel_Constant:32" id="1212574484191">
              <property name="text:32" value="child type restrictions" />
              <link role="styleClass:32" targetNodeId="27.1186415544875" resolveInfo="KeyWord" />
            </node>
            <node role="childCellModel:32" type="jetbrains.mps.lang.editor.structure.CellModel_RefNodeList:32" id="1212574508146">
              <property name="vertical:32" value="true" />
              <link role="relationDeclaration:32" targetNodeId="1.1212574183907:3" />
              <node role="cellLayout:32" type="jetbrains.mps.lang.editor.structure.CellLayout_Vertical:32" id="1239880443150" />
            </node>
            <node role="styleItem:32" type="jetbrains.mps.lang.editor.structure.SelectableStyleSheetItem:32" id="1214310996984">
              <property name="flag:32" value="false" />
            </node>
            <node role="cellLayout:32" type="jetbrains.mps.lang.editor.structure.CellLayout_Horizontal:32" id="1239880443125" />
            <node role="renderingCondition:32" type="jetbrains.mps.lang.editor.structure.QueryFunction_NodeCondition:32" id="843338424126772895">
              <node role="body:32" type="jetbrains.mps.baseLanguage.structure.StatementList:3" id="843338424126772896">
                <node role="statement:3" type="jetbrains.mps.baseLanguage.structure.ExpressionStatement:3" id="843338424126774841">
                  <node role="expression:3" type="jetbrains.mps.baseLanguage.structure.DotExpression:3" id="843338424126774848">
                    <node role="operand:3" type="jetbrains.mps.baseLanguage.structure.DotExpression:3" id="843338424126774843">
                      <node role="operand:3" type="jetbrains.mps.lang.editor.structure.ConceptFunctionParameter_node:32" id="843338424126774842" />
                      <node role="operation:3" type="jetbrains.mps.lang.smodel.structure.SLinkListAccess:16" id="843338424126774847">
                        <link role="link:16" targetNodeId="1.1212574183907:3" />
                      </node>
                    </node>
                    <node role="operation:3" type="jetbrains.mps.baseLanguage.collections.structure.IsNotEmptyOperation:7" id="843338424126774852" />
                  </node>
                </node>
              </node>
            </node>
  ...
  <node type="jetbrains.mps.lang.editor.structure.ConceptEditorDeclaration:32" id="1174913634157">
    <link role="conceptDeclaration:32" targetNodeId="1.1174913569543:3" />
    <node role="cellModel:32" type="jetbrains.mps.lang.editor.structure.CellModel_Collection:32" id="1174913637237">
      <node role="childCellModel:32" type="jetbrains.mps.lang.editor.structure.CellModel_Constant:32" id="1174913642958">
        <property name="text:32" value="judgement match" />
      </node>
      <node role="childCellModel:32" type="jetbrains.mps.lang.editor.structure.CellModel_RefNode:32" id="1174913663382">
        <link role="relationDeclaration:32" targetNodeId="1.1174913589936:3" />
      </node>
      <node role="childCellModel:32" type="jetbrains.mps.lang.editor.structure.CellModel_Constant:32" id="1174913668524">
        <property name="text:32" value="with" />
      </node>
      <node role="childCellModel:32" type="jetbrains.mps.lang.editor.structure.CellModel_RefNode:32" id="1174913693620">
        <link role="relationDeclaration:32" targetNodeId="1.1174913577997:3" />
      </node>
      <node role="childCellModel:32" type="jetbrains.mps.lang.editor.structure.CellModel_Constant:32" id="1174913703684">
        <property name="text:32" value="=" />
      </node>
      <node role="childCellModel:32" type="jetbrains.mps.lang.editor.structure.CellModel_Property:32" id="1174913712233">
        <link role="relationDeclaration:32" targetNodeId="1.1174913619594:3" />
      </node>
      <node role="cellLayout:32" type="jetbrains.mps.lang.editor.structure.CellLayout_Horizontal:32" id="1239880443094" />
    </node>
  </node>
  <node type="jetbrains.mps.lang.editor.structure.ConceptEditorDeclaration:32" id="1174913832562">
    <link role="conceptDeclaration:32" targetNodeId="1.1174913798044:3" />
    <node role="cellModel:32" type="jetbrains.mps.lang.editor.structure.CellModel_Collection:32" id="1174913840470">
      <property name="vertical:32" value="true" />
      <node role="childCellModel:32" type="jetbrains.mps.lang.editor.structure.CellModel_Constant:32" id="1174913842284">
        <property name="text:32" value="judgements" />
      </node>
      <node role="childCellModel:32" type="jetbrains.mps.lang.editor.structure.CellModel_Constant:32" id="1174913847364" />
      <node role="childCellModel:32" type="jetbrains.mps.lang.editor.structure.CellModel_RefNodeList:32" id="1174913854382">
        <property name="vertical:32" value="true" />
        <link role="relationDeclaration:32" targetNodeId="1.1174913808889:3" />
        <node role="cellLayout:32" type="jetbrains.mps.lang.editor.structure.CellLayout_Vertical:32" id="1239880443164" />
      </node>
      <node role="cellLayout:32" type="jetbrains.mps.lang.editor.structure.CellLayout_Vertical:32" id="1239880443100" />
    </node>
  </node>
  ...
  <node type="jetbrains.mps.lang.editor.structure.ConceptEditorDeclaration:32" id="1215687079072">
    <link role="conceptDeclaration:32" targetNodeId="1.1215686999346:3" resolveInfo="TypeOfExpression_internal" />
    <node role="cellModel:32" type="jetbrains.mps.lang.editor.structure.CellModel_Collection:32" id="1215687106454">
      <property name="vertical:32" value="false" />
      <node role="childCellModel:32" type="jetbrains.mps.lang.editor.structure.CellModel_ConceptProperty:32" id="1215687116036">
        <link role="relationDeclaration:32" targetNodeId="2.1137473891462:0" resolveInfo="alias" />
      </node>
      <node role="childCellModel:32" type="jetbrains.mps.lang.editor.structure.CellModel_Constant:32" id="1215687143741">
        <property name="text:32" value="(" />
        <node role="styleItem:32" type="jetbrains.mps.lang.editor.structure.MatchingLabelStyleClassItem:32" id="1238150394662">
          <property name="labelName:32" value="brace" />
        </node>
      </node>
      <node role="childCellModel:32" type="jetbrains.mps.lang.editor.structure.CellModel_RefNode:32" id="1215687148978">
        <link role="relationDeclaration:32" targetNodeId="1.1215687039958:3" />
      </node>
      <node role="childCellModel:32" type="jetbrains.mps.lang.editor.structure.CellModel_Constant:32" id="1215687151699">
        <property name="text:32" value=")" />
        <node role="styleItem:32" type="jetbrains.mps.lang.editor.structure.MatchingLabelStyleClassItem:32" id="1238150399655">
          <property name="labelName:32" value="brace" />
        </node>
      </node>
      <node role="childCellModel:32" type="jetbrains.mps.lang.editor.structure.CellModel_Constant:32" id="1215687614362">
        <property name="text:32" value="skipDepOnCurrent=" />
      </node>
      <node role="childCellModel:32" type="jetbrains.mps.lang.editor.structure.CellModel_Property:32" id="1215687611063">
        <link role="relationDeclaration:32" targetNodeId="1.1215687031113:3" resolveInfo="skipDependencyOnCurrent" />
      </node>
      <node role="childCellModel:32" type="jetbrains.mps.lang.editor.structure.CellModel_Constant:32" id="1215687156341">
        <property name="text:32" value="[" />
        <node role="styleItem:32" type="jetbrains.mps.lang.editor.structure.MatchingLabelStyleClassItem:32" id="1238150375548">
          <property name="labelName:32" value="square-bracket" />
        </node>
      </node>
      <node role="childCellModel:32" type="jetbrains.mps.lang.editor.structure.CellModel_Property:32" id="1215687162844">
        <link role="relationDeclaration:32" targetNodeId="1.1215687068337:3" resolveInfo="modelId" />
      </node>
      <node role="childCellModel:32" type="jetbrains.mps.lang.editor.structure.CellModel_Constant:32" id="1215687178051">
        <property name="text:32" value="." />
      </node>
      <node role="childCellModel:32" type="jetbrains.mps.lang.editor.structure.CellModel_Property:32" id="1215687183522">
        <link role="relationDeclaration:32" targetNodeId="1.1215687062242:3" resolveInfo="nodeId" />
      </node>
      <node role="childCellModel:32" type="jetbrains.mps.lang.editor.structure.CellModel_Constant:32" id="1215687198337">
        <property name="text:32" value="]" />
        <node role="styleItem:32" type="jetbrains.mps.lang.editor.structure.MatchingLabelStyleClassItem:32" id="1238150378644">
          <property name="labelName:32" value="square-bracket" />
        </node>
      </node>
      <node role="cellLayout:32" type="jetbrains.mps.lang.editor.structure.CellLayout_Indent:32" id="1237813583147" />
    </node>
  </node>
  <node type="jetbrains.mps.lang.editor.structure.ConceptEditorDeclaration:32" id="1215689759248">
    <link role="conceptDeclaration:32" targetNodeId="1.1215689617507:3" resolveInfo="AbstractEquationStatement_internal" />
    <node role="cellModel:32" type="jetbrains.mps.lang.editor.structure.CellModel_Collection:32" id="1215697557626">
      <property name="vertical:32" value="true" />
      <node role="childCellModel:32" type="jetbrains.mps.lang.editor.structure.CellModel_RefNode:32" id="1215697557628">
        <link role="relationDeclaration:32" targetNodeId="1.1215689671056:3" />
      </node>
      <node role="childCellModel:32" type="jetbrains.mps.lang.editor.structure.CellModel_Property:32" id="1215697557629">
        <link role="relationDeclaration:32" targetNodeId="1.1215689731418:3" resolveInfo="symbol" />
      </node>
      <node role="childCellModel:32" type="jetbrains.mps.lang.editor.structure.CellModel_Constant:32" id="1215697557630">
        <property name="text:32" value="(" />
        <node role="styleItem:32" type="jetbrains.mps.lang.editor.structure.MatchingLabelStyleClassItem:32" id="1238150245242">
          <property name="labelName:32" value="brace" />
        </node>
      </node>
      <node role="childCellModel:32" type="jetbrains.mps.lang.editor.structure.CellModel_Property:32" id="1215697557631">
        <link role="relationDeclaration:32" targetNodeId="1.1215689874440:3" resolveInfo="inequationPriority" />
      </node>
      <node role="childCellModel:32" type="jetbrains.mps.lang.editor.structure.CellModel_Constant:32" id="1215697557632">
        <property name="text:32" value=")" />
        <node role="styleItem:32" type="jetbrains.mps.lang.editor.structure.MatchingLabelStyleClassItem:32" id="1238150252847">
          <property name="labelName:32" value="brace" />
        </node>
      </node>
      <node role="childCellModel:32" type="jetbrains.mps.lang.editor.structure.CellModel_RefNode:32" id="1215697557633">
        <link role="relationDeclaration:32" targetNodeId="1.1215689671057:3" />
      </node>
      <node role="childCellModel:32" type="jetbrains.mps.lang.editor.structure.CellModel_Constant:32" id="1215697557634">
        <property name="text:32" value="[" />
        <node role="styleItem:32" type="jetbrains.mps.lang.editor.structure.MatchingLabelStyleClassItem:32" id="1238150256488">
          <property name="labelName:32" value="square-bracket" />
        </node>
      </node>
      <node role="childCellModel:32" type="jetbrains.mps.lang.editor.structure.CellModel_Property:32" id="1215697557635">
        <link role="relationDeclaration:32" targetNodeId="1.1215689689546:3" resolveInfo="modelId" />
      </node>
      <node role="childCellModel:32" type="jetbrains.mps.lang.editor.structure.CellModel_Constant:32" id="1215697557636">
        <property name="text:32" value="." />
      </node>
      <node role="childCellModel:32" type="jetbrains.mps.lang.editor.structure.CellModel_Property:32" id="1215697557637">
        <link role="relationDeclaration:32" targetNodeId="1.1215689685983:3" resolveInfo="nodeId" />
      </node>
      <node role="childCellModel:32" type="jetbrains.mps.lang.editor.structure.CellModel_Constant:32" id="1215697557638">
        <property name="text:32" value="];" />
        <node role="styleItem:32" type="jetbrains.mps.lang.editor.structure.MatchingLabelStyleClassItem:32" id="1238150360846">
          <property name="labelName:32" value="square-bracket" />
        </node>
        <node role="styleItem:32" type="jetbrains.mps.lang.editor.structure.IndentLayoutNewLineStyleClassItem:32" id="1237812032280">
          <property name="flag:32" value="true" />
        </node>
      </node>
      <node role="childCellModel:32" type="jetbrains.mps.lang.editor.structure.CellModel_Constant:32" id="1215697577395">
        <property name="text:32" value="node to check" />
      </node>
      <node role="childCellModel:32" type="jetbrains.mps.lang.editor.structure.CellModel_RefNode:32" id="1215697602241">
        <link role="relationDeclaration:32" targetNodeId="1.1215689671058:3" />
        <node role="styleItem:32" type="jetbrains.mps.lang.editor.structure.IndentLayoutNewLineStyleClassItem:32" id="1237812032281">
          <property name="flag:32" value="true" />
        </node>
      </node>
      <node role="childCellModel:32" type="jetbrains.mps.lang.editor.structure.CellModel_Constant:32" id="1215697607528">
        <property name="text:32" value="error string" />
      </node>
      <node role="childCellModel:32" type="jetbrains.mps.lang.editor.structure.CellModel_RefNode:32" id="1215697619624">
        <link role="relationDeclaration:32" targetNodeId="1.1215689671059:3" />
        <node role="styleItem:32" type="jetbrains.mps.lang.editor.structure.IndentLayoutNewLineStyleClassItem:32" id="1237812032282">
          <property name="flag:32" value="true" />
        </node>
      </node>
      <node role="childCellModel:32" type="jetbrains.mps.lang.editor.structure.CellModel_Constant:32" id="1216204600098">
        <property name="text:32" value="intention" />
      </node>
      <node role="childCellModel:32" type="jetbrains.mps.lang.editor.structure.CellModel_RefNode:32" id="1216204611834">
        <link role="relationDeclaration:32" targetNodeId="1.1216204558370:3" />
        <node role="styleItem:32" type="jetbrains.mps.lang.editor.structure.IndentLayoutNewLineStyleClassItem:32" id="1237812032284">
          <property name="flag:32" value="true" />
        </node>
      </node>
      <node role="childCellModel:32" type="jetbrains.mps.lang.editor.structure.CellModel_Constant:32" id="1215697633130">
        <property name="text:32" value="check only" />
      </node>
      <node role="childCellModel:32" type="jetbrains.mps.lang.editor.structure.CellModel_Property:32" id="1215697639304">
        <link role="relationDeclaration:32" targetNodeId="1.1215689656618:3" resolveInfo="checkOnly" />
        <node role="styleItem:32" type="jetbrains.mps.lang.editor.structure.IndentLayoutNewLineStyleClassItem:32" id="1237812032285">
          <property name="flag:32" value="true" />
        </node>
      </node>
      <node role="childCellModel:32" type="jetbrains.mps.lang.editor.structure.CellModel_Constant:32" id="7342618720439823041">
        <property name="text:32" value="inequation group:" />
      </node>
      <node role="childCellModel:32" type="jetbrains.mps.lang.editor.structure.CellModel_Property:32" id="7342618720439823042">
        <link role="relationDeclaration:32" targetNodeId="1.7342618720439823029:3" resolveInfo="inequationGroup" />
        <node role="styleItem:32" type="jetbrains.mps.lang.editor.structure.IndentLayoutNewLineStyleClassItem:32" id="7342618720439823043">
          <property name="flag:32" value="true" />
        </node>
      </node>
      <node role="childCellModel:32" type="jetbrains.mps.lang.editor.structure.CellModel_Constant:32" id="792701744776129735">
        <property name="text:32" value="before equations:" />
      </node>
      <node role="childCellModel:32" type="jetbrains.mps.lang.editor.structure.CellModel_RefNodeList:32" id="792701744776129739">
        <property name="separatorText:32" value="," />
        <link role="relationDeclaration:32" targetNodeId="1.792701744776129733:3" />
        <node role="cellLayout:32" type="jetbrains.mps.lang.editor.structure.CellLayout_Indent:32" id="792701744776129740" />
        <node role="styleItem:32" type="jetbrains.mps.lang.editor.structure.IndentLayoutNewLineStyleClassItem:32" id="792701744776129741">
          <property name="flag:32" value="true" />
        </node>
      </node>
      <node role="childCellModel:32" type="jetbrains.mps.lang.editor.structure.CellModel_Constant:32" id="792701744776129743">
        <property name="text:32" value="after equations:" />
      </node>
      <node role="childCellModel:32" type="jetbrains.mps.lang.editor.structure.CellModel_RefNodeList:32" id="792701744776129745">
        <property name="separatorText:32" value="," />
        <link role="relationDeclaration:32" targetNodeId="1.792701744776129732:3" />
        <node role="cellLayout:32" type="jetbrains.mps.lang.editor.structure.CellLayout_Indent:32" id="792701744776129746" />
        <node role="styleItem:32" type="jetbrains.mps.lang.editor.structure.IndentLayoutNewLineStyleClassItem:32" id="792701744776129747">
          <property name="flag:32" value="true" />
        </node>
      </node>
      <node role="childCellModel:32" type="jetbrains.mps.lang.editor.structure.CellModel_Constant:32" id="7342618720439823031">
        <property name="text:32" value="before groups:" />
      </node>
      <node role="childCellModel:32" type="jetbrains.mps.lang.editor.structure.CellModel_RefNodeList:32" id="7342618720439823032">
        <property name="separatorText:32" value="," />
        <link role="relationDeclaration:32" targetNodeId="1.7342618720439823028:3" />
        <node role="cellLayout:32" type="jetbrains.mps.lang.editor.structure.CellLayout_Indent:32" id="7342618720439823033" />
        <node role="styleItem:32" type="jetbrains.mps.lang.editor.structure.IndentLayoutNewLineStyleClassItem:32" id="7342618720439823034">
          <property name="flag:32" value="true" />
        </node>
      </node>
      <node role="childCellModel:32" type="jetbrains.mps.lang.editor.structure.CellModel_Constant:32" id="7342618720439823035">
        <property name="text:32" value="after groups:" />
      </node>
      <node role="childCellModel:32" type="jetbrains.mps.lang.editor.structure.CellModel_RefNodeList:32" id="7342618720439823036">
        <property name="separatorText:32" value="," />
        <link role="relationDeclaration:32" targetNodeId="1.7342618720439823027:3" />
        <node role="cellLayout:32" type="jetbrains.mps.lang.editor.structure.CellLayout_Indent:32" id="7342618720439823037" />
        <node role="styleItem:32" type="jetbrains.mps.lang.editor.structure.IndentLayoutNewLineStyleClassItem:32" id="7342618720439823038">
          <property name="flag:32" value="true" />
        </node>
      </node>
      <node role="cellLayout:32" type="jetbrains.mps.lang.editor.structure.CellLayout_Indent:32" id="1237812032290" />
    </node>
  </node>
  ...
  <node type="jetbrains.mps.lang.editor.structure.ConceptEditorDeclaration:32" id="1221229239306">
    <link role="conceptDeclaration:32" targetNodeId="1.1221225538487:3" resolveInfo="WhenConcreteStatement_internal" />
    <node role="cellModel:32" type="jetbrains.mps.lang.editor.structure.CellModel_Collection:32" id="1221229241511">
      <property name="vertical:32" value="true" />
      <node role="childCellModel:32" type="jetbrains.mps.lang.editor.structure.CellModel_Constant:32" id="1221229241513">
        <property name="text:32" value="when concrete" />
        <link role="styleClass:32" targetNodeId="27.1215188818086" resolveInfo="CompactKeyWord" />
      </node>
      <node role="childCellModel:32" type="jetbrains.mps.lang.editor.structure.CellModel_Property:32" id="1221229298704">
        <link role="relationDeclaration:32" targetNodeId="1.1221225753305:3" resolveInfo="modelId" />
      </node>
      <node role="childCellModel:32" type="jetbrains.mps.lang.editor.structure.CellModel_Property:32" id="1221229302004">
        <link role="relationDeclaration:32" targetNodeId="1.1221225753306:3" resolveInfo="nodeId" />
      </node>
      <node role="childCellModel:32" type="jetbrains.mps.lang.editor.structure.CellModel_Constant:32" id="1221229241514">
        <property name="text:32" value="(" />
        <link role="styleClass:32" targetNodeId="27.1215087929380" resolveInfo="LeftParen" />
      </node>
      <node role="childCellModel:32" type="jetbrains.mps.lang.editor.structure.CellModel_RefNode:32" id="1221229241515">
        <link role="relationDeclaration:32" targetNodeId="1.1221225619831:3" />
      </node>
      <node role="childCellModel:32" type="jetbrains.mps.lang.editor.structure.CellModel_Constant:32" id="1221229241516">
        <property name="text:32" value="as" />
        <link role="styleClass:32" targetNodeId="27.1186415544875" resolveInfo="KeyWord" />
      </node>
      <node role="childCellModel:32" type="jetbrains.mps.lang.editor.structure.CellModel_RefNode:32" id="1221229241517">
        <link role="relationDeclaration:32" targetNodeId="1.1221225619832:3" />
      </node>
      <node role="childCellModel:32" type="jetbrains.mps.lang.editor.structure.CellModel_Constant:32" id="1221229241518">
        <property name="text:32" value=")" />
        <link role="styleClass:32" targetNodeId="27.1215088010675" resolveInfo="RightParen" />
      </node>
      <node role="childCellModel:32" type="jetbrains.mps.lang.editor.structure.CellModel_Constant:32" id="1221229241519">
        <property name="text:32" value="{" />
        <link role="styleClass:32" targetNodeId="27.1215091279307" resolveInfo="LeftBrace" />
        <node role="styleItem:32" type="jetbrains.mps.lang.editor.structure.IndentLayoutNewLineStyleClassItem:32" id="1237812584688">
          <property name="flag:32" value="true" />
        </node>
      </node>
      <node role="childCellModel:32" type="jetbrains.mps.lang.editor.structure.CellModel_Constant:32" id="1221229241521">
        <property name="text:32" value="  " />
        <node role="styleItem:32" type="jetbrains.mps.lang.editor.structure.SelectableStyleSheetItem:32" id="1221229241522">
          <property name="flag:32" value="false" />
        </node>
      </node>
      <node role="childCellModel:32" type="jetbrains.mps.lang.editor.structure.CellModel_RefNode:32" id="1221229241523">
        <link role="relationDeclaration:32" targetNodeId="1.1221225619829:3" />
        <node role="styleItem:32" type="jetbrains.mps.lang.editor.structure.IndentLayoutNewLineStyleClassItem:32" id="1237812584690">
          <property name="flag:32" value="true" />
        </node>
      </node>
      <node role="childCellModel:32" type="jetbrains.mps.lang.editor.structure.CellModel_Constant:32" id="1221229241524">
        <property name="text:32" value="}" />
        <link role="styleClass:32" targetNodeId="27.1215091331565" resolveInfo="RightBrace" />
        <node role="styleItem:32" type="jetbrains.mps.lang.editor.structure.IndentLayoutNewLineStyleClassItem:32" id="1237812584691">
          <property name="flag:32" value="true" />
        </node>
      </node>
      <node role="childCellModel:32" type="jetbrains.mps.lang.editor.structure.CellModel_Constant:32" id="1227279937590">
        <property name="text:32" value="is shallow:" />
      </node>
      <node role="childCellModel:32" type="jetbrains.mps.lang.editor.structure.CellModel_Property:32" id="1227279947265">
        <link role="relationDeclaration:32" targetNodeId="1.1227279868398:3" resolveInfo="isShallow" />
        <node role="styleItem:32" type="jetbrains.mps.lang.editor.structure.IndentLayoutNewLineStyleClassItem:32" id="1237812584692">
          <property name="flag:32" value="true" />
        </node>
      </node>
      <node role="childCellModel:32" type="jetbrains.mps.lang.editor.structure.CellModel_Constant:32" id="1233571444642">
        <property name="text:32" value="skips error:" />
      </node>
      <node role="childCellModel:32" type="jetbrains.mps.lang.editor.structure.CellModel_Property:32" id="1233571472207">
        <link role="relationDeclaration:32" targetNodeId="1.1233571459078:3" resolveInfo="reportsError" />
        <node role="styleItem:32" type="jetbrains.mps.lang.editor.structure.IndentLayoutNewLineStyleClassItem:32" id="1237812584693">
          <property name="flag:32" value="true" />
        </node>
      </node>
      <node role="cellLayout:32" type="jetbrains.mps.lang.editor.structure.CellLayout_Indent:32" id="1237812584696" />
    </node>
  </node>
  <node type="jetbrains.mps.lang.editor.structure.ConceptEditorDeclaration:32" id="1222949072068">
    <link role="conceptDeclaration:32" targetNodeId="1.1222948723278:3" resolveInfo="ReportErrorStatement_internal" />
    <node role="cellModel:32" type="jetbrains.mps.lang.editor.structure.CellModel_Collection:32" id="1222949654680">
      <property name="vertical:32" value="true" />
      <node role="childCellModel:32" type="jetbrains.mps.lang.editor.structure.CellModel_Constant:32" id="1222949654682">
        <property name="text:32" value="error" />
        <link role="styleClass:32" targetNodeId="27.1186415544875" resolveInfo="KeyWord" />
      </node>
      <node role="childCellModel:32" type="jetbrains.mps.lang.editor.structure.CellModel_Property:32" id="1222949654683">
        <link role="relationDeclaration:32" targetNodeId="1.1222948753920:3" resolveInfo="modelId" />
      </node>
      <node role="childCellModel:32" type="jetbrains.mps.lang.editor.structure.CellModel_Property:32" id="1222949654684">
        <link role="relationDeclaration:32" targetNodeId="1.1222948753921:3" resolveInfo="nodeId" />
      </node>
      <node role="childCellModel:32" type="jetbrains.mps.lang.editor.structure.CellModel_RefNode:32" id="1222949654685">
        <property name="noTargetText:32" value="&lt;error string&gt;" />
        <link role="relationDeclaration:32" targetNodeId="1.1222948974814:3" />
      </node>
      <node role="childCellModel:32" type="jetbrains.mps.lang.editor.structure.CellModel_Constant:32" id="1222949654686">
        <property name="text:32" value="-&gt;" />
      </node>
      <node role="childCellModel:32" type="jetbrains.mps.lang.editor.structure.CellModel_RefNode:32" id="1222949654687">
        <property name="noTargetText:32" value="&lt;node to highlight&gt;" />
        <link role="relationDeclaration:32" targetNodeId="1.1222948974815:3" />
      </node>
      <node role="childCellModel:32" type="jetbrains.mps.lang.editor.structure.CellModel_Constant:32" id="1222949654688">
        <property name="text:32" value=";" />
        <node role="styleItem:32" type="jetbrains.mps.lang.editor.structure.IndentLayoutNewLineStyleClassItem:32" id="1237812433800">
          <property name="flag:32" value="true" />
        </node>
      </node>
      <node role="childCellModel:32" type="jetbrains.mps.lang.editor.structure.CellModel_Constant:32" id="1222949668551">
        <property name="text:32" value="intention to fix an error(optional)" />
        <node role="styleItem:32" type="jetbrains.mps.lang.editor.structure.IndentLayoutNewLineStyleClassItem:32" id="1237812433801">
          <property name="flag:32" value="true" />
        </node>
      </node>
      <node role="childCellModel:32" type="jetbrains.mps.lang.editor.structure.CellModel_RefNode:32" id="1222949668552">
        <property name="noTargetText:32" value="&lt;no intention&gt;" />
        <link role="relationDeclaration:32" targetNodeId="1.1222948974816:3" />
        <node role="styleItem:32" type="jetbrains.mps.lang.editor.structure.IndentLayoutNewLineStyleClassItem:32" id="1237812433802">
          <property name="flag:32" value="true" />
        </node>
      </node>
      <node role="childCellModel:32" type="jetbrains.mps.lang.editor.structure.CellModel_Constant:32" id="1227104710783">
        <property name="text:32" value="message target" />
        <node role="styleItem:32" type="jetbrains.mps.lang.editor.structure.IndentLayoutNewLineStyleClassItem:32" id="1237812433803">
          <property name="flag:32" value="true" />
        </node>
      </node>
      <node role="childCellModel:32" type="jetbrains.mps.lang.editor.structure.CellModel_RefNode:32" id="1227104710784">
        <link role="relationDeclaration:32" targetNodeId="1.1227104618952:3" />
        <node role="styleItem:32" type="jetbrains.mps.lang.editor.structure.IndentLayoutNewLineStyleClassItem:32" id="1237812433804">
          <property name="flag:32" value="true" />
        </node>
      </node>
      <node role="childCellModel:32" type="jetbrains.mps.lang.editor.structure.CellModel_Constant:32" id="4447441075424595179">
        <property name="text:32" value="foreign message source" />
        <node role="styleItem:32" type="jetbrains.mps.lang.editor.structure.IndentLayoutNewLineStyleClassItem:32" id="4447441075424595180">
          <property name="flag:32" value="true" />
        </node>
      </node>
      <node role="childCellModel:32" type="jetbrains.mps.lang.editor.structure.CellModel_RefNode:32" id="4447441075424595181">
        <link role="relationDeclaration:32" targetNodeId="1.4447441075424595172:3" />
        <node role="styleItem:32" type="jetbrains.mps.lang.editor.structure.IndentLayoutNewLineStyleClassItem:32" id="4447441075424595182">
          <property name="flag:32" value="true" />
        </node>
      </node>
      <node role="cellLayout:32" type="jetbrains.mps.lang.editor.structure.CellLayout_Indent:32" id="1237812433807" />
    </node>
  </node>
  ...
  <node type="jetbrains.mps.lang.editor.structure.ConceptEditorDeclaration:32" id="1223995803829">
    <link role="conceptDeclaration:32" targetNodeId="1.1223995273390:3" resolveInfo="AssertStatement_internal" />
    <node role="cellModel:32" type="jetbrains.mps.lang.editor.structure.CellModel_Collection:32" id="1223995805660">
      <property name="vertical:32" value="true" />
      <node role="childCellModel:32" type="jetbrains.mps.lang.editor.structure.CellModel_Constant:32" id="1223995837603">
        <property name="text:32" value="ensure" />
      </node>
      <node role="childCellModel:32" type="jetbrains.mps.lang.editor.structure.CellModel_RefNode:32" id="1223995845121">
        <link role="relationDeclaration:32" targetNodeId="1.1223995331830:3" />
      </node>
      <node role="childCellModel:32" type="jetbrains.mps.lang.editor.structure.CellModel_Constant:32" id="1223995805662">
        <property name="text:32" value="error" />
        <link role="styleClass:32" targetNodeId="27.1186415544875" resolveInfo="KeyWord" />
      </node>
      <node role="childCellModel:32" type="jetbrains.mps.lang.editor.structure.CellModel_Property:32" id="1223995805663">
        <link role="relationDeclaration:32" targetNodeId="1.1223995779374:3" resolveInfo="modelId" />
      </node>
      <node role="childCellModel:32" type="jetbrains.mps.lang.editor.structure.CellModel_Property:32" id="1223995805664">
        <link role="relationDeclaration:32" targetNodeId="1.1223995779375:3" resolveInfo="nodeId" />
      </node>
      <node role="childCellModel:32" type="jetbrains.mps.lang.editor.structure.CellModel_RefNode:32" id="1223995805665">
        <property name="noTargetText:32" value="&lt;error string&gt;" />
        <link role="relationDeclaration:32" targetNodeId="1.1223995386457:3" />
      </node>
      <node role="childCellModel:32" type="jetbrains.mps.lang.editor.structure.CellModel_Constant:32" id="1223995805666">
        <property name="text:32" value="-&gt;" />
      </node>
      <node role="childCellModel:32" type="jetbrains.mps.lang.editor.structure.CellModel_RefNode:32" id="1223995805667">
        <property name="noTargetText:32" value="&lt;node to highlight&gt;" />
        <link role="relationDeclaration:32" targetNodeId="1.1223995386458:3" />
      </node>
      <node role="childCellModel:32" type="jetbrains.mps.lang.editor.structure.CellModel_Constant:32" id="1223995805668">
        <property name="text:32" value=";" />
        <node role="styleItem:32" type="jetbrains.mps.lang.editor.structure.IndentLayoutNewLineStyleClassItem:32" id="1237812133093">
          <property name="flag:32" value="true" />
        </node>
      </node>
      <node role="childCellModel:32" type="jetbrains.mps.lang.editor.structure.CellModel_Constant:32" id="1223995805670">
        <property name="text:32" value="intention to fix an error(optional)" />
        <node role="styleItem:32" type="jetbrains.mps.lang.editor.structure.IndentLayoutNewLineStyleClassItem:32" id="1237812133095">
          <property name="flag:32" value="true" />
        </node>
      </node>
      <node role="childCellModel:32" type="jetbrains.mps.lang.editor.structure.CellModel_RefNode:32" id="1223995805671">
        <property name="noTargetText:32" value="&lt;no intention&gt;" />
        <link role="relationDeclaration:32" targetNodeId="1.1223995386459:3" />
        <node role="styleItem:32" type="jetbrains.mps.lang.editor.structure.IndentLayoutNewLineStyleClassItem:32" id="1237812133096">
          <property name="flag:32" value="true" />
        </node>
      </node>
      <node role="childCellModel:32" type="jetbrains.mps.lang.editor.structure.CellModel_Constant:32" id="1227104701735">
        <property name="text:32" value="message target" />
        <node role="styleItem:32" type="jetbrains.mps.lang.editor.structure.IndentLayoutNewLineStyleClassItem:32" id="1237812133097">
          <property name="flag:32" value="true" />
        </node>
      </node>
      <node role="childCellModel:32" type="jetbrains.mps.lang.editor.structure.CellModel_RefNode:32" id="1227104701736">
        <link role="relationDeclaration:32" targetNodeId="1.1227104635133:3" />
        <node role="styleItem:32" type="jetbrains.mps.lang.editor.structure.IndentLayoutNewLineStyleClassItem:32" id="1237812133098">
          <property name="flag:32" value="true" />
        </node>
      </node>
      <node role="childCellModel:32" type="jetbrains.mps.lang.editor.structure.CellModel_Constant:32" id="4447441075424595175">
        <property name="text:32" value="foreign message source" />
        <node role="styleItem:32" type="jetbrains.mps.lang.editor.structure.IndentLayoutNewLineStyleClassItem:32" id="4447441075424595176">
          <property name="flag:32" value="true" />
        </node>
      </node>
      <node role="childCellModel:32" type="jetbrains.mps.lang.editor.structure.CellModel_RefNode:32" id="4447441075424595177">
        <link role="relationDeclaration:32" targetNodeId="1.4447441075424595174:3" />
        <node role="styleItem:32" type="jetbrains.mps.lang.editor.structure.IndentLayoutNewLineStyleClassItem:32" id="4447441075424595178">
          <property name="flag:32" value="true" />
        </node>
      </node>
      <node role="cellLayout:32" type="jetbrains.mps.lang.editor.structure.CellLayout_Indent:32" id="1237812133102" />
    </node>
  </node>
  ...
  <node type="jetbrains.mps.lang.editor.structure.ConceptEditorDeclaration:32" id="1225968673200">
    <link role="conceptDeclaration:32" targetNodeId="1.1225968571991:3" resolveInfo="WarningStatement_internal" />
    <node role="cellModel:32" type="jetbrains.mps.lang.editor.structure.CellModel_Collection:32" id="1225968675592">
      <property name="vertical:32" value="true" />
      <node role="childCellModel:32" type="jetbrains.mps.lang.editor.structure.CellModel_Constant:32" id="1225968675594">
        <property name="text:32" value="warning" />
        <link role="styleClass:32" targetNodeId="27.1186415544875" resolveInfo="KeyWord" />
      </node>
      <node role="childCellModel:32" type="jetbrains.mps.lang.editor.structure.CellModel_Property:32" id="1225968675595">
        <link role="relationDeclaration:32" targetNodeId="1.1225968642860:3" resolveInfo="modelId" />
      </node>
      <node role="childCellModel:32" type="jetbrains.mps.lang.editor.structure.CellModel_Property:32" id="1225968675596">
        <link role="relationDeclaration:32" targetNodeId="1.1225968627315:3" resolveInfo="nodeId" />
      </node>
      <node role="childCellModel:32" type="jetbrains.mps.lang.editor.structure.CellModel_RefNode:32" id="1225968675597">
        <property name="noTargetText:32" value="&lt;error string&gt;" />
        <link role="relationDeclaration:32" targetNodeId="1.1225968625359:3" />
      </node>
      <node role="childCellModel:32" type="jetbrains.mps.lang.editor.structure.CellModel_Constant:32" id="1225968675598">
        <property name="text:32" value="-&gt;" />
      </node>
      <node role="childCellModel:32" type="jetbrains.mps.lang.editor.structure.CellModel_RefNode:32" id="1225968675599">
        <property name="noTargetText:32" value="&lt;node to highlight&gt;" />
        <link role="relationDeclaration:32" targetNodeId="1.1225968625360:3" />
      </node>
      <node role="childCellModel:32" type="jetbrains.mps.lang.editor.structure.CellModel_Constant:32" id="1225968675600">
        <property name="text:32" value=";" />
        <node role="styleItem:32" type="jetbrains.mps.lang.editor.structure.IndentLayoutNewLineStyleClassItem:32" id="1237812562779">
          <property name="flag:32" value="true" />
        </node>
      </node>
      <node role="childCellModel:32" type="jetbrains.mps.lang.editor.structure.CellModel_Constant:32" id="1225968675602">
        <property name="text:32" value="intention to fix an error(optional)" />
        <node role="styleItem:32" type="jetbrains.mps.lang.editor.structure.IndentLayoutNewLineStyleClassItem:32" id="1237812562780">
          <property name="flag:32" value="true" />
        </node>
      </node>
      <node role="childCellModel:32" type="jetbrains.mps.lang.editor.structure.CellModel_RefNode:32" id="1225968675603">
        <property name="noTargetText:32" value="&lt;no intention&gt;" />
        <link role="relationDeclaration:32" targetNodeId="1.1225968625361:3" />
        <node role="styleItem:32" type="jetbrains.mps.lang.editor.structure.IndentLayoutNewLineStyleClassItem:32" id="1237812562782">
          <property name="flag:32" value="true" />
        </node>
      </node>
      <node role="childCellModel:32" type="jetbrains.mps.lang.editor.structure.CellModel_Constant:32" id="1227104690023">
        <property name="text:32" value="message target" />
        <node role="styleItem:32" type="jetbrains.mps.lang.editor.structure.IndentLayoutNewLineStyleClassItem:32" id="1237812562783">
          <property name="flag:32" value="true" />
        </node>
      </node>
      <node role="childCellModel:32" type="jetbrains.mps.lang.editor.structure.CellModel_RefNode:32" id="1227104693816">
        <link role="relationDeclaration:32" targetNodeId="1.1227104644040:3" />
        <node role="styleItem:32" type="jetbrains.mps.lang.editor.structure.IndentLayoutNewLineStyleClassItem:32" id="1237812562784">
          <property name="flag:32" value="true" />
        </node>
      </node>
      <node role="childCellModel:32" type="jetbrains.mps.lang.editor.structure.CellModel_Constant:32" id="4447441075424595183">
        <property name="text:32" value="foreign message source" />
        <node role="styleItem:32" type="jetbrains.mps.lang.editor.structure.IndentLayoutNewLineStyleClassItem:32" id="4447441075424595184">
          <property name="flag:32" value="true" />
        </node>
      </node>
      <node role="childCellModel:32" type="jetbrains.mps.lang.editor.structure.CellModel_RefNode:32" id="4447441075424595185">
        <link role="relationDeclaration:32" targetNodeId="1.4447441075424595170:3" />
        <node role="styleItem:32" type="jetbrains.mps.lang.editor.structure.IndentLayoutNewLineStyleClassItem:32" id="4447441075424595186">
          <property name="flag:32" value="true" />
        </node>
      </node>
      <node role="cellLayout:32" type="jetbrains.mps.lang.editor.structure.CellLayout_Indent:32" id="1237812562786" />
    </node>
  </node>
  <node type="jetbrains.mps.lang.editor.structure.ConceptEditorDeclaration:32" id="1225971344562">
    <link role="conceptDeclaration:32" targetNodeId="1.1225971039738:3" resolveInfo="InfoStatement_internal" />
    <node role="cellModel:32" type="jetbrains.mps.lang.editor.structure.CellModel_Collection:32" id="1225971346173">
      <property name="vertical:32" value="true" />
      <node role="childCellModel:32" type="jetbrains.mps.lang.editor.structure.CellModel_Constant:32" id="1225971346175">
        <property name="text:32" value="info" />
        <link role="styleClass:32" targetNodeId="27.1186415544875" resolveInfo="KeyWord" />
      </node>
      <node role="childCellModel:32" type="jetbrains.mps.lang.editor.structure.CellModel_Property:32" id="1225971346176">
        <link role="relationDeclaration:32" targetNodeId="1.1225971261248:3" resolveInfo="modelId" />
      </node>
      <node role="childCellModel:32" type="jetbrains.mps.lang.editor.structure.CellModel_Property:32" id="1225971346177">
        <link role="relationDeclaration:32" targetNodeId="1.1225971265421:3" resolveInfo="nodeId" />
      </node>
      <node role="childCellModel:32" type="jetbrains.mps.lang.editor.structure.CellModel_RefNode:32" id="1225971346178">
        <property name="noTargetText:32" value="&lt;error string&gt;" />
        <link role="relationDeclaration:32" targetNodeId="1.1225971258464:3" />
      </node>
      <node role="childCellModel:32" type="jetbrains.mps.lang.editor.structure.CellModel_Constant:32" id="1225971346179">
        <property name="text:32" value="-&gt;" />
      </node>
      <node role="childCellModel:32" type="jetbrains.mps.lang.editor.structure.CellModel_RefNode:32" id="1225971346180">
        <property name="noTargetText:32" value="&lt;node to highlight&gt;" />
        <link role="relationDeclaration:32" targetNodeId="1.1225971258465:3" />
      </node>
      <node role="childCellModel:32" type="jetbrains.mps.lang.editor.structure.CellModel_Constant:32" id="1225971346181">
        <property name="text:32" value=";" />
        <node role="styleItem:32" type="jetbrains.mps.lang.editor.structure.IndentLayoutNewLineStyleClassItem:32" id="1237812319507">
          <property name="flag:32" value="true" />
        </node>
      </node>
      <node role="childCellModel:32" type="jetbrains.mps.lang.editor.structure.CellModel_Constant:32" id="1225971346183">
        <property name="text:32" value="intention to fix an error(optional)" />
        <node role="styleItem:32" type="jetbrains.mps.lang.editor.structure.IndentLayoutNewLineStyleClassItem:32" id="1237812319508">
          <property name="flag:32" value="true" />
        </node>
      </node>
      <node role="childCellModel:32" type="jetbrains.mps.lang.editor.structure.CellModel_RefNode:32" id="1225971346184">
        <property name="noTargetText:32" value="&lt;no intention&gt;" />
        <link role="relationDeclaration:32" targetNodeId="1.1225971258466:3" />
        <node role="styleItem:32" type="jetbrains.mps.lang.editor.structure.IndentLayoutNewLineStyleClassItem:32" id="1237812319509">
          <property name="flag:32" value="true" />
        </node>
      </node>
      <node role="childCellModel:32" type="jetbrains.mps.lang.editor.structure.CellModel_Constant:32" id="1227104723181">
        <property name="text:32" value="message target" />
        <node role="styleItem:32" type="jetbrains.mps.lang.editor.structure.IndentLayoutNewLineStyleClassItem:32" id="1237812319510">
          <property name="flag:32" value="true" />
        </node>
      </node>
      <node role="childCellModel:32" type="jetbrains.mps.lang.editor.structure.CellModel_RefNode:32" id="1227104723182">
        <link role="relationDeclaration:32" targetNodeId="1.1227104609964:3" />
        <node role="styleItem:32" type="jetbrains.mps.lang.editor.structure.IndentLayoutNewLineStyleClassItem:32" id="1237812319511">
          <property name="flag:32" value="true" />
        </node>
      </node>
      <node role="childCellModel:32" type="jetbrains.mps.lang.editor.structure.CellModel_Constant:32" id="4447441075424595188">
        <property name="text:32" value="foreign message source" />
        <node role="styleItem:32" type="jetbrains.mps.lang.editor.structure.IndentLayoutNewLineStyleClassItem:32" id="4447441075424595189">
          <property name="flag:32" value="true" />
        </node>
      </node>
      <node role="childCellModel:32" type="jetbrains.mps.lang.editor.structure.CellModel_RefNode:32" id="4447441075424595190">
        <link role="relationDeclaration:32" targetNodeId="1.4447441075424595168:3" />
        <node role="styleItem:32" type="jetbrains.mps.lang.editor.structure.IndentLayoutNewLineStyleClassItem:32" id="4447441075424595191">
          <property name="flag:32" value="true" />
        </node>
      </node>
      <node role="cellLayout:32" type="jetbrains.mps.lang.editor.structure.CellLayout_Indent:32" id="1237812319515" />
    </node>
  </node>
  ...
  <node type="jetbrains.mps.lang.editor.structure.ConceptEditorDeclaration:32" id="1230554254879">
    <link role="conceptDeclaration:32" targetNodeId="1.1230554163368:3" resolveInfo="ExperimentalSubtypingRulesContainer" />
    <node role="cellModel:32" type="jetbrains.mps.lang.editor.structure.CellModel_Collection:32" id="1230554289691">
      <property name="vertical:32" value="true" />
      <node role="childCellModel:32" type="jetbrains.mps.lang.editor.structure.CellModel_Constant:32" id="1230554291922">
        <property name="text:32" value="subtyping rules (experimental)" />
      </node>
      <node role="childCellModel:32" type="jetbrains.mps.lang.editor.structure.CellModel_RefNodeList:32" id="1230554318255">
        <property name="vertical:32" value="true" />
        <property name="separatorText:32" value="#" />
        <link role="relationDeclaration:32" targetNodeId="1.1230554226455:3" />
        <node role="cellLayout:32" type="jetbrains.mps.lang.editor.structure.CellLayout_Vertical:32" id="1239880443158" />
      </node>
      <node role="cellLayout:32" type="jetbrains.mps.lang.editor.structure.CellLayout_Vertical:32" id="1239880442965" />
    </node>
  </node>
  <node type="jetbrains.mps.lang.editor.structure.ConceptEditorDeclaration:32" id="1230560479391">
    <link role="conceptDeclaration:32" targetNodeId="1.1230560224148:3" resolveInfo="LinksAssociationKind" />
    <node role="cellModel:32" type="jetbrains.mps.lang.editor.structure.CellModel_ConceptProperty:32" id="1230560482492">
      <link role="relationDeclaration:32" targetNodeId="2.1137473891462:0" resolveInfo="alias" />
      <node role="styleItem:32" type="jetbrains.mps.lang.editor.structure.ForegroundColorStyleClassItem:32" id="1230560494955">
        <property name="color:32" value="DARK_GREEN" />
      </node>
    </node>
  </node>
  <node type="jetbrains.mps.lang.editor.structure.ConceptEditorDeclaration:32" id="1230560981030">
    <link role="conceptDeclaration:32" targetNodeId="1.1230554361641:3" resolveInfo="LinkAssociation" />
    <node role="cellModel:32" type="jetbrains.mps.lang.editor.structure.CellModel_Collection:32" id="1230561006739">
      <property name="vertical:32" value="false" />
      <node role="childCellModel:32" type="jetbrains.mps.lang.editor.structure.CellModel_RefCell:32" id="1230561006740">
        <link role="relationDeclaration:32" targetNodeId="1.1230554396851:3" />
        <node role="editorComponent:32" type="jetbrains.mps.lang.editor.structure.InlineEditorComponent:32" id="1230561006741">
          <node role="cellModel:32" type="jetbrains.mps.lang.editor.structure.CellModel_Property:32" id="1230561006742">
            <property name="readOnly:32" value="true" />
            <link role="relationDeclaration:32" targetNodeId="8.1071599776563:0" resolveInfo="role" />
          </node>
        </node>
      </node>
      <node role="childCellModel:32" type="jetbrains.mps.lang.editor.structure.CellModel_RefNode:32" id="1230561014568">
        <link role="relationDeclaration:32" targetNodeId="1.1230560961413:3" />
      </node>
      <node role="childCellModel:32" type="jetbrains.mps.lang.editor.structure.CellModel_RefCell:32" id="1230561033890">
        <link role="relationDeclaration:32" targetNodeId="1.1230560176540:3" />
        <node role="editorComponent:32" type="jetbrains.mps.lang.editor.structure.InlineEditorComponent:32" id="1230561033891">
          <node role="cellModel:32" type="jetbrains.mps.lang.editor.structure.CellModel_Property:32" id="1230561037850">
            <property name="readOnly:32" value="true" />
            <link role="relationDeclaration:32" targetNodeId="8.1071599776563:0" resolveInfo="role" />
          </node>
        </node>
      </node>
      <node role="cellLayout:32" type="jetbrains.mps.lang.editor.structure.CellLayout_Horizontal:32" id="1239880442963" />
    </node>
  </node>
  <node type="jetbrains.mps.lang.editor.structure.ConceptEditorDeclaration:32" id="1230562172052">
    <link role="conceptDeclaration:32" targetNodeId="1.1230554202040:3" resolveInfo="ExperimentalSubtypingRule" />
    <node role="cellModel:32" type="jetbrains.mps.lang.editor.structure.CellModel_Collection:32" id="1230562188007">
      <property name="vertical:32" value="true" />
      <node role="childCellModel:32" type="jetbrains.mps.lang.editor.structure.CellModel_Collection:32" id="1232291066645">
        <property name="vertical:32" value="false" />
        <node role="styleItem:32" type="jetbrains.mps.lang.editor.structure.SelectableStyleSheetItem:32" id="1232291066646">
          <property name="flag:32" value="false" />
        </node>
        <node role="childCellModel:32" type="jetbrains.mps.lang.editor.structure.CellModel_Constant:32" id="1232291066647">
          <property name="text:32" value="rule" />
        </node>
        <node role="childCellModel:32" type="jetbrains.mps.lang.editor.structure.CellModel_Property:32" id="1232291070553">
          <link role="relationDeclaration:32" targetNodeId="2.1169194664001:0" resolveInfo="name" />
        </node>
        <node role="styleItem:32" type="jetbrains.mps.lang.editor.structure.SelectableStyleSheetItem:32" id="1232291066648">
          <property name="flag:32" value="false" />
        </node>
        <node role="cellLayout:32" type="jetbrains.mps.lang.editor.structure.CellLayout_Horizontal:32" id="1239880443018" />
      </node>
      <node role="childCellModel:32" type="jetbrains.mps.lang.editor.structure.CellModel_Collection:32" id="1230562194600">
        <property name="vertical:32" value="false" />
        <node role="styleItem:32" type="jetbrains.mps.lang.editor.structure.SelectableStyleSheetItem:32" id="1230562194601">
          <property name="flag:32" value="false" />
        </node>
        <node role="childCellModel:32" type="jetbrains.mps.lang.editor.structure.CellModel_Constant:32" id="1230562197125">
          <property name="text:32" value="subtype concept:" />
        </node>
        <node role="childCellModel:32" type="jetbrains.mps.lang.editor.structure.CellModel_RefCell:32" id="1230562206156">
          <link role="relationDeclaration:32" targetNodeId="1.1230558876059:3" />
          <node role="editorComponent:32" type="jetbrains.mps.lang.editor.structure.InlineEditorComponent:32" id="1230562206157">
            <node role="cellModel:32" type="jetbrains.mps.lang.editor.structure.CellModel_Property:32" id="1230562210962">
              <property name="readOnly:32" value="true" />
              <link role="relationDeclaration:32" targetNodeId="2.1169194664001:0" resolveInfo="name" />
            </node>
          </node>
        </node>
        <node role="childCellModel:32" type="jetbrains.mps.lang.editor.structure.CellModel_Constant:32" id="1230562213002">
          <property name="text:32" value="  " />
          <node role="styleItem:32" type="jetbrains.mps.lang.editor.structure.SelectableStyleSheetItem:32" id="1230562219035" />
        </node>
        <node role="childCellModel:32" type="jetbrains.mps.lang.editor.structure.CellModel_Constant:32" id="1230562239366">
          <property name="text:32" value="supertype concept:" />
        </node>
        <node role="childCellModel:32" type="jetbrains.mps.lang.editor.structure.CellModel_RefCell:32" id="1230562259010">
          <link role="relationDeclaration:32" targetNodeId="1.1230558885001:3" />
          <node role="editorComponent:32" type="jetbrains.mps.lang.editor.structure.InlineEditorComponent:32" id="1230562259011">
            <node role="cellModel:32" type="jetbrains.mps.lang.editor.structure.CellModel_Property:32" id="1230562260390">
              <property name="readOnly:32" value="true" />
              <link role="relationDeclaration:32" targetNodeId="2.1169194664001:0" resolveInfo="name" />
            </node>
          </node>
        </node>
        <node role="styleItem:32" type="jetbrains.mps.lang.editor.structure.SelectableStyleSheetItem:32" id="1230562194603">
          <property name="flag:32" value="false" />
        </node>
        <node role="cellLayout:32" type="jetbrains.mps.lang.editor.structure.CellLayout_Horizontal:32" id="1239880443138" />
      </node>
      <node role="childCellModel:32" type="jetbrains.mps.lang.editor.structure.CellModel_Collection:32" id="1230562277740">
        <property name="vertical:32" value="false" />
        <node role="styleItem:32" type="jetbrains.mps.lang.editor.structure.SelectableStyleSheetItem:32" id="1230562277741">
          <property name="flag:32" value="false" />
        </node>
        <node role="childCellModel:32" type="jetbrains.mps.lang.editor.structure.CellModel_Indent:32" id="1230562282259" />
        <node role="childCellModel:32" type="jetbrains.mps.lang.editor.structure.CellModel_RefNodeList:32" id="1230562277742">
          <property name="vertical:32" value="true" />
          <link role="relationDeclaration:32" targetNodeId="1.1230558896440:3" />
          <node role="cellLayout:32" type="jetbrains.mps.lang.editor.structure.CellLayout_Vertical:32" id="1239880443156" />
        </node>
        <node role="styleItem:32" type="jetbrains.mps.lang.editor.structure.SelectableStyleSheetItem:32" id="1230562277743">
          <property name="flag:32" value="false" />
        </node>
        <node role="cellLayout:32" type="jetbrains.mps.lang.editor.structure.CellLayout_Horizontal:32" id="1239880443141" />
      </node>
      <node role="cellLayout:32" type="jetbrains.mps.lang.editor.structure.CellLayout_Vertical:32" id="1239880443129" />
    </node>
  </node>
  ...
  <node type="jetbrains.mps.lang.editor.structure.ConceptEditorDeclaration:32" id="7204977815415955558">
    <link role="conceptDeclaration:32" targetNodeId="1.7204977815415955556:3" resolveInfo="CopiedTypeProvider" />
    <node role="cellModel:32" type="jetbrains.mps.lang.editor.structure.CellModel_Collection:32" id="7204977815415970907">
      <node role="childCellModel:32" type="jetbrains.mps.lang.editor.structure.CellModel_Constant:32" id="7204977815415970910">
        <property name="text:32" value="copied" />
      </node>
      <node role="childCellModel:32" type="jetbrains.mps.lang.editor.structure.CellModel_ModelAccess:32" id="7204977815415970912">
        <property name="nullText:32" value="&lt;no source&gt;" />
        <node role="modelAcessor:32" type="jetbrains.mps.lang.editor.structure.ModelAccessor:32" id="7204977815415970913">
          <node role="getter:32" type="jetbrains.mps.lang.editor.structure.QueryFunction_ModelAccess_Getter:32" id="7204977815415970914">
            <node role="body:32" type="jetbrains.mps.baseLanguage.structure.StatementList:3" id="7204977815415970915">
              <node role="statement:3" type="jetbrains.mps.baseLanguage.structure.ReturnStatement:3" id="7204977815415970920">
                <node role="expression:3" type="jetbrains.mps.baseLanguage.structure.DotExpression:3" id="7204977815415970928">
                  <node role="operand:3" type="jetbrains.mps.baseLanguage.structure.DotExpression:3" id="7204977815415970923">
                    <node role="operand:3" type="jetbrains.mps.lang.editor.structure.ConceptFunctionParameter_node:32" id="7204977815415970922" />
                    <node role="operation:3" type="jetbrains.mps.lang.smodel.structure.SLinkAccess:16" id="7204977815415970927">
                      <link role="link:16" targetNodeId="1.7204977815415955557:3" />
                    </node>
                  </node>
                  <node role="operation:3" type="jetbrains.mps.lang.smodel.structure.Node_ConceptMethodCall:16" id="7204977815415970932">
          ...
          <node role="setter:32" type="jetbrains.mps.lang.editor.structure.QueryFunction_ModelAccess_Setter:32" id="7204977815415970916">
            <node role="body:32" type="jetbrains.mps.baseLanguage.structure.StatementList:3" id="7204977815415970917" />
          </node>
          <node role="validator:32" type="jetbrains.mps.lang.editor.structure.QueryFunction_ModelAccess_Validator:32" id="7204977815415970918">
            <node role="body:32" type="jetbrains.mps.baseLanguage.structure.StatementList:3" id="7204977815415970919">
              <node role="statement:3" type="jetbrains.mps.baseLanguage.structure.ReturnStatement:3" id="7204977815415970933">
                <node role="expression:3" type="jetbrains.mps.baseLanguage.structure.DotExpression:3" id="7204977815415970936">
                  <node role="operand:3" type="jetbrains.mps.lang.editor.structure.ConceptFunctionParameter_oldText:32" id="7204977815415970935" />
                  <node role="operation:3" type="jetbrains.mps.baseLanguage.structure.InstanceMethodCallOperation:3" id="7204977815415971297">
                    <link role="baseMethodDeclaration:3" targetNodeId="35.~String.equals(java.lang.Object):boolean" resolveInfo="equals" />
                    <node role="actualArgument:3" type="jetbrains.mps.lang.editor.structure.ConceptFunctionParameter_text:32" id="7204977815415971299" />
                  </node>
                </node>
              </node>
            </node>
      ...
      <node role="cellLayout:32" type="jetbrains.mps.lang.editor.structure.CellLayout_Horizontal:32" id="7204977815415970909" />
    </node>
  </node>
