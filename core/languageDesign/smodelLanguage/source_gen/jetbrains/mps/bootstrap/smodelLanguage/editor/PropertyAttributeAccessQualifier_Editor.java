...
public class PropertyAttributeAccessQualifier_Editor extends DefaultNodeEditor {
  ...
  private static void setupBasic_PropertyArgumentCell(EditorCell editorCell, SNode node, EditorContext context) {
  ...
  private static void setupLabel_PropertyArgumentCell(EditorCell_Label editorCell, SNode node, EditorContext context) {
  }
  ...
  public EditorCell createRowCell(EditorContext context, SNode node) {
    ...
    editorCell.addEditorCell(this.createPropertyArgumentCell(context, node));
  ...
  public EditorCell createPropertyArgumentCellinternal(EditorContext context, SNode node, CellProviderWithRole aProvider) {
    CellProviderWithRole provider = aProvider;
    provider.setAuxiliaryCellProvider(null);
    EditorCell editorCell = provider.createEditorCell(context);
    PropertyAttributeAccessQualifier_Editor.setupBasic_PropertyArgumentCell(editorCell, node, context);
    if(editorCell instanceof EditorCell_Label) {
      PropertyAttributeAccessQualifier_Editor.setupLabel_PropertyArgumentCell((EditorCell_Label)editorCell, node, context);
    }
    editorCell.setSubstituteInfo(provider.createDefaultSubstituteInfo());
    return editorCell;
  }

  public EditorCell createPropertyArgumentCell(EditorContext context, SNode node) {
    CellProviderWithRole provider = new RefNodeCellProvider(node, context);
    provider.setRole("propertyArgument");
    provider.setNoTargetText("<property>");
    provider.setReadOnly(false);
    provider.setAllowsEmptyTarget(false);
    EditorCell cellWithRole = this.createPropertyArgumentCellinternal(context, node, provider);
    SNode attributeConcept = provider.getRoleAttribute();
    Class attributeKind = provider.getRoleAttributeClass();
    if(attributeConcept != null) {
      IOperationContext opContext = context.getOperationContext();
