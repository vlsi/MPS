...
public class RefConcept_Reference_Editor extends DefaultNodeEditor {
  ...
  public static class _Inline25 extends AbstractCellProvider {
    ...
    public EditorCell createNameCellinternal(EditorContext context, SNode node, CellProviderWithRole aProvider) {
      ...
      EditorCell editorCell = provider.createEditorCell(context);
      RefConcept_Reference_Editor._Inline25.setupBasic_NameCell(editorCell, node, context);
      if (editorCell instanceof EditorCell_Label) {
        RefConcept_Reference_Editor._Inline25.setupLabel_NameCell((EditorCell_Label)editorCell, node, context);
      }
      editorCell.setSubstituteInfo(provider.createDefaultSubstituteInfo());
      return editorCell;
    }
