...
public class typeof_SLinkListAccess_InferenceRule implements InferenceRule_Runtime {
  ...
  public void applyRule(final SNode op) {
    ...
    // assign type
    {
      ...
      TypeChecker.getInstance().getRuntimeSupport().createEquation(TypeChecker.getInstance().getRuntimeSupport().typeOf(op, "jetbrains.mps.bootstrap.smodelLanguage.helgins", "1206103737722", true), new QuotationClass_72().createNode(SLinkOperations.getTarget(linkDecl, "target", false), "" + SPropertyOperations.hasValue(linkDecl, "metaClass", "aggregation", "reference")), _nodeToCheck_1029348928467, null, "jetbrains.mps.bootstrap.smodelLanguage.helgins", "1206103745585", intentionProvider);
    }
    // ---
    ...
    RulesUtil.equate_inputNodeConcept(op, TypeChecker.getInstance().getEquationManager().getRepresentator(Concept_typevar_1186062842230));
    {
      ...
      }, "jetbrains.mps.bootstrap.smodelLanguage.helgins@3_0", "1220522414769");
    }
  }
