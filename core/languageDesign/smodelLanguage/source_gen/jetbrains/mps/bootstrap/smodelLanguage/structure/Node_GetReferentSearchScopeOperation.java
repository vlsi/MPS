...
public class Node_GetReferentSearchScopeOperation extends SNodeOperation {
  public static final String concept = "jetbrains.mps.bootstrap.smodelLanguage.structure.Node_GetReferentSearchScopeOperation";
  ...
  public static Node_GetReferentSearchScopeOperation newInstance(SModel sm, boolean init) {
    return (Node_GetReferentSearchScopeOperation)SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.bootstrap.smodelLanguage.structure.Node_GetReferentSearchScopeOperation", sm, GlobalScope.getInstance(), init).getAdapter();
  }
