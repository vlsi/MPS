...
public class typeOf_LinkList_AddChildOperation_InferenceRule implements InferenceRule_Runtime {
  ...
  public void applyRule(final SNode op) {
    ...
    if ((parameter != null)) {
      final SNode ExpectedType_typevar_1206101161890 = TypeChecker.getInstance().getRuntimeSupport().createNewRuntimeTypesVariable(false);
      ...
      TypeChecker.getInstance().getRuntimeSupport().createLessThanInequation(parmType, TypeChecker.getInstance().getEquationManager().getRepresentator(ExpectedType_typevar_1206101161890), op, null, "jetbrains.mps.bootstrap.smodelLanguage.helgins", "1205272443656", false);
    }
  }
