...
public class Property_HasValue_Enum_Editor extends DefaultNodeEditor {
  ...
  private static void setupBasic_ValueCell(EditorCell editorCell, SNode node, EditorContext context) {
    editorCell.putUserObject(EditorCell.CELL_ID, node.getId() + "_1146171170038");
    editorCell.setDrawBorder(false);
  }

  private static void setupBasic_ReplaceableAlias_CompCell(EditorCell editorCell, SNode node, EditorContext context) {
    editorCell.putUserObject(EditorCell.CELL_ID, node.getId() + "_1206487951704");
  }

  private static void setupBasic_ConstantCell(EditorCell editorCell, SNode node, EditorContext context) {
    editorCell.putUserObject(EditorCell.CELL_ID, node.getId() + "_1206487951705");
  ...
  private static void setupBasic_ConstantCell1(EditorCell editorCell, SNode node, EditorContext context) {
    editorCell.putUserObject(EditorCell.CELL_ID, node.getId() + "_1206487964378");
    editorCell.setDrawBorder(false);
    editorCell.setFontType(MPSFonts.PLAIN);
  }
  ...
  public EditorCell createRowCell(EditorContext context, SNode node) {
    ...
    Property_HasValue_Enum_Editor.setupBasic_RowCell(editorCell, node, context);
  ...
  public EditorCell createConstantCell(EditorContext context, SNode node, String text) {
    ...
    Property_HasValue_Enum_Editor.setupBasic_ConstantCell(editorCell, node, context);
    Property_HasValue_Enum_Editor.setupLabel_ConstantCell(editorCell, node, context);
  ...
  public EditorCell createConstantCell1(EditorContext context, SNode node, String text) {
    EditorCell_Constant editorCell = new EditorCell_Constant(context, node, text);
    Property_HasValue_Enum_Editor.setupBasic_ConstantCell1(editorCell, node, context);
    Property_HasValue_Enum_Editor.setupLabel_ConstantCell1(editorCell, node, context);
    editorCell.setDefaultText("");
    return editorCell;
  }
  ...
  public EditorCell createValueCellinternal(EditorContext context, SNode node, CellProviderWithRole aProvider) {
    ...
    Property_HasValue_Enum_Editor.setupBasic_ValueCell(editorCell, node, context);
    if (editorCell instanceof EditorCell_Label) {
      Property_HasValue_Enum_Editor.setupLabel_ValueCell((EditorCell_Label)editorCell, node, context);
    }
