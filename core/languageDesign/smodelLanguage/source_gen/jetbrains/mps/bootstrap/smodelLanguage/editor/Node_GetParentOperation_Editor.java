...
public class Node_GetParentOperation_Editor extends DefaultNodeEditor {
  ...
  private static void setupBasic_ReplaceableAliasAndParms_CompCell(EditorCell editorCell, SNode node, EditorContext context) {
    editorCell.putUserObject(EditorCell.CELL_ID, node.getId() + "_1207269848529");
  }
  ...
  public EditorCell createColumnCell(EditorContext context, SNode node) {
    ...
    editorCell.addEditorCell(this.createConstantCell(context, node, "The 'parent' operation"));
    editorCell.addEditorCell(this.createConstantCell1(context, node, ""));
    editorCell.addEditorCell(this.createConstantCell2(context, node, "Returns parent node"));
    editorCell.addEditorCell(this.createConstantCell3(context, node, ""));
    editorCell.addEditorCell(this.createConstantCell4(context, node, "Optional parameters - deprecated. Use the 'ancestor' operation"));
  ...
  public EditorCell createReplaceableAliasAndParms_CompCell(EditorContext context, SNode node) {
    ...
    Node_GetParentOperation_Editor.setupBasic_ReplaceableAliasAndParms_CompCell(editorCell, node, context);
    return editorCell;
  }
