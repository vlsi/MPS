...
public class Node_InsertNewNextSiblingOperation_Editor extends DefaultNodeEditor {
  ...
  private static void setupBasic_ReplaceableAlias_CompCell(EditorCell editorCell, SNode node, EditorContext context) {
    editorCell.putUserObject(EditorCell.CELL_ID, node.getId() + "_1206487125968");
  }

  private static void setupBasic_ConstantCell(EditorCell editorCell, SNode node, EditorContext context) {
    editorCell.putUserObject(EditorCell.CELL_ID, node.getId() + "_1206487163813");
  ...
  private static void setupBasic_ConstantCell1(EditorCell editorCell, SNode node, EditorContext context) {
    editorCell.putUserObject(EditorCell.CELL_ID, node.getId() + "_1206487181236");
    editorCell.setDrawBorder(false);
    editorCell.setFontType(MPSFonts.PLAIN);
  }
  ...
  public EditorCell createRowCell(EditorContext context, SNode node) {
    ...
    Node_InsertNewNextSiblingOperation_Editor.setupBasic_RowCell(editorCell, node, context);
  ...
  public EditorCell createReplaceableAlias_CompCell(EditorContext context, SNode node) {
    ...
    Node_InsertNewNextSiblingOperation_Editor.setupBasic_ReplaceableAlias_CompCell(editorCell, node, context);
    return editorCell;
  }

  public EditorCell createConstantCell(EditorContext context, SNode node, String text) {
    EditorCell_Constant editorCell = new EditorCell_Constant(context, node, text);
    Node_InsertNewNextSiblingOperation_Editor.setupBasic_ConstantCell(editorCell, node, context);
    Node_InsertNewNextSiblingOperation_Editor.setupLabel_ConstantCell(editorCell, node, context);
  ...
  public EditorCell createConstantCell1(EditorContext context, SNode node, String text) {
    EditorCell_Constant editorCell = new EditorCell_Constant(context, node, text);
    Node_InsertNewNextSiblingOperation_Editor.setupBasic_ConstantCell1(editorCell, node, context);
    Node_InsertNewNextSiblingOperation_Editor.setupLabel_ConstantCell1(editorCell, node, context);
    editorCell.setDefaultText("");
    return editorCell;
  }
  ...
  public EditorCell createConceptReferenceCellinternal(EditorContext context, SNode node, CellProviderWithRole aProvider) {
    ...
    if (editorCell instanceof EditorCell_Label) {
      Node_InsertNewNextSiblingOperation_Editor.setupLabel_ConceptReferenceCell((EditorCell_Label)editorCell, node, context);
    }
  ...
  public static class _Inline4 extends AbstractCellProvider {
    ...
    private static void setupBasic_NameCell(EditorCell editorCell, SNode node, EditorContext context) {
      editorCell.putUserObject(EditorCell.CELL_ID, node.getId() + "_1139859127630");
      editorCell.setDrawBorder(false);
    }
