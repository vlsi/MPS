...
public class typeof_Node_GetConceptOperation_InferenceRule implements InferenceRule_Runtime {
  ...
  public void applyRule(final SNode op) {
    ...
    RulesUtil.checkOpParameters_generic(op);
    {
      ...
      TypeChecker.getInstance().getRuntimeSupport().createLessThanInequation(TypeChecker.getInstance().getRuntimeSupport().typeOf(op, "jetbrains.mps.bootstrap.smodelLanguage.helgins", "1210625778386", true), new QuotationClass_92().createNode(), _nodeToCheck_1029348928467, null, "jetbrains.mps.bootstrap.smodelLanguage.helgins", "1210625806639", false, 0, intentionProvider);
    }
              ...
              if (SLinkOperations.getTarget(coercedNode_3, "concept", false) != null) {
                {
                  ...
                  BaseIntentionProvider intentionProvider = null;
                  TypeChecker.getInstance().getRuntimeSupport().createEquation(TypeChecker.getInstance().getRuntimeSupport().typeOf(op, "jetbrains.mps.bootstrap.smodelLanguage.helgins", "1210625860175", true), new QuotationClass_93().createNode(SLinkOperations.getTarget(coercedNode_3, "concept", false)), _nodeToCheck_1029348928467, null, "jetbrains.mps.bootstrap.smodelLanguage.helgins", "1210625868819", intentionProvider);
                }
              }
            }
          }
