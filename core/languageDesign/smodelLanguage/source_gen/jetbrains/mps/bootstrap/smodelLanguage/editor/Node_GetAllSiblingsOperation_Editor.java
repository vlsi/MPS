...
public class Node_GetAllSiblingsOperation_Editor extends DefaultNodeEditor {
  ...
  private static void setupBasic_ReplaceableAlias_CompCell(EditorCell editorCell, SNode node, EditorContext context) {
    editorCell.putUserObject(EditorCell.CELL_ID, node.getId() + "_1206486853576");
  }
  ...
  public EditorCell createReplaceableAlias_CompCell(EditorContext context, SNode node) {
    ...
    Node_GetAllSiblingsOperation_Editor.setupBasic_ReplaceableAlias_CompCell(editorCell, node, context);
    return editorCell;
  }
