...
public class Property_SetOperation_Editor extends DefaultNodeEditor {
  ...
  /* package */AbstractCellProvider myReplaceableAlias_Comp35;
  ...
  private static void setupBasic_ValueCell(EditorCell editorCell, SNode node, EditorContext context) {
    editorCell.putUserObject(EditorCell.CELL_ID, node.getId() + "_1138662130034");
    editorCell.setDrawBorder(false);
  }

  private static void setupBasic_ReplaceableAlias_CompCell(EditorCell editorCell, SNode node, EditorContext context) {
    editorCell.putUserObject(EditorCell.CELL_ID, node.getId() + "_1206487990991");
  }

  private static void setupBasic_ConstantCell(EditorCell editorCell, SNode node, EditorContext context) {
    editorCell.putUserObject(EditorCell.CELL_ID, node.getId() + "_1206487990992");
  ...
  private static void setupBasic_ConstantCell1(EditorCell editorCell, SNode node, EditorContext context) {
    editorCell.putUserObject(EditorCell.CELL_ID, node.getId() + "_1206488004275");
    editorCell.setDrawBorder(false);
    editorCell.setFontType(MPSFonts.PLAIN);
  }
  ...
  public EditorCell createRowCell(EditorContext context, SNode node) {
    ...
    Property_SetOperation_Editor.setupBasic_RowCell(editorCell, node, context);
  ...
  public EditorCell createReplaceableAlias_CompCell(EditorContext context, SNode node) {
    if (this.myReplaceableAlias_Comp35 == null) {
      this.myReplaceableAlias_Comp35 = new ReplaceableAlias_Comp(node);
    }
    EditorCell editorCell = this.myReplaceableAlias_Comp35.createEditorCell(context);
  ...
  public EditorCell createConstantCell(EditorContext context, SNode node, String text) {
    ...
    Property_SetOperation_Editor.setupBasic_ConstantCell(editorCell, node, context);
    Property_SetOperation_Editor.setupLabel_ConstantCell(editorCell, node, context);
  ...
  public EditorCell createConstantCell1(EditorContext context, SNode node, String text) {
    EditorCell_Constant editorCell = new EditorCell_Constant(context, node, text);
    Property_SetOperation_Editor.setupBasic_ConstantCell1(editorCell, node, context);
    Property_SetOperation_Editor.setupLabel_ConstantCell1(editorCell, node, context);
    editorCell.setDefaultText("");
    return editorCell;
  }
