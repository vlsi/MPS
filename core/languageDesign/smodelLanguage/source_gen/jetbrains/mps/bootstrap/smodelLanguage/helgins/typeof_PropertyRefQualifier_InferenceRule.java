    ...
    if (op == null || propAAQ == null) {
      {
        ...
        TypeChecker.getInstance().reportTypeError(nodeToCheck, "not expected here", "jetbrains.mps.bootstrap.smodelLanguage.helgins@33_0", "1216638131766", intentionProvider);
      }
      return;
    }
  }
