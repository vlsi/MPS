    ...
    if (op == null || propAAQ == null) {
      {
        ...
        TypeChecker.getInstance().reportTypeError(nodeToCheck, "not expected here", "jetbrains.mps.bootstrap.smodelLanguage.helgins@3_0", "1217025503008", intentionProvider);
      }
      return;
    }
  }
