    ...
    if (op == null || propAAQ == null) {
      {
        ...
        TypeChecker.getInstance().reportTypeError(nodeToCheck, "not expected here", "jetbrains.mps.bootstrap.smodelLanguage.helgins@3_0", "1221169177108", intentionProvider);
      }
      return;
    }
  }
