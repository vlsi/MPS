  ...
  public void applyRule(final SNode op) {
    ...
    if ((value != null)) {
      ...
      } else
      {
        {
          BaseIntentionProvider intentionProvider = null;
          TypeChecker.getInstance().reportTypeError(op, "unknown property datatype: " + dataType, "jetbrains.mps.bootstrap.smodelLanguage.helgins@3_0", "1221168801353", intentionProvider);
        }
      }
    }
  }
