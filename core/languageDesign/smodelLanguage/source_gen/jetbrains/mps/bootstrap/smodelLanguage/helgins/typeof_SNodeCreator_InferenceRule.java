      ...
      if (SLinkOperations.getTarget(createdType, "concept", false) == null) {
        {
          ...
          TypeChecker.getInstance().reportTypeError(createdType, "concrete node type is expected", "jetbrains.mps.bootstrap.smodelLanguage.helgins@3_0", "1220269577351", intentionProvider);
        }
        return;
      }
