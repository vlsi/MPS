  ...
  public void applyRule(final SNode creator) {
    ...
    if(createdType != null) {
      ...
      if(SLinkOperations.getTarget(creator, "prototypeNode", true) != null) {
        TypeChecker.getInstance().getRuntimeSupport().createLessThanInequation(TypeChecker.getInstance().getRuntimeSupport().typeOf(SLinkOperations.getTarget(creator, "prototypeNode", true), "jetbrains.mps.bootstrap.smodelLanguage.helgins", "1186061742845", true), new QuotationClass_63().createNode(), SLinkOperations.getTarget(creator, "prototypeNode", true), null, "jetbrains.mps.bootstrap.smodelLanguage.helgins", "1181945011354");
      }
