...
public class Link_SetTargetOperation_Editor extends DefaultNodeEditor {
  ...
  private static void setupBasic_RowCell(EditorCell editorCell, SNode node, EditorContext context) {
    editorCell.putUserObject(EditorCell.CELL_ID, node.getId() + "_1140725455180");
    editorCell.setDrawBorder(false);
  }

  private static void setupBasic_ParameterCell(EditorCell editorCell, SNode node, EditorContext context) {
    editorCell.putUserObject(EditorCell.CELL_ID, node.getId() + "_1140725455182");
    editorCell.setDrawBorder(false);
  }

  private static void setupBasic_ConstantCell1(EditorCell editorCell, SNode node, EditorContext context) {
    editorCell.putUserObject(EditorCell.CELL_ID, node.getId() + "_1206487874371");
    editorCell.setDrawBorder(false);
    editorCell.setFontType(MPSFonts.PLAIN);
  }

  private static void setupBasic_ReplaceableAlias_CompCell(EditorCell editorCell, SNode node, EditorContext context) {
    editorCell.putUserObject(EditorCell.CELL_ID, node.getId() + "_1206487883216");
  }

  private static void setupBasic_ConstantCell(EditorCell editorCell, SNode node, EditorContext context) {
    editorCell.putUserObject(EditorCell.CELL_ID, node.getId() + "_1206487883217");
  ...
  public EditorCell createRowCell(EditorContext context, SNode node) {
    ...
    Link_SetTargetOperation_Editor.setupBasic_RowCell(editorCell, node, context);
  ...
  public EditorCell createReplaceableAlias_CompCell(EditorContext context, SNode node) {
    ...
    Link_SetTargetOperation_Editor.setupBasic_ReplaceableAlias_CompCell(editorCell, node, context);
    return editorCell;
  }

  public EditorCell createConstantCell1(EditorContext context, SNode node, String text) {
    EditorCell_Constant editorCell = new EditorCell_Constant(context, node, text);
    Link_SetTargetOperation_Editor.setupBasic_ConstantCell1(editorCell, node, context);
    Link_SetTargetOperation_Editor.setupLabel_ConstantCell1(editorCell, node, context);
  ...
  public EditorCell createConstantCell(EditorContext context, SNode node, String text) {
    EditorCell_Constant editorCell = new EditorCell_Constant(context, node, text);
    Link_SetTargetOperation_Editor.setupBasic_ConstantCell(editorCell, node, context);
    Link_SetTargetOperation_Editor.setupLabel_ConstantCell(editorCell, node, context);
    editorCell.setDefaultText("");
    return editorCell;
  }
  ...
  public EditorCell createParameterCellinternal(EditorContext context, SNode node, CellProviderWithRole aProvider) {
    ...
    Link_SetTargetOperation_Editor.setupBasic_ParameterCell(editorCell, node, context);
    if (editorCell instanceof EditorCell_Label) {
      Link_SetTargetOperation_Editor.setupLabel_ParameterCell((EditorCell_Label)editorCell, node, context);
    }
