...
public class Model_RootsIncludingImportedOperation extends SNodeOperation {
  ...
  public static Model_RootsIncludingImportedOperation newInstance(SModel sm, boolean init) {
    return (Model_RootsIncludingImportedOperation)SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.bootstrap.smodelLanguage.structure.Model_RootsIncludingImportedOperation", sm, GlobalScope.getInstance(), init).getAdapter();
  }
