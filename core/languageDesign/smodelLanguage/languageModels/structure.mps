...
<model name="jetbrains.mps.bootstrap.smodelLanguage.structure">
  ...
  <refactoringHistory>
    <refactoringContext modelVersion="0">
      ...
      <conceptFeatureMap>
        <entry>
          <key featureName="parameter"
               conceptFQName="jetbrains.mps.bootstrap.smodelLanguage.structure.Node_InsertNextSiblingOperation"
               featureKind="CHILD"/>
          <value featureName="insertedNode"
                 conceptFQName="jetbrains.mps.bootstrap.smodelLanguage.structureNode_InsertNextSiblingOperation"
                 featureKind="CHILD"/>
        </entry>
      </conceptFeatureMap>
    </refactoringContext>
  ...
  <node type="jetbrains.mps.bootstrap.structureLanguage.structure.ConceptDeclaration" id="1138411891628">
    ...
    <node role="conceptLinkDeclaration"
          type="jetbrains.mps.bootstrap.structureLanguage.structure.ReferenceConceptLinkDeclaration" id="1144102537873">
  ...
  <node type="jetbrains.mps.bootstrap.structureLanguage.structure.ConceptDeclaration" id="1176461918946">
    ...
    <node role="conceptProperty" type="jetbrains.mps.bootstrap.structureLanguage.structure.StringConceptProperty"
          id="1207356007560">
      <property name="value"
                value="this concept is deprecated because now #&lt;expr&gt; is supported in OperationParm_Concept"/>
      <link role="conceptPropertyDeclaration" targetNodeId="1.1206652974901" resolveInfo="deprecated_next_after_504"/>
    </node>
  </node>
