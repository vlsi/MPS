...
public class Pattern_Editor extends DefaultNodeEditor {
  ...
  private static void setupBasic_ErrorCell(EditorCell editorCell, SNode node, EditorContext context) {
    editorCell.putUserObject(EditorCell.CELL_ID, node.getId() + "_1136720096757");
  ...
  public EditorCell createErrorCell(EditorContext context, SNode node) {
    ...
    Pattern_Editor.setupBasic_ErrorCell(editorCell, node, context);
    Pattern_Editor.setupLabel_ErrorCell(editorCell, node, context);
    return editorCell;
  }
