...
public class AsPattern_Editor extends DefaultNodeEditor {
  ...
  private static void setupBasic_CellModel_AttributedNodeCell(EditorCell editorCell, SNode node, EditorContext context) {
    editorCell.putUserObject(EditorCell.CELL_ID, node.getId() + "_1150461005171");
  ...
  public EditorCell createRowCell(EditorContext context, SNode node) {
    ...
    AsPattern_Editor.setupBasic_RowCell(editorCell, node, context);
  ...
  public EditorCell createConstantCell(EditorContext context, SNode node, String text) {
    ...
    AsPattern_Editor.setupBasic_ConstantCell(editorCell, node, context);
    AsPattern_Editor.setupLabel_ConstantCell(editorCell, node, context);
  ...
  public EditorCell createCellModel_AttributedNodeCell(EditorContext context, SNode node) {
    ...
    AsPattern_Editor.setupBasic_CellModel_AttributedNodeCell(editorCell, node, context);
    return editorCell;
  }
  ...
  public EditorCell createVarNameCellinternal(EditorContext context, SNode node, CellProviderWithRole aProvider) {
    ...
    AsPattern_Editor.setupBasic_VarNameCell(editorCell, node, context);
    if(editorCell instanceof EditorCell_Label) {
      AsPattern_Editor.setupLabel_VarNameCell((EditorCell_Label)editorCell, node, context);
    }
