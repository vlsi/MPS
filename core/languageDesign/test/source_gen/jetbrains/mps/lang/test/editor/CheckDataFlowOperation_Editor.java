...
public class CheckDataFlowOperation_Editor extends DefaultNodeEditor {
  public EditorCell createEditorCell(EditorContext editorContext, SNode node) {
    return this.createConstant_5947_fifzx8pz(editorContext, node);
  }

  private EditorCell createConstant_5947_fifzx8pz(EditorContext editorContext, SNode node) {
    EditorCell_Constant editorCell = new EditorCell_Constant(editorContext, node, "check dataflow");
    editorCell.setCellId("Constant_5947_fifzx8pz");
