...
public class typeof_AssertMatch_InferenceRule extends AbstractInferenceRule_Runtime implements InferenceRule_Runtime {
  ...
  public static class QuotationClass_qwyt5f_a0a0a0a0 {
    ...
    public SNode createNode(final TypeCheckingContext typeCheckingContext) {
      ...
      SNode quotedNode_qwyt5f_a0a0a0a0 = null;
      {
        quotedNode_qwyt5f_a0a0a0a0 = SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.lang.smodel.structure.SNodeType", TypeChecker.getInstance().getRuntimeTypesModel(), GlobalScope.getInstance(), false);
        SNode quotedNode1_qwyt5f_a0a0a0a0 = quotedNode_qwyt5f_a0a0a0a0;
        result = quotedNode1_qwyt5f_a0a0a0a0;
      }
      return result;
    }
  ...
  public static class QuotationClass_qwyt5f_a0a0a1a0 {
    ...
    public SNode createNode(final TypeCheckingContext typeCheckingContext) {
      SNode result = null;
      Set<SNode> _parameterValues_129834374 = new HashSet<SNode>();
      SNode quotedNode_qwyt5f_a0a0a1a0 = null;
      {
        quotedNode_qwyt5f_a0a0a1a0 = SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.lang.smodel.structure.SNodeType", TypeChecker.getInstance().getRuntimeTypesModel(), GlobalScope.getInstance(), false);
        SNode quotedNode1_qwyt5f_a0a0a1a0 = quotedNode_qwyt5f_a0a0a1a0;
        result = quotedNode1_qwyt5f_a0a0a1a0;
      }
      return result;
    }
