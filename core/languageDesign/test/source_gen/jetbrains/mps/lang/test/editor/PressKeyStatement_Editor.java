...
public class PressKeyStatement_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createCollection_3031_0(EditorContext context, SNode node) {
  ...
  private EditorCell createConstant_3031_0(EditorContext context, SNode node, String text) {
  ...
  private EditorCell createConstant_3031_1(EditorContext context, SNode node, String text) {
    EditorCell_Constant editorCell = new EditorCell_Constant(context, node, text);
  ...
  private EditorCell createRefNodeList_3031_0(EditorContext context, SNode node) {
    AbstractCellListHandler handler = new PressKeyStatement_Editor.keyStrokesListHandler_3031_0(node, "keyStrokes", context);
