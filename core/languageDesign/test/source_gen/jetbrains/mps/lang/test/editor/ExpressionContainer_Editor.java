...
public class ExpressionContainer_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createCollection_2925_0(EditorContext context, SNode node) {
    ...
    editorCell.addEditorCell(this.createRefNode_2925_0(context, node));
  ...
  private EditorCell createConstant_2925_1(EditorContext context, SNode node, String text) {
    EditorCell_Constant editorCell = new EditorCell_Constant(context, node, text);
  ...
  private EditorCell createRefNode_2925_0(EditorContext context, SNode node) {
