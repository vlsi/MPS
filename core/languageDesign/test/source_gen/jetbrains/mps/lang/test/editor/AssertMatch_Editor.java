...
public class AssertMatch_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createRefNodeList_9939_0(EditorContext context, SNode node) {
    AbstractCellListHandler handler = new AssertMatch_Editor.beforeListHandler_9939_0(node, "before", context);
  ...
  private EditorCell createRefNodeList_9939_1(EditorContext context, SNode node) {
    AbstractCellListHandler handler = new AssertMatch_Editor.afterListHandler_9939_0(node, "after", context);
    EditorCell_Collection editorCell = handler.createCells(context, new CellLayout_Indent(), false);
