...
public class NodeWarningProperty_Editor extends DefaultNodeEditor {
  public EditorCell createEditorCell(EditorContext editorContext, SNode node) {
    return this.createConstant_7453_fieegnqo(editorContext, node);
  }

  private EditorCell createConstant_7453_fieegnqo(EditorContext editorContext, SNode node) {
    EditorCell_Constant editorCell = new EditorCell_Constant(editorContext, node, "has warning");
    editorCell.setCellId("Constant_7453_fieegnqo");
