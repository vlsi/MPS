...
<model modelUID="r:1222075024891(jetbrains.mps.transformation.test.inputLang.generator.outputLang.template.util)">
  ...
  <import index="3" modelUID="r:1222075024884(jetbrains.mps.transformation.test.inputLang.structure)" version="-1" />
