...
<model modelUID="r:1222075024886(jetbrains.mps.transformation.test.inputLang.generator.outputLang.template.test_generationScripts@generator)">
  ...
  <import index="6" modelUID="r:1222075024901(jetbrains.mps.transformation.test.outputLang.structure)" version="-1" />
  <import index="7" modelUID="r:1222075024891(jetbrains.mps.transformation.test.inputLang.generator.outputLang.template.util)" version="-1" />
