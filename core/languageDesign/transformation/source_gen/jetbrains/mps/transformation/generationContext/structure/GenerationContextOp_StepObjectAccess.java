...
public class GenerationContextOp_StepObjectAccess extends GenerationContextOp_UserObjectAccessBase {
  public static final String concept = "jetbrains.mps.transformation.generationContext.structure.GenerationContextOp_StepObjectAccess";
  ...
  public static GenerationContextOp_StepObjectAccess newInstance(SModel sm, boolean init) {
    return (GenerationContextOp_StepObjectAccess)SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.transformation.generationContext.structure.GenerationContextOp_StepObjectAccess", sm, GlobalScope.getInstance(), init).getAdapter();
  }
