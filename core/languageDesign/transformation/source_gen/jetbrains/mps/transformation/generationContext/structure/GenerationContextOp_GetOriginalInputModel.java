...
public class GenerationContextOp_GetOriginalInputModel extends GenerationContextOp_Base {
  public static final String concept = "jetbrains.mps.transformation.generationContext.structure.GenerationContextOp_GetOriginalInputModel";
  ...
  public static GenerationContextOp_GetOriginalInputModel newInstance(SModel sm, boolean init) {
    return (GenerationContextOp_GetOriginalInputModel)SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.transformation.generationContext.structure.GenerationContextOp_GetOriginalInputModel", sm, GlobalScope.getInstance(), init).getAdapter();
  }
