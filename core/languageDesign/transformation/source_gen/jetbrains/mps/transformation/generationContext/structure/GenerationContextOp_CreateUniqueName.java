...
public class GenerationContextOp_CreateUniqueName extends GenerationContextOp_Base {
  public static final String concept = "jetbrains.mps.transformation.generationContext.structure.GenerationContextOp_CreateUniqueName";
  ...
  public static GenerationContextOp_CreateUniqueName newInstance(SModel sm, boolean init) {
    return (GenerationContextOp_CreateUniqueName)SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.transformation.generationContext.structure.GenerationContextOp_CreateUniqueName", sm, GlobalScope.getInstance(), init).getAdapter();
  }
