...
public class GenerationContextOp_GetCopiedOutputByInput extends GenerationContextOp_Base {
  public static final String concept = "jetbrains.mps.transformation.generationContext.structure.GenerationContextOp_GetCopiedOutputByInput";
  ...
  public static GenerationContextOp_GetCopiedOutputByInput newInstance(SModel sm, boolean init) {
    return (GenerationContextOp_GetCopiedOutputByInput)SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.transformation.generationContext.structure.GenerationContextOp_GetCopiedOutputByInput", sm, GlobalScope.getInstance(), init).getAdapter();
  }
