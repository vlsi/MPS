...
public class GenerationContextOp_ShowInfoMessage extends GenerationContextOp_ShowMessageBase {
  public static final String concept = "jetbrains.mps.transformation.generationContext.structure.GenerationContextOp_ShowInfoMessage";
  ...
  public static GenerationContextOp_ShowInfoMessage newInstance(SModel sm, boolean init) {
    return (GenerationContextOp_ShowInfoMessage)SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.transformation.generationContext.structure.GenerationContextOp_ShowInfoMessage", sm, GlobalScope.getInstance(), init).getAdapter();
  }
