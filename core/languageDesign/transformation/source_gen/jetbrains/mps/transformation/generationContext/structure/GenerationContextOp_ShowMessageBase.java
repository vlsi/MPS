...
public class GenerationContextOp_ShowMessageBase extends GenerationContextOp_Base {
  public static final String concept = "jetbrains.mps.transformation.generationContext.structure.GenerationContextOp_ShowMessageBase";
  ...
  public static GenerationContextOp_ShowMessageBase newInstance(SModel sm, boolean init) {
    return (GenerationContextOp_ShowMessageBase)SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.transformation.generationContext.structure.GenerationContextOp_ShowMessageBase", sm, GlobalScope.getInstance(), init).getAdapter();
  }
