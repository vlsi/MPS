...
<model modelUID="r:1222075024106(jetbrains.mps.transformation.TLBase.generator.baseLanguage.template.util)">
  ...
  <import index="5" modelUID="r:1222075024104(jetbrains.mps.transformation.TLBase.structure)" version="1" />
</model>
