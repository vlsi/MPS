...
<model modelUID="r:00000000-0000-4000-0000-011c895902e0(jetbrains.mps.transformation.TLBase.actions)">
  ...
  <import index="3" modelUID="r:00000000-0000-4000-0000-011c89590301(jetbrains.mps.lang.smodel.structure)" version="3" />
  ...
  <node type="jetbrains.mps.lang.actions.structure.NodeFactories" id="1198265022560">
    ...
    <node role="nodeFactory" type="jetbrains.mps.lang.actions.structure.NodeFactory" id="1205663677152">
      ...
      <node role="setupFunction" type="jetbrains.mps.lang.actions.structure.NodeSetupFunction" id="1205663677153">
        <node role="body" type="jetbrains.mps.baseLanguage.structure.StatementList" id="1205663677154">
          <node role="statement" type="jetbrains.mps.baseLanguage.structure.LocalVariableDeclarationStatement" id="1205663736295">
            <node role="localVariableDeclaration" type="jetbrains.mps.baseLanguage.structure.LocalVariableDeclaration" id="1205663736296">
              ...
              <node role="type" type="jetbrains.mps.lang.smodel.structure.SNodeType" id="1205663736297">
              ...
              <node role="initializer" type="jetbrains.mps.baseLanguage.structure.DotExpression" id="1205663736298">
                <node role="operation" type="jetbrains.mps.lang.smodel.structure.Node_GetAncestorOperation" id="1205663736299">
                  <node role="parameter" type="jetbrains.mps.lang.smodel.structure.OperationParm_Concept" id="1205663736300">
                    <node role="conceptArgument" type="jetbrains.mps.lang.smodel.structure.RefConcept_Reference" id="1207674649459">
                      <link role="conceptDeclaration" targetNodeId="5.1137021947720" resolveInfo="ConceptFunction" />
                    </node>
                  </node>
                  <node role="parameter" type="jetbrains.mps.lang.smodel.structure.OperationParm_Inclusion" id="1205663736301" />
                </node>
                <node role="operand" type="jetbrains.mps.lang.actions.structure.NodeSetupFunction_EnclosingNode" id="1205663736302" />
              </node>
            </node>
          </node>
              ...
              <node role="statement" type="jetbrains.mps.baseLanguage.structure.ExpressionStatement" id="1205663800271">
                <node role="expression" type="jetbrains.mps.baseLanguage.structure.DotExpression" id="1205663815117">
                  <node role="operand" type="jetbrains.mps.baseLanguage.structure.DotExpression" id="1205663800654">
                    <node role="operand" type="jetbrains.mps.lang.actions.structure.NodeSetupFunction_NewNode" id="1205663800272" />
                    <node role="operation" type="jetbrains.mps.lang.smodel.structure.SLinkAccess" id="1205663814728">
                      <link role="link" targetNodeId="1.1200913810085" />
                    </node>
                  </node>
                  <node role="operation" type="jetbrains.mps.lang.smodel.structure.Link_SetNewChildOperation" id="1205663817076">
            ...
            <node role="condition" type="jetbrains.mps.baseLanguage.structure.AndExpression" id="1205663748380">
              <node role="rightExpression" type="jetbrains.mps.baseLanguage.structure.DotExpression" id="1205663759580">
                <node role="operand" type="jetbrains.mps.baseLanguage.structure.DotExpression" id="1205663750298">
                  ...
                  <node role="operation" type="jetbrains.mps.lang.smodel.structure.SConceptLinkAccess" id="1205663753412">
                ...
                <node role="operation" type="jetbrains.mps.baseLanguage.ext.collections.lang.structure.ContainsOperation" id="1205663768925">
                  <node role="argument" type="jetbrains.mps.lang.smodel.structure.ConceptRefExpression" id="1205663780336">
