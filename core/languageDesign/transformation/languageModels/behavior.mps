...
<model name="jetbrains.mps.transformation.TLBase.behavior">
  ...
  <import index="2" modelUID="jetbrains.mps.transformation.TLBase.behavior" version="-1" />
  ...
  <node type="jetbrains.mps.bootstrap.constraintsLanguage.structure.ConceptBehavior" id="1213877491628">
    ...
    <node role="method" type="jetbrains.mps.bootstrap.constraintsLanguage.structure.ConceptMethodDeclaration" id="1213877491629">
      <property name="name" value="getPresentation" />
      <link role="overriddenMethod" targetNodeId="6v.1213877396640" resolveInfo="getPresentation" />
      <node role="body" type="jetbrains.mps.baseLanguage.structure.StatementList" id="1213877491630">
        <node role="statement" type="jetbrains.mps.baseLanguage.structure.IfStatement" id="1213877491631">
          <node role="condition" type="jetbrains.mps.baseLanguage.structure.EqualsExpression" id="1213877491632">
            ...
            <node role="leftExpression" type="jetbrains.mps.bootstrap.constraintsLanguage.structure.ThisNodeExpression" id="1213877491634" />
          </node>
            ...
            <node role="rightExpression" type="jetbrains.mps.baseLanguage.structure.PlusExpression" id="1213877491641">
              ...
              <node role="leftExpression" type="jetbrains.mps.baseLanguage.structure.DotExpression" id="1213877491643">
                <node role="operand" type="jetbrains.mps.baseLanguage.structure.DotExpression" id="1213877491644">
                  <node role="operand" type="jetbrains.mps.bootstrap.constraintsLanguage.structure.ThisNodeExpression" id="1213877491645" />
                  <node role="operation" type="jetbrains.mps.bootstrap.smodelLanguage.structure.SLinkAccess" id="1213877491646">
                    <link role="link" targetNodeId="1.1198101462928" />
                  </node>
                </node>
                <node role="operation" type="jetbrains.mps.bootstrap.smodelLanguage.structure.Node_ConceptMethodCall" id="1213877491647">
    ...
    <node role="constructor" type="jetbrains.mps.bootstrap.constraintsLanguage.structure.ConceptConstructorDeclaration" id="1213877491649">
