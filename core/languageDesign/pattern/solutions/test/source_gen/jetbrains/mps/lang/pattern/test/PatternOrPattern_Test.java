  ...
  public static class TestBody extends BaseTestBody {
    ...
    public static class Pattern_qttyfe_a0a1a1a extends GeneratedMatchingPattern implements IMatchingPattern {
      ...
      public boolean match(SNode nodeToMatch) {
        {
          SNode nodeToMatch_7ozj7q_a0;
          nodeToMatch_7ozj7q_a0 = nodeToMatch;
          if (!("jetbrains.mps.baseLanguage.structure.IfStatement".equals(nodeToMatch_7ozj7q_a0.getConceptFqName()))) {
            return false;
          }
          {
            ...
            {
              SNode childVar_a0a_8 = nodeToMatch_7ozj7q_a0.getChildren(childRole_7ozj7q_).get(0);
              {
                SNode nodeToMatch_7ozj7q_a0a;
                nodeToMatch_7ozj7q_a0a = childVar_a0a_8;
                if (!("jetbrains.mps.baseLanguage.structure.StatementList".equals(nodeToMatch_7ozj7q_a0a.getConceptFqName()))) {
                  return false;
                }
                {
                  String childRole_7ozj7q__0 = "statement";
                  if (nodeToMatch_7ozj7q_a0a.getChildCount(childRole_7ozj7q__0) != 1) {
                    return false;
                  }
                  {
                    SNode childVar_a0a0_1 = nodeToMatch_7ozj7q_a0a.getChildren(childRole_7ozj7q__0).get(0);
                    this.patternVar_body = childVar_a0a0_1;
                  }
                }
              }
            }
          }
          {
            ...
            if (nodeToMatch_7ozj7q_a0.getChildCount(childRole_7ozj7q__1) != 1) {
              return false;
            }
            {
              SNode childVar_a0a_9 = nodeToMatch_7ozj7q_a0.getChildren(childRole_7ozj7q__1).get(0);
              {
                SNode nodeToMatch_7ozj7q_a0a_0;
                nodeToMatch_7ozj7q_a0a_0 = childVar_a0a_9;
                {
      ...
      public class Pattern_qttyfe_a0a0a2a2a1a1a1a1a1a2a0a0a0a1a1a extends GeneratedMatchingPattern implements IMatchingPattern {
        ...
        public boolean match(SNode nodeToMatch) {
          {
            SNode nodeToMatch_7ozj7q_a0a0a;
            nodeToMatch_7ozj7q_a0a0a = nodeToMatch;
            if (!("jetbrains.mps.baseLanguage.structure.NotEqualsExpression".equals(nodeToMatch_7ozj7q_a0a0a.getConceptFqName()))) {
              return false;
            }
            {
              String childRole_7ozj7q__2 = "leftExpression";
              if (nodeToMatch_7ozj7q_a0a0a.getChildCount(childRole_7ozj7q__2) != 1) {
                return false;
              }
              {
                SNode childVar_a0a0a0 = nodeToMatch_7ozj7q_a0a0a.getChildren(childRole_7ozj7q__2).get(0);
                {
                  SNode nodeToMatch_7ozj7q_a0a0a0;
                  nodeToMatch_7ozj7q_a0a0a0 = childVar_a0a0a0;
            ...
            }
            {
              ...
              if (nodeToMatch_7ozj7q_a0a0a.getChildCount(childRole_7ozj7q__3) != 1) {
                return false;
              }
              {
                SNode childVar_a0a0a0_0 = nodeToMatch_7ozj7q_a0a0a.getChildren(childRole_7ozj7q__3).get(0);
                {
                  SNode nodeToMatch_7ozj7q_a0a0a0_0;
                  nodeToMatch_7ozj7q_a0a0a0_0 = childVar_a0a0a0_0;
      ...
      public class Pattern_qttyfe_a0a0a3a2a1a1a1a1a1a2a0a0a0a1a1a extends GeneratedMatchingPattern implements IMatchingPattern {
        ...
        public boolean match(SNode nodeToMatch) {
          {
            SNode nodeToMatch_7ozj7q_a1a0a;
            nodeToMatch_7ozj7q_a1a0a = nodeToMatch;
            if (!("jetbrains.mps.baseLanguage.structure.NotEqualsExpression".equals(nodeToMatch_7ozj7q_a1a0a.getConceptFqName()))) {
              return false;
            }
            {
              String childRole_7ozj7q__4 = "leftExpression";
              if (nodeToMatch_7ozj7q_a1a0a.getChildCount(childRole_7ozj7q__4) != 1) {
                return false;
              }
              {
                SNode childVar_a0b0a0 = nodeToMatch_7ozj7q_a1a0a.getChildren(childRole_7ozj7q__4).get(0);
                {
                  SNode nodeToMatch_7ozj7q_a0b0a0;
                  nodeToMatch_7ozj7q_a0b0a0 = childVar_a0b0a0;
                  if (!("jetbrains.mps.baseLanguage.structure.NullLiteral".equals(nodeToMatch_7ozj7q_a0b0a0.getConceptFqName()))) {
                    return false;
                  }
                }
              }
            }
            {
              ...
              if (nodeToMatch_7ozj7q_a1a0a.getChildCount(childRole_7ozj7q__5) != 1) {
                return false;
              }
              {
                SNode childVar_a0b0a0_0 = nodeToMatch_7ozj7q_a1a0a.getChildren(childRole_7ozj7q__5).get(0);
                {
                  SNode nodeToMatch_7ozj7q_a0b0a0_0;
                  nodeToMatch_7ozj7q_a0b0a0_0 = childVar_a0b0a0_0;
