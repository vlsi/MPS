...
public class PatternOrPattern_Test extends BaseTransformationTest {
  ...
  public void testMethod() throws Throwable {
    this.initTest("${mps_home}/workbench/workbench.mpr", "r:ef0e231b-e6bd-436f-9003-b53de4081716(jetbrains.mps.lang.pattern.test)");
        ...
        SNode quotedNode_6 = null;
        {
          ...
          }
          {
            ...
            }
            {
              ...
              quotedNode1_12.addReference(SReference.create("classifier", quotedNode1_12, SModelReference.fromString("f:java_stub#java.io(java.io@java_stub)"), SNodeId.fromString("~BufferedOutputStream")));
      ...
      public boolean match(SNode nodeToMatch) {
        {
          ...
          }
          {
            ...
            {
              SNode childVar_7ozj7q_a0a_0 = nodeToMatch_7ozj7q_a0.getChildren(childRole_7ozj7q__1).get(0);
              {
        ...
        public boolean match(SNode nodeToMatch) {
          {
            ...
            }
            {
              ...
              {
                SNode childVar_7ozj7q_a0b0a0 = nodeToMatch_7ozj7q_a1a0a.getChildren(childRole_7ozj7q__4).get(0);
                {
    ...
    public static class QuotationClass_qttyfe_a1a0g0b0 {
      ...
      public SNode createNode() {
        ...
        SNode quotedNode_1 = null;
        {
          ...
          quotedNode1_2.addReference(SReference.create("classifier", quotedNode1_2, SModelReference.fromString("f:java_stub#java.io(java.io@java_stub)"), SNodeId.fromString("~BufferedOutputStream")));
