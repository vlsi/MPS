...
public class PatternTest_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createCollection_kasahx_a(EditorContext editorContext, SNode node) {
    ...
    editorCell.addEditorCell(this.createRefNodeList_kasahx_i0(editorContext, node));
    return editorCell;
  }
  ...
  private EditorCell createRefNodeList_kasahx_i0(EditorContext editorContext, SNode node) {
    AbstractCellListHandler handler = new PatternTest_Editor.valuesListHandler_kasahx_i0(node, "values", editorContext);
  ...
  private static class valuesListHandler_kasahx_i0 extends RefNodeListHandler {
    public valuesListHandler_kasahx_i0(SNode ownerNode, String childRole, EditorContext context) {
