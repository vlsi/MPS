...
<model modelUID="r:d2b7cfed-de53-404b-aa28-8afd6d7632e0(jetbrains.mps.lang.pattern.testLang.behavior)">
  ...
  <node type="jetbrains.mps.lang.behavior.structure.ConceptBehavior" id="394224946578869061">
    <link role="concept" targetNodeId="1.8707387027762047752" resolveInfo="PatternTest" />
    <node role="method" type="jetbrains.mps.lang.behavior.structure.ConceptMethodDeclaration" id="394224946578869064">
      <property name="name" value="getPatternTestName" />
      <node role="visibility" type="jetbrains.mps.baseLanguage.structure.PublicVisibility:3" id="394224946578869065" />
      <node role="body" type="jetbrains.mps.baseLanguage.structure.StatementList:3" id="394224946578869067">
        <node role="statement:3" type="jetbrains.mps.baseLanguage.structure.ExpressionStatement:3" id="394224946578905096">
          <node role="expression:3" type="jetbrains.mps.baseLanguage.structure.PlusExpression:3" id="394224946578905660">
            <node role="rightExpression:3" type="jetbrains.mps.baseLanguage.structure.StringLiteral:3" id="394224946578905663">
              <property name="value:3" value="_Test" />
            </node>
            <node role="leftExpression:3" type="jetbrains.mps.baseLanguage.structure.PlusExpression:3" id="394224946578905098">
              <node role="leftExpression:3" type="jetbrains.mps.baseLanguage.structure.StringLiteral:3" id="394224946578905097">
                <property name="value:3" value="Pattern" />
              </node>
              <node role="rightExpression:3" type="jetbrains.mps.baseLanguage.structure.DotExpression:3" id="394224946578905102">
                <node role="operand:3" type="jetbrains.mps.lang.behavior.structure.ThisNodeExpression" id="394224946578905101" />
                <node role="operation:3" type="jetbrains.mps.lang.smodel.structure.SPropertyAccess:16" id="394224946578905659">
      ...
      <node role="returnType" type="jetbrains.mps.baseLanguage.structure.StringType:3" id="394224946578878741" />
    </node>
    <node role="constructor" type="jetbrains.mps.lang.behavior.structure.ConceptConstructorDeclaration" id="394224946578869062">
      <node role="body" type="jetbrains.mps.baseLanguage.structure.StatementList:3" id="394224946578869063" />
    </node>
  </node>
</model>
