...
<model modelUID="r:00000000-0000-4000-0000-011c89590353(jetbrains.mps.lang.intentions.structure)">
      ...
      <conceptFeatureMap>
        <entry>
          <key featureName="ConceptFunctionParameter_node"
               conceptFQName="jetbrains.mps.bootstrap.intentionsLanguage.structure.ConceptFunctionParameter_node"
               featureKind="CONCEPT"/>
          <value featureName="ConceptFunctionParameter_node"
                 conceptFQName="jetbrains.mps.lang.intentions.structure.ConceptFunctionParameter_node"
                 featureKind="CONCEPT"/>
        </entry>
        <entry>
          <key featureName="DescriptionBlock"
               conceptFQName="jetbrains.mps.bootstrap.intentionsLanguage.structure.DescriptionBlock"
               featureKind="CONCEPT"/>
          <value featureName="DescriptionBlock" conceptFQName="jetbrains.mps.lang.intentions.structure.DescriptionBlock"
                 featureKind="CONCEPT"/>
        </entry>
        <entry>
          <key featureName="ExecuteBlock"
               conceptFQName="jetbrains.mps.bootstrap.intentionsLanguage.structure.ExecuteBlock" featureKind="CONCEPT"/>
          <value featureName="ExecuteBlock" conceptFQName="jetbrains.mps.lang.intentions.structure.ExecuteBlock"
                 featureKind="CONCEPT"/>
        </entry>
        <entry>
          <key featureName="IntentionDeclaration"
               conceptFQName="jetbrains.mps.bootstrap.intentionsLanguage.structure.IntentionDeclaration"
               featureKind="CONCEPT"/>
          <value featureName="IntentionDeclaration"
                 conceptFQName="jetbrains.mps.lang.intentions.structure.IntentionDeclaration" featureKind="CONCEPT"/>
        </entry>
        <entry>
          <key featureName="IsApplicableBlock"
               conceptFQName="jetbrains.mps.bootstrap.intentionsLanguage.structure.IsApplicableBlock"
               featureKind="CONCEPT"/>
          <value featureName="IsApplicableBlock"
                 conceptFQName="jetbrains.mps.lang.intentions.structure.IsApplicableBlock" featureKind="CONCEPT"/>
        </entry>
      </conceptFeatureMap>
    </refactoringContext>
  </refactoringHistory>
  ...
  <import index="2" modelUID="r:00000000-0000-4000-0000-011c895902bc(jetbrains.mps.lang.sharedConcepts.structure)"
          version="0"/>
  <import index="3" modelUID="r:00000000-0000-4000-0000-011c895902ca(jetbrains.mps.baseLanguage.structure)"
          version="1"/>
  <import index="5" modelUID="r:00000000-0000-4000-0000-011c89590292(jetbrains.mps.lang.structure.structure)"
          version="0"/>
  ...
  <node type="jetbrains.mps.lang.structure.structure.ConceptDeclaration" id="1192794782375">
    ...
    <node role="conceptLink" type="jetbrains.mps.lang.structure.structure.AggregationConceptLink" id="1192796187416">
      ...
      <node role="target" type="jetbrains.mps.baseLanguage.strings.structure.StringType" id="1225192247394"/>
    </node>
