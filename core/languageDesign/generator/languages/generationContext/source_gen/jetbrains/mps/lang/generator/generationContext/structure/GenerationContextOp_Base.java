...
public class GenerationContextOp_Base extends BaseConcept implements IOperation {
  ...
  public int get_$attributesCount() {
    return this.getChildCount(GenerationContextOp_Base._$ATTRIBUTE);
  }

  public Iterator<Attribute> _$attributes() {
    return this.children(Attribute.class, GenerationContextOp_Base._$ATTRIBUTE);
  }

  public List<Attribute> get_$attributes() {
    return this.getChildren(Attribute.class, GenerationContextOp_Base._$ATTRIBUTE);
  }

  public void add_$attribute(Attribute node) {
    this.addChild(GenerationContextOp_Base._$ATTRIBUTE, node);
  }

  public void insert_$attribute(Attribute prev, Attribute node) {
    this.insertChild(prev, GenerationContextOp_Base._$ATTRIBUTE, node);
  }
