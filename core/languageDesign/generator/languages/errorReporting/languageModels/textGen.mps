...
<model modelUID="r:e99b0478-397a-402b-a078-57c984a0eca3(jetbrains.mps.transformation.test.errorReporting.textGen)">
  ...
  <import index="1" modelUID="r:13099be6-e9be-4c1b-a5cd-d0d83a6c9f0a(jetbrains.mps.transformation.test.errorReporting.structure)" version="-1" />
  <node type="jetbrains.mps.lang.textGen.structure.ConceptTextGenDeclaration:11" id="7287346816896128678">
    <link role="conceptDeclaration:11" targetNodeId="1.7287346816896104019" resolveInfo="ErrorReportingRoot" />
    <node role="textGenBlock:11" type="jetbrains.mps.lang.textGen.structure.GenerateTextDeclaration:11" id="7287346816896128679">
      <node role="body:11" type="jetbrains.mps.baseLanguage.structure.StatementList:3" id="7287346816896128680">
        <node role="statement:3" type="jetbrains.mps.lang.textGen.structure.AppendOperation:11" id="7287346816896135357">
          <node role="part:11" type="jetbrains.mps.lang.textGen.structure.ConstantStringAppendPart:11" id="7287346816896135359">
            <property name="value:11" value="error reporting root {" />
          </node>
        </node>
        <node role="statement:3" type="jetbrains.mps.lang.textGen.structure.AppendOperation:11" id="7287346816896135365">
          <node role="part:11" type="jetbrains.mps.lang.textGen.structure.NewLineAppendPart:11" id="7287346816896135367" />
        </node>
        <node role="statement:3" type="jetbrains.mps.lang.textGen.structure.AppendOperation:11" id="7287346816896135370">
          <node role="part:11" type="jetbrains.mps.lang.textGen.structure.ConstantStringAppendPart:11" id="7287346816896135372">
