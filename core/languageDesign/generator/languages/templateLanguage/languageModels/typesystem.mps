...
<model modelUID="r:00000000-0000-4000-0000-011c895902e4(jetbrains.mps.lang.generator.typesystem)">
  ...
  <node type="jetbrains.mps.lang.typesystem.structure.InferenceRule:3" id="1178562976744">
    ...
    <node role="body:3" type="jetbrains.mps.baseLanguage.structure.StatementList:3" id="1178562976745">
      <node role="statement:3" type="jetbrains.mps.baseLanguage.structure.LocalVariableDeclarationStatement:3" id="1178721749744">
        <node role="localVariableDeclaration:3" type="jetbrains.mps.baseLanguage.structure.LocalVariableDeclaration:3" id="1178721749745">
          <property name="name:3" value="rule" />
          <node role="type:3" type="jetbrains.mps.lang.smodel.structure.SNodeType:16" id="1178721749746">
            <link role="concept:16" targetNodeId="3.1167169308231:2" />
          </node>
          <node role="initializer:3" type="jetbrains.mps.baseLanguage.structure.DotExpression:3" id="1204227881089">
            <node role="operand:3" type="jetbrains.mps.lang.typesystem.structure.ApplicableNodeReference:3" id="1178721708334">
              <link role="applicableNode:3" targetNodeId="1178562976719" resolveInfo="templateReference" />
            </node>
            <node role="operation:3" type="jetbrains.mps.lang.smodel.structure.Node_GetAncestorOperation:16" id="1178721716014">
              <node role="parameter:16" type="jetbrains.mps.lang.smodel.structure.OperationParm_Concept:16" id="1178721719658">
                <node role="conceptArgument:16" type="jetbrains.mps.lang.smodel.structure.RefConcept_Reference:16" id="1207675648303">
      ...
      <node role="statement:3" type="jetbrains.mps.baseLanguage.structure.IfStatement:3" id="1178721780457">
        <node role="ifTrue:3" type="jetbrains.mps.baseLanguage.structure.StatementList:3" id="1178721780458">
          <node role="statement:3" type="jetbrains.mps.baseLanguage.structure.LocalVariableDeclarationStatement:3" id="1183153405890">
            <node role="localVariableDeclaration:3" type="jetbrains.mps.baseLanguage.structure.LocalVariableDeclaration:3" id="1183153405891">
              <property name="name:3" value="templateApplicableConcept" />
              <node role="type:3" type="jetbrains.mps.lang.smodel.structure.SConceptType:16" id="1183153405892" />
              <node role="initializer:3" type="jetbrains.mps.baseLanguage.structure.DotExpression:3" id="1204227957814">
                <node role="operand:3" type="jetbrains.mps.baseLanguage.structure.DotExpression:3" id="1204227934531">
                  <node role="operand:3" type="jetbrains.mps.lang.typesystem.structure.ApplicableNodeReference:3" id="1183153408091">
                    <link role="applicableNode:3" targetNodeId="1178562976719" resolveInfo="templateReference" />
                  </node>
                  <node role="operation:3" type="jetbrains.mps.lang.smodel.structure.SLinkAccess:16" id="1183153405896">
                    <link role="link:16" targetNodeId="3.1168559393589:2" />
                  </node>
                </node>
                <node role="operation:3" type="jetbrains.mps.lang.smodel.structure.SLinkAccess:16" id="1183153405897">
                  <link role="link:16" targetNodeId="3.1168285871518:2" />
                </node>
              </node>
            </node>
          </node>
          <node role="statement:3" type="jetbrains.mps.baseLanguage.structure.LocalVariableDeclarationStatement:3" id="1178721808199">
            <node role="localVariableDeclaration:3" type="jetbrains.mps.baseLanguage.structure.LocalVariableDeclaration:3" id="1178721808200">
              <property name="name:3" value="ruleApplicableConcept" />
              <node role="type:3" type="jetbrains.mps.lang.smodel.structure.SConceptType:16" id="1183153284041" />
              <node role="initializer:3" type="jetbrains.mps.baseLanguage.structure.DotExpression:3" id="1204227919706">
                <node role="operand:3" type="jetbrains.mps.baseLanguage.structure.LocalVariableReference:3" id="1178721793216">
                  <link role="variableDeclaration:3" targetNodeId="1178721749745" resolveInfo="rule" />
                </node>
                <node role="operation:3" type="jetbrains.mps.lang.smodel.structure.SLinkAccess:16" id="1178721802505">
                  <link role="link:16" targetNodeId="3.1167169349424:2" />
                </node>
              </node>
            </node>
          </node>
          <node role="statement:3" type="jetbrains.mps.baseLanguage.structure.IfStatement:3" id="1178721817697">
            <node role="ifTrue:3" type="jetbrains.mps.baseLanguage.structure.StatementList:3" id="1178721817698">
              <node role="statement:3" type="jetbrains.mps.baseLanguage.structure.IfStatement:3" id="1183153339133">
                <node role="ifTrue:3" type="jetbrains.mps.baseLanguage.structure.StatementList:3" id="1183153339134">
                  <node role="statement:3" type="jetbrains.mps.lang.typesystem.structure.ReportErrorStatement:3" id="1183153489205">
                    <node role="errorString:3" type="jetbrains.mps.baseLanguage.structure.PlusExpression:3" id="1183153701928">
                      <node role="rightExpression:3" type="jetbrains.mps.baseLanguage.structure.StringLiteral:3" id="1183153712857">
                        <property name="value:3" value="'" />
                      </node>
                      <node role="leftExpression:3" type="jetbrains.mps.baseLanguage.structure.PlusExpression:3" id="1183153489206">
                        <node role="leftExpression:3" type="jetbrains.mps.baseLanguage.structure.StringLiteral:3" id="1183153489208">
                          <property name="value:3" value="template is not applicable to the rule concept '" />
                        </node>
                        <node role="rightExpression:3" type="jetbrains.mps.baseLanguage.structure.DotExpression:3" id="1204227833280">
                          <node role="operand:3" type="jetbrains.mps.baseLanguage.structure.LocalVariableReference:3" id="1183153495352">
                            <link role="variableDeclaration:3" targetNodeId="1178721808200" resolveInfo="ruleApplicableConcept" />
                          </node>
                          <node role="operation:3" type="jetbrains.mps.lang.smodel.structure.SPropertyAccess:16" id="1183153699884">
                            <link role="property:16" targetNodeId="5.1169194664001:0" />
                          </node>
                        </node>
                      </node>
                    </node>
                    <node role="nodeToReport:3" type="jetbrains.mps.lang.typesystem.structure.ApplicableNodeReference:3" id="1183153499531">
                      <link role="applicableNode:3" targetNodeId="1178562976719" resolveInfo="templateReference" />
                    </node>
                  </node>
                </node>
                <node role="condition:3" type="jetbrains.mps.baseLanguage.structure.NotExpression:3" id="1183153477564">
                  <node role="expression:3" type="jetbrains.mps.baseLanguage.structure.DotExpression:3" id="1204227919329">
                    <node role="operand:3" type="jetbrains.mps.baseLanguage.structure.LocalVariableReference:3" id="1183153477569">
                      <link role="variableDeclaration:3" targetNodeId="1178721808200" resolveInfo="ruleApplicableConcept" />
                    </node>
                    <node role="operation:3" type="jetbrains.mps.lang.smodel.structure.Concept_IsSubConceptOfOperation:16" id="1183153477566">
                      <node role="conceptArgument:16" type="jetbrains.mps.lang.smodel.structure.PoundExpression:16" id="1207675646020">
                        <node role="expression:16" type="jetbrains.mps.baseLanguage.structure.LocalVariableReference:3" id="1183153477568">
                          <link role="variableDeclaration:3" targetNodeId="1183153405891" resolveInfo="templateApplicableConcept" />
                        </node>
                      </node>
                    </node>
                  </node>
            ...
            <node role="condition:3" type="jetbrains.mps.baseLanguage.structure.AndExpression:3" id="1183153423895">
              <node role="rightExpression:3" type="jetbrains.mps.baseLanguage.structure.NotEqualsExpression:3" id="1183153429351">
                <node role="rightExpression:3" type="jetbrains.mps.baseLanguage.structure.NullLiteral:3" id="1183153431063" />
                <node role="leftExpression:3" type="jetbrains.mps.baseLanguage.structure.LocalVariableReference:3" id="1183153427529">
                  <link role="variableDeclaration:3" targetNodeId="1183153405891" resolveInfo="templateApplicableConcept" />
                </node>
              </node>
              <node role="leftExpression:3" type="jetbrains.mps.baseLanguage.structure.NotEqualsExpression:3" id="1178721993099">
                <node role="leftExpression:3" type="jetbrains.mps.baseLanguage.structure.LocalVariableReference:3" id="1178721993097">
                  <link role="variableDeclaration:3" targetNodeId="1178721808200" resolveInfo="ruleApplicableConcept" />
                </node>
                <node role="rightExpression:3" type="jetbrains.mps.baseLanguage.structure.NullLiteral:3" id="1178721993098" />
              </node>
            </node>
          </node>
        </node>
        <node role="condition:3" type="jetbrains.mps.baseLanguage.structure.NotEqualsExpression:3" id="1178721788032">
          <node role="rightExpression:3" type="jetbrains.mps.baseLanguage.structure.NullLiteral:3" id="1178721790116" />
          <node role="leftExpression:3" type="jetbrains.mps.baseLanguage.structure.LocalVariableReference:3" id="1178721785479">
            <link role="variableDeclaration:3" targetNodeId="1178721749745" resolveInfo="rule" />
          </node>
        </node>
      </node>
    ...
    <node role="applicableNode:3" type="jetbrains.mps.lang.typesystem.structure.ConceptReference:3" id="1178562976719">
      ...
      <link role="concept:3" targetNodeId="3.1168559333462:2" />
    </node>
  </node>
  ...
  <node type="jetbrains.mps.lang.typesystem.structure.InferenceRule:3" id="1200921388036">
    ...
    <property name="package:3" value="rule" />
  ...
  <node type="jetbrains.mps.lang.typesystem.structure.InferenceRule:3" id="1221153432505">
    ...
    <property name="package:3" value="functionParameter" />
  ...
  <node type="jetbrains.mps.lang.typesystem.structure.NonTypesystemRule:3" id="1226664040798">
    ...
    <node role="body:3" type="jetbrains.mps.baseLanguage.structure.StatementList:3" id="1226664040799">
      <node role="statement:3" type="jetbrains.mps.baseLanguage.structure.LocalVariableDeclarationStatement:3" id="1226664181604">
        <node role="localVariableDeclaration:3" type="jetbrains.mps.baseLanguage.structure.LocalVariableDeclaration:3" id="1226664181605">
          <property name="name:3" value="templateApplicableConcept" />
          <property name="isFinal:3" value="true" />
          <node role="type:3" type="jetbrains.mps.lang.smodel.structure.SNodeType:16" id="1226664181606">
            <link role="concept:16" targetNodeId="8.1169125787135:0" resolveInfo="AbstractConceptDeclaration" />
          </node>
          <node role="initializer:3" type="jetbrains.mps.baseLanguage.structure.DotExpression:3" id="1226664181607">
            <node role="operand:3" type="jetbrains.mps.baseLanguage.structure.DotExpression:3" id="1226664181608">
              <node role="operand:3" type="jetbrains.mps.lang.typesystem.structure.ApplicableNodeReference:3" id="1226664181609">
                <link role="applicableNode:3" targetNodeId="1226664079052" resolveInfo="weaveEach" />
              </node>
              <node role="operation:3" type="jetbrains.mps.lang.smodel.structure.SLinkAccess:16" id="1226664181610">
                <link role="link:16" targetNodeId="3.1169569853122:2" />
              </node>
            </node>
            <node role="operation:3" type="jetbrains.mps.lang.smodel.structure.SLinkAccess:16" id="1226664181611">
              <link role="link:16" targetNodeId="3.1168285871518:2" />
            </node>
          </node>
        </node>
      </node>
      <node role="statement:3" type="jetbrains.mps.baseLanguage.structure.IfStatement:3" id="1226664181612">
        <node role="ifTrue:3" type="jetbrains.mps.baseLanguage.structure.StatementList:3" id="1226664181613">
          <node role="statement:3" type="jetbrains.mps.baseLanguage.structure.ReturnStatement:3" id="1226664181614" />
        </node>
        <node role="condition:3" type="jetbrains.mps.baseLanguage.structure.EqualsExpression:3" id="1226664181615">
          <node role="rightExpression:3" type="jetbrains.mps.baseLanguage.structure.NullLiteral:3" id="1226664181616" />
          <node role="leftExpression:3" type="jetbrains.mps.baseLanguage.structure.LocalVariableReference:3" id="1226664181617">
            <link role="variableDeclaration:3" targetNodeId="1226664181605" resolveInfo="templateApplicableConcept" />
          </node>
        </node>
      </node>
      <node role="statement:3" type="jetbrains.mps.baseLanguage.structure.LocalVariableDeclarationStatement:3" id="1226664120468">
        <node role="localVariableDeclaration:3" type="jetbrains.mps.baseLanguage.structure.LocalVariableDeclaration:3" id="1226664120469">
          <property name="name:3" value="query" />
          <node role="type:3" type="jetbrains.mps.lang.smodel.structure.SNodeType:16" id="1226664120470">
            <link role="concept:16" targetNodeId="3.1167951910403:2" resolveInfo="SourceSubstituteMacro_SourceNodesQuery" />
          </node>
          <node role="initializer:3" type="jetbrains.mps.baseLanguage.structure.DotExpression:3" id="1226664120471">
            <node role="operand:3" type="jetbrains.mps.lang.typesystem.structure.ApplicableNodeReference:3" id="1226664146740">
              <link role="applicableNode:3" targetNodeId="1226664079052" resolveInfo="weaveEach" />
            </node>
            <node role="operation:3" type="jetbrains.mps.lang.smodel.structure.SLinkAccess:16" id="1226664120473">
              <link role="link:16" targetNodeId="3.1169569939267:2" />
            </node>
          </node>
        </node>
      </node>
      <node role="statement:3" type="jetbrains.mps.baseLanguage.structure.LocalVariableDeclarationStatement:3" id="1226664202525">
        <node role="localVariableDeclaration:3" type="jetbrains.mps.baseLanguage.structure.LocalVariableDeclaration:3" id="1226664202526">
          <property name="name:3" value="NT" />
          <node role="type:3" type="jetbrains.mps.lang.smodel.structure.SNodeType:16" id="1226664202527" />
          <node role="initializer:3" type="jetbrains.mps.baseLanguage.structure.StaticMethodCall:3" id="1226664202528">
            <link role="baseMethodDeclaration:3" targetNodeId="1226663231601" resolveInfo="getOutputNodeType_fromSourceQuery" />
            <link role="classConcept:3" targetNodeId="1178666070052" resolveInfo="QueriesUtil" />
            <node role="actualArgument:3" type="jetbrains.mps.baseLanguage.structure.LocalVariableReference:3" id="1226664202529">
              <link role="variableDeclaration:3" targetNodeId="1226664120469" resolveInfo="query" />
            </node>
          </node>
        </node>
      </node>
      <node role="statement:3" type="jetbrains.mps.baseLanguage.structure.LocalVariableDeclarationStatement:3" id="1226664097345">
        <node role="localVariableDeclaration:3" type="jetbrains.mps.baseLanguage.structure.LocalVariableDeclaration:3" id="1226664097346">
          <property name="name:3" value="nodeConcept" />
          <node role="type:3" type="jetbrains.mps.lang.smodel.structure.SNodeType:16" id="1226664097347">
            <link role="concept:16" targetNodeId="8.1169125787135:0" resolveInfo="AbstractConceptDeclaration" />
          </node>
          <node role="initializer:3" type="jetbrains.mps.baseLanguage.structure.DotExpression:3" id="1226664097348">
            <node role="operand:3" type="jetbrains.mps.lang.smodel.structure.SNodeTypeCastExpression:16" id="1226664097349">
              <link role="concept:16" targetNodeId="11.1138055754698:16" resolveInfo="SNodeType" />
              <node role="leftExpression:16" type="jetbrains.mps.baseLanguage.structure.LocalVariableReference:3" id="1226664214796">
                <link role="variableDeclaration:3" targetNodeId="1226664202526" resolveInfo="NT" />
              </node>
            </node>
            <node role="operation:3" type="jetbrains.mps.lang.smodel.structure.SLinkAccess:16" id="1226664097351">
              <link role="link:16" targetNodeId="11.1138405853777:16" />
            </node>
          </node>
        </node>
      </node>
      <node role="statement:3" type="jetbrains.mps.baseLanguage.structure.IfStatement:3" id="1226664097352">
        <node role="ifTrue:3" type="jetbrains.mps.baseLanguage.structure.StatementList:3" id="1226664097353">
          <node role="statement:3" type="jetbrains.mps.lang.typesystem.structure.ReportErrorStatement:3" id="1226664097354">
            <node role="errorString:3" type="jetbrains.mps.baseLanguage.structure.PlusExpression:3" id="1226664097355">
              <node role="rightExpression:3" type="jetbrains.mps.baseLanguage.structure.LocalVariableReference:3" id="1226664214795">
                <link role="variableDeclaration:3" targetNodeId="1226664202526" resolveInfo="NT" />
              </node>
              <node role="leftExpression:3" type="jetbrains.mps.baseLanguage.structure.StringLiteral:3" id="1226664097357">
                <property name="value:3" value="template is not applicable to " />
              </node>
            </node>
            <node role="nodeToReport:3" type="jetbrains.mps.lang.typesystem.structure.ApplicableNodeReference:3" id="1226664097358">
              <link role="applicableNode:3" targetNodeId="1226664079052" resolveInfo="weaveEach" />
            </node>
          </node>
        </node>
        <node role="condition:3" type="jetbrains.mps.baseLanguage.structure.NotExpression:3" id="1226664097359">
          <node role="expression:3" type="jetbrains.mps.baseLanguage.structure.StaticMethodCall:3" id="1238252098828">
            ...
            <node role="actualArgument:3" type="jetbrains.mps.baseLanguage.structure.LocalVariableReference:3" id="1238252098830">
              <link role="variableDeclaration:3" targetNodeId="1226664097346" resolveInfo="nodeConcept" />
            </node>
            <node role="actualArgument:3" type="jetbrains.mps.baseLanguage.structure.LocalVariableReference:3" id="1238252098833">
              <link role="variableDeclaration:3" targetNodeId="1226664181605" resolveInfo="templateApplicableConcept" />
            </node>
          </node>
        </node>
          ...
          <node role="statement:3" type="jetbrains.mps.baseLanguage.structure.LocalVariableDeclarationStatement:3" id="1241017468591">
            <node role="localVariableDeclaration:3" type="jetbrains.mps.baseLanguage.structure.LocalVariableDeclaration:3" id="1241017468592">
              ...
              <node role="initializer:3" type="jetbrains.mps.baseLanguage.structure.DotExpression:3" id="1241017468594">
                ...
                <node role="operation:3" type="jetbrains.mps.lang.smodel.structure.SLinkAccess:16" id="1241017468599">
                  <link role="link:16" targetNodeId="3.1168559393589:2" />
                </node>
              </node>
            </node>
