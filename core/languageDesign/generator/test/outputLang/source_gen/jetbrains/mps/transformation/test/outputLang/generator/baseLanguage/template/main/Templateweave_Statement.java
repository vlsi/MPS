...
public class Templateweave_Statement implements TemplateDeclarationWeavingAware {
  private static SNodePointer templateNode_38fazg_a0a0a1a1 = new SNodePointer("r:00000000-0000-4000-0000-011c89590606(jetbrains.mps.transformation.test.outputLang.generator.baseLanguage.template.main@generator)", "3571912445009934888");
  private static SNodePointer propertyMacro_38fazg_c0b0b0a2a1a1 = new SNodePointer("r:00000000-0000-4000-0000-011c89590606(jetbrains.mps.transformation.test.outputLang.generator.baseLanguage.template.main@generator)", "3571912445009934893");
  private static SNodePointer templateNode_38fazg_a0a0a1a4a1a1 = new SNodePointer("r:00000000-0000-4000-0000-011c89590606(jetbrains.mps.transformation.test.outputLang.generator.baseLanguage.template.main@generator)", "3571912445009934889");
  private static SNodePointer templateNode_38fazg_a0a0a1a5a1a1 = new SNodePointer("r:00000000-0000-4000-0000-011c89590606(jetbrains.mps.transformation.test.outputLang.generator.baseLanguage.template.main@generator)", "3571912445009934890");
  private static SNodePointer templateNode_38fazg_a0a0a1a6a1a1 = new SNodePointer("r:00000000-0000-4000-0000-011c89590606(jetbrains.mps.transformation.test.outputLang.generator.baseLanguage.template.main@generator)", "3571912445009934891");
  private static SNodePointer templateNode_38fazg_a0a0a1a3a1a6a1a1 = new SNodePointer("r:00000000-0000-4000-0000-011c89590606(jetbrains.mps.transformation.test.outputLang.generator.baseLanguage.template.main@generator)", "3571912445009937372");
  private static SNodePointer templateNode_38fazg_a0a0a1a3a1a3a1a6a1a1 = new SNodePointer("r:00000000-0000-4000-0000-011c89590606(jetbrains.mps.transformation.test.outputLang.generator.baseLanguage.template.main@generator)", "3571912445009937375");
  private static SNodePointer propertyMacro_38fazg_c0b0b0a2a1a3a1a3a1a6a1a1 = new SNodePointer("r:00000000-0000-4000-0000-011c89590606(jetbrains.mps.transformation.test.outputLang.generator.baseLanguage.template.main@generator)", "3571912445009937376");
  private static SNodePointer templateNode_38fazg_a0a0a1a2 = new SNodePointer("r:00000000-0000-4000-0000-011c89590606(jetbrains.mps.transformation.test.outputLang.generator.baseLanguage.template.main@generator)", "3571912445009937422");
  private static SNodePointer templateNode_38fazg_a0a0a1a3a1a2 = new SNodePointer("r:00000000-0000-4000-0000-011c89590606(jetbrains.mps.transformation.test.outputLang.generator.baseLanguage.template.main@generator)", "3571912445009937424");
  private static SNodePointer propertyMacro_38fazg_c0b0b0a2a1a3a1a2 = new SNodePointer("r:00000000-0000-4000-0000-011c89590606(jetbrains.mps.transformation.test.outputLang.generator.baseLanguage.template.main@generator)", "3571912445009937426");
  private static SNodePointer weaveTfConst_38fazg_a0b0e = new SNodePointer("r:00000000-0000-4000-0000-011c89590606(jetbrains.mps.transformation.test.outputLang.generator.baseLanguage.template.main@generator)", "3571912445009934892");
  private static SNodePointer weaveTfConst_38fazg_a0e0e = new SNodePointer("r:00000000-0000-4000-0000-011c89590606(jetbrains.mps.transformation.test.outputLang.generator.baseLanguage.template.main@generator)", "3571912445009937429");

  public Templateweave_Statement() {
  }
  ...
  protected SNode applyPart0(@NotNull final TemplateExecutionEnvironment environment, @NotNull final TemplateContext context) throws GenerationException {
    ...
    try {
...

      {
        ...
        try {
          environment.getTracer().pushTemplateNode(templateNode_38fazg_a0a0a1a4a1a1);
      ...
      }
      {
        ...
        try {
          environment.getTracer().pushTemplateNode(templateNode_38fazg_a0a0a1a5a1a1);
      ...
      }
      {
        ...
        try {
          environment.getTracer().pushTemplateNode(templateNode_38fazg_a0a0a1a6a1a1);
...

          {
            ...
            try {
              environment.getTracer().pushTemplateNode(templateNode_38fazg_a0a0a1a3a1a6a1a1);
      ...
      environment.getTracer().closeTemplateNode(templateNode_38fazg_a0a0a1a1);
    }
    return tnode1;
  }
  ...
  protected SNode applyPart1(@NotNull final TemplateExecutionEnvironment environment, @NotNull final TemplateContext context) throws GenerationException {
    ...
    try {
      environment.getTracer().pushTemplateNode(templateNode_38fazg_a0a0a1a2);
      ...
      environment.getTracer().closeTemplateNode(templateNode_38fazg_a0a0a1a2);
    }
    return tnode7;
  }
  ...
  public Collection<SNode> weave(@NotNull TemplateExecutionEnvironment environment, @NotNull TemplateContext context, @NotNull SNode outputContextNode) throws GenerationException {
    ...
    SNodePointer weaveTf0 = weaveTfConst_38fazg_a0b0e;
    ...
    SNodePointer weaveTf1 = weaveTfConst_38fazg_a0e0e;
