...
<model modelUID="r:00000000-0000-4000-0000-011c89590605(jetbrains.mps.transformation.test.outputLang.structure)">
  ...
  <refactoringHistory>
    <refactoringContext modelVersion="0">
      ...
      <conceptFeatureMap>
        <entry>
          <key featureName="TwoVarRoot" conceptFQName="jetbrains.mps.transformation.test.outputLang.structure.TwoVarRoot" featureKind="CONCEPT" />
          <value featureName="TwoVarStatement" conceptFQName="jetbrains.mps.transformation.test.outputLang.structure.TwoVarStatement" featureKind="CONCEPT" />
        </entry>
      </conceptFeatureMap>
    </refactoringContext>
  </refactoringHistory>
  ...
  <node type="jetbrains.mps.lang.structure.structure.ConceptDeclaration:0" id="1195164668463">
    ...
    <node role="linkDeclaration:0" type="jetbrains.mps.lang.structure.structure.LinkDeclaration:0" id="1195169631818">
      ...
      <link role="target:0" targetNodeId="1195165132070:0" resolveInfo="OutputNode" />
    </node>
  ...
  <node type="jetbrains.mps.lang.structure.structure.ConceptDeclaration:0" id="1209604028561">
    ...
    <link role="extends:0" targetNodeId="1195165132070:0" resolveInfo="OutputNode" />
  </node>
  ...
  <node type="jetbrains.mps.lang.structure.structure.ConceptDeclaration:0" id="2163819695913378074">
    <property name="name:0" value="CustomStatementRef" />
    <link role="extends:0" targetNodeId="2.1068431790191:3" resolveInfo="Expression" />
    <node role="propertyDeclaration:0" type="jetbrains.mps.lang.structure.structure.PropertyDeclaration:0" id="2163819695913379842">
      <property name="name:0" value="ii" />
      <link role="dataType:0" targetNodeId="1.1082983657062:0" resolveInfo="integer" />
    </node>
    <node role="linkDeclaration:0" type="jetbrains.mps.lang.structure.structure.LinkDeclaration:0" id="2163819695913379841">
      <property name="metaClass:0" value="reference" />
      <property name="role:0" value="myStatement" />
      <property name="sourceCardinality:0" value="1" />
      <link role="target:0" targetNodeId="2681305894288486346:0" resolveInfo="CustomStatement" />
    </node>
  </node>
  <node type="jetbrains.mps.lang.structure.structure.ConceptDeclaration:0" id="6010543442198679048">
    <property name="name:0" value="TwoVarStatement" />
    <link role="extends:0" targetNodeId="2.1068580123157:3" resolveInfo="Statement" />
    <node role="propertyDeclaration:0" type="jetbrains.mps.lang.structure.structure.PropertyDeclaration:0" id="6010543442198679051">
      <property name="name:0" value="name1" />
      <link role="dataType:0" targetNodeId="1.1082983041843:0" resolveInfo="string" />
    </node>
    <node role="propertyDeclaration:0" type="jetbrains.mps.lang.structure.structure.PropertyDeclaration:0" id="6010543442198679052">
      <property name="name:0" value="name2" />
      <link role="dataType:0" targetNodeId="1.1082983041843:0" resolveInfo="string" />
    </node>
  </node>
</model>
