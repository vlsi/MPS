...
public class TemplateOutputRoot_1 implements TemplateDeclaration {
  ...
  private static SNodePointer loopMacroRef_rz5qmv_a0a0a2a3a2a1a5a1a0 = new SNodePointer("r:00000000-0000-4000-0000-011c895905f7(jetbrains.mps.transformation.test.inputLang.generator.outputLang.template.test_getPrevInput@generator)", "1202256587516");
  private static SNodePointer loopMacroRef_rz5qmv_a0a0a3a2a2a2a3a2a1a5a1a0 = new SNodePointer("r:00000000-0000-4000-0000-011c895905f7(jetbrains.mps.transformation.test.inputLang.generator.outputLang.template.test_getPrevInput@generator)", "1202256594379");
  private static SNodePointer mapsrcMacroRef_rz5qmv_a0a0a3a2a2a3a2a2a2a3a2a1a5a1a0 = new SNodePointer("r:00000000-0000-4000-0000-011c895905f7(jetbrains.mps.transformation.test.inputLang.generator.outputLang.template.test_getPrevInput@generator)", "1202337434278");
  private static SNodePointer templateNode_rz5qmv_a0a0a2a3a2a2a3a2a2a2a3a2a1a5a1a0 = new SNodePointer("r:00000000-0000-4000-0000-011c895905f7(jetbrains.mps.transformation.test.inputLang.generator.outputLang.template.test_getPrevInput@generator)", "1202256495546");
  private static SNodePointer templateNode_rz5qmv_a0a0a1a4a2a3a2a2a3a2a2a2a3a2a1a5a1a0 = new SNodePointer("r:00000000-0000-4000-0000-011c895905f7(jetbrains.mps.transformation.test.inputLang.generator.outputLang.template.test_getPrevInput@generator)", "1202327206676");
  private static SNodePointer ifMacroRef_rz5qmv_a0a0a1a5a2a3a2a2a3a2a2a2a3a2a1a5a1a0 = new SNodePointer("r:00000000-0000-4000-0000-011c895905f7(jetbrains.mps.transformation.test.inputLang.generator.outputLang.template.test_getPrevInput@generator)", "1202332796046");
  private static SNodePointer templateNode_rz5qmv_a0a0a1a1a1a5a2a3a2a2a3a2a2a2a3a2a1a5a1a0 = new SNodePointer("r:00000000-0000-4000-0000-011c895905f7(jetbrains.mps.transformation.test.inputLang.generator.outputLang.template.test_getPrevInput@generator)", "1202327778745");
  private static SNodePointer templateNode_rz5qmv_a0a0a1a6a2a3a2a2a3a2a2a2a3a2a1a5a1a0 = new SNodePointer("r:00000000-0000-4000-0000-011c895905f7(jetbrains.mps.transformation.test.inputLang.generator.outputLang.template.test_getPrevInput@generator)", "1202327949446");
  ...
  public Collection<SNode> apply(@NotNull final TemplateExecutionEnvironment environment, @NotNull final TemplateContext context) throws GenerationException {
    ...
    try {
      ...
      environment.nodeCopied(context.getInput(), tnode1, "tpl/r:00000000-0000-4000-0000-011c895905f7/1202255620269");
        ...
        try {
          ...
          for (SNode itnode2 : sourceList2) {
            ...
            try {
              ...
              try {
                environment.getTracer().pushMacro(loopMacroRef_rz5qmv_a0a0a2a3a2a1a5a1a0);
                ...
                for (SNode itnode3 : loopList3) {
                  ...
                  try {
                    ...
                    try {
                      environment.getTracer().pushMacro(loopMacroRef_rz5qmv_a0a0a3a2a2a2a3a2a1a5a1a0);
                      ...
                      for (SNode itnode4 : loopList4) {
                        ...
                        try {
                          ...
                          try {
                            environment.getTracer().pushMacro(mapsrcMacroRef_rz5qmv_a0a0a3a2a2a3a2a2a2a3a2a1a5a1a0);
                            ...
                            try {
                              environment.getTracer().pushTemplateNode(templateNode_rz5qmv_a0a0a2a3a2a2a3a2a2a2a3a2a1a5a1a0);
                              environment.nodeCopied(context4.getInput(), tnode6, "tpl/r:00000000-0000-4000-0000-011c895905f7/1202256495546");
...

                              {
                                ...
                                try {
                                  environment.getTracer().pushTemplateNode(templateNode_rz5qmv_a0a0a1a4a2a3a2a2a3a2a2a2a3a2a1a5a1a0);
                                  environment.nodeCopied(context4.getInput(), tnode7, "tpl/r:00000000-0000-4000-0000-011c895905f7/1202327206676");
                                  ...
                                  environment.getTracer().closeTemplateNode(templateNode_rz5qmv_a0a0a1a4a2a3a2a2a3a2a2a2a3a2a1a5a1a0);
                                }
                              ...
                              }
                              {
                                ...
                                try {
                                  environment.getTracer().pushMacro(ifMacroRef_rz5qmv_a0a0a1a5a2a3a2a2a3a2a2a2a3a2a1a5a1a0);
                                  if (QueriesGenerated.ifMacro_Condition_1202332796047(environment.getOperationContext(), new IfMacroContext(context4.getInput(), null, context4, environment.getGenerator()))) {
                                    ...
                                    try {
                                      environment.getTracer().pushTemplateNode(templateNode_rz5qmv_a0a0a1a1a1a5a2a3a2a2a3a2a2a2a3a2a1a5a1a0);
                                      environment.nodeCopied(context4.getInput(), tnode9, "tpl/r:00000000-0000-4000-0000-011c895905f7/1202327778745");
                                      ...
                                      environment.getTracer().closeTemplateNode(templateNode_rz5qmv_a0a0a1a1a1a5a2a3a2a2a3a2a2a2a3a2a1a5a1a0);
                                    }
                                    tlist8 = TemplateUtil.singletonList(tnode9);
                                  }

                                } finally {
                                  environment.getTracer().closeMacro(ifMacroRef_rz5qmv_a0a0a1a5a2a3a2a2a3a2a2a2a3a2a1a5a1a0);
                                }
                              ...
                              }
                              {
                                ...
                                try {
                                  environment.getTracer().pushTemplateNode(templateNode_rz5qmv_a0a0a1a6a2a3a2a2a3a2a2a2a3a2a1a5a1a0);
                                  environment.nodeCopied(context4.getInput(), tnode11, "tpl/r:00000000-0000-4000-0000-011c895905f7/1202327949446");
                                  ...
                                  environment.getTracer().closeTemplateNode(templateNode_rz5qmv_a0a0a1a6a2a3a2a2a3a2a2a2a3a2a1a5a1a0);
                                }
                              ...
                              environment.getTracer().closeTemplateNode(templateNode_rz5qmv_a0a0a2a3a2a2a3a2a2a2a3a2a1a5a1a0);
                            }
                            if (tnode6 != null) {
                              tlist5.add(tnode6);
                            ...
                            environment.getTracer().closeMacro(mapsrcMacroRef_rz5qmv_a0a0a3a2a2a3a2a2a2a3a2a1a5a1a0);
                          }
                          if (tlist5 != null) {
                      ...
                      environment.getTracer().closeMacro(loopMacroRef_rz5qmv_a0a0a3a2a2a2a3a2a1a5a1a0);
                    }
                    if (tlist4 != null) {
                ...
                environment.getTracer().closeMacro(loopMacroRef_rz5qmv_a0a0a2a3a2a1a5a1a0);
              }
              if (tlist3 != null) {
