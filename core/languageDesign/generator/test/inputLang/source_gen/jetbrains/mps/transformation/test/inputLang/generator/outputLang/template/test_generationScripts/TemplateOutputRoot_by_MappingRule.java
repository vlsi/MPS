    ...
    try {
...

      {
        ...
        try {
          ...
          tlist2 = environment.copyNodes(copyListInput2, copySrcListMacro_jwmwuq_a0a0a1a5a1a0, null, context);
        } finally {
      ...
      environment.getTracer().closeTemplateNode(templateNode_jwmwuq_a0a0a1a0);
    }
