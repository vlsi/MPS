...
public class InputNode_C_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createCollection_3988_0(EditorContext context, SNode node) {
  ...
  private EditorCell createCollection_3988_1(EditorContext context, SNode node) {
    EditorCell_Collection editorCell = EditorCell_Collection.createVertical(context, node);
  ...
  private EditorCell createCollection_3988_2(EditorContext context, SNode node) {
    ...
    editorCell.addEditorCell(this.createProperty_3988_0(context, node));
    return editorCell;
  }

  private EditorCell createCollection_3988_3(EditorContext context, SNode node) {
    EditorCell_Collection editorCell = EditorCell_Collection.createHorizontal(context, node);
  ...
  private EditorCell createCollection_3988_4(EditorContext context, SNode node) {
    EditorCell_Collection editorCell = EditorCell_Collection.createHorizontal(context, node);
  ...
  private EditorCell createConstant_3988_0(EditorContext context, SNode node, String text) {
  ...
  private EditorCell createConstant_3988_1(EditorContext context, SNode node, String text) {
    EditorCell_Constant editorCell = new EditorCell_Constant(context, node, text);
  ...
  private EditorCell createConstant_3988_2(EditorContext context, SNode node, String text) {
    EditorCell_Constant editorCell = new EditorCell_Constant(context, node, text);
  ...
  private EditorCell createConstant_3988_4(EditorContext context, SNode node, String text) {
    EditorCell_Constant editorCell = new EditorCell_Constant(context, node, text);
  ...
  private EditorCell createRefNodeList_3988_0(EditorContext context, SNode node) {
    AbstractCellListHandler handler = new InputNode_C_Editor.inputChildListHandler_3988_0(node, "inputChild", context);
  ...
  private EditorCell createProperty_3988_0(EditorContext context, SNode node) {
  ...
  private EditorCell createProperty_3988_1(EditorContext context, SNode node) {
    CellProviderWithRole provider = new PropertyCellProvider(node, context);
  ...
  private static class inputChildListHandler_3988_0 extends RefNodeListHandler {
    ...
    private EditorCell createConstant_3988_3(EditorContext context, SNode node, String text) {
      EditorCell_Constant editorCell = new EditorCell_Constant(context, node, text);
