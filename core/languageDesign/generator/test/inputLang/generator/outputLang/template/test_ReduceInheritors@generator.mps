...
<model modelUID="r:00000000-0000-4000-0000-011c895905f9(jetbrains.mps.transformation.test.inputLang.generator.outputLang.template.test_ReduceInheritors@generator)">
  ...
  <languageAspect modelUID="r:41fb14d2-a085-41df-8256-2db786d90029(jetbrains.mps.lang.generator.generationParameters.structure)" version="-1" />
  <languageAspect modelUID="r:00000000-0000-4000-0000-011c895905f9(jetbrains.mps.transformation.test.inputLang.generator.outputLang.template.test_ReduceInheritors@generator)" version="-1" />
  ...
  <node type="jetbrains.mps.lang.generator.structure.GeneratorDescriptor:2" id="5023471013036366740">
    <property name="generate:2" value="true" />
    <node role="requires:2" type="jetbrains.mps.lang.generator.structure.GeneratorParameterReference:2" id="7941504602773316098">
      <link role="declaration:2" targetNodeId="1646518082434722004" resolveInfo="os" />
    </node>
    <node role="requires:2" type="jetbrains.mps.lang.generator.structure.GeneratorParameterReference:2" id="7941504602773316100">
      <link role="declaration:2" targetNodeId="1646518082434723264" resolveInfo="arch" />
    </node>
  </node>
</model>
