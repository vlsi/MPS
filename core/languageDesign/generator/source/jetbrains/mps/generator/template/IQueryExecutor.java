...
public interface IQueryExecutor {
  ...
  boolean checkConditionForIfMacro(SNode inputNode, IfMacro ifMacro) throws GenerationFailureException;

  void executeMappingScript(MappingScript mappingScript, SModel model) throws GenerationFailureException;

  SNode executeMapSrcNodeMacro(SNode inputNode, SNode mapSrcNodeOrListMacro, SNode parentOutputNode) throws GenerationFailureException;

  void executeMapSrcNodeMacro_PostProc(SNode inputNode, SNode mapSrcNodeOrListMacro, SNode outputNode) throws GenerationFailureException;
  ...
  Object getReferentTarget(SNode node, SNode outputNode, ReferenceMacro refMacro);
}
