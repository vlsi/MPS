...
public class TemplateDeclarationReference_Editor extends DefaultNodeEditor {
  public EditorCell createEditorCell(EditorContext editorContext, SNode node) {
    return this.createCollection_krqspc_a(editorContext, node);
  }

  private EditorCell createCollection_krqspc_a(EditorContext editorContext, SNode node) {
  ...
  private EditorCell createRefCell_krqspc_a0(EditorContext editorContext, SNode node) {
  ...
  public static class _Inline_krqspc_a0a extends InlineCellProvider {
    ...
    public EditorCell createEditorCell(EditorContext editorContext, SNode node) {
      return this.createProperty_krqspc_a0a0(editorContext, node);
    }

    private EditorCell createProperty_krqspc_a0a0(EditorContext editorContext, SNode node) {
