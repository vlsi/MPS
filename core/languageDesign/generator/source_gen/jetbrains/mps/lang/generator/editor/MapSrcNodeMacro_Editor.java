...
public class MapSrcNodeMacro_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createConstant_dms3bp_a0_0(EditorContext editorContext, SNode node) {
    ...
    editorCell.setDefaultText("");
    editorCell.setSubstituteInfo(new CompositeSubstituteInfo(editorContext, new BasicCellContext(node), new SubstituteInfoPart[]{new MapSrcNodeMacro_Editor.MapSrcNodeMacro_Editor_replaceWith_NodeMacro_cellMenu_a0a0()}));
    return editorCell;
  }
  ...
  public static class MapSrcNodeMacro_Editor_replaceWith_NodeMacro_cellMenu_a0a0 extends AbstractCellMenuPart_ReplaceNode_CustomNodeConcept {
    public MapSrcNodeMacro_Editor_replaceWith_NodeMacro_cellMenu_a0a0() {
    }
