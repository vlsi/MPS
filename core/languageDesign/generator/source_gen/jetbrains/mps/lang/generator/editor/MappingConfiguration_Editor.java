...
public class MappingConfiguration_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createRefNodeList_2420_0(EditorContext context, SNode node) {
    AbstractCellListHandler handler = new MappingConfiguration_Editor.createRootRuleListHandler_2420_0(node, "createRootRule", context);
  ...
  private EditorCell createRefNodeList_2420_1(EditorContext context, SNode node) {
    AbstractCellListHandler handler = new MappingConfiguration_Editor.rootMappingRuleListHandler_2420_0(node, "rootMappingRule", context);
    EditorCell_Collection editorCell = handler.createCells(context, new CellLayout_Vertical(), false);
  ...
  private EditorCell createRefNodeList_2420_2(EditorContext context, SNode node) {
    AbstractCellListHandler handler = new MappingConfiguration_Editor.weavingMappingRuleListHandler_2420_0(node, "weavingMappingRule", context);
    EditorCell_Collection editorCell = handler.createCells(context, new CellLayout_Vertical(), false);
  ...
  private EditorCell createRefNodeList_2420_3(EditorContext context, SNode node) {
    AbstractCellListHandler handler = new MappingConfiguration_Editor.reductionMappingRuleListHandler_2420_0(node, "reductionMappingRule", context);
    EditorCell_Collection editorCell = handler.createCells(context, new CellLayout_Vertical(), false);
  ...
  private EditorCell createRefNodeList_2420_4(EditorContext context, SNode node) {
    AbstractCellListHandler handler = new MappingConfiguration_Editor.preMappingScriptListHandler_2420_0(node, "preMappingScript", context);
    EditorCell_Collection editorCell = handler.createCells(context, new CellLayout_Vertical(), false);
  ...
  private EditorCell createRefNodeList_2420_5(EditorContext context, SNode node) {
    AbstractCellListHandler handler = new MappingConfiguration_Editor.postMappingScriptListHandler_2420_0(node, "postMappingScript", context);
    EditorCell_Collection editorCell = handler.createCells(context, new CellLayout_Vertical(), false);
  ...
  private EditorCell createRefNodeList_2420_6(EditorContext context, SNode node) {
    AbstractCellListHandler handler = new MappingConfiguration_Editor.mappingLabelListHandler_2420_0(node, "mappingLabel", context);
    EditorCell_Collection editorCell = handler.createCells(context, new CellLayout_Vertical(), false);
  ...
  private EditorCell createRefNodeList_2420_7(EditorContext context, SNode node) {
    AbstractCellListHandler handler = new MappingConfiguration_Editor.dropRootRuleListHandler_2420_0(node, "dropRootRule", context);
    EditorCell_Collection editorCell = handler.createCells(context, new CellLayout_Vertical(), false);
