...
public class RootTemplateAnnotation_Editor extends DefaultNodeEditor {
  ...
  private static void setupBasic_Collection_11686196668651168619666865(EditorCell editorCell, SNode node, EditorContext context) {
    editorCell.putUserObject(EditorCell.CELL_ID, "Collection_1168619666865");
    {
      Style inlineStyle = new Style(editorCell) {
        {
          this.set(StyleAttributes.SELECTABLE, new AttributeCalculator <Boolean>() {
            ...
            public Boolean calculate(EditorCell cell) {
              return RootTemplateAnnotation_Editor.calculateBoolean6257_4(cell);
            }
  ...
  private static void setupBasic_AttributedNodeCell_11686198370041168619837004(EditorCell editorCell, SNode node, EditorContext context) {
    editorCell.putUserObject(EditorCell.CELL_ID, "AttributedNodeCell_1168619837004");
  }
  ...
  private static void setupBasic_Collection_11686256445101168625644510(EditorCell editorCell, SNode node, EditorContext context) {
    editorCell.putUserObject(EditorCell.CELL_ID, "Collection_1168625644510");
    {
      Style inlineStyle = new Style(editorCell) {
        {
          this.set(StyleAttributes.SELECTABLE, new AttributeCalculator <Boolean>() {
            ...
            public Boolean calculate(EditorCell cell) {
              return RootTemplateAnnotation_Editor.calculateBoolean6257_6(cell);
            }
          ...
          this.set(StyleAttributes.DRAW_BRACKETS, new AttributeCalculator <Boolean>() {
            ...
            public Boolean calculate(EditorCell cell) {
              return RootTemplateAnnotation_Editor.calculateBoolean6257_9(cell);
            }
          ...
          this.set(StyleAttributes.BRACKETS_COLOR, new AttributeCalculator <Color>() {
            ...
            public Color calculate(EditorCell cell) {
              return RootTemplateAnnotation_Editor.calculateColor6257_0(cell);
            }
  ...
  private static void setupBasic_Collection_11686256445111168625644511(EditorCell editorCell, SNode node, EditorContext context) {
    editorCell.putUserObject(EditorCell.CELL_ID, "Collection_1168625644511");
    {
      Style inlineStyle = new Style(editorCell) {
        {
          this.set(StyleAttributes.SELECTABLE, new AttributeCalculator <Boolean>() {
            ...
            public Boolean calculate(EditorCell cell) {
              return RootTemplateAnnotation_Editor.calculateBoolean6257_7(cell);
            }
  ...
  private static void setupBasic_Constant_11686256445121168625644512(EditorCell editorCell, SNode node, EditorContext context) {
    editorCell.putUserObject(EditorCell.CELL_ID, "Constant_1168625644512");
    {
      Style inlineStyle = new Style(editorCell) {
        {
          this.set(StyleAttributes.SELECTABLE, new AttributeCalculator <Boolean>() {
            ...
            public Boolean calculate(EditorCell cell) {
              return RootTemplateAnnotation_Editor.calculateBoolean6257_5(cell);
            }
  ...
  private static void setupBasic_Constant_11686256513621168625651362(EditorCell editorCell, SNode node, EditorContext context) {
    editorCell.putUserObject(EditorCell.CELL_ID, "Constant_1168625651362");
    {
      Style inlineStyle = new Style(editorCell) {
        {
          this.set(StyleAttributes.SELECTABLE, new AttributeCalculator <Boolean>() {
            ...
            public Boolean calculate(EditorCell cell) {
              return RootTemplateAnnotation_Editor.calculateBoolean6257_1(cell);
            }
  ...
  private static void setupBasic_Constant_11686256590151168625659015(EditorCell editorCell, SNode node, EditorContext context) {
    editorCell.putUserObject(EditorCell.CELL_ID, "Constant_1168625659015");
    {
      Style inlineStyle = new Style(editorCell) {
        {
          this.set(StyleAttributes.SELECTABLE, new AttributeCalculator <Boolean>() {
            ...
            public Boolean calculate(EditorCell cell) {
              return RootTemplateAnnotation_Editor.calculateBoolean6257_8(cell);
            }
  ...
  private static void setupBasic_Collection_11686256590161168625659016(EditorCell editorCell, SNode node, EditorContext context) {
    editorCell.putUserObject(EditorCell.CELL_ID, "Collection_1168625659016");
    {
      Style inlineStyle = new Style(editorCell) {
        {
          this.set(StyleAttributes.SELECTABLE, new AttributeCalculator <Boolean>() {
            ...
            public Boolean calculate(EditorCell cell) {
              return RootTemplateAnnotation_Editor.calculateBoolean6257_3(cell);
            }
  ...
  private static void setupBasic_Constant_11686256590171168625659017(EditorCell editorCell, SNode node, EditorContext context) {
    editorCell.putUserObject(EditorCell.CELL_ID, "Constant_1168625659017");
    {
      Style inlineStyle = new Style(editorCell) {
        {
          this.set(StyleAttributes.TEXT_BACKGROUND_COLOR, new AttributeCalculator <Color>() {
            ...
            public Color calculate(EditorCell cell) {
              return RootTemplateAnnotation_Editor.calculateColor6257_2(cell);
            }
  ...
  private static void setupBasic_Constant_11686256590181168625659018(EditorCell editorCell, SNode node, EditorContext context) {
    editorCell.putUserObject(EditorCell.CELL_ID, "Constant_1168625659018");
    {
      Style inlineStyle = new Style(editorCell) {
        {
          this.set(StyleAttributes.SELECTABLE, new AttributeCalculator <Boolean>() {
            ...
            public Boolean calculate(EditorCell cell) {
              return RootTemplateAnnotation_Editor.calculateBoolean6257_0(cell);
            }
  ...
  private static void setupBasic_Constant_11686256590191168625659019(EditorCell editorCell, SNode node, EditorContext context) {
    editorCell.putUserObject(EditorCell.CELL_ID, "Constant_1168625659019");
  }
  ...
  private static void setupBasic_Constant_11686256590201168625659020(EditorCell editorCell, SNode node, EditorContext context) {
    editorCell.putUserObject(EditorCell.CELL_ID, "Constant_1168625659020");
    {
      Style inlineStyle = new Style(editorCell) {
        {
          this.set(StyleAttributes.SELECTABLE, new AttributeCalculator <Boolean>() {
            ...
            public Boolean calculate(EditorCell cell) {
              return RootTemplateAnnotation_Editor.calculateBoolean6257_2(cell);
            }
  ...
  private static Color calculateColor6257_0(EditorCell cell) {
    Color result;
    result = MPSColors.lightGray;
    return result;
  }

  private static Color calculateColor6257_1(EditorCell cell) {
    Color result;
    result = MPSColors.DARK_MAGENTA;
    return result;
  }

  private static Color calculateColor6257_2(EditorCell cell) {
    Color result;
    result = MPSColors.orange;
    return result;
  }

  public static Boolean calculateBoolean6257_0(EditorCell cell) {
    boolean result;
    result = false;
    return result;
  }

  public static Boolean calculateBoolean6257_1(EditorCell cell) {
    boolean result;
    result = true;
    return result;
  }

  public static Boolean calculateBoolean6257_2(EditorCell cell) {
    boolean result;
    result = false;
    return result;
  }

  public static Boolean calculateBoolean6257_3(EditorCell cell) {
    boolean result;
    result = false;
    return result;
  }

  public static Boolean calculateBoolean6257_4(EditorCell cell) {
    boolean result;
    result = false;
    return result;
  }

  public static Boolean calculateBoolean6257_5(EditorCell cell) {
    boolean result;
    result = false;
    return result;
  }

  public static Boolean calculateBoolean6257_6(EditorCell cell) {
    boolean result;
    result = true;
    return result;
  }

  public static Boolean calculateBoolean6257_7(EditorCell cell) {
    boolean result;
    result = false;
    return result;
  }

  public static Boolean calculateBoolean6257_8(EditorCell cell) {
    boolean result;
    result = false;
    return result;
  }

  public static Boolean calculateBoolean6257_9(EditorCell cell) {
    boolean result;
    result = true;
    return result;
  }
        ...
        Style inlineStyle = new Style(editorCell) {
          {
            this.set(StyleAttributes.TEXT_COLOR, new AttributeCalculator <Color>() {
              ...
              public Color calculate(EditorCell cell) {
                return RootTemplateAnnotation_Editor.calculateColor6257_1(cell);
              }
