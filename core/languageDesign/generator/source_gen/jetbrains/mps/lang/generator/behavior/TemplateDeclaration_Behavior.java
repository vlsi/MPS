...
public class TemplateDeclaration_Behavior {
  ...
  private static Class[] PARAMETERS_6261424444345979476 = {SNode.class ,SNode.class};
  ...
  public static void call_setBaseConcept_6261424444345979476(SNode thisNode, SNode baseConcept) {
    BehaviorManager.getInstance().invoke(Object.class, SNodeOperations.cast(thisNode, "jetbrains.mps.lang.generator.structure.TemplateDeclaration"), "virtual_setBaseConcept_6261424444345963020", PARAMETERS_6261424444345979476, baseConcept);
  }
  ...
  public static void callSuper_setBaseConcept_6261424444345979476(SNode thisNode, String callerConceptFqName, SNode baseConcept) {
    BehaviorManager.getInstance().invokeSuper(Object.class, SNodeOperations.cast(thisNode, "jetbrains.mps.lang.generator.structure.TemplateDeclaration"), callerConceptFqName, "virtual_setBaseConcept_6261424444345963020", PARAMETERS_6261424444345979476, baseConcept);
  }
}
