  ...
  <node type="jetbrains.mps.baseLanguage.structure.ClassConcept" id="1216147812749">
    ...
    <node role="constructor" type="jetbrains.mps.baseLanguage.structure.ConstructorDeclaration" id="1216147812751">
      ...
      <node role="body" type="jetbrains.mps.baseLanguage.structure.StatementList" id="1216147812754">
        ...
        <node role="statement" type="jetbrains.mps.baseLanguage.structure.ExpressionStatement" id="1223900676839">
          <node role="expression" type="jetbrains.mps.lang.quotation.structure.Quotation" id="1223900676840">
            <node role="quotedNode" type="jetbrains.mps.baseLanguage.structure.IfStatement" id="1223900737630">
              <node role="condition" type="jetbrains.mps.baseLanguage.structure.Expression" id="1223900737631" />
              <node role="ifTrue" type="jetbrains.mps.baseLanguage.structure.StatementList" id="1223900737632">
                <node role="statement" type="jetbrains.mps.baseLanguage.structure.ExpressionStatement" id="1223900739648">
                  <node role="expression" type="jetbrains.mps.baseLanguage.structure.LocalVariableReference" id="1223900739649">
                    <link role="variableDeclaration" targetNodeId="1216147851226" resolveInfo="i" />
                  </node>
                </node>
              </node>
            </node>
            ...
            <node role="nodeMacro$attribute" type="jetbrains.mps.lang.generator.structure.CopySrcNodeMacro" id="1227320153119">
              ...
              <node role="sourceNodeQuery" type="jetbrains.mps.lang.generator.structure.SourceSubstituteMacro_SourceNodeQuery" id="1227320153120">
                <node role="body" type="jetbrains.mps.baseLanguage.structure.StatementList" id="1227320153121">
                  <node role="statement" type="jetbrains.mps.baseLanguage.structure.ExpressionStatement" id="1229480337142">
                    <node role="expression" type="jetbrains.mps.baseLanguage.structure.DotExpression" id="1229480363466">
                      <node role="operand" type="jetbrains.mps.lang.generator.generationContext.structure.TemplateFunctionParameter_generationContext" id="1229480362402" />
                      <node role="operation" type="jetbrains.mps.lang.generator.generationContext.structure.GenerationContextOp_GetOriginalCopiedInputByOutput" id="1229480366328">
                        <node role="outputNode" type="jetbrains.mps.lang.generator.structure.TemplateFunctionParameter_sourceNode" id="1229480392205" />
                      </node>
                    </node>
                  </node>
                </node>
