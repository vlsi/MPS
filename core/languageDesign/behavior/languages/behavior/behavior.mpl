...
<language namespace="jetbrains.mps.lang.behavior" uuid="af65afd8-f0dd-4942-87d9-63a55f2a9db1" generatorOutputPath="${mps_home}/core/languageDesign/behavior/source_gen" java-stubs-enabled="true" compileInMPS="false" doNotGenerateAdapters="false">
  <models>
  ...
  <stubModelEntries>
    <stubModelEntry path="${mps_home}/core/languageDesign/behavior/classes" include="false">
