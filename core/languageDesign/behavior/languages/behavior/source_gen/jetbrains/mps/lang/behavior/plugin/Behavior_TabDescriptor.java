...
public class Behavior_TabDescriptor extends EditorTabDescriptor {
  ...
  private static Logger LOG = Logger.getLogger(Behavior_TabDescriptor.class);
  ...
  private static Icon loadIcon() {
    try {
      return new ImageIcon(StreamUtil.loadFromStream(URLUtil.openStream(Behavior_TabDescriptor.class.getResource("behavior.png"))));
    } catch (IOException e) {
      LOG.warning("Couldn't load icon for Behavior", e);
      return null;
    }
  }
}
