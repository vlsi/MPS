...
public class ImplementBehaviorMethod_Action extends GeneratedAction {
  ...
  public boolean isApplicable(AnActionEvent event, final Map<String, Object> _params) {
    return !(((EditorContext) MapSequence.<String,Object>fromMap(_params).get("editorContext")).isInspector()) && (SNodeOperations.getAncestor(((SNode) MapSequence.<String,Object>fromMap(_params).get("selectedNode")), "jetbrains.mps.lang.behavior.structure.ConceptBehavior", true, false) != null);
  }
  ...
  public void doExecute(@NotNull final AnActionEvent event, final Map<String, Object> _params) {
    try {
      ...
      new StratergyAddMethodDialog(((EditorContext) MapSequence.<String,Object>fromMap(_params).get("editorContext")), frame, new AddConceptMethodStrategy(((SNode) MapSequence.<String,Object>fromMap(_params).get("selectedNode"))), new MethodsToImplementStrategy(), new ImplementMethodStrategy(project)).showDialog();
