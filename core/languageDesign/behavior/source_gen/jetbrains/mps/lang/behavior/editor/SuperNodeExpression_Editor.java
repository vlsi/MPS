...
public class SuperNodeExpression_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createCollection_3177_0(EditorContext editorContext, SNode node) {
    ...
    editorCell.addEditorCell(this.createConstant_3177_0(editorContext, node, "super"));
    return editorCell;
  }

  private EditorCell createConstant_3177_0(EditorContext editorContext, SNode node, String text) {
