...
public class ConceptConstructorDeclaration_Editor extends DefaultNodeEditor {
  ...
  public EditorCell createCollection_6948_0(EditorContext context, SNode node) {
    ...
    editorCell.addEditorCell(this.createCollection_6948_1(context, node));
    editorCell.addEditorCell(this.createCollection_6948_2(context, node));
    editorCell.addEditorCell(this.createConstant_6948_2(context, node, "}"));
    return editorCell;
  }

  public EditorCell createCollection_6948_1(EditorContext context, SNode node) {
    EditorCell_Collection editorCell = EditorCell_Collection.createHorizontal(context, node);
    setupBasic_Collection_6948_1(editorCell, node, context);
    editorCell.setGridLayout(false);
    editorCell.setUsesBraces(false);
    editorCell.setCanBeFolded(false);
  ...
  public EditorCell createCollection_6948_2(EditorContext context, SNode node) {
    EditorCell_Collection editorCell = EditorCell_Collection.createHorizontal(context, node);
    setupBasic_Collection_6948_2(editorCell, node, context);
    editorCell.setGridLayout(false);
    editorCell.setUsesBraces(false);
    editorCell.setCanBeFolded(false);
  ...
  private static void setupBasic_Collection_6948_1(EditorCell editorCell, SNode node, EditorContext context) {
    editorCell.setCellId("Collection_6948_1");
  }
  ...
  private static void setupBasic_Collection_6948_2(EditorCell editorCell, SNode node, EditorContext context) {
    editorCell.setCellId("Collection_6948_2");
  }

  private static void setupBasic_Indent_6948_0(EditorCell editorCell, SNode node, EditorContext context) {
    editorCell.setCellId("Indent_6948_0");
  }
