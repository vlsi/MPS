...
public class ConceptMethodDeclaration_Menu extends AbstractCellMenuComponent {
  public ConceptMethodDeclaration_Menu() {
    super(new SubstituteInfoPart[]{new ConceptMethodDeclaration_Menu.ConceptMethodDeclaration_generic_cellMenufmulpzdo()});
  }

  public static class ConceptMethodDeclaration_generic_cellMenufmulpzdo extends AbstractCellMenuPart_Generic_Group {
    public ConceptMethodDeclaration_generic_cellMenufmulpzdo() {
    }
