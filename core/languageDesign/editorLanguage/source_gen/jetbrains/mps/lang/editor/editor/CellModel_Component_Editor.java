...
public class CellModel_Component_Editor extends DefaultNodeEditor {
      ...
      Style inlineStyle = new Style(editorCell) {
        {
          this.set(StyleAttributes.DRAW_BORDER, new AttributeCalculator <Boolean>() {
            ...
            public Boolean calculate(EditorCell cell) {
              return CellModel_Component_Editor.calculateBoolean6025_3(cell);
            }
      ...
      Style inlineStyle = new Style(editorCell) {
        {
          this.set(StyleAttributes.SELECTABLE, new AttributeCalculator <Boolean>() {
            ...
            public Boolean calculate(EditorCell cell) {
              return CellModel_Component_Editor.calculateBoolean6025_0(cell);
            }
      ...
      Style inlineStyle = new Style(editorCell) {
        {
          this.set(StyleAttributes.DRAW_BORDER, new AttributeCalculator <Boolean>() {
            ...
            public Boolean calculate(EditorCell cell) {
              return CellModel_Component_Editor.calculateBoolean6025_4(cell);
            }
      ...
      Style inlineStyle = new Style(editorCell) {
        {
          this.set(StyleAttributes.DRAW_BORDER, new AttributeCalculator <Boolean>() {
            ...
            public Boolean calculate(EditorCell cell) {
              return CellModel_Component_Editor.calculateBoolean6025_1(cell);
            }
  ...
  public static Boolean calculateBoolean6025_0(EditorCell cell) {
    boolean result;
    result = false;
    return result;
  }

  public static Boolean calculateBoolean6025_1(EditorCell cell) {
    boolean result;
    result = true;
    return result;
  }

  public static Boolean calculateBoolean6025_2(EditorCell cell) {
    boolean result;
    result = true;
    return result;
  }

  public static Boolean calculateBoolean6025_3(EditorCell cell) {
    boolean result;
    result = true;
    return result;
  }

  public static Boolean calculateBoolean6025_4(EditorCell cell) {
    boolean result;
    result = true;
    return result;
  }
        ...
        Style inlineStyle = new Style(editorCell) {
          {
            this.set(StyleAttributes.DRAW_BORDER, new AttributeCalculator <Boolean>() {
              ...
              public Boolean calculate(EditorCell cell) {
                return CellModel_Component_Editor.calculateBoolean6025_2(cell);
              }
