...
public class CellMenuPart_ReplaceChild_Group_Editor extends DefaultNodeEditor {
  ...
  public static boolean checkRenderCondition7(SNode node, EditorContext editorContext, IScope scope) {
    return SPropertyOperations.hasValue(node, "presentation", "custom", null);
  }

  public static boolean checkRenderCondition8(SNode node, EditorContext editorContext, IScope scope) {
    return SPropertyOperations.hasValue(node, "presentation", "custom", null);
  }
  ...
  public EditorCell createColumnCell1(EditorContext context, SNode node) {
    ...
    if (CellMenuPart_ReplaceChild_Group_Editor.checkRenderCondition7(node, context, context.getOperationContext().getScope())) {
      editorCell.addEditorCell(this.createRowCell5(context, node));
    }
    if (CellMenuPart_ReplaceChild_Group_Editor.checkRenderCondition8(node, context, context.getOperationContext().getScope())) {
