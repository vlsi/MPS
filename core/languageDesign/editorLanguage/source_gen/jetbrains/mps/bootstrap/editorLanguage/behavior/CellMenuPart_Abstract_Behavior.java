...
import jetbrains.mps.bootstrap.editorLanguage.structure.CellMenuDescriptor;
...
public class CellMenuPart_Abstract_Behavior {
  ...
  public static SNode call_getEditedFeature_1219409924597(SNode thisNode) {
    return BaseAdapter.fromAdapter(CellMenuUtil.getEditedFeature(((CellMenuDescriptor)SNodeOperations.getAdapter(SNodeOperations.getParent(thisNode)))));
  }
