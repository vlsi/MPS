...
public class check_CellModel_RefNodeList_InferenceRule extends AbstractInferenceRule_Runtime implements InferenceRule_Runtime {
  ...
  public void applyRule(final SNode refNodeList, final TypeCheckingContext typeCheckingContext) {
    ...
    if (!(SPropertyOperations.hasValue(lnk, "metaClass", "aggregation", "reference"))) {
      TypeChecker.getInstance().reportTypeError(refNodeList, "aggregation link expected", "r:00000000-0000-4000-0000-011c8959029a(jetbrains.mps.bootstrap.editorLanguage.helgins)", "1180295464579");
    }
    if (!(SPropertyOperations.hasValue(lnk, "sourceCardinality", "0..n", "0..1") || SPropertyOperations.hasValue(lnk, "sourceCardinality", "1..n", "0..1"))) {
      TypeChecker.getInstance().reportTypeError(refNodeList, "multiple cardinality expected", "r:00000000-0000-4000-0000-011c8959029a(jetbrains.mps.bootstrap.editorLanguage.helgins)", "1180295464588");
    }
  }
