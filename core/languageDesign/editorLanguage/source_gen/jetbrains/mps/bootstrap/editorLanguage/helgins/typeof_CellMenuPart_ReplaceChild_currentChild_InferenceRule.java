...
public class typeof_CellMenuPart_ReplaceChild_currentChild_InferenceRule implements InferenceRule_Runtime {
  ...
  public void applyRule(final SNode node) {
    ...
    }
    {
      ...
      TypeChecker.getInstance().reportTypeError(node, "couldn't define concept of child node", "jetbrains.mps.bootstrap.editorLanguage.helgins@3_0", "1221482375385", intentionProvider);
    }
