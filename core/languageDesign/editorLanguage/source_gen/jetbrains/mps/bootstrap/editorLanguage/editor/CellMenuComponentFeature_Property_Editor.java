...
public class CellMenuComponentFeature_Property_Editor extends DefaultNodeEditor {
  ...
  private static void setupBasic_PropertyDeclarationReferenceCell(EditorCell editorCell, SNode node, EditorContext context) {
    editorCell.putUserObject(EditorCell.CELL_ID, node.getId() + "_1166057861191");
  ...
  public EditorCell createPropertyDeclarationReferenceCellinternal(EditorContext context, SNode node, CellProviderWithRole aProvider) {
    ...
    if (editorCell instanceof EditorCell_Label) {
      CellMenuComponentFeature_Property_Editor.setupLabel_PropertyDeclarationReferenceCell((EditorCell_Label)editorCell, node, context);
    }
  ...
  public static class _Inline30 extends AbstractCellProvider {
    ...
    private static void setupBasic_NameCell(EditorCell editorCell, SNode node, EditorContext context) {
      editorCell.putUserObject(EditorCell.CELL_ID, node.getId() + "_1166057861193");
    }
