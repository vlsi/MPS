...
public class typeof_CellActionMap_FunctionParm_selectedNode_InferenceRule extends AbstractInferenceRule_Runtime implements InferenceRule_Runtime {
  ...
  public void applyRule(final SNode node, final TypeCheckingContext typeCheckingContext) {
    ...
    TypeChecker.getInstance().getRuntimeSupport().givetype(new QuotationClass_1().createNode(applicableConcept), node, "r:00000000-0000-4000-0000-011c8959029a(jetbrains.mps.bootstrap.editorLanguage.helgins)", "1179767185667");
  }
