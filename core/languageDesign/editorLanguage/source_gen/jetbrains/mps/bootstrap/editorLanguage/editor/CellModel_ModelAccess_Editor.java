...
public class CellModel_ModelAccess_Editor extends DefaultNodeEditor {
  ...
  private static void setupBasic_RowCell8(EditorCell editorCell, SNode node, EditorContext context) {
    editorCell.putUserObject(EditorCell.CELL_ID, node.getId() + "_0144");
    editorCell.setSelectable(false);
    editorCell.setDrawBorder(true);
  }
  ...
  private static void setupBasic_EditableCell(EditorCell editorCell, SNode node, EditorContext context) {
    editorCell.putUserObject(EditorCell.CELL_ID, node.getId() + "_0160");
    editorCell.setDrawBorder(true);
  }
  ...
  private static void setupBasic_RowCell9(EditorCell editorCell, SNode node, EditorContext context) {
    editorCell.putUserObject(EditorCell.CELL_ID, node.getId() + "_0863");
    editorCell.setSelectable(false);
    editorCell.setDrawBorder(false);
  }

  private static void setupBasic_ConstantCell8(EditorCell editorCell, SNode node, EditorContext context) {
    editorCell.putUserObject(EditorCell.CELL_ID, node.getId() + "_0864");
    editorCell.setSelectable(false);
    editorCell.setDrawBorder(true);
  }
  ...
  public static boolean checkRenderingCondition36(SNode node, EditorContext editorContext, IScope scope) {
    return SPropertyOperations.hasValue(node, "textFgColor", "query", null);
  }

  public static boolean checkRenderingCondition37(SNode node, EditorContext editorContext, IScope scope) {
    return SPropertyOperations.hasValue(node, "textFgColor", "query", null);
  }

  public static boolean checkRenderingCondition38(SNode node, EditorContext editorContext, IScope scope) {
    return SPropertyOperations.hasValue(node, "textBgColor", "query", null);
  }

  public static boolean checkRenderingCondition39(SNode node, EditorContext editorContext, IScope scope) {
  ...
  public EditorCell create_CollectionCell19694_02(EditorContext context, SNode node) {
    ...
    if (CellModel_ModelAccess_Editor.checkRenderingCondition36(node, context, context.getOperationContext().getScope())) {
    ...
    if (CellModel_ModelAccess_Editor.checkRenderingCondition37(node, context, context.getOperationContext().getScope())) {
    ...
    if (CellModel_ModelAccess_Editor.checkRenderingCondition38(node, context, context.getOperationContext().getScope())) {
    ...
    if (CellModel_ModelAccess_Editor.checkRenderingCondition39(node, context, context.getOperationContext().getScope())) {
  ...
  public EditorCell create_CollectionCell19694_019(EditorContext context, SNode node) {
    ...
    editorCell.setUsesBraces(false);
    editorCell.setCanBeFolded(false);
    editorCell.addEditorCell(this.create_ConstantCell19694_022(context, node, "style class"));
    editorCell.addEditorCell(this.create_styleClassRefCell19694_0(context, node));
    return editorCell;
  }
  ...
  public EditorCell create_CollectionCell19694_020(EditorContext context, SNode node) {
    ...
    editorCell.setUsesBraces(false);
    editorCell.setCanBeFolded(false);
    editorCell.addEditorCell(this.create_ConstantCell19694_023(context, node, "text fg."));
  ...
  public EditorCell create_CollectionCell19694_021(EditorContext context, SNode node) {
    ...
    editorCell.setUsesBraces(false);
    editorCell.setCanBeFolded(false);
    editorCell.addEditorCell(this.create_ConstantCell19694_024(context, node, "fg. color query:"));
  ...
  public EditorCell create_CollectionCell19694_023(EditorContext context, SNode node) {
    ...
    editorCell.setUsesBraces(false);
    editorCell.setCanBeFolded(false);
    editorCell.addEditorCell(this.create_ConstantCell19694_026(context, node, "null text fg."));
  ...
  public EditorCell create_CollectionCell19694_024(EditorContext context, SNode node) {
    ...
    editorCell.setUsesBraces(false);
    editorCell.setCanBeFolded(false);
    editorCell.addEditorCell(this.create_ConstantCell19694_027(context, node, "null text fg. color query:"));
  ...
  public EditorCell create_CollectionCell19694_025(EditorContext context, SNode node) {
    ...
    editorCell.setUsesBraces(false);
    editorCell.setCanBeFolded(false);
    editorCell.addEditorCell(this.create_ConstantCell19694_028(context, node, "  "));
  ...
  public EditorCell create_CollectionCell19694_026(EditorContext context, SNode node) {
    ...
    editorCell.setUsesBraces(false);
    editorCell.setCanBeFolded(false);
    editorCell.addEditorCell(this.create_ConstantCell19694_029(context, node, "text bg."));
  ...
  public EditorCell create_CollectionCell19694_027(EditorContext context, SNode node) {
    ...
    editorCell.setUsesBraces(false);
    editorCell.setCanBeFolded(false);
    editorCell.addEditorCell(this.create_ConstantCell19694_030(context, node, "bg. color query:"));
  ...
  public EditorCell create_CollectionCell19694_028(EditorContext context, SNode node) {
    ...
    editorCell.setUsesBraces(false);
    editorCell.setCanBeFolded(false);
    editorCell.addEditorCell(this.create_ConstantCell19694_031(context, node, "  "));
  ...
  public EditorCell create_CollectionCell19694_029(EditorContext context, SNode node) {
    ...
    editorCell.setUsesBraces(false);
    editorCell.setCanBeFolded(false);
    editorCell.addEditorCell(this.create_ConstantCell19694_032(context, node, "text bg.selected"));
  ...
  public EditorCell create_CollectionCell19694_030(EditorContext context, SNode node) {
    ...
    editorCell.setUsesBraces(false);
    editorCell.setCanBeFolded(false);
    editorCell.addEditorCell(this.create_ConstantCell19694_033(context, node, "bg.selected color query:"));
    editorCell.addEditorCell(this.create_CollectionCell19694_031(context, node));
    return editorCell;
  }

  public EditorCell create_CollectionCell19694_031(EditorContext context, SNode node) {
    EditorCell_Collection editorCell = EditorCell_Collection.createHorizontal(context, node);
    setupBasic_RowCell24(editorCell, node, context);
    editorCell.setGridLayout(false);
    editorCell.setUsesBraces(false);
    editorCell.setCanBeFolded(false);
    editorCell.addEditorCell(this.create_ConstantCell19694_034(context, node, "  "));
  ...
  public EditorCell create_ConstantCell19694_034(EditorContext context, SNode node, String text) {
    EditorCell_Constant editorCell = new EditorCell_Constant(context, node, text);
  ...
  public EditorCell create_modelAcessorRefNodeCell19694_0_internal(EditorContext context, SNode node, CellProviderWithRole aProvider) {
    ...
    provider.setAuxiliaryCellProvider(null);
    EditorCell editorCell = provider.createEditorCell(context);
    setupBasic_ModelAcessorCell(editorCell, node, context);
    if (editorCell instanceof EditorCell_Label) {
      setupLabel_ModelAcessorCell((EditorCell_Label)editorCell, node, context);
    }
    editorCell.setSubstituteInfo(provider.createDefaultSubstituteInfo());
    return editorCell;
  }
  ...
  public EditorCell create_styleClassRefCell19694_0_internal(EditorContext context, SNode node, CellProviderWithRole aProvider) {
    CellProviderWithRole provider = aProvider;
  ...
  public EditorCell create_styleClassRefCell19694_0(EditorContext context, SNode node) {
    CellProviderWithRole provider = new RefCellCellProvider(node, context);
    provider.setRole("styleClass");
    provider.setNoTargetText("<no style>");
    provider.setReadOnly(false);
    provider.setAllowsEmptyTarget(false);
    EditorCell cellWithRole = this.create_styleClassRefCell19694_0_internal(context, node, provider);
    SNode attributeConcept = provider.getRoleAttribute();
    Class attributeKind = provider.getRoleAttributeClass();
    if (attributeConcept != null) {
      IOperationContext opContext = context.getOperationContext();
  ...
  public static class _Inline11 extends AbstractCellProvider {
    ...
    public EditorCell createEditorCell(EditorContext context, SNode node) {
      return this.create_namePropertyCell_011(context, node);
    }

    public EditorCell create_namePropertyCell_011_internal(EditorContext context, SNode node, CellProviderWithRole aProvider) {
      CellProviderWithRole provider = aProvider;
      provider.setAuxiliaryCellProvider(null);
      EditorCell editorCell = provider.createEditorCell(context);
    ...
    public EditorCell create_namePropertyCell_011(EditorContext context, SNode node) {
      CellProviderWithRole provider = new PropertyCellProvider(node, context);
      provider.setRole("name");
      provider.setNoTargetText("");
      provider.setReadOnly(true);
      provider.setAllowsEmptyTarget(false);
      EditorCell cellWithRole = this.create_namePropertyCell_011_internal(context, node, provider);
      SNode attributeConcept = provider.getRoleAttribute();
      Class attributeKind = provider.getRoleAttributeClass();
      if (attributeConcept != null) {
        IOperationContext opContext = context.getOperationContext();
  ...
  public static class _Inline39 extends AbstractCellProvider {
    ...
    public EditorCell createEditorCell(EditorContext context, SNode node) {
      return this.create_namePropertyCell_030(context, node);
    }

    public EditorCell create_namePropertyCell_030_internal(EditorContext context, SNode node, CellProviderWithRole aProvider) {
      CellProviderWithRole provider = aProvider;
      provider.setAuxiliaryCellProvider(null);
      EditorCell editorCell = provider.createEditorCell(context);
      setupBasic_NameCell(editorCell, node, context);
    ...
    public EditorCell create_namePropertyCell_030(EditorContext context, SNode node) {
      CellProviderWithRole provider = new PropertyCellProvider(node, context);
      provider.setRole("name");
      provider.setNoTargetText("");
      provider.setReadOnly(true);
      provider.setAllowsEmptyTarget(false);
      EditorCell cellWithRole = this.create_namePropertyCell_030_internal(context, node, provider);
      SNode attributeConcept = provider.getRoleAttribute();
      Class attributeKind = provider.getRoleAttributeClass();
      if (attributeConcept != null) {
        IOperationContext opContext = context.getOperationContext();
