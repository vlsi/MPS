...
public class CaretPositionParameter_Editor extends DefaultNodeEditor {
  ...
  private static void setupBasic_CollectionCell256_0(EditorCell editorCell, SNode node, EditorContext context) {
    editorCell.putUserObject(EditorCell.CELL_ID, node.getId() + "_CollectionCell256_0");
  }

  private static void setupBasic_ConstantCell256_0(EditorCell editorCell, SNode node, EditorContext context) {
    editorCell.putUserObject(EditorCell.CELL_ID, node.getId() + "_ConstantCell256_0");
  }

  private static void setupBasic_ConstantCell256_01(EditorCell editorCell, SNode node, EditorContext context) {
    editorCell.putUserObject(EditorCell.CELL_ID, node.getId() + "_ConstantCell256_01");
  }
  ...
  private static void setupLabel_ConstantCell256_01(EditorCell_Label editorCell, SNode node, EditorContext context) {
  }

  private static void setupLabel_positionRefNodeCell256_0(EditorCell_Label editorCell, SNode node, EditorContext context) {
  }
  ...
  public EditorCell create_CollectionCell256_0(EditorContext context, SNode node) {
    ...
    setupBasic_CollectionCell256_0(editorCell, node, context);
  ...
  public EditorCell create_ConstantCell256_0(EditorContext context, SNode node, String text) {
    ...
    setupBasic_ConstantCell256_0(editorCell, node, context);
    setupLabel_ConstantCell256_0(editorCell, node, context);
  ...
  public EditorCell create_ConstantCell256_01(EditorContext context, SNode node, String text) {
    EditorCell_Constant editorCell = new EditorCell_Constant(context, node, text);
    setupBasic_ConstantCell256_01(editorCell, node, context);
    setupLabel_ConstantCell256_01(editorCell, node, context);
    editorCell.setDefaultText("");
    return editorCell;
  }
  ...
  public EditorCell create_positionRefNodeCell256_0_internal(EditorContext context, SNode node, CellProviderWithRole aProvider) {
    ...
    setupBasic_positionRefNodeCell256_0(editorCell, node, context);
    if (editorCell instanceof EditorCell_Label) {
      setupLabel_positionRefNodeCell256_0((EditorCell_Label)editorCell, node, context);
    }
