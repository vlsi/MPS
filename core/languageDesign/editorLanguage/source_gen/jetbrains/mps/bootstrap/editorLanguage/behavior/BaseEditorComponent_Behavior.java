...
public class BaseEditorComponent_Behavior {
  ...
  public static List<SNode> call_getApplicableComponents_1213877372457(SNode thisNode, IScope scope) {
    ...
    List<SNode> editorComponents = SModelOperations.getRootsIncludingImported(SNodeOperations.getModel(thisNode), scope, "jetbrains.mps.bootstrap.editorLanguage.structure.EditorComponentDeclaration");
