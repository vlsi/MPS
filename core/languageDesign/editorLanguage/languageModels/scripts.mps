...
<model modelUID="r:1222075024029(jetbrains.mps.bootstrap.editorLanguage.scripts)">
  ...
  <import index="2" modelUID="r:1222075024253(jetbrains.mps.bootstrap.dataFlow.structure)" version="-1" />
