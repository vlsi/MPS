...
<model name="jetbrains.mps.bootstrap.structureLanguage.plugin">
  ...
  <node type="jetbrains.mps.bootstrap.pluginLanguage.structure.ActionDeclaration" id="1216650700674">
          ...
          <node role="localVariableDeclaration" type="jetbrains.mps.baseLanguage.structure.LocalVariableDeclaration" id="1216651728626">
            ...
            <node role="initializer" type="jetbrains.mps.baseLanguage.structure.DotExpression" id="1216651728628">
              <node role="operand" type="jetbrains.mps.baseLanguage.structure.DotExpression" id="1216651728629">
                ...
                <node role="operation" type="jetbrains.mps.bootstrap.pluginLanguage.structure.ActionParameterReferenceOperation" id="1216651728631">
              ...
              <node role="actualArgument" type="jetbrains.mps.baseLanguage.structure.GenericNewExpression" id="1216650728478">
                <node role="creator" type="jetbrains.mps.baseLanguage.structure.ClassCreator" id="1216650728479">
                  ...
                  <node role="actualArgument" type="jetbrains.mps.baseLanguage.structure.DotExpression" id="1216650728480">
                    ...
                    <node role="operation" type="jetbrains.mps.bootstrap.pluginLanguage.structure.ActionParameterReferenceOperation" id="1216650728482">
                      <link role="member" targetNodeId="1216650700699" resolveInfo="project" />
                    </node>
                  </node>
                </node>
    ...
    <node role="parameterDeclaration" type="jetbrains.mps.bootstrap.pluginLanguage.structure.ActionParameterDeclaration" id="1216650700696">
    ...
    <node role="parameterDeclaration" type="jetbrains.mps.bootstrap.pluginLanguage.structure.ActionParameterDeclaration" id="1216650700699">
