            ...
            <node role="initializer" type="jetbrains.mps.baseLanguage.structure.NewExpression" id="1201531773383">
              ...
              <node role="actualArgument" type="jetbrains.mps.baseLanguage.structure.DotExpression" id="1204740201528">
                ...
                <node role="operation" type="jetbrains.mps.baseLanguage.structure.InstanceMethodCallOperation"
                      id="1204740201529">
                  <link role="baseMethodDeclaration"
                        targetNodeId="2.~ActionContext.getScope():jetbrains.mps.smodel.IScope" resolveInfo="getScope"/>
                </node>
              </node>
            </node>
          </node>
          ...
          <node role="localVariableDeclaration" type="jetbrains.mps.baseLanguage.structure.LocalVariableDeclaration"
            ...
            <node role="initializer" type="jetbrains.mps.baseLanguage.structure.DotExpression" id="1204740202531">
              ...
              <node role="operation" type="jetbrains.mps.baseLanguage.structure.InstanceMethodCallOperation"
                    id="1204740202532">
                <link role="baseMethodDeclaration"
                      targetNodeId="23.~IResultProvider.getResults(jetbrains.mps.ide.findusages.model.searchquery.SearchQuery,jetbrains.mps.ide.progress.IAdaptiveProgressMonitor):jetbrains.mps.ide.findusages.model.result.SearchResults"
        ...
        <node role="body" type="jetbrains.mps.baseLanguage.structure.StatementList" id="1198689008356">
          ...
          <node role="statement" type="jetbrains.mps.baseLanguage.structure.ReturnStatement" id="1198689023328">
            <node role="expression" type="jetbrains.mps.baseLanguage.structure.NewExpression" id="1198689027174">
              <link role="baseMethodDeclaration"
                    targetNodeId="8.~HierarchicalChooseNodeComponent.&lt;init&gt;(java.lang.String,java.lang.String,jetbrains.mps.ide.action.ActionContext,jetbrains.mps.refactoring.framework.IDescendantsProvider,jetbrains.mps.smodel.SNode)"
              ...
              <node role="actualArgument" type="jetbrains.mps.baseLanguage.structure.NewExpression" id="1198760075273">
                <link role="baseMethodDeclaration" targetNodeId="8.~ConceptAncestorsProvider.&lt;init&gt;()"
                    ...
                    <node role="statement" type="jetbrains.mps.baseLanguage.structure.ExpressionStatement"
                      ...
                      <node role="expression" type="jetbrains.mps.baseLanguage.structure.DotExpression"
                        ...
                        <node role="operation" type="jetbrains.mps.baseLanguage.structure.InstanceMethodCallOperation"
                              id="1204740202654">
                          <link role="baseMethodDeclaration"
                                targetNodeId="21.~SearchResults.remove(jetbrains.mps.smodel.SNode):void"
                                resolveInfo="remove"/>
                          <node role="actualArgument" type="jetbrains.mps.baseLanguage.structure.DotExpression"
                                id="1204740201501">
                            <node role="operand"
                                  type="jetbrains.mps.logging.refactoring.structure.RequiredAdditionalArgumentReference"
                                  id="1202135778426">
                              <link role="argument" targetNodeId="1201283883838"
                                    resolveInfo="conceptEditorDeclaration"/>
                            </node>
                            <node role="operation"
                                  type="jetbrains.mps.baseLanguage.structure.InstanceMethodCallOperation"
