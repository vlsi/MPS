...
public class BooleanConceptPropertyDeclaration_Editor extends DefaultNodeEditor {
  ...
  private static void setupLabel_namePropertyCell14194_0(EditorCell_Label editorCell, SNode node, EditorContext context) {
  }
  ...
  public EditorCell create_CollectionCell14194_0(EditorContext context, SNode node) {
    ...
    editorCell.addEditorCell(this.create_ConstantCell14194_0(context, node, "boolean"));
    editorCell.addEditorCell(this.create_namePropertyCell14194_0(context, node));
    return editorCell;
  }
  ...
  public EditorCell create_namePropertyCell14194_0_internal(EditorContext context, SNode node, CellProviderWithRole aProvider) {
    CellProviderWithRole provider = aProvider;
    provider.setAuxiliaryCellProvider(null);
    EditorCell editorCell = provider.createEditorCell(context);
    setupBasic_namePropertyCell14194_0(editorCell, node, context);
    if (editorCell instanceof EditorCell_Label) {
      setupLabel_namePropertyCell14194_0((EditorCell_Label)editorCell, node, context);
    }
    editorCell.setSubstituteInfo(provider.createDefaultSubstituteInfo());
    return editorCell;
  }

  public EditorCell create_namePropertyCell14194_0(EditorContext context, SNode node) {
    CellProviderWithRole provider = new PropertyCellProvider(node, context);
    provider.setRole("name");
    provider.setNoTargetText("<no name>");
    provider.setReadOnly(false);
    provider.setAllowsEmptyTarget(false);
    EditorCell cellWithRole = this.create_namePropertyCell14194_0_internal(context, node, provider);
