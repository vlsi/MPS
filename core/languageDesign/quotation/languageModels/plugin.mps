...
<model modelUID="r:0721b2d0-d01b-4c4c-98df-39cdc7d62aee(jetbrains.mps.lang.quotation.plugin)">
  ...
  <node type="jetbrains.mps.lang.plugin.structure.ActionDeclaration:23" id="3981318653438276869">
    ...
    <node role="parameter:23" type="jetbrains.mps.lang.plugin.structure.ActionParameterDeclaration:23" id="3981318653438278529">
      ...
      <node role="type:23" type="jetbrains.mps.lang.smodel.structure.SNodeType:16" id="3981318653438278531">
        <link role="concept:16" targetNodeId="2v.1133920641626:0" resolveInfo="BaseConcept" />
      </node>
    </node>
    <node role="parameter:23" type="jetbrains.mps.lang.plugin.structure.ActionDataParameterDeclaration:23" id="3981318653438329578">
      <property name="name:23" value="component" />
      <link role="key:23" targetNodeId="3.~PlatformDataKeys.CONTEXT_COMPONENT" resolveInfo="CONTEXT_COMPONENT" />
    </node>
    <node role="executeFunction:23" type="jetbrains.mps.lang.plugin.structure.ExecuteBlock:23" id="3981318653438276870">
      <node role="body:23" type="jetbrains.mps.baseLanguage.structure.StatementList:3" id="3981318653438276871">
        <node role="statement:3" type="jetbrains.mps.baseLanguage.structure.LocalVariableDeclarationStatement:3" id="3981318653438280035">
          <node role="localVariableDeclaration:3" type="jetbrains.mps.baseLanguage.structure.LocalVariableDeclaration:3" id="3981318653438280036">
            <property name="name:3" value="metaLevel" />
            <node role="type:3" type="jetbrains.mps.baseLanguage.structure.IntegerType:3" id="3981318653438280037" />
            <node role="initializer:3" type="jetbrains.mps.baseLanguage.structure.DotExpression:3" id="3981318653438280038">
              <node role="operand:3" type="jetbrains.mps.baseLanguage.structure.DotExpression:3" id="3981318653438280039">
                <node role="operand:3" type="jetbrains.mps.baseLanguage.classifiers.structure.ThisClassifierExpression:0" id="3981318653438280040" />
                <node role="operation:3" type="jetbrains.mps.lang.plugin.structure.ActionParameterReferenceOperation:23" id="3981318653438280041">
                  <link role="member:23" targetNodeId="3981318653438278529" resolveInfo="currentNode" />
                </node>
              </node>
              <node role="operation:3" type="jetbrains.mps.lang.smodel.structure.Node_ConceptMethodCall:16" id="3981318653438280042">
                <link role="baseMethodDeclaration:16" targetNodeId="4.3981318653438234726" resolveInfo="getMetaLevel" />
              </node>
            </node>
          </node>
        </node>
        <node role="statement:3" type="jetbrains.mps.baseLanguage.structure.ExpressionStatement:3" id="3981318653438301381">
          <node role="expression:3" type="jetbrains.mps.baseLanguage.structure.StaticMethodCall:3" id="3981318653438329576">
            <link role="baseMethodDeclaration:3" targetNodeId="2.~JOptionPane.showMessageDialog(java.awt.Component,java.lang.Object):void" resolveInfo="showMessageDialog" />
            <link role="classConcept:3" targetNodeId="2.~JOptionPane" resolveInfo="JOptionPane" />
            <node role="actualArgument:3" type="jetbrains.mps.baseLanguage.structure.DotExpression:3" id="3981318653438329579">
              <node role="operand:3" type="jetbrains.mps.baseLanguage.classifiers.structure.ThisClassifierExpression:0" id="3981318653438329580" />
              <node role="operation:3" type="jetbrains.mps.lang.plugin.structure.ActionDataParameterReferenceOperation:23" id="3981318653438329581">
                <link role="member:23" targetNodeId="3981318653438329578" resolveInfo="component" />
              </node>
            </node>
            <node role="actualArgument:3" type="jetbrains.mps.baseLanguage.structure.LocalVariableReference:3" id="3981318653438329583">
              <link role="variableDeclaration:3" targetNodeId="3981318653438280036" resolveInfo="metaLevel" />
            </node>
          </node>
        </node>
      </node>
  ...
  <node type="jetbrains.mps.lang.plugin.structure.ActionGroupDeclaration:23" id="3981318653438329584">
    ...
    <node role="contents:23" type="jetbrains.mps.lang.plugin.structure.ElementListContents:23" id="3981318653438329586">
      <node role="reference:23" type="jetbrains.mps.lang.plugin.structure.ActionInstance:23" id="3981318653438329587">
        <link role="action:23" targetNodeId="3981318653438276869" resolveInfo="ShowMetaLevel" />
      </node>
    </node>
  </node>
</model>
