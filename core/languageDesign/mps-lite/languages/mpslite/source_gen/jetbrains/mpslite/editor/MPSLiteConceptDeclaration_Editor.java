...
public class MPSLiteConceptDeclaration_Editor extends DefaultNodeEditor {
  ...
  /* package */AbstractCellListHandler myListHandler_3196_0;
  ...
  public EditorCell createCollection_3196_5(EditorContext context, SNode node) {
    ...
    editorCell.setUsesBraces(false);
    editorCell.setCanBeFolded(false);
    editorCell.addEditorCell(this.createCollection_3196_6(context, node));
    return editorCell;
  }

  public EditorCell createCollection_3196_6(EditorContext context, SNode node) {
    EditorCell_Collection editorCell = EditorCell_Collection.createHorizontal(context, node);
    setupBasic_Collection_3196_6(editorCell, node, context);
    editorCell.setGridLayout(false);
    editorCell.setUsesBraces(false);
    editorCell.setCanBeFolded(false);
    editorCell.addEditorCell(this.createConstant_3196_6(context, node, "    "));
    editorCell.addEditorCell(this.createRefNodeList_3196_0(context, node));
    return editorCell;
  }
  ...
  public EditorCell createRefNodeList_3196_0(EditorContext context, SNode node) {
    if (this.myListHandler_3196_0 == null) {
      this.myListHandler_3196_0 = new MPSLiteConceptDeclaration_Editor.lineListHandler_3196_0(node, "line", context);
    }
    EditorCell_Collection editorCell = this.myListHandler_3196_0.createCells(context, new CellLayout_Vertical(), false);
    setupBasic_RefNodeList_3196_0(editorCell, node, context);
    editorCell.setGridLayout(false);
    editorCell.setUsesBraces(false);
    editorCell.setCanBeFolded(false);
    editorCell.setRole(this.myListHandler_3196_0.getElementRole());
    return editorCell;
  }
  ...
  private static void setupBasic_Collection_3196_6(EditorCell editorCell, SNode node, EditorContext context) {
    editorCell.setCellId("Collection_3196_6");
    {
      Style inlineStyle = new Style(editorCell) {
        {
          this.set(StyleAttributes.SELECTABLE, false);
  ...
  private static void setupBasic_RefNodeList_3196_0(EditorCell editorCell, SNode node, EditorContext context) {
  ...
  private static void setupLabel_RefNodeList_3196_0(EditorCell_Label editorCell, SNode node, EditorContext context) {
  }
  ...
  public static class lineListHandler_3196_0 extends RefNodeListHandler {

    public lineListHandler_3196_0(SNode ownerNode, String childRole, EditorContext context) {
    ...
    public EditorCell createEmptyCell_internal(EditorContext context, SNode node) {
      return this.createConstant_3196_7(context, node, "---");
    }
    ...
    public EditorCell createConstant_3196_7(EditorContext context, SNode node, String text) {
      EditorCell_Constant editorCell = new EditorCell_Constant(context, node, text);
      setupBasic_Constant_3196_7(editorCell, node, context);
      setupLabel_Constant_3196_7(editorCell, node, context);
      editorCell.setDefaultText("");
      return editorCell;
    }


    private static void setupBasic_Constant_3196_7(EditorCell editorCell, SNode node, EditorContext context) {
      editorCell.setCellId("Constant_3196_7");
    }

    private static void setupLabel_Constant_3196_7(EditorCell_Label editorCell, SNode node, EditorContext context) {
    }
