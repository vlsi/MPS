...
public class ConcreteChildPart extends ChildPart implements INamedConcept {
  ...
  public MPSLiteConceptDeclaration getTarget() {
    return (MPSLiteConceptDeclaration)this.getReferent(MPSLiteConceptDeclaration.class, ConcreteChildPart.TARGET);
  }

  public void setTarget(MPSLiteConceptDeclaration node) {
    super.setReferent(ConcreteChildPart.TARGET, node);
  }
