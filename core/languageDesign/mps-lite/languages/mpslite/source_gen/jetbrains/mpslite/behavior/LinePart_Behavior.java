...
public class LinePart_Behavior {
  ...
  private static Class[] PARAMETERS_1238614099938 = {SNode.class ,SNode.class ,Map.class};
  ...
  public static SNode call_createCellModel_1238614099938(SNode thisNode, SNode templateBasedConcept, Map<SNode, SNode> linePartsToLinks) {
    return (SNode)BehaviorManager.getInstance().invoke(Object.class, thisNode, "virtual_createCellModel_1238614099938", PARAMETERS_1238614099938, templateBasedConcept, linePartsToLinks);
  }
  ...
  public static SNode callSuper_createCellModel_1238614099938(SNode thisNode, String callerConceptFqName, SNode templateBasedConcept, Map<SNode, SNode> linePartsToLinks) {
    return (SNode)BehaviorManager.getInstance().invokeSuper(Object.class, thisNode, callerConceptFqName, "virtual_createCellModel_1238614099938", PARAMETERS_1238614099938, templateBasedConcept, linePartsToLinks);
  }
