...
public class ConcreteReferencePart extends jetbrains.mpslite.structure.ReferencePart implements jetbrains.mps.lang.core.structure.INamedConcept, jetbrains.mpslite.structure.Concretization {
  ...
  public jetbrains.mpslite.structure.AbstractConceptReference getConceptReference() {
    return (jetbrains.mpslite.structure.AbstractConceptReference)this.getChild(AbstractConceptReference.class, ConcreteReferencePart.CONCEPT_REFERENCE);
  }

  public void setConceptReference(jetbrains.mpslite.structure.AbstractConceptReference node) {
