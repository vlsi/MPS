...
public class ConcreteReferencePart extends ReferencePart implements INamedConcept {
  ...
  public MPSLiteConceptDeclaration getTarget() {
    return (MPSLiteConceptDeclaration)this.getReferent(MPSLiteConceptDeclaration.class, ConcreteReferencePart.TARGET);
  }

  public void setTarget(MPSLiteConceptDeclaration node) {
