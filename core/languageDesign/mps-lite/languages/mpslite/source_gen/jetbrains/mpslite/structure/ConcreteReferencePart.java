...
public class ConcreteReferencePart extends jetbrains.mpslite.structure.ReferencePart implements jetbrains.mps.lang.core.structure.INamedConcept {
  ...
  public jetbrains.mpslite.structure.MPSLiteConceptDeclaration getTarget() {
    return (jetbrains.mpslite.structure.MPSLiteConceptDeclaration)this.getReferent(MPSLiteConceptDeclaration.class, ConcreteReferencePart.TARGET);
  }

  public void setTarget(jetbrains.mpslite.structure.MPSLiteConceptDeclaration node) {
    super.setReferent(ConcreteReferencePart.TARGET, node);
  }
