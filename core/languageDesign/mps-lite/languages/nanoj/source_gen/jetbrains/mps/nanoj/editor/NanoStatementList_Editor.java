...
public class NanoStatementList_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createRefNodeList_6819_0(EditorContext editorContext, SNode node) {
    AbstractCellListHandler handler = new NanoStatementList_Editor.bodyListHandler_6819_0(node, "body", editorContext);
