...
public class QueryFunction_ParameterizedSubstitute_String extends ConceptFunction implements ISubstitute_String {
  ...
  public int get_$attributesCount() {
    return this.getChildCount(QueryFunction_ParameterizedSubstitute_String._$ATTRIBUTE);
  }

  public Iterator<Attribute> _$attributes() {
    return this.children(Attribute.class, QueryFunction_ParameterizedSubstitute_String._$ATTRIBUTE);
  }

  public List<Attribute> get_$attributes() {
    return this.getChildren(Attribute.class, QueryFunction_ParameterizedSubstitute_String._$ATTRIBUTE);
  }

  public void add_$attribute(Attribute node) {
    this.addChild(QueryFunction_ParameterizedSubstitute_String._$ATTRIBUTE, node);
  }

  public void insert_$attribute(Attribute prev, Attribute node) {
    this.insertChild(prev, QueryFunction_ParameterizedSubstitute_String._$ATTRIBUTE, node);
  }
