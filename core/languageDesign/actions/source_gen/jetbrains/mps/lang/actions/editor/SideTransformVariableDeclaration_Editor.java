...
public class SideTransformVariableDeclaration_Editor extends DefaultNodeEditor {
  ...
  public EditorCell createCollection_5389_0(EditorContext context, SNode node) {
    ...
    editorCell.addEditorCell(this.createConstant_5389_0(context, node, "="));
  ...
  public EditorCell createCollection_5389_1(EditorContext context, SNode node) {
    ...
    editorCell.addEditorCell(this.createConstant_5389_1(context, node, ""));
    return editorCell;
  }
  ...
  public EditorCell createRefNode_5389_0_internal(EditorContext context, SNode node, CellProviderWithRole provider) {
  ...
  public EditorCell createProperty_5389_0_internal(EditorContext context, SNode node, CellProviderWithRole provider) {
    EditorCell editorCell = provider.createEditorCell(context);
  ...
  public EditorCell createRefNode_5389_2_internal(EditorContext context, SNode node, CellProviderWithRole provider) {
    EditorCell editorCell = provider.createEditorCell(context);
    editorCell.setSubstituteInfo(provider.createDefaultSubstituteInfo());
    return editorCell;
  }
