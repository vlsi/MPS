...
public class typeof_ConceptFunctionParameter_nodeToCopyPreProcess_InferenceRule extends AbstractInferenceRule_Runtime implements InferenceRule_Runtime {
  ...
  public static class QuotationClass_74scda_a0a0a0 {
    ...
    public SNode createNode(Object parameter_74scda_a0a0a0a0, final TypeCheckingContext typeCheckingContext) {
      SNode result = null;
      Set<SNode> _parameterValues_129834374 = new HashSet<SNode>();
      SNode quotedNode_74scda_a0a0a0 = null;
      {
        quotedNode_74scda_a0a0a0 = SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.lang.smodel.structure.SNodeType", TypeChecker.getInstance().getRuntimeTypesModel(), GlobalScope.getInstance(), false);
        SNode quotedNode1_74scda_a0a0a0 = quotedNode_74scda_a0a0a0;
        quotedNode1_74scda_a0a0a0.setReferent("concept", (SNode) parameter_74scda_a0a0a0a0);
        result = quotedNode1_74scda_a0a0a0;
      }
      return result;
    }

    public SNode createNode(Object parameter_74scda_a0a0a0a0) {
      SNode result = null;
      Set<SNode> _parameterValues_129834374 = new HashSet<SNode>();
      SNode quotedNode_74scda_a0a0a0 = null;
      {
