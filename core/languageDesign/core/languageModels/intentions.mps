...
<model modelUID="r:00000000-0000-4000-0000-011c89590285(jetbrains.mps.core.intentions)">
  ...
  <languageAspect
    modelUID="r:00000000-0000-4000-0000-011c8959034f(jetbrains.mps.bootstrap.intentionsLanguage.constraints)"
    version="1"/>
  ...
  <languageAspect modelUID="r:00000000-0000-4000-0000-011c895902ba(jetbrains.mps.bootstrap.sharedConcepts.constraints)"
                  version="0"/>
  <languageAspect
            ...
            <node role="rightExpression" type="jetbrains.mps.baseLanguage.structure.PlusExpression" id="1209383953317">
              ...
              <node role="leftExpression" type="jetbrains.mps.baseLanguage.structure.DotExpression" id="1209383946791">
                ...
                <node role="operation" type="jetbrains.mps.baseLanguage.structure.InstanceMethodCallOperation"
                      id="1209383950488">
                  <link role="baseMethodDeclaration" targetNodeId="2.~SNode.getLanguageNamespace():java.lang.String"
                        resolveInfo="getLanguageNamespace"/>
                </node>
              </node>
            </node>
          ...
          <node role="expression" type="jetbrains.mps.baseLanguage.structure.DotExpression" id="1209384001893">
            <node role="operand" type="jetbrains.mps.baseLanguage.structure.DotExpression" id="1209384000468">
              <node role="operand" type="jetbrains.mps.baseLanguage.structure.DotExpression" id="1209383995837">
                ...
                <node role="operation" type="jetbrains.mps.baseLanguage.structure.InstanceMethodCallOperation"
                  ...
                  <link role="baseMethodDeclaration"
                        targetNodeId="3.~EditorContext.getOperationContext():jetbrains.mps.smodel.IOperationContext"
              ...
              <node role="operation" type="jetbrains.mps.baseLanguage.structure.InstanceMethodCallOperation"
                    id="1209384001674">
                <link role="baseMethodDeclaration"
                      targetNodeId="2.~IOperationContext.getModule():jetbrains.mps.project.IModule"
            ...
            <node role="operation" type="jetbrains.mps.baseLanguage.structure.InstanceMethodCallOperation"
                  id="1209384006437">
              <link role="baseMethodDeclaration"
                    targetNodeId="4.~IModule.addUsedLangauge(jetbrains.mps.project.ModuleReference):void"
                    resolveInfo="addUsedLangauge"/>
              <node role="actualArgument" type="jetbrains.mps.baseLanguage.structure.DotExpression" id="1222268400854">
                <node role="operand" type="jetbrains.mps.baseLanguage.structure.DotExpression" id="1209384011866">
                  ...
                  <node role="operation" type="jetbrains.mps.baseLanguage.structure.InstanceMethodCallOperation"
                        id="1222268391701">
                    <link role="baseMethodDeclaration"
                          targetNodeId="2.~SNode.getLanguage(jetbrains.mps.smodel.IScope):jetbrains.mps.smodel.Language"
                    ...
                    <node role="actualArgument" type="jetbrains.mps.baseLanguage.structure.DotExpression"
                      ...
                      <node role="operation" type="jetbrains.mps.baseLanguage.structure.InstanceMethodCallOperation"
                            id="1222268398517">
                        <link role="baseMethodDeclaration"
                              targetNodeId="3.~EditorContext.getScope():jetbrains.mps.smodel.IScope"
                ...
                <node role="operation" type="jetbrains.mps.baseLanguage.structure.InstanceMethodCallOperation"
                      id="1222268403809">
                  <link role="baseMethodDeclaration"
                        targetNodeId="4.~AbstractModule.getModuleReference():jetbrains.mps.project.ModuleReference"
                        resolveInfo="getModuleReference"/>
                </node>
              </node>
            </node>
          </node>
      ...
      <node role="body" type="jetbrains.mps.baseLanguage.structure.StatementList" id="1209384963620">
          ...
          <node role="localVariableDeclaration" type="jetbrains.mps.baseLanguage.structure.LocalVariableDeclaration"
            ...
            <node role="initializer" type="jetbrains.mps.baseLanguage.structure.DotExpression" id="1209384989618">
              ...
              <node role="operation" type="jetbrains.mps.baseLanguage.structure.InstanceMethodCallOperation"
                    id="1209384990782">
                <link role="baseMethodDeclaration"
                      targetNodeId="3.~EditorContext.getScope():jetbrains.mps.smodel.IScope" resolveInfo="getScope"/>
              </node>
            </node>
          </node>
        </node>
        <node role="statement" type="jetbrains.mps.baseLanguage.structure.ForeachStatement" id="1209384972498">
          <node role="iterable" type="jetbrains.mps.baseLanguage.structure.DotExpression" id="1209384979085">
            ...
            <node role="operation" type="jetbrains.mps.baseLanguage.structure.InstanceMethodCallOperation"
                  id="1209384982627">
              <link role="baseMethodDeclaration" targetNodeId="2.~SNode.getReferences():java.util.List"
                    resolveInfo="getReferences"/>
            </node>
          </node>
              ...
              <node role="localVariableDeclaration" type="jetbrains.mps.baseLanguage.structure.LocalVariableDeclaration"
                ...
                <node role="initializer" type="jetbrains.mps.baseLanguage.structure.DotExpression" id="1209385154012">
                  ...
                  <node role="operation" type="jetbrains.mps.baseLanguage.structure.InstanceMethodCallOperation"
                        id="1222094716646">
                    <link role="baseMethodDeclaration"
                          targetNodeId="2.~SReference.getTargetSModelReference():jetbrains.mps.smodel.SModelReference"
                          resolveInfo="getTargetSModelReference"/>
                  </node>
                </node>
              </node>
            </node>
                ...
                <node role="rightExpression" type="jetbrains.mps.baseLanguage.structure.NotEqualsExpression"
                  ...
                  <node role="leftExpression" type="jetbrains.mps.baseLanguage.structure.DotExpression"
                    ...
                    <node role="operand" type="jetbrains.mps.baseLanguage.structure.StaticMethodCall"
                          id="1209385211106">
                      <link role="baseMethodDeclaration"
                            targetNodeId="4.~GlobalScope.getInstance():jetbrains.mps.project.GlobalScope"
                    ...
                    <node role="operation" type="jetbrains.mps.baseLanguage.structure.InstanceMethodCallOperation"
                          id="1209385214301">
                      <link role="baseMethodDeclaration"
                            targetNodeId="4.~GlobalScope.getModelDescriptor(jetbrains.mps.smodel.SModelReference):jetbrains.mps.smodel.SModelDescriptor"
                ...
                <node role="leftExpression" type="jetbrains.mps.baseLanguage.structure.EqualsExpression"
                  ...
                  <node role="leftExpression" type="jetbrains.mps.baseLanguage.structure.DotExpression"
                    ...
                    <node role="operation" type="jetbrains.mps.baseLanguage.structure.InstanceMethodCallOperation"
                          id="1209384997231">
                      <link role="baseMethodDeclaration"
                            targetNodeId="2.~IScope.getModelDescriptor(jetbrains.mps.smodel.SModelReference):jetbrains.mps.smodel.SModelDescriptor"
                            resolveInfo="getModelDescriptor"/>
                      <node role="actualArgument" type="jetbrains.mps.baseLanguage.structure.LocalVariableReference"
                            id="1209385154031">
                        <link role="variableDeclaration" targetNodeId="1209385154010" resolveInfo="uid"/>
              ...
              <node role="ifTrue" type="jetbrains.mps.baseLanguage.structure.StatementList" id="1209384983304">
                <node role="statement" type="jetbrains.mps.baseLanguage.structure.LocalVariableDeclarationStatement"
                  ...
                  <node role="localVariableDeclaration"
                        type="jetbrains.mps.baseLanguage.structure.LocalVariableDeclaration" id="1209385165279">
                  ...
                  <node role="expression" type="jetbrains.mps.baseLanguage.structure.PlusExpression" id="1209385242563">
                    <node role="rightExpression" type="jetbrains.mps.baseLanguage.structure.DotExpression"
                      ...
                      <node role="operation" type="jetbrains.mps.baseLanguage.structure.InstanceMethodCallOperation"
                            id="1209385245685">
                        <link role="baseMethodDeclaration"
                              targetNodeId="2.~SModelDescriptor.getModule():jetbrains.mps.project.IModule"
                              resolveInfo="getModule"/>
                      </node>
                    </node>
        ...
        <node role="statement" type="jetbrains.mps.baseLanguage.structure.ThrowStatement" id="1209385248988">
          <node role="throwable" type="jetbrains.mps.baseLanguage.structure.GenericNewExpression" id="1217888335958">
            <node role="creator" type="jetbrains.mps.baseLanguage.structure.ClassCreator" id="1217888335960">
              <link role="baseMethodDeclaration" targetNodeId="5.~RuntimeException.&lt;init&gt;()"
            ...
            <node role="statement" type="jetbrains.mps.baseLanguage.structure.IfStatement" id="1209385300996">
              ...
              <node role="ifTrue" type="jetbrains.mps.baseLanguage.structure.StatementList" id="1209385301010">
                <node role="statement" type="jetbrains.mps.baseLanguage.structure.LocalVariableDeclarationStatement"
                      id="1209385301011">
                  <node role="localVariableDeclaration"
                        type="jetbrains.mps.baseLanguage.structure.LocalVariableDeclaration" id="1209385301012">
                    <property name="name" value="sm"/>
                ...
                <node role="statement" type="jetbrains.mps.baseLanguage.structure.ExpressionStatement"
                  ...
                  <node role="expression" type="jetbrains.mps.baseLanguage.structure.DotExpression" id="1209385315968">
                    ...
                    <node role="operation" type="jetbrains.mps.baseLanguage.structure.InstanceMethodCallOperation"
                          id="1209385319386">
                      <link role="baseMethodDeclaration"
                            targetNodeId="4.~IModule.addDependency(jetbrains.mps.project.ModuleReference,boolean):void"
                            resolveInfo="addDependency"/>
                      <node role="actualArgument" type="jetbrains.mps.baseLanguage.structure.DotExpression"
                            id="1209385322361">
                        ...
                        <node role="operation" type="jetbrains.mps.baseLanguage.structure.InstanceMethodCallOperation"
                              id="1222268327592">
                          <link role="baseMethodDeclaration"
                                targetNodeId="4.~IModule.getModuleReference():jetbrains.mps.project.ModuleReference"
                                resolveInfo="getModuleReference"/>
                        </node>
                      </node>
