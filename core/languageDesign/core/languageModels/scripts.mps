...
<model modelUID="r:00000000-0000-4000-0000-011c89590287(jetbrains.mps.lang.core.scripts)">
  ...
  <node type="jetbrains.mps.lang.refactoring.structure.Refactoring" id="1198076144993">
      ...
      <node role="body" type="jetbrains.mps.baseLanguage.structure.StatementList" id="1198077595127">
        <node role="statement" type="jetbrains.mps.baseLanguage.structure.IfStatement" id="1198077659039">
          ...
          <node role="condition" type="jetbrains.mps.baseLanguage.structure.DotExpression" id="1207782886125">
            <node role="operand" type="jetbrains.mps.lang.refactoring.structure.NodesExpression" id="1215086367921" />
            <node role="operation" type="jetbrains.mps.baseLanguage.collections.structure.IsEmptyOperation" id="1215086378675" />
          </node>
        </node>
  ...
  <node type="jetbrains.mps.lang.refactoring.structure.Refactoring" id="1199457919461">
    ...
    <node role="isApplicableClause" type="jetbrains.mps.lang.refactoring.structure.IsApplicableClause" id="1199458011650">
      <node role="body" type="jetbrains.mps.baseLanguage.structure.StatementList" id="1199458011651">
        <node role="statement" type="jetbrains.mps.baseLanguage.structure.IfStatement" id="4706738529699577904">
          <node role="ifTrue" type="jetbrains.mps.baseLanguage.structure.StatementList" id="4706738529699577905">
            <node role="statement" type="jetbrains.mps.baseLanguage.structure.ReturnStatement" id="4706738529699577913">
              <node role="expression" type="jetbrains.mps.baseLanguage.structure.BooleanConstant" id="4706738529699577915">
                <property name="value" value="false" />
              </node>
            </node>
          </node>
          <node role="condition" type="jetbrains.mps.baseLanguage.structure.EqualsExpression" id="4706738529699577909">
            <node role="rightExpression" type="jetbrains.mps.baseLanguage.structure.NullLiteral" id="4706738529699577912" />
            <node role="leftExpression" type="jetbrains.mps.lang.refactoring.structure.NodeExpression" id="4706738529699577908" />
          </node>
        </node>
        <node role="statement" type="jetbrains.mps.baseLanguage.structure.ReturnStatement" id="4706738529699924207">
          <node role="expression" type="jetbrains.mps.baseLanguage.structure.StaticMethodCall" id="4706738529699924210">
            ...
            <node role="actualArgument" type="jetbrains.mps.lang.refactoring.structure.NodeExpression" id="4706738529699924211" />
          </node>
        </node>
      </node>
    </node>
  ...
  <node type="jetbrains.mps.lang.refactoring.structure.Refactoring" id="1200665013408">
    ...
    <link role="applicableConcept" targetNodeId="1.1133920641626" resolveInfo="BaseConcept" />
    <node role="isApplicableClause" type="jetbrains.mps.lang.refactoring.structure.IsApplicableClause" id="1200666435294">
      <node role="body" type="jetbrains.mps.baseLanguage.structure.StatementList" id="1200666435295">
        <node role="statement" type="jetbrains.mps.baseLanguage.structure.ReturnStatement" id="1200667324293">
          <node role="expression" type="jetbrains.mps.baseLanguage.structure.NotEqualsExpression" id="6528618226609612967">
            <node role="rightExpression" type="jetbrains.mps.baseLanguage.structure.NullLiteral" id="6528618226609612970" />
            <node role="leftExpression" type="jetbrains.mps.lang.refactoring.structure.NodeExpression" id="6528618226609612966" />
          </node>
        </node>
      </node>
    </node>
