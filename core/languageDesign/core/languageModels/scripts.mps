        ...
        <node role="statement" type="jetbrains.mps.baseLanguage.structure.LocalVariableDeclarationStatement" id="1209124107217">
          <node role="localVariableDeclaration" type="jetbrains.mps.baseLanguage.structure.LocalVariableDeclaration" id="1209124107218">
            ...
            <node role="initializer" type="jetbrains.mps.baseLanguage.structure.DotExpression" id="1209124132364">
              ...
              <node role="operation" type="jetbrains.mps.baseLanguage.structure.InstanceMethodCallOperation" id="1222085981514">
                <link role="baseMethodDeclaration" targetNodeId="2v.~SModelDescriptor.getModelFqName():jetbrains.mps.smodel.SModelFqName" resolveInfo="getModelFqName" />
              </node>
            </node>
          </node>
        </node>
                ...
                <node role="initializer" type="jetbrains.mps.baseLanguage.structure.StaticMethodCall" id="1215419811190">
                  ...
                  <node role="actualArgument" type="jetbrains.mps.baseLanguage.structure.DotExpression" id="1215419815692">
                    <node role="operand" type="jetbrains.mps.baseLanguage.structure.DotExpression" id="1215419815693">
                      ...
                      <node role="operation" type="jetbrains.mps.baseLanguage.structure.InstanceMethodCallOperation" id="1215419815695">
                        <link role="baseMethodDeclaration" targetNodeId="2v.~SModelDescriptor.getModelUID():jetbrains.mps.smodel.SModelReference" resolveInfo="getModelUID" />
                      </node>
                    </node>
