                ...
                <node role="initializer" type="jetbrains.mps.baseLanguage.structure.NewExpression" id="1199556412768">
                  ...
                  <node role="actualArgument" type="jetbrains.mps.baseLanguage.structure.DotExpression"
                    ...
                    <node role="operation" type="jetbrains.mps.baseLanguage.structure.InstanceMethodCallOperation"
                          id="1207782883084">
                      <link role="baseMethodDeclaration"
                            targetNodeId="5.~IOperationContext.getProject():jetbrains.mps.project.MPSProject"
              ...
              <node role="ifTrue" type="jetbrains.mps.baseLanguage.structure.StatementList" id="1199555326182">
                <node role="statement" type="jetbrains.mps.baseLanguage.structure.ExpressionStatement"
                  ...
                  <node role="expression" type="jetbrains.mps.baseLanguage.structure.StaticMethodCall"
                        id="1199555337394">
                    <link role="baseMethodDeclaration"
                          targetNodeId="17.~NavigationActionProcessor.navigateToNode(jetbrains.mps.smodel.SNode,jetbrains.mps.smodel.IOperationContext,boolean):void"
                          resolveInfo="navigateToNode"/>
                    <link role="classConcept" targetNodeId="17.~NavigationActionProcessor"
        ...
        <node role="statement" type="jetbrains.mps.baseLanguage.structure.LocalVariableDeclarationStatement"
          ...
          <node role="localVariableDeclaration" type="jetbrains.mps.baseLanguage.structure.LocalVariableDeclaration"
            ...
            <node role="type" type="jetbrains.mps.baseLanguage.structure.ClassifierType" id="1201529581252">
              <link role="classifier" targetNodeId="24.~IAdaptiveProgressMonitor"
            ...
            <node role="initializer" type="jetbrains.mps.baseLanguage.structure.DotExpression" id="1207782886127">
              ...
              <node role="operation" type="jetbrains.mps.baseLanguage.structure.InstanceMethodCallOperation"
                    id="1207782886128">
                <link role="baseMethodDeclaration"
                      targetNodeId="16.~AbstractProjectFrame.createAdaptiveProgressMonitor():jetbrains.mps.ide.progress.IAdaptiveProgressMonitor"
          ...
          <node role="localVariableDeclaration" type="jetbrains.mps.baseLanguage.structure.LocalVariableDeclaration"
            ...
            <node role="initializer" type="jetbrains.mps.baseLanguage.structure.DotExpression" id="1207782886137">
              ...
              <node role="operation" type="jetbrains.mps.baseLanguage.structure.InstanceMethodCallOperation"
                    id="1207782886138">
                <link role="baseMethodDeclaration"
                      targetNodeId="26.~IResultProvider.getResults(jetbrains.mps.ide.findusages.model.SearchQuery,jetbrains.mps.ide.progress.IAdaptiveProgressMonitor):jetbrains.mps.ide.findusages.model.SearchResults"
        ...
        <node role="statement" type="jetbrains.mps.baseLanguage.structure.IfStatement" id="1201261469292">
          ...
          <node role="condition" type="jetbrains.mps.baseLanguage.structure.DotExpression" id="1207782886082">
            <node role="operand" type="jetbrains.mps.baseLanguage.structure.DotExpression" id="1209483941128">
              ...
              <node role="operation" type="jetbrains.mps.baseLanguage.structure.InstanceMethodCallOperation"
                    id="1209483947490">
                <link role="baseMethodDeclaration" targetNodeId="26.~SearchResults.getSearchResults():java.util.List"
      ...
      <node role="body" type="jetbrains.mps.baseLanguage.structure.StatementList" id="1209311493455">
        ...
        <node role="statement" type="jetbrains.mps.baseLanguage.structure.LocalVariableDeclarationStatement"
          ...
          <node role="localVariableDeclaration" type="jetbrains.mps.baseLanguage.structure.LocalVariableDeclaration"
                id="1209311545682">
            <property name="name" value="projectFrame"/>
            <node role="type" type="jetbrains.mps.baseLanguage.structure.ClassifierType" id="1209311545683">
              <link role="classifier" targetNodeId="16.~IDEProjectFrame" resolveInfo="IDEProjectFrame"/>
            </node>
            <node role="initializer" type="jetbrains.mps.baseLanguage.structure.DotExpression" id="1209311545684">
              <node role="operand"
                    type="jetbrains.mps.logging.refactoring.structure.ConceptFunctionParameter_ActionContext"
                    id="1209312340852"/>
              <node role="operation" type="jetbrains.mps.baseLanguage.structure.InstanceMethodCallOperation"
                    id="1209311545686">
                <link role="baseMethodDeclaration" targetNodeId="2.~ActionContext.get(java.lang.Class):java.lang.Object"
                      resolveInfo="get"/>
                <node role="actualArgument" type="jetbrains.mps.baseLanguage.structure.ClassifierClassExpression"
                      id="1209311545687">
                  <link role="classifier" targetNodeId="16.~IDEProjectFrame" resolveInfo="IDEProjectFrame"/>
        ...
        <node role="statement" type="jetbrains.mps.baseLanguage.structure.LocalVariableDeclarationStatement"
          ...
          <node role="localVariableDeclaration" type="jetbrains.mps.baseLanguage.structure.LocalVariableDeclaration"
            ...
            <node role="initializer" type="jetbrains.mps.baseLanguage.structure.DotExpression" id="1209312315546">
              <node role="operand" type="jetbrains.mps.baseLanguage.structure.LocalVariableReference"
                    id="1209312336974">
                <link role="variableDeclaration" targetNodeId="1209311545682" resolveInfo="projectFrame"/>
              </node>
              <node role="operation" type="jetbrains.mps.baseLanguage.structure.InstanceMethodCallOperation"
                    id="1209312315548">
                <link role="baseMethodDeclaration"
