...
public class SetExportAnnotation_Intention extends BaseIntention implements Intention {
  ...
  public String getDescription(final SNode node, final EditorContext editorContext) {
    return ((this.myParameter == null) ?
      ...
      "Add @export(" + SConceptPropertyOperations.getString(SNodeOperations.castConcept(this.myParameter, "jetbrains.mps.lang.core.structure.ExportScope"), "alias") + ") Annotation"
    );
  }
