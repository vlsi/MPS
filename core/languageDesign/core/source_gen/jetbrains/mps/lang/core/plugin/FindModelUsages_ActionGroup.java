    ...
    try {
      {
        ...
        this.add(ActionFactory.getInstance().acquireRegisteredAction(language.getClass("jetbrains.mps.lang.core.plugin.FindModelUsages_Action"), language.getModuleFqName(), null));
      }
    } catch (Throwable t) {
