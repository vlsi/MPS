    ...
    try {
      {
        ...
        this.add(ActionFactory.getInstance().acquireRegisteredAction(module.getClass("jetbrains.mps.lang.core.plugin.FindModelUsages_Action"), module.getModuleFqName()));
      }
    } catch (Throwable t) {
