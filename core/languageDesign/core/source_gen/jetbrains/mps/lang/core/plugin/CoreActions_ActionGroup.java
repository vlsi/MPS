    ...
    try {
      {
        ...
        this.add(ActionFactory.getInstance().acquireRegisteredAction(module.getClass("jetbrains.mps.lang.core.plugin.ShowNodeMessages_Action"), module.getModuleFqName(), null));
      }
    } catch (Throwable t) {
