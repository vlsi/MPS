    ...
    try {
      {
        ...
        this.add(ActionFactory.getInstance().acquireRegisteredAction(module.getClass("jetbrains.mps.lang.core.plugin.ShowNodeMessages_Action"), module.getModuleFqName()));
      }
    } catch (Throwable t) {
