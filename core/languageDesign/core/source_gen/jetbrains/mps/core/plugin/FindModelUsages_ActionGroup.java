...
public class FindModelUsages_ActionGroup extends CurrentProjectGroup {
  ...
  public FindModelUsages_ActionGroup(Project project) {
  ...
  public void adjust() {
    {
      BaseGroup gTo = ActionUtils.getGroup(ProjectPaneModelActions_ActionGroup.ID);
