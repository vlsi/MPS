...
<model name="jetbrains.mps.bootstrap.sharedConcepts.generator.baseLanguage.template.main">
  ...
  <import index="1" modelUID="jetbrains.mps.baseLanguage.generator.java.conceptFunctionDefaults@templates" version="-1" />
