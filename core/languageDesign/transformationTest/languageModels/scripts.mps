...
<model modelUID="r:1222075024263(jetbrains.mps.transformationTest.scripts)">
  ...
  <import index="6" modelUID="r:1222075024262(jetbrains.mps.transformationTest.intentions)" version="-1" />
