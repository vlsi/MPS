...
<model modelUID="r:00000000-0000-4000-0000-011c89590312(jetbrains.mps.lang.refactoring.behavior)">
  ...
  <node type="jetbrains.mps.lang.constraints.structure.ConceptBehavior" id="1213877320624">
    <link role="concept" targetNodeId="1.1197983858784" resolveInfo="ChooseComponentClause" />
    <node role="constructor" type="jetbrains.mps.lang.constraints.structure.ConceptConstructorDeclaration" id="1213877320625">
      <node role="body" type="jetbrains.mps.baseLanguage.structure.StatementList" id="1213877320626" />
    </node>
    <node role="method" type="jetbrains.mps.lang.constraints.structure.ConceptMethodDeclaration" id="1213877320627">
            ...
            <node role="initializer" type="jetbrains.mps.baseLanguage.structure.DotExpression" id="1213877320632">
              <node role="operand" type="jetbrains.mps.lang.smodel.structure.SNodeTypeCastExpression" id="1213877320633">
                ...
                <node role="leftExpression" type="jetbrains.mps.baseLanguage.structure.DotExpression" id="1213877320634">
                  <node role="operand" type="jetbrains.mps.lang.constraints.structure.ThisNodeExpression" id="1213877320635" />
  ...
  <node type="jetbrains.mps.lang.constraints.structure.ConceptBehavior" id="1213877332272">
    <link role="concept" targetNodeId="1.1189694084608" resolveInfo="RequiredAdditionalArgumentReference" />
    <node role="constructor" type="jetbrains.mps.lang.constraints.structure.ConceptConstructorDeclaration" id="1213877332273">
      <node role="body" type="jetbrains.mps.baseLanguage.structure.StatementList" id="1213877332274" />
    </node>
  </node>
  <node type="jetbrains.mps.lang.constraints.structure.ConceptBehavior" id="1213877343861">
    <link role="concept" targetNodeId="1.1189693830529" resolveInfo="RequiredAdditionalArgument" />
    <node role="constructor" type="jetbrains.mps.lang.constraints.structure.ConceptConstructorDeclaration" id="1213877343862">
      <node role="body" type="jetbrains.mps.baseLanguage.structure.StatementList" id="1213877343863" />
    </node>
    <node role="method" type="jetbrains.mps.lang.constraints.structure.ConceptMethodDeclaration" id="1213877343864">
        ...
        <node role="statement" type="jetbrains.mps.baseLanguage.structure.LocalVariableDeclarationStatement" id="1213877343867">
          <node role="localVariableDeclaration" type="jetbrains.mps.baseLanguage.structure.LocalVariableDeclaration" id="1213877343868">
            ...
            <node role="initializer" type="jetbrains.mps.baseLanguage.structure.DotExpression" id="1213877343870">
              <node role="operand" type="jetbrains.mps.lang.constraints.structure.ThisNodeExpression" id="1213877343871" />
          ...
          <node role="body" type="jetbrains.mps.baseLanguage.structure.StatementList" id="1213877343891">
            <node role="statement" type="jetbrains.mps.baseLanguage.structure.IfStatement" id="1213877343892">
              ...
              <node role="condition" type="jetbrains.mps.baseLanguage.structure.EqualsExpression" id="1213877343896">
                <node role="rightExpression" type="jetbrains.mps.lang.constraints.structure.ThisNodeExpression" id="1213877343897" />
  ...
  <node type="jetbrains.mps.lang.constraints.structure.ConceptBehavior" id="1213877358041">
    ...
    <node role="constructor" type="jetbrains.mps.lang.constraints.structure.ConceptConstructorDeclaration" id="1213877358042">
      <node role="body" type="jetbrains.mps.baseLanguage.structure.StatementList" id="1213877358043" />
    </node>
  </node>
  <node type="jetbrains.mps.lang.constraints.structure.ConceptBehavior" id="1213877405900">
    <link role="concept" targetNodeId="1.1198599668934" resolveInfo="InitialValueClause" />
    <node role="constructor" type="jetbrains.mps.lang.constraints.structure.ConceptConstructorDeclaration" id="1213877405901">
      <node role="body" type="jetbrains.mps.baseLanguage.structure.StatementList" id="1213877405902" />
    </node>
    <node role="method" type="jetbrains.mps.lang.constraints.structure.ConceptMethodDeclaration" id="1213877405903">
      <property name="name" value="getExpectedReturnType" />
      <property name="isPrivate" value="false" />
      <link role="overriddenMethod" targetNodeId="4.1213877374441" resolveInfo="getExpectedReturnType" />
          ...
          <node role="expression" type="jetbrains.mps.baseLanguage.structure.DotExpression" id="1213877405906">
            <node role="operand" type="jetbrains.mps.lang.smodel.structure.SNodeTypeCastExpression" id="1213877405907">
              ...
              <node role="leftExpression" type="jetbrains.mps.baseLanguage.structure.DotExpression" id="1213877405908">
                <node role="operand" type="jetbrains.mps.lang.constraints.structure.ThisNodeExpression" id="1213877405909" />
