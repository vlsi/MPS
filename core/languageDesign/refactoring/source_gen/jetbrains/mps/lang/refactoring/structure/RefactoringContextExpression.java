...
public class RefactoringContextExpression extends Expression {
  public static final String concept = "jetbrains.mps.lang.refactoring.structure.RefactoringContextExpression";

  public RefactoringContextExpression(SNode node) {
    super(node);
  }
  ...
  public static RefactoringContextExpression newInstance(SModel sm) {
    return RefactoringContextExpression.newInstance(sm, false);
  }
}
