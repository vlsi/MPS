...
public class AffectedNodesClauseInParent extends AbstractCellProvider {
  ...
  public EditorCell createConstant_5723_2(EditorContext context, SNode node, String text) {
    EditorCell_Constant editorCell = new EditorCell_Constant(context, node, text);
    setupBasic_Constant_5723_2(editorCell, node, context);
    editorCell.setDefaultText("");
    return editorCell;
  }
  ...
  public EditorCell createConstant_5723_3(EditorContext context, SNode node, String text) {
    EditorCell_Constant editorCell = new EditorCell_Constant(context, node, text);
    setupBasic_Constant_5723_3(editorCell, node, context);
    editorCell.setDefaultText("");
    return editorCell;
  }
  ...
  public EditorCell createConstant_5723_4(EditorContext context, SNode node, String text) {
    EditorCell_Constant editorCell = new EditorCell_Constant(context, node, text);
    setupBasic_Constant_5723_4(editorCell, node, context);
    editorCell.setDefaultText("");
    return editorCell;
  }
  ...
  private static void setupBasic_Constant_5723_2(EditorCell editorCell, SNode node, EditorContext context) {
  ...
  private static void setupBasic_Constant_5723_3(EditorCell editorCell, SNode node, EditorContext context) {
    editorCell.setCellId("Constant_5723_3");
  }

  private static void setupBasic_Constant_5723_4(EditorCell editorCell, SNode node, EditorContext context) {
