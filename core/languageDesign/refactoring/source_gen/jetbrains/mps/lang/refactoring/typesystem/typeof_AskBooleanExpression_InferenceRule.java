  ...
  public void applyRule(final SNode expression, final TypeCheckingContext typeCheckingContext) {
    {
      ...
      typeCheckingContext.createEquation((SNode)typeCheckingContext.typeOf(_nodeToCheck_1029348928467, "r:00000000-0000-4000-0000-011c89590316(jetbrains.mps.lang.refactoring.typesystem)", "4312073247720489878", true), (SNode)new _Quotations.QuotationClass_33().createNode(typeCheckingContext), _info_12389875345);
    }
    {
      ...
      typeCheckingContext.createLessThanInequationStrong((SNode)typeCheckingContext.typeOf(_nodeToCheck_1029348928467, "r:00000000-0000-4000-0000-011c89590316(jetbrains.mps.lang.refactoring.typesystem)", "4312073247720567561", true), (SNode)new _Quotations.QuotationClass_34().createNode(typeCheckingContext), true, _info_12389875345);
    }
    {
