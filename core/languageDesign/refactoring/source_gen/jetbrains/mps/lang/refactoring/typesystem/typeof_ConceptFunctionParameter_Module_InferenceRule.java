  ...
  public void applyRule(final SNode module, final TypeCheckingContext typeCheckingContext) {
    ...
    if ((moduleType != null)) {
    ...
    } else {
      {
        SNode _nodeToCheck_1029348928467 = module;
        BaseIntentionProvider intentionProvider = null;
        typeCheckingContext.createEquation((SNode)typeCheckingContext.typeOf(_nodeToCheck_1029348928467, "r:00000000-0000-4000-0000-011c89590316(jetbrains.mps.lang.refactoring.typesystem)", "6895093993902310908", true), (SNode)new _Quotations.QuotationClass_40().createNode(typeCheckingContext), _nodeToCheck_1029348928467, null, "r:00000000-0000-4000-0000-011c89590316(jetbrains.mps.lang.refactoring.typesystem)", "6895093993902310904", intentionProvider);
      }
    }
  }
