...
public class typeof_RefactoringContext_ConceptFunctionParameter_InferenceRule extends AbstractInferenceRule_Runtime implements InferenceRule_Runtime {
  ...
  public static class QuotationClass_v91xio_a0a0a0 {
    ...
    public SNode createNode(final TypeCheckingContext typeCheckingContext) {
      ...
      SNode quotedNode_v91xio_a0a0a0 = null;
      {
        quotedNode_v91xio_a0a0a0 = SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.lang.refactoring.structure.ContextType", TypeChecker.getInstance().getRuntimeTypesModel(), GlobalScope.getInstance(), false);
        SNode quotedNode1_v91xio_a0a0a0 = quotedNode_v91xio_a0a0a0;
        result = quotedNode1_v91xio_a0a0a0;
      }
      return result;
    }
