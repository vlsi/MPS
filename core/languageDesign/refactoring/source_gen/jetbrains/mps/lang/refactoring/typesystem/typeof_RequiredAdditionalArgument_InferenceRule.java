  ...
  public void applyRule(final SNode requiredAdditionalArgument, final TypeCheckingContext typeCheckingContext) {
    {
      ...
      typeCheckingContext.createEquation(typeCheckingContext.typeOf(requiredAdditionalArgument, "r:00000000-0000-4000-0000-011c89590316(jetbrains.mps.lang.refactoring.helgins)", "1190728902837", true), SLinkOperations.getTarget(requiredAdditionalArgument, "argumentType", true), _nodeToCheck_1029348928467, null, "r:00000000-0000-4000-0000-011c89590316(jetbrains.mps.lang.refactoring.helgins)", "1190728908074", intentionProvider);
    }
  }
