...
public class OperationContextOperation extends ContextMemberOperation {
  public static final String concept = "jetbrains.mps.lang.refactoring.structure.OperationContextOperation";

  public OperationContextOperation(SNode node) {
    super(node);
  }
  ...
  public static OperationContextOperation newInstance(SModel sm) {
    return OperationContextOperation.newInstance(sm, false);
  }
}
