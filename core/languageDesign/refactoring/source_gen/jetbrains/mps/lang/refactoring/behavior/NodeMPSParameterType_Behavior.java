...
public class NodeMPSParameterType_Behavior {
  ...
  public static class QuotationClass_58bmda_a0a0b {
    ...
    public SNode createNode() {
      ...
      SNode quotedNode_58bmda_a0a0a = null;
      {
        quotedNode_58bmda_a0a0a = SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.baseLanguage.structure.StaticMethodCall", TypeChecker.getInstance().getRuntimeTypesModel(), GlobalScope.getInstance(), false);
        SNode quotedNode1_58bmda_a0a0a = quotedNode_58bmda_a0a0a;
        quotedNode1_58bmda_a0a0a.addReference(SReference.create("classConcept", quotedNode1_58bmda_a0a0a, SModelReference.fromString("f:java_stub#jetbrains.mps.refactoring.framework.paramchooser.mps(jetbrains.mps.refactoring.framework.paramchooser.mps@java_stub)"), SNodeId.fromString("~MPSChooserFactory")));
        quotedNode1_58bmda_a0a0a.addReference(SReference.create("baseMethodDeclaration", quotedNode1_58bmda_a0a0a, SModelReference.fromString("f:java_stub#jetbrains.mps.refactoring.framework.paramchooser.mps(jetbrains.mps.refactoring.framework.paramchooser.mps@java_stub)"), SNodeId.fromString("~MPSChooserFactory.createNodeChooser(jetbrains.mps.refactoring.framework.RefactoringContext,java.lang.String,jetbrains.mps.refactoring.framework.paramchooser.mps.IChooserSettings):jetbrains.mps.refactoring.framework.paramchooser.IChooser")));
        result = quotedNode1_58bmda_a0a0a;
      }
      return result;
    }
  }
