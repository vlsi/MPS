...
public class NodeMPSParameterType_Behavior {
  ...
  public static SNode virtual_getCreatorMethod_4413749148913760555(SNode thisNode) {
    return new NodeMPSParameterType_Behavior.QuotationClass_0028_l523emnf3cs3().createNode();
  }
  ...
  public static class QuotationClass_0028_l523emnf3cs3 {
    public QuotationClass_0028_l523emnf3cs3() {
    }

    public SNode createNode() {
      SNode result = null;
      Set<SNode> _parameterValues_129834374 = new HashSet<SNode>();
      SNode quotedNode_0028_xj7jhr05b324 = null;
      {
        quotedNode_0028_xj7jhr05b324 = SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.baseLanguage.structure.StaticMethodCall", TypeChecker.getInstance().getRuntimeTypesModel(), GlobalScope.getInstance(), false);
        SNode quotedNode1_0028_xj7jhr05b324 = quotedNode_0028_xj7jhr05b324;
        quotedNode1_0028_xj7jhr05b324.addReference(SReference.create("classConcept", quotedNode1_0028_xj7jhr05b324, SModelReference.fromString("f:java_stub#jetbrains.mps.refactoring.framework.paramchooser.mps(jetbrains.mps.refactoring.framework.paramchooser.mps@java_stub)"), SNodeId.fromString("~MPSChooserFactory")));
        quotedNode1_0028_xj7jhr05b324.addReference(SReference.create("baseMethodDeclaration", quotedNode1_0028_xj7jhr05b324, SModelReference.fromString("f:java_stub#jetbrains.mps.refactoring.framework.paramchooser.mps(jetbrains.mps.refactoring.framework.paramchooser.mps@java_stub)"), SNodeId.fromString("~MPSChooserFactory.createNodeChooser(jetbrains.mps.refactoring.framework.RefactoringContext,java.lang.String,jetbrains.mps.refactoring.framework.paramchooser.mps.IChooserSettings):jetbrains.mps.refactoring.framework.paramchooser.IChooser")));
        result = quotedNode1_0028_xj7jhr05b324;
      }
      return result;
    }
  }
