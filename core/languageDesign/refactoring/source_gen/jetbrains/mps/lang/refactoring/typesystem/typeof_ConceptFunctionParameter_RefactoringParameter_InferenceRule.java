...
public class typeof_ConceptFunctionParameter_RefactoringParameter_InferenceRule extends AbstractInferenceRule_Runtime implements InferenceRule_Runtime {
  ...
  public void applyRule(final SNode parameter, final TypeCheckingContext typeCheckingContext) {
    SNode chooser = SNodeOperations.getAncestor(parameter, "jetbrains.mps.lang.refactoring.structure.MPSParameterChooser", false, false);
    {
      ...
      typeCheckingContext.createEquation((SNode)typeCheckingContext.typeOf(_nodeToCheck_1029348928467, "r:00000000-0000-4000-0000-011c89590316(jetbrains.mps.lang.refactoring.typesystem)", "4413749148913757628", true), (SNode)typeCheckingContext.typeOf(SLinkOperations.getTarget(chooser, "paramType", true), "r:00000000-0000-4000-0000-011c89590316(jetbrains.mps.lang.refactoring.typesystem)", "4413749148913757631", true), _nodeToCheck_1029348928467, null, "r:00000000-0000-4000-0000-011c89590316(jetbrains.mps.lang.refactoring.typesystem)", "4413749148913757623", intentionProvider);
    }
  }
