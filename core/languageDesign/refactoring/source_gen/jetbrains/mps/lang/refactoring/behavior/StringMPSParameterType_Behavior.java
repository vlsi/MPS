...
public class StringMPSParameterType_Behavior {
  ...
  public static class QuotationClass_n45y7a_a0a0b {
    ...
    public SNode createNode() {
      ...
      SNode quotedNode_n45y7a_a0a0a = null;
      {
        quotedNode_n45y7a_a0a0a = SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.baseLanguage.structure.StaticMethodCall", TypeChecker.getInstance().getRuntimeTypesModel(), GlobalScope.getInstance(), false);
        SNode quotedNode1_n45y7a_a0a0a = quotedNode_n45y7a_a0a0a;
        quotedNode1_n45y7a_a0a0a.addReference(SReference.create("baseMethodDeclaration", quotedNode1_n45y7a_a0a0a, SModelReference.fromString("f:java_stub#jetbrains.mps.refactoring.framework.paramchooser.mps(jetbrains.mps.refactoring.framework.paramchooser.mps@java_stub)"), SNodeId.fromString("~MPSChooserFactory.createStringChooser(jetbrains.mps.refactoring.framework.RefactoringContext,java.lang.String,jetbrains.mps.refactoring.framework.paramchooser.mps.IChooserSettings):jetbrains.mps.refactoring.framework.paramchooser.IChooser")));
        quotedNode1_n45y7a_a0a0a.addReference(SReference.create("classConcept", quotedNode1_n45y7a_a0a0a, SModelReference.fromString("f:java_stub#jetbrains.mps.refactoring.framework.paramchooser.mps(jetbrains.mps.refactoring.framework.paramchooser.mps@java_stub)"), SNodeId.fromString("~MPSChooserFactory")));
        result = quotedNode1_n45y7a_a0a0a;
      }
      return result;
    }
  }
