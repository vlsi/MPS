...
public class RequiredAdditionalArgument extends jetbrains.mps.lang.core.structure.BaseConcept implements jetbrains.mps.lang.core.structure.INamedConcept {
  ...
  public jetbrains.mps.baseLanguage.structure.Type getArgumentType() {
    return (jetbrains.mps.baseLanguage.structure.Type)this.getChild(Type.class, RequiredAdditionalArgument.ARGUMENT_TYPE);
  }

  public void setArgumentType(jetbrains.mps.baseLanguage.structure.Type node) {
