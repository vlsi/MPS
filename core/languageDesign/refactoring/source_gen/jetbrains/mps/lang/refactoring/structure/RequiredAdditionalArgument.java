...
public class RequiredAdditionalArgument extends BaseConcept implements INamedConcept {
  ...
  public int get_$attributesCount() {
    return this.getChildCount(RequiredAdditionalArgument._$ATTRIBUTE);
  }

  public Iterator<Attribute> _$attributes() {
    return this.children(Attribute.class, RequiredAdditionalArgument._$ATTRIBUTE);
  }

  public List<Attribute> get_$attributes() {
    return this.getChildren(Attribute.class, RequiredAdditionalArgument._$ATTRIBUTE);
  }

  public void add_$attribute(Attribute node) {
    this.addChild(RequiredAdditionalArgument._$ATTRIBUTE, node);
  }

  public void insert_$attribute(Attribute prev, Attribute node) {
    this.insertChild(prev, RequiredAdditionalArgument._$ATTRIBUTE, node);
  }
