...
public class RefactoringParameter extends BaseConcept implements INamedConcept, RefactoringArgument {
  ...
  public int get_$attributesCount() {
    return this.getChildCount(RefactoringParameter._$ATTRIBUTE);
  }

  public Iterator<Attribute> _$attributes() {
    return this.children(Attribute.class, RefactoringParameter._$ATTRIBUTE);
  }

  public List<Attribute> get_$attributes() {
    return this.getChildren(Attribute.class, RefactoringParameter._$ATTRIBUTE);
  }

  public void add_$attribute(Attribute node) {
    this.addChild(RefactoringParameter._$ATTRIBUTE, node);
  }

  public void insert_$attribute(Attribute prev, Attribute node) {
    this.insertChild(prev, RefactoringParameter._$ATTRIBUTE, node);
  }
