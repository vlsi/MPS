...
public class RequiredAdditionalArgumentReference_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createCollection_3524_0(EditorContext context, SNode node) {
    EditorCell_Collection editorCell = EditorCell_Collection.createIndent2(context, node);
    editorCell.setCellId("Collection_3524_0");
    editorCell.addEditorCell(this.createRefCell_3524_0(context, node));
    return editorCell;
  }

  private EditorCell createRefCell_3524_0(EditorContext context, SNode node) {
  ...
  public static class _Inline3524_0 extends AbstractCellProvider {
    ...
    public EditorCell createEditorCell(EditorContext context, SNode node) {
      return this.createProperty_3524_0(context, node);
    }

    private EditorCell createProperty_3524_0(EditorContext context, SNode node) {
