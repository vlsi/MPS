...
public class ContextMemberOperation_Behavior {
  ...
  public static SNode call_createType_7012097027058652452(SNode thisNode) {
    return (SNode) BehaviorManager.getInstance().invoke(Object.class, SNodeOperations.cast(thisNode, "jetbrains.mps.lang.refactoring.structure.ContextMemberOperation"), "virtual_createType_7012097027058652452", PARAMETERS_7012097027058652452);
  }
