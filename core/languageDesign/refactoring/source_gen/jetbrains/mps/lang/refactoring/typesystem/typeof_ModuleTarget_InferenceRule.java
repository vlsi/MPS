...
public class typeof_ModuleTarget_InferenceRule extends AbstractInferenceRule_Runtime implements InferenceRule_Runtime {
  ...
  public static class QuotationClass_rkxyo0_a0a0a0 {
    ...
    public SNode createNode(final TypeCheckingContext typeCheckingContext) {
      ...
      SNode quotedNode_rkxyo0_a0a0a0 = null;
      {
        quotedNode_rkxyo0_a0a0a0 = SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.baseLanguage.structure.ClassifierType", TypeChecker.getInstance().getRuntimeTypesModel(), GlobalScope.getInstance(), false);
        SNode quotedNode1_rkxyo0_a0a0a0 = quotedNode_rkxyo0_a0a0a0;
        quotedNode1_rkxyo0_a0a0a0.addReference(SReference.create("classifier", quotedNode1_rkxyo0_a0a0a0, SModelReference.fromString("f:java_stub#jetbrains.mps.project(jetbrains.mps.project@java_stub)"), SNodeId.fromString("~IModule")));
        result = quotedNode1_rkxyo0_a0a0a0;
      }
      return result;
    }
