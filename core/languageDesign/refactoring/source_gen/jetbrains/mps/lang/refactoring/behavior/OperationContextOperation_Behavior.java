...
public class OperationContextOperation_Behavior {
  ...
  public static SNode call_createType_7012097027058652520(SNode thisNode) {
    return (SNode) BehaviorManager.getInstance().invoke(Object.class, SNodeOperations.cast(thisNode, "jetbrains.mps.lang.refactoring.structure.OperationContextOperation"), "virtual_createType_7012097027058652452", PARAMETERS_7012097027058652520);
  }
