...
public class MoveNodeToModelExpression extends AbstractMoveNodeExpression {
  public static final String concept = "jetbrains.mps.logging.refactoring.structure.MoveNodeToModelExpression";
  ...
  public static MoveNodeToModelExpression newInstance(SModel sm, boolean init) {
    return (MoveNodeToModelExpression)SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.logging.refactoring.structure.MoveNodeToModelExpression", sm, GlobalScope.getInstance(), init).getAdapter();
  }
