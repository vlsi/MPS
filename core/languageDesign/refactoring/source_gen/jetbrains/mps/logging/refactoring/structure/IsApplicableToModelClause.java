...
public class IsApplicableToModelClause extends ConceptFunction {
  public static final String concept = "jetbrains.mps.logging.refactoring.structure.IsApplicableToModelClause";
  ...
  public static IsApplicableToModelClause newInstance(SModel sm, boolean init) {
    return (IsApplicableToModelClause)SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.logging.refactoring.structure.IsApplicableToModelClause", sm, GlobalScope.getInstance(), init).getAdapter();
  }
