...
public class UpdateModelProcedure_Editor extends DefaultNodeEditor {
  ...
  private static void setupLabel_argumentRefNodeCell18949_0(EditorCell_Label editorCell, SNode node, EditorContext context) {
  }
  ...
  public EditorCell create_CollectionCell18949_0(EditorContext context, SNode node) {
    ...
    editorCell.addEditorCell(this.create_ConstantCell18949_0(context, node, "updateModel("));
    editorCell.addEditorCell(this.create_argumentRefNodeCell18949_0(context, node));
  ...
  public EditorCell create_argumentRefNodeCell18949_0_internal(EditorContext context, SNode node, CellProviderWithRole aProvider) {
    CellProviderWithRole provider = aProvider;
    provider.setAuxiliaryCellProvider(null);
    EditorCell editorCell = provider.createEditorCell(context);
    setupBasic_argumentRefNodeCell18949_0(editorCell, node, context);
    if (editorCell instanceof EditorCell_Label) {
      setupLabel_argumentRefNodeCell18949_0((EditorCell_Label)editorCell, node, context);
    }
    editorCell.setSubstituteInfo(provider.createDefaultSubstituteInfo());
    return editorCell;
  }

  public EditorCell create_argumentRefNodeCell18949_0(EditorContext context, SNode node) {
    CellProviderWithRole provider = new RefNodeCellProvider(node, context);
    provider.setRole("argument");
    provider.setNoTargetText("<no argument>");
    provider.setReadOnly(false);
    provider.setAllowsEmptyTarget(false);
    EditorCell cellWithRole = this.create_argumentRefNodeCell18949_0_internal(context, node, provider);
