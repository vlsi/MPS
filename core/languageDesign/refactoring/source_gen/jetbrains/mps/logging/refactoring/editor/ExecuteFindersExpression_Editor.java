...
public class ExecuteFindersExpression_Editor extends DefaultNodeEditor {
  ...
  public EditorCell createRefNodeList1212242818597(EditorContext context, SNode node) {
    if (this.myListHandler_1212242818597 == null) {
      this.myListHandler_1212242818597 = new ExecuteFindersExpression_Editor.findersListHandler_(node, "finders", context);
    }
  ...
  public static class findersListHandler_ extends RefNodeListHandler {

    public findersListHandler_(SNode ownerNode, String childRole, EditorContext context) {
