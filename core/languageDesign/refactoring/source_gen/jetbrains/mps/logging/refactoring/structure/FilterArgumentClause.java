...
public class FilterArgumentClause extends ConceptFunction {
  ...
  public static FilterArgumentClause newInstance(SModel sm, boolean init) {
    return (FilterArgumentClause)SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.logging.refactoring.structure.FilterArgumentClause", sm, GlobalScope.getInstance(), init).getAdapter();
  }
