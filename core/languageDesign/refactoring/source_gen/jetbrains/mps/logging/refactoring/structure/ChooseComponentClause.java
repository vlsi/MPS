...
public class ChooseComponentClause extends ConceptFunction {
  ...
  public static ChooseComponentClause newInstance(SModel sm, boolean init) {
    return (ChooseComponentClause)SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.logging.refactoring.structure.ChooseComponentClause", sm, GlobalScope.getInstance(), init).getAdapter();
  }
