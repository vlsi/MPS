...
<model modelUID="r:1222075024839(jetbrains.mps.bootstrap.helgins.test.editor)">
  ...
  <import index="1" modelUID="r:1222075024840(jetbrains.mps.bootstrap.helgins.test.structure)" version="-1" />
