...
public class IsSubtypeExpression_Editor extends DefaultNodeEditor {
  ...
  public EditorCell createConstant1176543998552(EditorContext context, SNode node, String text) {
    ...
    editorCell.setSubstituteInfo(new CompositeSubstituteInfo(context, new BasicCellContext(node), new SubstituteInfoPart[]{new IsSubtypeExpression_Editor.IsSubtypeExpression_Editor_replaceWith_IsSubtypeExpression_cellMenu()}));
    return editorCell;
  }
