...
public class ConceptFunctionParameter_node extends ConceptFunctionParameter {
  public static final String concept = "jetbrains.mps.bootstrap.helgins.structure.ConceptFunctionParameter_node";
  ...
  public static ConceptFunctionParameter_node newInstance(SModel sm, boolean init) {
    return (ConceptFunctionParameter_node)SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.bootstrap.helgins.structure.ConceptFunctionParameter_node", sm, GlobalScope.getInstance(), init).getAdapter();
  }
