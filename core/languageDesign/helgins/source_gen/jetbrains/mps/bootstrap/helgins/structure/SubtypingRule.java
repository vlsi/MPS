...
public class SubtypingRule extends AbstractSubtypingRule {
  ...
  public static SubtypingRule newInstance(SModel sm, boolean init) {
    return ((SubtypingRule)SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.bootstrap.helgins.structure.SubtypingRule", sm, GlobalScope.getInstance(), init).getAdapter());
  }
