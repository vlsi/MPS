...
public class typeof_FindSourceBlockParameter_InferenceRule implements InferenceRule_Runtime {
  ...
  public void applyRule(final SNode findSourceBlockParameter) {
    ...
    if((dependency != null)) {
      TypeChecker.getInstance().getRuntimeSupport().createEquation(TypeChecker.getInstance().getRuntimeSupport().typeOf(findSourceBlockParameter, "jetbrains.mps.bootstrap.helgins.helgins", "1193734407573", true), new QuotationClass_17().createNode(SLinkOperations.getTarget(dependency, "targetConcept", false)), findSourceBlockParameter, null, "jetbrains.mps.bootstrap.helgins.helgins", "1193734407570");
    }
  }
