...
public class typeOf_TypeCheckerAccess_InferenceRule implements InferenceRule_Runtime {
  ...
  public void applyRule(final SNode typeCheckerAccess) {
    TypeChecker.getInstance().getRuntimeSupport().givetype(new QuotationClass_1().createNode(), typeCheckerAccess, "jetbrains.mps.bootstrap.helgins.helgins", "1175595994022");
  }
