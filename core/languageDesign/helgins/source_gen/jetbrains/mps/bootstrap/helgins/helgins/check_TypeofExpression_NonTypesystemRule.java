...
public class check_TypeofExpression_NonTypesystemRule extends AbstractNonTypesystemRule_Runtime implements NonTypesystemRule_Runtime {
  ...
  public void applyRule(final SNode typeOfExpression, final TypeCheckingContext typeCheckingContext) {
    if (!(RulesUtil.withinInferenceItem(typeOfExpression))) {
      TypeChecker.getInstance().reportTypeError(typeOfExpression, "TYPEOF should be used only within inference rules", "r:00000000-0000-4000-0000-011c895902b1(jetbrains.mps.bootstrap.helgins.helgins)", "1195217231011");
    }
    if (!(!(SNodeOperations.isInstanceOf(SLinkOperations.getTarget(typeOfExpression, "term", true), "jetbrains.mps.bootstrap.helgins.structure.TypeVarReference")))) {
      TypeChecker.getInstance().reportTypeError(typeOfExpression, "type of a type has little sense", "r:00000000-0000-4000-0000-011c895902b1(jetbrains.mps.bootstrap.helgins.helgins)", "1204815653385");
    }
  }
