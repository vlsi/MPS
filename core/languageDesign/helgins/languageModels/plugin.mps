          ...
          <node role="localVariableDeclaration" type="jetbrains.mps.baseLanguage.structure.LocalVariableDeclaration"
            ...
            <node role="initializer" type="jetbrains.mps.baseLanguage.structure.DotExpression" id="1211220207829">
              ...
              <node role="operation" type="jetbrains.mps.baseLanguage.structure.InstanceMethodCallOperation"
                    id="1211220210958">
                <link role="baseMethodDeclaration"
                      targetNodeId="16.~ToolsPane.getTool(java.lang.Class):jetbrains.mps.ide.toolsPane.ITool"
                      resolveInfo="getTool"/>
                <node role="actualArgument" type="jetbrains.mps.baseLanguage.structure.ClassifierClassExpression"
                      id="1211220219443">
                  <link role="classifier" targetNodeId="2.~SupertypesViewTool" resolveInfo="SupertypesViewTool"/>
        ...
        <node role="statement" type="jetbrains.mps.baseLanguage.structure.ExpressionStatement" id="1210262657182">
          <node role="expression" type="jetbrains.mps.baseLanguage.structure.DotExpression" id="1210262660888">
            <node role="operand" type="jetbrains.mps.baseLanguage.structure.StaticMethodCall" id="1210262659651">
              <link role="baseMethodDeclaration"
                    targetNodeId="23.~NavigationActionProcessor.getInstance():jetbrains.mps.ide.navigation.NavigationActionProcessor"
                    resolveInfo="getInstance"/>
            ...
            <node role="operation" type="jetbrains.mps.baseLanguage.structure.InstanceMethodCallOperation"
              ...
              <node role="actualArgument" type="jetbrains.mps.baseLanguage.structure.NewExpression" id="1210262675361">
                <link role="baseMethodDeclaration"
                      targetNodeId="23.~EditorNavigationCommand.&lt;init&gt;(jetbrains.mps.smodel.SNode,jetbrains.mps.ide.IEditor,jetbrains.mps.ide.EditorsPane,boolean)"
        ...
        <node role="statement" type="jetbrains.mps.baseLanguage.structure.ExpressionStatement" id="1211381749943">
          <node role="expression" type="jetbrains.mps.baseLanguage.structure.DotExpression" id="1211381761181">
            <node role="operand" type="jetbrains.mps.baseLanguage.structure.StaticMethodCall" id="1211381756116">
              <link role="baseMethodDeclaration"
                    targetNodeId="27.~MessagesViewTool.getMessageViewTool(jetbrains.mps.project.MPSProject):jetbrains.mps.ide.messages.MessagesViewTool"
                    resolveInfo="getMessageViewTool"/>
            ...
            <node role="operation" type="jetbrains.mps.baseLanguage.structure.InstanceMethodCallOperation"
                  id="1211381763374">
              <link role="baseMethodDeclaration" targetNodeId="27.~MessagesViewTool.showTool(boolean):void"
                    resolveInfo="showTool"/>
              <node role="actualArgument" type="jetbrains.mps.baseLanguage.structure.BooleanConstant"
                    id="1211381767455">
                <property name="value" value="true"/>
              </node>
