...
<model name="jetbrains.mps.bootstrap.constraintsLanguage.structure">
  ...
  <refactoringHistory>
    <refactoringContext modelVersion="0">
      ...
      <conceptFeatureMap>
        <entry>
          <key featureName="overridenMethod"
               conceptFQName="jetbrains.mps.bootstrap.constraintsLanguage.structure.ConceptMethodDeclaration"
               featureKind="REFERENCE"/>
          <value featureName="overriddenMethod"
                 conceptFQName="jetbrains.mps.bootstrap.constraintsLanguage.structureConceptMethodDeclaration"
                 featureKind="REFERENCE"/>
        </entry>
      </conceptFeatureMap>
    </refactoringContext>
    <refactoringContext modelVersion="1">
      ...
      <conceptFeatureMap>
        <entry>
          <key featureName="PropertyGetter_FunctionParm_node"
               conceptFQName="jetbrains.mps.bootstrap.constraintsLanguage.structure.PropertyGetter_FunctionParm_node"
               featureKind="CONCEPT"/>
          <value featureName="ConstraintsFunctionParameter_node"
                 conceptFQName="jetbrains.mps.bootstrap.constraintsLanguage.structure.ConstraintsFunctionParameter_node"
                 featureKind="CONCEPT"/>
        </entry>
      </conceptFeatureMap>
    </refactoringContext>
    <refactoringContext modelVersion="0">
      ...
      <conceptFeatureMap>
        <entry>
          <key featureName="PropertySetter_FunctionParm_propertyValue"
               conceptFQName="jetbrains.mps.bootstrap.constraintsLanguage.structure.PropertySetter_FunctionParm_propertyValue"
               featureKind="CONCEPT"/>
          <value featureName="ConstraintsFunctionParameter_propertyValue"
                 conceptFQName="jetbrains.mps.bootstrap.constraintsLanguage.structure.ConstraintsFunctionParameter_propertyValue"
                 featureKind="CONCEPT"/>
        </entry>
      </conceptFeatureMap>
    </refactoringContext>
  ...
  <node type="jetbrains.mps.bootstrap.structureLanguage.structure.ConceptDeclaration" id="1148684180339">
    ...
    <link role="extends" targetNodeId="1148934493876"
          resolveInfo="ConstraintFunction_ReferentSearchScope_AbstractBase"/>
  ...
  <node type="jetbrains.mps.bootstrap.structureLanguage.structure.ConceptDeclaration" id="1148934493876">
    ...
    <node role="conceptLink" type="jetbrains.mps.bootstrap.structureLanguage.structure.ReferenceConceptLink"
      ...
      <link role="conceptLinkDeclaration" targetNodeId="3.1161119487665"
            resolveInfo="applicableConceptFunctionParameter"/>
      <link role="target" targetNodeId="1148934636683"
            resolveInfo="ConceptParameter_ReferentSearchScope_enclosingNode"/>
    </node>
    <node role="conceptProperty" type="jetbrains.mps.bootstrap.structureLanguage.structure.BooleanConceptProperty"
          id="1148934569050">
    ...
    <node role="conceptLink" type="jetbrains.mps.bootstrap.structureLanguage.structure.AggregationConceptLink"
      ...
      <node role="target" type="jetbrains.mps.bootstrap.structureLanguage.structure.ConceptDeclaration"
        ...
        <node role="conceptProperty" type="jetbrains.mps.bootstrap.structureLanguage.structure.StringConceptProperty"
          ...
          <link role="conceptPropertyDeclaration" targetNodeId="1.1210365515391"
                resolveInfo="deprecated_next_after_607"/>
        </node>
      </node>
    </node>
    <node role="conceptProperty" type="jetbrains.mps.bootstrap.structureLanguage.structure.StringConceptProperty"
