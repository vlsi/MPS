...
public class ConceptBehavior_Editor extends DefaultNodeEditor {
  ...
  private static void setupBasic_ConstantCell6(EditorCell editorCell, SNode node, EditorContext context) {
    editorCell.putUserObject(EditorCell.CELL_ID, node.getId() + "_1202989779529");
    editorCell.setSelectable(false);
  }
  ...
  public EditorCell createColumnCell1(EditorContext context, SNode node) {
    ...
    editorCell.addEditorCell(this.createConstantCell7(context, node, "can be a child"));
    ...
    editorCell.addEditorCell(this.createConstantCell9(context, node, "can be a parent"));
    ...
    editorCell.addEditorCell(this.createConstantCell16(context, node, "default scope"));
  ...
  public EditorCell createConstantCell13(EditorContext context, SNode node, String text) {
    EditorCell_Constant editorCell = new EditorCell_Constant(context, node, text);
    ConceptBehavior_Editor.setupBasic_ConstantCell13(editorCell, node, context);
    ConceptBehavior_Editor.setupLabel_ConstantCell13(editorCell, node, context);
    editorCell.setDefaultText("");
    return editorCell;
  }
  ...
  public EditorCell createConstantCell17(EditorContext context, SNode node, String text) {
    EditorCell_Constant editorCell = new EditorCell_Constant(context, node, text);
    ConceptBehavior_Editor.setupBasic_ConstantCell17(editorCell, node, context);
    ConceptBehavior_Editor.setupLabel_ConstantCell17(editorCell, node, context);
    editorCell.setDefaultText("");
    return editorCell;
  }
  ...
  public EditorCell createConstantCell19(EditorContext context, SNode node, String text) {
    EditorCell_Constant editorCell = new EditorCell_Constant(context, node, text);
    ConceptBehavior_Editor.setupBasic_ConstantCell19(editorCell, node, context);
    ConceptBehavior_Editor.setupLabel_ConstantCell19(editorCell, node, context);
    editorCell.setDefaultText("");
    return editorCell;
  }
  ...
  public EditorCell createDefaultConcreteConceptReferenceCellinternal(EditorContext context, SNode node, CellProviderWithRole aProvider) {
    CellProviderWithRole provider = aProvider;
    provider.setAuxiliaryCellProvider(new ConceptBehavior_Editor._Inline6());
    EditorCell editorCell = provider.createEditorCell(context);
  ...
  public static class _Inline6 extends AbstractCellProvider {
    ...
    public EditorCell createNameCellinternal(EditorContext context, SNode node, CellProviderWithRole aProvider) {
      ...
      provider.setAuxiliaryCellProvider(null);
      EditorCell editorCell = provider.createEditorCell(context);
      ConceptBehavior_Editor._Inline6.setupBasic_NameCell(editorCell, node, context);
      if(editorCell instanceof EditorCell_Label) {
        ConceptBehavior_Editor._Inline6.setupLabel_NameCell((EditorCell_Label)editorCell, node, context);
      }
      editorCell.setSubstituteInfo(provider.createDefaultSubstituteInfo());
      return editorCell;
    }
  ...
  public static class _RefNodeListHandler3 extends RefNodeListHandler {
    ...
    public EditorCell createEmptyCell_internal(EditorContext context, SNode node) {
      return this.createConstantCell12(context, node, "<<property constraints>>");
    }
    ...
    public EditorCell createConstantCell12(EditorContext context, SNode node, String text) {
      EditorCell_Constant editorCell = new EditorCell_Constant(context, node, text);
      ConceptBehavior_Editor._RefNodeListHandler3.setupBasic_ConstantCell12(editorCell, node, context);
      ConceptBehavior_Editor._RefNodeListHandler3.setupLabel_ConstantCell12(editorCell, node, context);
      editorCell.setDefaultText("");
      return editorCell;
    }
  ...
  public static class _RefNodeListHandler4 extends RefNodeListHandler {
    ...
    public EditorCell createEmptyCell_internal(EditorContext context, SNode node) {
      return this.createConstantCell14(context, node, "<<reference constraints>>");
    }
    ...
    public EditorCell createConstantCell14(EditorContext context, SNode node, String text) {
      EditorCell_Constant editorCell = new EditorCell_Constant(context, node, text);
      ConceptBehavior_Editor._RefNodeListHandler4.setupBasic_ConstantCell14(editorCell, node, context);
      ConceptBehavior_Editor._RefNodeListHandler4.setupLabel_ConstantCell14(editorCell, node, context);
      editorCell.setDefaultText("");
      return editorCell;
    }
  ...
  public static class _RefNodeListHandler5 extends RefNodeListHandler {
    ...
    public EditorCell createEmptyCell_internal(EditorContext context, SNode node) {
      return this.createConstantCell18(context, node, "<<concept methods>>");
    }
    ...
    public EditorCell createConstantCell18(EditorContext context, SNode node, String text) {
      EditorCell_Constant editorCell = new EditorCell_Constant(context, node, text);
      ConceptBehavior_Editor._RefNodeListHandler5.setupBasic_ConstantCell18(editorCell, node, context);
      ConceptBehavior_Editor._RefNodeListHandler5.setupLabel_ConstantCell18(editorCell, node, context);
      editorCell.setDefaultText("");
      return editorCell;
    }
