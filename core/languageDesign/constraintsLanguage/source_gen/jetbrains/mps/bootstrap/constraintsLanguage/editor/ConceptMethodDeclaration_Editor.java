...
public class ConceptMethodDeclaration_Editor extends DefaultNodeEditor {
  ...
  public EditorCell create_ConstantCell20116_05(EditorContext context, SNode node, String text) {
    ...
    editorCell.setDefaultText("");
    editorCell.setSubstituteInfo(new CompositeSubstituteInfo(context, new BasicCellContext(node), new SubstituteInfoPart[]{new ConceptMethodDeclaration_Editor.ConceptMethodDeclaration_component_cellMenu()}));
    return editorCell;
  }
  ...
  public static class ConceptMethodDeclaration_component_cellMenu implements SubstituteInfoPart {
