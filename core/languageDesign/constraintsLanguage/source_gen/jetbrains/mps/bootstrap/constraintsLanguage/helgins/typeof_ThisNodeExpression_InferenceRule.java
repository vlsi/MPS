...
public class typeof_ThisNodeExpression_InferenceRule extends AbstractInferenceRule_Runtime implements InferenceRule_Runtime {
  ...
  public void applyRule(final SNode thisNode, final TypeCheckingContext typeCheckingContext) {
    SNode behaviour = SNodeOperations.getAncestor(thisNode, "jetbrains.mps.bootstrap.constraintsLanguage.structure.ConceptBehavior", true, false);
    {
      ...
      TypeChecker.getInstance().getRuntimeSupport().createEquation(TypeChecker.getInstance().getRuntimeSupport().typeOf(thisNode, "r:00000000-0000-4000-0000-011c89590309(jetbrains.mps.bootstrap.constraintsLanguage.helgins)", "1212097673898", true), new QuotationClass_8().createNode(SLinkOperations.getTarget(behaviour, "concept", false)), _nodeToCheck_1029348928467, null, "r:00000000-0000-4000-0000-011c89590309(jetbrains.mps.bootstrap.constraintsLanguage.helgins)", "1212097673896", intentionProvider);
    }
  }
