...
public class ConstraintFunctionParameter_referenceNode extends ConceptFunctionParameter {
  public static final String concept = "jetbrains.mps.bootstrap.constraintsLanguage.structure.ConstraintFunctionParameter_referenceNode";
  ...
  public static ConstraintFunctionParameter_referenceNode newInstance(SModel sm, boolean init) {
    return (ConstraintFunctionParameter_referenceNode)SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.bootstrap.constraintsLanguage.structure.ConstraintFunctionParameter_referenceNode", sm, GlobalScope.getInstance(), init).getAdapter();
  }
