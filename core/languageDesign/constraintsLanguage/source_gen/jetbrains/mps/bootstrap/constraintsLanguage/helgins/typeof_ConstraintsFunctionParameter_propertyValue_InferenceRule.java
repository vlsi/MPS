    ...
    if (dataType != null) {
      {
        ...
        TypeChecker.getInstance().getRuntimeSupport().createEquation(TypeChecker.getInstance().getRuntimeSupport().typeOf(node, "r:00000000-0000-4000-0000-011c89590309(jetbrains.mps.bootstrap.constraintsLanguage.helgins)", "1212097666659", true), DataTypeDeclaration_Behavior.call_toBaseLanguageType_1213877229718(dataType), _nodeToCheck_1029348928467, null, "r:00000000-0000-4000-0000-011c89590309(jetbrains.mps.bootstrap.constraintsLanguage.helgins)", "1212097666657", intentionProvider);
      }
    }
  }
