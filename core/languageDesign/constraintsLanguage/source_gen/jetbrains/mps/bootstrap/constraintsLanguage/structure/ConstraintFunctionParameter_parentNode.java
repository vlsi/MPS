...
public class ConstraintFunctionParameter_parentNode extends ConceptFunctionParameter {
  public static final String concept = "jetbrains.mps.bootstrap.constraintsLanguage.structure.ConstraintFunctionParameter_parentNode";
  ...
  public static ConstraintFunctionParameter_parentNode newInstance(SModel sm, boolean init) {
    return (ConstraintFunctionParameter_parentNode)SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.bootstrap.constraintsLanguage.structure.ConstraintFunctionParameter_parentNode", sm, GlobalScope.getInstance(), init).getAdapter();
  }
