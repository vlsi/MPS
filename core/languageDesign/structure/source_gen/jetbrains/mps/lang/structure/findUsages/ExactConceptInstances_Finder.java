...
public class ExactConceptInstances_Finder extends GeneratedFinder {
  ...
  protected void doFind(SNode node, IScope scope, List<SNode> _results, ProgressIndicator indicator) {
    List<SNode> resNodes = ListSequence.<SNode>fromListWithValues(new ArrayList<SNode>(), FindUsagesManager.getInstance().findExactInstances(node, scope, new FindUsagesManager.ProgressAdapter(indicator), false));
