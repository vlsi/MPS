...
public class ShowConceptStructure_Action extends GeneratedAction {
  ...
  public void doExecute(@NotNull final AnActionEvent event) {
    try {
      ...
      tool.getStructureView().inspect(((AbstractConceptDeclaration) ((BaseConcept) SNodeOperations.getAdapter(ShowConceptStructure_Action.this.node))), ProjectOperationContext.get(ShowConceptStructure_Action.this.project));
