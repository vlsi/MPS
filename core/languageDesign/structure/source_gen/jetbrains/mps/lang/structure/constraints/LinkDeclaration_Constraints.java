      ...
      public ReferenceScopeProvider getScopeProvider() {
        return new BaseReferenceScopeProvider() {
          ...
          public Object createSearchScopeOrListOfNodes(final IOperationContext operationContext, final ReferenceConstraintsContext _context) {
            ...
            for (SNode concept : ListSequence.<SNode>fromList(directSupers)) {
              List<SNode> links = AbstractConceptDeclaration_Behavior.call_getLinkDeclarations_1213877394480(concept);
              ListSequence.<SNode>fromList(result).addSequence(ListSequence.<SNode>fromList(links).where(new IWhereFilter<SNode>() {
