...
public class AbstractConceptDeclaration_Behavior {
  ...
  public static List<SNode> call_findConceptAspect_1567570417158062208(SNode thisNode, IScope scope, LanguageAspect aspect) {
    ...
    for (SNode aspectConcept : SModelOperations.getRoots(model, "jetbrains.mps.lang.structure.structure.IConceptAspect")) {
      if (ListSequence.fromList(IConceptAspect_Behavior.call_getBaseConceptCollection_5270353093116013036(aspectConcept)).contains(thisNode)) {
        ListSequence.fromList(result).addElement(aspectConcept);
      }
    }
    return result;
  }
  ...
  public static List<SNode> call_findActions_4085963264561761230(SNode thisNode, IScope scope) {
    ...
    for (SNode aspect : SModelOperations.getRoots(model, "jetbrains.mps.lang.structure.structure.IConceptAspect")) {
      if (ListSequence.fromList(IConceptAspect_Behavior.call_getBaseConceptCollection_5270353093116013036(aspect)).contains(thisNode)) {
        ListSequence.fromList(result).addElement(aspect);
      }
    }
    return result;
  }
