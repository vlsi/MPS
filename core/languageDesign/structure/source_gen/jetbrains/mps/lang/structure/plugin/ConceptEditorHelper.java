...
/*
  public static void addMultitabbedListener(final BaseMultitabbedTab tab, final LanguageAspect aspect, boolean listenNonRootEvents) {
  ...
  public static void addGeneratorListener(final BaseMultitabbedTab tab) {
    final Language language = ConceptEditorHelper.getLanguageForTab(tab);
  ...
  public static void addSingletabbedListener(final BaseSingletabbedTab tab, final LanguageAspect aspect, boolean listenNonRootEvents) {
    final Language language = ConceptEditorHelper.getLanguageForTab(tab);
...
*/
  ...
  /*package*/
  static List<SNode> sortRootsByConcept(List<SNode> roots, final SNode[] conceptOrder) {
...
/*
  public static class MultitabbedListener extends SModelAdapter {
    private BaseMultitabbedTab tab;
    private boolean listenNonRootEvents;

    public MultitabbedListener(BaseMultitabbedTab tab, boolean listenNonRootEvents) {
      this.tab = tab;
  ...
  public static class SingletabbedListener extends SModelAdapter {
    private BaseSingletabbedTab tab;
    private boolean listenNonRootEvents;

    public SingletabbedListener(BaseSingletabbedTab tab, boolean listenNonRootEvents) {
      this.tab = tab;
      this.listenNonRootEvents = listenNonRootEvents;
    }
