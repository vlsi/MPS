...
public class LinkDeclaration extends jetbrains.mps.lang.core.structure.BaseConcept implements jetbrains.mps.lang.structure.structure.IStructureDeprecatable {
  ...
  public jetbrains.mps.lang.structure.structure.LinkDeclaration getSpecializedLink() {
    return (jetbrains.mps.lang.structure.structure.LinkDeclaration)this.getReferent(LinkDeclaration.class, LinkDeclaration.SPECIALIZED_LINK);
  }

  public void setSpecializedLink(jetbrains.mps.lang.structure.structure.LinkDeclaration node) {
    super.setReferent(LinkDeclaration.SPECIALIZED_LINK, node);
  }

  public jetbrains.mps.lang.structure.structure.AbstractConceptDeclaration getTarget() {
    return (jetbrains.mps.lang.structure.structure.AbstractConceptDeclaration)this.getReferent(AbstractConceptDeclaration.class, LinkDeclaration.TARGET);
  }

  public void setTarget(jetbrains.mps.lang.structure.structure.AbstractConceptDeclaration node) {
