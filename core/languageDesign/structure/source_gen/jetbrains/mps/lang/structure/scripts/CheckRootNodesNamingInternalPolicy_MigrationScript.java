  ...
  public CheckRootNodesNamingInternalPolicy_MigrationScript(IOperationContext operationContext) {
    ...
    this.addRefactoring(new AbstractMigrationRefactoring(operationContext) {
      ...
      public void doUpdateInstanceNode(SNode node) {
        SNode aliasProperty = SNodeOperations.cast(ListSequence.<SNode>fromList(SLinkOperations.getTargets(node, "conceptProperty", true)).where(new IWhereFilter<SNode>() {
    ...
    this.addRefactoring(new AbstractMigrationRefactoring(operationContext) {
      ...
      public void doUpdateInstanceNode(SNode node) {
        ...
        for (String word : ListSequence.<String>fromList(NameUtil.splitByCamels(SPropertyOperations.getString(node, "name")))) {
