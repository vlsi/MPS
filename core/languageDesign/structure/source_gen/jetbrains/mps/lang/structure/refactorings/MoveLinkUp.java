...
public class MoveLinkUp extends BaseLoggableRefactoring {
  ...
  public boolean init(final RefactoringContext refactoringContext) {
    ...
    return MoveLinkUp.this.ask(refactoringContext, MPSChooserFactory.createNodeChooser(refactoringContext, "targetConcept", new MoveLinkUp_targetConcept_Settings(refactoringContext)));
  }

  public void refactor(final RefactoringContext refactoringContext) {
    SNode node = refactoringContext.getSelectedNode();
    /*
      SNode linkToReplace = RefUtil.findLinkToMerge(SNodeOperations.cast(((SNode) refactoringContext.getParameter("targetConcept")), "jetbrains.mps.lang.structure.structure.AbstractConceptDeclaration"), node);
