...
public class QueryFunction_ParameterizedSideTransform_Handler extends ConceptFunction {
  public static final String concept = "jetbrains.mps.bootstrap.actionsLanguage.structure.QueryFunction_ParameterizedSideTransform_Handler";
  ...
  public static QueryFunction_ParameterizedSideTransform_Handler newInstance(SModel sm, boolean init) {
    return (QueryFunction_ParameterizedSideTransform_Handler)SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.bootstrap.actionsLanguage.structure.QueryFunction_ParameterizedSideTransform_Handler", sm, GlobalScope.getInstance(), init).getAdapter();
  }
