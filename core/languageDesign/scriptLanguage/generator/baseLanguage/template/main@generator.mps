...
<model modelUID="jetbrains.mps.ide.scriptLanguage.generator.baseLanguage.template.main@generator">
  ...
  <import index="5" modelUID="jetbrains.mps.ide.scriptLanguage.util@java_stub" version="-1" />
