...
public class typeof_MigrationScriptPart_node_InferenceRule implements InferenceRule_Runtime {
  ...
  public void applyRule(final SNode node) {
    SNode affectedConcept = SLinkOperations.getTarget(SNodeOperations.getAncestor(node, "jetbrains.mps.ide.scriptLanguage.structure.MigrationScriptPart_Instance", false, false), "affectedInstanceConcept", false);
    {
      ...
      TypeChecker.getInstance().getRuntimeSupport().createEquation(TypeChecker.getInstance().getRuntimeSupport().typeOf(node, "jetbrains.mps.ide.scriptLanguage.helgins", "1209063748604", true), new QuotationClass_0().createNode(affectedConcept), _nodeToCheck_1029348928467, null, "jetbrains.mps.ide.scriptLanguage.helgins", "1209063748602", intentionProvider);
    }
  }
