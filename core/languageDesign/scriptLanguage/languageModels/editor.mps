...
<model name="jetbrains.mps.ide.scriptLanguage.editor">
  ...
  <node type="jetbrains.mps.bootstrap.editorLanguage.structure.ConceptEditorDeclaration" id="1172272818532">
    ...
    <node role="cellModel" type="jetbrains.mps.bootstrap.editorLanguage.structure.CellModel_Collection" id="1172272822706">
      ...
      <node role="childCellModel" type="jetbrains.mps.bootstrap.editorLanguage.structure.CellModel_RefNodeList" id="1202868101489">
        <property name="vertical" value="true" />
        <link role="relationDeclaration" targetNodeId="5.1202867702844" />
        <node role="emptyCellModel" type="jetbrains.mps.bootstrap.editorLanguage.structure.CellModel_Constant" id="1202868106146">
