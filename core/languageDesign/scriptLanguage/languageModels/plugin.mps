      ...
      <node role="body" type="jetbrains.mps.baseLanguage.structure.StatementList" id="1207490769340">
        ...
        <node role="statement" type="jetbrains.mps.baseLanguage.structure.ExpressionStatement" id="1207492378589">
          <node role="expression" type="jetbrains.mps.baseLanguage.structure.DotExpression" id="1207492379669">
            <node role="operand" type="jetbrains.mps.baseLanguage.classifiers.structure.ThisClassifierExpresson" id="1207492378590" />
            <node role="operation" type="jetbrains.mps.baseLanguage.structure.InstanceMethodCallOperation" id="1207492382030">
              <link role="baseMethodDeclaration" targetNodeId="7.~ActionGroupElement.setVisible(boolean):void" resolveInfo="setVisible" />
              <node role="actualArgument" type="jetbrains.mps.baseLanguage.structure.BooleanConstant" id="1207492384031">
        ...
        <node role="statement" type="jetbrains.mps.baseLanguage.structure.IfStatement" id="1207492387235">
          <node role="ifTrue" type="jetbrains.mps.baseLanguage.structure.StatementList" id="1207492387236">
            <node role="statement" type="jetbrains.mps.baseLanguage.structure.ExpressionStatement" id="1207492452911">
              <node role="expression" type="jetbrains.mps.baseLanguage.structure.DotExpression" id="1207492453991">
                <node role="operand" type="jetbrains.mps.baseLanguage.classifiers.structure.ThisClassifierExpresson" id="1207492452912" />
                <node role="operation" type="jetbrains.mps.baseLanguage.structure.InstanceMethodCallOperation" id="1207492454758">
                  <link role="baseMethodDeclaration" targetNodeId="7.~ActionGroupElement.setEnabled(boolean):void" resolveInfo="setEnabled" />
                  <node role="actualArgument" type="jetbrains.mps.baseLanguage.structure.BooleanConstant" id="1207492457384">
          ...
          <node role="condition" type="jetbrains.mps.baseLanguage.structure.EqualsExpression" id="1207492441893">
            ...
            <node role="leftExpression" type="jetbrains.mps.baseLanguage.structure.DotExpression" id="1207492391193">
              <node role="operand" type="jetbrains.mps.bootstrap.pluginLanguage.structure.ConceptFunctionParameter_ActionContext" id="1207492389708" />
              <node role="operation" type="jetbrains.mps.baseLanguage.structure.InstanceMethodCallOperation" id="1207492406990">
                <link role="baseMethodDeclaration" targetNodeId="7.~ActionContext.get(java.lang.Class):java.lang.Object" resolveInfo="get" />
                <node role="actualArgument" type="jetbrains.mps.baseLanguage.structure.ClassifierClassExpression" id="1207492433237">
        ...
        <node role="statement" type="jetbrains.mps.baseLanguage.structure.ExpressionStatement" id="1207492467246">
          <node role="expression" type="jetbrains.mps.baseLanguage.structure.DotExpression" id="1207492468186">
            <node role="operand" type="jetbrains.mps.baseLanguage.classifiers.structure.ThisClassifierExpresson" id="1207492467247" />
            <node role="operation" type="jetbrains.mps.baseLanguage.structure.InstanceMethodCallOperation" id="1207492469312">
              <link role="baseMethodDeclaration" targetNodeId="7.~ActionGroupElement.setEnabled(boolean):void" resolveInfo="setEnabled" />
              <node role="actualArgument" type="jetbrains.mps.baseLanguage.structure.BooleanConstant" id="1207492472360">
                <property name="value" value="true" />
              </node>
            </node>
          </node>
        ...
        <node role="statement" type="jetbrains.mps.baseLanguage.structure.LocalVariableDeclarationStatement" id="1207493128970">
          <node role="localVariableDeclaration" type="jetbrains.mps.baseLanguage.structure.LocalVariableDeclaration" id="1207493128971">
            ...
            <node role="initializer" type="jetbrains.mps.baseLanguage.structure.NewExpression" id="1207493142444">
              <link role="baseMethodDeclaration" targetNodeId="7.~ActionGroup.&lt;init&gt;(java.lang.String)" resolveInfo="ActionGroup" />
        ...
        <node role="statement" type="jetbrains.mps.baseLanguage.structure.ExpressionStatement" id="1207493245136">
          <node role="expression" type="jetbrains.mps.baseLanguage.structure.StaticMethodCall" id="1207493245137">
            <link role="classConcept" targetNodeId="2.~ScriptsActionGroupHelper" resolveInfo="ScriptsActionGroupHelper" />
            <link role="baseMethodDeclaration" targetNodeId="2.~ScriptsActionGroupHelper.populateByCategoryGroup(java.util.List,jetbrains.mps.ide.action.ActionGroup):void" resolveInfo="populateByCategoryGroup" />
        ...
        <node role="statement" type="jetbrains.mps.baseLanguage.structure.ExpressionStatement" id="1207493307359">
          <node role="expression" type="jetbrains.mps.baseLanguage.structure.StaticMethodCall" id="1207493310267">
            <link role="classConcept" targetNodeId="2.~ScriptsActionGroupHelper" resolveInfo="ScriptsActionGroupHelper" />
            <link role="baseMethodDeclaration" targetNodeId="2.~ScriptsActionGroupHelper.populateByBuildGroup(java.util.List,jetbrains.mps.ide.action.ActionGroup):void" resolveInfo="populateByBuildGroup" />
          ...
          <node role="body" type="jetbrains.mps.baseLanguage.structure.StatementList" id="1207493362825">
            <node role="statement" type="jetbrains.mps.baseLanguage.structure.ExpressionStatement" id="1207493381401">
              <node role="expression" type="jetbrains.mps.baseLanguage.structure.StaticMethodCall" id="1207493384403">
                <link role="classConcept" targetNodeId="2.~ScriptsActionGroupHelper" resolveInfo="ScriptsActionGroupHelper" />
                <link role="baseMethodDeclaration" targetNodeId="2.~ScriptsActionGroupHelper.populateByLanguageGroup(jetbrains.mps.smodel.Language,jetbrains.mps.ide.action.ActionGroup):void" resolveInfo="populateByLanguageGroup" />
