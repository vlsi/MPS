...
public class typeof_ConstraintFunctionParameter_referenceNode_InferenceRule extends AbstractInferenceRule_Runtime implements InferenceRule_Runtime {
  ...
  public static class QuotationClass_57math_a0a0a2a0 {
    public QuotationClass_57math_a0a0a2a0() {
    }

    public SNode createNode(final TypeCheckingContext typeCheckingContext) {
      SNode result = null;
      Set<SNode> _parameterValues_129834374 = new HashSet<SNode>();
      SNode quotedNode_57math_a0a0a2a0 = null;
      {
        quotedNode_57math_a0a0a2a0 = SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.lang.smodel.structure.SNodeType", TypeChecker.getInstance().getRuntimeTypesModel(), GlobalScope.getInstance(), false);
        SNode quotedNode1_57math_a0a0a2a0 = quotedNode_57math_a0a0a2a0;
        result = quotedNode1_57math_a0a0a2a0;
      }
      return result;
    }
  ...
  public static class QuotationClass_57math_a0a0a0c0a {
    public QuotationClass_57math_a0a0a0c0a() {
    }

    public SNode createNode(Object parameter_57math_a0a0a0a0c0a, final TypeCheckingContext typeCheckingContext) {
      SNode result = null;
      Set<SNode> _parameterValues_129834374 = new HashSet<SNode>();
      SNode quotedNode_57math_a0a0a0c0a = null;
      {
        quotedNode_57math_a0a0a0c0a = SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.lang.smodel.structure.SNodeType", TypeChecker.getInstance().getRuntimeTypesModel(), GlobalScope.getInstance(), false);
        SNode quotedNode1_57math_a0a0a0c0a = quotedNode_57math_a0a0a0c0a;
        quotedNode1_57math_a0a0a0c0a.setReferent("concept", (SNode) parameter_57math_a0a0a0a0c0a);
        result = quotedNode1_57math_a0a0a0c0a;
      }
      return result;
    }

    public SNode createNode(Object parameter_57math_a0a0a0a0c0a) {
      SNode result = null;
      Set<SNode> _parameterValues_129834374 = new HashSet<SNode>();
      SNode quotedNode_57math_a0a0a0c0a = null;
      {
