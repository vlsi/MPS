...
public class ConceptConstructorDeclaration extends ConceptFunction {
  public static final String concept = "jetbrains.mps.lang.constraints.structure.ConceptConstructorDeclaration";
  ...
  public static ConceptConstructorDeclaration newInstance(SModel sm, boolean init) {
    return (ConceptConstructorDeclaration)SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.lang.constraints.structure.ConceptConstructorDeclaration", sm, GlobalScope.getInstance(), init).getAdapter();
  }
