...
public class ConceptConstraints_Behavior {
  ...
  public static void call_setBaseConcept_6261424444345978682(SNode thisNode, SNode baseConcept) {
    BehaviorManager.getInstance().invoke(Object.class, SNodeOperations.cast(thisNode, "jetbrains.mps.lang.constraints.structure.ConceptConstraints"), "virtual_setBaseConcept_6261424444345963020", PARAMETERS_6261424444345978682, baseConcept);
  }
