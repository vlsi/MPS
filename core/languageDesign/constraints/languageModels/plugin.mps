...
<model modelUID="r:00000000-0000-4000-0000-011c8959030b(jetbrains.mps.lang.constraints.plugin)">
    ...
    <languageAspect modelUID="r:00000000-0000-4000-0000-011c895902ba(jetbrains.mps.lang.sharedConcepts.constraints)"
                    version="0"/>
    <languageAspect modelUID="r:00000000-0000-4000-0000-011c89590307(jetbrains.mps.lang.constraints.constraints)"
                    version="9"/>
    ...
    <import index="2"
            modelUID="f:java_stub#jetbrains.mps.smodel.constraints(jetbrains.mps.smodel.constraints@java_stub)"
            version="-1"/>
            ...
            <node role="body" type="jetbrains.mps.baseLanguage.structure.StatementList" id="1208436374876">
                <node role="statement" type="jetbrains.mps.baseLanguage.structure.LocalVariableDeclarationStatement"
                    ...
                    <node role="localVariableDeclaration"
                          type="jetbrains.mps.baseLanguage.structure.LocalVariableDeclaration" id="1208436397040">
                        ...
                        <node role="initializer" type="jetbrains.mps.baseLanguage.structure.DotExpression"
                            ...
                            <node role="operation"
                                ...
                                <link role="baseMethodDeclaration"
                                      targetNodeId="16.~MPSProject.getComponent(java.lang.Class):java.lang.Object"
                        ...
                        <node role="statement" type="jetbrains.mps.baseLanguage.structure.ExpressionStatement"
                            ...
                            <node role="expression" type="jetbrains.mps.baseLanguage.structure.DotExpression"
                                ...
                                <node role="operand" type="jetbrains.mps.baseLanguage.structure.LocalVariableReference"
                                      id="1208436397050">
                                    <link role="variableDeclaration" targetNodeId="1208436397040"
                                ...
                                <node role="operation"
                                      ...
                                      id="1208436397051">
                                    <link role="baseMethodDeclaration"
                                          targetNodeId="12.~Highlighter.addChecker(jetbrains.mps.nodeEditor.IEditorChecker):void"
                                          resolveInfo="addChecker"/>
                                    <node role="actualArgument"
                                          type="jetbrains.mps.baseLanguage.structure.DotExpression" id="1208436397052">
                                        <node role="operand"
                                        ...
                                        <node role="operation"
                                              ...
                                              id="1215438662761">
                                            <link role="member" targetNodeId="1215438637915"
                                                  resolveInfo="myConstraintsChecker"/>
                                        </node>
                                    </node>
                                </node>
                            </node>
        ...
        <node role="disposeBlock" type="jetbrains.mps.lang.plugin.structure.ProjectPluginDisposeBlock"
            ...
            <node role="body" type="jetbrains.mps.baseLanguage.structure.StatementList" id="1208436375613">
                <node role="statement" type="jetbrains.mps.baseLanguage.structure.LocalVariableDeclarationStatement"
                      id="1208436450682">
                    <node role="localVariableDeclaration"
                          type="jetbrains.mps.baseLanguage.structure.LocalVariableDeclaration" id="1208436450683">
                        <property name="name" value="highlighter"/>
                    ...
                    <node role="ifTrue" type="jetbrains.mps.baseLanguage.structure.StatementList" id="1208436450705">
                        <node role="statement" type="jetbrains.mps.baseLanguage.structure.ExpressionStatement"
                            ...
                            <node role="expression" type="jetbrains.mps.baseLanguage.structure.DotExpression"
                                ...
                                <node role="operand" type="jetbrains.mps.baseLanguage.structure.LocalVariableReference"
                                      id="1208436450708">
                                    <link role="variableDeclaration" targetNodeId="1208436450683"
                                          resolveInfo="highlighter"/>
                                </node>
                                <node role="operation"
                                      type="jetbrains.mps.baseLanguage.structure.InstanceMethodCallOperation"
                                      id="1208436450709">
                                    <link role="baseMethodDeclaration"
                                          targetNodeId="12.~Highlighter.removeChecker(jetbrains.mps.nodeEditor.IEditorChecker):void"
                                          resolveInfo="removeChecker"/>
                                    <node role="actualArgument"
                                          type="jetbrains.mps.baseLanguage.structure.DotExpression" id="1208436450710">
                                        <node role="operand"
                                              type="jetbrains.mps.baseLanguage.classifiers.structure.ThisClassifierExpresson"
                                              id="1208436450711"/>
                                        <node role="operation"
