...
public class RelativePosition extends Position {
  ...
  public static RelativePosition newInstance(SModel sm, boolean init) {
    return (RelativePosition)SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.bootstrap.dataFlow.structure.RelativePosition", sm, GlobalScope.getInstance(), init).getAdapter();
  }
