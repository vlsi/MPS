...
public class DataFlowBuilderDeclaration_name_PropertyConstraint implements IModelConstraints, INodePropertyGetter {
  ...
  public void registerSelf(ModelConstraintsManager manager) {
    manager.registerNodePropertyGetter("jetbrains.mps.bootstrap.dataFlow.structure.DataFlowBuilderDeclaration", "name", this);
  }

  public void unRegisterSelf(ModelConstraintsManager manager) {
    manager.unRegisterNodePropertyGetter("jetbrains.mps.bootstrap.dataFlow.structure.DataFlowBuilderDeclaration", "name");
  }
