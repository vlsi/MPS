...
public class EmitStatement extends Statement {
  public static final String concept = "jetbrains.mps.bootstrap.dataFlow.structure.EmitStatement";
  ...
  public static EmitStatement newInstance(SModel sm, boolean init) {
    return (EmitStatement)SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.bootstrap.dataFlow.structure.EmitStatement", sm, GlobalScope.getInstance(), init).getAdapter();
  }
