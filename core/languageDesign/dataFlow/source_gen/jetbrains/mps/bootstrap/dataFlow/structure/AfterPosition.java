...
public class AfterPosition extends RelativePosition {
  public static final String concept = "jetbrains.mps.bootstrap.dataFlow.structure.AfterPosition";
  ...
  public static AfterPosition newInstance(SModel sm, boolean init) {
    return (AfterPosition)SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.bootstrap.dataFlow.structure.AfterPosition", sm, GlobalScope.getInstance(), init).getAdapter();
  }
