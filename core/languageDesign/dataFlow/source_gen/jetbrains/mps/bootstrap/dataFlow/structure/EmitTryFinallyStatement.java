...
public class EmitTryFinallyStatement extends EmitStatement {
  public static final String concept = "jetbrains.mps.bootstrap.dataFlow.structure.EmitTryFinallyStatement";
  ...
  public StatementList getTryPart() {
    return (StatementList)this.getChild(EmitTryFinallyStatement.TRY_PART);
  }
  ...
  public StatementList getFinallyPart() {
    return (StatementList)this.getChild(EmitTryFinallyStatement.FINALLY_PART);
  }
  ...
  public static EmitTryFinallyStatement newInstance(SModel sm, boolean init) {
    return (EmitTryFinallyStatement)SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.bootstrap.dataFlow.structure.EmitTryFinallyStatement", sm, GlobalScope.getInstance(), init).getAdapter();
  }
