...
public class BaseEmitVariableStatement_Editor extends DefaultNodeEditor {
  ...
  private static void setupBasic_RowCell(EditorCell editorCell, SNode node, EditorContext context) {
    editorCell.putUserObject(EditorCell.CELL_ID, node.getId() + "_1206444688631");
  }

  private static void setupBasic_CellModel_ConceptProperty(EditorCell editorCell, SNode node, EditorContext context) {
    editorCell.putUserObject(EditorCell.CELL_ID, node.getId() + "_1206444690133");
  ...
  private static void setupBasic_VariableCell(EditorCell editorCell, SNode node, EditorContext context) {
    editorCell.putUserObject(EditorCell.CELL_ID, node.getId() + "_1206444691354");
  }
  ...
  public EditorCell createRowCell(EditorContext context, SNode node) {
    ...
    BaseEmitVariableStatement_Editor.setupBasic_RowCell(editorCell, node, context);
  ...
  public EditorCell createCellModel_ConceptPropertyinternal(EditorContext context, SNode node, CellProviderWithRole aProvider) {
    ...
    BaseEmitVariableStatement_Editor.setupBasic_CellModel_ConceptProperty(editorCell, node, context);
    if (editorCell instanceof EditorCell_Label) {
      BaseEmitVariableStatement_Editor.setupLabel_CellModel_ConceptProperty((EditorCell_Label)editorCell, node, context);
    }
  ...
  public EditorCell createVariableCellinternal(EditorContext context, SNode node, CellProviderWithRole aProvider) {
    ...
    provider.setAuxiliaryCellProvider(null);
    EditorCell editorCell = provider.createEditorCell(context);
    BaseEmitVariableStatement_Editor.setupBasic_VariableCell(editorCell, node, context);
    if (editorCell instanceof EditorCell_Label) {
      BaseEmitVariableStatement_Editor.setupLabel_VariableCell((EditorCell_Label)editorCell, node, context);
    }
    editorCell.setSubstituteInfo(provider.createDefaultSubstituteInfo());
    return editorCell;
  }
