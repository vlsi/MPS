...
public class EmitReadStatement extends BaseEmitVariableStatement {
  public static final String concept = "jetbrains.mps.bootstrap.dataFlow.structure.EmitReadStatement";
  ...
  public static EmitReadStatement newInstance(SModel sm, boolean init) {
    return (EmitReadStatement)SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.bootstrap.dataFlow.structure.EmitReadStatement", sm, GlobalScope.getInstance(), init).getAdapter();
  }
