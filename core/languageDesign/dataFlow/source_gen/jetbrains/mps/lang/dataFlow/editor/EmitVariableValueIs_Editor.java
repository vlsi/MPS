...
public class EmitVariableValueIs_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createCollection_0576_0(EditorContext editorContext, SNode node) {
    ...
    editorCell.addEditorCell(this.createConstant_0576_0(editorContext, node, "variable"));
    editorCell.addEditorCell(this.createRefNode_0576_0(editorContext, node));
    editorCell.addEditorCell(this.createConstant_0576_1(editorContext, node, "value is"));
    editorCell.addEditorCell(this.createRefNode_0576_1(editorContext, node));
    return editorCell;
  }

  private EditorCell createConstant_0576_0(EditorContext editorContext, SNode node, String text) {
  ...
  private EditorCell createConstant_0576_1(EditorContext editorContext, SNode node, String text) {
    EditorCell_Constant editorCell = new EditorCell_Constant(editorContext, node, text);
