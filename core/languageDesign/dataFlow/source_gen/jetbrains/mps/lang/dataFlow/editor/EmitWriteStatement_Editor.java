...
public class EmitWriteStatement_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createCollection_7agu8k_a(EditorContext editorContext, SNode node) {
    ...
    editorCell.addEditorCell(this.createConceptProperty_7agu8k_a0(editorContext, node));
  ...
  private EditorCell createConceptProperty_7agu8k_a0(EditorContext editorContext, SNode node) {
