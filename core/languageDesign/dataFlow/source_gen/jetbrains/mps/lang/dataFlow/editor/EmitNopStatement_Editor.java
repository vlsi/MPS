...
public class EmitNopStatement_Editor extends DefaultNodeEditor {
  public EditorCell createEditorCell(EditorContext editorContext, SNode node) {
    return this.createConstant_s9jju4_a(editorContext, node);
  }

  private EditorCell createConstant_s9jju4_a(EditorContext editorContext, SNode node) {
    EditorCell_Constant editorCell = new EditorCell_Constant(editorContext, node, "nop");
    editorCell.setCellId("Constant_s9jju4_a");
