...
public class typeof_RelativePosition_InferenceRule extends AbstractInferenceRule_Runtime implements InferenceRule_Runtime {
  ...
  public static class QuotationClass_lgqnjw_a0a0a0 {
    ...
    public SNode createNode(final TypeCheckingContext typeCheckingContext) {
      ...
      SNode quotedNode_lgqnjw_a0a0a0 = null;
      {
        quotedNode_lgqnjw_a0a0a0 = SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.lang.smodel.structure.SNodeType", TypeChecker.getInstance().getRuntimeTypesModel(), GlobalScope.getInstance(), false);
        SNode quotedNode1_lgqnjw_a0a0a0 = quotedNode_lgqnjw_a0a0a0;
        result = quotedNode1_lgqnjw_a0a0a0;
      }
      return result;
    }
