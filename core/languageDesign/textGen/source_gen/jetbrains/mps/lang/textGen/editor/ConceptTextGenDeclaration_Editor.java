...
public class ConceptTextGenDeclaration_Editor extends DefaultNodeEditor {
  ...
  public EditorCell createCollection_2829_0(EditorContext context, SNode node) {
    ...
    editorCell.addEditorCell(this.createCollection_2829_4(context, node));
  ...
  public EditorCell createCollection_2829_2(EditorContext context, SNode node) {
    EditorCell_Collection editorCell = EditorCell_Collection.createVertical(context, node);
    setupBasic_Collection_2829_2(editorCell, node, context);
    editorCell.setGridLayout(false);
    editorCell.setUsesBraces(false);
    editorCell.setCanBeFolded(false);
    editorCell.addEditorCell(this.createCollection_2829_3(context, node));
    return editorCell;
  }

  public EditorCell createCollection_2829_3(EditorContext context, SNode node) {
    EditorCell_Collection editorCell = EditorCell_Collection.createHorizontal(context, node);
    setupBasic_Collection_2829_3(editorCell, node, context);
    editorCell.setGridLayout(false);
    editorCell.setUsesBraces(false);
    editorCell.setCanBeFolded(false);
  ...
  public EditorCell createCollection_2829_4(EditorContext context, SNode node) {
    EditorCell_Collection editorCell = EditorCell_Collection.createHorizontal(context, node);
    setupBasic_Collection_2829_4(editorCell, node, context);
    editorCell.setGridLayout(false);
    editorCell.setUsesBraces(false);
    editorCell.setCanBeFolded(false);
    editorCell.addEditorCell(this.createIndentCell2829_0(context, node));
    editorCell.addEditorCell(this.createCollection_2829_2(context, node));
    return editorCell;
  }
  ...
  public EditorCell createIndentCell2829_0(EditorContext context, SNode node) {
  ...
  private static void setupBasic_Collection_2829_2(EditorCell editorCell, SNode node, EditorContext context) {
  ...
  private static void setupBasic_Collection_2829_3(EditorCell editorCell, SNode node, EditorContext context) {
    editorCell.setCellId("Collection_2829_3");
    {
      Style inlineStyle = new Style(editorCell) {
        {
          this.set(StyleAttributes.SELECTABLE, false);
  ...
  private static void setupBasic_Collection_2829_4(EditorCell editorCell, SNode node, EditorContext context) {
    editorCell.setCellId("Collection_2829_4");
    {
      Style inlineStyle = new Style(editorCell) {
        {
          this.set(StyleAttributes.SELECTABLE, false);
  ...
  private static void setupBasic_Indent_2829_0(EditorCell editorCell, SNode node, EditorContext context) {
    editorCell.setCellId("Indent_2829_0");
  }
