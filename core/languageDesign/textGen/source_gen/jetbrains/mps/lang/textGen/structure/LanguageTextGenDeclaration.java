...
public class LanguageTextGenDeclaration extends AbstractTextGenDeclaration implements IConceptAspect {
  ...
  public String getShortDescription() {
    return this.getProperty(LanguageTextGenDeclaration.SHORT_DESCRIPTION);
  }

  public void setShortDescription(String value) {
    this.setProperty(LanguageTextGenDeclaration.SHORT_DESCRIPTION, value);
  }

  public String getAlias() {
    return this.getProperty(LanguageTextGenDeclaration.ALIAS);
  }

  public void setAlias(String value) {
    this.setProperty(LanguageTextGenDeclaration.ALIAS, value);
  }

  public String getVirtualPackage() {
    return this.getProperty(LanguageTextGenDeclaration.VIRTUAL_PACKAGE);
  }

  public void setVirtualPackage(String value) {
    this.setProperty(LanguageTextGenDeclaration.VIRTUAL_PACKAGE, value);
  }
