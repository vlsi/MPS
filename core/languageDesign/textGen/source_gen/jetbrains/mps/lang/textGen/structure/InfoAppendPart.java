...
public class InfoAppendPart extends jetbrains.mps.lang.textGen.structure.AbstractAppendPart {
  ...
  public jetbrains.mps.baseLanguage.structure.Expression getValue() {
    return (jetbrains.mps.baseLanguage.structure.Expression)this.getChild(Expression.class, InfoAppendPart.VALUE);
  }
