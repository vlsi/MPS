...
public class AppendOperation extends jetbrains.mps.baseLanguage.structure.Statement {
  ...
  public Iterator<jetbrains.mps.lang.textGen.structure.AbstractAppendPart> parts() {
    return this.children(AbstractAppendPart.class, AppendOperation.PART);
  }

  public List<jetbrains.mps.lang.textGen.structure.AbstractAppendPart> getParts() {
    return this.getChildren(AbstractAppendPart.class, AppendOperation.PART);
  }

  public void addPart(jetbrains.mps.lang.textGen.structure.AbstractAppendPart node) {
    this.addChild(AppendOperation.PART, node);
  }

  public void insertPart(jetbrains.mps.lang.textGen.structure.AbstractAppendPart prev, jetbrains.mps.lang.textGen.structure.AbstractAppendPart node) {
