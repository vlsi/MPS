...
public class OperationCall extends jetbrains.mps.lang.textGen.structure.AbstractAppendPart {
  ...
  public jetbrains.mps.lang.textGen.structure.OperationDeclaration getFunction() {
    return (jetbrains.mps.lang.textGen.structure.OperationDeclaration)this.getReferent(OperationDeclaration.class, OperationCall.FUNCTION);
  }

  public void setFunction(jetbrains.mps.lang.textGen.structure.OperationDeclaration node) {
