...
public class LanguageTextGenDeclaration_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createCollection_6115_0(EditorContext context, SNode node) {
    ...
    editorCell.addEditorCell(this.createProperty_6115_0(context, node));
    editorCell.addEditorCell(this.createConstant_6115_4(context, node, "extends"));
    editorCell.addEditorCell(this.createRefCell_6115_0(context, node));
  ...
  private EditorCell createRefNodeList_6115_0(EditorContext context, SNode node) {
    AbstractCellListHandler handler = new LanguageTextGenDeclaration_Editor.operationListHandler_6115_0(node, "operation", context);
  ...
  private EditorCell createRefNodeList_6115_1(EditorContext context, SNode node) {
    AbstractCellListHandler handler = new LanguageTextGenDeclaration_Editor.functionListHandler_6115_0(node, "function", context);
    EditorCell_Collection editorCell = handler.createCells(context, new CellLayout_Vertical(), false);
