...
public class OperationCall_Editor extends DefaultNodeEditor {
  ...
  /* package */AbstractCellListHandler myListHandler_6903_0;

  public EditorCell createEditorCell(EditorContext context, SNode node) {
    return this.createCollection_6903_0(context, node);
  }
  ...
  public EditorCell createRefNodeList_6903_0(EditorContext context, SNode node) {
    if (this.myListHandler_6903_0 == null) {
      this.myListHandler_6903_0 = new OperationCall_Editor.parameterListHandler_6903_0(node, "parameter", context);
    }
    EditorCell_Collection editorCell = this.myListHandler_6903_0.createCells(context, new CellLayout_Horizontal(), false);
  ...
  public EditorCell createRefCell_6903_0_internal(EditorContext context, SNode node, CellProviderWithRole aProvider) {
    ...
    if (editorCell instanceof EditorCell_Label) {
      setupLabel_RefCell_6903_0((EditorCell_Label)editorCell, node, context);
    }
    editorCell.setSubstituteInfo(provider.createDefaultSubstituteInfo());
    return editorCell;
  }

  public EditorCell createRefCell_6903_1(EditorContext context, SNode node) {
    CellProviderWithRole provider = new RefCellCellProvider(node, context);
    provider.setRole("function");
    provider.setNoTargetText("<no function>");
    provider.setReadOnly(false);
    provider.setAllowsEmptyTarget(false);
    EditorCell cellWithRole = this.createRefCell_6903_0_internal(context, node, provider);
  ...
  public static class _Inline6903_0 extends AbstractCellProvider {
    ...
    public EditorCell createEditorCell(EditorContext context, SNode node) {
      return this.createProperty_6903_1(context, node);
    }

    public EditorCell createProperty_6903_0_internal(EditorContext context, SNode node, CellProviderWithRole aProvider) {
      CellProviderWithRole provider = aProvider;
      provider.setAuxiliaryCellProvider(null);
      EditorCell editorCell = provider.createEditorCell(context);
      setupBasic_Property_6903_0(editorCell, node, context);
      if (editorCell instanceof EditorCell_Label) {
        setupLabel_Property_6903_0((EditorCell_Label)editorCell, node, context);
      }
      editorCell.setSubstituteInfo(provider.createDefaultSubstituteInfo());
      return editorCell;
    }

    public EditorCell createProperty_6903_1(EditorContext context, SNode node) {
      CellProviderWithRole provider = new PropertyCellProvider(node, context);
      provider.setRole("operationName");
      provider.setNoTargetText("<no operationName>");
      provider.setReadOnly(true);
      provider.setAllowsEmptyTarget(false);
      EditorCell cellWithRole = this.createProperty_6903_0_internal(context, node, provider);
      SNode attributeConcept = provider.getRoleAttribute();
      Class attributeKind = provider.getRoleAttributeClass();
      if (attributeConcept != null) {
        IOperationContext opContext = context.getOperationContext();
    ...
    private static void setupLabel_Property_6903_0(EditorCell_Label editorCell, SNode node, EditorContext context) {
    }

}
  public static class parameterListHandler_6903_0 extends RefNodeListHandler {
    ...
    public EditorCell createEmptyCell_internal(EditorContext context, SNode node) {
      return this.createConstant_6903_0(context, node, "");
    }
    ...
    public EditorCell createConstant_6903_0(EditorContext context, SNode node, String text) {
      ...
      setupLabel_Constant_6903_0(editorCell, node, context);
      editorCell.setDefaultText("");
      return editorCell;
    }
    ...
    private static void setupLabel_Constant_6903_0(EditorCell_Label editorCell, SNode node, EditorContext context) {
    }
