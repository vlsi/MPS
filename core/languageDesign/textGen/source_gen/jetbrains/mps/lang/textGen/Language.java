...
public class Language extends LanguageRuntime {
  ...
  public Language() {
    generators = TemplateUtil.<TemplateModule>asCollection(TemplateUtil.createInterpretedGenerator(this, "6477ee8f-eec2-4bda-bd85-252b93f5f0ec(jetbrains.mps.lang.textGen#1233678176149)"));
    structureAspect = getAspectDescriptorByClassName("jetbrains.mps.lang.textGen.structure.StructureAspectDescriptor");
    behaviorAspect = getAspectDescriptorByClassName("jetbrains.mps.lang.textGen.behavior.BehaviorAspectDescriptor");
    constraintsAspect = getAspectDescriptorByClassName("jetbrains.mps.lang.textGen.constraints.ConstraintsAspectDescriptor");
