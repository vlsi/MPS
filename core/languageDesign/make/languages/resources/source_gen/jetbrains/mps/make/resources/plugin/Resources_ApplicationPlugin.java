...
public class Resources_ApplicationPlugin extends BaseApplicationPlugin {
  private PluginId myId = PluginId.getId("jetbrains.mps.make.resources");

  public Resources_ApplicationPlugin() {
  }
