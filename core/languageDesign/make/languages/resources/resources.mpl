...
<language namespace="jetbrains.mps.make.resources" uuid="3d60ffbd-ae79-4d7b-a1c0-810dfec83399" java-stubs-enabled="false" compileInMPS="false" doNotGenerateAdapters="false">
  <models>
    <modelRoot path="${language_descriptor}/languageModels" namespacePrefix="jetbrains.mps.make.resources" />
  </models>
  <accessoryModels />
  <generators>
    <generator name="" generatorUID="jetbrains.mps.make.resources#5674250849982861648" uuid="273e02b1-69fd-4c3a-9ba3-15bedd580eb6">
      <models>
        <modelRoot path="${language_descriptor}/generator/template" namespacePrefix="jetbrains.mps.make.resources.generator.template" />
      </models>
      <external-templates />
      <usedDevKits>
