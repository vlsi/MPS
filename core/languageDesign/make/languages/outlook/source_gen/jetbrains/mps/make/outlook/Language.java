...
public class Language extends LanguageRuntime {
  ...
  public Language() {
    generators = TemplateUtil.<TemplateModule>asCollection(TemplateUtil.createInterpretedGenerator(this, "f2324f12-b66e-4ff0-82da-267897cc06d8(jetbrains.mps.make.outlook#5608160002100106841)"));
    structureAspect = getAspectDescriptorByClassName("jetbrains.mps.make.outlook.structure.StructureAspectDescriptor");
    behaviorAspect = getAspectDescriptorByClassName("jetbrains.mps.make.outlook.behavior.BehaviorAspectDescriptor");
    constraintsAspect = getAspectDescriptorByClassName("jetbrains.mps.make.outlook.constraints.ConstraintsAspectDescriptor");
