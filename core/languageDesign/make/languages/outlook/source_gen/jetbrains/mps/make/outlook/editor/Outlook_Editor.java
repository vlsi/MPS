...
public class Outlook_Editor extends DefaultNodeEditor {
  public EditorCell createEditorCell(EditorContext editorContext, SNode node) {
    return this.createCollection_qlzo2n_a(editorContext, node);
  }
  ...
  private EditorCell createCollection_qlzo2n_a0(EditorContext editorContext, SNode node) {
  ...
  private EditorCell createCollection_qlzo2n_b0(EditorContext editorContext, SNode node) {
    EditorCell_Collection editorCell = EditorCell_Collection.createHorizontal(editorContext, node);
  ...
  private EditorCell createProperty_qlzo2n_b0a(EditorContext editorContext, SNode node) {
  ...
  private static class facetListHandler_qlzo2n_b1a extends RefNodeListHandler {
    ...
    public EditorCell createEmptyCell_internal(EditorContext editorContext, SNode node) {
      return this.createConstant_qlzo2n_a1b0(editorContext, node);
    }
