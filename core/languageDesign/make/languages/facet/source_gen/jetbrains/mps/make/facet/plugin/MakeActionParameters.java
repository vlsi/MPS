...
public class MakeActionParameters {
  ...
  public String actionText(boolean cleanMake) {
    ...
    if (model != null) {
      ...
      sb.append(NameUtil.shortNameFromLongName(module.getClass().getName())).append(" '").append(NameUtil.shortNameFromLongName(module.getModuleReference().getModuleFqName())).append("'");
