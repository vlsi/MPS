...
public class TextPreviewGroup_ActionGroup extends GeneratedActionGroup {
  ...
  public static final String ID = "jetbrains.mps.make.facet.plugin.TextPreviewGroup_ActionGroup";
  ...
  public TextPreviewGroup_ActionGroup() {
    ...
    this.setPopup(false);
    try {
      TextPreviewGroup_ActionGroup.this.addAction("jetbrains.mps.make.facet.plugin.TextPreviewModel_Action");
    } catch (Throwable t) {
