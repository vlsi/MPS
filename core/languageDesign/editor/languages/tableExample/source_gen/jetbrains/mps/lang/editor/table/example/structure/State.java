...
public class State extends BaseConcept implements INamedConcept {
  public static final String concept = "jetbrains.mps.lang.editor.table.example.structure.State";
  ...
  public static State newInstance(SModel sm, boolean init) {
    return (State) SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.lang.editor.table.example.structure.State", sm, GlobalScope.getInstance(), init).getAdapter();
  }
