  ...
  private EditorCell createTable_sl01pn_c0(EditorContext editorContext, SNode node) {
    TableModelCreator creator = new TableModelCreator() {
      public TableModel getTable(final SNode node, EditorContext editorContext) {
        return new HierarchycalTableModelWithHeader(node, SLinkOperations.findLinkDeclaration("jetbrains.mps.lang.editor.table.example.structure.Table", "rows"), SLinkOperations.findLinkDeclaration("jetbrains.mps.lang.editor.table.example.structure.Row", "cells"), SLinkOperations.findLinkDeclaration("jetbrains.mps.lang.editor.table.example.structure.HierarchycalTable", "headers"));
      }
    };
