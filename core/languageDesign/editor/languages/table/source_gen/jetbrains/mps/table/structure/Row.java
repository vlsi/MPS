...
public class Row extends BaseConcept {
  public static final String concept = "jetbrains.mps.table.structure.Row";
  ...
  public static Row newInstance(SModel sm, boolean init) {
    return (Row) SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.table.structure.Row", sm, GlobalScope.getInstance(), init).getAdapter();
  }
