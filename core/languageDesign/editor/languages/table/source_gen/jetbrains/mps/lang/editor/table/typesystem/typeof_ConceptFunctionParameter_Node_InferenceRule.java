...
public class typeof_ConceptFunctionParameter_Node_InferenceRule extends AbstractInferenceRule_Runtime implements InferenceRule_Runtime {
  ...
  public void applyRule(final SNode conceptFunctionParameter_Node, final TypeCheckingContext typeCheckingContext, IsApplicableStatus status) {
    SNode applicableConcept = AbstractComponent_Behavior.call_getConceptDeclaration_7055725856388417603(SNodeOperations.getAncestor(conceptFunctionParameter_Node, "jetbrains.mps.lang.editor.structure.BaseEditorComponent", false, false));
    {
      ...
      EquationInfo _info_12389875345 = new EquationInfo(_nodeToCheck_1029348928467, null, "r:e125855b-e82a-412d-93a9-a61da5b6df4f(jetbrains.mps.lang.editor.table.typesystem)", "4490468428501062880", 0, intentionProvider);
      typeCheckingContext.createEquation((SNode) typeCheckingContext.typeOf(_nodeToCheck_1029348928467, "r:e125855b-e82a-412d-93a9-a61da5b6df4f(jetbrains.mps.lang.editor.table.typesystem)", "4490468428501062877", true), (SNode) new typeof_ConceptFunctionParameter_Node_InferenceRule.QuotationClass_yw9nds_a0a1a0().createNode(applicableConcept, typeCheckingContext), _info_12389875345);
    }
  }

  public String getApplicableConceptFQName() {
    return "jetbrains.mps.lang.editor.table.structure.ConceptFunctionParameter_Node";
  }
