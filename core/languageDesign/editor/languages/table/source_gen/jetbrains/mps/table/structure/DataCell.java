...
public class DataCell extends BaseConcept {
  public static final String concept = "jetbrains.mps.table.structure.DataCell";
  ...
  public static DataCell newInstance(SModel sm, boolean init) {
    return (DataCell) SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.table.structure.DataCell", sm, GlobalScope.getInstance(), init).getAdapter();
  }
