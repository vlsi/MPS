...
public class Event extends BaseConcept implements INamedConcept {
  public static final String concept = "jetbrains.mps.table.structure.Event";
  ...
  public static Event newInstance(SModel sm, boolean init) {
    return (Event) SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.table.structure.Event", sm, GlobalScope.getInstance(), init).getAdapter();
  }
