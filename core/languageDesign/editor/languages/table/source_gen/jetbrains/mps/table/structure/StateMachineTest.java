...
public class StateMachineTest extends BaseConcept implements INamedConcept {
  public static final String concept = "jetbrains.mps.table.structure.StateMachineTest";
  ...
  public static StateMachineTest newInstance(SModel sm, boolean init) {
    return (StateMachineTest) SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.table.structure.StateMachineTest", sm, GlobalScope.getInstance(), init).getAdapter();
  }
