...
public class Table extends BaseConcept {
  public static final String concept = "jetbrains.mps.table.structure.Table";
  ...
  public static Table newInstance(SModel sm, boolean init) {
    return (Table) SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.table.structure.Table", sm, GlobalScope.getInstance(), init).getAdapter();
  }
