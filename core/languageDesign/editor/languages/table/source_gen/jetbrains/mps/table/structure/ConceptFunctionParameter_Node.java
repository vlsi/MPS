...
public class ConceptFunctionParameter_Node extends ConceptFunctionParameter {
  public static final String concept = "jetbrains.mps.table.structure.ConceptFunctionParameter_Node";
  ...
  public static ConceptFunctionParameter_Node newInstance(SModel sm, boolean init) {
    return (ConceptFunctionParameter_Node) SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.table.structure.ConceptFunctionParameter_Node", sm, GlobalScope.getInstance(), init).getAdapter();
  }
