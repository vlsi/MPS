      ...
      public TableModel getTable(final SNode node, EditorContext editorContext) {
        return new AbstractTableModel() {
          ...
          public void insertRow(int row) {
            SNode rowNode = SConceptOperations.createNewNode("jetbrains.mps.table.structure.Row", null);
            for (int i = 0; i < ListSequence.fromList(SLinkOperations.getTargets(ListSequence.fromList(SLinkOperations.getTargets(node, "rows", true)).first(), "cell", true)).count(); i++) {
              ListSequence.fromList(SLinkOperations.getTargets(rowNode, "cell", true)).addElement(SConceptOperations.createNewNode("jetbrains.mps.table.structure.DataCell", null));
            }
