        ...
        return new AbstractTableModel() {
          ...
          public void createElement(int row, int column) {
            if (row > 0 && column > 0) {
              SNode event = ListSequence.fromList(SLinkOperations.getTargets(node, "events", true)).getElement(column - 1);
              SNode state = ListSequence.fromList(SLinkOperations.getTargets(node, "states", true)).getElement(row - 1);
              SNode transition = SConceptOperations.createNewNode("jetbrains.mps.lang.editor.table.structure.Transition", null);
              SLinkOperations.setTarget(transition, "event", SConceptOperations.createNewNode("jetbrains.mps.lang.editor.table.structure.EventReference", null), true);
              SLinkOperations.setTarget(SLinkOperations.getTarget(transition, "event", true), "event", event, false);
              SLinkOperations.setTarget(transition, "state", SConceptOperations.createNewNode("jetbrains.mps.lang.editor.table.structure.StateReference", null), true);
