...
public class HierarchycalTable extends Table {
  public static final String concept = "jetbrains.mps.lang.editor.table.example.structure.HierarchycalTable";
  ...
  public static HierarchycalTable newInstance(SModel sm, boolean init) {
    return (HierarchycalTable) SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.lang.editor.table.example.structure.HierarchycalTable", sm, GlobalScope.getInstance(), init).getAdapter();
  }
