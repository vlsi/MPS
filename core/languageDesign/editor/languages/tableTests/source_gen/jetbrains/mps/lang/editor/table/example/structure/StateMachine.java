...
public class StateMachine extends BaseConcept implements INamedConcept {
  public static final String concept = "jetbrains.mps.lang.editor.table.example.structure.StateMachine";
  ...
  public static StateMachine newInstance(SModel sm, boolean init) {
    return (StateMachine) SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.lang.editor.table.example.structure.StateMachine", sm, GlobalScope.getInstance(), init).getAdapter();
  }
