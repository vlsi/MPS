...
<model modelUID="r:00000000-0000-4000-0000-011c8959029a(jetbrains.mps.lang.editor.typesystem)">
  ...
  <node type="jetbrains.mps.lang.typesystem.structure.InferenceRule" id="1179766709108">
    ...
    <node role="body" type="jetbrains.mps.baseLanguage.structure.StatementList" id="1179766709109">
      ...
      <node role="statement" type="jetbrains.mps.baseLanguage.structure.IfStatement" id="3623276037088176590">
        <node role="ifTrue" type="jetbrains.mps.baseLanguage.structure.StatementList" id="3623276037088176591">
          <node role="statement" type="jetbrains.mps.baseLanguage.structure.LocalVariableDeclarationStatement" id="3623276037088177834">
            <node role="localVariableDeclaration" type="jetbrains.mps.baseLanguage.structure.LocalVariableDeclaration" id="3623276037088177835">
              <property name="name" value="withRole" />
              <node role="type" type="jetbrains.mps.lang.smodel.structure.SNodeType" id="3623276037088177836">
                <link role="concept" targetNodeId="3.1139848536355" resolveInfo="CellModel_WithRole" />
              </node>
              <node role="initializer" type="jetbrains.mps.baseLanguage.structure.DotExpression" id="3623276037088177837">
                <node role="operand" type="jetbrains.mps.lang.typesystem.structure.ApplicableNodeReference" id="3623276037088177838">
                  <link role="applicableNode" targetNodeId="1179766709008" resolveInfo="node" />
                </node>
                <node role="operation" type="jetbrains.mps.lang.smodel.structure.Node_GetAncestorOperation" id="3623276037088177839">
                  <node role="parameter" type="jetbrains.mps.lang.smodel.structure.OperationParm_Concept" id="3623276037088177840">
                    <node role="conceptArgument" type="jetbrains.mps.lang.smodel.structure.RefConcept_Reference" id="3623276037088177841">
                      <link role="conceptDeclaration" targetNodeId="3.1139848536355" resolveInfo="CellModel_WithRole" />
                    </node>
                  </node>
                </node>
              </node>
          ...
          <node role="statement" type="jetbrains.mps.baseLanguage.structure.IfStatement" id="3623276037088176595">
            <node role="ifTrue" type="jetbrains.mps.baseLanguage.structure.StatementList" id="3623276037088176596">
              <node role="statement" type="jetbrains.mps.baseLanguage.structure.LocalVariableDeclarationStatement" id="3623276037088176597">
                <node role="localVariableDeclaration" type="jetbrains.mps.baseLanguage.structure.LocalVariableDeclaration" id="3623276037088176598">
                  <property name="name" value="link" />
                  <node role="type" type="jetbrains.mps.lang.smodel.structure.SNodeType" id="3623276037088176599">
                    <link role="concept" targetNodeId="1.1071489288298" resolveInfo="LinkDeclaration" />
                  </node>
                  <node role="initializer" type="jetbrains.mps.lang.smodel.structure.SNodeTypeCastExpression" id="3623276037088176600">
                    <link role="concept" targetNodeId="1.1071489288298" resolveInfo="LinkDeclaration" />
                    <node role="leftExpression" type="jetbrains.mps.baseLanguage.structure.DotExpression" id="3623276037088176601">
                      <node role="operand" type="jetbrains.mps.baseLanguage.structure.LocalVariableReference" id="3623276037088176602">
                        <link role="variableDeclaration" targetNodeId="3623276037088177835" resolveInfo="withRole" />
                      </node>
                      <node role="operation" type="jetbrains.mps.lang.smodel.structure.SLinkAccess" id="3623276037088176603">
              ...
              <node role="statement" type="jetbrains.mps.baseLanguage.structure.ExpressionStatement" id="3623276037088176604">
                <node role="expression" type="jetbrains.mps.baseLanguage.structure.AssignmentExpression" id="3623276037088176605">
                  <node role="lValue" type="jetbrains.mps.baseLanguage.structure.LocalVariableReference" id="3623276037088176606">
                    <link role="variableDeclaration" targetNodeId="1179766709009" resolveInfo="applicableConcept" />
                  </node>
                  <node role="rValue" type="jetbrains.mps.baseLanguage.structure.DotExpression" id="3623276037088176607">
                    <node role="operand" type="jetbrains.mps.baseLanguage.structure.LocalVariableReference" id="3623276037088176608">
                      <link role="variableDeclaration" targetNodeId="3623276037088176598" resolveInfo="link" />
                    </node>
                    <node role="operation" type="jetbrains.mps.lang.smodel.structure.SLinkAccess" id="3623276037088176609">
            ...
            <node role="condition" type="jetbrains.mps.baseLanguage.structure.AndExpression" id="3623276037088176610">
              <node role="rightExpression" type="jetbrains.mps.baseLanguage.structure.DotExpression" id="3623276037088176611">
                <node role="operand" type="jetbrains.mps.baseLanguage.structure.DotExpression" id="3623276037088176612">
                  <node role="operand" type="jetbrains.mps.baseLanguage.structure.LocalVariableReference" id="3623276037088176613">
                    <link role="variableDeclaration" targetNodeId="3623276037088177835" resolveInfo="withRole" />
                  </node>
                  <node role="operation" type="jetbrains.mps.lang.smodel.structure.SLinkAccess" id="3623276037088176614">
                    <link role="link" targetNodeId="3.1140103550593" />
                  </node>
                </node>
                <node role="operation" type="jetbrains.mps.lang.smodel.structure.Node_IsInstanceOfOperation" id="3623276037088176615">
                  <node role="conceptArgument" type="jetbrains.mps.lang.smodel.structure.RefConcept_Reference" id="3623276037088176616">
                    <link role="conceptDeclaration" targetNodeId="1.1071489288298" resolveInfo="LinkDeclaration" />
                  </node>
                </node>
              </node>
              <node role="leftExpression" type="jetbrains.mps.baseLanguage.structure.NotEqualsExpression" id="3623276037088176617">
                <node role="leftExpression" type="jetbrains.mps.baseLanguage.structure.LocalVariableReference" id="3623276037088176618">
                  <link role="variableDeclaration" targetNodeId="3623276037088177835" resolveInfo="withRole" />
                </node>
                <node role="rightExpression" type="jetbrains.mps.baseLanguage.structure.NullLiteral" id="3623276037088176619" />
              </node>
            </node>
          </node>
        </node>
        <node role="condition" type="jetbrains.mps.baseLanguage.structure.NotEqualsExpression" id="3623276037088177829">
          <node role="rightExpression" type="jetbrains.mps.baseLanguage.structure.NullLiteral" id="3623276037088177832" />
          <node role="leftExpression" type="jetbrains.mps.baseLanguage.structure.DotExpression" id="3623276037088176623">
            <node role="operand" type="jetbrains.mps.lang.typesystem.structure.ApplicableNodeReference" id="3623276037088176622">
              <link role="applicableNode" targetNodeId="1179766709008" resolveInfo="node" />
            </node>
            <node role="operation" type="jetbrains.mps.lang.smodel.structure.Node_GetAncestorOperation" id="3623276037088177824">
              <node role="parameter" type="jetbrains.mps.lang.smodel.structure.OperationParm_Concept" id="3623276037088177825">
                <node role="conceptArgument" type="jetbrains.mps.lang.smodel.structure.RefConcept_Reference" id="3623276037088177828">
                  <link role="conceptDeclaration" targetNodeId="3.1186402475462" resolveInfo="StyleClassItem" />
                </node>
              </node>
            </node>
          </node>
  ...
  <node type="jetbrains.mps.lang.typesystem.structure.InferenceRule" id="1201270044264">
    ...
    <node role="body" type="jetbrains.mps.baseLanguage.structure.StatementList" id="1201270044265">
      <node role="statement" type="jetbrains.mps.lang.typesystem.structure.CreateStrongLessThanInequationStatement" id="1201270048564">
        ...
        <node role="inequationGroup" type="jetbrains.mps.lang.typesystem.structure.DefaultGroupReference" id="5970100369440882733" />
      </node>
    </node>
  ...
  <node type="jetbrains.mps.lang.typesystem.structure.InferenceRule" id="4531786690999948571">
    <property name="name" value="typeof_AbstractOperation" />
    <property name="package" value="MethodParameters" />
    <node role="body" type="jetbrains.mps.baseLanguage.structure.StatementList" id="4531786690999948572">
      <node role="statement" type="jetbrains.mps.lang.typesystem.structure.CreateEquationStatement" id="4531786690999950596">
        <node role="leftExpression" type="jetbrains.mps.lang.typesystem.structure.NormalTypeClause" id="4531786690999950599">
          <node role="normalType" type="jetbrains.mps.lang.typesystem.structure.TypeOfExpression" id="4531786690999950590">
            <node role="term" type="jetbrains.mps.lang.typesystem.structure.ApplicableNodeReference" id="4531786690999950592">
    ...
    <node role="applicableNode" type="jetbrains.mps.lang.typesystem.structure.ConceptReference" id="4531786690999948573">
      <property name="name" value="operation" />
      <link role="concept" targetNodeId="3.4531786690998636238" resolveInfo="AbstractOperation" />
    </node>
  </node>
  <node type="jetbrains.mps.lang.typesystem.structure.InferenceRule" id="6050628152418936547">
    <property name="name" value="typeof_AbstractOperationArguments" />
    <property name="package" value="MethodParameters" />
    <node role="body" type="jetbrains.mps.baseLanguage.structure.StatementList" id="6050628152418936548">
      <node role="statement" type="jetbrains.mps.baseLanguage.structure.LocalVariableDeclarationStatement" id="6050628152418938572">
        <node role="localVariableDeclaration" type="jetbrains.mps.baseLanguage.structure.LocalVariableDeclaration" id="6050628152418938573">
          <property name="name" value="argumentTypes" />
          <node role="type" type="jetbrains.mps.lang.smodel.structure.SNodeListType" id="6050628152418938574">
            <link role="elementConcept" targetNodeId="6.1068431790189" resolveInfo="Type" />
          </node>
          <node role="initializer" type="jetbrains.mps.baseLanguage.structure.DotExpression" id="6050628152418938575">
            <node role="operand" type="jetbrains.mps.lang.typesystem.structure.ApplicableNodeReference" id="6050628152418938576">
              <link role="applicableNode" targetNodeId="6050628152418936549" resolveInfo="operation" />
            </node>
            <node role="operation" type="jetbrains.mps.lang.smodel.structure.SConceptLinkAccess" id="6050628152418938577">
              <link role="conceptLinkDeclaration" targetNodeId="3.4531786690998812992" resolveInfo="operationArgumentType" />
            </node>
          </node>
        </node>
      </node>
      <node role="statement" type="jetbrains.mps.baseLanguage.structure.IfStatement" id="6050628152418938579">
        <node role="ifTrue" type="jetbrains.mps.baseLanguage.structure.StatementList" id="6050628152418938580">
          <node role="statement" type="jetbrains.mps.lang.typesystem.structure.ReportErrorStatement" id="6050628152418938611">
            <node role="errorString" type="jetbrains.mps.baseLanguage.structure.StringLiteral" id="6050628152418938614">
              <property name="value" value="Wrong number of arguments" />
            </node>
            <node role="nodeToReport" type="jetbrains.mps.lang.typesystem.structure.ApplicableNodeReference" id="6050628152418938615">
              <link role="applicableNode" targetNodeId="6050628152418936549" resolveInfo="operation" />
            </node>
          </node>
        </node>
        <node role="condition" type="jetbrains.mps.baseLanguage.structure.NotEqualsExpression" id="6050628152418938597">
          <node role="rightExpression" type="jetbrains.mps.baseLanguage.structure.DotExpression" id="6050628152418938603">
            <node role="operand" type="jetbrains.mps.baseLanguage.structure.LocalVariableReference" id="6050628152418938601">
              <link role="variableDeclaration" targetNodeId="6050628152418938573" resolveInfo="argumentTypes" />
            </node>
            <node role="operation" type="jetbrains.mps.baseLanguage.collections.structure.GetSizeOperation" id="6050628152418938608" />
          </node>
          <node role="leftExpression" type="jetbrains.mps.baseLanguage.structure.DotExpression" id="6050628152418938589">
            <node role="operand" type="jetbrains.mps.baseLanguage.structure.DotExpression" id="6050628152418938584">
              <node role="operand" type="jetbrains.mps.lang.typesystem.structure.ApplicableNodeReference" id="6050628152418938583">
                <link role="applicableNode" targetNodeId="6050628152418936549" resolveInfo="operation" />
              </node>
              <node role="operation" type="jetbrains.mps.lang.smodel.structure.SLinkListAccess" id="6050628152418938588">
                <link role="link" targetNodeId="3.4531786690998636240" />
              </node>
            </node>
            <node role="operation" type="jetbrains.mps.baseLanguage.collections.structure.GetSizeOperation" id="6050628152418938593" />
          </node>
        </node>
        <node role="ifFalseStatement" type="jetbrains.mps.baseLanguage.structure.BlockStatement" id="6050628152418938616">
          <node role="statements" type="jetbrains.mps.baseLanguage.structure.StatementList" id="6050628152418938617">
            <node role="statement" type="jetbrains.mps.lang.typesystem.structure.MultipleForeachLoop" id="6050628152418938626">
              <node role="loopVariable" type="jetbrains.mps.lang.typesystem.structure.MultipleForeachLoopVariable" id="6050628152418938627">
                <node role="variable" type="jetbrains.mps.baseLanguage.structure.LocalVariableDeclaration" id="6050628152418938628">
                  <property name="name" value="argument" />
                  <node role="type" type="jetbrains.mps.lang.smodel.structure.SNodeType" id="6050628152418938645" />
                </node>
                <node role="iterable" type="jetbrains.mps.baseLanguage.structure.DotExpression" id="6050628152418938633">
                  <node role="operand" type="jetbrains.mps.lang.typesystem.structure.ApplicableNodeReference" id="6050628152418938632">
                    <link role="applicableNode" targetNodeId="6050628152418936549" resolveInfo="operation" />
                  </node>
                  <node role="operation" type="jetbrains.mps.lang.smodel.structure.SLinkListAccess" id="6050628152418938639">
                    <link role="link" targetNodeId="3.4531786690998636240" />
                  </node>
                </node>
              </node>
              <node role="loopVariable" type="jetbrains.mps.lang.typesystem.structure.MultipleForeachLoopVariable" id="6050628152418938640">
                <node role="variable" type="jetbrains.mps.baseLanguage.structure.LocalVariableDeclaration" id="6050628152418938641">
                  <property name="name" value="type" />
                  <node role="type" type="jetbrains.mps.lang.smodel.structure.SNodeType" id="6050628152418938646">
                    <link role="concept" targetNodeId="6.1068431790189" resolveInfo="Type" />
                  </node>
                </node>
                <node role="iterable" type="jetbrains.mps.baseLanguage.structure.LocalVariableReference" id="6050628152418938644">
                  <link role="variableDeclaration" targetNodeId="6050628152418938573" resolveInfo="argumentTypes" />
                </node>
              </node>
              <node role="body" type="jetbrains.mps.baseLanguage.structure.StatementList" id="6050628152418938631">
                <node role="statement" type="jetbrains.mps.lang.typesystem.structure.CreateLessThanInequationStatement" id="6050628152418947751">
                  <node role="rightExpression" type="jetbrains.mps.lang.typesystem.structure.NormalTypeClause" id="6050628152418947755">
                    <node role="normalType" type="jetbrains.mps.baseLanguage.structure.LocalVariableReference" id="6050628152418947756">
                      <link role="variableDeclaration" targetNodeId="6050628152418938641" resolveInfo="types" />
                    </node>
                  </node>
                  <node role="leftExpression" type="jetbrains.mps.lang.typesystem.structure.NormalTypeClause" id="6050628152418947754">
                    <node role="normalType" type="jetbrains.mps.lang.typesystem.structure.TypeOfExpression" id="6050628152418947748">
                      <node role="term" type="jetbrains.mps.baseLanguage.structure.LocalVariableReference" id="6050628152418947750">
                        <link role="variableDeclaration" targetNodeId="6050628152418938628" resolveInfo="argument" />
                      </node>
                    </node>
                  </node>
                  <node role="inequationGroup" type="jetbrains.mps.lang.typesystem.structure.DefaultGroupReference" id="5970100369440882568" />
                </node>
              </node>
            </node>
          </node>
    ...
    <node role="applicableNode" type="jetbrains.mps.lang.typesystem.structure.ConceptReference" id="6050628152418936549">
      <property name="name" value="operation" />
      <link role="concept" targetNodeId="3.4531786690998636238" resolveInfo="AbstractOperation" />
    </node>
  </node>
  <node type="jetbrains.mps.lang.typesystem.structure.InferenceRule" id="7806530711847278495">
    <property name="name" value="typeof_ConceptFunctionParameter_method" />
    <property name="package" value="MethodParameters" />
    <node role="body" type="jetbrains.mps.baseLanguage.structure.StatementList" id="7806530711847278496">
      <node role="statement" type="jetbrains.mps.baseLanguage.structure.LocalVariableDeclarationStatement" id="7806530711847278522">
        <node role="localVariableDeclaration" type="jetbrains.mps.baseLanguage.structure.LocalVariableDeclaration" id="7806530711847278523">
          <property name="name" value="expectedType" />
          <node role="type" type="jetbrains.mps.lang.smodel.structure.SNodeType" id="7806530711847278524">
            <link role="concept" targetNodeId="6.1068431790189" resolveInfo="Type" />
          </node>
          <node role="initializer" type="jetbrains.mps.baseLanguage.structure.DotExpression" id="7806530711847280109">
            <node role="operand" type="jetbrains.mps.baseLanguage.structure.DotExpression" id="7806530711847280114">
              <node role="operand" type="jetbrains.mps.lang.typesystem.structure.ApplicableNodeReference" id="7806530711847280115">
                <link role="applicableNode" targetNodeId="7806530711847278497" resolveInfo="parameter_method" />
              </node>
              <node role="operation" type="jetbrains.mps.lang.smodel.structure.Node_GetAncestorOperation" id="7806530711847280116">
                <node role="parameter" type="jetbrains.mps.lang.smodel.structure.OperationParm_Concept" id="7806530711847280117">
                  <node role="conceptArgument" type="jetbrains.mps.lang.smodel.structure.RefConcept_Reference" id="7806530711847280118">
                    <link role="conceptDeclaration" targetNodeId="3.7667276221847612622" resolveInfo="ParametersInformationQuery" />
                  </node>
                </node>
              </node>
            </node>
            <node role="operation" type="jetbrains.mps.lang.smodel.structure.SLinkAccess" id="7806530711847280113">
              <link role="link" targetNodeId="3.8178273524755058633" />
            </node>
          </node>
        </node>
      </node>
      <node role="statement" type="jetbrains.mps.baseLanguage.structure.IfStatement" id="7806530711847278540">
        <node role="ifTrue" type="jetbrains.mps.baseLanguage.structure.StatementList" id="7806530711847278541">
          <node role="statement" type="jetbrains.mps.lang.typesystem.structure.CreateEquationStatement" id="7806530711847280124">
            <node role="leftExpression" type="jetbrains.mps.lang.typesystem.structure.NormalTypeClause" id="7806530711847280127">
              <node role="normalType" type="jetbrains.mps.lang.typesystem.structure.TypeOfExpression" id="7806530711847280121">
                <node role="term" type="jetbrains.mps.lang.typesystem.structure.ApplicableNodeReference" id="7806530711847280123">
                  <link role="applicableNode" targetNodeId="7806530711847278497" resolveInfo="parameter_method" />
                </node>
              </node>
            </node>
            <node role="rightExpression" type="jetbrains.mps.lang.typesystem.structure.NormalTypeClause" id="7806530711847280139">
              <node role="normalType" type="jetbrains.mps.lang.quotation.structure.Quotation" id="7806530711847280142">
                <node role="quotedNode" type="jetbrains.mps.baseLanguage.structure.ClassifierType" id="7806530711847280149">
        ...
        <node role="condition" type="jetbrains.mps.baseLanguage.structure.EqualsExpression" id="7806530711847278546">
          <node role="rightExpression" type="jetbrains.mps.baseLanguage.structure.NullLiteral" id="7806530711847278547" />
          <node role="leftExpression" type="jetbrains.mps.baseLanguage.structure.LocalVariableReference" id="7806530711847278548">
            <link role="variableDeclaration" targetNodeId="7806530711847278523" resolveInfo="expectedType" />
          </node>
        </node>
        <node role="ifFalseStatement" type="jetbrains.mps.baseLanguage.structure.BlockStatement" id="7806530711847280145">
          <node role="statements" type="jetbrains.mps.baseLanguage.structure.StatementList" id="7806530711847280146">
            <node role="statement" type="jetbrains.mps.lang.typesystem.structure.CreateEquationStatement" id="7806530711847280150">
              <node role="leftExpression" type="jetbrains.mps.lang.typesystem.structure.NormalTypeClause" id="7806530711847280151">
                <node role="normalType" type="jetbrains.mps.lang.typesystem.structure.TypeOfExpression" id="7806530711847280152">
                  <node role="term" type="jetbrains.mps.lang.typesystem.structure.ApplicableNodeReference" id="7806530711847280153">
                    <link role="applicableNode" targetNodeId="7806530711847278497" resolveInfo="parameter_method" />
                  </node>
                </node>
              </node>
              <node role="rightExpression" type="jetbrains.mps.lang.typesystem.structure.NormalTypeClause" id="7806530711847280157">
                <node role="normalType" type="jetbrains.mps.baseLanguage.structure.LocalVariableReference" id="7806530711847280158">
                  <link role="variableDeclaration" targetNodeId="7806530711847278523" resolveInfo="expectedType" />
                </node>
              </node>
            </node>
