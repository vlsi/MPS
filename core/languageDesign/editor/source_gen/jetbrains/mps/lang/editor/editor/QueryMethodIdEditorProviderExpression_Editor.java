...
public class QueryMethodIdEditorProviderExpression_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createRefNodeList_9522_0(EditorContext context, SNode node) {
    AbstractCellListHandler handler = new QueryMethodIdEditorProviderExpression_Editor.parameterListHandler_9522_0(node, "parameter", context);
  ...
  private EditorCell createRefNodeList_9522_1(EditorContext context, SNode node) {
    AbstractCellListHandler handler = new QueryMethodIdEditorProviderExpression_Editor.additionalImportListHandler_9522_0(node, "additionalImport", context);
