...
public class QueryMethodIdEditorProviderExpression extends jetbrains.mps.baseLanguage.structure.Expression {
  ...
  public jetbrains.mps.lang.structure.structure.PropertyDeclaration getQueryIdProperty() {
    return (jetbrains.mps.lang.structure.structure.PropertyDeclaration)this.getReferent(PropertyDeclaration.class, QueryMethodIdEditorProviderExpression.QUERY_ID_PROPERTY);
  }

  public void setQueryIdProperty(jetbrains.mps.lang.structure.structure.PropertyDeclaration node) {
  ...
  public jetbrains.mps.baseLanguage.structure.Type getReturnType() {
    return (jetbrains.mps.baseLanguage.structure.Type)this.getChild(Type.class, QueryMethodIdEditorProviderExpression.RETURN_TYPE);
  }
  ...
  public Iterator<jetbrains.mps.baseLanguage.structure.Type> additionalImports() {
    return this.children(Type.class, QueryMethodIdEditorProviderExpression.ADDITIONAL_IMPORT);
  }

  public List<jetbrains.mps.baseLanguage.structure.Type> getAdditionalImports() {
    return this.getChildren(Type.class, QueryMethodIdEditorProviderExpression.ADDITIONAL_IMPORT);
  }

  public void addAdditionalImport(jetbrains.mps.baseLanguage.structure.Type node) {
    this.addChild(QueryMethodIdEditorProviderExpression.ADDITIONAL_IMPORT, node);
  }

  public void insertAdditionalImport(jetbrains.mps.baseLanguage.structure.Type prev, jetbrains.mps.baseLanguage.structure.Type node) {
