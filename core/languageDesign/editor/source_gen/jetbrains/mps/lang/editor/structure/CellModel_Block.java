...
public class CellModel_Block extends jetbrains.mps.lang.editor.structure.EditorCellModel {
  ...
  public jetbrains.mps.lang.editor.structure.EditorCellModel getHeader() {
    return (jetbrains.mps.lang.editor.structure.EditorCellModel)this.getChild(EditorCellModel.class, CellModel_Block.HEADER);
  }

  public void setHeader(jetbrains.mps.lang.editor.structure.EditorCellModel node) {
    super.setChild(CellModel_Block.HEADER, node);
  }

  public jetbrains.mps.lang.editor.structure.EditorCellModel getBody() {
    return (jetbrains.mps.lang.editor.structure.EditorCellModel)this.getChild(EditorCellModel.class, CellModel_Block.BODY);
  }

  public void setBody(jetbrains.mps.lang.editor.structure.EditorCellModel node) {
