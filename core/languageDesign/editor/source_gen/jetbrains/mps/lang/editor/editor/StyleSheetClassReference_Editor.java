...
public class StyleSheetClassReference_Editor extends DefaultNodeEditor {
  ...
  public EditorCell createEditorCell(EditorContext context, SNode node) {
    return this.createCollection_0725_0(context, node);
  }

  public EditorCell createCollection_0725_0(EditorContext context, SNode node) {
    EditorCell_Collection editorCell = EditorCell_Collection.createIndent2(context, node);
    setupBasic_Collection_0725_0(editorCell, node, context);
    editorCell.addEditorCell(this.createRefCell_0725_1(context, node));
    return editorCell;
  }

  public EditorCell createRefCell_0725_0_internal(EditorContext context, SNode node, CellProviderWithRole provider) {
  ...
  private static void setupBasic_Collection_0725_0(EditorCell editorCell, SNode node, EditorContext context) {
    editorCell.setCellId("Collection_0725_0");
  }

  public static class _Inline0725_0 extends AbstractCellProvider {

    public _Inline0725_0() {
      super();
    }
    ...
    public EditorCell createProperty_0725_0_internal(EditorContext context, SNode node, CellProviderWithRole provider) {
      EditorCell editorCell = provider.createEditorCell(context);
