...
public class CellMenuComponent extends jetbrains.mps.lang.editor.structure.AbstractComponent implements jetbrains.mps.lang.core.structure.INamedConcept {
  ...
  public jetbrains.mps.lang.editor.structure.CellMenuComponentFeature getApplicableFeature() {
    return (jetbrains.mps.lang.editor.structure.CellMenuComponentFeature)this.getChild(CellMenuComponentFeature.class, CellMenuComponent.APPLICABLE_FEATURE);
  }

  public void setApplicableFeature(jetbrains.mps.lang.editor.structure.CellMenuComponentFeature node) {
  ...
  public jetbrains.mps.lang.editor.structure.CellMenuDescriptor getMenuDescriptor() {
    return (jetbrains.mps.lang.editor.structure.CellMenuDescriptor)this.getChild(CellMenuDescriptor.class, CellMenuComponent.MENU_DESCRIPTOR);
  }
