...
public class CellModel_Alternation extends EditorCellModel {
  ...
  public QueryFunction_NodeCondition getAlternationCondition() {
    return (QueryFunction_NodeCondition)this.getChild(CellModel_Alternation.ALTERNATION_CONDITION);
  }
  ...
  public EditorCellModel getIfTrueCellModel() {
    return (EditorCellModel)this.getChild(CellModel_Alternation.IF_TRUE_CELL_MODEL);
  }
  ...
  public EditorCellModel getIfFalseCellModel() {
    return (EditorCellModel)this.getChild(CellModel_Alternation.IF_FALSE_CELL_MODEL);
  }
