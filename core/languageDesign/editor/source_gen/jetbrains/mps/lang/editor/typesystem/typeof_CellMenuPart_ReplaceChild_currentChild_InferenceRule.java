...
public class typeof_CellMenuPart_ReplaceChild_currentChild_InferenceRule extends AbstractInferenceRule_Runtime implements InferenceRule_Runtime {
  ...
  public static class QuotationClass_fjdzuh_a0a1a2a0 {
    ...
    public SNode createNode(Object parameter_fjdzuh_a0a0a1a2a0, final TypeCheckingContext typeCheckingContext) {
      SNode result = null;
      Set<SNode> _parameterValues_129834374 = new HashSet<SNode>();
      SNode quotedNode_fjdzuh_a0a1a2a0 = null;
      {
        quotedNode_fjdzuh_a0a1a2a0 = SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.lang.smodel.structure.SNodeType", TypeChecker.getInstance().getRuntimeTypesModel(), GlobalScope.getInstance(), false);
        SNode quotedNode1_fjdzuh_a0a1a2a0 = quotedNode_fjdzuh_a0a1a2a0;
        quotedNode1_fjdzuh_a0a1a2a0.setReferent("concept", (SNode) parameter_fjdzuh_a0a0a1a2a0);
        result = quotedNode1_fjdzuh_a0a1a2a0;
      }
      return result;
    }

    public SNode createNode(Object parameter_fjdzuh_a0a0a1a2a0) {
      SNode result = null;
      Set<SNode> _parameterValues_129834374 = new HashSet<SNode>();
      SNode quotedNode_fjdzuh_a0a1a2a0 = null;
      {
  ...
  public static class QuotationClass_fjdzuh_a0a4a0 {
    ...
    public SNode createNode(final TypeCheckingContext typeCheckingContext) {
      SNode result = null;
      Set<SNode> _parameterValues_129834374 = new HashSet<SNode>();
      SNode quotedNode_fjdzuh_a0a4a0 = null;
      {
        quotedNode_fjdzuh_a0a4a0 = SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.lang.smodel.structure.SNodeType", TypeChecker.getInstance().getRuntimeTypesModel(), GlobalScope.getInstance(), false);
        SNode quotedNode1_fjdzuh_a0a4a0 = quotedNode_fjdzuh_a0a4a0;
        result = quotedNode1_fjdzuh_a0a4a0;
      }
      return result;
    }
