...
import jetbrains.mps.lang.editor.structure.QueryFunction_NodeFactory;
import jetbrains.mps.lang.editor.structure.EditorCellModel;
import jetbrains.mps.lang.editor.structure.CellLayout;
import jetbrains.mps.lang.editor.structure.InlineStyleDeclaration;
import jetbrains.mps.smodel.SModel;
import jetbrains.mps.smodel.SModelUtil_new;
import jetbrains.mps.project.GlobalScope;

public class CellModel_ListWithRole extends jetbrains.mps.lang.editor.structure.CellModel_WithRole {
  ...
  public jetbrains.mps.lang.editor.structure.QueryFunction_NodeFactory getNodeFactory() {
    return (jetbrains.mps.lang.editor.structure.QueryFunction_NodeFactory)this.getChild(QueryFunction_NodeFactory.class, CellModel_ListWithRole.NODE_FACTORY);
  }

  public void setNodeFactory(jetbrains.mps.lang.editor.structure.QueryFunction_NodeFactory node) {
    super.setChild(CellModel_ListWithRole.NODE_FACTORY, node);
  }

  public jetbrains.mps.lang.editor.structure.EditorCellModel getEmptyCellModel() {
    return (jetbrains.mps.lang.editor.structure.EditorCellModel)this.getChild(EditorCellModel.class, CellModel_ListWithRole.EMPTY_CELL_MODEL);
  }

  public void setEmptyCellModel(jetbrains.mps.lang.editor.structure.EditorCellModel node) {
    super.setChild(CellModel_ListWithRole.EMPTY_CELL_MODEL, node);
  }

  public jetbrains.mps.lang.editor.structure.CellLayout getCellLayout() {
    return (jetbrains.mps.lang.editor.structure.CellLayout)this.getChild(CellLayout.class, CellModel_ListWithRole.CELL_LAYOUT);
  }

  public void setCellLayout(jetbrains.mps.lang.editor.structure.CellLayout node) {
    super.setChild(CellModel_ListWithRole.CELL_LAYOUT, node);
  }

  public jetbrains.mps.lang.editor.structure.InlineStyleDeclaration getSeparatorStyle() {
    return (jetbrains.mps.lang.editor.structure.InlineStyleDeclaration)this.getChild(InlineStyleDeclaration.class, CellModel_ListWithRole.SEPARATOR_STYLE);
  }

  public void setSeparatorStyle(jetbrains.mps.lang.editor.structure.InlineStyleDeclaration node) {
