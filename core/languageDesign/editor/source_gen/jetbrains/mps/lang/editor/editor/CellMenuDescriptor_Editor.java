...
public class CellMenuDescriptor_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createCollection_1820_0(EditorContext editorContext, SNode node) {
    ...
    editorCell.addEditorCell(this.createConstant_1820_0(editorContext, node, "menu parts:"));
    editorCell.addEditorCell(this.createRefNodeList_1820_0(editorContext, node));
    return editorCell;
  }

  private EditorCell createConstant_1820_0(EditorContext editorContext, SNode node, String text) {
  ...
  private static class cellMenuPartListHandler_1820_0 extends RefNodeListHandler {
    ...
    public EditorCell createEmptyCell_internal(EditorContext editorContext, SNode node) {
      return this.createConstant_1820_1(editorContext, node, "<choose menu part>");
    }
    ...
    private EditorCell createConstant_1820_1(EditorContext editorContext, SNode node, String text) {
      EditorCell_Constant editorCell = new EditorCell_Constant(editorContext, node, text);
