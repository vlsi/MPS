...
public class CellModel_AbstractLabel extends jetbrains.mps.lang.editor.structure.EditorCellModel {
  ...
  public jetbrains.mps.lang.editor.structure.QueryFunction_Color getCellForegroundFunction() {
    return (jetbrains.mps.lang.editor.structure.QueryFunction_Color)this.getChild(QueryFunction_Color.class, CellModel_AbstractLabel.CELL_FOREGROUND_FUNCTION);
  }

  public void setCellForegroundFunction(jetbrains.mps.lang.editor.structure.QueryFunction_Color node) {
    super.setChild(CellModel_AbstractLabel.CELL_FOREGROUND_FUNCTION, node);
  }

  public jetbrains.mps.lang.editor.structure.QueryFunction_Color getTextForegroundEmptyFunction() {
    return (jetbrains.mps.lang.editor.structure.QueryFunction_Color)this.getChild(QueryFunction_Color.class, CellModel_AbstractLabel.TEXT_FOREGROUND_EMPTY_FUNCTION);
  }

  public void setTextForegroundEmptyFunction(jetbrains.mps.lang.editor.structure.QueryFunction_Color node) {
    super.setChild(CellModel_AbstractLabel.TEXT_FOREGROUND_EMPTY_FUNCTION, node);
  }

  public jetbrains.mps.lang.editor.structure.QueryFunction_Color getTextBackgroundFunction() {
    return (jetbrains.mps.lang.editor.structure.QueryFunction_Color)this.getChild(QueryFunction_Color.class, CellModel_AbstractLabel.TEXT_BACKGROUND_FUNCTION);
  }

  public void setTextBackgroundFunction(jetbrains.mps.lang.editor.structure.QueryFunction_Color node) {
    super.setChild(CellModel_AbstractLabel.TEXT_BACKGROUND_FUNCTION, node);
  }

  public jetbrains.mps.lang.editor.structure.QueryFunction_Color getTextBgColorSelectedFunction() {
    return (jetbrains.mps.lang.editor.structure.QueryFunction_Color)this.getChild(QueryFunction_Color.class, CellModel_AbstractLabel.TEXT_BG_COLOR_SELECTED_FUNCTION);
  }

  public void setTextBgColorSelectedFunction(jetbrains.mps.lang.editor.structure.QueryFunction_Color node) {
