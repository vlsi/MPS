...
public class CellModel_Collection extends jetbrains.mps.lang.editor.structure.EditorCellModel {
  ...
  public jetbrains.mps.lang.editor.structure.CellLayout getCellLayout() {
    return (jetbrains.mps.lang.editor.structure.CellLayout)this.getChild(CellLayout.class, CellModel_Collection.CELL_LAYOUT);
  }
  ...
  public Iterator<jetbrains.mps.lang.editor.structure.EditorCellModel> childCellModels() {
    return this.children(EditorCellModel.class, CellModel_Collection.CHILD_CELL_MODEL);
  }

  public List<jetbrains.mps.lang.editor.structure.EditorCellModel> getChildCellModels() {
    return this.getChildren(EditorCellModel.class, CellModel_Collection.CHILD_CELL_MODEL);
  }

  public void addChildCellModel(jetbrains.mps.lang.editor.structure.EditorCellModel node) {
    this.addChild(CellModel_Collection.CHILD_CELL_MODEL, node);
  }

  public void insertChildCellModel(jetbrains.mps.lang.editor.structure.EditorCellModel prev, jetbrains.mps.lang.editor.structure.EditorCellModel node) {
