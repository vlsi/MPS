...
public class EditorCellModel extends BaseConcept implements IStyleContainer {
  ...
  public CellActionMapDeclaration getActionMap() {
    return (CellActionMapDeclaration)this.getReferent(EditorCellModel.ACTION_MAP);
  }
  ...
  public CellKeyMapDeclaration getKeyMap() {
    return (CellKeyMapDeclaration)this.getReferent(EditorCellModel.KEY_MAP);
  }
  ...
  public StyleSheetClass getStyleClass() {
    return (StyleSheetClass)this.getReferent(EditorCellModel.STYLE_CLASS);
  }
  ...
  public QueryFunction_NodeCondition getRenderingCondition() {
    return (QueryFunction_NodeCondition)this.getChild(EditorCellModel.RENDERING_CONDITION);
  }
  ...
  public CellMenuDescriptor getMenuDescriptor() {
    return (CellMenuDescriptor)this.getChild(EditorCellModel.MENU_DESCRIPTOR);
  }
  ...
  public QueryFunction_Color getCellBackgroundFunction() {
    return (QueryFunction_Color)this.getChild(EditorCellModel.CELL_BACKGROUND_FUNCTION);
  }
  ...
  public QueryFunction_NodeCondition getFocusPolicyApplicable() {
    return (QueryFunction_NodeCondition)this.getChild(EditorCellModel.FOCUS_POLICY_APPLICABLE);
  }
  ...
  public Iterator<StyleClassItem> styleItems() {
    return this.children(EditorCellModel.STYLE_ITEM);
  }

  public List<StyleClassItem> getStyleItems() {
    return this.getChildren(EditorCellModel.STYLE_ITEM);
  }
