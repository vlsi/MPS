...
public class Styles_StyleSheet {
  public static Style getRootCellModelStyle(final EditorCell cell) {
    ...
    style.set(StyleAttributes.INDENT_LAYOUT_INDENT, new AttributeCalculator<Boolean>() {
      public Boolean calculate(EditorCell cell) {
        return Styles_StyleSheet._StyleParameter_QueryFunction_7582_fsg2h571((cell == null ?
          null :
          cell.getSNode()
        ), (cell == null ?
          null :
    ...
    style.set(StyleAttributes.INDENT_LAYOUT_NEW_LINE, new AttributeCalculator<Boolean>() {
      public Boolean calculate(EditorCell cell) {
        return Styles_StyleSheet._StyleParameter_QueryFunction_7582_fsg2hv0v((cell == null ?
          null :
          cell.getSNode()
        ), (cell == null ?
          null :
    ...
    style.set(StyleAttributes.INDENT_LAYOUT_ON_NEW_LINE, new AttributeCalculator<Boolean>() {
      public Boolean calculate(EditorCell cell) {
        return Styles_StyleSheet._StyleParameter_QueryFunction_7582_fsg3efib((cell == null ?
          null :
          cell.getSNode()
        ), (cell == null ?
          null :
  ...
  public static Style getAttributedCellLabel(final EditorCell cell) {
    ...
    style.set(StyleAttributes.UNDERLINED, new AttributeCalculator<Boolean>() {
      public Boolean calculate(EditorCell cell) {
        return Styles_StyleSheet._StyleParameter_QueryFunction_7582_xilj3fm55xef((cell == null ?
          null :
          cell.getSNode()
        ), (cell == null ?
          null :
  ...
  private static boolean _StyleParameter_QueryFunction_7582_fsg2h571(SNode node, EditorContext editorContext) {
  ...
  private static boolean _StyleParameter_QueryFunction_7582_fsg2hv0v(SNode node, EditorContext editorContext) {
    if (!(SNodeOperations.isInstanceOf(node, "jetbrains.mps.lang.editor.structure.EditorCellModel"))) {
      return false;
    }
  ...
  private static boolean _StyleParameter_QueryFunction_7582_fsg3efib(SNode node, EditorContext editorContext) {
    if (!(SNodeOperations.isInstanceOf(node, "jetbrains.mps.lang.editor.structure.EditorCellModel"))) {
      return false;
    }
  ...
  private static boolean _StyleParameter_QueryFunction_7582_xilj3fm55xef(SNode node, EditorContext editorContext) {
    return true;
  }
}
