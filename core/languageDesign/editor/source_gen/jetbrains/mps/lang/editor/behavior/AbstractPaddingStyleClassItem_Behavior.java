...
public class AbstractPaddingStyleClassItem_Behavior {
  ...
  public static boolean call_canUseSpaces_1226492824000(SNode thisNode) {
    return (Boolean)BehaviorManager.getInstance().invoke(Boolean.class, thisNode, "virtual_canUseSpaces_1226492824000", PARAMETERS_1226492824000);
  }

  public static boolean callSuper_canUseSpaces_1226492824000(SNode thisNode, String callerConceptFqName) {
    return (Boolean)BehaviorManager.getInstance().invokeSuper(Boolean.class, thisNode, callerConceptFqName, "virtual_canUseSpaces_1226492824000", PARAMETERS_1226492824000);
  }
