...
public class RGBColor extends BaseConcept implements IQueryFunction_Color {
  ...
  public int get_$attributesCount() {
    return this.getChildCount(RGBColor._$ATTRIBUTE);
  }

  public Iterator<Attribute> _$attributes() {
    return this.children(Attribute.class, RGBColor._$ATTRIBUTE);
  }

  public List<Attribute> get_$attributes() {
    return this.getChildren(Attribute.class, RGBColor._$ATTRIBUTE);
  }

  public void add_$attribute(Attribute node) {
    this.addChild(RGBColor._$ATTRIBUTE, node);
  }

  public void insert_$attribute(Attribute prev, Attribute node) {
    this.insertChild(prev, RGBColor._$ATTRIBUTE, node);
  }
