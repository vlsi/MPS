    ...
    try {
      {
        ...
        this.add(ActionFactory.getInstance().getRegisteredAction(language.getClass("jetbrains.mps.lang.editor.plugin.CopyThisDown_Action"), language.getModuleFqName()));
      }
    } catch (Throwable t) {
