...
public class CellModel_Collection_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createRefNodeList_2102_0(EditorContext context, SNode node) {
    AbstractCellListHandler handler = new CellModel_Collection_Editor.childCellModelListHandler_2102_0(node, "childCellModel", context);
  ...
  private EditorCell createRefNodeList_2102_1(EditorContext context, SNode node) {
    AbstractCellListHandler handler = new CellModel_Collection_Editor.childCellModelListHandler_2102_1(node, "childCellModel", context);
  ...
  private EditorCell createRefNodeList_2102_2(EditorContext context, SNode node) {
    AbstractCellListHandler handler = new CellModel_Collection_Editor.childCellModelListHandler_2102_2(node, "childCellModel", context);
