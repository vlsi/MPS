  ...
  public void applyRule(final SNode nodeToCheck, final TypeCheckingContext typeCheckingContext) {
    {
      ...
      typeCheckingContext.createLessThanInequation(typeCheckingContext.typeOf(SLinkOperations.getTarget(nodeToCheck, "foundNode", true), "r:00000000-0000-4000-0000-011c8959035a(jetbrains.mps.lang.findUsages.helgins)", "1200308962549", true), new QuotationClass_2().createNode(), _nodeToCheck_1029348928467, null, "r:00000000-0000-4000-0000-011c8959035a(jetbrains.mps.lang.findUsages.helgins)", "1200308962544", false, 0, intentionProvider);
    }
  }
