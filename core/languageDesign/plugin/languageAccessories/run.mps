...
<model modelUID="r:82f15792-6966-47aa-8004-b293ab2bcfd2(jetbrains.mps.lang.plugin.run)">
  ...
  <root id="242278890011773407">
        ...
        <node role="statement" roleId="tpee.1068581517665" type="tpee.SuperConstructorInvocation" typeId="tpee.1070475587102" id="242278890011773464">
          ...
          <node role="actualArgument" roleId="tpee.1068499141038" type="tpee.GenericNewExpression" typeId="tpee.1145552977093" id="4762811064051541378">
            <node role="creator" roleId="tpee.1145553007750" type="tpee.ClassCreator" typeId="tpee.1212685548494" id="4762811064051542501">
              <link role="baseMethodDeclaration" roleId="tpee.1068499141037" targetNodeId="3d29.~ConsoleProcessListener%d&lt;init&gt;(com%dintellij%dexecution%dui%dConsoleView)" resolveInfo="ConsoleProcessListener" />
    ...
    <node role="superclass" roleId="tpee.1165602531693" type="tpee.ClassifierType" typeId="tpee.1107535904670" id="4762811064051541376">
      <link role="classifier" roleId="tpee.1107535924139" targetNodeId="3d29.~DefaultProcessHandler" resolveInfo="DefaultProcessHandler" />
    </node>
