...
public class typeof_PersistentPropertyDeclaration_InferenceRule extends AbstractInferenceRule_Runtime implements InferenceRule_Runtime {
  ...
  public void applyRule(final SNode persistentPropertyDeclaration, final TypeCheckingContext typeCheckingContext) {
    {
      ...
      typeCheckingContext.createLessThanInequation((SNode) SLinkOperations.getTarget(persistentPropertyDeclaration, "type", true), (SNode) new typeof_PersistentPropertyDeclaration_InferenceRule.QuotationClass_sacma3_a0a0a0().createNode(typeCheckingContext), false, _info_12389875345);
    }
  }
  ...
  public static class QuotationClass_sacma3_a0a0a0 {
    public QuotationClass_sacma3_a0a0a0() {
    }
