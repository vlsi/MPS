...
public class MultitabbedEditorTab_Behavior {
  ...
  public static class QuotationClass_rydvjr_a0a0b {
    ...
    public SNode createNode() {
      ...
      {
        quotedNode_1 = SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.lang.plugin.structure.MultitabbedEditorTabType", TypeChecker.getInstance().getRuntimeTypesModel(), GlobalScope.getInstance(), false);
