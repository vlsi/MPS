...
public class SingletabbedEditorTab_Behavior {
  ...
  public static class QuotationClass_oqwaam_a0a0b {
    ...
    public SNode createNode() {
      ...
      {
        quotedNode_1 = SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.lang.plugin.structure.SingletabbedEditorTabType", TypeChecker.getInstance().getRuntimeTypesModel(), GlobalScope.getInstance(), false);
