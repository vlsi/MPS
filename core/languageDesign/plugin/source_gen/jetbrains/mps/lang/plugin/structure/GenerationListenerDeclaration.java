...
public class GenerationListenerDeclaration extends BaseConcept implements INamedConcept {
  ...
  public static String BEFORE_GENERATION_BLOCK = "beforeGenerationBlock";
  public static String MODELS_GENERATED_BLOCK = "modelsGeneratedBlock";
  public static String AFTER_GENERATION_BLOCK = "afterGenerationBlock";
  ...
  public BeforeGenerationBlock getBeforeGenerationBlock() {
    return (BeforeGenerationBlock)this.getChild(GenerationListenerDeclaration.BEFORE_GENERATION_BLOCK);
  }
  ...
  public OnModelsGeneratedBlock getModelsGeneratedBlock() {
    return (OnModelsGeneratedBlock)this.getChild(GenerationListenerDeclaration.MODELS_GENERATED_BLOCK);
  }
  ...
  public AfterGenerationBlock getAfterGenerationBlock() {
    return (AfterGenerationBlock)this.getChild(GenerationListenerDeclaration.AFTER_GENERATION_BLOCK);
  }
