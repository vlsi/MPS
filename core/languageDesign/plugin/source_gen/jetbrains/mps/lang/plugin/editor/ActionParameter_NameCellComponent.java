...
public class ActionParameter_NameCellComponent extends AbstractCellProvider {
  ...
  public EditorCell createProperty_9788_0_internal(EditorContext context, SNode node, CellProviderWithRole aProvider) {
    CellProviderWithRole provider = aProvider;
    provider.setAuxiliaryCellProvider(null);
    EditorCell editorCell = provider.createEditorCell(context);
    setupBasic_Property_9788_0(editorCell, node, context);
    if (editorCell instanceof EditorCell_Label) {
      setupLabel_Property_9788_0((EditorCell_Label)editorCell, node, context);
    }
  ...
  private static void setupLabel_Property_9788_0(EditorCell_Label editorCell, SNode node, EditorContext context) {
  }
