...
public class ProjectPluginDeclaration extends jetbrains.mps.lang.core.structure.BaseConcept implements jetbrains.mps.baseLanguage.classifiers.structure.IClassifier {
  ...
  public jetbrains.mps.lang.plugin.structure.ProjectPluginInitBlock getInitBlock() {
    return (jetbrains.mps.lang.plugin.structure.ProjectPluginInitBlock)this.getChild(ProjectPluginInitBlock.class, ProjectPluginDeclaration.INIT_BLOCK);
  }
  ...
  public jetbrains.mps.lang.plugin.structure.ProjectPluginDisposeBlock getDisposeBlock() {
    return (jetbrains.mps.lang.plugin.structure.ProjectPluginDisposeBlock)this.getChild(ProjectPluginDisposeBlock.class, ProjectPluginDeclaration.DISPOSE_BLOCK);
  }
