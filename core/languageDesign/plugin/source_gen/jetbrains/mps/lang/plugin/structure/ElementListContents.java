...
public class ElementListContents extends jetbrains.mps.lang.core.structure.BaseConcept implements jetbrains.mps.lang.plugin.structure.GroupContents {
  ...
  public Iterator<jetbrains.mps.lang.plugin.structure.ActionGroupMember> references() {
    return this.children(ActionGroupMember.class, ElementListContents.REFERENCE);
  }

  public List<jetbrains.mps.lang.plugin.structure.ActionGroupMember> getReferences() {
    return this.getChildren(ActionGroupMember.class, ElementListContents.REFERENCE);
  }

  public void addReference(jetbrains.mps.lang.plugin.structure.ActionGroupMember node) {
    this.addChild(ElementListContents.REFERENCE, node);
  }

  public void insertReference(jetbrains.mps.lang.plugin.structure.ActionGroupMember prev, jetbrains.mps.lang.plugin.structure.ActionGroupMember node) {
