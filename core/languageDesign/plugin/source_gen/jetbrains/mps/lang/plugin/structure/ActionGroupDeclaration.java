...
public class ActionGroupDeclaration extends jetbrains.mps.lang.core.structure.BaseConcept implements jetbrains.mps.lang.core.structure.INamedConcept, jetbrains.mps.lang.plugin.structure.ActionGroupMember, jetbrains.mps.baseLanguage.classifiers.structure.IClassifier {
  ...
  public jetbrains.mps.lang.plugin.structure.GroupContents getContents() {
    return (jetbrains.mps.lang.plugin.structure.GroupContents)this.getChild(GroupContents.class, ActionGroupDeclaration.CONTENTS);
  }

  public void setContents(jetbrains.mps.lang.plugin.structure.GroupContents node) {
  ...
  public Iterator<jetbrains.mps.lang.plugin.structure.ModificationStatement> modifiers() {
    return this.children(ModificationStatement.class, ActionGroupDeclaration.MODIFIER);
  }

  public List<jetbrains.mps.lang.plugin.structure.ModificationStatement> getModifiers() {
    return this.getChildren(ModificationStatement.class, ActionGroupDeclaration.MODIFIER);
  }

  public void addModifier(jetbrains.mps.lang.plugin.structure.ModificationStatement node) {
    this.addChild(ActionGroupDeclaration.MODIFIER, node);
  }

  public void insertModifier(jetbrains.mps.lang.plugin.structure.ModificationStatement prev, jetbrains.mps.lang.plugin.structure.ModificationStatement node) {
