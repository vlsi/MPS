...
public class SplitMPSClasspath_MigrationScript extends BaseMigrationScript {
    ...
    this.addRefactoring(new AbstractMigrationRefactoring(operationContext) {
      ...
      public void doUpdateInstanceNode(SNode node) {
        ...
        for (SReference ref : ListSequence.fromList(SNodeOperations.getReferences(node))) {
          final String fqname = check_ylpn3n_a0a0f0a0(ref.getTargetSModelReference());
          for (IModule newModule : modules) {
            List<SModelDescriptor> models = newModule.getOwnModelDescriptors();
            SModelReference modelRef = check_ylpn3n_a0b0b0f0a0(ListSequence.fromList(models).findFirst(new IWhereFilter<SModelDescriptor>() {
              public boolean accept(SModelDescriptor it) {
                return eq_e5sso0_a0a0a0a0a0a0b0b0f0e0a0a0b0a(it.getLongName(), fqname);
              }
            }));
            if (modelRef == null) {
              continue;
            }
            model.deleteModelImport(ref.getTargetSModelReference());
  ...
  private static String check_ylpn3n_a0a0f0a0(SModelReference checkedDotOperand) {
    if (null != checkedDotOperand) {
  ...
  private static SModelReference check_ylpn3n_a0b0b0f0a0(SModelDescriptor checkedDotOperand) {
    if (null != checkedDotOperand) {
  ...
  private static boolean eq_e5sso0_a0a0a0a0a0a0b0b0f0e0a0a0b0a(Object a, Object b) {
    return (a != null ?
      a.equals(b) :
      a == b
    );
