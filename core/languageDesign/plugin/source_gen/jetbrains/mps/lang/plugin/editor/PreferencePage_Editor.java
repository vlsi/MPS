...
public class PreferencePage_Editor extends DefaultNodeEditor {
  ...
  public EditorCell createCollection_6322_3(EditorContext context, SNode node) {
    ...
    editorCell.addEditorCell(EditorCell_Component.createComponentCell(context, node, PreferencePage_Editor._QueryFunction_JComponent_8308907181189009536(node, context), "_8308907181189009535"));
    return editorCell;
  }
  ...
  public EditorCell createImage_6322_0(EditorContext context, SNode node) {
    ...
    editorCell = EditorCell_Image.createImageCell(context, node, _image_provider_8308907181189009525(node, context));
  ...
  public static String _image_provider_8308907181189009525(SNode node, EditorContext editorContext) {
  ...
  public static JComponent _QueryFunction_JComponent_8308907181189009536(SNode node, EditorContext editorContext) {
