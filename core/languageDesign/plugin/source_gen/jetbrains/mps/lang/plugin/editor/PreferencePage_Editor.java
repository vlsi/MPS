...
public class PreferencePage_Editor extends DefaultNodeEditor {
  ...
  public EditorCell createCollection_6322_3(EditorContext context, SNode node) {
    ...
    editorCell.addEditorCell(EditorCell_Component.createComponentCell(context, node, PreferencePage_Editor._QueryFunction_JComponent_617352830884906889(node, context), "_617352830884906888"));
    return editorCell;
  }
  ...
  public EditorCell createImage_6322_0(EditorContext context, SNode node) {
    ...
    editorCell = EditorCell_Image.createImageCell(context, node, _image_provider_617352830884906878(node, context));
  ...
  public static String _image_provider_617352830884906878(SNode node, EditorContext editorContext) {
  ...
  public static JComponent _QueryFunction_JComponent_617352830884906889(SNode node, EditorContext editorContext) {
