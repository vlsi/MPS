...
public class PreferencePage_Editor extends DefaultNodeEditor {
  ...
  public EditorCell createCollection_6322_3(EditorContext context, SNode node) {
    ...
    editorCell.addEditorCell(EditorCell_Component.createComponentCell(context, node, PreferencePage_Editor._QueryFunction_JComponent_1171743928472750506(node, context), "_1171743928472750505"));
    return editorCell;
  }
  ...
  public EditorCell createImage_6322_0(EditorContext context, SNode node) {
    ...
    editorCell = EditorCell_Image.createImageCell(context, node, _image_provider_1171743928472750495(node, context));
  ...
  public static String _image_provider_1171743928472750495(SNode node, EditorContext editorContext) {
  ...
  public static JComponent _QueryFunction_JComponent_1171743928472750506(SNode node, EditorContext editorContext) {
