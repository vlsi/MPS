...
public class MoveTraceInfoToTextGen_MigrationScript extends BaseMigrationScript {
  ...
  private static boolean eq_3y9ork_a0a0a0a0a0a0a0a0a0a3a4a0a0a2a0(Object a, Object b) {
    return (a != null ?
      a.equals(b) :
      a == b
    );
  ...
  private static boolean eq_3y9ork_a0a0a0a0a0a0a0a0a0a6a4a0a0a2a0(Object a, Object b) {
    return (a != null ?
      a.equals(b) :
      a == b
    );
  ...
  private static boolean eq_3y9ork_a0a0a0a0a0a0a0a0a0a9a4a0a0a2a0(Object a, Object b) {
    return (a != null ?
      a.equals(b) :
      a == b
    );
  ...
  public static class QuotationClass_3y9ork_a0a0a0c0e0a0a0b0a {
    public QuotationClass_3y9ork_a0a0a0c0e0a0a0b0a() {
    }
  ...
  public static class QuotationClass_3y9ork_a0a0b0d0e0a0a0c0a {
    public QuotationClass_3y9ork_a0a0b0d0e0a0a0c0a() {
    }
  ...
  public static class QuotationClass_3y9ork_a0a0b0c0d0e0a0a0c0a {
    public QuotationClass_3y9ork_a0a0b0c0d0e0a0a0c0a() {
    }
    ...
    public SNode createNode(Object parameter_12) {
      ...
      SNode quotedNode_6 = null;
      {
        ...
        quotedNode1_7.setProperty("name", "getTraceableProperty");
        quotedNode1_7.addReference(SReference.create("overriddenMethod", quotedNode1_7, SModelReference.fromString("r:0fa39ea9-f6a4-454d-9b16-ce07a09428ca(jetbrains.mps.lang.textGen.behavior)"), SNodeId.fromString("3822000666564591088")));
        {
        ...
        }
        {
          ...
          quotedNode1_9.addReference(SReference.create("annotation", quotedNode1_9, SModelReference.fromString("f:java_stub#org.jetbrains.annotations(org.jetbrains.annotations@java_stub)"), SNodeId.fromString("~Nullable")));
          quotedNode_1.addChild("annotation", quotedNode1_9);
        }
        {
        ...
        {
          quotedNode_5 = SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.baseLanguage.structure.StringType", null, GlobalScope.getInstance(), false);
  ...
  public static class QuotationClass_3y9ork_a1a0a2a2a3a4a0a0a2a0 {
    public QuotationClass_3y9ork_a1a0a2a2a3a4a0a0a2a0() {
    }
  ...
  public static class QuotationClass_3y9ork_a0a0a0a0a0a0a0a3a4a0a0a2a0 {
    public QuotationClass_3y9ork_a0a0a0a0a0a0a0a3a4a0a0a2a0() {
    }
  ...
  public static class QuotationClass_3y9ork_a0a0b0g0e0a0a0c0a {
    public QuotationClass_3y9ork_a0a0b0g0e0a0a0c0a() {
    }
  ...
  public static class QuotationClass_3y9ork_a0a0d0g0e0a0a0c0a {
    public QuotationClass_3y9ork_a0a0d0g0e0a0a0c0a() {
    }
      ...
      SNode quotedNode_5 = null;
      {
        ...
        }
        {
          ...
          SNode quotedNode1_8 = quotedNode_3;
          {
            ...
            for (SNode child : nodes) {
              quotedNode_3.addChild("statement", HUtil.copyIfNecessary(child));
            }
          }
          quotedNode_1.addChild("body", quotedNode1_8);
        }
        {
          quotedNode_4 = SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.lang.smodel.structure.SNodeListType", null, GlobalScope.getInstance(), false);
  ...
  public static class QuotationClass_3y9ork_a1a0a4a6a4a0a0a2a0 {
    public QuotationClass_3y9ork_a1a0a4a6a4a0a0a2a0() {
    }
  ...
  public static class QuotationClass_3y9ork_a0a0a0a0a0a0a0a6a4a0a0a2a0 {
    public QuotationClass_3y9ork_a0a0a0a0a0a0a0a6a4a0a0a2a0() {
    }
  ...
  public static class QuotationClass_3y9ork_a0a0b0j0e0a0a0c0a {
    public QuotationClass_3y9ork_a0a0b0j0e0a0a0c0a() {
    }
  ...
  public static class QuotationClass_3y9ork_a0a0d0j0e0a0a0c0a {
    public QuotationClass_3y9ork_a0a0d0j0e0a0a0c0a() {
    }
    ...
    public SNode createNode(Object parameter_10) {
      ...
      SNode quotedNode_5 = null;
      {
        ...
        SNode quotedNode1_6 = quotedNode_1;
        quotedNode1_6.setProperty("isVirtual", "true");
        quotedNode1_6.setProperty("name", "getUnitName");
        quotedNode1_6.addReference(SReference.create("overriddenMethod", quotedNode1_6, SModelReference.fromString("r:0fa39ea9-f6a4-454d-9b16-ce07a09428ca(jetbrains.mps.lang.textGen.behavior)"), SNodeId.fromString("3822000666564591112")));
        {
          quotedNode_2 = SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.baseLanguage.structure.PublicVisibility", null, GlobalScope.getInstance(), false);
          SNode quotedNode1_7 = quotedNode_2;
          quotedNode_1.addChild("visibility", quotedNode1_7);
  ...
  public static class QuotationClass_3y9ork_a1a0a4a9a4a0a0a2a0 {
    public QuotationClass_3y9ork_a1a0a4a9a4a0a0a2a0() {
    }
  ...
  public static class QuotationClass_3y9ork_a0a0a0a0a0a0a0a9a4a0a0a2a0 {
    public QuotationClass_3y9ork_a0a0a0a0a0a0a0a9a4a0a0a2a0() {
    }
