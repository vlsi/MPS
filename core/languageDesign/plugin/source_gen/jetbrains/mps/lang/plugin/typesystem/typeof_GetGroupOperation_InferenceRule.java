  ...
  public static class QuotationClass_0454_0 {
    ...
    public SNode createNode(final TypeCheckingContext typeCheckingContext) {
      ...
      SNode quotedNode_10 = null;
      {
        ...
        quotedNode1_10.addReference(SReference.create("classifier", quotedNode1_10, SModelReference.fromString("f:java_stub#jetbrains.mps.workbench.action(jetbrains.mps.workbench.action@java_stub)"), SNodeId.fromString("~BaseGroup")));
