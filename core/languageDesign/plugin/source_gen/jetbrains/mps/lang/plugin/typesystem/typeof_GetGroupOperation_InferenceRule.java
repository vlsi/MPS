  ...
  public void applyRule(final SNode getGroupOperation, final TypeCheckingContext typeCheckingContext) {
    {
      ...
      typeCheckingContext.createEquation((SNode)typeCheckingContext.typeOf(_nodeToCheck_1029348928467, "r:00000000-0000-4000-0000-011c89590364(jetbrains.mps.lang.plugin.typesystem)", "1209911237497", true), (SNode)new _Quotations.QuotationClass_11().createNode(typeCheckingContext), _info_12389875345);
    }
  }
