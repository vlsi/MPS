...
public class ToolDeclaration_Editor extends DefaultNodeEditor {
  ...
  public EditorCell createCollection_4170_5(EditorContext context, SNode node) {
    ...
    editorCell.addEditorCell(EditorCell_Component.createComponentCell(context, node, ToolDeclaration_Editor._QueryFunction_JComponent_5003188907306245590(node, context), "_5003188907306245589"));
    return editorCell;
  }
  ...
  public EditorCell createImage_4170_0(EditorContext context, SNode node) {
    ...
    editorCell = EditorCell_Image.createImageCell(context, node, _image_provider_5003188907306245579(node, context));
  ...
  public static String _image_provider_5003188907306245579(SNode node, EditorContext editorContext) {
  ...
  public static JComponent _QueryFunction_JComponent_5003188907306245590(SNode node, EditorContext editorContext) {
