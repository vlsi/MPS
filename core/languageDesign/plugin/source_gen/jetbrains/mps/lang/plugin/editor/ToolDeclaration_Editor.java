...
public class ToolDeclaration_Editor extends DefaultNodeEditor {
  ...
  public EditorCell createCollection_4170_5(EditorContext context, SNode node) {
    ...
    editorCell.addEditorCell(EditorCell_Component.createComponentCell(context, node, ToolDeclaration_Editor._QueryFunction_JComponent_4859441577819771463(node, context), "_4859441577819771462"));
    return editorCell;
  }
  ...
  public EditorCell createImage_4170_0(EditorContext context, SNode node) {
    ...
    editorCell = EditorCell_Image.createImageCell(context, node, _image_provider_4859441577819771452(node, context));
  ...
  public static String _image_provider_4859441577819771452(SNode node, EditorContext editorContext) {
  ...
  public static JComponent _QueryFunction_JComponent_4859441577819771463(SNode node, EditorContext editorContext) {
