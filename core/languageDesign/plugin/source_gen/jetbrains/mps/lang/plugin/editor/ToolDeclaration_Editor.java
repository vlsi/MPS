...
public class ToolDeclaration_Editor extends DefaultNodeEditor {
  ...
  public EditorCell createCollection_4170_5(EditorContext context, SNode node) {
    ...
    editorCell.addEditorCell(EditorCell_Component.createComponentCell(context, node, ToolDeclaration_Editor._QueryFunction_JComponent_1237388091027(node, context), "_1237388091026"));
    return editorCell;
  }
  ...
  public EditorCell createImage_4170_0(EditorContext context, SNode node) {
    ...
    editorCell = EditorCell_Image.createImageCell(context, node, _image_provider_1237388091017(node, context));
  ...
  public static String _image_provider_1237388091017(SNode node, EditorContext editorContext) {
  ...
  public static JComponent _QueryFunction_JComponent_1237388091027(SNode node, EditorContext editorContext) {
