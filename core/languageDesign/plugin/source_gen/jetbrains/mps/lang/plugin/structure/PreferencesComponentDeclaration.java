...
public class PreferencesComponentDeclaration extends jetbrains.mps.lang.core.structure.BaseConcept implements jetbrains.mps.baseLanguage.classifiers.structure.IClassifier {
  ...
  public jetbrains.mps.lang.plugin.structure.OnAfterReadBlock getAfterReadBlock() {
    return (jetbrains.mps.lang.plugin.structure.OnAfterReadBlock)this.getChild(OnAfterReadBlock.class, PreferencesComponentDeclaration.AFTER_READ_BLOCK);
  }

  public void setAfterReadBlock(jetbrains.mps.lang.plugin.structure.OnAfterReadBlock node) {
    super.setChild(PreferencesComponentDeclaration.AFTER_READ_BLOCK, node);
  }

  public jetbrains.mps.lang.plugin.structure.OnBeforeWriteBlock getBeforeWriteBlock() {
    return (jetbrains.mps.lang.plugin.structure.OnBeforeWriteBlock)this.getChild(OnBeforeWriteBlock.class, PreferencesComponentDeclaration.BEFORE_WRITE_BLOCK);
  }

  public void setBeforeWriteBlock(jetbrains.mps.lang.plugin.structure.OnBeforeWriteBlock node) {
  ...
  public Iterator<jetbrains.mps.lang.plugin.structure.PersistentPropertyDeclaration> persistenPropertyDeclarations() {
    return this.children(PersistentPropertyDeclaration.class, PreferencesComponentDeclaration.PERSISTEN_PROPERTY_DECLARATION);
  }

  public List<jetbrains.mps.lang.plugin.structure.PersistentPropertyDeclaration> getPersistenPropertyDeclarations() {
  ...
  public void addPersistenPropertyDeclaration(jetbrains.mps.lang.plugin.structure.PersistentPropertyDeclaration node) {
    this.addChild(PreferencesComponentDeclaration.PERSISTEN_PROPERTY_DECLARATION, node);
  }

  public void insertPersistenPropertyDeclaration(jetbrains.mps.lang.plugin.structure.PersistentPropertyDeclaration prev, jetbrains.mps.lang.plugin.structure.PersistentPropertyDeclaration node) {
  ...
  public Iterator<jetbrains.mps.lang.plugin.structure.PreferencePage> preferencePages() {
    return this.children(PreferencePage.class, PreferencesComponentDeclaration.PREFERENCE_PAGE);
  }

  public List<jetbrains.mps.lang.plugin.structure.PreferencePage> getPreferencePages() {
    return this.getChildren(PreferencePage.class, PreferencesComponentDeclaration.PREFERENCE_PAGE);
  }

  public void addPreferencePage(jetbrains.mps.lang.plugin.structure.PreferencePage node) {
    this.addChild(PreferencesComponentDeclaration.PREFERENCE_PAGE, node);
  }

  public void insertPreferencePage(jetbrains.mps.lang.plugin.structure.PreferencePage prev, jetbrains.mps.lang.plugin.structure.PreferencePage node) {
