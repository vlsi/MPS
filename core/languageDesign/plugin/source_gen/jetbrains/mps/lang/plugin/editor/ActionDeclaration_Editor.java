...
public class ActionDeclaration_Editor extends DefaultNodeEditor {
  ...
  public EditorCell createCollection_0824_9(EditorContext context, SNode node) {
    ...
    editorCell.addEditorCell(EditorCell_Component.createComponentCell(context, node, ActionDeclaration_Editor._QueryFunction_JComponent_4859441577819771178(node, context), "_4859441577819771177"));
    return editorCell;
  }
  ...
  public EditorCell createImage_0824_0(EditorContext context, SNode node) {
    ...
    editorCell = EditorCell_Image.createImageCell(context, node, _image_provider_4859441577819771167(node, context));
  ...
  public static String _image_provider_4859441577819771167(SNode node, EditorContext editorContext) {
  ...
  public static JComponent _QueryFunction_JComponent_4859441577819771178(SNode node, EditorContext editorContext) {
