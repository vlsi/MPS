...
public class ActionDeclaration_Editor extends DefaultNodeEditor {
  ...
  public EditorCell createCollection_0824_8(EditorContext context, SNode node) {
    ...
    editorCell.addEditorCell(EditorCell_Component.createComponentCell(context, node, ActionDeclaration_Editor._QueryFunction_JComponent_1234960281543(node, context), "_1234960281542"));
    return editorCell;
  }
  ...
  public EditorCell createImage_0824_0(EditorContext context, SNode node) {
    ...
    editorCell = EditorCell_Image.createImageCell(context, node, _image_provider_1234960281532(node, context));
  ...
  public static String _image_provider_1234960281532(SNode node, EditorContext editorContext) {
  ...
  public static JComponent _QueryFunction_JComponent_1234960281543(SNode node, EditorContext editorContext) {
