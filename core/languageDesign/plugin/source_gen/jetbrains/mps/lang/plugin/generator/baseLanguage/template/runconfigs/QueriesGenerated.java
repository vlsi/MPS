...
public class QueriesGenerated {
  ...
  public static Object referenceMacro_GetReferent_8591610611835627262(final IOperationContext operationContext, final ReferenceMacroContext _context) {
    if ((SLinkOperations.getTarget(_context.getNode(), "stateTypeParameter", false) != null)) {
      ...
      return SLinkOperations.getTarget(new QueriesGenerated.QuotationClass_x583g4_a0a0a0a0eb().createNode(), "classifier", false);
    }
  }
  ...
  public static Object referenceMacro_GetReferent_3994570451548110947(final IOperationContext operationContext, final ReferenceMacroContext _context) {
    return (SLinkOperations.getTarget(_context.getNode(), "concept", false) == null ?
      SLinkOperations.getTarget(new QueriesGenerated.QuotationClass_x583g4_a0a0a0ec().createNode(), "concept", false) :
      SLinkOperations.getTarget(_context.getNode(), "concept", false)
    );
  }
  ...
  public static boolean ifMacro_Condition_8901044928163425520(final IOperationContext operationContext, final IfMacroContext _context) {
    ...
    if (SLinkOperations.getTarget(type, "classifier", false) == SLinkOperations.getTarget(new QueriesGenerated.QuotationClass_x583g4_a0a0e0mc().createNode(), "classifier", false)) {
      return false;
    }
    return true;
  }
  ...
  public static SNode sourceNodeQuery_3018238135944429960(final IOperationContext operationContext, final SourceSubstituteMacroNodeContext _context) {
    return SLinkOperations.getTarget(_context.getNode(), "parameterType", true);
  }

  public static SNode sourceNodeQuery_3018238135944429971(final IOperationContext operationContext, final SourceSubstituteMacroNodeContext _context) {
    return SLinkOperations.getTarget(_context.getNode(), "body", true);
  }
  ...
  public static SNode weaving_MappingRule_ContextNodeQuery_3018238135944391305(final IOperationContext opereationContext, final WeavingMappingRuleContext _context) {
    return _context.getOutputNodeByInputNodeAndMappingLabel(SNodeOperations.getAncestor(_context.getNode(), "jetbrains.mps.lang.plugin.structure.RunConfigurationDeclaration", false, true), "map_ConfigClass");
  }
  ...
  public static class QuotationClass_x583g4_a0a0a0a0eb {
    public QuotationClass_x583g4_a0a0a0a0eb() {
    }
  ...
  public static class QuotationClass_x583g4_a0a0a0ec {
    public QuotationClass_x583g4_a0a0a0ec() {
    }
  ...
  public static class QuotationClass_x583g4_a0a0e0mc {
    public QuotationClass_x583g4_a0a0e0mc() {
    }
