  ...
  public void applyRule(final SNode parameterReferenceOperation, final TypeCheckingContext typeCheckingContext) {
    {
      ...
      EquationInfo info = new EquationInfo(_nodeToCheck_1029348928467, null, "r:00000000-0000-4000-0000-011c89590364(jetbrains.mps.lang.plugin.typesystem)", "1206093159061", 0, intentionProvider);
      typeCheckingContext.createEquation((SNode)typeCheckingContext.typeOf(_nodeToCheck_1029348928467, "r:00000000-0000-4000-0000-011c89590364(jetbrains.mps.lang.plugin.typesystem)", "1206093151683", true), (SNode)SLinkOperations.getTarget(SLinkOperations.getTarget(parameterReferenceOperation, "member", false), "type", true), info);
    }
  }
