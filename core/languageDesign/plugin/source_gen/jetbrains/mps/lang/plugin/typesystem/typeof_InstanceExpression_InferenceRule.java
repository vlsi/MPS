...
public class typeof_InstanceExpression_InferenceRule extends AbstractInferenceRule_Runtime implements InferenceRule_Runtime {
  ...
  public static class QuotationClass_8479_0 {
    ...
    public SNode createNode(final TypeCheckingContext typeCheckingContext) {
      ...
      SNode quotedNode_8479_0 = null;
      {
        quotedNode_8479_0 = SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.baseLanguage.structure.ClassifierType", TypeChecker.getInstance().getRuntimeTypesModel(), GlobalScope.getInstance(), false);
        SNode quotedNode1_8479_0 = quotedNode_8479_0;
        quotedNode1_8479_0.addReference(SReference.create("classifier", quotedNode1_8479_0, SModelReference.fromString("f:java_stub#javax.swing(javax.swing@java_stub)"), SNodeId.fromString("~JComponent")));
        result = quotedNode1_8479_0;
      }
      return result;
    }
