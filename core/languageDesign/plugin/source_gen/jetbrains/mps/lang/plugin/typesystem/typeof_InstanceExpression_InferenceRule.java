...
public class typeof_InstanceExpression_InferenceRule extends AbstractInferenceRule_Runtime implements InferenceRule_Runtime {
  ...
  public static class QuotationClass_rp0l14_a0a0a0 {
    ...
    public SNode createNode(final TypeCheckingContext typeCheckingContext) {
      ...
      SNode quotedNode_rp0l14_a0a0a0 = null;
      {
        quotedNode_rp0l14_a0a0a0 = SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.baseLanguage.structure.ClassifierType", TypeChecker.getInstance().getRuntimeTypesModel(), GlobalScope.getInstance(), false);
        SNode quotedNode1_rp0l14_a0a0a0 = quotedNode_rp0l14_a0a0a0;
        quotedNode1_rp0l14_a0a0a0.addReference(SReference.create("classifier", quotedNode1_rp0l14_a0a0a0, SModelReference.fromString("f:java_stub#javax.swing(javax.swing@java_stub)"), SNodeId.fromString("~JComponent")));
        result = quotedNode1_rp0l14_a0a0a0;
      }
      return result;
    }
