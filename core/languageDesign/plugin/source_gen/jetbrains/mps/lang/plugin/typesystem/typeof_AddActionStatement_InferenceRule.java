...
public class typeof_AddActionStatement_InferenceRule extends AbstractInferenceRule_Runtime implements InferenceRule_Runtime {
  ...
  public static class QuotationClass_g49o0e_a0a0a0 {
    ...
    public SNode createNode(final TypeCheckingContext typeCheckingContext) {
      ...
      SNode quotedNode_g49o0e_a0a0a0 = null;
      {
        quotedNode_g49o0e_a0a0a0 = SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.baseLanguage.structure.ClassifierType", TypeChecker.getInstance().getRuntimeTypesModel(), GlobalScope.getInstance(), false);
        SNode quotedNode1_g49o0e_a0a0a0 = quotedNode_g49o0e_a0a0a0;
        quotedNode1_g49o0e_a0a0a0.addReference(SReference.create("classifier", quotedNode1_g49o0e_a0a0a0, SModelReference.fromString("f:java_stub#com.intellij.openapi.actionSystem(com.intellij.openapi.actionSystem@java_stub)"), SNodeId.fromString("~AnAction")));
        result = quotedNode1_g49o0e_a0a0a0;
      }
      return result;
    }
