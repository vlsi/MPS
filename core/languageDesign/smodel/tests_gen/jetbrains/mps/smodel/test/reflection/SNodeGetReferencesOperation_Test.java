...
public class SNodeGetReferencesOperation_Test extends BaseTransformationTest {
  ...
  public static class TestBody extends BaseTestBody {
    public void test_size() throws Exception {
      ...
      Assert.assertTrue(Sequence.<SReference>fromIterable(SNodeOperations.getReferences(SNodeOperations.cast(this.getNodeById("2906110183022219808"), "jetbrains.mps.lang.smodelTests.structure.ReferenceContainer"))).isEmpty());
      Assert.assertEquals(3, Sequence.<SReference>fromIterable(SNodeOperations.getReferences(SNodeOperations.cast(this.getNodeById("2906110183022219844"), "jetbrains.mps.lang.smodelTests.structure.ReferenceContainer"))).count());
    }
    ...
    public void test_linkDeclaration() throws Exception {
      ...
      this.addNodeById("2906110183022354865");
      this.addNodeById("2906110183022432276");
      TestUtilities.assertEquals(Sequence.fromArray(new SNode[]{SLinkOperations.findLinkDeclaration("jetbrains.mps.lang.smodelTests.structure.ReferenceContainer", "root"), SLinkOperations.findLinkDeclaration("jetbrains.mps.lang.smodelTests.structure.ReferenceContainer", "leftChild"), SLinkOperations.findLinkDeclaration("jetbrains.mps.lang.smodelTests.structure.ReferenceContainer", "rightChild")}), Sequence.<SReference>fromIterable(SNodeOperations.getReferences(SNodeOperations.cast(this.getNodeById("2906110183022219844"), "jetbrains.mps.lang.smodelTests.structure.ReferenceContainer"))).<SNode>select(new ISelector<SReference, SNode>() {
        public SNode select(SReference it) {
    ...
    public void test_forSpecializedLink() throws Exception {
      ...
      Assert.assertTrue(Sequence.<SReference>fromIterable(SNodeOperations.getReferences(SNodeOperations.cast(this.getNodeById("2906110183022354866"), "jetbrains.mps.lang.smodelTests.structure.ReferenceContainerSubConcept"))).where(new IWhereFilter<SReference>() {
        public boolean accept(SReference it) {
    ...
    public void test_roles() throws Exception {
      ...
      this.addNodeById("2906110183022354865");
      this.addNodeById("2906110183022432276");
      TestUtilities.assertEquals(Sequence.fromArray(new String[]{SPropertyOperations.getString(SLinkOperations.findLinkDeclaration("jetbrains.mps.lang.smodelTests.structure.ReferenceContainer", "root"), "role"), SPropertyOperations.getString(SLinkOperations.findLinkDeclaration("jetbrains.mps.lang.smodelTests.structure.ReferenceContainer", "leftChild"), "role"), SPropertyOperations.getString(SLinkOperations.findLinkDeclaration("jetbrains.mps.lang.smodelTests.structure.ReferenceContainer", "rightChild"), "role")}), Sequence.<SReference>fromIterable(SNodeOperations.getReferences(SNodeOperations.cast(this.getNodeById("2906110183022219844"), "jetbrains.mps.lang.smodelTests.structure.ReferenceContainer"))).<String>select(new ISelector<SReference, String>() {
    ...
    public void test_resolveInfo() throws Exception {
      ...
      Sequence.<SReference>fromIterable(SNodeOperations.getReferences(SNodeOperations.cast(this.getNodeById("2906110183022219844"), "jetbrains.mps.lang.smodelTests.structure.ReferenceContainer"))).visitAll(new IVisitor<SReference>() {
        public void visit(SReference it) {
          SLinkOperations.getTargetNode(it);
        }
      });
      Sequence.<SReference>fromIterable(SNodeOperations.getReferences(SNodeOperations.cast(this.getNodeById("2906110183022219844"), "jetbrains.mps.lang.smodelTests.structure.ReferenceContainer"))).<String>select(new ISelector<SReference, String>() {
        public String select(SReference it) {
    ...
    public void test_unspecifiedReferences() throws Exception {
      ...
      int initialSize = Sequence.<SReference>fromIterable(SNodeOperations.getReferences(SNodeOperations.cast(this.getNodeById("2906110183022432277"), "jetbrains.mps.lang.smodelTests.structure.ReferenceContainer"))).count();
      ...
      Assert.assertEquals(initialSize + 1, Sequence.<SReference>fromIterable(SNodeOperations.getReferences(SNodeOperations.cast(this.getNodeById("2906110183022432277"), "jetbrains.mps.lang.smodelTests.structure.ReferenceContainer"))).count());
      // Checking if unspecified reference is working properly 
      Iterable<SReference> unspecifiedReferences = Sequence.<SReference>fromIterable(SNodeOperations.getReferences(SNodeOperations.cast(this.getNodeById("2906110183022432277"), "jetbrains.mps.lang.smodelTests.structure.ReferenceContainer"))).where(new IWhereFilter<SReference>() {
        public boolean accept(SReference it) {
          return (SLinkOperations.findLinkDeclaration(it) == null);
        }
      });
      Assert.assertEquals(1, Sequence.<SReference>fromIterable(unspecifiedReferences).count());
      SReference theReference = Sequence.<SReference>fromIterable(unspecifiedReferences).first();
    ...
    public void test_unresolvedReference() throws Exception {
      ...
      this.addNodeById("2906110183022432276");
      int initialSize = Sequence.<SReference>fromIterable(SNodeOperations.getReferences(SNodeOperations.cast(this.getNodeById("2906110183022432277"), "jetbrains.mps.lang.smodelTests.structure.ReferenceContainer"))).count();
      Assert.assertTrue(Sequence.<SReference>fromIterable(SNodeOperations.getReferences(SNodeOperations.cast(this.getNodeById("2906110183022432277"), "jetbrains.mps.lang.smodelTests.structure.ReferenceContainer"))).where(new IWhereFilter<SReference>() {
        public boolean accept(SReference it) {
      ...
      Assert.assertEquals(initialSize, Sequence.<SReference>fromIterable(SNodeOperations.getReferences(SNodeOperations.cast(this.getNodeById("2906110183022432277"), "jetbrains.mps.lang.smodelTests.structure.ReferenceContainer"))).count());
      Iterable<SReference> brokenReferences = Sequence.<SReference>fromIterable(SNodeOperations.getReferences(SNodeOperations.cast(this.getNodeById("2906110183022432277"), "jetbrains.mps.lang.smodelTests.structure.ReferenceContainer"))).where(new IWhereFilter<SReference>() {
        public boolean accept(SReference it) {
          return it.getTargetNodeSilently() == null;
        }
      });
      Assert.assertEquals(1, Sequence.<SReference>fromIterable(brokenReferences).count());
      SReference theReference = Sequence.<SReference>fromIterable(brokenReferences).first();
    ...
    public void test_forNull() throws Exception {
      ...
      this.addNodeById("2906110183022432276");
      SNode nullNode = null;
      Assert.assertTrue(Sequence.<SReference>fromIterable(SNodeOperations.getReferences(nullNode)).isEmpty());
