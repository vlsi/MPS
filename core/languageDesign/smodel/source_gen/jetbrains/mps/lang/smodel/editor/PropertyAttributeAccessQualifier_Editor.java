...
public class PropertyAttributeAccessQualifier_Editor extends DefaultNodeEditor {
  ...
  public EditorCell createCollection_0883_0(EditorContext context, SNode node) {
    ...
    editorCell.addEditorCell(this.createConstant_0883_0(context, node, "<"));
    editorCell.addEditorCell(this.createRefNode_0883_1(context, node));
  ...
  public EditorCell createRefNode_0883_0_internal(EditorContext context, SNode node, CellProviderWithRole aProvider) {
    CellProviderWithRole provider = aProvider;
    provider.setAuxiliaryCellProvider(null);
    EditorCell editorCell = provider.createEditorCell(context);
    setupBasic_RefNode_0883_0(editorCell, node, context);
    if (editorCell instanceof EditorCell_Label) {
      setupLabel_RefNode_0883_0((EditorCell_Label)editorCell, node, context);
    }
    editorCell.setSubstituteInfo(provider.createDefaultSubstituteInfo());
    return editorCell;
  }

  public EditorCell createRefNode_0883_1(EditorContext context, SNode node) {
    CellProviderWithRole provider = new RefNodeCellProvider(node, context);
    provider.setRole("propertyQualifier");
    provider.setNoTargetText("<property>");
    provider.setReadOnly(false);
    provider.setAllowsEmptyTarget(false);
    EditorCell cellWithRole = this.createRefNode_0883_0_internal(context, node, provider);
    SNode attributeConcept = provider.getRoleAttribute();
    Class attributeKind = provider.getRoleAttributeClass();
    if (attributeConcept != null) {
      IOperationContext opContext = context.getOperationContext();
  ...
  private static void setupBasic_RefNode_0883_0(EditorCell editorCell, SNode node, EditorContext context) {
  }
  ...
  private static void setupLabel_RefNode_0883_0(EditorCell_Label editorCell, SNode node, EditorContext context) {
  }
