...
public class typeof_Property_HasValue_Simple_InferenceRule extends AbstractInferenceRule_Runtime implements InferenceRule_Runtime {
  ...
  public static class QuotationClass_2716_0 {
    public QuotationClass_2716_0() {
    }

    public SNode createNode(final TypeCheckingContext typeCheckingContext) {
      SNode result = null;
      Set<SNode> _parameterValues_129834374 = new HashSet<SNode>();
      SNode quotedNode_2716_0 = null;
      {
        quotedNode_2716_0 = SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.baseLanguage.structure.BooleanType", TypeChecker.getInstance().getRuntimeTypesModel(), GlobalScope.getInstance(), false);
        SNode quotedNode1_2716_0 = quotedNode_2716_0;
        result = quotedNode1_2716_0;
      }
      return result;
    }
  ...
  public static class QuotationClass_2716_1 {
    public QuotationClass_2716_1() {
    }

    public SNode createNode(final TypeCheckingContext typeCheckingContext) {
      SNode result = null;
      Set<SNode> _parameterValues_129834374 = new HashSet<SNode>();
      SNode quotedNode_2716_1 = null;
      {
        quotedNode_2716_1 = SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.baseLanguage.structure.StringType", TypeChecker.getInstance().getRuntimeTypesModel(), GlobalScope.getInstance(), false);
        SNode quotedNode1_2716_1 = quotedNode_2716_1;
        result = quotedNode1_2716_1;
      }
      return result;
    }
  ...
  public static class QuotationClass_2716_2 {
    public QuotationClass_2716_2() {
    }

    public SNode createNode(final TypeCheckingContext typeCheckingContext) {
      SNode result = null;
      Set<SNode> _parameterValues_129834374 = new HashSet<SNode>();
      SNode quotedNode_2716_2 = null;
      {
        quotedNode_2716_2 = SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.baseLanguage.structure.IntegerType", TypeChecker.getInstance().getRuntimeTypesModel(), GlobalScope.getInstance(), false);
        SNode quotedNode1_2716_2 = quotedNode_2716_2;
        result = quotedNode1_2716_2;
      }
      return result;
    }
  ...
  public static class QuotationClass_2716_3 {
    public QuotationClass_2716_3() {
    }

    public SNode createNode(final TypeCheckingContext typeCheckingContext) {
      SNode result = null;
      Set<SNode> _parameterValues_129834374 = new HashSet<SNode>();
      SNode quotedNode_2716_3 = null;
      {
        quotedNode_2716_3 = SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.baseLanguage.structure.BooleanType", TypeChecker.getInstance().getRuntimeTypesModel(), GlobalScope.getInstance(), false);
        SNode quotedNode1_2716_3 = quotedNode_2716_3;
        result = quotedNode1_2716_3;
      }
      return result;
    }
