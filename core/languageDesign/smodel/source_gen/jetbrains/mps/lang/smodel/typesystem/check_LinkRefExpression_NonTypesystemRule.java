...
public class check_LinkRefExpression_NonTypesystemRule extends AbstractNonTypesystemRule_Runtime implements NonTypesystemRule_Runtime {
  ...
  public void applyRule(final SNode expr, final TypeCheckingContext typeCheckingContext) {
    ...
    if (!(ListSequence.fromList(declaredLinks).contains(link))) {
      ...
      typeCheckingContext.reportTypeError(expr, "link '" + SPropertyOperations.getString(link, "role") + "' is not expected here", "r:00000000-0000-4000-0000-011c895902fe(jetbrains.mps.lang.smodel.typesystem)", "1226360207686", intentionProvider, errorTarget);
    }
  }
