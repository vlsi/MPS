...
public class typeOf_Node_GetAncestorOperation_InferenceRule extends AbstractInferenceRule_Runtime implements InferenceRule_Runtime {
  ...
  public void applyRule(final SNode op, final TypeCheckingContext typeCheckingContext) {
    ...
    RulesUtil.equate_conceptFromOpParm(typeCheckingContext, op, typeCheckingContext.getEquationManager().getRepresentator(ConceptFromOpParm_typevar_1207354629107));
    {
      ...
      typeCheckingContext.createEquation((SNode) typeCheckingContext.typeOf(_nodeToCheck_1029348928467, "r:00000000-0000-4000-0000-011c895902fe(jetbrains.mps.lang.smodel.typesystem)", "1207354639036", true), (SNode) new typeOf_Node_GetAncestorOperation_InferenceRule.QuotationClass_acw35t_a0a2a0().createNode(typeCheckingContext.getEquationManager().getRepresentator(ConceptFromOpParm_typevar_1207354629107), typeCheckingContext), _info_12389875345);
    }
  }
  ...
  public static class QuotationClass_acw35t_a0a2a0 {
    ...
    public SNode createNode(Object parameter_acw35t_a0a0a2a0, final TypeCheckingContext typeCheckingContext) {
      SNode result = null;
      Set<SNode> _parameterValues_129834374 = new HashSet<SNode>();
      SNode quotedNode_acw35t_a0a2a0 = null;
      {
        quotedNode_acw35t_a0a2a0 = SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.lang.smodel.structure.SNodeType", TypeChecker.getInstance().getRuntimeTypesModel(), GlobalScope.getInstance(), false);
        SNode quotedNode1_acw35t_a0a2a0 = quotedNode_acw35t_a0a2a0;
        quotedNode1_acw35t_a0a2a0.setReferent("concept", (SNode) parameter_acw35t_a0a0a2a0);
        result = quotedNode1_acw35t_a0a2a0;
      }
      return result;
    }

    public SNode createNode(Object parameter_acw35t_a0a0a2a0) {
      SNode result = null;
      Set<SNode> _parameterValues_129834374 = new HashSet<SNode>();
      SNode quotedNode_acw35t_a0a2a0 = null;
      {
