...
public class Concept_IsSubConceptOfOperation_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createConstant_0805_0(EditorContext editorContext, SNode node, String text) {
  ...
  private EditorCell createConstant_0805_1(EditorContext editorContext, SNode node, String text) {
    EditorCell_Constant editorCell = new EditorCell_Constant(editorContext, node, text);
