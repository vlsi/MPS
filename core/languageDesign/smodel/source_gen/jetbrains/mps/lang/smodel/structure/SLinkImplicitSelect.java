...
public class SLinkImplicitSelect extends BaseConcept implements IOperation {
  ...
  public int get_$attributesCount() {
    return this.getChildCount(SLinkImplicitSelect._$ATTRIBUTE);
  }

  public Iterator<Attribute> _$attributes() {
    return this.children(Attribute.class, SLinkImplicitSelect._$ATTRIBUTE);
  }

  public List<Attribute> get_$attributes() {
    return this.getChildren(Attribute.class, SLinkImplicitSelect._$ATTRIBUTE);
  }

  public void add_$attribute(Attribute node) {
    this.addChild(SLinkImplicitSelect._$ATTRIBUTE, node);
  }

  public void insert_$attribute(Attribute prev, Attribute node) {
    this.insertChild(prev, SLinkImplicitSelect._$ATTRIBUTE, node);
  }
