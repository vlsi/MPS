...
public class supertypesOf_SModelType_ClassifierTypeSModel_SubtypingRule extends SubtypingRule_Runtime implements ISubtypingRule_Runtime {
  ...
  public static class QuotationClass_iznehh_a0a0a {
    ...
    public SNode createNode(final TypeCheckingContext typeCheckingContext) {
      ...
      SNode quotedNode_iznehh_a0a0a = null;
      {
        quotedNode_iznehh_a0a0a = SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.baseLanguage.structure.ClassifierType", TypeChecker.getInstance().getRuntimeTypesModel(), GlobalScope.getInstance(), false);
        SNode quotedNode1_iznehh_a0a0a = quotedNode_iznehh_a0a0a;
        quotedNode1_iznehh_a0a0a.addReference(SReference.create("classifier", quotedNode1_iznehh_a0a0a, SModelReference.fromString("f:java_stub#jetbrains.mps.smodel(jetbrains.mps.smodel@java_stub)"), SNodeId.fromString("~SModel")));
        result = quotedNode1_iznehh_a0a0a;
      }
      return result;
    }
