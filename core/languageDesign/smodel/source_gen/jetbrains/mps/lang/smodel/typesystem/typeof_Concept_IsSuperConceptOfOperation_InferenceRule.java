...
public class typeof_Concept_IsSuperConceptOfOperation_InferenceRule extends AbstractInferenceRule_Runtime implements InferenceRule_Runtime {
  ...
  public static class QuotationClass_goto9h_a0a1a1a0 {
    ...
    public SNode createNode(final TypeCheckingContext typeCheckingContext) {
      ...
      SNode quotedNode_goto9h_a0a1a1a0 = null;
      {
        quotedNode_goto9h_a0a1a1a0 = SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.lang.smodel.structure.SConceptType", TypeChecker.getInstance().getRuntimeTypesModel(), GlobalScope.getInstance(), false);
        SNode quotedNode1_goto9h_a0a1a1a0 = quotedNode_goto9h_a0a1a1a0;
        result = quotedNode1_goto9h_a0a1a1a0;
      }
      return result;
    }
