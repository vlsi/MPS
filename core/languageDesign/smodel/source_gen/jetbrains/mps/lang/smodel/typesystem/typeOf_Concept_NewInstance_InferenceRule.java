    ...
    if (SLinkOperations.getTarget(node, "prototypeNode", true) != null) {
      {
        ...
        typeCheckingContext.createLessThanInequation(typeCheckingContext.typeOf(SLinkOperations.getTarget(node, "prototypeNode", true), "r:00000000-0000-4000-0000-011c895902fe(jetbrains.mps.lang.smodel.typesystem)", "1186061176339", true), new _Quotations.QuotationClass_71().createNode(typeCheckingContext), _nodeToCheck_1029348928467, null, "r:00000000-0000-4000-0000-011c895902fe(jetbrains.mps.lang.smodel.typesystem)", "1181950211367", false, 0, intentionProvider);
      }
    }
            ...
            if (coercedNode_0 != null) {
              {
                SNode _nodeToCheck_1029348928467 = node;
                BaseIntentionProvider intentionProvider = null;
                typeCheckingContext.createEquation(typeCheckingContext.typeOf(node, "r:00000000-0000-4000-0000-011c895902fe(jetbrains.mps.lang.smodel.typesystem)", "1207688101919", true), new _Quotations.QuotationClass_72().createNode(SLinkOperations.getTarget(coercedNode_0, "conceptDeclaraton", false), typeCheckingContext), _nodeToCheck_1029348928467, null, "r:00000000-0000-4000-0000-011c895902fe(jetbrains.mps.lang.smodel.typesystem)", "1207688101917", intentionProvider);
              }
            }
          }
        }
