...
public class LinkList_InsertChildFirstOperation extends jetbrains.mps.lang.smodel.structure.SNodeOperation {
  ...
  public jetbrains.mps.baseLanguage.structure.Expression getChildNode() {
    return (jetbrains.mps.baseLanguage.structure.Expression)this.getChild(Expression.class, LinkList_InsertChildFirstOperation.CHILD_NODE);
  }
