...
public class LinkList_AddChildOperation_Editor extends DefaultNodeEditor {
  ...
  public EditorCell createComponent_8105_0(EditorContext context, SNode node) {
    if (this.myReplaceableAlias_Comp8105_0 == null) {
      this.myReplaceableAlias_Comp8105_0 = new jetbrains.mps.lang.smodel.editor.ReplaceableAlias_Comp(node);
    }
  ...
  public EditorCell createConstant_8105_0(EditorContext context, SNode node, String text) {
    ...
    setupLabel_Constant_8105_0(editorCell, node, context);
  ...
  public EditorCell createConstant_8105_1(EditorContext context, SNode node, String text) {
    ...
    setupLabel_Constant_8105_1(editorCell, node, context);
    editorCell.setDefaultText("");
    return editorCell;
  }
  ...
  public EditorCell createRefNode_8105_0_internal(EditorContext context, SNode node, CellProviderWithRole aProvider) {
    ...
    if (editorCell instanceof EditorCell_Label) {
      setupLabel_RefNode_8105_0((EditorCell_Label)editorCell, node, context);
    }
  ...
  private static void setupLabel_RefNode_8105_0(EditorCell_Label editorCell, SNode node, EditorContext context) {
  }

  private static void setupLabel_Constant_8105_0(EditorCell_Label editorCell, SNode node, EditorContext context) {
  }

  private static void setupLabel_Constant_8105_1(EditorCell_Label editorCell, SNode node, EditorContext context) {
  }
