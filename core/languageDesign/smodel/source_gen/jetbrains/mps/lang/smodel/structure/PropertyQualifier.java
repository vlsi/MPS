...
public class PropertyQualifier extends BaseConcept implements IPropertyQualifier {
  ...
  public int get_$attributesCount() {
    return this.getChildCount(PropertyQualifier._$ATTRIBUTE);
  }

  public Iterator<Attribute> _$attributes() {
    return this.children(Attribute.class, PropertyQualifier._$ATTRIBUTE);
  }

  public List<Attribute> get_$attributes() {
    return this.getChildren(Attribute.class, PropertyQualifier._$ATTRIBUTE);
  }

  public void add_$attribute(Attribute node) {
    this.addChild(PropertyQualifier._$ATTRIBUTE, node);
  }

  public void insert_$attribute(Attribute prev, Attribute node) {
    this.insertChild(prev, PropertyQualifier._$ATTRIBUTE, node);
  }
