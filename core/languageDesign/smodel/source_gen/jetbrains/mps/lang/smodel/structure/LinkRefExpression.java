...
public class LinkRefExpression extends jetbrains.mps.baseLanguage.structure.Expression {
  ...
  public jetbrains.mps.lang.structure.structure.AbstractConceptDeclaration getConceptDeclaration() {
    return (jetbrains.mps.lang.structure.structure.AbstractConceptDeclaration)this.getReferent(AbstractConceptDeclaration.class, LinkRefExpression.CONCEPT_DECLARATION);
  }
  ...
  public jetbrains.mps.lang.structure.structure.LinkDeclaration getLinkDeclaration() {
    return (jetbrains.mps.lang.structure.structure.LinkDeclaration)this.getReferent(LinkDeclaration.class, LinkRefExpression.LINK_DECLARATION);
  }
