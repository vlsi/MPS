...
public class Node_GetContainingLinkOperation_Editor extends DefaultNodeEditor {
  public EditorCell createEditorCell(EditorContext editorContext, SNode node) {
    return this.createComponent_1142_0(editorContext, node);
  }
  ...
  private EditorCell createCollection_1142_0(EditorContext editorContext, SNode node) {
    ...
    editorCell.addEditorCell(this.createConstant_1142_2(editorContext, node));
    return editorCell;
  }

  private EditorCell createComponent_1142_0(EditorContext editorContext, SNode node) {
  ...
  private EditorCell createConstant_1142_2(EditorContext editorContext, SNode node) {
    ...
    editorCell.setCellId("Constant_1142_2");
    {
      Style style = editorCell.getStyle();
