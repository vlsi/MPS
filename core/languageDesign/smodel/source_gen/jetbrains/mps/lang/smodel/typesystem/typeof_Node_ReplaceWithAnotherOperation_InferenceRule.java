...
public class typeof_Node_ReplaceWithAnotherOperation_InferenceRule extends AbstractInferenceRule_Runtime implements InferenceRule_Runtime {
  ...
  public static class QuotationClass_wjy3ci_a0a0a0 {
    ...
    public SNode createNode(final TypeCheckingContext typeCheckingContext) {
      ...
      SNode quotedNode_wjy3ci_a0a0a0 = null;
      {
        quotedNode_wjy3ci_a0a0a0 = SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.lang.smodel.structure.SNodeType", TypeChecker.getInstance().getRuntimeTypesModel(), GlobalScope.getInstance(), false);
        SNode quotedNode1_wjy3ci_a0a0a0 = quotedNode_wjy3ci_a0a0a0;
        result = quotedNode1_wjy3ci_a0a0a0;
      }
      return result;
    }
