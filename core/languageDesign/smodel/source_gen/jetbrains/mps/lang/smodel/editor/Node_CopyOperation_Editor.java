...
public class Node_CopyOperation_Editor extends DefaultNodeEditor {
  public EditorCell createEditorCell(EditorContext editorContext, SNode node) {
    return this.createConstant_6119_elm376av(editorContext, node);
  }

  private EditorCell createConstant_6119_elm376av(EditorContext editorContext, SNode node) {
    EditorCell_Constant editorCell = new EditorCell_Constant(editorContext, node, "copy");
    editorCell.setCellId("Constant_6119_elm376av");
    {
