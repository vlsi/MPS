...
public class typeOf_Node_CopyOperation_InferenceRule extends AbstractInferenceRule_Runtime implements InferenceRule_Runtime {
  ...
  public static class QuotationClass_72s9fw_a0a2a0 {
    ...
    public SNode createNode(Object parameter_72s9fw_a0a0a2a0, final TypeCheckingContext typeCheckingContext) {
      SNode result = null;
      Set<SNode> _parameterValues_129834374 = new HashSet<SNode>();
      SNode quotedNode_72s9fw_a0a2a0 = null;
      {
        quotedNode_72s9fw_a0a2a0 = SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.lang.smodel.structure.SNodeType", TypeChecker.getInstance().getRuntimeTypesModel(), GlobalScope.getInstance(), false);
        SNode quotedNode1_72s9fw_a0a2a0 = quotedNode_72s9fw_a0a2a0;
        quotedNode1_72s9fw_a0a2a0.setReferent("concept", (SNode) parameter_72s9fw_a0a0a2a0);
        result = quotedNode1_72s9fw_a0a2a0;
      }
      return result;
    }

    public SNode createNode(Object parameter_72s9fw_a0a0a2a0) {
      SNode result = null;
      Set<SNode> _parameterValues_129834374 = new HashSet<SNode>();
      SNode quotedNode_72s9fw_a0a2a0 = null;
      {
