...
public class SNodeCreator_Editor extends DefaultNodeEditor {
  ...
  public EditorCell createCollection_6629_0(EditorContext context, SNode node) {
    ...
    editorCell.addEditorCell(this.createCollection_6629_1(context, node));
    return editorCell;
  }

  public EditorCell createCollection_6629_1(EditorContext context, SNode node) {
    EditorCell_Collection editorCell = EditorCell_Collection.createHorizontal(context, node);
    setupBasic_Collection_6629_1(editorCell, node, context);
    editorCell.setGridLayout(false);
    editorCell.setUsesBraces(false);
    editorCell.setCanBeFolded(false);
  ...
  public EditorCell createConstant_6629_0(EditorContext context, SNode node, String text) {
    ...
    setupLabel_Constant_6629_0(editorCell, node, context);
  ...
  public EditorCell createConstant_6629_1(EditorContext context, SNode node, String text) {
    ...
    setupLabel_Constant_6629_1(editorCell, node, context);
    editorCell.setDefaultText("");
    return editorCell;
  }

  public EditorCell createRefNode_6629_0_internal(EditorContext context, SNode node, CellProviderWithRole aProvider) {
    CellProviderWithRole provider = aProvider;
    provider.setAuxiliaryCellProvider(null);
    EditorCell editorCell = provider.createEditorCell(context);
    setupBasic_RefNode_6629_0(editorCell, node, context);
    if (editorCell instanceof EditorCell_Label) {
      setupLabel_RefNode_6629_0((EditorCell_Label)editorCell, node, context);
    }
  ...
  public EditorCell createRefNode_6629_2_internal(EditorContext context, SNode node, CellProviderWithRole aProvider) {
    CellProviderWithRole provider = aProvider;
    provider.setAuxiliaryCellProvider(null);
    EditorCell editorCell = provider.createEditorCell(context);
    setupBasic_RefNode_6629_1(editorCell, node, context);
    if (editorCell instanceof EditorCell_Label) {
      setupLabel_RefNode_6629_1((EditorCell_Label)editorCell, node, context);
    }
    editorCell.setSubstituteInfo(provider.createDefaultSubstituteInfo());
    return editorCell;
  }
  ...
  private static void setupBasic_Collection_6629_1(EditorCell editorCell, SNode node, EditorContext context) {
    editorCell.setCellId("Collection_6629_1");
    {
  ...
  private static void setupLabel_RefNode_6629_0(EditorCell_Label editorCell, SNode node, EditorContext context) {
  }

  private static void setupLabel_Constant_6629_0(EditorCell_Label editorCell, SNode node, EditorContext context) {
  }

  private static void setupLabel_RefNode_6629_1(EditorCell_Label editorCell, SNode node, EditorContext context) {
  }

  private static void setupLabel_Constant_6629_1(EditorCell_Label editorCell, SNode node, EditorContext context) {
  }
