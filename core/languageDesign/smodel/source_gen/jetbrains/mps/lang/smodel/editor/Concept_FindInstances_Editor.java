...
public class Concept_FindInstances_Editor extends DefaultNodeEditor {
  ...
  private AbstractCellProvider myReplaceableAlias_Comp9854_0;
  ...
  private EditorCell createCollection_9854_0(EditorContext context, SNode node) {
    ...
    editorCell.addEditorCell(this.createRefNode_9854_0(context, node));
    editorCell.addEditorCell(this.createConstant_9854_1(context, node, ")"));
    return editorCell;
  }

  private EditorCell createComponent_9854_0(EditorContext context, SNode node) {
  ...
  private EditorCell createRefNode_9854_0(EditorContext context, SNode node) {
