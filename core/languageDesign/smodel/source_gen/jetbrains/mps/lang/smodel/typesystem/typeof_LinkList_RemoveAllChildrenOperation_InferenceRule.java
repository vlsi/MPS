...
public class typeof_LinkList_RemoveAllChildrenOperation_InferenceRule extends AbstractInferenceRule_Runtime implements InferenceRule_Runtime {
  ...
  public static class QuotationClass_kyb4al_a0a2a0 {
    public QuotationClass_kyb4al_a0a2a0() {
    }

    public SNode createNode(Object parameter_kyb4al_a0a0a2a0, final TypeCheckingContext typeCheckingContext) {
      SNode result = null;
      Set<SNode> _parameterValues_129834374 = new HashSet<SNode>();
      SNode quotedNode_kyb4al_a0a2a0 = null;
      {
        quotedNode_kyb4al_a0a2a0 = SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.lang.smodel.structure.SNodeListType", TypeChecker.getInstance().getRuntimeTypesModel(), GlobalScope.getInstance(), false);
        SNode quotedNode1_kyb4al_a0a2a0 = quotedNode_kyb4al_a0a2a0;
        quotedNode1_kyb4al_a0a2a0.setReferent("elementConcept", (SNode) parameter_kyb4al_a0a0a2a0);
        result = quotedNode1_kyb4al_a0a2a0;
      }
      return result;
    }

    public SNode createNode(Object parameter_kyb4al_a0a0a2a0) {
      SNode result = null;
      Set<SNode> _parameterValues_129834374 = new HashSet<SNode>();
      SNode quotedNode_kyb4al_a0a2a0 = null;
      {
