...
public class LinkRefQualifier_Editor extends DefaultNodeEditor {
  ...
  public EditorCell createCollection_1307_0(EditorContext context, SNode node) {
    ...
    setupBasic_Collection_1307_0(editorCell, node, context);
    editorCell.addEditorCell(this.createRefCell_1307_1(context, node));
    return editorCell;
  }

  public EditorCell createRefCell_1307_0_internal(EditorContext context, SNode node, CellProviderWithRole provider) {
  ...
  private static void setupBasic_Collection_1307_0(EditorCell editorCell, SNode node, EditorContext context) {
  ...
  public static class _Inline1307_0 extends AbstractCellProvider {
    ...
    public EditorCell createProperty_1307_0_internal(EditorContext context, SNode node, CellProviderWithRole provider) {
      EditorCell editorCell = provider.createEditorCell(context);
