...
public class LinkList_AddAllOperation_Editor extends DefaultNodeEditor {
  ...
  private AbstractCellProvider myReplaceableAlias_Comp2492_0;

  public EditorCell createEditorCell(EditorContext context, SNode node) {
    return this.createCollection_2492_0(context, node);
  }

  private EditorCell createCollection_2492_0(EditorContext context, SNode node) {
    ...
    editorCell.addEditorCell(this.createRefNode_2492_0(context, node));
    editorCell.addEditorCell(this.createConstant_2492_1(context, node, ")"));
    return editorCell;
  }

  private EditorCell createComponent_2492_0(EditorContext context, SNode node) {
  ...
  private EditorCell createConstant_2492_0(EditorContext context, SNode node, String text) {
  ...
  private EditorCell createConstant_2492_1(EditorContext context, SNode node, String text) {
    EditorCell_Constant editorCell = new EditorCell_Constant(context, node, text);
  ...
  private EditorCell createRefNode_2492_0(EditorContext context, SNode node) {
