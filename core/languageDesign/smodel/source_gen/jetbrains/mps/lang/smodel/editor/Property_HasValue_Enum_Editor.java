...
public class Property_HasValue_Enum_Editor extends DefaultNodeEditor {
  ...
  private AbstractCellProvider myReplaceableAlias_Comp0541_0;

  public EditorCell createEditorCell(EditorContext context, SNode node) {
    return this.createCollection_0541_0(context, node);
  }

  private EditorCell createCollection_0541_0(EditorContext context, SNode node) {
    ...
    editorCell.addEditorCell(this.createRefNode_0541_0(context, node));
    editorCell.addEditorCell(this.createConstant_0541_1(context, node, ")"));
    return editorCell;
  }

  private EditorCell createComponent_0541_0(EditorContext context, SNode node) {
  ...
  private EditorCell createConstant_0541_0(EditorContext context, SNode node, String text) {
  ...
  private EditorCell createConstant_0541_1(EditorContext context, SNode node, String text) {
    EditorCell_Constant editorCell = new EditorCell_Constant(context, node, text);
  ...
  private EditorCell createRefNode_0541_0(EditorContext context, SNode node) {
