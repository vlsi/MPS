...
public class typeof_Node_InsertNextSiblingOperation_InferenceRule extends AbstractInferenceRule_Runtime implements InferenceRule_Runtime {
  ...
  public static class QuotationClass_yio9mj_a0a0a1a0 {
    ...
    public SNode createNode(final TypeCheckingContext typeCheckingContext) {
      ...
      SNode quotedNode_yio9mj_a0a0a1a0 = null;
      {
        quotedNode_yio9mj_a0a0a1a0 = SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.lang.smodel.structure.SNodeType", TypeChecker.getInstance().getRuntimeTypesModel(), GlobalScope.getInstance(), false);
        SNode quotedNode1_yio9mj_a0a0a1a0 = quotedNode_yio9mj_a0a0a1a0;
        result = quotedNode1_yio9mj_a0a0a1a0;
      }
      return result;
    }
