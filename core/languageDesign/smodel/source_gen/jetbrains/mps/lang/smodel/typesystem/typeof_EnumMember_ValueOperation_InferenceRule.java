...
public class typeof_EnumMember_ValueOperation_InferenceRule extends AbstractInferenceRule_Runtime implements InferenceRule_Runtime {
  ...
  public void applyRule(final SNode operation, final TypeCheckingContext typeCheckingContext, IsApplicableStatus status) {
    ...
    }
    {
      ...
      typeCheckingContext.createEquation((SNode) typeCheckingContext.getRepresentative(Enum_typevar_1240331870095), new ConceptWrapper("jetbrains.mps.lang.structure.structure.EnumerationDataTypeDeclaration", new ConceptWrapper.LinkTargetInfo(true, "memberDataType", typeCheckingContext.getRepresentative(Member_typevar_1240331876974), -1)), _info_12389875345);
    }
    {
      final SNode memberType = typeCheckingContext.getRepresentative(Member_typevar_1240331876974);
        ...
        public void run() {
          {
            ...
            typeCheckingContext.createEquation((SNode) typeCheckingContext.typeOf(_nodeToCheck_1029348928467, "r:00000000-0000-4000-0000-011c895902fe(jetbrains.mps.lang.smodel.typesystem)", "1240577344539", true), (SNode) DataTypeDeclaration_Behavior.call_toBaseLanguageType_1213877229718(SNodeOperations.cast(typeCheckingContext.getRepresentative(memberType), "jetbrains.mps.lang.structure.structure.PrimitiveDataTypeDeclaration")), _info_12389875345);
          }
        }
