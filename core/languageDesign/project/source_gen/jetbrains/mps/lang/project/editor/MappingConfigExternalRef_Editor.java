...
public class MappingConfigExternalRef_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createCollection_njrz2i_a(EditorContext editorContext, SNode node) {
    ...
    editorCell.addEditorCell(this.createRefNode_njrz2i_b0(editorContext, node));
    editorCell.addEditorCell(this.createConstant_njrz2i_c0(editorContext, node));
    editorCell.addEditorCell(this.createRefNode_njrz2i_d0(editorContext, node));
    return editorCell;
  }

  private EditorCell createConstant_njrz2i_a0(EditorContext editorContext, SNode node) {
    EditorCell_Constant editorCell = new EditorCell_Constant(editorContext, node, "ext");
    editorCell.setCellId("Constant_njrz2i_a0");
    editorCell.setDefaultText("");
    return editorCell;
  }

  private EditorCell createConstant_njrz2i_c0(EditorContext editorContext, SNode node) {
    EditorCell_Constant editorCell = new EditorCell_Constant(editorContext, node, "/");
    editorCell.setCellId("Constant_njrz2i_c0");
    editorCell.setDefaultText("");
    return editorCell;
  }

  private EditorCell createRefNode_njrz2i_b0(EditorContext editorContext, SNode node) {
  ...
  private EditorCell createRefNode_njrz2i_d0(EditorContext editorContext, SNode node) {
    CellProviderWithRole provider = new RefNodeCellProvider(node, editorContext);
