...
import jetbrains.mps.reloading.ReloadSession;
...
public class FSChangesWatcher extends ReloadListenerContainer implements ApplicationComponent {
  ...
  private class BulkFileChangesListener implements BulkFileListener {
    ...
    private void processAfterEvent(final VFileEvent event, final ReloadSession reloadSession) {
      ...
      ModelAccess.instance().runReadAction(new Runnable() {
        public void run() {
          for (IFileProcessor p : reloadSession.getProcessors()) {
