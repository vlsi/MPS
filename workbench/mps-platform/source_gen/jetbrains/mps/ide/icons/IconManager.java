...
public class IconManager {
  ...
  public static Icon getIconFor(@NotNull final SNode node, final boolean withoutAdditional) {
    return ModelAccess.instance().runReadAction(new Computable<Icon>() {
      ...
      public Icon compute() {
        ...
        List<Icon> markIcons = BehaviorReflection.invokeVirtual((Class<List<Icon>>) ((Class) Object.class), node, "virtual_getMarkIcons_3923831204883340393",
            new Object[]{});
        if (markIcons != null) {
  ...
  public static Icon getIconFor(SModel model) {
    ...
    } else if (SModelStereotype.isGeneratorModel(model)) {
      return IdeIcons.TEMPLATES_MODEL_ICON;
    } else if (Language.isLanguageOwnedAccessoryModel(model)) {
      return IdeIcons.ACCESSORY_MODEL_ICON;
    } else if (SModelStereotype.isTestModel(model)) {
      return IdeIcons.TEST_MODEL_ICON;
    }
    return IdeIcons.MODEL_ICON;
  }
