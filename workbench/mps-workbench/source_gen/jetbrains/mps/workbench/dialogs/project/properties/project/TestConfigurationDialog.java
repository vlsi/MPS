...
public class TestConfigurationDialog extends DialogWrapper {
  public static final String MODELS_PROPERTY = "models";
  private static final Logger LOG = LogManager.getLogger(TestConfigurationDialog.class);
  ...
  protected void doOKAction() {
    ...
    if (myRadioModule.isSelected()) {
      ...
      setErrorText("Unknown radiobutton state");
  ...
  private class NamePanel extends JPanel {
    ...
    public void setConfigName(String name) {
      myName.setText(name);
      TestConfigurationDialog.this.setErrorText(null);
    }
