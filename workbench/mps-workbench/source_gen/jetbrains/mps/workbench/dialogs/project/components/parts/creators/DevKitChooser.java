...
public class DevKitChooser implements Computable<List<ModuleReference>> {
  ...
  public List<ModuleReference> compute() {
    ...
    ModelAccess.instance().runReadAction(new Runnable() {
      public void run() {
        Collection<DevKit> devkits = GlobalScope.getInstance().getVisibleDevkits();
        dkRefs.value = ListSequence.fromIterable(devkits).select(new ISelector<DevKit, ModuleReference>() {
