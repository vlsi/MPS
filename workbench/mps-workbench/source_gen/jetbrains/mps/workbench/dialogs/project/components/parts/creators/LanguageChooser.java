...
public class LanguageChooser implements Computable<List<ModuleReference>> {
  ...
  public List<ModuleReference> compute() {
    ...
    ModelAccess.instance().runReadAction(new Runnable() {
      public void run() {
        Collection<Language> langs = GlobalScope.getInstance().getVisibleLanguages();
        langRefs.value = ListSequence.fromIterable(langs).select(new ISelector<Language, ModuleReference>() {
