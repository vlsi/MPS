...
public class StructureAdditions_ActionGroup extends GeneratedActionGroup {
  ...
  public static final String ID = "jetbrains.mps.ide.actions.StructureAdditions_ActionGroup";
  ...
  public StructureAdditions_ActionGroup() {
    ...
    this.setPopup(false);
    try {
      StructureAdditions_ActionGroup.this.addAction("jetbrains.mps.ide.actions.ShowStructure_Action");
    } catch (Throwable t) {
