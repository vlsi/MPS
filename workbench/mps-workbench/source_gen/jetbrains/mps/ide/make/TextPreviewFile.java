...
public class TextPreviewFile extends StubVirtualFile {
  ...
  private static class TextPreviewVirtualFileSystem extends NewVirtualFileSystem {
    ...
    public int getBooleanAttributes(@NotNull VirtualFile file, @FileBooleanAttributes int flags) {
      return ((flags & com.intellij.openapi.util.io.FileUtil.BA_EXISTS) != 0 ? com.intellij.openapi.util.io.FileUtil.BA_EXISTS : 0) |
        ((flags & com.intellij.openapi.util.io.FileUtil.BA_REGULAR) != 0 ? com.intellij.openapi.util.io.FileUtil.BA_REGULAR : 0);
    }
