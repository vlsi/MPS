...
<model ref="r:39c01cc7-82c8-4706-9a38-48a33acb0535(jetbrains.mps.ide.findusages.view.optionseditor)">
  ...
  <imports>
    ...
    <import index="32gr" ref="86441d7a-e194-42da-81a5-2161ec62a379/java:jetbrains.mps.ide.findusages.view.optionseditor.options()" />
    <import index="v27p" ref="498d89d2-c2e9-11e2-ad49-6cf049e62fe5/java:com.intellij.openapi.startup()" />
    <import index="rhcb" ref="86441d7a-e194-42da-81a5-2161ec62a379/java:jetbrains.mps.ide.findusages.view.optionseditor()" />
    <import index="drpk" ref="86441d7a-e194-42da-81a5-2161ec62a379/java:jetbrains.mps.ide.make()" />
  ...
  <node concept="312cEu" id="1AxNPWQ_V_">
    ...
    <node concept="3clFb_" id="1AxNPWQ_Z6" role="jymVt">
      ...
      <node concept="3clFbS" id="1AxNPWQ_Zd" role="3clF47">
        ...
        <node concept="3clFbJ" id="2wcL5yQh1AZ" role="3cqZAp">
          <node concept="3clFbS" id="2wcL5yQh1B1" role="3clFbx">
            <node concept="3clFbF" id="2wcL5yQh3u6" role="3cqZAp">
              <node concept="37vLTI" id="2wcL5yQh3$4" role="3clFbG">
                <node concept="1rXfSq" id="2wcL5yQh3Ef" role="37vLTx">
                  <ref role="37wK5l" node="1AxNPWQ_X8" resolve="createDefaultSearchOptions" />
                </node>
                <node concept="37vLTw" id="2wcL5yQh3u4" role="37vLTJ">
                  <ref role="3cqZAo" node="1AxNPWQ_VK" resolve="myDefaultOptions" />
                </node>
              </node>
            </node>
          </node>
          <node concept="22lmx$" id="2wcL5yQh2Zu" role="3clFbw">
            <node concept="3clFbC" id="2wcL5yQh2EG" role="3uHU7B">
              <node concept="2OqwBi" id="2wcL5yQh2bC" role="3uHU7B">
                <node concept="37vLTw" id="2wcL5yQh1Vd" role="2Oq$k0">
                  <ref role="3cqZAo" node="1AxNPWQ_VK" resolve="myDefaultOptions" />
                </node>
                <node concept="liA8E" id="2wcL5yQh2s9" role="2OqNvi">
                  <ref role="37wK5l" to="rhcb:~FindUsagesOptions.getOption(java.lang.Class):java.lang.Object" resolve="getOption" />
                  <node concept="3VsKOn" id="2wcL5yQh2$d" role="37wK5m">
                    <ref role="3VsUkX" to="32gr:~ScopeOptions" resolve="ScopeOptions" />
                  </node>
                </node>
              </node>
              <node concept="10Nm6u" id="2wcL5yQh2S5" role="3uHU7w" />
            </node>
            <node concept="3clFbC" id="2wcL5yQh3gQ" role="3uHU7w">
              <node concept="2OqwBi" id="2wcL5yQh3gR" role="3uHU7B">
                <node concept="37vLTw" id="2wcL5yQh3gS" role="2Oq$k0">
                  <ref role="3cqZAo" node="1AxNPWQ_VK" resolve="myDefaultOptions" />
                </node>
                <node concept="liA8E" id="2wcL5yQh3gT" role="2OqNvi">
                  <ref role="37wK5l" to="rhcb:~FindUsagesOptions.getOption(java.lang.Class):java.lang.Object" resolve="getOption" />
                  <node concept="3VsKOn" id="2wcL5yQh3gU" role="37wK5m">
                    <ref role="3VsUkX" to="32gr:~ViewOptions" resolve="ViewOptions" />
                  </node>
                </node>
              </node>
              <node concept="10Nm6u" id="2wcL5yQh3gV" role="3uHU7w" />
            </node>
          </node>
        </node>
      </node>
