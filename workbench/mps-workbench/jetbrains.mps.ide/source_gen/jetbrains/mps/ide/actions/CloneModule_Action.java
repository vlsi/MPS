...
public class CloneModule_Action extends BaseAction {
  ...
  private static Map<ModelRoot, String> collectCloneErrorMessages(Iterable<ModelRoot> modelRoots) {
  ...
  public void doExecute(@NotNull final AnActionEvent event, final Map<String, Object> _params) {
    Map<ModelRoot, String> nonCloneable = collectCloneErrorMessages(event.getData(MPSCommonDataKeys.MODULE).getModelRoots());
    ...
    // TODO: RADIMIR Sync ProjectPane.rebuildTree() with NewLanguage, NewSolution actions
