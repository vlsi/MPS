        ...
        for (SModel smodel : Sequence.fromIterable(seq)) {
          ...
          try {
            ...
            if (sourceRoots.isEmpty()) {
              throw new RuntimeException(new NoSourceRootsInModelRootException((FileBasedModelRoot) modelRoot));
            }
            SourceRoot defaultSourceRoot = sourceRoots.get(0);
            DataSource folderDataSource = new DataSourceFactoryBridge((FileBasedModelRoot) modelRoot)
                                              .createPerRootDataSource(defaultSourceRoot, newModel.getName())
                                              .getDataSource();
          ...
          } catch (IOException | ModelSaveException | NoSourceRootsInModelRootException | DataSourceFactoryNotFoundException | SourceRootDoesNotExistException ex) {
            if (LOG.isEnabledFor(Level.ERROR)) {
