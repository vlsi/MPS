...
import jetbrains.mps.persistence.ModelCreationOptions;
      ...
      public void run() {
        ...
        for (SModel smodel : Sequence.fromIterable(seq)) {
          ...
          try {
            ...
            DataSource newSource = new DataSourceFactory((FileBasedModelRoot) modelRoot)
                                       .createFolderDataSource(filePerRootFactory, defaultSourceRoot, newModel.getName().getValue())
                                       .getDataSource();
