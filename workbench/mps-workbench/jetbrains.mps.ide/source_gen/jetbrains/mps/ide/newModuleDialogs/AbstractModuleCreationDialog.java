...
public abstract class AbstractModuleCreationDialog<R extends AbstractModule> extends DialogWrapper {
  ...
  protected String getProjectPath() {
    // looks like magic 
    return (myProject != null ? ((!(ProjectKt.isDirectoryBased(ProjectHelper.toIdeaProject(myProject))) ? myProject.getProjectFile().getParentFile().getAbsolutePath() : myProject.getProjectFile().getAbsolutePath())) : null);
  }
