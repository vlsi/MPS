      ...
      if (ClassLikeMenuAdjustment_CustomApplicationPlugin.this.myClassLikeConcepts == null) {
        ...
        Iterable<SAbstractConcept> nonTrivialClassLikes = CollectionSequence.fromCollection(languages).translate(new ITranslator2<Language, SModel>() {
          ...
          public Iterable<SNode> translate(SModel it) {
            return SModelOperations.roots(((SModel) it), MetaAdapterFactory.getConcept(0xc7d5b9dda05f4be2L, 0xbc73f2e16994cc67L, 0x340eb2bd2e03d160L, "jetbrains.mps.baseLanguage.lightweightdsl.structure.ClassLikeDescriptor"));
          }
