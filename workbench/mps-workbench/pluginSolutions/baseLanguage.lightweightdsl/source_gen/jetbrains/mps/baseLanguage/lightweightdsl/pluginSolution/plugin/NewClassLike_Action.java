...
public class NewClassLike_Action extends BaseAction {
  ...
  public void doUpdate(@NotNull AnActionEvent event, final Map<String, Object> _params) {
    event.getPresentation().setText(SPropertyOperations.getString(NewClassLike_Action.this.descr, MetaAdapterFactory.getProperty(0xceab519525ea4f22L, 0x9b92103b95ca8c0cL, 0x110396eaaa4L, 0x110396ec041L, "name")) + " dslclass");
    ...
    if (pc == null) {
      pc = SNodeOperations.getNode("r:00000000-0000-4000-0000-011c895902ca(jetbrains.mps.baseLanguage.structure)", "1068390468198");
    }
    event.getPresentation().setIcon(IconManager.getIcon(SNodeOperations.asSConcept(pc)));
  }
  @Override
  ...
  public void doExecute(@NotNull final AnActionEvent event, final Map<String, Object> _params) {
    SAbstractConcept c = SNodeOperations.asSConcept(DSLDescriptor_BehaviorDescriptor.getPreferredConcept_id1_lSsE3TA5X.invoke(NewClassLike_Action.this.descr));
    SNode newClass;
