...
public class NewClassLike_Action extends BaseAction {
  ...
  public void doUpdate(@NotNull AnActionEvent event, final Map<String, Object> _params) {
    ...
    if (pc != null) {
      ...
      icon = SNodeOperations.asSConcept(pc).getIcon();
    } else {
      icon = MetaAdapterFactory.getConcept(0xf3061a5392264cc5L, 0xa443f952ceaf5816L, 0xf8c108ca66L, "jetbrains.mps.baseLanguage.structure.ClassConcept").getIcon();
    }
