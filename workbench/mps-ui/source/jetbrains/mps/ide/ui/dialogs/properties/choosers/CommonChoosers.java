...
public class CommonChoosers {
  ...
  public static List<SModelReference> showDialogModelCollectionChooser(@NotNull Project project, List<SModelReference> models, @Nullable List<SModelReference> nonProjectModels) {
    return showDialogModelChooser_internal(project, models, nonProjectModels, true);
  }

  public static SModelReference showDialogModelChooser(@NotNull Project project, List<SModelReference> models, @Nullable List<SModelReference> nonProjectModels) {
    List<SModelReference> result = showDialogModelChooser_internal(project, models, nonProjectModels, false);
    if (result == null || result.isEmpty()) return null;
    return result.get(0);
  }

  public static SModuleReference showDialogModuleChooser(@NotNull Project project, String entityString, List<? extends SModuleReference> modules, @Nullable List<? extends SModuleReference> nonProjectModules) {
  ...
  public static List<SModuleReference> showModuleSetChooser(@NotNull jetbrains.mps.project.Project mpsProject, String title, List<SModuleReference> modules) {
