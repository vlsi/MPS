...
<model modelUID="r:00000000-0000-4000-0000-011c895904a8(jetbrains.mps.ide.newDevkitDialog)">
  ...
  <import index="12" modelUID="r:00000000-0000-4000-0000-011c89590288(jetbrains.mps.core.structure)" version="-1"/>
  ...
  <node type="jetbrains.mps.uiLanguage.structure.ComponentController" id="1204026656767">
    ...
    <node role="componentMethod"
          type="jetbrains.mps.baseLanguage.classifiers.structure.DefaultClassifierMethodDeclaration" id="1204027050087">
            ...
            <node role="initializer" type="jetbrains.mps.baseLanguage.structure.PlusExpression" id="1204027646764">
              <node role="rightExpression" type="jetbrains.mps.baseLanguage.structure.PlusExpression"
                ...
                <node role="rightExpression" type="jetbrains.mps.baseLanguage.structure.PlusExpression"
                  ...
                  <node role="rightExpression" type="jetbrains.mps.baseLanguage.structure.StaticFieldReference"
                        id="1214659395994">
                ...
                <node role="leftExpression" type="jetbrains.mps.baseLanguage.structure.StaticFieldReference"
                      id="1204027649080">
                ...
                <node role="expression" type="jetbrains.mps.baseLanguage.structure.StaticMethodCall" id="1204027933712">
                  ...
                  <node role="actualArgument" type="jetbrains.mps.baseLanguage.structure.CastExpression"
                    ...
                    <node role="expression" type="jetbrains.mps.baseLanguage.structure.DotExpression"
                          id="1205834565815">
                      <node role="operand" type="jetbrains.mps.ide.uiLanguage.structure.DialogExpression"
                            id="1204027949734"/>
                      <node role="operation" type="jetbrains.mps.baseLanguage.structure.InstanceMethodCallOperation"
                            id="1205834565816">
                        <link role="baseMethodDeclaration" targetNodeId="1.~Window.getOwner():java.awt.Window"
        ...
        <node role="statement" type="jetbrains.mps.baseLanguage.structure.ExpressionStatement" id="1217961230493">
          <node role="expression" type="jetbrains.mps.baseLanguage.structure.DotExpression" id="1217961230494">
            ...
            <node role="operation" type="jetbrains.mps.baseLanguage.structure.InstanceMethodCallOperation"
                  id="1217961230496">
              <link role="baseMethodDeclaration"
                    targetNodeId="13.~ProgressManager.run(com.intellij.openapi.progress.Task):void" resolveInfo="run"/>
                  ...
                  <node role="cls" type="jetbrains.mps.baseLanguage.structure.AnonymousClass" id="1217961230499">
                    ...
                    <node role="method" type="jetbrains.mps.baseLanguage.structure.InstanceMethodDeclaration"
                      ...
                      <node role="body" type="jetbrains.mps.baseLanguage.structure.StatementList" id="1217961230507">
                        ...
                        <node role="statement"
                              type="jetbrains.mps.bootstrap.smodelLanguage.structure.ExecuteWriteActionStatement"
                              id="1217961230513">
    ...
    <node role="componentMethod"
          type="jetbrains.mps.baseLanguage.classifiers.structure.DefaultClassifierMethodDeclaration" id="1204027087626">
    ...
    <node role="componentMethod"
          type="jetbrains.mps.baseLanguage.classifiers.structure.DefaultClassifierMethodDeclaration" id="1204027179199">
            ...
            <node role="initializer" type="jetbrains.mps.baseLanguage.structure.StaticMethodCall" id="1204027246048">
              ...
              <node role="actualArgument" type="jetbrains.mps.baseLanguage.structure.DotExpression" id="1205834587952">
                <node role="operand" type="jetbrains.mps.baseLanguage.structure.DotExpression" id="1205834571991">
                  ...
                  <node role="operation" type="jetbrains.mps.baseLanguage.structure.InstanceMethodCallOperation"
                        id="1205834571992">
                    <link role="baseMethodDeclaration" targetNodeId="4.~MPSProject.getProjectFile():java.io.File"
                          resolveInfo="getProjectFile"/>
                  </node>
                </node>
                <node role="operation" type="jetbrains.mps.baseLanguage.structure.InstanceMethodCallOperation"
                      id="1205834587953">
                  <link role="baseMethodDeclaration" targetNodeId="8.~File.getParentFile():java.io.File"
        ...
        <node role="statement" type="jetbrains.mps.baseLanguage.structure.IfStatement" id="1204027305859">
          ...
          <node role="condition" type="jetbrains.mps.baseLanguage.structure.OrExpression" id="1204027313106">
            <node role="rightExpression" type="jetbrains.mps.baseLanguage.structure.DotExpression" id="1205834587950">
              ...
              <node role="operation" type="jetbrains.mps.baseLanguage.structure.InstanceMethodCallOperation"
                    id="1205834587951">
                <link role="baseMethodDeclaration" targetNodeId="2.~String.startsWith(java.lang.String):boolean"
    ...
    <node role="componentMethod"
          type="jetbrains.mps.baseLanguage.classifiers.structure.DefaultClassifierMethodDeclaration" id="1204027985317">
          ...
          <node role="expression" type="jetbrains.mps.baseLanguage.structure.StaticMethodCall" id="1204028271453">
            ...
            <node role="actualArgument" type="jetbrains.mps.baseLanguage.structure.GenericNewExpression"
              ...
              <node role="creator" type="jetbrains.mps.baseLanguage.structure.ClassCreator" id="1217888358745">
                <link role="baseMethodDeclaration" targetNodeId="11.~FileSystemFile.&lt;init&gt;(java.io.File)"
