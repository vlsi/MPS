      ...
      <node role="body" type="jetbrains.mps.baseLanguage.structure.StatementList" id="1203599983023">
                ...
                <node role="expression" type="jetbrains.mps.baseLanguage.structure.StaticMethodCall" id="1203611018225">
                  ...
                  <node role="actualArgument" type="jetbrains.mps.baseLanguage.structure.CastExpression"
                    ...
                    <node role="expression" type="jetbrains.mps.baseLanguage.structure.InstanceMethodCall"
                      ...
                      <node role="instance" type="jetbrains.mps.ide.uiLanguage.structure.DialogExpression"
                            id="1203611018229"/>
                    </node>
                  </node>
                  <node role="actualArgument" type="jetbrains.mps.baseLanguage.structure.LocalVariableReference"
        ...
        <node role="statement" type="jetbrains.mps.baseLanguage.structure.ExpressionStatement" id="1203611229471">
          <node role="expression" type="jetbrains.mps.baseLanguage.structure.InstanceMethodCall" id="1203611233555">
            <link role="baseMethodDeclaration"
                  targetNodeId="5.~ModelAccess.runWriteActionInCommand(java.lang.Runnable):void"
                  resolveInfo="runWriteActionInCommand"/>
            <node role="instance" type="jetbrains.mps.baseLanguage.structure.StaticMethodCall" id="1213109744609">
              <link role="baseMethodDeclaration"
                    targetNodeId="5.~ModelAccess.instance():jetbrains.mps.smodel.ModelAccess" resolveInfo="instance"/>
