...
<model modelUID="r:00000000-0000-4000-0000-011c895904a6(jetbrains.mps.ide.embeddableEditor)">
    ...
    <import index="18" modelUID="f:java_stub#jetbrains.mps.workbench.editors(jetbrains.mps.workbench.editors@java_stub)"
            version="-1"/>
    <import index="19" modelUID="f:java_stub#jetbrains.mps.workbench.nodesFs(jetbrains.mps.workbench.nodesFs@java_stub)"
            version="-1"/>
    <import index="20"
            modelUID="f:java_stub#com.intellij.openapi.actionSystem(com.intellij.openapi.actionSystem@java_stub)"
            version="-1"/>
    <import index="21" modelUID="f:java_stub#org.jetbrains.annotations(org.jetbrains.annotations@java_stub)"
            version="-1"/>
            ...
            <node role="body" type="jetbrains.mps.baseLanguage.structure.StatementList" id="1219412504352">
                ...
                <node role="statement" type="jetbrains.mps.baseLanguage.structure.LocalVariableDeclarationStatement"
                    ...
                    <node role="localVariableDeclaration"
                          type="jetbrains.mps.baseLanguage.structure.LocalVariableDeclaration" id="1219740443861">
                        ...
                        <node role="initializer" type="jetbrains.mps.baseLanguage.structure.GenericNewExpression"
                            ...
                            <node role="creator" type="jetbrains.mps.baseLanguage.structure.ClassCreator"
                                  id="1219740449807">
                                <link role="baseMethodDeclaration" targetNodeId="1219653381253"
                                      resolveInfo="EditorGenerateType"/>
                            </node>
                        </node>
                    </node>
                </node>
                <node role="statement" type="jetbrains.mps.baseLanguage.structure.LocalVariableDeclarationStatement"
                      id="1219583399615">
                    <node role="localVariableDeclaration"
                          type="jetbrains.mps.baseLanguage.structure.LocalVariableDeclaration" id="1219583399616">
                        ...
                        <node role="initializer" type="jetbrains.mps.baseLanguage.structure.DotExpression"
                            ...
                            <node role="operation"
                                ...
                                <node role="actualArgument"
                                      ...
                                      id="1219583399620">
                                    <link role="classifier" targetNodeId="11.~GeneratorManager"
                ...
                <node role="statement" type="jetbrains.mps.baseLanguage.structure.ExpressionStatement"
                    ...
                    <node role="expression" type="jetbrains.mps.baseLanguage.structure.DotExpression"
                        ...
                        <node role="operation" type="jetbrains.mps.baseLanguage.structure.InstanceMethodCallOperation"
                              id="1219583399625">
                            <link role="baseMethodDeclaration"
                                  targetNodeId="11.~GeneratorManager.generateModelsWithProgressWindow(java.util.List,jetbrains.mps.smodel.IOperationContext,jetbrains.mps.generator.IGenerationType,boolean):boolean"
                            ...
                            <node role="actualArgument" type="jetbrains.mps.baseLanguage.structure.StaticMethodCall"
                                ...
                                <link role="baseMethodDeclaration"
                                      targetNodeId="12.~Arrays.asList(java.lang.Object...):java.util.List"
                                      resolveInfo="asList"/>
                                <node role="actualArgument" type="jetbrains.mps.baseLanguage.structure.DotExpression"
                                    ...
                                    <node role="operation"
                                          type="jetbrains.mps.baseLanguage.structure.FieldReferenceOperation"
                                          id="1219654142603">
                                        <link role="fieldDeclaration" targetNodeId="1219408476932"
                                              resolveInfo="myModel"/>
                                    </node>
                                    <node role="operand" type="jetbrains.mps.baseLanguage.structure.ThisExpression"
                                          id="1219654142604"/>
                            ...
                            <node role="actualArgument"
                                  type="jetbrains.mps.baseLanguage.structure.LocalVariableReference" id="1219740447271">
                ...
                <node role="statement" type="jetbrains.mps.baseLanguage.structure.ReturnStatement" id="1219412758986">
                    <node role="expression" type="jetbrains.mps.baseLanguage.structure.GenericNewExpression"
                        ...
                        <node role="creator" type="jetbrains.mps.baseLanguage.structure.ClassCreator"
                              id="1219412759832">
                            <link role="baseMethodDeclaration" targetNodeId="1219669234496"
                            ...
                            <node role="actualArgument"
                                  type="jetbrains.mps.baseLanguage.structure.LocalVariableReference" id="1219740683782">
                                <link role="variableDeclaration" targetNodeId="1219740443861" resolveInfo="type"/>
                            </node>
                        </node>
                    </node>
                            ...
                            <node role="statement" type="jetbrains.mps.baseLanguage.structure.ExpressionStatement"
                                ...
                                <node role="expression" type="jetbrains.mps.baseLanguage.structure.DotExpression"
                                    ...
                                    <node role="operation"
                                          ...
                                          id="1219654007816">
                                        <link role="baseMethodDeclaration"
                                              targetNodeId="5.~SModel.addImportedModel(jetbrains.mps.smodel.SModelReference):void"
                                        ...
                                        <node role="actualArgument"
                                            ...
                                            <node role="operand"
                                                ...
                                                <node role="operand"
                                                      ...
                                                      id="1219654007820">
                                                    <link role="variableDeclaration" targetNodeId="1219418299303"
                                            ...
                                            <node role="operation"
                                                  ...
                                                  id="1222449614427">
                                                <link role="baseMethodDeclaration"
                                                      targetNodeId="5.~SModelDescriptor.getSModelReference():jetbrains.mps.smodel.SModelReference"
                ...
                <node role="statement" type="jetbrains.mps.baseLanguage.structure.ExpressionStatement"
                    ...
                    <node role="expression" type="jetbrains.mps.baseLanguage.structure.DotExpression"
                        ...
                        <node role="operand" type="jetbrains.mps.baseLanguage.structure.StaticMethodCall"
                            ...
                            <link role="classConcept" targetNodeId="5.~SModelRepository"
                                  resolveInfo="SModelRepository"/>
                        </node>
                        <node role="operation" type="jetbrains.mps.baseLanguage.structure.InstanceMethodCallOperation"
                              id="1219672399596">
                            <link role="baseMethodDeclaration"
                                  targetNodeId="5.~SModelRepository.unRegisterModelDescriptors(jetbrains.mps.smodel.ModelOwner):void"
                ...
                <node role="statement" type="jetbrains.mps.baseLanguage.structure.ExpressionStatement"
                    ...
                    <node role="expression" type="jetbrains.mps.baseLanguage.structure.DotExpression"
                        ...
                        <node role="operand" type="jetbrains.mps.baseLanguage.structure.DotExpression"
                            ...
                            <node role="operation" type="jetbrains.mps.baseLanguage.structure.FieldReferenceOperation"
                                  id="1220438442953">
                                <link role="fieldDeclaration" targetNodeId="1220438174600"
                                      resolveInfo="myFileNodeEditor"/>
                            </node>
                            <node role="operand" type="jetbrains.mps.baseLanguage.structure.ThisExpression"
                                  id="1220438442954"/>
                        </node>
                        <node role="operation" type="jetbrains.mps.baseLanguage.structure.InstanceMethodCallOperation"
                              id="1220438447779">
                            <link role="baseMethodDeclaration" targetNodeId="18.~MPSFileNodeEditor.dispose():void"
                                  resolveInfo="dispose"/>
                        </node>
                    </node>
                </node>
                ...
                <node role="statement" type="jetbrains.mps.baseLanguage.structure.ExpressionStatement"
                    ...
                    <node role="expression" type="jetbrains.mps.baseLanguage.structure.AssignmentExpression"
                        ...
                        <node role="rValue" type="jetbrains.mps.baseLanguage.structure.StaticMethodCall"
                            ...
                            <link role="baseMethodDeclaration"
                                  targetNodeId="5.~ProjectModels.createDescriptorFor(jetbrains.mps.smodel.ModelOwner):jetbrains.mps.smodel.SModelDescriptor"
                                  resolveInfo="createDescriptorFor"/>
                            <node role="actualArgument" type="jetbrains.mps.baseLanguage.structure.DotExpression"
                                  id="1219653957300">
                                <node role="operation"
                                      type="jetbrains.mps.baseLanguage.structure.FieldReferenceOperation"
                ...
                <node role="statement" type="jetbrains.mps.baseLanguage.structure.ExpressionStatement"
                    ...
                    <node role="expression" type="jetbrains.mps.baseLanguage.structure.DotExpression"
                        ...
                        <node role="operation" type="jetbrains.mps.baseLanguage.structure.InstanceMethodCallOperation"
                              id="1220432287015">
                            <link role="baseMethodDeclaration"
                                  targetNodeId="5.~SModel.runLoadingAction(java.lang.Runnable):void"
                                  resolveInfo="runLoadingAction"/>
                                                ...
                                                <node role="statement"
                                                    ...
                                                    <node role="expression"
                                                        ...
                                                        <node role="operation"
                                                              ...
                                                              id="1220432353889">
                                                            <link role="baseMethodDeclaration"
                                                                  targetNodeId="5.~SModel.addRoot(jetbrains.mps.smodel.SNode):void"
                                                                  resolveInfo="addRoot"/>
                                                            <node role="actualArgument"
                                                                  type="jetbrains.mps.baseLanguage.structure.DotExpression"
                                                                  id="1220432353890">
                    ...
                    <node role="expression" type="jetbrains.mps.baseLanguage.structure.AssignmentExpression"
                        ...
                        <node role="rValue" type="jetbrains.mps.baseLanguage.structure.GenericNewExpression"
                            ...
                            <node role="creator" type="jetbrains.mps.baseLanguage.structure.ClassCreator"
                                  id="1220438424067">
                                <link role="baseMethodDeclaration"
                                      targetNodeId="18.~MPSFileNodeEditor.&lt;init&gt;(jetbrains.mps.smodel.IOperationContext,jetbrains.mps.workbench.nodesFs.MPSNodeVirtualFile)"
                                      resolveInfo="MPSFileNodeEditor"/>
                                <node role="actualArgument"
                                      type="jetbrains.mps.baseLanguage.structure.ParameterReference" id="1220438424068">
                                    <link role="variableDeclaration" targetNodeId="1219405578628"
                                          resolveInfo="context"/>
                                </node>
                                <node role="actualArgument" type="jetbrains.mps.baseLanguage.structure.DotExpression"
                                      id="1220438424069">
                                    <node role="operand" type="jetbrains.mps.baseLanguage.structure.StaticMethodCall"
                                          id="1220438424070">
                                        <link role="baseMethodDeclaration"
                                              targetNodeId="19.~MPSNodesVirtualFileSystem.getInstance():jetbrains.mps.workbench.nodesFs.MPSNodesVirtualFileSystem"
                                              resolveInfo="getInstance"/>
                                        <link role="classConcept" targetNodeId="19.~MPSNodesVirtualFileSystem"
                                    ...
                                    <node role="operation"
                                          ...
                                          id="1220438424071">
                                        <link role="baseMethodDeclaration"
                                              targetNodeId="19.~MPSNodesVirtualFileSystem.getFileFor(jetbrains.mps.smodel.SNode):jetbrains.mps.workbench.nodesFs.MPSNodeVirtualFile"
                                              resolveInfo="getFileFor"/>
                                        <node role="actualArgument"
                                              type="jetbrains.mps.baseLanguage.structure.ParameterReference"
                                              id="1220438424072">
                                            <link role="variableDeclaration" targetNodeId="1220272668087"
                                                  resolveInfo="node"/>
                                        </node>
                                    </node>
                                </node>
                ...
                <node role="statement" type="jetbrains.mps.baseLanguage.structure.ExpressionStatement"
                    ...
                    <node role="expression" type="jetbrains.mps.baseLanguage.structure.AssignmentExpression"
                        ...
                        <node role="rValue" type="jetbrains.mps.baseLanguage.structure.GenericNewExpression"
                            ...
                            <node role="creator" type="jetbrains.mps.baseLanguage.structure.ClassCreator"
                                  id="1220433531595">
                                <link role="baseMethodDeclaration" targetNodeId="1220433141276"
                                      resolveInfo="EmbeddableEditorPanel"/>
                                <node role="actualArgument" type="jetbrains.mps.baseLanguage.structure.DotExpression"
                                      id="1220438430463">
                                    <node role="operation"
                                          type="jetbrains.mps.baseLanguage.structure.FieldReferenceOperation"
                ...
                <node role="statement" type="jetbrains.mps.baseLanguage.structure.ReturnStatement" id="1219740561099">
                    <node role="expression" type="jetbrains.mps.baseLanguage.structure.DotExpression"
                        ...
                        <node role="operation" type="jetbrains.mps.baseLanguage.structure.InstanceMethodCallOperation"
                              id="1219741069275">
                            <link role="baseMethodDeclaration"
                                  targetNodeId="9.~GenerateClassesGenerationType.getClassLoader(java.lang.ClassLoader):java.lang.ClassLoader"
                                  resolveInfo="getClassLoader"/>
                            <node role="actualArgument" type="jetbrains.mps.baseLanguage.structure.ParameterReference"
                                  id="1219935006359">
                                <link role="variableDeclaration" targetNodeId="1219741072589"
                                      resolveInfo="parentLoader"/>
                            </node>
                        </node>
                    </node>
                </node>
        ...
        <node role="constructor" type="jetbrains.mps.baseLanguage.structure.ConstructorDeclaration" id="1219669234496">
            ...
            <node role="parameter" type="jetbrains.mps.baseLanguage.structure.ParameterDeclaration" id="1219740839230">
                ...
                <node role="type" type="jetbrains.mps.baseLanguage.structure.ClassifierType" id="1219740848561">
                    <link role="classifier" targetNodeId="9.~GenerateClassesGenerationType"
                          resolveInfo="GenerateClassesGenerationType"/>
                </node>
            </node>
            ...
            <node role="body" type="jetbrains.mps.baseLanguage.structure.StatementList" id="1219669234499">
                ...
                <node role="statement" type="jetbrains.mps.baseLanguage.structure.ExpressionStatement"
                    ...
                    <node role="expression" type="jetbrains.mps.baseLanguage.structure.AssignmentExpression"
                        ...
                        <node role="rValue" type="jetbrains.mps.baseLanguage.structure.ParameterReference"
                              id="1219669351521">
                            <link role="variableDeclaration" targetNodeId="1219669269757"
            ...
            <node role="body" type="jetbrains.mps.baseLanguage.structure.StatementList" id="1219653381256">
                <node role="statement" type="jetbrains.mps.baseLanguage.structure.SuperConstructorInvocation"
                    ...
                    <link role="constructorDeclaration"
                          targetNodeId="9.~GenerateClassesGenerationType.&lt;init&gt;(boolean)"
                          resolveInfo="GenerateClassesGenerationType"/>
                    <node role="actualArgument" type="jetbrains.mps.baseLanguage.structure.BooleanConstant"
                          id="1219653633235">
                        <property name="value" value="false"/>
    ...
    <node type="jetbrains.mps.baseLanguage.structure.ClassConcept" id="1220433141274">
        ...
        <node role="constructor" type="jetbrains.mps.baseLanguage.structure.ConstructorDeclaration" id="1220433141276">
            ...
            <node role="body" type="jetbrains.mps.baseLanguage.structure.StatementList" id="1220433141279">
                <node role="statement" type="jetbrains.mps.baseLanguage.structure.SuperConstructorInvocation"
                      id="1220433474908">
                    <link role="constructorDeclaration" targetNodeId="1.~JPanel.&lt;init&gt;(java.awt.LayoutManager)"
                          resolveInfo="JPanel"/>
                    <node role="actualArgument" type="jetbrains.mps.baseLanguage.structure.GenericNewExpression"
                          id="1220433476893">
                        <node role="creator" type="jetbrains.mps.baseLanguage.structure.ClassCreator"
                ...
                <node role="statement" type="jetbrains.mps.baseLanguage.structure.ExpressionStatement"
                    ...
                    <node role="expression" type="jetbrains.mps.baseLanguage.structure.AssignmentExpression"
                        ...
                        <node role="lValue" type="jetbrains.mps.baseLanguage.structure.DotExpression"
                            ...
                            <node role="operation" type="jetbrains.mps.baseLanguage.structure.FieldReferenceOperation"
                                  id="1220433806862">
                                <link role="fieldDeclaration" targetNodeId="1220433350457"
                                      resolveInfo="myFileNodeEditor"/>
                            </node>
                            <node role="operand" type="jetbrains.mps.baseLanguage.structure.ThisExpression"
                                  id="1220433806863"/>
                ...
                <node role="statement" type="jetbrains.mps.baseLanguage.structure.ExpressionStatement"
                    ...
                    <node role="expression" type="jetbrains.mps.baseLanguage.structure.DotExpression"
                        ...
                        <node role="operation" type="jetbrains.mps.baseLanguage.structure.InstanceMethodCallOperation"
                              id="1220433393110">
                            <link role="baseMethodDeclaration"
                                  targetNodeId="4.~Container.add(java.awt.Component,java.lang.Object):void"
                                  resolveInfo="add"/>
                            <node role="actualArgument" type="jetbrains.mps.baseLanguage.structure.DotExpression"
                                  id="1220434159691">
                                ...
                                <node role="operation"
                                      ...
                                      id="1220434162505">
                                    <link role="baseMethodDeclaration"
                                          targetNodeId="18.~MPSFileNodeEditor.getComponent():javax.swing.JComponent"
                                          resolveInfo="getComponent"/>
                                </node>
                            </node>
                        ...
                        <node role="operation" type="jetbrains.mps.baseLanguage.structure.InstanceMethodCallOperation"
                            ...
                            <node role="actualArgument" type="jetbrains.mps.baseLanguage.structure.DotExpression"
                                ...
                                <node role="operand" type="jetbrains.mps.baseLanguage.structure.StaticFieldReference"
                                    ...
                                    <link role="variableDeclaration" targetNodeId="20.~PlatformDataKeys.FILE_EDITOR"
                                          resolveInfo="FILE_EDITOR"/>
                                </node>
                                <node role="operation"
                                      type="jetbrains.mps.baseLanguage.structure.InstanceMethodCallOperation"
                                      id="1220433232307">
                                    <link role="baseMethodDeclaration"
                                          targetNodeId="20.~DataKey.getName():java.lang.String" resolveInfo="getName"/>
                                </node>
                            </node>
                        </node>
                    </node>
