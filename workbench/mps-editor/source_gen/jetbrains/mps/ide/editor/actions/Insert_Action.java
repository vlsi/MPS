  ...
  public void doExecute(@NotNull final AnActionEvent event, final Map<String, Object> _params) {
    try {
      ...
      if (((jetbrains.mps.nodeEditor.cells.EditorCell) editorCell).isFirstCaretPosition()) {
        if (!(((jetbrains.mps.nodeEditor.cells.EditorCell) editorCell).isLastCaretPosition()) || (editorCell instanceof EditorCell_Label && !StyleAttributesUtil.isLastPositionAllowed(editorCell.getStyle()))) {
