...
public class ShowRegularEditor_Action extends BaseAction {
  ...
  public void doExecute(@NotNull final AnActionEvent event, final Map<String, Object> _params) {
    ((EditorComponent) MapSequence.fromMap(_params).get("editorComponent")).getUpdater().setShowDefaultEditor(((SNode) MapSequence.fromMap(_params).get("node")).getReference(), false);
