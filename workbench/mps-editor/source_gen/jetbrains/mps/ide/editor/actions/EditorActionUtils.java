...
public class EditorActionUtils {
  ...
  public static void callInsertAction(@NotNull EditorCell cell) {
    ...
    if (cell instanceof EditorCell_Label && !(isLinkCollection(cell))) {
      ...
      if (cellWithRole != null && cellWithRole.getEditorComponent().getActionHandler().executeAction(cellWithRole, CellActionType.INSERT)) {
        return;
      }
    }

    cell.getEditorComponent().getActionHandler().executeAction(cell, CellActionType.INSERT);
  }
  ...
  public static void callInsertBeforeAction(@NotNull EditorCell cell) {
    ...
    if (cell instanceof EditorCell_Label && !(isLinkCollection(cell))) {
      ...
      if (cellWithRole != null && cellWithRole.getEditorComponent().getActionHandler().executeAction(cellWithRole, CellActionType.INSERT_BEFORE)) {
        return;
      }
    }

    cell.getEditorComponent().getActionHandler().executeAction(cell, CellActionType.INSERT_BEFORE);
  }
