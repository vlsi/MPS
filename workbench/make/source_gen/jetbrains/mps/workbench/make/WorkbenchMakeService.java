...
public class WorkbenchMakeService implements IMakeService {
  ...
  private Future<IResult> doMake(final Iterable<? extends IResource> inputRes, final IScript script, IScriptController controller) {
    ...
    IScriptController ctl = this.completeController(scrName, mh, controller, new _FunctionTypes._void_P0_E0() {
      public void invoke() {
  ...
  private IScriptController completeController(final String scrName, final IMessageHandler mh, final IScriptController ctl, final _FunctionTypes._void_P0_E0 beforeDialog) {
