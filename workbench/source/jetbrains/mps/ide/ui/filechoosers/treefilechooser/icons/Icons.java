...
public class Icons {
  ...
  public static final Icon UPDATE_ICON = new ImageIcon(Icons.class.getResource("delete.png"));
  public static final Icon SHOW_HIDDEN_ICON = new ImageIcon(Icons.class.getResource("delete.png"));
}