...
public class TabbedEditor implements IEditor {
  ...
  public TabbedEditor(IOperationContext context, SNode node) {
    ...
    }, KeyStroke.getKeyStroke("alt LEFT"), JComponent.WHEN_ANCESTOR_OF_FOCUSED_COMPONENT);
    ...
    }, KeyStroke.getKeyStroke("alt RIGHT"), JComponent.WHEN_ANCESTOR_OF_FOCUSED_COMPONENT);
