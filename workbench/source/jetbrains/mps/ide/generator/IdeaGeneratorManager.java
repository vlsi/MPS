 ...
 */
public class IdeaGeneratorManager {

  private static final IdeaGeneratorManager INSTANCE = new IdeaGeneratorManager();

  private IdeaGeneratorManager() {
  }

  public static IdeaGeneratorManager getInstance() {
    return INSTANCE;
  }
