...
public class MPSDataKeys {
  public static final DataKey<SModelDescriptor> MODEL_DESCRIPTOR = DataKey.create("smodel descriptor");
  ...
  public static final DataKey<IEditor> EDITOR = DataKey.create("ieditor");
}
