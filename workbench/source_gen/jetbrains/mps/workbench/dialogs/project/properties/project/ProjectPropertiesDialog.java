...
public final class ProjectPropertiesDialog extends BaseStretchingBindedDialog {
  private static final Logger LOG = Logger.getLogger(ProjectPropertiesDialog.class);

  private Project myProject;
  private ProjectProperties myProperties;

  public ProjectPropertiesDialog(final Project project) {
    super(project.getName() + " Properties", project.getComponent(MPSProjectHolder.class).getMPSProject().createOperationContext());
