...
public final class ListsFactory {
  ...
  public static final ListsFactory.ListComparator<jetbrains.mps.project.structure.model.ModelRoot> MODEL_ROOT_COMPARATOR = new ListsFactory.ListComparator<jetbrains.mps.project.structure.model.ModelRoot>() {
    public int compare(jetbrains.mps.project.structure.model.ModelRoot o1, jetbrains.mps.project.structure.model.ModelRoot o2) {
      return o1.getPath().compareTo(o2.getPath());
    }

    public boolean isEqual(jetbrains.mps.project.structure.model.ModelRoot o1, jetbrains.mps.project.structure.model.ModelRoot o2) {
      if (super.isEqual(o1, o2)) {
        return true;
      }
  ...
  public static final ListsFactory.ListComparator<ModelRoot> STUB_MODEL_ENTRY_COMPARATOR = new ListsFactory.ListComparator<ModelRoot>() {
