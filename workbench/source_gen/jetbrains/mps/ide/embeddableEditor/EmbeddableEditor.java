...
public class EmbeddableEditor {
  ...
  public EmbeddableEditor(IOperationContext context, ModelOwner owner, SNode rootNode, SNode targetNode, boolean editable) {
    ...
    myModel.getSModel().addDevKit(GeneralPurpose_DevKit.get().getModuleReference());
  ...
  public void addLanguageStructureModel(final Language language) {
    ModelAccess.instance().runWriteActionInCommand(new Runnable() {
      public void run() {
        SModelOperations.addImportedModel(myModel.getSModel(), language.getStructureModelDescriptor().getSModelReference());
      }
    });
  }
  ...
  public void addLanguage(final Language language) {
    ModelAccess.instance().runWriteAction(new Runnable() {
      public void run() {
        SModelOperations.addLanguage(myModel.getSModel(), language);
      }
    });
  }
  ...
  public void addModel(final SModelReference model) {
    ModelAccess.instance().runWriteAction(new Runnable() {
      public void run() {
        SModelOperations.addImportedModel(myModel.getSModel(), model);
      }
    });
  }
