    ...
    while (children.hasMoreElements()) {
      ...
      if (childData.getObject().equals(modRef)) {
        ...
        if (innerOperand instanceof MappingConfig_RefAllLocal) {
          ...
          setMappingRefSet(child, (MappingConfig_RefSet) innerOperand);
        }
      }
    }
  }
