...
public class ModelPropertiesDialog extends BasePropertiesDialog {
  ...
  public Condition<SModelReference> getImportedModelsRemoveCondition() {
    ...
    ModelAccess.instance().runReadAction(new Runnable() {
      public void run() {
        models.value = SModelOperations.getUsedImportedModels(myPresenter.getModelDescriptor().getSModel());
      }
    });
  ...
  public Condition<ModuleReference> getUsedLanguageRemoveCondition() {
    ...
    ModelAccess.instance().runReadAction(new Runnable() {
      public void run() {
        usedLanguages.value = SModelOperations.getUsedLanguages(myPresenter.getModelDescriptor().getSModel());
      }
    });
