...
public class SurroundWithIntentions_Action extends GeneratedAction {
  ...
  private BaseGroup getIntentionGroup() {
    ...
    groupItems.addAll(IntentionsManager.getInstance().getAvailableIntentions(new QueryDescriptor(SurroundWithIntention.class, true,false), SurroundWithIntentions_Action.this.selectedNode, SurroundWithIntentions_Action.this.editorContext, null));
