...
import jetbrains.mps.ide.projectPane.NodeExplorerView;
...
public class ShowNodeInExplorer_Action extends GeneratedAction {
  ...
  public void doExecute(@NotNull() final AnActionEvent event) {
    try {
      NodeExplorerView view = this.project.getComponent(NodeExplorerView.class);
      view.showNode(this.node, this.project);
    } catch (Throwable t) {
