...
public class Ide_ApplicationPlugin extends BaseApplicationPlugin {
  ...
  public void adjustInterfaceGroups() {
    insertInterfaceGroupIntoAnother(AbstractFileActions_ActionGroup.ID, "VcsGroup", AbstractFileActions_ActionGroup.LABEL_ID_vcs);
    insertInterfaceGroupIntoAnother(EditorPopup_ActionGroup.ID, "VcsGroup", EditorPopup_ActionGroup.LABEL_ID_vcs);
    insertInterfaceGroupIntoAnother(LanguageActions_ActionGroup.ID, "VcsGroup", LanguageActions_ActionGroup.LABEL_ID_vcs);
    insertInterfaceGroupIntoAnother(ModelActions_ActionGroup.ID, "VcsGroup", ModelActions_ActionGroup.LABEL_ID_ideavcs);
    insertInterfaceGroupIntoAnother(DebugTool_ActionGroup.ID, "DebugMuteAction", DebugTool_ActionGroup.LABEL_ID_MuteAction);
    insertInterfaceGroupIntoAnother(AbstractFileActions_ActionGroup.ID, "NavbarPopupMenu", AbstractFileActions_ActionGroup.LABEL_ID_ideaActions);
    insertInterfaceGroupIntoAnother(DebugTool_ActionGroup.ID, "DebugStopAction", DebugTool_ActionGroup.LABEL_ID_StopAction);
    insertInterfaceGroupIntoAnother(EditorPopup_ActionGroup.ID, "RunContextGroup", null);
    insertInterfaceGroupIntoAnother(EditorTabActions_ActionGroup.ID, "RunContextGroup", null);
    insertInterfaceGroupIntoAnother(JUnitTestCaseActions_ActionGroup.ID, "RunContextGroup", null);
    insertInterfaceGroupIntoAnother(JUnitTestMethodActions_ActionGroup.ID, "RunContextGroup", null);
    insertInterfaceGroupIntoAnother(LanguageActions_ActionGroup.ID, "RunContextGroup", null);
    insertInterfaceGroupIntoAnother(ModelActions_ActionGroup.ID, "RunContextGroup", null);
    insertInterfaceGroupIntoAnother(NodeActions_ActionGroup.ID, "RunContextGroup", null);
    insertInterfaceGroupIntoAnother(ProjectActions_ActionGroup.ID, "RunContextGroup", ProjectActions_ActionGroup.LABEL_ID_runConfig);
    insertInterfaceGroupIntoAnother(SolutionActions_ActionGroup.ID, "RunContextGroup", null);
  }

  public void adjustRegularGroups() {
    insertGroupIntoAnother(ProjectActions_ActionGroup.ID, "jetbrains.mps.ide.actions.ProjectNewActions_ActionGroup", ProjectActions_ActionGroup.LABEL_ID_projectNew);
    insertGroupIntoAnother(LanguageActions_ActionGroup.ID, "jetbrains.mps.ide.actions.LanguageNewActions_ActionGroup", LanguageActions_ActionGroup.LABEL_ID_newGroup);
    insertGroupIntoAnother(SolutionActions_ActionGroup.ID, "jetbrains.mps.ide.actions.SolutionNewActions_ActionGroup", SolutionActions_ActionGroup.LABEL_ID_solutionNew);
    insertGroupIntoAnother(GeneratorActions_ActionGroup.ID, "jetbrains.mps.ide.actions.GeneratorNewActions_ActionGroup", GeneratorActions_ActionGroup.LABEL_ID_generatorNew);
    insertGroupIntoAnother(EditorPopup_ActionGroup.ID, "jetbrains.mps.ide.actions.EditorInternal_ActionGroup", null);
    insertGroupIntoAnother("EditMenu", "jetbrains.mps.ide.actions.Edit_ActionGroup", null);
    insertGroupIntoAnother("GenerateMenu", "jetbrains.mps.ide.actions.Generate_ActionGroup", null);
    insertGroupIntoAnother("GoToMenu", "jetbrains.mps.ide.actions.Goto_ActionGroup", null);
    insertGroupIntoAnother("ToolsMenu", "jetbrains.mps.ide.actions.Tools_ActionGroup", null);
    insertGroupIntoAnother(NodeActions_ActionGroup.ID, "jetbrains.mps.ide.actions.NodeActionsInternal_ActionGroup", null);
    insertGroupIntoAnother(LanguageNewActions_ActionGroup.ID, "jetbrains.mps.ide.actions.LanguageNewCustomPartActions_ActionGroup", LanguageNewActions_ActionGroup.LABEL_ID_newAspect);
    insertGroupIntoAnother("BuildMenu", "jetbrains.mps.ide.actions.Build_ActionGroup", null);
    insertGroupIntoAnother(FileActions_ActionGroup.ID, "jetbrains.mps.ide.actions.AbstractFileActions_ActionGroup", FileActions_ActionGroup.LABEL_ID_abstractFileActions);
    insertGroupIntoAnother(FolderActions_ActionGroup.ID, "jetbrains.mps.ide.actions.AbstractFileActions_ActionGroup", FolderActions_ActionGroup.LABEL_ID_abstractFileActions);
    insertGroupIntoAnother(ModuleActions_ActionGroup.ID, "jetbrains.mps.ide.actions.AbstractFileActions_ActionGroup", ModuleActions_ActionGroup.LABEL_ID_abstractFileActions);
    insertGroupIntoAnother(LanguageActions_ActionGroup.ID, "jetbrains.mps.ide.actions.LanguageRefactoring_ActionGroup", LanguageActions_ActionGroup.LABEL_ID_refactoring);
    insertGroupIntoAnother(SolutionActions_ActionGroup.ID, "jetbrains.mps.ide.actions.SolutionRefactoring_ActionGroup", SolutionActions_ActionGroup.LABEL_ID_refactoring);
    insertGroupIntoAnother(NamespaceActions_ActionGroup.ID, "jetbrains.mps.ide.actions.NamespaceInternalActions_ActionGroup", NamespaceActions_ActionGroup.LABEL_ID_namespaceInternal);
    insertGroupIntoAnother(EditorPopup_ActionGroup.ID, "jetbrains.mps.ide.actions.Bookmarks_ActionGroup", null);
    insertGroupIntoAnother(ModelActions_ActionGroup.ID, "jetbrains.mps.ide.actions.ModelRefactoring_ActionGroup", ModelActions_ActionGroup.LABEL_ID_refactoring);
    insertGroupIntoAnother(ModelNewActions_ActionGroup.ID, "jetbrains.mps.ide.actions.CreateRootNode_ActionGroup", ModelNewActions_ActionGroup.LABEL_ID_newRoot);
    insertGroupIntoAnother(PackageNewActions_ActionGroup.ID, "jetbrains.mps.ide.actions.CreateRootNode_ActionGroup", null);
    insertGroupIntoAnother(LanguageActions_ActionGroup.ID, "jetbrains.mps.ide.actions.GenerateModule_ActionGroup", LanguageActions_ActionGroup.LABEL_ID_generateModule);
    insertGroupIntoAnother(SolutionActions_ActionGroup.ID, "jetbrains.mps.ide.actions.GenerateModule_ActionGroup", SolutionActions_ActionGroup.LABEL_ID_generateModule);
    insertGroupIntoAnother(Generate_ActionGroup.ID, "jetbrains.mps.ide.actions.GenerateModule_ActionGroup", Generate_ActionGroup.LABEL_ID_generateModule);
    insertGroupIntoAnother(Generate_ActionGroup.ID, "jetbrains.mps.ide.actions.GenerateModels_ActionGroup", Generate_ActionGroup.LABEL_ID_generateModel);
    insertGroupIntoAnother(EditorPopup_ActionGroup.ID, "jetbrains.mps.ide.actions.GenerateModels_ActionGroup", EditorPopup_ActionGroup.LABEL_ID_generateModel);
    insertGroupIntoAnother("MPSToolbarRunGroup", "jetbrains.mps.ide.actions.GenerateModels_ActionGroup", null);
    insertGroupIntoAnother(Generate_ActionGroup.ID, "jetbrains.mps.ide.actions.SaveTransientModels_ActionGroup", Generate_ActionGroup.LABEL_ID_saveTransientModels);
    insertGroupIntoAnother(EditorPopup_ActionGroup.ID, "jetbrains.mps.ide.actions.GoByReference_ActionGroup", EditorPopup_ActionGroup.LABEL_ID_goByRef);
    insertGroupIntoAnother(ModelActions_ActionGroup.ID, "jetbrains.mps.ide.actions.ModelNewActions_ActionGroup", ModelActions_ActionGroup.LABEL_ID_newActions);
    insertGroupIntoAnother(PackageActions_ActionGroup.ID, "jetbrains.mps.ide.actions.PackageNewActions_ActionGroup", PackageActions_ActionGroup.LABEL_ID_newActions);
    insertGroupIntoAnother(EditorPopup_ActionGroup.ID, "jetbrains.mps.ide.actions.Breakpoints_ActionGroup", null);
    insertGroupIntoAnother(AbstractFileActions_ActionGroup.ID, "jetbrains.mps.ide.actions.FileSystemNewActions_ActionGroup", AbstractFileActions_ActionGroup.LABEL_ID_new);
    insertGroupIntoAnother(FavoritesPopupWrapper_ActionGroup.ID, "jetbrains.mps.ide.actions.FavoritesPopup_ActionGroup", null);
    insertGroupIntoAnother(FavoritesPopup_ActionGroup.ID, "jetbrains.mps.ide.actions.AddToFavoritesGroup_ActionGroup", FavoritesPopup_ActionGroup.LABEL_ID_addToFavorites);
    insertGroupIntoAnother(Favorites_ActionGroup.ID, "jetbrains.mps.ide.actions.FavoritesPopupWrapper_ActionGroup", Favorites_ActionGroup.LABEL_ID_popup);
    insertGroupIntoAnother(NodeActions_ActionGroup.ID, "jetbrains.mps.ide.actions.Favorites_ActionGroup", NodeActions_ActionGroup.LABEL_ID_favorites);
    insertGroupIntoAnother(LanguageActions_ActionGroup.ID, "jetbrains.mps.ide.actions.Favorites_ActionGroup", LanguageActions_ActionGroup.LABEL_ID_favorites);
    insertGroupIntoAnother(SolutionActions_ActionGroup.ID, "jetbrains.mps.ide.actions.Favorites_ActionGroup", SolutionActions_ActionGroup.LABEL_ID_favorites);
    insertGroupIntoAnother(GeneratorActions_ActionGroup.ID, "jetbrains.mps.ide.actions.Favorites_ActionGroup", GeneratorActions_ActionGroup.LABEL_ID_favorites);
    insertGroupIntoAnother(ModelActions_ActionGroup.ID, "jetbrains.mps.ide.actions.Favorites_ActionGroup", ModelActions_ActionGroup.LABEL_ID_favorites);
    insertGroupIntoAnother(Favorites_ActionGroup.ID, "jetbrains.mps.ide.actions.GenerateFavorites_ActionGroup", Favorites_ActionGroup.LABEL_ID_generate);
    insertGroupIntoAnother("RunMenu", "jetbrains.mps.ide.actions.DebugRunMenu_ActionGroup", null);
    insertGroupIntoAnother("SearchMenu", "jetbrains.mps.ide.actions.Search_ActionGroup", null);
    insertGroupIntoAnother("EditorActions", "jetbrains.mps.ide.actions.InEditorActions_ActionGroup", null);
    insertGroupIntoAnother(EditorPopup_ActionGroup.ID, "jetbrains.mps.ide.actions.Folding_ActionGroup", EditorPopup_ActionGroup.LABEL_ID_folding);
    insertGroupIntoAnother("CodeMenu", "jetbrains.mps.ide.actions.Code_ActionGroup", null);
  }
