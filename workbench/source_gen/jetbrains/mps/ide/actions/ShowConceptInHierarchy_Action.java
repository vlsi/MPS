...
/*
    if (!(((IEditor) MapSequence.fromMap(_params).get("editor")) instanceof OldTabbedEditor)) {
      return null;
    }
    OldTabbedEditor tabbedEditor = (OldTabbedEditor) ((IEditor) MapSequence.fromMap(_params).get("editor"));
