...
public class RedirectOutputExpression extends Expression {
  public static final String concept = "jetbrains.mps.run.commands.structure.RedirectOutputExpression";
  ...
  public static RedirectOutputExpression newInstance(SModel sm, boolean init) {
    return (RedirectOutputExpression) SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.run.commands.structure.RedirectOutputExpression", sm, GlobalScope.getInstance(), init).getAdapter();
  }
