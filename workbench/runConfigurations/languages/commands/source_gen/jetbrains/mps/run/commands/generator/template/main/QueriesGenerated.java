package jetbrains.mps.run.commands.generator.template.main;
...
import jetbrains.mps.run.commands.behavior.ReportErrorStatement_Behavior;
...
public class QueriesGenerated {
  public static boolean baseMappingRule_Condition_865001690840234050(final IOperationContext operationContext, final BaseMappingRuleContext _context) {
    return (TypeChecker.getInstance().getRuntimeSupport().coerce_(TypeChecker.getInstance().getTypeOf(SLinkOperations.getTarget(_context.getNode(), "operand", true)), HUtil.createMatchingPatternByConceptFQName("jetbrains.mps.run.commands.structure.CommandType"), true) != null) && SNodeOperations.isInstanceOf(SLinkOperations.getTarget(_context.getNode(), "operation", true), "jetbrains.mps.run.commands.structure.CommandDebuggerOperation");
  }
  ...
  public static boolean baseMappingRule_Condition_865001690840234071(final IOperationContext operationContext, final BaseMappingRuleContext _context) {
    return (TypeChecker.getInstance().getRuntimeSupport().coerce_(TypeChecker.getInstance().getTypeOf(SLinkOperations.getTarget(_context.getNode(), "operand", true)), HUtil.createMatchingPatternByConceptFQName("jetbrains.mps.run.commands.structure.CommandType"), true) != null) && SNodeOperations.isInstanceOf(SLinkOperations.getTarget(_context.getNode(), "operation", true), "jetbrains.mps.baseLanguage.classifiers.structure.DefaultClassifierMethodCallOperation") && SNodeOperations.isInstanceOf(SLinkOperations.getTarget(SNodeOperations.cast(SLinkOperations.getTarget(_context.getNode(), "operation", true), "jetbrains.mps.baseLanguage.classifiers.structure.DefaultClassifierMethodCallOperation"), "member", false), "jetbrains.mps.run.commands.structure.CommandMethod");
  }
  ...
  public static SNode sourceNodeQuery_865001690840233661(final IOperationContext operationContext, final SourceSubstituteMacroNodeContext _context) {
    return SLinkOperations.getTarget(SNodeOperations.cast(_context.getNode(), "jetbrains.mps.run.commands.structure.ProcessBuilderPart"), "expression", true);
  }
  ...
  public static SNode sourceNodeQuery_865001690840233702(final IOperationContext operationContext, final SourceSubstituteMacroNodeContext _context) {
    return TypeChecker.getInstance().getTypeOf(SLinkOperations.getTarget(SNodeOperations.cast(_context.getNode(), "jetbrains.mps.run.commands.structure.ProcessBuilderKeyPart"), "key", true));
  }
  ...
  public static SNode sourceNodeQuery_865001690840233713(final IOperationContext operationContext, final SourceSubstituteMacroNodeContext _context) {
    return SLinkOperations.getTarget(SNodeOperations.cast(_context.getNode(), "jetbrains.mps.run.commands.structure.ProcessBuilderKeyPart"), "key", true);
  }
  ...
  public static SNode sourceNodeQuery_865001690840233754(final IOperationContext operationContext, final SourceSubstituteMacroNodeContext _context) {
    return TypeChecker.getInstance().getTypeOf(SLinkOperations.getTarget(SNodeOperations.cast(_context.getNode(), "jetbrains.mps.run.commands.structure.ProcessBuilderKeyPart"), "value", true));
  }
  ...
  public static SNode sourceNodeQuery_865001690840233765(final IOperationContext operationContext, final SourceSubstituteMacroNodeContext _context) {
    return SLinkOperations.getTarget(SNodeOperations.cast(_context.getNode(), "jetbrains.mps.run.commands.structure.ProcessBuilderKeyPart"), "value", true);
  }
  ...
  public static Iterable sourceNodesQuery_865001690840233681(final IOperationContext operationContext, final SourceSubstituteMacroNodesContext _context) {
    return ListSequence.fromList(SLinkOperations.getTargets(_context.getNode(), "part", true)).where(new IWhereFilter<SNode>() {
      public boolean accept(SNode it) {
        return SNodeOperations.isInstanceOf(it, "jetbrains.mps.run.commands.structure.ProcessBuilderPart");
      }
    });
  }
  ...
  public static Iterable sourceNodesQuery_865001690840233733(final IOperationContext operationContext, final SourceSubstituteMacroNodesContext _context) {
    return ListSequence.fromList(SLinkOperations.getTargets(_context.getNode(), "part", true)).where(new IWhereFilter<SNode>() {
      public boolean accept(SNode it) {
        return SNodeOperations.isInstanceOf(it, "jetbrains.mps.run.commands.structure.ProcessBuilderKeyPart");
      }
    });
  }
  ...
  public static SNode mapSrcMacro_mapper_865001690840233348(final IOperationContext operationContext, final MapSrcMacroContext _context) {
    ...
    for (SNode argument : ListSequence.fromList(SLinkOperations.getTargets(_context.getNode(), "argument", true)).where(new IWhereFilter<SNode>() {
      ...
      AttributeOperations.createAndSetAttrbiute(ref, new IAttributeDescriptor.NodeAttribute(SConceptOperations.findConceptDeclaration("jetbrains.mps.run.commands.structure.BuilderParameter")), "jetbrains.mps.run.commands.structure.BuilderParameter");
  ...
  public static SNode mapSrcMacro_mapper_865001690840233807(final IOperationContext operationContext, final MapSrcMacroContext _context) {
    ...
    for (SNode part : ListSequence.fromList(SLinkOperations.getTargets(_context.getNode(), "part", true))) {
      if (SNodeOperations.isInstanceOf(part, "jetbrains.mps.run.commands.structure.ProcessBuilderPart")) {
      ...
      } else if (SNodeOperations.isInstanceOf(part, "jetbrains.mps.run.commands.structure.ProcessBuilderKeyPart")) {
        ...
        AttributeOperations.createAndSetAttrbiute(keyRef, new IAttributeDescriptor.NodeAttribute(SConceptOperations.findConceptDeclaration("jetbrains.mps.run.commands.structure.BuilderParameter")), "jetbrains.mps.run.commands.structure.BuilderParameter");
        AttributeOperations.createAndSetAttrbiute(valueRef, new IAttributeDescriptor.NodeAttribute(SConceptOperations.findConceptDeclaration("jetbrains.mps.run.commands.structure.BuilderParameter")), "jetbrains.mps.run.commands.structure.BuilderParameter");
  ...
  public static void mapSrcMacro_post_mapper_865001690840233535(final IOperationContext operationContext, final MapSrcMacroPostProcContext _context) {
    Iterable<SNode> references = ListSequence.fromList(SNodeOperations.getDescendants(_context.getOutputNode(), "jetbrains.mps.baseLanguage.structure.LocalVariableReference", false, new String[]{})).where(new IWhereFilter<SNode>() {
      public boolean accept(SNode it) {
        return (AttributeOperations.getAttribute(it, new IAttributeDescriptor.NodeAttribute(SConceptOperations.findConceptDeclaration("jetbrains.mps.run.commands.structure.BuilderParameter"))) != null);
      }
    });
    ...
    AttributeOperations.createAndSetAttrbiute(_context.getOutputNode(), new IAttributeDescriptor.NodeAttribute(SConceptOperations.findConceptDeclaration("jetbrains.mps.run.commands.structure.BuilderBlockStatement")), "jetbrains.mps.run.commands.structure.BuilderBlockStatement");
  }
  ...
  public static void mappingScript_CodeBlock_865001690840234106(final IOperationContext operationContext, final MappingScriptContext _context) {
    for (SNode commandRef : ListSequence.fromList(SModelOperations.getNodes(_context.getModel(), "jetbrains.mps.run.commands.structure.CommandParameterReference"))) {
  ...
  public static void mappingScript_CodeBlock_865001690840234128(final IOperationContext operationContext, final MappingScriptContext _context) {
    for (SNode blockStatement : ListSequence.fromList(SModelOperations.getNodes(_context.getModel(), "jetbrains.mps.baseLanguage.structure.BlockStatement")).where(new IWhereFilter<SNode>() {
      public boolean accept(SNode it) {
        return (AttributeOperations.getAttribute(it, new IAttributeDescriptor.NodeAttribute(SConceptOperations.findConceptDeclaration("jetbrains.mps.run.commands.structure.BuilderBlockStatement"))) != null);
      }
    })) {
