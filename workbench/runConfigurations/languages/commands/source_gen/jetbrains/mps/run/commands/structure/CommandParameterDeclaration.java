...
public class CommandParameterDeclaration extends VariableDeclaration {
  public static final String concept = "jetbrains.mps.run.commands.structure.CommandParameterDeclaration";
  ...
  public static CommandParameterDeclaration newInstance(SModel sm, boolean init) {
    return (CommandParameterDeclaration) SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.run.commands.structure.CommandParameterDeclaration", sm, GlobalScope.getInstance(), init).getAdapter();
  }
