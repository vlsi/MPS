...
public class CommandReferenceExpression extends Expression {
  public static final String concept = "jetbrains.mps.run.commands.structure.CommandReferenceExpression";
  ...
  public static CommandReferenceExpression newInstance(SModel sm, boolean init) {
    return (CommandReferenceExpression) SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.run.commands.structure.CommandReferenceExpression", sm, GlobalScope.getInstance(), init).getAdapter();
  }
