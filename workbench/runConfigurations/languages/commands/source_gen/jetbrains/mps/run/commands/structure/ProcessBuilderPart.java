...
public class ProcessBuilderPart extends AbstractProcessBuilderPart {
  public static final String concept = "jetbrains.mps.run.commands.structure.ProcessBuilderPart";
  ...
  public static ProcessBuilderPart newInstance(SModel sm, boolean init) {
    return (ProcessBuilderPart) SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.run.commands.structure.ProcessBuilderPart", sm, GlobalScope.getInstance(), init).getAdapter();
  }
