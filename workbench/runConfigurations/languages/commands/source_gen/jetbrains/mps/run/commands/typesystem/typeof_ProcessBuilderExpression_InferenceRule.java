  ...
  public void applyRule(final SNode processBuilderExpression, final TypeCheckingContext typeCheckingContext, IsApplicableStatus status) {
    {
      ...
      EquationInfo _info_12389875345 = new EquationInfo(_nodeToCheck_1029348928467, null, "r:3eecec87-82a4-4ea1-952b-7d3a8d81c769(jetbrains.mps.run.commands.typesystem)", "946964771156863772", 0, intentionProvider);
      typeCheckingContext.createEquation((SNode) typeCheckingContext.typeOf(_nodeToCheck_1029348928467, "r:3eecec87-82a4-4ea1-952b-7d3a8d81c769(jetbrains.mps.run.commands.typesystem)", "946964771156863777", true), (SNode) new typeof_ProcessBuilderExpression_InferenceRule.QuotationClass_31rd6s_a0a0a0().createNode(typeCheckingContext), _info_12389875345);
    }
    {
      SNode _nodeToCheck_1029348928467 = SLinkOperations.getTarget(processBuilderExpression, "workingDirectory", true);
      BaseQuickFixProvider intentionProvider = null;
      EquationInfo _info_12389875345 = new EquationInfo(_nodeToCheck_1029348928467, null, "r:3eecec87-82a4-4ea1-952b-7d3a8d81c769(jetbrains.mps.run.commands.typesystem)", "946964771156863779", 0, intentionProvider);
      typeCheckingContext.createLessThanInequationStrong((SNode) typeCheckingContext.typeOf(_nodeToCheck_1029348928467, "r:3eecec87-82a4-4ea1-952b-7d3a8d81c769(jetbrains.mps.run.commands.typesystem)", "946964771156863785", true), (SNode) new typeof_ProcessBuilderExpression_InferenceRule.QuotationClass_31rd6s_a0a1a0().createNode(typeCheckingContext), false, _info_12389875345);
    }
  }
