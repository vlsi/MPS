...
public class CommandParameterReference extends Expression {
  public static final String concept = "jetbrains.mps.run.commands.structure.CommandParameterReference";
  ...
  public static CommandParameterReference newInstance(SModel sm, boolean init) {
    return (CommandParameterReference) SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.run.commands.structure.CommandParameterReference", sm, GlobalScope.getInstance(), init).getAdapter();
  }
