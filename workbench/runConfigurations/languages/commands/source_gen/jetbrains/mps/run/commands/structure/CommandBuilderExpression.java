...
public class CommandBuilderExpression extends Expression {
  public static final String concept = "jetbrains.mps.run.commands.structure.CommandBuilderExpression";
  ...
  public static CommandBuilderExpression newInstance(SModel sm, boolean init) {
    return (CommandBuilderExpression) SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.run.commands.structure.CommandBuilderExpression", sm, GlobalScope.getInstance(), init).getAdapter();
  }
