...
public class CommandDeclaration extends BaseConcept implements INamedConcept, IClassifier, IMethodLike, IGeneratedToClass {
  public static final String concept = "jetbrains.mps.run.commands.structure.CommandDeclaration";
  ...
  public static CommandDeclaration newInstance(SModel sm, boolean init) {
    return (CommandDeclaration) SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.run.commands.structure.CommandDeclaration", sm, GlobalScope.getInstance(), init).getAdapter();
  }
