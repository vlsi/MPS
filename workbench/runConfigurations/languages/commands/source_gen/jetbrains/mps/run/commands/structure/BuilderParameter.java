...
public class BuilderParameter extends NodeAttribute {
  public static final String concept = "jetbrains.mps.run.commands.structure.BuilderParameter";
  ...
  public static BuilderParameter newInstance(SModel sm, boolean init) {
    return (BuilderParameter) SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.run.commands.structure.BuilderParameter", sm, GlobalScope.getInstance(), init).getAdapter();
  }
