...
public class CommandType extends DefaultClassifierType {
  public static final String concept = "jetbrains.mps.run.commands.structure.CommandType";
  ...
  public static CommandType newInstance(SModel sm, boolean init) {
    return (CommandType) SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.run.commands.structure.CommandType", sm, GlobalScope.getInstance(), init).getAdapter();
  }
