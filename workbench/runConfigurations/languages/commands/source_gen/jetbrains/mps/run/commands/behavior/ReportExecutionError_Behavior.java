...
public class ReportExecutionError_Behavior {
  ...
  public static SNode call_getException_856705193941282173(SNode thisNode) {
    return (SNode) BehaviorManager.getInstance().invoke(Object.class, SNodeOperations.cast(thisNode, "jetbrains.mps.run.commands.structure.ReportExecutionError"), "virtual_getException_856705193941282181", PARAMETERS_856705193941282173);
  }

  public static SNode callSuper_getException_856705193941282173(SNode thisNode, String callerConceptFqName) {
    return (SNode) BehaviorManager.getInstance().invokeSuper(Object.class, SNodeOperations.cast(thisNode, "jetbrains.mps.run.commands.structure.ReportExecutionError"), callerConceptFqName, "virtual_getException_856705193941282181", PARAMETERS_856705193941282173);
  }
