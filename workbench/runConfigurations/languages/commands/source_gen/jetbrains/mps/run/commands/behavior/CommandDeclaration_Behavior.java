...
public class CommandDeclaration_Behavior {
  ...
  public static SNode call_createType_856705193941282121(SNode thisNode) {
    return (SNode) BehaviorManager.getInstance().invoke(Object.class, SNodeOperations.cast(thisNode, "jetbrains.mps.run.commands.structure.CommandDeclaration"), "virtual_createType_1213877527970", PARAMETERS_856705193941282121);
  }

  public static List<SNode> call_getThrowableTypes_856705193941282132(SNode thisNode) {
    return (List<SNode>) BehaviorManager.getInstance().invoke(Object.class, SNodeOperations.cast(thisNode, "jetbrains.mps.run.commands.structure.CommandDeclaration"), "virtual_getThrowableTypes_6204026822016975623", PARAMETERS_856705193941282132);
  }

  public static SNode call_getBody_856705193941282142(SNode thisNode) {
    return (SNode) BehaviorManager.getInstance().invoke(Object.class, SNodeOperations.cast(thisNode, "jetbrains.mps.run.commands.structure.CommandDeclaration"), "virtual_getBody_1239354440022", PARAMETERS_856705193941282142);
  }

  public static SNode call_getExpectedRetType_856705193941282152(SNode thisNode) {
    return (SNode) BehaviorManager.getInstance().invoke(Object.class, SNodeOperations.cast(thisNode, "jetbrains.mps.run.commands.structure.CommandDeclaration"), "virtual_getExpectedRetType_1239354342632", PARAMETERS_856705193941282152);
  }
  ...
  public static SNode callSuper_createType_856705193941282121(SNode thisNode, String callerConceptFqName) {
    return (SNode) BehaviorManager.getInstance().invokeSuper(Object.class, SNodeOperations.cast(thisNode, "jetbrains.mps.run.commands.structure.CommandDeclaration"), callerConceptFqName, "virtual_createType_1213877527970", PARAMETERS_856705193941282121);
  }

  public static List<SNode> callSuper_getThrowableTypes_856705193941282132(SNode thisNode, String callerConceptFqName) {
    return (List<SNode>) BehaviorManager.getInstance().invokeSuper(Object.class, SNodeOperations.cast(thisNode, "jetbrains.mps.run.commands.structure.CommandDeclaration"), callerConceptFqName, "virtual_getThrowableTypes_6204026822016975623", PARAMETERS_856705193941282132);
  }

  public static SNode callSuper_getBody_856705193941282142(SNode thisNode, String callerConceptFqName) {
    return (SNode) BehaviorManager.getInstance().invokeSuper(Object.class, SNodeOperations.cast(thisNode, "jetbrains.mps.run.commands.structure.CommandDeclaration"), callerConceptFqName, "virtual_getBody_1239354440022", PARAMETERS_856705193941282142);
  }

  public static SNode callSuper_getExpectedRetType_856705193941282152(SNode thisNode, String callerConceptFqName) {
    return (SNode) BehaviorManager.getInstance().invokeSuper(Object.class, SNodeOperations.cast(thisNode, "jetbrains.mps.run.commands.structure.CommandDeclaration"), callerConceptFqName, "virtual_getExpectedRetType_1239354342632", PARAMETERS_856705193941282152);
  }
