  ...
  public void applyRule(final SNode commandParameterReference, final TypeCheckingContext typeCheckingContext, IsApplicableStatus status) {
    {
      ...
      EquationInfo _info_12389875345 = new EquationInfo(_nodeToCheck_1029348928467, null, "r:3eecec87-82a4-4ea1-952b-7d3a8d81c769(jetbrains.mps.run.commands.typesystem)", "946964771156863728", 0, intentionProvider);
      typeCheckingContext.createEquation((SNode) typeCheckingContext.typeOf(_nodeToCheck_1029348928467, "r:3eecec87-82a4-4ea1-952b-7d3a8d81c769(jetbrains.mps.run.commands.typesystem)", "946964771156863736", true), (SNode) SLinkOperations.getTarget(SLinkOperations.getTarget(commandParameterReference, "parameter", false), "type", true), _info_12389875345);
    }
  }
