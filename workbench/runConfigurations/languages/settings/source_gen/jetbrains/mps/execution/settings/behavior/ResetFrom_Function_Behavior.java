...
public class ResetFrom_Function_Behavior {
  ...
  public static SNode call_getJavaMethod_946964771156067021(SNode thisNode) {
    return (SNode) BehaviorManager.getInstance().invoke(Object.class, SNodeOperations.cast(thisNode, "jetbrains.mps.execution.settings.structure.ResetFrom_Function"), "virtual_getJavaMethod_946964771156066991", PARAMETERS_946964771156067021);
  }

  public static SNode call_getPublicJavaMethod_203908296139519720(SNode thisNode) {
    return (SNode) BehaviorManager.getInstance().invoke(Object.class, SNodeOperations.cast(thisNode, "jetbrains.mps.execution.settings.structure.ResetFrom_Function"), "virtual_getPublicJavaMethod_203908296139519011", PARAMETERS_203908296139519720);
  }
