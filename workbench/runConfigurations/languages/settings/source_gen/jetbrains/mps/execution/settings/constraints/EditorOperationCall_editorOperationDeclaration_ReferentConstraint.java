...
public class EditorOperationCall_editorOperationDeclaration_ReferentConstraint extends BaseNodeReferenceSearchScopeProvider implements IModelConstraints {
  public EditorOperationCall_editorOperationDeclaration_ReferentConstraint() {
  }

  public void registerSelf(ModelConstraintsManager manager) {
    manager.registerNodeReferentSearchScopeProvider("jetbrains.mps.execution.settings.structure.EditorOperationCall", "editorOperationDeclaration", this);
  }

  public void unRegisterSelf(ModelConstraintsManager manager) {
    manager.unRegisterNodeReferentSearchScopeProvider("jetbrains.mps.execution.settings.structure.EditorOperationCall", "editorOperationDeclaration");
  }
