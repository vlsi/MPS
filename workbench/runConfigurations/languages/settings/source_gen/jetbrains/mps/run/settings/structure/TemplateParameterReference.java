...
public class TemplateParameterReference extends VariableReference {
  public static final String concept = "jetbrains.mps.run.settings.structure.TemplateParameterReference";
  ...
  public static TemplateParameterReference newInstance(SModel sm, boolean init) {
    return (TemplateParameterReference) SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.run.settings.structure.TemplateParameterReference", sm, GlobalScope.getInstance(), init).getAdapter();
  }
