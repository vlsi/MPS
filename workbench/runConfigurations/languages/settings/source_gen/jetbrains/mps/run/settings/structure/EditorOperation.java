...
public class EditorOperation extends BaseConcept implements IOperation {
  public static final String concept = "jetbrains.mps.run.settings.structure.EditorOperation";
  ...
  public static EditorOperation newInstance(SModel sm, boolean init) {
    return (EditorOperation) SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.run.settings.structure.EditorOperation", sm, GlobalScope.getInstance(), init).getAdapter();
  }
