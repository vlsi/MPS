...
public class ResetFrom_Function extends EditorOperationDeclaration {
  public static final String concept = "jetbrains.mps.run.settings.structure.ResetFrom_Function";
  ...
  public static ResetFrom_Function newInstance(SModel sm, boolean init) {
    return (ResetFrom_Function) SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.run.settings.structure.ResetFrom_Function", sm, GlobalScope.getInstance(), init).getAdapter();
  }
