...
public class TemplatePersistentPropertyType extends Type {
  public static final String concept = "jetbrains.mps.run.settings.structure.TemplatePersistentPropertyType";
  ...
  public static TemplatePersistentPropertyType newInstance(SModel sm, boolean init) {
    return (TemplatePersistentPropertyType) SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.run.settings.structure.TemplatePersistentPropertyType", sm, GlobalScope.getInstance(), init).getAdapter();
  }
