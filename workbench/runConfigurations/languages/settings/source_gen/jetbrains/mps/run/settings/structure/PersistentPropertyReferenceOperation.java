...
public class PersistentPropertyReferenceOperation extends BaseConcept implements IOperation {
  public static final String concept = "jetbrains.mps.run.settings.structure.PersistentPropertyReferenceOperation";
  ...
  public static PersistentPropertyReferenceOperation newInstance(SModel sm, boolean init) {
    return (PersistentPropertyReferenceOperation) SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.run.settings.structure.PersistentPropertyReferenceOperation", sm, GlobalScope.getInstance(), init).getAdapter();
  }
