...
public class ApplyTo_Function extends EditorOperationDeclaration {
  public static final String concept = "jetbrains.mps.run.settings.structure.ApplyTo_Function";
  ...
  public static ApplyTo_Function newInstance(SModel sm, boolean init) {
    return (ApplyTo_Function) SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.run.settings.structure.ApplyTo_Function", sm, GlobalScope.getInstance(), init).getAdapter();
  }
