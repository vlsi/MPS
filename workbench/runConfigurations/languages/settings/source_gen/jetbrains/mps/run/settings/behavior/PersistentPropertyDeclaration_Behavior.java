...
public class PersistentPropertyDeclaration_Behavior {
  ...
  public static SNode call_getTemplate_946964771156066964(SNode thisNode) {
    ...
    return SLinkOperations.getTarget(TypeChecker.getInstance().getRuntimeSupport().coerce_(SLinkOperations.getTarget(thisNode, "type", true), HUtil.createMatchingPatternByConceptFQName("jetbrains.mps.run.settings.structure.TemplatePersistentPropertyType"), true), "propertyTemplate", false);
  }

  public static boolean call_isInitializable_946964771156066897(SNode thisNode) {
    return (Boolean) BehaviorManager.getInstance().invoke(Boolean.class, SNodeOperations.cast(thisNode, "jetbrains.mps.run.settings.structure.PersistentPropertyDeclaration"), "virtual_isInitializable_1213877517488", PARAMETERS_946964771156066897);
  }

  public static boolean callSuper_isInitializable_946964771156066897(SNode thisNode, String callerConceptFqName) {
    return (Boolean) BehaviorManager.getInstance().invokeSuper(Boolean.class, SNodeOperations.cast(thisNode, "jetbrains.mps.run.settings.structure.PersistentPropertyDeclaration"), callerConceptFqName, "virtual_isInitializable_1213877517488", PARAMETERS_946964771156066897);
  }
