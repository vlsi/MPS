...
public class EditorPropertyReference extends VariableReference {
  public static final String concept = "jetbrains.mps.run.settings.structure.EditorPropertyReference";
  ...
  public static EditorPropertyReference newInstance(SModel sm, boolean init) {
    return (EditorPropertyReference) SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.run.settings.structure.EditorPropertyReference", sm, GlobalScope.getInstance(), init).getAdapter();
  }
