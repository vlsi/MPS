...
public class PersistentConfigurationType extends BaseClassifierType {
  public static final String concept = "jetbrains.mps.run.settings.structure.PersistentConfigurationType";
  ...
  public static PersistentConfigurationType newInstance(SModel sm, boolean init) {
    return (PersistentConfigurationType) SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.run.settings.structure.PersistentConfigurationType", sm, GlobalScope.getInstance(), init).getAdapter();
  }
