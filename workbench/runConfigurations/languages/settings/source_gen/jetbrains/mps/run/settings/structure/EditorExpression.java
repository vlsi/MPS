...
public class EditorExpression extends Expression {
  public static final String concept = "jetbrains.mps.run.settings.structure.EditorExpression";
  ...
  public static EditorExpression newInstance(SModel sm, boolean init) {
    return (EditorExpression) SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.run.settings.structure.EditorExpression", sm, GlobalScope.getInstance(), init).getAdapter();
  }
