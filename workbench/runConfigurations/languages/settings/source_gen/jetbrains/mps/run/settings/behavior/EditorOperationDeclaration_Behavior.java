...
public class EditorOperationDeclaration_Behavior {
  ...
  public static SNode call_getJavaMethod_946964771156066991(SNode thisNode) {
    return (SNode) BehaviorManager.getInstance().invoke(Object.class, SNodeOperations.cast(thisNode, "jetbrains.mps.run.settings.structure.EditorOperationDeclaration"), "virtual_getJavaMethod_946964771156066991", PARAMETERS_946964771156066991);
  }

  public static SNode callSuper_getJavaMethod_946964771156066991(SNode thisNode, String callerConceptFqName) {
    return (SNode) BehaviorManager.getInstance().invokeSuper(Object.class, SNodeOperations.cast(thisNode, "jetbrains.mps.run.settings.structure.EditorOperationDeclaration"), callerConceptFqName, "virtual_getJavaMethod_946964771156066991", PARAMETERS_946964771156066991);
  }
}
