...
public class CreateEditor_Function extends EditorOperationDeclaration {
  public static final String concept = "jetbrains.mps.run.settings.structure.CreateEditor_Function";
  ...
  public static CreateEditor_Function newInstance(SModel sm, boolean init) {
    return (CreateEditor_Function) SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.run.settings.structure.CreateEditor_Function", sm, GlobalScope.getInstance(), init).getAdapter();
  }
