...
public class PersistentConfigurationTemplateInitializer extends AbstractCreator {
  public static final String concept = "jetbrains.mps.run.settings.structure.PersistentConfigurationTemplateInitializer";
  ...
  public static PersistentConfigurationTemplateInitializer newInstance(SModel sm, boolean init) {
    return (PersistentConfigurationTemplateInitializer) SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.run.settings.structure.PersistentConfigurationTemplateInitializer", sm, GlobalScope.getInstance(), init).getAdapter();
  }
