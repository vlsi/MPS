...
public class ThisExpression extends Expression implements IThisExpression {
  public static final String concept = "jetbrains.mps.runConfigurations.structure.ThisExpression";
  ...
  public static ThisExpression newInstance(SModel sm, boolean init) {
    return (ThisExpression) SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.runConfigurations.structure.ThisExpression", sm, GlobalScope.getInstance(), init).getAdapter();
  }
