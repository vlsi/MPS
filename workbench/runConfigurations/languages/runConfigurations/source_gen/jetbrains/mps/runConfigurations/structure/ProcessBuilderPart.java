...
public class ProcessBuilderPart extends BaseConcept {
  public static final String concept = "jetbrains.mps.runConfigurations.structure.ProcessBuilderPart";
  ...
  public static ProcessBuilderPart newInstance(SModel sm, boolean init) {
    return (ProcessBuilderPart) SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.runConfigurations.structure.ProcessBuilderPart", sm, GlobalScope.getInstance(), init).getAdapter();
  }
