...
public class SettingsEditorType extends Type {
  public static final String concept = "jetbrains.mps.runConfigurations.structure.SettingsEditorType";
  ...
  public static SettingsEditorType newInstance(SModel sm, boolean init) {
    return (SettingsEditorType) SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.runConfigurations.structure.SettingsEditorType", sm, GlobalScope.getInstance(), init).getAdapter();
  }
