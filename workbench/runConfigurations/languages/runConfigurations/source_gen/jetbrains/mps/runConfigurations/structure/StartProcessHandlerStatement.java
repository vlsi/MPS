...
public class StartProcessHandlerStatement extends StartStatement {
  public static final String concept = "jetbrains.mps.runConfigurations.structure.StartProcessHandlerStatement";
  ...
  public static StartProcessHandlerStatement newInstance(SModel sm, boolean init) {
    return (StartProcessHandlerStatement) SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.runConfigurations.structure.StartProcessHandlerStatement", sm, GlobalScope.getInstance(), init).getAdapter();
  }
