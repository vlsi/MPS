...
public class CommandBuilderExpression extends Expression {
  public static final String concept = "jetbrains.mps.runConfigurations.structure.CommandBuilderExpression";
  ...
  public static CommandBuilderExpression newInstance(SModel sm, boolean init) {
    return (CommandBuilderExpression) SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.runConfigurations.structure.CommandBuilderExpression", sm, GlobalScope.getInstance(), init).getAdapter();
  }
