...
public class PersistentConfigurationType extends BaseConcept {
  public static final String concept = "jetbrains.mps.runConfigurations.structure.PersistentConfigurationType";
  ...
  public static PersistentConfigurationType newInstance(SModel sm, boolean init) {
    return (PersistentConfigurationType) SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.runConfigurations.structure.PersistentConfigurationType", sm, GlobalScope.getInstance(), init).getAdapter();
  }
