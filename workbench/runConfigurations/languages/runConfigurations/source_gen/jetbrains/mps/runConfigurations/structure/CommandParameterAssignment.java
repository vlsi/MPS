...
public class CommandParameterAssignment extends BaseConcept {
  public static final String concept = "jetbrains.mps.runConfigurations.structure.CommandParameterAssignment";
  ...
  public static CommandParameterAssignment newInstance(SModel sm, boolean init) {
    return (CommandParameterAssignment) SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.runConfigurations.structure.CommandParameterAssignment", sm, GlobalScope.getInstance(), init).getAdapter();
  }
