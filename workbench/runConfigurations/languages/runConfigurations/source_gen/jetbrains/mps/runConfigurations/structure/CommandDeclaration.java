...
public class CommandDeclaration extends BaseConcept implements INamedConcept {
  ...
  public boolean getIsDebuggable() {
    return this.getBooleanProperty(CommandDeclaration.IS_DEBUGGABLE);
  }

  public void setIsDebuggable(boolean value) {
    this.setBooleanProperty(CommandDeclaration.IS_DEBUGGABLE, value);
  }
  ...
  public DebugSession_Function getDebug() {
    return (DebugSession_Function) this.getChild(DebugSession_Function.class, CommandDeclaration.DEBUG);
  }

  public void setDebug(DebugSession_Function node) {
    super.setChild(CommandDeclaration.DEBUG, node);
  }
