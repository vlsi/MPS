...
public class typeof_PersistentPropertyDeclaration_InferenceRule extends AbstractInferenceRule_Runtime implements InferenceRule_Runtime {
  ...
  public void applyRule(final SNode persistentPropertyDeclaration, final TypeCheckingContext typeCheckingContext, IsApplicableStatus status) {
    SNode primitive = SLinkOperations.getTarget(new typeof_PersistentPropertyDeclaration_InferenceRule.QuotationClass_sacma3_a0a0a0a().createNode(typeCheckingContext), "descriptor", false);
    {
      ...
      EquationInfo _info_12389875345 = new EquationInfo(_nodeToCheck_1029348928467, null, "r:8b43a830-217d-43d8-a0f8-6460c443f22d(jetbrains.mps.runConfigurations.typesystem)", "77193491200204439", 0, intentionProvider);
    ...
    public SNode createNode(Object parameter_13, final TypeCheckingContext typeCheckingContext) {
      ...
      SNode quotedNode_6 = null;
      {
        ...
        SNode quotedNode1_7 = quotedNode_1;
        {
          ...
          quotedNode1_8.addReference(SReference.create("classifier", quotedNode1_8, SModelReference.fromString("f:java_stub#java.lang(java.lang@java_stub)"), SNodeId.fromString("~Cloneable")));
        ...
        }
        {
          ...
          quotedNode1_9.addReference(SReference.create("classifier", quotedNode1_9, SModelReference.fromString("f:java_stub#java.lang(java.lang@java_stub)"), SNodeId.fromString("~Enum")));
        ...
        }
        {
          ...
          quotedNode1_10.addReference(SReference.create("classifier", quotedNode1_10, SModelReference.fromString("f:java_stub#java.lang(java.lang@java_stub)"), SNodeId.fromString("~String")));
