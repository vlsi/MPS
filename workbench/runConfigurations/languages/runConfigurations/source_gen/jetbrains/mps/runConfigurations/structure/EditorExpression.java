...
public class EditorExpression extends Expression {
  public static final String concept = "jetbrains.mps.runConfigurations.structure.EditorExpression";
  ...
  public static EditorExpression newInstance(SModel sm, boolean init) {
    return (EditorExpression) SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.runConfigurations.structure.EditorExpression", sm, GlobalScope.getInstance(), init).getAdapter();
  }
