...
public class ComplexRunConfigurationExecutor extends RunConfigurationExecutor {
  public static final String concept = "jetbrains.mps.runConfigurations.structure.ComplexRunConfigurationExecutor";
  ...
  public static ComplexRunConfigurationExecutor newInstance(SModel sm, boolean init) {
    return (ComplexRunConfigurationExecutor) SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.runConfigurations.structure.ComplexRunConfigurationExecutor", sm, GlobalScope.getInstance(), init).getAdapter();
  }
