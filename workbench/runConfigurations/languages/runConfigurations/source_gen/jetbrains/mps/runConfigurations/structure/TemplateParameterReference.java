...
public class TemplateParameterReference extends VariableReference {
  public static final String concept = "jetbrains.mps.runConfigurations.structure.TemplateParameterReference";
  ...
  public static TemplateParameterReference newInstance(SModel sm, boolean init) {
    return (TemplateParameterReference) SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.runConfigurations.structure.TemplateParameterReference", sm, GlobalScope.getInstance(), init).getAdapter();
  }
