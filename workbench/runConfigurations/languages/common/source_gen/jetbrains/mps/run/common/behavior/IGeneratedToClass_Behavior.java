...
public class IGeneratedToClass_Behavior {
  ...
  public static String call_getSuffix_946964771156905483(SNode thisNode) {
    return (String) BehaviorManager.getInstance().invoke(Object.class, SNodeOperations.cast(thisNode, "jetbrains.mps.run.common.structure.IGeneratedToClass"), "virtual_getSuffix_946964771156905483", PARAMETERS_946964771156905483);
  }

  public static String call_getGeneratedClassName_946964771156905488(SNode thisNode) {
    return (String) BehaviorManager.getInstance().invoke(Object.class, SNodeOperations.cast(thisNode, "jetbrains.mps.run.common.structure.IGeneratedToClass"), "virtual_getGeneratedClassName_946964771156905488", PARAMETERS_946964771156905488);
  }

  public static String call_getFullName_946964771156905503(SNode thisNode) {
    return (String) BehaviorManager.getInstance().invoke(Object.class, SNodeOperations.cast(thisNode, "jetbrains.mps.run.common.structure.IGeneratedToClass"), "virtual_getFullName_946964771156905503", PARAMETERS_946964771156905503);
  }

  public static String callSuper_getSuffix_946964771156905483(SNode thisNode, String callerConceptFqName) {
    return (String) BehaviorManager.getInstance().invokeSuper(Object.class, SNodeOperations.cast(thisNode, "jetbrains.mps.run.common.structure.IGeneratedToClass"), callerConceptFqName, "virtual_getSuffix_946964771156905483", PARAMETERS_946964771156905483);
  }

  public static String callSuper_getGeneratedClassName_946964771156905488(SNode thisNode, String callerConceptFqName) {
    return (String) BehaviorManager.getInstance().invokeSuper(Object.class, SNodeOperations.cast(thisNode, "jetbrains.mps.run.common.structure.IGeneratedToClass"), callerConceptFqName, "virtual_getGeneratedClassName_946964771156905488", PARAMETERS_946964771156905488);
  }

  public static String callSuper_getFullName_946964771156905503(SNode thisNode, String callerConceptFqName) {
    return (String) BehaviorManager.getInstance().invokeSuper(Object.class, SNodeOperations.cast(thisNode, "jetbrains.mps.run.common.structure.IGeneratedToClass"), callerConceptFqName, "virtual_getFullName_946964771156905503", PARAMETERS_946964771156905503);
  }
