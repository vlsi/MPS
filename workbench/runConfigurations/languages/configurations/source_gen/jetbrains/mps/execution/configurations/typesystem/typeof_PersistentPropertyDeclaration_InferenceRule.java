...
public class typeof_PersistentPropertyDeclaration_InferenceRule extends AbstractInferenceRule_Runtime implements InferenceRule_Runtime {
  ...
  public void applyRule(final SNode persistentPropertyDeclaration, final TypeCheckingContext typeCheckingContext, IsApplicableStatus status) {
    SNode primitive = SLinkOperations.getTarget(new typeof_PersistentPropertyDeclaration_InferenceRule.QuotationClass_sacma3_a0a0a0a().createNode(typeCheckingContext), "descriptor", false);
    {
      ...
      EquationInfo _info_12389875345 = new EquationInfo(_nodeToCheck_1029348928467, null, "r:8b43a830-217d-43d8-a0f8-6460c443f22d(jetbrains.mps.execution.configurations.typesystem)", "77193491200204439", 0, intentionProvider);
  ...
  public static class QuotationClass_sacma3_a0a1a0 {
    ...
    public SNode createNode(Object parameter_13, final TypeCheckingContext typeCheckingContext) {
      SNode result = null;
      Set<SNode> _parameterValues_129834374 = new HashSet<SNode>();
      SNode quotedNode_1 = null;
      ...
      SNode quotedNode_6 = null;
      {
        ...
        SNode quotedNode1_7 = quotedNode_1;
        {
          ...
          quotedNode1_8.addReference(SReference.create("classifier", quotedNode1_8, SModelReference.fromString("f:java_stub#6354ebe7-c22a-4a0f-ac54-50b52ab9b065#java.lang(java.lang@java_stub)"), SNodeId.fromString("~Cloneable")));
        ...
        }
        {
          ...
          quotedNode1_9.addReference(SReference.create("classifier", quotedNode1_9, SModelReference.fromString("f:java_stub#6354ebe7-c22a-4a0f-ac54-50b52ab9b065#java.lang(java.lang@java_stub)"), SNodeId.fromString("~Enum")));
        ...
        }
        {
          ...
          quotedNode1_10.addReference(SReference.create("classifier", quotedNode1_10, SModelReference.fromString("f:java_stub#6354ebe7-c22a-4a0f-ac54-50b52ab9b065#java.lang(java.lang@java_stub)"), SNodeId.fromString("~String")));
        ...
        }
        {
          ...
          if (_parameterValues_129834374.contains(quotedNode_5)) {
            quotedNode1_11 = HUtil.copyIfNecessary(quotedNode_5, typeCheckingContext);
          } else {
            _parameterValues_129834374.add(quotedNode_5);
            quotedNode1_11 = quotedNode_5;
          }
          if (quotedNode1_11 != null) {
            quotedNode_1.addChild("argument", HUtil.copyIfNecessary(quotedNode1_11, typeCheckingContext));
          }
        }
        {
          quotedNode_6 = SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.execution.settings.structure.TemplatePersistentPropertyType", null, GlobalScope.getInstance(), false);
    ...
    public SNode createNode(Object parameter_13) {
      ...
      SNode quotedNode_6 = null;
      {
        ...
        }
        {
          ...
          if (quotedNode1_11 != null) {
            quotedNode_1.addChild("argument", HUtil.copyIfNecessary(quotedNode1_11));
          }
        }
        {
          quotedNode_6 = SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.execution.settings.structure.TemplatePersistentPropertyType", null, GlobalScope.getInstance(), false);
