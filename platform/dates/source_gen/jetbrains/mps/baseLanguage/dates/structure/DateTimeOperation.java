...
public class DateTimeOperation extends BaseConcept implements IOperation {
  ...
  public int get_$attributesCount() {
    return this.getChildCount(DateTimeOperation._$ATTRIBUTE);
  }

  public Iterator<Attribute> _$attributes() {
    return this.children(Attribute.class, DateTimeOperation._$ATTRIBUTE);
  }

  public List<Attribute> get_$attributes() {
    return this.getChildren(Attribute.class, DateTimeOperation._$ATTRIBUTE);
  }

  public void add_$attribute(Attribute node) {
    this.addChild(DateTimeOperation._$ATTRIBUTE, node);
  }

  public void insert_$attribute(Attribute prev, Attribute node) {
    this.insertChild(prev, DateTimeOperation._$ATTRIBUTE, node);
  }
