...
public class PeriodFormatsTable extends BaseConcept implements INamedConcept {
  ...
  public int get_$attributesCount() {
    return this.getChildCount(PeriodFormatsTable._$ATTRIBUTE);
  }

  public Iterator<Attribute> _$attributes() {
    return this.children(Attribute.class, PeriodFormatsTable._$ATTRIBUTE);
  }

  public List<Attribute> get_$attributes() {
    return this.getChildren(Attribute.class, PeriodFormatsTable._$ATTRIBUTE);
  }

  public void add_$attribute(Attribute node) {
    this.addChild(PeriodFormatsTable._$ATTRIBUTE, node);
  }

  public void insert_$attribute(Attribute prev, Attribute node) {
    this.insertChild(prev, PeriodFormatsTable._$ATTRIBUTE, node);
  }
