...
import jetbrains.mps.closures.test._FunctionTypes._void_from_Iterable_of_Integer;

public class SequenceFunctionTypes_Test extends ClosuresBase_Test {

  public void test_returnSequence() throws Exception {
    _Iterable_of_Integer fun1 = null;
    _Iterable_of_Integer fun2 = null;
    fun1 = fun2;
    fun2 = fun1;
    fun1 = new _FunctionTypes._Iterable_of_Integer() {
    ...
    fun1 = new _FunctionTypes._List_of_Integer_to_Iterable_of_Integer_adapter(new _FunctionTypes._List_of_Integer() {
...
__switch__:
  ...
  public void test_acceptSequence() throws Exception {
    _void_from_Iterable_of_Integer fun1 = new _FunctionTypes._void_from_Iterable_of_Integer() {

      public void invoke(Iterable<Integer> p) {
      }

    };
    _void_from_Iterable_of_Integer fun2 = new _FunctionTypes._void_from_Iterable_of_Integer() {
  ...
  public void test_resultsReturnSequence() throws Exception {
    this.assertResultsEqual(new _FunctionTypes._Iterable_of_Integer() {
