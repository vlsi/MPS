...
import jetbrains.mps.closures.runtime.FunctionTypes._void;
...
public class TestClosure {
  ...
  public static void main(String[] args) {
    _void closure;
    _R_from_T<? extends Integer, ? super Integer> fib = new FunctionTypes._R_from_T <Integer, Integer>() {
    ...
    System.out.println("fib(9)=" + new FunctionTypes._R_from_T <Integer, Integer>() {
    ...
    int calc = new FunctionTypes._R <Integer>() {
    ...
    System.out.println("fact(5)=" + new FunctionTypes._R_from_T <Integer, Integer>() {
    ...
    _R<? extends Iterable<Integer>> fun = new FunctionTypes._R <Iterable<Integer>>() {
...
__switch__:
    ...
    seq = new FunctionTypes._R <Iterable<Integer>>() {
...
__switch__:
    ...
    final Iterable<Integer> si = new FunctionTypes._R <Iterable<Integer>>() {
...
__switch__:
    ...
    for(int i : new FunctionTypes._R <Iterable<Integer>>() {
...
__switch__:
                  switch (this.__CP__) {
                    ...
                    case 15:
                      this.__CP__ = 25;
                      this.yield((Integer)this._13_r);
                      return true;
                    case 16:
                      this._13_r = this._9_j + 10;
                      this.__CP__ = 15;
                      break;
                    case 17:
                      this._13_r = this._9_j + 100;
                      this.__CP__ = 15;
                      break;
                    case 19:
                      this._13_r = this._9_j + 1000;
                      this.__CP__ = 15;
                      break;
                    case 23:
                      assert false;
