...
public class ParamSequenceFeature_Editor extends DefaultNodeEditor {
  ...
  private static void setupBasic_ConstantCell7(EditorCell editorCell, SNode node, EditorContext context) {
    editorCell.putUserObject(EditorCell.CELL_ID, node.getId() + "_1185010393004");
  }

  private static void setupBasic_FromStringFunctionCell(EditorCell editorCell, SNode node, EditorContext context) {
    editorCell.putUserObject(EditorCell.CELL_ID, node.getId() + "_1185010397678");
  }

  private static void setupBasic_RowCell7(EditorCell editorCell, SNode node, EditorContext context) {
    editorCell.putUserObject(EditorCell.CELL_ID, node.getId() + "_1185010391661");
    editorCell.setSelectable(false);
  }
  ...
  private static void setupLabel_FromStringFunctionCell(EditorCell_Label editorCell, SNode node, EditorContext context) {
  }
  ...
  public EditorCell createRowCell7(EditorContext context, SNode node) {
    ...
    editorCell.setUsesBraces(false);
    editorCell.setCanBeFolded(false);
    editorCell.addEditorCell(this.createConstantCell7(context, node, "fromString:"));
    editorCell.addEditorCell(this.createFromStringFunctionCell(context, node));
    return editorCell;
  }
  ...
  public EditorCell createRowCell10(EditorContext context, SNode node) {
    ...
    editorCell.setUsesBraces(false);
    editorCell.setCanBeFolded(false);
    editorCell.addEditorCell(this.createConstantCell10(context, node, "sequence"));
  ...
  public EditorCell createRowCell12(EditorContext context, SNode node) {
    ...
    editorCell.setUsesBraces(false);
    editorCell.setCanBeFolded(false);
    editorCell.addEditorCell(this.createConstantCell12(context, node, "add"));
  ...
  public EditorCell createRowCell13(EditorContext context, SNode node) {
    ...
    editorCell.setUsesBraces(false);
    editorCell.setCanBeFolded(false);
    editorCell.addEditorCell(this.createConstantCell13(context, node, "remove"));
  ...
  public EditorCell createRowCell14(EditorContext context, SNode node) {
    ...
    editorCell.setUsesBraces(false);
    editorCell.setCanBeFolded(false);
    editorCell.addEditorCell(this.createConstantCell14(context, node, "sequence"));
  ...
  public EditorCell createFromStringFunctionCellinternal(EditorContext context, SNode node, CellProviderWithRole aProvider) {
    CellProviderWithRole provider = aProvider;
    provider.setAuxiliaryCellProvider(null);
    EditorCell editorCell = provider.createEditorCell(context);
    ParamSequenceFeature_Editor.setupBasic_FromStringFunctionCell(editorCell, node, context);
    if(editorCell instanceof EditorCell_Label) {
      ParamSequenceFeature_Editor.setupLabel_FromStringFunctionCell((EditorCell_Label)editorCell, node, context);
    }
    editorCell.setSubstituteInfo(provider.createDefaultSubstituteInfo());
    return editorCell;
  }

  public EditorCell createFromStringFunctionCell(EditorContext context, SNode node) {
    CellProviderWithRole provider = new RefNodeCellProvider(node, context);
    provider.setRole("fromStringFunction");
    provider.setNoTargetText("");
    provider.setReadOnly(false);
    provider.setAllowsEmptyTarget(false);
    EditorCell cellWithRole = this.createFromStringFunctionCellinternal(context, node, provider);
    SNode attributeConcept = provider.getRoleAttribute();
    Class attributeKind = provider.getRoleAttributeClass();
    if(attributeConcept != null) {
      IOperationContext opContext = context.getOperationContext();
