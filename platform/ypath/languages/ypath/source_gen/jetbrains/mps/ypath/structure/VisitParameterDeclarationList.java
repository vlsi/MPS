...
public class VisitParameterDeclarationList extends BaseConcept {
  ...
  public static VisitParameterDeclarationList newInstance(SModel sm, boolean init) {
    return (VisitParameterDeclarationList)SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.ypath.VisitParameterDeclarationList", sm, GlobalScope.getInstance(), init).getAdapter();
  }
