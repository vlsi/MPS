  ...
  public void applyRule(final SNode argument) {
    ...
    }
    {
      ...
      while(true) {
        ...
        TypeChecker.getInstance().getRuntimeSupport().createLessThanInequation(TypeChecker.getInstance().getRuntimeSupport().typeOf(arg), TypeChecker.getInstance().getRuntimeSupport().typeOf(param), arg, null, "jetbrains.mps.ypath.helgins", "1180014737422");
      }
    }
  }
