...
public class LambdaMethodParameter extends ClosureParameter {
  ...
  public static LambdaMethodParameter newInstance(SModel sm, boolean init) {
    return (LambdaMethodParameter)SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.ypath.LambdaMethodParameter", sm, GlobalScope.getInstance(), init).getAdapter();
  }
