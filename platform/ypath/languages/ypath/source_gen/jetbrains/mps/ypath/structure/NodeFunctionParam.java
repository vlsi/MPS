...
public class NodeFunctionParam extends ConceptFunctionParameter {
  ...
  public static NodeFunctionParam newInstance(SModel sm, boolean init) {
    return (NodeFunctionParam)SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.ypath.NodeFunctionParam", sm, GlobalScope.getInstance(), init).getAdapter();
  }
