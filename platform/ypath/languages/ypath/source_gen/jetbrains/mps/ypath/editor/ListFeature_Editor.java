...
public class ListFeature_Editor extends DefaultNodeEditor {
  ...
  public EditorCell createRowCell15(EditorContext context, SNode node) {
    ...
    editorCell.setUsesBraces(false);
    editorCell.setCanBeFolded(false);
    editorCell.addEditorCell(this.createConstantCell17(context, node, "set"));
    return editorCell;
  }
  ...
  public EditorCell createRowCell17(EditorContext context, SNode node) {
    ...
    editorCell.setUsesBraces(false);
    editorCell.setCanBeFolded(false);
    editorCell.addEditorCell(this.createConstantCell19(context, node, "insert"));
    return editorCell;
  }
  ...
  public EditorCell createRowCell19(EditorContext context, SNode node) {
    ...
    editorCell.setUsesBraces(false);
    editorCell.setCanBeFolded(false);
    editorCell.addEditorCell(this.createConstantCell21(context, node, "delete"));
    return editorCell;
  }
  ...
  public EditorCell createRowCell21(EditorContext context, SNode node) {
    ...
    editorCell.setUsesBraces(false);
    editorCell.setCanBeFolded(false);
    editorCell.addEditorCell(this.createConstantCell23(context, node, "get"));
    return editorCell;
  }
  ...
  public EditorCell createRowCell24(EditorContext context, SNode node) {
    EditorCell_Collection editorCell = EditorCell_Collection.createHorizontal(context, node);
    ListFeature_Editor.setupBasic_RowCell24(editorCell, node, context);
    editorCell.setGridLayout(false);
    editorCell.setUsesBraces(false);
    editorCell.setCanBeFolded(false);
  ...
  public EditorCell createRowCell25(EditorContext context, SNode node) {
    EditorCell_Collection editorCell = EditorCell_Collection.createHorizontal(context, node);
    ListFeature_Editor.setupBasic_RowCell25(editorCell, node, context);
    editorCell.setGridLayout(false);
    editorCell.setUsesBraces(false);
    editorCell.setCanBeFolded(false);
  ...
  public EditorCell createConstantCell27(EditorContext context, SNode node, String text) {
    EditorCell_Constant editorCell = new EditorCell_Constant(context, node, text);
    ListFeature_Editor.setupBasic_ConstantCell27(editorCell, node, context);
    ListFeature_Editor.setupLabel_ConstantCell27(editorCell, node, context);
    editorCell.setDefaultText("");
    return editorCell;
  }
  ...
  public ModelAccessor _modelAcessorFactory_1197921774652(final EditorContext editorContext, final SNode node) {
    return new ModelAccessor() {
      ...
      public String getText() {
        ...
        String sep = "";
        {
          ICursor<SNode> _zCursor4 = CursorFactory.createCursor(IFeature_Behavior.call_getPartialOpposites_1197921554165(node));
          try {
            while(_zCursor4.moveToNext()) {
              SNode foo = _zCursor4.getCurrent();
