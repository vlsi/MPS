...
<model modelUID="r:00000000-0000-4000-0000-011c895905ac(jetbrains.mps.ypath.plugin)">
    ...
    <import index="2" modelUID="f:java_stub#jetbrains.mps.ypath.plugin(jetbrains.mps.ypath.plugin@java_stub)"
            version="-1"/>
                ...
                <node role="statement" type="jetbrains.mps.baseLanguage.structure.ExpressionStatement"
                    ...
                    <node role="expression" type="jetbrains.mps.baseLanguage.structure.DotExpression"
                        ...
                        <node role="operand" type="jetbrains.mps.baseLanguage.structure.StaticMethodCall"
                            ...
                            <link role="classConcept" targetNodeId="2.~DesignPartLoader"
                                  resolveInfo="DesignPartLoader"/>
                        </node>
                        <node role="operation" type="jetbrains.mps.baseLanguage.structure.InstanceMethodCallOperation"
                              id="1216918084193">
                            <link role="baseMethodDeclaration"
                                  targetNodeId="2.~DesignPartLoader.registerInClassLoadManager():void"
