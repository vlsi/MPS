...
public class ParameterQueryFun_Behavior {
  ...
  public static SNode virtual_getExpectedReturnType_1213877374441(SNode thisNode) {
    ...
    return new QuotationClass_().createNode(SLinkOperations.getTarget(SNodeOperations.getAncestor(thisNode, "jetbrains.mps.ypath.structure.IFeature", false, false), "parameterType", true));
  }
