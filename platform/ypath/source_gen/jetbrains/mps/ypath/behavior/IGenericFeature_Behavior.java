...
public class IGenericFeature_Behavior {
  ...
  public static SNode call_replaceStatement_1213877249161(SNode thisNode, SNode srcExp, SNode param, SNode range, SNode replaceExp, ITemplateGenerator generator) {
    return (SNode)BehaviorManager.getInstance().invoke(Object.class, SNodeOperations.cast(thisNode, "jetbrains.mps.ypath.structure.IGenericFeature"), "virtual_replaceStatement_1213877249161", PARAMETERS_1213877249161, srcExp, param, range, replaceExp, generator);
  }
  ...
  public static SNode call_removeStatement_1213877249174(SNode thisNode, SNode srcExp, SNode param, SNode range, ITemplateGenerator generator) {
    return (SNode)BehaviorManager.getInstance().invoke(Object.class, SNodeOperations.cast(thisNode, "jetbrains.mps.ypath.structure.IGenericFeature"), "virtual_removeStatement_1213877249174", PARAMETERS_1213877249174, srcExp, param, range, generator);
  }
  ...
  public static SNode call_insertStatement_1213877249185(SNode thisNode, SNode srcExp, SNode param, SNode range, SNode insertExp, ITemplateGenerator generator) {
    return (SNode)BehaviorManager.getInstance().invoke(Object.class, SNodeOperations.cast(thisNode, "jetbrains.mps.ypath.structure.IGenericFeature"), "virtual_insertStatement_1213877249185", PARAMETERS_1213877249185, srcExp, param, range, insertExp, generator);
  }
  ...
  public static SNode callSuper_replaceStatement_1213877249161(SNode thisNode, String callerConceptFqName, SNode srcExp, SNode param, SNode range, SNode replaceExp, ITemplateGenerator generator) {
    return (SNode)BehaviorManager.getInstance().invokeSuper(Object.class, SNodeOperations.cast(thisNode, "jetbrains.mps.ypath.structure.IGenericFeature"), callerConceptFqName, "virtual_replaceStatement_1213877249161", PARAMETERS_1213877249161, srcExp, param, range, replaceExp, generator);
  }
  ...
  public static SNode callSuper_removeStatement_1213877249174(SNode thisNode, String callerConceptFqName, SNode srcExp, SNode param, SNode range, ITemplateGenerator generator) {
    return (SNode)BehaviorManager.getInstance().invokeSuper(Object.class, SNodeOperations.cast(thisNode, "jetbrains.mps.ypath.structure.IGenericFeature"), callerConceptFqName, "virtual_removeStatement_1213877249174", PARAMETERS_1213877249174, srcExp, param, range, generator);
  }
  ...
  public static SNode callSuper_insertStatement_1213877249185(SNode thisNode, String callerConceptFqName, SNode srcExp, SNode param, SNode range, SNode insertExp, ITemplateGenerator generator) {
    return (SNode)BehaviorManager.getInstance().invokeSuper(Object.class, SNodeOperations.cast(thisNode, "jetbrains.mps.ypath.structure.IGenericFeature"), callerConceptFqName, "virtual_insertStatement_1213877249185", PARAMETERS_1213877249185, srcExp, param, range, insertExp, generator);
  }
