...
public class VisitChildrenExpression_Editor extends DefaultNodeEditor {
  ...
  public EditorCell createRefNodeList_9190_0(EditorContext context, SNode node) {
    ...
    EditorCell_Collection editorCell = this.myListHandler_9190_0.createCells(context, new CellLayout_Horizontal(), false);
  ...
  public EditorCell createConceptProperty_9190_0_internal(EditorContext context, SNode node, CellProviderWithRole aProvider) {
    CellProviderWithRole provider = aProvider;
    provider.setAuxiliaryCellProvider(null);
    EditorCell editorCell = provider.createEditorCell(context);
    setupBasic_ConceptProperty_9190_0(editorCell, node, context);
    if (editorCell instanceof EditorCell_Label) {
      setupLabel_ConceptProperty_9190_0((EditorCell_Label)editorCell, node, context);
    }
    editorCell.setSubstituteInfo(provider.createDefaultSubstituteInfo());
    return editorCell;
  }

  public EditorCell createConceptProperty_9190_1(EditorContext context, SNode node) {
    CellProviderWithRole provider = new ConceptPropertyCellProvider(node, context);
    provider.setRole("alias");
    provider.setNoTargetText("<no alias>");
    provider.setReadOnly(false);
    provider.setAllowsEmptyTarget(false);
    EditorCell cellWithRole = this.createConceptProperty_9190_0_internal(context, node, provider);
  ...
  private static void setupLabel_ConceptProperty_9190_0(EditorCell_Label editorCell, SNode node, EditorContext context) {
  }
