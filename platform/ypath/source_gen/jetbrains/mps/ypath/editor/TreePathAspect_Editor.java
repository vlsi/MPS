...
public class TreePathAspect_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createRefNodeList_1553_0(EditorContext context, SNode node) {
    AbstractCellListHandler handler = new TreePathAspect_Editor.nodeKindsListHandler_1553_0(node, "nodeKinds", context);
  ...
  private EditorCell createRefNodeList_1553_1(EditorContext context, SNode node) {
    AbstractCellListHandler handler = new TreePathAspect_Editor.featuresListHandler_1553_0(node, "features", context);
    EditorCell_Collection editorCell = handler.createCells(context, new CellLayout_Vertical(), false);
