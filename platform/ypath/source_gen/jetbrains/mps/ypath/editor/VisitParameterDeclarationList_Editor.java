...
public class VisitParameterDeclarationList_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createCollection_2322_0(EditorContext editorContext, SNode node) {
    ...
    editorCell.addEditorCell(this.createRefNodeList_2322_0(editorContext, node));
    editorCell.addEditorCell(this.createConstant_2322_2(editorContext, node, ")"));
    return editorCell;
  }
  ...
  private EditorCell createConstant_2322_2(EditorContext editorContext, SNode node, String text) {
    EditorCell_Constant editorCell = new EditorCell_Constant(editorContext, node, text);
  ...
  private EditorCell createRefNodeList_2322_0(EditorContext editorContext, SNode node) {
    AbstractCellListHandler handler = new VisitParameterDeclarationList_Editor.visitParameterDeclarationListHandler_2322_0(node, "visitParameterDeclaration", editorContext);
  ...
  private static class visitParameterDeclarationListHandler_2322_0 extends RefNodeListHandler {
    ...
    public EditorCell createEmptyCell_internal(EditorContext editorContext, SNode node) {
      return this.createConstant_2322_0(editorContext, node, "<no parameters>");
    }
