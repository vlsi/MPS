...
public class ToStringFun extends ConceptFunction implements IDesignFunction {
  ...
  public int get_$attributesCount() {
    return this.getChildCount(ToStringFun._$ATTRIBUTE);
  }

  public Iterator<Attribute> _$attributes() {
    return this.children(Attribute.class, ToStringFun._$ATTRIBUTE);
  }

  public List<Attribute> get_$attributes() {
    return this.getChildren(Attribute.class, ToStringFun._$ATTRIBUTE);
  }

  public void add_$attribute(Attribute node) {
    this.addChild(ToStringFun._$ATTRIBUTE, node);
  }

  public void insert_$attribute(Attribute prev, Attribute node) {
    this.insertChild(prev, ToStringFun._$ATTRIBUTE, node);
  }
