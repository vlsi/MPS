...
public class TreePathOperation extends BaseConcept implements IOperation {
  ...
  public int get_$attributesCount() {
    return this.getChildCount(TreePathOperation._$ATTRIBUTE);
  }

  public Iterator<Attribute> _$attributes() {
    return this.children(Attribute.class, TreePathOperation._$ATTRIBUTE);
  }

  public List<Attribute> get_$attributes() {
    return this.getChildren(Attribute.class, TreePathOperation._$ATTRIBUTE);
  }

  public void add_$attribute(Attribute node) {
    this.addChild(TreePathOperation._$ATTRIBUTE, node);
  }

  public void insert_$attribute(Attribute prev, Attribute node) {
    this.insertChild(prev, TreePathOperation._$ATTRIBUTE, node);
  }
