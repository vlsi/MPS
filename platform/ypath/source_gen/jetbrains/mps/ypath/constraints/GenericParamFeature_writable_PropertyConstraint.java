...
public class GenericParamFeature_writable_PropertyConstraint implements IModelConstraints, INodePropertySetter {
  ...
  public void registerSelf(ModelConstraintsManager manager) {
    manager.registerNodePropertySetter("jetbrains.mps.ypath.structure.GenericParamFeature", "writable", this);
  }

  public void unRegisterSelf(ModelConstraintsManager manager) {
    manager.unRegisterNodePropertySetter("jetbrains.mps.ypath.structure.GenericParamFeature", "writable");
  }
