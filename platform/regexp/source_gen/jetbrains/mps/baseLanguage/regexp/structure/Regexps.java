...
public class Regexps extends jetbrains.mps.lang.core.structure.BaseConcept implements jetbrains.mps.lang.core.structure.INamedConcept {
  ...
  public Iterator<jetbrains.mps.baseLanguage.regexp.structure.RegexpDeclaration> regexps() {
    return this.children(RegexpDeclaration.class, Regexps.REGEXP);
  }

  public List<jetbrains.mps.baseLanguage.regexp.structure.RegexpDeclaration> getRegexps() {
    return this.getChildren(RegexpDeclaration.class, Regexps.REGEXP);
  }

  public void addRegexp(jetbrains.mps.baseLanguage.regexp.structure.RegexpDeclaration node) {
    this.addChild(Regexps.REGEXP, node);
  }

  public void insertRegexp(jetbrains.mps.baseLanguage.regexp.structure.RegexpDeclaration prev, jetbrains.mps.baseLanguage.regexp.structure.RegexpDeclaration node) {
