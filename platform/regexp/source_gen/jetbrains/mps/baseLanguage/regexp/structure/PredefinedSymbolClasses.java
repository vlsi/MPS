...
public class PredefinedSymbolClasses extends BaseConcept implements INamedConcept {
  ...
  public int get_$attributesCount() {
    return this.getChildCount(PredefinedSymbolClasses._$ATTRIBUTE);
  }

  public Iterator<Attribute> _$attributes() {
    return this.children(Attribute.class, PredefinedSymbolClasses._$ATTRIBUTE);
  }

  public List<Attribute> get_$attributes() {
    return this.getChildren(Attribute.class, PredefinedSymbolClasses._$ATTRIBUTE);
  }

  public void add_$attribute(Attribute node) {
    this.addChild(PredefinedSymbolClasses._$ATTRIBUTE, node);
  }

  public void insert_$attribute(Attribute prev, Attribute node) {
    this.insertChild(prev, PredefinedSymbolClasses._$ATTRIBUTE, node);
  }
