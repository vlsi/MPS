...
public class UnaryRegexp_Behavior {
  ...
  public static String call_getString_1222867684394(SNode thisNode, List<SNode> vars) {
    return (String)BehaviorManager.getInstance().invoke(Object.class, thisNode, "virtual_getString_1222432436326", PARAMETERS_1222867684394, vars);
  }

  public static String callSuper_getString_1222867684394(SNode thisNode, String callerConceptFqName, List<SNode> vars) {
    return (String)BehaviorManager.getInstance().invokeSuper(Object.class, thisNode, callerConceptFqName, "virtual_getString_1222432436326", PARAMETERS_1222867684394, vars);
  }
