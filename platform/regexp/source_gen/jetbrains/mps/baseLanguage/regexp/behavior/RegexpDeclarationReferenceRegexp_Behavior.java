...
public class RegexpDeclarationReferenceRegexp_Behavior {
  ...
  public static String call_getString_1222437178336(SNode thisNode, List<SNode> vars) {
    return (String)BehaviorManager.getInstance().invoke(Object.class, SNodeOperations.cast(thisNode, "jetbrains.mps.baseLanguage.regexp.structure.RegexpDeclarationReferenceRegexp"), "virtual_getString_1222432436326", PARAMETERS_1222437178336, vars);
  }
