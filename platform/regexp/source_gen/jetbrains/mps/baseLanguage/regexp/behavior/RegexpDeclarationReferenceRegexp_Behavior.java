...
public class RegexpDeclarationReferenceRegexp_Behavior {
  public static Class[] PARAMETERS_1222437178336 = {SNode.class ,List.class};
  ...
  public static String call_getString_1222437178336(SNode thisNode, List<SNode> vars) {
    return (String)BehaviorManager.getInstance().invoke(Object.class, thisNode, "virtual_getString_1222432436326", PARAMETERS_1222437178336, vars);
  }

  public static String callSuper_getString_1222437178336(SNode thisNode, String callerConceptFqName, List<SNode> vars) {
    return (String)BehaviorManager.getInstance().invokeSuper(Object.class, thisNode, callerConceptFqName, "virtual_getString_1222432436326", PARAMETERS_1222437178336, vars);
  }
