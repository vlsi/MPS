...
public class ReplaceWithRegexpExpression_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createCollection_9889_0(EditorContext context, SNode node) {
    ...
    editorCell.addEditorCell(this.createRefNode_9889_0(context, node));
    ...
    editorCell.addEditorCell(this.createRefNode_9889_2(context, node));
    return editorCell;
  }

  private EditorCell createConstant_9889_0(EditorContext context, SNode node, String text) {
  ...
  private EditorCell createConstant_9889_1(EditorContext context, SNode node, String text) {
    EditorCell_Constant editorCell = new EditorCell_Constant(context, node, text);
  ...
  private EditorCell createConstant_9889_2(EditorContext context, SNode node, String text) {
    EditorCell_Constant editorCell = new EditorCell_Constant(context, node, text);
  ...
  private EditorCell createConstant_9889_3(EditorContext context, SNode node, String text) {
    EditorCell_Constant editorCell = new EditorCell_Constant(context, node, text);
  ...
  private EditorCell createRefNode_9889_0(EditorContext context, SNode node) {
  ...
  private EditorCell createRefNode_9889_1(EditorContext context, SNode node) {
    CellProviderWithRole provider = new RefNodeCellProvider(node, context);
  ...
  private EditorCell createRefNode_9889_2(EditorContext context, SNode node) {
    CellProviderWithRole provider = new RefNodeCellProvider(node, context);
