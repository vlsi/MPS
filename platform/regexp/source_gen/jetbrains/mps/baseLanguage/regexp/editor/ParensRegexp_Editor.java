...
public class ParensRegexp_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createCollection_9798_0(EditorContext context, SNode node) {
  ...
  private EditorCell createConstant_9798_0(EditorContext context, SNode node, String text) {
  ...
  private EditorCell createConstant_9798_1(EditorContext context, SNode node, String text) {
    EditorCell_Constant editorCell = new EditorCell_Constant(context, node, text);
  ...
  private EditorCell createRefNode_9798_0(EditorContext context, SNode node) {
