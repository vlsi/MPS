...
public class IntersectionSymbolClassPart_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createCollection_7554_0(EditorContext context, SNode node) {
    EditorCell_Collection editorCell = EditorCell_Collection.createIndent2(context, node);
    editorCell.setCellId("Collection_7554_0");
    editorCell.addEditorCell(this.createRefNode_7554_0(context, node));
    editorCell.addEditorCell(this.createConceptProperty_7554_0(context, node));
    editorCell.addEditorCell(this.createRefNode_7554_1(context, node));
    return editorCell;
  }

  private EditorCell createRefNode_7554_0(EditorContext context, SNode node) {
  ...
  private EditorCell createConceptProperty_7554_0(EditorContext context, SNode node) {
  ...
  private EditorCell createRefNode_7554_1(EditorContext context, SNode node) {
    CellProviderWithRole provider = new RefNodeCellProvider(node, context);
