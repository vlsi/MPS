...
public class IntersectionSymbolClassPart extends SymbolClassPart {
  public static final String concept = "jetbrains.mps.regexp.structure.IntersectionSymbolClassPart";
  ...
  public static IntersectionSymbolClassPart newInstance(SModel sm, boolean init) {
    return (IntersectionSymbolClassPart)SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.regexp.structure.IntersectionSymbolClassPart", sm, GlobalScope.getInstance(), init).getAdapter();
  }
