...
public class PositiveLookBehindRegexp extends LookRegexp {
  public static final String concept = "jetbrains.mps.regexp.structure.PositiveLookBehindRegexp";
  ...
  public static PositiveLookBehindRegexp newInstance(SModel sm, boolean init) {
    return (PositiveLookBehindRegexp)SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.regexp.structure.PositiveLookBehindRegexp", sm, GlobalScope.getInstance(), init).getAdapter();
  }
