...
public class ReplaceWithRegexpOperation extends BaseConcept implements IOperation, RegexpUsingConstruction {
  public static final String concept = "jetbrains.mps.regexp.structure.ReplaceWithRegexpOperation";
  ...
  public static ReplaceWithRegexpOperation newInstance(SModel sm, boolean init) {
    return (ReplaceWithRegexpOperation)SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.regexp.structure.ReplaceWithRegexpOperation", sm, GlobalScope.getInstance(), init).getAdapter();
  }
