  ...
  public void applyRule(final SNode rr, final TypeCheckingContext typeCheckingContext) {
    {
      ...
      TypeChecker.getInstance().getRuntimeSupport().createLessThanInequation(TypeChecker.getInstance().getRuntimeSupport().typeOf(SLinkOperations.getTarget(rr, "expr", true), "r:00000000-0000-4000-0000-011c89590517(jetbrains.mps.regexp.helgins)", "1178179183634", true), new QuotationClass_3().createNode(), _nodeToCheck_1029348928467, null, "r:00000000-0000-4000-0000-011c89590517(jetbrains.mps.regexp.helgins)", "1178179183633", false, 0, intentionProvider);
    }
  }
