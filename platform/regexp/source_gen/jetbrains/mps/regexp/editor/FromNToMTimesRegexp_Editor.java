...
public class FromNToMTimesRegexp_Editor extends DefaultNodeEditor {
      ...
      Style inlineStyle = new Style(editorCell) {
        {
          this.set(StyleAttributes.TEXT_COLOR, new AttributeCalculator <Color>() {
            ...
            public Color calculate(EditorCell cell) {
              return FromNToMTimesRegexp_Editor.calculateColor27(cell);
            }
      ...
      Style inlineStyle = new Style(editorCell) {
        {
          this.set(StyleAttributes.TEXT_COLOR, new AttributeCalculator <Color>() {
            ...
            public Color calculate(EditorCell cell) {
              return FromNToMTimesRegexp_Editor.calculateColor18(cell);
            }
  ...
  private static void setupLabel_ConstantCell1435_01(EditorCell_Label editorCell, SNode node, EditorContext context) {
  }
  ...
  public EditorCell createEditorCell(EditorContext context, SNode node) {
    return this.create_CollectionCell1435_0(context, node);
  }

  public EditorCell create_CollectionCell1435_0(EditorContext context, SNode node) {
    EditorCell_Collection editorCell = EditorCell_Collection.createHorizontal(context, node);
    setupBasic_CollectionCell1435_0(editorCell, node, context);
    editorCell.setGridLayout(false);
    editorCell.setUsesBraces(false);
    editorCell.setCanBeFolded(false);
    editorCell.addEditorCell(this.create_regexpRefNodeCell1435_0(context, node));
    editorCell.addEditorCell(this.create_ConstantCell1435_0(context, node, "{"));
    editorCell.addEditorCell(this.create_nPropertyCell1435_0(context, node));
    editorCell.addEditorCell(this.create_ConstantCell1435_01(context, node, ","));
    editorCell.addEditorCell(this.create_mPropertyCell1435_0(context, node));
    editorCell.addEditorCell(this.create_ConstantCell1435_02(context, node, "}"));
    return editorCell;
  }

  public EditorCell create_ConstantCell1435_0(EditorContext context, SNode node, String text) {
    EditorCell_Constant editorCell = new EditorCell_Constant(context, node, text);
    setupBasic_ConstantCell1435_0(editorCell, node, context);
    setupLabel_ConstantCell1435_0(editorCell, node, context);
    editorCell.setDefaultText("");
    return editorCell;
  }

  public EditorCell create_ConstantCell1435_01(EditorContext context, SNode node, String text) {
    EditorCell_Constant editorCell = new EditorCell_Constant(context, node, text);
    setupBasic_ConstantCell1435_01(editorCell, node, context);
    setupLabel_ConstantCell1435_01(editorCell, node, context);
    editorCell.setDefaultText("");
    return editorCell;
  }

  public EditorCell create_ConstantCell1435_02(EditorContext context, SNode node, String text) {
    EditorCell_Constant editorCell = new EditorCell_Constant(context, node, text);
    setupBasic_ConstantCell1435_02(editorCell, node, context);
    setupLabel_ConstantCell1435_02(editorCell, node, context);
    editorCell.setDefaultText("");
    return editorCell;
  }

  public EditorCell create_regexpRefNodeCell1435_0_internal(EditorContext context, SNode node, CellProviderWithRole aProvider) {
    CellProviderWithRole provider = aProvider;
    provider.setAuxiliaryCellProvider(null);
    EditorCell editorCell = provider.createEditorCell(context);
    setupBasic_regexpRefNodeCell1435_0(editorCell, node, context);
    if (editorCell instanceof EditorCell_Label) {
      setupLabel_regexpRefNodeCell1435_0((EditorCell_Label)editorCell, node, context);
    }
  ...
  public EditorCell create_nPropertyCell1435_0_internal(EditorContext context, SNode node, CellProviderWithRole aProvider) {
    CellProviderWithRole provider = aProvider;
    provider.setAuxiliaryCellProvider(null);
    EditorCell editorCell = provider.createEditorCell(context);
    setupBasic_nPropertyCell1435_0(editorCell, node, context);
    if (editorCell instanceof EditorCell_Label) {
      setupLabel_nPropertyCell1435_0((EditorCell_Label)editorCell, node, context);
    }
    editorCell.setSubstituteInfo(provider.createDefaultSubstituteInfo());
    return editorCell;
  }
  ...
  public EditorCell create_mPropertyCell1435_0_internal(EditorContext context, SNode node, CellProviderWithRole aProvider) {
    CellProviderWithRole provider = aProvider;
    provider.setAuxiliaryCellProvider(null);
    EditorCell editorCell = provider.createEditorCell(context);
    setupBasic_mPropertyCell1435_0(editorCell, node, context);
    if (editorCell instanceof EditorCell_Label) {
      setupLabel_mPropertyCell1435_0((EditorCell_Label)editorCell, node, context);
    }
    editorCell.setSubstituteInfo(provider.createDefaultSubstituteInfo());
    return editorCell;
  }
