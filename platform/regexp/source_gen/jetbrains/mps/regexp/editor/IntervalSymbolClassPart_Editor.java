...
public class IntervalSymbolClassPart_Editor extends DefaultNodeEditor {
      ...
      Style inlineStyle = new Style(editorCell) {
        {
          this.set(StyleAttributes.TEXT_COLOR, new AttributeCalculator <Color>() {
            ...
            public Color calculate(EditorCell cell) {
              return IntervalSymbolClassPart_Editor.calculateColor35(cell);
            }
  ...
  private static void setupLabel_ConstantCell7273_0(EditorCell_Label editorCell, SNode node, EditorContext context) {
  }
  ...
  public EditorCell createEditorCell(EditorContext context, SNode node) {
    return this.create_CollectionCell7273_0(context, node);
  }

  public EditorCell create_CollectionCell7273_0(EditorContext context, SNode node) {
    EditorCell_Collection editorCell = EditorCell_Collection.createHorizontal(context, node);
    setupBasic_CollectionCell7273_0(editorCell, node, context);
    editorCell.setGridLayout(false);
    editorCell.setUsesBraces(false);
    editorCell.setCanBeFolded(false);
    editorCell.addEditorCell(this.create_startPropertyCell7273_0(context, node));
    editorCell.addEditorCell(this.create_ConstantCell7273_0(context, node, "-"));
    editorCell.addEditorCell(this.create_endPropertyCell7273_0(context, node));
    return editorCell;
  }

  public EditorCell create_ConstantCell7273_0(EditorContext context, SNode node, String text) {
    EditorCell_Constant editorCell = new EditorCell_Constant(context, node, text);
    setupBasic_ConstantCell7273_0(editorCell, node, context);
    setupLabel_ConstantCell7273_0(editorCell, node, context);
    editorCell.setDefaultText("");
    return editorCell;
  }

  public EditorCell create_startPropertyCell7273_0_internal(EditorContext context, SNode node, CellProviderWithRole aProvider) {
    CellProviderWithRole provider = aProvider;
    provider.setAuxiliaryCellProvider(null);
    EditorCell editorCell = provider.createEditorCell(context);
    setupBasic_startPropertyCell7273_0(editorCell, node, context);
    if (editorCell instanceof EditorCell_Label) {
      setupLabel_startPropertyCell7273_0((EditorCell_Label)editorCell, node, context);
    }
  ...
  public EditorCell create_endPropertyCell7273_0_internal(EditorContext context, SNode node, CellProviderWithRole aProvider) {
    CellProviderWithRole provider = aProvider;
    provider.setAuxiliaryCellProvider(null);
    EditorCell editorCell = provider.createEditorCell(context);
    setupBasic_endPropertyCell7273_0(editorCell, node, context);
    if (editorCell instanceof EditorCell_Label) {
      setupLabel_endPropertyCell7273_0((EditorCell_Label)editorCell, node, context);
    }
    editorCell.setSubstituteInfo(provider.createDefaultSubstituteInfo());
    return editorCell;
  }
