...
public class MatchVariableReference_Editor extends DefaultNodeEditor {
  ...
  private static Integer calculateFontStyle2814_0(EditorCell cell) {
    int result;
    result = MPSFonts.ITALIC;
    return result;
  }

  private static Color calculateColor2814_0(EditorCell cell) {
    Color result;
        ...
        Style inlineStyle = new Style(editorCell) {
          {
            this.set(StyleAttributes.FONT_STYLE, new AttributeCalculator <Integer>() {
              ...
              public Integer calculate(EditorCell cell) {
                return MatchVariableReference_Editor.calculateFontStyle2814_0(cell);
              }
            ...
            this.set(StyleAttributes.TEXT_COLOR, new AttributeCalculator <Color>() {
              ...
              public Color calculate(EditorCell cell) {
                return MatchVariableReference_Editor.calculateColor2814_0(cell);
              }
