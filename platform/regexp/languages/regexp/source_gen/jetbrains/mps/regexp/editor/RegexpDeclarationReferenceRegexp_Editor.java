...
import jetbrains.mps.regexp.editor.RegexpDeclarationReferenceRegexp_Editor_regexp_InlineComponent;
...
public class RegexpDeclarationReferenceRegexp_Editor extends DefaultNodeEditor {
  ...
  public EditorCell createRegexpReferenceCellinternal(EditorContext context, SNode node, CellProviderWithRole aProvider) {
    ...
    provider.setAuxiliaryCellProvider(new RegexpDeclarationReferenceRegexp_Editor_regexp_InlineComponent());
