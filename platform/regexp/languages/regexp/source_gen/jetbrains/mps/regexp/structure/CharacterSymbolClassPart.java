...
public class CharacterSymbolClassPart extends SymbolClassPart {
  ...
  public static CharacterSymbolClassPart newInstance(SModel sm, boolean init) {
    return (CharacterSymbolClassPart)SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.regexp.CharacterSymbolClassPart", sm, GlobalScope.getInstance(), init).getAdapter();
  }
