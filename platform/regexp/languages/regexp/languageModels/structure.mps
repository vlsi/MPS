...
<model name="jetbrains.mps.regexp.structure">
  ...
  <node type="jetbrains.mps.bootstrap.structureLanguage.ConceptDeclaration" id="1174482769792">
    ...
    <node role="linkDeclaration" type="jetbrains.mps.bootstrap.structureLanguage.LinkDeclaration" id="1174482838673">
      <property name="sourceCardinality" value="1" />
      <property name="role" value="left" />
      <property name="metaClass" value="aggregation" />
      <link role="target" targetNodeId="1174482743037" resolveInfo="Regexp" />
    </node>
    <node role="linkDeclaration" type="jetbrains.mps.bootstrap.structureLanguage.LinkDeclaration" id="1174482844612">
      <property name="sourceCardinality" value="1" />
  ...
  <node type="jetbrains.mps.bootstrap.structureLanguage.ConceptDeclaration" id="1174482804200">
    ...
    <node role="linkDeclaration" type="jetbrains.mps.bootstrap.structureLanguage.LinkDeclaration" id="1174482919940">
      <property name="sourceCardinality" value="1" />
  ...
  <node type="jetbrains.mps.bootstrap.structureLanguage.ConceptDeclaration" id="1174482808826">
    ...
    <link role="extends" targetNodeId="1.1133920641626" />
    <node role="linkDeclaration" type="jetbrains.mps.bootstrap.structureLanguage.LinkDeclaration" id="1174482887353">
      <property name="sourceCardinality" value="1" />
      <property name="role" value="expr" />
      <property name="metaClass" value="aggregation" />
      <link role="target" targetNodeId="1174482743037" resolveInfo="Regexp" />
