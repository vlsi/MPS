...
<model modelUID="r:00000000-0000-4000-0000-011c8959051d(jetbrains.mps.regexp.examples)">
  ...
  <node type="jetbrains.mps.baseLanguage.structure.ClassConcept" id="1178535069057">
    ...
    <node role="staticMethod" type="jetbrains.mps.baseLanguage.structure.StaticMethodDeclaration" id="1178535219991">
                    ...
                    <node role="statement" type="jetbrains.mps.baseLanguage.structure.ReturnStatement" id="1178535270085">
                      <node role="expression" type="jetbrains.mps.baseLanguage.structure.PlusExpression" id="1178535272220">
                        <node role="rightExpression" type="jetbrains.mps.baseLanguage.structure.PlusExpression" id="1178535274539">
                          ...
                          <node role="leftExpression" type="jetbrains.mps.baseLanguage.regexp.structure.MatchVariableReference" id="1178535273685">
      ...
      <node role="returnType" type="jetbrains.mps.baseLanguage.structure.ClassifierType" id="1222616769518">
        <link role="classifier" targetNodeId="1.~String" resolveInfo="String" />
      </node>
    </node>
    ...
    <node role="testMethodList" type="jetbrains.mps.baseLanguage.unitTest.structure.TestMethodList" id="1220892430277">
      <node role="testMethod" type="jetbrains.mps.baseLanguage.unitTest.structure.TestMethod" id="1220892470700">
        ...
        <node role="body" type="jetbrains.mps.baseLanguage.structure.StatementList" id="1220892470702">
          ...
          <node role="statement" type="jetbrains.mps.baseLanguage.regexp.structure.ForEachMatchStatement" id="1220893453002">
              ...
              <node role="statement" type="jetbrains.mps.baseLanguage.unitTest.structure.AssertTrue" id="1220893559506">
                <node role="condition" type="jetbrains.mps.baseLanguage.structure.OrExpression" id="1220893586702">
                  <node role="rightExpression" type="jetbrains.mps.baseLanguage.structure.DotExpression" id="1220893590769">
                    <node role="operand" type="jetbrains.mps.baseLanguage.regexp.structure.MatchVariableReference" id="1220893589377">
                  ...
                  <node role="leftExpression" type="jetbrains.mps.baseLanguage.structure.DotExpression" id="1220893563306">
                    <node role="operand" type="jetbrains.mps.baseLanguage.regexp.structure.MatchVariableReference" id="1220893561524">
                      <link role="match" targetNodeId="1220893522842" resolveInfo="match" />
                    </node>
            ...
            <node role="regexp" type="jetbrains.mps.baseLanguage.regexp.structure.InlineRegexpExpression" id="1220893455912">
              <node role="regexp" type="jetbrains.mps.baseLanguage.regexp.structure.MatchParensRegexp" id="1220893522842">
                <property name="name" value="match" />
                <node role="regexp" type="jetbrains.mps.baseLanguage.regexp.structure.OrRegexp" id="1220893534939">
                  <node role="right" type="jetbrains.mps.baseLanguage.regexp.structure.UnicodeCharacterRegexp" id="1220893537661">
                    <property name="code" value="041F" />
                  </node>
                  <node role="left" type="jetbrains.mps.baseLanguage.regexp.structure.UnicodeCharacterRegexp" id="1220893532204">
      ...
      <node role="testMethod" type="jetbrains.mps.baseLanguage.unitTest.structure.TestMethod" id="1221034616485">
        ...
        <node role="body" type="jetbrains.mps.baseLanguage.structure.StatementList" id="1221034616487">
          ...
          <node role="statement" type="jetbrains.mps.baseLanguage.regexp.structure.ForEachMatchStatement" id="1221034702262">
            ...
            <node role="body" type="jetbrains.mps.baseLanguage.structure.StatementList" id="1221034702264">
              <node role="statement" type="jetbrains.mps.baseLanguage.unitTest.structure.AssertTrue" id="1221034886042">
                <node role="condition" type="jetbrains.mps.baseLanguage.structure.DotExpression" id="1221040247077">
                  <node role="operand" type="jetbrains.mps.baseLanguage.regexp.structure.MatchVariableReference" id="1221040243310">
            ...
            <node role="regexp" type="jetbrains.mps.baseLanguage.regexp.structure.InlineRegexpExpression" id="1221034719079">
              <node role="regexp" type="jetbrains.mps.baseLanguage.regexp.structure.MatchParensRegexp" id="1221043190685">
                <property name="name" value="match" />
                <node role="regexp" type="jetbrains.mps.baseLanguage.regexp.structure.PositiveSymbolClassRegexp" id="1221043202031">
                  <node role="part" type="jetbrains.mps.baseLanguage.regexp.structure.IntervalSymbolClassPart" id="1221043203095">
      ...
      <node role="testMethod" type="jetbrains.mps.baseLanguage.unitTest.structure.TestMethod" id="1221047527207">
        ...
        <node role="body" type="jetbrains.mps.baseLanguage.structure.StatementList" id="1221047527209">
          ...
          <node role="statement" type="jetbrains.mps.baseLanguage.regexp.structure.ForEachMatchStatement" id="1221047575061">
            ...
            <node role="body" type="jetbrains.mps.baseLanguage.structure.StatementList" id="1221047575063">
              <node role="statement" type="jetbrains.mps.baseLanguage.unitTest.structure.AssertTrue" id="1221047683450">
                <node role="condition" type="jetbrains.mps.baseLanguage.structure.DotExpression" id="1221047705064">
                  <node role="operand" type="jetbrains.mps.baseLanguage.regexp.structure.MatchVariableReference" id="1221047696531">
            ...
            <node role="regexp" type="jetbrains.mps.baseLanguage.regexp.structure.InlineRegexpExpression" id="1221047584159">
              <node role="regexp" type="jetbrains.mps.baseLanguage.regexp.structure.MatchParensRegexp" id="1221047587208">
                <property name="name" value="match" />
                <node role="regexp" type="jetbrains.mps.baseLanguage.regexp.structure.PositiveSymbolClassRegexp" id="1221047597288">
                  <node role="part" type="jetbrains.mps.baseLanguage.regexp.structure.CharacterSymbolClassPart" id="1221047668527">
