...
public class matrix_element_must_be_number_CheckingRule extends AbstractNonTypesystemRule_Runtime implements Rule_Runtime {
  public matrix_element_must_be_number_CheckingRule() {
  }
