...
public class MatrixInitializerIndex extends BaseConcept implements INamedConcept, MatrixOrVectorInitializer {
  ...
  public int get_$attributesCount() {
    return this.getChildCount(MatrixInitializerIndex._$ATTRIBUTE);
  }

  public Iterator<Attribute> _$attributes() {
    return this.children(Attribute.class, MatrixInitializerIndex._$ATTRIBUTE);
  }

  public List<Attribute> get_$attributes() {
    return this.getChildren(Attribute.class, MatrixInitializerIndex._$ATTRIBUTE);
  }

  public void add_$attribute(Attribute node) {
    this.addChild(MatrixInitializerIndex._$ATTRIBUTE, node);
  }

  public void insert_$attribute(Attribute prev, Attribute node) {
    this.insertChild(prev, MatrixInitializerIndex._$ATTRIBUTE, node);
  }
