...
public class HereStringRedirection extends Redirection implements IToWordRedirection {
  ...
  public int get_$attributesCount() {
    return this.getChildCount(HereStringRedirection._$ATTRIBUTE);
  }

  public Iterator<Attribute> _$attributes() {
    return this.children(Attribute.class, HereStringRedirection._$ATTRIBUTE);
  }

  public List<Attribute> get_$attributes() {
    return this.getChildren(Attribute.class, HereStringRedirection._$ATTRIBUTE);
  }

  public void add_$attribute(Attribute node) {
    this.addChild(HereStringRedirection._$ATTRIBUTE, node);
  }

  public void insert_$attribute(Attribute prev, Attribute node) {
    this.insertChild(prev, HereStringRedirection._$ATTRIBUTE, node);
  }
