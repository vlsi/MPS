...
public class StructureAspectDescriptor extends DescriptorProvider<StructureDescriptor> {
  ...
  public StructureDescriptor getDescriptor(String conceptFqName) {
    switch ((conceptFqName).hashCode()) {
      ...
      case -478649446:
        return new StructureAspectDescriptor.DataBasedStructureDescriptor("jetbrains.mps.bash.structure.SimpleCommand", new String[]{"jetbrains.mps.bash.structure.AbstractCommand", "jetbrains.mps.lang.core.structure.INamedConcept"}, new String[]{"jetbrains.mps.bash.structure.Command", "jetbrains.mps.bash.structure.AbstractCommand"}, new String[]{"jetbrains.mps.lang.core.structure.BaseConcept", "jetbrains.mps.lang.core.structure.INamedConcept"});
      case -162753593:
      ...
      case -130393050:
        return new StructureAspectDescriptor.DataBasedStructureDescriptor("jetbrains.mps.bash.structure.AbstractLoopCommand", new String[]{"jetbrains.mps.bash.structure.AbstractCommand", "jetbrains.mps.bash.structure.ICompoundCommand"}, new String[]{"jetbrains.mps.bash.structure.ICompoundCommand", "jetbrains.mps.bash.structure.Command", "jetbrains.mps.bash.structure.AbstractCommand"}, new String[]{"jetbrains.mps.lang.core.structure.BaseConcept"});
      case 918159304:
        return new StructureAspectDescriptor.DataBasedStructureDescriptor("jetbrains.mps.bash.structure.UntilLoopCommand", new String[]{"jetbrains.mps.bash.structure.AbstractLoopCommand"}, new String[]{"jetbrains.mps.bash.structure.Command", "jetbrains.mps.bash.structure.ICompoundCommand", "jetbrains.mps.bash.structure.AbstractCommand", "jetbrains.mps.bash.structure.AbstractLoopCommand"}, new String[]{"jetbrains.mps.lang.core.structure.BaseConcept"});
      case -1329630486:
      ...
      case -1075895787:
        return new StructureAspectDescriptor.DataBasedStructureDescriptor("jetbrains.mps.bash.structure.WhileLoopCommand", new String[]{"jetbrains.mps.bash.structure.AbstractLoopCommand"}, new String[]{"jetbrains.mps.bash.structure.Command", "jetbrains.mps.bash.structure.ICompoundCommand", "jetbrains.mps.bash.structure.AbstractCommand", "jetbrains.mps.bash.structure.AbstractLoopCommand"}, new String[]{"jetbrains.mps.lang.core.structure.BaseConcept"});
      case -1296101536:
        return new StructureAspectDescriptor.DataBasedStructureDescriptor("jetbrains.mps.bash.structure.ForeachCommand", new String[]{"jetbrains.mps.bash.structure.AbstractLoopCommand"}, new String[]{"jetbrains.mps.bash.structure.Command", "jetbrains.mps.bash.structure.ICompoundCommand", "jetbrains.mps.bash.structure.AbstractCommand", "jetbrains.mps.bash.structure.AbstractLoopCommand"}, new String[]{"jetbrains.mps.lang.core.structure.BaseConcept"});
      case -1380544268:
      ...
      case -958947455:
        return new StructureAspectDescriptor.DataBasedStructureDescriptor("jetbrains.mps.bash.structure.ForCommand", new String[]{"jetbrains.mps.bash.structure.AbstractLoopCommand"}, new String[]{"jetbrains.mps.bash.structure.Command", "jetbrains.mps.bash.structure.ICompoundCommand", "jetbrains.mps.bash.structure.AbstractCommand", "jetbrains.mps.bash.structure.AbstractLoopCommand"}, new String[]{"jetbrains.mps.lang.core.structure.BaseConcept"});
      case -1395519135:
      ...
      case 1861239375:
        return new StructureAspectDescriptor.DataBasedStructureDescriptor("jetbrains.mps.bash.structure.IfCommand", new String[]{"jetbrains.mps.bash.structure.AbstractCommand", "jetbrains.mps.bash.structure.ICompoundCommand"}, new String[]{"jetbrains.mps.bash.structure.ICompoundCommand", "jetbrains.mps.bash.structure.Command", "jetbrains.mps.bash.structure.AbstractCommand"}, new String[]{"jetbrains.mps.lang.core.structure.BaseConcept"});
      case -1952887480:
      ...
      case 1165178012:
        return new StructureAspectDescriptor.DataBasedStructureDescriptor("jetbrains.mps.bash.structure.CaseCommand", new String[]{"jetbrains.mps.bash.structure.AbstractCommand", "jetbrains.mps.bash.structure.ICompoundCommand"}, new String[]{"jetbrains.mps.bash.structure.ICompoundCommand", "jetbrains.mps.bash.structure.Command", "jetbrains.mps.bash.structure.AbstractCommand"}, new String[]{"jetbrains.mps.lang.core.structure.BaseConcept"});
      case 627780097:
      ...
      case -1871775472:
        return new StructureAspectDescriptor.DataBasedStructureDescriptor("jetbrains.mps.bash.structure.SelectCommand", new String[]{"jetbrains.mps.bash.structure.AbstractCommand", "jetbrains.mps.bash.structure.ICompoundCommand"}, new String[]{"jetbrains.mps.bash.structure.ICompoundCommand", "jetbrains.mps.bash.structure.Command", "jetbrains.mps.bash.structure.AbstractCommand"}, new String[]{"jetbrains.mps.lang.core.structure.BaseConcept"});
      case -932595991:
        return new StructureAspectDescriptor.DataBasedStructureDescriptor("jetbrains.mps.bash.structure.GroupingCommand", new String[]{"jetbrains.mps.bash.structure.AbstractCommand", "jetbrains.mps.bash.structure.ICompoundCommand"}, new String[]{"jetbrains.mps.bash.structure.ICompoundCommand", "jetbrains.mps.bash.structure.Command", "jetbrains.mps.bash.structure.AbstractCommand"}, new String[]{"jetbrains.mps.lang.core.structure.BaseConcept"});
      case 1812296375:
        return new StructureAspectDescriptor.DataBasedStructureDescriptor("jetbrains.mps.bash.structure.BraceGrouping", new String[]{"jetbrains.mps.bash.structure.GroupingCommand"}, new String[]{"jetbrains.mps.bash.structure.Command", "jetbrains.mps.bash.structure.ICompoundCommand", "jetbrains.mps.bash.structure.GroupingCommand", "jetbrains.mps.bash.structure.AbstractCommand"}, new String[]{"jetbrains.mps.lang.core.structure.BaseConcept"});
      case -335053844:
        return new StructureAspectDescriptor.DataBasedStructureDescriptor("jetbrains.mps.bash.structure.BracketGrouping", new String[]{"jetbrains.mps.bash.structure.GroupingCommand"}, new String[]{"jetbrains.mps.bash.structure.Command", "jetbrains.mps.bash.structure.ICompoundCommand", "jetbrains.mps.bash.structure.GroupingCommand", "jetbrains.mps.bash.structure.AbstractCommand"}, new String[]{"jetbrains.mps.lang.core.structure.BaseConcept"});
      case 356461506:
        return new StructureAspectDescriptor.DataBasedStructureDescriptor("jetbrains.mps.bash.structure.BinaryArithmeticExpression", new String[]{"jetbrains.mps.bash.structure.ArithmeticExpression", "jetbrains.mps.bash.structure.IPriorityExpression"}, new String[]{"jetbrains.mps.bash.structure.IPriorityExpression", "jetbrains.mps.bash.structure.ArithmeticExpression"}, new String[]{"jetbrains.mps.lang.core.structure.BaseConcept"});
      case 451754973:
        return new StructureAspectDescriptor.DataBasedStructureDescriptor("jetbrains.mps.bash.structure.MulExpression", new String[]{"jetbrains.mps.bash.structure.BinaryArithmeticExpression"}, new String[]{"jetbrains.mps.bash.structure.IPriorityExpression", "jetbrains.mps.bash.structure.BinaryArithmeticExpression", "jetbrains.mps.bash.structure.ArithmeticExpression"}, new String[]{"jetbrains.mps.lang.core.structure.BaseConcept"});
      case 753745002:
        return new StructureAspectDescriptor.DataBasedStructureDescriptor("jetbrains.mps.bash.structure.DivExpression", new String[]{"jetbrains.mps.bash.structure.BinaryArithmeticExpression"}, new String[]{"jetbrains.mps.bash.structure.IPriorityExpression", "jetbrains.mps.bash.structure.BinaryArithmeticExpression", "jetbrains.mps.bash.structure.ArithmeticExpression"}, new String[]{"jetbrains.mps.lang.core.structure.BaseConcept"});
      case 1167967643:
        return new StructureAspectDescriptor.DataBasedStructureDescriptor("jetbrains.mps.bash.structure.ModExpression", new String[]{"jetbrains.mps.bash.structure.BinaryArithmeticExpression"}, new String[]{"jetbrains.mps.bash.structure.IPriorityExpression", "jetbrains.mps.bash.structure.BinaryArithmeticExpression", "jetbrains.mps.bash.structure.ArithmeticExpression"}, new String[]{"jetbrains.mps.lang.core.structure.BaseConcept"});
      case -1026073478:
        return new StructureAspectDescriptor.DataBasedStructureDescriptor("jetbrains.mps.bash.structure.AddExpression", new String[]{"jetbrains.mps.bash.structure.BinaryArithmeticExpression"}, new String[]{"jetbrains.mps.bash.structure.IPriorityExpression", "jetbrains.mps.bash.structure.BinaryArithmeticExpression", "jetbrains.mps.bash.structure.ArithmeticExpression"}, new String[]{"jetbrains.mps.lang.core.structure.BaseConcept"});
      case -519018663:
        return new StructureAspectDescriptor.DataBasedStructureDescriptor("jetbrains.mps.bash.structure.SubExpression", new String[]{"jetbrains.mps.bash.structure.BinaryArithmeticExpression"}, new String[]{"jetbrains.mps.bash.structure.IPriorityExpression", "jetbrains.mps.bash.structure.BinaryArithmeticExpression", "jetbrains.mps.bash.structure.ArithmeticExpression"}, new String[]{"jetbrains.mps.lang.core.structure.BaseConcept"});
      case -1004536542:
        return new StructureAspectDescriptor.DataBasedStructureDescriptor("jetbrains.mps.bash.structure.ArithmeticCommand", new String[]{"jetbrains.mps.bash.structure.AbstractCommand", "jetbrains.mps.bash.structure.ICompoundCommand", "jetbrains.mps.bash.structure.IArithmeticHolder"}, new String[]{"jetbrains.mps.bash.structure.IArithmeticHolder", "jetbrains.mps.bash.structure.ICompoundCommand", "jetbrains.mps.bash.structure.Command", "jetbrains.mps.bash.structure.AbstractCommand"}, new String[]{"jetbrains.mps.lang.core.structure.BaseConcept"});
      case 392289170:
      ...
      case 444388919:
        return new StructureAspectDescriptor.DataBasedStructureDescriptor("jetbrains.mps.bash.structure.PostIncExpression", new String[]{"jetbrains.mps.bash.structure.PostVariableExpression"}, new String[]{"jetbrains.mps.bash.structure.ArithmeticExpression", "jetbrains.mps.bash.structure.WordExpression", "jetbrains.mps.bash.structure.PostVariableExpression"}, new String[]{"jetbrains.mps.lang.core.structure.BaseConcept"});
      case 749659483:
        return new StructureAspectDescriptor.DataBasedStructureDescriptor("jetbrains.mps.bash.structure.PostDecExpression", new String[]{"jetbrains.mps.bash.structure.PostVariableExpression"}, new String[]{"jetbrains.mps.bash.structure.ArithmeticExpression", "jetbrains.mps.bash.structure.WordExpression", "jetbrains.mps.bash.structure.PostVariableExpression"}, new String[]{"jetbrains.mps.lang.core.structure.BaseConcept"});
      case 1640314162:
        return new StructureAspectDescriptor.DataBasedStructureDescriptor("jetbrains.mps.bash.structure.PreIncExpression", new String[]{"jetbrains.mps.bash.structure.PreVariableExpression"}, new String[]{"jetbrains.mps.bash.structure.ArithmeticExpression", "jetbrains.mps.bash.structure.WordExpression", "jetbrains.mps.bash.structure.PreVariableExpression"}, new String[]{"jetbrains.mps.lang.core.structure.BaseConcept"});
      case 1945584726:
        return new StructureAspectDescriptor.DataBasedStructureDescriptor("jetbrains.mps.bash.structure.PreDecExpression", new String[]{"jetbrains.mps.bash.structure.PreVariableExpression"}, new String[]{"jetbrains.mps.bash.structure.ArithmeticExpression", "jetbrains.mps.bash.structure.WordExpression", "jetbrains.mps.bash.structure.PreVariableExpression"}, new String[]{"jetbrains.mps.lang.core.structure.BaseConcept"});
      case 664537218:
        return new StructureAspectDescriptor.DataBasedStructureDescriptor("jetbrains.mps.bash.structure.UnaryPlusExpression", new String[]{"jetbrains.mps.bash.structure.UnaryArithmeticExpression"}, new String[]{"jetbrains.mps.bash.structure.UnaryArithmeticExpression", "jetbrains.mps.bash.structure.ArithmeticExpression"}, new String[]{"jetbrains.mps.lang.core.structure.BaseConcept"});
      case 590404728:
        return new StructureAspectDescriptor.DataBasedStructureDescriptor("jetbrains.mps.bash.structure.UnaryMinusExpression", new String[]{"jetbrains.mps.bash.structure.UnaryArithmeticExpression"}, new String[]{"jetbrains.mps.bash.structure.UnaryArithmeticExpression", "jetbrains.mps.bash.structure.ArithmeticExpression"}, new String[]{"jetbrains.mps.lang.core.structure.BaseConcept"});
      case -2140698457:
        return new StructureAspectDescriptor.DataBasedStructureDescriptor("jetbrains.mps.bash.structure.LogicalNegationExpression", new String[]{"jetbrains.mps.bash.structure.UnaryArithmeticExpression"}, new String[]{"jetbrains.mps.bash.structure.UnaryArithmeticExpression", "jetbrains.mps.bash.structure.ArithmeticExpression"}, new String[]{"jetbrains.mps.lang.core.structure.BaseConcept"});
      case -2086776369:
        return new StructureAspectDescriptor.DataBasedStructureDescriptor("jetbrains.mps.bash.structure.BitwiseNegationExpression", new String[]{"jetbrains.mps.bash.structure.UnaryArithmeticExpression"}, new String[]{"jetbrains.mps.bash.structure.UnaryArithmeticExpression", "jetbrains.mps.bash.structure.ArithmeticExpression"}, new String[]{"jetbrains.mps.lang.core.structure.BaseConcept"});
      case 293389046:
        return new StructureAspectDescriptor.DataBasedStructureDescriptor("jetbrains.mps.bash.structure.ExpExpression", new String[]{"jetbrains.mps.bash.structure.BinaryArithmeticExpression"}, new String[]{"jetbrains.mps.bash.structure.IPriorityExpression", "jetbrains.mps.bash.structure.BinaryArithmeticExpression", "jetbrains.mps.bash.structure.ArithmeticExpression"}, new String[]{"jetbrains.mps.lang.core.structure.BaseConcept"});
      case -67688081:
      ...
      case 899464561:
        return new StructureAspectDescriptor.DataBasedStructureDescriptor("jetbrains.mps.bash.structure.EqualityExpression", new String[]{"jetbrains.mps.bash.structure.BinaryArithmeticExpression"}, new String[]{"jetbrains.mps.bash.structure.IPriorityExpression", "jetbrains.mps.bash.structure.BinaryArithmeticExpression", "jetbrains.mps.bash.structure.ArithmeticExpression"}, new String[]{"jetbrains.mps.lang.core.structure.BaseConcept"});
      case -87418986:
        return new StructureAspectDescriptor.DataBasedStructureDescriptor("jetbrains.mps.bash.structure.InequalityExpression", new String[]{"jetbrains.mps.bash.structure.BinaryArithmeticExpression"}, new String[]{"jetbrains.mps.bash.structure.IPriorityExpression", "jetbrains.mps.bash.structure.BinaryArithmeticExpression", "jetbrains.mps.bash.structure.ArithmeticExpression"}, new String[]{"jetbrains.mps.lang.core.structure.BaseConcept"});
      case -240007523:
        return new StructureAspectDescriptor.DataBasedStructureDescriptor("jetbrains.mps.bash.structure.BitwiseAndExpression", new String[]{"jetbrains.mps.bash.structure.BinaryArithmeticExpression"}, new String[]{"jetbrains.mps.bash.structure.IPriorityExpression", "jetbrains.mps.bash.structure.BinaryArithmeticExpression", "jetbrains.mps.bash.structure.ArithmeticExpression"}, new String[]{"jetbrains.mps.lang.core.structure.BaseConcept"});
      case 1985326157:
        return new StructureAspectDescriptor.DataBasedStructureDescriptor("jetbrains.mps.bash.structure.BitwiseOrExpression", new String[]{"jetbrains.mps.bash.structure.BinaryArithmeticExpression"}, new String[]{"jetbrains.mps.bash.structure.IPriorityExpression", "jetbrains.mps.bash.structure.BinaryArithmeticExpression", "jetbrains.mps.bash.structure.ArithmeticExpression"}, new String[]{"jetbrains.mps.lang.core.structure.BaseConcept"});
      case -1951741919:
        return new StructureAspectDescriptor.DataBasedStructureDescriptor("jetbrains.mps.bash.structure.BitwiseXorExpression", new String[]{"jetbrains.mps.bash.structure.BinaryArithmeticExpression"}, new String[]{"jetbrains.mps.bash.structure.IPriorityExpression", "jetbrains.mps.bash.structure.BinaryArithmeticExpression", "jetbrains.mps.bash.structure.ArithmeticExpression"}, new String[]{"jetbrains.mps.lang.core.structure.BaseConcept"});
      case -41441083:
        return new StructureAspectDescriptor.DataBasedStructureDescriptor("jetbrains.mps.bash.structure.LogicalAndExpression", new String[]{"jetbrains.mps.bash.structure.BinaryArithmeticExpression"}, new String[]{"jetbrains.mps.bash.structure.IPriorityExpression", "jetbrains.mps.bash.structure.BinaryArithmeticExpression", "jetbrains.mps.bash.structure.ArithmeticExpression"}, new String[]{"jetbrains.mps.lang.core.structure.BaseConcept"});
      case 883352869:
        return new StructureAspectDescriptor.DataBasedStructureDescriptor("jetbrains.mps.bash.structure.LogicalOrExpression", new String[]{"jetbrains.mps.bash.structure.BinaryArithmeticExpression"}, new String[]{"jetbrains.mps.bash.structure.IPriorityExpression", "jetbrains.mps.bash.structure.BinaryArithmeticExpression", "jetbrains.mps.bash.structure.ArithmeticExpression"}, new String[]{"jetbrains.mps.lang.core.structure.BaseConcept"});
      case -1539845778:
        return new StructureAspectDescriptor.DataBasedStructureDescriptor("jetbrains.mps.bash.structure.CommaExpression", new String[]{"jetbrains.mps.bash.structure.BinaryArithmeticExpression"}, new String[]{"jetbrains.mps.bash.structure.IPriorityExpression", "jetbrains.mps.bash.structure.BinaryArithmeticExpression", "jetbrains.mps.bash.structure.ArithmeticExpression"}, new String[]{"jetbrains.mps.lang.core.structure.BaseConcept"});
      case 1015035728:
      ...
      case -1457229770:
        return new StructureAspectDescriptor.DataBasedStructureDescriptor("jetbrains.mps.bash.structure.DecimalConstant", new String[]{"jetbrains.mps.bash.structure.IntegerLiteral"}, new String[]{"jetbrains.mps.bash.structure.IntegerLiteral", "jetbrains.mps.bash.structure.ArithmeticExpression"}, new String[]{"jetbrains.mps.lang.core.structure.BaseConcept"});
      case -729531539:
        return new StructureAspectDescriptor.DataBasedStructureDescriptor("jetbrains.mps.bash.structure.HexIntegerLiteral", new String[]{"jetbrains.mps.bash.structure.IntegerLiteral"}, new String[]{"jetbrains.mps.bash.structure.IntegerLiteral", "jetbrains.mps.bash.structure.ArithmeticExpression"}, new String[]{"jetbrains.mps.lang.core.structure.BaseConcept"});
      case -1309172283:
        return new StructureAspectDescriptor.DataBasedStructureDescriptor("jetbrains.mps.bash.structure.BasedIntegerLiteral", new String[]{"jetbrains.mps.bash.structure.IntegerLiteral"}, new String[]{"jetbrains.mps.bash.structure.IntegerLiteral", "jetbrains.mps.bash.structure.ArithmeticExpression"}, new String[]{"jetbrains.mps.lang.core.structure.BaseConcept"});
      case 1343773505:
      ...
      case 363248404:
        return new StructureAspectDescriptor.DataBasedStructureDescriptor("jetbrains.mps.bash.structure.GreaterThanExpression", new String[]{"jetbrains.mps.bash.structure.BinaryArithmeticExpression"}, new String[]{"jetbrains.mps.bash.structure.IPriorityExpression", "jetbrains.mps.bash.structure.BinaryArithmeticExpression", "jetbrains.mps.bash.structure.ArithmeticExpression"}, new String[]{"jetbrains.mps.lang.core.structure.BaseConcept"});
      case 1218207569:
        return new StructureAspectDescriptor.DataBasedStructureDescriptor("jetbrains.mps.bash.structure.LessThanExpression", new String[]{"jetbrains.mps.bash.structure.BinaryArithmeticExpression"}, new String[]{"jetbrains.mps.bash.structure.IPriorityExpression", "jetbrains.mps.bash.structure.BinaryArithmeticExpression", "jetbrains.mps.bash.structure.ArithmeticExpression"}, new String[]{"jetbrains.mps.lang.core.structure.BaseConcept"});
      case 422166669:
        return new StructureAspectDescriptor.DataBasedStructureDescriptor("jetbrains.mps.bash.structure.GreaterThanOrEqualExpression", new String[]{"jetbrains.mps.bash.structure.BinaryArithmeticExpression"}, new String[]{"jetbrains.mps.bash.structure.IPriorityExpression", "jetbrains.mps.bash.structure.BinaryArithmeticExpression", "jetbrains.mps.bash.structure.ArithmeticExpression"}, new String[]{"jetbrains.mps.lang.core.structure.BaseConcept"});
      case -1711583824:
        return new StructureAspectDescriptor.DataBasedStructureDescriptor("jetbrains.mps.bash.structure.LessThanOrEqualExpression", new String[]{"jetbrains.mps.bash.structure.BinaryArithmeticExpression"}, new String[]{"jetbrains.mps.bash.structure.IPriorityExpression", "jetbrains.mps.bash.structure.BinaryArithmeticExpression", "jetbrains.mps.bash.structure.ArithmeticExpression"}, new String[]{"jetbrains.mps.lang.core.structure.BaseConcept"});
      case -281672704:
      ...
      case -32343786:
        return new StructureAspectDescriptor.DataBasedStructureDescriptor("jetbrains.mps.bash.structure.AssingmentExpression", new String[]{"jetbrains.mps.bash.structure.BaseAssingmentExpression"}, new String[]{"jetbrains.mps.bash.structure.BaseAssingmentExpression", "jetbrains.mps.bash.structure.ArithmeticExpression"}, new String[]{"jetbrains.mps.lang.core.structure.BaseConcept"});
      case 1928991312:
        return new StructureAspectDescriptor.DataBasedStructureDescriptor("jetbrains.mps.bash.structure.PlusAssingmentExpression", new String[]{"jetbrains.mps.bash.structure.BaseAssingmentExpression"}, new String[]{"jetbrains.mps.bash.structure.BaseAssingmentExpression", "jetbrains.mps.bash.structure.ArithmeticExpression"}, new String[]{"jetbrains.mps.lang.core.structure.BaseConcept"});
      case 1738033160:
        return new StructureAspectDescriptor.DataBasedStructureDescriptor("jetbrains.mps.bash.structure.MinusAssingmentExpression", new String[]{"jetbrains.mps.bash.structure.BaseAssingmentExpression"}, new String[]{"jetbrains.mps.bash.structure.BaseAssingmentExpression", "jetbrains.mps.bash.structure.ArithmeticExpression"}, new String[]{"jetbrains.mps.lang.core.structure.BaseConcept"});
      case -1234235357:
        return new StructureAspectDescriptor.DataBasedStructureDescriptor("jetbrains.mps.bash.structure.MusAssingmentExpression", new String[]{"jetbrains.mps.bash.structure.BaseAssingmentExpression"}, new String[]{"jetbrains.mps.bash.structure.BaseAssingmentExpression", "jetbrains.mps.bash.structure.ArithmeticExpression"}, new String[]{"jetbrains.mps.lang.core.structure.BaseConcept"});
      case -231289367:
        return new StructureAspectDescriptor.DataBasedStructureDescriptor("jetbrains.mps.bash.structure.DivAssingmentExpression", new String[]{"jetbrains.mps.bash.structure.BaseAssingmentExpression"}, new String[]{"jetbrains.mps.bash.structure.BaseAssingmentExpression", "jetbrains.mps.bash.structure.ArithmeticExpression"}, new String[]{"jetbrains.mps.lang.core.structure.BaseConcept"});
      case -766095910:
        return new StructureAspectDescriptor.DataBasedStructureDescriptor("jetbrains.mps.bash.structure.ModAssingmentExpression", new String[]{"jetbrains.mps.bash.structure.BaseAssingmentExpression"}, new String[]{"jetbrains.mps.bash.structure.BaseAssingmentExpression", "jetbrains.mps.bash.structure.ArithmeticExpression"}, new String[]{"jetbrains.mps.lang.core.structure.BaseConcept"});
      case -1550893997:
        return new StructureAspectDescriptor.DataBasedStructureDescriptor("jetbrains.mps.bash.structure.LeftShiftAssingmentExpression", new String[]{"jetbrains.mps.bash.structure.BaseAssingmentExpression"}, new String[]{"jetbrains.mps.bash.structure.BaseAssingmentExpression", "jetbrains.mps.bash.structure.ArithmeticExpression"}, new String[]{"jetbrains.mps.lang.core.structure.BaseConcept"});
      case -1480136900:
        return new StructureAspectDescriptor.DataBasedStructureDescriptor("jetbrains.mps.bash.structure.RightShiftAssingmentExpression", new String[]{"jetbrains.mps.bash.structure.BaseAssingmentExpression"}, new String[]{"jetbrains.mps.bash.structure.BaseAssingmentExpression", "jetbrains.mps.bash.structure.ArithmeticExpression"}, new String[]{"jetbrains.mps.lang.core.structure.BaseConcept"});
      case -780311505:
        return new StructureAspectDescriptor.DataBasedStructureDescriptor("jetbrains.mps.bash.structure.AndAssingmentExpression", new String[]{"jetbrains.mps.bash.structure.BaseAssingmentExpression"}, new String[]{"jetbrains.mps.bash.structure.BaseAssingmentExpression", "jetbrains.mps.bash.structure.ArithmeticExpression"}, new String[]{"jetbrains.mps.lang.core.structure.BaseConcept"});
      case -1835186215:
        return new StructureAspectDescriptor.DataBasedStructureDescriptor("jetbrains.mps.bash.structure.OrAssingmentExpression", new String[]{"jetbrains.mps.bash.structure.BaseAssingmentExpression"}, new String[]{"jetbrains.mps.bash.structure.BaseAssingmentExpression", "jetbrains.mps.bash.structure.ArithmeticExpression"}, new String[]{"jetbrains.mps.lang.core.structure.BaseConcept"});
      case -1294643021:
        return new StructureAspectDescriptor.DataBasedStructureDescriptor("jetbrains.mps.bash.structure.XorAssingmentExpression", new String[]{"jetbrains.mps.bash.structure.BaseAssingmentExpression"}, new String[]{"jetbrains.mps.bash.structure.BaseAssingmentExpression", "jetbrains.mps.bash.structure.ArithmeticExpression"}, new String[]{"jetbrains.mps.lang.core.structure.BaseConcept"});
      case -551242325:
        return new StructureAspectDescriptor.DataBasedStructureDescriptor("jetbrains.mps.bash.structure.BaseVariableAssingment", new String[]{"jetbrains.mps.bash.structure.AbstractCommand"}, new String[]{"jetbrains.mps.bash.structure.Command", "jetbrains.mps.bash.structure.AbstractCommand"}, new String[]{"jetbrains.mps.lang.core.structure.BaseConcept"});
      case -49554310:
        return new StructureAspectDescriptor.DataBasedStructureDescriptor("jetbrains.mps.bash.structure.VariableAssingment", new String[]{"jetbrains.mps.bash.structure.BaseVariableAssingment"}, new String[]{"jetbrains.mps.bash.structure.Command", "jetbrains.mps.bash.structure.AbstractCommand", "jetbrains.mps.bash.structure.BaseVariableAssingment"}, new String[]{"jetbrains.mps.lang.core.structure.BaseConcept"});
      case 177057029:
      ...
      case -1716626478:
        return new StructureAspectDescriptor.DataBasedStructureDescriptor("jetbrains.mps.bash.structure.QuotesCommandSubstitution", new String[]{"jetbrains.mps.bash.structure.BaseCommandSubstitution", "jetbrains.mps.bash.structure.IConcreteWordUnit"}, new String[]{"jetbrains.mps.bash.structure.IConcreteWordUnit", "jetbrains.mps.bash.structure.BaseCommandSubstitution", "jetbrains.mps.bash.structure.IGeneralizedWordUnit"}, new String[]{"jetbrains.mps.lang.core.structure.BaseConcept"});
      case -1113380082:
      ...
      case 902159153:
        return new StructureAspectDescriptor.DataBasedStructureDescriptor("jetbrains.mps.bash.structure.RedirectedCommand", new String[]{"jetbrains.mps.bash.structure.AbstractCommand"}, new String[]{"jetbrains.mps.bash.structure.Command", "jetbrains.mps.bash.structure.AbstractCommand"}, new String[]{"jetbrains.mps.lang.core.structure.BaseConcept"});
      case 1680634189:
      ...
      case 1607356772:
        return new StructureAspectDescriptor.DataBasedStructureDescriptor("jetbrains.mps.bash.structure.OutputErrorRedirection", new String[]{"jetbrains.mps.bash.structure.Redirection", "jetbrains.mps.bash.structure.IToWordRedirection"}, new String[]{"jetbrains.mps.bash.structure.Redirection", "jetbrains.mps.bash.structure.IToWordRedirection"}, new String[]{"jetbrains.mps.lang.core.structure.BaseConcept"});
      case 1528865646:
      ...
      case -741151444:
        return new StructureAspectDescriptor.DataBasedStructureDescriptor("jetbrains.mps.bash.structure.HereStringRedirection", new String[]{"jetbrains.mps.bash.structure.Redirection", "jetbrains.mps.bash.structure.IToWordRedirection"}, new String[]{"jetbrains.mps.bash.structure.Redirection", "jetbrains.mps.bash.structure.IToWordRedirection"}, new String[]{"jetbrains.mps.lang.core.structure.BaseConcept"});
      case 794347757:
      ...
      case 985026595:
        return new StructureAspectDescriptor.DataBasedStructureDescriptor("jetbrains.mps.bash.structure.FunctionDeclaration", new String[]{"jetbrains.mps.bash.structure.AbstractCommand", "jetbrains.mps.lang.core.structure.INamedConcept"}, new String[]{"jetbrains.mps.bash.structure.Command", "jetbrains.mps.bash.structure.AbstractCommand"}, new String[]{"jetbrains.mps.lang.core.structure.BaseConcept", "jetbrains.mps.lang.core.structure.INamedConcept"});
      case -1649341066:
      ...
      case -744484426:
        return new StructureAspectDescriptor.DataBasedStructureDescriptor("jetbrains.mps.bash.structure.FunctionCallCommand", new String[]{"jetbrains.mps.bash.structure.AbstractCommand"}, new String[]{"jetbrains.mps.bash.structure.Command", "jetbrains.mps.bash.structure.AbstractCommand"}, new String[]{"jetbrains.mps.lang.core.structure.BaseConcept"});
      case 775606169:
      ...
      case 515421471:
        return new StructureAspectDescriptor.DataBasedStructureDescriptor("jetbrains.mps.bash.structure.ExternalCommandCall", new String[]{"jetbrains.mps.bash.structure.AbstractCommand"}, new String[]{"jetbrains.mps.bash.structure.Command", "jetbrains.mps.bash.structure.AbstractCommand"}, new String[]{"jetbrains.mps.lang.core.structure.BaseConcept"});
      case -89410516:
      ...
      case -356655068:
        return new StructureAspectDescriptor.DataBasedStructureDescriptor("jetbrains.mps.bash.structure.ConditionalCommand", new String[]{"jetbrains.mps.bash.structure.AbstractCommand", "jetbrains.mps.bash.structure.ICompoundCommand"}, new String[]{"jetbrains.mps.bash.structure.ICompoundCommand", "jetbrains.mps.bash.structure.Command", "jetbrains.mps.bash.structure.AbstractCommand"}, new String[]{"jetbrains.mps.lang.core.structure.BaseConcept"});
      case -1771122223:
      ...
      case -2034342475:
        return new StructureAspectDescriptor.DataBasedStructureDescriptor("jetbrains.mps.bash.structure.SingleQuote", new String[]{"jetbrains.mps.bash.structure.QuotedWord"}, new String[]{"jetbrains.mps.bash.structure.IConcreteWordUnit", "jetbrains.mps.bash.structure.QuotedWord", "jetbrains.mps.bash.structure.IGeneralizedWordUnit"}, new String[]{"jetbrains.mps.lang.core.structure.BaseConcept"});
      case -1920353332:
        return new StructureAspectDescriptor.DataBasedStructureDescriptor("jetbrains.mps.bash.structure.DoubleQuote", new String[]{"jetbrains.mps.bash.structure.QuotedWord"}, new String[]{"jetbrains.mps.bash.structure.IConcreteWordUnit", "jetbrains.mps.bash.structure.QuotedWord", "jetbrains.mps.bash.structure.IGeneralizedWordUnit"}, new String[]{"jetbrains.mps.lang.core.structure.BaseConcept"});
      case 246545734:
      ...
      case -1097091081:
        return new StructureAspectDescriptor.DataBasedStructureDescriptor("jetbrains.mps.bash.structure.CommentedFollowingCommandList", new String[]{"jetbrains.mps.bash.structure.AbstractFollowingCommandList", "jetbrains.mps.bash.structure.IComment"}, new String[]{"jetbrains.mps.bash.structure.IComment", "jetbrains.mps.bash.structure.AbstractFollowingCommandList"}, new String[]{"jetbrains.mps.lang.core.structure.BaseConcept"});
      case 552013305:
      ...
      case 1804831248:
        return new StructureAspectDescriptor.DataBasedStructureDescriptor("jetbrains.mps.bash.structure.VariableReference", new String[]{"jetbrains.mps.bash.structure.LValue", "jetbrains.mps.bash.structure.IGeneralizedWordUnit"}, new String[]{"jetbrains.mps.bash.structure.LValue", "jetbrains.mps.bash.structure.IGeneralizedWordUnit"}, new String[]{"jetbrains.mps.lang.core.structure.BaseConcept"});
      case -1941555425:
      ...
      case 558087648:
        return new StructureAspectDescriptor.DataBasedStructureDescriptor("jetbrains.mps.bash.structure.FreeCommand", new String[]{"jetbrains.mps.bash.structure.AbstractCommand"}, new String[]{"jetbrains.mps.bash.structure.Command", "jetbrains.mps.bash.structure.AbstractCommand"}, new String[]{"jetbrains.mps.lang.core.structure.BaseConcept"});
      case 1704792662:
      ...
      case -297275803:
        return new StructureAspectDescriptor.DataBasedStructureDescriptor("jetbrains.mps.bash.structure.VariableAddAssingment", new String[]{"jetbrains.mps.bash.structure.BaseVariableAssingment"}, new String[]{"jetbrains.mps.bash.structure.Command", "jetbrains.mps.bash.structure.AbstractCommand", "jetbrains.mps.bash.structure.BaseVariableAssingment"}, new String[]{"jetbrains.mps.lang.core.structure.BaseConcept"});
      case 954565175:
        return new StructureAspectDescriptor.DataBasedStructureDescriptor("jetbrains.mps.bash.structure.NotCommand", new String[]{"jetbrains.mps.bash.structure.AbstractCommand"}, new String[]{"jetbrains.mps.bash.structure.Command", "jetbrains.mps.bash.structure.AbstractCommand"}, new String[]{"jetbrains.mps.lang.core.structure.BaseConcept"});
      case -1849847993:
