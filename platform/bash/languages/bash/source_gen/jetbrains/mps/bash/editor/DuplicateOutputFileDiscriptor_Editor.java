...
public class DuplicateOutputFileDiscriptor_Editor extends DefaultNodeEditor {
  public EditorCell createEditorCell(EditorContext editorContext, SNode node) {
    return this.createCollection_gxzhd4_a(editorContext, node);
  }
  ...
  private EditorCell createConstant_gxzhd4_b0(EditorContext editorContext, SNode node) {
    EditorCell_Constant editorCell = new EditorCell_Constant(editorContext, node, ">&");
    editorCell.setCellId("Constant_gxzhd4_b0");
    {
  ...
  private EditorCell createProperty_gxzhd4_a0(EditorContext editorContext, SNode node) {
  ...
  private EditorCell createRefNode_gxzhd4_c0(EditorContext editorContext, SNode node) {
