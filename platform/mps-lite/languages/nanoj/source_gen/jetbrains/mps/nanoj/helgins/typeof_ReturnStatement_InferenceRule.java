...
public class typeof_ReturnStatement_InferenceRule implements InferenceRule_Runtime {
  ...
  public void applyRule(final SNode argument) {
    ...
    if(method != null) {
      TypeChecker.getInstance().getRuntimeSupport().createLessThanInequationStrong(TypeChecker.getInstance().getRuntimeSupport().typeOf(SLinkOperations.getTarget(argument, "expression", true), "jetbrains.mps.nanoj.helgins", "1197468445014", true), SLinkOperations.getTarget(method, "type", true), SLinkOperations.getTarget(argument, "expression", true), null, "jetbrains.mps.nanoj.helgins", "1197468445012");
    }
  }
