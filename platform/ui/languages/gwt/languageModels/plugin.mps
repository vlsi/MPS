...
<model modelUID="r:bf61c05e-83e1-433e-ab90-8fab5d35e6e3(jetbrains.mps.ui.gwt.plugin)">
  ...
  <node type="jetbrains.mps.lang.plugin.structure.ApplicationPluginDeclaration" id="6661832029303965099">
    ...
    <node role="fieldDeclaration" type="jetbrains.mps.baseLanguage.classifiers.structure.DefaultClassifierFieldDeclaration" id="6661832029303965100">
      ...
      <node role="visibility" type="jetbrains.mps.baseLanguage.structure.PrivateVisibility" id="6661832029303965101" />
      <node role="type" type="jetbrains.mps.baseLanguage.structure.ClassifierType" id="6661832029303965102">
        <link role="classifier" targetNodeId="5.6661832029303857606" resolveInfo="EditorExtensionHelper" />
      </node>
    </node>
    <node role="initBlock" type="jetbrains.mps.lang.plugin.structure.ApplicationPluginInitBlock" id="6661832029303965103">
      <node role="body" type="jetbrains.mps.baseLanguage.structure.StatementList" id="6661832029303965104">
        <node role="statement" type="jetbrains.mps.baseLanguage.structure.ExpressionStatement" id="6661832029303965105">
          <node role="expression" type="jetbrains.mps.baseLanguage.structure.AssignmentExpression" id="6661832029303965106">
            <node role="rValue" type="jetbrains.mps.baseLanguage.structure.GenericNewExpression" id="6661832029303965107">
              <node role="creator" type="jetbrains.mps.baseLanguage.structure.ClassCreator" id="6661832029303965108">
                <link role="baseMethodDeclaration" targetNodeId="5.6661832029303857608" resolveInfo="EditorExtensionHelper" />
                <node role="actualArgument" type="jetbrains.mps.baseLanguage.structure.StringLiteral" id="6661832029303965109">
                  <property name="value" value="jetbrains.mps.ui.gwt" />
                </node>
              </node>
            </node>
            <node role="lValue" type="jetbrains.mps.baseLanguage.structure.DotExpression" id="6661832029303965110">
              <node role="operand" type="jetbrains.mps.baseLanguage.classifiers.structure.ThisClassifierExpression" id="6661832029303965111" />
              <node role="operation" type="jetbrains.mps.baseLanguage.classifiers.structure.DefaultClassifierFieldAccessOperation" id="6661832029303965112">
                <link role="member" targetNodeId="6661832029303965100" resolveInfo="helper" />
              </node>
            </node>
          </node>
        </node>
        <node role="statement" type="jetbrains.mps.baseLanguage.structure.ExpressionStatement" id="6661832029303965113">
          <node role="expression" type="jetbrains.mps.baseLanguage.structure.DotExpression" id="6661832029303965114">
            <node role="operand" type="jetbrains.mps.baseLanguage.structure.DotExpression" id="6661832029303965115">
              <node role="operand" type="jetbrains.mps.baseLanguage.classifiers.structure.ThisClassifierExpression" id="6661832029303965116" />
              <node role="operation" type="jetbrains.mps.baseLanguage.classifiers.structure.DefaultClassifierFieldAccessOperation" id="6661832029303965117">
                <link role="member" targetNodeId="6661832029303965100" resolveInfo="helper" />
              </node>
            </node>
            <node role="operation" type="jetbrains.mps.baseLanguage.structure.InstanceMethodCallOperation" id="6661832029303965118">
    ...
    <node role="disposeBlock" type="jetbrains.mps.lang.plugin.structure.ApplicationPluginDisposeBlock" id="6661832029303965119">
      <node role="body" type="jetbrains.mps.baseLanguage.structure.StatementList" id="6661832029303965120">
        <node role="statement" type="jetbrains.mps.baseLanguage.structure.ExpressionStatement" id="6661832029303965121">
          <node role="expression" type="jetbrains.mps.baseLanguage.structure.DotExpression" id="6661832029303965122">
            <node role="operand" type="jetbrains.mps.baseLanguage.structure.DotExpression" id="6661832029303965123">
              <node role="operand" type="jetbrains.mps.baseLanguage.classifiers.structure.ThisClassifierExpression" id="6661832029303965124" />
              <node role="operation" type="jetbrains.mps.baseLanguage.classifiers.structure.DefaultClassifierFieldAccessOperation" id="6661832029303965125">
                <link role="member" targetNodeId="6661832029303965100" resolveInfo="helper" />
              </node>
            </node>
            <node role="operation" type="jetbrains.mps.baseLanguage.structure.InstanceMethodCallOperation" id="6661832029303965126">
              <link role="baseMethodDeclaration" targetNodeId="5.6661832029303857616" resolveInfo="dispose" />
            </node>
          </node>
        </node>
        <node role="statement" type="jetbrains.mps.baseLanguage.structure.ExpressionStatement" id="6661832029303965127">
          <node role="expression" type="jetbrains.mps.baseLanguage.structure.AssignmentExpression" id="6661832029303965128">
            <node role="rValue" type="jetbrains.mps.baseLanguage.structure.NullLiteral" id="6661832029303965129" />
            <node role="lValue" type="jetbrains.mps.baseLanguage.structure.DotExpression" id="6661832029303965130">
