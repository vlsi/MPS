...
public class check_UIObject_consistent_belongsTo_CheckingRule extends AbstractNonTypesystemRule_Runtime implements Rule_Runtime {
  public check_UIObject_consistent_belongsTo_CheckingRule() {
  }
