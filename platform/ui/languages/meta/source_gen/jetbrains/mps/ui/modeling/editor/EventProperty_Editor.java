...
public class EventProperty_Editor extends DefaultNodeEditor {
  public EditorCell createEditorCell(EditorContext editorContext, SNode node) {
    return this.createCollection_tj1da_a(editorContext, node);
  }
  ...
  private EditorCell createConstant_tj1da_b0(EditorContext editorContext, SNode node) {
    EditorCell_Constant editorCell = new EditorCell_Constant(editorContext, node, ":");
    editorCell.setCellId("Constant_tj1da_b0");
    editorCell.setDefaultText("");
    return editorCell;
  }

  private EditorCell createProperty_tj1da_a0(EditorContext editorContext, SNode node) {
  ...
  private EditorCell createRefNode_tj1da_c0(EditorContext editorContext, SNode node) {
