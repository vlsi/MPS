...
public class UIObject_editor_TabbedEditor extends BaseTabbedEditor {
  public UIObject_editor_TabbedEditor(IOperationContext operationContext, SNode node) {
    super(operationContext, node);
    this.addTab(new UIObject_editor_TabbedEditor.Structure_Tab(this, node), null);
    this.addTab(new UIObject_editor_TabbedEditor.Code_Tab(this, node), null);
  }
