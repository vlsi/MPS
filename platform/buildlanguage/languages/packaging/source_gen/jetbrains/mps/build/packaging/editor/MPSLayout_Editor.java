...
public class MPSLayout_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createRefNodeList_8098_0(EditorContext context, SNode node) {
    AbstractCellListHandler handler = new MPSLayout_Editor.componentListHandler_8098_0(node, "component", context);
  ...
  private EditorCell createRefNodeList_8098_1(EditorContext context, SNode node) {
    AbstractCellListHandler handler = new MPSLayout_Editor.configurationListHandler_8098_0(node, "configuration", context);
  ...
  private EditorCell createRefNodeList_8098_2(EditorContext context, SNode node) {
    AbstractCellListHandler handler = new MPSLayout_Editor.variableListHandler_8098_0(node, "variable", context);
    EditorCell_Collection editorCell = handler.createCells(context, new CellLayout_Vertical(), false);
