...
public class Plugin_name_PropertyConstraint implements IModelConstraints, INodePropertyGetter {
  public Plugin_name_PropertyConstraint() {
  }

  public void registerSelf(ModelConstraintsManager manager) {
    manager.registerNodePropertyGetter("jetbrains.mps.build.packaging.structure.Plugin", "name", this);
  }

  public void unRegisterSelf(ModelConstraintsManager manager) {
    manager.unRegisterNodePropertyGetter("jetbrains.mps.build.packaging.structure.Plugin", "name");
  }
