...
public class Macro extends PropertyDeclaration implements INamedConcept {
  ...
  public int get_$attributesCount() {
    return this.getChildCount(Macro._$ATTRIBUTE);
  }

  public Iterator<Attribute> _$attributes() {
    return this.children(Attribute.class, Macro._$ATTRIBUTE);
  }

  public List<Attribute> get_$attributes() {
    return this.getChildren(Attribute.class, Macro._$ATTRIBUTE);
  }

  public void add_$attribute(Attribute node) {
    this.addChild(Macro._$ATTRIBUTE, node);
  }

  public void insert_$attribute(Attribute prev, Attribute node) {
    this.insertChild(prev, Macro._$ATTRIBUTE, node);
  }
