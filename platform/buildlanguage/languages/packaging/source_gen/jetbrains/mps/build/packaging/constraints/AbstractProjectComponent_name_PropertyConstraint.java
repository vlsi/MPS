...
public class AbstractProjectComponent_name_PropertyConstraint implements IModelConstraints, INodePropertyGetter {
  ...
  public void registerSelf(ModelConstraintsManager manager) {
    manager.registerNodePropertyGetter("jetbrains.mps.build.packaging.structure.AbstractProjectComponent", "name", this);
  }

  public void unRegisterSelf(ModelConstraintsManager manager) {
    manager.unRegisterNodePropertyGetter("jetbrains.mps.build.packaging.structure.AbstractProjectComponent", "name");
  }
