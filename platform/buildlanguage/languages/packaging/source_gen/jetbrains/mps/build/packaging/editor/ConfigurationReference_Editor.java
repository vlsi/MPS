...
public class ConfigurationReference_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createCollection_6215_0(EditorContext context, SNode node) {
    EditorCell_Collection editorCell = EditorCell_Collection.createIndent2(context, node);
    editorCell.setCellId("Collection_6215_0");
    editorCell.addEditorCell(this.createRefCell_6215_0(context, node));
    return editorCell;
  }

  private EditorCell createRefCell_6215_0(EditorContext context, SNode node) {
  ...
  public static class _Inline6215_0 extends AbstractCellProvider {
    ...
    public EditorCell createEditorCell(EditorContext context, SNode node) {
      return this.createProperty_6215_0(context, node);
    }

    private EditorCell createProperty_6215_0(EditorContext context, SNode node) {
