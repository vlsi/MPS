...
public class ConfigurationReference_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createCollection_6215_0(EditorContext editorContext, SNode node) {
    ...
    editorCell.addEditorCell(this.createRefCell_6215_0(editorContext, node));
    return editorCell;
  }

  private EditorCell createRefCell_6215_0(EditorContext editorContext, SNode node) {
  ...
  public static class _Inline6215_0 extends InlineCellProvider {
    ...
    public EditorCell createEditorCell(EditorContext editorContext, SNode node) {
      return this.createProperty_6215_0(editorContext, node);
    }

    private EditorCell createProperty_6215_0(EditorContext editorContext, SNode node) {
