...
public class ConfigurationReference_Editor extends DefaultNodeEditor {
  ...
  public EditorCell createEditorCell(EditorContext context, SNode node) {
    return this.createCollection_6215_0(context, node);
  }

  public EditorCell createCollection_6215_0(EditorContext context, SNode node) {
    EditorCell_Collection editorCell = EditorCell_Collection.createIndent2(context, node);
    setupBasic_Collection_6215_0(editorCell, node, context);
    editorCell.addEditorCell(this.createRefCell_6215_1(context, node));
    return editorCell;
  }

  public EditorCell createRefCell_6215_0_internal(EditorContext context, SNode node, CellProviderWithRole provider) {
  ...
  private static void setupBasic_Collection_6215_0(EditorCell editorCell, SNode node, EditorContext context) {
  ...
  public static class _Inline6215_0 extends AbstractCellProvider {
    ...
    public EditorCell createProperty_6215_0_internal(EditorContext context, SNode node, CellProviderWithRole provider) {
      EditorCell editorCell = provider.createEditorCell(context);
