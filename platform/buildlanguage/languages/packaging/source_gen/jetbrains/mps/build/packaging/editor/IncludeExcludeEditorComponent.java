...
public class IncludeExcludeEditorComponent extends AbstractCellProvider {
  ...
  public EditorCell createProperty_0446_0_internal(EditorContext context, SNode node, CellProviderWithRole provider) {
  ...
  public EditorCell createProperty_0446_2_internal(EditorContext context, SNode node, CellProviderWithRole provider) {
    EditorCell editorCell = provider.createEditorCell(context);
