...
public class Configuration extends BaseConcept implements INamedConcept {
  ...
  public int get_$attributesCount() {
    return this.getChildCount(Configuration._$ATTRIBUTE);
  }

  public Iterator<Attribute> _$attributes() {
    return this.children(Attribute.class, Configuration._$ATTRIBUTE);
  }

  public List<Attribute> get_$attributes() {
    return this.getChildren(Attribute.class, Configuration._$ATTRIBUTE);
  }

  public void add_$attribute(Attribute node) {
    this.addChild(Configuration._$ATTRIBUTE, node);
  }

  public void insert_$attribute(Attribute prev, Attribute node) {
    this.insertChild(prev, Configuration._$ATTRIBUTE, node);
  }
