...
private    static Class[] PARAMETERS_1213877333900 = {SNode.class ,SNode.class};
  ...
  public static String call_getHomePath_1213877333764(SNode thisNode) {
  ...
  public static String virtual_getPath_1213877333777(SNode thisNode) {
    if (SNodeOperations.isInstanceOf(SNodeOperations.getParent(thisNode), "jetbrains.mps.build.packaging.structure.ICompositeComponent")) {
      return ICompositeComponent_Behavior.call_getChildrenTargetDir_1213877279370(((SNode)SNodeOperations.getParent(thisNode))) + File.separator + SPropertyOperations.getString(thisNode, "name");
    }
  ...
  public static String call_getPath_1213877333777(SNode thisNode) {
    return (String)BehaviorManager.getInstance().invoke(Object.class, thisNode, "virtual_getPath_1213877333777", PARAMETERS_1213877333777);
  }
  ...
  public static String callSuper_getPath_1213877333777(SNode thisNode, String callerConceptFqName) {
    return (String)BehaviorManager.getInstance().invokeSuper(Object.class, thisNode, callerConceptFqName, "virtual_getPath_1213877333777", PARAMETERS_1213877333777);
  }
