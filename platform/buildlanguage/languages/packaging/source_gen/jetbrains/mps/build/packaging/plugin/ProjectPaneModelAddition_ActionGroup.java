    ...
    try {
      {
        ...
        this.add(ActionFactory.getInstance().getRegisteredAction(language.getClass("jetbrains.mps.build.packaging.plugin.GenerateMPSBuildAction_Action"), language.getModuleFqName()));
      }
    } catch (Throwable t) {
