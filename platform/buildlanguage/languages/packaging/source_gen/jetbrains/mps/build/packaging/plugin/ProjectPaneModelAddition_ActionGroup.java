    ...
    try {
      {
        ...
        this.add(ActionFactory.getInstance().acquireRegisteredAction(language.getClass("jetbrains.mps.build.packaging.plugin.GenerateMPSBuildAction_Action"), language.getModuleFqName(), null));
      }
    } catch (Throwable t) {
