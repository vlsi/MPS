...
public class QueriesGenerated {
  public static boolean createRootRule_Condition_5471562003147840954(final IOperationContext operationContext, final CreateRootRuleContext _context) {
    // we do not want to generate idea.classpath for user models, only for mpsautobuild 
    // todo remove this out of here: packaging is not a 'special language for building mps', should not know about mpsautobuild 
    return SModelOperations.getModelName(_context.getOriginalInputModel()).equals("jetbrains.mps.build.mpsautobuild");
  }
