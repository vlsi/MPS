...
<model modelUID="r:19a13561-830e-4400-a084-e2990744f9e1(jetbrains.mps.build.packaging.defaultVariables)">
  ...
  <node type="jetbrains.mps.build.packaging.structure.Variable:7" id="5558646027962548291">
    <property name="name:7" value="basedir" />
    <property name="antName:7" value="basedir" />
  </node>
  <node type="jetbrains.mps.build.packaging.structure.Variable:7" id="5558646027962551659">
    <property name="name:7" value=":" />
    <property name="antName:7" value="path.separator" />
  </node>
  <node type="jetbrains.mps.build.packaging.structure.Variable:7" id="5558646027962551660">
    <property name="name:7" value="/" />
    <property name="antName:7" value="file.separator" />
  </node>
  <node type="jetbrains.mps.build.packaging.structure.Variable:7" id="5558646027962551661">
    <property name="name:7" value="date" />
    <property name="antName:7" value="DSTAMP" />
  </node>
  <node type="jetbrains.mps.build.packaging.structure.Variable:7" id="5558646027962551662">
    <property name="name:7" value="\n" />
