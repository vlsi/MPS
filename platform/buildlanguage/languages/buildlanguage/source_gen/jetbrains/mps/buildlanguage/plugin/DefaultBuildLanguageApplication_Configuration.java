    ...
    final StringBuilder error = new StringBuilder();
    {
      ...
      final SNode node = new _FunctionTypes._return_P0_E0<SNode>() {
        public SNode invoke() {
          ...
          String errorReport;
          {
            Tuples._2<SNode, String> _tmp_3pf0a9_c0a0a2a1a1 = DefaultBuildLanguageApplication_Configuration.this.checkNode();
            snode = _tmp_3pf0a9_c0a0a2a1a1._0();
            errorReport = _tmp_3pf0a9_c0a0a2a1a1._1();
          }
          if (snode == null) {
