...
public class PropertyDeclaration extends jetbrains.mps.lang.core.structure.BaseConcept implements jetbrains.mps.buildlanguage.structure.IProjectComponent, jetbrains.mps.buildlanguage.structure.ICommented {
  ...
  public jetbrains.mps.buildlanguage.structure.PropertyType getType() {
    return (jetbrains.mps.buildlanguage.structure.PropertyType)this.getChild(PropertyType.class, PropertyDeclaration.TYPE);
  }

  public void setType(jetbrains.mps.buildlanguage.structure.PropertyType node) {
    super.setChild(PropertyDeclaration.TYPE, node);
  }

  public jetbrains.mps.buildlanguage.structure.PropertyValueExpression getPropertyValue() {
    return (jetbrains.mps.buildlanguage.structure.PropertyValueExpression)this.getChild(PropertyValueExpression.class, PropertyDeclaration.PROPERTY_VALUE);
  }

  public void setPropertyValue(jetbrains.mps.buildlanguage.structure.PropertyValueExpression node) {
