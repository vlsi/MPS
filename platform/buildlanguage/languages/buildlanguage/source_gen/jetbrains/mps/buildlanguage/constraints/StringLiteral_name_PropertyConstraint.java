...
public class StringLiteral_name_PropertyConstraint implements IModelConstraints, INodePropertyGetter {
  ...
  public void registerSelf(ModelConstraintsManager manager) {
    manager.registerNodePropertyGetter("jetbrains.mps.buildlanguage.structure.StringLiteral", "name", this);
  }

  public void unRegisterSelf(ModelConstraintsManager manager) {
    manager.unRegisterNodePropertyGetter("jetbrains.mps.buildlanguage.structure.StringLiteral", "name");
  }
