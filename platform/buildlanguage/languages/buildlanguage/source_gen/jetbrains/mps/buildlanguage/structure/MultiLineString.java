...
public class MultiLineString extends jetbrains.mps.buildlanguage.structure.PropertyValueExpression implements jetbrains.mps.lang.core.structure.INamedConcept {
  ...
  public Iterator<jetbrains.mps.buildlanguage.structure.PropertyValueExpression> stringExpressions() {
    return this.children(PropertyValueExpression.class, MultiLineString.STRING_EXPRESSION);
  }

  public List<jetbrains.mps.buildlanguage.structure.PropertyValueExpression> getStringExpressions() {
    return this.getChildren(PropertyValueExpression.class, MultiLineString.STRING_EXPRESSION);
  }

  public void addStringExpression(jetbrains.mps.buildlanguage.structure.PropertyValueExpression node) {
    this.addChild(MultiLineString.STRING_EXPRESSION, node);
  }

  public void insertStringExpression(jetbrains.mps.buildlanguage.structure.PropertyValueExpression prev, jetbrains.mps.buildlanguage.structure.PropertyValueExpression node) {
