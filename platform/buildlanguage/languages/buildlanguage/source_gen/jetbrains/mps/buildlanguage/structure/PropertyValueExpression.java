...
public class PropertyValueExpression extends BaseConcept implements ISource {
  ...
  public int get_$attributesCount() {
    return this.getChildCount(PropertyValueExpression._$ATTRIBUTE);
  }

  public Iterator<Attribute> _$attributes() {
    return this.children(Attribute.class, PropertyValueExpression._$ATTRIBUTE);
  }

  public List<Attribute> get_$attributes() {
    return this.getChildren(Attribute.class, PropertyValueExpression._$ATTRIBUTE);
  }

  public void add_$attribute(Attribute node) {
    this.addChild(PropertyValueExpression._$ATTRIBUTE, node);
  }

  public void insert_$attribute(Attribute prev, Attribute node) {
    this.insertChild(prev, PropertyValueExpression._$ATTRIBUTE, node);
  }
