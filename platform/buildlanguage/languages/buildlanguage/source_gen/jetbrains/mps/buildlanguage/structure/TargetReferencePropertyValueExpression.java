...
public class TargetReferencePropertyValueExpression extends jetbrains.mps.buildlanguage.structure.PropertyValueExpression implements jetbrains.mps.buildlanguage.structure.ITargetReference {
  ...
  public jetbrains.mps.buildlanguage.structure.TargetDeclaration getDeclaration() {
    return (jetbrains.mps.buildlanguage.structure.TargetDeclaration)this.getReferent(TargetDeclaration.class, TargetReferencePropertyValueExpression.DECLARATION);
  }

  public void setDeclaration(jetbrains.mps.buildlanguage.structure.TargetDeclaration node) {
