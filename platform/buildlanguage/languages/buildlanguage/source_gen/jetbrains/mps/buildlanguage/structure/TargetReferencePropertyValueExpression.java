...
public class TargetReferencePropertyValueExpression extends PropertyValueExpression implements ITargetReference {
  ...
  public int get_$attributesCount() {
    return this.getChildCount(TargetReferencePropertyValueExpression._$ATTRIBUTE);
  }

  public Iterator<Attribute> _$attributes() {
    return this.children(Attribute.class, TargetReferencePropertyValueExpression._$ATTRIBUTE);
  }

  public List<Attribute> get_$attributes() {
    return this.getChildren(Attribute.class, TargetReferencePropertyValueExpression._$ATTRIBUTE);
  }

  public void add_$attribute(Attribute node) {
    this.addChild(TargetReferencePropertyValueExpression._$ATTRIBUTE, node);
  }

  public void insert_$attribute(Attribute prev, Attribute node) {
    this.insertChild(prev, TargetReferencePropertyValueExpression._$ATTRIBUTE, node);
  }
