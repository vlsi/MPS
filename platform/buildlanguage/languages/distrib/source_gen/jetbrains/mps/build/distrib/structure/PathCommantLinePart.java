...
public class PathCommantLinePart extends jetbrains.mps.build.distrib.structure.AbstractCommandLinePart {
  ...
  public jetbrains.mps.build.packaging.structure.Path getPath() {
    return (jetbrains.mps.build.packaging.structure.Path)this.getChild(Path.class, PathCommantLinePart.PATH);
  }

  public void setPath(jetbrains.mps.build.packaging.structure.Path node) {
