...
import jetbrains.mps.build.distrib.structure.Role;
import jetbrains.mps.smodel.SModel;
import jetbrains.mps.smodel.SModelUtil_new;
import jetbrains.mps.project.GlobalScope;

public class MacOsFileAssociation extends jetbrains.mps.build.distrib.structure.FileAssociation {
  ...
  public jetbrains.mps.build.distrib.structure.Role getRole() {
    return (jetbrains.mps.build.distrib.structure.Role)this.getChild(Role.class, MacOsFileAssociation.ROLE);
  }

  public void setRole(jetbrains.mps.build.distrib.structure.Role node) {
