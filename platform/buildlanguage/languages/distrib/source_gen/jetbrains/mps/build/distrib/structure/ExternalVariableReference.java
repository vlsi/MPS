...
public class ExternalVariableReference extends jetbrains.mps.lang.core.structure.BaseConcept implements jetbrains.mps.build.packaging.structure.IStringExpression {
  ...
  public jetbrains.mps.build.packaging.structure.Variable getVariable() {
    return (jetbrains.mps.build.packaging.structure.Variable)this.getReferent(Variable.class, ExternalVariableReference.VARIABLE);
  }

  public void setVariable(jetbrains.mps.build.packaging.structure.Variable node) {
