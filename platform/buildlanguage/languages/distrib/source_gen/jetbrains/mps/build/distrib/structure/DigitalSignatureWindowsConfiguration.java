...
public class DigitalSignatureWindowsConfiguration extends BaseConcept {
  ...
  public AbstractPath getPathToExecutable() {
    return (AbstractPath)this.getChild(AbstractPath.class, DigitalSignatureWindowsConfiguration.PATH_TO_EXECUTABLE);
  }

  public void setPathToExecutable(AbstractPath node) {
