...
public class DigitalSignatureWindowsConfiguration extends jetbrains.mps.lang.core.structure.BaseConcept {
  ...
  public jetbrains.mps.build.packaging.structure.IPath getPathToExecutable() {
    return (jetbrains.mps.build.packaging.structure.IPath)this.getChild(IPath.class, DigitalSignatureWindowsConfiguration.PATH_TO_EXECUTABLE);
  }

  public void setPathToExecutable(jetbrains.mps.build.packaging.structure.IPath node) {
  ...
  public Iterator<jetbrains.mps.build.distrib.structure.AbstractCommandLinePart> commandLines() {
    return this.children(AbstractCommandLinePart.class, DigitalSignatureWindowsConfiguration.COMMAND_LINE);
  }

  public List<jetbrains.mps.build.distrib.structure.AbstractCommandLinePart> getCommandLines() {
    return this.getChildren(AbstractCommandLinePart.class, DigitalSignatureWindowsConfiguration.COMMAND_LINE);
  }

  public void addCommandLine(jetbrains.mps.build.distrib.structure.AbstractCommandLinePart node) {
    this.addChild(DigitalSignatureWindowsConfiguration.COMMAND_LINE, node);
  }

  public void insertCommandLine(jetbrains.mps.build.distrib.structure.AbstractCommandLinePart prev, jetbrains.mps.build.distrib.structure.AbstractCommandLinePart node) {
