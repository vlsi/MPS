...
public class CustomMPSBuildGenerator extends BuildGeneratorImpl {
  ...
  protected void addReferencesToModel(SModelDescriptor descriptor) {
    super.addReferencesToModel(descriptor);
    final Language custommpsLanguage = this.getCustomMPSLanguage();
    ModuleReference moduleReference = custommpsLanguage.getModuleReference();
  ...
  private Language getCustomMPSLanguage() {
    return MPSModuleRepository.getInstance().getLanguage("jetbrains.mps.build.custommps");
  }
