...
public class MPSBuild extends jetbrains.mps.build.packaging.structure.AbstractProjectComponent implements jetbrains.mps.build.packaging.structure.ICompositeComponent {
  ...
  public jetbrains.mps.build.packaging.structure.Path getPathToBuildToolsZip() {
    return (jetbrains.mps.build.packaging.structure.Path)this.getChild(Path.class, MPSBuild.PATH_TO_BUILD_TOOLS_ZIP);
  }

  public void setPathToBuildToolsZip(jetbrains.mps.build.packaging.structure.Path node) {
    super.setChild(MPSBuild.PATH_TO_BUILD_TOOLS_ZIP, node);
  }

  public jetbrains.mps.build.packaging.structure.Path getLicencePath() {
    return (jetbrains.mps.build.packaging.structure.Path)this.getChild(Path.class, MPSBuild.LICENCE_PATH);
  }

  public void setLicencePath(jetbrains.mps.build.packaging.structure.Path node) {
  ...
  public Iterator<jetbrains.mps.build.packaging.structure.AbstractProjectComponent> entries() {
    return this.children(AbstractProjectComponent.class, MPSBuild.ENTRY);
  }

  public List<jetbrains.mps.build.packaging.structure.AbstractProjectComponent> getEntries() {
    return this.getChildren(AbstractProjectComponent.class, MPSBuild.ENTRY);
  }

  public void addEntry(jetbrains.mps.build.packaging.structure.AbstractProjectComponent node) {
    this.addChild(MPSBuild.ENTRY, node);
  }

  public void insertEntry(jetbrains.mps.build.packaging.structure.AbstractProjectComponent prev, jetbrains.mps.build.packaging.structure.AbstractProjectComponent node) {
