...
public class AbstractAction extends ConfigurationXmlNode implements IConfigurationElement {
  ...
  public ClassConcept getActionClass() {
    return (ClassConcept) this.getReferent(ClassConcept.class, AbstractAction.ACTION_CLASS);
  }

  public void setActionClass(ClassConcept node) {
    super.setReferent(AbstractAction.ACTION_CLASS, node);
  }
  ...
  public Iterator<ActionReference> addToGroups() {
    return this.children(ActionReference.class, AbstractAction.ADD_TO_GROUP);
  }

  public List<ActionReference> getAddToGroups() {
    return this.getChildren(ActionReference.class, AbstractAction.ADD_TO_GROUP);
  }

  public void addAddToGroup(ActionReference node) {
    this.addChild(AbstractAction.ADD_TO_GROUP, node);
  }

  public void insertAddToGroup(ActionReference prev, ActionReference node) {
