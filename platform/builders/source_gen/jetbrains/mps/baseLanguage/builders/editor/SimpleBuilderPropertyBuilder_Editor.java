...
public class SimpleBuilderPropertyBuilder_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createCollection_9503_0(EditorContext editorContext, SNode node) {
    ...
    editorCell.addEditorCell(this.createRefCell_9503_0(editorContext, node));
  ...
  private EditorCell createRefCell_9503_0(EditorContext editorContext, SNode node) {
    CellProviderWithRole provider = new RefCellCellProvider(node, editorContext);
    provider.setRole("declaration");
    provider.setNoTargetText("<no declaration>");
    EditorCell editorCell;
    provider.setAuxiliaryCellProvider(new SimpleBuilderPropertyBuilder_Editor._Inline9503_0());
  ...
  public static class _Inline9503_0 extends InlineCellProvider {
    public _Inline9503_0() {
      super();
    }
    ...
    public EditorCell createEditorCell(EditorContext editorContext, SNode node) {
      return this.createProperty_9503_0(editorContext, node);
    }

    private EditorCell createProperty_9503_0(EditorContext editorContext, SNode node) {
