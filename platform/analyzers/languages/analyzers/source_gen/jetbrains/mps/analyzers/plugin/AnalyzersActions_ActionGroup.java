...
public class AnalyzersActions_ActionGroup extends GeneratedActionGroup {
  ...
  public static final String ID = "jetbrains.mps.analyzers.plugin.AnalyzersActions";
  ...
  public AnalyzersActions_ActionGroup() {
    ...
    this.setPopup(false);
    try {
      AnalyzersActions_ActionGroup.this.addAction("jetbrains.mps.analyzers.plugin.ShowNullDFA_Action", "jetbrains.mps.analyzers");
    } catch (Throwable t) {
