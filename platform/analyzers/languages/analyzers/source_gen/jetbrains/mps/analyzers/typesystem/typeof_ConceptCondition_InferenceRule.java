...
public class typeof_ConceptCondition_InferenceRule extends AbstractInferenceRule_Runtime implements InferenceRule_Runtime {
  ...
  public void applyRule(final SNode conceptCondition, final TypeCheckingContext typeCheckingContext) {
    SNode conceptReference = conceptCondition;
    {
      SNode _nodeToCheck_1029348928467 = conceptReference;
      BaseIntentionProvider intentionProvider = null;
      EquationInfo _info_12389875345 = new EquationInfo(_nodeToCheck_1029348928467, null, "r:139daa25-c5a7-4ac9-85a2-eb14d22e8f56(jetbrains.mps.analyzers.typesystem)", "4943044633101742745", 0, intentionProvider);
