...
<model modelUID="r:fc545d82-6d72-41b7-a7f1-93ef15402ef1(jetbrains.mps.analyzers.mpsAnalyzers.nullable)">
  ...
  <import index="13" modelUID="r:fc94574f-a075-45e6-9927-48e7e87153e6(jetbrains.mps.analyzers.runtime.framework)" version="-1" />
  <node type="jetbrains.mps.analyzers.structure.Analyzer:0" id="1665527126811217298">
    ...
    <node role="ruleReference:0" type="jetbrains.mps.analyzers.structure.RuleReference:0" id="375746805846579101">
      <link role="rule:0" targetNodeId="4943044633101889893" resolveInfo="RuleTesdt" />
    </node>
    <node role="ruleReference:0" type="jetbrains.mps.analyzers.structure.RuleReference:0" id="1384134943041935792">
      <link role="rule:0" targetNodeId="1384134943041910557" resolveInfo="RuleNullLiteral" />
    </node>
    <node role="ruleReference:0" type="jetbrains.mps.analyzers.structure.RuleReference:0" id="5317099423844024316">
      <link role="rule:0" targetNodeId="5317099423844018525" resolveInfo="RuleFieldReference" />
    </node>
    <node role="ruleReference:0" type="jetbrains.mps.analyzers.structure.RuleReference:0" id="323410281720718466">
      <link role="rule:0" targetNodeId="323410281720652596" resolveInfo="RuleAfterDotExpression" />
    </node>
    <node role="ruleReference:0" type="jetbrains.mps.analyzers.structure.RuleReference:0" id="6465013485826578910">
      <link role="rule:0" targetNodeId="6465013485826573723" resolveInfo="RuleVariableDeclaration" />
    </node>
    <node role="ruleReference:0" type="jetbrains.mps.analyzers.structure.RuleReference:0" id="680562289607974143">
      <link role="rule:0" targetNodeId="680562289607974122" resolveInfo="WhileNotNull" />
    </node>
    ...
    <node role="instruction:0" type="jetbrains.mps.analyzers.structure.Instruction:0" id="680562289607957342">
      <property name="name:0" value="null" />
      <node role="parameter:0" type="jetbrains.mps.analyzers.structure.InstructionParameter:0" id="680562289607957343">
        <property name="name:0" value="expression" />
        <node role="type:0" type="jetbrains.mps.lang.smodel.structure.SNodeType:16" id="680562289607957345" />
      </node>
    </node>
                  ...
                  <node role="ifTrue:3" type="jetbrains.mps.baseLanguage.structure.StatementList:3" id="2022791306161969002">
                    <node role="statement:3" type="jetbrains.mps.baseLanguage.structure.ExpressionStatement:3" id="2022791306161969010">
                      <node role="expression:3" type="jetbrains.mps.baseLanguage.structure.AssignmentExpression:3" id="2022791306161969012">
                        <node role="rValue:3" type="jetbrains.mps.baseLanguage.structure.EnumConstantReference:3" id="4289235493514158520">
                          <link role="enumConstantDeclaration:3" targetNodeId="4289235493514158493" resolveInfo="NOT_INIT" />
      ...
      <node role="body:0" type="jetbrains.mps.baseLanguage.structure.StatementList:3" id="1665527126811217304">
        <node role="statement:3" type="jetbrains.mps.baseLanguage.structure.LocalVariableDeclarationStatement:3" id="2022791306161968884">
          <node role="localVariableDeclaration:3" type="jetbrains.mps.baseLanguage.structure.LocalVariableDeclaration:3" id="2022791306161968885">
            ...
            <node role="initializer:3" type="jetbrains.mps.analyzers.structure.AnalyzerFunParameterInput:0" id="5028143593699971288" />
          </node>
        </node>
        ...
        <node role="statement:3" type="jetbrains.mps.baseLanguage.structure.IfStatement:3" id="7801926404027365352">
          <node role="ifTrue:3" type="jetbrains.mps.baseLanguage.structure.StatementList:3" id="7801926404027365353">
            <node role="statement:3" type="jetbrains.mps.baseLanguage.structure.LocalVariableDeclarationStatement:3" id="7801926404027365521">
              <node role="localVariableDeclaration:3" type="jetbrains.mps.baseLanguage.structure.LocalVariableDeclaration:3" id="7801926404027365522">
                <property name="name:3" value="node" />
                <node role="type:3" type="jetbrains.mps.lang.smodel.structure.SNodeType:16" id="7801926404027365523" />
                <node role="initializer:3" type="jetbrains.mps.baseLanguage.structure.CastExpression:3" id="7801926404027385686">
                  <node role="type:3" type="jetbrains.mps.lang.smodel.structure.SNodeType:16" id="7801926404027385689" />
                  <node role="expression:3" type="jetbrains.mps.baseLanguage.structure.ParenthesizedExpression:3" id="7801926404027385679">
                    <node role="expression:3" type="jetbrains.mps.baseLanguage.structure.DotExpression:3" id="7801926404027385681">
                      <node role="operand:3" type="jetbrains.mps.baseLanguage.structure.ParenthesizedExpression:3" id="7801926404027380696">
                        <node role="expression:3" type="jetbrains.mps.baseLanguage.structure.CastExpression:3" id="7801926404027380692">
                          <node role="type:3" type="jetbrains.mps.baseLanguage.structure.ClassifierType:3" id="8204054280416655192">
                            <link role="classifier:3" targetNodeId="13.7801926404027364448" resolveInfo="GeneratedInstruction" />
                          </node>
                          <node role="expression:3" type="jetbrains.mps.baseLanguage.structure.LocalVariableReference:3" id="7801926404027380694">
                            <link role="variableDeclaration:3" targetNodeId="3762983614228137829" resolveInfo="instruction" />
                          </node>
                        </node>
                      </node>
                      <node role="operation:3" type="jetbrains.mps.baseLanguage.structure.InstanceMethodCallOperation:3" id="7801926404027385685">
                        <link role="baseMethodDeclaration:3" targetNodeId="13.7801926404027364500" resolveInfo="getParameter" />
                      </node>
                    </node>
                  </node>
                </node>
            ...
            <node role="statement:3" type="jetbrains.mps.baseLanguage.structure.IfStatement:3" id="7801926404027365469">
              <node role="ifTrue:3" type="jetbrains.mps.baseLanguage.structure.StatementList:3" id="7801926404027365470">
                <node role="statement:3" type="jetbrains.mps.baseLanguage.structure.ExpressionStatement:3" id="7801926404027365471">
                  <node role="expression:3" type="jetbrains.mps.baseLanguage.structure.AssignmentExpression:3" id="7801926404027365472">
                    <node role="rValue:3" type="jetbrains.mps.baseLanguage.structure.EnumConstantReference:3" id="7801926404027365473">
                      <link role="enumClass:3" targetNodeId="1665527126811217334" resolveInfo="NullableState" />
                      <link role="enumConstantDeclaration:3" targetNodeId="1665527126811217342" resolveInfo="NOTNULL" />
                    </node>
                    <node role="lValue:3" type="jetbrains.mps.baseLanguage.structure.LocalVariableReference:3" id="7801926404027365474">
                      <link role="variableDeclaration:3" targetNodeId="4113754758724700815" resolveInfo="nullableState" />
                    </node>
                  </node>
                </node>
              </node>
              <node role="condition:3" type="jetbrains.mps.analyzers.structure.IsOperation:0" id="7801926404027365475">
                <link role="instruction:0" targetNodeId="1665527126811217322" resolveInfo="notNull" />
                <node role="left:0" type="jetbrains.mps.baseLanguage.structure.LocalVariableReference:3" id="7801926404027365476">
                  <link role="variableDeclaration:3" targetNodeId="3762983614228137829" resolveInfo="instruction" />
                </node>
              </node>
            </node>
            <node role="statement:3" type="jetbrains.mps.baseLanguage.structure.IfStatement:3" id="7801926404027365477">
              <node role="ifTrue:3" type="jetbrains.mps.baseLanguage.structure.StatementList:3" id="7801926404027365478">
                <node role="statement:3" type="jetbrains.mps.baseLanguage.structure.ExpressionStatement:3" id="7801926404027365479">
                  <node role="expression:3" type="jetbrains.mps.baseLanguage.structure.AssignmentExpression:3" id="7801926404027365480">
                    <node role="rValue:3" type="jetbrains.mps.baseLanguage.structure.EnumConstantReference:3" id="7801926404027365481">
                      <link role="enumClass:3" targetNodeId="1665527126811217334" resolveInfo="NullableState" />
                      <link role="enumConstantDeclaration:3" targetNodeId="1665527126811217340" resolveInfo="NULLABLE" />
                    </node>
                    <node role="lValue:3" type="jetbrains.mps.baseLanguage.structure.LocalVariableReference:3" id="7801926404027365482">
                      <link role="variableDeclaration:3" targetNodeId="4113754758724700815" resolveInfo="nullableState" />
                    </node>
                  </node>
                </node>
              </node>
              <node role="condition:3" type="jetbrains.mps.analyzers.structure.IsOperation:0" id="7801926404027365483">
                <link role="instruction:0" targetNodeId="1665527126811217326" resolveInfo="nullable" />
                <node role="left:0" type="jetbrains.mps.baseLanguage.structure.LocalVariableReference:3" id="7801926404027365484">
                  <link role="variableDeclaration:3" targetNodeId="3762983614228137829" resolveInfo="instruction" />
                </node>
              </node>
            </node>
            <node role="statement:3" type="jetbrains.mps.baseLanguage.structure.IfStatement:3" id="7801926404027365485">
              <node role="ifTrue:3" type="jetbrains.mps.baseLanguage.structure.StatementList:3" id="7801926404027365486">
                <node role="statement:3" type="jetbrains.mps.baseLanguage.structure.ExpressionStatement:3" id="7801926404027365487">
                  <node role="expression:3" type="jetbrains.mps.baseLanguage.structure.AssignmentExpression:3" id="7801926404027365488">
                    <node role="rValue:3" type="jetbrains.mps.baseLanguage.structure.EnumConstantReference:3" id="7801926404027365489">
                      <link role="enumClass:3" targetNodeId="1665527126811217334" resolveInfo="NullableState" />
                      <link role="enumConstantDeclaration:3" targetNodeId="680562289607957341" resolveInfo="NULL" />
                    </node>
                    <node role="lValue:3" type="jetbrains.mps.baseLanguage.structure.LocalVariableReference:3" id="7801926404027365490">
                      <link role="variableDeclaration:3" targetNodeId="4113754758724700815" resolveInfo="nullableState" />
                    </node>
                  </node>
                </node>
              </node>
              <node role="condition:3" type="jetbrains.mps.analyzers.structure.IsOperation:0" id="7801926404027365491">
                <link role="instruction:0" targetNodeId="680562289607957342" resolveInfo="null" />
                <node role="left:0" type="jetbrains.mps.baseLanguage.structure.LocalVariableReference:3" id="7801926404027365492">
                  <link role="variableDeclaration:3" targetNodeId="3762983614228137829" resolveInfo="instruction" />
                </node>
              </node>
            </node>
            <node role="statement:3" type="jetbrains.mps.baseLanguage.structure.IfStatement:3" id="7801926404027365493">
              <node role="ifTrue:3" type="jetbrains.mps.baseLanguage.structure.StatementList:3" id="7801926404027365494">
                <node role="statement:3" type="jetbrains.mps.baseLanguage.structure.ExpressionStatement:3" id="7801926404027365495">
                  <node role="expression:3" type="jetbrains.mps.baseLanguage.structure.AssignmentExpression:3" id="7801926404027365496">
                    <node role="rValue:3" type="jetbrains.mps.baseLanguage.structure.DotExpression:3" id="7801926404027365497">
                      <node role="operand:3" type="jetbrains.mps.lang.smodel.structure.SNodeTypeCastExpression:16" id="7801926404027365498">
                        <link role="concept:16" targetNodeId="8.1068498886296:3" resolveInfo="VariableReference" />
                        <node role="leftExpression:16" type="jetbrains.mps.baseLanguage.structure.LocalVariableReference:3" id="7801926404027365499">
                          <link role="variableDeclaration:3" targetNodeId="7801926404027365522" resolveInfo="node" />
                        </node>
                      </node>
                      <node role="operation:3" type="jetbrains.mps.lang.smodel.structure.SLinkAccess:16" id="7801926404027365500">
                        <link role="link:16" targetNodeId="8.1068581517664:3" />
                      </node>
                    </node>
                    <node role="lValue:3" type="jetbrains.mps.baseLanguage.structure.LocalVariableReference:3" id="7801926404027365501">
                      <link role="variableDeclaration:3" targetNodeId="7801926404027365522" resolveInfo="node" />
                    </node>
                  </node>
                </node>
              </node>
              <node role="condition:3" type="jetbrains.mps.baseLanguage.structure.DotExpression:3" id="7801926404027365502">
                <node role="operand:3" type="jetbrains.mps.baseLanguage.structure.LocalVariableReference:3" id="7801926404027365503">
                  <link role="variableDeclaration:3" targetNodeId="7801926404027365522" resolveInfo="node" />
                </node>
                <node role="operation:3" type="jetbrains.mps.lang.smodel.structure.Node_IsInstanceOfOperation:16" id="7801926404027365504">
                  <node role="conceptArgument:16" type="jetbrains.mps.lang.smodel.structure.RefConcept_Reference:16" id="7801926404027365505">
                    <link role="conceptDeclaration:16" targetNodeId="8.1068498886296:3" resolveInfo="VariableReference" />
                  </node>
                </node>
              </node>
            </node>
            <node role="statement:3" type="jetbrains.mps.baseLanguage.structure.IfStatement:3" id="7801926404027365506">
              <node role="ifTrue:3" type="jetbrains.mps.baseLanguage.structure.StatementList:3" id="7801926404027365507">
                <node role="statement:3" type="jetbrains.mps.baseLanguage.structure.ExpressionStatement:3" id="7801926404027365508">
                  <node role="expression:3" type="jetbrains.mps.baseLanguage.structure.DotExpression:3" id="7801926404027365509">
                    <node role="operand:3" type="jetbrains.mps.baseLanguage.structure.LocalVariableReference:3" id="7801926404027365510">
                      <link role="variableDeclaration:3" targetNodeId="2022791306161968885" resolveInfo="result" />
                    </node>
                    <node role="operation:3" type="jetbrains.mps.baseLanguage.structure.InstanceMethodCallOperation:3" id="7801926404027365511">
                      <link role="baseMethodDeclaration:3" targetNodeId="4.~Map.put(java.lang.Object,java.lang.Object):java.lang.Object" resolveInfo="put" />
                      <node role="actualArgument:3" type="jetbrains.mps.baseLanguage.structure.CastExpression:3" id="7801926404027365512">
                        <node role="type:3" type="jetbrains.mps.lang.smodel.structure.SNodeType:16" id="7801926404027365513" />
                        <node role="expression:3" type="jetbrains.mps.baseLanguage.structure.LocalVariableReference:3" id="7801926404027365514">
                          <link role="variableDeclaration:3" targetNodeId="7801926404027365522" resolveInfo="node" />
                        </node>
                      </node>
                      <node role="actualArgument:3" type="jetbrains.mps.baseLanguage.structure.LocalVariableReference:3" id="7801926404027365515">
                        <link role="variableDeclaration:3" targetNodeId="4113754758724700815" resolveInfo="nullableState" />
                      </node>
                    </node>
                  </node>
              ...
              <node role="condition:3" type="jetbrains.mps.baseLanguage.structure.NotEqualsExpression:3" id="7801926404027365516">
                <node role="rightExpression:3" type="jetbrains.mps.baseLanguage.structure.NullLiteral:3" id="7801926404027365517" />
                <node role="leftExpression:3" type="jetbrains.mps.baseLanguage.structure.LocalVariableReference:3" id="7801926404027365518">
                  <link role="variableDeclaration:3" targetNodeId="7801926404027365522" resolveInfo="node" />
                </node>
              </node>
            </node>
          </node>
          <node role="condition:3" type="jetbrains.mps.baseLanguage.structure.InstanceOfExpression:3" id="7801926404027365357">
            <node role="classType:3" type="jetbrains.mps.baseLanguage.structure.ClassifierType:3" id="8204054280416655191">
              <link role="classifier:3" targetNodeId="13.7801926404027364448" resolveInfo="GeneratedInstruction" />
            </node>
            <node role="leftExpression:3" type="jetbrains.mps.baseLanguage.structure.LocalVariableReference:3" id="7801926404027365356">
              <link role="variableDeclaration:3" targetNodeId="3762983614228137829" resolveInfo="instruction" />
            </node>
          </node>
        </node>
              ...
              <node role="ifTrue:3" type="jetbrains.mps.baseLanguage.structure.StatementList:3" id="4113754758724670047">
                <node role="statement:3" type="jetbrains.mps.baseLanguage.structure.ExpressionStatement:3" id="4113754758724670055">
                  <node role="expression:3" type="jetbrains.mps.baseLanguage.structure.AssignmentExpression:3" id="4113754758724670057">
                    <node role="rValue:3" type="jetbrains.mps.baseLanguage.structure.EnumConstantReference:3" id="4036797860728536560">
                      <link role="enumConstantDeclaration:3" targetNodeId="1665527126811217344" resolveInfo="UNKNOWN" />
                      <link role="enumClass:3" targetNodeId="1665527126811217334" resolveInfo="NullableState" />
                    </node>
  ...
  <node type="jetbrains.mps.baseLanguage.structure.EnumClass:3" id="1665527126811217334">
    <property name="name:3" value="NullableState" />
    <node role="staticMethod:3" type="jetbrains.mps.baseLanguage.structure.StaticMethodDeclaration:3" id="7962250936070434139">
      <property name="name:3" value="canBeNull" />
      <node role="returnType:3" type="jetbrains.mps.baseLanguage.structure.BooleanType:3" id="7962250936070434155" />
      <node role="visibility:3" type="jetbrains.mps.baseLanguage.structure.PublicVisibility:3" id="7962250936070434141" />
      <node role="body:3" type="jetbrains.mps.baseLanguage.structure.StatementList:3" id="7962250936070434142">
        <node role="statement:3" type="jetbrains.mps.baseLanguage.structure.IfStatement:3" id="7962250936070434145">
          <node role="condition:3" type="jetbrains.mps.baseLanguage.structure.EqualsExpression:3" id="7962250936070434149">
            <node role="rightExpression:3" type="jetbrains.mps.baseLanguage.structure.NullLiteral:3" id="7962250936070434152" />
            <node role="leftExpression:3" type="jetbrains.mps.baseLanguage.structure.ParameterReference:3" id="7962250936070434148">
              <link role="variableDeclaration:3" targetNodeId="7962250936070434143" resolveInfo="state" />
            </node>
          </node>
          <node role="ifTrue:3" type="jetbrains.mps.baseLanguage.structure.StatementList:3" id="7962250936070434147">
            <node role="statement:3" type="jetbrains.mps.baseLanguage.structure.ReturnStatement:3" id="7962250936070434153">
              <node role="expression:3" type="jetbrains.mps.baseLanguage.structure.BooleanConstant:3" id="7962250936070434157">
                <property name="value:3" value="false" />
              </node>
            </node>
          </node>
        </node>
        <node role="statement:3" type="jetbrains.mps.baseLanguage.structure.ReturnStatement:3" id="7962250936070434160">
          <node role="expression:3" type="jetbrains.mps.baseLanguage.structure.OrExpression:3" id="7962250936070434161">
            <node role="rightExpression:3" type="jetbrains.mps.baseLanguage.structure.DotExpression:3" id="7962250936070434162">
              <node role="operand:3" type="jetbrains.mps.baseLanguage.structure.ParameterReference:3" id="7962250936070434173">
                <link role="variableDeclaration:3" targetNodeId="7962250936070434143" resolveInfo="state" />
              </node>
              <node role="operation:3" type="jetbrains.mps.baseLanguage.structure.InstanceMethodCallOperation:3" id="7962250936070434164">
                <link role="baseMethodDeclaration:3" targetNodeId="2v.~Enum.equals(java.lang.Object):boolean" resolveInfo="equals" />
                <node role="actualArgument:3" type="jetbrains.mps.baseLanguage.structure.EnumConstantReference:3" id="7962250936070434165">
                  <link role="enumClass:3" targetNodeId="1665527126811217334" resolveInfo="NullableState" />
                  <link role="enumConstantDeclaration:3" targetNodeId="1665527126811217340" resolveInfo="NULLABLE" />
                </node>
              </node>
            </node>
            <node role="leftExpression:3" type="jetbrains.mps.baseLanguage.structure.DotExpression:3" id="7962250936070434166">
              <node role="operand:3" type="jetbrains.mps.baseLanguage.structure.ParameterReference:3" id="7962250936070434172">
                <link role="variableDeclaration:3" targetNodeId="7962250936070434143" resolveInfo="state" />
              </node>
              <node role="operation:3" type="jetbrains.mps.baseLanguage.structure.InstanceMethodCallOperation:3" id="7962250936070434168">
                <link role="baseMethodDeclaration:3" targetNodeId="2v.~Enum.equals(java.lang.Object):boolean" resolveInfo="equals" />
                <node role="actualArgument:3" type="jetbrains.mps.baseLanguage.structure.EnumConstantReference:3" id="7962250936070434169">
                  <link role="enumClass:3" targetNodeId="1665527126811217334" resolveInfo="NullableState" />
                  <link role="enumConstantDeclaration:3" targetNodeId="680562289607957341" resolveInfo="NULL" />
                </node>
              </node>
      ...
      <node role="parameter:3" type="jetbrains.mps.baseLanguage.structure.ParameterDeclaration:3" id="7962250936070434143">
        <property name="name:3" value="state" />
        <node role="type:3" type="jetbrains.mps.baseLanguage.structure.ClassifierType:3" id="7962250936070434144">
          <link role="classifier:3" targetNodeId="1665527126811217334" resolveInfo="NullableState" />
        </node>
      </node>
    </node>
    <node role="method:3" type="jetbrains.mps.baseLanguage.structure.InstanceMethodDeclaration:3" id="7985661997283757656">
      ...
      <node role="body:3" type="jetbrains.mps.baseLanguage.structure.StatementList:3" id="7985661997283757659">
        ...
        <node role="statement:3" type="jetbrains.mps.baseLanguage.structure.IfStatement:3" id="4289235493514158495">
          <node role="ifTrue:3" type="jetbrains.mps.baseLanguage.structure.StatementList:3" id="4289235493514158496">
            <node role="statement:3" type="jetbrains.mps.baseLanguage.structure.ReturnStatement:3" id="4289235493514158507">
              <node role="expression:3" type="jetbrains.mps.baseLanguage.structure.ParameterReference:3" id="4289235493514158509">
                <link role="variableDeclaration:3" targetNodeId="7985661997283757712" resolveInfo="state" />
              </node>
            </node>
          </node>
          <node role="condition:3" type="jetbrains.mps.baseLanguage.structure.DotExpression:3" id="4289235493514158500">
            <node role="operand:3" type="jetbrains.mps.baseLanguage.structure.ThisExpression:3" id="4289235493514158499" />
            <node role="operation:3" type="jetbrains.mps.baseLanguage.structure.InstanceMethodCallOperation:3" id="4289235493514158504">
              <link role="baseMethodDeclaration:3" targetNodeId="2v.~Enum.equals(java.lang.Object):boolean" resolveInfo="equals" />
              <node role="actualArgument:3" type="jetbrains.mps.baseLanguage.structure.EnumConstantReference:3" id="4289235493514158506">
                <link role="enumConstantDeclaration:3" targetNodeId="4289235493514158493" resolveInfo="NOT_INIT" />
                <link role="enumClass:3" targetNodeId="1665527126811217334" resolveInfo="NullableState" />
              </node>
            </node>
        ...
        <node role="statement:3" type="jetbrains.mps.baseLanguage.structure.IfStatement:3" id="4289235493514158510">
          <node role="ifTrue:3" type="jetbrains.mps.baseLanguage.structure.StatementList:3" id="4289235493514158511">
            <node role="statement:3" type="jetbrains.mps.baseLanguage.structure.ReturnStatement:3" id="4289235493514158512">
              <node role="expression:3" type="jetbrains.mps.baseLanguage.structure.ThisExpression:3" id="4289235493514158518" />
            </node>
          </node>
          <node role="condition:3" type="jetbrains.mps.baseLanguage.structure.DotExpression:3" id="4289235493514158514">
            <node role="operand:3" type="jetbrains.mps.baseLanguage.structure.ParameterReference:3" id="4289235493514158519">
              <link role="variableDeclaration:3" targetNodeId="7985661997283757712" resolveInfo="state" />
            </node>
            <node role="operation:3" type="jetbrains.mps.baseLanguage.structure.InstanceMethodCallOperation:3" id="4289235493514158516">
              <link role="baseMethodDeclaration:3" targetNodeId="2v.~Enum.equals(java.lang.Object):boolean" resolveInfo="equals" />
              <node role="actualArgument:3" type="jetbrains.mps.baseLanguage.structure.EnumConstantReference:3" id="4289235493514158517">
                <link role="enumClass:3" targetNodeId="1665527126811217334" resolveInfo="NullableState" />
                <link role="enumConstantDeclaration:3" targetNodeId="4289235493514158493" resolveInfo="NOT_INIT" />
              </node>
            </node>
    ...
    <node role="enumConstant:3" type="jetbrains.mps.baseLanguage.structure.EnumConstantDeclaration:3" id="4289235493514158493">
      <property name="name:3" value="NOT_INIT" />
      <link role="baseMethodDeclaration:3" targetNodeId="1665527126811217336" resolveInfo="NullableState" />
    </node>
    <node role="enumConstant:3" type="jetbrains.mps.baseLanguage.structure.EnumConstantDeclaration:3" id="680562289607957341">
        ...
        <node role="patternNode:0" type="jetbrains.mps.baseLanguage.structure.IfStatement:3" id="3762983614228143042">
          ...
          <node role="condition:3" type="jetbrains.mps.baseLanguage.structure.AndExpression:3" id="6942119419517283928">
            <node role="leftExpression:3" type="jetbrains.mps.baseLanguage.structure.NotEqualsExpression:3" id="6942119419517283931">
              ...
              <node role="asPattern$attribute:3" type="jetbrains.mps.lang.pattern.structure.ActionAsPattern:0" id="4623726889382011479">
                <property name="varName:0" value="notEquals" />
                <node role="action:0" type="jetbrains.mps.analyzers.structure.EmitInstruction:0" id="4623726889382011481">
                  <node role="instructionRef:0" type="jetbrains.mps.analyzers.structure.InstructionReference:0" id="4623726889382011484">
                    <link role="instruction:0" targetNodeId="1665527126811217322" resolveInfo="notNull" />
                    <node role="argument:0" type="jetbrains.mps.lang.pattern.structure.PatternVariableReference:0" id="4623726889382015082">
                      <link role="variable:0" targetNodeId="6942119419517283934" resolveInfo="#p" />
                    </node>
                  </node>
                  <node role="position:0" type="jetbrains.mps.analyzers.structure.InsertAfterPosition:0" id="4623726889382015083" />
                </node>
              </node>
            </node>
  ...
  <node type="jetbrains.mps.analyzers.structure.Rule:0" id="4943044633101889893">
    <property name="name:0" value="RuleMethodCall" />
    <node role="actions:0" type="jetbrains.mps.baseLanguage.structure.StatementList:3" id="4943044633101889894">
      <node role="statement:3" type="jetbrains.mps.baseLanguage.structure.LocalVariableDeclarationStatement:3" id="4943044633102120747">
        <node role="localVariableDeclaration:3" type="jetbrains.mps.baseLanguage.structure.LocalVariableDeclaration:3" id="4943044633102120748">
          <property name="name:3" value="m" />
          <node role="type:3" type="jetbrains.mps.lang.smodel.structure.SNodeType:16" id="4943044633102120749">
            <link role="concept:16" targetNodeId="8.1204053956946:3" resolveInfo="IMethodCall" />
          </node>
          <node role="initializer:3" type="jetbrains.mps.analyzers.structure.ApplicableNodeReference:0" id="4943044633102120751">
            <link role="applicableNode:0" targetNodeId="4943044633101897935" resolveInfo="method" />
          </node>
        </node>
      </node>
      <node role="statement:3" type="jetbrains.mps.baseLanguage.structure.IfStatement:3" id="4943044633101897947">
        <node role="ifTrue:3" type="jetbrains.mps.baseLanguage.structure.StatementList:3" id="4943044633101897948">
          <node role="statement:3" type="jetbrains.mps.baseLanguage.structure.ForeachStatement:3" id="4943044633102120789">
            <node role="variable:3" type="jetbrains.mps.baseLanguage.structure.LocalVariableDeclaration:3" id="4943044633102120790">
              <property name="name:3" value="annotation" />
              <node role="type:3" type="jetbrains.mps.lang.smodel.structure.SNodeType:16" id="4943044633102120800">
                <link role="concept:16" targetNodeId="8.1188207840427:3" resolveInfo="AnnotationInstance" />
              </node>
            </node>
            <node role="body:3" type="jetbrains.mps.baseLanguage.structure.StatementList:3" id="4943044633102120791">
              <node role="statement:3" type="jetbrains.mps.baseLanguage.structure.IfStatement:3" id="4943044633102120801">
                <node role="ifTrue:3" type="jetbrains.mps.baseLanguage.structure.StatementList:3" id="4943044633102120802">
                  <node role="statement:3" type="jetbrains.mps.analyzers.structure.EmitInstruction:0" id="4943044633102120845">
                    <node role="instructionRef:0" type="jetbrains.mps.analyzers.structure.InstructionReference:0" id="4943044633102120846">
                      <link role="instruction:0" targetNodeId="1665527126811217326" resolveInfo="nullable" />
                      <node role="argument:0" type="jetbrains.mps.analyzers.structure.ApplicableNodeReference:0" id="4943044633102120849">
                        <link role="applicableNode:0" targetNodeId="4943044633101897935" resolveInfo="method" />
                      </node>
                    </node>
                    <node role="position:0" type="jetbrains.mps.analyzers.structure.InsertAfterPosition:0" id="4943044633102120853" />
                    <node role="target:0" type="jetbrains.mps.analyzers.structure.ApplicableNodeReference:0" id="323410281720635072">
                      <link role="applicableNode:0" targetNodeId="4943044633101897935" resolveInfo="methodCall" />
                    </node>
                  </node>
                </node>
                <node role="condition:3" type="jetbrains.mps.baseLanguage.structure.EqualsExpression:3" id="5187999405556739502">
                  <node role="rightExpression:3" type="jetbrains.mps.lang.smodel.structure.NodeRefExpression:16" id="5187999405556739505">
                    <link role="referentNode:16" targetNodeId="10.~Nullable" resolveInfo="Nullable" />
                  </node>
                  <node role="leftExpression:3" type="jetbrains.mps.baseLanguage.structure.DotExpression:3" id="5187999405556739506">
                    <node role="operand:3" type="jetbrains.mps.baseLanguage.structure.LocalVariableReference:3" id="5187999405556739501">
                      <link role="variableDeclaration:3" targetNodeId="4943044633102120790" resolveInfo="annotation" />
                    </node>
                    <node role="operation:3" type="jetbrains.mps.lang.smodel.structure.SLinkAccess:16" id="5187999405556739510">
                      <link role="link:16" targetNodeId="8.1188208074048:3" />
                    </node>
                  </node>
                </node>
              </node>
              <node role="statement:3" type="jetbrains.mps.baseLanguage.structure.IfStatement:3" id="4943044633102120834">
                <node role="ifTrue:3" type="jetbrains.mps.baseLanguage.structure.StatementList:3" id="4943044633102120835">
                  <node role="statement:3" type="jetbrains.mps.analyzers.structure.EmitInstruction:0" id="4943044633102120842">
                    <node role="instructionRef:0" type="jetbrains.mps.analyzers.structure.InstructionReference:0" id="4943044633102120843">
                      <link role="instruction:0" targetNodeId="1665527126811217322" resolveInfo="notNull" />
                      <node role="argument:0" type="jetbrains.mps.analyzers.structure.ApplicableNodeReference:0" id="4943044633102120848">
                        <link role="applicableNode:0" targetNodeId="4943044633101897935" resolveInfo="method" />
                      </node>
                    </node>
                    <node role="position:0" type="jetbrains.mps.analyzers.structure.InsertAfterPosition:0" id="4943044633102120852" />
                    <node role="target:0" type="jetbrains.mps.analyzers.structure.ApplicableNodeReference:0" id="323410281720635073">
                      <link role="applicableNode:0" targetNodeId="4943044633101897935" resolveInfo="methodCall" />
                    </node>
                  </node>
                </node>
                <node role="condition:3" type="jetbrains.mps.baseLanguage.structure.EqualsExpression:3" id="323410281720592199">
                  <node role="rightExpression:3" type="jetbrains.mps.lang.smodel.structure.NodeRefExpression:16" id="323410281720592202">
                    <link role="referentNode:16" targetNodeId="10.~NotNull" resolveInfo="NotNull" />
                  </node>
                  <node role="leftExpression:3" type="jetbrains.mps.baseLanguage.structure.DotExpression:3" id="323410281720592194">
                    <node role="operand:3" type="jetbrains.mps.baseLanguage.structure.LocalVariableReference:3" id="323410281720592193">
                      <link role="variableDeclaration:3" targetNodeId="4943044633102120790" resolveInfo="annotation" />
                    </node>
                    <node role="operation:3" type="jetbrains.mps.lang.smodel.structure.SLinkAccess:16" id="323410281720592198">
                      <link role="link:16" targetNodeId="8.1188208074048:3" />
                    </node>
                  </node>
                </node>
            ...
            <node role="iterable:3" type="jetbrains.mps.baseLanguage.structure.DotExpression:3" id="4943044633102120795">
              <node role="operand:3" type="jetbrains.mps.baseLanguage.structure.DotExpression:3" id="4943044633102120796">
                <node role="operand:3" type="jetbrains.mps.baseLanguage.structure.LocalVariableReference:3" id="4943044633102120797">
                  <link role="variableDeclaration:3" targetNodeId="4943044633102120748" resolveInfo="m" />
                </node>
                <node role="operation:3" type="jetbrains.mps.lang.smodel.structure.SLinkAccess:16" id="4943044633102120798">
                  <link role="link:16" targetNodeId="8.1068499141037:3" />
                </node>
              </node>
              <node role="operation:3" type="jetbrains.mps.lang.smodel.structure.SLinkListAccess:16" id="4943044633102120799">
                <link role="link:16" targetNodeId="8.1188208488637:3" />
              </node>
            </node>
          </node>
        </node>
        <node role="condition:3" type="jetbrains.mps.baseLanguage.structure.NotEqualsExpression:3" id="4943044633102120768">
          <node role="rightExpression:3" type="jetbrains.mps.baseLanguage.structure.NullLiteral:3" id="4943044633102120771" />
          <node role="leftExpression:3" type="jetbrains.mps.baseLanguage.structure.DotExpression:3" id="4943044633102120758">
            <node role="operand:3" type="jetbrains.mps.baseLanguage.structure.DotExpression:3" id="4943044633102120753">
              <node role="operand:3" type="jetbrains.mps.baseLanguage.structure.LocalVariableReference:3" id="4943044633102120752">
                <link role="variableDeclaration:3" targetNodeId="4943044633102120748" resolveInfo="m" />
              </node>
              <node role="operation:3" type="jetbrains.mps.lang.smodel.structure.SLinkAccess:16" id="4943044633102120757">
                <link role="link:16" targetNodeId="8.1068499141037:3" />
              </node>
            </node>
            <node role="operation:3" type="jetbrains.mps.lang.smodel.structure.SLinkListAccess:16" id="4943044633102120762">
              <link role="link:16" targetNodeId="8.1188208488637:3" />
            </node>
          </node>
        </node>
    ...
    <node role="condition:0" type="jetbrains.mps.analyzers.structure.ConceptCondition:0" id="4943044633101897935">
      <property name="name:0" value="methodCall" />
      <link role="concept:0" targetNodeId="8.1204053956946:3" resolveInfo="IMethodCall" />
    </node>
  </node>
  <node type="jetbrains.mps.analyzers.structure.Rule:0" id="1384134943041910557">
    <property name="name:0" value="RuleNullLiteral" />
    <node role="condition:0" type="jetbrains.mps.analyzers.structure.ConceptCondition:0" id="1384134943041910559">
      <property name="name:0" value="nullLiteral" />
      <link role="concept:0" targetNodeId="8.1070534058343:3" resolveInfo="NullLiteral" />
    </node>
    <node role="actions:0" type="jetbrains.mps.baseLanguage.structure.StatementList:3" id="1384134943041910560">
      <node role="statement:3" type="jetbrains.mps.analyzers.structure.EmitInstruction:0" id="1384134943041914159">
        <node role="instructionRef:0" type="jetbrains.mps.analyzers.structure.InstructionReference:0" id="1384134943041914162">
          <link role="instruction:0" targetNodeId="680562289607957342" resolveInfo="null" />
          <node role="argument:0" type="jetbrains.mps.analyzers.structure.ApplicableNodeReference:0" id="1384134943041914163">
            <link role="applicableNode:0" targetNodeId="1384134943041910559" resolveInfo="nullLiteral" />
          </node>
        </node>
        <node role="position:0" type="jetbrains.mps.analyzers.structure.InsertAfterPosition:0" id="1384134943041914164" />
        <node role="target:0" type="jetbrains.mps.analyzers.structure.ApplicableNodeReference:0" id="323410281720635074">
          <link role="applicableNode:0" targetNodeId="1384134943041910559" resolveInfo="nullLiteral" />
        </node>
      </node>
    </node>
  ...
  <node type="jetbrains.mps.analyzers.structure.Rule:0" id="5317099423844018525">
    <property name="name:0" value="RuleFieldReference" />
    <node role="condition:0" type="jetbrains.mps.analyzers.structure.ConceptCondition:0" id="5317099423844018527">
      <property name="name:0" value="fieldReference" />
      <link role="concept:0" targetNodeId="8.7785501532031639928:3" resolveInfo="LocalInstanceFieldReference" />
    </node>
    <node role="actions:0" type="jetbrains.mps.baseLanguage.structure.StatementList:3" id="5317099423844019310">
      <node role="statement:3" type="jetbrains.mps.baseLanguage.structure.IfStatement:3" id="5317099423844019311">
        <node role="condition:3" type="jetbrains.mps.baseLanguage.structure.NotEqualsExpression:3" id="5317099423844019878">
          <node role="rightExpression:3" type="jetbrains.mps.baseLanguage.structure.NullLiteral:3" id="5317099423844019881" />
          <node role="leftExpression:3" type="jetbrains.mps.baseLanguage.structure.DotExpression:3" id="5317099423844019320">
            <node role="operand:3" type="jetbrains.mps.baseLanguage.structure.DotExpression:3" id="5317099423844019315">
              <node role="operand:3" type="jetbrains.mps.analyzers.structure.ApplicableNodeReference:0" id="5317099423844019314">
                <link role="applicableNode:0" targetNodeId="5317099423844018527" resolveInfo="fieldReference" />
              </node>
              <node role="operation:3" type="jetbrains.mps.lang.smodel.structure.SLinkAccess:16" id="7670236024126332186">
                <link role="link:16" targetNodeId="8.7785501532031731645:3" />
              </node>
            </node>
            <node role="operation:3" type="jetbrains.mps.lang.smodel.structure.SLinkListAccess:16" id="5317099423844019877">
              <link role="link:16" targetNodeId="8.1188208488637:3" />
            </node>
          </node>
        </node>
        <node role="ifTrue:3" type="jetbrains.mps.baseLanguage.structure.StatementList:3" id="5317099423844019313">
          <node role="statement:3" type="jetbrains.mps.baseLanguage.structure.ForeachStatement:3" id="5317099423844019884">
            <node role="variable:3" type="jetbrains.mps.baseLanguage.structure.LocalVariableDeclaration:3" id="5317099423844019885">
              <property name="name:3" value="annotation" />
              <node role="type:3" type="jetbrains.mps.lang.smodel.structure.SNodeType:16" id="5317099423844019886">
                <link role="concept:16" targetNodeId="8.1188207840427:3" resolveInfo="AnnotationInstance" />
              </node>
            </node>
            <node role="body:3" type="jetbrains.mps.baseLanguage.structure.StatementList:3" id="5317099423844019887">
              <node role="statement:3" type="jetbrains.mps.baseLanguage.structure.LocalVariableDeclarationStatement:3" id="5317099423844019888">
                <node role="localVariableDeclaration:3" type="jetbrains.mps.baseLanguage.structure.LocalVariableDeclaration:3" id="5317099423844019889">
                  <property name="name:3" value="name" />
                  <node role="type:3" type="jetbrains.mps.baseLanguage.structure.StringType:3" id="5317099423844019890" />
                  <node role="initializer:3" type="jetbrains.mps.baseLanguage.structure.DotExpression:3" id="5317099423844019891">
                    <node role="operand:3" type="jetbrains.mps.baseLanguage.structure.DotExpression:3" id="5317099423844019892">
                      <node role="operand:3" type="jetbrains.mps.baseLanguage.structure.LocalVariableReference:3" id="5317099423844019893">
                        <link role="variableDeclaration:3" targetNodeId="5317099423844019885" resolveInfo="annotation" />
                      </node>
                      <node role="operation:3" type="jetbrains.mps.lang.smodel.structure.SLinkAccess:16" id="5317099423844019894">
                        <link role="link:16" targetNodeId="8.1188208074048:3" />
                      </node>
                    </node>
                    <node role="operation:3" type="jetbrains.mps.lang.smodel.structure.SPropertyAccess:16" id="5317099423844019895">
                      <link role="property:16" targetNodeId="3v.1169194664001:0" resolveInfo="name" />
                    </node>
                  </node>
                </node>
              </node>
              <node role="statement:3" type="jetbrains.mps.baseLanguage.structure.IfStatement:3" id="5317099423844019896">
                <node role="ifTrue:3" type="jetbrains.mps.baseLanguage.structure.StatementList:3" id="5317099423844019897">
                  <node role="statement:3" type="jetbrains.mps.analyzers.structure.EmitInstruction:0" id="5317099423844019898">
                    <node role="instructionRef:0" type="jetbrains.mps.analyzers.structure.InstructionReference:0" id="5317099423844019899">
                      <link role="instruction:0" targetNodeId="1665527126811217326" resolveInfo="nullable" />
                      <node role="argument:0" type="jetbrains.mps.baseLanguage.structure.DotExpression:3" id="5317099423844019930">
                        <node role="operand:3" type="jetbrains.mps.analyzers.structure.ApplicableNodeReference:0" id="5317099423844019929">
                          <link role="applicableNode:0" targetNodeId="5317099423844018527" resolveInfo="fieldReference" />
                        </node>
                        <node role="operation:3" type="jetbrains.mps.lang.smodel.structure.SLinkAccess:16" id="7670236024126332187">
                          <link role="link:16" targetNodeId="8.7785501532031731645:3" />
                        </node>
                      </node>
                    </node>
                    <node role="position:0" type="jetbrains.mps.analyzers.structure.InsertAfterPosition:0" id="5317099423844019901" />
                    <node role="target:0" type="jetbrains.mps.analyzers.structure.ApplicableNodeReference:0" id="323410281720635075">
                      <link role="applicableNode:0" targetNodeId="5317099423844018527" resolveInfo="fieldReference" />
                    </node>
                  </node>
                </node>
                <node role="condition:3" type="jetbrains.mps.baseLanguage.structure.EqualsExpression:3" id="323410281720635082">
                  <node role="rightExpression:3" type="jetbrains.mps.lang.smodel.structure.NodeRefExpression:16" id="323410281720635083">
                    <link role="referentNode:16" targetNodeId="10.~Nullable" resolveInfo="Nullable" />
                  </node>
                  <node role="leftExpression:3" type="jetbrains.mps.baseLanguage.structure.DotExpression:3" id="323410281720635084">
                    <node role="operand:3" type="jetbrains.mps.baseLanguage.structure.LocalVariableReference:3" id="323410281720635085">
                      <link role="variableDeclaration:3" targetNodeId="5317099423844019885" resolveInfo="annotation" />
                    </node>
                    <node role="operation:3" type="jetbrains.mps.lang.smodel.structure.SLinkAccess:16" id="323410281720635086">
                      <link role="link:16" targetNodeId="8.1188208074048:3" />
                    </node>
                  </node>
                </node>
              </node>
              <node role="statement:3" type="jetbrains.mps.baseLanguage.structure.IfStatement:3" id="5317099423844019906">
                <node role="ifTrue:3" type="jetbrains.mps.baseLanguage.structure.StatementList:3" id="5317099423844019907">
                  <node role="statement:3" type="jetbrains.mps.analyzers.structure.EmitInstruction:0" id="5317099423844019908">
                    <node role="instructionRef:0" type="jetbrains.mps.analyzers.structure.InstructionReference:0" id="5317099423844019909">
                      <link role="instruction:0" targetNodeId="1665527126811217322" resolveInfo="notNull" />
                      <node role="argument:0" type="jetbrains.mps.baseLanguage.structure.DotExpression:3" id="5317099423844019940">
                        <node role="operand:3" type="jetbrains.mps.analyzers.structure.ApplicableNodeReference:0" id="5317099423844019939">
                          <link role="applicableNode:0" targetNodeId="5317099423844018527" resolveInfo="fieldReference" />
                        </node>
                        <node role="operation:3" type="jetbrains.mps.lang.smodel.structure.SLinkAccess:16" id="7670236024126332189">
                          <link role="link:16" targetNodeId="8.7785501532031731645:3" />
                        </node>
                      </node>
                    </node>
                    <node role="position:0" type="jetbrains.mps.analyzers.structure.InsertAfterPosition:0" id="5317099423844019911" />
                    <node role="target:0" type="jetbrains.mps.analyzers.structure.ApplicableNodeReference:0" id="323410281720635076">
                      <link role="applicableNode:0" targetNodeId="5317099423844018527" resolveInfo="fieldReference" />
                    </node>
                  </node>
                </node>
                <node role="condition:3" type="jetbrains.mps.baseLanguage.structure.EqualsExpression:3" id="323410281720635077">
                  <node role="rightExpression:3" type="jetbrains.mps.lang.smodel.structure.NodeRefExpression:16" id="323410281720635078">
                    <link role="referentNode:16" targetNodeId="10.~NotNull" resolveInfo="NotNull" />
                  </node>
                  <node role="leftExpression:3" type="jetbrains.mps.baseLanguage.structure.DotExpression:3" id="323410281720635079">
                    <node role="operand:3" type="jetbrains.mps.baseLanguage.structure.LocalVariableReference:3" id="323410281720635080">
                      <link role="variableDeclaration:3" targetNodeId="5317099423844019885" resolveInfo="annotation" />
                    </node>
                    <node role="operation:3" type="jetbrains.mps.lang.smodel.structure.SLinkAccess:16" id="323410281720635081">
                      <link role="link:16" targetNodeId="8.1188208074048:3" />
                    </node>
                  </node>
                </node>
            ...
            <node role="iterable:3" type="jetbrains.mps.baseLanguage.structure.DotExpression:3" id="5317099423844019916">
              <node role="operand:3" type="jetbrains.mps.baseLanguage.structure.DotExpression:3" id="5317099423844019923">
                <node role="operand:3" type="jetbrains.mps.analyzers.structure.ApplicableNodeReference:0" id="5317099423844019922">
                  <link role="applicableNode:0" targetNodeId="5317099423844018527" resolveInfo="fieldReference" />
                </node>
                <node role="operation:3" type="jetbrains.mps.lang.smodel.structure.SLinkAccess:16" id="7670236024126332188">
                  <link role="link:16" targetNodeId="8.7785501532031731645:3" />
                </node>
              </node>
              <node role="operation:3" type="jetbrains.mps.lang.smodel.structure.SLinkListAccess:16" id="5317099423844019920">
                <link role="link:16" targetNodeId="8.1188208488637:3" />
              </node>
            </node>
          </node>
  ...
  <node type="jetbrains.mps.analyzers.structure.Rule:0" id="323410281720652596">
    <property name="name:0" value="RuleAfterDotExpression" />
    <node role="condition:0" type="jetbrains.mps.analyzers.structure.ConceptCondition:0" id="323410281720652598">
      <property name="name:0" value="dot" />
      <link role="concept:0" targetNodeId="8.1197027756228:3" resolveInfo="DotExpression" />
    </node>
    <node role="actions:0" type="jetbrains.mps.baseLanguage.structure.StatementList:3" id="323410281720652599">
      <node role="statement:3" type="jetbrains.mps.baseLanguage.structure.IfStatement:3" id="323410281720718467">
        <node role="condition:3" type="jetbrains.mps.baseLanguage.structure.NotExpression:3" id="323410281720718481">
          <node role="expression:3" type="jetbrains.mps.baseLanguage.structure.DotExpression:3" id="323410281720718476">
            <node role="operand:3" type="jetbrains.mps.baseLanguage.structure.DotExpression:3" id="323410281720718471">
              <node role="operand:3" type="jetbrains.mps.analyzers.structure.ApplicableNodeReference:0" id="323410281720718470">
                <link role="applicableNode:0" targetNodeId="323410281720652598" resolveInfo="dot" />
              </node>
              <node role="operation:3" type="jetbrains.mps.lang.smodel.structure.SLinkAccess:16" id="323410281720718475">
                <link role="link:16" targetNodeId="8.1197027833540:3" />
              </node>
            </node>
            <node role="operation:3" type="jetbrains.mps.lang.smodel.structure.Node_ConceptMethodCall:16" id="323410281720718480">
              <link role="baseMethodDeclaration:16" targetNodeId="11.323410281720656291" resolveInfo="operandCanBeNull" />
            </node>
          </node>
        </node>
        <node role="ifTrue:3" type="jetbrains.mps.baseLanguage.structure.StatementList:3" id="323410281720718469">
          <node role="statement:3" type="jetbrains.mps.analyzers.structure.EmitInstruction:0" id="323410281720718483">
            <node role="instructionRef:0" type="jetbrains.mps.analyzers.structure.InstructionReference:0" id="323410281720718486">
              <link role="instruction:0" targetNodeId="1665527126811217322" resolveInfo="notNull" />
              <node role="argument:0" type="jetbrains.mps.baseLanguage.structure.DotExpression:3" id="323410281720718488">
                <node role="operand:3" type="jetbrains.mps.analyzers.structure.ApplicableNodeReference:0" id="323410281720718487">
                  <link role="applicableNode:0" targetNodeId="323410281720652598" resolveInfo="dot" />
                </node>
                <node role="operation:3" type="jetbrains.mps.lang.smodel.structure.SLinkAccess:16" id="323410281720718492">
                  <link role="link:16" targetNodeId="8.1197027771414:3" />
                </node>
              </node>
            </node>
            <node role="position:0" type="jetbrains.mps.analyzers.structure.InsertAfterPosition:0" id="323410281720718493" />
            <node role="target:0" type="jetbrains.mps.baseLanguage.structure.DotExpression:3" id="323410281720718495">
              <node role="operand:3" type="jetbrains.mps.analyzers.structure.ApplicableNodeReference:0" id="323410281720718494">
                <link role="applicableNode:0" targetNodeId="323410281720652598" resolveInfo="dot" />
              </node>
              <node role="operation:3" type="jetbrains.mps.lang.smodel.structure.SLinkAccess:16" id="323410281720718499">
                <link role="link:16" targetNodeId="8.1197027771414:3" />
              </node>
            </node>
          </node>
  ...
  <node type="jetbrains.mps.analyzers.structure.Rule:0" id="6465013485826573723">
    <property name="name:0" value="RuleVariableDeclaration" />
    <node role="condition:0" type="jetbrains.mps.analyzers.structure.ConceptCondition:0" id="6465013485826573725">
      <property name="name:0" value="var" />
      <link role="concept:0" targetNodeId="8.1068431474542:3" resolveInfo="VariableDeclaration" />
    </node>
    <node role="actions:0" type="jetbrains.mps.baseLanguage.structure.StatementList:3" id="6465013485826575171">
      <node role="statement:3" type="jetbrains.mps.baseLanguage.structure.IfStatement:3" id="6465013485826575173">
        <node role="ifTrue:3" type="jetbrains.mps.baseLanguage.structure.StatementList:3" id="6465013485826575174">
          <node role="statement:3" type="jetbrains.mps.baseLanguage.structure.ForeachStatement:3" id="6465013485826575175">
            <node role="variable:3" type="jetbrains.mps.baseLanguage.structure.LocalVariableDeclaration:3" id="6465013485826575176">
              <property name="name:3" value="annotation" />
              <node role="type:3" type="jetbrains.mps.lang.smodel.structure.SNodeType:16" id="6465013485826575177">
                <link role="concept:16" targetNodeId="8.1188207840427:3" resolveInfo="AnnotationInstance" />
              </node>
            </node>
            <node role="body:3" type="jetbrains.mps.baseLanguage.structure.StatementList:3" id="6465013485826575178">
              <node role="statement:3" type="jetbrains.mps.baseLanguage.structure.LocalVariableDeclarationStatement:3" id="6465013485826575179">
                <node role="localVariableDeclaration:3" type="jetbrains.mps.baseLanguage.structure.LocalVariableDeclaration:3" id="6465013485826575180">
                  <property name="name:3" value="name" />
                  <node role="type:3" type="jetbrains.mps.baseLanguage.structure.StringType:3" id="6465013485826575181" />
                  <node role="initializer:3" type="jetbrains.mps.baseLanguage.structure.DotExpression:3" id="6465013485826575182">
                    <node role="operand:3" type="jetbrains.mps.baseLanguage.structure.DotExpression:3" id="6465013485826575183">
                      <node role="operand:3" type="jetbrains.mps.baseLanguage.structure.LocalVariableReference:3" id="6465013485826575184">
                        <link role="variableDeclaration:3" targetNodeId="6465013485826575176" resolveInfo="annotation" />
                      </node>
                      <node role="operation:3" type="jetbrains.mps.lang.smodel.structure.SLinkAccess:16" id="6465013485826575185">
                        <link role="link:16" targetNodeId="8.1188208074048:3" />
                      </node>
                    </node>
                    <node role="operation:3" type="jetbrains.mps.lang.smodel.structure.SPropertyAccess:16" id="6465013485826575186">
                      <link role="property:16" targetNodeId="3v.1169194664001:0" resolveInfo="name" />
                    </node>
                  </node>
                </node>
              </node>
              <node role="statement:3" type="jetbrains.mps.baseLanguage.structure.IfStatement:3" id="6465013485826575187">
                <node role="ifTrue:3" type="jetbrains.mps.baseLanguage.structure.StatementList:3" id="6465013485826575188">
                  <node role="statement:3" type="jetbrains.mps.analyzers.structure.EmitInstruction:0" id="6465013485826575189">
                    <node role="instructionRef:0" type="jetbrains.mps.analyzers.structure.InstructionReference:0" id="6465013485826575190">
                      <link role="instruction:0" targetNodeId="1665527126811217326" resolveInfo="nullable" />
                      <node role="argument:0" type="jetbrains.mps.analyzers.structure.ApplicableNodeReference:0" id="6465013485826575229">
                        <link role="applicableNode:0" targetNodeId="6465013485826573725" resolveInfo="var" />
                      </node>
                    </node>
                    <node role="position:0" type="jetbrains.mps.analyzers.structure.InsertAfterPosition:0" id="6465013485826575192" />
                    <node role="target:0" type="jetbrains.mps.analyzers.structure.ApplicableNodeReference:0" id="6465013485826575230">
                      <link role="applicableNode:0" targetNodeId="6465013485826573725" resolveInfo="var" />
                    </node>
                  </node>
                </node>
                <node role="condition:3" type="jetbrains.mps.baseLanguage.structure.EqualsExpression:3" id="6465013485826575194">
                  <node role="rightExpression:3" type="jetbrains.mps.lang.smodel.structure.NodeRefExpression:16" id="6465013485826575195">
                    <link role="referentNode:16" targetNodeId="10.~Nullable" resolveInfo="Nullable" />
                  </node>
                  <node role="leftExpression:3" type="jetbrains.mps.baseLanguage.structure.DotExpression:3" id="6465013485826575196">
                    <node role="operand:3" type="jetbrains.mps.baseLanguage.structure.LocalVariableReference:3" id="6465013485826575227">
                      <link role="variableDeclaration:3" targetNodeId="6465013485826575176" resolveInfo="annotation" />
                    </node>
                    <node role="operation:3" type="jetbrains.mps.lang.smodel.structure.SLinkAccess:16" id="6465013485826575228">
                      <link role="link:16" targetNodeId="8.1188208074048:3" />
                    </node>
                  </node>
                </node>
              </node>
              <node role="statement:3" type="jetbrains.mps.baseLanguage.structure.IfStatement:3" id="6465013485826575199">
                <node role="ifTrue:3" type="jetbrains.mps.baseLanguage.structure.StatementList:3" id="6465013485826575200">
                  <node role="statement:3" type="jetbrains.mps.analyzers.structure.EmitInstruction:0" id="6465013485826575201">
                    <node role="instructionRef:0" type="jetbrains.mps.analyzers.structure.InstructionReference:0" id="6465013485826575202">
                      <link role="instruction:0" targetNodeId="1665527126811217322" resolveInfo="notNull" />
                      <node role="argument:0" type="jetbrains.mps.analyzers.structure.ApplicableNodeReference:0" id="6465013485826575232">
                        <link role="applicableNode:0" targetNodeId="6465013485826573725" resolveInfo="var" />
                      </node>
                    </node>
                    <node role="position:0" type="jetbrains.mps.analyzers.structure.InsertAfterPosition:0" id="6465013485826575204" />
                    <node role="target:0" type="jetbrains.mps.analyzers.structure.ApplicableNodeReference:0" id="6465013485826575231">
                      <link role="applicableNode:0" targetNodeId="6465013485826573725" resolveInfo="var" />
                    </node>
                  </node>
                </node>
                <node role="condition:3" type="jetbrains.mps.baseLanguage.structure.EqualsExpression:3" id="6465013485826575206">
                  <node role="rightExpression:3" type="jetbrains.mps.lang.smodel.structure.NodeRefExpression:16" id="6465013485826575207">
                    <link role="referentNode:16" targetNodeId="10.~NotNull" resolveInfo="NotNull" />
                  </node>
                  <node role="leftExpression:3" type="jetbrains.mps.baseLanguage.structure.DotExpression:3" id="6465013485826575208">
                    <node role="operand:3" type="jetbrains.mps.baseLanguage.structure.LocalVariableReference:3" id="6465013485826575209">
                      <link role="variableDeclaration:3" targetNodeId="6465013485826575176" resolveInfo="annotation" />
                    </node>
                    <node role="operation:3" type="jetbrains.mps.lang.smodel.structure.SLinkAccess:16" id="6465013485826575210">
                      <link role="link:16" targetNodeId="8.1188208074048:3" />
                    </node>
                  </node>
                </node>
            ...
            <node role="iterable:3" type="jetbrains.mps.baseLanguage.structure.DotExpression:3" id="6465013485826575211">
              <node role="operand:3" type="jetbrains.mps.analyzers.structure.ApplicableNodeReference:0" id="6465013485826575226">
                <link role="applicableNode:0" targetNodeId="6465013485826573725" resolveInfo="var" />
              </node>
              <node role="operation:3" type="jetbrains.mps.lang.smodel.structure.SLinkListAccess:16" id="6465013485826575215">
                <link role="link:16" targetNodeId="8.1188208488637:3" />
              </node>
            </node>
          </node>
        </node>
        <node role="condition:3" type="jetbrains.mps.baseLanguage.structure.NotEqualsExpression:3" id="6465013485826575216">
          <node role="rightExpression:3" type="jetbrains.mps.baseLanguage.structure.NullLiteral:3" id="6465013485826575217" />
          <node role="leftExpression:3" type="jetbrains.mps.baseLanguage.structure.DotExpression:3" id="6465013485826575218">
            <node role="operand:3" type="jetbrains.mps.analyzers.structure.ApplicableNodeReference:0" id="6465013485826575224">
              <link role="applicableNode:0" targetNodeId="6465013485826573725" resolveInfo="var" />
            </node>
            <node role="operation:3" type="jetbrains.mps.lang.smodel.structure.SLinkListAccess:16" id="6465013485826575222">
              <link role="link:16" targetNodeId="8.1188208488637:3" />
            </node>
          </node>
        </node>
  ...
  <node type="jetbrains.mps.analyzers.structure.Rule:0" id="680562289607974122">
    <property name="name:0" value="WhileNotNull" />
    <node role="condition:0" type="jetbrains.mps.analyzers.structure.PatternCondition:0" id="680562289607974124">
      <node role="pattern:0" type="jetbrains.mps.lang.pattern.structure.PatternExpression:0" id="680562289607974125">
        <node role="patternNode:0" type="jetbrains.mps.baseLanguage.structure.WhileStatement:3" id="680562289607974126">
          <node role="condition:3" type="jetbrains.mps.baseLanguage.structure.NotEqualsExpression:3" id="680562289607974129">
            <node role="rightExpression:3" type="jetbrains.mps.baseLanguage.structure.NullLiteral:3" id="680562289607974132" />
            <node role="leftExpression:3" type="jetbrains.mps.baseLanguage.structure.Expression:3" id="680562289607974131">
              <node role="_attr_$attribute:3" type="jetbrains.mps.lang.pattern.structure.PatternVariableDeclaration:0" id="680562289607974133">
                <property name="varName:0" value="p" />
              </node>
            </node>
          </node>
          <node role="body:3" type="jetbrains.mps.baseLanguage.structure.StatementList:3" id="680562289607974128">
            <node role="asPattern$attribute:3" type="jetbrains.mps.lang.pattern.structure.ActionAsPattern:0" id="680562289607974134">
              <property name="varName:0" value="body" />
              <node role="action:0" type="jetbrains.mps.analyzers.structure.EmitInstruction:0" id="680562289607974136">
                <node role="instructionRef:0" type="jetbrains.mps.analyzers.structure.InstructionReference:0" id="680562289607974139">
                  <link role="instruction:0" targetNodeId="1665527126811217322" resolveInfo="notNull" />
                  <node role="argument:0" type="jetbrains.mps.lang.pattern.structure.PatternVariableReference:0" id="680562289607974140">
                    <link role="variable:0" targetNodeId="680562289607974133" resolveInfo="#p" />
                  </node>
                </node>
                <node role="position:0" type="jetbrains.mps.analyzers.structure.InsertBeforePosition:0" id="680562289607974141" />
              </node>
            </node>
          </node>
        </node>
  ...
  <node type="jetbrains.mps.analyzers.structure.Rule:0" id="3380610091175375006">
    <property name="name:0" value="RuleCreator" />
    <node role="condition:0" type="jetbrains.mps.analyzers.structure.ConceptCondition:0" id="3380610091175375008">
      <property name="name:0" value="creator" />
      <link role="concept:0" targetNodeId="8.1145552809883:3" resolveInfo="AbstractCreator" />
    </node>
    <node role="actions:0" type="jetbrains.mps.baseLanguage.structure.StatementList:3" id="3380610091175378606">
      <node role="statement:3" type="jetbrains.mps.analyzers.structure.EmitInstruction:0" id="3380610091175378610">
        <node role="instructionRef:0" type="jetbrains.mps.analyzers.structure.InstructionReference:0" id="3380610091175378613">
          <link role="instruction:0" targetNodeId="1665527126811217322" resolveInfo="notNull" />
          <node role="argument:0" type="jetbrains.mps.analyzers.structure.ApplicableNodeReference:0" id="3380610091175378614">
            <link role="applicableNode:0" targetNodeId="3380610091175375008" resolveInfo="creator" />
          </node>
        </node>
        <node role="position:0" type="jetbrains.mps.analyzers.structure.InsertAfterPosition:0" id="3380610091175378615" />
        <node role="target:0" type="jetbrains.mps.analyzers.structure.ApplicableNodeReference:0" id="3380610091175378616">
          <link role="applicableNode:0" targetNodeId="3380610091175375008" resolveInfo="creator" />
        </node>
      </node>
    </node>
  </node>
  <node type="jetbrains.mps.analyzers.structure.Rule:0" id="7801926404027355804">
    <property name="name:0" value="WhileNullNot" />
    <node role="condition:0" type="jetbrains.mps.analyzers.structure.PatternCondition:0" id="7801926404027355806">
      <node role="pattern:0" type="jetbrains.mps.lang.pattern.structure.PatternExpression:0" id="7801926404027355807">
        <node role="patternNode:0" type="jetbrains.mps.baseLanguage.structure.WhileStatement:3" id="7801926404027355808">
          <node role="condition:3" type="jetbrains.mps.baseLanguage.structure.NotEqualsExpression:3" id="7801926404027355812">
            <node role="rightExpression:3" type="jetbrains.mps.baseLanguage.structure.Expression:3" id="7801926404027355813">
              <node role="_attr_$attribute:3" type="jetbrains.mps.lang.pattern.structure.PatternVariableDeclaration:0" id="7801926404027355815">
                <property name="varName:0" value="p" />
              </node>
            </node>
            <node role="leftExpression:3" type="jetbrains.mps.baseLanguage.structure.NullLiteral:3" id="7801926404027355811" />
          </node>
          <node role="body:3" type="jetbrains.mps.baseLanguage.structure.StatementList:3" id="7801926404027355810">
            <node role="asPattern$attribute:3" type="jetbrains.mps.lang.pattern.structure.ActionAsPattern:0" id="7801926404027355816">
              <property name="varName:0" value="body" />
              <node role="action:0" type="jetbrains.mps.analyzers.structure.EmitInstruction:0" id="7801926404027355818">
                <node role="instructionRef:0" type="jetbrains.mps.analyzers.structure.InstructionReference:0" id="7801926404027355821">
                  <link role="instruction:0" targetNodeId="1665527126811217322" resolveInfo="notNull" />
                  <node role="argument:0" type="jetbrains.mps.lang.pattern.structure.PatternVariableReference:0" id="7801926404027359419">
                    <link role="variable:0" targetNodeId="7801926404027355815" resolveInfo="#p" />
                  </node>
                </node>
