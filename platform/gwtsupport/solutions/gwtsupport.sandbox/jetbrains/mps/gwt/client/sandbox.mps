...
<model modelUID="r:08f902c8-ff6a-43df-b543-532598ca57f7(jetbrains.mps.gwt.client.sandbox)">
  ...
  <node type="jetbrains.mps.gwt.client.structure.GWTModule:0" id="8778502744741320291">
    ...
    <node role="element:0" type="jetbrains.mps.gwt.client.structure.Public:0" id="8778502744741320296">
      <node role="path:0" type="jetbrains.mps.gwt.client.structure.Path:0" id="8778502744741320297">
        <property name="value:0" value="com" />
      </node>
      <node role="pattern:0" type="jetbrains.mps.gwt.client.structure.Exclude:0" id="8778502744741320298">
        <node role="pattern:0" type="jetbrains.mps.gwt.client.structure.Pattern:0" id="8778502744741320299">
