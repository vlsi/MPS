...
public class PathFilter_Enter extends EditorCellKeyMap {
  public PathFilter_Enter() {
    this.setApplicableToEveryModel(false);
    EditorCellKeyMapAction action;
    action = new PathFilter_Enter.PathFilter_Enter_Action0();
    this.putAction("any", "VK_ENTER", action);
  }

  public static class PathFilter_Enter_Action0 extends EditorCellKeyMapAction {
    public PathFilter_Enter_Action0() {
    ...
    public boolean canExecute(final KeyEvent keyEvent, final EditorContext editorContext) {
      ...
      if (contextNode.isInstanceOfConcept("jetbrains.mps.gwt.client.structure.PatternFilter")) {
    ...
    private void execute_internal(final KeyEvent keyEvent, final EditorContext editorContext, final SNode node, final List<SNode> selectedNodes) {
      SLinkOperations.setNewChild(node, "path", "jetbrains.mps.gwt.client.structure.Path");
    }
