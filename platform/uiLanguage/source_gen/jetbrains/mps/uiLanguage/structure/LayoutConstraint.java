...
public class LayoutConstraint extends BaseConcept implements IComponentPart {
  ...
  public int get_$attributesCount() {
    return this.getChildCount(LayoutConstraint._$ATTRIBUTE);
  }

  public Iterator<Attribute> _$attributes() {
    return this.children(Attribute.class, LayoutConstraint._$ATTRIBUTE);
  }

  public List<Attribute> get_$attributes() {
    return this.getChildren(Attribute.class, LayoutConstraint._$ATTRIBUTE);
  }

  public void add_$attribute(Attribute node) {
    this.addChild(LayoutConstraint._$ATTRIBUTE, node);
  }

  public void insert_$attribute(Attribute prev, Attribute node) {
    this.insertChild(prev, LayoutConstraint._$ATTRIBUTE, node);
  }
