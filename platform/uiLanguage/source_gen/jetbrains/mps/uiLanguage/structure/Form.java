...
public class Form extends BaseConcept implements IComponentPart, IComponentInstance {
  ...
  public int get_$attributesCount() {
    return this.getChildCount(Form._$ATTRIBUTE);
  }

  public Iterator<Attribute> _$attributes() {
    return this.children(Attribute.class, Form._$ATTRIBUTE);
  }

  public List<Attribute> get_$attributes() {
    return this.getChildren(Attribute.class, Form._$ATTRIBUTE);
  }

  public void add_$attribute(Attribute node) {
    this.addChild(Form._$ATTRIBUTE, node);
  }

  public void insert_$attribute(Attribute prev, Attribute node) {
    this.insertChild(prev, Form._$ATTRIBUTE, node);
  }
