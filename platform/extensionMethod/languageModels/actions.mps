...
<model modelUID="r:e0c5b5da-9545-4753-a462-f79d5ed8b466(jetbrains.mps.baseLanguage.extensionMethods.actions)">
  ...
  <import index="4" modelUID="f:java_stub#jetbrains.mps.baseLanguage.constraints(jetbrains.mps.baseLanguage.constraints@java_stub)" version="-1" />
  ...
  <visible index="4" modelUID="r:a5509d93-a6df-4356-9363-7de4efc47849(jetbrains.mps.baseLanguage.extensionMethods.behavior)" />
  <node type="jetbrains.mps.lang.actions.structure.NodeSubstituteActions:23" id="8455935734540360532">
    <property name="name:23" value="InstanceMethodCallSubstitute" />
    <node role="actionsBuilder:23" type="jetbrains.mps.lang.actions.structure.NodeSubstituteActionsBuilder:23" id="8455935734540360533">
      <link role="applicableConcept:23" targetNodeId="3v.1068431790191:3" resolveInfo="Expression" />
      <node role="precondition:23" type="jetbrains.mps.lang.actions.structure.NodeSubstitutePreconditionFunction:23" id="8455935734540360534">
        <node role="body:23" type="jetbrains.mps.baseLanguage.structure.StatementList:3" id="8455935734540360535">
          <node role="statement:3" type="jetbrains.mps.baseLanguage.structure.IfStatement:3" id="8455935734540360536">
            <node role="condition:3" type="jetbrains.mps.baseLanguage.structure.DotExpression:3" id="8455935734540360537">
              <node role="operand:3" type="jetbrains.mps.baseLanguage.structure.DotExpression:3" id="8455935734540360538">
                <node role="operand:3" type="jetbrains.mps.lang.actions.structure.ConceptFunctionParameter_parentNode:23" id="8455935734540360539" />
                <node role="operation:3" type="jetbrains.mps.lang.smodel.structure.Node_GetAncestorOperation:16" id="8455935734540360540">
                  <node role="parameter:16" type="jetbrains.mps.lang.smodel.structure.OperationParm_ConceptList:16" id="8455935734540360541">
                    <node role="concept:16" type="jetbrains.mps.lang.smodel.structure.ConceptReference:16" id="8455935734540360542">
                      <link role="concept:16" targetNodeId="2v.8022092943110829337:0" resolveInfo="BaseExtensionMethodContainer" />
                    </node>
                  </node>
                  <node role="parameter:16" type="jetbrains.mps.lang.smodel.structure.OperationParm_Inclusion:16" id="8455935734540360543" />
                </node>
              </node>
              <node role="operation:3" type="jetbrains.mps.lang.smodel.structure.Node_IsNotNullOperation:16" id="8455935734540360544" />
            </node>
          ...
          <node role="statement:3" type="jetbrains.mps.baseLanguage.structure.ReturnStatement:3" id="8455935734540360548">
            <node role="expression:3" type="jetbrains.mps.baseLanguage.structure.BooleanConstant:3" id="8455935734540360549">
              <property name="value:3" value="false" />
            </node>
          </node>
        </node>
      </node>
      <node role="part:23" type="jetbrains.mps.lang.actions.structure.AddMenuPart:23" id="8455935734540360550">
        <link role="concept:23" targetNodeId="3v.1197027756228:3" resolveInfo="DotExpression" />
        <node role="part:23" type="jetbrains.mps.lang.actions.structure.ParameterizedSubstituteMenuPart:23" id="8455935734540361459">
          <node role="type:23" type="jetbrains.mps.lang.smodel.structure.SNodeType:16" id="8455935734540361465" />
          <node role="query:23" type="jetbrains.mps.lang.actions.structure.QueryFunction_ParameterizedSubstitute_Query:23" id="8455935734540361461">
            <node role="body:23" type="jetbrains.mps.baseLanguage.structure.StatementList:3" id="8455935734540361462">
              <node role="statement:3" type="jetbrains.mps.baseLanguage.structure.LocalVariableDeclarationStatement:3" id="5417760646066155069">
                <node role="localVariableDeclaration:3" type="jetbrains.mps.baseLanguage.structure.LocalVariableDeclaration:3" id="5417760646066155070">
                  <property name="name:3" value="instance" />
                  <node role="type:3" type="jetbrains.mps.lang.smodel.structure.SNodeType:16" id="5417760646066155071" />
                  <node role="initializer:3" type="jetbrains.mps.baseLanguage.structure.DotExpression:3" id="5417760646066550623">
                    <node role="operand:3" type="jetbrains.mps.baseLanguage.structure.DotExpression:3" id="5417760646066155084">
                      <node role="operand:3" type="jetbrains.mps.lang.actions.structure.ConceptFunctionParameter_parentNode:23" id="5417760646066155085" />
                      <node role="operation:3" type="jetbrains.mps.lang.smodel.structure.Node_GetAncestorOperation:16" id="5417760646066155086">
                        <node role="parameter:16" type="jetbrains.mps.lang.smodel.structure.OperationParm_Concept:16" id="5417760646066155087">
                          <node role="conceptArgument:16" type="jetbrains.mps.lang.smodel.structure.RefConcept_Reference:16" id="5417760646066155088">
                            <link role="conceptDeclaration:16" targetNodeId="2v.1550313277222152185:0" resolveInfo="ExtensionMethodDeclaration" />
                          </node>
                        </node>
                      </node>
                    </node>
                    <node role="operation:3" type="jetbrains.mps.lang.smodel.structure.Node_ConceptMethodCall:16" id="5417760646066574254">
                      <link role="baseMethodDeclaration:16" targetNodeId="4v.8022092943109893938" resolveInfo="getThisType" />
                    </node>
                  </node>
                </node>
              </node>
              <node role="statement:3" type="jetbrains.mps.baseLanguage.structure.LocalVariableDeclarationStatement:3" id="5417760646066155076">
                <node role="localVariableDeclaration:3" type="jetbrains.mps.baseLanguage.structure.LocalVariableDeclaration:3" id="5417760646066155077">
                  <property name="name:3" value="classifierType" />
                  <node role="type:3" type="jetbrains.mps.lang.smodel.structure.SNodeType:16" id="5417760646066155078">
                    <link role="concept:16" targetNodeId="3v.1107535904670:3" resolveInfo="ClassifierType" />
                  </node>
                  <node role="initializer:3" type="jetbrains.mps.lang.typesystem.structure.CoerceStrongExpression:3" id="5417760646066155079">
                    <node role="nodeToCoerce:3" type="jetbrains.mps.baseLanguage.structure.LocalVariableReference:3" id="5417760646066155081">
                      <link role="variableDeclaration:3" targetNodeId="5417760646066155070" resolveInfo="instance" />
                    </node>
                    <node role="pattern:3" type="jetbrains.mps.lang.typesystem.structure.ConceptReference:3" id="5417760646066155083">
              ...
              <node role="statement:3" type="jetbrains.mps.baseLanguage.structure.ReturnStatement:3" id="5417760646066155089">
                <node role="expression:3" type="jetbrains.mps.baseLanguage.structure.DotExpression:3" id="5417760646066155100">
                  <node role="operand:3" type="jetbrains.mps.baseLanguage.structure.GenericNewExpression:3" id="5417760646066155090">
                    <node role="creator:3" type="jetbrains.mps.baseLanguage.structure.ClassCreator:3" id="5417760646066155091">
                      <link role="baseMethodDeclaration:3" targetNodeId="4.~InstanceMethodCall_InstanceMethodScope.&lt;init&gt;(jetbrains.mps.baseLanguage.structure.ClassifierType,jetbrains.mps.smodel.SNode)" resolveInfo="InstanceMethodCall_InstanceMethodScope" />
                      <node role="actualArgument:3" type="jetbrains.mps.baseLanguage.structure.DotExpression:3" id="5417760646066155092">
                        <node role="operand:3" type="jetbrains.mps.baseLanguage.structure.LocalVariableReference:3" id="5417760646066155093">
                          <link role="variableDeclaration:3" targetNodeId="5417760646066155077" resolveInfo="classifierType" />
                        </node>
                        <node role="operation:3" type="jetbrains.mps.lang.smodel.structure.Node_GetAdapterOperation:16" id="5417760646066155094" />
                      </node>
                      <node role="actualArgument:3" type="jetbrains.mps.lang.actions.structure.ConceptFunctionParameter_currentTargetNode:23" id="5417760646066433224" />
                    </node>
                  </node>
                  <node role="operation:3" type="jetbrains.mps.baseLanguage.structure.InstanceMethodCallOperation:3" id="5417760646066156527">
                    <link role="baseMethodDeclaration:3" targetNodeId="5.~AbstractSearchScope.getNodes():java.util.List" resolveInfo="getNodes" />
                  </node>
                </node>
              </node>
            </node>
          </node>
          <node role="handler:23" type="jetbrains.mps.lang.actions.structure.QueryFunction_ParameterizedSubstitute_Handler:23" id="8455935734540361463">
            <node role="body:23" type="jetbrains.mps.baseLanguage.structure.StatementList:3" id="8455935734540361464">
              <node role="statement:3" type="jetbrains.mps.baseLanguage.structure.LocalVariableDeclarationStatement:3" id="8455935734540361476">
                <node role="localVariableDeclaration:3" type="jetbrains.mps.baseLanguage.structure.LocalVariableDeclaration:3" id="8455935734540361477">
                  <property name="name:3" value="operationExpression" />
                  <node role="type:3" type="jetbrains.mps.lang.smodel.structure.SNodeType:16" id="8455935734540361478">
                    <link role="concept:16" targetNodeId="3v.1197027756228:3" resolveInfo="DotExpression" />
                  </node>
                  <node role="initializer:3" type="jetbrains.mps.baseLanguage.structure.DotExpression:3" id="8455935734540361479">
                    <node role="operand:3" type="jetbrains.mps.lang.sharedConcepts.structure.ConceptFunctionParameter_model:0" id="8455935734540361480" />
                    <node role="operation:3" type="jetbrains.mps.lang.smodel.structure.Model_CreateNewNodeOperation:16" id="8455935734540361481">
                      <link role="concept:16" targetNodeId="3v.1197027756228:3" resolveInfo="DotExpression" />
                    </node>
                  </node>
                </node>
              </node>
              <node role="statement:3" type="jetbrains.mps.baseLanguage.structure.ExpressionStatement:3" id="8455935734540361596">
                <node role="expression:3" type="jetbrains.mps.baseLanguage.structure.DotExpression:3" id="8455935734540361597">
                  <node role="operand:3" type="jetbrains.mps.baseLanguage.structure.DotExpression:3" id="8455935734540361598">
                    <node role="operand:3" type="jetbrains.mps.baseLanguage.structure.DotExpression:3" id="8455935734540361599">
                      <node role="operand:3" type="jetbrains.mps.baseLanguage.structure.DotExpression:3" id="8455935734540361600">
                        <node role="operand:3" type="jetbrains.mps.baseLanguage.structure.LocalVariableReference:3" id="8455935734540361601">
                          <link role="variableDeclaration:3" targetNodeId="8455935734540361477" resolveInfo="operationExpression" />
                        </node>
                        <node role="operation:3" type="jetbrains.mps.lang.smodel.structure.SLinkAccess:16" id="8455935734540361602">
                          <link role="link:16" targetNodeId="3v.1197027833540:3" />
                        </node>
                      </node>
                      <node role="operation:3" type="jetbrains.mps.lang.smodel.structure.Link_SetNewChildOperation:16" id="8455935734540361603">
                        <link role="concept:16" targetNodeId="3v.1202948039474:3" resolveInfo="InstanceMethodCallOperation" />
                      </node>
                    </node>
                    <node role="operation:3" type="jetbrains.mps.lang.smodel.structure.SLinkAccess:16" id="8455935734540361604">
                      <link role="link:16" targetNodeId="3v.1202948736718:3" />
                    </node>
                  </node>
                  <node role="operation:3" type="jetbrains.mps.lang.smodel.structure.Link_SetTargetOperation:16" id="8455935734540361605">
                    <node role="linkTarget:16" type="jetbrains.mps.lang.smodel.structure.SNodeTypeCastExpression:16" id="8455935734540361606">
                      <link role="concept:16" targetNodeId="3v.1068580123165:3" resolveInfo="InstanceMethodDeclaration" />
                      <node role="leftExpression:16" type="jetbrains.mps.lang.actions.structure.ConceptFunctionParameter_parameterObject:23" id="8455935734540361607" />
                    </node>
                  </node>
                </node>
              </node>
              <node role="statement:3" type="jetbrains.mps.baseLanguage.structure.LocalVariableDeclarationStatement:3" id="8455935734540361518">
                <node role="localVariableDeclaration:3" type="jetbrains.mps.baseLanguage.structure.LocalVariableDeclaration:3" id="8455935734540361519">
                  <property name="name:3" value="thisExpression" />
                  <node role="type:3" type="jetbrains.mps.lang.smodel.structure.SNodeType:16" id="8455935734540361520">
                    <link role="concept:16" targetNodeId="2v.3316739663067157299:0" resolveInfo="ThisExtensionExpression" />
                  </node>
                  <node role="initializer:3" type="jetbrains.mps.baseLanguage.structure.DotExpression:3" id="8455935734540361521">
                    <node role="operand:3" type="jetbrains.mps.baseLanguage.structure.DotExpression:3" id="8455935734540361522">
                      <node role="operand:3" type="jetbrains.mps.baseLanguage.structure.LocalVariableReference:3" id="8455935734540361523">
                        <link role="variableDeclaration:3" targetNodeId="8455935734540361477" resolveInfo="operationExpression" />
                      </node>
                      <node role="operation:3" type="jetbrains.mps.lang.smodel.structure.SLinkAccess:16" id="8455935734540361524">
                        <link role="link:16" targetNodeId="3v.1197027771414:3" />
                      </node>
                    </node>
                    <node role="operation:3" type="jetbrains.mps.lang.smodel.structure.Link_SetNewChildOperation:16" id="8455935734540361525">
                      <link role="concept:16" targetNodeId="2v.3316739663067157299:0" resolveInfo="ThisExtensionExpression" />
                    </node>
                  </node>
                </node>
              </node>
              <node role="statement:3" type="jetbrains.mps.baseLanguage.structure.Statement:3" id="8455935734540361526" />
              <node role="statement:3" type="jetbrains.mps.baseLanguage.structure.ReturnStatement:3" id="8455935734540361583">
                <node role="expression:3" type="jetbrains.mps.baseLanguage.structure.LocalVariableReference:3" id="8455935734540361584">
                  <link role="variableDeclaration:3" targetNodeId="8455935734540361477" resolveInfo="operationExpression" />
                </node>
              </node>
            </node>
