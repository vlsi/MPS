...
import jetbrains.mps.xml.deprecated.structure.ElementPart;
...
public class Text extends ElementPart {
  ...
  public static Text newInstance(SModel sm, boolean init) {
    return (Text)SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.xml.deprecated.structure.Text", sm, GlobalScope.getInstance(), init).getAdapter();
  }
