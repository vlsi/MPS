...
public class GStatementItem extends GItem {
  public static final String concept = "webr.gtext.structure.GStatementItem";
  ...
  public static GStatementItem newInstance(SModel sm, boolean init) {
    return (GStatementItem)SModelUtil_new.instantiateConceptDeclaration("webr.gtext.structure.GStatementItem", sm, GlobalScope.getInstance(), init).getAdapter();
  }
