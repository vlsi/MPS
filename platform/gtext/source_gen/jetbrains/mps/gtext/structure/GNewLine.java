...
public class GNewLine extends GItem {
  public static final String concept = "webr.gtext.structure.GNewLine";
  ...
  public static GNewLine newInstance(SModel sm, boolean init) {
    return (GNewLine)SModelUtil_new.instantiateConceptDeclaration("webr.gtext.structure.GNewLine", sm, GlobalScope.getInstance(), init).getAdapter();
  }
