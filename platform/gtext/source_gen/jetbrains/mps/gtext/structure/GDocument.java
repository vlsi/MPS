...
public class GDocument extends BaseConcept implements INamedConcept {
  ...
  public int get_$attributesCount() {
    return this.getChildCount(GDocument._$ATTRIBUTE);
  }

  public Iterator<Attribute> _$attributes() {
    return this.children(Attribute.class, GDocument._$ATTRIBUTE);
  }

  public List<Attribute> get_$attributes() {
    return this.getChildren(Attribute.class, GDocument._$ATTRIBUTE);
  }

  public void add_$attribute(Attribute node) {
    this.addChild(GDocument._$ATTRIBUTE, node);
  }

  public void insert_$attribute(Attribute prev, Attribute node) {
    this.insertChild(prev, GDocument._$ATTRIBUTE, node);
  }
