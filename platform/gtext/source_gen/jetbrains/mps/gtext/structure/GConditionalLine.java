...
public class GConditionalLine extends GItem {
  public static final String concept = "webr.gtext.structure.GConditionalLine";
  ...
  public static GConditionalLine newInstance(SModel sm, boolean init) {
    return (GConditionalLine)SModelUtil_new.instantiateConceptDeclaration("webr.gtext.structure.GConditionalLine", sm, GlobalScope.getInstance(), init).getAdapter();
  }
