...
public class GContentPlaceholder extends GItem implements INamedConcept {
  ...
  public int get_$attributesCount() {
    return this.getChildCount(GContentPlaceholder._$ATTRIBUTE);
  }

  public Iterator<Attribute> _$attributes() {
    return this.children(Attribute.class, GContentPlaceholder._$ATTRIBUTE);
  }

  public List<Attribute> get_$attributes() {
    return this.getChildren(Attribute.class, GContentPlaceholder._$ATTRIBUTE);
  }

  public void add_$attribute(Attribute node) {
    this.addChild(GContentPlaceholder._$ATTRIBUTE, node);
  }

  public void insert_$attribute(Attribute prev, Attribute node) {
    this.insertChild(prev, GContentPlaceholder._$ATTRIBUTE, node);
  }
