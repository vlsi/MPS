...
<model name="jetbrains.mps.baseLanguage.unitTest.plugin">
  ...
  <node type="jetbrains.mps.bootstrap.pluginLanguage.structure.ActionDeclaration" id="1208265544755">
      ...
      <node role="body" type="jetbrains.mps.baseLanguage.structure.StatementList" id="1208265544757">
        ...
        <node role="statement" type="jetbrains.mps.baseLanguage.structure.LocalVariableDeclarationStatement"
          ...
          <node role="localVariableDeclaration" type="jetbrains.mps.baseLanguage.structure.LocalVariableDeclaration"
            ...
            <node role="initializer" type="jetbrains.mps.baseLanguage.structure.NewExpression" id="1208267229674">
              <link role="baseMethodDeclaration"
                    targetNodeId="3.~MessageDialog.&lt;init&gt;(java.awt.Frame,java.lang.String)"
                    resolveInfo="MessageDialog"/>
              <node role="actualArgument" type="jetbrains.mps.baseLanguage.structure.DotExpression" id="1208352909998">
                <node role="operand" type="jetbrains.mps.baseLanguage.classifiers.structure.ThisClassifierExpresson"
                      id="1208352909999"/>
                <node role="operation"
                      type="jetbrains.mps.bootstrap.pluginLanguage.structure.ActionParameterReferenceOperation"
                      id="1208352910000">
                  <link role="member" targetNodeId="1208352887010" resolveInfo="frame"/>
                </node>
              </node>
        ...
        <node role="statement" type="jetbrains.mps.baseLanguage.structure.ExpressionStatement" id="1208267232034">
          <node role="expression" type="jetbrains.mps.baseLanguage.structure.DotExpression" id="1208267233544">
            ...
            <node role="operation" type="jetbrains.mps.baseLanguage.structure.InstanceMethodCallOperation"
                  id="1208268938454">
              <link role="baseMethodDeclaration" targetNodeId="3.~BaseDialog.showDialog():void"
    ...
    <node role="parameterDeclaration" type="jetbrains.mps.bootstrap.pluginLanguage.structure.ActionParameterDeclaration"
      ...
      <node role="visibility" type="jetbrains.mps.baseLanguage.structure.PrivateVisibility" id="1208352887011"/>
      <node role="type" type="jetbrains.mps.baseLanguage.structure.ClassifierType" id="1208352890670">
