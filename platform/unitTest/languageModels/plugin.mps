...
<model name="jetbrains.mps.baseLanguage.unitTest.plugin">
  ...
  <node type="jetbrains.mps.bootstrap.pluginLanguage.structure.Tool" id="1208269069496">
    ...
    <property name="icon" value="${mps_home}\core\baseLanguage\baseLanguage\icons\run.png"/>
        ...
        <node role="statement" type="jetbrains.mps.baseLanguage.structure.ExpressionStatement" id="1208769143845">
          <node role="expression" type="jetbrains.mps.baseLanguage.structure.DotExpression" id="1208769143846">
            ...
            <node role="operation" type="jetbrains.mps.baseLanguage.structure.InstanceMethodCallOperation"
                  id="1208769143848">
              <link role="baseMethodDeclaration"
                    targetNodeId="23.~IDEProjectFrame.openNode(jetbrains.mps.smodel.SNode,jetbrains.mps.smodel.IOperationContext):jetbrains.mps.ide.IEditor"
                    ...
                    <node role="expression" type="jetbrains.mps.baseLanguage.structure.AssignmentExpression"
                      ...
                      <node role="rValue" type="jetbrains.mps.baseLanguage.structure.DotExpression" id="1208942216868">
                        ...
                        <node role="operation"
                              type="jetbrains.mps.bootstrap.smodelLanguage.structure.Node_ConceptMethodCall"
                              id="1208942216870">
                          <link role="conceptMethodDeclaration" targetNodeId="4v.1184686272576"
